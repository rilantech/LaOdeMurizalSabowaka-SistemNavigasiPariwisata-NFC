...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    private static final CoroutineDispatcher f63default = UnlimitedIoScheduler.INSTANCE.limitedParallelism(SystemPropsKt__SystemProps_commonKt.systemProp$default(DispatchersKt.IO_PARALLELISM_PROPERTY_NAME, RangesKt.coerceAtLeast(64, SystemPropsKt.getAVAILABLE_PROCESSORS()), 0, 0, 12, (Object) null));
    ...
    public void dispatch(CoroutineContext context, Runnable block) {
        f63default.dispatch(context, block);
    }

    public void dispatchYield(CoroutineContext context, Runnable block) {
        f63default.dispatchYield(context, block);
    }
