...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m6229constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), (String) null, 2, (DefaultConstructorMarker) null));
        } catch (Throwable th) {
    ...
    public static final void m7739postFrameCallback$lambda6(CancellableContinuation $cont, long nanos) {
