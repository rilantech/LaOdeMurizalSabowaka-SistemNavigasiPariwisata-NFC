...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r8v8, resolved type: kotlinx.coroutines.flow.SharedFlowSlot} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v15, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v6, resolved type: kotlinx.coroutines.flow.SharedFlowImpl} */
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x008f, code lost:
        r2 = (kotlinx.coroutines.Job) r9.getContext().get(kotlinx.coroutines.Job.Key);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x00a1, code lost:
        r4 = r3.tryTakeValue(r8);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x00a8, code lost:
        if (r4 != kotlinx.coroutines.flow.SharedFlowKt.NO_VALUE) goto L_0x00bd;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:32:0x00b9, code lost:
        if (r3.awaitValue(r8, r9) != r1) goto L_0x00bc;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x00d1, code lost:
        if (r2.emit(r4, r9) != r1) goto L_0x00d4;
     */
    ...
    static /* synthetic */ java.lang.Object collect$suspendImpl(kotlinx.coroutines.flow.SharedFlowImpl r7, kotlinx.coroutines.flow.FlowCollector r8, kotlin.coroutines.Continuation r9) {
        /*
            boolean r0 = r9 instanceof kotlinx.coroutines.flow.SharedFlowImpl$collect$1
        ...
        L_0x006b:
            ...
            kotlinx.coroutines.flow.SharedFlowSlot r8 = (kotlinx.coroutines.flow.SharedFlowSlot) r8
            boolean r2 = r7 instanceof kotlinx.coroutines.flow.SubscribedFlowCollector     // Catch:{ all -> 0x00d8 }
            if (r2 == 0) goto L_0x008f
            r2 = r7
            kotlinx.coroutines.flow.SubscribedFlowCollector r2 = (kotlinx.coroutines.flow.SubscribedFlowCollector) r2     // Catch:{ all -> 0x00d8 }
            r9.L$0 = r3     // Catch:{ all -> 0x00d8 }
            r9.L$1 = r7     // Catch:{ all -> 0x00d8 }
            r9.L$2 = r8     // Catch:{ all -> 0x00d8 }
            r4 = 1
            r9.label = r4     // Catch:{ all -> 0x00d8 }
            java.lang.Object r2 = r2.onSubscription(r9)     // Catch:{ all -> 0x00d8 }
            if (r2 != r1) goto L_0x008e
            return r1
        L_0x008e:
        L_0x008f:
            r2 = 0
            kotlin.coroutines.CoroutineContext r4 = r9.getContext()     // Catch:{ all -> 0x00d8 }
            kotlinx.coroutines.Job$Key r2 = kotlinx.coroutines.Job.Key     // Catch:{ all -> 0x00d8 }
            kotlin.coroutines.CoroutineContext$Key r2 = (kotlin.coroutines.CoroutineContext.Key) r2     // Catch:{ all -> 0x00d8 }
            kotlin.coroutines.CoroutineContext$Element r2 = r4.get(r2)     // Catch:{ all -> 0x00d8 }
            kotlinx.coroutines.Job r2 = (kotlinx.coroutines.Job) r2     // Catch:{ all -> 0x00d8 }
        L_0x009e:
            r6 = r2
            r2 = r7
            r7 = r6
        L_0x00a1:
            java.lang.Object r4 = r3.tryTakeValue(r8)     // Catch:{ all -> 0x00d8 }
            kotlinx.coroutines.internal.Symbol r5 = kotlinx.coroutines.flow.SharedFlowKt.NO_VALUE     // Catch:{ all -> 0x00d8 }
            if (r4 != r5) goto L_0x00bd
            r9.L$0 = r3     // Catch:{ all -> 0x00d8 }
            r9.L$1 = r2     // Catch:{ all -> 0x00d8 }
            r9.L$2 = r8     // Catch:{ all -> 0x00d8 }
            r9.L$3 = r7     // Catch:{ all -> 0x00d8 }
            r4 = 2
            r9.label = r4     // Catch:{ all -> 0x00d8 }
            java.lang.Object r4 = r3.awaitValue(r8, r9)     // Catch:{ all -> 0x00d8 }
        ...
        L_0x00bd:
            ...
            kotlinx.coroutines.JobKt.ensureActive((kotlinx.coroutines.Job) r7)     // Catch:{ all -> 0x00d8 }
        L_0x00c2:
            r9.L$0 = r3     // Catch:{ all -> 0x00d8 }
            r9.L$1 = r2     // Catch:{ all -> 0x00d8 }
            r9.L$2 = r8     // Catch:{ all -> 0x00d8 }
            r9.L$3 = r7     // Catch:{ all -> 0x00d8 }
            r5 = 3
            r9.label = r5     // Catch:{ all -> 0x00d8 }
            java.lang.Object r5 = r2.emit(r4, r9)     // Catch:{ all -> 0x00d8 }
    ...
    public boolean tryEmit(T value) {
        ...
        for (Continuation cont : continuationArr) {
            if (cont != null) {
                ...
                cont.resumeWith(Result.m6229constructorimpl(Unit.INSTANCE));
            }
        }
        return emitted;
    }
    ...
    public final Object emitSuspend(T value, Continuation<? super Unit> $completion) {
        ...
        for (Continuation r : continuationArr) {
            if (r != null) {
                ...
                r.resumeWith(Result.m6229constructorimpl(Unit.INSTANCE));
            }
        }
    ...
    public final kotlin.coroutines.Continuation<kotlin.Unit>[] updateCollectorIndexLocked$kotlinx_coroutines_core(long r27) {
        ...
        L_0x00cd:
            ...
            java.lang.Object r15 = kotlinx.coroutines.flow.SharedFlowKt.getBufferAt(r8, r13)
            ...
            kotlin.coroutines.Continuation<kotlin.Unit> r5 = r5.cont
            r6[r7] = r5
            kotlinx.coroutines.internal.Symbol r5 = kotlinx.coroutines.flow.SharedFlowKt.NO_VALUE
            kotlinx.coroutines.flow.SharedFlowKt.setBufferAt(r8, r13, r5)
            r5 = r15
            kotlinx.coroutines.flow.SharedFlowImpl$Emitter r5 = (kotlinx.coroutines.flow.SharedFlowImpl.Emitter) r5
            java.lang.Object r5 = r5.value
            kotlinx.coroutines.flow.SharedFlowKt.setBufferAt(r8, r0, r5)
            r16 = 1
            long r0 = r0 + r16
        ...
        L_0x00fe:
            ...
            java.lang.String r5 = "null cannot be cast to non-null type kotlinx.coroutines.flow.SharedFlowImpl.Emitter"
            r4.<init>(r5)
            throw r4
        L_0x0106:
            r4 = 1
    ...
    private final Object tryTakeValue(SharedFlowSlot slot) {
        ...
        for (Continuation resume : continuationArr) {
            if (resume != null) {
                Result.Companion companion = Result.Companion;
                resume.resumeWith(Result.m6229constructorimpl(Unit.INSTANCE));
            }
        }
        return value;
    }
