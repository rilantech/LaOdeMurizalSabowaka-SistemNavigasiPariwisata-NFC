...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m7777catch(Flow<? extends T> $this$catch, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> action) {
        return FlowKt__ErrorsKt.m7784catch($this$catch, action);
    }
    ...
    public static final <T> Flow<T> m7778debounceHG0u8IE(Flow<? extends T> $this$debounce_u2dHG0u8IE, long timeout) {
        return FlowKt__DelayKt.m7780debounceHG0u8IE($this$debounce_u2dHG0u8IE, timeout);
    }
    ...
    public static final <T> Flow<T> m7779sampleHG0u8IE(Flow<? extends T> $this$sample_u2dHG0u8IE, long period) {
        return FlowKt__DelayKt.m7781sampleHG0u8IE($this$sample_u2dHG0u8IE, period);
    }
