...
public final class TimeoutKt {
    ...
    public static final <T> Object m7736withTimeoutKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return withTimeout(DelayKt.m7734toDelayMillisLRDsOJo(timeout), block, $completion);
    }
    ...
    public static final <T> Object m7737withTimeoutOrNullKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return withTimeoutOrNull(DelayKt.m7734toDelayMillisLRDsOJo(timeout), block, $completion);
    }
