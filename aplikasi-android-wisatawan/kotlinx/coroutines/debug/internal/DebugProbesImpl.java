...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            if (newInstance != null) {
                obj = Result.m6229constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
    ...
    public final void install() {
        ...
        L_0x001c:
            ...
            int r6 = installations     // Catch:{ all -> 0x006e }
            r7 = 1
            int r6 = r6 + r7
            installations = r6     // Catch:{ all -> 0x006e }
            int r6 = installations     // Catch:{ all -> 0x006e }
        ...
        L_0x0053:
            ...
            java.lang.Boolean r6 = java.lang.Boolean.valueOf(r7)     // Catch:{ all -> 0x006e }
    ...
    public final void uninstall() {
        ...
        L_0x001c:
            ...
            r0.lock()
            r4 = 0
            kotlinx.coroutines.debug.internal.DebugProbesImpl r5 = INSTANCE     // Catch:{ all -> 0x008b }
            boolean r6 = r5.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x008b }
            if (r6 == 0) goto L_0x007e
            int r6 = installations     // Catch:{ all -> 0x008b }
            int r6 = r6 + -1
            installations = r6     // Catch:{ all -> 0x008b }
            int r6 = installations     // Catch:{ all -> 0x008b }
        ...
        L_0x003e:
            ...
            return
        L_0x0042:
            r5.stopWeakRefCleanerThread()     // Catch:{ all -> 0x008b }
            kotlinx.coroutines.debug.internal.ConcurrentWeakMap<kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner<?>, java.lang.Boolean> r5 = capturedCoroutinesMap     // Catch:{ all -> 0x008b }
            r5.clear()     // Catch:{ all -> 0x008b }
            kotlinx.coroutines.debug.internal.ConcurrentWeakMap<kotlin.coroutines.jvm.internal.CoroutineStackFrame, kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl> r5 = callerInfoCache     // Catch:{ all -> 0x008b }
            r5.clear()     // Catch:{ all -> 0x008b }
            kotlinx.coroutines.debug.internal.AgentInstallationType r5 = kotlinx.coroutines.debug.internal.AgentInstallationType.INSTANCE     // Catch:{ all -> 0x008b }
            boolean r5 = r5.isInstalledStatically$kotlinx_coroutines_core()     // Catch:{ all -> 0x008b }
        ...
        L_0x005f:
            ...
            return
        L_0x0063:
            kotlin.jvm.functions.Function1<java.lang.Boolean, kotlin.Unit> r5 = dynamicAttach     // Catch:{ all -> 0x008b }
            if (r5 == 0) goto L_0x006e
            java.lang.Boolean r6 = java.lang.Boolean.valueOf(r3)     // Catch:{ all -> 0x008b }
            r5.invoke(r6)     // Catch:{ all -> 0x008b }
        L_0x006e:
        ...
        L_0x007e:
            ...
            java.lang.IllegalStateException r5 = new java.lang.IllegalStateException     // Catch:{ all -> 0x008b }
    ...
    private final void dumpCoroutinesSynchronized(PrintStream out) {
        ...
        try {
            ...
            if (debugProbesImpl.isInstalled$kotlinx_coroutines_core()) {
                ...
                Sequence<CoroutineOwner> $this$forEach$iv = SequencesKt.sortedWith(SequencesKt.filter(CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines()), DebugProbesImpl$dumpCoroutinesSynchronized$1$2.INSTANCE), new DebugProbesImpl$dumpCoroutinesSynchronized$lambda19$$inlined$sortedBy$1());
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            DebugProbesImpl debugProbesImpl = this;
            obj = Result.m6229constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m6229constructorimpl(ResultKt.createFailure(th));
        }
