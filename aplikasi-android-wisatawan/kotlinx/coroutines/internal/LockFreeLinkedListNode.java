        ...
        public Object perform(Object affected2) {
            ...
            if (affected2 != null) {
                ...
                if (decision == LockFreeLinkedList_commonKt.REMOVE_PREPARED) {
                    ...
                    if (LockFreeLinkedListNode._next$FU.compareAndSet((LockFreeLinkedListNode) affected2, this, next2.removed())) {
                ...
                LockFreeLinkedListNode._next$FU.compareAndSet((LockFreeLinkedListNode) affected2, this, update);
                return null;
            }
                    ...
                    if (!retry(affected, next)) {
                        ...
                        if (LockFreeLinkedListNode._next$FU.compareAndSet(affected, next, prepareOp)) {
                            try {
                                ...
                                LockFreeLinkedListNode._next$FU.compareAndSet(affected, prepareOp, next);
                                throw e;
                            }
                        } else {
                            continue;
