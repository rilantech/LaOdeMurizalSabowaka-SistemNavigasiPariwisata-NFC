...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E exception) {
        ...
        try {
            ...
            e = Result.m6229constructorimpl(((CopyableThrowable) exception).createCopy());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            e = Result.m6229constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m6235isFailureimpl(e)) {
            e = null;
        }
        return (Throwable) e;
    }
    ...
    public static final <E extends Throwable> Function1<Throwable, Throwable> createConstructor(Class<E> clz) {
        ...
        for (Constructor constructor : ArraysKt.sortedWith((T[]) clz.getConstructors(), new ExceptionsConstructorKt$createConstructor$$inlined$sortedByDescending$1())) {
    ...
    private static final int fieldsCountOrDefault(Class<?> $this$fieldsCountOrDefault, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            num = Result.m6229constructorimpl(Integer.valueOf(fieldsCount$default($this$fieldsCountOrDefault, 0, 1, (Object) null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            num = Result.m6229constructorimpl(ResultKt.createFailure(th));
        }
        Integer valueOf = Integer.valueOf(defaultValue);
        if (Result.m6235isFailureimpl(num)) {
            num = valueOf;
        }
