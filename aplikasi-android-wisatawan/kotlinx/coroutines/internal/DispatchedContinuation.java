...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
        ...
        do {
            ...
            if (state != DispatchedContinuationKt.REUSABLE_CLAIMED) {
                if (!(state instanceof Throwable)) {
                    throw new IllegalStateException(("Inconsistent state " + state).toString());
                } else if (_reusableCancellableContinuation$FU.compareAndSet(this, state, (Object) null)) {
                    return (Throwable) state;
                } else {
                    throw new IllegalArgumentException("Failed requirement.".toString());
                }
            }
        } while (!_reusableCancellableContinuation$FU.compareAndSet(this, DispatchedContinuationKt.REUSABLE_CLAIMED, continuation2));
        return null;
    }
    ...
    public final boolean postponeCancellation(Throwable cause) {
        while (true) {
            ...
            if (Intrinsics.areEqual(state, (Object) DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                ...
                if (_reusableCancellableContinuation$FU.compareAndSet(this, state, (Object) null)) {
                    return false;
                }
            }
        }
    ...
    public final void resumeCancellableWith(java.lang.Object r24, kotlin.jvm.functions.Function1<? super java.lang.Throwable, kotlin.Unit> r25) {
        ...
        L_0x0059:
            ...
            r19 = r0
            java.lang.Object r0 = kotlin.Result.m6229constructorimpl(r18)     // Catch:{ all -> 0x009f }
    ...
    public final boolean resumeCancelled(Object state) {
        ...
        resumeWith(Result.m6229constructorimpl(ResultKt.createFailure(cause)));
        return true;
    }
