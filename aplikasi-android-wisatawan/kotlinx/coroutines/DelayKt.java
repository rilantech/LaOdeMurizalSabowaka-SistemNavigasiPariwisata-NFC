...
public final class DelayKt {
    ...
    public static final Object m7733delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m7734toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m7734toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m7559compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.Companion.m7663getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m7578getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1);
        }
        return 0;
    }
}
