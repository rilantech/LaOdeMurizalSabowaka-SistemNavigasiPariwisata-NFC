...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected() != 0) {
            while (true) {
                ...
                if (result$iv == SelectKt.UNDECIDED) {
                    if (_result$FU.compareAndSet(this, SelectKt.UNDECIDED, CompletionStateKt.toState$default(result, (Function1) null, 1, (Object) null))) {
                        return;
                    }
                } else if (result$iv != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    throw new IllegalStateException("Already resumed");
                } else if (_result$FU.compareAndSet(this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                    if (Result.m6235isFailureimpl(result)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable exception$iv = Result.m6232exceptionOrNullimpl(result);
                        ...
                        continuation.resumeWith(Result.m6229constructorimpl(ResultKt.createFailure(th)));
                        return;
                    }
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected() != 0) {
            while (true) {
                ...
                if (result$iv == SelectKt.UNDECIDED) {
                    ...
                    if (_result$FU.compareAndSet(this, SelectKt.UNDECIDED, new CompletedExceptionally(th, false, 2, (DefaultConstructorMarker) null))) {
                        return;
                    }
                } else if (result$iv != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    throw new IllegalStateException("Already resumed");
                    ...
                    Result.Companion companion = Result.Companion;
                    intercepted.resumeWith(Result.m6229constructorimpl(ResultKt.createFailure(exception)));
                    return;
                }
            }
        } else {
    ...
    public final void handleBuilderException(Throwable e) {
        if (trySelect()) {
            Result.Companion companion = Result.Companion;
            resumeWith(Result.m6229constructorimpl(ResultKt.createFailure(e)));
    ...
    private static final class PairSelectOp extends OpDescriptor {
        ...
        public Object perform(Object affected) {
            if (affected != null) {
                ...
                SelectBuilderImpl._state$FU.compareAndSet(impl, this, decision == null ? this.otherOp.desc : SelectKt.getNOT_SELECTED());
                return decision;
            }
    ...
    private static final class AtomicSelectOp extends AtomicOp<Object> {
        ...
        private final void completeSelect(Object failure) {
            ...
            if (SelectBuilderImpl._state$FU.compareAndSet(this.impl, this, selectSuccess ? null : SelectKt.getNOT_SELECTED()) && selectSuccess) {
