...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1 extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m7773invokeWpGqRn0(((ChannelResult) obj).m7764unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m7773invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m7752boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Object it = ((ChannelResult) this.L$0).m7764unboximpl();
                Throwable it2 = ChannelResult.m7756exceptionOrNullimpl(it);
                if (it2 == null) {
                    Function2<E, Continuation<? super R>, Object> function2 = this.$block;
                    Object r4 = ChannelResult.m7757getOrNullimpl(it);
                    this.label = 1;
                    Object it3 = function2.invoke(r4, this);
                    if (it3 == coroutine_suspended) {
