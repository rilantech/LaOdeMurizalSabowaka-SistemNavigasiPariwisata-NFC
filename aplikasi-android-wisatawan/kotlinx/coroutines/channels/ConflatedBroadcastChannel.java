...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        } while (!_state$FU.compareAndSet(this, state, new State(((State) state).value, addSubscriber(((State) state).subscribers, subscriber))));
        return subscriber;
    }
    ...
    public Object m7768trySendJP2dKIU(E element) {
        Closed it = offerInternal(element);
        if (it != null) {
            return ChannelResult.Companion.m7765closedJP2dKIU(it.getSendException());
        }
        return ChannelResult.Companion.m7767successJP2dKIU(Unit.INSTANCE);
    }
    ...
    private final kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed offerInternal(E r14) {
        ...
        L_0x000c:
            ...
            r3 = 0
        L_0x000f:
            java.lang.Object r4 = r0._state     // Catch:{ all -> 0x006d }
            r5 = 0
            boolean r6 = r4 instanceof kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed     // Catch:{ all -> 0x006d }
            if (r6 == 0) goto L_0x001e
            r1 = r4
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$Closed r1 = (kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed) r1     // Catch:{ all -> 0x006d }
        L_0x001b:
            r13._updating = r2
            return r1
        L_0x001e:
            boolean r6 = r4 instanceof kotlinx.coroutines.channels.ConflatedBroadcastChannel.State     // Catch:{ all -> 0x006d }
            if (r6 == 0) goto L_0x0050
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$State r6 = new kotlinx.coroutines.channels.ConflatedBroadcastChannel$State     // Catch:{ all -> 0x006d }
            r7 = r4
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$State r7 = (kotlinx.coroutines.channels.ConflatedBroadcastChannel.State) r7     // Catch:{ all -> 0x006d }
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$Subscriber<E>[] r7 = r7.subscribers     // Catch:{ all -> 0x006d }
            r6.<init>(r14, r7)     // Catch:{ all -> 0x006d }
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r7 = _state$FU     // Catch:{ all -> 0x006d }
            boolean r7 = r7.compareAndSet(r13, r4, r6)     // Catch:{ all -> 0x006d }
            if (r7 == 0) goto L_0x004d
            r0 = r4
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$State r0 = (kotlinx.coroutines.channels.ConflatedBroadcastChannel.State) r0     // Catch:{ all -> 0x006d }
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$Subscriber<E>[] r0 = r0.subscribers     // Catch:{ all -> 0x006d }
            if (r0 == 0) goto L_0x004b
            r7 = 0
            int r8 = r0.length     // Catch:{ all -> 0x006d }
            r9 = r2
        L_0x003e:
            if (r9 >= r8) goto L_0x004a
            r10 = r0[r9]     // Catch:{ all -> 0x006d }
            r11 = r10
            r12 = 0
            r11.offerInternal(r14)     // Catch:{ all -> 0x006d }
            int r9 = r9 + 1
            goto L_0x003e
        L_0x004a:
        L_0x004b:
        ...
        L_0x0050:
            ...
            java.lang.StringBuilder r1 = r1.append(r6)     // Catch:{ all -> 0x006d }
            java.lang.StringBuilder r1 = r1.append(r4)     // Catch:{ all -> 0x006d }
