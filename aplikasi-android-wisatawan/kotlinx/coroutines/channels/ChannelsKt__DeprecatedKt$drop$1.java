...
final class ChannelsKt__DeprecatedKt$drop$1 extends SuspendLambda implements Function2<ProducerScope<? super E>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0087, code lost:
        if (((java.lang.Boolean) r9).booleanValue() == false) goto L_0x0099;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x00c1, code lost:
        if (((java.lang.Boolean) r9).booleanValue() == false) goto L_0x00de;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x00d5, code lost:
        if (r4.send(r3.next(), r2) != r1) goto L_0x00d8;
     */
