...
class ActivityChooserModel extends DataSetObservable {
    ...
    private void readHistoricalDataImpl() {
        /*
            ...
            r1 = 0
            android.content.Context r2 = r12.mContext     // Catch:{ FileNotFoundException -> 0x00dc }
            java.lang.String r3 = r12.mHistoryFileName     // Catch:{ FileNotFoundException -> 0x00dc }
            java.io.FileInputStream r2 = r2.openFileInput(r3)     // Catch:{ FileNotFoundException -> 0x00dc }
            r1 = r2
            org.xmlpull.v1.XmlPullParser r2 = android.util.Xml.newPullParser()     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            java.lang.String r3 = "UTF-8"
            r2.setInput(r1, r3)     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            r3 = 0
        L_0x0017:
            r4 = 1
            ...
            int r4 = r2.next()     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            r3 = r4
            goto L_0x0017
        L_0x0023:
            java.lang.String r5 = "historical-records"
            java.lang.String r6 = r2.getName()     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            boolean r5 = r5.equals(r6)     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            if (r5 == 0) goto L_0x0087
            java.util.List<androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord> r5 = r12.mHistoricalRecords     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            r5.clear()     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
        L_0x0035:
            int r6 = r2.next()     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            r3 = r6
        ...
        L_0x004b:
            ...
            boolean r7 = r7.equals(r6)     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            if (r7 == 0) goto L_0x007f
            java.lang.String r7 = "activity"
            r8 = 0
            java.lang.String r7 = r2.getAttributeValue(r8, r7)     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            java.lang.String r9 = "time"
            java.lang.String r9 = r2.getAttributeValue(r8, r9)     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            long r9 = java.lang.Long.parseLong(r9)     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            java.lang.String r11 = "weight"
            java.lang.String r8 = r2.getAttributeValue(r8, r11)     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            float r8 = java.lang.Float.parseFloat(r8)     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord r11 = new androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            r11.<init>((java.lang.String) r7, (long) r9, (float) r8)     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            r5.add(r11)     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            goto L_0x0035
        L_0x007f:
            org.xmlpull.v1.XmlPullParserException r4 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            java.lang.String r7 = "Share records file not well-formed."
            r4.<init>(r7)     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            throw r4     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
        L_0x0087:
            org.xmlpull.v1.XmlPullParserException r4 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            java.lang.String r5 = "Share records file does not start with historical-records tag."
            r4.<init>(r5)     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
            throw r4     // Catch:{ XmlPullParserException -> 0x00b1, IOException -> 0x0091 }
        L_0x008f:
            r0 = move-exception
            goto L_0x00d4
        L_0x0091:
            r2 = move-exception
            java.lang.String r3 = LOG_TAG     // Catch:{ all -> 0x008f }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x008f }
            r4.<init>()     // Catch:{ all -> 0x008f }
            java.lang.StringBuilder r0 = r4.append(r0)     // Catch:{ all -> 0x008f }
            java.lang.String r4 = r12.mHistoryFileName     // Catch:{ all -> 0x008f }
            java.lang.StringBuilder r0 = r0.append(r4)     // Catch:{ all -> 0x008f }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x008f }
            android.util.Log.e(r3, r0, r2)     // Catch:{ all -> 0x008f }
            if (r1 == 0) goto L_0x00d3
            r1.close()     // Catch:{ IOException -> 0x00d1 }
            goto L_0x00d0
        L_0x00b1:
    ...
    private final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:35:0x00dd A[SYNTHETIC, Splitter:B:35:0x00dd] */
        /* JADX WARNING: Removed duplicated region for block: B:43:0x0105 A[SYNTHETIC, Splitter:B:43:0x0105] */
        /* JADX WARNING: Removed duplicated region for block: B:51:0x0114 A[SYNTHETIC, Splitter:B:51:0x0114] */
        /* JADX WARNING: Unknown top exception splitter block from list: {B:23:0x0094=Splitter:B:23:0x0094, B:39:0x00e4=Splitter:B:39:0x00e4, B:31:0x00bc=Splitter:B:31:0x00bc} */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public java.lang.Void doInBackground(java.lang.Object... r18) {
            /*
                ...
                r8 = 0
                r9 = 0
                androidx.appcompat.widget.ActivityChooserModel r10 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ FileNotFoundException -> 0x011a }
                android.content.Context r10 = r10.mContext     // Catch:{ FileNotFoundException -> 0x011a }
                java.io.FileOutputStream r10 = r10.openFileOutput(r7, r4)     // Catch:{ FileNotFoundException -> 0x011a }
                r8 = r10
                org.xmlpull.v1.XmlSerializer r10 = android.util.Xml.newSerializer()
                r10.setOutput(r8, r9)     // Catch:{ IllegalArgumentException -> 0x00e1, IllegalStateException -> 0x00b9, IOException -> 0x0091, all -> 0x008b }
                java.lang.String r11 = "UTF-8"
                java.lang.Boolean r12 = java.lang.Boolean.valueOf(r6)     // Catch:{ IllegalArgumentException -> 0x00e1, IllegalStateException -> 0x00b9, IOException -> 0x0091, all -> 0x008b }
                r10.startDocument(r11, r12)     // Catch:{ IllegalArgumentException -> 0x00e1, IllegalStateException -> 0x00b9, IOException -> 0x0091, all -> 0x008b }
                r10.startTag(r9, r2)     // Catch:{ IllegalArgumentException -> 0x00e1, IllegalStateException -> 0x00b9, IOException -> 0x0091, all -> 0x008b }
                int r11 = r5.size()     // Catch:{ IllegalArgumentException -> 0x00e1, IllegalStateException -> 0x00b9, IOException -> 0x0091, all -> 0x008b }
                r12 = 0
            L_0x0038:
                if (r12 >= r11) goto L_0x0072
                java.lang.Object r13 = r5.remove(r4)     // Catch:{ IllegalArgumentException -> 0x00e1, IllegalStateException -> 0x00b9, IOException -> 0x0091, all -> 0x008b }
                androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord r13 = (androidx.appcompat.widget.ActivityChooserModel.HistoricalRecord) r13     // Catch:{ IllegalArgumentException -> 0x00e1, IllegalStateException -> 0x00b9, IOException -> 0x0091, all -> 0x008b }
                r10.startTag(r9, r0)     // Catch:{ IllegalArgumentException -> 0x00e1, IllegalStateException -> 0x00b9, IOException -> 0x0091, all -> 0x008b }
                java.lang.String r14 = "activity"
                android.content.ComponentName r15 = r13.activity     // Catch:{ IllegalArgumentException -> 0x00e1, IllegalStateException -> 0x00b9, IOException -> 0x0091, all -> 0x008b }
                java.lang.String r15 = r15.flattenToString()     // Catch:{ IllegalArgumentException -> 0x00e1, IllegalStateException -> 0x00b9, IOException -> 0x0091, all -> 0x008b }
                r10.attribute(r9, r14, r15)     // Catch:{ IllegalArgumentException -> 0x00e1, IllegalStateException -> 0x00b9, IOException -> 0x0091, all -> 0x008b }
                java.lang.String r14 = "time"
                r16 = r5
                long r4 = r13.time     // Catch:{ IllegalArgumentException -> 0x0089, IllegalStateException -> 0x0087, IOException -> 0x0085 }
                java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ IllegalArgumentException -> 0x0089, IllegalStateException -> 0x0087, IOException -> 0x0085 }
                r10.attribute(r9, r14, r4)     // Catch:{ IllegalArgumentException -> 0x0089, IllegalStateException -> 0x0087, IOException -> 0x0085 }
                java.lang.String r4 = "weight"
                float r5 = r13.weight     // Catch:{ IllegalArgumentException -> 0x0089, IllegalStateException -> 0x0087, IOException -> 0x0085 }
                java.lang.String r5 = java.lang.String.valueOf(r5)     // Catch:{ IllegalArgumentException -> 0x0089, IllegalStateException -> 0x0087, IOException -> 0x0085 }
                r10.attribute(r9, r4, r5)     // Catch:{ IllegalArgumentException -> 0x0089, IllegalStateException -> 0x0087, IOException -> 0x0085 }
                r10.endTag(r9, r0)     // Catch:{ IllegalArgumentException -> 0x0089, IllegalStateException -> 0x0087, IOException -> 0x0085 }
                int r12 = r12 + 1
                r5 = r16
                r4 = 0
                goto L_0x0038
            L_0x0072:
                r16 = r5
                r10.endTag(r9, r2)     // Catch:{ IllegalArgumentException -> 0x0089, IllegalStateException -> 0x0087, IOException -> 0x0085 }
                r10.endDocument()     // Catch:{ IllegalArgumentException -> 0x0089, IllegalStateException -> 0x0087, IOException -> 0x0085 }
            ...
            L_0x0091:
                ...
                r16 = r5
            L_0x0094:
                java.lang.String r2 = androidx.appcompat.widget.ActivityChooserModel.LOG_TAG     // Catch:{ all -> 0x010c }
                java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x010c }
                r4.<init>()     // Catch:{ all -> 0x010c }
                java.lang.StringBuilder r3 = r4.append(r3)     // Catch:{ all -> 0x010c }
                androidx.appcompat.widget.ActivityChooserModel r4 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ all -> 0x010c }
                java.lang.String r4 = r4.mHistoryFileName     // Catch:{ all -> 0x010c }
                java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x010c }
                java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x010c }
                android.util.Log.e(r2, r3, r0)     // Catch:{ all -> 0x010c }
                androidx.appcompat.widget.ActivityChooserModel r0 = androidx.appcompat.widget.ActivityChooserModel.this
                r0.mCanReadHistoricalData = r6
                if (r8 == 0) goto L_0x010b
                r8.close()     // Catch:{ IOException -> 0x0109 }
