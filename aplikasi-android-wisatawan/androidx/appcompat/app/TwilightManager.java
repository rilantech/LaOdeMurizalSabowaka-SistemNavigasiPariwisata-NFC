...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        twilightCalculator.calculateTwilight(now - CalendarModelKt.MillisecondsIn24Hours, location.getLatitude(), location.getLongitude());
        ...
        long j = now + CalendarModelKt.MillisecondsIn24Hours;
