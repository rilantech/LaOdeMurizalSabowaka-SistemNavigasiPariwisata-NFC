...
public class FontRequestEmojiCompatConfig extends EmojiCompat.Config {
    ...
    private static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public void createMetadata() {
            ...
            L_0x0009:
                monitor-exit(r0)     // Catch:{ all -> 0x00ad }
                androidx.core.provider.FontsContractCompat$FontInfo r0 = r7.retrieveFontInfo()     // Catch:{ all -> 0x0099 }
                int r1 = r0.getResultCode()     // Catch:{ all -> 0x0099 }
                r2 = 2
                if (r1 != r2) goto L_0x0034
                java.lang.Object r2 = r7.mLock     // Catch:{ all -> 0x0099 }
                ...
                r7.scheduleRetry(r5, r3)     // Catch:{ all -> 0x0031 }
            ...
            L_0x0034:
                ...
                androidx.emoji2.text.FontRequestEmojiCompatConfig$FontProviderHelper r2 = r7.mFontProviderHelper     // Catch:{ all -> 0x0074 }
                android.content.Context r3 = r7.mContext     // Catch:{ all -> 0x0074 }
                ...
                androidx.core.os.TraceCompat.endSection()     // Catch:{ all -> 0x0099 }
                java.lang.Object r2 = r7.mLock     // Catch:{ all -> 0x0099 }
                monitor-enter(r2)     // Catch:{ all -> 0x0099 }
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r3 = r7.mCallback     // Catch:{ all -> 0x0069 }
                if (r3 == 0) goto L_0x0064
                r3.onLoaded(r4)     // Catch:{ all -> 0x0069 }
            L_0x0064:
                monitor-exit(r2)     // Catch:{ all -> 0x0069 }
                r7.cleanUp()     // Catch:{ all -> 0x0099 }
                goto L_0x00a9
            L_0x0069:
                r3 = move-exception
                monitor-exit(r2)     // Catch:{ all -> 0x0069 }
            ...
            L_0x007a:
                java.lang.RuntimeException r2 = new java.lang.RuntimeException     // Catch:{ all -> 0x0099 }
                ...
                java.lang.StringBuilder r3 = r3.append(r1)     // Catch:{ all -> 0x0099 }
                java.lang.String r4 = ")"
                java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x0099 }
            ...
            L_0x0099:
                ...
                monitor-enter(r2)
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r0 = r7.mCallback     // Catch:{ all -> 0x00aa }
                if (r0 == 0) goto L_0x00a5
                r0.onFailed(r1)     // Catch:{ all -> 0x00aa }
            L_0x00a5:
