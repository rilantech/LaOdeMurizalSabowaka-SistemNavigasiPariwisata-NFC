...
class ProfileTranscoder {
    ...
    private static DexProfileData[] readUncompressedBody(InputStream is, String apkName, int numberOfDexFiles) throws IOException {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            long j = numMethodIds;
            long j2 = hotMethodRegionSize;
            int i3 = (int) hotMethodRegionSize;
            int i4 = classSetSize;
            lines[i2] = new DexProfileData(apkName, Encoding.readString(inputStream, dexNameSize), dexChecksum, 0, classSetSize, i3, (int) numMethodIds, new int[classSetSize], new TreeMap());
        }
        for (DexProfileData data : lines) {
