...
public abstract class KeyCycleOscillator {
    ...
    public void setup(float pathLength) {
        ...
        if (count != 0) {
            ...
            double[][] values = (double[][]) Array.newInstance(Double.TYPE, new int[]{count, 3});
    ...
    static class CycleOscillator {
        ...
        public void setup(float pathLength) {
            ...
            double[][] splineValues = (double[][]) Array.newInstance(Double.TYPE, new int[]{this.mPosition.length, 3});
