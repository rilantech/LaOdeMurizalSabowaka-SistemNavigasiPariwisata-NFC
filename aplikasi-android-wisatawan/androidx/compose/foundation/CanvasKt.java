...
public final class CanvasKt {
    public static final void Canvas(Modifier modifier, Function1<? super DrawScope, Unit> onDraw, Composer $composer, int $changed) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new CanvasKt$Canvas$1(modifier, onDraw, $changed));
        }
    }
    ...
    public static final void Canvas(Modifier modifier, String contentDescription, Function1<? super DrawScope, Unit> onDraw, Composer $composer, int $changed) {
        ...
        if (($dirty & 731) != 146 || !$composer2.getSkipping()) {
            ...
            boolean invalid$iv$iv = $composer2.changed((Object) contentDescription);
            Composer $this$cache$iv$iv = $composer2;
            Object it$iv$iv = $this$cache$iv$iv.rememberedValue();
            if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
                value$iv$iv = (Function1) new CanvasKt$Canvas$2$1(contentDescription);
                $this$cache$iv$iv.updateRememberedValue(value$iv$iv);
            } else {
                value$iv$iv = it$iv$iv;
            }
            $composer2.endReplaceableGroup();
            SpacerKt.Spacer(SemanticsModifierKt.semantics$default(drawBehind, false, (Function1) value$iv$iv, 1, (Object) null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        ScopeUpdateScope endRestartGroup = $composer2.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new CanvasKt$Canvas$3(modifier, contentDescription, onDraw, $changed));
        }
    }
}
