...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNode> {
    ...
    public void update(CombinedClickableNode node) {
        ...
        node.m218updatecJG_KMw(this.interactionSource, this.enabled, this.onClickLabel, this.role, this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick);
    }
    ...
    public int hashCode() {
        ...
        int result3 = (((result2 + (role2 != null ? Role.m5159hashCodeimpl(role2.m5161unboximpl()) : 0)) * 31) + this.onClick.hashCode()) * 31;
