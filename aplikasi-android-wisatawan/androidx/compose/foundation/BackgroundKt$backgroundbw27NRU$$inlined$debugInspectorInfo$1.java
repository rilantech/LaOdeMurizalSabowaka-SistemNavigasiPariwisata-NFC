...
public final class BackgroundKt$backgroundbw27NRU$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        $this$background_bw27NRU_u24lambda_u240.setValue(Color.m3243boximpl(this.$color$inlined));
        $this$background_bw27NRU_u24lambda_u240.getProperties().set(TypedValues.Custom.S_COLOR, Color.m3243boximpl(this.$color$inlined));
