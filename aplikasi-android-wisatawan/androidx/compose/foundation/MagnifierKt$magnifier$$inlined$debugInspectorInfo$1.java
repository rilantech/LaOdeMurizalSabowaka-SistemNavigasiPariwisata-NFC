...
public final class MagnifierKt$magnifier$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$magnifier_u24lambda_u240 = $this$null;
        $this$magnifier_u24lambda_u240.setName(MagnifierKt.isPlatformMagnifierSupported$default(0, 1, (Object) null) ? "magnifier" : "magnifier (not supported)");
        $this$magnifier_u24lambda_u240.getProperties().set("sourceCenter", this.$sourceCenter$inlined);
        $this$magnifier_u24lambda_u240.getProperties().set("magnifierCenter", this.$magnifierCenter$inlined);
        $this$magnifier_u24lambda_u240.getProperties().set("zoom", Float.valueOf(this.$zoom$inlined));
        $this$magnifier_u24lambda_u240.getProperties().set("style", this.$style$inlined);
    }
}
