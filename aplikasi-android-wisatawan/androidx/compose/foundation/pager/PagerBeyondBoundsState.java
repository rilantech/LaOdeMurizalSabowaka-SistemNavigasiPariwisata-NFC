...
public final class PagerBeyondBoundsState implements LazyLayoutBeyondBoundsState {
    ...
    public PagerBeyondBoundsState(PagerState state2, int beyondBoundsPageCount2) {
        Intrinsics.checkNotNullParameter(state2, "state");
        this.state = state2;
        this.beyondBoundsPageCount = beyondBoundsPageCount2;
    }
    ...
    public int getLastPlacedIndex() {
        return Math.min(getItemCount() - 1, ((PageInfo) CollectionsKt.last(this.state.getLayoutInfo$foundation_release().getVisiblePagesInfo())).getIndex() + this.beyondBoundsPageCount);
    }
}
