...
public final class PagerKt {
    ...
    public static final void m818HorizontalPagerxYaah8o(PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Vertical verticalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> key, NestedScrollConnection pageNestedScrollConnection, Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, int $changed, int $changed1, int i) {
        ...
        if (i21 == 2048 && ($dirty & 1533916891) == 306783378 && ($dirty13 & 731) == 146 && $composer3.getSkipping()) {
            ...
            if ((i10 & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if (i14 != 0) {
                    contentPadding2 = PaddingKt.m531PaddingValues0680j_4(Dp.m5844constructorimpl((float) 0));
                } else {
                    contentPadding2 = contentPadding;
                }
                if (i15 != 0) {
                ...
                if (i17 != 0) {
                    pageSpacing3 = Dp.m5844constructorimpl((float) 0);
                } else {
                ...
                if ((i12 & 128) != 0) {
                    ...
                    i5 = 1491175841;
                    i6 = i21;
                    flingBehavior3 = PagerDefaults.INSTANCE.m816flingBehaviorPfoAEA0(state, (PagerSnapDistance) null, (AnimationSpec<Float>) null, (DecayAnimationSpec<Float>) null, (AnimationSpec<Float>) null, 0.0f, 0.0f, $composer3, ($dirty & 14) | 12582912, 126);
                    $dirty &= -29360129;
                } else {
                    $dirty12 = $dirty13;
                    $composer2 = $composer3;
    ...
    public static final void m817HorizontalPagerAlbwjTQ(int pageCount, Modifier modifier, PagerState state, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Vertical verticalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> key, NestedScrollConnection pageNestedScrollConnection, Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, int $changed, int $changed1, int i) {
        ...
        if (i29 == 4096 && (1533916891 & $dirty3) == 306783378 && ($dirty13 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if ((i14 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i18 != 0) {
                    contentPadding3 = PaddingKt.m531PaddingValues0680j_4(Dp.m5844constructorimpl((float) 0));
                } else {
                ...
                if ((i16 & 256) != 0) {
                    flingBehavior4 = PagerDefaults.INSTANCE.m816flingBehaviorPfoAEA0(state4, (PagerSnapDistance) null, (AnimationSpec<Float>) null, (DecayAnimationSpec<Float>) null, (AnimationSpec<Float>) null, 0.0f, 0.0f, $composer2, (($dirty2 >> 6) & 14) | 12582912, 126);
                    $dirty2 &= -234881025;
                } else {
    ...
    public static final void m820VerticalPagerxYaah8o(PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Horizontal horizontalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> key, NestedScrollConnection pageNestedScrollConnection, Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, int $changed, int $changed1, int i) {
        Modifier modifier2;
        PageSize pageSize2;
        int i2;
    ...
    public static final void m819VerticalPagerAlbwjTQ(int pageCount, Modifier modifier, PagerState state, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Horizontal horizontalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> key, NestedScrollConnection pageNestedScrollConnection, Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, int $changed, int $changed1, int i) {
        Modifier modifier2;
        PagerState state2;
        PageSize pageSize2;
        int i2;
    ...
    public static final float dragGestureDelta(PagerState $this$dragGestureDelta) {
        if ($this$dragGestureDelta.getLayoutInfo$foundation_release().getOrientation() == Orientation.Horizontal) {
            return Offset.m3003getXimpl($this$dragGestureDelta.m829getUpDownDifferenceF1C5BW0$foundation_release());
        }
        return Offset.m3004getYimpl($this$dragGestureDelta.m829getUpDownDifferenceF1C5BW0$foundation_release());
    }
}
