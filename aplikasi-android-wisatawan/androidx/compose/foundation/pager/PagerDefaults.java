...
public final class PagerDefaults {
    ...
    public final SnapFlingBehavior m816flingBehaviorPfoAEA0(PagerState state, PagerSnapDistance pagerSnapDistance, AnimationSpec<Float> lowVelocityAnimationSpec, DecayAnimationSpec<Float> highVelocityAnimationSpec, AnimationSpec<Float> snapAnimationSpec, float snapVelocityThreshold, float snapPositionalThreshold, Composer $composer, int $changed, int i) {
