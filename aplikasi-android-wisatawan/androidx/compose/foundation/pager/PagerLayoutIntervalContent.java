...
final class PagerLayoutIntervalContent extends LazyLayoutIntervalContent<PagerIntervalContent> {
    ...
    public PagerLayoutIntervalContent(Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent2, Function1<? super Integer, ? extends Object> key2, int pageCount2) {
        Intrinsics.checkNotNullParameter(pageContent2, "pageContent");
        this.pageContent = pageContent2;
        this.key = key2;
        this.pageCount = pageCount2;
        MutableIntervalList $this$intervals_u24lambda_u240 = new MutableIntervalList();
        $this$intervals_u24lambda_u240.addInterval(pageCount2, new PagerIntervalContent(key2, pageContent2));
