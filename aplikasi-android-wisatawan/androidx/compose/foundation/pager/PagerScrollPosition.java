...
public final class PagerScrollPosition {
    ...
    public PagerScrollPosition(int initialPage, int initialScrollOffset) {
        this.firstVisiblePage$delegate = SnapshotIntStateKt.mutableIntStateOf(initialPage);
        this.currentPage$delegate = SnapshotIntStateKt.mutableIntStateOf(initialPage);
