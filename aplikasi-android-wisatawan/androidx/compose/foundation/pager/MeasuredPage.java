...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        if (this.mainAxisLayoutSize != Integer.MIN_VALUE) {
            ...
            while (i4 < size2) {
                ...
                long offset2 = m814getOffsetBjo55l4(index2);
                if (this.reverseLayout) {
                    long $this$copy_u2d4Tuh3kE$iv = offset2;
                    if (this.isVertical) {
                        mainAxisOffset = IntOffset.m5962getXimpl($this$copy_u2d4Tuh3kE$iv);
                        i = i3;
                    } else {
                        i = i3;
                        mainAxisOffset = (this.mainAxisLayoutSize - IntOffset.m5962getXimpl($this$copy_u2d4Tuh3kE$iv)) - getMainAxisSize(placeable);
                    }
                    if (this.isVertical) {
                        long j = offset2;
                ...
                long offset3 = IntOffsetKt.IntOffset(IntOffset.m5962getXimpl(offset2) + IntOffset.m5962getXimpl(other$iv), IntOffset.m5963getYimpl(offset2) + IntOffset.m5963getYimpl(other$iv));
                if (this.isVertical) {
    ...
    private final long m814getOffsetBjo55l4(int index2) {
    ...
    private final long m813copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> mainAxisMap) {
