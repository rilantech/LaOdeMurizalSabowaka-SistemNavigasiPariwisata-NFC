...
final class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult m987measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        MeasureScope measureScope = $this$measure_u2d3p2s80s;
        Measurable measurable2 = measurable;
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable2, "measurable");
        Placeable placeable = measurable2.m4689measureBRTryo0(Constraints.m5779copyZbe2FdA$default(constraints, 0, 0, 0, Integer.MAX_VALUE, 7, (Object) null));
        int height = Math.min(placeable.getHeight(), Constraints.m5787getMaxHeightimpl(constraints));
