...
final class BasicTextKt$BasicText$8 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        BasicTextKt.m878BasicText4YKlhWE(this.$text, this.$modifier, this.$style, (Function1) this.$onTextLayout, this.$overflow, this.$softWrap, this.$maxLines, this.$minLines, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), this.$$default);
    }
}
