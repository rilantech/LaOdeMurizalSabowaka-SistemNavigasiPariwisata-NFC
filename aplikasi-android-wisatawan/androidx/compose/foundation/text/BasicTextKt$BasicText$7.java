...
final class BasicTextKt$BasicText$7 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        BasicTextKt.m877BasicText4YKlhWE(this.$text, this.$modifier, this.$style, (Function1) this.$onTextLayout, this.$overflow, this.$softWrap, this.$maxLines, (Map) this.$inlineContent, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), this.$$default);
    }
}
