...
final class AnnotatedStringResolveInlineContentKt$InlineChildren$1$2 implements MeasurePolicy {
    ...
    public final MeasureResult m876measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> children, long constrains) {
        ...
        while (index$iv$iv < size) {
            ...
            Object obj = it$iv;
            target$iv.add(((Measurable) it$iv).m4689measureBRTryo0(constrains));
            index$iv$iv++;
            MeasureScope measureScope = $this$Layout;
        }
        long j = constrains;
        return MeasureScope.layout$default($this$Layout, Constraints.m5788getMaxWidthimpl(constrains), Constraints.m5787getMaxHeightimpl(constrains), (Map) null, new AnnotatedStringResolveInlineContentKt$InlineChildren$1$2$measure$1(target$iv), 4, (Object) null);
    }
}
