...
final class TextFieldSizeKt$textFieldMinSize$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
        ...
        if (invalid$iv$iv2 || it$iv$iv2 == Composer.Companion.getEmpty()) {
            ...
            int $changed$iv = r16 != null ? r16.m5427unboximpl() : FontStyle.Companion.m5429getNormal_LCdwA();
            FontSynthesis r162 = resolvedStyle.m5349getFontSynthesisZQGJjVo();
            value$iv$iv2 = fontFamilyResolver.m5398resolveDPcqOEQ(fontFamily, fontWeight2, $changed$iv, r162 != null ? r162.m5438unboximpl() : FontSynthesis.Companion.m5439getAllGVVA2EU());
        ...
        Modifier layout = LayoutModifierKt.layout(Modifier.Companion, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() {
            public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2, Object p3) {
                return m973invoke3p2s80s((MeasureScope) p1, (Measurable) p2, ((Constraints) p3).m5794unboximpl());
            }

            /* renamed from: invoke-3p2s80s  reason: not valid java name */
            public final MeasureResult m973invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long constraints) {
                Measurable measurable2 = measurable;
                Intrinsics.checkNotNullParameter($this$layout, "$this$layout");
                Intrinsics.checkNotNullParameter(measurable2, "measurable");
                SizeKt.m597defaultMinSizeVpY3zN4$default(Modifier.Companion, 0.0f, 0.0f, 3, (Object) null);
                long minSize = minSizeState.m972getMinSizeYbymL2g();
                final Placeable measured = measurable2.m4689measureBRTryo0(Constraints.m5779copyZbe2FdA$default(constraints, RangesKt.coerceIn(IntSize.m6004getWidthimpl(minSize), Constraints.m5790getMinWidthimpl(constraints), Constraints.m5788getMaxWidthimpl(constraints)), 0, RangesKt.coerceIn(IntSize.m6003getHeightimpl(minSize), Constraints.m5789getMinHeightimpl(constraints), Constraints.m5787getMaxHeightimpl(constraints)), 0, 10, (Object) null));
