...
public final class TextFieldDelegate {
    ...
    public static final Triple<Integer, Integer, TextLayoutResult> m951layout_EkL_Y$foundation_release(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult) {
    ...
    public static final void m952setCursorOffsetULxng0E$foundation_release(long j, TextLayoutResultProxy textLayoutResultProxy, EditProcessor editProcessor, OffsetMapping offsetMapping, Function1<? super TextFieldValue, Unit> function1) {
        Companion.m956setCursorOffsetULxng0E$foundation_release(j, textLayoutResultProxy, editProcessor, offsetMapping, function1);
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ Triple m953layout_EkL_Y$foundation_release$default(Companion companion, TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
            ...
            return companion.m955layout_EkL_Y$foundation_release(textDelegate, j, layoutDirection, textLayoutResult2);
        }
        ...
        public final Triple<Integer, Integer, TextLayoutResult> m955layout_EkL_Y$foundation_release(TextDelegate textDelegate, long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResultText) {
            ...
            TextLayoutResult layoutResult = textDelegate.m945layoutNN6EwU(constraints, layoutDirection, prevResultText);
            return new Triple<>(Integer.valueOf(IntSize.m6004getWidthimpl(layoutResult.m5298getSizeYbymL2g())), Integer.valueOf(IntSize.m6003getHeightimpl(layoutResult.m5298getSizeYbymL2g())), layoutResult);
        }
        ...
        public final void draw$foundation_release(Canvas canvas, TextFieldValue value, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Paint selectionPaint) {
            ...
            if (!TextRange.m5319getCollapsedimpl(value.m5555getSelectiond9O1mEE()) && (start = offsetMapping.originalToTransformed(TextRange.m5323getMinimpl(value.m5555getSelectiond9O1mEE()))) != (end = offsetMapping.originalToTransformed(TextRange.m5322getMaximpl(value.m5555getSelectiond9O1mEE())))) {
        ...
        public final void notifyFocusedRect$foundation_release(TextFieldValue value, TextDelegate textDelegate, TextLayoutResult textLayoutResult, LayoutCoordinates layoutCoordinates, TextInputSession textInputSession, boolean hasFocus, OffsetMapping offsetMapping) {
            ...
            if (hasFocus) {
                int focusOffsetInTransformed = offsetMapping2.originalToTransformed(TextRange.m5322getMaximpl(value.m5555getSelectiond9O1mEE()));
                if (focusOffsetInTransformed < textLayoutResult.getLayoutInput().getText().length()) {
                    ...
                    bbox = new Rect(0.0f, 0.0f, 1.0f, (float) IntSize.m6003getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText$default(textDelegate.getStyle(), textDelegate.getDensity(), textDelegate.getFontFamilyResolver(), (String) null, 0, 24, (Object) null)));
                }
                long globalLT = layoutCoordinates2.m4652localToRootMKHz9U(OffsetKt.Offset(bbox.getLeft(), bbox.getTop()));
                textInputSession2.notifyFocusedRect(RectKt.m3043Recttz77jQw(OffsetKt.Offset(Offset.m3003getXimpl(globalLT), Offset.m3004getYimpl(globalLT)), SizeKt.Size(bbox.getWidth(), bbox.getHeight())));
            }
        }
        ...
        public final void m956setCursorOffsetULxng0E$foundation_release(long position, TextLayoutResultProxy textLayoutResult, EditProcessor editProcessor, OffsetMapping offsetMapping, Function1<? super TextFieldValue, Unit> onValueChange) {
            ...
            Intrinsics.checkNotNullParameter(offsetMapping, "offsetMapping");
            Intrinsics.checkNotNullParameter(onValueChange, "onValueChange");
            onValueChange.invoke(TextFieldValue.m5550copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, TextRangeKt.TextRange(offsetMapping.transformedToOriginal(TextLayoutResultProxy.m980getOffsetForPosition3MmeM6k$default(textLayoutResult, position, false, 2, (Object) null))), (TextRange) null, 5, (Object) null));
        }
        ...
        public final void onBlur$foundation_release(TextInputSession textInputSession, EditProcessor editProcessor, Function1<? super TextFieldValue, Unit> onValueChange) {
            ...
            Intrinsics.checkNotNullParameter(editProcessor, "editProcessor");
            Intrinsics.checkNotNullParameter(onValueChange, "onValueChange");
            onValueChange.invoke(TextFieldValue.m5550copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, 0, (TextRange) null, 3, (Object) null));
        ...
        public final TransformedText m954applyCompositionDecoration72CqOWE(long compositionRange, TransformedText transformed) {
            ...
            $this$applyCompositionDecoration_72CqOWE_u24lambda_u240.addStyle(spanStyle, transformed.getOffsetMapping().originalToTransformed(TextRange.m5325getStartimpl(compositionRange)), transformed.getOffsetMapping().originalToTransformed(TextRange.m5320getEndimpl(compositionRange)));
