...
final class TextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult m986measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> measurables, long constraints) {
        List toPlace;
        ...
        if ($this$fastMapIndexedNotNull$iv2 != null) {
            ...
            while (index$iv$iv < size) {
                ...
                if (rect != null) {
                    ...
                    it$iv = new Pair(((Measurable) list.get(index2)).m4689measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) ((float) Math.floor((double) it.getWidth())), 0, (int) ((float) Math.floor((double) it.getHeight())), 5, (Object) null)), IntOffset.m5953boximpl(IntOffsetKt.IntOffset(MathKt.roundToInt(it.getLeft()), MathKt.roundToInt(it.getTop()))));
                } else {
                    $this$fastMapIndexedNotNull$iv = $this$fastMapIndexedNotNull$iv2;
                    $this$fastForEachIndexed$iv$iv = $this$fastForEachIndexed$iv$iv2;
                    $i$f$fastForEachIndexed = $i$f$fastForEachIndexed2;
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, Constraints.m5788getMaxWidthimpl(constraints), Constraints.m5787getMaxHeightimpl(constraints), (Map) null, new TextMeasurePolicy$measure$1(toPlace), 4, (Object) null);
    }
}
