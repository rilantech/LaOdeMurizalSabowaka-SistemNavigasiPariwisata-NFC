...
final class CoreTextFieldKt$CoreTextField$semanticsModifier$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    public final void invoke(final SemanticsPropertyReceiver $this$semantics) {
        ...
        SemanticsPropertiesKt.m5174setImeAction4L7nppU($this$semantics, this.$imeOptions.m5506getImeActioneUduSuo());
        SemanticsPropertiesKt.setEditableText($this$semantics, this.$transformedText.getText());
        SemanticsPropertiesKt.m5177setTextSelectionRangeFDrldGo($this$semantics, this.$value.m5555getSelectiond9O1mEE());
        if (!this.$enabled) {
        ...
        SemanticsPropertiesKt.insertTextAtCursor$default($this$semantics, (String) null, new Function1<AnnotatedString, Boolean>() {
            public final Boolean invoke(AnnotatedString text) {
                ...
                if (unit == null) {
                    ...
                    textFieldState3.getOnValueChange().invoke(new TextFieldValue(StringsKt.replaceRange((CharSequence) textFieldValue.getText(), TextRange.m5325getStartimpl(textFieldValue.m5555getSelectiond9O1mEE()), TextRange.m5320getEndimpl(textFieldValue.m5555getSelectiond9O1mEE()), (CharSequence) annotatedString).toString(), TextRangeKt.TextRange(TextRange.m5325getStartimpl(textFieldValue.m5555getSelectiond9O1mEE()) + text.length()), (TextRange) null, 4, (DefaultConstructorMarker) null));
                }
                return true;
            }
        }, 1, (Object) null);
        ...
        SemanticsPropertiesKt.setSelection$default($this$semantics, (String) null, new Function3<Integer, Integer, Boolean, Boolean>() {
            ...
            public final Boolean invoke(int selectionStart, int selectionEnd, boolean relativeToOriginalText) {
                ...
                boolean z = false;
                if (z5 && !(start == TextRange.m5325getStartimpl(textFieldValue2.m5555getSelectiond9O1mEE()) && end == TextRange.m5320getEndimpl(textFieldValue2.m5555getSelectiond9O1mEE()))) {
        ...
        SemanticsPropertiesKt.performImeAction$default($this$semantics, (String) null, new Function0<Boolean>() {
            public final Boolean invoke() {
                textFieldState5.getOnImeActionPerformed().invoke(ImeAction.m5480boximpl(imeOptions.m5506getImeActioneUduSuo()));
                return true;
            }
        }, 1, (Object) null);
        ...
        if (!TextRange.m5319getCollapsedimpl(this.$value.m5555getSelectiond9O1mEE()) && !this.$isPassword) {
