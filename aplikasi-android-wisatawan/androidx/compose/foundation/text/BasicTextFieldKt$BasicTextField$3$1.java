...
final class BasicTextFieldKt$BasicTextField$3$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        if (!TextRange.m5318equalsimpl0(this.$textFieldValue.m5555getSelectiond9O1mEE(), BasicTextFieldKt.BasicTextField$lambda$2(this.$textFieldValueState$delegate).m5555getSelectiond9O1mEE()) || !Intrinsics.areEqual((Object) this.$textFieldValue.m5554getCompositionMzsxiRA(), (Object) BasicTextFieldKt.BasicTextField$lambda$2(this.$textFieldValueState$delegate).m5554getCompositionMzsxiRA())) {
