...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m980getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m982getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k  reason: not valid java name */
    public final int m982getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        long it = position;
        if (coerceInVisibleBounds) {
            it = m979coercedInVisibleBoundsOfInputTextMKHz9U(it);
        }
        return this.value.m5297getOffsetForPositionk4lQ0M(m981relativeToInputTextMKHz9U(it));
    }

    public final int getLineForVerticalPosition(float vertical) {
        return this.value.getLineForVerticalPosition(Offset.m3004getYimpl(m981relativeToInputTextMKHz9U(m979coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical)))));
    }
    ...
    public final boolean m983isPositionOnTextk4lQ0M(long offset) {
        long relativeOffset = m981relativeToInputTextMKHz9U(m979coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int line = this.value.getLineForVerticalPosition(Offset.m3004getYimpl(relativeOffset));
        return Offset.m3003getXimpl(relativeOffset) >= this.value.getLineLeft(line) && Offset.m3003getXimpl(relativeOffset) <= this.value.getLineRight(line);
    }
    ...
    private final long m981relativeToInputTextMKHz9U(long $this$relativeToInputText_u2dMK_u2dHz9U) {
        Offset offset;
        long j;
        ...
        if (innerTextFieldCoordinates2 != null) {
            ...
            if (decorationBoxCoordinates2 != null) {
                if (!innerTextFieldCoordinates2.isAttached() || !decorationBoxCoordinates2.isAttached()) {
                    ...
                    j = innerTextFieldCoordinates2.m4651localPositionOfR5De75A(decorationBoxCoordinates2, $this$relativeToInputText_u2dMK_u2dHz9U);
                }
                offset = Offset.m2992boximpl(j);
            } else {
                offset = null;
            }
            if (offset != null) {
                return offset.m3013unboximpl();
            }
        }
    ...
    private final long m979coercedInVisibleBoundsOfInputTextMKHz9U(long r7) {
        /*
            r6 = this;
        ...
        L_0x0026:
            r0 = r3
            long r1 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m985coerceIn3MmeM6k(r7, r0)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m979coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
}
