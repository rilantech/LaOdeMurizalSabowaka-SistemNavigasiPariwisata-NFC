...
final class EmptyMeasurePolicy implements MeasurePolicy {
    ...
    private static final Function1<Placeable.PlacementScope, Unit> placementBlock = EmptyMeasurePolicy$placementBlock$1.INSTANCE;

    private EmptyMeasurePolicy() {
    }

    /* renamed from: measure-3p2s80s  reason: not valid java name */
    public MeasureResult m899measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> measurables, long constraints) {
        Intrinsics.checkNotNullParameter($this$measure_u2d3p2s80s, "$this$measure");
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, Constraints.m5788getMaxWidthimpl(constraints), Constraints.m5787getMaxHeightimpl(constraints), (Map) null, placementBlock, 4, (Object) null);
    }
}
