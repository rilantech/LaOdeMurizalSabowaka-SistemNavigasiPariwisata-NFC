...
final class TextFieldCursorKt$cursor$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
        ...
        if (brush instanceof SolidColor) {
            if (((SolidColor) brush).m3623getValue0d7_KjU() == Color.Companion.m3289getUnspecified0d7_KjU()) {
                z = false;
            }
        }
        boolean isBrushSpecified = z;
        if (!this.$state.getHasFocus() || !TextRange.m5319getCollapsedimpl(this.$value.m5555getSelectiond9O1mEE()) || !isBrushSpecified) {
            modifier = Modifier.Companion;
        } else {
            EffectsKt.LaunchedEffect(this.$value.getAnnotatedString(), TextRange.m5313boximpl(this.$value.m5555getSelectiond9O1mEE()), new AnonymousClass1((Continuation<? super AnonymousClass1>) null), composer, 512);
            ...
            modifier = DrawModifierKt.drawWithContent(modifier2, new Function1<ContentDrawScope, Unit>() {
                ...
                public final void invoke(ContentDrawScope $this$drawWithContent) {
                    ...
                    if (!(cursorAlphaValue == 0.0f)) {
                        int transformedOffset = offsetMapping.originalToTransformed(TextRange.m5325getStartimpl(textFieldValue.m5555getSelectiond9O1mEE()));
                        ...
                        float cursorWidth = contentDrawScope.m5825toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
                        float f = (float) 2;
                        float cursorX = RangesKt.coerceAtMost(cursorRect.getLeft() + (cursorWidth / f), Size.m3072getWidthimpl($this$drawWithContent.m3866getSizeNHjbRc()) - (cursorWidth / f));
                        float f2 = cursorX;
                        DrawScope.m3833drawLine1RTmtNc$default(contentDrawScope, brush2, OffsetKt.Offset(cursorX, cursorRect.getTop()), OffsetKt.Offset(cursorX, cursorRect.getBottom()), cursorWidth, 0, (PathEffect) null, cursorAlphaValue, (ColorFilter) null, 0, 432, (Object) null);
                    }
                }
            });
        }
