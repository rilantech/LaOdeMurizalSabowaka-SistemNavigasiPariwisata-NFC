...
public final class SelectionControllerKt$makeSelectionModifier$mouseSelectionObserver$1 implements MouseSelectionObserver {
    ...
    public boolean m1028onExtendk4lQ0M(long downPosition) {
        ...
        if (selectionRegistrar.m1118notifySelectionUpdate5iVPX68(layoutCoordinates, downPosition, this.lastPosition, false, SelectionAdjustment.Companion.getNone())) {
    ...
    public boolean m1029onExtendDragk4lQ0M(long dragPosition) {
        LayoutCoordinates layoutCoordinates = this.$layoutCoordinates.invoke();
        if (layoutCoordinates == null) {
            return true;
        }
        ...
        if (!selectionRegistrar.m1118notifySelectionUpdate5iVPX68(layoutCoordinates, dragPosition, this.lastPosition, false, SelectionAdjustment.Companion.getNone())) {
            return true;
        }
    ...
    public boolean m1030onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
        ...
        selectionRegistrar.m1119notifySelectionUpdateStartd4ec7I(it, downPosition, adjustment);
        this.lastPosition = downPosition;
        return SelectionRegistrarKt.hasSelection(selectionRegistrar, j);
    }

    /* renamed from: onDrag-3MmeM6k  reason: not valid java name */
    public boolean m1027onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        LayoutCoordinates it = this.$layoutCoordinates.invoke();
        if (it == null) {
            return true;
        ...
        if (!selectionRegistrar.m1118notifySelectionUpdate5iVPX68(it, dragPosition, this.lastPosition, false, adjustment)) {
            return true;
        }
        this.lastPosition = dragPosition;
        return true;
