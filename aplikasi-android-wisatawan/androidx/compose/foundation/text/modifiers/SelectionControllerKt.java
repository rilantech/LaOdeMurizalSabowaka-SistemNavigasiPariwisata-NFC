...
public final class SelectionControllerKt {
    ...
    public static final boolean m1023outOfBoundary2x9bVx0(TextLayoutResult $this$outOfBoundary_u2d2x9bVx0, long start, long end) {
        if ($this$outOfBoundary_u2d2x9bVx0 == null) {
            return false;
        }
        int lastOffset = $this$outOfBoundary_u2d2x9bVx0.getLayoutInput().getText().getText().length();
        int rawStartOffset = $this$outOfBoundary_u2d2x9bVx0.m5297getOffsetForPositionk4lQ0M(start);
        int rawEndOffset = $this$outOfBoundary_u2d2x9bVx0.m5297getOffsetForPositionk4lQ0M(end);
