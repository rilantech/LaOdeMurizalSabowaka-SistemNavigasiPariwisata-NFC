...
public final class SelectionControllerKt$makeSelectionModifier$longPressDragObserver$1 implements TextDragObserver {
    ...
    private long dragTotalDistance = Offset.Companion.m3019getZeroF1C5BW0();
    private long lastPosition = Offset.Companion.m3019getZeroF1C5BW0();
    ...
    public void m1024onDownk4lQ0M(long point) {
    }
    ...
    public void m1026onStartk4lQ0M(long startPoint) {
        ...
        if (it != null) {
            ...
            if (it.isAttached()) {
                if (SelectionControllerKt.m1023outOfBoundary2x9bVx0(function0.invoke(), startPoint, startPoint)) {
                    selectionRegistrar.notifySelectionUpdateSelectAll(j);
                } else {
                    selectionRegistrar.m1119notifySelectionUpdateStartd4ec7I(it, startPoint, SelectionAdjustment.Companion.getWord());
                }
    ...
    public void m1025onDragk4lQ0M(long delta) {
        LayoutCoordinates it = this.$layoutCoordinates.invoke();
        if (it != null) {
            SelectionRegistrar selectionRegistrar = this.$this_makeSelectionModifier;
            long j = this.$selectableId;
            ...
            if (it.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar, j)) {
                long r3 = Offset.m3008plusMKHz9U(this.dragTotalDistance, delta);
                this.dragTotalDistance = r3;
                long newPosition = Offset.m3008plusMKHz9U(this.lastPosition, r3);
                if (!SelectionControllerKt.m1023outOfBoundary2x9bVx0(function0.invoke(), this.lastPosition, newPosition)) {
                    if (selectionRegistrar.m1118notifySelectionUpdate5iVPX68(it, newPosition, this.lastPosition, false, SelectionAdjustment.Companion.getCharacterWithWordAccelerate())) {
