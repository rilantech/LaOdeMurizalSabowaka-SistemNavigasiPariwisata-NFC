...
public final class TextFieldKeyInput {
    ...
    private final CommitTextCommand m960typedCommandZmokQxo(KeyEvent event) {
        Integer r0;
        if (!TextFieldKeyInput_androidKt.m965isTypedEventZmokQxo(event) || (r0 = this.keyCombiner.m898consumeZmokQxo(event)) == null) {
            return null;
        }
    ...
    public final boolean m961processZmokQxo(KeyEvent event) {
        KeyCommand command;
        Intrinsics.checkNotNullParameter(event, NotificationCompat.CATEGORY_EVENT);
        CommitTextCommand it = m960typedCommandZmokQxo(event);
        if (it != null) {
            if (!this.editable) {
                return false;
            }
            ...
            return true;
        } else if (!KeyEventType.m4326equalsimpl0(KeyEvent_androidKt.m4334getTypeZmokQxo(event), KeyEventType.Companion.m4330getKeyDownCS__XNY()) || (command = this.keyMapping.m902mapZmokQxo(event)) == null || (command.getEditsText() && !this.editable)) {
            return false;
        } else {
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (!TextRange.m5318equalsimpl0(preparedSelection.m1039getSelectiond9O1mEE(), this.value.m5555getSelectiond9O1mEE()) || !Intrinsics.areEqual((Object) preparedSelection.getAnnotatedString(), (Object) this.value.getAnnotatedString())) {
