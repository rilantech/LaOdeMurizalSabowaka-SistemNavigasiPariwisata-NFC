...
public final class SelectionHandlesKt {
    private static final float HandleHeight = Dp.m5844constructorimpl((float) 25);
    private static final float HandleWidth = Dp.m5844constructorimpl((float) 25);
    ...
    public static final long m1073getAdjustedCoordinatesk4lQ0M(long position) {
        return OffsetKt.Offset(Offset.m3003getXimpl(position), Offset.m3004getYimpl(position) - 1.0f);
    }
}
