...
public final class SelectionManager {
    ...
    private final MutableState dragBeginPosition$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2992boximpl(Offset.Companion.m3019getZeroF1C5BW0()), (SnapshotMutationPolicy) null, 2, (Object) null);
    private final MutableState dragTotalDistance$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2992boximpl(Offset.Companion.m3019getZeroF1C5BW0()), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrar2) {
        ...
        selectionRegistrar2.setOnSelectionUpdateStartCallback$foundation_release(new Function3<LayoutCoordinates, Offset, SelectionAdjustment, Unit>(this) {
            ...
            public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2, Object p3) {
                m1101invoked4ec7I((LayoutCoordinates) p1, ((Offset) p2).m3013unboximpl(), (SelectionAdjustment) p3);
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-d-4ec7I  reason: not valid java name */
            public final void m1101invoked4ec7I(LayoutCoordinates layoutCoordinates, long position, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                Offset positionInContainer = this.this$0.m1086convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, position);
                if (positionInContainer != null) {
                    this.this$0.m1092startSelection9KIMszo(positionInContainer.m3013unboximpl(), false, selectionMode);
        ...
        selectionRegistrar2.setOnSelectionUpdateCallback$foundation_release(new Function5<LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>(this) {
            ...
            public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2, Object p3, Object p4, Object p5) {
                return m1102invoke5iVPX68((LayoutCoordinates) p1, ((Offset) p2).m3013unboximpl(), ((Offset) p3).m3013unboximpl(), ((Boolean) p4).booleanValue(), (SelectionAdjustment) p5);
            }

            /* renamed from: invoke-5iVPX68  reason: not valid java name */
            public final Boolean m1102invoke5iVPX68(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                return Boolean.valueOf(this.this$0.m1100updateSelectionRHHTvR4$foundation_release(this.this$0.m1086convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, newPosition), this.this$0.m1086convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, previousPosition), isStartHandle, selectionMode));
            }
        });
        ...
        selectionRegistrar2.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>(this) {
            ...
            public final void invoke(long r6) {
                ...
                L_0x0038:
                    androidx.compose.foundation.text.selection.SelectionManager r0 = r5.this$0
                    r1 = 0
                    r0.m1091setStartHandlePosition_kEHs6E(r1)
                    androidx.compose.foundation.text.selection.SelectionManager r0 = r5.this$0
                    r0.m1090setEndHandlePosition_kEHs6E(r1)
                L_0x0043:
                    return
                */
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates value) {
        ...
        if (getHasFocus() && getSelection() != null) {
            Offset positionInWindow = value != null ? Offset.m2992boximpl(LayoutCoordinatesKt.positionInWindow(value)) : null;
    ...
    public final void m1088setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition$delegate.setValue(Offset.m2992boximpl(j));
    }

    /* renamed from: getDragBeginPosition-F1C5BW0$foundation_release  reason: not valid java name */
    public final long m1095getDragBeginPositionF1C5BW0$foundation_release() {
        return ((Offset) this.dragBeginPosition$delegate.getValue()).m3013unboximpl();
    }

    /* access modifiers changed from: private */
    /* renamed from: setDragTotalDistance-k-4lQ0M  reason: not valid java name */
    public final void m1089setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance$delegate.setValue(Offset.m2992boximpl(j));
    }

    /* renamed from: getDragTotalDistance-F1C5BW0$foundation_release  reason: not valid java name */
    public final long m1096getDragTotalDistanceF1C5BW0$foundation_release() {
        return ((Offset) this.dragTotalDistance$delegate.getValue()).m3013unboximpl();
    }

    /* access modifiers changed from: private */
    /* renamed from: setStartHandlePosition-_kEHs6E  reason: not valid java name */
    public final void m1091setStartHandlePosition_kEHs6E(Offset offset) {
        this.startHandlePosition$delegate.setValue(offset);
    }

    /* renamed from: getStartHandlePosition-_m7T9-E  reason: not valid java name */
    public final Offset m1098getStartHandlePosition_m7T9E() {
        return (Offset) this.startHandlePosition$delegate.getValue();
    }

    /* access modifiers changed from: private */
    /* renamed from: setEndHandlePosition-_kEHs6E  reason: not valid java name */
    public final void m1090setEndHandlePosition_kEHs6E(Offset offset) {
        this.endHandlePosition$delegate.setValue(offset);
    }

    /* renamed from: getEndHandlePosition-_m7T9-E  reason: not valid java name */
    public final Offset m1097getEndHandlePosition_m7T9E() {
    ...
    public final void m1087setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition$delegate.setValue(offset);
    }

    /* renamed from: getCurrentDragPosition-_m7T9-E  reason: not valid java name */
    public final Offset m1094getCurrentDragPosition_m7T9E() {
    ...
    public final void updateHandleOffsets() {
        ...
        L_0x0049:
            r8 = 1
            long r9 = r4.m1055getHandlePositiondBAh8RU(r1, r8)
            long r9 = r2.m4651localPositionOfR5De75A(r6, r9)
            r11 = 0
            long r12 = r5.m1055getHandlePositiondBAh8RU(r1, r11)
            long r12 = r2.m4651localPositionOfR5De75A(r7, r12)
            androidx.compose.ui.geometry.Rect r14 = androidx.compose.foundation.text.selection.SelectionManagerKt.visibleBounds(r2)
            androidx.compose.ui.geometry.Offset r15 = androidx.compose.ui.geometry.Offset.m2992boximpl(r9)
            long r16 = r15.m3013unboximpl()
            r18 = 0
            boolean r19 = androidx.compose.foundation.text.selection.SelectionManagerKt.m1109containsInclusiveUv8p0NA(r14, r9)
        ...
        L_0x0089:
            r15 = 0
        L_0x008a:
            r0.m1091setStartHandlePosition_kEHs6E(r15)
            androidx.compose.ui.geometry.Offset r8 = androidx.compose.ui.geometry.Offset.m2992boximpl(r12)
            long r15 = r8.m3013unboximpl()
            r11 = 0
            boolean r17 = androidx.compose.foundation.text.selection.SelectionManagerKt.m1109containsInclusiveUv8p0NA(r14, r12)
        ...
        L_0x00b3:
            r3 = 0
        L_0x00b4:
            r0.m1090setEndHandlePosition_kEHs6E(r3)
            return
        L_0x00b8:
            r18 = r1
            goto L_0x00c3
            ...
            if (startLayoutCoordinates == null) {
                ...
                if (endSelectable != null) {
                    ...
                    if (endLayoutCoordinates == null) {
                        ...
                        long startOffset = localLayoutCoordinates.m4651localPositionOfR5De75A(startLayoutCoordinates, startSelectable.m1055getHandlePositiondBAh8RU(selection, true));
                        long endOffset = localLayoutCoordinates.m4651localPositionOfR5De75A(endLayoutCoordinates, endSelectable.m1055getHandlePositiondBAh8RU(selection, false));
                        long startOffset2 = localLayoutCoordinates.m4652localToRootMKHz9U(startOffset);
                        long endOffset2 = localLayoutCoordinates.m4652localToRootMKHz9U(endOffset);
                        float left = Math.min(Offset.m3003getXimpl(startOffset2), Offset.m3003getXimpl(endOffset2));
                        float right = Math.max(Offset.m3003getXimpl(startOffset2), Offset.m3003getXimpl(endOffset2));
                        float left2 = left;
                        long startTop = localLayoutCoordinates.m4651localPositionOfR5De75A(startLayoutCoordinates, OffsetKt.Offset(0.0f, startSelectable.getBoundingBox(selection.getStart().getOffset()).getTop()));
                        long endTop = localLayoutCoordinates.m4651localPositionOfR5De75A(endLayoutCoordinates, OffsetKt.Offset(0.0f, endSelectable.getBoundingBox(selection.getEnd().getOffset()).getTop()));
                        Selection selection4 = selection;
                        Selectable selectable7 = startSelectable;
                        Selectable selectable8 = endSelectable;
                        return new Rect(left2, Math.min(Offset.m3004getYimpl(localLayoutCoordinates.m4652localToRootMKHz9U(startTop)), Offset.m3004getYimpl(localLayoutCoordinates.m4652localToRootMKHz9U(endTop))), right, Math.max(Offset.m3004getYimpl(startOffset2), Offset.m3004getYimpl(endOffset2)) + ((float) (((double) SelectionHandlesKt.getHandleHeight()) * 4.0d)));
                    }
                } else {
    ...
    public final Offset m1086convertToContainerCoordinatesQ7Q5hAU(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates coordinates = this.containerLayoutCoordinates;
        if (coordinates == null || !coordinates.isAttached()) {
            return null;
        }
        return Offset.m2992boximpl(requireContainerCoordinates$foundation_release().m4651localPositionOfR5De75A(layoutCoordinates, offset));
    }

    /* access modifiers changed from: private */
    /* renamed from: startSelection-9KIMszo  reason: not valid java name */
    public final void m1092startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        m1099updateSelection3R_tFg$foundation_release(position, position, (Offset) null, isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-RHHTvR4$foundation_release  reason: not valid java name */
    public final boolean m1100updateSelectionRHHTvR4$foundation_release(Offset newPosition, Offset previousPosition2, boolean isStartHandle, SelectionAdjustment adjustment) {
        Selection selection;
        ...
        if (!(newPosition == null || (selection = getSelection()) == null)) {
            ...
            if (otherSelectable == null) {
                ...
                offset = m1086convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, SelectionHandlesKt.m1073getAdjustedCoordinatesk4lQ0M(otherSelectable.m1055getHandlePositiondBAh8RU(selection, !isStartHandle)));
            }
            if (offset != null) {
                long otherHandlePosition = offset.m3013unboximpl();
                return m1099updateSelection3R_tFg$foundation_release(isStartHandle ? newPosition.m3013unboximpl() : otherHandlePosition, isStartHandle ? otherHandlePosition : newPosition.m3013unboximpl(), previousPosition2, isStartHandle, adjustment);
            }
        }
        return false;
    }
    ...
    public final boolean m1099updateSelection3R_tFg$foundation_release(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m1087setCurrentDragPosition_kEHs6E(isStartHandle ? Offset.m2992boximpl(startHandlePosition) : Offset.m2992boximpl(endHandlePosition));
        ...
        while (index$iv$iv < size) {
            ...
            Pair<Selection, Boolean> r1 = selectable.m1057updateSelectionqCDeeow(startHandlePosition, endHandlePosition, previousHandlePosition, isStartHandle, requireContainerCoordinates$foundation_release(), adjustment, this.selectionRegistrar.getSubselections().get(Long.valueOf(selectable.getSelectableId())));
    ...
    public final void m1093contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        if (selection != null ? TextRange.m5319getCollapsedimpl(selection.m1058toTextRanged9O1mEE()) : true) {
            m1092startSelection9KIMszo(position, true, SelectionAdjustment.Companion.getWord());
        }
    }
}
