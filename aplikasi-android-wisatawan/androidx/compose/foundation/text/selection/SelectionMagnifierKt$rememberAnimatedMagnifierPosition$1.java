            ...
            case 0:
                ...
                Flow snapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() {
                    public /* bridge */ /* synthetic */ Object invoke() {
                        return Offset.m2992boximpl(m1077invokeF1C5BW0());
                    }
                ...
                if (snapshotFlow.collect(new FlowCollector<Offset>() {
                    public /* bridge */ /* synthetic */ Object emit(Object value, Continuation $completion) {
                        return m1078emit3MmeM6k(((Offset) value).m3013unboximpl(), $completion);
                    }

                    /* renamed from: emit-3MmeM6k  reason: not valid java name */
                    public final Object m1078emit3MmeM6k(long targetValue, Continuation<? super Unit> $completion) {
                        if (OffsetKt.m3022isSpecifiedk4lQ0M(animatable.getValue().m3013unboximpl()) && OffsetKt.m3022isSpecifiedk4lQ0M(targetValue)) {
                            if (!(Offset.m3004getYimpl(animatable.getValue().m3013unboximpl()) == Offset.m3004getYimpl(targetValue))) {
                        ...
                        Object snapTo = animatable.snapTo(Offset.m2992boximpl(targetValue), $completion);
