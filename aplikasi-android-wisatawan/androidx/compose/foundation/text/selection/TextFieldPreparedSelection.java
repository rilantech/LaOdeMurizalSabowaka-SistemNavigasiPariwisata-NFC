...
public final class TextFieldPreparedSelection extends BaseTextPreparedSelection<TextFieldPreparedSelection> {
    ...
    public TextFieldPreparedSelection(TextFieldValue currentValue2, OffsetMapping offsetMapping, TextLayoutResultProxy layoutResultProxy2, TextPreparedSelectionState state) {
        super(currentValue2.getAnnotatedString(), currentValue2.m5555getSelectiond9O1mEE(), layoutResultProxy2 != null ? layoutResultProxy2.getValue() : null, offsetMapping, state, (DefaultConstructorMarker) null);
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m5550copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), m1039getSelectiond9O1mEE(), (TextRange) null, 4, (Object) null);
    }
    ...
    public final List<EditCommand> deleteIfSelectedOr(Function1<? super TextFieldPreparedSelection, ? extends EditCommand> or) {
        ...
        if (TextRange.m5319getCollapsedimpl(m1039getSelectiond9O1mEE())) {
        ...
        return CollectionsKt.listOf(new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m5323getMinimpl(m1039getSelectiond9O1mEE()), TextRange.m5323getMinimpl(m1039getSelectiond9O1mEE())));
    }
    ...
    private final int jumpByPagesOffset(androidx.compose.foundation.text.TextLayoutResultProxy r10, int r11) {
        ...
        L_0x001c:
            ...
            long r2 = r2.m5555getSelectiond9O1mEE()
            ...
            int r6 = r6.m5297getOffsetForPositionk4lQ0M(r7)
