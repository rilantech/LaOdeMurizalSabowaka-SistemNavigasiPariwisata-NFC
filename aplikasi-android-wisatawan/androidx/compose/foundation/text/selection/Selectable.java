...
public interface Selectable {
    ...
    long m1055getHandlePositiondBAh8RU(Selection selection, boolean z);
    ...
    long m1056getRangeOfLineContainingjx7JFs(int i);
    ...
    Pair<Selection, Boolean> m1057updateSelectionqCDeeow(long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection);

    /* renamed from: updateSelection-qCDeeow$default  reason: not valid java name */
    static /* synthetic */ Pair m1054updateSelectionqCDeeow$default(Selectable selectable, long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection, int i, Object obj) {
        boolean z2;
        if (obj == null) {
            if ((i & 8) != 0) {
                z2 = true;
            ...
            return selectable.m1057updateSelectionqCDeeow(j, j2, offset, z2, layoutCoordinates, selectionAdjustment, (i & 64) != 0 ? null : selection);
        }
