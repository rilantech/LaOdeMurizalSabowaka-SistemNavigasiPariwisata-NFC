...
public final class TextFieldSelectionManager$mouseSelectionObserver$1 implements MouseSelectionObserver {
    ...
    public boolean m1141onExtendk4lQ0M(long downPosition) {
        ...
        int startOffset = textFieldSelectionManager.getOffsetMapping$foundation_release().originalToTransformed(TextRange.m5325getStartimpl(textFieldSelectionManager.getValue$foundation_release().m5555getSelectiond9O1mEE()));
        int clickOffset = TextLayoutResultProxy.m980getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, (Object) null);
    ...
    public boolean m1142onExtendDragk4lQ0M(long dragPosition) {
        ...
        TextFieldSelectionManager textFieldSelectionManager = this.this$0;
        textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), textFieldSelectionManager.getOffsetMapping$foundation_release().originalToTransformed(TextRange.m5325getStartimpl(textFieldSelectionManager.getValue$foundation_release().m5555getSelectiond9O1mEE())), layoutResult.m982getOffsetForPosition3MmeM6k(dragPosition, false), false, SelectionAdjustment.Companion.getNone());
        return true;
    }

    /* renamed from: onStart-3MmeM6k  reason: not valid java name */
    public boolean m1143onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
        TextLayoutResultProxy layoutResult;
        ...
        TextFieldSelectionManager textFieldSelectionManager = this.this$0;
        textFieldSelectionManager.dragBeginOffsetInText = Integer.valueOf(TextLayoutResultProxy.m980getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, (Object) null));
        int clickOffset = TextLayoutResultProxy.m980getOffsetForPosition3MmeM6k$default(layoutResult, textFieldSelectionManager.dragBeginPosition, false, 2, (Object) null);
    ...
    public boolean m1140onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
        TextFieldState state$foundation_release;
        TextLayoutResultProxy layoutResult;
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        if ((this.this$0.getValue$foundation_release().getText().length() == 0) || (state$foundation_release = this.this$0.getState$foundation_release()) == null || (layoutResult = state$foundation_release.getLayoutResult()) == null) {
        ...
        TextFieldSelectionManager textFieldSelectionManager = this.this$0;
        int dragOffset = layoutResult.m982getOffsetForPosition3MmeM6k(dragPosition, false);
