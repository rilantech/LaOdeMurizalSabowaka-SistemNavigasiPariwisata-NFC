...
public final class TextFieldSelectionManager$touchSelectionObserver$1 implements TextDragObserver {
    ...
    public void m1144onDownk4lQ0M(long point) {
    }
    ...
    public void m1146onStartk4lQ0M(long r11) {
        /*
            r10 = this;
        ...
        L_0x0009:
            ...
            if (r0 == 0) goto L_0x002d
            boolean r0 = r0.m983isPositionOnTextk4lQ0M(r11)
        ...
        L_0x002e:
            ...
            float r5 = androidx.compose.ui.geometry.Offset.m3004getYimpl(r11)
            ...
            int r5 = r5.m4002getTextHandleMove5zf0vsI()
            r4.m3993performHapticFeedbackCdsT49E(r5)
        L_0x0067:
            ...
            androidx.compose.ui.text.input.TextFieldValue r4 = r1.m1126createTextFieldValueFDrldGo(r4, r5)
        ...
        L_0x009a:
            ...
            r4 = 0
            r2 = r11
            int r9 = androidx.compose.foundation.text.TextLayoutResultProxy.m980getOffsetForPosition3MmeM6k$default(r1, r2, r4, r5, r6)
        ...
        L_0x00d5:
            ...
            r0.m1128setCurrentDragPosition_kEHs6E(r1)
            androidx.compose.foundation.text.selection.TextFieldSelectionManager r0 = r10.this$0
            androidx.compose.ui.geometry.Offset$Companion r1 = androidx.compose.ui.geometry.Offset.Companion
            long r1 = r1.m3019getZeroF1C5BW0()
            r0.dragTotalDistance = r1
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1.m1146onStartk4lQ0M(long):void");
    }

    /* renamed from: onDrag-k-4lQ0M  reason: not valid java name */
    public void m1145onDragk4lQ0M(long delta) {
        ...
        if (!(this.this$0.getValue$foundation_release().getText().length() == 0)) {
            ...
            if (!(state$foundation_release == null || (layoutResult = state$foundation_release.getLayoutResult()) == null)) {
                ...
                int startOffset = access$getDragBeginOffsetInText$p != null ? access$getDragBeginOffsetInText$p.intValue() : layoutResult.m982getOffsetForPosition3MmeM6k(textFieldSelectionManager2.dragBeginPosition, false);
                Offset r3 = textFieldSelectionManager2.m1131getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(r3);
                textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), startOffset, layoutResult.m982getOffsetForPosition3MmeM6k(r3.m3013unboximpl(), false), false, SelectionAdjustment.Companion.getWord());
            }
