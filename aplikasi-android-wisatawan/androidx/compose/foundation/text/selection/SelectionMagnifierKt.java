...
public final class SelectionMagnifierKt {
    ...
    static {
        ...
        MagnifierSpringSpec = new SpringSpec(0.0f, 0.0f, Offset.m2992boximpl(Offset), 3, (DefaultConstructorMarker) null);
    }
    ...
    public static final State<Offset> rememberAnimatedMagnifierPosition(Function0<Offset> targetCalculation, Composer $composer, int $changed) {
        ...
        if (it$iv$iv2 == Composer.Companion.getEmpty()) {
            value$iv$iv = new Animatable(Offset.m2992boximpl(rememberAnimatedMagnifierPosition$lambda$1(targetValue$delegate)), UnspecifiedSafeOffsetVectorConverter, Offset.m2992boximpl(OffsetDisplacementThreshold), (String) null, 8, (DefaultConstructorMarker) null);
    ...
    public static final long rememberAnimatedMagnifierPosition$lambda$1(State<Offset> $targetValue$delegate) {
        return ((Offset) $targetValue$delegate.getValue()).m3013unboximpl();
    }
}
