...
final class SelectionManager$modifier$4 extends Lambda implements Function1<KeyEvent, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return m1106invokeZmokQxo(((KeyEvent) p1).m4322unboximpl());
    }

    /* renamed from: invoke-ZmokQxo  reason: not valid java name */
    public final Boolean m1106invokeZmokQxo(android.view.KeyEvent it) {
        boolean z;
        Intrinsics.checkNotNullParameter(it, "it");
        if (SelectionManager_androidKt.m1110isCopyKeyEventZmokQxo(it)) {
