...
final class AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1 extends Lambda implements Function1<CacheDrawScope, DrawResult> {
    ...
    public final DrawResult invoke(CacheDrawScope $this$drawWithCache) {
        ...
        ImageBitmap handleImage = AndroidSelectionHandles_androidKt.createHandleImage($this$drawWithCache, Size.m3072getWidthimpl($this$drawWithCache.m2904getSizeNHjbRc()) / 2.0f);
        ColorFilter colorFilter = ColorFilter.Companion.m3294tintxETnrds$default(ColorFilter.Companion, this.$handleColor, 0, 2, (Object) null);
        ...
        return $this$drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() {
            ...
            public final void invoke(ContentDrawScope $this$onDrawWithContent) {
                ...
                if (AndroidSelectionHandles_androidKt.isLeft(z, resolvedTextDirection, z2)) {
                    ...
                    long j = pivot$iv;
                    DrawScope.m3832drawImagegbVJVH8$default($this$withTransform$iv$iv, imageBitmap, 0, 0.0f, (DrawStyle) null, colorFilter, 0, 46, (Object) null);
                ...
                DrawScope.m3832drawImagegbVJVH8$default(contentDrawScope, imageBitmap, 0, 0.0f, (DrawStyle) null, colorFilter2, 0, 46, (Object) null);
            }
        });
    }
}
