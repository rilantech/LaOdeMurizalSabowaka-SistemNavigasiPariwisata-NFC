...
public final class TextFieldSelectionDelegateKt {
    ...
    public static final long m1123getTextFieldSelectionbb3KNj8(TextLayoutResult textLayoutResult, int rawStartOffset, int rawEndOffset, TextRange previousSelection, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        if (previousSelection != null || !Intrinsics.areEqual((Object) selectionAdjustment, (Object) SelectionAdjustment.Companion.getCharacter())) {
            return adjustment.m1059adjustZXO7KMw(textLayoutResult, textRange, -1, isStartHandle, previousSelection);
        }
        return textRange;
    }
}
