...
public final class ClipScrollableContainerKt$VerticalScrollableClipModifier$1 implements Shape {
    ...
    public Outline m217createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        return new Outline.Rectangle(new Rect(-inflateSize, 0.0f, Size.m3072getWidthimpl(size) + inflateSize, Size.m3069getHeightimpl(size)));
    }
}
