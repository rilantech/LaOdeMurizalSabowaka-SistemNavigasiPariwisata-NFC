    ...
    private static final class DefaultDebugIndicationInstance implements IndicationInstance {
        ...
        public void drawIndication(ContentDrawScope $this$drawIndication) {
            ...
            if (this.isPressed.getValue().booleanValue()) {
                DrawScope.m3842drawRectnJ9OG0$default($this$drawIndication, Color.m3252copywmQWz5c$default(Color.Companion.m3279getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, (Object) null), 0, $this$drawIndication.m3866getSizeNHjbRc(), 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 122, (Object) null);
            } else if (this.isHovered.getValue().booleanValue() || this.isFocused.getValue().booleanValue()) {
                DrawScope.m3842drawRectnJ9OG0$default($this$drawIndication, Color.m3252copywmQWz5c$default(Color.Companion.m3279getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, (Object) null), 0, $this$drawIndication.m3866getSizeNHjbRc(), 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 122, (Object) null);
            }
        }
    }
