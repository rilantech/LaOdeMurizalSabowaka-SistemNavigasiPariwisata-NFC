...
public final class NoOpOverscrollEffect implements OverscrollEffect {
    ...
    public long m252applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
        Intrinsics.checkNotNullParameter(performScroll, "performScroll");
        return performScroll.invoke(Offset.m2992boximpl(delta)).m3013unboximpl();
    }

    /* renamed from: applyToFling-BMRW4eQ  reason: not valid java name */
    public Object m251applyToFlingBMRW4eQ(long velocity, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> performFling, Continuation<? super Unit> $completion) {
        Object invoke = performFling.invoke(Velocity.m6060boximpl(velocity), $completion);
