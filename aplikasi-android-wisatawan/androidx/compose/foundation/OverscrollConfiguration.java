...
public final class OverscrollConfiguration {
    ...
    private OverscrollConfiguration(long glowColor2, PaddingValues drawPadding2) {
        Intrinsics.checkNotNullParameter(drawPadding2, "drawPadding");
        this.glowColor = glowColor2;
        this.drawPadding = drawPadding2;
    }
    ...
    public /* synthetic */ OverscrollConfiguration(long j, PaddingValues paddingValues, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4284900966L) : j, (i & 2) != 0 ? PaddingKt.m533PaddingValuesYgX7TsA$default(0.0f, 0.0f, 3, (Object) null) : paddingValues, (DefaultConstructorMarker) null);
    }

    /* renamed from: getGlowColor-0d7_KjU  reason: not valid java name */
    public final long m253getGlowColor0d7_KjU() {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m3254equalsimpl0(this.glowColor, ((OverscrollConfiguration) other).glowColor) && Intrinsics.areEqual((Object) this.drawPadding, (Object) ((OverscrollConfiguration) other).drawPadding)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (Color.m3260hashCodeimpl(this.glowColor) * 31) + this.drawPadding.hashCode();
    }

    public String toString() {
        return "OverscrollConfiguration(glowColor=" + Color.m3261toStringimpl(this.glowColor) + ", drawPadding=" + this.drawPadding + ')';
    }
}
