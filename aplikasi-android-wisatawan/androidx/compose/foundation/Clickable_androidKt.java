...
public final class Clickable_androidKt {
    ...
    public static final boolean m215isPressZmokQxo(KeyEvent $this$isPress) {
        Intrinsics.checkNotNullParameter($this$isPress, "$this$isPress");
        return KeyEventType.m4326equalsimpl0(KeyEvent_androidKt.m4334getTypeZmokQxo($this$isPress), KeyEventType.Companion.m4330getKeyDownCS__XNY()) && m214isEnterZmokQxo($this$isPress);
    }

    /* renamed from: isClick-ZmokQxo  reason: not valid java name */
    public static final boolean m213isClickZmokQxo(KeyEvent $this$isClick) {
        Intrinsics.checkNotNullParameter($this$isClick, "$this$isClick");
        return KeyEventType.m4326equalsimpl0(KeyEvent_androidKt.m4334getTypeZmokQxo($this$isClick), KeyEventType.Companion.m4331getKeyUpCS__XNY()) && m214isEnterZmokQxo($this$isClick);
    }

    /* renamed from: isEnter-ZmokQxo  reason: not valid java name */
    private static final boolean m214isEnterZmokQxo(KeyEvent $this$isEnter) {
        switch (Key_androidKt.m4344getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m4333getKeyZmokQxo($this$isEnter))) {
            case 23:
            case 66:
            case 160:
                return true;
