...
public final class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public static /* synthetic */ BorderModifierNodeElement m187copy8Feqmps$default(BorderModifierNodeElement borderModifierNodeElement, float f, Brush brush2, Shape shape2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderModifierNodeElement.m189copy8Feqmps(f, brush2, shape2);
    }

    /* renamed from: component1-D9Ej5fM  reason: not valid java name */
    public final float m188component1D9Ej5fM() {
        return this.width;
    }
    ...
    public final BorderModifierNodeElement m189copy8Feqmps(float f, Brush brush2, Shape shape2) {
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m5849equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual((Object) this.brush, (Object) borderModifierNodeElement.brush) && Intrinsics.areEqual((Object) this.shape, (Object) borderModifierNodeElement.shape);
    }
    ...
    public String toString() {
        return "BorderModifierNodeElement(width=" + Dp.m5855toStringimpl(this.width) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }
    ...
    public void update(BorderModifierNode node) {
        ...
        node.m186setWidth0680j_4(this.width);
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("width", Dp.m5842boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            $this$inspectableProperties.getProperties().set(TypedValues.Custom.S_COLOR, Color.m3243boximpl(((SolidColor) this.brush).m3623getValue0d7_KjU()));
            $this$inspectableProperties.setValue(Color.m3243boximpl(((SolidColor) this.brush).m3623getValue0d7_KjU()));
        } else {
