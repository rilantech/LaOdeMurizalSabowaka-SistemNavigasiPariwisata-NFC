...
final class ScrollingLayoutElement extends ModifierNodeElement<ScrollingLayoutNode> {
    ...
    public ScrollingLayoutElement(ScrollState scrollState2, boolean isReversed2, boolean isVertical2) {
    ...
    public boolean equals(Object other) {
        if ((other instanceof ScrollingLayoutElement) && Intrinsics.areEqual((Object) this.scrollState, (Object) ((ScrollingLayoutElement) other).scrollState) && this.isReversed == ((ScrollingLayoutElement) other).isReversed && this.isVertical == ((ScrollingLayoutElement) other).isVertical) {
            return true;
        }
        return false;
    }
