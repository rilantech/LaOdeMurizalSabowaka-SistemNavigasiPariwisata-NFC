...
public final class ValueInsets implements WindowInsets {
    ...
    public ValueInsets(InsetsValues insets, String name2) {
        Intrinsics.checkNotNullParameter(insets, "insets");
        Intrinsics.checkNotNullParameter(name2, HintConstants.AUTOFILL_HINT_NAME);
        this.name = name2;
        this.value$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(insets, (SnapshotMutationPolicy) null, 2, (Object) null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual((Object) getValue$foundation_layout_release(), (Object) ((ValueInsets) other).getValue$foundation_layout_release());
    }
