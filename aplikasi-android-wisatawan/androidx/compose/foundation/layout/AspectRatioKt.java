...
public final class AspectRatioKt {
    ...
    public static final Modifier aspectRatio(Modifier $this$aspectRatio, float ratio, boolean matchHeightConstraintsFirst) {
        ...
        return $this$aspectRatio.then(new AspectRatioElement(ratio, matchHeightConstraintsFirst, InspectableValueKt.isDebugInspectorInfoEnabled() ? new AspectRatioKt$aspectRatio$$inlined$debugInspectorInfo$1(ratio, matchHeightConstraintsFirst) : InspectableValueKt.getNoInspectorInfo()));
    }
}
