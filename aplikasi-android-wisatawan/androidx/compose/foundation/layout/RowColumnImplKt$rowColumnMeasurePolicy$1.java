...
public final class RowColumnImplKt$rowColumnMeasurePolicy$1 implements MeasurePolicy {
    ...
    public MeasureResult m582measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> measurables, long constraints) {
        int layoutHeight;
        int layoutWidth;
        ...
        RowColumnMeasureHelperResult measureResult = rowColumnMeasureHelper.m584measureWithoutPlacing_EkL_Y($this$measure_u2d3p2s80s, constraints, 0, measurables.size());
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
        ...
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        return ((Number) RowColumnImplKt.MinIntrinsicWidthMeasureBlock(this.$orientation).invoke(measurables, Integer.valueOf(height), Integer.valueOf($this$minIntrinsicWidth.m5819roundToPx0680j_4(this.$arrangementSpacing)))).intValue();
    }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
        ...
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        return ((Number) RowColumnImplKt.MinIntrinsicHeightMeasureBlock(this.$orientation).invoke(measurables, Integer.valueOf(width), Integer.valueOf($this$minIntrinsicHeight.m5819roundToPx0680j_4(this.$arrangementSpacing)))).intValue();
    }
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
        ...
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        return ((Number) RowColumnImplKt.MaxIntrinsicWidthMeasureBlock(this.$orientation).invoke(measurables, Integer.valueOf(height), Integer.valueOf($this$maxIntrinsicWidth.m5819roundToPx0680j_4(this.$arrangementSpacing)))).intValue();
    }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
        ...
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        return ((Number) RowColumnImplKt.MaxIntrinsicHeightMeasureBlock(this.$orientation).invoke(measurables, Integer.valueOf(width), Integer.valueOf($this$maxIntrinsicHeight.m5819roundToPx0680j_4(this.$arrangementSpacing)))).intValue();
    }
}
