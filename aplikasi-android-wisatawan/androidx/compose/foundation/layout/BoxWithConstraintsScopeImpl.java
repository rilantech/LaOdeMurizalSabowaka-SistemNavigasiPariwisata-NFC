...
final class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m464copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density2, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m466copy0kLqBqw(density2, j);
    }
    ...
    public final long m465component2msEJaDk() {
        return this.constraints;
    }

    /* renamed from: copy-0kLqBqw  reason: not valid java name */
    public final BoxWithConstraintsScopeImpl m466copy0kLqBqw(Density density2, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.density, (Object) boxWithConstraintsScopeImpl.density) && Constraints.m5781equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m5791hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + Constraints.m5793toStringimpl(this.constraints) + ')';
    }
    ...
    public long m467getConstraintsmsEJaDk() {
        return this.constraints;
    }

    /* renamed from: getMinWidth-D9Ej5fM  reason: not valid java name */
    public float m471getMinWidthD9Ej5fM() {
        return this.density.m5822toDpu2uoSUM(Constraints.m5790getMinWidthimpl(m467getConstraintsmsEJaDk()));
    }

    /* renamed from: getMaxWidth-D9Ej5fM  reason: not valid java name */
    public float m469getMaxWidthD9Ej5fM() {
        return Constraints.m5784getHasBoundedWidthimpl(m467getConstraintsmsEJaDk()) ? this.density.m5822toDpu2uoSUM(Constraints.m5788getMaxWidthimpl(m467getConstraintsmsEJaDk())) : Dp.Companion.m5863getInfinityD9Ej5fM();
    }

    /* renamed from: getMinHeight-D9Ej5fM  reason: not valid java name */
    public float m470getMinHeightD9Ej5fM() {
        return this.density.m5822toDpu2uoSUM(Constraints.m5789getMinHeightimpl(m467getConstraintsmsEJaDk()));
    }

    /* renamed from: getMaxHeight-D9Ej5fM  reason: not valid java name */
    public float m468getMaxHeightD9Ej5fM() {
        return Constraints.m5783getHasBoundedHeightimpl(m467getConstraintsmsEJaDk()) ? this.density.m5822toDpu2uoSUM(Constraints.m5787getMaxHeightimpl(m467getConstraintsmsEJaDk())) : Dp.Companion.m5863getInfinityD9Ej5fM();
    }
}
