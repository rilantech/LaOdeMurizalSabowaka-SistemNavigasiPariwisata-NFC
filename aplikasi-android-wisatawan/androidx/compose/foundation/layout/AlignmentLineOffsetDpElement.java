...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    public final float m399getBeforeD9Ej5fM() {
        return this.before;
    }

    /* renamed from: getAfter-D9Ej5fM  reason: not valid java name */
    public final float m398getAfterD9Ej5fM() {
        return this.after;
    }
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine2, float before2, float after2, Function1<? super InspectorInfo, Unit> inspectorInfo2) {
        ...
        if (!((before2 >= 0.0f || Dp.m5849equalsimpl0(before2, Dp.Companion.m5864getUnspecifiedD9Ej5fM())) && (after2 >= 0.0f || Dp.m5849equalsimpl0(after2, Dp.Companion.m5864getUnspecifiedD9Ej5fM())))) {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m404setBefore0680j_4(this.before);
        node.m403setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!Intrinsics.areEqual((Object) this.alignmentLine, (Object) otherModifier.alignmentLine) || !Dp.m5849equalsimpl0(this.before, otherModifier.before) || !Dp.m5849equalsimpl0(this.after, otherModifier.after)) {
            return false;
        }
        return true;
    }
