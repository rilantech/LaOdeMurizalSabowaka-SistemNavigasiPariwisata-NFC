...
public final class SizeKt {
    ...
    public static final Modifier m617width3ABfNKs(Modifier $this$width_u2d3ABfNKs, float width) {
    ...
    public static final Modifier m598height3ABfNKs(Modifier $this$height_u2d3ABfNKs, float height) {
    ...
    public static final Modifier m612size3ABfNKs(Modifier $this$size_u2d3ABfNKs, float size) {
    ...
    public static final Modifier m614sizeVpY3zN4(Modifier $this$size_u2dVpY3zN4, float width, float height) {
    ...
    public static final Modifier m613size6HolHcs(Modifier $this$size_u2d6HolHcs, long size) {
        Intrinsics.checkNotNullParameter($this$size_u2d6HolHcs, "$this$size");
        return m614sizeVpY3zN4($this$size_u2d6HolHcs, DpSize.m5942getWidthD9Ej5fM(size), DpSize.m5940getHeightD9Ej5fM(size));
    }

    /* renamed from: widthIn-VpY3zN4$default  reason: not valid java name */
    public static /* synthetic */ Modifier m619widthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m618widthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: widthIn-VpY3zN4  reason: not valid java name */
    public static final Modifier m618widthInVpY3zN4(Modifier $this$widthIn_u2dVpY3zN4, float min, float max) {
    ...
    public static /* synthetic */ Modifier m600heightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m599heightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: heightIn-VpY3zN4  reason: not valid java name */
    public static final Modifier m599heightInVpY3zN4(Modifier $this$heightIn_u2dVpY3zN4, float min, float max) {
    ...
    public static /* synthetic */ Modifier m616sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.Companion.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.Companion.m5864getUnspecifiedD9Ej5fM();
        }
        return m615sizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: sizeIn-qDBjuR0  reason: not valid java name */
    public static final Modifier m615sizeInqDBjuR0(Modifier $this$sizeIn_u2dqDBjuR0, float minWidth, float minHeight, float maxWidth, float maxHeight) {
    ...
    public static final Modifier m609requiredWidth3ABfNKs(Modifier $this$requiredWidth_u2d3ABfNKs, float width) {
    ...
    public static final Modifier m601requiredHeight3ABfNKs(Modifier $this$requiredHeight_u2d3ABfNKs, float height) {
    ...
    public static final Modifier m604requiredSize3ABfNKs(Modifier $this$requiredSize_u2d3ABfNKs, float size) {
    ...
    public static final Modifier m606requiredSizeVpY3zN4(Modifier $this$requiredSize_u2dVpY3zN4, float width, float height) {
    ...
    public static final Modifier m605requiredSize6HolHcs(Modifier $this$requiredSize_u2d6HolHcs, long size) {
        Intrinsics.checkNotNullParameter($this$requiredSize_u2d6HolHcs, "$this$requiredSize");
        return m606requiredSizeVpY3zN4($this$requiredSize_u2d6HolHcs, DpSize.m5942getWidthD9Ej5fM(size), DpSize.m5940getHeightD9Ej5fM(size));
    }

    /* renamed from: requiredWidthIn-VpY3zN4$default  reason: not valid java name */
    public static /* synthetic */ Modifier m611requiredWidthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m610requiredWidthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredWidthIn-VpY3zN4  reason: not valid java name */
    public static final Modifier m610requiredWidthInVpY3zN4(Modifier $this$requiredWidthIn_u2dVpY3zN4, float min, float max) {
    ...
    public static /* synthetic */ Modifier m603requiredHeightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m602requiredHeightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredHeightIn-VpY3zN4  reason: not valid java name */
    public static final Modifier m602requiredHeightInVpY3zN4(Modifier $this$requiredHeightIn_u2dVpY3zN4, float min, float max) {
    ...
    public static /* synthetic */ Modifier m608requiredSizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m607requiredSizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: requiredSizeIn-qDBjuR0  reason: not valid java name */
    public static final Modifier m607requiredSizeInqDBjuR0(Modifier $this$requiredSizeIn_u2dqDBjuR0, float minWidth, float minHeight, float maxWidth, float maxHeight) {
    ...
    public static /* synthetic */ Modifier m597defaultMinSizeVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m5864getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m596defaultMinSizeVpY3zN4(modifier, f, f2);
    }

    /* renamed from: defaultMinSize-VpY3zN4  reason: not valid java name */
    public static final Modifier m596defaultMinSizeVpY3zN4(Modifier $this$defaultMinSize_u2dVpY3zN4, float minWidth, float minHeight) {
