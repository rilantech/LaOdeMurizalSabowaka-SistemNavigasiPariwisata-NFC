...
public final class WindowInsetsSides {
    ...
    public static final /* synthetic */ WindowInsetsSides m649boximpl(int i) {
        return new WindowInsetsSides(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m650constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m651equalsimpl(int i, Object obj) {
        return (obj instanceof WindowInsetsSides) && i == ((WindowInsetsSides) obj).m658unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m652equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public static final int m655plusgK_yJZ4(int arg0, int sides) {
        return m650constructorimpl(arg0 | sides);
    }

    /* renamed from: hasAny-bkgdKaI$foundation_layout_release  reason: not valid java name */
    public static final boolean m653hasAnybkgdKaI$foundation_layout_release(int arg0, int sides) {
        return (arg0 & sides) != 0;
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m656toStringimpl(int arg0) {
        return "WindowInsetsSides(" + m657valueToStringimpl(arg0) + ')';
    }
    ...
    private static final String m657valueToStringimpl(int arg0) {
    ...
    public static final class Companion {
        ...
        public final int m659getAllowLeftInLtrJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowLeftInLtr;
        }

        /* renamed from: getAllowRightInLtr-JoeWqyM$foundation_layout_release  reason: not valid java name */
        public final int m661getAllowRightInLtrJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowRightInLtr;
        }

        /* renamed from: getAllowLeftInRtl-JoeWqyM$foundation_layout_release  reason: not valid java name */
        public final int m660getAllowLeftInRtlJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowLeftInRtl;
        }

        /* renamed from: getAllowRightInRtl-JoeWqyM$foundation_layout_release  reason: not valid java name */
        public final int m662getAllowRightInRtlJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowRightInRtl;
        }

        /* renamed from: getStart-JoeWqyM  reason: not valid java name */
        public final int m668getStartJoeWqyM() {
            return WindowInsetsSides.Start;
        }

        /* renamed from: getEnd-JoeWqyM  reason: not valid java name */
        public final int m664getEndJoeWqyM() {
            return WindowInsetsSides.End;
        }

        /* renamed from: getTop-JoeWqyM  reason: not valid java name */
        public final int m669getTopJoeWqyM() {
            return WindowInsetsSides.Top;
        }

        /* renamed from: getBottom-JoeWqyM  reason: not valid java name */
        public final int m663getBottomJoeWqyM() {
            return WindowInsetsSides.Bottom;
        }

        /* renamed from: getLeft-JoeWqyM  reason: not valid java name */
        public final int m666getLeftJoeWqyM() {
            return WindowInsetsSides.Left;
        }

        /* renamed from: getRight-JoeWqyM  reason: not valid java name */
        public final int m667getRightJoeWqyM() {
            return WindowInsetsSides.Right;
        }

        /* renamed from: getHorizontal-JoeWqyM  reason: not valid java name */
        public final int m665getHorizontalJoeWqyM() {
            return WindowInsetsSides.Horizontal;
        }

        /* renamed from: getVertical-JoeWqyM  reason: not valid java name */
        public final int m670getVerticalJoeWqyM() {
            return WindowInsetsSides.Vertical;
        }
    }

    static {
        int r0 = m650constructorimpl(8);
        AllowLeftInLtr = r0;
        int r1 = m650constructorimpl(4);
        AllowRightInLtr = r1;
        int r2 = m650constructorimpl(2);
        AllowLeftInRtl = r2;
        int r3 = m650constructorimpl(1);
        AllowRightInRtl = r3;
        Start = m655plusgK_yJZ4(r0, r3);
        End = m655plusgK_yJZ4(r1, r2);
        int r4 = m650constructorimpl(16);
        Top = r4;
        int r5 = m650constructorimpl(32);
        Bottom = r5;
        int r02 = m655plusgK_yJZ4(r0, r2);
        Left = r02;
        int r12 = m655plusgK_yJZ4(r1, r3);
        Right = r12;
        Horizontal = m655plusgK_yJZ4(r02, r12);
        Vertical = m655plusgK_yJZ4(r4, r5);
    }
}
