...
public final class InsetsPaddingModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public MeasureResult m480measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        long childConstraints = ConstraintsKt.m5804offsetNN6EwU(j, -horizontal, -vertical);
        Placeable placeable = measurable2.m4689measureBRTryo0(childConstraints);
        Placeable placeable2 = placeable;
        long j2 = childConstraints;
        int i = vertical;
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, ConstraintsKt.m5802constrainWidthK40F9xA(j, placeable.getWidth() + horizontal), ConstraintsKt.m5801constrainHeightK40F9xA(j, placeable.getHeight() + vertical), (Map) null, new InsetsPaddingModifier$measure$1(placeable, left, top), 4, (Object) null);
    }
