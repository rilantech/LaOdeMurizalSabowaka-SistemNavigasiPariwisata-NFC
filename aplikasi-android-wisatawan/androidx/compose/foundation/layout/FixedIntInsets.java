...
final class FixedIntInsets implements WindowInsets {
    ...
    public FixedIntInsets(int leftVal2, int topVal2, int rightVal2, int bottomVal2) {
        this.leftVal = leftVal2;
        this.topVal = topVal2;
        this.rightVal = rightVal2;
        this.bottomVal = bottomVal2;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.leftVal == ((FixedIntInsets) other).leftVal && this.topVal == ((FixedIntInsets) other).topVal && this.rightVal == ((FixedIntInsets) other).rightVal && this.bottomVal == ((FixedIntInsets) other).bottomVal) {
            return true;
        }
        return false;
    }
