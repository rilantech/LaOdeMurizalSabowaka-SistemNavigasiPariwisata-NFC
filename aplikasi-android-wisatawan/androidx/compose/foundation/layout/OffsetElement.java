...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public void update(OffsetNode node) {
        ...
        node.m501setX0680j_4(this.x);
        node.m502setY0680j_4(this.y);
    ...
    public boolean equals(Object other) {
        ...
        if (!Dp.m5849equalsimpl0(this.x, otherModifierElement.x) || !Dp.m5849equalsimpl0(this.y, otherModifierElement.y) || this.rtlAware != otherModifierElement.rtlAware) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((Dp.m5850hashCodeimpl(this.x) * 31) + Dp.m5850hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + Dp.m5855toStringimpl(this.x) + ", y=" + Dp.m5855toStringimpl(this.y) + ", rtlAware=" + this.rtlAware + ')';
    }
