...
final class OffsetKt$absoluteOffset$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    OffsetKt$absoluteOffset$1(float f, float f2) {
        super(1);
        this.$x = f;
        this.$y = f2;
    }
    ...
    public final void invoke(InspectorInfo $this$$receiver) {
        ...
        $this$$receiver.getProperties().set("x", Dp.m5842boximpl(this.$x));
        $this$$receiver.getProperties().set("y", Dp.m5842boximpl(this.$y));
    }
}
