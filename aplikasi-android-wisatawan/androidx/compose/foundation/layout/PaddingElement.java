...
final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    public /* synthetic */ PaddingElement(float r10, float r11, float r12, float r13, boolean r14, kotlin.jvm.functions.Function1 r15, int r16, kotlin.jvm.internal.DefaultConstructorMarker r17) {
        ...
        L_0x001c:
            ...
            r1 = 0
            float r4 = (float) r0
            float r0 = androidx.compose.ui.unit.Dp.m5844constructorimpl(r4)
            r4 = r0
            goto L_0x002a
        L_0x0029:
            r4 = r12
        L_0x002a:
            ...
            r1 = 0
            float r5 = (float) r0
            float r0 = androidx.compose.ui.unit.Dp.m5844constructorimpl(r5)
            r5 = r0
            goto L_0x0038
        L_0x0037:
            r5 = r13
    ...
    public final void m529setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m530setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public final void m528setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m527setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    private PaddingElement(float r4, float r5, float r6, float r7, boolean r8, kotlin.jvm.functions.Function1<? super androidx.compose.ui.platform.InspectorInfo, kotlin.Unit> r9) {
        /*
            ...
            float r1 = r1.m5864getUnspecifiedD9Ej5fM()
            boolean r1 = androidx.compose.ui.unit.Dp.m5849equalsimpl0(r4, r1)
        ...
        L_0x0027:
            ...
            float r2 = r2.m5864getUnspecifiedD9Ej5fM()
            boolean r1 = androidx.compose.ui.unit.Dp.m5849equalsimpl0(r1, r2)
            if (r1 == 0) goto L_0x005e
        L_0x0039:
            float r1 = r3.end
            int r2 = (r1 > r0 ? 1 : (r1 == r0 ? 0 : -1))
        ...
        L_0x004b:
            ...
            float r0 = r0.m5864getUnspecifiedD9Ej5fM()
            boolean r0 = androidx.compose.ui.unit.Dp.m5849equalsimpl0(r1, r0)
    ...
    public void update(PaddingNode node) {
        ...
        node.m550setStart0680j_4(this.start);
        node.m551setTop0680j_4(this.top);
        node.m549setEnd0680j_4(this.end);
        node.m548setBottom0680j_4(this.bottom);
        node.setRtlAware(this.rtlAware);
    }

    public int hashCode() {
        return (((((((Dp.m5850hashCodeimpl(this.start) * 31) + Dp.m5850hashCodeimpl(this.top)) * 31) + Dp.m5850hashCodeimpl(this.end)) * 31) + Dp.m5850hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public boolean equals(Object other) {
        PaddingElement otherModifierElement = other instanceof PaddingElement ? (PaddingElement) other : null;
        if (otherModifierElement != null && Dp.m5849equalsimpl0(this.start, otherModifierElement.start) && Dp.m5849equalsimpl0(this.top, otherModifierElement.top) && Dp.m5849equalsimpl0(this.end, otherModifierElement.end) && Dp.m5849equalsimpl0(this.bottom, otherModifierElement.bottom) && this.rtlAware == otherModifierElement.rtlAware) {
            return true;
        }
        return false;
    }
