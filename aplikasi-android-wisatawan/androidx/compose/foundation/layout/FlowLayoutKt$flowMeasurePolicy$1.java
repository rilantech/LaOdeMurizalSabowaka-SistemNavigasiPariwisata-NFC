...
public final class FlowLayoutKt$flowMeasurePolicy$1 implements MeasurePolicy {
    ...
    public MeasureResult m479measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> measurables, long constraints) {
        int layoutHeight;
        int layoutWidth;
        ...
        FlowResult flowResult = FlowLayoutKt.m476breakDownItemsw1Onq5I(measureScope2, rowColumnMeasurementHelper, this.$orientation, OrientationIndependentConstraints.m507constructorimpl(j, this.$orientation), this.$maxItemsInMainAxis);
        ...
        int totalCrossAxisSize = flowResult.getCrossAxisTotalSize() + (measureScope.m5819roundToPx0680j_4(this.$crossAxisArrangementSpacing) * (this_$iv.getSize() - 1));
        ...
        int layoutWidth2 = ConstraintsKt.m5802constrainWidthK40F9xA(j, layoutWidth);
        int layoutHeight2 = ConstraintsKt.m5801constrainHeightK40F9xA(j, layoutHeight);
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
        ...
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        if (this.$orientation == LayoutOrientation.Horizontal) {
            return minIntrinsicMainAxisSize(measurables, height, $this$minIntrinsicWidth.m5819roundToPx0680j_4(this.$mainAxisArrangementSpacing), $this$minIntrinsicWidth.m5819roundToPx0680j_4(this.$crossAxisArrangementSpacing));
        }
        return intrinsicCrossAxisSize(measurables, height, $this$minIntrinsicWidth.m5819roundToPx0680j_4(this.$mainAxisArrangementSpacing), $this$minIntrinsicWidth.m5819roundToPx0680j_4(this.$crossAxisArrangementSpacing));
    }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
        ...
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        if (this.$orientation == LayoutOrientation.Horizontal) {
            return intrinsicCrossAxisSize(measurables, width, $this$minIntrinsicHeight.m5819roundToPx0680j_4(this.$mainAxisArrangementSpacing), $this$minIntrinsicHeight.m5819roundToPx0680j_4(this.$crossAxisArrangementSpacing));
        }
        return minIntrinsicMainAxisSize(measurables, width, $this$minIntrinsicHeight.m5819roundToPx0680j_4(this.$mainAxisArrangementSpacing), $this$minIntrinsicHeight.m5819roundToPx0680j_4(this.$crossAxisArrangementSpacing));
    }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
        ...
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        if (this.$orientation == LayoutOrientation.Horizontal) {
            return intrinsicCrossAxisSize(measurables, width, $this$maxIntrinsicHeight.m5819roundToPx0680j_4(this.$mainAxisArrangementSpacing), $this$maxIntrinsicHeight.m5819roundToPx0680j_4(this.$crossAxisArrangementSpacing));
        }
        return maxIntrinsicMainAxisSize(measurables, width, $this$maxIntrinsicHeight.m5819roundToPx0680j_4(this.$mainAxisArrangementSpacing));
    }
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
        ...
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        if (this.$orientation == LayoutOrientation.Horizontal) {
            return maxIntrinsicMainAxisSize(measurables, height, $this$maxIntrinsicWidth.m5819roundToPx0680j_4(this.$mainAxisArrangementSpacing));
        }
        return intrinsicCrossAxisSize(measurables, height, $this$maxIntrinsicWidth.m5819roundToPx0680j_4(this.$mainAxisArrangementSpacing), $this$maxIntrinsicWidth.m5819roundToPx0680j_4(this.$crossAxisArrangementSpacing));
    }
