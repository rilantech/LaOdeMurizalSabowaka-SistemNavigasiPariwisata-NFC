...
public final class ColumnKt {
    ...
    static {
        ...
        float r1 = Arrangement.INSTANCE.getTop().m444getSpacingD9Ej5fM();
        ...
        DefaultColumnMeasurePolicy = RowColumnImplKt.m581rowColumnMeasurePolicyTDGSqEk(layoutOrientation, ColumnKt$DefaultColumnMeasurePolicy$1.INSTANCE, r1, SizeMode.Wrap, horizontal$foundation_layout_release);
    }
    ...
    public static final MeasurePolicy columnMeasurePolicy(Arrangement.Vertical verticalArrangement, Alignment.Horizontal horizontalAlignment, Composer $composer, int $changed) {
        ...
        if (!Intrinsics.areEqual((Object) vertical, (Object) Arrangement.INSTANCE.getTop()) || !Intrinsics.areEqual((Object) horizontal, (Object) Alignment.Companion.getStart())) {
            ...
            if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
                LayoutOrientation layoutOrientation = LayoutOrientation.Vertical;
                float r13 = verticalArrangement.m444getSpacingD9Ej5fM();
                ...
                measurePolicy2 = RowColumnImplKt.m581rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new ColumnKt$columnMeasurePolicy$1$1(vertical), r13, SizeMode.Wrap, horizontal$foundation_layout_release);
