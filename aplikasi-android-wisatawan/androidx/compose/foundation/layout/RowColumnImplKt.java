...
public final class RowColumnImplKt {
    ...
    public static final MeasurePolicy m581rowColumnMeasurePolicyTDGSqEk(LayoutOrientation orientation, Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> arrangement, float arrangementSpacing, SizeMode crossAxisSize, CrossAxisAlignment crossAxisAlignment) {
