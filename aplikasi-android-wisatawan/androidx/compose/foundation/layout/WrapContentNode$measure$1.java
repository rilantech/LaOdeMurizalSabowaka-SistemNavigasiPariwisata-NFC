...
final class WrapContentNode$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope $this$layout) {
        ...
        Placeable.PlacementScope.m4729place70tqf50$default(placementScope, this.$placeable, this.this$0.getAlignmentCallback().invoke(IntSize.m5996boximpl(IntSizeKt.IntSize(this.$wrapperWidth - this.$placeable.getWidth(), this.$wrapperHeight - this.$placeable.getHeight())), this.$this_measure.getLayoutDirection()).m5971unboximpl(), 0.0f, 2, (Object) null);
    }
}
