...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final long m408getBeforeXSAIIZE() {
        return this.before;
    }

    /* renamed from: setBefore--R2X_6o  reason: not valid java name */
    public final void m411setBeforeR2X_6o(long j) {
        this.before = j;
    }

    /* renamed from: getAfter-XSAIIZE  reason: not valid java name */
    public final long m407getAfterXSAIIZE() {
        return this.after;
    }

    /* renamed from: setAfter--R2X_6o  reason: not valid java name */
    public final void m410setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult m409measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$measure_u2d3p2s80s, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return AlignmentLineKt.m389alignmentLineOffsetMeasuretjqqzMA($this$measure_u2d3p2s80s, this.alignmentLine, !TextUnitKt.m6043isUnspecifiedR2X_6o(this.before) ? $this$measure_u2d3p2s80s.m5820toDpGaN1DYA(this.before) : Dp.Companion.m5864getUnspecifiedD9Ej5fM(), !TextUnitKt.m6043isUnspecifiedR2X_6o(this.after) ? $this$measure_u2d3p2s80s.m5820toDpGaN1DYA(this.after) : Dp.Companion.m5864getUnspecifiedD9Ej5fM(), measurable, constraints);
    }
}
