...
final class WrapContentElement$Companion$width$1 extends Lambda implements Function2<IntSize, LayoutDirection, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return IntOffset.m5953boximpl(m673invoke5SAbXVA(((IntSize) p1).m6008unboximpl(), (LayoutDirection) p2));
    }

    /* renamed from: invoke-5SAbXVA  reason: not valid java name */
    public final long m673invoke5SAbXVA(long size, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return IntOffsetKt.IntOffset(this.$align.align(0, IntSize.m6004getWidthimpl(size), layoutDirection), 0);
    }
}
