...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        ...
        node.m637setMinWidth0680j_4(this.minWidth);
        node.m636setMinHeight0680j_4(this.minHeight);
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("minWidth", Dp.m5842boximpl(this.minWidth));
        $this$inspectableProperties.getProperties().set("minHeight", Dp.m5842boximpl(this.minHeight));
    }

    public boolean equals(Object other) {
        if ((other instanceof UnspecifiedConstraintsElement) && Dp.m5849equalsimpl0(this.minWidth, ((UnspecifiedConstraintsElement) other).minWidth) && Dp.m5849equalsimpl0(this.minHeight, ((UnspecifiedConstraintsElement) other).minHeight)) {
            return true;
        }
        return false;
    }
