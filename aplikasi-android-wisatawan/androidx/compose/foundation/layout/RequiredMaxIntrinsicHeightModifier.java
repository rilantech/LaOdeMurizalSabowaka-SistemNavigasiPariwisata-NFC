...
final class RequiredMaxIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public long m577calculateContentConstraintsl58MMJ0(MeasureScope $this$calculateContentConstraints_u2dl58MMJ0, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$calculateContentConstraints_u2dl58MMJ0, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m5797fixedHeightOenEA2s(measurable.maxIntrinsicHeight(Constraints.m5788getMaxWidthimpl(constraints)));
    }
