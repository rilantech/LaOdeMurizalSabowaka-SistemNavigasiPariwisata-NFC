...
final class MaxIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long m489calculateContentConstraintsl58MMJ0(MeasureScope $this$calculateContentConstraints_u2dl58MMJ0, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$calculateContentConstraints_u2dl58MMJ0, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m5798fixedWidthOenEA2s(measurable.maxIntrinsicWidth(Constraints.m5787getMaxHeightimpl(constraints)));
    }
