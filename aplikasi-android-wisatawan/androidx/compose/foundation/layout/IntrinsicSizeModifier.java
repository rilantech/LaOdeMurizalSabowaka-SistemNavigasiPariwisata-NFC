...
interface IntrinsicSizeModifier extends LayoutModifier {
    ...
    long m485calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    MeasureResult m486measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$measure_u2d3p2s80s, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        long contentConstraints = m485calculateContentConstraintsl58MMJ0($this$measure_u2d3p2s80s, measurable, constraints);
        Placeable placeable = measurable.m4689measureBRTryo0(getEnforceIncoming() ? ConstraintsKt.m5800constrainN9IONVI(constraints, contentConstraints) : contentConstraints);
