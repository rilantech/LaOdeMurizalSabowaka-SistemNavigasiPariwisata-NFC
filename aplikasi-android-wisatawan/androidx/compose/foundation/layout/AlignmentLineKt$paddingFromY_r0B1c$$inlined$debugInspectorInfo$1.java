...
public final class AlignmentLineKt$paddingFromY_r0B1c$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        $this$paddingFrom_Y_r0B1c_u24lambda_u241.getProperties().set("before", TextUnit.m6015boximpl(this.$before$inlined));
        $this$paddingFrom_Y_r0B1c_u24lambda_u241.getProperties().set("after", TextUnit.m6015boximpl(this.$after$inlined));
    }
}
