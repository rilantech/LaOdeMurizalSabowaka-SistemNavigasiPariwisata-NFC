...
final class LimitInsets implements WindowInsets {
    ...
    public final int m487getSidesJoeWqyM() {
        return this.sides;
    }
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        if (layoutDirection == LayoutDirection.Ltr) {
            layoutDirectionSide = WindowInsetsSides.Companion.m659getAllowLeftInLtrJoeWqyM$foundation_layout_release();
        } else {
            layoutDirectionSide = WindowInsetsSides.Companion.m660getAllowLeftInRtlJoeWqyM$foundation_layout_release();
        }
        if (WindowInsetsSides.m653hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirectionSide)) {
    ...
    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m653hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.Companion.m669getTopJoeWqyM())) {
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        ...
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (layoutDirection == LayoutDirection.Ltr) {
            layoutDirectionSide = WindowInsetsSides.Companion.m661getAllowRightInLtrJoeWqyM$foundation_layout_release();
        } else {
            layoutDirectionSide = WindowInsetsSides.Companion.m662getAllowRightInRtlJoeWqyM$foundation_layout_release();
        }
        if (WindowInsetsSides.m653hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirectionSide)) {
    ...
    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m653hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.Companion.m663getBottomJoeWqyM())) {
    ...
    public boolean equals(Object other) {
        ...
        if (!Intrinsics.areEqual((Object) this.insets, (Object) ((LimitInsets) other).insets) || !WindowInsetsSides.m652equalsimpl0(this.sides, ((LimitInsets) other).sides)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (this.insets.hashCode() * 31) + WindowInsetsSides.m654hashCodeimpl(this.sides);
    }

    public String toString() {
        return '(' + this.insets + " only " + WindowInsetsSides.m656toStringimpl(this.sides) + ')';
    }
}
