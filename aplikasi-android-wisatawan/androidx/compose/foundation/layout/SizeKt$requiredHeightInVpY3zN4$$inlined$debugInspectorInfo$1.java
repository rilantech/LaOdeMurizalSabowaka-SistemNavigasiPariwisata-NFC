...
public final class SizeKt$requiredHeightInVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$requiredHeightIn_VpY3zN4_u24lambda_u2412 = $this$null;
        $this$requiredHeightIn_VpY3zN4_u24lambda_u2412.setName("requiredHeightIn");
        $this$requiredHeightIn_VpY3zN4_u24lambda_u2412.getProperties().set("min", Dp.m5842boximpl(this.$min$inlined));
        $this$requiredHeightIn_VpY3zN4_u24lambda_u2412.getProperties().set("max", Dp.m5842boximpl(this.$max$inlined));
    }
}
