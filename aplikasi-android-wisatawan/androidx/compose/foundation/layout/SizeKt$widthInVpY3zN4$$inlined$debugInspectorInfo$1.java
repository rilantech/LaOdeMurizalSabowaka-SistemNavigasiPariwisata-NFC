...
public final class SizeKt$widthInVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        $this$widthIn_VpY3zN4_u24lambda_u244.getProperties().set("min", Dp.m5842boximpl(this.$min$inlined));
        $this$widthIn_VpY3zN4_u24lambda_u244.getProperties().set("max", Dp.m5842boximpl(this.$max$inlined));
    }
}
