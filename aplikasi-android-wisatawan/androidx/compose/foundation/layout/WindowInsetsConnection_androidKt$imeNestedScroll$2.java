...
final class WindowInsetsConnection_androidKt$imeNestedScroll$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
        ...
        Modifier nestedScroll$default = NestedScrollModifierKt.nestedScroll$default($this$composed, WindowInsetsConnection_androidKt.m638rememberWindowInsetsConnectionVRgvIgI(WindowInsetsHolder.Companion.current($composer, 8).getIme(), WindowInsetsSides.Companion.m663getBottomJoeWqyM(), $composer, 48), (NestedScrollDispatcher) null, 2, (Object) null);
        if (ComposerKt.isTraceInProgress()) {
