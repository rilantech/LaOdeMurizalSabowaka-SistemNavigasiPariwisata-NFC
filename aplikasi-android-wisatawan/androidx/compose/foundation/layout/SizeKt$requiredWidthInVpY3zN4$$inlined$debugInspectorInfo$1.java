...
public final class SizeKt$requiredWidthInVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$requiredWidthIn_VpY3zN4_u24lambda_u2411 = $this$null;
        $this$requiredWidthIn_VpY3zN4_u24lambda_u2411.setName("requiredWidthIn");
        $this$requiredWidthIn_VpY3zN4_u24lambda_u2411.getProperties().set("min", Dp.m5842boximpl(this.$min$inlined));
        $this$requiredWidthIn_VpY3zN4_u24lambda_u2411.getProperties().set("max", Dp.m5842boximpl(this.$max$inlined));
    }
}
