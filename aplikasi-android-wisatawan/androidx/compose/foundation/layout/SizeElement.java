...
final class SizeElement extends ModifierNodeElement<SizeNode> {
    ...
    public void update(SizeNode node) {
        ...
        node.m629setMinWidth0680j_4(this.minWidth);
        node.m628setMinHeight0680j_4(this.minHeight);
        node.m627setMaxWidth0680j_4(this.maxWidth);
        node.m626setMaxHeight0680j_4(this.maxHeight);
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SizeElement) && Dp.m5849equalsimpl0(this.minWidth, ((SizeElement) other).minWidth) && Dp.m5849equalsimpl0(this.minHeight, ((SizeElement) other).minHeight) && Dp.m5849equalsimpl0(this.maxWidth, ((SizeElement) other).maxWidth) && Dp.m5849equalsimpl0(this.maxHeight, ((SizeElement) other).maxHeight) && this.enforceIncoming == ((SizeElement) other).enforceIncoming) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((Dp.m5850hashCodeimpl(this.minWidth) * 31) + Dp.m5850hashCodeimpl(this.minHeight)) * 31) + Dp.m5850hashCodeimpl(this.maxWidth)) * 31) + Dp.m5850hashCodeimpl(this.maxHeight)) * 31) + Boolean.hashCode(this.enforceIncoming);
    }
}
