...
public final class AlignmentLineKt$paddingFrom4j6BHR0$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        $this$paddingFrom_4j6BHR0_u24lambda_u240.getProperties().set("before", Dp.m5842boximpl(this.$before$inlined));
        $this$paddingFrom_4j6BHR0_u24lambda_u240.getProperties().set("after", Dp.m5842boximpl(this.$after$inlined));
    }
}
