...
public final class SideCalculator$Companion$BottomSideCalculator$1 implements SideCalculator {
    ...
    public long m588consumedOffsetsMKHz9U(long available) {
        return OffsetKt.Offset(0.0f, Offset.m3004getYimpl(available));
    }

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    public long m589consumedVelocityQWom1Mo(long available, float remaining) {
        return VelocityKt.Velocity(0.0f, Velocity.m6070getYimpl(available) + remaining);
    }
}
