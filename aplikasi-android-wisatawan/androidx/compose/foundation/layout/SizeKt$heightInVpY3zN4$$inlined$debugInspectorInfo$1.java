...
public final class SizeKt$heightInVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        $this$heightIn_VpY3zN4_u24lambda_u245.getProperties().set("min", Dp.m5842boximpl(this.$min$inlined));
        $this$heightIn_VpY3zN4_u24lambda_u245.getProperties().set("max", Dp.m5842boximpl(this.$max$inlined));
    }
}
