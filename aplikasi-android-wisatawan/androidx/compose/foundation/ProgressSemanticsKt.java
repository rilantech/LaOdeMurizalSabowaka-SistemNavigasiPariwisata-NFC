...
public final class ProgressSemanticsKt {
    ...
    public static final Modifier progressSemantics(Modifier $this$progressSemantics, float value, ClosedFloatingPointRange<Float> valueRange, int steps) {
        ...
        return SemanticsModifierKt.semantics($this$progressSemantics, true, new ProgressSemanticsKt$progressSemantics$1(value, valueRange, steps));
    }

    public static final Modifier progressSemantics(Modifier $this$progressSemantics) {
        Intrinsics.checkNotNullParameter($this$progressSemantics, "<this>");
        return SemanticsModifierKt.semantics($this$progressSemantics, true, ProgressSemanticsKt$progressSemantics$2.INSTANCE);
    }
}
