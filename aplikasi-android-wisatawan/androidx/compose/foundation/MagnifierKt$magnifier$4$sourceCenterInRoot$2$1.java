...
final class MagnifierKt$magnifier$4$sourceCenterInRoot$2$1 extends Lambda implements Function0<Offset> {
    ...
    public /* bridge */ /* synthetic */ Object invoke() {
        return Offset.m2992boximpl(m228invokeF1C5BW0());
    }

    /* renamed from: invoke-F1C5BW0  reason: not valid java name */
    public final long m228invokeF1C5BW0() {
        long sourceCenterOffset = ((Offset) MagnifierKt$magnifier$4.invoke$lambda$3(this.$updatedSourceCenter$delegate).invoke(this.$density)).m3013unboximpl();
        if (!OffsetKt.m3022isSpecifiedk4lQ0M(MagnifierKt$magnifier$4.invoke$lambda$1(this.$anchorPositionInRoot$delegate)) || !OffsetKt.m3022isSpecifiedk4lQ0M(sourceCenterOffset)) {
            return Offset.Companion.m3018getUnspecifiedF1C5BW0();
        }
        return Offset.m3008plusMKHz9U(MagnifierKt$magnifier$4.invoke$lambda$1(this.$anchorPositionInRoot$delegate), sourceCenterOffset);
    }
}
