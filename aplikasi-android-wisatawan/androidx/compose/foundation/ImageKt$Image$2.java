...
final class ImageKt$Image$2 implements MeasurePolicy {
    ...
    public final MeasureResult m225measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
        Intrinsics.checkNotNullParameter($this$Layout, "$this$Layout");
        Intrinsics.checkNotNullParameter(list, "<anonymous parameter 0>");
        return MeasureScope.layout$default($this$Layout, Constraints.m5790getMinWidthimpl(constraints), Constraints.m5789getMinHeightimpl(constraints), (Map) null, ImageKt$Image$2$measure$1.INSTANCE, 4, (Object) null);
    }
}
