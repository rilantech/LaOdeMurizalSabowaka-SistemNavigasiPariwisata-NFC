...
public abstract class CornerBasedShape implements Shape {
    ...
    public abstract Outline m854createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection);
    ...
    public final Outline m855createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        float bottomStart2;
        float topStart2;
        float topEnd2;
        float bottomEnd2;
        ...
        float topStart3 = this.topStart.m856toPxTmRCtEA(j, density2);
        float topEnd3 = this.topEnd.m856toPxTmRCtEA(j, density2);
        float bottomEnd3 = this.bottomEnd.m856toPxTmRCtEA(j, density2);
        float bottomStart3 = this.bottomStart.m856toPxTmRCtEA(j, density2);
        float minDimension = Size.m3071getMinDimensionimpl(size);
        ...
        if (topStart2 >= 0.0f && topEnd2 >= 0.0f && bottomEnd2 >= 0.0f && bottomStart2 >= 0.0f) {
            float f = bottomEnd2;
            float f2 = topEnd2;
            return m854createOutlineLjSzlW0(size, topStart2, topEnd2, bottomEnd2, bottomStart2, layoutDirection);
        }
