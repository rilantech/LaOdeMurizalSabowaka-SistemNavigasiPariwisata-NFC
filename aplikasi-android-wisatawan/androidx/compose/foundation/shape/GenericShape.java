...
public final class GenericShape implements Shape {
    ...
    public Outline m868createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Path path = AndroidPath_androidKt.Path();
        Path $this$createOutline_Pq9zytI_u24lambda_u240 = path;
        this.builder.invoke($this$createOutline_Pq9zytI_u24lambda_u240, Size.m3060boximpl(size), layoutDirection);
