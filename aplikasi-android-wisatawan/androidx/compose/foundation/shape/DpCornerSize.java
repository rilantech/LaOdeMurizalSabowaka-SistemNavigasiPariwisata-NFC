...
final class DpCornerSize implements CornerSize, InspectableValue {
    ...
    private final float m863component1D9Ej5fM() {
        return this.size;
    }

    /* renamed from: copy-0680j_4$default  reason: not valid java name */
    public static /* synthetic */ DpCornerSize m864copy0680j_4$default(DpCornerSize dpCornerSize, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpCornerSize.size;
        }
        return dpCornerSize.m865copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4  reason: not valid java name */
    public final DpCornerSize m865copy0680j_4(float f) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof DpCornerSize) && Dp.m5849equalsimpl0(this.size, ((DpCornerSize) obj).size);
    }
    ...
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m5842boximpl(m866getValueOverrideD9Ej5fM());
    }

    /* renamed from: toPx-TmRCtEA  reason: not valid java name */
    public float m867toPxTmRCtEA(long shapeSize, Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m5825toPx0680j_4(this.size);
    }
    ...
    public float m866getValueOverrideD9Ej5fM() {
        return this.size;
    }
}
