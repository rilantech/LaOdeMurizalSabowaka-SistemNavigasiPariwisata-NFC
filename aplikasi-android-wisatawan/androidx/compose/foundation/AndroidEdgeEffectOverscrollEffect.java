...
public final class AndroidEdgeEffectOverscrollEffect implements OverscrollEffect {
    ...
    public AndroidEdgeEffectOverscrollEffect(Context context, OverscrollConfiguration overscrollConfig2) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            $this$fastForEach$iv.get(index$iv).setColor(ColorKt.m3307toArgb8_81llA(this.overscrollConfig.m253getGlowColor0d7_KjU()));
        }
        this.redrawSignal = SnapshotStateKt.mutableStateOf(Unit.INSTANCE, SnapshotStateKt.neverEqualPolicy());
        this.invalidationEnabled = true;
        this.containerSize = Size.Companion.m3081getZeroNHjbRc();
    ...
    public long m162applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
        ...
        if (Size.m3074isEmptyimpl(this.containerSize)) {
            return function1.invoke(Offset.m2992boximpl(delta)).m3013unboximpl();
        }
        ...
        long pointer = offset != null ? offset.m3013unboximpl() : SizeKt.m3082getCenteruvyYCjk(this.containerSize);
        float consumedPixelsX = 0.0f;
        if (Offset.m3004getYimpl(delta) == 0.0f) {
            consumedPixelsY = 0.0f;
        } else {
            if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.topEffect) == 0.0f)) {
                consumedPixelsY = m159pullTop0a9Yr6o(j, pointer);
                ...
                if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.bottomEffect) == 0.0f)) {
                    consumedPixelsY = m156pullBottom0a9Yr6o(j, pointer);
        ...
        if (!(Offset.m3003getXimpl(delta) == 0.0f)) {
            if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.leftEffect) == 0.0f)) {
                float r10 = m157pullLeft0a9Yr6o(j, pointer);
                float f3 = r10;
                if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.leftEffect) == 0.0f) {
                ...
                if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.rightEffect) == 0.0f)) {
                    float r102 = m158pullRight0a9Yr6o(j, pointer);
                    float f4 = r102;
                    if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.rightEffect) == 0.0f) {
        ...
        if (!Offset.m3000equalsimpl0(consumedOffset, Offset.Companion.m3019getZeroF1C5BW0())) {
            invalidateOverscroll();
        }
        long leftForDelta = Offset.m3007minusMKHz9U(j, consumedOffset);
        long consumedByDelta = function1.invoke(Offset.m2992boximpl(leftForDelta)).m3013unboximpl();
        long consumedOffset2 = consumedOffset;
        long leftForOverscroll = Offset.m3007minusMKHz9U(leftForDelta, consumedByDelta);
        ...
        if (NestedScrollSource.m4372equalsimpl0(source, NestedScrollSource.Companion.m4377getDragWNlRxjI())) {
            if (Offset.m3003getXimpl(leftForOverscroll) > 0.5f) {
                m157pullLeft0a9Yr6o(leftForOverscroll, pointer);
                appliedHorizontalOverscroll = true;
            } else if (Offset.m3003getXimpl(leftForOverscroll) < -0.5f) {
                m158pullRight0a9Yr6o(leftForOverscroll, pointer);
                appliedHorizontalOverscroll = true;
            } else {
                appliedHorizontalOverscroll = false;
            }
            if (Offset.m3004getYimpl(leftForOverscroll) > 0.5f) {
                m159pullTop0a9Yr6o(leftForOverscroll, pointer);
                appliedVerticalOverscroll = true;
            } else if (Offset.m3004getYimpl(leftForOverscroll) < -0.5f) {
                m156pullBottom0a9Yr6o(leftForOverscroll, pointer);
                appliedVerticalOverscroll = true;
            } else {
        ...
        if (m160releaseOppositeOverscrollk4lQ0M(delta) || needsInvalidation) {
            invalidateOverscroll();
        }
        return Offset.m3008plusMKHz9U(consumedOffset2, consumedByDelta);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:58:0x013f, code lost:
        r10 = androidx.compose.ui.unit.Velocity.m6072minusAH228Gc(r10, ((androidx.compose.ui.unit.Velocity) r12).m6078unboximpl());
        r2.scrollCycleInProgress = false;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:59:0x0151, code lost:
        if (androidx.compose.ui.unit.Velocity.m6069getXimpl(r10) <= 0.0f) goto L_0x0163;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:60:0x0153, code lost:
        androidx.compose.foundation.EdgeEffectCompat.INSTANCE.onAbsorbCompat(r2.leftEffect, kotlin.math.MathKt.roundToInt(androidx.compose.ui.unit.Velocity.m6069getXimpl(r10)));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:62:0x0169, code lost:
        if (androidx.compose.ui.unit.Velocity.m6069getXimpl(r10) >= 0.0f) goto L_0x017b;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:63:0x016b, code lost:
        androidx.compose.foundation.EdgeEffectCompat.INSTANCE.onAbsorbCompat(r2.rightEffect, -kotlin.math.MathKt.roundToInt(androidx.compose.ui.unit.Velocity.m6069getXimpl(r10)));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:65:0x0181, code lost:
        if (androidx.compose.ui.unit.Velocity.m6070getYimpl(r10) <= 0.0f) goto L_0x0193;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:66:0x0183, code lost:
        androidx.compose.foundation.EdgeEffectCompat.INSTANCE.onAbsorbCompat(r2.topEffect, kotlin.math.MathKt.roundToInt(androidx.compose.ui.unit.Velocity.m6070getYimpl(r10)));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:68:0x0199, code lost:
        if (androidx.compose.ui.unit.Velocity.m6070getYimpl(r10) >= 0.0f) goto L_0x01ab;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:69:0x019b, code lost:
        androidx.compose.foundation.EdgeEffectCompat.INSTANCE.onAbsorbCompat(r2.bottomEffect, -kotlin.math.MathKt.roundToInt(androidx.compose.ui.unit.Velocity.m6070getYimpl(r10)));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:71:0x01b5, code lost:
        if (androidx.compose.ui.unit.Velocity.m6068equalsimpl0(r10, androidx.compose.ui.unit.Velocity.Companion.m6080getZero9UxMQ8M()) != false) goto L_0x01ba;
     */
    ...
    public java.lang.Object m161applyToFlingBMRW4eQ(long r10, kotlin.jvm.functions.Function2<? super androidx.compose.ui.unit.Velocity, ? super kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity>, ? extends java.lang.Object> r12, kotlin.coroutines.Continuation<? super kotlin.Unit> r13) {
        /*
            r9 = this;
        ...
        L_0x0040:
            ...
            boolean r5 = androidx.compose.ui.geometry.Size.m3074isEmptyimpl(r5)
            r6 = 1
            if (r5 == 0) goto L_0x005d
            androidx.compose.ui.unit.Velocity r2 = androidx.compose.ui.unit.Velocity.m6060boximpl(r10)
            r13.label = r6
        ...
        L_0x005a:
            ...
            return r10
        L_0x005d:
            float r5 = androidx.compose.ui.unit.Velocity.m6069getXimpl(r10)
        ...
        L_0x0074:
            ...
            androidx.compose.foundation.EdgeEffectCompat r5 = androidx.compose.foundation.EdgeEffectCompat.INSTANCE
            android.widget.EdgeEffect r7 = r2.leftEffect
            float r8 = androidx.compose.ui.unit.Velocity.m6069getXimpl(r10)
        ...
        L_0x00b8:
            r5 = r4
        L_0x00b9:
            float r7 = androidx.compose.ui.unit.Velocity.m6070getYimpl(r10)
        ...
        L_0x00d1:
            ...
            float r8 = androidx.compose.ui.unit.Velocity.m6070getYimpl(r10)
            int r8 = kotlin.math.MathKt.roundToInt((float) r8)
            r6.onAbsorbCompat(r7, r8)
            float r6 = androidx.compose.ui.unit.Velocity.m6070getYimpl(r10)
            goto L_0x0115
        L_0x00e7:
            float r7 = androidx.compose.ui.unit.Velocity.m6070getYimpl(r10)
            int r7 = (r7 > r4 ? 1 : (r7 == r4 ? 0 : -1))
        ...
        L_0x0115:
            ...
            boolean r7 = androidx.compose.ui.unit.Velocity.m6068equalsimpl0(r5, r7)
            if (r7 != 0) goto L_0x0129
            r2.invalidateOverscroll()
        L_0x0129:
            long r10 = androidx.compose.ui.unit.Velocity.m6072minusAH228Gc(r10, r5)
            androidx.compose.ui.unit.Velocity r5 = androidx.compose.ui.unit.Velocity.m6060boximpl(r10)
            r13.L$0 = r2
            r13.J$0 = r10
            r6 = 2
            r13.label = r6
        ...
        L_0x013f:
            ...
            long r5 = r12.m6078unboximpl()
            long r10 = androidx.compose.ui.unit.Velocity.m6072minusAH228Gc(r10, r5)
            r2.scrollCycleInProgress = r3
            float r12 = androidx.compose.ui.unit.Velocity.m6069getXimpl(r10)
            ...
            float r3 = androidx.compose.ui.unit.Velocity.m6069getXimpl(r10)
        ...
        L_0x0163:
            ...
            r12.onAbsorbCompat(r1, r3)
        L_0x017b:
            float r12 = androidx.compose.ui.unit.Velocity.m6070getYimpl(r10)
            int r12 = (r12 > r4 ? 1 : (r12 == r4 ? 0 : -1))
            if (r12 <= 0) goto L_0x0193
            androidx.compose.foundation.EdgeEffectCompat r12 = androidx.compose.foundation.EdgeEffectCompat.INSTANCE
            android.widget.EdgeEffect r1 = r2.topEffect
            float r3 = androidx.compose.ui.unit.Velocity.m6070getYimpl(r10)
            int r3 = kotlin.math.MathKt.roundToInt((float) r3)
            r12.onAbsorbCompat(r1, r3)
            goto L_0x01ab
        L_0x0193:
        ...
        L_0x01ab:
            ...
            long r3 = r12.m6080getZero9UxMQ8M()
            boolean r12 = androidx.compose.ui.unit.Velocity.m6068equalsimpl0(r10, r3)
        ...
        L_0x01ba:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.AndroidEdgeEffectOverscrollEffect.m161applyToFlingBMRW4eQ(long, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    private final boolean stopOverscrollAnimation() {
        ...
        long fakeDisplacement = SizeKt.m3082getCenteruvyYCjk(this.containerSize);
        boolean z = true;
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.leftEffect) == 0.0f)) {
            m157pullLeft0a9Yr6o(Offset.Companion.m3019getZeroF1C5BW0(), fakeDisplacement);
            stopped = true;
        }
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.rightEffect) == 0.0f)) {
            m158pullRight0a9Yr6o(Offset.Companion.m3019getZeroF1C5BW0(), fakeDisplacement);
            stopped = true;
        }
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.topEffect) == 0.0f)) {
            m159pullTop0a9Yr6o(Offset.Companion.m3019getZeroF1C5BW0(), fakeDisplacement);
            stopped = true;
        }
        if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.bottomEffect) != 0.0f) {
            z = false;
        ...
        m156pullBottom0a9Yr6o(Offset.Companion.m3019getZeroF1C5BW0(), fakeDisplacement);
        return true;
    }
    ...
    private final boolean drawLeft(DrawScope $this$drawLeft, EdgeEffect left, android.graphics.Canvas canvas) {
        ...
        canvas.translate(-Size.m3069getHeightimpl(this.containerSize), $this$drawLeft.m5825toPx0680j_4(this.overscrollConfig.getDrawPadding().m553calculateLeftPaddingu2uoSUM($this$drawLeft.getLayoutDirection())));
    ...
    private final boolean drawTop(DrawScope $this$drawTop, EdgeEffect top, android.graphics.Canvas canvas) {
        int restore = canvas.save();
        canvas.translate(0.0f, $this$drawTop.m5825toPx0680j_4(this.overscrollConfig.getDrawPadding().m555calculateTopPaddingD9Ej5fM()));
    ...
    private final boolean drawRight(DrawScope $this$drawRight, EdgeEffect right, android.graphics.Canvas canvas) {
        int restore = canvas.save();
        int width = MathKt.roundToInt(Size.m3072getWidthimpl(this.containerSize));
        float rightPadding = this.overscrollConfig.getDrawPadding().m554calculateRightPaddingu2uoSUM($this$drawRight.getLayoutDirection());
        canvas.rotate(90.0f);
        canvas.translate(0.0f, (-((float) width)) + $this$drawRight.m5825toPx0680j_4(rightPadding));
    ...
    private final boolean drawBottom(DrawScope $this$drawBottom, EdgeEffect bottom, android.graphics.Canvas canvas) {
        ...
        canvas.translate(-Size.m3072getWidthimpl(this.containerSize), (-Size.m3069getHeightimpl(this.containerSize)) + $this$drawBottom.m5825toPx0680j_4(this.overscrollConfig.getDrawPadding().m552calculateBottomPaddingD9Ej5fM()));
    ...
    private final boolean m160releaseOppositeOverscrollk4lQ0M(long delta) {
        boolean needsInvalidation = false;
        if (!this.leftEffect.isFinished() && Offset.m3003getXimpl(delta) < 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.leftEffect, Offset.m3003getXimpl(delta));
            needsInvalidation = this.leftEffect.isFinished();
        }
        boolean needsInvalidation2 = false;
        if (!this.rightEffect.isFinished() && Offset.m3003getXimpl(delta) > 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.rightEffect, Offset.m3003getXimpl(delta));
            needsInvalidation = needsInvalidation || this.rightEffect.isFinished();
        }
        if (!this.topEffect.isFinished() && Offset.m3004getYimpl(delta) < 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.topEffect, Offset.m3004getYimpl(delta));
            needsInvalidation = needsInvalidation || this.topEffect.isFinished();
        }
        if (this.bottomEffect.isFinished() || Offset.m3004getYimpl(delta) <= 0.0f) {
            return needsInvalidation;
        }
        EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.bottomEffect, Offset.m3004getYimpl(delta));
    ...
    private final float m159pullTop0a9Yr6o(long scroll, long displacement) {
        float consumed = EdgeEffectCompat.INSTANCE.onPullDistanceCompat(this.topEffect, Offset.m3004getYimpl(scroll) / Size.m3069getHeightimpl(this.containerSize), Offset.m3003getXimpl(displacement) / Size.m3072getWidthimpl(this.containerSize)) * Size.m3069getHeightimpl(this.containerSize);
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.topEffect) == 0.0f)) {
            return Offset.m3004getYimpl(scroll);
        }
        return consumed;
    }

    /* renamed from: pullBottom-0a9Yr6o  reason: not valid java name */
    private final float m156pullBottom0a9Yr6o(long scroll, long displacement) {
        float displacementX = Offset.m3003getXimpl(displacement) / Size.m3072getWidthimpl(this.containerSize);
        boolean z = true;
        float consumed = (-EdgeEffectCompat.INSTANCE.onPullDistanceCompat(this.bottomEffect, -(Offset.m3004getYimpl(scroll) / Size.m3069getHeightimpl(this.containerSize)), ((float) 1) - displacementX)) * Size.m3069getHeightimpl(this.containerSize);
        if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.bottomEffect) != 0.0f) {
            z = false;
        }
        if (!z) {
    ...
    private final float m157pullLeft0a9Yr6o(long scroll, long displacement) {
        float displacementY = Offset.m3004getYimpl(displacement) / Size.m3069getHeightimpl(this.containerSize);
        boolean z = true;
        float consumed = EdgeEffectCompat.INSTANCE.onPullDistanceCompat(this.leftEffect, Offset.m3003getXimpl(scroll) / Size.m3072getWidthimpl(this.containerSize), ((float) 1) - displacementY) * Size.m3072getWidthimpl(this.containerSize);
        if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.leftEffect) != 0.0f) {
            z = false;
        }
        if (!z) {
            return Offset.m3003getXimpl(scroll);
        }
        return consumed;
    }

    /* renamed from: pullRight-0a9Yr6o  reason: not valid java name */
    private final float m158pullRight0a9Yr6o(long scroll, long displacement) {
        float consumed = (-EdgeEffectCompat.INSTANCE.onPullDistanceCompat(this.rightEffect, -(Offset.m3003getXimpl(scroll) / Size.m3072getWidthimpl(this.containerSize)), Offset.m3004getYimpl(displacement) / Size.m3069getHeightimpl(this.containerSize))) * Size.m3072getWidthimpl(this.containerSize);
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.rightEffect) == 0.0f)) {
            return Offset.m3003getXimpl(scroll);
        }
        return consumed;
