...
public abstract class LazyListMeasuredItemProvider {
    ...
    private LazyListMeasuredItemProvider(long constraints, boolean isVertical, LazyListItemProvider itemProvider2, LazyLayoutMeasureScope measureScope2) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, isVertical ? Constraints.m5788getMaxWidthimpl(constraints) : Integer.MAX_VALUE, 0, !isVertical ? Constraints.m5787getMaxHeightimpl(constraints) : Integer.MAX_VALUE, 5, (Object) null);
    }

    /* renamed from: getChildConstraints-msEJaDk  reason: not valid java name */
    public final long m685getChildConstraintsmsEJaDk() {
        return this.childConstraints;
    }

    public final LazyListMeasuredItem getAndMeasure(int index) {
        return createItem(index, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.m737measure0kLqBqw(index, this.childConstraints));
    }
