...
public final class LazyLayoutBeyondBoundsModifierLocal implements ModifierLocalProvider<BeyondBoundsLayout>, BeyondBoundsLayout {
    ...
    public <T> T m733layouto7g1Pn8(int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        int startIndex;
        Intrinsics.checkNotNullParameter(block, "block");
        if (this.state.getItemCount() <= 0 || !this.state.getHasVisibleItems()) {
            return block.invoke(emptyBeyondBoundsScope);
        }
        if (m731isForward4vf7U8o(direction)) {
        ...
        Object found = null;
        while (found == null && m730hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) interval.element, direction)) {
            T r3 = m729addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) interval.element, direction);
            T t = r3;
    ...
    private final boolean m731isForward4vf7U8o(int $this$isForward_u2d4vf7U8o) {
        if (BeyondBoundsLayout.LayoutDirection.m4597equalsimpl0($this$isForward_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.Companion.m4603getBeforehoxUOeE())) {
            return false;
        }
        if (BeyondBoundsLayout.LayoutDirection.m4597equalsimpl0($this$isForward_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.Companion.m4602getAfterhoxUOeE())) {
            return true;
        }
        if (BeyondBoundsLayout.LayoutDirection.m4597equalsimpl0($this$isForward_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.Companion.m4601getAbovehoxUOeE())) {
            return this.reverseLayout;
        }
        if (BeyondBoundsLayout.LayoutDirection.m4597equalsimpl0($this$isForward_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.Companion.m4604getBelowhoxUOeE())) {
            if (!this.reverseLayout) {
                return true;
            }
            return false;
        } else if (BeyondBoundsLayout.LayoutDirection.m4597equalsimpl0($this$isForward_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.Companion.m4605getLefthoxUOeE())) {
        ...
        } else if (BeyondBoundsLayout.LayoutDirection.m4597equalsimpl0($this$isForward_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.Companion.m4606getRighthoxUOeE())) {
            switch (WhenMappings.$EnumSwitchMapping$0[this.layoutDirection.ordinal()]) {
                case 1:
                    if (!this.reverseLayout) {
                        return true;
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m729addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval currentInterval, int direction) {
    ...
    public final boolean m730hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval $this$hasMoreContent_u2dFR3nfPY, int direction) {
        if (m732isOppositeToOrientation4vf7U8o(direction)) {
            return false;
        }
        if (m731isForward4vf7U8o(direction)) {
    ...
    private final boolean m732isOppositeToOrientation4vf7U8o(int $this$isOppositeToOrientation_u2d4vf7U8o) {
        boolean z = true;
        if (BeyondBoundsLayout.LayoutDirection.m4597equalsimpl0($this$isOppositeToOrientation_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.Companion.m4601getAbovehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m4597equalsimpl0($this$isOppositeToOrientation_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.Companion.m4604getBelowhoxUOeE())) {
            return this.orientation == Orientation.Horizontal;
        }
        if (!(BeyondBoundsLayout.LayoutDirection.m4597equalsimpl0($this$isOppositeToOrientation_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.Companion.m4605getLefthoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m4597equalsimpl0($this$isOppositeToOrientation_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.Companion.m4606getRighthoxUOeE()))) {
            if (!BeyondBoundsLayout.LayoutDirection.m4597equalsimpl0($this$isOppositeToOrientation_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.Companion.m4603getBeforehoxUOeE())) {
                z = BeyondBoundsLayout.LayoutDirection.m4597equalsimpl0($this$isOppositeToOrientation_u2d4vf7U8o, BeyondBoundsLayout.LayoutDirection.Companion.m4602getAfterhoxUOeE());
            }
            if (z) {
                return false;
            }
