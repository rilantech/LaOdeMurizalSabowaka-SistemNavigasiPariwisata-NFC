...
public final class LazyLayoutMeasureScopeImpl implements LazyLayoutMeasureScope, MeasureScope {
    ...
    public int m747roundToPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.m5818roundToPxR2X_6o(j);
    }

    /* renamed from: roundToPx-0680j_4  reason: not valid java name */
    public int m748roundToPx0680j_4(float f) {
        return this.subcomposeMeasureScope.m5819roundToPx0680j_4(f);
    }

    /* renamed from: toPx--R2X_6o  reason: not valid java name */
    public float m753toPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.m5824toPxR2X_6o(j);
    }

    /* renamed from: toPx-0680j_4  reason: not valid java name */
    public float m754toPx0680j_4(float f) {
        return this.subcomposeMeasureScope.m5825toPx0680j_4(f);
    }
    ...
    public List<Placeable> m746measure0kLqBqw(int index, long constraints) {
        ...
        for (int i = 0; i < size; i++) {
            arrayList.add(measurables.get(i).m4689measureBRTryo0(constraints));
        }
        List it = arrayList;
    ...
    public float m749toDpGaN1DYA(long $this$toDp_u2dGaN1DYA) {
        return this.subcomposeMeasureScope.m5820toDpGaN1DYA($this$toDp_u2dGaN1DYA);
    }

    /* renamed from: toDp-u2uoSUM  reason: not valid java name */
    public float m751toDpu2uoSUM(int $this$toDp_u2du2uoSUM) {
        return this.subcomposeMeasureScope.m5822toDpu2uoSUM($this$toDp_u2du2uoSUM);
    }

    /* renamed from: toDp-u2uoSUM  reason: not valid java name */
    public float m750toDpu2uoSUM(float $this$toDp_u2du2uoSUM) {
        return this.subcomposeMeasureScope.m5821toDpu2uoSUM($this$toDp_u2du2uoSUM);
    }

    /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
    public long m757toSpkPz2Gy4(float $this$toSp_u2dkPz2Gy4) {
        return this.subcomposeMeasureScope.m5828toSpkPz2Gy4($this$toSp_u2dkPz2Gy4);
    }

    /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
    public long m758toSpkPz2Gy4(int $this$toSp_u2dkPz2Gy4) {
        return this.subcomposeMeasureScope.m5829toSpkPz2Gy4($this$toSp_u2dkPz2Gy4);
    }

    /* renamed from: toSp-0xMU5do  reason: not valid java name */
    public long m756toSp0xMU5do(float $this$toSp_u2d0xMU5do) {
        return this.subcomposeMeasureScope.m5827toSp0xMU5do($this$toSp_u2d0xMU5do);
    }

    /* renamed from: toSize-XkaWNTQ  reason: not valid java name */
    public long m755toSizeXkaWNTQ(long $this$toSize_u2dXkaWNTQ) {
        return this.subcomposeMeasureScope.m5826toSizeXkaWNTQ($this$toSize_u2dXkaWNTQ);
    }

    /* renamed from: toDpSize-k-rfVVM  reason: not valid java name */
    public long m752toDpSizekrfVVM(long $this$toDpSize_u2dk_u2drfVVM) {
        return this.subcomposeMeasureScope.m5823toDpSizekrfVVM($this$toDpSize_u2dk_u2drfVVM);
    }
}
