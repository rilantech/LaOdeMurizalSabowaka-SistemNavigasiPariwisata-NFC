...
final class ItemFoundInScroll extends CancellationException {
    ...
    public ItemFoundInScroll(int itemOffset2, AnimationState<Float, AnimationVector1D> previousAnimation2) {
        Intrinsics.checkNotNullParameter(previousAnimation2, "previousAnimation");
        this.itemOffset = itemOffset2;
        this.previousAnimation = previousAnimation2;
    }
}
