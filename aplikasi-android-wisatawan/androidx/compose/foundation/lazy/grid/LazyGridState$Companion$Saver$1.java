...
final class LazyGridState$Companion$Saver$1 extends Lambda implements Function2<SaverScope, LazyGridState, List<? extends Integer>> {
    ...
    public final List<Integer> invoke(SaverScope $this$listSaver, LazyGridState it) {
        ...
        return CollectionsKt.listOf(Integer.valueOf(it.getFirstVisibleItemIndex()), Integer.valueOf(it.getFirstVisibleItemScrollOffset()));
    }
}
