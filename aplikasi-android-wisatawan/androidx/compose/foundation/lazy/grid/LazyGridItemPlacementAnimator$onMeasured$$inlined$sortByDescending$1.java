...
public final class LazyGridItemPlacementAnimator$onMeasured$$inlined$sortByDescending$1<T> implements Comparator {
    ...
    public final int compare(T a, T b) {
        return ComparisonsKt.compareValues(Integer.valueOf(this.$previousKeyToIndexMap$inlined.getIndex(((LazyGridMeasuredItem) b).getKey())), Integer.valueOf(this.$previousKeyToIndexMap$inlined.getIndex(((LazyGridMeasuredItem) a).getKey())));
    }
}
