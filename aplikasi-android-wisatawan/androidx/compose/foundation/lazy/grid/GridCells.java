...
public interface GridCells {
    ...
    public static final class Adaptive implements GridCells {
        ...
        private Adaptive(float minSize2) {
            ...
            if (!(Dp.m5843compareTo0680j_4(minSize2, Dp.m5844constructorimpl((float) 0)) > 0)) {
                throw new IllegalArgumentException(("Provided min size " + Dp.m5855toStringimpl(minSize2) + " should be larger than zero.").toString());
            }
        }

        public List<Integer> calculateCrossAxisCellSizes(Density $this$calculateCrossAxisCellSizes, int availableSize, int spacing) {
            Intrinsics.checkNotNullParameter($this$calculateCrossAxisCellSizes, "<this>");
            return LazyGridDslKt.calculateCellsCrossAxisSizeImpl(availableSize, Math.max((availableSize + spacing) / ($this$calculateCrossAxisCellSizes.m5819roundToPx0680j_4(this.minSize) + spacing), 1), spacing);
        }
    ...
    public static final class FixedSize implements GridCells {
        ...
        private FixedSize(float size2) {
            this.size = size2;
            if (!(Dp.m5843compareTo0680j_4(size2, Dp.m5844constructorimpl((float) 0)) > 0)) {
                throw new IllegalArgumentException(("Provided size " + Dp.m5855toStringimpl(size2) + " should be larger than zero.").toString());
            }
        }

        public List<Integer> calculateCrossAxisCellSizes(Density $this$calculateCrossAxisCellSizes, int availableSize, int spacing) {
            Intrinsics.checkNotNullParameter($this$calculateCrossAxisCellSizes, "<this>");
            int cellSize = $this$calculateCrossAxisCellSizes.m5819roundToPx0680j_4(this.size);
            int i = 0;
