...
public final class LazyGridItemPlacementAnimator$onMeasured$$inlined$sortByDescending$2<T> implements Comparator {
    ...
    public final int compare(T a, T b) {
        return ComparisonsKt.compareValues(Integer.valueOf(this.this$0.keyIndexMap.getIndex(((LazyGridMeasuredItem) b).getKey())), Integer.valueOf(this.this$0.keyIndexMap.getIndex(((LazyGridMeasuredItem) a).getKey())));
    }
}
