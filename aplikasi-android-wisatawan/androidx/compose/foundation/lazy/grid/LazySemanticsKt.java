...
public final class LazySemanticsKt {
    public static final LazyLayoutSemanticState rememberLazyGridSemanticState(LazyGridState state, boolean reverseScrolling, Composer $composer, int $changed) {
        Object value$iv$iv;
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = new LazySemanticsKt$rememberLazyGridSemanticState$1$1(state);
