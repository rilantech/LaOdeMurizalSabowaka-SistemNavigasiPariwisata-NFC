...
public abstract class LazyGridMeasuredItemProvider {
    ...
    public static /* synthetic */ LazyGridMeasuredItem m717getAndMeasure3p2s80s$default(LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i, int i2, long j, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 2) != 0) {
                i2 = lazyGridMeasuredItemProvider.defaultMainAxisSpacing;
            }
            return lazyGridMeasuredItemProvider.m718getAndMeasure3p2s80s(i, i2, j);
        }
        throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: getAndMeasure-3p2s80s");
    }

    /* renamed from: getAndMeasure-3p2s80s  reason: not valid java name */
    public final LazyGridMeasuredItem m718getAndMeasure3p2s80s(int index, int mainAxisSpacing, long constraints) {
        int crossAxisSize;
        Object key = this.itemProvider.getKey(index);
        Object contentType = this.itemProvider.getContentType(index);
        List<Placeable> r9 = this.measureScope.m737measure0kLqBqw(index, constraints);
        if (Constraints.m5786getHasFixedWidthimpl(constraints)) {
            crossAxisSize = Constraints.m5790getMinWidthimpl(constraints);
        } else if (Constraints.m5785getHasFixedHeightimpl(constraints)) {
            crossAxisSize = Constraints.m5789getMinHeightimpl(constraints);
        } else {
