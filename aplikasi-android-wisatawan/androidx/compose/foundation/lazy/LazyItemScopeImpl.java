...
public final class LazyItemScopeImpl implements LazyItemScope {
    ...
    public Modifier fillParentMaxWidth(Modifier $this$fillParentMaxWidth, float fraction) {
        ...
        return $this$fillParentMaxWidth.then(new ParentSizeElement(fraction, this.maxWidthState, (State) null, "fillParentMaxWidth", 4, (DefaultConstructorMarker) null));
    }
    ...
    public Modifier fillParentMaxHeight(Modifier $this$fillParentMaxHeight, float fraction) {
        ...
        return $this$fillParentMaxHeight.then(new ParentSizeElement(fraction, (State) null, this.maxHeightState, "fillParentMaxHeight", 2, (DefaultConstructorMarker) null));
    }
