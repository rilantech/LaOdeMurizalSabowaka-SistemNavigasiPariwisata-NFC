...
final class LazyStaggeredGridItemProviderImpl implements LazyStaggeredGridItemProvider {
    ...
    public LazyStaggeredGridItemProviderImpl(LazyStaggeredGridState state2, LazyStaggeredGridIntervalContent intervalContent2, LazyLayoutKeyIndexMap keyIndexMap2) {
    ...
    public void Item(int index, Object key, Composer $composer, int $changed) {
        ...
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, index, this.state.getPinnedItems$foundation_release(), ComposableLambdaKt.composableLambda($composer2, 608834466, true, new LazyStaggeredGridItemProviderImpl$Item$1(this, index)), $composer2, (($dirty << 3) & 112) | 3592);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope endRestartGroup = $composer2.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new LazyStaggeredGridItemProviderImpl$Item$2(this, index, key, $changed));
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual((Object) this.intervalContent, (Object) ((LazyStaggeredGridItemProviderImpl) other).intervalContent);
    }
