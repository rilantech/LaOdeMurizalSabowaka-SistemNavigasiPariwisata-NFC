...
public final class LazyStaggeredGridKt {
    ...
    public static final void m777LazyStaggeredGridLJWHXA8(LazyStaggeredGridState state, Orientation orientation, Function2<? super Density, ? super Constraints, LazyStaggeredGridSlots> slots, Modifier modifier, PaddingValues contentPadding, boolean reverseLayout, FlingBehavior flingBehavior, boolean userScrollEnabled, float mainAxisSpacing, float crossAxisSpacing, Function1<? super LazyStaggeredGridScope, Unit> content, Composer $composer, int $changed, int $changed1, int i) {
        ...
        if ((i2 & 256) != 0) {
            mainAxisSpacing2 = Dp.m5844constructorimpl((float) 0);
        } else {
            mainAxisSpacing2 = mainAxisSpacing;
        }
        if ((i2 & 512) != 0) {
            crossAxisSpacing2 = Dp.m5844constructorimpl((float) 0);
        } else {
        ...
        int i3 = $dirty1;
        Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> r23 = LazyStaggeredGridMeasurePolicyKt.m787rememberStaggeredGridMeasurePolicynbWgWpA(state, rememberStaggeredGridItemProviderLambda, contentPadding2, reverseLayout2, orientation, mainAxisSpacing2, crossAxisSpacing2, slots, $composer2, (($dirty >> 6) & 896) | 8 | (($dirty >> 6) & 7168) | (($dirty << 9) & 57344) | (($dirty >> 9) & 458752) | (($dirty >> 9) & 3670016) | (($dirty << 15) & 29360128));
