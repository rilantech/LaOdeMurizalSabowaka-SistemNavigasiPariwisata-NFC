...
final class LazyStaggeredGridSlotCache implements Function2<Density, Constraints, LazyStaggeredGridSlots> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m796invoke0kLqBqw((Density) p1, ((Constraints) p2).m5794unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public LazyStaggeredGridSlots m796invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyStaggeredGridSlots it = this.calculation.invoke($this$invoke_0kLqBqw_u24lambda_u241, Constraints.m5776boximpl(constraints));
        this.cachedSizes = it;
        return it;
    }
}
