...
public final class LazyListItemPlacementAnimator$onMeasured$$inlined$sortBy$2<T> implements Comparator {
    ...
    public final int compare(T a, T b) {
        return ComparisonsKt.compareValues(Integer.valueOf(this.this$0.keyIndexMap.getIndex(((LazyListMeasuredItem) a).getKey())), Integer.valueOf(this.this$0.keyIndexMap.getIndex(((LazyListMeasuredItem) b).getKey())));
    }
}
