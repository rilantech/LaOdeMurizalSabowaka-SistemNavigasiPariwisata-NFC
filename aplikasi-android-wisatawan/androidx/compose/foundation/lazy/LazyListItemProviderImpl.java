...
final class LazyListItemProviderImpl implements LazyListItemProvider {
    ...
    public LazyListItemProviderImpl(LazyListState state2, LazyListIntervalContent intervalContent2, LazyItemScopeImpl itemScope2, LazyLayoutKeyIndexMap keyIndexMap2) {
    ...
    public void Item(int index, Object key, Composer $composer, int $changed) {
        ...
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, index, this.state.getPinnedItems$foundation_release(), ComposableLambdaKt.composableLambda($composer2, -824725566, true, new LazyListItemProviderImpl$Item$1(this, index)), $composer2, (($dirty << 3) & 112) | 3592);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope endRestartGroup = $composer2.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new LazyListItemProviderImpl$Item$2(this, index, key, $changed));
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual((Object) this.intervalContent, (Object) ((LazyListItemProviderImpl) other).intervalContent);
    }
