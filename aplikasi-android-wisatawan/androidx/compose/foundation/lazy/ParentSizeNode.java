...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult m688measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        int i;
        int i2;
        ...
        int height = i2;
        Placeable placeable = measurable2.m4689measureBRTryo0(ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : Constraints.m5790getMinWidthimpl(constraints), width != Integer.MAX_VALUE ? width : Constraints.m5788getMaxWidthimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m5789getMinHeightimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m5787getMaxHeightimpl(constraints)));
