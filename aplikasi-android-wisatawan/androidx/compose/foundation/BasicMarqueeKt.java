...
public final class BasicMarqueeKt {
    ...
    private static final float DefaultMarqueeVelocity = Dp.m5844constructorimpl((float) 30);
    ...
    public static /* synthetic */ Modifier m173basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        int i6;
        int i7;
        int i8;
        ...
        if ((i5 & 2) != 0) {
            i6 = MarqueeAnimationMode.Companion.m241getImmediatelyZbEOnfQ();
        } else {
            i6 = i2;
        }
        if ((i5 & 4) != 0) {
        ...
        if ((i5 & 8) != 0) {
            i8 = MarqueeAnimationMode.m235equalsimpl0(i6, MarqueeAnimationMode.Companion.m241getImmediatelyZbEOnfQ()) ? i7 : 0;
        } else {
            i8 = i4;
        }
        if ((i5 & 16) != 0) {
        ...
        return m172basicMarquee1Mj1MLw(modifier, i, i6, i7, i8, marqueeSpacing2, f2);
    }

    /* renamed from: basicMarquee-1Mj1MLw  reason: not valid java name */
    public static final Modifier m172basicMarquee1Mj1MLw(Modifier $this$basicMarquee_u2d1Mj1MLw, int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
    ...
    public static final AnimationSpec<Float> m174createMarqueeAnimationSpecZ4HSEVQ(int iterations, float targetValue, int initialDelayMillis, int delayMillis, float velocity, Density density) {
        int i = delayMillis;
        TweenSpec<Float> velocityBasedTween = velocityBasedTween(Math.abs(density.m5825toPx0680j_4(velocity)), targetValue, i);
        long startOffset = StartOffset.m118constructorimpl$default((-i) + initialDelayMillis, 0, 2, (DefaultConstructorMarker) null);
        if (iterations == Integer.MAX_VALUE) {
            return AnimationSpecKt.m98infiniteRepeatable9IiC70o$default(velocityBasedTween, (RepeatMode) null, startOffset, 2, (Object) null);
        }
        return AnimationSpecKt.m100repeatable91I0pcU$default(iterations, velocityBasedTween, (RepeatMode) null, startOffset, 4, (Object) null);
    }
    ...
    public static final MarqueeSpacing m170MarqueeSpacing0680j_4(float spacing) {
