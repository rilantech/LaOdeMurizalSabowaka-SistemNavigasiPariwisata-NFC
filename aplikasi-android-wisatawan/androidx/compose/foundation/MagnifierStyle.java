...
public final class MagnifierStyle {
    ...
    public final long m231getSizeMYxV2XQ$foundation_release() {
        return this.size;
    }

    /* renamed from: getCornerRadius-D9Ej5fM$foundation_release  reason: not valid java name */
    public final float m229getCornerRadiusD9Ej5fM$foundation_release() {
        return this.cornerRadius;
    }

    /* renamed from: getElevation-D9Ej5fM$foundation_release  reason: not valid java name */
    public final float m230getElevationD9Ej5fM$foundation_release() {
    ...
    public /* synthetic */ MagnifierStyle(long r8, float r10, float r11, boolean r12, boolean r13, int r14, kotlin.jvm.internal.DefaultConstructorMarker r15) {
        /*
            ...
            long r0 = r0.m5951getUnspecifiedMYxV2XQ()
            goto L_0x000c
        L_0x000b:
            r0 = r8
        L_0x000c:
        ...
        L_0x0018:
            ...
            float r3 = r3.m5864getUnspecifiedD9Ej5fM()
            goto L_0x0024
        L_0x0023:
            r3 = r11
        L_0x0024:
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MagnifierStyle) && this.useTextDefault == ((MagnifierStyle) other).useTextDefault && DpSize.m5939equalsimpl0(this.size, ((MagnifierStyle) other).size) && Dp.m5849equalsimpl0(this.cornerRadius, ((MagnifierStyle) other).cornerRadius) && Dp.m5849equalsimpl0(this.elevation, ((MagnifierStyle) other).elevation) && this.clippingEnabled == ((MagnifierStyle) other).clippingEnabled && this.fishEyeEnabled == ((MagnifierStyle) other).fishEyeEnabled) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((Boolean.hashCode(this.useTextDefault) * 31) + DpSize.m5944hashCodeimpl(this.size)) * 31) + Dp.m5850hashCodeimpl(this.cornerRadius)) * 31) + Dp.m5850hashCodeimpl(this.elevation)) * 31) + Boolean.hashCode(this.clippingEnabled)) * 31) + Boolean.hashCode(this.fishEyeEnabled);
    }
    ...
    public String toString() {
        ...
        return "MagnifierStyle(size=" + DpSize.m5949toStringimpl(this.size) + ", cornerRadius=" + Dp.m5855toStringimpl(this.cornerRadius) + ", elevation=" + Dp.m5855toStringimpl(this.elevation) + ", clippingEnabled=" + this.clippingEnabled + ", fishEyeEnabled=" + this.fishEyeEnabled + ')';
    }
