...
final class AndroidConfig implements ScrollConfig {
    ...
    public long m262calculateMouseWheelScroll8xgXZGE(Density $this$calculateMouseWheelScroll_u2d8xgXZGE, PointerEvent event, long bounds) {
        ...
        Offset r5 = Offset.m2992boximpl(Offset.Companion.m3019getZeroF1C5BW0());
        List $this$fastForEach$iv$iv = $this$fastFold$iv;
        int index$iv$iv = 0;
        int size = $this$fastForEach$iv$iv.size();
        while (index$iv$iv < size) {
            r5 = Offset.m2992boximpl(Offset.m3008plusMKHz9U(r5.m3013unboximpl(), ((PointerInputChange) $this$fastForEach$iv$iv.get(index$iv$iv)).m4482getScrollDeltaF1C5BW0()));
            index$iv$iv++;
            PointerEvent pointerEvent = event;
            $this$fastFold$iv = $this$fastFold$iv;
        }
        return Offset.m3010timestuRUvjQ(r5.m3013unboximpl(), -density.m5825toPx0680j_4(Dp.m5844constructorimpl((float) 64)));
    }
}
