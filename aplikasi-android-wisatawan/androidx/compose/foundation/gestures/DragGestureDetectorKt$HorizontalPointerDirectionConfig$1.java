...
public final class DragGestureDetectorKt$HorizontalPointerDirectionConfig$1 implements PointerDirectionConfig {
    ...
    public float m296mainAxisDeltak4lQ0M(long offset) {
        return Offset.m3003getXimpl(offset);
    }

    /* renamed from: crossAxisDelta-k-4lQ0M  reason: not valid java name */
    public float m295crossAxisDeltak4lQ0M(long offset) {
        return Offset.m3004getYimpl(offset);
    }

    /* renamed from: offsetFromChanges-dBAh8RU  reason: not valid java name */
    public long m297offsetFromChangesdBAh8RU(float mainChange, float crossChange) {
