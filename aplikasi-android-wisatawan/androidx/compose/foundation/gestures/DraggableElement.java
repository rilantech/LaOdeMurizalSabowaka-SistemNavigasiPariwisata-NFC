...
public final class DraggableElement extends ModifierNodeElement<DraggableNode> {
    ...
    public DraggableElement(DraggableState state2, Function1<? super PointerInputChange, Boolean> canDrag2, Orientation orientation2, boolean enabled2, MutableInteractionSource interactionSource2, Function0<Boolean> startDragImmediately2, Function3<? super CoroutineScope, ? super Offset, ? super Continuation<? super Unit>, ? extends Object> onDragStarted2, Function3<? super CoroutineScope, ? super Velocity, ? super Continuation<? super Unit>, ? extends Object> onDragStopped2, boolean reverseDirection2) {
    ...
    public boolean equals(Object other) {
        ...
        if (Intrinsics.areEqual((Object) this.state, (Object) ((DraggableElement) other).state) && Intrinsics.areEqual((Object) this.canDrag, (Object) ((DraggableElement) other).canDrag) && this.orientation == ((DraggableElement) other).orientation && this.enabled == ((DraggableElement) other).enabled && Intrinsics.areEqual((Object) this.interactionSource, (Object) ((DraggableElement) other).interactionSource) && Intrinsics.areEqual((Object) this.startDragImmediately, (Object) ((DraggableElement) other).startDragImmediately) && Intrinsics.areEqual((Object) this.onDragStarted, (Object) ((DraggableElement) other).onDragStarted) && Intrinsics.areEqual((Object) this.onDragStopped, (Object) ((DraggableElement) other).onDragStopped) && this.reverseDirection == ((DraggableElement) other).reverseDirection) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = ((((((this.state.hashCode() * 31) + this.canDrag.hashCode()) * 31) + this.orientation.hashCode()) * 31) + Boolean.hashCode(this.enabled)) * 31;
        MutableInteractionSource mutableInteractionSource = this.interactionSource;
        return ((((((((result + (mutableInteractionSource != null ? mutableInteractionSource.hashCode() : 0)) * 31) + this.startDragImmediately.hashCode()) * 31) + this.onDragStarted.hashCode()) * 31) + this.onDragStopped.hashCode()) * 31) + Boolean.hashCode(this.reverseDirection);
    }
