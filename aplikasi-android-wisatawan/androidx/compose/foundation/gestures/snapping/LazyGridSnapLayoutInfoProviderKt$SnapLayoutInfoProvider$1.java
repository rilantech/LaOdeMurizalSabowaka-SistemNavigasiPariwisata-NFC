...
public final class LazyGridSnapLayoutInfoProviderKt$SnapLayoutInfoProvider$1 implements SnapLayoutInfoProvider {
    ...
    public float calculateSnapStepSize(Density $this$calculateSnapStepSize) {
        ...
        if (getLayoutInfo().getOrientation() == Orientation.Vertical) {
            ...
            int size = $this$fastForEach$iv$iv.size();
            for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
                sum$iv += IntSize.m6003getHeightimpl(((LazyGridItemInfo) $this$fastForEach$iv$iv.get(index$iv$iv)).m708getSizeYbymL2g());
            }
        } else {
            int sum$iv2 = 0;
            ...
            for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
                sum$iv2 = sum$iv + IntSize.m6004getWidthimpl(((LazyGridItemInfo) $this$fastForEach$iv$iv2.get(index$iv$iv2)).m708getSizeYbymL2g());
            }
        }
