...
public final class LazyGridSnapLayoutInfoProviderKt {
    ...
    public static final int getSingleAxisViewportSize(LazyGridLayoutInfo $this$singleAxisViewportSize) {
        ...
        if ($this$singleAxisViewportSize.getOrientation() == Orientation.Vertical) {
            return IntSize.m6003getHeightimpl($this$singleAxisViewportSize.m710getViewportSizeYbymL2g());
        }
        return IntSize.m6004getWidthimpl($this$singleAxisViewportSize.m710getViewportSizeYbymL2g());
    }
    ...
    public static final int sizeOnMainAxis(LazyGridItemInfo $this$sizeOnMainAxis, Orientation orientation) {
        ...
        if (orientation == Orientation.Vertical) {
            return IntSize.m6003getHeightimpl($this$sizeOnMainAxis.m708getSizeYbymL2g());
        }
        return IntSize.m6004getWidthimpl($this$sizeOnMainAxis.m708getSizeYbymL2g());
    }
    ...
    public static final int offsetOnMainAxis(LazyGridItemInfo $this$offsetOnMainAxis, Orientation orientation) {
        ...
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return IntOffset.m5963getYimpl($this$offsetOnMainAxis.m707getOffsetnOccac());
        }
        return IntOffset.m5962getXimpl($this$offsetOnMainAxis.m707getOffsetnOccac());
    }
}
