...
public final class SnapFlingBehavior implements FlingBehavior {
    ...
    private SnapFlingBehavior(SnapLayoutInfoProvider snapLayoutInfoProvider2, AnimationSpec<Float> lowVelocityAnimationSpec2, DecayAnimationSpec<Float> highVelocityAnimationSpec2, AnimationSpec<Float> snapAnimationSpec2, Density density2, float shortSnapVelocityThreshold2) {
        ...
        this.velocityThreshold = density2.m5825toPx0680j_4(shortSnapVelocityThreshold2);
    ...
    public int hashCode() {
        return (((((((((((0 * 31) + this.snapAnimationSpec.hashCode()) * 31) + this.highVelocityAnimationSpec.hashCode()) * 31) + this.lowVelocityAnimationSpec.hashCode()) * 31) + this.snapLayoutInfoProvider.hashCode()) * 31) + this.density.hashCode()) * 31) + Dp.m5850hashCodeimpl(this.shortSnapVelocityThreshold);
    }
}
