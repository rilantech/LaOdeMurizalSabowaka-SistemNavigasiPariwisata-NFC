    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                AnimationState animationState = new AnimationState(VectorConvertersKt.getVectorConverter(Offset.Companion), Offset.m2992boximpl(this.$previous.element), (AnimationVector) null, 0, 0, false, 60, (DefaultConstructorMarker) null);
                Offset r5 = Offset.m2992boximpl(this.$offset);
                ...
                if (SuspendAnimationKt.animateTo$default(animationState, r5, animationSpec, false, new Function1<AnimationScope<Offset, AnimationVector2D>, Unit>() {
                    ...
                    public final void invoke(AnimationScope<Offset, AnimationVector2D> $this$animateTo) {
                        ...
                        TransformScope.m380transformByd4ec7I$default($this$transform, 0.0f, Offset.m3007minusMKHz9U($this$animateTo.getValue().m3013unboximpl(), longRef.element), 0.0f, 5, (Object) null);
                        longRef.element = $this$animateTo.getValue().m3013unboximpl();
                    }
