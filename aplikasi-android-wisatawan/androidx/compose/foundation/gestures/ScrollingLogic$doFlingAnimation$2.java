    ...
    public final Object invokeSuspend(Object $result2) {
        ...
        switch (this.label) {
            case 0:
                ...
                float reverseIfNeeded = scrollingLogic2.reverseIfNeeded(scrollingLogic2.m370toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic2.m373updateQWom1Mo(j, scrollingLogic.reverseIfNeeded(((Number) $result2).floatValue()));
