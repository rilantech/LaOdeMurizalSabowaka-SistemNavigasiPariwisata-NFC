...
public final class ContentInViewModifier implements BringIntoViewResponder, OnRemeasuredModifier, OnPlacedModifier {
    ...
    private long viewportSize = IntSize.Companion.m6009getZeroYbymL2g();
    ...
    public Rect calculateRectForParent(Rect localRect) {
        ...
        if (!IntSize.m6002equalsimpl0(this.viewportSize, IntSize.Companion.m6009getZeroYbymL2g())) {
    ...
    public Object bringChildIntoView(Function0<Rect> localRect, Continuation<? super Unit> $completion) {
        ...
        boolean z = false;
        if (invoke != null && !m267isMaxVisibleO0kMr_c$default(this, invoke, 0, 1, (Object) null)) {
            z = true;
        }
        if (!z) {
    ...
    public void m269onRemeasuredozmzZPI(long size) {
        Rect focusedChild2;
        long oldSize = this.viewportSize;
        this.viewportSize = size;
        if (m263compareToTemP2vQ(size, oldSize) < 0 && (focusedChild2 = getFocusedChildBounds()) != null) {
            ...
            if (!this.isAnimationRunning && !this.trackingFocusedChild && m266isMaxVisibleO0kMr_c(previousFocusedChildBounds, oldSize) && !m266isMaxVisibleO0kMr_c(focusedChild2, size)) {
    ...
    public final float calculateScrollDelta() {
        ...
        long size = IntSizeKt.m6014toSizeozmzZPI(this.viewportSize);
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return relocationDistance(rectangleToMakeVisible.getTop(), rectangleToMakeVisible.getBottom(), Size.m3069getHeightimpl(size));
            case 2:
                return relocationDistance(rectangleToMakeVisible.getLeft(), rectangleToMakeVisible.getRight(), Size.m3072getWidthimpl(size));
            default:
        ...
        if (size$iv$iv > 0) {
            ...
            while (true) {
                ...
                if (bounds != null) {
                    ...
                    if (m264compareToiLBOSCw(bounds.m3036getSizeNHjbRc(), IntSizeKt.m6014toSizeozmzZPI(this.viewportSize)) > 0) {
                        return rect;
                    }
                    rect = bounds;
                } else {
    ...
    private final Rect m265computeDestinationO0kMr_c(Rect childBounds, long containerSize) {
        return childBounds.m3040translatek4lQ0M(Offset.m3012unaryMinusF1C5BW0(m268relocationOffsetBMxPBkI(childBounds, containerSize)));
    }

    /* renamed from: isMaxVisible-O0kMr_c$default  reason: not valid java name */
    static /* synthetic */ boolean m267isMaxVisibleO0kMr_c$default(ContentInViewModifier contentInViewModifier, Rect rect, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = contentInViewModifier.viewportSize;
        }
        return contentInViewModifier.m266isMaxVisibleO0kMr_c(rect, j);
    }

    /* renamed from: isMaxVisible-O0kMr_c  reason: not valid java name */
    private final boolean m266isMaxVisibleO0kMr_c(Rect $this$isMaxVisible_u2dO0kMr_c, long size) {
        return Offset.m3000equalsimpl0(m268relocationOffsetBMxPBkI($this$isMaxVisible_u2dO0kMr_c, size), Offset.Companion.m3019getZeroF1C5BW0());
    }

    /* renamed from: relocationOffset-BMxPBkI  reason: not valid java name */
    private final long m268relocationOffsetBMxPBkI(Rect childBounds, long containerSize) {
        long size = IntSizeKt.m6014toSizeozmzZPI(containerSize);
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return OffsetKt.Offset(0.0f, relocationDistance(childBounds.getTop(), childBounds.getBottom(), Size.m3069getHeightimpl(size)));
            case 2:
                return OffsetKt.Offset(relocationDistance(childBounds.getLeft(), childBounds.getRight(), Size.m3072getWidthimpl(size)), 0.0f);
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
    ...
    private final int m263compareToTemP2vQ(long $this$compareTo_u2dTemP2vQ, long other) {
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return Intrinsics.compare(IntSize.m6003getHeightimpl($this$compareTo_u2dTemP2vQ), IntSize.m6003getHeightimpl(other));
            case 2:
                return Intrinsics.compare(IntSize.m6004getWidthimpl($this$compareTo_u2dTemP2vQ), IntSize.m6004getWidthimpl(other));
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
    ...
    private final int m264compareToiLBOSCw(long $this$compareTo_u2diLBOSCw, long other) {
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return Float.compare(Size.m3069getHeightimpl($this$compareTo_u2diLBOSCw), Size.m3069getHeightimpl(other));
            case 2:
                return Float.compare(Size.m3072getWidthimpl($this$compareTo_u2diLBOSCw), Size.m3072getWidthimpl(other));
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
