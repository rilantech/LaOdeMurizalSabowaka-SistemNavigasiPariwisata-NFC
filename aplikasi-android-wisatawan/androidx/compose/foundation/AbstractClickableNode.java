...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    public static final class InteractionData {
        ...
        private long centreOffset = Offset.Companion.m3019getZeroF1C5BW0();
        ...
        public final long m152getCentreOffsetF1C5BW0() {
            return this.centreOffset;
        }

        /* renamed from: setCentreOffset-k-4lQ0M  reason: not valid java name */
        public final void m153setCentreOffsetk4lQ0M(long j) {
            this.centreOffset = j;
        }
    }
    ...
    public static /* synthetic */ void m147updateCommonXHw0xAI$default(AbstractClickableNode abstractClickableNode, MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role2, Function0 function0, int i, Object obj) {
        Role role3;
        if (obj == null) {
            if ((i & 8) != 0) {
                role3 = null;
            ...
            abstractClickableNode.m151updateCommonXHw0xAI(mutableInteractionSource, z, str, role3, function0);
            return;
        }
    ...
    public final void m151updateCommonXHw0xAI(MutableInteractionSource interactionSource2, boolean enabled2, String onClickLabel2, Role role2, Function0<Unit> onClick2) {
        Intrinsics.checkNotNullParameter(interactionSource2, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick2, "onClick");
    ...
    public void m149onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        Intrinsics.checkNotNullParameter(pointerEvent, "pointerEvent");
        Intrinsics.checkNotNullParameter(pass, "pass");
        getClickablePointerInputNode().m155onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public boolean m148onKeyEventZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, NotificationCompat.CATEGORY_EVENT);
        if (!this.enabled || !Clickable_androidKt.m215isPressZmokQxo(event)) {
            if (!this.enabled || !Clickable_androidKt.m213isClickZmokQxo(event)) {
                return false;
            }
            PressInteraction.Press it = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m4022boximpl(KeyEvent_androidKt.m4333getKeyZmokQxo(event)));
            if (it != null) {
            ...
            this.onClick.invoke();
            return true;
        } else if (this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m4022boximpl(KeyEvent_androidKt.m4333getKeyZmokQxo(event)))) {
            return false;
        } else {
            PressInteraction.Press press = new PressInteraction.Press(this.interactionData.m152getCentreOffsetF1C5BW0(), (DefaultConstructorMarker) null);
            this.interactionData.getCurrentKeyPressInteractions().put(Key.m4022boximpl(KeyEvent_androidKt.m4333getKeyZmokQxo(event)), press);
    ...
    public boolean m150onPreKeyEventZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, NotificationCompat.CATEGORY_EVENT);
        return false;
    }
}
