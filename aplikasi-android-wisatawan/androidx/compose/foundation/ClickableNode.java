...
final class ClickableNode extends AbstractClickableNode {
    ...
    public final void m209updateXHw0xAI(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        m151updateCommonXHw0xAI(interactionSource, enabled, onClickLabel, role, onClick);
        getClickableSemanticsNode().m212updateUMe6uN4(enabled, onClickLabel, role, onClick, (String) null, (Function0<Unit>) null);
