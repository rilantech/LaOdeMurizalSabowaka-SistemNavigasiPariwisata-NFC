...
public final class ComposerImpl implements Composer {
    ...
    public void startReplaceableGroup(int key) {
        m2843startBaiHCIY(key, (Object) null, GroupKind.Companion.m2853getGroupULZAiWs(), (Object) null);
    }
    ...
    public void startDefaults() {
        m2843startBaiHCIY(-127, (Object) null, GroupKind.Companion.m2853getGroupULZAiWs(), (Object) null);
    }
    ...
    public void startMovableGroup(int key, Object dataKey) {
        m2843startBaiHCIY(key, dataKey, GroupKind.Companion.m2853getGroupULZAiWs(), (Object) null);
    }
    ...
    public void startNode() {
        m2843startBaiHCIY(125, (Object) null, GroupKind.Companion.m2854getNodeULZAiWs(), (Object) null);
        this.nodeExpected = true;
    }

    public void startReusableNode() {
        m2843startBaiHCIY(125, (Object) null, GroupKind.Companion.m2855getReusableNodeULZAiWs(), (Object) null);
        this.nodeExpected = true;
    }
    ...
    public void startReusableGroup(int key, Object dataKey) {
        ...
        m2843startBaiHCIY(key, (Object) null, GroupKind.Companion.m2853getGroupULZAiWs(), dataKey);
    }
    ...
    public void startProviders(ProvidedValue<?>[] values) {
        ...
        this.providerCache = providers;
        m2843startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.Companion.m2853getGroupULZAiWs(), providers);
    }
    ...
    private final void m2843startBaiHCIY(int key, Object objectKey, int kind, Object data) {
        Pending newPending;
        int i = key;
        ...
        int i3 = 0;
        boolean isNode = i2 != GroupKind.Companion.m2853getGroupULZAiWs();
        if (getInserting()) {
        ...
        boolean forceReplace = (i2 != GroupKind.Companion.m2854getNodeULZAiWs() ? 1 : 0) == 0 && this.reusing;
    ...
    public final void invokeMovableContentLambda(MovableContent<Object> content, PersistentCompositionLocalMap locals, Object parameter, boolean force) {
        ...
        try {
            ...
            m2843startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.Companion.m2853getGroupULZAiWs(), persistentCompositionLocalMap);
    ...
    public void sourceInformationMarkerStart(int key, String sourceInformation) {
        ...
        if (this.sourceInformationEnabled) {
            m2843startBaiHCIY(key, (Object) null, GroupKind.Companion.m2853getGroupULZAiWs(), sourceInformation);
        }
    }
