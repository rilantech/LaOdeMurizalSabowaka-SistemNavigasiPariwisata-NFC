...
public final class IdentityArraySet<T> implements Set<T>, KMappedMarker {
    ...
    public boolean m2877addAll(Collection<? extends T> collection) {
    ...
    public final boolean add(T value) {
        ...
        if (size2 == values2.length) {
            ...
            ArraysKt.copyInto((T[]) values2, (T[]) newSorted, insertIndex + 1, insertIndex, size2);
            ArraysKt.copyInto$default(values2, newSorted, 0, 0, insertIndex, 6, (Object) null);
            this.values = newSorted;
        } else {
            ArraysKt.copyInto((T[]) values2, (T[]) values2, insertIndex + 1, insertIndex, size2);
        }
    ...
    public final void addAll(Collection<? extends T> collection) {
        ...
        if (!collection.isEmpty()) {
            if (!(collection2 instanceof IdentityArraySet)) {
            ...
            Object[] otherValues = ((IdentityArraySet) collection2).values;
            int thisSize = size();
            int otherSize = ((IdentityArraySet) collection2).size();
            ...
            if (needsResize || !elementsInOrder) {
                ...
                while (true) {
                    ...
                    if (thisIndex2 < 0) {
                        ...
                        nextValue = otherValues[otherIndex];
                        thisValues = thisValues2;
                    } else if (otherIndex < 0) {
                        thisValues = thisValues2;
                        int i = otherIndex;
                        nextValue = thisValues2[thisIndex2];
                        thisIndex2--;
                        thisIndex = i;
                    } else {
                        ...
                        if (thisHash2 > otherHash) {
                            ...
                            while (true) {
                                ...
                                int i3 = i2 - 1;
                                Object value2 = thisValues2[i2];
                                thisValues = thisValues2;
                                if (ActualJvm_jvmKt.identityHashCode(value2) != otherHash) {
                                    int i4 = i3;
                                    break;
                                } else if (otherValue == value2) {
                                    foundDuplicate = true;
                                    int i5 = i3;
                                    break;
                                } else {
                                    Object value3 = collection;
                                    i2 = i3;
                ...
                if (nextInsertIndex >= 0) {
                    ArraysKt.copyInto((T[]) newArray, (T[]) newArray, thisHash, nextInsertIndex + 1, combinedSize);
                }
                int newSize = combinedSize - (nextInsertIndex + 1);
                ArraysKt.fill((T[]) newArray, null, newSize, combinedSize);
                identityArraySet.values = newArray;
                identityArraySet.size = newSize;
                return;
            }
            ArraysKt.copyInto((T[]) otherValues, (T[]) thisValues2, thisSize, 0, otherSize);
