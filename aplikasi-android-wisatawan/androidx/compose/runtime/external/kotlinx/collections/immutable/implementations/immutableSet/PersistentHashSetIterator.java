...
public class PersistentHashSetIterator<E> implements Iterator<E>, KMappedMarker {
    ...
    public PersistentHashSetIterator(TrieNode<E> node) {
        ...
        TrieNodeIterator.reset$default(mutableListOf.get(0), node.getBuffer(), 0, 2, (Object) null);
    ...
    private final int moveToNextNodeWithData(int pathIndex) {
        ...
        TrieNodeIterator.reset$default(this.path.get(pathIndex + 1), node.getBuffer(), 0, 2, (Object) null);
    ...
    public E next() {
        if (this.hasNext) {
            Object result = this.path.get(this.pathLastIndex).nextElement();
            ensureNextElementIsReady();
            return result;
        }
    ...
    public final E currentElement() {
        CommonFunctionsKt.m2881assert(hasNext());
