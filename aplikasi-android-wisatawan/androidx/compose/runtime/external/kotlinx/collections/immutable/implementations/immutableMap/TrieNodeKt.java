...
public final class TrieNodeKt {
    ...
    public static final <K, V> Object[] insertEntryAtIndex(Object[] $this$insertEntryAtIndex, int keyIndex, K key, V value) {
        ...
        ArraysKt.copyInto((T[]) $this$insertEntryAtIndex, (T[]) newBuffer, keyIndex + 2, keyIndex, $this$insertEntryAtIndex.length);
    ...
    /* access modifiers changed from: private */
    public static final Object[] replaceEntryWithNode(Object[] $this$replaceEntryWithNode, int keyIndex, int nodeIndex, TrieNode<?, ?> newNode) {
        ...
        ArraysKt.copyInto((T[]) $this$replaceEntryWithNode, (T[]) newBuffer, keyIndex, keyIndex + 2, nodeIndex);
        newBuffer[newNodeIndex] = newNode;
        ArraysKt.copyInto((T[]) $this$replaceEntryWithNode, (T[]) newBuffer, newNodeIndex + 1, nodeIndex, $this$replaceEntryWithNode.length);
        return newBuffer;
    }

    /* access modifiers changed from: private */
    public static final <K, V> Object[] replaceNodeWithEntry(Object[] $this$replaceNodeWithEntry, int nodeIndex, int keyIndex, K key, V value) {
        ...
        ArraysKt.copyInto((T[]) newBuffer, (T[]) newBuffer, nodeIndex + 2, nodeIndex + 1, $this$replaceNodeWithEntry.length);
        ArraysKt.copyInto((T[]) newBuffer, (T[]) newBuffer, keyIndex + 2, keyIndex, nodeIndex);
        newBuffer[keyIndex] = key;
        newBuffer[keyIndex + 1] = value;
        return newBuffer;
    }
    ...
    public static final Object[] removeEntryAtIndex(Object[] $this$removeEntryAtIndex, int keyIndex) {
        ...
        ArraysKt.copyInto((T[]) $this$removeEntryAtIndex, (T[]) newBuffer, keyIndex, keyIndex + 2, $this$removeEntryAtIndex.length);
        return newBuffer;
    }
    ...
    public static final Object[] removeNodeAtIndex(Object[] $this$removeNodeAtIndex, int nodeIndex) {
        ...
        ArraysKt.copyInto((T[]) $this$removeNodeAtIndex, (T[]) newBuffer, nodeIndex, nodeIndex + 1, $this$removeNodeAtIndex.length);
        return newBuffer;
    }
}
