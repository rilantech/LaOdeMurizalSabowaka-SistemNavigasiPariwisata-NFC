...
public final class PersistentOrderedSetMutableIterator<E> extends PersistentOrderedSetIterator<E> implements Iterator<E>, KMutableIterator {
    ...
    public PersistentOrderedSetMutableIterator(PersistentOrderedSetBuilder<E> builder2) {
        super(builder2.getFirstElement$runtime_release(), builder2.getHashMapBuilder$runtime_release());
        Intrinsics.checkNotNullParameter(builder2, "builder");
        this.builder = builder2;
        this.expectedModCount = builder2.getHashMapBuilder$runtime_release().getModCount$runtime_release();
    }
