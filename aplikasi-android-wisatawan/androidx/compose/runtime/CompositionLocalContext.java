...
public final class CompositionLocalContext {
    ...
    public CompositionLocalContext(PersistentCompositionLocalMap compositionLocals2) {
        Intrinsics.checkNotNullParameter(compositionLocals2, "compositionLocals");
        this.compositionLocals = compositionLocals2;
    }
