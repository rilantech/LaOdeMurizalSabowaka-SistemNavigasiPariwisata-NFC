...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    private static final class FrameAwaiter<R> {
        ...
        public final void resume(long timeNanos) {
            ...
            try {
                ...
                obj = Result.m6229constructorimpl(this.onFrame.invoke(Long.valueOf(timeNanos)));
            } catch (Throwable th) {
    ...
    public <R> java.lang.Object withFrameNanos(kotlin.jvm.functions.Function1<? super java.lang.Long, ? extends R> r17, kotlin.coroutines.Continuation<? super R> r18) {
        /*
            ...
            java.lang.Object r13 = kotlin.Result.m6229constructorimpl(r13)     // Catch:{ all -> 0x00aa }
        ...
        synchronized (this.lock) {
            if (this.failureCause == null) {
                ...
                for (int index$iv = 0; index$iv < size; index$iv++) {
                    ...
                    Result.Companion companion = Result.Companion;
                    continuation.resumeWith(Result.m6229constructorimpl(ResultKt.createFailure(cause)));
                }
                this.awaiters.clear();
                Unit unit = Unit.INSTANCE;
            }
