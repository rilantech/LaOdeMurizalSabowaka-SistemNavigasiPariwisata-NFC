...
public abstract class Snapshot {
    ...
    private Snapshot(int id2, SnapshotIdSet invalid2) {
        this.invalid = invalid2;
        this.id = id2;
        this.pinningTrackingHandle = id2 != 0 ? SnapshotKt.trackPinning(id2, getInvalid$runtime_release()) : -1;
    }
    ...
    public static final class Companion {
        ...
        public final <T> T global(Function0<? extends T> block) {
            ...
            T t = invoke;
            Snapshot.Companion.restoreCurrent(previous);
            return invoke;
        }
        ...
        public final <R> R withMutableSnapshot(Function0<? extends R> block) {
            ...
            Intrinsics.checkNotNullParameter(block, "block");
            MutableSnapshot $this$withMutableSnapshot_u24lambda_u242 = takeMutableSnapshot$default(this, (Function1) null, (Function1) null, 3, (Object) null);
            try {
                this_$iv = $this$withMutableSnapshot_u24lambda_u242;
                previous$iv = this_$iv.makeCurrent();
                R invoke = block.invoke();
                InlineMarker.finallyStart(1);
                this_$iv.restoreCurrent(previous$iv);
                InlineMarker.finallyEnd(1);
                Snapshot this_$iv2 = invoke;
        ...
        public final <T> T observe(Function1<Object, Unit> readObserver, Function1<Object, Unit> writeObserver, Function0<? extends T> block) {
            ...
            Snapshot currentSnapshot = (Snapshot) SnapshotKt.threadSnapshot.get();
        ...
        public final ObserverHandle registerGlobalWriteObserver(Function1<Object, Unit> observer) {
            ...
            return new Snapshot$Companion$registerGlobalWriteObserver$2(observer);
        }
