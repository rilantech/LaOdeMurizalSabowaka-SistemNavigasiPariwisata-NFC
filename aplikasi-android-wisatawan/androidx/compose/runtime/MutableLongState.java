...
public interface MutableLongState extends LongState, MutableState<Long> {
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static Long getValue(MutableLongState $this) {
            return Long.valueOf(MutableLongState.super.getValue().longValue());
        }

        @Deprecated
        public static void setValue(MutableLongState $this, long value) {
            MutableLongState.super.setValue(value);
        }
    }
