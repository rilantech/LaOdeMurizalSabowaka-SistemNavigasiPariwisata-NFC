...
public interface MutableFloatState extends FloatState, MutableState<Float> {
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static Float getValue(MutableFloatState $this) {
            return Float.valueOf(MutableFloatState.super.getValue().floatValue());
        }

        @Deprecated
        public static void setValue(MutableFloatState $this, float value) {
            MutableFloatState.super.setValue(value);
        }
    }
