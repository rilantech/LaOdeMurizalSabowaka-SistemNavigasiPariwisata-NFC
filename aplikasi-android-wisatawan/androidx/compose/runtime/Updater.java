...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m2864boximpl(Composer composer2) {
        return new Updater(composer2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Composer m2865constructorimpl(Composer composer2) {
        Intrinsics.checkNotNullParameter(composer2, "composer");
        return composer2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2866equalsimpl(Composer composer2, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual((Object) composer2, (Object) ((Updater) obj).m2876unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2867equalsimpl0(Composer composer2, Composer composer3) {
    ...
    public static int m2868hashCodeimpl(Composer composer2) {
        return composer2.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2873toStringimpl(Composer composer2) {
        return "Updater(composer=" + composer2 + ')';
    }

    public boolean equals(Object obj) {
        return m2866equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2868hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2873toStringimpl(this.composer);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Composer m2876unboximpl() {
    ...
    public static final void m2871setimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> block) {
    ...
    /* renamed from: set-impl  reason: not valid java name */
    public static final <V> void m2872setimpl(Composer arg0, V value, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2874updateimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    /* renamed from: update-impl  reason: not valid java name */
    public static final <V> void m2875updateimpl(Composer arg0, V value, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2869initimpl(Composer arg0, Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2870reconcileimpl(Composer arg0, Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
