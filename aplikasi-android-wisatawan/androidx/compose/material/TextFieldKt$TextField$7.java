...
final class TextFieldKt$TextField$7 extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
    ...
    public final void invoke(Function2<? super Composer, ? super Integer, Unit> innerTextField, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation(composer, "C399@19753L543:TextField.kt#jmzs0o");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
        ...
        if (($dirty2 & 91) != 18 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-126640971, $dirty2, -1, "androidx.compose.material.TextField.<anonymous> (TextField.kt:397)");
            }
            ...
            int i2 = this.$$dirty1;
            int i3 = $dirty2;
            TextFieldDefaults.INSTANCE.TextFieldDecorationBox(this.$value.getText(), innerTextField, this.$enabled, this.$singleLine, this.$visualTransformation, this.$interactionSource, z, function22, function23, function24, function25, textFieldColors, (PaddingValues) null, $composer, ((i2 >> 3) & 7168) | (($dirty2 << 3) & 112) | ((i >> 3) & 896) | ((i2 << 9) & 57344) | ((i2 >> 6) & 458752) | ((i2 << 18) & 3670016) | ((i << 3) & 29360128) | ((i << 3) & 234881024) | ((i << 3) & 1879048192), ((i >> 27) & 14) | 3072 | ((i2 >> 24) & 112), 4096);
            if (ComposerKt.isTraceInProgress()) {
