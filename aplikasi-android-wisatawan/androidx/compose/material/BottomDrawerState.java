...
public final class BottomDrawerState {
    ...
    public BottomDrawerState(BottomDrawerValue initialValue, Function1<? super BottomDrawerValue, Boolean> confirmStateChange) {
        ...
        BottomDrawerValue bottomDrawerValue = initialValue;
        AnchoredDraggableState anchoredDraggableState2 = new AnchoredDraggableState(bottomDrawerValue, new BottomDrawerState$anchoredDraggableState$1(this), new BottomDrawerState$anchoredDraggableState$2(this), DrawerKt.AnimationSpec, confirmStateChange);
        this.anchoredDraggableState = anchoredDraggableState2;
        this.nestedScrollConnection = DrawerKt.ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection(anchoredDraggableState2);
    }
    ...
    public final Object open(Continuation<? super Unit> $completion) {
        Object animateTo$default = AnchoredDraggableKt.animateTo$default(this.anchoredDraggableState, isOpenEnabled() ? BottomDrawerValue.Open : BottomDrawerValue.Expanded, 0.0f, $completion, 2, (Object) null);
        return animateTo$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo$default : Unit.INSTANCE;
    }

    public final Object close(Continuation<? super Unit> $completion) {
        Object animateTo$default = AnchoredDraggableKt.animateTo$default(this.anchoredDraggableState, BottomDrawerValue.Closed, 0.0f, $completion, 2, (Object) null);
        return animateTo$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo$default : Unit.INSTANCE;
    }

    public final Object expand(Continuation<? super Unit> $completion) {
        Object animateTo$default = AnchoredDraggableKt.animateTo$default(this.anchoredDraggableState, BottomDrawerValue.Expanded, 0.0f, $completion, 2, (Object) null);
        return animateTo$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo$default : Unit.INSTANCE;
    }
    ...
    public final Object animateTo$material_release(BottomDrawerValue target, float velocity, Continuation<? super Unit> $completion) {
        Object animateTo = AnchoredDraggableKt.animateTo(this.anchoredDraggableState, target, velocity, $completion);
        return animateTo == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo : Unit.INSTANCE;
    }

    public final Object snapTo$material_release(BottomDrawerValue target, Continuation<? super Unit> $completion) {
    ...
    public static final class Companion {
        ...
        public final Saver<BottomDrawerState, BottomDrawerValue> Saver(Density density, Function1<? super BottomDrawerValue, Boolean> confirmStateChange) {
