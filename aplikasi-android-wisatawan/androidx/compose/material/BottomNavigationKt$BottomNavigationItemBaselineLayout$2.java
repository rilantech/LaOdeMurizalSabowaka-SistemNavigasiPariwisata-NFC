...
final class BottomNavigationKt$BottomNavigationItemBaselineLayout$2 implements MeasurePolicy {
    ...
    public final MeasureResult m1191measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        Placeable placeable;
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv), (Object) "icon")) {
                Placeable iconPlaceable = ((Measurable) element$iv).m4689measureBRTryo0(j);
                Function2 it = this.$label;
                if (it != null) {
                    for (Object element$iv2 : $this$first$iv) {
                        Function2 it2 = it;
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv2), (Object) "label")) {
                            placeable = ((Measurable) element$iv2).m4689measureBRTryo0(Constraints.m5779copyZbe2FdA$default(constraints, 0, 0, 0, 0, 11, (Object) null));
                        } else {
                            it = it2;
                        }
                    }
                ...
                if (this.$label == null) {
                    ...
                    return BottomNavigationKt.m1189placeIcon3p2s80s(measureScope, iconPlaceable, j);
                }
                Intrinsics.checkNotNull(labelPlaceable);
                Placeable placeable3 = iconPlaceable;
                return BottomNavigationKt.m1190placeLabelAndIconDIyivk0($this$Layout, labelPlaceable, iconPlaceable, constraints, this.$iconPositionAnimationProgress);
            }
            j = constraints;
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
