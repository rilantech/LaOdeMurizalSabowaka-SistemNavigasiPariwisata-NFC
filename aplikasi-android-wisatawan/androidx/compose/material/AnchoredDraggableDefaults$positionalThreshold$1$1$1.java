...
final class AnchoredDraggableDefaults$positionalThreshold$1$1$1 extends Lambda implements Function1<Float, Float> {
    ...
    AnchoredDraggableDefaults$positionalThreshold$1$1$1(Density density) {
        super(1);
        this.$this_with = density;
    }

    public final Float invoke(float it) {
        return Float.valueOf(this.$this_with.m5825toPx0680j_4(Dp.m5844constructorimpl((float) 56)));
    }
