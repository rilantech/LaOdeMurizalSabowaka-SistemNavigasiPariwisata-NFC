...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public final long m1339getSizeMYxV2XQ() {
        return this.size;
    }

    /* renamed from: measure-3p2s80s  reason: not valid java name */
    public MeasureResult m1340measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        int width = Math.max(placeable.getWidth(), $this$measure_u2d3p2s80s.m5819roundToPx0680j_4(DpSize.m5942getWidthD9Ej5fM(this.size)));
        int height = Math.max(placeable.getHeight(), $this$measure_u2d3p2s80s.m5819roundToPx0680j_4(DpSize.m5940getHeightD9Ej5fM(this.size)));
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m5939equalsimpl0(this.size, otherModifier.size);
    }
