...
public final class AppBarDefaults {
    ...
    private static final float BottomAppBarElevation = Dp.m5844constructorimpl((float) 8);
    private static final PaddingValues ContentPadding = PaddingKt.m535PaddingValuesa9UjIt4$default(AppBarKt.AppBarHorizontalPadding, 0.0f, AppBarKt.AppBarHorizontalPadding, 0.0f, 10, (Object) null);
    public static final AppBarDefaults INSTANCE = new AppBarDefaults();
    private static final float TopAppBarElevation = Dp.m5844constructorimpl((float) 4);

    private AppBarDefaults() {
    }

    /* renamed from: getTopAppBarElevation-D9Ej5fM  reason: not valid java name */
    public final float m1162getTopAppBarElevationD9Ej5fM() {
        return TopAppBarElevation;
    }

    /* renamed from: getBottomAppBarElevation-D9Ej5fM  reason: not valid java name */
    public final float m1161getBottomAppBarElevationD9Ej5fM() {
