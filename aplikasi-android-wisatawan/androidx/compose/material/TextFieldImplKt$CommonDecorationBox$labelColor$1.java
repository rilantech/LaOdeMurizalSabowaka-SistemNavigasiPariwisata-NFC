...
final class TextFieldImplKt$CommonDecorationBox$labelColor$1 extends Lambda implements Function3<InputPhase, Composer, Integer, Color> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2, Object p3) {
        return Color.m3243boximpl(m1478invokeXeAY9LY((InputPhase) p1, (Composer) p2, ((Number) p3).intValue()));
    }

    /* renamed from: invoke-XeAY9LY  reason: not valid java name */
    public final long m1478invokeXeAY9LY(InputPhase it, Composer $composer, int $changed) {
        ...
        int i = this.$$dirty1;
        long r0 = textFieldColors.labelColor(z, z2, interactionSource, $composer, ((this.$$dirty >> 27) & 14) | ((i << 3) & 896) | (i & 7168)).getValue().m3263unboximpl();
        if (ComposerKt.isTraceInProgress()) {
