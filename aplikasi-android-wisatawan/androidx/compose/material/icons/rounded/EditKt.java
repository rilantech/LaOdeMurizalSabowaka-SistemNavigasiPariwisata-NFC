...
public final class EditKt {
    ...
    public static final ImageVector getEdit(Icons.Rounded $this$Edit) {
        ...
        ImageVector.Builder $this$_get_Edit__u24lambda_u241 = new ImageVector.Builder("Rounded.Edit", Dp.m5844constructorimpl(24.0f), Dp.m5844constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        $this$_get_Edit__u24lambda_u241_u24lambda_u240.moveTo(3.0f, 17.46f);
        $this$_get_Edit__u24lambda_u241_u24lambda_u240.verticalLineToRelative(3.04f);
        PathBuilder pathBuilder = $this$_get_Edit__u24lambda_u241_u24lambda_u240;
        pathBuilder.curveToRelative(0.0f, 0.28f, 0.22f, 0.5f, 0.5f, 0.5f);
        $this$_get_Edit__u24lambda_u241_u24lambda_u240.horizontalLineToRelative(3.04f);
        ...
        $this$_get_Edit__u24lambda_u241_u24lambda_u240.lineTo(3.15f, 17.1f);
        pathBuilder.curveToRelative(-0.1f, 0.1f, -0.15f, 0.22f, -0.15f, 0.36f);
        $this$_get_Edit__u24lambda_u241_u24lambda_u240.close();
        $this$_get_Edit__u24lambda_u241_u24lambda_u240.moveTo(20.71f, 7.04f);
        ...
        ImageVector build = ImageVector.Builder.m3967addPathoIyEayM$default($this$_get_Edit__u24lambda_u241, nodes, VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m3279getBlack0d7_KjU(), (DefaultConstructorMarker) null), 1.0f, (Brush) null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _edit = build;
