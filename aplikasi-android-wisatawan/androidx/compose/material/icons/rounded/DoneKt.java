...
public final class DoneKt {
    ...
    public static final ImageVector getDone(Icons.Rounded $this$Done) {
        ...
        ImageVector.Builder $this$_get_Done__u24lambda_u241 = new ImageVector.Builder("Rounded.Done", Dp.m5844constructorimpl(24.0f), Dp.m5844constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        $this$_get_Done__u24lambda_u241_u24lambda_u240.lineToRelative(-3.5f, -3.5f);
        PathBuilder pathBuilder = $this$_get_Done__u24lambda_u241_u24lambda_u240;
        ...
        $this$_get_Done__u24lambda_u241_u24lambda_u240.lineToRelative(4.19f, 4.19f);
        pathBuilder.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        $this$_get_Done__u24lambda_u241_u24lambda_u240.lineTo(20.3f, 7.7f);
        pathBuilder.curveToRelative(0.39f, -0.39f, 0.39f, -1.01f, 0.0f, -1.4f);
        pathBuilder.curveToRelative(-0.39f, -0.39f, -1.01f, -0.39f, -1.4f, 0.0f);
        ...
        ImageVector build = ImageVector.Builder.m3967addPathoIyEayM$default($this$_get_Done__u24lambda_u241, nodes, VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m3279getBlack0d7_KjU(), (DefaultConstructorMarker) null), 1.0f, (Brush) null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _done = build;
