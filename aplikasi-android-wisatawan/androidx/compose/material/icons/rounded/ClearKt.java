...
public final class ClearKt {
    ...
    public static final ImageVector getClear(Icons.Rounded $this$Clear) {
        ...
        ImageVector.Builder $this$_get_Clear__u24lambda_u241 = new ImageVector.Builder("Rounded.Clear", Dp.m5844constructorimpl(24.0f), Dp.m5844constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        Object obj = "Rounded.Clear";
        ImageVector.Builder builder = $this$_get_Clear__u24lambda_u241;
        PathBuilder $this$_get_Clear__u24lambda_u241_u24lambda_u240 = $this$PathData_u24lambda_u240$iv$iv$iv;
        $this$_get_Clear__u24lambda_u241_u24lambda_u240.moveTo(18.3f, 5.71f);
        PathBuilder pathBuilder = $this$_get_Clear__u24lambda_u241_u24lambda_u240;
        pathBuilder.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        $this$_get_Clear__u24lambda_u241_u24lambda_u240.lineTo(12.0f, 10.59f);
        $this$_get_Clear__u24lambda_u241_u24lambda_u240.lineTo(7.11f, 5.7f);
        pathBuilder.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilder.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        $this$_get_Clear__u24lambda_u241_u24lambda_u240.lineTo(10.59f, 12.0f);
        $this$_get_Clear__u24lambda_u241_u24lambda_u240.lineTo(5.7f, 16.89f);
        pathBuilder.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilder.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        $this$_get_Clear__u24lambda_u241_u24lambda_u240.lineTo(12.0f, 13.41f);
        $this$_get_Clear__u24lambda_u241_u24lambda_u240.lineToRelative(4.89f, 4.89f);
        pathBuilder.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilder.curveToRelative(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
