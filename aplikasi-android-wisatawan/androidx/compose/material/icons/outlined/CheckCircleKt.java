...
public final class CheckCircleKt {
    ...
    public static final ImageVector getCheckCircle(Icons.Outlined $this$CheckCircle) {
        ...
        ImageVector.Builder $this$_get_CheckCircle__u24lambda_u241 = new ImageVector.Builder("Outlined.CheckCircle", Dp.m5844constructorimpl(24.0f), Dp.m5844constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        Object obj = "Outlined.CheckCircle";
        ...
        $this$_get_CheckCircle__u24lambda_u241_u24lambda_u240.moveTo(12.0f, 20.0f);
        pathBuilder.curveToRelative(-4.41f, 0.0f, -8.0f, -3.59f, -8.0f, -8.0f);
        $this$_get_CheckCircle__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(3.59f, -8.0f, 8.0f, -8.0f);
        $this$_get_CheckCircle__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(8.0f, 3.59f, 8.0f, 8.0f);
        $this$_get_CheckCircle__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(-3.59f, 8.0f, -8.0f, 8.0f);
        $this$_get_CheckCircle__u24lambda_u241_u24lambda_u240.close();
        $this$_get_CheckCircle__u24lambda_u241_u24lambda_u240.moveTo(16.59f, 7.58f);
        $this$_get_CheckCircle__u24lambda_u241_u24lambda_u240.lineTo(10.0f, 14.17f);
        $this$_get_CheckCircle__u24lambda_u241_u24lambda_u240.lineToRelative(-2.59f, -2.58f);
        $this$_get_CheckCircle__u24lambda_u241_u24lambda_u240.lineTo(6.0f, 13.0f);
        $this$_get_CheckCircle__u24lambda_u241_u24lambda_u240.lineToRelative(4.0f, 4.0f);
        $this$_get_CheckCircle__u24lambda_u241_u24lambda_u240.lineToRelative(8.0f, -8.0f);
        $this$_get_CheckCircle__u24lambda_u241_u24lambda_u240.close();
        List<PathNode> nodes = $this$PathData_u24lambda_u240$iv$iv$iv.getNodes();
        ImageVector build = ImageVector.Builder.m3967addPathoIyEayM$default($this$_get_CheckCircle__u24lambda_u241, nodes, VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m3279getBlack0d7_KjU(), (DefaultConstructorMarker) null), 1.0f, (Brush) null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _checkCircle = build;
