...
public final class PlaceKt {
    ...
    public static final ImageVector getPlace(Icons.Outlined $this$Place) {
        ...
        ImageVector.Builder $this$_get_Place__u24lambda_u241 = new ImageVector.Builder("Outlined.Place", Dp.m5844constructorimpl(24.0f), Dp.m5844constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        ImageVector build = ImageVector.Builder.m3967addPathoIyEayM$default($this$_get_Place__u24lambda_u241, nodes, VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m3279getBlack0d7_KjU(), (DefaultConstructorMarker) null), 1.0f, (Brush) null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _place = build;
