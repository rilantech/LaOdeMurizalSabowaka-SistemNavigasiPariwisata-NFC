...
public final class KeyboardArrowUpKt {
    ...
    public static final ImageVector getKeyboardArrowUp(Icons.Outlined $this$KeyboardArrowUp) {
        ...
        ImageVector.Builder $this$_get_KeyboardArrowUp__u24lambda_u241 = new ImageVector.Builder("Outlined.KeyboardArrowUp", Dp.m5844constructorimpl(24.0f), Dp.m5844constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        Object obj = "Outlined.KeyboardArrowUp";
        ...
        $this$_get_KeyboardArrowUp__u24lambda_u241_u24lambda_u240.moveTo(7.41f, 15.41f);
        $this$_get_KeyboardArrowUp__u24lambda_u241_u24lambda_u240.lineTo(12.0f, 10.83f);
        $this$_get_KeyboardArrowUp__u24lambda_u241_u24lambda_u240.lineToRelative(4.59f, 4.58f);
        $this$_get_KeyboardArrowUp__u24lambda_u241_u24lambda_u240.lineTo(18.0f, 14.0f);
        $this$_get_KeyboardArrowUp__u24lambda_u241_u24lambda_u240.lineToRelative(-6.0f, -6.0f);
        $this$_get_KeyboardArrowUp__u24lambda_u241_u24lambda_u240.lineToRelative(-6.0f, 6.0f);
        $this$_get_KeyboardArrowUp__u24lambda_u241_u24lambda_u240.lineToRelative(1.41f, 1.41f);
        ...
        ImageVector build = ImageVector.Builder.m3967addPathoIyEayM$default($this$_get_KeyboardArrowUp__u24lambda_u241, nodes, VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m3279getBlack0d7_KjU(), (DefaultConstructorMarker) null), 1.0f, (Brush) null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
