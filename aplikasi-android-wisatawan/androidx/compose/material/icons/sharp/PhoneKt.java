...
public final class PhoneKt {
    ...
    public static final ImageVector getPhone(Icons.Sharp $this$Phone) {
        ...
        ImageVector.Builder $this$_get_Phone__u24lambda_u241 = new ImageVector.Builder("Sharp.Phone", Dp.m5844constructorimpl(24.0f), Dp.m5844constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.moveTo(21.0f, 15.46f);
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.lineToRelative(-5.27f, -0.61f);
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.lineToRelative(-2.52f, 2.52f);
        ...
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.lineToRelative(2.53f, -2.53f);
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.lineTo(8.54f, 3.0f);
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.horizontalLineTo(3.03f);
        pathBuilder.curveTo(2.45f, 13.18f, 10.82f, 21.55f, 21.0f, 20.97f);
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.verticalLineToRelative(-5.51f);
