...
final class BadgeKt$BadgedBox$2 implements MeasurePolicy {
    ...
    public final MeasureResult m1180measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv), (Object) "badge")) {
                Placeable badgePlaceable = ((Measurable) element$iv).m4689measureBRTryo0(Constraints.m5779copyZbe2FdA$default(constraints, 0, 0, 0, 0, 11, (Object) null));
                for (Object element$iv2 : $this$first$iv) {
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv2), (Object) "anchor")) {
                        Placeable anchorPlaceable = ((Measurable) element$iv2).m4689measureBRTryo0(constraints);
