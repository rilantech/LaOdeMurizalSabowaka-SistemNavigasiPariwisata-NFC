...
final class CheckboxKt$CheckboxImpl$1$1 extends Lambda implements Function1<DrawScope, Unit> {
    ...
    public final void invoke(DrawScope $this$Canvas) {
        ...
        CheckboxKt.m1222drawBox1wkBAMs(drawScope, CheckboxKt.CheckboxImpl$lambda$9(this.$boxColor$delegate), CheckboxKt.CheckboxImpl$lambda$10(this.$borderColor$delegate), $this$Canvas.m5825toPx0680j_4(CheckboxKt.RadiusSize), strokeWidthPx);
        CheckboxKt.m1223drawCheck3IgeMak(drawScope, CheckboxKt.CheckboxImpl$lambda$8(this.$checkColor$delegate), CheckboxKt.CheckboxImpl$lambda$4(this.$checkDrawFraction$delegate), CheckboxKt.CheckboxImpl$lambda$6(this.$checkCenterGravitationShiftFraction$delegate), strokeWidthPx, this.$checkCache);
    }
}
