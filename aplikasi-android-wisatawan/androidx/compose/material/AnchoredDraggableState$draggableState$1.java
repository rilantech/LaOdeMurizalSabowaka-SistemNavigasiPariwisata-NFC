...
public final class AnchoredDraggableState$draggableState$1 implements DraggableState {
    ...
    public final AnchoredDraggableState$draggableState$1$dragScope$1<T> dragScope;
    final /* synthetic */ AnchoredDraggableState<T> this$0;

    AnchoredDraggableState$draggableState$1(AnchoredDraggableState<T> $receiver) {
        this.this$0 = $receiver;
        this.dragScope = new AnchoredDraggableState$draggableState$1$dragScope$1($receiver);
    }
    ...
    public Object drag(MutatePriority dragPriority, Function2<? super DragScope, ? super Continuation<? super Unit>, ? extends Object> block, Continuation<? super Unit> $completion) {
        Object anchoredDrag = this.this$0.anchoredDrag(dragPriority, new AnchoredDraggableState$draggableState$1$drag$2(this, block, (Continuation<? super AnchoredDraggableState$draggableState$1$drag$2>) null), $completion);
