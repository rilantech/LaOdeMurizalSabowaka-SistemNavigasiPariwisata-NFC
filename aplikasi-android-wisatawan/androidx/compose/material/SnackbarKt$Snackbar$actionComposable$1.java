...
final class SnackbarKt$Snackbar$actionComposable$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            ButtonColors r8 = ButtonDefaults.INSTANCE.m1215textButtonColorsRGew2ao(0, this.$actionColor, 0, $composer, ((this.$$dirty >> 15) & 112) | 3072, 5);
            ...
            ButtonKt.TextButton(new Function0<Unit>() {
                ...
                public final void invoke(RowScope $this$TextButton, Composer $composer, int $changed) {
                    ...
                    if ((i & 81) != 16 || !$composer.getSkipping()) {
                        ...
                        TextKt.m1486Text4IGK_g(str, (Modifier) null, 0, 0, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0, (TextDecoration) null, (TextAlign) null, 0, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer, 0, 0, 131070);
                        if (ComposerKt.isTraceInProgress()) {
