...
public final class ExposedDropdownMenuKt$ExposedDropdownMenuBox$scope$1$1 implements ExposedDropdownMenuBoxScope {
    ...
    public Modifier exposedDropdownSize(Modifier $this$exposedDropdownSize, boolean matchTextFieldWidth) {
        ...
        Modifier it = SizeKt.m600heightInVpY3zN4$default($this$exposedDropdownSize, 0.0f, $this$exposedDropdownSize_u24lambda_u241.m5822toDpu2uoSUM(ExposedDropdownMenuKt.ExposedDropdownMenuBox$lambda$4(mutableIntState)), 1, (Object) null);
        if (matchTextFieldWidth) {
            return SizeKt.m617width3ABfNKs(it, $this$exposedDropdownSize_u24lambda_u241.m5822toDpu2uoSUM(ExposedDropdownMenuKt.ExposedDropdownMenuBox$lambda$1(mutableIntState2)));
        }
        return it;
    }
}
