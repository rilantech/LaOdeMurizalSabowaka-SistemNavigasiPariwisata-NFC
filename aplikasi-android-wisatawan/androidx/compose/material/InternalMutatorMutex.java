...
public final class InternalMutatorMutex {
    ...
    private static final class Mutator {
        ...
        public Mutator(MutatePriority priority2, Job job2) {
    ...
    public final <R> Object mutate(MutatePriority priority, Function1<? super Continuation<? super R>, ? extends Object> block, Continuation<? super R> $completion) {
        return CoroutineScopeKt.coroutineScope(new InternalMutatorMutex$mutate$2(priority, this, block, (Continuation<? super InternalMutatorMutex$mutate$2>) null), $completion);
    }
    ...
    public final <T, R> Object mutateWith(T receiver, MutatePriority priority, Function2<? super T, ? super Continuation<? super R>, ? extends Object> block, Continuation<? super R> $completion) {
        return CoroutineScopeKt.coroutineScope(new InternalMutatorMutex$mutateWith$2(priority, this, block, receiver, (Continuation<? super InternalMutatorMutex$mutateWith$2>) null), $completion);
    }

    public final boolean tryMutate(Function0<Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        boolean didLock = Mutex.DefaultImpls.tryLock$default(this.mutex, (Object) null, 1, (Object) null);
        if (didLock) {
            try {
                block.invoke();
            } finally {
