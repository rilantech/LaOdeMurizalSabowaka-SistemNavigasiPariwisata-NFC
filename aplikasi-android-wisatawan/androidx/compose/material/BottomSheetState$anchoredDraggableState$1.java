...
final class BottomSheetState$anchoredDraggableState$1 extends Lambda implements Function1<Float, Float> {
    ...
    BottomSheetState$anchoredDraggableState$1(BottomSheetState bottomSheetState) {
        super(1);
    ...
    public final Float invoke(float it) {
        return Float.valueOf(this.this$0.requireDensity().m5825toPx0680j_4(BottomSheetScaffoldKt.BottomSheetScaffoldPositionalThreshold));
    }
}
