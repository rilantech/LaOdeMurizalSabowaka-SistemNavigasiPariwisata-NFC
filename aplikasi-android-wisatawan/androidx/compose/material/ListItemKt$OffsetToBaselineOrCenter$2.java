...
final class ListItemKt$OffsetToBaselineOrCenter$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ListItemKt.m1330OffsetToBaselineOrCenterKz89ssw(this.$offset, this.$modifier, this.$content, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), this.$$default);
    }
}
