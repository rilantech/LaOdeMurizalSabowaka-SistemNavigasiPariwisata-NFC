...
public final class TabRowDefaults$tabIndicatorOffset$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$tabIndicatorOffset_u24lambda_u240 = $this$null;
        $this$tabIndicatorOffset_u24lambda_u240.setName("tabIndicatorOffset");
        $this$tabIndicatorOffset_u24lambda_u240.setValue(this.$currentTabPosition$inlined);
    }
}
