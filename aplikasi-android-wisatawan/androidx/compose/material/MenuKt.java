...
public final class MenuKt {
    ...
    private static final float DropdownMenuItemDefaultMinHeight = Dp.m5844constructorimpl((float) 48);
    private static final float DropdownMenuItemDefaultMinWidth = Dp.m5844constructorimpl((float) 112);
    /* access modifiers changed from: private */
    public static final float DropdownMenuItemHorizontalPadding = Dp.m5844constructorimpl((float) 16);
    private static final float DropdownMenuVerticalPadding = Dp.m5844constructorimpl((float) 8);
    public static final int InTransitionDuration = 120;
    private static final float MenuElevation = Dp.m5844constructorimpl((float) 8);
    ...
    public static final void DropdownMenuContent(MutableTransitionState<Boolean> expandedStates, MutableState<TransformOrigin> transformOriginState, ScrollState scrollState, Modifier modifier, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        ...
        if ((46811 & $dirty2) != 9362 || !$composer2.getSkipping()) {
            ...
            CardKt.m1217CardFjzlyU(GraphicsLayerModifierKt.graphicsLayer(modifier6, (Function1) value$iv$iv), (Shape) null, 0, 0, (BorderStroke) null, MenuElevation, ComposableLambdaKt.composableLambda($composer2, 895555282, true, new MenuKt$DropdownMenuContent$2(modifier7, scrollState, function3, $dirty2)), $composer2, 1769472, 30);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier3 = modifier7;
    ...
    public static final void DropdownMenuItemContent(kotlin.jvm.functions.Function0<kotlin.Unit> r34, androidx.compose.ui.Modifier r35, boolean r36, androidx.compose.foundation.layout.PaddingValues r37, androidx.compose.foundation.interaction.MutableInteractionSource r38, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r39, androidx.compose.runtime.Composer r40, int r41, int r42) {
        ...
        L_0x013f:
            ...
            r23 = 0
            r21 = 0
            androidx.compose.ui.Modifier r0 = androidx.compose.foundation.layout.SizeKt.m616sizeInqDBjuR0$default(r17, r18, r19, r20, r21, r22, r23)
        ...
        L_0x01fb:
            ...
            androidx.compose.runtime.Updater.m2872setimpl((androidx.compose.runtime.Composer) r3, r4, r6)
            androidx.compose.ui.node.ComposeUiNode$Companion r6 = androidx.compose.ui.node.ComposeUiNode.Companion
            kotlin.jvm.functions.Function2 r6 = r6.getSetResolvedCompositionLocals()
            androidx.compose.runtime.Updater.m2872setimpl((androidx.compose.runtime.Composer) r3, r2, r6)
            androidx.compose.ui.node.ComposeUiNode$Companion r6 = androidx.compose.ui.node.ComposeUiNode.Companion
