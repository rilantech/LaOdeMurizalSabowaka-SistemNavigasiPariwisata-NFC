...
public final class SliderDefaults {
    ...
    public final SliderColors m1393colorsq0g_0yA(long thumbColor, long disabledThumbColor, long activeTrackColor, long inactiveTrackColor, long disabledActiveTrackColor, long disabledInactiveTrackColor, long activeTickColor, long inactiveTickColor, long disabledActiveTickColor, long disabledInactiveTickColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        long thumbColor2 = (i3 & 1) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m1241getPrimary0d7_KjU() : thumbColor;
        if ((i3 & 2) != 0) {
            disabledThumbColor2 = ColorKt.m3298compositeOverOWjLjI(Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1240getOnSurface0d7_KjU(), ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColors(composer, 6).m1245getSurface0d7_KjU());
        } else {
            disabledThumbColor2 = disabledThumbColor;
        }
        if ((i3 & 4) != 0) {
            activeTrackColor2 = MaterialTheme.INSTANCE.getColors(composer, 6).m1241getPrimary0d7_KjU();
        } else {
            activeTrackColor2 = activeTrackColor;
        }
        if ((i3 & 8) != 0) {
            inactiveTrackColor2 = Color.m3252copywmQWz5c$default(activeTrackColor2, 0.24f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            inactiveTrackColor2 = inactiveTrackColor;
        }
        if ((i3 & 16) != 0) {
            disabledActiveTrackColor2 = Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1240getOnSurface0d7_KjU(), 0.32f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledActiveTrackColor2 = disabledActiveTrackColor;
        }
        if ((i3 & 32) != 0) {
            disabledInactiveTrackColor2 = Color.m3252copywmQWz5c$default(disabledActiveTrackColor2, 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledInactiveTrackColor2 = disabledInactiveTrackColor;
        }
        if ((i3 & 64) != 0) {
            activeTickColor2 = Color.m3252copywmQWz5c$default(ColorsKt.m1259contentColorForek8zF_U(activeTrackColor2, composer, (i2 >> 6) & 14), 0.54f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            activeTickColor2 = activeTickColor;
        }
        if ((i3 & 128) != 0) {
            inactiveTickColor2 = Color.m3252copywmQWz5c$default(activeTrackColor2, 0.54f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            inactiveTickColor2 = inactiveTickColor;
        }
        if ((i3 & 256) != 0) {
            disabledActiveTickColor2 = Color.m3252copywmQWz5c$default(activeTickColor2, 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledActiveTickColor2 = disabledActiveTickColor;
        }
        if ((i3 & 512) != 0) {
            disabledInactiveTickColor2 = Color.m3252copywmQWz5c$default(disabledInactiveTrackColor2, 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
