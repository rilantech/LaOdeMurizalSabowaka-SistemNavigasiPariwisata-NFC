...
final class PullRefreshNestedScrollConnection implements NestedScrollConnection {
    ...
    public PullRefreshNestedScrollConnection(Function1<? super Float, Float> onPull2, Function2<? super Float, ? super Continuation<? super Float>, ? extends Object> onRelease2, boolean enabled2) {
        Intrinsics.checkNotNullParameter(onPull2, "onPull");
        Intrinsics.checkNotNullParameter(onRelease2, "onRelease");
        this.onPull = onPull2;
        this.onRelease = onRelease2;
        this.enabled = enabled2;
    }

    /* renamed from: onPreScroll-OzD1aCk  reason: not valid java name */
    public long m1509onPreScrollOzD1aCk(long available, int source) {
        if (!this.enabled) {
            return Offset.Companion.m3019getZeroF1C5BW0();
        }
        if (!NestedScrollSource.m4372equalsimpl0(source, NestedScrollSource.Companion.m4377getDragWNlRxjI()) || Offset.m3004getYimpl(available) >= 0.0f) {
            return Offset.Companion.m3019getZeroF1C5BW0();
        }
        return OffsetKt.Offset(0.0f, this.onPull.invoke(Float.valueOf(Offset.m3004getYimpl(available))).floatValue());
    }

    /* renamed from: onPostScroll-DzOQY0M  reason: not valid java name */
    public long m1507onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (!this.enabled) {
            return Offset.Companion.m3019getZeroF1C5BW0();
        }
        if (!NestedScrollSource.m4372equalsimpl0(source, NestedScrollSource.Companion.m4377getDragWNlRxjI()) || Offset.m3004getYimpl(available) <= 0.0f) {
    ...
    public java.lang.Object m1508onPreFlingQWom1Mo(long r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r10) {
        /*
            r7 = this;
        ...
        L_0x0035:
            ...
            float r4 = androidx.compose.ui.unit.Velocity.m6070getYimpl(r8)
        ...
        L_0x0050:
            ...
            androidx.compose.ui.unit.Velocity r8 = androidx.compose.ui.unit.Velocity.m6060boximpl(r8)
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.pullrefresh.PullRefreshNestedScrollConnection.m1508onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
