...
public final class PullRefreshDefaults {
    ...
    private static final float RefreshThreshold = Dp.m5844constructorimpl((float) 80);
    private static final float RefreshingOffset = Dp.m5844constructorimpl((float) 56);

    private PullRefreshDefaults() {
    }

    /* renamed from: getRefreshThreshold-D9Ej5fM  reason: not valid java name */
    public final float m1500getRefreshThresholdD9Ej5fM() {
        return RefreshThreshold;
    }

    /* renamed from: getRefreshingOffset-D9Ej5fM  reason: not valid java name */
    public final float m1501getRefreshingOffsetD9Ej5fM() {
