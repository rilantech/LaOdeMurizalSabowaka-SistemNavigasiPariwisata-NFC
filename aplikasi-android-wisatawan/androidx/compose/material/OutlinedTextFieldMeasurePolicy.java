...
final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult m1367measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> measurables, long constraints) {
        Object obj;
        Object obj2;
        Object obj3;
        ...
        int bottomPadding = measureScope.m5819roundToPx0680j_4(this.paddingValues.m552calculateBottomPaddingD9Ej5fM());
        long relaxedConstraints = Constraints.m5779copyZbe2FdA$default(constraints, 0, 0, 0, 0, 10, (Object) null);
        ...
        Placeable leadingPlaceable = measurable != null ? measurable.m4689measureBRTryo0(relaxedConstraints) : null;
        ...
        Placeable trailingPlaceable = measurable2 != null ? measurable2.m4689measureBRTryo0(ConstraintsKt.m5805offsetNN6EwU$default(relaxedConstraints, -occupiedSpaceHorizontally, 0, 2, (Object) null)) : null;
        int occupiedSpaceHorizontally2 = occupiedSpaceHorizontally + TextFieldImplKt.widthOrZero(trailingPlaceable);
        int labelHorizontalPaddingOffset = measureScope.m5819roundToPx0680j_4(this.paddingValues.m553calculateLeftPaddingu2uoSUM($this$measure_u2d3p2s80s.getLayoutDirection())) + measureScope.m5819roundToPx0680j_4(this.paddingValues.m554calculateRightPaddingu2uoSUM($this$measure_u2d3p2s80s.getLayoutDirection()));
        long labelConstraints = ConstraintsKt.m5804offsetNN6EwU(relaxedConstraints, MathHelpersKt.lerp((-occupiedSpaceHorizontally2) - labelHorizontalPaddingOffset, -labelHorizontalPaddingOffset, this.animationProgress), -bottomPadding);
        ...
        Placeable labelPlaceable = measurable3 != null ? measurable3.m4689measureBRTryo0(labelConstraints) : null;
        if (labelPlaceable != null) {
            Placeable it5 = labelPlaceable;
            long j = labelConstraints;
            this.onLabelMeasured.invoke(Size.m3060boximpl(SizeKt.Size((float) it5.getWidth(), (float) it5.getHeight())));
        }
        long textConstraints2 = Constraints.m5779copyZbe2FdA$default(ConstraintsKt.m5804offsetNN6EwU(constraints, -occupiedSpaceHorizontally2, (-bottomPadding) - Math.max(TextFieldImplKt.heightOrZero(labelPlaceable) / 2, measureScope.m5819roundToPx0680j_4(this.paddingValues.m555calculateTopPaddingD9Ej5fM()))), 0, 0, 0, 0, 11, (Object) null);
        ...
        while (true) {
            ...
            if (it6.hasNext()) {
                ...
                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv), (Object) "TextField")) {
                    Placeable textFieldPlaceable = ((Measurable) element$iv).m4689measureBRTryo0(textConstraints2);
                    long placeholderConstraints = Constraints.m5779copyZbe2FdA$default(textConstraints2, 0, 0, 0, 0, 14, (Object) null);
                    ...
                    Placeable placeholderPlaceable = measurable4 != null ? measurable4.m4689measureBRTryo0(placeholderConstraints) : null;
                    long j3 = constraints;
                    int width = OutlinedTextFieldKt.m1365calculateWidthO3s9Psw(TextFieldImplKt.widthOrZero(leadingPlaceable), TextFieldImplKt.widthOrZero(trailingPlaceable), textFieldPlaceable.getWidth(), TextFieldImplKt.widthOrZero(labelPlaceable), TextFieldImplKt.widthOrZero(placeholderPlaceable), this.animationProgress, j3, $this$measure_u2d3p2s80s.getDensity(), this.paddingValues);
                    int bottomPadding2 = OutlinedTextFieldKt.m1364calculateHeightO3s9Psw(TextFieldImplKt.heightOrZero(leadingPlaceable), TextFieldImplKt.heightOrZero(trailingPlaceable), textFieldPlaceable.getHeight(), TextFieldImplKt.heightOrZero(labelPlaceable), TextFieldImplKt.heightOrZero(placeholderPlaceable), this.animationProgress, j3, $this$measure_u2d3p2s80s.getDensity(), this.paddingValues);
    ...
    private final int intrinsicWidth(androidx.compose.ui.layout.IntrinsicMeasureScope r15, java.util.List<? extends androidx.compose.ui.layout.IntrinsicMeasurable> r16, int r17, kotlin.jvm.functions.Function2<? super androidx.compose.ui.layout.IntrinsicMeasurable, ? super java.lang.Integer, java.lang.Integer> r18) {
        ...
        L_0x0123:
            ...
            int r2 = androidx.compose.material.OutlinedTextFieldKt.m1365calculateWidthO3s9Psw(r3, r4, r5, r6, r7, r8, r9, r11, r12)
            return r2
        L_0x013a:
    ...
    private final int intrinsicHeight(androidx.compose.ui.layout.IntrinsicMeasureScope r15, java.util.List<? extends androidx.compose.ui.layout.IntrinsicMeasurable> r16, int r17, kotlin.jvm.functions.Function2<? super androidx.compose.ui.layout.IntrinsicMeasurable, ? super java.lang.Integer, java.lang.Integer> r18) {
        ...
        L_0x0123:
            ...
            float r11 = r15.getDensity()
            androidx.compose.foundation.layout.PaddingValues r12 = r0.paddingValues
            int r2 = androidx.compose.material.OutlinedTextFieldKt.m1364calculateHeightO3s9Psw(r3, r4, r5, r6, r7, r8, r9, r11, r12)
            return r2
        L_0x013a:
            java.util.NoSuchElementException r4 = new java.util.NoSuchElementException
            java.lang.String r5 = "Collection contains no element matching the predicate."
