...
public final class TabRowDefaults {
    ...
    private static final float DividerThickness = Dp.m5844constructorimpl((float) 1);
    public static final TabRowDefaults INSTANCE = new TabRowDefaults();
    private static final float IndicatorHeight = Dp.m5844constructorimpl((float) 2);
    ...
    public final void m1449Divider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        float f;
        long color2;
        long color3;
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            if ((i4 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    ...
                    $dirty &= -897;
                    color2 = Color.m3252copywmQWz5c$default(((Color) consume).m3263unboximpl(), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
                }
            } else {
            ...
            DividerKt.m1276DivideroMI9zvI(modifier4, color2, thickness3, 0.0f, $composer2, ($dirty & 14) | (($dirty >> 3) & 112) | (($dirty << 3) & 896), 8);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final void m1450Indicator9IZ8Weo(Modifier modifier, float height, long color, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        float f;
        long color2;
        long color3;
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            if ((i4 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    $dirty &= -897;
                    color2 = ((Color) consume).m3263unboximpl();
                }
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
    ...
    public final float m1451getDividerThicknessD9Ej5fM() {
        return DividerThickness;
    }

    /* renamed from: getIndicatorHeight-D9Ej5fM  reason: not valid java name */
    public final float m1452getIndicatorHeightD9Ej5fM() {
        return IndicatorHeight;
    }

    /* renamed from: getScrollableTabRowPadding-D9Ej5fM  reason: not valid java name */
    public final float m1453getScrollableTabRowPaddingD9Ej5fM() {
