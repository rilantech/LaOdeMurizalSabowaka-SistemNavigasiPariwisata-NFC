...
public final class TextFieldDefaults$indicatorLinegv0btCI$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        $this$indicatorLine_gv0btCI_u24lambda_u240.getProperties().set("focusedIndicatorLineThickness", Dp.m5842boximpl(this.$focusedIndicatorLineThickness$inlined));
        $this$indicatorLine_gv0btCI_u24lambda_u240.getProperties().set("unfocusedIndicatorLineThickness", Dp.m5842boximpl(this.$unfocusedIndicatorLineThickness$inlined));
    }
}
