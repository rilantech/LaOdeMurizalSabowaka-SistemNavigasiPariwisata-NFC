...
public final class PlatformRipple extends Ripple {
    ...
    public RippleIndicationInstance m1514rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean bounded, float radius, State<Color> color, State<RippleAlpha> rippleAlpha, Composer $composer, int $changed) {
