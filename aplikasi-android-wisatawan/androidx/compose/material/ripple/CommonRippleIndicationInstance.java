...
public final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        ...
        m1522drawStateLayerH2RKhps($this$drawIndication, this.radius, color2);
        m1512drawRipples4WTKRHQ($this$drawIndication, color2);
    }
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        RippleAnimation rippleAnimation = new RippleAnimation(this.bounded ? Offset.m2992boximpl(interaction.m387getPressPositionF1C5BW0()) : null, this.radius, this.bounded, (DefaultConstructorMarker) null);
    ...
    private final void m1512drawRipples4WTKRHQ(DrawScope $this$drawRipples_u2d4WTKRHQ, long color2) {
        for (Map.Entry element$iv : this.ripples.entrySet()) {
            ...
            if (!(alpha == 0.0f)) {
                $this$drawRipples_4WTKRHQ_u24lambda_u242_u24lambda_u241.m1516draw4WTKRHQ($this$drawRipples_u2d4WTKRHQ, Color.m3252copywmQWz5c$default(color2, alpha, 0.0f, 0.0f, 0.0f, 14, (Object) null));
            } else {
