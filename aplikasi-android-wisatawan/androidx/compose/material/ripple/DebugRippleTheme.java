...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long m1513defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long r0 = RippleTheme.Companion.m1526defaultRippleColor5vOe2sY(Color.Companion.m3279getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        RippleAlpha r0 = RippleTheme.Companion.m1525defaultRippleAlphaDxMtmZc(Color.Companion.m3279getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
