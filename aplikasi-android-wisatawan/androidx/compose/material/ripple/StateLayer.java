...
final class StateLayer {
    ...
    public final void m1527drawStateLayerH2RKhps(DrawScope $this$drawStateLayer_u2dH2RKhps, float radius, long color) {
        float targetRadius;
        DrawScope drawScope = $this$drawStateLayer_u2dH2RKhps;
        Intrinsics.checkNotNullParameter(drawScope, "$this$drawStateLayer");
        if (Float.isNaN(radius)) {
            targetRadius = RippleAnimationKt.m1517getRippleEndRadiuscSwnlzA(drawScope, this.bounded, $this$drawStateLayer_u2dH2RKhps.m3866getSizeNHjbRc());
        } else {
            targetRadius = $this$drawStateLayer_u2dH2RKhps.m5825toPx0680j_4(radius);
        }
        float alpha = this.animatedAlpha.getValue().floatValue();
        if (alpha > 0.0f) {
            long modulatedColor = Color.m3252copywmQWz5c$default(color, alpha, 0.0f, 0.0f, 0.0f, 14, (Object) null);
            if (this.bounded) {
                ...
                DrawScope.m3829drawCircleVaOC9Bg$default($this$withTransform$iv$iv, modulatedColor, targetRadius, 0, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 124, (Object) null);
            ...
            DrawScope.m3829drawCircleVaOC9Bg$default($this$drawStateLayer_u2dH2RKhps, modulatedColor, targetRadius, 0, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 124, (Object) null);
        }
    }
}
