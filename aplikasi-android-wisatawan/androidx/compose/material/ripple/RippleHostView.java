...
public final class RippleHostView extends View {
    ...
    public final void m1520addRippleKOepWvA(PressInteraction.Press interaction, boolean bounded2, long size, int radius, long color, float alpha, Function0<Unit> onInvalidateRipple2) {
        boolean z = bounded2;
        ...
        m1521updateRipplePropertiesbiQXAtU(size, radius, color, alpha);
        if (z) {
            ripple2.setHotspot(Offset.m3003getXimpl(interaction.m387getPressPositionF1C5BW0()), Offset.m3004getYimpl(interaction.m387getPressPositionF1C5BW0()));
        } else {
    ...
    public final void m1521updateRipplePropertiesbiQXAtU(long size, int radius, long color, float alpha) {
        UnprojectedRipple ripple2 = this.ripple;
        if (ripple2 != null) {
            ripple2.trySetRadius(radius);
            ripple2.m1529setColorDxMtmZc(color, alpha);
            Rect newBounds = new Rect(0, 0, MathKt.roundToInt(Size.m3072getWidthimpl(size)), MathKt.roundToInt(Size.m3069getHeightimpl(size)));
