...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m5844constructorimpl((float) 10);
    ...
    public static final float m1518getRippleStartRadiusuvyYCjk(long size) {
        return Math.max(Size.m3072getWidthimpl(size), Size.m3069getHeightimpl(size)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA  reason: not valid java name */
    public static final float m1517getRippleEndRadiuscSwnlzA(Density $this$getRippleEndRadius_u2dcSwnlzA, boolean bounded, long size) {
        Intrinsics.checkNotNullParameter($this$getRippleEndRadius_u2dcSwnlzA, "$this$getRippleEndRadius");
        float radiusCoveringBounds = Offset.m3001getDistanceimpl(OffsetKt.Offset(Size.m3072getWidthimpl(size), Size.m3069getHeightimpl(size))) / 2.0f;
        if (bounded) {
            return $this$getRippleEndRadius_u2dcSwnlzA.m5825toPx0680j_4(BoundedRippleExtraRadius) + radiusCoveringBounds;
        }
