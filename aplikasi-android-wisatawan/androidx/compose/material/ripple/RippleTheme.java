...
public interface RippleTheme {
    ...
    long m1524defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1526defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            float contentLuminance = ColorKt.m3305luminance8_81llA(contentColor);
            if (lightTheme || ((double) contentLuminance) >= 0.5d) {
                return contentColor;
            }
            return Color.Companion.m3290getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc  reason: not valid java name */
        public final RippleAlpha m1525defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            if (!lightTheme) {
                return RippleThemeKt.DarkThemeRippleAlpha;
            }
            if (((double) ColorKt.m3305luminance8_81llA(contentColor)) > 0.5d) {
