...
public final class CommonRipple extends Ripple {
    ...
    public RippleIndicationInstance m1511rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean bounded, float radius, State<Color> color, State<RippleAlpha> rippleAlpha, Composer $composer, int $changed) {
