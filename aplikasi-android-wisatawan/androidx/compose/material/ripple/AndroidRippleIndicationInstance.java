...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    private AndroidRippleIndicationInstance(boolean bounded2, float radius2, State<Color> color2, State<RippleAlpha> rippleAlpha2, RippleContainer rippleContainer2) {
        ...
        Intrinsics.checkNotNullParameter(rippleContainer2, "rippleContainer");
        ...
        this.rippleSize = Size.Companion.m3081getZeroNHjbRc();
        this.rippleRadius = -1;
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        ...
        Intrinsics.checkNotNullParameter($this$drawIntoCanvas$iv, "<this>");
        this.rippleSize = $this$drawIndication.m3866getSizeNHjbRc();
        if (Float.isNaN(this.radius)) {
            i = MathKt.roundToInt(RippleAnimationKt.m1517getRippleEndRadiuscSwnlzA($this$drawIntoCanvas$iv, this.bounded, $this$drawIndication.m3866getSizeNHjbRc()));
        } else {
            i = $this$drawIntoCanvas$iv.m5819roundToPx0680j_4(this.radius);
        }
        this.rippleRadius = i;
        long color2 = this.color.getValue().m3263unboximpl();
        float alpha = this.rippleAlpha.getValue().getPressedAlpha();
        $this$drawIndication.drawContent();
        m1522drawStateLayerH2RKhps($this$drawIntoCanvas$iv, this.radius, color2);
        ...
        if ($this$drawIndication_u24lambda_u241_u24lambda_u240 != null) {
            $this$drawIndication_u24lambda_u241_u24lambda_u240.m1521updateRipplePropertiesbiQXAtU($this$drawIndication.m3866getSizeNHjbRc(), this.rippleRadius, color2, alpha);
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        RippleHostView $this$addRipple_u24lambda_u243_u24lambda_u242 = this.rippleContainer.getRippleHostView(this);
        $this$addRipple_u24lambda_u243_u24lambda_u242.m1520addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m3263unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
