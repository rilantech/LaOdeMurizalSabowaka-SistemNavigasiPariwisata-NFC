...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m612size3ABfNKs(Modifier.Companion, Dp.m5844constructorimpl((float) 24));

    /* renamed from: Icon-ww6aTOc  reason: not valid java name */
    public static final void m1328Iconww6aTOc(ImageVector imageVector, String contentDescription, Modifier modifier, long tint, Composer $composer, int $changed, int i) {
        long tint2;
        ...
        if ((i & 8) != 0) {
            ...
            long r12 = ((Color) consume).m3263unboximpl();
            ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object consume2 = composer.consume(ContentAlphaKt.getLocalContentAlpha());
            ComposerKt.sourceInformationMarkerEnd($composer);
            tint2 = Color.m3252copywmQWz5c$default(r12, ((Number) consume2).floatValue(), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            tint2 = tint;
        }
        ...
        m1327Iconww6aTOc((Painter) VectorPainterKt.rememberVectorPainter(imageVector2, composer, i2 & 14), contentDescription, modifier2, tint2, $composer, VectorPainter.$stable | (i2 & 112) | (i2 & 896) | (i2 & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    /* renamed from: Icon-ww6aTOc  reason: not valid java name */
    public static final void m1326Iconww6aTOc(ImageBitmap bitmap, String contentDescription, Modifier modifier, long tint, Composer $composer, int $changed, int i) {
        long tint2;
        ...
        if ((i & 8) != 0) {
            ...
            Object consume = composer.consume(ContentColorKt.getLocalContentColor());
            ComposerKt.sourceInformationMarkerEnd($composer);
            long r13 = ((Color) consume).m3263unboximpl();
            ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object consume2 = composer.consume(ContentAlphaKt.getLocalContentAlpha());
            ComposerKt.sourceInformationMarkerEnd($composer);
            tint2 = Color.m3252copywmQWz5c$default(r13, ((Number) consume2).floatValue(), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            tint2 = tint;
        }
        if (ComposerKt.isTraceInProgress()) {
        ...
        $composer.endReplaceableGroup();
        m1327Iconww6aTOc((Painter) (BitmapPainter) value$iv$iv, contentDescription, modifier2, tint2, $composer, (i2 & 112) | 8 | (i2 & 896) | (i2 & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    /* renamed from: Icon-ww6aTOc  reason: not valid java name */
    public static final void m1327Iconww6aTOc(Painter painter, String contentDescription, Modifier modifier, long tint, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        long tint2;
        int $dirty;
        Modifier modifier3;
        ...
        if ((i & 8) != 0) {
            ...
            long r17 = ((Color) consume).m3263unboximpl();
            ComposerKt.sourceInformationMarkerStart($composer2, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object consume2 = $composer2.consume(ContentAlphaKt.getLocalContentAlpha());
            ComposerKt.sourceInformationMarkerEnd($composer2);
            $dirty = $dirty2 & -7169;
            tint2 = Color.m3252copywmQWz5c$default(r17, ((Number) consume2).floatValue(), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            tint2 = tint;
            $dirty = $dirty2;
        }
    ...
    private static final Modifier defaultSizeFor(Modifier $this$defaultSizeFor, Painter painter) {
        Modifier modifier;
        if (Size.m3068equalsimpl0(painter.m3961getIntrinsicSizeNHjbRc(), Size.Companion.m3080getUnspecifiedNHjbRc()) || m1329isInfiniteuvyYCjk(painter.m3961getIntrinsicSizeNHjbRc())) {
    ...
    private static final boolean m1329isInfiniteuvyYCjk(long $this$isInfinite_u2duvyYCjk) {
