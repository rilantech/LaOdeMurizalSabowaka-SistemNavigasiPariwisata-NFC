...
final class DefaultButtonColors implements ButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m3254equalsimpl0(this.backgroundColor, ((DefaultButtonColors) other).backgroundColor) && Color.m3254equalsimpl0(this.contentColor, ((DefaultButtonColors) other).contentColor) && Color.m3254equalsimpl0(this.disabledBackgroundColor, ((DefaultButtonColors) other).disabledBackgroundColor) && Color.m3254equalsimpl0(this.disabledContentColor, ((DefaultButtonColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Color.m3260hashCodeimpl(this.backgroundColor) * 31) + Color.m3260hashCodeimpl(this.contentColor)) * 31) + Color.m3260hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m3260hashCodeimpl(this.disabledContentColor);
    }
}
