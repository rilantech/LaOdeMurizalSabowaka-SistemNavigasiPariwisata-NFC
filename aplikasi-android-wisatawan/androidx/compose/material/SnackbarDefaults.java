...
public final class SnackbarDefaults {
    ...
    public final long getBackgroundColor(Composer $composer, int $changed) {
        ...
        long r0 = ColorKt.m3298compositeOverOWjLjI(Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors($composer, 6).m1240getOnSurface0d7_KjU(), SnackbarOverlayAlpha, 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColors($composer, 6).m1245getSurface0d7_KjU());
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final long getPrimaryActionColor(Composer $composer, int $changed) {
        ...
        if (colors.isLight()) {
            primary = ColorKt.m3298compositeOverOWjLjI(Color.m3252copywmQWz5c$default(colors.m1245getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, (Object) null), colors.m1241getPrimary0d7_KjU());
        } else {
            primary = colors.m1242getPrimaryVariant0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
