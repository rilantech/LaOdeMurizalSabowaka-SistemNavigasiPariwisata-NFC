...
public final class TabRowKt {
    ...
    public static final void m1455TabRowpAZo6Ak(int selectedTabIndex, Modifier modifier, long backgroundColor, long contentColor, Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> indicator, Function2<? super Composer, ? super Integer, Unit> divider, Function2<? super Composer, ? super Integer, Unit> tabs, Composer $composer, int $changed, int i) {
        ...
        if (($dirty & 2995931) != 599186 || !$composer2.getSkipping()) {
            ...
            if ((i5 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    $dirty &= -7169;
                    contentColor2 = ColorsKt.m1259contentColorForek8zF_U(backgroundColor2, $composer2, ($dirty >> 6) & 14);
                }
                if (i7 != 0) {
                    indicator2 = ComposableLambdaKt.composableLambda($composer2, -553782708, true, new TabRowKt$TabRow$1(i4));
                }
                divider3 = i8 != 0 ? ComposableSingletons$TabRowKt.INSTANCE.m1272getLambda1$material_release() : function2;
            } else {
            ...
            SurfaceKt.m1420SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier3), (Shape) null, backgroundColor2, contentColor2, (BorderStroke) null, 0.0f, ComposableLambdaKt.composableLambda($composer2, -1961746365, true, new TabRowKt$TabRow$2(function22, divider3, indicator2, $dirty)), $composer2, ($dirty & 896) | 1572864 | ($dirty & 7168), 50);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m1454ScrollableTabRowsKfQg0A(int r28, androidx.compose.ui.Modifier r29, long r30, long r32, float r34, kotlin.jvm.functions.Function3<? super java.util.List<androidx.compose.material.TabPosition>, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r35, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r37, androidx.compose.runtime.Composer r38, int r39, int r40) {
        /*
            r13 = r28
            r14 = r37
            r15 = r39
        ...
        L_0x0170:
            ...
            int r2 = r1 >> 6
            r2 = r2 & 14
            long r2 = androidx.compose.material.ColorsKt.m1259contentColorForek8zF_U(r4, r11, r2)
            r1 = r1 & -7169(0xffffffffffffe3ff, float:NaN)
            r6 = r2
        L_0x017f:
            if (r8 == 0) goto L_0x0188
            androidx.compose.material.TabRowDefaults r2 = androidx.compose.material.TabRowDefaults.INSTANCE
            float r2 = r2.m1453getScrollableTabRowPaddingD9Ej5fM()
            r9 = r2
        L_0x0188:
        ...
        L_0x019c:
            ...
            kotlin.jvm.functions.Function2 r3 = r3.m1273getLambda2$material_release()
            goto L_0x01a7
        L_0x01a5:
            r3 = r36
        L_0x01a7:
