    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            SubcomposeLayoutKt.SubcomposeLayout(clipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() {
                public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                    return m1456invoke0kLqBqw((SubcomposeMeasureScope) p1, ((Constraints) p2).m5794unboximpl());
                }

                /* renamed from: invoke-0kLqBqw  reason: not valid java name */
                public final MeasureResult m1456invoke0kLqBqw(SubcomposeMeasureScope $this$SubcomposeLayout, long constraints) {
                    ...
                    long tabConstraints = Constraints.m5779copyZbe2FdA$default(constraints, minTabWidth, 0, 0, 0, 14, (Object) null);
                    ...
                    return MeasureScope.layout$default(subcomposeMeasureScope, i5, i2, (Map) null, new Function1<Placeable.PlacementScope, Unit>() {
                        ...
                        public final void invoke(Placeable.PlacementScope $this$layout) {
                            ...
                            for (Measurable it2 : subcomposeMeasureScope2.subcompose(TabSlots.Divider, function2)) {
                                Placeable placeable = it2.m4689measureBRTryo0(Constraints.m5779copyZbe2FdA$default(j, intRef.element, intRef.element, 0, 0, 8, (Object) null));
                            ...
                            for (Measurable it3 : subcomposeMeasureScope2.subcompose(tabSlots, ComposableLambdaKt.composableLambdaInstance(230769237, true, new Function2<Composer, Integer, Unit>() {
                                ...
                                Placeable.PlacementScope.placeRelative$default($this$layout, it3.m4689measureBRTryo0(Constraints.Companion.m5796fixedJhjzzOo(intRef3.element, intRef4.element)), 0, 0, 0.0f, 4, (Object) null);
                            }
