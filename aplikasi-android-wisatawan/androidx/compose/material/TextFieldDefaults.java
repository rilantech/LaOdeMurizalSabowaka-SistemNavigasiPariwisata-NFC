...
public final class TextFieldDefaults {
    ...
    private static final float FocusedBorderThickness = Dp.m5844constructorimpl((float) 2);
    ...
    private static final float UnfocusedBorderThickness = Dp.m5844constructorimpl((float) 1);
    ...
    public final float m1465getMinWidthD9Ej5fM() {
        return MinWidth;
    }
    ...
    public final float m1466getUnfocusedBorderThicknessD9Ej5fM() {
        return UnfocusedBorderThickness;
    }

    /* renamed from: getFocusedBorderThickness-D9Ej5fM  reason: not valid java name */
    public final float m1463getFocusedBorderThicknessD9Ej5fM() {
        return FocusedBorderThickness;
    }

    /* renamed from: indicatorLine-gv0btCI$default  reason: not valid java name */
    public static /* synthetic */ Modifier m1458indicatorLinegv0btCI$default(TextFieldDefaults textFieldDefaults, Modifier modifier, boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2, int i, Object obj) {
        float f3;
        float f4;
        if ((i & 16) != 0) {
        ...
        return textFieldDefaults.m1467indicatorLinegv0btCI(modifier, z, z2, interactionSource, textFieldColors, f3, f4);
    }

    /* renamed from: indicatorLine-gv0btCI  reason: not valid java name */
    public final Modifier m1467indicatorLinegv0btCI(Modifier $this$indicatorLine_u2dgv0btCI, boolean enabled, boolean isError, InteractionSource interactionSource, TextFieldColors colors, float focusedIndicatorLineThickness, float unfocusedIndicatorLineThickness) {
    ...
    public final void m1462BorderBoxnbWgWpA(boolean r22, boolean r23, androidx.compose.foundation.interaction.InteractionSource r24, androidx.compose.material.TextFieldColors r25, androidx.compose.ui.graphics.Shape r26, float r27, float r28, androidx.compose.runtime.Composer r29, int r30, int r31) {
        /*
            r21 = this;
            r11 = r21
            r12 = r24
        ...
        L_0x0186:
            ...
            r8 = r7
            r7 = r18
            androidx.compose.runtime.State r0 = androidx.compose.material.TextFieldDefaultsKt.m1474animateBorderStrokeAsStateNuRrP5Q(r0, r1, r2, r3, r4, r5, r6, r7)
        ...
        L_0x0202:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.TextFieldDefaults.m1462BorderBoxnbWgWpA(boolean, boolean, androidx.compose.foundation.interaction.InteractionSource, androidx.compose.material.TextFieldColors, androidx.compose.ui.graphics.Shape, float, float, androidx.compose.runtime.Composer, int, int):void");
    }

    /* renamed from: textFieldWithLabelPadding-a9UjIt4$default  reason: not valid java name */
    public static /* synthetic */ PaddingValues m1460textFieldWithLabelPaddinga9UjIt4$default(TextFieldDefaults textFieldDefaults, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldDefaults.m1471textFieldWithLabelPaddinga9UjIt4(f, f2, f3, f4);
    }

    /* renamed from: textFieldWithLabelPadding-a9UjIt4  reason: not valid java name */
    public final PaddingValues m1471textFieldWithLabelPaddinga9UjIt4(float start, float end, float top, float bottom) {
    ...
    public static /* synthetic */ PaddingValues m1461textFieldWithoutLabelPaddinga9UjIt4$default(TextFieldDefaults textFieldDefaults, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = TextFieldImplKt.getTextFieldPadding();
        }
        if ((i & 2) != 0) {
        ...
        return textFieldDefaults.m1472textFieldWithoutLabelPaddinga9UjIt4(f, f2, f3, f4);
    }

    /* renamed from: textFieldWithoutLabelPadding-a9UjIt4  reason: not valid java name */
    public final PaddingValues m1472textFieldWithoutLabelPaddinga9UjIt4(float start, float top, float end, float bottom) {
        return PaddingKt.m534PaddingValuesa9UjIt4(start, top, end, bottom);
    }

    /* renamed from: outlinedTextFieldPadding-a9UjIt4$default  reason: not valid java name */
    public static /* synthetic */ PaddingValues m1459outlinedTextFieldPaddinga9UjIt4$default(TextFieldDefaults textFieldDefaults, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = TextFieldImplKt.getTextFieldPadding();
        }
        if ((i & 2) != 0) {
    ...
    public final TextFieldColors m1470textFieldColorsdx8h9Zs(long textColor, long disabledTextColor, long backgroundColor, long cursorColor, long errorCursorColor, long focusedIndicatorColor, long unfocusedIndicatorColor, long disabledIndicatorColor, long errorIndicatorColor, long leadingIconColor, long disabledLeadingIconColor, long errorLeadingIconColor, long trailingIconColor, long disabledTrailingIconColor, long errorTrailingIconColor, long focusedLabelColor, long unfocusedLabelColor, long disabledLabelColor, long errorLabelColor, long placeholderColor, long disabledPlaceholderColor, Composer $composer, int $changed, int $changed1, int $changed2, int i) {
        ...
        if ((i2 & 1) != 0) {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer);
            long r9 = ((Color) consume).m3263unboximpl();
            ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object consume2 = composer.consume(ContentAlphaKt.getLocalContentAlpha());
            ComposerKt.sourceInformationMarkerEnd($composer);
            textColor2 = Color.m3252copywmQWz5c$default(r9, ((Number) consume2).floatValue(), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            textColor2 = textColor;
        }
        if ((i2 & 2) != 0) {
            disabledTextColor2 = Color.m3252copywmQWz5c$default(textColor2, ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledTextColor2 = disabledTextColor;
        }
        if ((i2 & 4) != 0) {
            backgroundColor2 = Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1240getOnSurface0d7_KjU(), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            backgroundColor2 = backgroundColor;
        }
        if ((i2 & 8) != 0) {
            cursorColor2 = MaterialTheme.INSTANCE.getColors(composer, 6).m1241getPrimary0d7_KjU();
        } else {
            cursorColor2 = cursorColor;
        }
        if ((i2 & 16) != 0) {
            errorCursorColor2 = MaterialTheme.INSTANCE.getColors(composer, 6).m1235getError0d7_KjU();
        } else {
            errorCursorColor2 = errorCursorColor;
        }
        if ((i2 & 32) != 0) {
            focusedIndicatorColor2 = Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1241getPrimary0d7_KjU(), ContentAlpha.INSTANCE.getHigh(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            focusedIndicatorColor2 = focusedIndicatorColor;
        }
        if ((i2 & 64) != 0) {
            unfocusedIndicatorColor2 = Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1240getOnSurface0d7_KjU(), 0.42f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            unfocusedIndicatorColor2 = unfocusedIndicatorColor;
        }
        if ((i2 & 128) != 0) {
            disabledIndicatorColor2 = Color.m3252copywmQWz5c$default(unfocusedIndicatorColor2, ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledIndicatorColor2 = disabledIndicatorColor;
        }
        if ((i2 & 256) != 0) {
            errorIndicatorColor2 = MaterialTheme.INSTANCE.getColors(composer, 6).m1235getError0d7_KjU();
        } else {
            errorIndicatorColor2 = errorIndicatorColor;
        }
        if ((i2 & 512) != 0) {
            leadingIconColor2 = Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1240getOnSurface0d7_KjU(), 0.54f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            leadingIconColor2 = leadingIconColor;
        }
        if ((i2 & 1024) != 0) {
            disabledLeadingIconColor2 = Color.m3252copywmQWz5c$default(leadingIconColor2, ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
        ...
        if ((i2 & 4096) != 0) {
            trailingIconColor2 = Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1240getOnSurface0d7_KjU(), 0.54f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            trailingIconColor2 = trailingIconColor;
        }
        if ((i2 & 8192) != 0) {
            disabledTrailingIconColor2 = Color.m3252copywmQWz5c$default(trailingIconColor2, ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledTrailingIconColor2 = disabledTrailingIconColor;
        }
        if ((i2 & 16384) != 0) {
            errorTrailingIconColor2 = MaterialTheme.INSTANCE.getColors(composer, 6).m1235getError0d7_KjU();
        } else {
            errorTrailingIconColor2 = errorTrailingIconColor;
        }
        if ((32768 & i2) != 0) {
            focusedLabelColor2 = Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1241getPrimary0d7_KjU(), ContentAlpha.INSTANCE.getHigh(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            focusedLabelColor2 = focusedLabelColor;
        }
        if ((65536 & i2) != 0) {
            unfocusedLabelColor2 = Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1240getOnSurface0d7_KjU(), ContentAlpha.INSTANCE.getMedium(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            unfocusedLabelColor2 = unfocusedLabelColor;
        }
        if ((131072 & i2) != 0) {
            disabledLabelColor2 = Color.m3252copywmQWz5c$default(unfocusedLabelColor2, ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledLabelColor2 = disabledLabelColor;
        }
        if ((262144 & i2) != 0) {
            errorLabelColor2 = MaterialTheme.INSTANCE.getColors(composer, 6).m1235getError0d7_KjU();
        } else {
            errorLabelColor2 = errorLabelColor;
        }
        if ((524288 & i2) != 0) {
            placeholderColor2 = Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1240getOnSurface0d7_KjU(), ContentAlpha.INSTANCE.getMedium(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            placeholderColor2 = placeholderColor;
        }
        if ((i2 & 1048576) != 0) {
            disabledPlaceholderColor2 = Color.m3252copywmQWz5c$default(placeholderColor2, ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
    ...
    public final TextFieldColors m1468outlinedTextFieldColorsdx8h9Zs(long textColor, long disabledTextColor, long backgroundColor, long cursorColor, long errorCursorColor, long focusedBorderColor, long unfocusedBorderColor, long disabledBorderColor, long errorBorderColor, long leadingIconColor, long disabledLeadingIconColor, long errorLeadingIconColor, long trailingIconColor, long disabledTrailingIconColor, long errorTrailingIconColor, long focusedLabelColor, long unfocusedLabelColor, long disabledLabelColor, long errorLabelColor, long placeholderColor, long disabledPlaceholderColor, Composer $composer, int $changed, int $changed1, int $changed2, int i) {
        ...
        if ((i2 & 32) != 0) {
            focusedBorderColor2 = Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1241getPrimary0d7_KjU(), ContentAlpha.INSTANCE.getHigh(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            focusedBorderColor2 = focusedBorderColor;
        }
        if ((i2 & 64) != 0) {
            unfocusedBorderColor2 = Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1240getOnSurface0d7_KjU(), ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            unfocusedBorderColor2 = unfocusedBorderColor;
        }
        if ((i2 & 128) != 0) {
            disabledBorderColor2 = Color.m3252copywmQWz5c$default(unfocusedBorderColor2, ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledBorderColor2 = disabledBorderColor;
        }
        if ((i2 & 256) != 0) {
            errorBorderColor2 = MaterialTheme.INSTANCE.getColors(composer, 6).m1235getError0d7_KjU();
        } else {
    ...
    public final void TextFieldDecorationBox(java.lang.String r68, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r69, boolean r70, boolean r71, androidx.compose.ui.text.input.VisualTransformation r72, androidx.compose.foundation.interaction.InteractionSource r73, boolean r74, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r75, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r76, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r77, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r78, androidx.compose.material.TextFieldColors r79, androidx.compose.foundation.layout.PaddingValues r80, androidx.compose.runtime.Composer r81, int r82, int r83, int r84) {
        ...
        L_0x0268:
            ...
            r16 = r67
            r59 = r7
            androidx.compose.material.TextFieldColors r6 = r16.m1470textFieldColorsdx8h9Zs(r17, r19, r21, r23, r25, r27, r29, r31, r33, r35, r37, r39, r41, r43, r45, r47, r49, r51, r53, r55, r57, r59, r60, r61, r62, r63)
            r2 = r2 & -113(0xffffffffffffff8f, float:NaN)
            goto L_0x02ae
        L_0x02ac:
            r6 = r79
        L_0x02ae:
            ...
            r25 = 0
            r21 = r67
            androidx.compose.foundation.layout.PaddingValues r9 = m1461textFieldWithoutLabelPaddinga9UjIt4$default(r21, r22, r23, r24, r25, r26, r27)
            goto L_0x02d9
        L_0x02c7:
            r26 = 15
            r27 = 0
            ...
            r25 = 0
            r21 = r67
            androidx.compose.foundation.layout.PaddingValues r9 = m1460textFieldWithLabelPaddinga9UjIt4$default(r21, r22, r23, r24, r25, r26, r27)
        L_0x02d9:
    ...
    public final void OutlinedTextFieldDecorationBox(java.lang.String r67, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r68, boolean r69, boolean r70, androidx.compose.ui.text.input.VisualTransformation r71, androidx.compose.foundation.interaction.InteractionSource r72, boolean r73, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r74, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r75, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r76, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r77, androidx.compose.material.TextFieldColors r78, androidx.compose.foundation.layout.PaddingValues r79, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r80, androidx.compose.runtime.Composer r81, int r82, int r83, int r84) {
        ...
        L_0x0293:
            ...
            r16 = r66
            r59 = r8
            androidx.compose.material.TextFieldColors r10 = r16.m1468outlinedTextFieldColorsdx8h9Zs(r17, r19, r21, r23, r25, r27, r29, r31, r33, r35, r37, r39, r41, r43, r45, r47, r49, r51, r53, r55, r57, r59, r60, r61, r62, r63)
            r2 = r2 & -113(0xffffffffffffff8f, float:NaN)
            goto L_0x02d9
        L_0x02d7:
            r10 = r78
        L_0x02d9:
            ...
            r27 = 0
            r23 = r66
            androidx.compose.foundation.layout.PaddingValues r0 = m1459outlinedTextFieldPaddinga9UjIt4$default(r23, r24, r25, r26, r27, r28, r29)
            r2 = r2 & -897(0xfffffffffffffc7f, float:NaN)
            goto L_0x02f6
        L_0x02f4:
            r0 = r79
