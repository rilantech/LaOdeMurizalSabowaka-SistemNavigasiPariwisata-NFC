...
final class MaterialRippleTheme implements RippleTheme {
    ...
    public long m1334defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long r0 = companion.m1526defaultRippleColor5vOe2sY(((Color) consume).m3263unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        Object consume = $composer.consume(ContentColorKt.getLocalContentColor());
        ComposerKt.sourceInformationMarkerEnd($composer);
        RippleAlpha r0 = companion.m1525defaultRippleAlphaDxMtmZc(((Color) consume).m3263unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
