...
final class BadgeKt$BadgedBox$2$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope $this$layout) {
        ...
        float badgeHorizontalOffset = this.$badgePlaceable.getWidth() > this.$this_Layout.m5819roundToPx0680j_4(BadgeKt.getBadgeRadius()) * 2 ? BadgeKt.getBadgeWithContentHorizontalOffset() : BadgeKt.getBadgeHorizontalOffset();
        Placeable.PlacementScope.placeRelative$default($this$layout, this.$anchorPlaceable, 0, 0, 0.0f, 4, (Object) null);
        Placeable.PlacementScope.placeRelative$default($this$layout, this.$badgePlaceable, this.$anchorPlaceable.getWidth() + this.$this_Layout.m5819roundToPx0680j_4(badgeHorizontalOffset), (-this.$badgePlaceable.getHeight()) / 2, 0.0f, 4, (Object) null);
    }
}
