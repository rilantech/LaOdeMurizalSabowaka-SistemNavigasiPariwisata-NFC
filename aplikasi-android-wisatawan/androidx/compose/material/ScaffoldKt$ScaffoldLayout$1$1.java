...
final class ScaffoldKt$ScaffoldLayout$1$1 extends Lambda implements Function2<SubcomposeMeasureScope, Constraints, MeasureResult> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m1392invoke0kLqBqw((SubcomposeMeasureScope) p1, ((Constraints) p2).m5794unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final MeasureResult m1392invoke0kLqBqw(SubcomposeMeasureScope $this$SubcomposeLayout, long constraints) {
        ...
        return MeasureScope.layout$default(subcomposeMeasureScope, layoutWidth, layoutHeight, (Map) null, new Function1<Placeable.PlacementScope, Unit>() {
            ...
            public final void invoke(Placeable.PlacementScope $this$layout) {
                ...
                for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
                    target$iv2.add(((Measurable) $this$fastForEach$iv$iv2.get(index$iv$iv2)).m4689measureBRTryo0(j2));
                }
                ...
                while (index$iv$iv3 < size3) {
                    target$iv3.add(((Measurable) $this$fastForEach$iv$iv3.get(index$iv$iv3)).m4689measureBRTryo0(j3));
                    index$iv$iv3++;
                ...
                if (!fabPlaceables.isEmpty()) {
                    ...
                    if (fabWidth == 0 || fabHeight == 0) {
                        ...
                        if (!FabPosition.m1313equalsimpl0(i, FabPosition.Companion.m1318getEnd5ygKITE())) {
                ...
                while (index$iv$iv4 < size4) {
                    target$iv4.add(((Measurable) $this$fastForEach$iv$iv4.get(index$iv$iv4)).m4689measureBRTryo0(j4));
                    index$iv$iv4++;
                    size4 = size4;
                ...
                if (fabPlacement2 != null) {
                    ...
                    if (bottomBarHeight == 0) {
                        i2 = it.getHeight() + subcomposeMeasureScope.m5819roundToPx0680j_4(ScaffoldKt.FabSpacing);
                    } else if (z) {
                        i2 = bottomBarHeight + (it.getHeight() / 2);
                    } else {
                        i2 = it.getHeight() + bottomBarHeight + subcomposeMeasureScope.m5819roundToPx0680j_4(ScaffoldKt.FabSpacing);
                    }
                ...
                while (index$iv$iv5 < size5) {
                    target$iv5.add(((Measurable) $this$fastForEach$iv$iv5.get(index$iv$iv5)).m4689measureBRTryo0(Constraints.m5779copyZbe2FdA$default(j5, 0, 0, 0, bodyContentHeight, 7, (Object) null)));
                    index$iv$iv5++;
                    size5 = size5;
