...
final class ScaffoldKt$Scaffold$child$1 extends Lambda implements Function3<Modifier, Composer, Integer, Unit> {
    ...
    public final void invoke(Modifier childModifier, Composer $composer, int $changed) {
        ...
        if (($dirty2 & 91) != 18 || !$composer.getSkipping()) {
            ...
            int i6 = this.$$dirty1;
            SurfaceKt.m1420SurfaceFjzlyU(childModifier, (Shape) null, j, j2, (BorderStroke) null, 0.0f, ComposableLambdaKt.composableLambda(composer, -1128984656, true, new Function2<Composer, Integer, Unit>() {
                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if (($changed & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        int i3 = i4;
                        ScaffoldKt.m1390ScaffoldLayoutMDYNRJg(z, i, function2, function3, ComposableLambdaKt.composableLambda($composer, 533782017, true, new Function2<Composer, Integer, Unit>() {
                            public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                                invoke((Composer) p1, ((Number) p2).intValue());
                                return Unit.INSTANCE;
                            }
