...
final class BottomSheetScaffoldKt$BottomSheetScaffold$child$1$1$1$1 extends Lambda implements Function1<IntSize, Map<BottomSheetValue, ? extends Float>> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return m1200invokeozmzZPI(((IntSize) p1).m6008unboximpl());
    }

    /* renamed from: invoke-ozmzZPI  reason: not valid java name */
    public final Map<BottomSheetValue, Float> m1200invokeozmzZPI(long sheetSize) {
        float sheetHeight = (float) IntSize.m6003getHeightimpl(sheetSize);
