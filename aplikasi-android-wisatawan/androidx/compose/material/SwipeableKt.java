...
public final class SwipeableKt {
    ...
    public static final <T> SwipeableState<T> rememberSwipeableStateFor(T value, Function1<? super T, Unit> onValueChange, AnimationSpec<Float> animationSpec, Composer $composer, int $changed, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1156387078, i2, -1, "androidx.compose.material.rememberSwipeableStateFor (Swipeable.kt:496)");
        }
    ...
    public static /* synthetic */ Modifier m1431swipeablepPrIpRY$default(Modifier modifier, SwipeableState swipeableState, Map map, Orientation orientation, boolean z, boolean z2, MutableInteractionSource mutableInteractionSource, Function2 function2, ResistanceConfig resistanceConfig, float f, int i, Object obj) {
        boolean z3;
        ...
        return m1430swipeablepPrIpRY(modifier, swipeableState, map, orientation, z3, z4, mutableInteractionSource2, function22, (i2 & 128) != 0 ? SwipeableDefaults.resistanceConfig$default(SwipeableDefaults.INSTANCE, map.keySet(), 0.0f, 0.0f, 6, (Object) null) : resistanceConfig, (i2 & 256) != 0 ? SwipeableDefaults.INSTANCE.m1429getVelocityThresholdD9Ej5fM() : f);
    }

    /* renamed from: swipeable-pPrIpRY  reason: not valid java name */
    public static final <T> Modifier m1430swipeablepPrIpRY(Modifier $this$swipeable_u2dpPrIpRY, SwipeableState<T> state, Map<Float, ? extends T> anchors, Orientation orientation, boolean enabled, boolean reverseDirection, MutableInteractionSource interactionSource, Function2<? super T, ? super T, ? extends ThresholdConfig> thresholds, ResistanceConfig resistance, float velocityThreshold) {
