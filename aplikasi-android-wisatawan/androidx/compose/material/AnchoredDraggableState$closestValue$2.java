...
final class AnchoredDraggableState$closestValue$2 extends Lambda implements Function0<T> {
    final /* synthetic */ AnchoredDraggableState<T> this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AnchoredDraggableState$closestValue$2(AnchoredDraggableState<T> anchoredDraggableState) {
        super(0);
    ...
    public final T invoke() {
        ...
        if (!Float.isNaN(currentOffset)) {
            $this$invoke_u24lambda_u240 = $this$invoke_u24lambda_u2402.computeTargetWithoutThresholds(currentOffset, $this$invoke_u24lambda_u2402.getCurrentValue());
        } else {
