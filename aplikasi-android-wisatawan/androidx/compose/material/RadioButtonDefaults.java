...
public final class RadioButtonDefaults {
    ...
    public final RadioButtonColors m1388colorsRGew2ao(long selectedColor, long unselectedColor, long disabledColor, Composer $composer, int $changed, int i) {
        ...
        long selectedColor2 = (i & 1) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m1243getSecondary0d7_KjU() : selectedColor;
        if ((i & 2) != 0) {
            unselectedColor2 = Color.m3252copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1240getOnSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
        ...
        Object key1$iv = Color.m3243boximpl(selectedColor2);
        int i3 = (i2 & 14) | (i2 & 112) | (i2 & 896);
        Color r14 = Color.m3243boximpl(unselectedColor2);
        Color r12 = Color.m3243boximpl(disabledColor2);
