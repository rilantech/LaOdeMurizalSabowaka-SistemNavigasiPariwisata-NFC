...
public final class CardKt {
    ...
    public static final void m1217CardFjzlyU(Modifier modifier, Shape shape, long backgroundColor, long contentColor, BorderStroke border, float elevation, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        Shape shape2;
        ...
        if ((i & 4) != 0) {
            backgroundColor2 = MaterialTheme.INSTANCE.getColors(composer, 6).m1245getSurface0d7_KjU();
        } else {
            backgroundColor2 = backgroundColor;
        }
        if ((i & 8) != 0) {
            contentColor2 = ColorsKt.m1259contentColorForek8zF_U(backgroundColor2, composer, (i2 >> 6) & 14);
        } else {
        ...
        if ((i & 32) != 0) {
            elevation2 = Dp.m5844constructorimpl((float) 1);
        } else {
        ...
        SurfaceKt.m1420SurfaceFjzlyU(modifier2, shape2, backgroundColor2, contentColor2, border2, elevation2, content, $composer, (i2 & 14) | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m1218CardLPr_se0(Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, long backgroundColor, long contentColor, BorderStroke border, float elevation, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        ...
        if ((i3 & 32) != 0) {
            contentColor2 = ColorsKt.m1259contentColorForek8zF_U(backgroundColor2, composer, (i2 >> 12) & 14);
        } else {
            contentColor2 = contentColor;
        }
        if ((i3 & 64) != 0) {
        ...
        long j = backgroundColor2;
        SurfaceKt.m1421SurfaceLPr_se0(onClick, modifier2, enabled2, shape2, backgroundColor2, contentColor2, border2, elevation2, interactionSource2, content, $composer, (i2 & 14) | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | (29360128 & i2) | (234881024 & i2) | (1879048192 & i2), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final void m1216Card9VG74zQ(kotlin.jvm.functions.Function0<kotlin.Unit> r32, androidx.compose.ui.Modifier r33, androidx.compose.ui.graphics.Shape r34, long r35, long r37, androidx.compose.foundation.BorderStroke r39, float r40, androidx.compose.foundation.interaction.MutableInteractionSource r41, androidx.compose.foundation.Indication r42, boolean r43, java.lang.String r44, androidx.compose.ui.semantics.Role r45, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r46, androidx.compose.runtime.Composer r47, int r48, int r49, int r50) {
        /*
            r15 = r47
            r14 = r48
            r13 = r49
        ...
        L_0x0057:
            ...
            int r2 = r14 >> 9
            r2 = r2 & 14
            long r2 = androidx.compose.material.ColorsKt.m1259contentColorForek8zF_U(r9, r15, r2)
            r21 = r2
            goto L_0x0068
        L_0x0066:
            r21 = r37
        ...
        L_0x010b:
            ...
            r14 = r46
            r15 = r47
            androidx.compose.material.SurfaceKt.m1419Surface9VG74zQ(r0, r1, r2, r3, r5, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18)
            boolean r0 = androidx.compose.runtime.ComposerKt.isTraceInProgress()
