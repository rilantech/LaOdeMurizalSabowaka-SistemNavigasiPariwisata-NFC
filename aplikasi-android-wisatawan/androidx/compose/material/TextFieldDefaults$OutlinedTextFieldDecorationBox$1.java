...
final class TextFieldDefaults$OutlinedTextFieldDecorationBox$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            textFieldDefaults.m1462BorderBoxnbWgWpA(z, z2, interactionSource, textFieldColors, (Shape) null, 0.0f, 0.0f, composer, ((i2 >> 9) & 896) | ((i2 >> 6) & 14) | 12582912 | ((i2 >> 15) & 112) | ((this.$$dirty1 << 6) & 7168), 112);
            if (ComposerKt.isTraceInProgress()) {
