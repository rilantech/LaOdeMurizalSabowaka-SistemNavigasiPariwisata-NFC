...
final class DefaultTextFieldForExposedDropdownMenusColors implements TextFieldColorsWithIcons {
    ...
    public State<Color> backgroundColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(this.backgroundColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public State<Color> placeholderColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(enabled ? this.placeholderColor : this.disabledPlaceholderColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public State<Color> textColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(enabled ? this.textColor : this.disabledTextColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m3254equalsimpl0(this.textColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).textColor) && Color.m3254equalsimpl0(this.disabledTextColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledTextColor) && Color.m3254equalsimpl0(this.cursorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).cursorColor) && Color.m3254equalsimpl0(this.errorCursorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorCursorColor) && Color.m3254equalsimpl0(this.focusedIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).focusedIndicatorColor) && Color.m3254equalsimpl0(this.unfocusedIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).unfocusedIndicatorColor) && Color.m3254equalsimpl0(this.errorIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorIndicatorColor) && Color.m3254equalsimpl0(this.disabledIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledIndicatorColor) && Color.m3254equalsimpl0(this.leadingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).leadingIconColor) && Color.m3254equalsimpl0(this.disabledLeadingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledLeadingIconColor) && Color.m3254equalsimpl0(this.errorLeadingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorLeadingIconColor) && Color.m3254equalsimpl0(this.trailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).trailingIconColor) && Color.m3254equalsimpl0(this.focusedTrailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).focusedTrailingIconColor) && Color.m3254equalsimpl0(this.disabledTrailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledTrailingIconColor) && Color.m3254equalsimpl0(this.errorTrailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorTrailingIconColor) && Color.m3254equalsimpl0(this.backgroundColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).backgroundColor) && Color.m3254equalsimpl0(this.focusedLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).focusedLabelColor) && Color.m3254equalsimpl0(this.unfocusedLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).unfocusedLabelColor) && Color.m3254equalsimpl0(this.disabledLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledLabelColor) && Color.m3254equalsimpl0(this.errorLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorLabelColor) && Color.m3254equalsimpl0(this.placeholderColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).placeholderColor) && Color.m3254equalsimpl0(this.disabledPlaceholderColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledPlaceholderColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((Color.m3260hashCodeimpl(this.textColor) * 31) + Color.m3260hashCodeimpl(this.disabledTextColor)) * 31) + Color.m3260hashCodeimpl(this.cursorColor)) * 31) + Color.m3260hashCodeimpl(this.errorCursorColor)) * 31) + Color.m3260hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m3260hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m3260hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m3260hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m3260hashCodeimpl(this.leadingIconColor)) * 31) + Color.m3260hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m3260hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m3260hashCodeimpl(this.trailingIconColor)) * 31) + Color.m3260hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m3260hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m3260hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m3260hashCodeimpl(this.backgroundColor)) * 31) + Color.m3260hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m3260hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m3260hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m3260hashCodeimpl(this.errorLabelColor)) * 31) + Color.m3260hashCodeimpl(this.placeholderColor)) * 31) + Color.m3260hashCodeimpl(this.disabledPlaceholderColor);
    }
}
