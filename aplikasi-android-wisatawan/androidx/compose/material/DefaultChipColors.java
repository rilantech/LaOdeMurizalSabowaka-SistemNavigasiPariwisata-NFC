...
final class DefaultChipColors implements ChipColors {
    ...
    public State<Color> backgroundColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(enabled ? this.backgroundColor : this.disabledBackgroundColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> contentColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(enabled ? this.contentColor : this.disabledContentColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m3254equalsimpl0(this.backgroundColor, ((DefaultChipColors) other).backgroundColor) && Color.m3254equalsimpl0(this.contentColor, ((DefaultChipColors) other).contentColor) && Color.m3254equalsimpl0(this.leadingIconContentColor, ((DefaultChipColors) other).leadingIconContentColor) && Color.m3254equalsimpl0(this.disabledBackgroundColor, ((DefaultChipColors) other).disabledBackgroundColor) && Color.m3254equalsimpl0(this.disabledContentColor, ((DefaultChipColors) other).disabledContentColor) && Color.m3254equalsimpl0(this.disabledLeadingIconContentColor, ((DefaultChipColors) other).disabledLeadingIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((Color.m3260hashCodeimpl(this.backgroundColor) * 31) + Color.m3260hashCodeimpl(this.contentColor)) * 31) + Color.m3260hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m3260hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m3260hashCodeimpl(this.disabledContentColor)) * 31) + Color.m3260hashCodeimpl(this.disabledLeadingIconContentColor);
    }
}
