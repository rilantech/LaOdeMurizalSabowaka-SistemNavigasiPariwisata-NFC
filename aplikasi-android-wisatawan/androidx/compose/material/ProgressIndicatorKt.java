...
public final class ProgressIndicatorKt {
    ...
    private static final float CircularIndicatorDiameter = Dp.m5844constructorimpl((float) 40);
    ...
    private static final float LinearIndicatorHeight = ProgressIndicatorDefaults.INSTANCE.m1368getStrokeWidthD9Ej5fM();
    private static final float LinearIndicatorWidth = Dp.m5844constructorimpl((float) 240);
    ...
    public static final void m1375LinearProgressIndicator_5eSRE(float r23, androidx.compose.ui.Modifier r24, long r25, long r27, int r29, androidx.compose.runtime.Composer r30, int r31, int r32) {
        /*
            r10 = r23
            r11 = r31
        ...
        L_0x00e6:
            ...
            long r3 = r3.m1241getPrimary0d7_KjU()
            r1 = r1 & -897(0xfffffffffffffc7f, float:NaN)
            goto L_0x00f9
        L_0x00f8:
            r3 = r4
        L_0x00f9:
            ...
            r19 = 0
            r14 = r3
            long r5 = androidx.compose.ui.graphics.Color.m3252copywmQWz5c$default(r14, r16, r17, r18, r19, r20, r21)
            r1 = r1 & -7169(0xffffffffffffe3ff, float:NaN)
            r6 = r5
        L_0x0112:
            r5 = r32 & 16
        ...
        L_0x012d:
            ...
            androidx.compose.ui.Modifier r5 = androidx.compose.foundation.layout.SizeKt.m614sizeVpY3zN4(r5, r9, r13)
            androidx.compose.ui.graphics.Color r9 = androidx.compose.ui.graphics.Color.m3243boximpl(r6)
            androidx.compose.ui.graphics.StrokeCap r13 = androidx.compose.ui.graphics.StrokeCap.m3634boximpl(r8)
            java.lang.Float r14 = java.lang.Float.valueOf(r0)
            androidx.compose.ui.graphics.Color r15 = androidx.compose.ui.graphics.Color.m3243boximpl(r3)
        ...
        L_0x01fa:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ProgressIndicatorKt.m1375LinearProgressIndicator_5eSRE(float, androidx.compose.ui.Modifier, long, long, int, androidx.compose.runtime.Composer, int, int):void");
    }

    /* renamed from: LinearProgressIndicator-2cYBFYY  reason: not valid java name */
    public static final void m1373LinearProgressIndicator2cYBFYY(Modifier modifier, long color, long backgroundColor, int strokeCap, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        long j;
        long j2;
        int i2;
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            if ((i7 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 2) != 0) {
                    color3 = MaterialTheme.INSTANCE.getColors($composer2, 6).m1241getPrimary0d7_KjU();
                    $dirty &= -113;
                } else {
                    color3 = j;
                }
                if ((i & 4) != 0) {
                    backgroundColor3 = Color.m3252copywmQWz5c$default(color3, 0.24f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
                    $dirty &= -897;
                } else {
                    backgroundColor3 = j2;
                }
                if ((i & 8) != 0) {
                    ...
                    strokeCap2 = StrokeCap.Companion.m3641getButtKaPHkGw();
                } else {
                    int i10 = $dirty;
                    modifier3 = modifier4;
                    color2 = color3;
            ...
            State firstLineHead$delegate = InfiniteTransitionKt.animateFloat(infiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m98infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$firstLineHead$2.INSTANCE), (RepeatMode) null, 0, 6, (Object) null), (String) null, $composer2, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
            State firstLineTail$delegate = InfiniteTransitionKt.animateFloat(infiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m98infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$firstLineTail$2.INSTANCE), (RepeatMode) null, 0, 6, (Object) null), (String) null, $composer2, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
            State secondLineHead$delegate = InfiniteTransitionKt.animateFloat(infiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m98infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$secondLineHead$2.INSTANCE), (RepeatMode) null, 0, 6, (Object) null), (String) null, $composer2, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
            State secondLineTail$delegate = InfiniteTransitionKt.animateFloat(infiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m98infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$LinearProgressIndicator$secondLineTail$2.INSTANCE), (RepeatMode) null, 0, 6, (Object) null), (String) null, $composer2, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
            Modifier r2 = SizeKt.m614sizeVpY3zN4(ProgressSemanticsKt.progressSemantics(modifier3), LinearIndicatorWidth, LinearIndicatorHeight);
            Object[] keys$iv = {Color.m3243boximpl(backgroundColor2), StrokeCap.m3634boximpl(strokeCap2), firstLineHead$delegate, firstLineTail$delegate, Color.m3243boximpl(color2), secondLineHead$delegate, secondLineTail$delegate};
    ...
    public static final /* synthetic */ void m1376LinearProgressIndicatoreaDK9VM(float progress, Modifier modifier, long color, long backgroundColor, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        long j;
        long j2;
        long backgroundColor2;
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            m1375LinearProgressIndicator_5eSRE(progress, modifier4, color3, backgroundColor3, StrokeCap.Companion.m3641getButtKaPHkGw(), $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            int i6 = $dirty;
    ...
    public static final /* synthetic */ void m1374LinearProgressIndicatorRIQooxk(Modifier modifier, long color, long backgroundColor, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        long j;
        long j2;
        long backgroundColor2;
        ...
        if (($dirty & 731) != 146 || !$composer2.getSkipping()) {
            ...
            m1373LinearProgressIndicator2cYBFYY(modifier4, color3, backgroundColor3, StrokeCap.Companion.m3641getButtKaPHkGw(), $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            int i6 = $dirty;
    ...
    public static final void m1386drawLinearIndicatorqYKTg0g(DrawScope $this$drawLinearIndicator_u2dqYKTg0g, float startFraction, float endFraction, long color, float strokeWidth, int strokeCap) {
        float width = Size.m3072getWidthimpl($this$drawLinearIndicator_u2dqYKTg0g.m3866getSizeNHjbRc());
        float height = Size.m3069getHeightimpl($this$drawLinearIndicator_u2dqYKTg0g.m3866getSizeNHjbRc());
        float f = (float) 2;
        ...
        if (StrokeCap.m3637equalsimpl0(strokeCap, StrokeCap.Companion.m3641getButtKaPHkGw()) || height > width) {
            DrawScope.m3834drawLineNGM6Ib0$default($this$drawLinearIndicator_u2dqYKTg0g, color, OffsetKt.Offset(barStart, yOffset), OffsetKt.Offset(barEnd, yOffset), strokeWidth, 0, (PathEffect) null, 0.0f, (ColorFilter) null, 0, 496, (Object) null);
            return;
        }
        ...
        if (Math.abs(endFraction - startFraction) > 0.0f) {
            ...
            DrawScope.m3834drawLineNGM6Ib0$default($this$drawLinearIndicator_u2dqYKTg0g, color, OffsetKt.Offset(adjustedBarStart, yOffset), OffsetKt.Offset(adjustedBarEnd, yOffset), strokeWidth, strokeCap, (PathEffect) null, 0.0f, (ColorFilter) null, 0, 480, (Object) null);
            return;
        }
    ...
    public static final void m1387drawLinearIndicatorBackgroundAZGd3zU(DrawScope $this$drawLinearIndicatorBackground_u2dAZGd3zU, long color, float strokeWidth, int strokeCap) {
        m1386drawLinearIndicatorqYKTg0g($this$drawLinearIndicatorBackground_u2dAZGd3zU, 0.0f, 1.0f, color, strokeWidth, strokeCap);
    }

    /* renamed from: CircularProgressIndicator-DUhRLBM  reason: not valid java name */
    public static final void m1369CircularProgressIndicatorDUhRLBM(float progress, Modifier modifier, long color, float strokeWidth, long backgroundColor, int strokeCap, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        long j;
        float strokeWidth2;
        long backgroundColor2;
        ...
        if ((374491 & $dirty2) != 74898 || !$composer2.getSkipping()) {
            ...
            if ((i5 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    color4 = MaterialTheme.INSTANCE.getColors($composer2, 6).m1241getPrimary0d7_KjU();
                    $dirty2 &= -897;
                } else {
                    color4 = j;
                }
                if (i7 != 0) {
                    strokeWidth2 = ProgressIndicatorDefaults.INSTANCE.m1368getStrokeWidthD9Ej5fM();
                }
                if (i8 != 0) {
                    backgroundColor2 = Color.Companion.m3288getTransparent0d7_KjU();
                }
                if ((i & 32) != 0) {
                    $dirty = $dirty2 & -458753;
                    strokeCap3 = StrokeCap.Companion.m3641getButtKaPHkGw();
            ...
            CanvasKt.Canvas(SizeKt.m612size3ABfNKs(ProgressSemanticsKt.progressSemantics$default(modifier5, coercedProgress, (ClosedFloatingPointRange) null, 0, 6, (Object) null), CircularIndicatorDiameter), new ProgressIndicatorKt$CircularProgressIndicator$1(coercedProgress, backgroundColor4, new Stroke(((Density) consume).m5825toPx0680j_4(strokeWidth4), 0.0f, strokeCap3, 0, (PathEffect) null, 26, (DefaultConstructorMarker) null), color3), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
    ...
    public static final void m1370CircularProgressIndicatorLxG7B9w(Modifier modifier, long color, float strokeWidth, long backgroundColor, int strokeCap, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        long j;
        float strokeWidth2;
        long backgroundColor2;
        ...
        if ((46811 & $dirty) != 9362 || !$composer2.getSkipping()) {
            ...
            if ((i5 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    ...
                    modifier3 = modifier4;
                    color2 = color3;
                    strokeCap2 = StrokeCap.Companion.m3643getSquareKaPHkGw();
                    backgroundColor3 = backgroundColor2;
                    strokeWidth4 = strokeWidth2;
                } else {
                    int i10 = $dirty;
            ...
            Object consume = $composer2.consume(CompositionLocalsKt.getLocalDensity());
            ComposerKt.sourceInformationMarkerEnd($composer2);
            Stroke stroke = new Stroke(((Density) consume).m5825toPx0680j_4(strokeWidth4), 0.0f, strokeCap2, 0, (PathEffect) null, 26, (DefaultConstructorMarker) null);
            ...
            CanvasKt.Canvas(SizeKt.m612size3ABfNKs(ProgressSemanticsKt.progressSemantics(modifier3), CircularIndicatorDiameter), new ProgressIndicatorKt$CircularProgressIndicator$3(backgroundColor3, stroke, strokeWidth5, color2, InfiniteTransitionKt.animateValue(transition, 0, 5, VectorConvertersKt.getVectorConverter(IntCompanionObject.INSTANCE), AnimationSpecKt.m98infiniteRepeatable9IiC70o$default(AnimationSpecKt.tween$default(6660, 0, EasingKt.getLinearEasing(), 2, (Object) null), (RepeatMode) null, 0, 6, (Object) null), (String) null, $composer2, InfiniteTransition.$stable | 4528 | (InfiniteRepeatableSpec.$stable << 12), 16), InfiniteTransitionKt.animateFloat(transition, 0.0f, JumpRotationAngle, AnimationSpecKt.m98infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$CircularProgressIndicator$endAngle$2.INSTANCE), (RepeatMode) null, 0, 6, (Object) null), (String) null, $composer2, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8), InfiniteTransitionKt.animateFloat(transition, 0.0f, JumpRotationAngle, AnimationSpecKt.m98infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(ProgressIndicatorKt$CircularProgressIndicator$startAngle$2.INSTANCE), (RepeatMode) null, 0, 6, (Object) null), (String) null, $composer2, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8), InfiniteTransitionKt.animateFloat(transition, 0.0f, BaseRotationAngle, AnimationSpecKt.m98infiniteRepeatable9IiC70o$default(AnimationSpecKt.tween$default(RotationDuration, 0, EasingKt.getLinearEasing(), 2, (Object) null), (RepeatMode) null, 0, 6, (Object) null), (String) null, $composer2, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8)), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
    ...
    public static final /* synthetic */ void m1371CircularProgressIndicatorMBs18nI(float progress, Modifier modifier, long color, float strokeWidth, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        long j;
        float f;
        float strokeWidth2;
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            if ((i3 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                strokeWidth3 = i5 != 0 ? ProgressIndicatorDefaults.INSTANCE.m1368getStrokeWidthD9Ej5fM() : f;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 4) != 0) {
                    $dirty &= -897;
            ...
            m1369CircularProgressIndicatorDUhRLBM(progress, modifier4, color3, strokeWidth3, Color.Companion.m3288getTransparent0d7_KjU(), StrokeCap.Companion.m3641getButtKaPHkGw(), $composer2, ($dirty & 14) | 24576 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            int i6 = $dirty;
    ...
    public static final /* synthetic */ void m1372CircularProgressIndicatoraMcp0Q(Modifier modifier, long color, float strokeWidth, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        long j;
        float f;
        float strokeWidth2;
        ...
        if (($dirty & 731) != 146 || !$composer2.getSkipping()) {
            ...
            m1370CircularProgressIndicatorLxG7B9w(modifier4, color3, strokeWidth3, Color.Companion.m3288getTransparent0d7_KjU(), StrokeCap.Companion.m3643getSquareKaPHkGw(), $composer2, ($dirty & 14) | 3072 | ($dirty & 112) | ($dirty & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            int i6 = $dirty;
    ...
    private static final void m1382drawCircularIndicator42QJj7c(DrawScope $this$drawCircularIndicator_u2d42QJj7c, float startAngle, float sweep, long color, Stroke stroke) {
        float f = (float) 2;
        float diameterOffset = stroke.getWidth() / f;
        float arcDimen = Size.m3072getWidthimpl($this$drawCircularIndicator_u2d42QJj7c.m3866getSizeNHjbRc()) - (f * diameterOffset);
        DrawScope.m3827drawArcyD3GUKo$default($this$drawCircularIndicator_u2d42QJj7c, color, startAngle, sweep, false, OffsetKt.Offset(diameterOffset, diameterOffset), androidx.compose.ui.geometry.SizeKt.Size(arcDimen, arcDimen), 0.0f, stroke, (ColorFilter) null, 0, 832, (Object) null);
    }

    /* access modifiers changed from: private */
    /* renamed from: drawCircularIndicatorBackground-bw27NRU  reason: not valid java name */
    public static final void m1383drawCircularIndicatorBackgroundbw27NRU(DrawScope $this$drawCircularIndicatorBackground_u2dbw27NRU, long color, Stroke stroke) {
        m1382drawCircularIndicator42QJj7c($this$drawCircularIndicatorBackground_u2dbw27NRU, 0.0f, 360.0f, color, stroke);
    }

    /* access modifiers changed from: private */
    /* renamed from: drawDeterminateCircularIndicator-42QJj7c  reason: not valid java name */
    public static final void m1384drawDeterminateCircularIndicator42QJj7c(DrawScope $this$drawDeterminateCircularIndicator_u2d42QJj7c, float startAngle, float sweep, long color, Stroke stroke) {
        m1382drawCircularIndicator42QJj7c($this$drawDeterminateCircularIndicator_u2d42QJj7c, startAngle, sweep, color, stroke);
    }

    /* access modifiers changed from: private */
    /* renamed from: drawIndeterminateCircularIndicator-hrjfTZI  reason: not valid java name */
    public static final void m1385drawIndeterminateCircularIndicatorhrjfTZI(DrawScope $this$drawIndeterminateCircularIndicator_u2dhrjfTZI, float startAngle, float strokeWidth, float sweep, long color, Stroke stroke) {
        float strokeCapOffset;
        if (StrokeCap.m3637equalsimpl0(stroke.m3946getCapKaPHkGw(), StrokeCap.Companion.m3641getButtKaPHkGw())) {
            strokeCapOffset = 0.0f;
        } else {
            strokeCapOffset = ((strokeWidth / Dp.m5844constructorimpl(CircularIndicatorDiameter / ((float) 2))) * 57.29578f) / 2.0f;
        }
        m1382drawCircularIndicator42QJj7c($this$drawIndeterminateCircularIndicator_u2dhrjfTZI, startAngle + strokeCapOffset, Math.max(sweep, 0.1f), color, stroke);
    }
}
