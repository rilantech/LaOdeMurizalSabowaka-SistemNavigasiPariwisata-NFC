...
public final class ElevationKt {
    ...
    public static /* synthetic */ Object m1303animateElevationrAjV9yQ$default(Animatable animatable, float f, Interaction interaction, Interaction interaction2, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            interaction = null;
        }
        if ((i & 4) != 0) {
        ...
        return m1302animateElevationrAjV9yQ(animatable, f, interaction, interaction2, continuation);
    }

    /* renamed from: animateElevation-rAjV9yQ  reason: not valid java name */
    public static final Object m1302animateElevationrAjV9yQ(Animatable<Dp, ?> $this$animateElevation_u2drAjV9yQ, float target, Interaction from, Interaction to, Continuation<? super Unit> $completion) {
        AnimationSpec spec;
        if (to != null) {
