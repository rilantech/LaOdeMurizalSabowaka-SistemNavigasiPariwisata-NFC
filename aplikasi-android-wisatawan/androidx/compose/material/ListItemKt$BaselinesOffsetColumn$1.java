...
final class ListItemKt$BaselinesOffsetColumn$1 implements MeasurePolicy {
    ...
    public final MeasureResult m1332measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        ...
        long childConstraints = Constraints.m5779copyZbe2FdA$default(constraints, 0, 0, 0, Integer.MAX_VALUE, 3, (Object) null);
        Iterable<Measurable> $this$map$iv = list;
        Collection destination$iv$iv = new ArrayList(CollectionsKt.collectionSizeOrDefault($this$map$iv, 10));
        for (Measurable it : $this$map$iv) {
            destination$iv$iv.add(it.m4689measureBRTryo0(childConstraints));
        }
        ...
        while (index$iv < size2) {
            ...
            int topPadding = Math.max(0, (measureScope.m5819roundToPx0680j_4(list2.get(index).m5858unboximpl()) - placeable2.get(AlignmentLineKt.getFirstBaseline())) - toPreviousBaseline);
