...
final class NavigationRailKt$NavigationRailItemBaselineLayout$2 implements MeasurePolicy {
    ...
    public final MeasureResult m1361measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        Placeable placeable;
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv), (Object) "icon")) {
                ...
                if (this.$label == null) {
                    ...
                    return NavigationRailKt.m1359placeIcon3p2s80s(measureScope, iconPlaceable, j);
                }
                Intrinsics.checkNotNull(labelPlaceable);
                Placeable placeable3 = iconPlaceable;
                return NavigationRailKt.m1360placeLabelAndIconDIyivk0($this$Layout, labelPlaceable, iconPlaceable, constraints, this.$iconPositionAnimationProgress);
            }
            j = constraints;
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
