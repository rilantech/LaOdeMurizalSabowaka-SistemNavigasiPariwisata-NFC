...
public final class ElevationOverlayKt {
    ...
    public static final long m1306calculateForegroundColorCLU3JFs(long backgroundColor, float elevation, Composer $composer, int $changed) {
        ...
        long r3 = Color.m3252copywmQWz5c$default(ColorsKt.m1259contentColorForek8zF_U(backgroundColor, composer, i & 14), ((((float) Math.log((double) (elevation + ((float) 1)))) * 4.5f) + 2.0f) / 100.0f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        if (ComposerKt.isTraceInProgress()) {
