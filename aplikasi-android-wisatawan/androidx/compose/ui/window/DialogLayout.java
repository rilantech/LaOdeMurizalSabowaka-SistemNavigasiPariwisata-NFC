...
final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    private final MutableState content$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$AndroidDialog_androidKt.INSTANCE.m6090getLambda1$ui_release(), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public void Content(Composer $composer, int $changed) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new DialogLayout$Content$4(this, $changed));
        }
    }
}
