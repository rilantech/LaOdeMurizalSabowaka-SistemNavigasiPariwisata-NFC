...
public final class SemanticsConfigurationKt {
    public static final <T> T getOrNull(SemanticsConfiguration $this$getOrNull, SemanticsPropertyKey<T> key) {
        Intrinsics.checkNotNullParameter($this$getOrNull, "<this>");
        Intrinsics.checkNotNullParameter(key, "key");
        return $this$getOrNull.getOrElseNullable(key, SemanticsConfigurationKt$getOrNull$1.INSTANCE);
    }
}
