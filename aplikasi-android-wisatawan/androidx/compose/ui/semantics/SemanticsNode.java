...
public final class SemanticsNode {
    ...
    public final long m5172getSizeYbymL2g() {
        NodeCoordinator findCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        return findCoordinatorToGetBounds$ui_release != null ? findCoordinatorToGetBounds$ui_release.m4930getSizeYbymL2g() : IntSize.Companion.m6009getZeroYbymL2g();
    }
    ...
    public final long m5170getPositionInRootF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui_release();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    public final long m5171getPositionInWindowF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui_release();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    private final void fillOneLayerOfSemanticsWrappers(LayoutNode $this$fillOneLayerOfSemanticsWrappers, List<SemanticsNode> list) {
        ...
        if (size$iv > 0) {
            ...
            do {
                ...
                if (child.isAttached()) {
                    if (child.getNodes$ui_release().m4906hasH91voCI$ui_release(NodeKind.m4956constructorimpl(8))) {
    ...
    public final NodeCoordinator findCoordinatorToGetBounds$ui_release() {
        ...
        return DelegatableNodeKt.m4792requireCoordinator64DMado(semanticsModifierNode, NodeKind.m4956constructorimpl(8));
    }
    ...
    private final void emitFakeNodes(List<SemanticsNode> unmergedChildren) {
        ...
        if (nodeRole != null && this.unmergedConfig.isMergingSemanticsOfDescendants() && (!unmergedChildren.isEmpty())) {
            unmergedChildren.add(m5169fakeSemanticsNodeypyhhiA(nodeRole, new SemanticsNode$emitFakeNodes$fakeNode$1(nodeRole)));
        }
        if (this.unmergedConfig.contains(SemanticsProperties.INSTANCE.getContentDescription()) && (!unmergedChildren.isEmpty()) && this.unmergedConfig.isMergingSemanticsOfDescendants()) {
            ...
            if (contentDescription != null) {
                unmergedChildren.add(0, m5169fakeSemanticsNodeypyhhiA((Role) null, new SemanticsNode$emitFakeNodes$fakeNode$2(contentDescription)));
            }
        }
    }

    /* renamed from: fakeSemanticsNode-ypyhhiA  reason: not valid java name */
    private final SemanticsNode m5169fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> properties) {
