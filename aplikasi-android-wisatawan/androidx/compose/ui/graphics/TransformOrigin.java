...
public final class TransformOrigin {
    ...
    public static final /* synthetic */ TransformOrigin m3667boximpl(long j) {
        return new TransformOrigin(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m3670constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3673equalsimpl(long j, Object obj) {
        return (obj instanceof TransformOrigin) && j == ((TransformOrigin) obj).m3679unboximpl();
    }
    ...
    public static String m3678toStringimpl(long j) {
    ...
    public String toString() {
        return m3678toStringimpl(this.packedValue);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m3679unboximpl() {
    ...
    public static final float m3675getPivotFractionXimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (arg0 >> 32));
    }

    /* renamed from: getPivotFractionY-impl  reason: not valid java name */
    public static final float m3676getPivotFractionYimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (4294967295L & arg0));
    }

    /* renamed from: component1-impl  reason: not valid java name */
    public static final float m3668component1impl(long arg0) {
        return m3675getPivotFractionXimpl(arg0);
    }

    /* renamed from: component2-impl  reason: not valid java name */
    public static final float m3669component2impl(long arg0) {
        return m3676getPivotFractionYimpl(arg0);
    }

    /* renamed from: copy-zey9I6w$default  reason: not valid java name */
    public static /* synthetic */ long m3672copyzey9I6w$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m3675getPivotFractionXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m3676getPivotFractionYimpl(j);
        }
        return m3671copyzey9I6w(j, f, f2);
    }

    /* renamed from: copy-zey9I6w  reason: not valid java name */
    public static final long m3671copyzey9I6w(long arg0, float pivotFractionX, float pivotFractionY) {
    ...
    public static final class Companion {
        ...
        public final long m3680getCenterSzJe1aQ() {
