...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(Paint internalPaint2) {
        ...
        this._blendMode = BlendMode.Companion.m3186getSrcOver0nO6VwU();
    }
    ...
    public long m3117getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    /* renamed from: setColor-8_81llA  reason: not valid java name */
    public void m3123setColor8_81llA(long color) {
        AndroidPaint_androidKt.m3129setNativeColor4WTKRHQ(this.internalPaint, color);
    }

    /* renamed from: getBlendMode-0nO6VwU  reason: not valid java name */
    public int m3116getBlendMode0nO6VwU() {
        return this._blendMode;
    }

    /* renamed from: setBlendMode-s9anfk8  reason: not valid java name */
    public void m3122setBlendModes9anfk8(int value) {
        if (!BlendMode.m3155equalsimpl0(this._blendMode, value)) {
            this._blendMode = value;
            AndroidPaint_androidKt.m3128setNativeBlendModeGB0RdKg(this.internalPaint, value);
        }
    }

    /* renamed from: getStyle-TiuSbCo  reason: not valid java name */
    public int m3121getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    /* renamed from: setStyle-k9PVt8s  reason: not valid java name */
    public void m3127setStylek9PVt8s(int value) {
        AndroidPaint_androidKt.m3133setNativeStyle5YerkU(this.internalPaint, value);
    }
    ...
    public int m3119getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    /* renamed from: setStrokeCap-BeK7IIE  reason: not valid java name */
    public void m3125setStrokeCapBeK7IIE(int value) {
        AndroidPaint_androidKt.m3131setNativeStrokeCapCSYIeUk(this.internalPaint, value);
    }

    /* renamed from: getStrokeJoin-LxFBmk8  reason: not valid java name */
    public int m3120getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    /* renamed from: setStrokeJoin-Ww9F2mQ  reason: not valid java name */
    public void m3126setStrokeJoinWw9F2mQ(int value) {
        AndroidPaint_androidKt.m3132setNativeStrokeJoinkLtJ_vA(this.internalPaint, value);
    }
    ...
    public int m3118getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    /* renamed from: setFilterQuality-vDHp3xo  reason: not valid java name */
    public void m3124setFilterQualityvDHp3xo(int value) {
        AndroidPaint_androidKt.m3130setNativeFilterQuality50PEsBU(this.internalPaint, value);
    }
