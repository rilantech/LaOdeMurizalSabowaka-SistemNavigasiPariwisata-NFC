...
public final class RenderEffectKt {
    ...
    public static /* synthetic */ BlurEffect m3583BlurEffect3YTHUZs$default(float f, float f2, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = TileMode.Companion.m3662getClamp3opZhB0();
        }
        return m3582BlurEffect3YTHUZs(f, f2, i);
    }

    /* renamed from: BlurEffect-3YTHUZs  reason: not valid java name */
    public static final BlurEffect m3582BlurEffect3YTHUZs(float radiusX, float radiusY, int edgeTreatment) {
