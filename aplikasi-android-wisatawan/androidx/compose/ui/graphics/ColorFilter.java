...
public final class ColorFilter {
    ...
    public ColorFilter(android.graphics.ColorFilter nativeColorFilter2) {
        Intrinsics.checkNotNullParameter(nativeColorFilter2, "nativeColorFilter");
        this.nativeColorFilter = nativeColorFilter2;
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m3294tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.Companion.m3184getSrcIn0nO6VwU();
            }
            return companion.m3297tintxETnrds(j, i);
        }

        /* renamed from: tint-xETnrds  reason: not valid java name */
        public final ColorFilter m3297tintxETnrds(long color, int blendMode) {
            return AndroidColorFilter_androidKt.m3110actualTintColorFilterxETnrds(color, blendMode);
        }

        /* renamed from: colorMatrix-jHG-Opc  reason: not valid java name */
        public final ColorFilter m3295colorMatrixjHGOpc(float[] colorMatrix) {
            Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
            return AndroidColorFilter_androidKt.m3108actualColorMatrixColorFilterjHGOpc(colorMatrix);
        }

        /* renamed from: lighting--OWjLjI  reason: not valid java name */
        public final ColorFilter m3296lightingOWjLjI(long multiply, long add) {
            return AndroidColorFilter_androidKt.m3109actualLightingColorFilterOWjLjI(multiply, add);
        }
    }
