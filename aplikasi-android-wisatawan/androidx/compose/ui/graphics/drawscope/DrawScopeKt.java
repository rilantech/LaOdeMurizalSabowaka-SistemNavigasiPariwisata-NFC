...
public final class DrawScopeKt {
    ...
    public static /* synthetic */ void m3908rotateRg1IO4c$default(DrawScope $this$rotate_u2dRg1IO4c_u24default, float degrees, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = $this$rotate_u2dRg1IO4c_u24default.m3865getCenterF1C5BW0();
        }
        ...
        $this$withTransform_u24lambda_u246$iv.getTransform().m3924rotateUv8p0NA(degrees, pivot);
    ...
    public static final void m3907rotateRg1IO4c(DrawScope $this$rotate_u2dRg1IO4c, float degrees, long pivot, Function1<? super DrawScope, Unit> block) {
    ...
    public static /* synthetic */ void m3910rotateRadRg1IO4c$default(DrawScope $this$rotateRad_u2dRg1IO4c_u24default, float radians, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = $this$rotateRad_u2dRg1IO4c_u24default.m3865getCenterF1C5BW0();
        }
        ...
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.m3809getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv.getCanvas().save();
        $this$withTransform_u24lambda_u246$iv.getTransform().m3924rotateUv8p0NA(DegreesKt.degrees(radians), pivot);
        block.invoke($this$withTransform$iv);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.m3810setSizeuvyYCjk(previousSize$iv);
    }
    ...
    public static final void m3909rotateRadRg1IO4c(DrawScope $this$rotateRad_u2dRg1IO4c, float radians, long pivot, Function1<? super DrawScope, Unit> block) {
    ...
    public static /* synthetic */ void m3912scaleFgt4K4Q$default(DrawScope $this$scale_u2dFgt4K4Q_u24default, float scaleX, float scaleY, long pivot, Function1 block, int i, Object obj) {
        if ((i & 4) != 0) {
            pivot = $this$scale_u2dFgt4K4Q_u24default.m3865getCenterF1C5BW0();
        }
        ...
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.m3809getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv.getCanvas().save();
        $this$withTransform_u24lambda_u246$iv.getTransform().m3925scale0AR0LA0(scaleX, scaleY, pivot);
        block.invoke($this$withTransform$iv);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.m3810setSizeuvyYCjk(previousSize$iv);
    }
    ...
    public static final void m3911scaleFgt4K4Q(DrawScope $this$scale_u2dFgt4K4Q, float scaleX, float scaleY, long pivot, Function1<? super DrawScope, Unit> block) {
    ...
    public static /* synthetic */ void m3914scaleRg1IO4c$default(DrawScope $this$scale_u2dRg1IO4c_u24default, float scale, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = $this$scale_u2dRg1IO4c_u24default.m3865getCenterF1C5BW0();
        }
        ...
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.m3809getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv.getCanvas().save();
        $this$withTransform_u24lambda_u246$iv.getTransform().m3925scale0AR0LA0(scale, scale, pivot);
        block.invoke($this$withTransform$iv);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.m3810setSizeuvyYCjk(previousSize$iv);
    }
    ...
    public static final void m3913scaleRg1IO4c(DrawScope $this$scale_u2dRg1IO4c, float scale, long pivot, Function1<? super DrawScope, Unit> block) {
    ...
    public static /* synthetic */ void m3906clipRectrOu3jXo$default(DrawScope $this$clipRect_u2drOu3jXo_u24default, float left, float top, float right, float bottom, int clipOp, Function1 block, int i, Object obj) {
        float left2;
        float top2;
        float right2;
        float bottom2;
        ...
        if ((i & 4) != 0) {
            right2 = Size.m3072getWidthimpl($this$clipRect_u2drOu3jXo_u24default.m3866getSizeNHjbRc());
        } else {
            right2 = right;
        }
        if ((i & 8) != 0) {
            bottom2 = Size.m3069getHeightimpl($this$clipRect_u2drOu3jXo_u24default.m3866getSizeNHjbRc());
        } else {
            bottom2 = bottom;
        }
        if ((i & 16) != 0) {
            clipOp2 = ClipOp.Companion.m3242getIntersectrtfAjoo();
        } else {
            clipOp2 = clipOp;
        }
        ...
        $this$withTransform_u24lambda_u246$iv.getTransform().m3921clipRectN_I0leg(left2, top2, right2, bottom2, clipOp2);
        function1.invoke($this$withTransform$iv);
        $this$withTransform_u24lambda_u246$iv2.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv2.m3810setSizeuvyYCjk(previousSize$iv);
    }

    /* renamed from: clipRect-rOu3jXo  reason: not valid java name */
    public static final void m3905clipRectrOu3jXo(DrawScope $this$clipRect_u2drOu3jXo, float left, float top, float right, float bottom, int clipOp, Function1<? super DrawScope, Unit> block) {
        ...
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.m3809getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv.getCanvas().save();
        $this$withTransform_u24lambda_u246$iv.getTransform().m3921clipRectN_I0leg(left, top, right, bottom, clipOp);
        function1.invoke($this$withTransform$iv);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.m3810setSizeuvyYCjk(previousSize$iv);
    }
    ...
    public static /* synthetic */ void m3904clipPathKD09W0M$default(DrawScope $this$clipPath_u2dKD09W0M_u24default, Path path, int clipOp, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            clipOp = ClipOp.Companion.m3242getIntersectrtfAjoo();
        }
        ...
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.m3809getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv.getCanvas().save();
        $this$withTransform_u24lambda_u246$iv.getTransform().m3920clipPathmtrdDE(path, clipOp);
        block.invoke($this$withTransform$iv);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.m3810setSizeuvyYCjk(previousSize$iv);
    }
    ...
    public static final void m3903clipPathKD09W0M(DrawScope $this$clipPath_u2dKD09W0M, Path path, int clipOp, Function1<? super DrawScope, Unit> block) {
    ...
    public static final void withTransform(DrawScope $this$withTransform, Function1<? super DrawTransform, Unit> transformBlock, Function1<? super DrawScope, Unit> drawBlock) {
        ...
        long previousSize = $this$withTransform_u24lambda_u246.m3809getSizeNHjbRc();
        ...
        $this$withTransform_u24lambda_u246.m3810setSizeuvyYCjk(previousSize);
    }
}
