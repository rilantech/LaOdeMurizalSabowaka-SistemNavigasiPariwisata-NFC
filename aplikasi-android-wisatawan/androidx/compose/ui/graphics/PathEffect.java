...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        public final PathEffect m3543stampedPathEffect7aD1DOk(Path shape, float advance, float phase, int style) {
            Intrinsics.checkNotNullParameter(shape, "shape");
            return AndroidPathEffect_androidKt.m3140actualStampedPathEffect7aD1DOk(shape, advance, phase, style);
        }
    }
}
