...
final class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public final long m3399component11SzJe1aQ() {
    ...
    public final long m3400component150d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: component16-0d7_KjU  reason: not valid java name */
    public final long m3401component160d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: component17--NrFUSI  reason: not valid java name */
    public final int m3402component17NrFUSI() {
    ...
    public final GraphicsLayerElement m3403copyJVvOYNQ(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape2, boolean z, RenderEffect renderEffect2, long j2, long j3, int i) {
    ...
    public int hashCode() {
        ...
        return ((((((i + (renderEffect2 == null ? 0 : renderEffect2.hashCode())) * 31) + Color.m3260hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m3260hashCodeimpl(this.spotShadowColor)) * 31) + CompositingStrategy.m3336hashCodeimpl(this.compositingStrategy);
    }
    ...
    public final long m3407getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    public final long m3404getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: getSpotShadowColor-0d7_KjU  reason: not valid java name */
    public final long m3406getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: getCompositingStrategy--NrFUSI  reason: not valid java name */
    public final int m3405getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }
    ...
    public void update(SimpleGraphicsLayerModifier node) {
        ...
        node.m3621setTransformOrigin__ExYCQ(this.transformOrigin);
        node.setShape(this.shape);
        node.setClip(this.clip);
        node.setRenderEffect(this.renderEffect);
        node.m3618setAmbientShadowColor8_81llA(this.ambientShadowColor);
        node.m3620setSpotShadowColor8_81llA(this.spotShadowColor);
        node.m3619setCompositingStrategyaDBOjCE(this.compositingStrategy);
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("transformOrigin", TransformOrigin.m3667boximpl(this.transformOrigin));
        ...
        $this$inspectableProperties.getProperties().set("ambientShadowColor", Color.m3243boximpl(this.ambientShadowColor));
        $this$inspectableProperties.getProperties().set("spotShadowColor", Color.m3243boximpl(this.spotShadowColor));
        $this$inspectableProperties.getProperties().set("compositingStrategy", CompositingStrategy.m3332boximpl(this.compositingStrategy));
    }
}
