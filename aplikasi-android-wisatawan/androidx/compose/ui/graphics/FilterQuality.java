...
public final class FilterQuality {
    ...
    public static final int High = m3343constructorimpl(3);
    /* access modifiers changed from: private */
    public static final int Low = m3343constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Medium = m3343constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int None = m3343constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ FilterQuality m3342boximpl(int i) {
    ...
    public static boolean m3344equalsimpl(int i, Object obj) {
        return (obj instanceof FilterQuality) && i == ((FilterQuality) obj).m3348unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m3352getNonefv9h1I() {
            return FilterQuality.None;
        }

        /* renamed from: getLow-f-v9h1I  reason: not valid java name */
        public final int m3350getLowfv9h1I() {
            return FilterQuality.Low;
        }

        /* renamed from: getMedium-f-v9h1I  reason: not valid java name */
        public final int m3351getMediumfv9h1I() {
            return FilterQuality.Medium;
        }

        /* renamed from: getHigh-f-v9h1I  reason: not valid java name */
        public final int m3349getHighfv9h1I() {
            return FilterQuality.High;
        }
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3347toStringimpl(int arg0) {
        if (m3345equalsimpl0(arg0, None)) {
            return "None";
        }
        if (m3345equalsimpl0(arg0, Low)) {
            return "Low";
        }
        if (m3345equalsimpl0(arg0, Medium)) {
            return "Medium";
        }
        if (m3345equalsimpl0(arg0, High)) {
            return "High";
        }
        return "Unknown";
    }
