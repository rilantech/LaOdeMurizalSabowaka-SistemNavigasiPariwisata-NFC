...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.Companion.m3339getAutoNrFUSI();
    ...
    private long size = Size.Companion.m3080getUnspecifiedNHjbRc();
    ...
    public long m3586getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: setAmbientShadowColor-8_81llA  reason: not valid java name */
    public void m3591setAmbientShadowColor8_81llA(long j) {
        this.ambientShadowColor = j;
    }

    /* renamed from: getSpotShadowColor-0d7_KjU  reason: not valid java name */
    public long m3589getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: setSpotShadowColor-8_81llA  reason: not valid java name */
    public void m3594setSpotShadowColor8_81llA(long j) {
    ...
    public long m3590getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }

    /* renamed from: setTransformOrigin-__ExYCQ  reason: not valid java name */
    public void m3595setTransformOrigin__ExYCQ(long j) {
    ...
    public int m3587getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: setCompositingStrategy-aDBOjCE  reason: not valid java name */
    public void m3592setCompositingStrategyaDBOjCE(int i) {
        this.compositingStrategy = i;
    }

    /* renamed from: getSize-NH-jbRc  reason: not valid java name */
    public long m3588getSizeNHjbRc() {
        return this.size;
    }

    /* renamed from: setSize-uvyYCjk  reason: not valid java name */
    public void m3593setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        m3591setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        m3594setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        m3595setTransformOrigin__ExYCQ(TransformOrigin.Companion.m3680getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect((RenderEffect) null);
        m3592setCompositingStrategyaDBOjCE(CompositingStrategy.Companion.m3339getAutoNrFUSI());
        m3593setSizeuvyYCjk(Size.Companion.m3080getUnspecifiedNHjbRc());
    }
}
