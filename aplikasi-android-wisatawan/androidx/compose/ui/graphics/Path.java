...
public interface Path {
    ...
    void m3534addPathUv8p0NA(Path path, long j);
    ...
    boolean m3536opN5in7k0(Path path, Path path2, int i);
    ...
    void m3537setFillTypeoQ8Xj4U(int i);

    /* renamed from: translate-k-4lQ0M  reason: not valid java name */
    void m3539translatek4lQ0M(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static void m3542transform58bKbWc(Path $this, float[] matrix) {
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            Path.super.m3538transform58bKbWc(matrix);
        }
    }
    ...
    static /* synthetic */ void m3533addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                j = Offset.Companion.m3019getZeroF1C5BW0();
            }
            path.m3534addPathUv8p0NA(path2, j);
            return;
        }
    ...
    /* renamed from: transform-58bKbWc  reason: not valid java name */
    void m3538transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
    }
    ...
    public static final class Companion {
        ...
        public final Path m3540combinexh6zSI8(int operation, Path path1, Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path path = AndroidPath_androidKt.Path();
            if (path.m3536opN5in7k0(path1, path2, operation)) {
                return path;
            }
