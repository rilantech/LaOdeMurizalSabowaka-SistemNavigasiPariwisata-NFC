...
public final class DrawCache {
    ...
    private long size = IntSize.Companion.m6009getZeroYbymL2g();
    ...
    public final void m3962drawCachedImageCJJARo(long size2, Density density, LayoutDirection layoutDirection2, Function1<? super DrawScope, Unit> block) {
        ...
        if (targetImage == null || targetCanvas == null || IntSize.m6004getWidthimpl(size2) > targetImage.getWidth() || IntSize.m6003getHeightimpl(size2) > targetImage.getHeight()) {
            targetImage = ImageBitmapKt.m3477ImageBitmapx__hDU$default(IntSize.m6004getWidthimpl(size2), IntSize.m6003getHeightimpl(size2), 0, false, (ColorSpace) null, 28, (Object) null);
        ...
        long size$iv = IntSizeKt.m6014toSizeozmzZPI(size2);
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        ImageBitmap targetImage = this.mCachedImage;
        if (targetImage != null) {
            DrawScope.m3831drawImageAZ2fEMs$default(target, targetImage, 0, this.size, 0, 0, alpha, (DrawStyle) null, colorFilter, 0, 0, 858, (Object) null);
            return;
        }
    ...
    private final void clear(DrawScope $this$clear) {
        DrawScope.m3842drawRectnJ9OG0$default($this$clear, Color.Companion.m3279getBlack0d7_KjU(), 0, 0, 0.0f, (DrawStyle) null, (ColorFilter) null, BlendMode.Companion.m3159getClear0nO6VwU(), 62, (Object) null);
    }
}
