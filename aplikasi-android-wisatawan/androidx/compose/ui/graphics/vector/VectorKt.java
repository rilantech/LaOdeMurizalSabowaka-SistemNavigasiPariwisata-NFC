...
public final class VectorKt {
    private static final int DefaultFillType = PathFillType.Companion.m3552getNonZeroRgk1Os();
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.Companion.m3641getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.Companion.m3652getMiterLxFBmk8();
    public static final float DefaultStrokeLineMiter = 4.0f;
    public static final float DefaultStrokeLineWidth = 0.0f;
    private static final int DefaultTintBlendMode = BlendMode.Companion.m3184getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.Companion.m3288getTransparent0d7_KjU();
