...
public final class ImageVectorKt {
    ...
    public static /* synthetic */ ImageVector.Builder m3970pathR_LF3I$default(ImageVector.Builder $this$path_u2dR_LF_u2d3I_u24default, String name, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int strokeLineCap, int strokeLineJoin, float strokeLineMiter, int pathFillType, Function1 pathBuilder, int i, Object obj) {
        ...
        return ImageVector.Builder.m3967addPathoIyEayM$default($this$path_u2dR_LF_u2d3I_u24default, $this$PathData_u24lambda_u240$iv.getNodes(), pathFillType2, name2, fill2, fillAlpha2, stroke2, strokeAlpha2, strokeLineWidth2, strokeLineCap2, strokeLineJoin2, strokeLineMiter2, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
    }

    /* renamed from: path-R_LF-3I  reason: not valid java name */
    public static final ImageVector.Builder m3969pathR_LF3I(ImageVector.Builder $this$path_u2dR_LF_u2d3I, String name, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int strokeLineCap, int strokeLineJoin, float strokeLineMiter, int pathFillType, Function1<? super PathBuilder, Unit> pathBuilder) {
        ...
        PathBuilder $this$PathData_u24lambda_u240$iv = new PathBuilder();
        function1.invoke($this$PathData_u24lambda_u240$iv);
        return ImageVector.Builder.m3967addPathoIyEayM$default($this$path_u2dR_LF_u2d3I, $this$PathData_u24lambda_u240$iv.getNodes(), i, name, fill, fillAlpha, stroke, strokeAlpha, strokeLineWidth, strokeLineCap, strokeLineJoin, strokeLineMiter, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
    }
