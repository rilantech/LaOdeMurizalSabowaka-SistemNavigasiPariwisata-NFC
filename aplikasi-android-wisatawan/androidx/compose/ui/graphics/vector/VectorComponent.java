...
public final class VectorComponent extends VNode {
    ...
    private long previousDrawSize = Size.Companion.m3080getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope $this$draw, float alpha, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m3068equalsimpl0(this.previousDrawSize, $this$draw.m3866getSizeNHjbRc())) {
            this.root.setScaleX(Size.m3072getWidthimpl($this$draw.m3866getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m3069getHeightimpl($this$draw.m3866getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m3962drawCachedImageCJJARo(IntSizeKt.IntSize((int) ((float) Math.ceil((double) Size.m3072getWidthimpl($this$draw.m3866getSizeNHjbRc()))), (int) ((float) Math.ceil((double) Size.m3069getHeightimpl($this$draw.m3866getSizeNHjbRc())))), $this$draw, $this$draw.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = $this$draw.m3866getSizeNHjbRc();
        }
