...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        ...
        if (target == null) {
            matrix = Matrix.m3482constructorimpl$default((float[]) null, 1, (DefaultConstructorMarker) null);
            this.groupMatrix = matrix;
        } else {
            matrix = target;
            Matrix.m3491resetimpl(matrix);
        }
        Matrix.m3502translateimpl$default(matrix, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, (Object) null);
        Matrix.m3494rotateZimpl(matrix, this.rotation);
        Matrix.m3495scaleimpl(matrix, this.scaleX, this.scaleY, 1.0f);
        Matrix.m3502translateimpl$default(matrix, -this.pivotX, -this.pivotY, 0.0f, 4, (Object) null);
    }
    ...
    public void draw(DrawScope $this$draw) {
        ...
        if (fArr != null) {
            $this$draw_u24lambda_u245.m3926transform58bKbWc((fArr != null ? Matrix.m3480boximpl(fArr) : null).m3503unboximpl());
        }
        Path targetClip = this.clipPath;
        if (getWillClipPath() && targetClip != null) {
            DrawTransform.m3916clipPathmtrdDE$default($this$draw_u24lambda_u245, targetClip, 0, 2, (Object) null);
        }
