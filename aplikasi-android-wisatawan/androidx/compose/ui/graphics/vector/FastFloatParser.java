...
public final class FastFloatParser {
    ...
    public static final class Companion {
        ...
        public final int nextFloat(String s, int start, int end, FloatResult result) {
            long significand;
            int index;
            boolean isNegative;
            ...
            int i2 = start;
            int i3 = end;
            FloatResult floatResult = result;
            Intrinsics.checkNotNullParameter(str, "s");
            Intrinsics.checkNotNullParameter(floatResult, "result");
            floatResult.setValue(Float.NaN);
            floatResult.setValid(false);
            if (i2 == i3) {
                return i2;
            }
            int index2 = start;
            char c12 = str.charAt(index2);
            boolean isNegative2 = c12 == 45;
            if (isNegative2) {
                index2++;
                if (index2 == i3) {
                    return index2;
                }
                c12 = str.charAt(index2);
                if ((((char) (c12 + 65488)) < 10 ? (char) 1 : 0) == 0 && c12 != '.') {
                    return index2;
                }
            }
            long significand5 = 0;
            int significandStartIndex2 = index2;
            while (true) {
                if (index == i3) {
                    isNegative = isNegative2;
                    break;
                }
                if (!(((char) (c12 + 65488)) < 10)) {
                    isNegative = isNegative2;
                    break;
                }
                boolean isNegative3 = isNegative2;
                significand5 = (10 * significand) + ((long) (c12 - '0'));
                index2 = index + 1;
                int index$iv = index2;
                if (index$iv < str.length()) {
                    c11 = str.charAt(index$iv);
                } else {
                    c11 = 0;
                }
                c12 = c11;
            ...
            int digitCount2 = index - significandStartIndex2;
            int exponent = 0;
            int exponentStartIndex = index;
            int exponentEndIndex2 = index;
            long j2 = 0;
            if (index == i3 || c12 != '.') {
                significandEndIndex = significandEndIndex2;
                exponentEndIndex = exponentEndIndex2;
                c = c12;
            } else {
                index++;
                ...
                while (true) {
                    if (i3 - index < 4) {
                        significandEndIndex = significandEndIndex2;
                        significand4 = significand;
                        break;
                    }
                    significand4 = significand;
                    significandEndIndex = significandEndIndex2;
                    long v$iv = (((long) str.charAt(index + 1)) << 16) | ((long) str.charAt(index)) | (((long) str.charAt(index + 2)) << 32) | (((long) str.charAt(index + 3)) << 48);
                    long base$iv = v$iv - 13511005043687472L;
                    if ((((v$iv + 19703549022044230L) | base$iv) & -35747867511423104L) != 0) {
                        i = -1;
                        c10 = c12;
                        long j3 = v$iv;
                    } else {
                        c10 = c12;
                        long j4 = v$iv;
                        i = (int) ((281475406208040961L * base$iv) >>> 48);
                    }
                    int digits = i;
                    if (digits < 0) {
                        break;
                    }
                    significand = (significand4 * DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM) + ((long) digits);
                    index += 4;
                ...
                while (index != i3) {
                    if ((((char) (c + 65488)) < 10 ? (char) 1 : 0) == 0) {
                        break;
                    }
                    significand = (significand * 10) + ((long) (c - '0'));
                    index++;
                    int index$iv2 = index;
                    if (index$iv2 < str.length()) {
                        c9 = str.charAt(index$iv2);
                    } else {
                        c9 = 0;
                    }
                    c = c9;
            ...
            if ((c | ' ') == 'e') {
                int index3 = index + 1;
                int index$iv3 = index3;
                if (index$iv3 < str.length()) {
                    c6 = str.charAt(index$iv3);
                } else {
                    c6 = 0;
                }
                boolean isExponentNegative = c6 == '-';
                if (isExponentNegative || c6 == '+') {
                    index3++;
                }
                c2 = str.charAt(index3);
                while (true) {
                    if (index == i3) {
                    ...
                    significand2 = significand;
                    if ((((char) (c2 + 65488)) < 10 ? (char) 1 : 0) == 0) {
                        break;
                    }
                    if (exponentNumber < 1024) {
                        exponentNumber = (exponentNumber * 10) + (c2 - '0');
                    }
                    index3 = index + 1;
                    int index$iv4 = index3;
                    if (index$iv4 < str.length()) {
                        c7 = str.charAt(index$iv4);
                    } else {
                        c7 = 0;
                    }
                    c2 = c7;
            ...
            boolean tooManyDigits2 = false;
            if (digitCount2 > 19) {
                int retryIndex = significandStartIndex2;
                int c14 = str.charAt(retryIndex);
                while (index != i3) {
                    if (c2 != '0') {
                        if (c2 != '.') {
                            break;
                    ...
                    retryIndex++;
                    int index$iv5 = retryIndex;
                    if (index$iv5 < str.length()) {
                        c5 = str.charAt(index$iv5);
                    } else {
                        c5 = 0;
                    }
                    c14 = c5;
                ...
                if (digitCount2 > 19) {
                    boolean tooManyDigits3 = true;
                    int retryIndex2 = significandStartIndex2;
                    char c15 = str.charAt(retryIndex2);
                    significand3 = 0;
                    while (true) {
                        int exponent2 = exponent;
                        tooManyDigits = tooManyDigits3;
                        j = 1000000000000000000L;
                        if (retryIndex2 != significandEndIndex && Long.compareUnsigned(ULong.m6403constructorimpl(significand3), 1000000000000000000L) < 0) {
                            significand3 = (significand3 * 10) + ((long) (c2 - '0'));
                            retryIndex2++;
                            int index$iv6 = retryIndex2;
                            if (index$iv6 < str.length()) {
                                c4 = str.charAt(index$iv6);
                            } else {
                                c4 = 0;
                            }
                            c15 = c4;
                            ...
                            int i5 = end;
                            exponent = exponent2;
                            tooManyDigits3 = tooManyDigits;
                        }
                    }
                    if (Long.compareUnsigned(ULong.m6403constructorimpl(significand3), 1000000000000000000L) >= 0) {
                        exponent = (significandEndIndex - retryIndex2) + exponentNumber;
                        digitCount = digitCount2;
                        significandStartIndex = significandStartIndex2;
                        int retryIndex3 = significandEndIndex;
                        tooManyDigits2 = tooManyDigits;
                    } else {
                        int retryIndex4 = exponentStartIndex;
                        char c16 = str.charAt(retryIndex4);
                        while (true) {
                            if (retryIndex4 == exponentEndIndex) {
                                significandStartIndex = significandStartIndex2;
                                int i6 = significandEndIndex;
                                break;
                            }
                            significandStartIndex = significandStartIndex2;
                            int significandEndIndex3 = significandEndIndex;
                            if (Long.compareUnsigned(ULong.m6403constructorimpl(significand3), j) >= 0) {
                                break;
                            }
                            significand3 = (significand3 * 10) + ((long) (c2 - '0'));
                            retryIndex4++;
                            int index$iv7 = retryIndex4;
                            if (index$iv7 < str.length()) {
                                c3 = str.charAt(index$iv7);
                            } else {
                                c3 = 0;
                            }
                            c16 = c3;
                            significandStartIndex2 = significandStartIndex;
                            significandEndIndex = significandEndIndex3;
                            j = 1000000000000000000L;
                        }
                        exponent = (exponentStartIndex - retryIndex4) + exponentNumber;
                        digitCount = digitCount2;
                        tooManyDigits2 = tooManyDigits;
                    }
                } else {
                    int i7 = exponent;
                    significandStartIndex = significandStartIndex2;
                    int i8 = significandEndIndex;
                    digitCount = digitCount2;
                    significand3 = significand2;
                }
            } else {
                significandStartIndex = significandStartIndex2;
                int i9 = significandEndIndex;
                digitCount = digitCount2;
                significand3 = significand2;
            }
            if (!(FastFloatParser.FloatMinExponent <= exponent && exponent < 11)) {
                int i10 = significandStartIndex;
            } else if (!tooManyDigits2) {
                int i11 = digitCount;
                int i12 = significandStartIndex;
                if (Long.compareUnsigned(ULong.m6403constructorimpl(significand3), ULong.m6403constructorimpl(16777216)) <= 0) {
                    float f2 = (float) significand3;
                    if (exponent < 0) {
                        f = f2 / FastFloatParser.PowersOfTen[-exponent];
                    } else {
                        f = f2 * FastFloatParser.PowersOfTen[exponent];
                    }
                    floatResult.setValid(true);
                    floatResult.setValue(isNegative ? -f : f);
                    return index;
                }
            } else {
                int i13 = significandStartIndex;
            }
            if (significand3 == 0) {
                floatResult.setValid(true);
                floatResult.setValue(isNegative ? -0.0f : 0.0f);
                return index;
            }
            if (!(-126 <= exponent && exponent < 128)) {
                try {
                    ...
                    floatResult.setValue(Float.parseFloat(substring));
                    return index;
                } finally {
                    floatResult.setValid(true);
                }
                ...
                int i14 = start;
                long significandFactor = ULongArray.m6463getsVKNKU(FastFloatParser.Mantissa64, exponent + 325);
                int lz = Long.numberOfLeadingZeros(significand3);
                long significand6 = significand3 << lz;
                long xLo$iv = significand6 & 4294967295L;
                long xHi$iv = significand6 >>> 32;
                long yLo$iv = significandFactor & 4294967295L;
                long yHi$iv = significandFactor >>> 32;
                long xTimesYMid$iv = xLo$iv * yHi$iv;
                long upper = (xHi$iv * yHi$iv) + ((((xHi$iv * yLo$iv) + ((xLo$iv * yLo$iv) >>> 32)) + (xTimesYMid$iv & 4294967295L)) >>> 32) + (xTimesYMid$iv >>> 32);
                int i15 = c2;
                int i16 = exponentEndIndex;
                int i17 = exponentNumber;
                int upperBit = (int) (upper >>> 63);
                long mantissa = upper >>> (upperBit + 9);
                int lz2 = (upperBit ^ 1) + lz;
                if ((upper & 511) == 511) {
                    int i18 = exponent;
                    boolean z = tooManyDigits2;
                } else if ((upper & 511) == 0 && (mantissa & 3) == 1) {
                    int i19 = upperBit;
                    int i20 = exponent;
                    boolean z2 = tooManyDigits2;
                } else {
                    ...
                    int i21 = upperBit;
                    int i22 = exponent;
                    boolean z3 = tooManyDigits2;
                    long adjustedExponent = ((((long) exponent) * 217706) >> 16) + ((long) 1024) + ((long) 63);
                    long realExponent = adjustedExponent - ((long) lz2);
                    if (realExponent < 1) {
                    } else if (realExponent > 2046) {
                        long j5 = adjustedExponent;
                    } else {
                        long mantissa4 = mantissa3 | (realExponent << 52);
                        if (isNegative) {
                            j2 = Long.MIN_VALUE;
                        }
                        floatResult.setValid(true);
                        DoubleCompanionObject doubleCompanionObject = DoubleCompanionObject.INSTANCE;
                        long j6 = adjustedExponent;
                        floatResult.setValue((float) Double.longBitsToDouble(mantissa4 | j2));
                        return index;
                    }
                    try {
                        String substring2 = str.substring(i14, index);
                        Intrinsics.checkNotNullExpressionValue(substring2, "this as java.lang.String…ing(startIndex, endIndex)");
                        floatResult.setValue(Float.parseFloat(substring2));
                        return index;
                    } finally {
                        floatResult.setValid(true);
                    }
                ...
                try {
                    String substring3 = str.substring(i14, index);
                    Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String…ing(startIndex, endIndex)");
                    floatResult.setValue(Float.parseFloat(substring3));
                    return index;
                } finally {
                    floatResult.setValid(true);
                }
