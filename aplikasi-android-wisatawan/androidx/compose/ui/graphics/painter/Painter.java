...
public abstract class Painter {
    ...
    public abstract long m3961getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m3959drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter2, int i, Object obj) {
        float f2;
        ...
        if (obj == null) {
            ...
            painter.m3960drawx_KDEd0(drawScope, j, f2, colorFilter3);
            return;
        }
    ...
    public final void m3960drawx_KDEd0(DrawScope $this$draw_u2dx_KDEd0, long size, float alpha2, ColorFilter colorFilter2) {
        float f = alpha2;
        ...
        float r0 = Size.m3072getWidthimpl($this$draw_u2dx_KDEd0.m3866getSizeNHjbRc()) - Size.m3072getWidthimpl(size);
        float bottom$iv = Size.m3069getHeightimpl($this$draw_u2dx_KDEd0.m3866getSizeNHjbRc()) - Size.m3069getHeightimpl(size);
        ...
        if (f > 0.0f && Size.m3072getWidthimpl(size) > 0.0f && Size.m3069getHeightimpl(size) > 0.0f) {
            if (this.useLayer) {
                Rect layerRect = RectKt.m3043Recttz77jQw(Offset.Companion.m3019getZeroF1C5BW0(), SizeKt.Size(Size.m3072getWidthimpl(size), Size.m3069getHeightimpl(size)));
