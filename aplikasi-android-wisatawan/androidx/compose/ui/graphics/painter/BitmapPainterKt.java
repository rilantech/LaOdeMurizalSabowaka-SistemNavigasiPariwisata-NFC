...
public final class BitmapPainterKt {
    ...
    public static /* synthetic */ BitmapPainter m3955BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j, long j2, int i, int i2, Object obj) {
        long j3;
        long j4;
        int i3;
        if ((i2 & 2) != 0) {
            j3 = IntOffset.Companion.m5972getZeronOccac();
        } else {
            j3 = j;
        }
        if ((i2 & 4) != 0) {
        ...
        if ((i2 & 8) != 0) {
            i3 = FilterQuality.Companion.m3350getLowfv9h1I();
        } else {
            i3 = i;
        }
        return m3954BitmapPainterQZhYCtY(imageBitmap, j3, j4, i3);
    }

    /* renamed from: BitmapPainter-QZhYCtY  reason: not valid java name */
    public static final BitmapPainter m3954BitmapPainterQZhYCtY(ImageBitmap image, long srcOffset, long srcSize, int filterQuality) {
        ...
        $this$BitmapPainter_QZhYCtY_u24lambda_u240.m3953setFilterQualityvDHp3xo$ui_graphics_release(filterQuality);
