...
public final class AndroidPathEffect implements PathEffect {
    ...
    public AndroidPathEffect(PathEffect nativePathEffect2) {
        Intrinsics.checkNotNullParameter(nativePathEffect2, "nativePathEffect");
        this.nativePathEffect = nativePathEffect2;
    }
