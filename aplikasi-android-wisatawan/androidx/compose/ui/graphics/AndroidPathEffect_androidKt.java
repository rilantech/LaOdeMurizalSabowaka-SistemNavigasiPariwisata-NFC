...
public final class AndroidPathEffect_androidKt {
    ...
    public static final PathEffect m3140actualStampedPathEffect7aD1DOk(Path shape, float advance, float phase, int style) {
        Intrinsics.checkNotNullParameter(shape, "shape");
        Path $this$asAndroidPath$iv = shape;
        if ($this$asAndroidPath$iv instanceof AndroidPath) {
            return new AndroidPathEffect(new PathDashPathEffect(((AndroidPath) $this$asAndroidPath$iv).getInternalPath(), advance, phase, m3141toAndroidPathDashPathEffectStyleoQv6xUo(style)));
        }
        throw new UnsupportedOperationException("Unable to obtain android.graphics.Path");
    }

    /* renamed from: toAndroidPathDashPathEffectStyle-oQv6xUo  reason: not valid java name */
    public static final PathDashPathEffect.Style m3141toAndroidPathDashPathEffectStyleoQv6xUo(int $this$toAndroidPathDashPathEffectStyle_u2doQv6xUo) {
        if (StampedPathEffectStyle.m3627equalsimpl0($this$toAndroidPathDashPathEffectStyle_u2doQv6xUo, StampedPathEffectStyle.Companion.m3631getMorphYpspkwk())) {
            return PathDashPathEffect.Style.MORPH;
        }
        if (StampedPathEffectStyle.m3627equalsimpl0($this$toAndroidPathDashPathEffectStyle_u2doQv6xUo, StampedPathEffectStyle.Companion.m3632getRotateYpspkwk())) {
            return PathDashPathEffect.Style.ROTATE;
        }
        if (StampedPathEffectStyle.m3627equalsimpl0($this$toAndroidPathDashPathEffectStyle_u2doQv6xUo, StampedPathEffectStyle.Companion.m3633getTranslateYpspkwk())) {
