...
public final class Rgb extends ColorSpace {
    ...
    public Rgb(String name, float[] primaries2, WhitePoint whitePoint2, float[] transform2, DoubleFunction oetf2, DoubleFunction eotf2, float min2, float max2, TransferParameters transferParameters2, int id) {
        super(name, ColorModel.Companion.m3703getRgbxdoWZVw(), id, (DefaultConstructorMarker) null);
    ...
    public long m3734xyzaToColorJlNiLsg$ui_graphics_release(float x, float y, float z, float a, ColorSpace colorSpace) {
        Intrinsics.checkNotNullParameter(colorSpace, "colorSpace");
