...
public final class WhitePoint {
    ...
    public WhitePoint(float x2, float y2) {
        this.x = x2;
        this.y = y2;
    }
    ...
    public WhitePoint(float x2, float y2, float z) {
        this(x2, y2, z, x2 + y2 + z);
    }

    private WhitePoint(float x2, float y2, float z, float sum) {
        this(x2 / sum, y2 / sum);
    }
