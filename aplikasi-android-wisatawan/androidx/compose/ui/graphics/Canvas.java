...
public interface Canvas {
    ...
    void m3218clipPathmtrdDE(Path path, int i);

    /* renamed from: clipRect-N_I0leg  reason: not valid java name */
    void m3219clipRectN_I0leg(float f, float f2, float f3, float f4, int i);

    /* renamed from: concat-58bKbWc  reason: not valid java name */
    void m3221concat58bKbWc(float[] fArr);
    ...
    void m3222drawCircle9KIMszo(long j, float f, Paint paint);

    /* renamed from: drawImage-d-4ec7I  reason: not valid java name */
    void m3223drawImaged4ec7I(ImageBitmap imageBitmap, long j, Paint paint);

    /* renamed from: drawImageRect-HPBpro0  reason: not valid java name */
    void m3224drawImageRectHPBpro0(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint);

    /* renamed from: drawLine-Wko1d7g  reason: not valid java name */
    void m3225drawLineWko1d7g(long j, long j2, Paint paint);
    ...
    void m3226drawPointsO7TthRY(int i, List<Offset> list, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY  reason: not valid java name */
    void m3227drawRawPointsO7TthRY(int i, float[] fArr, Paint paint);
    ...
    void m3228drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m3231clipRectmtrdDE(Canvas $this, Rect rect, int clipOp) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            Canvas.super.m3220clipRectmtrdDE(rect, clipOp);
        }
    ...
    static /* synthetic */ void m3216clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 2) != 0) {
                i = ClipOp.Companion.m3242getIntersectrtfAjoo();
            }
            canvas.m3220clipRectmtrdDE(rect, i);
            return;
        }
    ...
    /* renamed from: clipRect-mtrdD-E  reason: not valid java name */
    void m3220clipRectmtrdDE(Rect rect, int clipOp) {
        Intrinsics.checkNotNullParameter(rect, "rect");
        m3219clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
    }

    /* renamed from: clipRect-N_I0leg$default  reason: not valid java name */
    static /* synthetic */ void m3215clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        if (obj == null) {
            canvas.m3219clipRectN_I0leg(f, f2, f3, f4, (i2 & 16) != 0 ? ClipOp.Companion.m3242getIntersectrtfAjoo() : i);
            return;
        }
    ...
    static /* synthetic */ void m3214clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 2) != 0) {
                i = ClipOp.Companion.m3242getIntersectrtfAjoo();
            }
            canvas.m3218clipPathmtrdDE(path, i);
            return;
        }
    ...
    static /* synthetic */ void m3217drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        long j5;
        long j6;
        long j7;
        long j8;
        if (obj == null) {
            ...
            canvas.m3224drawImageRectHPBpro0(imageBitmap, j5, j6, j7, j8, paint);
            return;
        }
