...
public final class MatrixKt {
    ...
    public static final float m3505dotp89u6pk(float[] m1, int row, float[] m2, int column) {
    ...
    public static final boolean m3506isIdentity58bKbWc(float[] $this$isIdentity_u2d58bKbWc) {
