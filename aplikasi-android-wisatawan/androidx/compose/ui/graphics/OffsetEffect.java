...
public final class OffsetEffect extends RenderEffect {
    ...
    public RenderEffect createRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m3585createOffsetEffectUv8p0NA(this.renderEffect, this.offset);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OffsetEffect) && Intrinsics.areEqual((Object) this.renderEffect, (Object) ((OffsetEffect) other).renderEffect) && Offset.m3000equalsimpl0(this.offset, ((OffsetEffect) other).offset)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((renderEffect2 != null ? renderEffect2.hashCode() : 0) * 31) + Offset.m3005hashCodeimpl(this.offset);
    }

    public String toString() {
        return "OffsetEffect(renderEffect=" + this.renderEffect + ", offset=" + Offset.m3011toStringimpl(this.offset) + ')';
    }
}
