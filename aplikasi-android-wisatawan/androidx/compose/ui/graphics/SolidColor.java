...
public final class SolidColor extends Brush {
    ...
    public void m3622applyToPq9zytI(long size, Paint p, float alpha) {
        long j;
        Intrinsics.checkNotNullParameter(p, "p");
        p.setAlpha(1.0f);
        if (!(alpha == 1.0f)) {
            long j2 = this.value;
            j = Color.m3252copywmQWz5c$default(j2, Color.m3255getAlphaimpl(j2) * alpha, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            j = this.value;
        }
        p.m3518setColor8_81llA(j);
        if (p.getShader() != null) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SolidColor) && Color.m3254equalsimpl0(this.value, ((SolidColor) other).value)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "SolidColor(value=" + Color.m3261toStringimpl(this.value) + ')';
    }
}
