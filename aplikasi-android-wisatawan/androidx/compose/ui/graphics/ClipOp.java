...
public final class ClipOp {
    ...
    public static final int Difference = m3235constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Intersect = m3235constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ ClipOp m3234boximpl(int i) {
        return new ClipOp(i);
    }
    ...
    public static boolean m3236equalsimpl(int i, Object obj) {
        return (obj instanceof ClipOp) && i == ((ClipOp) obj).m3240unboximpl();
    }
    ...
    public static String m3239toStringimpl(int arg0) {
        if (m3237equalsimpl0(arg0, Difference)) {
            return "Difference";
        }
        if (m3237equalsimpl0(arg0, Intersect)) {
            return "Intersect";
        }
        return "Unknown";
    }
