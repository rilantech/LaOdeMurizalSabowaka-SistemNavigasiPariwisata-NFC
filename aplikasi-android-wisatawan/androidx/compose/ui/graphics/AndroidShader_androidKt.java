...
public final class AndroidShader_androidKt {
    ...
    public static final Shader m3145ActualLinearGradientShaderVjE6UOU(long from, long to, List<Color> colors, List<Float> colorStops, int tileMode) {
        ...
        return new LinearGradient(Offset.m3003getXimpl(from), Offset.m3004getYimpl(from), Offset.m3003getXimpl(to), Offset.m3004getYimpl(to), makeTransparentColors(list, numTransparentColors), makeTransparentStops(colorStops, list, numTransparentColors), AndroidTileMode_androidKt.m3149toAndroidTileMode0vamqd0(tileMode));
    }

    /* renamed from: ActualRadialGradientShader-8uybcMk  reason: not valid java name */
    public static final Shader m3146ActualRadialGradientShader8uybcMk(long center, float radius, List<Color> colors, List<Float> colorStops, int tileMode) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        validateColorStops(colors, colorStops);
        int numTransparentColors = countTransparentColors(colors);
        return new RadialGradient(Offset.m3003getXimpl(center), Offset.m3004getYimpl(center), radius, makeTransparentColors(colors, numTransparentColors), makeTransparentStops(colorStops, colors, numTransparentColors), AndroidTileMode_androidKt.m3149toAndroidTileMode0vamqd0(tileMode));
    }

    /* renamed from: ActualSweepGradientShader-9KIMszo  reason: not valid java name */
    public static final Shader m3147ActualSweepGradientShader9KIMszo(long center, List<Color> colors, List<Float> colorStops) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        validateColorStops(colors, colorStops);
        int numTransparentColors = countTransparentColors(colors);
        return new SweepGradient(Offset.m3003getXimpl(center), Offset.m3004getYimpl(center), makeTransparentColors(colors, numTransparentColors), makeTransparentStops(colorStops, colors, numTransparentColors));
    }

    /* renamed from: ActualImageShader-F49vj9s  reason: not valid java name */
    public static final Shader m3144ActualImageShaderF49vj9s(ImageBitmap image, int tileModeX, int tileModeY) {
        Intrinsics.checkNotNullParameter(image, "image");
        return new BitmapShader(AndroidImageBitmap_androidKt.asAndroidBitmap(image), AndroidTileMode_androidKt.m3149toAndroidTileMode0vamqd0(tileModeX), AndroidTileMode_androidKt.m3149toAndroidTileMode0vamqd0(tileModeY));
    }
    ...
    public static final int[] makeTransparentColors(List<Color> colors, int numTransparentColors) {
        ...
        for (int i = 0; i < size; i++) {
            iArr[i] = ColorKt.m3307toArgb8_81llA(colors.get(i).m3263unboximpl());
        }
        return iArr;
    }
    ...
    public static final float[] makeTransparentStops(List<Float> stops, List<Color> colors, int numTransparentColors) {
        ...
        if (numTransparentColors != 0) {
            ...
            for (int i = 1; i < lastIndex; i++) {
                long color = colors.get(i).m3263unboximpl();
                ...
                if (Color.m3255getAlphaimpl(color) == 0.0f) {
