...
public abstract class ShaderBrush extends Brush {
    private long createdSize = Size.Companion.m3080getUnspecifiedNHjbRc();
    private Shader internalShader;

    /* renamed from: createShader-uvyYCjk  reason: not valid java name */
    public abstract Shader m3597createShaderuvyYCjk(long j);
    ...
    public final void m3596applyToPq9zytI(long size, Paint p, float alpha) {
        Intrinsics.checkNotNullParameter(p, "p");
        Shader shader = this.internalShader;
        if (shader == null || !Size.m3068equalsimpl0(this.createdSize, size)) {
            if (Size.m3074isEmptyimpl(size)) {
                shader = null;
                this.internalShader = null;
                this.createdSize = Size.Companion.m3080getUnspecifiedNHjbRc();
            } else {
                Shader it = m3597createShaderuvyYCjk(size);
                this.internalShader = it;
                shader = it;
                this.createdSize = size;
            }
        }
        if (!Color.m3254equalsimpl0(p.m3512getColor0d7_KjU(), Color.Companion.m3279getBlack0d7_KjU())) {
            p.m3518setColor8_81llA(Color.Companion.m3279getBlack0d7_KjU());
        }
