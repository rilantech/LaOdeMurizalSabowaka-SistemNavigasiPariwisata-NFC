...
public final class VertexMode {
    ...
    public static final int TriangleFan = m3682constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int TriangleStrip = m3682constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Triangles = m3682constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ VertexMode m3681boximpl(int i) {
    ...
    public static boolean m3683equalsimpl(int i, Object obj) {
        return (obj instanceof VertexMode) && i == ((VertexMode) obj).m3687unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m3683equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3685hashCodeimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m3687unboximpl() {
        return this.value;
    }
    ...
    public static final class Companion {
        ...
        public final int m3690getTrianglesc2xauaI() {
            return VertexMode.Triangles;
        }

        /* renamed from: getTriangleStrip-c2xauaI  reason: not valid java name */
        public final int m3689getTriangleStripc2xauaI() {
            return VertexMode.TriangleStrip;
        }

        /* renamed from: getTriangleFan-c2xauaI  reason: not valid java name */
        public final int m3688getTriangleFanc2xauaI() {
            return VertexMode.TriangleFan;
        }
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3686toStringimpl(int arg0) {
        if (m3684equalsimpl0(arg0, Triangles)) {
            return "Triangles";
        }
        if (m3684equalsimpl0(arg0, TriangleStrip)) {
            return "TriangleStrip";
        }
        if (m3684equalsimpl0(arg0, TriangleFan)) {
            return "TriangleFan";
        }
        return "Unknown";
    }
    ...
    public String toString() {
        return m3686toStringimpl(this.value);
    }
}
