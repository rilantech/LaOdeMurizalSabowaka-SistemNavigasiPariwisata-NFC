...
final class PainterElement extends ModifierNodeElement<PainterNode> {
    ...
    public void update(PainterNode node) {
        ...
        boolean z = this.sizeToIntrinsics;
        boolean intrinsicsChanged = sizeToIntrinsics2 != z || (z && !Size.m3068equalsimpl0(node.getPainter().m3961getIntrinsicSizeNHjbRc(), this.painter.m3961getIntrinsicSizeNHjbRc()));
