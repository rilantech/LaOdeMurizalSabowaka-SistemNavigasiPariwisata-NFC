...
final class CacheDrawModifierNodeImpl extends Modifier.Node implements CacheDrawModifierNode, ObserverModifierNode, BuildDrawCacheParams {
    ...
    public CacheDrawModifierNodeImpl(CacheDrawScope cacheDrawScope2, Function1<? super CacheDrawScope, DrawResult> block2) {
    ...
    public long m2903getSizeNHjbRc() {
    ...
    private final DrawResult getOrBuildCachedDrawBlock() {
        if (!this.isCacheValid) {
            CacheDrawScope $this$getOrBuildCachedDrawBlock_u24lambda_u241 = this.cacheDrawScope;
            $this$getOrBuildCachedDrawBlock_u24lambda_u241.setDrawResult$ui_release((DrawResult) null);
            ObserverModifierNodeKt.observeReads(this, new CacheDrawModifierNodeImpl$getOrBuildCachedDrawBlock$1$1(this, $this$getOrBuildCachedDrawBlock_u24lambda_u241));
            if ($this$getOrBuildCachedDrawBlock_u24lambda_u241.getDrawResult$ui_release() != null) {
