...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View $this$layoutAccordingTo, LayoutNode layoutNode) {
        ...
        int x = MathKt.roundToInt(Offset.m3003getXimpl(position));
        int y = MathKt.roundToInt(Offset.m3004getYimpl(position));
    ...
    public static final int toNestedScrollSource(int type) {
        if (type == 0) {
            return NestedScrollSource.Companion.m4377getDragWNlRxjI();
        }
        return NestedScrollSource.Companion.m4378getFlingWNlRxjI();
    }
}
