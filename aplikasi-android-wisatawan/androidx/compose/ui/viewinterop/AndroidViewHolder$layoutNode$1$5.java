...
public final class AndroidViewHolder$layoutNode$1$5 implements MeasurePolicy {
    ...
    public MeasureResult m6081measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> measurables, long constraints) {
        Intrinsics.checkNotNullParameter($this$measure_u2d3p2s80s, "$this$measure");
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        if (this.$this_run.getChildCount() == 0) {
            return MeasureScope.layout$default($this$measure_u2d3p2s80s, Constraints.m5790getMinWidthimpl(constraints), Constraints.m5789getMinHeightimpl(constraints), (Map) null, AndroidViewHolder$layoutNode$1$5$measure$1.INSTANCE, 4, (Object) null);
        }
        if (Constraints.m5790getMinWidthimpl(constraints) != 0) {
            this.$this_run.getChildAt(0).setMinimumWidth(Constraints.m5790getMinWidthimpl(constraints));
        }
        if (Constraints.m5789getMinHeightimpl(constraints) != 0) {
            this.$this_run.getChildAt(0).setMinimumHeight(Constraints.m5789getMinHeightimpl(constraints));
        }
        AndroidViewHolder androidViewHolder = this.$this_run;
        int r1 = Constraints.m5790getMinWidthimpl(constraints);
        ...
        int r3 = Constraints.m5789getMinHeightimpl(constraints);
        int r4 = Constraints.m5787getMaxHeightimpl(constraints);
