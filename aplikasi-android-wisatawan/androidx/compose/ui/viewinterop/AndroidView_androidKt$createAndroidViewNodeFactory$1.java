...
final class AndroidView_androidKt$createAndroidViewNodeFactory$1 extends Lambda implements Function0<LayoutNode> {
    ...
    AndroidView_androidKt$createAndroidViewNodeFactory$1(Context context, Function1<? super Context, ? extends T> function1, CompositionContext compositionContext, SaveableStateRegistry saveableStateRegistry, int i) {
        super(0);
