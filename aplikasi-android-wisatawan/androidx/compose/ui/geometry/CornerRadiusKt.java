...
public final class CornerRadiusKt {
    public static final long CornerRadius(float x, float y) {
        return CornerRadius.m2972constructorimpl((((long) Float.floatToIntBits(x)) << 32) | (4294967295L & ((long) Float.floatToIntBits(y))));
    }
    ...
    public static final long m2989lerp3Ry4LBc(long start, long stop, float fraction) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m2978getXimpl(start), CornerRadius.m2978getXimpl(stop), fraction), MathHelpersKt.lerp(CornerRadius.m2979getYimpl(start), CornerRadius.m2979getYimpl(stop), fraction));
    }
}
