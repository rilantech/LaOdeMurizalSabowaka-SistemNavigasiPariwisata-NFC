...
public final class IntRectKt {
    ...
    public static final IntRect m5994IntRectVbeCjmY(long offset, long size) {
        return new IntRect(IntOffset.m5962getXimpl(offset), IntOffset.m5963getYimpl(offset), IntOffset.m5962getXimpl(offset) + IntSize.m6004getWidthimpl(size), IntOffset.m5963getYimpl(offset) + IntSize.m6003getHeightimpl(size));
    }

    /* renamed from: IntRect-E1MhUcY  reason: not valid java name */
    public static final IntRect m5993IntRectE1MhUcY(long topLeft, long bottomRight) {
        return new IntRect(IntOffset.m5962getXimpl(topLeft), IntOffset.m5963getYimpl(topLeft), IntOffset.m5962getXimpl(bottomRight), IntOffset.m5963getYimpl(bottomRight));
    }

    /* renamed from: IntRect-ar5cAso  reason: not valid java name */
    public static final IntRect m5995IntRectar5cAso(long center, int radius) {
        return new IntRect(IntOffset.m5962getXimpl(center) - radius, IntOffset.m5963getYimpl(center) - radius, IntOffset.m5962getXimpl(center) + radius, IntOffset.m5963getYimpl(center) + radius);
    }
