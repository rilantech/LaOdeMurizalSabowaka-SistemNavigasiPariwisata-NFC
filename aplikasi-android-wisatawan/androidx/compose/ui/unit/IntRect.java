...
public final class IntRect {
    ...
    public static /* synthetic */ void m5980getSizeYbymL2g$annotations() {
    }
    ...
    public IntRect(int left2, int top2, int right2, int bottom2) {
        this.left = left2;
        this.top = top2;
        this.right = right2;
        this.bottom = bottom2;
    ...
    public final long m5988getSizeYbymL2g() {
    ...
    public final IntRect m5992translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m5962getXimpl(offset), this.top + IntOffset.m5963getYimpl(offset), this.right + IntOffset.m5962getXimpl(offset), this.bottom + IntOffset.m5963getYimpl(offset));
    }
