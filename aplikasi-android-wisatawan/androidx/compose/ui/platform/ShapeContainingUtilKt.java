...
public final class ShapeContainingUtilKt {
    ...
    private static final boolean isInRoundedRect(Outline.Rounded outline, float x, float y, Path touchPointPath, Path opPath) {
        ...
        if (f < rrect.getLeft() || f >= rrect.getRight() || f2 < rrect.getTop()) {
            ...
            float topLeftX = rrect.getLeft() + CornerRadius.m2978getXimpl(rrect.m3053getTopLeftCornerRadiuskKHJgLs());
            float topLeftY = rrect.getTop() + CornerRadius.m2979getYimpl(rrect.m3053getTopLeftCornerRadiuskKHJgLs());
            float topRightX = rrect.getRight() - CornerRadius.m2978getXimpl(rrect.m3054getTopRightCornerRadiuskKHJgLs());
            float topRightY = rrect.getTop() + CornerRadius.m2979getYimpl(rrect.m3054getTopRightCornerRadiuskKHJgLs());
            float bottomRightX = rrect.getRight() - CornerRadius.m2978getXimpl(rrect.m3052getBottomRightCornerRadiuskKHJgLs());
            float bottomRightY = rrect.getBottom() - CornerRadius.m2979getYimpl(rrect.m3052getBottomRightCornerRadiuskKHJgLs());
            float bottomLeftX = rrect.getBottom() - CornerRadius.m2979getYimpl(rrect.m3051getBottomLeftCornerRadiuskKHJgLs());
            float bottomLeftY = rrect.getLeft() + CornerRadius.m2978getXimpl(rrect.m3051getBottomLeftCornerRadiuskKHJgLs());
            if (f < topLeftX && f2 < topLeftY) {
                return m5129isWithinEllipseVE1yxkc(x, y, rrect.m3053getTopLeftCornerRadiuskKHJgLs(), topLeftX, topLeftY);
            } else if (f < bottomLeftY && f2 > bottomLeftX) {
                return m5129isWithinEllipseVE1yxkc(x, y, rrect.m3051getBottomLeftCornerRadiuskKHJgLs(), bottomLeftY, bottomLeftX);
            } else if (f > topRightX && f2 < topRightY) {
                return m5129isWithinEllipseVE1yxkc(x, y, rrect.m3054getTopRightCornerRadiuskKHJgLs(), topRightX, topRightY);
            } else if (f <= bottomRightX || f2 <= bottomRightY) {
                return true;
            } else {
                return m5129isWithinEllipseVE1yxkc(x, y, rrect.m3052getBottomRightCornerRadiuskKHJgLs(), bottomRightX, bottomRightY);
            }
        }
    }

    private static final boolean cornersFit(RoundRect $this$cornersFit) {
        return CornerRadius.m2978getXimpl($this$cornersFit.m3053getTopLeftCornerRadiuskKHJgLs()) + CornerRadius.m2978getXimpl($this$cornersFit.m3054getTopRightCornerRadiuskKHJgLs()) <= $this$cornersFit.getWidth() && CornerRadius.m2978getXimpl($this$cornersFit.m3051getBottomLeftCornerRadiuskKHJgLs()) + CornerRadius.m2978getXimpl($this$cornersFit.m3052getBottomRightCornerRadiuskKHJgLs()) <= $this$cornersFit.getWidth() && CornerRadius.m2979getYimpl($this$cornersFit.m3053getTopLeftCornerRadiuskKHJgLs()) + CornerRadius.m2979getYimpl($this$cornersFit.m3051getBottomLeftCornerRadiuskKHJgLs()) <= $this$cornersFit.getHeight() && CornerRadius.m2979getYimpl($this$cornersFit.m3054getTopRightCornerRadiuskKHJgLs()) + CornerRadius.m2979getYimpl($this$cornersFit.m3052getBottomRightCornerRadiuskKHJgLs()) <= $this$cornersFit.getHeight();
    }

    /* renamed from: isWithinEllipse-VE1yxkc  reason: not valid java name */
    private static final boolean m5129isWithinEllipseVE1yxkc(float x, float y, long cornerRadius, float centerX, float centerY) {
        float px = x - centerX;
        float py = y - centerY;
        float radiusX = CornerRadius.m2978getXimpl(cornerRadius);
        float radiusY = CornerRadius.m2979getYimpl(cornerRadius);
    ...
    private static final boolean isInPath(Path path, float x, float y, Path tmpTouchPointPath, Path tmpOpPath) {
        ...
        opPath.m3536opN5in7k0(path, touchPointPath, PathOperation.Companion.m3563getIntersectb3I0S0c());
