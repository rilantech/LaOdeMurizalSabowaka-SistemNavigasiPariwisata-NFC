...
public final class SemanticsNodeWithAdjustedBounds {
    ...
    public SemanticsNodeWithAdjustedBounds(SemanticsNode semanticsNode2, Rect adjustedBounds2) {
        Intrinsics.checkNotNullParameter(semanticsNode2, "semanticsNode");
        Intrinsics.checkNotNullParameter(adjustedBounds2, "adjustedBounds");
        this.semanticsNode = semanticsNode2;
        this.adjustedBounds = adjustedBounds2;
    }
