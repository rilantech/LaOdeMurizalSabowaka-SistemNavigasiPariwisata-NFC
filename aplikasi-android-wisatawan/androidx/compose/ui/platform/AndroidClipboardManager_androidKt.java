...
public final class AndroidClipboardManager_androidKt {
    ...
    public static final AnnotatedString convertToAnnotatedString(CharSequence $this$convertToAnnotatedString) {
        ...
        if (!($this$convertToAnnotatedString instanceof Spanned)) {
            return new AnnotatedString($this$convertToAnnotatedString.toString(), (List) null, (List) null, 6, (DefaultConstructorMarker) null);
        }
        ...
        int lastIndex = ArraysKt.getLastIndex((T[]) annotations);
        if (0 <= lastIndex) {
            while (true) {
                Annotation span = annotations[i];
                if (Intrinsics.areEqual((Object) span.getKey(), (Object) "androidx.compose.text.SpanStyle")) {
                    ...
                    spanStyleRanges.add(new AnnotatedString.Range(new DecodeHelper(value).decodeSpanStyle(), start, end));
                }
                if (i == lastIndex) {
                    break;
                }
        ...
        return new AnnotatedString($this$convertToAnnotatedString.toString(), spanStyleRanges, (List) null, 4, (DefaultConstructorMarker) null);
    }
    ...
    public static final CharSequence convertToCharSequence(AnnotatedString $this$convertToCharSequence) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            EncodeHelper $this$convertToCharSequence_u24lambda_u241_u24lambda_u240 = encodeHelper;
            $this$convertToCharSequence_u24lambda_u241_u24lambda_u240.reset();
            $this$convertToCharSequence_u24lambda_u241_u24lambda_u240.encode((SpanStyle) range.component1());
