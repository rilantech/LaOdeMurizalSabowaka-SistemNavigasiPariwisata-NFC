...
public final class ScrollObservationScope implements OwnerScope {
    ...
    public ScrollObservationScope(int semanticsNodeId2, List<ScrollObservationScope> allScopes2, Float oldXValue2, Float oldYValue2, ScrollAxisRange horizontalScrollAxisRange2, ScrollAxisRange verticalScrollAxisRange2) {
        Intrinsics.checkNotNullParameter(allScopes2, "allScopes");
        this.semanticsNodeId = semanticsNodeId2;
        this.allScopes = allScopes2;
        this.oldXValue = oldXValue2;
        this.oldYValue = oldYValue2;
        this.horizontalScrollAxisRange = horizontalScrollAxisRange2;
        this.verticalScrollAxisRange = verticalScrollAxisRange2;
    }
