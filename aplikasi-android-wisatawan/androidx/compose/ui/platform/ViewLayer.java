...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    private long mTransformOrigin = TransformOrigin.Companion.m3680getCenterSzJe1aQ();
    ...
    public void m5139updateLayerPropertiesdDxrwY(float r22, float r23, float r24, float r25, float r26, float r27, float r28, float r29, float r30, float r31, long r32, androidx.compose.ui.graphics.Shape r34, boolean r35, androidx.compose.ui.graphics.RenderEffect r36, long r37, long r39, int r41, androidx.compose.ui.unit.LayoutDirection r42, androidx.compose.ui.unit.Density r43) {
        /*
            ...
            float r1 = androidx.compose.ui.graphics.TransformOrigin.m3675getPivotFractionXimpl(r1)
            int r2 = r21.getWidth()
            float r2 = (float) r2
            float r1 = r1 * r2
            r0.setPivotX(r1)
            long r1 = r0.mTransformOrigin
            float r1 = androidx.compose.ui.graphics.TransformOrigin.m3676getPivotFractionYimpl(r1)
        ...
        L_0x00ea:
            ...
            int r5 = androidx.compose.ui.graphics.ColorKt.m3307toArgb8_81llA(r37)
            r3.setOutlineAmbientShadowColor(r4, r5)
            androidx.compose.ui.platform.ViewLayerVerificationHelper28 r3 = androidx.compose.ui.platform.ViewLayerVerificationHelper28.INSTANCE
            r4 = r0
            android.view.View r4 = (android.view.View) r4
            int r5 = androidx.compose.ui.graphics.ColorKt.m3307toArgb8_81llA(r39)
            ...
            int r3 = r3.m3341getOffscreenNrFUSI()
            boolean r3 = androidx.compose.ui.graphics.CompositingStrategy.m3335equalsimpl0(r9, r3)
            r4 = 0
        ...
        L_0x0128:
            androidx.compose.ui.graphics.CompositingStrategy$Companion r3 = androidx.compose.ui.graphics.CompositingStrategy.Companion
            int r3 = r3.m3340getModulateAlphaNrFUSI()
            boolean r3 = androidx.compose.ui.graphics.CompositingStrategy.m3335equalsimpl0(r9, r3)
    ...
    public boolean m5134isInLayerk4lQ0M(long position) {
    ...
    public void m5137resizeozmzZPI(long size) {
        int width = IntSize.m6004getWidthimpl(size);
        int height = IntSize.m6003getHeightimpl(size);
        if (width != getWidth() || height != getHeight()) {
            setPivotX(TransformOrigin.m3675getPivotFractionXimpl(this.mTransformOrigin) * ((float) width));
            setPivotY(TransformOrigin.m3676getPivotFractionYimpl(this.mTransformOrigin) * ((float) height));
    ...
    public void m5136movegyyYBs(long position) {
        int left = IntOffset.m5962getXimpl(position);
        if (left != getLeft()) {
            offsetLeftAndRight(left - getLeft());
            this.matrixCache.invalidate();
        }
        int top = IntOffset.m5963getYimpl(position);
        if (top != getTop()) {
    ...
    public long m5135mapOffset8S9VItk(long point, boolean inverse) {
        if (!inverse) {
            return androidx.compose.ui.graphics.Matrix.m3488mapMKHz9U(this.matrixCache.m5090calculateMatrixGrdbGEg(this), point);
        }
        float[] r0 = this.matrixCache.m5089calculateInverseMatrixbWbORWo(this);
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        if (inverse) {
            float[] matrix = this.matrixCache.m5089calculateInverseMatrixbWbORWo(this);
            if (matrix != null) {
            ...
            androidx.compose.ui.graphics.Matrix.m3490mapimpl(this.matrixCache.m5090calculateMatrixGrdbGEg(this), rect);
        }
    }
    ...
    public void reuseLayer(Function1<? super Canvas, Unit> drawBlock2, Function0<Unit> invalidateParentLayer2) {
        ...
        this.mTransformOrigin = TransformOrigin.Companion.m3680getCenterSzJe1aQ();
        this.drawBlock = drawBlock2;
        this.invalidateParentLayer = invalidateParentLayer2;
    }

    /* renamed from: transform-58bKbWc  reason: not valid java name */
    public void m5138transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        androidx.compose.ui.graphics.Matrix.m3499timesAssign58bKbWc(matrix, this.matrixCache.m5090calculateMatrixGrdbGEg(this));
    }

    /* renamed from: inverseTransform-58bKbWc  reason: not valid java name */
    public void m5133inverseTransform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        float[] inverse = this.matrixCache.m5089calculateInverseMatrixbWbORWo(this);
        if (inverse != null) {
