...
public interface WindowInfo {
    ...
    static /* synthetic */ void m5140getKeyboardModifiersk7X9c1A$annotations() {
    }

    boolean isWindowFocused();

    /* renamed from: getKeyboardModifiers-k7X9c1A  reason: not valid java name */
    int m5141getKeyboardModifiersk7X9c1A() {
        return WindowInfoImpl.Companion.getGlobalKeyboardModifiers$ui_release().getValue().m4548unboximpl();
    }
}
