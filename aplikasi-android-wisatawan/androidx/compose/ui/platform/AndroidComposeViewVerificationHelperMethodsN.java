...
final class AndroidComposeViewVerificationHelperMethodsN {
    ...
    public final void setPointerIcon(View view, PointerIcon icon) {
        ...
        if (icon instanceof AndroidPointerIcon) {
            ...
            iconToSet = android.view.PointerIcon.getSystemIcon(view.getContext(), ((AndroidPointerIconType) icon).getType());
        ...
        if (!Intrinsics.areEqual((Object) view.getPointerIcon(), (Object) iconToSet)) {
