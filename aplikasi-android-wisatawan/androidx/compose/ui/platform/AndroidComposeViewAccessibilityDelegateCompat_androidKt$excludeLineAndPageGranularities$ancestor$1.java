...
final class AndroidComposeViewAccessibilityDelegateCompat_androidKt$excludeLineAndPageGranularities$ancestor$1 extends Lambda implements Function1<LayoutNode, Boolean> {
    ...
    public final Boolean invoke(LayoutNode it) {
        ...
        boolean z = true;
        if (!(ancestorSemanticsConfiguration != null && ancestorSemanticsConfiguration.isMergingSemanticsOfDescendants()) || !ancestorSemanticsConfiguration.contains(SemanticsActions.INSTANCE.getSetText())) {
            z = false;
        }
