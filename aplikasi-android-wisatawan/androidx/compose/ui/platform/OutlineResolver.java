...
public final class OutlineResolver {
    ...
    public OutlineResolver(Density density2) {
        ...
        this.size = Size.Companion.m3081getZeroNHjbRc();
        this.shape = RectangleShapeKt.getRectangleShape();
        this.rectTopLeft = Offset.Companion.m3019getZeroF1C5BW0();
        this.rectSize = Size.Companion.m3081getZeroNHjbRc();
    ...
    public final boolean m5116isInOutlinek4lQ0M(long position) {
        androidx.compose.ui.graphics.Outline outline;
        if (this.outlineNeeded && (outline = this.calculatedOutline) != null) {
            return ShapeContainingUtilKt.isInOutline(outline, Offset.m3003getXimpl(position), Offset.m3004getYimpl(position), this.tmpTouchPointPath, this.tmpOpPath);
        }
        return true;
    }

    /* JADX WARNING: Code restructure failed: missing block: B:8:0x0030, code lost:
        if (m5115isSameBounds4L21HEs(r13, r7.rectTopLeft, r7.rectSize, r6) == false) goto L_0x0032;
     */
    ...
    public final void clipToOutline(androidx.compose.ui.graphics.Canvas r23) {
        /*
            ...
            androidx.compose.ui.graphics.Canvas.m3214clipPathmtrdDE$default(r15, r14, r8, r10, r9)
            r2 = r14
            goto L_0x00b0
        L_0x0018:
            ...
            r0 = r22
            r1 = r13
            boolean r0 = r0.m5115isSameBounds4L21HEs(r1, r2, r4, r6)
            if (r0 != 0) goto L_0x0076
        L_0x0032:
            long r0 = r7.rectTopLeft
            float r16 = androidx.compose.ui.geometry.Offset.m3003getXimpl(r0)
            long r0 = r7.rectTopLeft
            float r17 = androidx.compose.ui.geometry.Offset.m3004getYimpl(r0)
            long r0 = r7.rectTopLeft
            float r0 = androidx.compose.ui.geometry.Offset.m3003getXimpl(r0)
            long r1 = r7.rectSize
            float r1 = androidx.compose.ui.geometry.Size.m3072getWidthimpl(r1)
            float r18 = r0 + r1
            long r0 = r7.rectTopLeft
            float r0 = androidx.compose.ui.geometry.Offset.m3004getYimpl(r0)
            long r1 = r7.rectSize
            float r1 = androidx.compose.ui.geometry.Size.m3069getHeightimpl(r1)
            float r19 = r0 + r1
            float r0 = r7.roundedCornerRadius
            long r20 = androidx.compose.ui.geometry.CornerRadiusKt.CornerRadius$default(r0, r11, r10, r9)
            androidx.compose.ui.geometry.RoundRect r13 = androidx.compose.ui.geometry.RoundRectKt.m3057RoundRectgG7oq9Y(r16, r17, r18, r19, r20)
        ...
        L_0x006f:
            ...
            r7.tmpPath = r12
        L_0x0076:
            androidx.compose.ui.graphics.Canvas.m3214clipPathmtrdDE$default(r15, r12, r8, r10, r9)
            r2 = r14
            goto L_0x00b0
        L_0x007b:
            long r0 = r7.rectTopLeft
            float r9 = androidx.compose.ui.geometry.Offset.m3003getXimpl(r0)
            long r0 = r7.rectTopLeft
            float r10 = androidx.compose.ui.geometry.Offset.m3004getYimpl(r0)
            long r0 = r7.rectTopLeft
            float r0 = androidx.compose.ui.geometry.Offset.m3003getXimpl(r0)
            long r1 = r7.rectSize
            float r1 = androidx.compose.ui.geometry.Size.m3072getWidthimpl(r1)
            ...
            r14 = r0
            r15 = r1
            androidx.compose.ui.graphics.Canvas.m3215clipRectN_I0leg$default(r8, r9, r10, r11, r12, r13, r14, r15)
        L_0x00b0:
            return
        */
    ...
    public final void m5117updateuvyYCjk(long size2) {
        if (!Size.m3068equalsimpl0(this.size, size2)) {
            this.size = size2;
            this.cacheIsDirty = true;
        }
    }
    ...
    private final void updateCache() {
        if (this.cacheIsDirty) {
            ...
            if (!this.outlineNeeded || Size.m3072getWidthimpl(j) <= 0.0f || Size.m3069getHeightimpl(this.size) <= 0.0f) {
                this.cachedOutline.setEmpty();
                return;
            }
            this.isSupportedOutline = true;
            androidx.compose.ui.graphics.Outline outline = this.shape.m3612createOutlinePq9zytI(this.size, this.layoutDirection, this.density);
    ...
    private final void updateCacheWithRoundRect(RoundRect roundRect) {
        float radius = CornerRadius.m2978getXimpl(roundRect.m3053getTopLeftCornerRadiuskKHJgLs());
    ...
    private final boolean m5115isSameBounds4L21HEs(RoundRect $this$isSameBounds_u2d4L21HEs, long offset, long size2, float radius) {
        if ($this$isSameBounds_u2d4L21HEs == null || !RoundRectKt.isSimple($this$isSameBounds_u2d4L21HEs)) {
            return false;
        }
        if (!($this$isSameBounds_u2d4L21HEs.getLeft() == Offset.m3003getXimpl(offset))) {
            return false;
        }
        if (!($this$isSameBounds_u2d4L21HEs.getTop() == Offset.m3004getYimpl(offset))) {
            return false;
        }
        if (!($this$isSameBounds_u2d4L21HEs.getRight() == Offset.m3003getXimpl(offset) + Size.m3072getWidthimpl(size2))) {
            return false;
        }
        if (!($this$isSameBounds_u2d4L21HEs.getBottom() == Offset.m3004getYimpl(offset) + Size.m3069getHeightimpl(size2))) {
            return false;
        }
        if (CornerRadius.m2978getXimpl($this$isSameBounds_u2d4L21HEs.m3053getTopLeftCornerRadiuskKHJgLs()) == radius) {
            return true;
        }
        return false;
    }
