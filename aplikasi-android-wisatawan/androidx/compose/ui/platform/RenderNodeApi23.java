...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.Companion.m3339getAutoNrFUSI();
    private int left;
    ...
    public int m5118getCompositingStrategyNrFUSI() {
        return this.internalCompositingStrategy;
    }

    /* renamed from: setCompositingStrategy-aDBOjCE  reason: not valid java name */
    public void m5119setCompositingStrategyaDBOjCE(int value) {
        if (CompositingStrategy.m3335equalsimpl0(value, CompositingStrategy.Companion.m3341getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m3335equalsimpl0(value, CompositingStrategy.Companion.m3340getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        if (CompositingStrategy.m3335equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.Companion.m3341getOffscreenNrFUSI())) {
            return 2;
        }
        return 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            ...
            Canvas.m3214clipPathmtrdDE$default($this$record_u24lambda_u240, clipPath, 0, 2, (Object) null);
        }
