...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte != 1) {
                if (decodeByte != 2) {
                    if (decodeByte != 3) {
                        if (decodeByte != 4) {
                            if (decodeByte != 5) {
                                        ...
                                        if (decodeByte != 8) {
                                            if (decodeByte != 9) {
                                                if (decodeByte != 10) {
                                                    ...
                                                    mutableSpanStyle.m5098setBackground8_81llA(m5070decodeColor0d7_KjU());
                                                }
                                            } else if (dataAvailable() < 8) {
                                                break;
                                            } else {
                                            ...
                                            mutableSpanStyle.m5099setBaselineShift_isdbwI(BaselineShift.m5599boximpl(m5068decodeBaselineShifty9eOQZs()));
                                        }
                                    } else if (dataAvailable() < 5) {
                                        break;
                                    } else {
                                        mutableSpanStyle.m5104setLetterSpacingR2X_6o(m5073decodeTextUnitXSAIIZE());
                                    }
                                } else {
                                ...
                                mutableSpanStyle.m5103setFontSynthesistDdu0R4(FontSynthesis.m5430boximpl(m5072decodeFontSynthesisGVVA2EU()));
                            }
                        } else if (dataAvailable() < 1) {
                            break;
                        } else {
                            mutableSpanStyle.m5102setFontStylemLjRB2g(FontStyle.m5421boximpl(m5071decodeFontStyle_LCdwA()));
                        }
                    } else if (dataAvailable() < 4) {
                        break;
                    } else {
                    ...
                    mutableSpanStyle.m5101setFontSizeR2X_6o(m5073decodeTextUnitXSAIIZE());
                }
            } else if (dataAvailable() < 8) {
                break;
            } else {
                mutableSpanStyle.m5100setColor8_81llA(m5070decodeColor0d7_KjU());
            }
        }
    ...
    public final long m5070decodeColor0d7_KjU() {
        return Color.m3249constructorimpl(m5069decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE  reason: not valid java name */
    public final long m5073decodeTextUnitXSAIIZE() {
        long type;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
            type = TextUnitType.Companion.m6058getSpUIouoOA();
        } else if (decodeByte == 2) {
            type = TextUnitType.Companion.m6057getEmUIouoOA();
        } else {
            type = TextUnitType.Companion.m6059getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m6053equalsimpl0(type, TextUnitType.Companion.m6059getUnspecifiedUIouoOA())) {
            return TextUnit.Companion.m6036getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m6037TextUnitanM5pPY(decodeFloat(), type);
    }
    ...
    public final int m5071decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontStyle.Companion.m5429getNormal_LCdwA();
        }
        if (decodeByte == 1) {
            return FontStyle.Companion.m5428getItalic_LCdwA();
        }
        return FontStyle.Companion.m5429getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU  reason: not valid java name */
    public final int m5072decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontSynthesis.Companion.m5440getNoneGVVA2EU();
        }
        if (decodeByte == 1) {
            return FontSynthesis.Companion.m5439getAllGVVA2EU();
        }
        if (decodeByte == 3) {
            return FontSynthesis.Companion.m5441getStyleGVVA2EU();
        }
        if (decodeByte == 2) {
            return FontSynthesis.Companion.m5442getWeightGVVA2EU();
        }
        return FontSynthesis.Companion.m5440getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs  reason: not valid java name */
    private final float m5068decodeBaselineShifty9eOQZs() {
        return BaselineShift.m5600constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m5070decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), (DefaultConstructorMarker) null);
    }
    ...
    private final long m5069decodeULongsVKNKU() {
        return ULong.m6403constructorimpl(this.parcel.readLong());
    }
