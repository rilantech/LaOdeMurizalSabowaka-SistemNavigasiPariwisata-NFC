...
public final class ImageVectorCache {
    ...
    public static final class Key {
        ...
        public Key(Resources.Theme theme2, int id2) {
            Intrinsics.checkNotNullParameter(theme2, "theme");
            this.theme = theme2;
            this.id = id2;
        }
    ...
    public static final class ImageVectorEntry {
        ...
        public ImageVectorEntry(ImageVector imageVector2, int configFlags2) {
            Intrinsics.checkNotNullParameter(imageVector2, "imageVector");
            this.imageVector = imageVector2;
            this.configFlags = configFlags2;
        }
    ...
    public final void prune(int configChanges) {
        ...
        while (it.hasNext()) {
            ...
            ImageVectorEntry imageVectorEntry = (ImageVectorEntry) ((WeakReference) entry.getValue()).get();
