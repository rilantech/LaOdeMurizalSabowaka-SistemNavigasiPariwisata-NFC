...
final class KeyInputNode extends Modifier.Node implements KeyInputModifierNode {
    ...
    public KeyInputNode(Function1<? super KeyEvent, Boolean> onEvent2, Function1<? super KeyEvent, Boolean> onPreEvent2) {
        this.onEvent = onEvent2;
        this.onPreEvent = onPreEvent2;
    }

    /* renamed from: onKeyEvent-ZmokQxo  reason: not valid java name */
    public boolean m4342onKeyEventZmokQxo(KeyEvent event) {
    ...
    public boolean m4343onPreKeyEventZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, NotificationCompat.CATEGORY_EVENT);
