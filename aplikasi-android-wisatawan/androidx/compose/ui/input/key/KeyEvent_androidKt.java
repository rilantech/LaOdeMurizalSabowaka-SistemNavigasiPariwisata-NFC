...
public final class KeyEvent_androidKt {
    ...
    public static final long m4333getKeyZmokQxo(KeyEvent $this$key) {
        Intrinsics.checkNotNullParameter($this$key, "$this$key");
        return Key_androidKt.Key($this$key.getKeyCode());
    }

    /* renamed from: getUtf16CodePoint-ZmokQxo  reason: not valid java name */
    public static final int m4335getUtf16CodePointZmokQxo(KeyEvent $this$utf16CodePoint) {
    ...
    public static final int m4334getTypeZmokQxo(KeyEvent $this$type) {
        Intrinsics.checkNotNullParameter($this$type, "$this$type");
        switch ($this$type.getAction()) {
            case 0:
                return KeyEventType.Companion.m4330getKeyDownCS__XNY();
            case 1:
                return KeyEventType.Companion.m4331getKeyUpCS__XNY();
            default:
                return KeyEventType.Companion.m4332getUnknownCS__XNY();
        }
    }

    /* renamed from: isAltPressed-ZmokQxo  reason: not valid java name */
    public static final boolean m4336isAltPressedZmokQxo(KeyEvent $this$isAltPressed) {
        Intrinsics.checkNotNullParameter($this$isAltPressed, "$this$isAltPressed");
        return $this$isAltPressed.isAltPressed();
    }

    /* renamed from: isCtrlPressed-ZmokQxo  reason: not valid java name */
    public static final boolean m4337isCtrlPressedZmokQxo(KeyEvent $this$isCtrlPressed) {
    ...
    public static final boolean m4338isMetaPressedZmokQxo(KeyEvent $this$isMetaPressed) {
    ...
    public static final boolean m4339isShiftPressedZmokQxo(KeyEvent $this$isShiftPressed) {
