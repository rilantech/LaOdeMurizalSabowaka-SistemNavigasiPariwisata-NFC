...
final class NestedScrollElement extends ModifierNodeElement<NestedScrollNode> {
    ...
    public NestedScrollElement(NestedScrollConnection connection2, NestedScrollDispatcher dispatcher2) {
    ...
    public boolean equals(Object other) {
        if ((other instanceof NestedScrollElement) && Intrinsics.areEqual((Object) ((NestedScrollElement) other).connection, (Object) this.connection) && Intrinsics.areEqual((Object) ((NestedScrollElement) other).dispatcher, (Object) this.dispatcher)) {
            return true;
        }
        return false;
    }
