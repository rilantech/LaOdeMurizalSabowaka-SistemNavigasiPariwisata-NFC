...
public final class InputMode {
    ...
    public static final int Keyboard = m4007constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int Touch = m4007constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ InputMode m4006boximpl(int i) {
    ...
    public static boolean m4008equalsimpl(int i, Object obj) {
        return (obj instanceof InputMode) && i == ((InputMode) obj).m4012unboximpl();
    }
    ...
    public final /* synthetic */ int m4012unboximpl() {
        return this.value;
    }
    ...
    public static String m4011toStringimpl(int arg0) {
        if (m4009equalsimpl0(arg0, Touch)) {
            return "Touch";
        }
        if (m4009equalsimpl0(arg0, Keyboard)) {
            return "Keyboard";
        }
        return "Error";
    }
    ...
    public static final class Companion {
        ...
        public final int m4014getTouchaOaMEAU() {
            return InputMode.Touch;
        }

        /* renamed from: getKeyboard-aOaMEAU  reason: not valid java name */
        public final int m4013getKeyboardaOaMEAU() {
