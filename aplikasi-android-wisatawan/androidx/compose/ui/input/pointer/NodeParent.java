...
public class NodeParent {
    ...
    public boolean buildCache(Map<PointerId, PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        if (size$iv > 0) {
            ...
            do {
                changed = ((Node) content$iv[i$iv]).buildCache(changes, parentCoordinates, internalPointerEvent, isInBounds) || changed;
                i$iv++;
            } while (i$iv < size$iv);
        }
        return changed;
    ...
    public boolean dispatchMainEventPass(Map<PointerId, PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        if (size$iv > 0) {
            ...
            Object[] content$iv = this_$iv.getContent();
            do {
                dispatched = ((Node) content$iv[i$iv]).dispatchMainEventPass(changes, parentCoordinates, internalPointerEvent, isInBounds) || dispatched;
                i$iv++;
            } while (i$iv < size$iv);
        }
        return dispatched;
    ...
    public boolean dispatchFinalEventPass(InternalPointerEvent internalPointerEvent) {
        ...
        if (size$iv > 0) {
            ...
            Object[] content$iv = this_$iv.getContent();
            do {
                dispatched = ((Node) content$iv[i$iv]).dispatchFinalEventPass(internalPointerEvent) || dispatched;
                i$iv++;
            } while (i$iv < size$iv);
        }
    ...
    public final void removeDetachedPointerInputFilters() {
        ...
        while (index < this.children.getSize()) {
            Node child = (Node) this.children.getContent()[index];
