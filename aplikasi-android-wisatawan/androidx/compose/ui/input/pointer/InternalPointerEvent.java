...
public final class InternalPointerEvent {
    ...
    public final boolean m4410issuesEnterExitEvent0FcD4WY(long pointerId) {
        Object it$iv;
        ...
        while (true) {
            ...
            if (PointerId.m4463equalsimpl0(((PointerInputEventData) it$iv).m4493getIdJ3iCeTQ(), pointerId)) {
                break;
            }
            index$iv$iv++;
        }
