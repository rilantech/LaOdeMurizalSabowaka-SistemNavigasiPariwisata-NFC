...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange $this$positionChanged) {
        ...
        return !Offset.m3000equalsimpl0(positionChangeInternal($this$positionChanged, false), Offset.Companion.m3019getZeroF1C5BW0());
    }
    ...
    public static final boolean positionChangedIgnoreConsumed(PointerInputChange $this$positionChangedIgnoreConsumed) {
        ...
        return true ^ Offset.m3000equalsimpl0(positionChangeInternal($this$positionChangedIgnoreConsumed, true), Offset.Companion.m3019getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange $this$positionChangeInternal, boolean ignoreConsumed) {
        return (ignoreConsumed || !$this$positionChangeInternal.isConsumed()) ? Offset.m3007minusMKHz9U($this$positionChangeInternal.m4480getPositionF1C5BW0(), $this$positionChangeInternal.m4481getPreviousPositionF1C5BW0()) : Offset.Companion.m3019getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange $this$consumePositionChange) {
        ...
        if (!Offset.m3000equalsimpl0(positionChange($this$consumePositionChange), Offset.Companion.m3019getZeroF1C5BW0())) {
    ...
    public static final boolean m4425isOutOfBoundsO0kMr_c(PointerInputChange $this$isOutOfBounds_u2dO0kMr_c, long size) {
        Intrinsics.checkNotNullParameter($this$isOutOfBounds_u2dO0kMr_c, "$this$isOutOfBounds");
        long position = $this$isOutOfBounds_u2dO0kMr_c.m4480getPositionF1C5BW0();
        float x = Offset.m3003getXimpl(position);
        float y = Offset.m3004getYimpl(position);
        return x < 0.0f || x > ((float) IntSize.m6004getWidthimpl(size)) || y < 0.0f || y > ((float) IntSize.m6003getHeightimpl(size));
    }

    /* renamed from: isOutOfBounds-jwHxaWs  reason: not valid java name */
    public static final boolean m4426isOutOfBoundsjwHxaWs(PointerInputChange $this$isOutOfBounds_u2djwHxaWs, long size, long extendedTouchPadding) {
        Intrinsics.checkNotNullParameter($this$isOutOfBounds_u2djwHxaWs, "$this$isOutOfBounds");
        if (!PointerType.m4552equalsimpl0($this$isOutOfBounds_u2djwHxaWs.m4483getTypeT8wyACA(), PointerType.Companion.m4559getTouchT8wyACA())) {
            return m4425isOutOfBoundsO0kMr_c($this$isOutOfBounds_u2djwHxaWs, size);
        }
        long position = $this$isOutOfBounds_u2djwHxaWs.m4480getPositionF1C5BW0();
        float x = Offset.m3003getXimpl(position);
        float y = Offset.m3004getYimpl(position);
        return x < (-Size.m3072getWidthimpl(extendedTouchPadding)) || x > ((float) IntSize.m6004getWidthimpl(size)) + Size.m3072getWidthimpl(extendedTouchPadding) || y < (-Size.m3069getHeightimpl(extendedTouchPadding)) || y > ((float) IntSize.m6003getHeightimpl(size)) + Size.m3069getHeightimpl(extendedTouchPadding);
    }
}
