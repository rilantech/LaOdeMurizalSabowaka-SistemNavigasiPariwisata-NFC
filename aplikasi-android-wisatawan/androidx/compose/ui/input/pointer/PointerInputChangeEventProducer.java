...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        ...
        while (index$iv < size) {
            ...
            PointerInputData previousData = this.previousPointerInputData.get(PointerId.m4460boximpl(it.m4493getIdJ3iCeTQ()));
            if (previousData == null) {
                previousTime = it.getUptime();
                previousPosition = it.m4494getPositionF1C5BW0();
                previousDown = false;
                i = size;
                ...
                previousPosition = positionCalculator2.m4562screenToLocalMKHz9U(previousData.m4484getPositionOnScreenF1C5BW0());
            }
            changes.put(PointerId.m4460boximpl(it.m4493getIdJ3iCeTQ()), new PointerInputChange(it.m4493getIdJ3iCeTQ(), it.getUptime(), it.m4494getPositionF1C5BW0(), it.getDown(), it.getPressure(), previousTime, previousPosition, previousDown, false, it.m4497getTypeT8wyACA(), (List) it.getHistorical(), it.m4496getScrollDeltaF1C5BW0(), (DefaultConstructorMarker) null));
            if (it.getDown()) {
                this.previousPointerInputData.put(PointerId.m4460boximpl(it.m4493getIdJ3iCeTQ()), new PointerInputData(it.getUptime(), it.m4495getPositionOnScreenF1C5BW0(), it.getDown(), it.m4497getTypeT8wyACA(), (DefaultConstructorMarker) null));
            } else {
                this.previousPointerInputData.remove(PointerId.m4460boximpl(it.m4493getIdJ3iCeTQ()));
            }
            index$iv++;
    ...
    private static final class PointerInputData {
        ...
        public final long m4484getPositionOnScreenF1C5BW0() {
        ...
        public final int m4485getTypeT8wyACA() {
            return this.type;
        }
    }
}
