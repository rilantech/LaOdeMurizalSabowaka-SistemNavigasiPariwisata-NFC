...
public final class VelocityTracker {
    ...
    private long currentPointerPositionAccumulator = Offset.Companion.m3019getZeroF1C5BW0();
    ...
    public final long m4591getCurrentPointerPositionAccumulatorF1C5BW0$ui_release() {
        return this.currentPointerPositionAccumulator;
    }

    /* renamed from: setCurrentPointerPositionAccumulator-k-4lQ0M$ui_release  reason: not valid java name */
    public final void m4592setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
        this.currentPointerPositionAccumulator = j;
    }

    /* renamed from: addPosition-Uv8p0NA  reason: not valid java name */
    public final void m4589addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m3003getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m3004getYimpl(position));
    }

    /* renamed from: calculateVelocity-9UxMQ8M  reason: not valid java name */
    public final long m4590calculateVelocity9UxMQ8M() {
