...
public final class VelocityTrackerKt {
    ...
    public static final void addPointerInputChange(VelocityTracker $this$addPointerInputChange, PointerInputChange event) {
        ...
        if (PointerEventKt.changedToDownIgnoreConsumed(event)) {
            velocityTracker.m4592setCurrentPointerPositionAccumulatork4lQ0M$ui_release(event.m4480getPositionF1C5BW0());
            $this$addPointerInputChange.resetTracking();
        }
        long previousPointerPosition = event.m4481getPreviousPositionF1C5BW0();
        List $this$fastForEach$iv = event.getHistorical();
        int index$iv = 0;
        int size = $this$fastForEach$iv.size();
        while (index$iv < size) {
            HistoricalChange it = $this$fastForEach$iv.get(index$iv);
            long historicalDelta = Offset.m3007minusMKHz9U(it.m4408getPositionF1C5BW0(), previousPointerPosition);
            previousPointerPosition = it.m4408getPositionF1C5BW0();
            velocityTracker.m4592setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m3008plusMKHz9U($this$addPointerInputChange.m4591getCurrentPointerPositionAccumulatorF1C5BW0$ui_release(), historicalDelta));
            velocityTracker.m4589addPositionUv8p0NA(it.getUptimeMillis(), $this$addPointerInputChange.m4591getCurrentPointerPositionAccumulatorF1C5BW0$ui_release());
            index$iv++;
            PointerInputChange pointerInputChange = event;
            $this$fastForEach$iv = $this$fastForEach$iv;
        }
        velocityTracker.m4592setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m3008plusMKHz9U($this$addPointerInputChange.m4591getCurrentPointerPositionAccumulatorF1C5BW0$ui_release(), Offset.m3007minusMKHz9U(event.m4480getPositionF1C5BW0(), previousPointerPosition)));
        velocityTracker.m4589addPositionUv8p0NA(event.getUptimeMillis(), $this$addPointerInputChange.m4591getCurrentPointerPositionAccumulatorF1C5BW0$ui_release());
    }
