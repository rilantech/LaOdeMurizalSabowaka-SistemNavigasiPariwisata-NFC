...
public final class PointerType {
    ...
    public static final int Eraser = m4550constructorimpl(4);
    /* access modifiers changed from: private */
    public static final int Mouse = m4550constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int Stylus = m4550constructorimpl(3);
    /* access modifiers changed from: private */
    public static final int Touch = m4550constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Unknown = m4550constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PointerType m4549boximpl(int i) {
        return new PointerType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m4550constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4551equalsimpl(int i, Object obj) {
        return (obj instanceof PointerType) && i == ((PointerType) obj).m4555unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4552equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4553hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m4551equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4553hashCodeimpl(this.value);
    }
    ...
    public static String m4554toStringimpl(int arg0) {
        switch (arg0) {
            case 1:
                return "Touch";
            case 2:
    ...
    public String toString() {
        return m4554toStringimpl(this.value);
    }
