...
public final class PointerInputEvent {
    ...
    public PointerInputEvent(long uptime2, List<PointerInputEventData> pointers2, MotionEvent motionEvent2) {
        Intrinsics.checkNotNullParameter(pointers2, "pointers");
