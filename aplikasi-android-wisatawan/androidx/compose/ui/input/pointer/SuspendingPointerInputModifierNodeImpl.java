...
public final class SuspendingPointerInputModifierNodeImpl extends Modifier.Node implements SuspendingPointerInputModifierNode, PointerInputScope, Density {
    ...
    public long boundsSize = IntSize.Companion.m6009getZeroYbymL2g();
    /* access modifiers changed from: private */
    ...
    public long m4573getSizeYbymL2g() {
        return this.boundsSize;
    }

    /* renamed from: getExtendedTouchPadding-NH-jbRc  reason: not valid java name */
    public long m4572getExtendedTouchPaddingNHjbRc() {
        long minimumTouchTargetSize = m5826toSizeXkaWNTQ(getViewConfiguration().m5131getMinimumTouchTargetSizeMYxV2XQ());
        long size = m4573getSizeYbymL2g();
        return SizeKt.Size(Math.max(0.0f, Size.m3072getWidthimpl(minimumTouchTargetSize) - ((float) IntSize.m6004getWidthimpl(size))) / 2.0f, Math.max(0.0f, Size.m3069getHeightimpl(minimumTouchTargetSize) - ((float) IntSize.m6003getHeightimpl(size))) / 2.0f);
    }
    ...
    public void m4574onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        boolean z;
        ...
        if (lastEvent != null) {
            ...
            if (!z) {
                ...
                for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
                    ...
                    long r15 = old.m4479getIdJ3iCeTQ();
                    long r19 = old.m4480getPositionF1C5BW0();
                    target$iv.add(new PointerInputChange(r15, old.getUptimeMillis(), r19, false, old.getPressure(), old.getUptimeMillis(), old.m4480getPositionF1C5BW0(), old.getPressed(), old.getPressed(), 0, 0, 1536, (DefaultConstructorMarker) null));
                }
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> block, Continuation<? super R> $completion) {
        ...
        synchronized (this.pointerHandlers) {
            ...
            createCoroutine.resumeWith(Result.m6229constructorimpl(Unit.INSTANCE));
    ...
    private final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        /* renamed from: getSize-YbymL2g  reason: not valid java name */
        public long m4576getSizeYbymL2g() {
        ...
        /* renamed from: getExtendedTouchPadding-NH-jbRc  reason: not valid java name */
        public long m4575getExtendedTouchPaddingNHjbRc() {
            return this.this$0.m4572getExtendedTouchPaddingNHjbRc();
        }
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            if (pass == this.awaitPass && ($this$offerPointerEvent_u24lambda_u240 = this.pointerAwaiter) != null) {
                ...
                Result.Companion companion = Result.Companion;
                $this$offerPointerEvent_u24lambda_u240.resumeWith(Result.m6229constructorimpl(event));
            }
        }
        ...
        public <T> java.lang.Object withTimeout(long r11, kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.AwaitPointerEventScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r13, kotlin.coroutines.Continuation<? super T> r14) {
            ...
            L_0x0039:
                ...
                java.lang.Object r4 = kotlin.Result.m6229constructorimpl(r4)
                r3.resumeWith(r4)
            L_0x005d:
