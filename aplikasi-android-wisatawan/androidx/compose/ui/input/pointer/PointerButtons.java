...
public final class PointerButtons {
    ...
    public static final /* synthetic */ PointerButtons m4413boximpl(int i) {
        return new PointerButtons(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m4414constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4415equalsimpl(int i, Object obj) {
        return (obj instanceof PointerButtons) && i == ((PointerButtons) obj).m4419unboximpl();
    }
    ...
    public static int m4417hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4418toStringimpl(int i) {
        return "PointerButtons(packedValue=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m4415equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m4417hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m4418toStringimpl(this.packedValue);
    }
