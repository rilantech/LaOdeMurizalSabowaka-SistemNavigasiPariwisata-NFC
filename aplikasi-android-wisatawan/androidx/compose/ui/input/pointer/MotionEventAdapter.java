...
public final class MotionEventAdapter {
    ...
    private final long m4411getComposePointerId_I2yYro(int motionEventPointerId) {
        long newId;
        ...
        return PointerId.m4461constructorimpl(newId);
    }
    ...
    private final PointerInputEventData createPointerInputEventData(PositionCalculator positionCalculator, MotionEvent motionEvent, int index, boolean pressed) {
        ...
        int i = index;
        long pointerId = m4411getComposePointerId_I2yYro(motionEvent.getPointerId(index));
        ...
        if (i == 0) {
            ...
            position = positionCalculator2.m4562screenToLocalMKHz9U(rawPosition2);
            rawPosition = rawPosition2;
        } else {
            long rawPosition3 = MotionEventHelper.INSTANCE.m4412toRawOffsetdBAh8RU(motionEvent2, i);
            position = positionCalculator2.m4562screenToLocalMKHz9U(rawPosition3);
            rawPosition = rawPosition3;
        }
        switch (motionEvent.getToolType(index)) {
            case 0:
                toolType = PointerType.Companion.m4560getUnknownT8wyACA();
                break;
            case 1:
                toolType = PointerType.Companion.m4559getTouchT8wyACA();
                break;
            case 2:
                toolType = PointerType.Companion.m4558getStylusT8wyACA();
                break;
            case 3:
                toolType = PointerType.Companion.m4557getMouseT8wyACA();
                break;
            case 4:
                toolType = PointerType.Companion.m4556getEraserT8wyACA();
                break;
            default:
                toolType = PointerType.Companion.m4560getUnknownT8wyACA();
                break;
        ...
        if (motionEvent.getActionMasked() == 8) {
            ...
            scrollDelta = Offset.Companion.m3019getZeroF1C5BW0();
        }
