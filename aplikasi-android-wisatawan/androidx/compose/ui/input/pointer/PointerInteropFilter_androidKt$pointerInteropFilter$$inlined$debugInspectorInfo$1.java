...
public final class PointerInteropFilter_androidKt$pointerInteropFilter$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$pointerInteropFilter_u24lambda_u240 = $this$null;
        $this$pointerInteropFilter_u24lambda_u240.setName("pointerInteropFilter");
        $this$pointerInteropFilter_u24lambda_u240.getProperties().set("requestDisallowInterceptTouchEvent", this.$requestDisallowInterceptTouchEvent$inlined);
        $this$pointerInteropFilter_u24lambda_u240.getProperties().set("onTouchEvent", this.$onTouchEvent$inlined);
    }
}
