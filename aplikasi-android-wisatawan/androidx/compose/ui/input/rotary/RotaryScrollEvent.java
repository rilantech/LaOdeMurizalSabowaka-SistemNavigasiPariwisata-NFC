...
public final class RotaryScrollEvent {
    ...
    public RotaryScrollEvent(float verticalScrollPixels2, float horizontalScrollPixels2, long uptimeMillis2) {
        this.verticalScrollPixels = verticalScrollPixels2;
        this.horizontalScrollPixels = horizontalScrollPixels2;
    ...
    public boolean equals(Object other) {
        ...
        if (!(((RotaryScrollEvent) other).horizontalScrollPixels == this.horizontalScrollPixels) || ((RotaryScrollEvent) other).uptimeMillis != this.uptimeMillis) {
            return false;
        }
        return true;
    }
