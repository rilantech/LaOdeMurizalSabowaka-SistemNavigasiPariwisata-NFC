        ...
        if (this_$iv != companion.getDefault()) {
            if (!(this_$iv != companion.getCancel())) {
                ...
                if (size$iv$iv > 0) {
                    ...
                    while (true) {
                        int type$iv$iv = NodeKind.m4956constructorimpl(1024);
                                            ...
                                            while (this_$iv$iv$iv$iv2 != null) {
                                                ...
                                                if (this_$iv$iv$iv$iv2 instanceof FocusTargetNode) {
                                                    ...
                                                    if (focusTarget.fetchFocusProperties$ui_release().getCanFocus()) {
                                                        ...
                                                        child$iv$iv$iv2 = child$iv$iv$iv;
                                                        success$iv = success$iv2;
                                                        z = TwoDimensionalFocusSearchKt.m2964findChildCorrespondingToFocusEnterOMvw8(focusTarget, FocusDirection.Companion.m2928getEnterdhqQ8s(), FocusRequester$focus$1$1.INSTANCE);
                                                    }
                                                    if (z) {
                                                        success$iv2 = true;
