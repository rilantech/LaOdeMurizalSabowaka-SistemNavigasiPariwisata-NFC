...
public final class FocusOwnerImpl implements FocusOwner {
    ...
    public void clearFocus(boolean force, boolean refreshFocusEvents) {
        ...
        if (!force) {
            switch (WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m2951performCustomClearFocusMxy_nc0(this.rootFocusNode, FocusDirection.Companion.m2929getExitdhqQ8s()).ordinal()]) {
                case 1:
                case 2:
                case 3:
                    return;
    ...
    public boolean m2944moveFocus3ESFkO8(int focusDirection) {
        FocusTargetNode source = FocusTraversalKt.findActiveFocusNode(this.rootFocusNode);
        if (source == null) {
            return false;
        }
        FocusRequester it = FocusTraversalKt.m2955customFocusSearchOMvw8(source, focusDirection, getLayoutDirection());
        if (it == FocusRequester.Companion.getDefault()) {
            Ref.BooleanRef isCancelled = new Ref.BooleanRef();
            boolean foundNextItem = FocusTraversalKt.m2956focusSearchsMXa3k8(this.rootFocusNode, focusDirection, getLayoutDirection(), new FocusOwnerImpl$moveFocus$foundNextItem$1(source, focusDirection, isCancelled));
            if (isCancelled.element) {
                return false;
            }
            if (foundNextItem || m2941wrapAroundFocus3ESFkO8(focusDirection)) {
                return true;
            }
            return false;
    ...
    public boolean m2943dispatchKeyEventZmokQxo(KeyEvent keyEvent) {
        ...
        if (activeFocusTarget5 != null) {
            ...
            if (lastLocalKeyInputNode == null) {
                int type$iv3 = NodeKind.m4956constructorimpl(8192);
            ...
            if (focusedKeyInputNode3 != null) {
                ...
                int type$iv4 = NodeKind.m4956constructorimpl(8192);
                ...
                if ($this$visitAncestors$iv$iv$iv$iv.getNode().isAttached()) {
                    ...
                    if (ancestors$iv != null) {
                        ...
                        if (size >= 0) {
                            do {
                                ...
                                size--;
                                if (((KeyInputModifierNode) $this$fastForEachReversed$iv$iv.get(index$iv$iv)).m4341onPreKeyEventZmokQxo(keyEvent2)) {
                                    return true;
                                }
                            } while (size >= 0);
                        }
                    ...
                    while (this_$iv$iv$iv != null) {
                        ...
                        } else if (((KeyInputModifierNode) this_$iv$iv$iv).m4341onPreKeyEventZmokQxo(keyEvent2)) {
                            return true;
                        } else {
                            $this$dispatchForKind_u2d6rFNWt0$iv$iv3 = $this$dispatchForKind_u2d6rFNWt0$iv$iv5;
                            i = i11;
                    ...
                    while (this_$iv$iv$iv2 != null) {
                        ...
                        } else if (((KeyInputModifierNode) this_$iv$iv$iv2).m4340onKeyEventZmokQxo(keyEvent2)) {
                            return true;
                        } else {
                            $this$traverseAncestors_u2dY_u2dYKmho$iv = $this$traverseAncestors_u2dY_u2dYKmho$iv3;
                            type$iv = type$iv4;
                    ...
                    for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
                        if (((KeyInputModifierNode) $this$fastForEach$iv$iv.get(index$iv$iv2)).m4340onKeyEventZmokQxo(keyEvent2)) {
                            return true;
                        }
                    }
                    return false;
    ...
    public boolean m2942dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent) {
        ...
        if (findActiveFocusNode != null) {
            ...
            int type$iv3 = NodeKind.m4956constructorimpl(131072);
            int mask$iv$iv$iv = type$iv3;
        ...
        if (focusedSoftKeyboardInterceptionNode3 != null) {
            ...
            int type$iv4 = NodeKind.m4956constructorimpl(131072);
            FocusOwnerImpl this_$iv5 = this;
            int i9 = false;
            List list = null;
            int mask$iv$iv$iv$iv = type$iv4;
            ...
            if ($this$visitAncestors$iv$iv$iv$iv.getNode().isAttached()) {
                ...
                if (ancestors$iv != null) {
                    ...
                    if (size >= 0) {
                        do {
                            int index$iv$iv = size;
                            size--;
                            if (((SoftKeyboardInterceptionModifierNode) $this$fastForEachReversed$iv$iv.get(index$iv$iv)).m4346onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent2)) {
                                return true;
                            }
                        } while (size >= 0);
                    }
                ...
                while (this_$iv$iv$iv != null) {
                    ...
                    } else if (((SoftKeyboardInterceptionModifierNode) this_$iv$iv$iv).m4346onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent2)) {
                        return true;
                    } else {
                        $this$dispatchForKind_u2d6rFNWt0$iv$iv3 = $this$dispatchForKind_u2d6rFNWt0$iv$iv5;
                        i = i11;
                ...
                while (this_$iv$iv$iv2 != null) {
                    ...
                    } else if (((SoftKeyboardInterceptionModifierNode) this_$iv$iv$iv2).m4345onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent2)) {
                        return true;
                    } else {
                        $this$traverseAncestors_u2dY_u2dYKmho$iv = $this$traverseAncestors_u2dY_u2dYKmho$iv3;
                        $this$dispatchForKind_u2d6rFNWt0$iv$iv = $this$dispatchForKind_u2d6rFNWt0$iv$iv6;
                ...
                int size2 = $this$fastForEach$iv$iv.size();
                for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
                    if (((SoftKeyboardInterceptionModifierNode) $this$fastForEach$iv$iv.get(index$iv$iv2)).m4345onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent2)) {
                        return true;
                    }
                }
                return false;
    ...
    public boolean dispatchRotaryEvent(RotaryScrollEvent event) {
        ...
        if (findActiveFocusNode != null) {
            DelegatableNode $this$nearestAncestor_u2d64DMado$iv5 = findActiveFocusNode;
            int type$iv3 = NodeKind.m4956constructorimpl(16384);
            int mask$iv$iv$iv = type$iv3;
            DelegatableNode $this$visitAncestors$iv$iv$iv = $this$nearestAncestor_u2d64DMado$iv5;
            if ($this$visitAncestors$iv$iv$iv.getNode().isAttached()) {
                Modifier.Node node$iv$iv$iv = $this$visitAncestors$iv$iv$iv.getNode().getParent$ui_release();
        ...
        if (focusedRotaryInputNode3 != null) {
            ...
            int type$iv4 = NodeKind.m4956constructorimpl(16384);
            FocusOwnerImpl this_$iv5 = this;
            int i9 = false;
            List list = null;
            int mask$iv$iv$iv$iv = type$iv4;
    ...
    private final /* synthetic */ <T extends DelegatableNode> void m2940traverseAncestorsYYKmho(DelegatableNode $this$traverseAncestors_u2dY_u2dYKmho, int type, Function1<? super T, Unit> onPreVisit, Function1<? super T, Unit> onVisit) {
        int i;
    ...
    private final Modifier.Node lastLocalKeyInputNode(DelegatableNode $this$lastLocalKeyInputNode) {
        ...
        int arg0$iv = NodeKind.m4956constructorimpl(1024) | NodeKind.m4956constructorimpl(8192);
            ...
            if ((self$iv.getAggregateChildKindSet$ui_release() & arg0$iv) != 0) {
                for (Modifier.Node next$iv = self$iv.getChild$ui_release(); next$iv != null; next$iv = next$iv.getChild$ui_release()) {
                    if ((next$iv.getKindSet$ui_release() & arg0$iv) != 0) {
                        ...
                        if ((modifierNode.getKindSet$ui_release() & NodeKind.m4956constructorimpl(1024)) != 0) {
                            return node;
                        }
                        node = modifierNode;
                    }
    ...
    private final boolean m2941wrapAroundFocus3ESFkO8(int focusDirection) {
        ...
        return m2944moveFocus3ESFkO8(focusDirection);
    }
}
