...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m2968twoDimensionalFocusSearchOMvw8(FocusTargetNode $this$twoDimensionalFocusSearch_u2d_u2dOM_u2dvw8, int direction, Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[$this$twoDimensionalFocusSearch_u2d_u2dOM_u2dvw8.getFocusState().ordinal()]) {
            case 1:
                ...
                if (focusedChild != null) {
                    switch (WhenMappings.$EnumSwitchMapping$0[focusedChild.getFocusState().ordinal()]) {
                        case 1:
                            Boolean found = m2968twoDimensionalFocusSearchOMvw8(focusedChild, direction, onFound);
                            if (!Intrinsics.areEqual((Object) found, (Object) false)) {
                                return found;
                            }
                            return Boolean.valueOf(m2965generateAndSearchChildren4C6V_qg($this$twoDimensionalFocusSearch_u2d_u2dOM_u2dvw8, activeNode(focusedChild), direction, onFound));
                        case 2:
                        case 3:
                            return Boolean.valueOf(m2965generateAndSearchChildren4C6V_qg($this$twoDimensionalFocusSearch_u2d_u2dOM_u2dvw8, focusedChild, direction, onFound));
                        case 4:
            ...
            case 2:
            case 3:
                return Boolean.valueOf(m2964findChildCorrespondingToFocusEnterOMvw8($this$twoDimensionalFocusSearch_u2d_u2dOM_u2dvw8, direction, onFound));
            case 4:
    ...
    public static final boolean m2964findChildCorrespondingToFocusEnterOMvw8(androidx.compose.ui.focus.FocusTargetNode r8, int r9, kotlin.jvm.functions.Function1<? super androidx.compose.ui.focus.FocusTargetNode, java.lang.Boolean> r10) {
        /*
        ...
        L_0x004b:
            ...
            int r1 = r1.m2928getEnterdhqQ8s()
            boolean r1 = androidx.compose.ui.focus.FocusDirection.m2919equalsimpl0(r9, r1)
            if (r1 == 0) goto L_0x0060
            androidx.compose.ui.focus.FocusDirection$Companion r1 = androidx.compose.ui.focus.FocusDirection.Companion
            int r1 = r1.m2935getRightdhqQ8s()
            goto L_0x0061
        L_0x0060:
            r1 = r9
        L_0x0061:
            androidx.compose.ui.focus.FocusDirection$Companion r3 = androidx.compose.ui.focus.FocusDirection.Companion
            int r3 = r3.m2935getRightdhqQ8s()
            boolean r3 = androidx.compose.ui.focus.FocusDirection.m2919equalsimpl0(r1, r3)
            if (r3 == 0) goto L_0x0071
            r3 = r2
            goto L_0x007b
        L_0x0071:
            androidx.compose.ui.focus.FocusDirection$Companion r3 = androidx.compose.ui.focus.FocusDirection.Companion
            int r3 = r3.m2927getDowndhqQ8s()
            boolean r3 = androidx.compose.ui.focus.FocusDirection.m2919equalsimpl0(r1, r3)
        L_0x007b:
        ...
        L_0x0086:
            androidx.compose.ui.focus.FocusDirection$Companion r3 = androidx.compose.ui.focus.FocusDirection.Companion
            int r3 = r3.m2931getLeftdhqQ8s()
            boolean r3 = androidx.compose.ui.focus.FocusDirection.m2919equalsimpl0(r1, r3)
            if (r3 == 0) goto L_0x0093
            goto L_0x009d
        L_0x0093:
            androidx.compose.ui.focus.FocusDirection$Companion r2 = androidx.compose.ui.focus.FocusDirection.Companion
            int r2 = r2.m2936getUpdhqQ8s()
            boolean r2 = androidx.compose.ui.focus.FocusDirection.m2919equalsimpl0(r1, r2)
        L_0x009d:
            if (r2 == 0) goto L_0x00bb
            androidx.compose.ui.geometry.Rect r2 = androidx.compose.ui.focus.FocusTraversalKt.focusRect(r8)
            androidx.compose.ui.geometry.Rect r2 = bottomRight(r2)
        L_0x00a7:
            androidx.compose.ui.focus.FocusTargetNode r3 = m2963findBestCandidate4WY_MpI(r0, r2, r1)
        ...
        L_0x00bb:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt.m2964findChildCorrespondingToFocusEnterOMvw8(androidx.compose.ui.focus.FocusTargetNode, int, kotlin.jvm.functions.Function1):boolean");
    }

    /* renamed from: generateAndSearchChildren-4C6V_qg  reason: not valid java name */
    private static final boolean m2965generateAndSearchChildren4C6V_qg(FocusTargetNode $this$generateAndSearchChildren_u2d4C6V_qg, FocusTargetNode focusedItem, int direction, Function1<? super FocusTargetNode, Boolean> onFound) {
        if (m2967searchChildren4C6V_qg($this$generateAndSearchChildren_u2d4C6V_qg, focusedItem, direction, onFound)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m2915searchBeyondBoundsOMvw8($this$generateAndSearchChildren_u2d4C6V_qg, direction, new TwoDimensionalFocusSearchKt$generateAndSearchChildren$1($this$generateAndSearchChildren_u2d4C6V_qg, focusedItem, direction, onFound));
        if (bool != null) {
    ...
    public static final boolean m2967searchChildren4C6V_qg(FocusTargetNode $this$searchChildren_u2d4C6V_qg, FocusTargetNode focusedItem, int direction, Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        if ($this$visitChildren$iv$iv.getNode().isAttached()) {
            ...
            while (children.isNotEmpty()) {
                FocusTargetNode nextItem = m2963findBestCandidate4WY_MpI(children, FocusTraversalKt.focusRect(focusedItem), i);
                if (nextItem == null) {
                    return false;
                }
                ...
                if (m2965generateAndSearchChildren4C6V_qg(nextItem, focusedItem, i, function1)) {
                    return true;
                }
    ...
    private static final FocusTargetNode m2963findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> $this$findBestCandidate_u2d4WY_MpI, Rect focusRect, int direction) {
        Rect rect;
        if (FocusDirection.m2919equalsimpl0(direction, FocusDirection.Companion.m2931getLeftdhqQ8s())) {
            rect = focusRect.translate(focusRect.getWidth() + ((float) 1), 0.0f);
        } else if (FocusDirection.m2919equalsimpl0(direction, FocusDirection.Companion.m2935getRightdhqQ8s())) {
            rect = focusRect.translate(-(focusRect.getWidth() + ((float) 1)), 0.0f);
        } else if (FocusDirection.m2919equalsimpl0(direction, FocusDirection.Companion.m2936getUpdhqQ8s())) {
            rect = focusRect.translate(0.0f, focusRect.getHeight() + ((float) 1));
        } else if (FocusDirection.m2919equalsimpl0(direction, FocusDirection.Companion.m2927getDowndhqQ8s())) {
            rect = focusRect.translate(0.0f, -(focusRect.getHeight() + ((float) 1)));
        } else {
        ...
        if (size$iv > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(candidateNode)) {
                    ...
                    if (m2966isBetterCandidateI7lrPNg(candidateRect, rect2, focusRect, direction)) {
                        rect2 = candidateRect;
    ...
    private static final boolean isBetterCandidate_I7lrPNg$isCandidate(Rect $this$isBetterCandidate_I7lrPNg_u24isCandidate, int $direction, Rect $focusedRect) {
        ...
        if (FocusDirection.m2919equalsimpl0($direction, FocusDirection.Companion.m2935getRightdhqQ8s())) {
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect $this$isBetterCandidate_I7lrPNg_u24minorAxisDistance, int $direction, Rect $focusedRect) {
        boolean z = true;
        if (FocusDirection.m2919equalsimpl0($direction, FocusDirection.Companion.m2931getLeftdhqQ8s()) ? true : FocusDirection.m2919equalsimpl0($direction, FocusDirection.Companion.m2935getRightdhqQ8s())) {
            float f = (float) 2;
        ...
        if (!FocusDirection.m2919equalsimpl0($direction, FocusDirection.Companion.m2936getUpdhqQ8s())) {
            z = FocusDirection.m2919equalsimpl0($direction, FocusDirection.Companion.m2927getDowndhqQ8s());
        }
        if (z) {
            float f2 = (float) 2;
    ...
    private static final boolean m2966isBetterCandidateI7lrPNg(Rect proposedCandidate, Rect currentCandidate, Rect focusedRect, int direction) {
        ...
        if (m2962beamBeatsI7lrPNg(focusedRect, proposedCandidate, currentCandidate, direction)) {
            return true;
        }
        if (!m2962beamBeatsI7lrPNg(focusedRect, currentCandidate, proposedCandidate, direction) && isBetterCandidate_I7lrPNg$weightedDistance(direction, focusedRect, proposedCandidate) < isBetterCandidate_I7lrPNg$weightedDistance(direction, focusedRect, currentCandidate)) {
            return true;
        }
        return false;
    }
    ...
    private static final boolean beamBeats_I7lrPNg$inSourceBeam(Rect $this$beamBeats_I7lrPNg_u24inSourceBeam, int $direction, Rect $source) {
        ...
        if (!(FocusDirection.m2919equalsimpl0($direction, FocusDirection.Companion.m2936getUpdhqQ8s()) ? true : FocusDirection.m2919equalsimpl0($direction, FocusDirection.Companion.m2927getDowndhqQ8s()))) {
            throw new IllegalStateException(InvalidFocusDirection.toString());
    ...
    private static final boolean m2962beamBeatsI7lrPNg(Rect source, Rect rect1, Rect rect2, int direction) {
        ...
        if (FocusDirection.m2919equalsimpl0(direction, FocusDirection.Companion.m2931getLeftdhqQ8s()) || FocusDirection.m2919equalsimpl0(direction, FocusDirection.Companion.m2935getRightdhqQ8s())) {
            return true;
        }
