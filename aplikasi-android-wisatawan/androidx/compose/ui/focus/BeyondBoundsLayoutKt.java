...
public final class BeyondBoundsLayoutKt {
    ...
    public static final <T> T m2915searchBeyondBoundsOMvw8(FocusTargetNode $this$searchBeyondBounds_u2d_u2dOM_u2dvw8, int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        ...
        if ($this$visitAncestors$iv$iv$iv.getNode().isAttached()) {
            ...
            if (FocusDirection.m2919equalsimpl0(i6, FocusDirection.Companion.m2936getUpdhqQ8s())) {
                i = BeyondBoundsLayout.LayoutDirection.Companion.m4601getAbovehoxUOeE();
            } else if (FocusDirection.m2919equalsimpl0(i6, FocusDirection.Companion.m2927getDowndhqQ8s())) {
                i = BeyondBoundsLayout.LayoutDirection.Companion.m4604getBelowhoxUOeE();
            } else if (FocusDirection.m2919equalsimpl0(i6, FocusDirection.Companion.m2931getLeftdhqQ8s())) {
                i = BeyondBoundsLayout.LayoutDirection.Companion.m4605getLefthoxUOeE();
            } else if (FocusDirection.m2919equalsimpl0(i6, FocusDirection.Companion.m2935getRightdhqQ8s())) {
                i = BeyondBoundsLayout.LayoutDirection.Companion.m4606getRighthoxUOeE();
            } else if (FocusDirection.m2919equalsimpl0(i6, FocusDirection.Companion.m2932getNextdhqQ8s())) {
                i = BeyondBoundsLayout.LayoutDirection.Companion.m4602getAfterhoxUOeE();
            } else if (FocusDirection.m2919equalsimpl0(i6, FocusDirection.Companion.m2934getPreviousdhqQ8s())) {
                i = BeyondBoundsLayout.LayoutDirection.Companion.m4603getBeforehoxUOeE();
            } else {
                throw new IllegalStateException("Unsupported direction for beyond bounds layout".toString());
            }
            return beyondBoundsLayoutParent.m4593layouto7g1Pn8(i, function1);
        }
