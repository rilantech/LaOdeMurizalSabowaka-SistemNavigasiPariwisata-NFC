...
public final class FocusTransactionsKt {
    ...
    public static final boolean requestFocus(FocusTargetNode $this$requestFocus) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[m2954performCustomRequestFocusMxy_nc0($this$requestFocus, FocusDirection.Companion.m2928getEnterdhqQ8s()).ordinal()]) {
            case 1:
    ...
    private static final boolean requestFocusForChild(FocusTargetNode $this$requestFocusForChild, FocusTargetNode childNode) {
        ...
        int type$iv10 = NodeKind.m4956constructorimpl(1024);
        int i7 = false;
            ...
            if (Intrinsics.areEqual((Object) node, (Object) focusTargetNode)) {
                switch (WhenMappings.$EnumSwitchMapping$1[$this$requestFocusForChild.getFocusState().ordinal()]) {
                    ...
                    case 4:
                        ...
                        int type$iv11 = NodeKind.m4956constructorimpl(1024);
    ...
    public static final CustomDestinationResult m2954performCustomRequestFocusMxy_nc0(FocusTargetNode $this$performCustomRequestFocus_u2dMxy_nc0, int focusDirection) {
        int i;
        int type$iv;
        ...
        switch (WhenMappings.$EnumSwitchMapping$1[$this$performCustomRequestFocus_u2dMxy_nc0.getFocusState().ordinal()]) {
            ...
            case 3:
                ...
                if (activeChild != null) {
                    return m2951performCustomClearFocusMxy_nc0(activeChild, i4);
                }
                throw new IllegalStateException("Required value was null.".toString());
            case 4:
                DelegatableNode $this$nearestAncestor_u2d64DMado$iv5 = focusTargetNode2;
                int type$iv6 = NodeKind.m4956constructorimpl(1024);
                ...
                if ($this$visitAncestors$iv$iv$iv.getNode().isAttached()) {
                    ...
                    switch (WhenMappings.$EnumSwitchMapping$1[focusParent.getFocusState().ordinal()]) {
                        case 1:
                            return m2952performCustomEnterMxy_nc0(focusParent, i4);
                        case 2:
                            return CustomDestinationResult.Cancelled;
                        case 3:
                            return m2954performCustomRequestFocusMxy_nc0(focusParent, i4);
                        case 4:
                            CustomDestinationResult it = m2954performCustomRequestFocusMxy_nc0(focusParent, i4);
    ...
    public static final CustomDestinationResult m2951performCustomClearFocusMxy_nc0(FocusTargetNode $this$performCustomClearFocus_u2dMxy_nc0, int focusDirection) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$1[$this$performCustomClearFocus_u2dMxy_nc0.getFocusState().ordinal()]) {
            ...
            case 3:
                ...
                if (activeChild != null) {
                    CustomDestinationResult it = m2951performCustomClearFocusMxy_nc0(activeChild, focusDirection);
                    if (it == CustomDestinationResult.None) {
                        it = null;
                    }
                    if (it == null) {
                        return m2953performCustomExitMxy_nc0($this$performCustomClearFocus_u2dMxy_nc0, focusDirection);
                    }
                    return it;
                }
                throw new IllegalStateException("Required value was null.".toString());
    ...
    private static final CustomDestinationResult m2952performCustomEnterMxy_nc0(FocusTargetNode $this$performCustomEnter_u2dMxy_nc0, int focusDirection) {
        ...
        if (!this_$iv.isProcessingCustomEnter) {
            ...
            try {
                FocusRequester it$iv = this_$iv.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2916boximpl(focusDirection));
    ...
    private static final CustomDestinationResult m2953performCustomExitMxy_nc0(FocusTargetNode $this$performCustomExit_u2dMxy_nc0, int focusDirection) {
        CustomDestinationResult customDestinationResult;
        ...
        if (!this_$iv.isProcessingCustomExit) {
            ...
            try {
                FocusRequester it$iv = this_$iv.fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2916boximpl(focusDirection));
                if (it$iv != FocusRequester.Companion.getDefault()) {
                    FocusRequester it = it$iv;
                    if (it == FocusRequester.Companion.getCancel()) {
                        customDestinationResult = CustomDestinationResult.Cancelled;
