...
public final class CallGroup extends Group {
    ...
    public CallGroup(Object key, String name, IntRect box, SourceLocation location, Object identity, List<ParameterInformation> parameters2, Collection<? extends Object> data, Collection<? extends Group> children, boolean isInline) {
        super(key, name, location, identity, box, data, children, isInline, (DefaultConstructorMarker) null);
        List<ParameterInformation> list = parameters2;
