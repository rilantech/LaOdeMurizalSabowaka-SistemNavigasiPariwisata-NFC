...
public final class NodeGroup extends Group {
    ...
    public NodeGroup(Object key, Object node2, IntRect box, Collection<? extends Object> data, List<ModifierInfo> modifierInfo2, Collection<? extends Group> children) {
        super(key, (String) null, (SourceLocation) null, (Object) null, box, data, children, false, (DefaultConstructorMarker) null);
        Object obj = node2;
        List<ModifierInfo> list = modifierInfo2;
