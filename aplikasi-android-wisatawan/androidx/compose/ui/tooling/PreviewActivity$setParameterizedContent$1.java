...
final class PreviewActivity$setParameterizedContent$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            ScaffoldKt.m1389Scaffold27mzLpw((Modifier) null, (ScaffoldState) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function3<? super SnackbarHostState, ? super Composer, ? super Integer, Unit>) null, ComposableLambdaKt.composableLambda(composer, 2137630662, true, new Function2<Composer, Integer, Unit>() {
                public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                    invoke((Composer) p1, ((Number) p2).intValue());
                    return Unit.INSTANCE;
                }
                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if ((i & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        Function2<Composer, Integer, Unit> r3 = ComposableSingletons$PreviewActivityKt.INSTANCE.m5762getLambda1$ui_tooling_release();
                        final MutableIntState mutableIntState = index;
                        final Object[] objArr = objArr;
                        FloatingActionButtonKt.m1324ExtendedFloatingActionButtonwqdebIU(r3, new Function0<Unit>() {
                ...
                public final void invoke(androidx.compose.foundation.layout.PaddingValues r30, androidx.compose.runtime.Composer r31, int r32) {
                    ...
                    L_0x00c9:
                        r19 = r4
                        androidx.compose.runtime.Composer r4 = androidx.compose.runtime.Updater.m2865constructorimpl(r31)
                        r21 = 0
                        ...
                        androidx.compose.runtime.Updater.m2872setimpl((androidx.compose.runtime.Composer) r4, r14, r5)
                    ...
                    L_0x0111:
                        ...
                        r4.apply(r1, r5)
                    L_0x0121:
                        androidx.compose.runtime.Composer r1 = androidx.compose.runtime.SkippableUpdater.m2857constructorimpl(r31)
