...
public final class AnimatedVisibilityClock implements ComposeAnimationClock<AnimatedVisibilityComposeAnimation, AnimatedVisibilityState> {
    ...
    public AnimatedVisibilityClock(AnimatedVisibilityComposeAnimation animation2) {
        ...
        if (getAnimation().getAnimationObject().getCurrentState().booleanValue()) {
            str = AnimatedVisibilityState.Companion.m5775getExitjXw82LU();
        } else {
            str = AnimatedVisibilityState.Companion.m5774getEnterjXw82LU();
        }
        this.state = str;
    }
    ...
    public /* bridge */ /* synthetic */ ComposeAnimationState getState() {
        return AnimatedVisibilityState.m5767boximpl(m5765getStatejXw82LU());
    }

    public /* bridge */ /* synthetic */ void setState(ComposeAnimationState composeAnimationState) {
        m5766setState7IW2chM(((AnimatedVisibilityState) composeAnimationState).m5773unboximpl());
    }

    /* renamed from: getState-jXw82LU  reason: not valid java name */
    public String m5765getStatejXw82LU() {
        return this.state;
    }

    /* renamed from: setState-7IW2chM  reason: not valid java name */
    public void m5766setState7IW2chM(String value) {
    ...
    public void setStateParameters(Object par1, Object par2) {
        ...
        m5766setState7IW2chM(((AnimatedVisibilityState) par1).m5773unboximpl());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        ...
        Pair<Boolean, Boolean> r2 = m5764toCurrentTargetPair7IW2chM(m5765getStatejXw82LU());
    ...
    private final Pair<Boolean, Boolean> m5764toCurrentTargetPair7IW2chM(String $this$toCurrentTargetPair_u2d7IW2chM) {
        return AnimatedVisibilityState.m5770equalsimpl0($this$toCurrentTargetPair_u2d7IW2chM, AnimatedVisibilityState.Companion.m5774getEnterjXw82LU()) ? TuplesKt.to(false, true) : TuplesKt.to(true, false);
    }
}
