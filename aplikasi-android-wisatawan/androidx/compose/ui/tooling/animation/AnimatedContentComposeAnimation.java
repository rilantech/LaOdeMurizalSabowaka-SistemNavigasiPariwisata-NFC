...
public final class AnimatedContentComposeAnimation<T> implements ComposeAnimation, TransitionBasedAnimation<T> {
    ...
    private AnimatedContentComposeAnimation(Transition<T> animationObject2, Set<? extends Object> states2, String label2) {
    ...
    public static final class Companion {
        ...
        public final androidx.compose.ui.tooling.animation.AnimatedContentComposeAnimation<?> parseAnimatedContent(androidx.compose.animation.core.Transition<?> r7) {
            ...
            L_0x000d:
                ...
                java.util.Set r3 = kotlin.collections.ArraysKt.toSet((T[]) r3)
    ...
    static {
        ...
        while (true) {
            if (i >= length) {
                break;
            } else if (Intrinsics.areEqual((Object) values[i].name(), (Object) "ANIMATED_CONTENT")) {
                z = true;
                break;
            } else {
                i++;
