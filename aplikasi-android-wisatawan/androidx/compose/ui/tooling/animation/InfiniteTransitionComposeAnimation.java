...
public final class InfiniteTransitionComposeAnimation implements ComposeAnimation {
    ...
    public /* synthetic */ InfiniteTransitionComposeAnimation(ToolingState toolingState2, InfiniteTransition infiniteTransition, DefaultConstructorMarker defaultConstructorMarker) {
        this(toolingState2, infiniteTransition);
    }

    private InfiniteTransitionComposeAnimation(ToolingState<Long> toolingState2, InfiniteTransition animationObject2) {
    ...
    public static final class Companion {
        ...
        public final InfiniteTransitionComposeAnimation parse$ui_tooling_release(AnimationSearch.InfiniteTransitionSearchInfo $this$parse) {
            ...
            return new InfiniteTransitionComposeAnimation($this$parse.getToolingState(), $this$parse.getInfiniteTransition(), (DefaultConstructorMarker) null);
        }
    ...
    static {
        ...
        while (true) {
            if (i >= length) {
                break;
            } else if (Intrinsics.areEqual((Object) values[i].name(), (Object) "INFINITE_TRANSITION")) {
                z = true;
                break;
            } else {
                i++;
