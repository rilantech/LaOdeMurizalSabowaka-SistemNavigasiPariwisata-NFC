...
public final class AnimatedVisibilityState implements ComposeAnimationState {
    ...
    public static final String Enter = m5768constructorimpl("Enter");
    /* access modifiers changed from: private */
    public static final String Exit = m5768constructorimpl("Exit");
    private final String value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ AnimatedVisibilityState m5767boximpl(String str) {
        return new AnimatedVisibilityState(str);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static String m5768constructorimpl(String str) {
        return str;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m5769equalsimpl(String str, Object obj) {
        return (obj instanceof AnimatedVisibilityState) && Intrinsics.areEqual((Object) str, (Object) ((AnimatedVisibilityState) obj).m5773unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m5770equalsimpl0(String str, String str2) {
        return Intrinsics.areEqual((Object) str, (Object) str2);
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m5771hashCodeimpl(String str) {
        return str.hashCode();
    }

    public boolean equals(Object obj) {
        return m5769equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m5771hashCodeimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ String m5773unboximpl() {
        return this.value;
    }
    ...
    public static String m5772toStringimpl(String arg0) {
        return arg0;
    }

    public String toString() {
        return m5772toStringimpl(this.value);
    }
