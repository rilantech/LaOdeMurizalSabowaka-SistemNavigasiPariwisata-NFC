...
public final class AnimateXAsStateComposeAnimation<T, V extends AnimationVector> implements ComposeAnimation {
    ...
    public /* synthetic */ AnimateXAsStateComposeAnimation(ToolingState toolingState2, AnimationSpec animationSpec2, Animatable animatable, DefaultConstructorMarker defaultConstructorMarker) {
        this(toolingState2, animationSpec2, animatable);
    }
    ...
    private AnimateXAsStateComposeAnimation(androidx.compose.ui.tooling.animation.ToolingState<T> r5, androidx.compose.animation.core.AnimationSpec<T> r6, androidx.compose.animation.core.Animatable<T, V> r7) {
        /*
            ...
            r4.type = r0
            androidx.compose.animation.core.Animatable r0 = r4.getAnimationObject()
            ...
            java.util.Set r2 = kotlin.collections.ArraysKt.toSet((T[]) r2)
    ...
    public static final class Companion {
        ...
        public final <T, V extends AnimationVector> AnimateXAsStateComposeAnimation<?, ?> parse$ui_tooling_release(AnimationSearch.AnimateXAsStateSearchInfo<T, V> $this$parse) {
            Intrinsics.checkNotNullParameter($this$parse, "<this>");
            if (getApiAvailable() && $this$parse.getAnimatable().getValue() != null) {
                return new AnimateXAsStateComposeAnimation<>($this$parse.getToolingState(), $this$parse.getAnimationSpec(), $this$parse.getAnimatable(), (DefaultConstructorMarker) null);
            }
            return null;
        }
