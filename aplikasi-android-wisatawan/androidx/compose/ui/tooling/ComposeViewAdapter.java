...
public final class ComposeViewAdapter extends FrameLayout {
    ...
    public ComposeViewAdapter(Context context, AttributeSet attrs) {
        ...
        this.previewComposition = ComposableSingletons$ComposeViewAdapterKt.INSTANCE.m5760getLambda2$ui_tooling_release();
        ...
        $this$debugBoundsPaint_u24lambda_u240.setColor(ColorKt.m3307toArgb8_81llA(Color.Companion.m3287getRed0d7_KjU()));
    ...
    private final void invalidateComposition() {
        this.content.setValue(ComposableSingletons$ComposeViewAdapterKt.INSTANCE.m5761getLambda3$ui_tooling_release());
