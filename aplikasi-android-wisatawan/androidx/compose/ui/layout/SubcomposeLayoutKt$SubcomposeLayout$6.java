...
final class SubcomposeLayoutKt$SubcomposeLayout$6 extends Lambda implements Function2<SubcomposeIntermediateMeasureScope, Constraints, MeasureResult> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m4769invoke0kLqBqw((SubcomposeIntermediateMeasureScope) p1, ((Constraints) p2).m5794unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final MeasureResult m4769invoke0kLqBqw(SubcomposeIntermediateMeasureScope $this$SubcomposeLayout, long it) {
        Intrinsics.checkNotNullParameter($this$SubcomposeLayout, "$this$SubcomposeLayout");
        return $this$SubcomposeLayout.getLookaheadMeasurePolicy().invoke($this$SubcomposeLayout, Constraints.m5776boximpl(it));
    }
}
