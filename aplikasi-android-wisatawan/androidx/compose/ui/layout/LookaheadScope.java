...
public interface LookaheadScope {
    ...
    long m4687localLookaheadPositionOfdBAh8RU(LayoutCoordinates $this$localLookaheadPositionOf_u2ddBAh8RU, LayoutCoordinates coordinates) {
        Intrinsics.checkNotNullParameter($this$localLookaheadPositionOf_u2ddBAh8RU, "$this$localLookaheadPositionOf");
        Intrinsics.checkNotNullParameter(coordinates, "coordinates");
        return toLookaheadCoordinates($this$localLookaheadPositionOf_u2ddBAh8RU).m4651localPositionOfR5De75A(toLookaheadCoordinates(coordinates), Offset.Companion.m3019getZeroF1C5BW0());
    }
