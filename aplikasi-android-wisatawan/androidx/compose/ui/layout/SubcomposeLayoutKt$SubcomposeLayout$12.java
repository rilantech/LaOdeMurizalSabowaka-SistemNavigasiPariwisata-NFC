...
final class SubcomposeLayoutKt$SubcomposeLayout$12 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    SubcomposeLayoutKt$SubcomposeLayout$12(SubcomposeLayoutState subcomposeLayoutState, Modifier modifier, Function2<? super SubcomposeIntermediateMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function22, int i, int i2) {
        super(2);
