...
final class TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1 implements MeasurePolicy {
    ...
    public final MeasureResult m4772measure3p2s80s(MeasureScope $this$MeasurePolicy, List<? extends Measurable> list, long constraints) {
        Intrinsics.checkNotNullParameter($this$MeasurePolicy, "$this$MeasurePolicy");
        Intrinsics.checkNotNullParameter(list, "<anonymous parameter 0>");
        return MeasureScope.layout$default($this$MeasurePolicy, Constraints.m5788getMaxWidthimpl(constraints), Constraints.m5787getMaxHeightimpl(constraints), (Map) null, TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1$measure$1.INSTANCE, 4, (Object) null);
    }
}
