...
final class OnSizeChangedModifier extends InspectorValueInfo implements OnRemeasuredModifier {
    ...
    public OnSizeChangedModifier(Function1<? super IntSize, Unit> onSizeChanged2, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        super(inspectorInfo);
    ...
    public void m4720onRemeasuredozmzZPI(long size) {
        if (!IntSize.m6002equalsimpl0(this.previousSize, size)) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual((Object) this.onSizeChanged, (Object) ((OnSizeChangedModifier) other).onSizeChanged);
    }
