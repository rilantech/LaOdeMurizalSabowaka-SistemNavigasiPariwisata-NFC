...
public final class IntermediateLayoutModifierNode$IntermediateMeasureScopeImpl$layout$1 implements MeasureResult {
    ...
    IntermediateLayoutModifierNode$IntermediateMeasureScopeImpl$layout$1(int $width2, int $height, Map<AlignmentLine, Integer> $alignmentLines, IntermediateLayoutModifierNode.IntermediateMeasureScopeImpl $receiver, IntermediateLayoutModifierNode $receiver2, Function1<? super Placeable.PlacementScope, Unit> $placementBlock2) {
        this.$width = $width2;
    ...
    public void placeChildren() {
        ...
        LookaheadCapablePlaceable lookaheadCapablePlaceable$iv = this.this$1.getCoordinator$ui_release();
