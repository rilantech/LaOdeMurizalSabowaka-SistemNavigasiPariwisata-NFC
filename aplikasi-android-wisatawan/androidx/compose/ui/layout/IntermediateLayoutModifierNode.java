...
public final class IntermediateLayoutModifierNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public void onAttach() {
        ...
        if (coordinates5 != null) {
            ...
            if (closestLookaheadRoot != null && closestLookaheadRoot.isVirtualLookaheadRoot$ui_release()) {
                ...
                int type$iv = NodeKind.m4956constructorimpl(512);
    ...
    public MeasureResult m4627measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$measure_u2d3p2s80s, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        Placeable $this$measure_3p2s80s_u24lambda_u241 = measurable.m4689measureBRTryo0(constraints);
    ...
    public final MeasureResult m4626intermediateMeasureTeuZzU(MeasureScope $this$intermediateMeasure_u2dTe_u2duZzU, Measurable measurable, long constraints, long lookaheadSize, long lookaheadConstraints2) {
        Intrinsics.checkNotNullParameter($this$intermediateMeasure_u2dTe_u2duZzU, "$this$intermediateMeasure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        this.intermediateMeasureScope.m4631setLookaheadSizeozmzZPI(lookaheadSize);
        this.lookaheadConstraints = Constraints.m5776boximpl(lookaheadConstraints2);
        ...
        return (MeasureResult) this.measureBlock.invoke(this.intermediateMeasureScope, wrappedMeasurable, Constraints.m5776boximpl(constraints));
    }
    ...
    private final class IntermediateMeasurablePlaceable extends Placeable implements Measurable {
        ...
        public Placeable m4628measureBRTryo0(long constraints) {
            Placeable placeable;
            long j;
            if (this.this$0.isIntermediateChangeActive()) {
                placeable = this.wrappedMeasurable.m4689measureBRTryo0(constraints);
                Placeable it = placeable;
                m4728setMeasurementConstraintsBRTryo0(constraints);
                m4727setMeasuredSizeozmzZPI(IntSizeKt.IntSize(it.getWidth(), it.getHeight()));
            } else {
                ...
                placeable = measurable.m4689measureBRTryo0(access$getLookaheadConstraints$p.m5794unboximpl());
                ...
                m4728setMeasurementConstraintsBRTryo0(access$getLookaheadConstraints$p2.m5794unboximpl());
                if (intermediateLayoutModifierNode.isIntermediateChangeActive()) {
                    j = IntSizeKt.IntSize(it2.getWidth(), it2.getHeight());
                } else {
                    j = intermediateLayoutModifierNode.intermediateMeasureScope.m4630getLookaheadSizeYbymL2g();
                }
                m4727setMeasuredSizeozmzZPI(j);
            }
            this.wrappedPlaceable = placeable;
            return this;
        }
        ...
        public void m4629placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Unit unit;
            long offset = this.this$0.isIntermediateChangeActive() ? position : IntOffset.Companion.m5972getZeronOccac();
            if (layerBlock != null) {
                Function1 it = layerBlock;
                Placeable placeable = this.wrappedPlaceable;
                if (placeable != null) {
                    Placeable.PlacementScope.Companion.m4738placeWithLayeraW9wM(placeable, offset, zIndex, it);
                    unit = Unit.INSTANCE;
                } else {
                    unit = null;
                }
            ...
            if (placeable2 != null) {
                Placeable.PlacementScope.Companion.m4733place70tqf50(placeable2, offset, zIndex);
