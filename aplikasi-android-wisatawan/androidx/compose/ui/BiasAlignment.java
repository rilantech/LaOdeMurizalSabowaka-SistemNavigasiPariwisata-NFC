...
public final class BiasAlignment implements Alignment {
    ...
    public long m2886alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        float resolvedHorizontalBias;
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        float centerX = ((float) (IntSize.m6004getWidthimpl(space) - IntSize.m6004getWidthimpl(size))) / 2.0f;
        float centerY = ((float) (IntSize.m6003getHeightimpl(space) - IntSize.m6003getHeightimpl(size))) / 2.0f;
