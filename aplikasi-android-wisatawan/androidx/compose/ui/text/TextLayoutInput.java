...
public final class TextLayoutInput {
    ...
    public final int m5294getOverflowgIe3tQ8() {
    ...
    public final long m5293getConstraintsmsEJaDk() {
    ...
    public static /* synthetic */ TextLayoutInput m5291copyhu1Yfo$default(TextLayoutInput textLayoutInput, AnnotatedString annotatedString, TextStyle textStyle, List list, int i, boolean z, int i2, Density density2, LayoutDirection layoutDirection2, Font.ResourceLoader resourceLoader, long j, int i3, Object obj) {
        ...
        return textLayoutInput.m5292copyhu1Yfo(annotatedString2, textStyle2, list2, i4, z2, i5, density3, layoutDirection3, resourceLoader2, j2);
    }
    ...
    public final TextLayoutInput m5292copyhu1Yfo(AnnotatedString text2, TextStyle style2, List<AnnotatedString.Range<Placeholder>> placeholders2, int maxLines2, boolean softWrap2, int overflow2, Density density2, LayoutDirection layoutDirection2, Font.ResourceLoader resourceLoader, long constraints2) {
        Intrinsics.checkNotNullParameter(text2, "text");
        Intrinsics.checkNotNullParameter(style2, "style");
        Intrinsics.checkNotNullParameter(placeholders2, "placeholders");
        Intrinsics.checkNotNullParameter(density2, "density");
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TextLayoutInput) && Intrinsics.areEqual((Object) this.text, (Object) ((TextLayoutInput) other).text) && Intrinsics.areEqual((Object) this.style, (Object) ((TextLayoutInput) other).style) && Intrinsics.areEqual((Object) this.placeholders, (Object) ((TextLayoutInput) other).placeholders) && this.maxLines == ((TextLayoutInput) other).maxLines && this.softWrap == ((TextLayoutInput) other).softWrap && TextOverflow.m5749equalsimpl0(this.overflow, ((TextLayoutInput) other).overflow) && Intrinsics.areEqual((Object) this.density, (Object) ((TextLayoutInput) other).density) && this.layoutDirection == ((TextLayoutInput) other).layoutDirection && Intrinsics.areEqual((Object) this.fontFamilyResolver, (Object) ((TextLayoutInput) other).fontFamilyResolver) && Constraints.m5781equalsimpl0(this.constraints, ((TextLayoutInput) other).constraints)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((this.text.hashCode() * 31) + this.style.hashCode()) * 31) + this.placeholders.hashCode()) * 31) + this.maxLines) * 31) + Boolean.hashCode(this.softWrap)) * 31) + TextOverflow.m5750hashCodeimpl(this.overflow)) * 31) + this.density.hashCode()) * 31) + this.layoutDirection.hashCode()) * 31) + this.fontFamilyResolver.hashCode()) * 31) + Constraints.m5791hashCodeimpl(this.constraints);
    }

    public String toString() {
        return "TextLayoutInput(text=" + this.text + ", style=" + this.style + ", placeholders=" + this.placeholders + ", maxLines=" + this.maxLines + ", softWrap=" + this.softWrap + ", overflow=" + TextOverflow.m5751toStringimpl(this.overflow) + ", density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + Constraints.m5793toStringimpl(this.constraints) + ')';
    }
}
