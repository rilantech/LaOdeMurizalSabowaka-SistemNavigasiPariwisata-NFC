...
final class SaversKt$TextIndentSaver$1 extends Lambda implements Function2<SaverScope, TextIndent, Object> {
    ...
    public final Object invoke(SaverScope $this$Saver, TextIndent it) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(TextUnit.m6015boximpl(it.m5731getFirstLineXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), $this$Saver), SaversKt.save(TextUnit.m6015boximpl(it.m5732getRestLineXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), $this$Saver));
    }
}
