...
public final class TextLayoutResult {
    ...
    public final long m5298getSizeYbymL2g() {
        return this.size;
    }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m6003getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m6004getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m5297getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m5208getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m5299getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m5209getWordBoundaryjx7JFs(offset);
    }
    ...
    public static /* synthetic */ TextLayoutResult m5295copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m5296copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c  reason: not valid java name */
    public final TextLayoutResult m5296copyO0kMr_c(TextLayoutInput layoutInput2, long size2) {
        Intrinsics.checkNotNullParameter(layoutInput2, "layoutInput");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TextLayoutResult) || !Intrinsics.areEqual((Object) this.layoutInput, (Object) ((TextLayoutResult) other).layoutInput) || !Intrinsics.areEqual((Object) this.multiParagraph, (Object) ((TextLayoutResult) other).multiParagraph) || !IntSize.m6002equalsimpl0(this.size, ((TextLayoutResult) other).size)) {
            return false;
        }
    ...
    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m6005hashCodeimpl(this.size)) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + IntSize.m6007toStringimpl(this.size) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
