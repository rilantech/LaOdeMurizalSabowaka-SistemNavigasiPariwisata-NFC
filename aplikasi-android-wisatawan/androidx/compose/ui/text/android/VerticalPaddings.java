...
public final class VerticalPaddings {
    ...
    public static final /* synthetic */ VerticalPaddings m5358boximpl(long j) {
        return new VerticalPaddings(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m5359constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m5360equalsimpl(long j, Object obj) {
        return (obj instanceof VerticalPaddings) && j == ((VerticalPaddings) obj).m5366unboximpl();
    }
    ...
    public static int m5364hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m5365toStringimpl(long j) {
    ...
    public int hashCode() {
        return m5364hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m5365toStringimpl(this.packedValue);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m5366unboximpl() {
    ...
    public static final int m5363getTopPaddingimpl(long arg0) {
        return (int) (arg0 >> 32);
    }

    /* renamed from: getBottomPadding-impl  reason: not valid java name */
    public static final int m5362getBottomPaddingimpl(long arg0) {
