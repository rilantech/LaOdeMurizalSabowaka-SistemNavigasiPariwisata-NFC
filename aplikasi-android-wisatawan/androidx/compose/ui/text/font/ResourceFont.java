...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m5466getLoadingStrategyPKNRLFQ$annotations() {
    }
    ...
    public /* synthetic */ ResourceFont(int r8, androidx.compose.ui.text.font.FontWeight r9, int r10, androidx.compose.ui.text.font.FontVariation.Settings r11, int r12, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        L_0x000d:
            ...
            int r10 = r9.m5429getNormal_LCdwA()
            r3 = r10
            goto L_0x001a
        L_0x0019:
            r3 = r10
        L_0x001a:
            ...
            androidx.compose.ui.text.font.FontVariation$Settings r11 = r9.m5444Settings6EWAqTQ(r2, r3, r10)
            r4 = r11
            goto L_0x002a
        L_0x0029:
            r4 = r11
        L_0x002a:
            ...
            int r12 = r9.m5415getAsyncPKNRLFQ()
            r5 = r12
            goto L_0x0037
        L_0x0036:
            r5 = r12
    ...
    public int m5470getStyle_LCdwA() {
        return this.style;
    }
    ...
    public int m5469getLoadingStrategyPKNRLFQ() {
        return this.loadingStrategy;
    }

    /* renamed from: copy-RetOiIg$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m5465copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        if ((i3 & 4) != 0) {
            i2 = resourceFont.m5470getStyle_LCdwA();
        }
        return resourceFont.m5468copyRetOiIg(i, fontWeight, i2);
    }

    /* renamed from: copy-RetOiIg  reason: not valid java name */
    public final ResourceFont m5468copyRetOiIg(int resId2, FontWeight weight2, int style2) {
        Intrinsics.checkNotNullParameter(weight2, "weight");
        return m5464copyF3nL8kk$default(this, resId2, weight2, style2, m5469getLoadingStrategyPKNRLFQ(), (FontVariation.Settings) null, 16, (Object) null);
    }

    /* renamed from: copy-F3nL8kk$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m5464copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        ...
        if ((i4 & 4) != 0) {
            i5 = resourceFont.m5470getStyle_LCdwA();
        } else {
            i5 = i2;
        }
        if ((i4 & 8) != 0) {
            i6 = resourceFont.m5469getLoadingStrategyPKNRLFQ();
        } else {
            i6 = i3;
        }
        if ((i4 & 16) != 0) {
        ...
        return resourceFont.m5467copyF3nL8kk(i, fontWeight2, i5, i6, settings2);
    }

    /* renamed from: copy-F3nL8kk  reason: not valid java name */
    public final ResourceFont m5467copyF3nL8kk(int resId2, FontWeight weight2, int style2, int loadingStrategy2, FontVariation.Settings variationSettings2) {
        Intrinsics.checkNotNullParameter(weight2, "weight");
        Intrinsics.checkNotNullParameter(variationSettings2, "variationSettings");
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ResourceFont) && this.resId == ((ResourceFont) other).resId && Intrinsics.areEqual((Object) getWeight(), (Object) ((ResourceFont) other).getWeight()) && FontStyle.m5424equalsimpl0(m5470getStyle_LCdwA(), ((ResourceFont) other).m5470getStyle_LCdwA()) && Intrinsics.areEqual((Object) this.variationSettings, (Object) ((ResourceFont) other).variationSettings) && FontLoadingStrategy.m5411equalsimpl0(m5469getLoadingStrategyPKNRLFQ(), ((ResourceFont) other).m5469getLoadingStrategyPKNRLFQ())) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((this.resId * 31) + getWeight().hashCode()) * 31) + FontStyle.m5425hashCodeimpl(m5470getStyle_LCdwA())) * 31) + FontLoadingStrategy.m5412hashCodeimpl(m5469getLoadingStrategyPKNRLFQ())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + FontStyle.m5426toStringimpl(m5470getStyle_LCdwA()) + ", loadingStrategy=" + FontLoadingStrategy.m5413toStringimpl(m5469getLoadingStrategyPKNRLFQ()) + ')';
    }
}
