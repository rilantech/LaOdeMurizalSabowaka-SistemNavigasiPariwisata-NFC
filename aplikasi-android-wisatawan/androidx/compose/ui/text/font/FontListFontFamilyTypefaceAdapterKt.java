        ...
        for (int idx = 0; idx < size; idx++) {
            ...
            if (FontLoadingStrategy.m5411equalsimpl0(r0, FontLoadingStrategy.Companion.m5416getBlockingPKNRLFQ())) {
                ...
                synchronized (this_$iv.cacheLock) {
                    ...
                    if (priorResult$iv != null) {
                        result = priorResult$iv.m5384unboximpl();
                    } else {
                ...
                if (result != null) {
                    return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m5443synthesizeTypefaceFxwP2eA(typefaceRequest.m5476getFontSynthesisGVVA2EU(), result, font, typefaceRequest.getFontWeight(), typefaceRequest.m5475getFontStyle_LCdwA()));
                }
                throw new IllegalStateException("Unable to load font " + font);
            }
            if (FontLoadingStrategy.m5411equalsimpl0(r0, FontLoadingStrategy.Companion.m5417getOptionalLocalPKNRLFQ())) {
                ...
                synchronized (this_$iv2.cacheLock) {
                    ...
                    if (priorResult$iv2 != null) {
                        obj = priorResult$iv2.m5384unboximpl();
                    } else {
                        Unit unit2 = Unit.INSTANCE;
                        try {
                            Result.Companion companion = Result.Companion;
                            it$iv = Result.m6229constructorimpl(platformFontLoader2.loadBlocking(font));
                        } catch (Throwable th) {
                            Result.Companion companion2 = Result.Companion;
                            it$iv = Result.m6229constructorimpl(ResultKt.createFailure(th));
                        }
                        if (Result.m6235isFailureimpl(it$iv)) {
                            it$iv = null;
                        }
                ...
                Object result2 = obj;
                if (result2 != null) {
                    return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m5443synthesizeTypefaceFxwP2eA(typefaceRequest.m5476getFontSynthesisGVVA2EU(), result2, font, typefaceRequest.getFontWeight(), typefaceRequest.m5475getFontStyle_LCdwA()));
                }
                ...
                AsyncTypefaceCache.AsyncTypefaceResult cacheResult = asyncTypefaceCache.m5376get1ASDuI8(font, platformFontLoader2);
                if (cacheResult == null) {
                ...
                } else if (!AsyncTypefaceCache.AsyncTypefaceResult.m5382isPermanentFailureimpl(cacheResult.m5384unboximpl()) && cacheResult.m5384unboximpl() != null) {
                    return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m5443synthesizeTypefaceFxwP2eA(typefaceRequest.m5476getFontSynthesisGVVA2EU(), cacheResult.m5384unboximpl(), font, typefaceRequest.getFontWeight(), typefaceRequest.m5475getFontStyle_LCdwA()));
                }
            } else {
