...
public final class FontKt {
    ...
    public static /* synthetic */ Font m5405FontRetOiIg$default(int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i3 & 4) != 0) {
            i2 = FontStyle.Companion.m5429getNormal_LCdwA();
        }
        return Intrinsics.checkNotNullParameter(fontWeight, "weight");
    }

    /* renamed from: Font-YpTlLL0$default  reason: not valid java name */
    public static /* synthetic */ Font m5407FontYpTlLL0$default(int i, FontWeight fontWeight, int i2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 8) != 0) {
            i3 = FontLoadingStrategy.Companion.m5416getBlockingPKNRLFQ();
        }
        return m5406FontYpTlLL0(i, fontWeight, i2, i3);
    }

    /* renamed from: Font-YpTlLL0  reason: not valid java name */
    public static final Font m5406FontYpTlLL0(int resId, FontWeight weight, int style, int loadingStrategy) {
    ...
    public static /* synthetic */ Font m5403FontF3nL8kk$default(int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 16) != 0) {
            settings = FontVariation.INSTANCE.m5444Settings6EWAqTQ(fontWeight, i2, new FontVariation.Setting[0]);
        }
        return m5402FontF3nL8kk(i, fontWeight, i2, i3, settings);
    }

    /* renamed from: Font-F3nL8kk  reason: not valid java name */
    public static final Font m5402FontF3nL8kk(int resId, FontWeight weight, int style, int loadingStrategy, FontVariation.Settings variationSettings) {
        Intrinsics.checkNotNullParameter(weight, "weight");
