...
final class DeviceFontFamilyNameFont extends AndroidFont {
    ...
    public int m5392getStyle_LCdwA() {
        return this.style;
    }
    ...
    private DeviceFontFamilyNameFont(String familyName2, FontWeight weight2, int style2, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.Companion.m5417getOptionalLocalPKNRLFQ(), NamedFontLoader.INSTANCE, variationSettings, (DefaultConstructorMarker) null);
    ...
    public final Typeface loadCached(Context context) {
        ...
        return PlatformTypefacesKt.PlatformTypefaces().m5451optionalOnDeviceFontFamilyByName78DK7lM(this.familyName, getWeight(), m5392getStyle_LCdwA(), getVariationSettings(), context);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeviceFontFamilyNameFont) && DeviceFontFamilyName.m5388equalsimpl0(this.familyName, ((DeviceFontFamilyNameFont) other).familyName) && Intrinsics.areEqual((Object) getWeight(), (Object) ((DeviceFontFamilyNameFont) other).getWeight()) && FontStyle.m5424equalsimpl0(m5392getStyle_LCdwA(), ((DeviceFontFamilyNameFont) other).m5392getStyle_LCdwA()) && Intrinsics.areEqual((Object) getVariationSettings(), (Object) ((DeviceFontFamilyNameFont) other).getVariationSettings())) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((DeviceFontFamilyName.m5389hashCodeimpl(this.familyName) * 31) + getWeight().hashCode()) * 31) + FontStyle.m5425hashCodeimpl(m5392getStyle_LCdwA())) * 31) + getVariationSettings().hashCode();
    }

    public String toString() {
        return "Font(familyName=\"" + DeviceFontFamilyName.m5390toStringimpl(this.familyName) + "\", weight=" + getWeight() + ", style=" + FontStyle.m5426toStringimpl(m5392getStyle_LCdwA()) + ')';
    }
}
