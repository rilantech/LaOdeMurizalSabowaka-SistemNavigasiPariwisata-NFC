...
public final class AsyncTypefaceCache {
    private final Object PermanentFailure = AsyncTypefaceResult.m5378constructorimpl((Object) null);
    ...
    public static final class AsyncTypefaceResult {
        ...
        public static final /* synthetic */ AsyncTypefaceResult m5377boximpl(Object obj) {
            return new AsyncTypefaceResult(obj);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        public static Object m5378constructorimpl(Object obj) {
            return obj;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m5379equalsimpl(Object obj, Object obj2) {
            return (obj2 instanceof AsyncTypefaceResult) && Intrinsics.areEqual(obj, ((AsyncTypefaceResult) obj2).m5384unboximpl());
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m5380equalsimpl0(Object obj, Object obj2) {
            return Intrinsics.areEqual(obj, obj2);
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m5381hashCodeimpl(Object obj) {
            if (obj == null) {
                return 0;
            }
            return obj.hashCode();
        ...
        public static String m5383toStringimpl(Object obj) {
            return "AsyncTypefaceResult(result=" + obj + ')';
        }

        public boolean equals(Object obj) {
            return m5379equalsimpl(this.result, obj);
        }

        public int hashCode() {
            return m5381hashCodeimpl(this.result);
        }

        public String toString() {
            return m5383toStringimpl(this.result);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ Object m5384unboximpl() {
            return this.result;
        }
        ...
        public static final boolean m5382isPermanentFailureimpl(Object arg0) {
            return arg0 == null;
        }
    }
    ...
    public final void put(Font font, PlatformFontLoader platformFontLoader, Object result, boolean forever) {
        ...
        synchronized (this.cacheLock) {
            if (result == null) {
                try {
                    AsyncTypefaceResult put = this.permanentCache.put(key, AsyncTypefaceResult.m5377boximpl(this.PermanentFailure));
                } catch (Throwable th) {
                    throw th;
                }
            } else if (forever) {
                AsyncTypefaceResult put2 = this.permanentCache.put(key, AsyncTypefaceResult.m5377boximpl(AsyncTypefaceResult.m5378constructorimpl(result)));
            } else {
                AsyncTypefaceResult put3 = this.resultCache.put(key, AsyncTypefaceResult.m5377boximpl(AsyncTypefaceResult.m5378constructorimpl(result)));
            }
        }
    }

    /* renamed from: get-1ASDuI8  reason: not valid java name */
    public final AsyncTypefaceResult m5376get1ASDuI8(Font font, PlatformFontLoader platformFontLoader) {
    ...
    public final java.lang.Object runCached(androidx.compose.ui.text.font.Font r8, androidx.compose.ui.text.font.PlatformFontLoader r9, boolean r10, kotlin.jvm.functions.Function1<? super kotlin.coroutines.Continuation<java.lang.Object>, ? extends java.lang.Object> r11, kotlin.coroutines.Continuation<java.lang.Object> r12) {
        ...
        L_0x0063:
            ...
            java.lang.Object r9 = r5.m5384unboximpl()     // Catch:{ all -> 0x00bd }
            monitor-exit(r8)
            return r9
        L_0x006b:
        ...
        L_0x007f:
            ...
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r11 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m5377boximpl(r11)     // Catch:{ all -> 0x0095 }
        ...
        L_0x0097:
            ...
            androidx.compose.ui.text.caches.SimpleArrayMap<androidx.compose.ui.text.font.AsyncTypefaceCache$Key, androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult> r10 = r2.permanentCache     // Catch:{ all -> 0x0095 }
            java.lang.Object r6 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m5378constructorimpl(r11)     // Catch:{ all -> 0x0095 }
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r6 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m5377boximpl(r6)     // Catch:{ all -> 0x0095 }
    ...
    public final Object runCachedBlocking(Font font, PlatformFontLoader platformFontLoader, Function0<? extends Object> block) {
        ...
        synchronized (this.cacheLock) {
            try {
                ...
                if (priorResult != null) {
                    Object r4 = priorResult.m5384unboximpl();
