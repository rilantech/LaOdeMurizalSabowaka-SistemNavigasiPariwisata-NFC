...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            result = this.platformTypefaceResolver.m5449createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m5475getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            result = this.platformTypefaceResolver.m5450createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m5475getFontStyle_LCdwA());
            ...
            result = ((AndroidTypeface) typeface).m5579getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m5475getFontStyle_LCdwA(), typefaceRequest.m5476getFontSynthesisGVVA2EU());
        }
