...
public final class FontVariation {
    ...
    private static final class SettingTextUnit implements Setting {
        ...
        public final long m5446getValueXSAIIZE() {
            return this.value;
        }

        public float toVariationValue(Density density) {
            if (density != null) {
                return TextUnit.m6025getValueimpl(this.value) * density.getFontScale();
            }
        ...
        public boolean equals(Object other) {
            ...
            if ((other instanceof SettingTextUnit) && Intrinsics.areEqual((Object) getAxisName(), (Object) ((SettingTextUnit) other).getAxisName()) && TextUnit.m6022equalsimpl0(this.value, ((SettingTextUnit) other).value)) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (getAxisName().hashCode() * 31) + TextUnit.m6026hashCodeimpl(this.value);
        }

        public String toString() {
            return "FontVariation.Setting(axisName='" + getAxisName() + "', value=" + TextUnit.m6032toStringimpl(this.value) + ')';
        }
    }
    ...
    public final Setting m5445opticalSizingR2X_6o(long textSize) {
        if (TextUnit.m6028isSpimpl(textSize)) {
    ...
    public final Settings m5444Settings6EWAqTQ(FontWeight weight, int style, Setting... settings) {
