...
public final class FontSynthesis_androidKt {
    ...
    public static final Object m5443synthesizeTypefaceFxwP2eA(int $this$synthesizeTypeface_u2dFxwP2eA, Object typeface, Font font, FontWeight requestedWeight, int requestedStyle) {
        int finalFontWeight;
        ...
        boolean synthesizeWeight = FontSynthesis.m5436isWeightOnimpl$ui_text_release($this$synthesizeTypeface_u2dFxwP2eA) && !Intrinsics.areEqual((Object) font.getWeight(), (Object) requestedWeight) && requestedWeight.compareTo(AndroidFontUtils_androidKt.getAndroidBold(FontWeight.Companion)) >= 0 && font.getWeight().compareTo(AndroidFontUtils_androidKt.getAndroidBold(FontWeight.Companion)) < 0;
        if (!FontSynthesis.m5435isStyleOnimpl$ui_text_release($this$synthesizeTypeface_u2dFxwP2eA) || FontStyle.m5424equalsimpl0(requestedStyle, font.m5396getStyle_LCdwA())) {
        ...
        if (synthesizeStyle) {
            finalFontStyle = FontStyle.m5424equalsimpl0(requestedStyle, FontStyle.Companion.m5428getItalic_LCdwA());
        } else {
            finalFontStyle = FontStyle.m5424equalsimpl0(font.m5396getStyle_LCdwA(), FontStyle.Companion.m5428getItalic_LCdwA());
        }
