...
public final class GenericFontFamily extends SystemFontFamily {
    ...
    public GenericFontFamily(String name2, String fontFamilyName2) {
        super((DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(name2, HintConstants.AUTOFILL_HINT_NAME);
        Intrinsics.checkNotNullParameter(fontFamilyName2, "fontFamilyName");
        this.name = name2;
        this.fontFamilyName = fontFamilyName2;
    }
