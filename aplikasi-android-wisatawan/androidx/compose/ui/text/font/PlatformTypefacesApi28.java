...
final class PlatformTypefacesApi28 implements PlatformTypefaces {
    ...
    public Typeface m5463optionalOnDeviceFontFamilyByName78DK7lM(String familyName, FontWeight weight, int style, FontVariation.Settings variationSettings, Context context) {
        Typeface result;
        ...
        if (Intrinsics.areEqual((Object) familyName, (Object) FontFamily.Companion.getSansSerif().getName())) {
            result = m5462createNamedRetOiIg(FontFamily.Companion.getSansSerif(), weight, style);
        } else if (Intrinsics.areEqual((Object) familyName, (Object) FontFamily.Companion.getSerif().getName())) {
            result = m5462createNamedRetOiIg(FontFamily.Companion.getSerif(), weight, style);
        } else if (Intrinsics.areEqual((Object) familyName, (Object) FontFamily.Companion.getMonospace().getName())) {
            result = m5462createNamedRetOiIg(FontFamily.Companion.getMonospace(), weight, style);
        } else if (Intrinsics.areEqual((Object) familyName, (Object) FontFamily.Companion.getCursive().getName())) {
            result = m5462createNamedRetOiIg(FontFamily.Companion.getCursive(), weight, style);
        } else {
            result = m5460loadNamedFromTypefaceCacheOrNullRetOiIg(familyName, weight, style);
        }
        return PlatformTypefacesKt.setFontVariationSettings(result, variationSettings, context);
    }

    /* renamed from: createDefault-FO1MlWM  reason: not valid java name */
    public Typeface m5461createDefaultFO1MlWM(FontWeight fontWeight, int fontStyle) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return m5458createAndroidTypefaceApi28RetOiIg((String) null, fontWeight, fontStyle);
    }

    /* renamed from: createNamed-RetOiIg  reason: not valid java name */
    public Typeface m5462createNamedRetOiIg(GenericFontFamily name, FontWeight fontWeight, int fontStyle) {
        Intrinsics.checkNotNullParameter(name, HintConstants.AUTOFILL_HINT_NAME);
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return m5458createAndroidTypefaceApi28RetOiIg(name.getName(), fontWeight, fontStyle);
    }

    /* renamed from: loadNamedFromTypefaceCacheOrNull-RetOiIg  reason: not valid java name */
    private final Typeface m5460loadNamedFromTypefaceCacheOrNullRetOiIg(String familyName, FontWeight weight, int style) {
        boolean z = true;
        if (familyName.length() == 0) {
            return null;
        }
        Typeface typeface = m5458createAndroidTypefaceApi28RetOiIg(familyName, weight, style);
        boolean isItalic = FontStyle.m5424equalsimpl0(style, FontStyle.Companion.m5428getItalic_LCdwA());
        Typeface it = typeface;
        TypefaceHelperMethodsApi28 typefaceHelperMethodsApi28 = TypefaceHelperMethodsApi28.INSTANCE;
        Typeface typeface2 = Typeface.DEFAULT;
        Intrinsics.checkNotNullExpressionValue(typeface2, "DEFAULT");
        if (Intrinsics.areEqual((Object) it, (Object) typefaceHelperMethodsApi28.create(typeface2, weight.getWeight(), isItalic)) || Intrinsics.areEqual((Object) it, (Object) m5458createAndroidTypefaceApi28RetOiIg((String) null, weight, style))) {
            z = false;
        }
        if (z) {
            return typeface;
    ...
    static /* synthetic */ Typeface m5459createAndroidTypefaceApi28RetOiIg$default(PlatformTypefacesApi28 platformTypefacesApi28, String str, FontWeight fontWeight, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = null;
        }
        return platformTypefacesApi28.m5458createAndroidTypefaceApi28RetOiIg(str, fontWeight, i);
    }

    /* renamed from: createAndroidTypefaceApi28-RetOiIg  reason: not valid java name */
    private final Typeface m5458createAndroidTypefaceApi28RetOiIg(String genericFontFamily, FontWeight fontWeight, int fontStyle) {
        ...
        Typeface create = Typeface.create(familyTypeface, fontWeight.getWeight(), FontStyle.m5424equalsimpl0(fontStyle, FontStyle.Companion.m5428getItalic_LCdwA()));
