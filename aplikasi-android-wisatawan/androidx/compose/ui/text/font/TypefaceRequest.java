...
public final class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m5471copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily2, FontWeight fontWeight2, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        return typefaceRequest.m5474copye1PVR60(fontFamily2, fontWeight3, i4, i5, obj);
    }
    ...
    public final int m5472component3_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: component4-GVVA2EU  reason: not valid java name */
    public final int m5473component4GVVA2EU() {
    ...
    public final TypefaceRequest m5474copye1PVR60(FontFamily fontFamily2, FontWeight fontWeight2, int i, int i2, Object obj) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.fontFamily, (Object) typefaceRequest.fontFamily) && Intrinsics.areEqual((Object) this.fontWeight, (Object) typefaceRequest.fontWeight) && FontStyle.m5424equalsimpl0(this.fontStyle, typefaceRequest.fontStyle) && FontSynthesis.m5433equalsimpl0(this.fontSynthesis, typefaceRequest.fontSynthesis) && Intrinsics.areEqual(this.resourceLoaderCacheKey, typefaceRequest.resourceLoaderCacheKey);
    }

    public int hashCode() {
        FontFamily fontFamily2 = this.fontFamily;
        int i = 0;
        int hashCode = (((((((fontFamily2 == null ? 0 : fontFamily2.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m5425hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m5434hashCodeimpl(this.fontSynthesis)) * 31;
    ...
    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + FontStyle.m5426toStringimpl(this.fontStyle) + ", fontSynthesis=" + FontSynthesis.m5437toStringimpl(this.fontSynthesis) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }

    private TypefaceRequest(FontFamily fontFamily2, FontWeight fontWeight2, int fontStyle2, int fontSynthesis2, Object resourceLoaderCacheKey2) {
        Intrinsics.checkNotNullParameter(fontWeight2, "fontWeight");
        this.fontFamily = fontFamily2;
        this.fontWeight = fontWeight2;
        this.fontStyle = fontStyle2;
        this.fontSynthesis = fontSynthesis2;
        this.resourceLoaderCacheKey = resourceLoaderCacheKey2;
    }
    ...
    public final int m5475getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: getFontSynthesis-GVVA2EU  reason: not valid java name */
    public final int m5476getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
