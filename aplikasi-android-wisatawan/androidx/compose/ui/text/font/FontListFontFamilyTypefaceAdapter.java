...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily family, PlatformFontLoader resourceLoader, Continuation<? super Unit> $completion) {
        ...
        while (index$iv$iv < size) {
            ...
            if (FontLoadingStrategy.m5411equalsimpl0(((Font) it$iv).m5395getLoadingStrategyPKNRLFQ(), FontLoadingStrategy.Companion.m5415getAsyncPKNRLFQ())) {
                target$iv.add(it$iv);
            }
            index$iv$iv++;
        ...
        while (index$iv$iv2 < size2) {
            ...
            target$iv2.add(TuplesKt.to(it.getWeight(), FontStyle.m5421boximpl(it.m5396getStyle_LCdwA())));
            index$iv$iv2++;
        ...
        while (index$iv < size4) {
            ...
            int fontStyle = ((FontStyle) pair.component2()).m5427unboximpl();
            int i3 = fontStyle;
            FontWeight fontWeight2 = fontWeight;
            int index$iv2 = index$iv;
            List asyncFontsToLoad = (List) FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m5420matchFontRetOiIg((List<? extends Font>) allFonts, fontWeight, fontStyle), new TypefaceRequest(family, fontWeight, fontStyle, FontSynthesis.Companion.m5439getAllGVVA2EU(), resourceLoader.getCacheKey(), (DefaultConstructorMarker) null), this.asyncTypefaceCache, platformFontLoader, FontListFontFamilyTypefaceAdapter$preload$2$1.INSTANCE).component1();
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        Pair access$firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m5420matchFontRetOiIg((List<? extends Font>) ((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m5475getFontStyle_LCdwA()), typefaceRequest2, this.asyncTypefaceCache, platformFontLoader2, function1);
