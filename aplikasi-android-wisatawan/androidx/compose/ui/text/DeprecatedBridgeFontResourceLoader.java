...
final class DeprecatedBridgeFontResourceLoader implements Font.ResourceLoader {
    ...
    private DeprecatedBridgeFontResourceLoader(FontFamily.Resolver fontFamilyResolver2) {
    ...
    public Object load(Font font) {
        ...
        return FontFamily.Resolver.m5397resolveDPcqOEQ$default(this.fontFamilyResolver, FontKt.toFontFamily(font), font.getWeight(), font.m5396getStyle_LCdwA(), 0, 8, (Object) null).getValue();
    }
    ...
    public static final class Companion {
        ...
        public final Font.ResourceLoader from(FontFamily.Resolver fontFamilyResolver) {
            ...
            synchronized (getLock()) {
                Font.ResourceLoader resourceLoader = DeprecatedBridgeFontResourceLoader.Companion.getCache().get(fontFamilyResolver);
                if (resourceLoader != null) {
                    return resourceLoader;
                }
                DeprecatedBridgeFontResourceLoader deprecatedBridgeFontResourceLoader = new DeprecatedBridgeFontResourceLoader(fontFamilyResolver, (DefaultConstructorMarker) null);
