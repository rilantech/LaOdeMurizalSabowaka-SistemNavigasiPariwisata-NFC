...
public final class TextRangeKt {
    ...
    public static final String m5332substringFDrldGo(CharSequence $this$substring_u2dFDrldGo, long range) {
        Intrinsics.checkNotNullParameter($this$substring_u2dFDrldGo, "$this$substring");
        return $this$substring_u2dFDrldGo.subSequence(TextRange.m5323getMinimpl(range), TextRange.m5322getMaximpl(range)).toString();
    }

    public static final long TextRange(int start, int end) {
        return TextRange.m5314constructorimpl(packWithCheck(start, end));
    }
    ...
    public static final long m5331coerceIn8ffj60Q(long $this$coerceIn_u2d8ffj60Q, int minimumValue, int maximumValue) {
        int newStart = RangesKt.coerceIn(TextRange.m5325getStartimpl($this$coerceIn_u2d8ffj60Q), minimumValue, maximumValue);
        int newEnd = RangesKt.coerceIn(TextRange.m5320getEndimpl($this$coerceIn_u2d8ffj60Q), minimumValue, maximumValue);
        if (newStart == TextRange.m5325getStartimpl($this$coerceIn_u2d8ffj60Q) && newEnd == TextRange.m5320getEndimpl($this$coerceIn_u2d8ffj60Q)) {
