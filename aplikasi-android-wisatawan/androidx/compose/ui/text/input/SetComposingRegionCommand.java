...
public final class SetComposingRegionCommand implements EditCommand {
    ...
    public SetComposingRegionCommand(int start2, int end2) {
        this.start = start2;
        this.end = end2;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SetComposingRegionCommand) && this.start == ((SetComposingRegionCommand) other).start && this.end == ((SetComposingRegionCommand) other).end) {
            return true;
        }
        return false;
    }
