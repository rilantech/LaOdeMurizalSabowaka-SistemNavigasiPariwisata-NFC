...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString text, long selection) {
        ...
        this.selectionStart = TextRange.m5323getMinimpl(selection);
        this.selectionEnd = TextRange.m5322getMaximpl(selection);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int start = TextRange.m5323getMinimpl(selection);
        int end = TextRange.m5322getMaximpl(selection);
    ...
    public final TextRange m5477getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m5313boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* renamed from: getSelection-d9O1mEE$ui_text_release  reason: not valid java name */
    public final long m5478getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int start, int end) {
        ...
        long newSelection = EditingBufferKt.m5479updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), deleteRange);
        setSelectionStart(TextRange.m5323getMinimpl(newSelection));
        setSelectionEnd(TextRange.m5322getMaximpl(newSelection));
        if (hasComposition$ui_text_release()) {
            long newComposition = EditingBufferKt.m5479updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd), deleteRange);
            if (TextRange.m5319getCollapsedimpl(newComposition)) {
                commitComposition$ui_text_release();
                return;
            }
            this.compositionStart = TextRange.m5323getMinimpl(newComposition);
            this.compositionEnd = TextRange.m5322getMaximpl(newComposition);
        }
    }
