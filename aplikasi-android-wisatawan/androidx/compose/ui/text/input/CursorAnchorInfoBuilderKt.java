...
public final class CursorAnchorInfoBuilderKt {
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder $this$build, TextFieldValue textFieldValue, TextLayoutResult textLayoutResult, Matrix matrix) {
        ...
        int selectionStart = TextRange.m5323getMinimpl(textFieldValue.m5555getSelectiond9O1mEE());
        $this$build.setSelectionRange(selectionStart, TextRange.m5322getMaximpl(textFieldValue.m5555getSelectiond9O1mEE()));
        setInsertionMarker($this$build, selectionStart, textLayoutResult);
        TextRange r2 = textFieldValue.m5554getCompositionMzsxiRA();
        int compositionEnd = -1;
        int compositionStart = r2 != null ? TextRange.m5323getMinimpl(r2.m5329unboximpl()) : -1;
        TextRange r4 = textFieldValue.m5554getCompositionMzsxiRA();
        if (r4 != null) {
            compositionEnd = TextRange.m5322getMaximpl(r4.m5329unboximpl());
        }
        boolean z = false;
