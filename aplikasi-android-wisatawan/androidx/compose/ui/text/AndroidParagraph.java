...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(androidx.compose.ui.text.platform.AndroidParagraphIntrinsics r34, int r35, boolean r36, long r37) {
        /*
            ...
            r10 = r37
            r13.constraints = r10
            int r0 = androidx.compose.ui.unit.Constraints.m5789getMinHeightimpl(r37)
            r9 = 0
            r8 = 1
            if (r0 != 0) goto L_0x002c
            int r0 = androidx.compose.ui.unit.Constraints.m5790getMinWidthimpl(r37)
            if (r0 != 0) goto L_0x002c
            r0 = r8
            goto L_0x002d
        L_0x002c:
        ...
        L_0x004d:
            r13.charSequence = r0
            androidx.compose.ui.text.style.TextAlign r0 = r7.m5354getTextAlignbuA522U()
            int r16 = androidx.compose.ui.text.AndroidParagraph_androidKt.m5190toLayoutAlignAMY3VfE(r0)
            androidx.compose.ui.text.style.TextAlign r0 = r7.m5354getTextAlignbuA522U()
            androidx.compose.ui.text.style.TextAlign$Companion r1 = androidx.compose.ui.text.style.TextAlign.Companion
            int r1 = r1.m5709getJustifye0LSkKk()
            if (r0 != 0) goto L_0x0065
            r0 = r9
            goto L_0x006d
        L_0x0065:
            int r0 = r0.m5706unboximpl()
            boolean r0 = androidx.compose.ui.text.style.TextAlign.m5703equalsimpl0(r0, r1)
        L_0x006d:
        ...
        L_0x0072:
            ...
            androidx.compose.ui.text.style.Hyphens r0 = r0.m5235getHyphensEaSxIns()
            int r17 = androidx.compose.ui.text.AndroidParagraph_androidKt.m5192toLayoutHyphenationFrequency0_XeFpE(r0)
            androidx.compose.ui.text.style.LineBreak r0 = r7.m5352getLineBreakLgCVezo()
            r18 = 0
            if (r0 == 0) goto L_0x0094
            int r0 = r0.m5640unboximpl()
            int r0 = androidx.compose.ui.text.style.LineBreak.m5635getStrategyfcGXIks(r0)
            androidx.compose.ui.text.style.LineBreak$Strategy r0 = androidx.compose.ui.text.style.LineBreak.Strategy.m5644boximpl(r0)
            goto L_0x0096
        L_0x0094:
            r0 = r18
        L_0x0096:
            int r19 = androidx.compose.ui.text.AndroidParagraph_androidKt.m5191toLayoutBreakStrategyu6PBz3U(r0)
            androidx.compose.ui.text.style.LineBreak r0 = r7.m5352getLineBreakLgCVezo()
            if (r0 == 0) goto L_0x00ad
            int r0 = r0.m5640unboximpl()
            int r0 = androidx.compose.ui.text.style.LineBreak.m5636getStrictnessusljTpc(r0)
            androidx.compose.ui.text.style.LineBreak$Strictness r0 = androidx.compose.ui.text.style.LineBreak.Strictness.m5654boximpl(r0)
            goto L_0x00af
        L_0x00ad:
            r0 = r18
        L_0x00af:
            int r20 = androidx.compose.ui.text.AndroidParagraph_androidKt.m5193toLayoutLineBreakStyle4a2g8L8(r0)
            androidx.compose.ui.text.style.LineBreak r0 = r7.m5352getLineBreakLgCVezo()
            if (r0 == 0) goto L_0x00c6
            int r0 = r0.m5640unboximpl()
            int r0 = androidx.compose.ui.text.style.LineBreak.m5637getWordBreakjp8hJ3c(r0)
            androidx.compose.ui.text.style.LineBreak$WordBreak r0 = androidx.compose.ui.text.style.LineBreak.WordBreak.m5665boximpl(r0)
            goto L_0x00c8
        L_0x00c6:
            r0 = r18
        L_0x00c8:
            int r21 = androidx.compose.ui.text.AndroidParagraph_androidKt.m5194toLayoutLineBreakWordStylegvcdTPQ(r0)
        ...
        L_0x00d4:
            ...
            int r1 = r0.getHeight()
            int r4 = androidx.compose.ui.unit.Constraints.m5787getMaxHeightimpl(r37)
            if (r1 <= r4) goto L_0x0133
            if (r15 <= r14) goto L_0x0133
            int r1 = androidx.compose.ui.unit.Constraints.m5787getMaxHeightimpl(r37)
        ...
        L_0x0136:
            ...
            r1.m5577setBrush12SF9DM(r4, r5, r7)
    ...
    public final long m5179getConstraintsmsEJaDk() {
    ...
    public float getWidth() {
        return (float) Constraints.m5788getMaxWidthimpl(this.constraints);
    }
    ...
    public int m5180getOffsetForPositionk4lQ0M(long position) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m3004getYimpl(position)), Offset.m3003getXimpl(position));
    }
    ...
    public final void m5178fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        Intrinsics.checkNotNullParameter(array, "array");
        this.layout.fillBoundingBoxes(TextRange.m5323getMinimpl(range), TextRange.m5322getMaximpl(range), array, arrayStart);
    }
    ...
    public long m5181getWordBoundaryjx7JFs(int offset) {
    ...
    public void m5183paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        AndroidTextPaint $this$paint_RPmYEkk_u24lambda_u248 = getTextPaint$ui_text_release();
        $this$paint_RPmYEkk_u24lambda_u248.m5578setColor8_81llA(color);
    ...
    public void m5182paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int currBlendMode = getTextPaint$ui_text_release().m5575getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_LG529CI_u24lambda_u249 = getTextPaint$ui_text_release();
        $this$paint_LG529CI_u24lambda_u249.m5578setColor8_81llA(color);
        ...
        $this$paint_LG529CI_u24lambda_u249.m5576setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m5576setBlendModes9anfk8(currBlendMode);
    }

    /* renamed from: paint-hn5TExg  reason: not valid java name */
    public void m5184painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        int currBlendMode = getTextPaint$ui_text_release().m5575getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_hn5TExg_u24lambda_u2410 = getTextPaint$ui_text_release();
        $this$paint_hn5TExg_u24lambda_u2410.m5577setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        ...
        $this$paint_hn5TExg_u24lambda_u2410.m5576setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m5576setBlendModes9anfk8(currBlendMode);
    }
