...
public final class TextIndent {
    ...
    public final long m5731getFirstLineXSAIIZE() {
        return this.firstLine;
    }

    /* renamed from: getRestLine-XSAIIZE  reason: not valid java name */
    public final long m5732getRestLineXSAIIZE() {
    ...
    public static /* synthetic */ TextIndent m5729copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m5730copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo  reason: not valid java name */
    public final TextIndent m5730copyNB67dxo(long firstLine2, long restLine2) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TextIndent) && TextUnit.m6022equalsimpl0(this.firstLine, ((TextIndent) other).firstLine) && TextUnit.m6022equalsimpl0(this.restLine, ((TextIndent) other).restLine)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (TextUnit.m6026hashCodeimpl(this.firstLine) * 31) + TextUnit.m6026hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + TextUnit.m6032toStringimpl(this.firstLine) + ", restLine=" + TextUnit.m6032toStringimpl(this.restLine) + ')';
    }
}
