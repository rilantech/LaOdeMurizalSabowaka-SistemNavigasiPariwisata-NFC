...
final class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m5614copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m5616copy8_81llA(j);
    }

    /* renamed from: component1-0d7_KjU  reason: not valid java name */
    public final long m5615component10d7_KjU() {
        return this.value;
    }

    /* renamed from: copy-8_81llA  reason: not valid java name */
    public final ColorStyle m5616copy8_81llA(long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ColorStyle) && Color.m3254equalsimpl0(this.value, ((ColorStyle) obj).value);
    }

    public int hashCode() {
        return Color.m3260hashCodeimpl(this.value);
    }

    public String toString() {
        return "ColorStyle(value=" + Color.m3261toStringimpl(this.value) + ')';
    }

    private ColorStyle(long value2) {
        this.value = value2;
        if (!(this.value != Color.Companion.m3289getUnspecified0d7_KjU())) {
            throw new IllegalArgumentException("ColorStyle value must be specified, use TextForegroundStyle.Unspecified instead.".toString());
        }
    }

    /* renamed from: getValue-0d7_KjU  reason: not valid java name */
    public final long m5618getValue0d7_KjU() {
        return this.value;
    }

    /* renamed from: getColor-0d7_KjU  reason: not valid java name */
    public long m5617getColor0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.m3255getAlphaimpl(m5617getColor0d7_KjU());
    }
}
