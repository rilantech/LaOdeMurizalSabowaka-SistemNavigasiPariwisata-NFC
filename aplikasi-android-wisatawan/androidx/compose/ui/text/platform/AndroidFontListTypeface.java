...
public final class AndroidFontListTypeface implements AndroidTypeface {
    ...
    public AndroidFontListTypeface(androidx.compose.ui.text.font.FontListFontFamily r20, android.content.Context r21, java.util.List<kotlin.Pair<androidx.compose.ui.text.font.FontWeight, androidx.compose.ui.text.font.FontStyle>> r22, androidx.compose.ui.text.font.FontMatcher r23) {
        ...
        L_0x0034:
            ...
            r15 = 0
            r16 = r0
            int r0 = r14.m5395getLoadingStrategyPKNRLFQ()
            ...
            int r4 = r17.m5416getBlockingPKNRLFQ()
            boolean r0 = androidx.compose.ui.text.font.FontLoadingStrategy.m5411equalsimpl0(r0, r4)
        ...
        L_0x007f:
            ...
            int r15 = r15.m5427unboximpl()
            r17 = r5
            androidx.compose.ui.text.font.FontMatcher r5 = r1.fontMatcher$1
            java.util.List r5 = r5.m5420matchFontRetOiIg((java.util.List<? extends androidx.compose.ui.text.font.Font>) r4, (androidx.compose.ui.text.font.FontWeight) r0, (int) r15)
    ...
    public Typeface m5562getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        Font font = (Font) CollectionsKt.firstOrNull(this.fontMatcher$1.m5420matchFontRetOiIg((List<? extends Font>) new ArrayList(this.loadedTypefaces.keySet()), fontWeight, fontStyle));
        if (font != null) {
            Typeface typeface = this.loadedTypefaces.get(font);
            if (typeface != null) {
                Object r2 = FontSynthesis_androidKt.m5443synthesizeTypefaceFxwP2eA(synthesis, typeface, font, fontWeight, fontStyle);
