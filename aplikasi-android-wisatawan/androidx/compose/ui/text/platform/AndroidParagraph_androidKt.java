...
public final class AndroidParagraph_androidKt {
    ...
    public static final Paragraph m5572ActualParagraphO3s9Psw(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, int maxLines, boolean ellipsis, long constraints, Density density, FontFamily.Resolver fontFamilyResolver) {
        String str = text;
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(spanStyles, "spanStyles");
    ...
    public static final Paragraph m5571ActualParagraphhBUhpc(ParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {
