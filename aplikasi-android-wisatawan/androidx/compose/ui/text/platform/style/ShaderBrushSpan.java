...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public final long m5597getSizeNHjbRc() {
        return this.size;
    }

    /* renamed from: setSize-uvyYCjk  reason: not valid java name */
    public final void m5598setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public void updateDrawState(TextPaint textPaint) {
        ...
        if (!(this.size == Size.Companion.m3080getUnspecifiedNHjbRc())) {
            Pair finalCachedShader = this.cachedShader;
            if (finalCachedShader == null || !Size.m3068equalsimpl0(finalCachedShader.getFirst().m3077unboximpl(), this.size)) {
                shader = this.shaderBrush.m3597createShaderuvyYCjk(this.size);
            } else {
                shader = (Shader) finalCachedShader.getSecond();
            }
            textPaint.setShader(shader);
            this.cachedShader = TuplesKt.to(Size.m3060boximpl(this.size), shader);
        }
    }
}
