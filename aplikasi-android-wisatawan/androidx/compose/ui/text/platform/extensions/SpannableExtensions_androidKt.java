...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable $this$setTextIndent, TextIndent textIndent, float contextFontSize, Density density) {
        ...
        if (textIndent != null) {
            ...
            if ((!TextUnit.m6022equalsimpl0(indent.m5731getFirstLineXSAIIZE(), TextUnitKt.getSp(0)) || !TextUnit.m6022equalsimpl0(indent.m5732getRestLineXSAIIZE(), TextUnitKt.getSp(0))) && !TextUnitKt.m6043isUnspecifiedR2X_6o(indent.m5731getFirstLineXSAIIZE()) && !TextUnitKt.m6043isUnspecifiedR2X_6o(indent.m5732getRestLineXSAIIZE())) {
                Density $this$setTextIndent_u24lambda_u241_u24lambda_u240 = density;
                long r5 = TextUnit.m6024getTypeUIouoOA(indent.m5731getFirstLineXSAIIZE());
                float restLine = 0.0f;
                if (TextUnitType.m6053equalsimpl0(r5, TextUnitType.Companion.m6058getSpUIouoOA())) {
                    firstLine = $this$setTextIndent_u24lambda_u241_u24lambda_u240.m5824toPxR2X_6o(indent.m5731getFirstLineXSAIIZE());
                } else if (TextUnitType.m6053equalsimpl0(r5, TextUnitType.Companion.m6057getEmUIouoOA())) {
                    firstLine = TextUnit.m6025getValueimpl(indent.m5731getFirstLineXSAIIZE()) * contextFontSize;
                } else {
                    firstLine = 0.0f;
                }
                long r6 = TextUnit.m6024getTypeUIouoOA(indent.m5732getRestLineXSAIIZE());
                if (TextUnitType.m6053equalsimpl0(r6, TextUnitType.Companion.m6058getSpUIouoOA())) {
                    restLine = $this$setTextIndent_u24lambda_u241_u24lambda_u240.m5824toPxR2X_6o(indent.m5732getRestLineXSAIIZE());
                } else if (TextUnitType.m6053equalsimpl0(r6, TextUnitType.Companion.m6057getEmUIouoOA())) {
                    restLine = TextUnit.m6025getValueimpl(indent.m5732getRestLineXSAIIZE()) * contextFontSize;
                }
    ...
    public static final void m5592setLineHeightKmRG4DE(Spannable $this$setLineHeight_u2dKmRG4DE, long lineHeight, float contextFontSize, Density density, LineHeightStyle lineHeightStyle) {
        Intrinsics.checkNotNullParameter($this$setLineHeight_u2dKmRG4DE, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(lineHeightStyle, "lineHeightStyle");
        float resolvedLineHeight = m5587resolveLineHeightInPxo2QH7mI(lineHeight, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
            setSpan($this$setLineHeight_u2dKmRG4DE, new LineHeightStyleSpan(resolvedLineHeight, 0, (($this$setLineHeight_u2dKmRG4DE.length() == 0) || StringsKt.last($this$setLineHeight_u2dKmRG4DE) == 10) ? $this$setLineHeight_u2dKmRG4DE.length() + 1 : $this$setLineHeight_u2dKmRG4DE.length(), LineHeightStyle.Trim.m5692isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.m5675getTrimEVpEnUU()), LineHeightStyle.Trim.m5693isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.m5675getTrimEVpEnUU()), lineHeightStyle.m5674getAlignmentPIaL0Z0()), 0, $this$setLineHeight_u2dKmRG4DE.length());
        }
    }

    /* renamed from: setLineHeight-r9BaKPg  reason: not valid java name */
    public static final void m5593setLineHeightr9BaKPg(Spannable $this$setLineHeight_u2dr9BaKPg, long lineHeight, float contextFontSize, Density density) {
    ...
    private static final float m5587resolveLineHeightInPxo2QH7mI(long lineHeight, float contextFontSize, Density density) {
        long r0 = TextUnit.m6024getTypeUIouoOA(lineHeight);
        if (TextUnitType.m6053equalsimpl0(r0, TextUnitType.Companion.m6058getSpUIouoOA())) {
            return density.m5824toPxR2X_6o(lineHeight);
        }
        if (TextUnitType.m6053equalsimpl0(r0, TextUnitType.Companion.m6057getEmUIouoOA())) {
            return TextUnit.m6025getValueimpl(lineHeight) * contextFontSize;
        }
        return Float.NaN;
    }
    ...
    public static final void setSpanStyles(Spannable $this$setSpanStyles, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface) {
        ...
        if (hasLetterSpacing) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < $this$setSpanStyles.length() && end2 > start2 && end2 <= $this$setSpanStyles.length() && (it = m5586createLetterSpacingSpaneAf_CNQ(style.m5288getLetterSpacingXSAIIZE(), density)) != null) {
    ...
    private static final void setSpanStyle(Spannable $this$setSpanStyle, AnnotatedString.Range<SpanStyle> spanStyleRange, Density density) {
        ...
        m5589setBaselineShift0ocSgnM($this$setSpanStyle, style.m5283getBaselineShift5SSeXJ0(), start, end);
        m5590setColorRPmYEkk($this$setSpanStyle, style.m5284getColor0d7_KjU(), start, end);
        ...
        m5591setFontSizeKmRG4DE($this$setSpanStyle, style.m5285getFontSizeXSAIIZE(), density, start, end);
        ...
        m5588setBackgroundRPmYEkk($this$setSpanStyle, style.m5282getBackground0d7_KjU(), start, end);
    ...
    private static final void setFontAttributes(Spannable $this$setFontAttributes, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface) {
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            if (TextPaintExtensions_androidKt.hasFontAttributes((SpanStyle) it.getItem()) || ((SpanStyle) it.getItem()).m5287getFontSynthesisZQGJjVo() != null) {
                target$iv.add(it$iv);
            }
        }
        List fontRelatedSpanStyles = target$iv;
        if (hasFontAttributes(contextTextStyle)) {
            contextFontSpanStyle = new SpanStyle(0, 0, contextTextStyle.getFontWeight(), contextTextStyle.m5348getFontStyle4Lr2A7w(), contextTextStyle.m5349getFontSynthesisZQGJjVo(), contextTextStyle.getFontFamily(), (String) null, 0, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null);
        } else {
    ...
    private static final MetricAffectingSpan m5586createLetterSpacingSpaneAf_CNQ(long letterSpacing, Density density) {
        long r0 = TextUnit.m6024getTypeUIouoOA(letterSpacing);
        if (TextUnitType.m6053equalsimpl0(r0, TextUnitType.Companion.m6058getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.m5824toPxR2X_6o(letterSpacing));
        }
        if (TextUnitType.m6053equalsimpl0(r0, TextUnitType.Companion.m6057getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m6025getValueimpl(letterSpacing));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle $this$needsLetterSpacingSpan) {
        return TextUnitType.m6053equalsimpl0(TextUnit.m6024getTypeUIouoOA($this$needsLetterSpacingSpan.m5288getLetterSpacingXSAIIZE()), TextUnitType.Companion.m6058getSpUIouoOA()) || TextUnitType.m6053equalsimpl0(TextUnit.m6024getTypeUIouoOA($this$needsLetterSpacingSpan.m5288getLetterSpacingXSAIIZE()), TextUnitType.Companion.m6057getEmUIouoOA());
    }

    private static final void setShadow(Spannable $this$setShadow, Shadow shadow, int start, int end) {
        if (shadow != null) {
            Shadow it = shadow;
            setSpan($this$setShadow, new ShadowSpan(ColorKt.m3307toArgb8_81llA(it.m3610getColor0d7_KjU()), Offset.m3003getXimpl(it.m3611getOffsetF1C5BW0()), Offset.m3004getYimpl(it.m3611getOffsetF1C5BW0()), TextPaintExtensions_androidKt.correctBlurRadius(it.getBlurRadius())), start, end);
        }
    }
    ...
    public static final void m5588setBackgroundRPmYEkk(Spannable $this$setBackground_u2dRPmYEkk, long color, int start, int end) {
        ...
        if (color != Color.Companion.m3289getUnspecified0d7_KjU()) {
            setSpan($this$setBackground_u2dRPmYEkk, new BackgroundColorSpan(ColorKt.m3307toArgb8_81llA(color)), start, end);
        }
    }
    ...
    public static final void m5591setFontSizeKmRG4DE(Spannable $this$setFontSize_u2dKmRG4DE, long fontSize, Density density, int start, int end) {
        Intrinsics.checkNotNullParameter($this$setFontSize_u2dKmRG4DE, "$this$setFontSize");
        Intrinsics.checkNotNullParameter(density, "density");
        long r0 = TextUnit.m6024getTypeUIouoOA(fontSize);
        if (TextUnitType.m6053equalsimpl0(r0, TextUnitType.Companion.m6058getSpUIouoOA())) {
            setSpan($this$setFontSize_u2dKmRG4DE, new AbsoluteSizeSpan(MathKt.roundToInt(density.m5824toPxR2X_6o(fontSize)), false), start, end);
        } else if (TextUnitType.m6053equalsimpl0(r0, TextUnitType.Companion.m6057getEmUIouoOA())) {
            setSpan($this$setFontSize_u2dKmRG4DE, new RelativeSizeSpan(TextUnit.m6025getValueimpl(fontSize)), start, end);
        }
    }
    ...
    public static final void m5590setColorRPmYEkk(Spannable $this$setColor_u2dRPmYEkk, long color, int start, int end) {
        Intrinsics.checkNotNullParameter($this$setColor_u2dRPmYEkk, "$this$setColor");
        if (color != Color.Companion.m3289getUnspecified0d7_KjU()) {
            setSpan($this$setColor_u2dRPmYEkk, new ForegroundColorSpan(ColorKt.m3307toArgb8_81llA(color)), start, end);
        }
    }

    /* renamed from: setBaselineShift-0ocSgnM  reason: not valid java name */
    private static final void m5589setBaselineShift0ocSgnM(Spannable $this$setBaselineShift_u2d0ocSgnM, BaselineShift baselineShift, int start, int end) {
        if (baselineShift != null) {
            setSpan($this$setBaselineShift_u2d0ocSgnM, new BaselineShiftSpan(baselineShift.m5605unboximpl()), start, end);
        }
    }
    ...
    private static final void setBrush(Spannable $this$setBrush, Brush brush, float alpha, int start, int end) {
        if (brush != null) {
            ...
            if (brush instanceof SolidColor) {
                m5590setColorRPmYEkk($this$setBrush, ((SolidColor) brush).m3623getValue0d7_KjU(), start, end);
    ...
    private static final boolean hasFontAttributes(TextStyle $this$hasFontAttributes) {
        return TextPaintExtensions_androidKt.hasFontAttributes($this$hasFontAttributes.toSpanStyle()) || $this$hasFontAttributes.m5349getFontSynthesisZQGJjVo() != null;
    }
