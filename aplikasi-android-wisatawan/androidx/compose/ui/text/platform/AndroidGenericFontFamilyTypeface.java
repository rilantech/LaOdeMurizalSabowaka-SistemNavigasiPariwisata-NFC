...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    public Typeface m5564getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        Typeface r0 = m5563buildStyledTypefaceFO1MlWM(fontWeight, fontStyle);
    ...
    private final Typeface m5563buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int fontStyle) {
        return TypefaceHelperMethodsApi28.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m5424equalsimpl0(fontStyle, FontStyle.Companion.m5428getItalic_LCdwA()));
    }
}
