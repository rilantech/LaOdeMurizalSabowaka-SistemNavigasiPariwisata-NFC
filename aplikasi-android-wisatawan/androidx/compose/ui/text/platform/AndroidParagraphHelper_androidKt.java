...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String text, float contextFontSize, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface, boolean useEmojiCompat) {
        ...
        if (spanStyles.isEmpty() && placeholders.isEmpty() && Intrinsics.areEqual((Object) contextTextStyle.getTextIndent(), (Object) TextIndent.Companion.getNone()) && TextUnitKt.m6043isUnspecifiedR2X_6o(contextTextStyle.m5353getLineHeightXSAIIZE())) {
            return currentText;
        }
        ...
        if (!isIncludeFontPaddingEnabled(contextTextStyle) || contextTextStyle.getLineHeightStyle() != null) {
            ...
            SpannableExtensions_androidKt.m5592setLineHeightKmRG4DE(spannableString, contextTextStyle.m5353getLineHeightXSAIIZE(), contextFontSize, density, lineHeightStyle2);
        } else {
            SpannableExtensions_androidKt.m5593setLineHeightr9BaKPg(spannableString, contextTextStyle.m5353getLineHeightXSAIIZE(), contextFontSize, density);
        }
