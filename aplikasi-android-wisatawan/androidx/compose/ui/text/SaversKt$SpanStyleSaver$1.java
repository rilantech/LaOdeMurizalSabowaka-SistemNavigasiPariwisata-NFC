...
final class SaversKt$SpanStyleSaver$1 extends Lambda implements Function2<SaverScope, SpanStyle, Object> {
    ...
    public final Object invoke(SaverScope $this$Saver, SpanStyle it) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(Color.m3243boximpl(it.m5284getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), saverScope), SaversKt.save(TextUnit.m6015boximpl(it.m5285getFontSizeXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), saverScope), SaversKt.save(it.getFontWeight(), SaversKt.getSaver(FontWeight.Companion), saverScope), SaversKt.save(it.m5286getFontStyle4Lr2A7w()), SaversKt.save(it.m5287getFontSynthesisZQGJjVo()), SaversKt.save(-1), SaversKt.save(it.getFontFeatureSettings()), SaversKt.save(TextUnit.m6015boximpl(it.m5288getLetterSpacingXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), saverScope), SaversKt.save(it.m5283getBaselineShift5SSeXJ0(), SaversKt.getSaver(BaselineShift.Companion), saverScope), SaversKt.save(it.getTextGeometricTransform(), SaversKt.getSaver(TextGeometricTransform.Companion), saverScope), SaversKt.save(it.getLocaleList(), SaversKt.getSaver(LocaleList.Companion), saverScope), SaversKt.save(Color.m3243boximpl(it.m5282getBackground0d7_KjU()), SaversKt.getSaver(Color.Companion), saverScope), SaversKt.save(it.getTextDecoration(), SaversKt.getSaver(TextDecoration.Companion), saverScope), SaversKt.save(it.getShadow(), SaversKt.getSaver(Shadow.Companion), saverScope));
    }
}
