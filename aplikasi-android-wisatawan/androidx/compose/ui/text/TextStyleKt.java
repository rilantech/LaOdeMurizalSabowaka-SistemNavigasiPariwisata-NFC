...
public final class TextStyleKt {
    ...
    public static final int m5357resolveTextDirectionYj3eThk(LayoutDirection layoutDirection, TextDirection textDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (textDirection == null ? false : TextDirection.m5716equalsimpl0(textDirection.m5719unboximpl(), TextDirection.Companion.m5720getContents_7Xco())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.Companion.m5721getContentOrLtrs_7Xco();
                case 2:
                    return TextDirection.Companion.m5722getContentOrRtls_7Xco();
                default:
                    throw new NoWhenBranchMatchedException();
            }
        } else if (textDirection != null) {
            return textDirection.m5719unboximpl();
        } else {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.Companion.m5723getLtrs_7Xco();
                case 2:
                    return TextDirection.Companion.m5724getRtls_7Xco();
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }
