...
public final class SpanStyle {
    ...
    public /* synthetic */ SpanStyle(androidx.compose.ui.text.style.TextForegroundStyle r25, long r26, androidx.compose.ui.text.font.FontWeight r28, androidx.compose.ui.text.font.FontStyle r29, androidx.compose.ui.text.font.FontSynthesis r30, androidx.compose.ui.text.font.FontFamily r31, java.lang.String r32, long r33, androidx.compose.ui.text.style.BaselineShift r35, androidx.compose.ui.text.style.TextGeometricTransform r36, androidx.compose.ui.text.intl.LocaleList r37, long r38, androidx.compose.ui.text.style.TextDecoration r40, androidx.compose.ui.graphics.Shadow r41, androidx.compose.ui.text.PlatformSpanStyle r42, androidx.compose.ui.graphics.drawscope.DrawStyle r43, int r44, kotlin.jvm.internal.DefaultConstructorMarker r45) {
        ...
        L_0x0039:
            ...
            androidx.compose.ui.unit.TextUnit$Companion r1 = androidx.compose.ui.unit.TextUnit.Companion
            long r3 = r1.m6036getUnspecifiedXSAIIZE()
            r12 = r3
            goto L_0x0047
        L_0x0045:
            r12 = r33
        ...
        L_0x0060:
            ...
            long r3 = r1.m3289getUnspecified0d7_KjU()
            r17 = r3
            goto L_0x006f
        L_0x006d:
            r17 = r38
    ...
    public final long m5285getFontSizeXSAIIZE() {
    ...
    public final FontStyle m5286getFontStyle4Lr2A7w() {
        return this.fontStyle;
    }

    /* renamed from: getFontSynthesis-ZQGJjVo  reason: not valid java name */
    public final FontSynthesis m5287getFontSynthesisZQGJjVo() {
    ...
    public final long m5288getLetterSpacingXSAIIZE() {
        return this.letterSpacing;
    }

    /* renamed from: getBaselineShift-5SSeXJ0  reason: not valid java name */
    public final BaselineShift m5283getBaselineShift5SSeXJ0() {
    ...
    public final long m5282getBackground0d7_KjU() {
    ...
    private SpanStyle(long color, long fontSize2, FontWeight fontWeight2, FontStyle fontStyle2, FontSynthesis fontSynthesis2, FontFamily fontFamily2, String fontFeatureSettings2, long letterSpacing2, BaselineShift baselineShift2, TextGeometricTransform textGeometricTransform2, LocaleList localeList2, long background2, TextDecoration textDecoration2, Shadow shadow2) {
        this(TextForegroundStyle.Companion.m5727from8_81llA(color), fontSize2, fontWeight2, fontStyle2, fontSynthesis2, fontFamily2, fontFeatureSettings2, letterSpacing2, baselineShift2, textGeometricTransform2, localeList2, background2, textDecoration2, shadow2, (PlatformSpanStyle) null, (DrawStyle) null, 32768, (DefaultConstructorMarker) null);
    }
    ...
    private SpanStyle(long color, long fontSize2, FontWeight fontWeight2, FontStyle fontStyle2, FontSynthesis fontSynthesis2, FontFamily fontFamily2, String fontFeatureSettings2, long letterSpacing2, BaselineShift baselineShift2, TextGeometricTransform textGeometricTransform2, LocaleList localeList2, long background2, TextDecoration textDecoration2, Shadow shadow2, PlatformSpanStyle platformStyle2) {
        this(TextForegroundStyle.Companion.m5727from8_81llA(color), fontSize2, fontWeight2, fontStyle2, fontSynthesis2, fontFamily2, fontFeatureSettings2, letterSpacing2, baselineShift2, textGeometricTransform2, localeList2, background2, textDecoration2, shadow2, platformStyle2, (DrawStyle) null, 32768, (DefaultConstructorMarker) null);
    }
    ...
    private SpanStyle(long color, long fontSize2, FontWeight fontWeight2, FontStyle fontStyle2, FontSynthesis fontSynthesis2, FontFamily fontFamily2, String fontFeatureSettings2, long letterSpacing2, BaselineShift baselineShift2, TextGeometricTransform textGeometricTransform2, LocaleList localeList2, long background2, TextDecoration textDecoration2, Shadow shadow2, PlatformSpanStyle platformStyle2, DrawStyle drawStyle2) {
        this(TextForegroundStyle.Companion.m5727from8_81llA(color), fontSize2, fontWeight2, fontStyle2, fontSynthesis2, fontFamily2, fontFeatureSettings2, letterSpacing2, baselineShift2, textGeometricTransform2, localeList2, background2, textDecoration2, shadow2, platformStyle2, drawStyle2, (DefaultConstructorMarker) null);
    }
    ...
    public final long m5284getColor0d7_KjU() {
        return this.textForegroundStyle.m5726getColor0d7_KjU();
    }
    ...
    public static /* synthetic */ SpanStyle m5276copyIuqyXdg$default(SpanStyle spanStyle, long j, long j2, FontWeight fontWeight2, FontStyle fontStyle2, FontSynthesis fontSynthesis2, FontFamily fontFamily2, String str, long j3, BaselineShift baselineShift2, TextGeometricTransform textGeometricTransform2, LocaleList localeList2, long j4, TextDecoration textDecoration2, Shadow shadow2, int i, Object obj) {
        long j5;
        long j6;
        ...
        int i2 = i;
        if ((i2 & 1) != 0) {
            j5 = spanStyle.m5284getColor0d7_KjU();
        } else {
            j5 = j;
        }
        if ((i2 & 2) != 0) {
        ...
        return spanStyle.m5280copyIuqyXdg(j5, j6, fontWeight3, fontStyle3, fontSynthesis3, fontFamily3, str2, j7, baselineShift3, textGeometricTransform4, localeList4, j9, textDecoration3, shadow3);
    }
    ...
    public final /* synthetic */ SpanStyle m5280copyIuqyXdg(long color, long fontSize2, FontWeight fontWeight2, FontStyle fontStyle2, FontSynthesis fontSynthesis2, FontFamily fontFamily2, String fontFeatureSettings2, long letterSpacing2, BaselineShift baselineShift2, TextGeometricTransform textGeometricTransform2, LocaleList localeList2, long background2, TextDecoration textDecoration2, Shadow shadow2) {
        TextForegroundStyle textForegroundStyle2;
        long j = color;
        if (Color.m3254equalsimpl0(j, m5284getColor0d7_KjU())) {
            textForegroundStyle2 = this.textForegroundStyle;
        } else {
            textForegroundStyle2 = TextForegroundStyle.Companion.m5727from8_81llA(j);
        }
    ...
    public static /* synthetic */ SpanStyle m5274copy2BkPm_w$default(SpanStyle spanStyle, long j, long j2, FontWeight fontWeight2, FontStyle fontStyle2, FontSynthesis fontSynthesis2, FontFamily fontFamily2, String str, long j3, BaselineShift baselineShift2, TextGeometricTransform textGeometricTransform2, LocaleList localeList2, long j4, TextDecoration textDecoration2, Shadow shadow2, PlatformSpanStyle platformSpanStyle, int i, Object obj) {
        ...
        return spanStyle.m5278copy2BkPm_w(j5, j6, fontWeight3, fontStyle3, fontSynthesis3, fontFamily3, str2, j7, baselineShift3, textGeometricTransform4, localeList4, j9, textDecoration3, shadow3, platformSpanStyle2);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "SpanStyle copy constructors that do not take new stable parameters like PlatformStyle, DrawStyle are deprecated. Please use the new stable copy constructor.")
    /* renamed from: copy-2BkPm_w  reason: not valid java name */
    public final /* synthetic */ SpanStyle m5278copy2BkPm_w(long color, long fontSize2, FontWeight fontWeight2, FontStyle fontStyle2, FontSynthesis fontSynthesis2, FontFamily fontFamily2, String fontFeatureSettings2, long letterSpacing2, BaselineShift baselineShift2, TextGeometricTransform textGeometricTransform2, LocaleList localeList2, long background2, TextDecoration textDecoration2, Shadow shadow2, PlatformSpanStyle platformStyle2) {
        TextForegroundStyle textForegroundStyle2;
        long j = color;
        if (Color.m3254equalsimpl0(j, m5284getColor0d7_KjU())) {
            textForegroundStyle2 = this.textForegroundStyle;
    ...
    public static /* synthetic */ SpanStyle m5275copyGSF8kmg$default(SpanStyle spanStyle, long j, long j2, FontWeight fontWeight2, FontStyle fontStyle2, FontSynthesis fontSynthesis2, FontFamily fontFamily2, String str, long j3, BaselineShift baselineShift2, TextGeometricTransform textGeometricTransform2, LocaleList localeList2, long j4, TextDecoration textDecoration2, Shadow shadow2, PlatformSpanStyle platformSpanStyle, DrawStyle drawStyle2, int i, Object obj) {
        long j5;
        long j6;
        FontWeight fontWeight3;
        FontStyle fontStyle3;
        ...
        return spanStyle.m5279copyGSF8kmg(j5, j6, fontWeight3, fontStyle3, fontSynthesis3, fontFamily3, str2, j7, baselineShift3, textGeometricTransform4, localeList4, j9, textDecoration3, shadow4, platformSpanStyle2, drawStyle3);
    }

    /* renamed from: copy-GSF8kmg  reason: not valid java name */
    public final SpanStyle m5279copyGSF8kmg(long color, long fontSize2, FontWeight fontWeight2, FontStyle fontStyle2, FontSynthesis fontSynthesis2, FontFamily fontFamily2, String fontFeatureSettings2, long letterSpacing2, BaselineShift baselineShift2, TextGeometricTransform textGeometricTransform2, LocaleList localeList2, long background2, TextDecoration textDecoration2, Shadow shadow2, PlatformSpanStyle platformStyle2, DrawStyle drawStyle2) {
        TextForegroundStyle textForegroundStyle2;
        long j = color;
        if (Color.m3254equalsimpl0(j, m5284getColor0d7_KjU())) {
            textForegroundStyle2 = this.textForegroundStyle;
    ...
    public static /* synthetic */ SpanStyle m5277copyNcG25M8$default(SpanStyle spanStyle, Brush brush, float f, long j, FontWeight fontWeight2, FontStyle fontStyle2, FontSynthesis fontSynthesis2, FontFamily fontFamily2, String str, long j2, BaselineShift baselineShift2, TextGeometricTransform textGeometricTransform2, LocaleList localeList2, long j3, TextDecoration textDecoration2, Shadow shadow2, PlatformSpanStyle platformSpanStyle, DrawStyle drawStyle2, int i, Object obj) {
        float f2;
        long j4;
        FontWeight fontWeight3;
        FontStyle fontStyle3;
        ...
        return spanStyle.m5281copyNcG25M8(brush, f2, j4, fontWeight3, fontStyle3, fontSynthesis3, fontFamily3, str2, j5, baselineShift3, textGeometricTransform3, localeList4, j7, textDecoration3, shadow4, platformSpanStyle2, drawStyle3);
    }

    /* renamed from: copy-NcG25M8  reason: not valid java name */
    public final SpanStyle m5281copyNcG25M8(Brush brush, float alpha, long fontSize2, FontWeight fontWeight2, FontStyle fontStyle2, FontSynthesis fontSynthesis2, FontFamily fontFamily2, String fontFeatureSettings2, long letterSpacing2, BaselineShift baselineShift2, TextGeometricTransform textGeometricTransform2, LocaleList localeList2, long background2, TextDecoration textDecoration2, Shadow shadow2, PlatformSpanStyle platformStyle2, DrawStyle drawStyle2) {
    ...
    public final boolean hasSameLayoutAffectingAttributes$ui_text_release(SpanStyle other) {
        ...
        if (TextUnit.m6022equalsimpl0(this.fontSize, other.fontSize) && Intrinsics.areEqual((Object) this.fontWeight, (Object) other.fontWeight) && Intrinsics.areEqual((Object) this.fontStyle, (Object) other.fontStyle) && Intrinsics.areEqual((Object) this.fontSynthesis, (Object) other.fontSynthesis) && Intrinsics.areEqual((Object) this.fontFamily, (Object) other.fontFamily) && Intrinsics.areEqual((Object) this.fontFeatureSettings, (Object) other.fontFeatureSettings) && TextUnit.m6022equalsimpl0(this.letterSpacing, other.letterSpacing) && Intrinsics.areEqual((Object) this.baselineShift, (Object) other.baselineShift) && Intrinsics.areEqual((Object) this.textGeometricTransform, (Object) other.textGeometricTransform) && Intrinsics.areEqual((Object) this.localeList, (Object) other.localeList) && Color.m3254equalsimpl0(this.background, other.background) && Intrinsics.areEqual((Object) this.platformStyle, (Object) other.platformStyle)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int r1 = Color.m3260hashCodeimpl(m5284getColor0d7_KjU()) * 31;
        Brush brush = getBrush();
        int i = 0;
        int result = (((((r1 + (brush != null ? brush.hashCode() : 0)) * 31) + Float.hashCode(getAlpha())) * 31) + TextUnit.m6026hashCodeimpl(this.fontSize)) * 31;
        ...
        int result3 = (result2 + (fontStyle2 != null ? FontStyle.m5425hashCodeimpl(fontStyle2.m5427unboximpl()) : 0)) * 31;
        FontSynthesis fontSynthesis2 = this.fontSynthesis;
        int result4 = (result3 + (fontSynthesis2 != null ? FontSynthesis.m5434hashCodeimpl(fontSynthesis2.m5438unboximpl()) : 0)) * 31;
        FontFamily fontFamily2 = this.fontFamily;
        int result5 = (result4 + (fontFamily2 != null ? fontFamily2.hashCode() : 0)) * 31;
        String str = this.fontFeatureSettings;
        int result6 = (((result5 + (str != null ? str.hashCode() : 0)) * 31) + TextUnit.m6026hashCodeimpl(this.letterSpacing)) * 31;
        BaselineShift baselineShift2 = this.baselineShift;
        int result7 = (result6 + (baselineShift2 != null ? BaselineShift.m5603hashCodeimpl(baselineShift2.m5605unboximpl()) : 0)) * 31;
        ...
        int result9 = (((result8 + (localeList2 != null ? localeList2.hashCode() : 0)) * 31) + Color.m3260hashCodeimpl(this.background)) * 31;
    ...
    public final int hashCodeLayoutAffectingAttributes$ui_text_release() {
        int r1 = TextUnit.m6026hashCodeimpl(this.fontSize) * 31;
        FontWeight fontWeight2 = this.fontWeight;
        int i = 0;
        int result = (r1 + (fontWeight2 != null ? fontWeight2.hashCode() : 0)) * 31;
        FontStyle fontStyle2 = this.fontStyle;
        int result2 = (result + (fontStyle2 != null ? FontStyle.m5425hashCodeimpl(fontStyle2.m5427unboximpl()) : 0)) * 31;
        FontSynthesis fontSynthesis2 = this.fontSynthesis;
        int result3 = (result2 + (fontSynthesis2 != null ? FontSynthesis.m5434hashCodeimpl(fontSynthesis2.m5438unboximpl()) : 0)) * 31;
        FontFamily fontFamily2 = this.fontFamily;
        int result4 = (result3 + (fontFamily2 != null ? fontFamily2.hashCode() : 0)) * 31;
        String str = this.fontFeatureSettings;
        int result5 = (((result4 + (str != null ? str.hashCode() : 0)) * 31) + TextUnit.m6026hashCodeimpl(this.letterSpacing)) * 31;
        BaselineShift baselineShift2 = this.baselineShift;
        int result6 = (result5 + (baselineShift2 != null ? BaselineShift.m5603hashCodeimpl(baselineShift2.m5605unboximpl()) : 0)) * 31;
        TextGeometricTransform textGeometricTransform2 = this.textGeometricTransform;
        int result7 = (result6 + (textGeometricTransform2 != null ? textGeometricTransform2.hashCode() : 0)) * 31;
        LocaleList localeList2 = this.localeList;
        int result8 = (((result7 + (localeList2 != null ? localeList2.hashCode() : 0)) * 31) + Color.m3260hashCodeimpl(this.background)) * 31;
        PlatformSpanStyle platformSpanStyle = this.platformStyle;
    ...
    public String toString() {
        ...
        sb.append("SpanStyle(color=").append(Color.m3261toStringimpl(m5284getColor0d7_KjU())).append(", brush=").append(getBrush()).append(", alpha=").append(getAlpha()).append(", fontSize=").append(TextUnit.m6032toStringimpl(this.fontSize)).append(", fontWeight=").append(this.fontWeight).append(", fontStyle=").append(this.fontStyle).append(", fontSynthesis=").append(this.fontSynthesis).append(", fontFamily=").append(this.fontFamily).append(", fontFeatureSettings=").append(this.fontFeatureSettings).append(", letterSpacing=").append(TextUnit.m6032toStringimpl(this.letterSpacing)).append(", baselineShift=").append(this.baselineShift).append(", textGeometricTransform=");
        sb.append(this.textGeometricTransform).append(", localeList=").append(this.localeList).append(", background=").append(Color.m3261toStringimpl(this.background)).append(", textDecoration=").append(this.textDecoration).append(", shadow=").append(this.shadow).append(", platformStyle=").append(this.platformStyle).append(", drawStyle=").append(this.drawStyle).append(')');
        return sb.toString();
    }
}
