...
public final class PlatformParagraphStyle {
    ...
    public final int m5263getEmojiSupportMatch_3YsG6Y() {
    ...
    public PlatformParagraphStyle(boolean includeFontPadding2) {
        ...
        this.emojiSupportMatch = EmojiSupportMatch.Companion.m5203getDefault_3YsG6Y();
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? EmojiSupportMatch.Companion.m5203getDefault_3YsG6Y() : i, (i2 & 2) != 0 ? true : z, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? EmojiSupportMatch.Companion.m5203getDefault_3YsG6Y() : i, (DefaultConstructorMarker) null);
    }

    public PlatformParagraphStyle() {
        this(EmojiSupportMatch.Companion.m5203getDefault_3YsG6Y(), true, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PlatformParagraphStyle) && this.includeFontPadding == ((PlatformParagraphStyle) other).includeFontPadding && EmojiSupportMatch.m5199equalsimpl0(this.emojiSupportMatch, ((PlatformParagraphStyle) other).emojiSupportMatch)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (Boolean.hashCode(this.includeFontPadding) * 31) + EmojiSupportMatch.m5200hashCodeimpl(this.emojiSupportMatch);
    }

    public String toString() {
        return "PlatformParagraphStyle(includeFontPadding=" + this.includeFontPadding + ", emojiSupportMatch=" + EmojiSupportMatch.m5201toStringimpl(this.emojiSupportMatch) + ')';
    }
