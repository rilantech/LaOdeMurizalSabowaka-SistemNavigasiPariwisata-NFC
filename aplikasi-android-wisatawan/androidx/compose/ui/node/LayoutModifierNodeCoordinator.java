...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable m4825measureBRTryo0(long constraints) {
            LookaheadDelegate this_$iv = this;
            LayoutModifierNodeCoordinator layoutModifierNodeCoordinator = LayoutModifierNodeCoordinator.this;
            this_$iv.m4728setMeasurementConstraintsBRTryo0(constraints);
            layoutModifierNodeCoordinator.lookaheadConstraints = Constraints.m5776boximpl(constraints);
            LookaheadDelegate lookaheadDelegate = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            this_$iv.set_measureResult(layoutModifierNodeCoordinator.getLayoutModifierNode().m4818measure3p2s80s(this, lookaheadDelegate, constraints));
            return this_$iv;
        }
    ...
    /* renamed from: measure-BRTryo0  reason: not valid java name */
    public Placeable m4823measureBRTryo0(long constraints) {
        MeasureResult measureResult;
        long j = constraints;
        m4728setMeasurementConstraintsBRTryo0(j);
        ...
        if ($this$measure_BRTryo0_u24lambda_u242_u24lambda_u241 instanceof IntermediateLayoutModifierNode) {
            ...
            measureResult = ((IntermediateLayoutModifierNode) $this$measure_BRTryo0_u24lambda_u242_u24lambda_u241).m4626intermediateMeasureTeuZzU(this, getWrappedNonNull(), constraints, IntSize, access$getLookaheadConstraints$p.m5794unboximpl());
        } else {
            measureResult = $this$measure_BRTryo0_u24lambda_u242_u24lambda_u241.m4818measure3p2s80s(this, getWrappedNonNull(), j);
        }
    ...
    public void m4824placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        ...
        if (!isShallowPlacing$ui_release()) {
            ...
            int parentWidth$iv = IntSize.m6004getWidthimpl(m4724getMeasuredSizeYbymL2g());
    ...
    static {
        ...
        Paint paint = Paint;
        paint.m3518setColor8_81llA(Color.Companion.m3280getBlue0d7_KjU());
