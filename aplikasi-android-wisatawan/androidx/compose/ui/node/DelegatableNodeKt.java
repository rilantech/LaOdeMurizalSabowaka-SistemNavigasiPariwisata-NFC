...
public final class DelegatableNodeKt {
    ...
    public static final /* synthetic */ <T> void m4797visitLocalDescendants6rFNWt0(DelegatableNode $this$visitLocalDescendants_u2d6rFNWt0, int type, Function1<? super T, Unit> block) {
        int mask$iv;
        int i;
    ...
    public static final /* synthetic */ <T> void m4796visitLocalAncestors6rFNWt0(DelegatableNode $this$visitLocalAncestors_u2d6rFNWt0, int type, Function1<? super T, Unit> block) {
        int mask$iv;
        int i;
        Function1<? super T, Unit> function1;
        int mask$iv2;
    ...
    public static /* synthetic */ void m4794visitAncestorsYYKmho$default(DelegatableNode $this$visitAncestors_u2dY_u2dYKmho_u24default, int type, boolean includeSelf, Function1 block, int i, Object obj) {
        boolean count$iv;
        int i2;
    ...
    public static final /* synthetic */ <T> void m4793visitAncestorsYYKmho(DelegatableNode $this$visitAncestors_u2dY_u2dYKmho, int type, boolean includeSelf, Function1<? super T, Unit> block) {
    ...
    public static final /* synthetic */ <T> void m4798visitSelfAndAncestors5BbP62I(DelegatableNode $this$visitSelfAndAncestors_u2d5BbP62I, int type, int untilType, Function1<? super T, Unit> block) {
        int mask$iv;
        Modifier.Node self;
        int i;
        NodeChain nodes$ui_release;
    ...
    public static final /* synthetic */ <T> List<T> m4788ancestors64DMado(DelegatableNode $this$ancestors_u2d64DMado, int type) {
    ...
    public static final /* synthetic */ <T> T m4791nearestAncestor64DMado(DelegatableNode $this$nearestAncestor_u2d64DMado, int type) {
        int i;
        boolean includeSelf$iv;
        DelegatableNode $this$visitAncestors_u2dY_u2dYKmho_u24default$iv;
        int i2;
    ...
    public static final /* synthetic */ <T> void m4800visitSubtree6rFNWt0(DelegatableNode $this$visitSubtree_u2d6rFNWt0, int type, Function1<? super T, Unit> block) {
    ...
    public static final /* synthetic */ <T> void m4795visitChildren6rFNWt0(DelegatableNode $this$visitChildren_u2d6rFNWt0, int type, Function1<? super T, Unit> block) {
    ...
    public static final /* synthetic */ <T> void m4799visitSelfAndChildren6rFNWt0(DelegatableNode $this$visitSelfAndChildren_u2d6rFNWt0, int type, Function1<? super T, Unit> block) {
        int count$iv;
        int i;
        int count$iv2;
        int mask$iv;
    ...
    public static final /* synthetic */ <T> void m4801visitSubtreeIf6rFNWt0(DelegatableNode $this$visitSubtreeIf_u2d6rFNWt0, int type, Function1<? super T, Boolean> block) {
    ...
    public static final boolean m4790has64DMado(DelegatableNode $this$has_u2d64DMado, int type) {
    ...
    public static final NodeCoordinator m4792requireCoordinator64DMado(DelegatableNode $this$requireCoordinator_u2d64DMado, int kind) {
        ...
        if (coordinator.getTail() != $this$requireCoordinator_u2d64DMado || !NodeKindKt.m4965getIncludeSelfInTraversalH91voCI(kind)) {
            return coordinator;
        }
    ...
    public static final LayoutModifierNode asLayoutModifierNode(Modifier.Node $this$asLayoutModifierNode) {
        ...
        if ((($this$asLayoutModifierNode.getKindSet$ui_release() & NodeKind.m4956constructorimpl(2)) != 0 ? 1 : 0) == 0) {
            return null;
        }
        ...
        if ($this$asLayoutModifierNode instanceof DelegatingNode) {
            ...
            while (node2 != null) {
                ...
                if (node2 instanceof DelegatingNode) {
                    if (((node2.getKindSet$ui_release() & NodeKind.m4956constructorimpl(2)) != 0 ? 1 : 0) != 0) {
    ...
    public static final /* synthetic */ <T> void m4789dispatchForKind6rFNWt0(Modifier.Node $this$dispatchForKind_u2d6rFNWt0, int kind, Function1<? super T, Unit> block) {
