...
public final class NodeKind<T> {
    ...
    public static final /* synthetic */ NodeKind m4955boximpl(int i) {
        return new NodeKind(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> int m4956constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4957equalsimpl(int i, Object obj) {
        return (obj instanceof NodeKind) && i == ((NodeKind) obj).m4963unboximpl();
    }
    ...
    public static String m4962toStringimpl(int i) {
        return "NodeKind(mask=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m4957equalsimpl(this.mask, obj);
    }

    public int hashCode() {
        return m4959hashCodeimpl(this.mask);
    }

    public String toString() {
        return m4962toStringimpl(this.mask);
    }
    ...
    public static final int m4960orH91voCI(int arg0, int other) {
        return arg0 | other;
    }

    /* renamed from: or-impl  reason: not valid java name */
    public static final int m4961orimpl(int arg0, int other) {
        return arg0 | other;
    }
}
