...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    public final SemanticsConfiguration getCollapsedSemantics$ui_release() {
        if (!this.nodes.m4906hasH91voCI$ui_release(NodeKind.m4956constructorimpl(8)) || this._collapsedSemantics != null) {
    ...
    public final void attach$ui_release(androidx.compose.ui.node.Owner r12) {
        ...
        L_0x00a7:
            ...
            r3 = 0
            r4 = 8
            int r3 = androidx.compose.ui.node.NodeKind.m4956constructorimpl(r4)
            boolean r1 = r1.m4906hasH91voCI$ui_release(r3)
    ...
    public final void detach$ui_release() {
        ...
        if (this.nodes.m4906hasH91voCI$ui_release(NodeKind.m4956constructorimpl(8))) {
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long innerContentConstraints = getInnerCoordinator$ui_release().m4927getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m5786getHasFixedWidthimpl(innerContentConstraints) && Constraints.m5785getHasFixedHeightimpl(innerContentConstraints);
    }
    ...
    public void setDensity(Density value) {
        ...
        if (!Intrinsics.areEqual((Object) this.density, (Object) density2)) {
            ...
            int type$iv5 = NodeKind.m4956constructorimpl(16);
            int i5 = false;
    ...
    public void setCompositionLocalMap(CompositionLocalMap value) {
        ...
        int type$iv5 = NodeKind.m4956constructorimpl(32768);
        int mask$iv$iv = type$iv5;
    ...
    public void setModifier(Modifier value) {
        ...
        if (!this.isVirtual || getModifier() == Modifier.Companion) {
            ...
            if (this.nodes.m4906hasH91voCI$ui_release(NodeKind.m4956constructorimpl(512)) && this.lookaheadRoot == null) {
    ...
    public static /* synthetic */ void m4826hitTestM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, boolean z, boolean z2, int i, Object obj) {
        boolean z3;
        boolean z4;
        if ((i & 4) != 0) {
            z3 = false;
        ...
        layoutNode.m4830hitTestM_7yMNQ$ui_release(j, hitTestResult, z3, z4);
    }

    /* renamed from: hitTest-M_7yMNQ$ui_release  reason: not valid java name */
    public final void m4830hitTestM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        getOuterCoordinator$ui_release().m4932hitTestYqVAtuI(NodeCoordinator.Companion.getPointerInputSource(), getOuterCoordinator$ui_release().m4926fromParentPositionMKHz9U(pointerPosition), hitTestResult, isTouchEvent, isInLayer);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release$default  reason: not valid java name */
    public static /* synthetic */ void m4827hitTestSemanticsM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, boolean z, boolean z2, int i, Object obj) {
        boolean z3;
        boolean z4;
        if ((i & 4) != 0) {
            z3 = true;
        ...
        layoutNode.m4831hitTestSemanticsM_7yMNQ$ui_release(j, hitTestResult, z3, z4);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release  reason: not valid java name */
    public final void m4831hitTestSemanticsM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitSemanticsEntities, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitSemanticsEntities, "hitSemanticsEntities");
        getOuterCoordinator$ui_release().m4932hitTestYqVAtuI(NodeCoordinator.Companion.getSemanticsSource(), getOuterCoordinator$ui_release().m4926fromParentPositionMKHz9U(pointerPosition), hitSemanticsEntities, true, isInLayer);
    }
    ...
    private final void invalidateFocusOnAttach() {
        if (this.nodes.has$ui_release(NodeKind.m4956constructorimpl(1024) | NodeKind.m4956constructorimpl(2048) | NodeKind.m4956constructorimpl(4096))) {
            for (Modifier.Node node$iv = this.nodes.getHead$ui_release(); node$iv != null; node$iv = node$iv.getChild$ui_release()) {
                Modifier.Node it = node$iv;
                int i = 1;
                int i2 = ((it.getKindSet$ui_release() & NodeKind.m4956constructorimpl(1024)) != 0 ? 1 : 0) | ((it.getKindSet$ui_release() & NodeKind.m4956constructorimpl(2048)) != 0 ? 1 : 0);
                if ((it.getKindSet$ui_release() & NodeKind.m4956constructorimpl(4096)) == 0) {
                    i = 0;
                }
                if ((i2 | i) != 0) {
    ...
    private final void invalidateFocusOnDetach() {
        ...
        int type$iv4 = NodeKind.m4956constructorimpl(1024);
        int i2 = false;
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        if (getLayoutState$ui_release() == LayoutState.Idle && !getLayoutPending$ui_release() && !getMeasurePending$ui_release() && isPlaced()) {
            ...
            char c2 = 256;
            int type$iv5 = NodeKind.m4956constructorimpl(256);
            int i4 = false;
            int mask$iv$iv = type$iv5;
                    ...
                    if ((it$iv$iv.getKindSet$ui_release() & mask$iv$iv) != 0) {
                        ...
                        while (node != null) {
                            if (node instanceof GlobalPositionAwareModifierNode) {
                                ...
                                this_$iv3 = this_$iv;
                                i3 = i;
                                it.onGloballyPositioned(DelegatableNodeKt.m4792requireCoordinator64DMado(it, NodeKind.m4956constructorimpl(256)));
                                type$iv3 = type$iv;
                            } else {
                                this_$iv3 = this_$iv;
                                i3 = i;
    ...
    public static /* synthetic */ boolean m4828lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4878getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m4832lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: lookaheadRemeasure-_Sx5XlM$ui_release  reason: not valid java name */
    public final boolean m4832lookaheadRemeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null || this.lookaheadRoot == null) {
            return false;
        }
        LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
        Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
        return lookaheadPassDelegate$ui_release.m4883remeasureBRTryo0(constraints.m5794unboximpl());
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release$default  reason: not valid java name */
    public static /* synthetic */ boolean m4829remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4877getLastConstraintsDWUhwKw();
        }
        return layoutNode.m4833remeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release  reason: not valid java name */
    public final boolean m4833remeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null) {
            return false;
        }
        if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
        ...
        return getMeasurePassDelegate$ui_release().m4888remeasureBRTryo0(constraints.m5794unboximpl());
    }
    ...
    public final void invalidateSubtree(boolean isRootOfInvalidation) {
        ...
        NodeChain this_$iv5 = this.nodes;
        char c4 = 2;
        int type$iv5 = NodeKind.m4956constructorimpl(2);
        int mask$iv$iv = type$iv5;
        NodeChain this_$iv$iv = this_$iv5;
        if ((this_$iv$iv.getAggregateChildKindSet() & mask$iv$iv) != 0) {
            Modifier.Node node$iv$iv$iv = this_$iv$iv.getHead$ui_release();
                ...
                if ((it$iv$iv.getKindSet$ui_release() & mask$iv$iv) != 0) {
                    ...
                    while (this_$iv$iv$iv != null) {
                        if (this_$iv$iv$iv instanceof LayoutModifierNode) {
                            c3 = 2;
                            OwnedLayer layer = DelegatableNodeKt.m4792requireCoordinator64DMado((LayoutModifierNode) this_$iv$iv$iv, NodeKind.m4956constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                            this_$iv3 = this_$iv;
    ...
    public void forceRemeasure() {
        ...
        Constraints lastConstraints = this.layoutDelegate.m4877getLastConstraintsDWUhwKw();
        if (lastConstraints != null) {
            Owner owner2 = this.owner;
            if (owner2 != null) {
                owner2.m5014measureAndLayout0kLqBqw(this, lastConstraints.m5794unboximpl());
                return;
            }
            return;
        }
    ...
    private final boolean shouldInvalidateParentLayer() {
        if (this.nodes.m4906hasH91voCI$ui_release(NodeKind.m4956constructorimpl(4)) && !this.nodes.m4906hasH91voCI$ui_release(NodeKind.m4956constructorimpl(2))) {
            return true;
        }
        for (Modifier.Node node$iv = this.nodes.getHead$ui_release(); node$iv != null; node$iv = node$iv.getChild$ui_release()) {
            Modifier.Node it = node$iv;
            boolean z = false;
            if (((it.getKindSet$ui_release() & NodeKind.m4956constructorimpl(2)) != 0 ? 1 : 0) != 0 && DelegatableNodeKt.m4792requireCoordinator64DMado(it, NodeKind.m4956constructorimpl(2)).getLayer() != null) {
                return false;
            }
            if ((it.getKindSet$ui_release() & NodeKind.m4956constructorimpl(4)) != 0) {
                z = true;
            }
            if (z) {
                return true;
