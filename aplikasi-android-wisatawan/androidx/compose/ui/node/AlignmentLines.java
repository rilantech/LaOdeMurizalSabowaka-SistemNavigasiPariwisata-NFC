...
public abstract class AlignmentLines {
    ...
    public abstract long m4773calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            position = m4773calculatePositionInParentR5De75A(coordinator, position);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            positionInContainer = MathKt.roundToInt(Offset.m3004getYimpl(position));
        } else {
            positionInContainer = MathKt.roundToInt(Offset.m3003getXimpl(position));
        }
