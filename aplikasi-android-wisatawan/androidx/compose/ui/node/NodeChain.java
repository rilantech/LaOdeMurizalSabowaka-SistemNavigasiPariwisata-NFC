...
public final class NodeChain {
    ...
    public final void propagateCoordinator(Modifier.Node start, NodeCoordinator coordinator) {
        ...
        while (node != null) {
            ...
            if (!((node.getKindSet$ui_release() & NodeKind.m4956constructorimpl(2)) != 0)) {
                node.updateCoordinator$ui_release(coordinator);
                node = node.getParent$ui_release();
            } else {
                return;
    ...
    private final class Differ implements DiffCallback {
        ...
        public void remove(int atIndex, int oldIndex) {
            ...
            if ((toRemove.getKindSet$ui_release() & NodeKind.m4956constructorimpl(2)) != 0) {
    ...
    public final /* synthetic */ <T> T m4905firstFromHeadaLcG6gQ$ui_release(int type, Function1<? super T, Boolean> block) {
    ...
    public final /* synthetic */ <T> void m4908headToTailaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        NodeChain this_$iv$iv;
        int $i$f$headToTail$ui_release;
        NodeChain this_$iv;
        int count$iv;
    ...
    public final /* synthetic */ <T> void m4910tailToHeadaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
    ...
    public final /* synthetic */ <T> T m4909tailH91voCI$ui_release(int type) {
        int $i$f$tailToHead$ui_release;
        NodeChain this_$iv$iv;
        int mask$iv$iv;
        int count$iv$iv;
    ...
    public final /* synthetic */ <T> T m4907headH91voCI$ui_release(int type) {
    ...
    public final boolean m4906hasH91voCI$ui_release(int type) {
