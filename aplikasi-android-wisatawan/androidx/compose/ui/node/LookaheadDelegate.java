...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public long m4892getPositionnOccac() {
        return this.position;
    }

    /* renamed from: setPosition--gyyYBs  reason: not valid java name */
    public void m4896setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final void set_measureResult(MeasureResult result) {
        ...
        if (unit == null) {
            m4727setMeasuredSizeozmzZPI(IntSize.Companion.m6009getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        m4894placeAtf8xVGno(m4892getPositionnOccac(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    /* access modifiers changed from: protected */
    /* renamed from: placeAt-f8xVGno  reason: not valid java name */
    public final void m4894placeAtf8xVGno(long position2, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        if (!IntOffset.m5961equalsimpl0(m4892getPositionnOccac(), position2)) {
            m4896setPositiongyyYBs(position2);
    ...
    public final Placeable m4893performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m4895positionInBjo55l4$ui_release(LookaheadDelegate ancestor) {
        Intrinsics.checkNotNullParameter(ancestor, "ancestor");
        long aggregatedOffset = IntOffset.Companion.m5972getZeronOccac();
        LookaheadDelegate lookaheadDelegate = this;
        while (!Intrinsics.areEqual((Object) lookaheadDelegate, (Object) ancestor)) {
            long other$iv = lookaheadDelegate.m4892getPositionnOccac();
            aggregatedOffset = IntOffsetKt.IntOffset(IntOffset.m5962getXimpl(aggregatedOffset) + IntOffset.m5962getXimpl(other$iv), IntOffset.m5963getYimpl(aggregatedOffset) + IntOffset.m5963getYimpl(other$iv));
