...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void unInitializeModifier() {
        if (isAttached()) {
            ...
            boolean z = true;
            if (((getKindSet$ui_release() & NodeKind.m4956constructorimpl(32)) != 0 ? 1 : null) != null) {
            ...
            if ((getKindSet$ui_release() & NodeKind.m4956constructorimpl(8)) == 0) {
                z = false;
            }
            if (z) {
    ...
    private final void initializeModifier(boolean duringAttach) {
        if (isAttached()) {
            ...
            if (((getKindSet$ui_release() & NodeKind.m4956constructorimpl(4)) != 0 ? 1 : null) != null) {
            ...
            if (((getKindSet$ui_release() & NodeKind.m4956constructorimpl(2)) != 0 ? 1 : null) != null) {
            ...
            if (((getKindSet$ui_release() & NodeKind.m4956constructorimpl(128)) != 0 ? 1 : null) != null) {
            ...
            if (((getKindSet$ui_release() & NodeKind.m4956constructorimpl(256)) != 0 ? 1 : null) != null && (element2 instanceof OnGloballyPositionedModifier) && BackwardsCompatNodeKt.isChainUpdate(this)) {
                DelegatableNodeKt.requireLayoutNode(this).invalidateMeasurements$ui_release();
            }
            if (element2 instanceof FocusRequesterModifier) {
                ((FocusRequesterModifier) element2).getFocusRequester().getFocusRequesterNodes$ui_release().add(this);
            }
            if (((getKindSet$ui_release() & NodeKind.m4956constructorimpl(16)) != 0 ? 1 : null) != null && (element2 instanceof PointerInputModifier)) {
    ...
    public long m4774getSizeNHjbRc() {
        return IntSizeKt.m6014toSizeozmzZPI(DelegatableNodeKt.m4792requireCoordinator64DMado(this, NodeKind.m4956constructorimpl(128)).m4930getSizeYbymL2g());
    }
    ...
    public MeasureResult m4775measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        return ((LayoutModifier) element2).m4659measure3p2s80s($this$measure_u2d3p2s80s, measurable, constraints);
    }
    ...
    public void m4776onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        ((PointerInputModifier) element2).getPointerInputFilter().m4501onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public void m4777onRemeasuredozmzZPI(long size) {
        Modifier.Element element2 = this.element;
        if (element2 instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element2).m4719onRemeasuredozmzZPI(size);
        }
    }
