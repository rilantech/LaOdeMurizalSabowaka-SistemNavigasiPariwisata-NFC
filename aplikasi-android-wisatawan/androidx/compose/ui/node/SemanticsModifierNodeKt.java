...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node $this$touchBoundsInRoot, boolean useMinimumTouchTarget) {
        ...
        if (!useMinimumTouchTarget) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m4792requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m4956constructorimpl(8)));
        }
        return DelegatableNodeKt.m4792requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m4956constructorimpl(8)).touchBoundsInRoot();
    }
}
