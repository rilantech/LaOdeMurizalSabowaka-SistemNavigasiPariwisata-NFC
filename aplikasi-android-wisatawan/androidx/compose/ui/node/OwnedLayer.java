...
public interface OwnedLayer {
    ...
    void m5004inverseTransform58bKbWc(float[] fArr);

    /* renamed from: isInLayer-k-4lQ0M  reason: not valid java name */
    boolean m5005isInLayerk4lQ0M(long j);

    void mapBounds(MutableRect mutableRect, boolean z);

    /* renamed from: mapOffset-8S9VItk  reason: not valid java name */
    long m5006mapOffset8S9VItk(long j, boolean z);

    /* renamed from: move--gyyYBs  reason: not valid java name */
    void m5007movegyyYBs(long j);

    /* renamed from: resize-ozmzZPI  reason: not valid java name */
    void m5008resizeozmzZPI(long j);

    void reuseLayer(Function1<? super Canvas, Unit> function1, Function0<Unit> function0);

    /* renamed from: transform-58bKbWc  reason: not valid java name */
    void m5009transform58bKbWc(float[] fArr);

    void updateDisplayList();

    /* renamed from: updateLayerProperties-dDxr-wY  reason: not valid java name */
    void m5010updateLayerPropertiesdDxrwY(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, LayoutDirection layoutDirection, Density density);
}
