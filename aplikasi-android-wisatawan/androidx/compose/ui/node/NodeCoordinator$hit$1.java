...
final class NodeCoordinator$hit$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        this.this$0.m4917hit1hIXUjU(NodeCoordinatorKt.m4954nextUntilhw7D004(this.$this_hit, this.$hitTestSource.m4952entityTypeOLwlOKw(), NodeKind.m4956constructorimpl(2)), this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer);
    }
}
