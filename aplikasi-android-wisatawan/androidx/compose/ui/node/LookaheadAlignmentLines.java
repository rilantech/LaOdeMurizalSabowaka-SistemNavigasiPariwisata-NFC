...
public final class LookaheadAlignmentLines extends AlignmentLines {
    ...
    public long m4889calculatePositionInParentR5De75A(NodeCoordinator $this$calculatePositionInParent_u2dR5De75A, long position) {
        ...
        Intrinsics.checkNotNull(lookaheadDelegate);
        long $this$toOffset_u2d_u2dgyyYBs$iv = lookaheadDelegate.m4892getPositionnOccac();
        return Offset.m3008plusMKHz9U(OffsetKt.Offset((float) IntOffset.m5962getXimpl($this$toOffset_u2d_u2dgyyYBs$iv), (float) IntOffset.m5963getYimpl($this$toOffset_u2d_u2dgyyYBs$iv)), position);
    }
}
