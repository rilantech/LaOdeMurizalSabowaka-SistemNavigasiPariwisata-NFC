...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable m4816measureBRTryo0(long constraints) {
            long j = constraints;
            LookaheadDelegate this_$iv = this;
            this_$iv.m4728setMeasurementConstraintsBRTryo0(j);
            ...
            this_$iv.set_measureResult(getLayoutNode().getMeasurePolicy().m4690measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui_release(), j));
            return this_$iv;
        }
    ...
    /* renamed from: measure-BRTryo0  reason: not valid java name */
    public Placeable m4814measureBRTryo0(long constraints) {
        long j = constraints;
        ...
        setMeasureResult$ui_release(getLayoutNode().getMeasurePolicy().m4690measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui_release(), j));
        onMeasured();
        return this;
    }
    ...
    public void m4815placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        super.m4939placeAtf8xVGno(position, zIndex, layerBlock);
    ...
    public void m4813hitTestChildYqVAtuI(androidx.compose.ui.node.NodeCoordinator.HitTestSource r26, long r27, androidx.compose.ui.node.HitTestResult r29, boolean r30, boolean r31) {
        /*
            r25 = this;
            r0 = r25
            r8 = r26
            ...
            boolean r3 = r0.m4946withinLayerBoundsk4lQ0M(r9)
        ...
        L_0x002c:
            ...
            long r3 = r25.m4928getMinimumTouchTargetSizeNHjbRc()
            float r3 = r0.m4925distanceInMinimumTouchTargettz77jQw(r9, r3)
        ...
        L_0x0073:
            ...
            r13 = r7
            r7 = r14
            r1.m4951childHitTestYqVAtuI(r2, r3, r5, r6, r7)
        ...
        L_0x00cd:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.InnerNodeCoordinator.m4813hitTestChildYqVAtuI(androidx.compose.ui.node.NodeCoordinator$HitTestSource, long, androidx.compose.ui.node.HitTestResult, boolean, boolean):void");
    }
    ...
    static {
        ...
        Paint paint = Paint;
        paint.m3518setColor8_81llA(Color.Companion.m3287getRed0d7_KjU());
        paint.setStrokeWidth(1.0f);
        paint.m3522setStylek9PVt8s(PaintingStyle.Companion.m3531getStrokeTiuSbCo());
