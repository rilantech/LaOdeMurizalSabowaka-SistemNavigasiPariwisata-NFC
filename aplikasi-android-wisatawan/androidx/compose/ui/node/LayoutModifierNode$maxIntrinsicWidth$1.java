...
final class LayoutModifierNode$maxIntrinsicWidth$1 implements NodeMeasuringIntrinsics.MeasureBlock {
    ...
    public final MeasureResult m4820measure3p2s80s(MeasureScope $this$maxWidth, Measurable intrinsicMeasurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$maxWidth, "$this$maxWidth");
        Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
        return this.this$0.m4818measure3p2s80s($this$maxWidth, intrinsicMeasurable, constraints);
    }
}
