...
public final class CalendarMonth {
    ...
    public CalendarMonth(int year2, int month2, int numberOfDays2, int daysFromStartOfWeekToFirstOfMonth2, long startUtcTimeMillis2) {
        this.year = year2;
        this.month = month2;
        this.numberOfDays = numberOfDays2;
        this.daysFromStartOfWeekToFirstOfMonth = daysFromStartOfWeekToFirstOfMonth2;
        this.startUtcTimeMillis = startUtcTimeMillis2;
        this.endUtcTimeMillis = ((((long) numberOfDays2) * CalendarModelKt.MillisecondsIn24Hours) + startUtcTimeMillis2) - 1;
    }
