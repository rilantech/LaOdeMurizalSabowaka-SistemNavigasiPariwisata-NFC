...
public final class CardElevation {
    ...
    public final State<Dp> tonalElevation$material3_release(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (interactionSource == null) {
            ...
            if (it$iv$iv == Composer.Companion.getEmpty()) {
                value$iv$iv = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m5842boximpl(this.defaultElevation), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        EffectsKt.LaunchedEffect((Object) Dp.m5842boximpl(target), (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new CardElevation$animateElevation$2(enabled, animatable, this, target, interaction, (Continuation<? super CardElevation$animateElevation$2>) null), composer, 64);
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof CardElevation) || !Dp.m5849equalsimpl0(this.defaultElevation, ((CardElevation) other).defaultElevation) || !Dp.m5849equalsimpl0(this.pressedElevation, ((CardElevation) other).pressedElevation) || !Dp.m5849equalsimpl0(this.focusedElevation, ((CardElevation) other).focusedElevation) || !Dp.m5849equalsimpl0(this.hoveredElevation, ((CardElevation) other).hoveredElevation) || !Dp.m5849equalsimpl0(this.disabledElevation, ((CardElevation) other).disabledElevation)) {
            return false;
        }
        return true;
    }
