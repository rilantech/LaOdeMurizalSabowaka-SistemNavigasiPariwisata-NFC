...
final class ComposableSingletons$TimePickerKt$lambda1$1 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    ...
    public final void invoke(RowScope $this$ToggleItem, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation(composer, "C996@40069L40,996@40057L53:TimePicker.kt#uh7d8r");
        if ((i & 81) != 16 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1425358052, i, -1, "androidx.compose.material3.ComposableSingletons$TimePickerKt.lambda-1.<anonymous> (TimePicker.kt:996)");
            }
            TextKt.m2148Text4IGK_g(Strings_androidKt.m2053getStringNWtq28(Strings.Companion.m2040getTimePickerAMadMyvUU(), composer, 6), (Modifier) null, 0, 0, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0, (TextDecoration) null, (TextAlign) null, 0, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer, 0, 0, 131070);
            if (ComposerKt.isTraceInProgress()) {
