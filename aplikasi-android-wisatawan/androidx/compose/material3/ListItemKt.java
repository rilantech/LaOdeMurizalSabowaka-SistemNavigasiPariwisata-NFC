...
public final class ListItemKt {
    private static final float ContentEndPadding = Dp.m5844constructorimpl((float) 8);
    /* access modifiers changed from: private */
    public static final float LeadingContentEndPadding = Dp.m5844constructorimpl((float) 16);
    private static final float ListItemHorizontalPadding = Dp.m5844constructorimpl((float) 16);
    private static final float ListItemThreeLineVerticalPadding = Dp.m5844constructorimpl((float) 16);
    private static final float ListItemVerticalPadding = Dp.m5844constructorimpl((float) 8);
    private static final float TrailingHorizontalPadding = Dp.m5844constructorimpl((float) 8);

    /* renamed from: ListItem-HXNGIdc  reason: not valid java name */
    public static final void m1829ListItemHXNGIdc(Function2<? super Composer, ? super Integer, Unit> headlineContent, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> overlineContent, Function2<? super Composer, ? super Integer, Unit> supportingContent, Function2<? super Composer, ? super Integer, Unit> leadingContent, Function2<? super Composer, ? super Integer, Unit> trailingContent, ListItemColors colors, float tonalElevation, float shadowElevation, Composer $composer, int $changed, int i) {
        Function2 function2;
        ...
        if (($dirty & 191739611) != 38347922 || !$composer2.getSkipping()) {
            ...
            if ((i3 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i4 & 64) != 0) {
                    colors3 = ListItemDefaults.INSTANCE.m1826colorsJ08w3E(0, 0, 0, 0, 0, 0, 0, 0, 0, $composer2, 805306368, FrameMetricsAggregator.EVERY_DURATION);
                    $dirty &= -3670017;
                } else {
                    colors3 = colors;
                }
                if (i10 != 0) {
                    tonalElevation3 = ListItemDefaults.INSTANCE.m1827getElevationD9Ej5fM();
                } else {
                    tonalElevation3 = tonalElevation;
                }
                shadowElevation3 = i11 != 0 ? ListItemDefaults.INSTANCE.m1827getElevationD9Ej5fM() : shadowElevation;
            } else {
            ...
            int listItemType = companion.m1846getListItemType7AlIA9s$material3_release(z2, z);
            ...
            if (ListItemType.m1841equalsimpl0(listItemType, ListItemType.Companion.m1847getOneLineAlXitO8())) {
                minHeight = ListTokens.INSTANCE.m2556getListItemOneLineContainerHeightD9Ej5fM();
            } else if (ListItemType.m1841equalsimpl0(listItemType, ListItemType.Companion.m1849getTwoLineAlXitO8())) {
                minHeight = ListTokens.INSTANCE.m2560getListItemTwoLineContainerHeightD9Ej5fM();
            } else {
                minHeight = ListTokens.INSTANCE.m2558getListItemThreeLineContainerHeightD9Ej5fM();
            }
            PaddingValues outerPaddingValues = PaddingKt.m532PaddingValuesYgX7TsA(ListItemHorizontalPadding, ListItemType.m1841equalsimpl0(listItemType, ListItemType.Companion.m1848getThreeLineAlXitO8()) ? ListItemThreeLineVerticalPadding : ListItemVerticalPadding);
            if (ListItemType.m1841equalsimpl0(listItemType, ListItemType.Companion.m1848getThreeLineAlXitO8())) {
                f = ContentEndPadding;
            } else {
                f = Dp.m5844constructorimpl((float) 0);
            }
            m1830ListItemxOgov6c(modifier3, (Shape) null, colors3.containerColor$material3_release($composer2, ($dirty >> 18) & 14).getValue().m3263unboximpl(), colors3.headlineColor$material3_release(true, $composer2, (($dirty >> 15) & 112) | 6).getValue().m3263unboximpl(), tonalElevation3, shadowElevation3, minHeight, outerPaddingValues, ComposableLambdaKt.composableLambda($composer2, -1813277157, true, new ListItemKt$ListItem$1(decoratedLeadingContent, PaddingKt.m535PaddingValuesa9UjIt4$default(0.0f, 0.0f, f, 0.0f, 11, (Object) null), ListItemType.m1841equalsimpl0(listItemType, ListItemType.Companion.m1848getThreeLineAlXitO8()) ? Alignment.Companion.getTop() : Alignment.Companion.getCenterVertically(), ListItemType.m1841equalsimpl0(listItemType, ListItemType.Companion.m1848getThreeLineAlXitO8()) ? Arrangement.INSTANCE.getTop() : Arrangement.INSTANCE.getCenter(), decoratedTrailingContent, decoratedOverlineContent, decoratedHeadlineContent, decoratedSupportingContent)), $composer2, (($dirty >> 3) & 14) | 100663296 | (($dirty >> 9) & 57344) | (($dirty >> 9) & 458752), 2);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m1830ListItemxOgov6c(androidx.compose.ui.Modifier r29, androidx.compose.ui.graphics.Shape r30, long r31, long r33, float r35, float r36, float r37, androidx.compose.foundation.layout.PaddingValues r38, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r39, androidx.compose.runtime.Composer r40, int r41, int r42) {
        ...
        L_0x01a9:
            ...
            float r3 = r3.m1827getElevationD9Ej5fM()
            goto L_0x01b4
        L_0x01b2:
            r3 = r35
        L_0x01b4:
            ...
            float r8 = r8.m1827getElevationD9Ej5fM()
            goto L_0x01bf
        L_0x01bd:
            r8 = r36
        L_0x01bf:
        ...
        L_0x0258:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ListItemKt.m1830ListItemxOgov6c(androidx.compose.ui.Modifier, androidx.compose.ui.graphics.Shape, long, long, float, float, float, androidx.compose.foundation.layout.PaddingValues, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }

    /* access modifiers changed from: private */
    /* renamed from: LeadingContent-3IgeMak  reason: not valid java name */
    public static final void m1828LeadingContent3IgeMak(RowScope $this$LeadingContent_u2d3IgeMak, long contentColor, boolean topAlign, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        if (($dirty2 & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3243boximpl(contentColor))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer2, 315166618, true, new ListItemKt$LeadingContent$1(z, rowScope, function2, $dirty2)), $composer2, 56);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void m1832TrailingContent3IgeMak(RowScope $this$TrailingContent_u2d3IgeMak, long contentColor, boolean topAlign, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        if (($dirty2 & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            Modifier r0 = PaddingKt.m540paddingVpY3zN4$default(Modifier.Companion, TrailingHorizontalPadding, 0.0f, 2, (Object) null);
            ...
            m1831ProvideTextStyleFromToken3JVO9M(contentColor, ListTokens.INSTANCE.getListItemTrailingSupportingTextFont(), content, $composer3, (($dirty2 >> 3) & 14) | 48 | (($dirty2 >> 3) & 896));
    ...
    public static final void m1831ProvideTextStyleFromToken3JVO9M(long color, TypographyKeyTokens textToken, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        if (($dirty & 731) != 146 || !$composer2.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3243boximpl(color))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer2, -514310925, true, new ListItemKt$ProvideTextStyleFromToken$1(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer2, 6), textToken), content, $dirty)), $composer2, 56);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
