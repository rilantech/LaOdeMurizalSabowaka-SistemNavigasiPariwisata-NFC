...
final class ModalBottomSheetWindow extends AbstractComposeView implements ViewTreeObserver.OnGlobalLayoutListener, ViewRootForInspector {
    ...
    private final MutableState content$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ModalBottomSheet_androidKt.INSTANCE.m1684getLambda3$material3_release(), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public ModalBottomSheetWindow(kotlin.jvm.functions.Function0<kotlin.Unit> r8, android.view.View r9, java.util.UUID r10) {
        /*
            ...
            kotlin.jvm.functions.Function2 r0 = r0.m1684getLambda3$material3_release()
            r1 = 0
            r2 = 2
    ...
    public void Content(Composer $composer, int $changed) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new ModalBottomSheetWindow$Content$4(this, $changed));
        }
    }
    ...
    public final void dismiss() {
        ...
        ViewTreeSavedStateRegistryOwner.set(this, (SavedStateRegistryOwner) null);
