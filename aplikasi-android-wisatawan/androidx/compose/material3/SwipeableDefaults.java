...
public final class SwipeableDefaults {
    ...
    public final float m2075getVelocityThresholdD9Ej5fM$material3_release() {
    ...
    public final ResistanceConfig resistanceConfig$material3_release(Set<Float> anchors, float factorAtMin, float factorAtMax) {
        ...
        Float maxOrNull = CollectionsKt.maxOrNull(anchors);
        Intrinsics.checkNotNull(maxOrNull);
        float floatValue = maxOrNull.floatValue();
        Float minOrNull = CollectionsKt.minOrNull(anchors);
