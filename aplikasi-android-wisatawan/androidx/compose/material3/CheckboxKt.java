...
public final class CheckboxKt {
    ...
    public static final void Checkbox(boolean checked, Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, CheckboxColors colors, MutableInteractionSource interactionSource, Composer $composer, int $changed, int i) {
        ...
        if ((374491 & $dirty) != 74898 || !$composer2.getSkipping()) {
            ...
            if ((i3 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    $dirty &= -57345;
                    colors2 = CheckboxDefaults.INSTANCE.m1585colors5tl4gsc(0, 0, 0, 0, 0, 0, $composer2, 1572864, 63);
                }
                if (i6 != 0) {
    ...
    public static final void TriStateCheckbox(ToggleableState state, Function0<Unit> onClick, Modifier modifier, boolean enabled, CheckboxColors colors, MutableInteractionSource interactionSource, Composer $composer, int $changed, int i) {
        ...
        if ((374491 & $dirty3) != 74898 || !$composer2.getSkipping()) {
            ...
            if ((i3 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    colors3 = CheckboxDefaults.INSTANCE.m1585colors5tl4gsc(0, 0, 0, 0, 0, 0, $composer2, 1572864, 63);
                    $dirty3 &= -57345;
                } else {
            ...
            if (function0 != null) {
                $dirty2 = $dirty;
                modifier4 = ToggleableKt.m841triStateToggleableO2vRcR0(Modifier.Companion, state, interactionSource2, RippleKt.m1523rememberRipple9IZ8Weo(false, Dp.m5844constructorimpl(CheckboxTokens.INSTANCE.m2309getStateLayerSizeD9Ej5fM() / ((float) 2)), 0, $composer2, 54, 4), enabled2, Role.m5155boximpl(Role.Companion.m5163getCheckboxo7Vup1c()), onClick);
            } else {
                $dirty2 = $dirty;
                modifier4 = Modifier.Companion;
            }
            ...
            CheckboxImpl(enabled2, state, PaddingKt.m538padding3ABfNKs(modifier3.then(modifier5).then(toggleableModifier), CheckboxDefaultPadding), colors2, $composer2, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 3) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            int i7 = $dirty2;
    ...
    public static final void m1588drawBox1wkBAMs(DrawScope $this$drawBox_u2d1wkBAMs, long boxColor, long borderColor, float radius, float strokeWidth) {
        float f = radius;
    ...
    public static final void m1589drawCheck3IgeMak(DrawScope $this$drawCheck_u2d3IgeMak, long checkColor, float checkFraction, float crossCenterGravitation, float strokeWidthPx, CheckDrawingCache drawingCache) {
