...
public final class FloatingActionButtonDefaults {
    ...
    private static final float LargeIconSize = FabPrimaryLargeTokens.INSTANCE.m2438getIconSizeD9Ej5fM();

    private FloatingActionButtonDefaults() {
    }

    /* renamed from: getLargeIconSize-D9Ej5fM  reason: not valid java name */
    public final float m1791getLargeIconSizeD9Ej5fM() {
    ...
    public final FloatingActionButtonElevation m1790elevationxZ9QkE(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            defaultElevation = FabPrimaryTokens.INSTANCE.m2455getContainerElevationD9Ej5fM();
        }
        if ((i & 2) != 0) {
            pressedElevation = FabPrimaryTokens.INSTANCE.m2465getPressedContainerElevationD9Ej5fM();
        }
        if ((i & 4) != 0) {
            focusedElevation = FabPrimaryTokens.INSTANCE.m2458getFocusContainerElevationD9Ej5fM();
        }
        if ((i & 8) != 0) {
            hoveredElevation = FabPrimaryTokens.INSTANCE.m2459getHoverContainerElevationD9Ej5fM();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final FloatingActionButtonElevation m1792loweredElevationxZ9QkE(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            defaultElevation = FabPrimaryTokens.INSTANCE.m2461getLoweredContainerElevationD9Ej5fM();
        }
        if ((i & 2) != 0) {
            pressedElevation = FabPrimaryTokens.INSTANCE.m2464getLoweredPressedContainerElevationD9Ej5fM();
        }
        if ((i & 4) != 0) {
            focusedElevation = FabPrimaryTokens.INSTANCE.m2462getLoweredFocusContainerElevationD9Ej5fM();
        }
        if ((i & 8) != 0) {
            hoveredElevation = FabPrimaryTokens.INSTANCE.m2463getLoweredHoverContainerElevationD9Ej5fM();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static /* synthetic */ FloatingActionButtonElevation m1788bottomAppBarFabElevationa9UjIt4$default(FloatingActionButtonDefaults floatingActionButtonDefaults, float $this$dp$iv, float $this$dp$iv2, float $this$dp$iv3, float $this$dp$iv4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return floatingActionButtonDefaults.m1789bottomAppBarFabElevationa9UjIt4($this$dp$iv, $this$dp$iv2, $this$dp$iv3, $this$dp$iv4);
    }

    /* renamed from: bottomAppBarFabElevation-a9UjIt4  reason: not valid java name */
    public final FloatingActionButtonElevation m1789bottomAppBarFabElevationa9UjIt4(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation) {
