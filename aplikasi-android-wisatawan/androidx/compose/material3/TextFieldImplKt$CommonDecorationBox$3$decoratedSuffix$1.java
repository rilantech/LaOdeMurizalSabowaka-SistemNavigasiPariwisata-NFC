...
final class TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1(float f, long j, TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C164@6940L285:TextFieldImpl.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = AlphaKt.alpha(Modifier.Companion, this.$prefixSuffixAlphaProgress);
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1425714523, "C165@7013L190:TextFieldImpl.kt#uh7d8r");
            LayoutDirection layoutDirection = layoutDirection$iv$iv;
            Density density = density$iv$iv2;
            TextFieldImplKt.m2137DecorationKTwxG1Y(j, textStyle, function2, $composer2, (i2 >> 21) & 896, 0);
