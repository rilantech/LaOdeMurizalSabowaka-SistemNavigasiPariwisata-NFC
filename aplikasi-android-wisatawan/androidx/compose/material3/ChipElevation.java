...
public final class ChipElevation {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (!enabled) {
            ...
            EffectsKt.LaunchedEffect((Object) Dp.m5842boximpl(target), (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new ChipElevation$animateElevation$2(animatable, target, (Continuation<? super ChipElevation$animateElevation$2>) null), composer, 64);
            $composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-1373769675);
            ComposerKt.sourceInformation(composer, "1552@74943L570");
            EffectsKt.LaunchedEffect((Object) Dp.m5842boximpl(target), (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new ChipElevation$animateElevation$3(animatable, this, target, interaction, (Continuation<? super ChipElevation$animateElevation$3>) null), composer, 64);
            $composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof ChipElevation) || !Dp.m5849equalsimpl0(this.elevation, ((ChipElevation) other).elevation) || !Dp.m5849equalsimpl0(this.pressedElevation, ((ChipElevation) other).pressedElevation) || !Dp.m5849equalsimpl0(this.focusedElevation, ((ChipElevation) other).focusedElevation) || !Dp.m5849equalsimpl0(this.hoveredElevation, ((ChipElevation) other).hoveredElevation) || !Dp.m5849equalsimpl0(this.disabledElevation, ((ChipElevation) other).disabledElevation)) {
            return false;
        }
        return true;
    }
