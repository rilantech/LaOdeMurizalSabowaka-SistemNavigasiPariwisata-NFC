...
final class NavigationRailKt$NavigationRailItem$2$indicator$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            BoxKt.Box(BackgroundKt.m166backgroundbw27NRU(LayoutIdKt.layoutId(Modifier.Companion, "indicator"), Color.m3252copywmQWz5c$default(this.$colors.getIndicatorColor($composer, (this.$$dirty >> 21) & 14), NavigationRailKt.NavigationRailItem$lambda$5$lambda$2(this.$animationProgress$delegate), 0.0f, 0.0f, 0.0f, 14, (Object) null), this.$indicatorShape), $composer, 0);
            if (ComposerKt.isTraceInProgress()) {
