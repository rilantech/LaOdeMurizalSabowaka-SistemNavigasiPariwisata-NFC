                        ...
                        TextKt.ProvideTextStyle(labelLarge, ComposableLambdaKt.composableLambda($composer, -2136309793, true, new Function2<Composer, Integer, Unit>() {
                            ...
                            public final void invoke(Composer $composer, int $changed) {
                                ...
                                if ((i & 11) != 2 || !$composer.getSkipping()) {
                                    ...
                                    Modifier modifier$iv = PaddingKt.padding(SizeKt.m596defaultMinSizeVpY3zN4(Modifier.Companion, ButtonDefaults.INSTANCE.m1576getMinWidthD9Ej5fM(), ButtonDefaults.INSTANCE.m1575getMinHeightD9Ej5fM()), paddingValues);
