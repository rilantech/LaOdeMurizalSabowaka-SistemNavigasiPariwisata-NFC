...
public final class SelectableChipElevation {
    ...
    private SelectableChipElevation(float elevation2, float pressedElevation2, float focusedElevation2, float hoveredElevation2, float draggedElevation2, float disabledElevation2) {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (!enabled) {
            ...
            EffectsKt.LaunchedEffect((Object) Dp.m5842boximpl(target), (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new SelectableChipElevation$animateElevation$2(animatable, target, (Continuation<? super SelectableChipElevation$animateElevation$2>) null), composer, 64);
            $composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-699481799);
            ComposerKt.sourceInformation(composer, "1712@81209L570");
            EffectsKt.LaunchedEffect((Object) Dp.m5842boximpl(target), (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new SelectableChipElevation$animateElevation$3(animatable, this, target, interaction, (Continuation<? super SelectableChipElevation$animateElevation$3>) null), composer, 64);
            $composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof SelectableChipElevation) || !Dp.m5849equalsimpl0(this.elevation, ((SelectableChipElevation) other).elevation) || !Dp.m5849equalsimpl0(this.pressedElevation, ((SelectableChipElevation) other).pressedElevation) || !Dp.m5849equalsimpl0(this.focusedElevation, ((SelectableChipElevation) other).focusedElevation) || !Dp.m5849equalsimpl0(this.hoveredElevation, ((SelectableChipElevation) other).hoveredElevation) || !Dp.m5849equalsimpl0(this.disabledElevation, ((SelectableChipElevation) other).disabledElevation)) {
            return false;
        }
        return true;
    }
