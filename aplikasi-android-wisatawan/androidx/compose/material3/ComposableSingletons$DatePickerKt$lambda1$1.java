...
final class ComposableSingletons$DatePickerKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            IconKt.m1808Iconww6aTOc(EditKt.getEdit(Icons.Filled.INSTANCE), Strings_androidKt.m2053getStringNWtq28(Strings.Companion.m2013getDatePickerSwitchToInputModeadMyvUU(), $composer, 6), (Modifier) null, 0, $composer, 0, 12);
            if (ComposerKt.isTraceInProgress()) {
