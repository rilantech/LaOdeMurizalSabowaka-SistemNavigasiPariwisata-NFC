...
final class BottomSheetScaffoldKt$StandardBottomSheet$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            function34.invoke(SkippableUpdater.m2856boximpl(SkippableUpdater.m2857constructorimpl($composer)), composer, Integer.valueOf(($changed$iv$iv$iv >> 3) & 112));
            ...
            if (function2 != null) {
                ...
                String partialExpandActionLabel = Strings_androidKt.m2053getStringNWtq28(Strings.Companion.m1994getBottomSheetPartialExpandDescriptionadMyvUU(), $composer2, 6);
                String dismissActionLabel = Strings_androidKt.m2053getStringNWtq28(Strings.Companion.m1990getBottomSheetDismissDescriptionadMyvUU(), $composer2, 6);
                MeasurePolicy measurePolicy = measurePolicy$iv;
                $composer$iv = $composer$iv2;
                ViewConfiguration viewConfiguration = viewConfiguration$iv$iv;
                Modifier modifier$iv2 = SemanticsModifierKt.semantics($this$invoke_u24lambda_u241.align(Modifier.Companion, Alignment.Companion.getCenterHorizontally()), true, new BottomSheetScaffoldKt$StandardBottomSheet$3$1$1(sheetState, z, Strings_androidKt.m2053getStringNWtq28(Strings.Companion.m1992getBottomSheetExpandDescriptionadMyvUU(), $composer2, 6), partialExpandActionLabel, dismissActionLabel, coroutineScope));
