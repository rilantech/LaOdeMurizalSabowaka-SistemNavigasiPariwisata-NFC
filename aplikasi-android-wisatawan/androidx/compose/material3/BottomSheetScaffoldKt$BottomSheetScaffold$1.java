...
final class BottomSheetScaffoldKt$BottomSheetScaffold$1 extends Lambda implements Function3<Integer, Composer, Integer, Unit> {
    ...
    public final void invoke(int layoutHeight, Composer $composer, int $changed) {
        ...
        if (($dirty & 91) != 18 || !$composer.getSkipping()) {
            ...
            int i3 = this.$$dirty;
            BottomSheetScaffoldKt.m1562StandardBottomSheet8oydGBM(bottomSheetState, f, z, f2, shape, j, j2, f3, f4, function2, function3, $composer, ((i3 >> 6) & 112) | ((this.$$dirty1 << 6) & 896) | (i3 & 57344) | (i3 & 458752) | (i3 & 3670016) | (i3 & 29360128) | (i3 & 234881024) | (i3 & 1879048192), i3 & 14);
            if (ComposerKt.isTraceInProgress()) {
