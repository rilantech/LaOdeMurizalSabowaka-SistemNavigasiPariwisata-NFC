...
public final class StateData {
    ...
    private StateData(Long initialSelectedStartDateMillis, Long initialSelectedEndDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange2, int initialDisplayMode) {
        CalendarMonth month;
        Intrinsics.checkNotNullParameter(yearRange2, "yearRange");
        this.yearRange = yearRange2;
        ...
        if (initialDisplayedMonthMillis != null) {
            ...
            if (!yearRange2.contains(month.getYear())) {
                throw new IllegalArgumentException(("The initial display month's year (" + month.getYear() + ") is out of the years range of " + yearRange2 + '.').toString());
            }
        } else {
            month = getCurrentMonth();
        }
        this.displayedMonth$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(month, (SnapshotMutationPolicy) null, 2, (Object) null);
        this.displayMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DisplayMode.m1731boximpl(initialDisplayMode), (SnapshotMutationPolicy) null, 2, (Object) null);
    }
    ...
    public final void m1981switchDisplayModevCnGnXg(int displayMode2) {
        ...
        this.displayMode.setValue(DisplayMode.m1731boximpl(displayMode2));
    }
