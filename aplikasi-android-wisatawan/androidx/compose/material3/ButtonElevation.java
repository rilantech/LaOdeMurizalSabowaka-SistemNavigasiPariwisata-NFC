...
public final class ButtonElevation {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (!enabled) {
            ...
            EffectsKt.LaunchedEffect((Object) Dp.m5842boximpl(target), (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new ButtonElevation$animateElevation$2(animatable, target, (Continuation<? super ButtonElevation$animateElevation$2>) null), composer, 64);
            $composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-719929940);
            ComposerKt.sourceInformation(composer, "861@40988L546");
            EffectsKt.LaunchedEffect((Object) Dp.m5842boximpl(target), (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new ButtonElevation$animateElevation$3(animatable, this, target, interaction, (Continuation<? super ButtonElevation$animateElevation$3>) null), composer, 64);
            $composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof ButtonElevation) || !Dp.m5849equalsimpl0(this.defaultElevation, ((ButtonElevation) other).defaultElevation) || !Dp.m5849equalsimpl0(this.pressedElevation, ((ButtonElevation) other).pressedElevation) || !Dp.m5849equalsimpl0(this.focusedElevation, ((ButtonElevation) other).focusedElevation) || !Dp.m5849equalsimpl0(this.hoveredElevation, ((ButtonElevation) other).hoveredElevation) || !Dp.m5849equalsimpl0(this.disabledElevation, ((ButtonElevation) other).disabledElevation)) {
            return false;
        }
        return true;
    }
