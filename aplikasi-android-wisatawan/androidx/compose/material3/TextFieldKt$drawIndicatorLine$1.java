...
final class TextFieldKt$drawIndicatorLine$1 extends Lambda implements Function1<ContentDrawScope, Unit> {
    ...
    public final void invoke(ContentDrawScope $this$drawWithContent) {
        ...
        if (!Dp.m5849equalsimpl0(this.$strokeWidthDp, Dp.Companion.m5862getHairlineD9Ej5fM())) {
            float strokeWidth = this.$strokeWidthDp * $this$drawWithContent.getDensity();
            float y = Size.m3069getHeightimpl($this$drawWithContent.m3866getSizeNHjbRc()) - (strokeWidth / ((float) 2));
            DrawScope.m3833drawLine1RTmtNc$default(contentDrawScope, this.$indicatorBorder.getBrush(), OffsetKt.Offset(0.0f, y), OffsetKt.Offset(Size.m3072getWidthimpl($this$drawWithContent.m3866getSizeNHjbRc()), y), strokeWidth, 0, (PathEffect) null, 0.0f, (ColorFilter) null, 0, 496, (Object) null);
        }
    }
}
