...
public final class TooltipDefaults {
    ...
    public final RichTooltipColors m2261richTooltipColorsro_MJ88(long containerColor, long contentColor, long titleContentColor, long actionContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        ...
        RichTooltipColors richTooltipColors = new RichTooltipColors(containerColor2, contentColor2, titleContentColor2, actionContentColor2, (DefaultConstructorMarker) null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
