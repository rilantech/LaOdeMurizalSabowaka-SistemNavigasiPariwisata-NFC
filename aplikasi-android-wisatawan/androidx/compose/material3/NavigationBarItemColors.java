...
public final class NavigationBarItemColors {
    ...
    public final State<Color> iconColor$material3_release(boolean selected, boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> r0 = SingleValueAnimationKt.m72animateColorAsStateeuL9pac(targetValue, AnimationSpecKt.tween$default(100, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, $composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final long m1862getIndicatorColor0d7_KjU$material3_release() {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof NavigationBarItemColors) || !Color.m3254equalsimpl0(this.selectedIconColor, ((NavigationBarItemColors) other).selectedIconColor) || !Color.m3254equalsimpl0(this.unselectedIconColor, ((NavigationBarItemColors) other).unselectedIconColor) || !Color.m3254equalsimpl0(this.selectedTextColor, ((NavigationBarItemColors) other).selectedTextColor) || !Color.m3254equalsimpl0(this.unselectedTextColor, ((NavigationBarItemColors) other).unselectedTextColor) || !Color.m3254equalsimpl0(this.selectedIndicatorColor, ((NavigationBarItemColors) other).selectedIndicatorColor) || !Color.m3254equalsimpl0(this.disabledIconColor, ((NavigationBarItemColors) other).disabledIconColor) || !Color.m3254equalsimpl0(this.disabledTextColor, ((NavigationBarItemColors) other).disabledTextColor)) {
            return false;
        }
        return true;
    }
