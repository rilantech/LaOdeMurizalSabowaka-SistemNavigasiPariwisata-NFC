...
public final class ChipColors {
    ...
    private ChipColors(long containerColor2, long labelColor2, long leadingIconContentColor2, long trailingIconContentColor2, long disabledContainerColor2, long disabledLabelColor2, long disabledLeadingIconContentColor2, long disabledTrailingIconContentColor2) {
        this.containerColor = containerColor2;
        this.labelColor = labelColor2;
        this.leadingIconContentColor = leadingIconContentColor2;
        this.trailingIconContentColor = trailingIconContentColor2;
        ...
        this.disabledTrailingIconContentColor = disabledTrailingIconContentColor2;
    }
    ...
    public final State<Color> containerColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(enabled ? this.containerColor : this.disabledContainerColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> labelColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(enabled ? this.labelColor : this.disabledLabelColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> leadingIconContentColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(enabled ? this.leadingIconContentColor : this.disabledLeadingIconContentColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> trailingIconContentColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(enabled ? this.trailingIconContentColor : this.disabledTrailingIconContentColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof ChipColors) || !Color.m3254equalsimpl0(this.containerColor, ((ChipColors) other).containerColor) || !Color.m3254equalsimpl0(this.labelColor, ((ChipColors) other).labelColor) || !Color.m3254equalsimpl0(this.leadingIconContentColor, ((ChipColors) other).leadingIconContentColor) || !Color.m3254equalsimpl0(this.trailingIconContentColor, ((ChipColors) other).trailingIconContentColor) || !Color.m3254equalsimpl0(this.disabledContainerColor, ((ChipColors) other).disabledContainerColor) || !Color.m3254equalsimpl0(this.disabledLabelColor, ((ChipColors) other).disabledLabelColor) || !Color.m3254equalsimpl0(this.disabledLeadingIconContentColor, ((ChipColors) other).disabledLeadingIconContentColor) || !Color.m3254equalsimpl0(this.disabledTrailingIconContentColor, ((ChipColors) other).disabledTrailingIconContentColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((((((Color.m3260hashCodeimpl(this.containerColor) * 31) + Color.m3260hashCodeimpl(this.labelColor)) * 31) + Color.m3260hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m3260hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m3260hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3260hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m3260hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m3260hashCodeimpl(this.disabledTrailingIconContentColor);
    }
}
