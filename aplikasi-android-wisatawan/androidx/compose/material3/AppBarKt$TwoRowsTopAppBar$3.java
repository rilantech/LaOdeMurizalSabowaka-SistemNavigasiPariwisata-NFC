...
final class AppBarKt$TwoRowsTopAppBar$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            float f4 = f2;
            AppBarKt.m1542TopAppBarLayoutkXwM9vE(ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(Modifier.Companion, windowInsets)), floatRef.element, topAppBarColors.m2269getNavigationIconContentColor0d7_KjU$material3_release(), topAppBarColors.m2270getTitleContentColor0d7_KjU$material3_release(), topAppBarColors.m2268getActionIconContentColor0d7_KjU$material3_release(), function2, textStyle4, f4, Arrangement.INSTANCE.getCenter(), start, 0, z, function26, function29, composer2, i9, ((i7 >> 12) & 896) | 3078);
            Modifier clipToBounds = ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(Modifier.Companion, WindowInsetsKt.m641onlybOOhFvg(windowInsets, WindowInsetsSides.Companion.m665getHorizontalJoeWqyM())));
            ...
            int i10 = i7 << 12;
            AppBarKt.m1542TopAppBarLayoutkXwM9vE(clipToBounds, f5 + f, topAppBarColors.m2269getNavigationIconContentColor0d7_KjU$material3_release(), topAppBarColors.m2270getTitleContentColor0d7_KjU$material3_release(), topAppBarColors.m2268getActionIconContentColor0d7_KjU$material3_release(), function28, textStyle2, f3, Arrangement.INSTANCE.getBottom(), Arrangement.INSTANCE.getStart(), intRef.element, z3, ComposableSingletons$AppBarKt.INSTANCE.m1667getLambda11$material3_release(), ComposableSingletons$AppBarKt.INSTANCE.m1668getLambda12$material3_release(), $composer3, (i10 & 458752) | 905969664 | (i10 & 3670016), 3456);
