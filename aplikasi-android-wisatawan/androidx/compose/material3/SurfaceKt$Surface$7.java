...
final class SurfaceKt$Surface$7 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = ToggleableKt.m838toggleableO2vRcR0$default(SurfaceKt.m2068surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(this.$modifier), this.$shape, SurfaceKt.m2069surfaceColorAtElevationCLU3JFs(this.$color, this.$absoluteElevation, composer, (this.$$changed >> 15) & 14), this.$border, this.$shadowElevation), this.$checked, this.$interactionSource, RippleKt.m1523rememberRipple9IZ8Weo(false, 0.0f, 0, $composer, 0, 7), this.$enabled, (Role) null, this.$onCheckedChange, 16, (Object) null);
