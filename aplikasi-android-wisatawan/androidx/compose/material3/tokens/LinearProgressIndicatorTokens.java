...
public final class LinearProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5844constructorimpl((float) 4.0d);
    ...
    private static final float TrackHeight = Dp.m5844constructorimpl((float) 4.0d);
    ...
    public final float m2546getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2547getTrackHeightD9Ej5fM() {
        return TrackHeight;
    }
