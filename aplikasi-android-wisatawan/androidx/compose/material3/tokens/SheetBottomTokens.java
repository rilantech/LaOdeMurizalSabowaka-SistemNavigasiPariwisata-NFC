...
public final class SheetBottomTokens {
    ...
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m2418getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m2418getLevel1D9Ej5fM();
    ...
    public final float m2709getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* renamed from: getDockedDragHandleWidth-D9Ej5fM  reason: not valid java name */
    public final float m2710getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m2711getDockedModalContainerElevationD9Ej5fM() {
        return DockedModalContainerElevation;
    }

    /* renamed from: getDockedStandardContainerElevation-D9Ej5fM  reason: not valid java name */
    public final float m2712getDockedStandardContainerElevationD9Ej5fM() {
