...
final class ScaffoldKt$ScaffoldLayout$1$1 extends Lambda implements Function2<SubcomposeMeasureScope, Constraints, MeasureResult> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m1940invoke0kLqBqw((SubcomposeMeasureScope) p1, ((Constraints) p2).m5794unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final MeasureResult m1940invoke0kLqBqw(SubcomposeMeasureScope $this$SubcomposeLayout, long constraints) {
        ...
        return MeasureScope.layout$default(subcomposeMeasureScope, layoutWidth, layoutHeight, (Map) null, new Function1<Placeable.PlacementScope, Unit>() {
            ...
            public final void invoke(Placeable.PlacementScope $this$layout) {
                ...
                for (Measurable it : $this$map$iv) {
                    destination$iv$iv.add(it.m4689measureBRTryo0(j));
                }
                ...
                for (Measurable it2 : $this$map$iv2) {
                    ...
                    int i3 = leftInset;
                    destination$iv$iv2.add(it2.m4689measureBRTryo0(ConstraintsKt.m5804offsetNN6EwU(j2, (-leftInset) - windowInsets.getRight(density, subcomposeMeasureScope.getLayoutDirection()), -windowInsets.getBottom(density))));
                ...
                while (true) {
                    ...
                    Object it$iv$iv = ((Measurable) it3.next()).m4689measureBRTryo0(ConstraintsKt.m5804offsetNN6EwU(j3, (-windowInsets2.getLeft(density2, subcomposeMeasureScope2.getLayoutDirection())) - windowInsets2.getRight(density2, subcomposeMeasureScope2.getLayoutDirection()), -windowInsets2.getBottom(density2)));
                ...
                if (!fabPlaceables.isEmpty()) {
                    ...
                    if (!FabPosition.m1772equalsimpl0(i, FabPosition.Companion.m1777getEndERTFSPs())) {
                        fabLeftOffset = (i3 - fabWidth) / 2;
                    } else if (subcomposeMeasureScope2.getLayoutDirection() == LayoutDirection.Ltr) {
                        fabLeftOffset = (i3 - subcomposeMeasureScope2.m5819roundToPx0680j_4(ScaffoldKt.FabSpacing)) - fabWidth;
                    } else {
                        fabLeftOffset = subcomposeMeasureScope2.m5819roundToPx0680j_4(ScaffoldKt.FabSpacing);
                    }
                ...
                for (Measurable it5 : $this$map$iv5) {
                    destination$iv$iv4.add(it5.m4689measureBRTryo0(j4));
                }
                ...
                if (fabPlacement2 != null) {
                    ...
                    if (bottomBarHeight == null) {
                        i2 = it6.getHeight() + subcomposeMeasureScope4.m5819roundToPx0680j_4(ScaffoldKt.FabSpacing) + windowInsets4.getBottom(subcomposeMeasureScope4);
                    } else {
                        i2 = bottomBarHeight.intValue() + it6.getHeight() + subcomposeMeasureScope4.m5819roundToPx0680j_4(ScaffoldKt.FabSpacing);
                    }
                ...
                for (Measurable it7 : $this$map$iv6) {
                    destination$iv$iv5.add(it7.m4689measureBRTryo0(j5));
                }
