...
final class NavigationBarKt$NavigationBarItemBaselineLayout$2 implements MeasurePolicy {
    ...
    NavigationBarKt$NavigationBarItemBaselineLayout$2(float f, Function2<? super Composer, ? super Integer, Unit> function2, boolean z) {
    ...
    public final MeasureResult m1871measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        ...
        for (Object element$iv2 : $this$first$iv) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv2), (Object) "icon")) {
                Placeable iconPlaceable = ((Measurable) element$iv2).m4689measureBRTryo0(constraints);
                int totalIndicatorWidth2 = iconPlaceable.getWidth() + measureScope.m5819roundToPx0680j_4(Dp.m5844constructorimpl(((float) 2) * NavigationBarKt.IndicatorHorizontalPadding));
                int animatedIndicatorWidth = MathKt.roundToInt(((float) totalIndicatorWidth2) * this.$animationProgress);
                int indicatorHeight = iconPlaceable.getHeight() + measureScope.m5819roundToPx0680j_4(Dp.m5844constructorimpl(((float) 2) * NavigationBarKt.IndicatorVerticalPadding));
                ...
                for (Object element$iv3 : $this$first$iv2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv3), (Object) "indicatorRipple")) {
                        Placeable indicatorRipplePlaceable = ((Measurable) element$iv3).m4689measureBRTryo0(Constraints.Companion.m5796fixedJhjzzOo(totalIndicatorWidth2, indicatorHeight));
                        ...
                        Placeable indicatorPlaceable = measurable != null ? measurable.m4689measureBRTryo0(Constraints.Companion.m5796fixedJhjzzOo(animatedIndicatorWidth, indicatorHeight)) : null;
                        ...
                        if (it2 != null) {
                            ...
                            for (Object element$iv4 : $this$first$iv4) {
                                ...
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv4), (Object) "label")) {
                                    ...
                                    labelPlaceable = ((Measurable) element$iv4).m4689measureBRTryo0(Constraints.m5779copyZbe2FdA$default(constraints, 0, 0, 0, 0, 11, (Object) null));
                                } else {
                        ...
                        if (this.$label == null) {
                            ...
                            return NavigationBarKt.m1868placeIconX9ElhV4($this$Layout, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints);
                        }
                        Intrinsics.checkNotNull(labelPlaceable);
                        return NavigationBarKt.m1869placeLabelAndIconzUg2_y0($this$Layout, labelPlaceable, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints, this.$alwaysShowLabel, this.$animationProgress);
                    }
