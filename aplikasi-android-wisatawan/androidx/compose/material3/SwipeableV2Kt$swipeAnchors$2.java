...
final class SwipeableV2Kt$swipeAnchors$2 extends Lambda implements Function1<IntSize, Unit> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        m2085invokeozmzZPI(((IntSize) p1).m6008unboximpl());
        return Unit.INSTANCE;
    }

    /* renamed from: invoke-ozmzZPI  reason: not valid java name */
    public final void m2085invokeozmzZPI(long layoutSize) {
        ...
        for (Object it : this.$possibleValues) {
            Float anchorValue = function2.invoke(it, IntSize.m5996boximpl(layoutSize));
            if (anchorValue != null) {
