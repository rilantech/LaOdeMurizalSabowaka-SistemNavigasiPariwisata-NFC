...
public final class IconToggleButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof IconToggleButtonColors) || !Color.m3254equalsimpl0(this.containerColor, ((IconToggleButtonColors) other).containerColor) || !Color.m3254equalsimpl0(this.contentColor, ((IconToggleButtonColors) other).contentColor) || !Color.m3254equalsimpl0(this.disabledContainerColor, ((IconToggleButtonColors) other).disabledContainerColor) || !Color.m3254equalsimpl0(this.disabledContentColor, ((IconToggleButtonColors) other).disabledContentColor) || !Color.m3254equalsimpl0(this.checkedContainerColor, ((IconToggleButtonColors) other).checkedContainerColor) || !Color.m3254equalsimpl0(this.checkedContentColor, ((IconToggleButtonColors) other).checkedContentColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((Color.m3260hashCodeimpl(this.containerColor) * 31) + Color.m3260hashCodeimpl(this.contentColor)) * 31) + Color.m3260hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3260hashCodeimpl(this.disabledContentColor)) * 31) + Color.m3260hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m3260hashCodeimpl(this.checkedContentColor);
    }
}
