...
public final class IconButtonDefaults {
    ...
    public final IconButtonColors m1802iconButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        ...
        if ((i & 2) != 0) {
            ...
            contentColor2 = ((Color) consume).m3263unboximpl();
        } else {
    ...
    public final IconToggleButtonColors m1803iconToggleButtonColors5tl4gsc(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContainerColor2;
        long disabledContentColor2;
        ...
        if ((i & 16) != 0) {
            checkedContainerColor2 = Color.Companion.m3288getTransparent0d7_KjU();
        } else {
    ...
    public final IconButtonColors m1798filledIconButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContainerColor2;
        long disabledContentColor2;
        Composer composer = $composer;
        ...
        if ((i & 4) != 0) {
            disabledContainerColor2 = Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(FilledIconButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i & 8) != 0) {
            disabledContentColor2 = Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(FilledIconButtonTokens.INSTANCE.getDisabledColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledContentColor2 = disabledContentColor;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final IconToggleButtonColors m1799filledIconToggleButtonColors5tl4gsc(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContainerColor2;
        long disabledContentColor2;
        long checkedContainerColor2;
        ...
        if ((i & 32) != 0) {
            checkedContentColor2 = ColorSchemeKt.m1659contentColorForek8zF_U(checkedContainerColor2, composer, (i2 >> 12) & 14);
        } else {
            checkedContentColor2 = checkedContentColor;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final IconButtonColors m1800filledTonalIconButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContainerColor2;
        long disabledContentColor2;
        Composer composer = $composer;
        ...
        if ((i & 4) != 0) {
            disabledContainerColor2 = Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i & 8) != 0) {
            disabledContentColor2 = Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalIconButtonTokens.INSTANCE.getDisabledColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledContentColor2 = disabledContentColor;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final IconToggleButtonColors m1801filledTonalIconToggleButtonColors5tl4gsc(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContainerColor2;
        long disabledContentColor2;
        long checkedContainerColor2;
    ...
    public final IconButtonColors m1804outlinedIconButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContainerColor2;
        long disabledContentColor2;
        Composer composer = $composer;
    ...
    public final IconToggleButtonColors m1805outlinedIconToggleButtonColors5tl4gsc(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContainerColor2;
        long disabledContentColor2;
        long checkedContainerColor2;
    ...
    public final BorderStroke outlinedIconButtonBorder(boolean enabled, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            Object consume = $composer.consume(ContentColorKt.getLocalContentColor());
            ComposerKt.sourceInformationMarkerEnd($composer);
            color = ((Color) consume).m3263unboximpl();
            $composer.endReplaceableGroup();
        } else {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer);
            color = Color.m3252copywmQWz5c$default(((Color) consume2).m3263unboximpl(), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
            $composer.endReplaceableGroup();
        }
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = BorderStrokeKt.m194BorderStrokecXLIe8U(OutlinedIconButtonTokens.INSTANCE.m2606getUnselectedOutlineWidthD9Ej5fM(), color);
