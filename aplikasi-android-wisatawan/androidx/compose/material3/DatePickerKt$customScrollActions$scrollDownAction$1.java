...
final class DatePickerKt$customScrollActions$scrollDownAction$1 extends Lambda implements Function0<Boolean> {
    final /* synthetic */ CoroutineScope $coroutineScope;
    final /* synthetic */ LazyGridState $state;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DatePickerKt$customScrollActions$scrollDownAction$1(LazyGridState lazyGridState, CoroutineScope coroutineScope) {
        super(0);
