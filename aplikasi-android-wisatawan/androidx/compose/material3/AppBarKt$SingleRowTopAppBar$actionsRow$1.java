...
final class AppBarKt$SingleRowTopAppBar$actionsRow$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    AppBarKt$SingleRowTopAppBar$actionsRow$1(Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C1055@48284L157:AppBar.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Function3 content$iv = this.$actions;
            int $changed$iv = ((this.$$dirty >> 6) & 7168) | 432;
