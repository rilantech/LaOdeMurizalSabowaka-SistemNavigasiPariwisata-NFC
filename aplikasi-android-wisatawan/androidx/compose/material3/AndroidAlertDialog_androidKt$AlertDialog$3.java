...
final class AndroidAlertDialog_androidKt$AlertDialog$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            String dialogPaneDescription = Strings_androidKt.m2053getStringNWtq28(Strings.Companion.m2029getDialogadMyvUU(), composer, 6);
            Modifier r5 = SizeKt.m616sizeInqDBjuR0$default(this.$modifier, AlertDialogKt.getDialogMinWidth(), 0.0f, AlertDialogKt.getDialogMaxWidth(), 0.0f, 10, (Object) null);
