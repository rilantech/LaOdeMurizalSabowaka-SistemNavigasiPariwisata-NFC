...
final class TextFieldImplKt$CommonDecorationBox$3$decoratedPrefix$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1425713931, "C151@6421L190:TextFieldImpl.kt#uh7d8r");
            LayoutDirection layoutDirection = layoutDirection$iv$iv;
            Density density = density$iv$iv2;
            TextFieldImplKt.m2137DecorationKTwxG1Y(j, textStyle, function2, $composer2, (i2 >> 18) & 896, 0);
