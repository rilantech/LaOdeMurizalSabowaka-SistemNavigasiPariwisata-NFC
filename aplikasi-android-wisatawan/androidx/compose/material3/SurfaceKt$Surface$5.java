...
final class SurfaceKt$Surface$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    SurfaceKt$Surface$5(Modifier modifier, Shape shape, long j, float f, int i, BorderStroke borderStroke, float f2, boolean z, MutableInteractionSource mutableInteractionSource, boolean z2, Function0<Unit> function0, Function2<? super Composer, ? super Integer, Unit> function2, int i2) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C333@16742L139,343@17154L16,328@16555L799:Surface.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1164547968, i, -1, "androidx.compose.material3.Surface.<anonymous> (Surface.kt:327)");
            }
            Modifier modifier$iv = SelectableKt.m834selectableO2vRcR0$default(SurfaceKt.m2068surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(this.$modifier), this.$shape, SurfaceKt.m2069surfaceColorAtElevationCLU3JFs(this.$color, this.$absoluteElevation, composer, (this.$$changed >> 15) & 14), this.$border, this.$shadowElevation), this.$selected, this.$interactionSource, RippleKt.m1523rememberRipple9IZ8Weo(false, 0.0f, 0, $composer, 0, 7), this.$enabled, (Role) null, this.$onClick, 16, (Object) null);
