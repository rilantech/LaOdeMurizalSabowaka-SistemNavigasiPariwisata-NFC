...
public final class SearchBarColors {
    ...
    private SearchBarColors(long containerColor2, long dividerColor2, TextFieldColors inputFieldColors2) {
    ...
    public final long m1941getContainerColor0d7_KjU() {
        return this.containerColor;
    }

    /* renamed from: getDividerColor-0d7_KjU  reason: not valid java name */
    public final long m1942getDividerColor0d7_KjU() {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m3254equalsimpl0(this.containerColor, ((SearchBarColors) other).containerColor) && Color.m3254equalsimpl0(this.dividerColor, ((SearchBarColors) other).dividerColor) && Intrinsics.areEqual((Object) this.inputFieldColors, (Object) ((SearchBarColors) other).inputFieldColors)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((Color.m3260hashCodeimpl(this.containerColor) * 31) + Color.m3260hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
