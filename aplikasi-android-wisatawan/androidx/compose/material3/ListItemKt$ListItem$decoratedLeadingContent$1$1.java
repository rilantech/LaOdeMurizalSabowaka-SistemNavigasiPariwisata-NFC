...
final class ListItemKt$ListItem$decoratedLeadingContent$1$1 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    ...
    public final void invoke(RowScope $this$null, Composer $composer, int $changed) {
        ...
        if (($dirty & 91) != 18 || !$composer.getSkipping()) {
            ...
            ListItemKt.m1828LeadingContent3IgeMak($this$null, this.$colors.leadingIconColor$material3_release(true, $composer, ((this.$$dirty >> 15) & 112) | 6).getValue().m3263unboximpl(), ListItemType.m1841equalsimpl0(this.$listItemType, ListItemType.Companion.m1848getThreeLineAlXitO8()), this.$it, $composer, $dirty & 14);
            if (ComposerKt.isTraceInProgress()) {
