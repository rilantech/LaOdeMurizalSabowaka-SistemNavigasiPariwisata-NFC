...
public final class DatePickerColors {
    ...
    public final long m1700getDayInSelectionRangeContainerColor0d7_KjU$material3_release() {
    ...
    public final State<Color> dayContentColor$material3_release(boolean isToday, boolean selected, boolean inRange, boolean enabled, Composer $composer, int $changed) {
        ...
        if (inRange) {
            ...
            state = SingleValueAnimationKt.m72animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, $composer, 0, 12);
            $composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> dayContainerColor$material3_release(boolean selected, boolean enabled, boolean animate, Composer $composer, int $changed) {
        ...
        if (selected) {
            ...
            target = Color.Companion.m3288getTransparent0d7_KjU();
        }
        if (animate) {
    ...
    public final State<Color> yearContentColor$material3_release(boolean currentYear, boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> r0 = SingleValueAnimationKt.m72animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, $composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> yearContainerColor$material3_release(boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> r0 = SingleValueAnimationKt.m72animateColorAsStateeuL9pac(selected ? this.selectedYearContainerColor : Color.Companion.m3288getTransparent0d7_KjU(), AnimationSpecKt.tween$default(100, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, $composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        if ((other instanceof DatePickerColors) && Color.m3254equalsimpl0(this.containerColor, ((DatePickerColors) other).containerColor) && Color.m3254equalsimpl0(this.titleContentColor, ((DatePickerColors) other).titleContentColor) && Color.m3254equalsimpl0(this.headlineContentColor, ((DatePickerColors) other).headlineContentColor) && Color.m3254equalsimpl0(this.weekdayContentColor, ((DatePickerColors) other).weekdayContentColor) && Color.m3254equalsimpl0(this.subheadContentColor, ((DatePickerColors) other).subheadContentColor) && Color.m3254equalsimpl0(this.yearContentColor, ((DatePickerColors) other).yearContentColor) && Color.m3254equalsimpl0(this.currentYearContentColor, ((DatePickerColors) other).currentYearContentColor) && Color.m3254equalsimpl0(this.selectedYearContentColor, ((DatePickerColors) other).selectedYearContentColor) && Color.m3254equalsimpl0(this.selectedYearContainerColor, ((DatePickerColors) other).selectedYearContainerColor) && Color.m3254equalsimpl0(this.dayContentColor, ((DatePickerColors) other).dayContentColor) && Color.m3254equalsimpl0(this.disabledDayContentColor, ((DatePickerColors) other).disabledDayContentColor) && Color.m3254equalsimpl0(this.selectedDayContentColor, ((DatePickerColors) other).selectedDayContentColor) && Color.m3254equalsimpl0(this.disabledSelectedDayContentColor, ((DatePickerColors) other).disabledSelectedDayContentColor) && Color.m3254equalsimpl0(this.selectedDayContainerColor, ((DatePickerColors) other).selectedDayContainerColor) && Color.m3254equalsimpl0(this.disabledSelectedDayContainerColor, ((DatePickerColors) other).disabledSelectedDayContainerColor) && Color.m3254equalsimpl0(this.todayContentColor, ((DatePickerColors) other).todayContentColor) && Color.m3254equalsimpl0(this.todayDateBorderColor, ((DatePickerColors) other).todayDateBorderColor) && Color.m3254equalsimpl0(this.dayInSelectionRangeContainerColor, ((DatePickerColors) other).dayInSelectionRangeContainerColor) && Color.m3254equalsimpl0(this.dayInSelectionRangeContentColor, ((DatePickerColors) other).dayInSelectionRangeContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((Color.m3260hashCodeimpl(this.containerColor) * 31) + Color.m3260hashCodeimpl(this.titleContentColor)) * 31) + Color.m3260hashCodeimpl(this.headlineContentColor)) * 31) + Color.m3260hashCodeimpl(this.weekdayContentColor)) * 31) + Color.m3260hashCodeimpl(this.subheadContentColor)) * 31) + Color.m3260hashCodeimpl(this.yearContentColor)) * 31) + Color.m3260hashCodeimpl(this.currentYearContentColor)) * 31) + Color.m3260hashCodeimpl(this.selectedYearContentColor)) * 31) + Color.m3260hashCodeimpl(this.selectedYearContainerColor)) * 31) + Color.m3260hashCodeimpl(this.dayContentColor)) * 31) + Color.m3260hashCodeimpl(this.disabledDayContentColor)) * 31) + Color.m3260hashCodeimpl(this.selectedDayContentColor)) * 31) + Color.m3260hashCodeimpl(this.disabledSelectedDayContentColor)) * 31) + Color.m3260hashCodeimpl(this.selectedDayContainerColor)) * 31) + Color.m3260hashCodeimpl(this.disabledSelectedDayContainerColor)) * 31) + Color.m3260hashCodeimpl(this.todayContentColor)) * 31) + Color.m3260hashCodeimpl(this.todayDateBorderColor)) * 31) + Color.m3260hashCodeimpl(this.dayInSelectionRangeContainerColor)) * 31) + Color.m3260hashCodeimpl(this.dayInSelectionRangeContentColor);
    }
}
