...
public final class SelectableChipColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof SelectableChipColors) || !Color.m3254equalsimpl0(this.containerColor, ((SelectableChipColors) other).containerColor) || !Color.m3254equalsimpl0(this.labelColor, ((SelectableChipColors) other).labelColor) || !Color.m3254equalsimpl0(this.leadingIconColor, ((SelectableChipColors) other).leadingIconColor) || !Color.m3254equalsimpl0(this.trailingIconColor, ((SelectableChipColors) other).trailingIconColor) || !Color.m3254equalsimpl0(this.disabledContainerColor, ((SelectableChipColors) other).disabledContainerColor) || !Color.m3254equalsimpl0(this.disabledLabelColor, ((SelectableChipColors) other).disabledLabelColor) || !Color.m3254equalsimpl0(this.disabledLeadingIconColor, ((SelectableChipColors) other).disabledLeadingIconColor) || !Color.m3254equalsimpl0(this.disabledTrailingIconColor, ((SelectableChipColors) other).disabledTrailingIconColor) || !Color.m3254equalsimpl0(this.selectedContainerColor, ((SelectableChipColors) other).selectedContainerColor) || !Color.m3254equalsimpl0(this.disabledSelectedContainerColor, ((SelectableChipColors) other).disabledSelectedContainerColor) || !Color.m3254equalsimpl0(this.selectedLabelColor, ((SelectableChipColors) other).selectedLabelColor) || !Color.m3254equalsimpl0(this.selectedLeadingIconColor, ((SelectableChipColors) other).selectedLeadingIconColor) || !Color.m3254equalsimpl0(this.selectedTrailingIconColor, ((SelectableChipColors) other).selectedTrailingIconColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((((((Color.m3260hashCodeimpl(this.containerColor) * 31) + Color.m3260hashCodeimpl(this.labelColor)) * 31) + Color.m3260hashCodeimpl(this.leadingIconColor)) * 31) + Color.m3260hashCodeimpl(this.trailingIconColor)) * 31) + Color.m3260hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3260hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m3260hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m3260hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m3260hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m3260hashCodeimpl(this.disabledSelectedContainerColor)) * 31) + Color.m3260hashCodeimpl(this.selectedLabelColor)) * 31) + Color.m3260hashCodeimpl(this.selectedLeadingIconColor)) * 31) + Color.m3260hashCodeimpl(this.selectedTrailingIconColor);
    }
}
