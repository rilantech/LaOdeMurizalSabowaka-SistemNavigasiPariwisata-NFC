...
final class NavigationBarKt$NavigationBarItem$3$indicator$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            BoxKt.Box(BackgroundKt.m166backgroundbw27NRU(LayoutIdKt.layoutId(Modifier.Companion, "indicator"), Color.m3252copywmQWz5c$default(this.$colors.m1862getIndicatorColor0d7_KjU$material3_release(), NavigationBarKt.NavigationBarItem$lambda$9$lambda$6(this.$animationProgress$delegate), 0.0f, 0.0f, 0.0f, 14, (Object) null), ShapesKt.toShape(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), $composer, 6)), $composer, 0);
            if (ComposerKt.isTraceInProgress()) {
