...
final class AppBarKt$TopAppBarLayout$2 implements MeasurePolicy {
    ...
    public final MeasureResult m1546measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        int maxTitleWidth;
        int titleBaseline;
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv), (Object) "navigationIcon")) {
                Placeable navigationIconPlaceable = ((Measurable) element$iv).m4689measureBRTryo0(Constraints.m5779copyZbe2FdA$default(constraints, 0, 0, 0, 0, 14, (Object) null));
                for (Object element$iv2 : $this$first$iv) {
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv2), (Object) "actionIcons")) {
                        Placeable actionIconsPlaceable = ((Measurable) element$iv2).m4689measureBRTryo0(Constraints.m5779copyZbe2FdA$default(constraints, 0, 0, 0, 0, 14, (Object) null));
                        if (Constraints.m5788getMaxWidthimpl(constraints) == Integer.MAX_VALUE) {
                            maxTitleWidth = Constraints.m5788getMaxWidthimpl(constraints);
                        } else {
                            maxTitleWidth = RangesKt.coerceAtLeast((Constraints.m5788getMaxWidthimpl(constraints) - navigationIconPlaceable.getWidth()) - actionIconsPlaceable.getWidth(), 0);
                        }
                        for (Object element$iv3 : $this$first$iv) {
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv3), (Object) "title")) {
                                Placeable titlePlaceable = ((Measurable) element$iv3).m4689measureBRTryo0(Constraints.m5779copyZbe2FdA$default(constraints, 0, maxTitleWidth, 0, 0, 12, (Object) null));
