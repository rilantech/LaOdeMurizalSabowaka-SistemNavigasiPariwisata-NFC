...
final class NavigationDrawerKt$NavigationDrawerItem$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = PaddingKt.m542paddingqDBjuR0$default(Modifier.Companion, Dp.m5844constructorimpl((float) 16), 0.0f, Dp.m5844constructorimpl((float) 24), 0.0f, 10, (Object) null);
            ...
            if (function2 != null) {
                ...
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3243boximpl(navigationDrawerItemColors.iconColor(z, $composer2, ((i2 >> 3) & 14) | ((i2 >> 18) & 112)).getValue().m3263unboximpl()))}, (Function2<? super Composer, ? super Integer, Unit>) function2, $composer2, ((i2 >> 9) & 112) | 8);
                SpacerKt.Spacer(SizeKt.m617width3ABfNKs(Modifier.Companion, Dp.m5844constructorimpl((float) 12)), $composer2, 6);
            }
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3243boximpl(navigationDrawerItemColors.textColor(z, $composer3, i10).getValue().m3263unboximpl()))}, (Function2<? super Composer, ? super Integer, Unit>) function23, $composer3, ((i2 << 3) & 112) | 8);
            ...
            if (function24 != null) {
                SpacerKt.Spacer(SizeKt.m617width3ABfNKs(Modifier.Companion, Dp.m5844constructorimpl((float) 12)), $composer2, 6);
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3243boximpl(navigationDrawerItemColors.badgeColor(z, $composer2, i10).getValue().m3263unboximpl()))}, (Function2<? super Composer, ? super Integer, Unit>) function24, $composer2, ((i2 >> 12) & 112) | 8);
            }
            $composer2.endReplaceableGroup();
            ComposerKt.sourceInformationMarkerEnd($composer2);
