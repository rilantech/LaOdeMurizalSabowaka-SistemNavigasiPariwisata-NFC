...
public final class NavigationBarItemDefaults {
    ...
    public final NavigationBarItemColors m1863colors69fazGs(long selectedIconColor, long selectedTextColor, long indicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor, Composer $composer, int $changed, int i) {
        ...
        if ((i & 32) != 0) {
            disabledIconColor2 = Color.m3252copywmQWz5c$default(unselectedIconColor2, 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledIconColor2 = disabledIconColor;
        }
        if ((i & 64) != 0) {
            disabledTextColor2 = Color.m3252copywmQWz5c$default(unselectedTextColor2, 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
    ...
    public final /* synthetic */ NavigationBarItemColors m1864colorszjMxDiM(long selectedIconColor, long selectedTextColor, long indicatorColor, long unselectedIconColor, long unselectedTextColor, Composer $composer, int $changed, int i) {
        long selectedTextColor2;
        long indicatorColor2;
        long unselectedIconColor2;
        long unselectedTextColor2;
        ...
        NavigationBarItemColors navigationBarItemColors = new NavigationBarItemColors(selectedIconColor2, selectedTextColor2, indicatorColor2, unselectedIconColor2, unselectedTextColor2, Color.m3252copywmQWz5c$default(unselectedIconColor2, 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null), Color.m3252copywmQWz5c$default(unselectedTextColor2, 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null), (DefaultConstructorMarker) null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
