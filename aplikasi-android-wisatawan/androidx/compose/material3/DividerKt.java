...
public final class DividerKt {
    ...
    public static final void m1741Divider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        float f;
        long j;
        long color2;
        ...
        if (($dirty & 731) != 146 || !$composer2.getSkipping()) {
            ...
            if ((i3 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    thickness3 = DividerDefaults.INSTANCE.m1740getThicknessD9Ej5fM();
                } else {
                    thickness3 = f;
                }
                if ((i & 4) != 0) {
            ...
            BoxKt.Box(BackgroundKt.m167backgroundbw27NRU$default(SizeKt.m598height3ABfNKs(SizeKt.fillMaxWidth$default(modifier4, 0.0f, 1, (Object) null), targetThickness), color3, (Shape) null, 2, (Object) null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
