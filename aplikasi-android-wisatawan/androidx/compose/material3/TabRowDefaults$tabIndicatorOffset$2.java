...
final class TabRowDefaults$tabIndicatorOffset$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    private static final float invoke$lambda$0(State<Dp> $currentTabWidth$delegate) {
        return ((Dp) $currentTabWidth$delegate.getValue()).m5858unboximpl();
    }
    ...
    public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
        ...
        State currentTabWidth$delegate = AnimateAsStateKt.m87animateDpAsStateAjpBEmI(this.$currentTabPosition.m2101getWidthD9Ej5fM(), AnimationSpecKt.tween$default(ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, 0, EasingKt.getFastOutSlowInEasing(), 2, (Object) null), (String) null, (Function1<? super Dp, Unit>) null, composer2, 0, 12);
        Modifier r3 = SizeKt.m617width3ABfNKs(OffsetKt.m497offsetVpY3zN4$default(SizeKt.wrapContentSize$default(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, (Object) null), Alignment.Companion.getBottomStart(), false, 2, (Object) null), invoke$lambda$1(AnimateAsStateKt.m87animateDpAsStateAjpBEmI(this.$currentTabPosition.m2099getLeftD9Ej5fM(), AnimationSpecKt.tween$default(ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, 0, EasingKt.getFastOutSlowInEasing(), 2, (Object) null), (String) null, (Function1<? super Dp, Unit>) null, composer2, 0, 12)), 0.0f, 2, (Object) null), invoke$lambda$0(currentTabWidth$delegate));
        if (ComposerKt.isTraceInProgress()) {
    ...
    private static final float invoke$lambda$1(State<Dp> $indicatorOffset$delegate) {
        return ((Dp) $indicatorOffset$delegate.getValue()).m5858unboximpl();
    }
}
