...
public final class SheetDefaultsKt {
    private static final float BottomSheetMaxWidth = Dp.m5844constructorimpl((float) 640);
    /* access modifiers changed from: private */
    public static final float DragHandleVerticalPadding = Dp.m5844constructorimpl((float) 22);
