...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public final long m1852getSizeMYxV2XQ() {
        return this.size;
    }

    /* renamed from: measure-3p2s80s  reason: not valid java name */
    public MeasureResult m1853measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
