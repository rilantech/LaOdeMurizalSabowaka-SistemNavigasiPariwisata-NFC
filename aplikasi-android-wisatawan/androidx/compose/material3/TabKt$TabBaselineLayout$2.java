...
final class TabKt$TabBaselineLayout$2 implements MeasurePolicy {
    ...
    public final MeasureResult m2098measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        Placeable placeable;
        ...
        if (this.$text != null) {
            for (Object element$iv : $this$first$iv) {
                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv), (Object) "text")) {
                    placeable = ((Measurable) element$iv).m4689measureBRTryo0(Constraints.m5779copyZbe2FdA$default(constraints, 0, 0, 0, 0, 11, (Object) null));
                }
            }
        ...
        if (this.$icon != null) {
            for (Object element$iv2 : $this$first$iv) {
                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv2), (Object) "icon")) {
                    placeable2 = ((Measurable) element$iv2).m4689measureBRTryo0(constraints);
                } else {
                    long j = constraints;
                }
            }
        ...
        int specHeight = measureScope.m5819roundToPx0680j_4(f);
        int height = iconPlaceable != null ? iconPlaceable.getHeight() : 0;
        if (textPlaceable != null) {
            i = textPlaceable.getHeight();
        }
        int tabHeight = Math.max(specHeight, height + i + measureScope.m5818roundToPxR2X_6o(TabKt.IconDistanceFromBaseline));
        int i2 = specHeight;
