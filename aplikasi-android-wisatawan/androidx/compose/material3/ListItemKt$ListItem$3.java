...
final class ListItemKt$ListItem$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = SemanticsModifierKt.semantics(PaddingKt.padding(SizeKt.m600heightInVpY3zN4$default(Modifier.Companion, this.$minHeight, 0.0f, 2, (Object) null), this.$paddingValues), true, AnonymousClass1.INSTANCE);
