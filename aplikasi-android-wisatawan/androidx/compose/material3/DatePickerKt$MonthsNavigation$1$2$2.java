...
final class DatePickerKt$MonthsNavigation$1$2$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            IconKt.m1808Iconww6aTOc(imageVector, Strings_androidKt.m2053getStringNWtq28(Strings.Companion.m2014getDatePickerSwitchToNextMonthadMyvUU(), $composer, 6), (Modifier) null, 0, $composer, 0, 12);
            if (ComposerKt.isTraceInProgress()) {
