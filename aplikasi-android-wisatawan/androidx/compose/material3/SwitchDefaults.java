...
public final class SwitchDefaults {
    ...
    public final SwitchColors m2088colorsV1nXRL4(long checkedThumbColor, long checkedTrackColor, long checkedBorderColor, long checkedIconColor, long uncheckedThumbColor, long uncheckedTrackColor, long uncheckedBorderColor, long uncheckedIconColor, long disabledCheckedThumbColor, long disabledCheckedTrackColor, long disabledCheckedBorderColor, long disabledCheckedIconColor, long disabledUncheckedThumbColor, long disabledUncheckedTrackColor, long disabledUncheckedBorderColor, long disabledUncheckedIconColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        if ((i2 & 4) != 0) {
            checkedBorderColor2 = Color.Companion.m3288getTransparent0d7_KjU();
        } else {
        ...
        if ((i2 & 256) != 0) {
            disabledCheckedThumbColor2 = ColorKt.m3298compositeOverOWjLjI(Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(SwitchTokens.INSTANCE.getDisabledSelectedHandleColor(), composer, 6), 1.0f, 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1623getSurface0d7_KjU());
        } else {
            disabledCheckedThumbColor2 = disabledCheckedThumbColor;
        }
        if ((i2 & 512) != 0) {
            disabledCheckedTrackColor2 = ColorKt.m3298compositeOverOWjLjI(Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(SwitchTokens.INSTANCE.getDisabledSelectedTrackColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1623getSurface0d7_KjU());
        } else {
            disabledCheckedTrackColor2 = disabledCheckedTrackColor;
        }
        if ((i2 & 1024) != 0) {
            disabledCheckedBorderColor2 = Color.Companion.m3288getTransparent0d7_KjU();
        } else {
            disabledCheckedBorderColor2 = disabledCheckedBorderColor;
        }
        if ((i2 & 2048) != 0) {
            disabledCheckedIconColor2 = ColorKt.m3298compositeOverOWjLjI(Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(SwitchTokens.INSTANCE.getDisabledSelectedIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1623getSurface0d7_KjU());
        } else {
            disabledCheckedIconColor2 = disabledCheckedIconColor;
        }
        if ((i2 & 4096) != 0) {
            disabledUncheckedThumbColor2 = ColorKt.m3298compositeOverOWjLjI(Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(SwitchTokens.INSTANCE.getDisabledUnselectedHandleColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1623getSurface0d7_KjU());
        } else {
            disabledUncheckedThumbColor2 = disabledUncheckedThumbColor;
        }
        if ((i2 & 8192) != 0) {
            disabledUncheckedTrackColor2 = ColorKt.m3298compositeOverOWjLjI(Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(SwitchTokens.INSTANCE.getDisabledUnselectedTrackColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1623getSurface0d7_KjU());
        } else {
            disabledUncheckedTrackColor2 = disabledUncheckedTrackColor;
        }
        if ((i2 & 16384) != 0) {
            disabledUncheckedBorderColor2 = ColorKt.m3298compositeOverOWjLjI(Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(SwitchTokens.INSTANCE.getDisabledUnselectedTrackOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1623getSurface0d7_KjU());
        } else {
            disabledUncheckedBorderColor2 = disabledUncheckedBorderColor;
        }
        if ((i2 & 32768) != 0) {
            disabledUncheckedIconColor2 = ColorKt.m3298compositeOverOWjLjI(Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(SwitchTokens.INSTANCE.getDisabledUnselectedIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1623getSurface0d7_KjU());
        } else {
    ...
    public final float m2089getIconSizeD9Ej5fM() {
        return IconSize;
    }
}
