...
final class AlertDialogKt$AlertDialogContent$1$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    AlertDialogKt$AlertDialogContent$1$1$1$1(ColumnScope columnScope, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C62@2180L229:AlertDialog.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = this.$this_Column.align(PaddingKt.padding(Modifier.Companion, AlertDialogKt.IconPadding), Alignment.Companion.getCenterHorizontally());
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 691155642, "C67@2381L6:AlertDialog.kt#uh7d8r");
