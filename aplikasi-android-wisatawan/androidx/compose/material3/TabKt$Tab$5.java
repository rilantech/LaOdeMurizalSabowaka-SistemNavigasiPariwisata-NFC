...
final class TabKt$Tab$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier fillMaxWidth$default = SizeKt.fillMaxWidth$default(SelectableKt.m833selectableO2vRcR0(this.$modifier, this.$selected, this.$interactionSource, this.$ripple, this.$enabled, Role.m5155boximpl(Role.Companion.m5168getTabo7Vup1c()), this.$onClick), 0.0f, 1, (Object) null);
