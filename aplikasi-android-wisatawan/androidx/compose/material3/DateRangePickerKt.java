...
public final class DateRangePickerKt {
    private static final PaddingValues CalendarMonthSubheadPadding = PaddingKt.m535PaddingValuesa9UjIt4$default(Dp.m5844constructorimpl((float) 24), Dp.m5844constructorimpl((float) 20), 0.0f, Dp.m5844constructorimpl((float) 8), 4, (Object) null);
    /* access modifiers changed from: private */
    public static final PaddingValues DateRangePickerHeadlinePadding = PaddingKt.m535PaddingValuesa9UjIt4$default(Dp.m5844constructorimpl((float) 64), 0.0f, Dp.m5844constructorimpl((float) 12), Dp.m5844constructorimpl((float) 12), 2, (Object) null);
    /* access modifiers changed from: private */
    public static final PaddingValues DateRangePickerTitlePadding = PaddingKt.m535PaddingValuesa9UjIt4$default(Dp.m5844constructorimpl((float) 64), 0.0f, Dp.m5844constructorimpl((float) 12), 0.0f, 10, (Object) null);
    private static final float HeaderHeightOffset = Dp.m5844constructorimpl((float) 60);
    ...
    public static final DateRangePickerState m1718rememberDateRangePickerStatepMw4iz8(Long initialSelectedStartDateMillis, Long initialSelectedEndDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode, Composer $composer, int $changed, int i) {
    ...
    public static final void SwitchableDateEntryContent(DateRangePickerState state, DatePickerFormatter dateFormatter, Function1<? super Long, Boolean> dateValidator, DatePickerColors colors, Composer $composer, int $changed) {
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            int r0 = state.m1721getDisplayModejFl4v0();
    ...
    public static final void DateRangePickerContent(StateData stateData, DatePickerFormatter dateFormatter, Function1<? super Long, Boolean> dateValidator, DatePickerColors colors, Composer $composer, int $changed) {
        ...
        if (($dirty2 & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            Modifier modifier$iv = PaddingKt.m540paddingVpY3zN4$default(Modifier.Companion, DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, (Object) null);
    ...
    public static final void m1717drawRangeBackgroundmxwnekA(ContentDrawScope $this$drawRangeBackground_u2dmxwnekA, SelectedRangeInfo selectedRangeInfo, long color) {
        float f;
        ...
        float itemContainerWidth = contentDrawScope.m5825toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float itemContainerHeight = contentDrawScope.m5825toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float itemStateLayerHeight = contentDrawScope.m5825toPx0680j_4(DatePickerModalTokens.INSTANCE.m2388getDateStateLayerHeightD9Ej5fM());
        float f2 = (float) 2;
        float stateLayerVerticalPadding = (itemContainerHeight - itemStateLayerHeight) / f2;
        float f3 = (float) 7;
        float horizontalSpaceBetweenItems = (Size.m3072getWidthimpl($this$drawRangeBackground_u2dmxwnekA.m3866getSizeNHjbRc()) - (f3 * itemContainerWidth)) / f3;
        long r8 = selectedRangeInfo.getGridCoordinates().getFirst().m5971unboximpl();
        int x1 = IntOffset.m5954component1impl(r8);
        int y1 = IntOffset.m5955component2impl(r8);
        long r11 = selectedRangeInfo.getGridCoordinates().getSecond().m5971unboximpl();
        int x2 = IntOffset.m5954component1impl(r11);
        int y2 = IntOffset.m5955component2impl(r11);
        ...
        if (isRtl) {
            startX = Size.m3072getWidthimpl($this$drawRangeBackground_u2dmxwnekA.m3866getSizeNHjbRc()) - startX;
            endX = Size.m3072getWidthimpl($this$drawRangeBackground_u2dmxwnekA.m3866getSizeNHjbRc()) - endX;
        }
        ...
        if (y1 == y2) {
            ...
            f = Size.m3072getWidthimpl($this$drawRangeBackground_u2dmxwnekA.m3866getSizeNHjbRc()) - startX;
        }
        DrawScope.m3842drawRectnJ9OG0$default(drawScope, color, Offset, SizeKt.Size(f, itemStateLayerHeight), 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 120, (Object) null);
        if (y1 != y2) {
            int y = (y2 - y1) - 1;
            while (y > 0) {
                DrawScope.m3842drawRectnJ9OG0$default(contentDrawScope, color, OffsetKt.Offset(0.0f, (((float) y) * itemContainerHeight) + startY), SizeKt.Size(Size.m3072getWidthimpl($this$drawRangeBackground_u2dmxwnekA.m3866getSizeNHjbRc()), itemStateLayerHeight), 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 120, (Object) null);
                y--;
                SelectedRangeInfo selectedRangeInfo2 = selectedRangeInfo;
                itemContainerHeight = itemContainerHeight;
            }
            DrawScope.m3842drawRectnJ9OG0$default(contentDrawScope, color, OffsetKt.Offset($this$drawRangeBackground_u2dmxwnekA.getLayoutDirection() == LayoutDirection.Ltr ? 0.0f : Size.m3072getWidthimpl($this$drawRangeBackground_u2dmxwnekA.m3866getSizeNHjbRc()), endY), SizeKt.Size(isRtl ? endX - Size.m3072getWidthimpl($this$drawRangeBackground_u2dmxwnekA.m3866getSizeNHjbRc()) : endX, itemStateLayerHeight), 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 120, (Object) null);
            return;
        }
    }
