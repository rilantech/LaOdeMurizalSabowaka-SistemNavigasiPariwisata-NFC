...
public final class FixedThreshold implements ThresholdConfig {
    ...
    private final float m1785component1D9Ej5fM() {
        return this.offset;
    }

    /* renamed from: copy-0680j_4$default  reason: not valid java name */
    public static /* synthetic */ FixedThreshold m1786copy0680j_4$default(FixedThreshold fixedThreshold, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = fixedThreshold.offset;
        }
        return fixedThreshold.m1787copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4  reason: not valid java name */
    public final FixedThreshold m1787copy0680j_4(float f) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof FixedThreshold) && Dp.m5849equalsimpl0(this.offset, ((FixedThreshold) obj).offset);
    }
    ...
    public String toString() {
        return "FixedThreshold(offset=" + Dp.m5855toStringimpl(this.offset) + ')';
    }
    ...
    public float computeThreshold(Density $this$computeThreshold, float fromValue, float toValue) {
        ...
        return ($this$computeThreshold.m5825toPx0680j_4(this.offset) * Math.signum(toValue - fromValue)) + fromValue;
    }
}
