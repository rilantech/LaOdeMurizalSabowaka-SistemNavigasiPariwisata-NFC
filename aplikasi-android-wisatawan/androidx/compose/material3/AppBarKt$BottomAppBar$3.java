...
final class AppBarKt$BottomAppBar$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = PaddingKt.padding(SizeKt.m598height3ABfNKs(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, (Object) null), this.$windowInsets), BottomAppBarTokens.INSTANCE.m2297getContainerHeightD9Ej5fM()), this.$contentPadding);
