...
public final class ListItemColors {
    ...
    private ListItemColors(long containerColor2, long headlineColor2, long leadingIconColor2, long overlineColor2, long supportingTextColor2, long trailingIconColor2, long disabledHeadlineColor2, long disabledLeadingIconColor2, long disabledTrailingIconColor2) {
        this.containerColor = containerColor2;
        this.headlineColor = headlineColor2;
        this.leadingIconColor = leadingIconColor2;
        this.overlineColor = overlineColor2;
        this.supportingTextColor = supportingTextColor2;
        this.trailingIconColor = trailingIconColor2;
        this.disabledHeadlineColor = disabledHeadlineColor2;
    ...
    public final State<Color> containerColor$material3_release(Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(this.containerColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> headlineColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(enabled ? this.headlineColor : this.disabledHeadlineColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> overlineColor$material3_release(Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(this.overlineColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> supportingColor$material3_release(Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(this.supportingTextColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
