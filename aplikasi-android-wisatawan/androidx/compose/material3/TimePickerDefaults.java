...
public final class TimePickerDefaults {
    ...
    public final TimePickerColors m2160colorsu3YEpmA(long clockDialColor, long clockDialSelectedContentColor, long clockDialUnselectedContentColor, long selectorColor, long containerColor, long periodSelectorBorderColor, long periodSelectorSelectedContainerColor, long periodSelectorUnselectedContainerColor, long periodSelectorSelectedContentColor, long periodSelectorUnselectedContentColor, long timeSelectorSelectedContainerColor, long timeSelectorUnselectedContainerColor, long timeSelectorSelectedContentColor, long timeSelectorUnselectedContentColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        long clockDialColor2 = (i2 & 1) != 0 ? ColorSchemeKt.toColor(TimePickerTokens.INSTANCE.getClockDialColor(), composer, 6) : clockDialColor;
        if ((i2 & 2) != 0) {
        ...
        if ((i2 & 128) != 0) {
            periodSelectorUnselectedContainerColor2 = Color.Companion.m3288getTransparent0d7_KjU();
        } else {
    ...
    public final int m2161layoutTypesDNSZnc(Composer $composer, int $changed) {
