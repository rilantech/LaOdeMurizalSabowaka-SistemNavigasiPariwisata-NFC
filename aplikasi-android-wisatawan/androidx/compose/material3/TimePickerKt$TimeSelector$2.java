...
final class TimePickerKt$TimeSelector$2 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        if (!Selection.m1956equalsimpl0(this.$selection, this.$state.m2191getSelectionJiIwxys$material3_release())) {
            this.$state.m2194setSelectioniHAOin8$material3_release(this.$selection);
