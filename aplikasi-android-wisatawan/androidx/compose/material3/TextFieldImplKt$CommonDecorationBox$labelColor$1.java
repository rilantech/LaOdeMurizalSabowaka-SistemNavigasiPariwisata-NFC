...
final class TextFieldImplKt$CommonDecorationBox$labelColor$1 extends Lambda implements Function3<InputPhase, Composer, Integer, Color> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2, Object p3) {
        return Color.m3243boximpl(m2140invokeXeAY9LY((InputPhase) p1, (Composer) p2, ((Number) p3).intValue()));
    }

    /* renamed from: invoke-XeAY9LY  reason: not valid java name */
    public final long m2140invokeXeAY9LY(InputPhase it, Composer $composer, int $changed) {
        ...
        int i = this.$$dirty1;
        long r0 = textFieldColors.labelColor$material3_release(z, z2, interactionSource, $composer, ((i >> 6) & 14) | ((i >> 6) & 112) | ((i >> 6) & 896) | ((i >> 9) & 7168)).getValue().m3263unboximpl();
        if (ComposerKt.isTraceInProgress()) {
