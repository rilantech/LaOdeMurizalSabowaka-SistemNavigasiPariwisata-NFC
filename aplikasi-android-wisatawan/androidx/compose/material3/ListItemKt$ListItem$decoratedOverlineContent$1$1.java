...
final class ListItemKt$ListItem$decoratedOverlineContent$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            ListItemKt.m1831ProvideTextStyleFromToken3JVO9M(this.$colors.overlineColor$material3_release($composer, (this.$$dirty >> 18) & 14).getValue().m3263unboximpl(), ListTokens.INSTANCE.getListItemOverlineFont(), this.$it, $composer, 48);
            if (ComposerKt.isTraceInProgress()) {
