...
final class ChipKt$ChipContent$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = PaddingKt.padding(SizeKt.m597defaultMinSizeVpY3zN4$default(Modifier.Companion, 0.0f, this.$minHeight, 1, (Object) null), this.$paddingValues);
            ...
            if (function2 != null) {
                ...
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3243boximpl(j))}, (Function2<? super Composer, ? super Integer, Unit>) function22, $composer2, ((i2 >> 6) & 112) | 8);
                $composer2.endReplaceableGroup();
            } else {
                $composer2.startReplaceableGroup(650988269);
                $composer2.endReplaceableGroup();
            }
            SpacerKt.Spacer(SizeKt.m617width3ABfNKs(Modifier.Companion, ChipKt.HorizontalElementsPadding), $composer2, 6);
            ...
            if (function24 != null) {
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3243boximpl(j3))}, (Function2<? super Composer, ? super Integer, Unit>) function24, $composer2, ((i2 >> 12) & 112) | 8);
            }
            $composer2.endReplaceableGroup();
