...
public final class BottomAppBarDefaults {
    ...
    private static final float ContainerElevation = BottomAppBarTokens.INSTANCE.m2296getContainerElevationD9Ej5fM();
    private static final PaddingValues ContentPadding = PaddingKt.m535PaddingValuesa9UjIt4$default(AppBarKt.BottomAppBarHorizontalPadding, AppBarKt.getBottomAppBarVerticalPadding(), AppBarKt.BottomAppBarHorizontalPadding, 0.0f, 8, (Object) null);
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets r0 = WindowInsetsKt.m641onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, $composer, 8), WindowInsetsSides.m655plusgK_yJZ4(WindowInsetsSides.Companion.m665getHorizontalJoeWqyM(), WindowInsetsSides.Companion.m663getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
