...
public final class MenuItemColors {
    ...
    public final State<Color> leadingIconColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(enabled ? this.leadingIconColor : this.disabledLeadingIconColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> trailingIconColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(enabled ? this.trailingIconColor : this.disabledTrailingIconColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof MenuItemColors) || !Color.m3254equalsimpl0(this.textColor, ((MenuItemColors) other).textColor) || !Color.m3254equalsimpl0(this.leadingIconColor, ((MenuItemColors) other).leadingIconColor) || !Color.m3254equalsimpl0(this.trailingIconColor, ((MenuItemColors) other).trailingIconColor) || !Color.m3254equalsimpl0(this.disabledTextColor, ((MenuItemColors) other).disabledTextColor) || !Color.m3254equalsimpl0(this.disabledLeadingIconColor, ((MenuItemColors) other).disabledLeadingIconColor) || !Color.m3254equalsimpl0(this.disabledTrailingIconColor, ((MenuItemColors) other).disabledTrailingIconColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((Color.m3260hashCodeimpl(this.textColor) * 31) + Color.m3260hashCodeimpl(this.leadingIconColor)) * 31) + Color.m3260hashCodeimpl(this.trailingIconColor)) * 31) + Color.m3260hashCodeimpl(this.disabledTextColor)) * 31) + Color.m3260hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m3260hashCodeimpl(this.disabledTrailingIconColor);
    }
}
