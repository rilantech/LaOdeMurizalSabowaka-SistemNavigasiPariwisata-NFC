...
public final class ListItemDefaults {
    ...
    private static final float Elevation = ListTokens.INSTANCE.m2548getListItemContainerElevationD9Ej5fM();
    ...
    public final ListItemColors m1826colorsJ08w3E(long containerColor, long headlineColor, long leadingIconColor, long overlineColor, long supportingColor, long trailingIconColor, long disabledHeadlineColor, long disabledLeadingIconColor, long disabledTrailingIconColor, Composer $composer, int $changed, int i) {
        long headlineColor2;
        ...
        if ((i2 & 64) != 0) {
            disabledHeadlineColor2 = Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(ListTokens.INSTANCE.getListItemDisabledLabelTextColor(), composer, 6), ListTokens.INSTANCE.getListItemDisabledLabelTextOpacity(), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledHeadlineColor2 = disabledHeadlineColor;
        }
        if ((i2 & 128) != 0) {
            disabledLeadingIconColor2 = Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(ListTokens.INSTANCE.getListItemDisabledLeadingIconColor(), composer, 6), ListTokens.INSTANCE.getListItemDisabledLeadingIconOpacity(), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledLeadingIconColor2 = disabledLeadingIconColor;
        }
        if ((i2 & 256) != 0) {
            disabledTrailingIconColor2 = Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(ListTokens.INSTANCE.getListItemDisabledTrailingIconColor(), composer, 6), ListTokens.INSTANCE.getListItemDisabledTrailingIconOpacity(), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
