...
public final class SwipeableV2Kt {
    ...
    public static final <T> SwipeableV2State<T> rememberSwipeableV2State(T initialValue, AnimationSpec<Float> animationSpec, Function1<? super T, Boolean> confirmValueChange, Composer $composer, int $changed, int i) {
        ...
        SwipeableV2State<T> swipeableV2State = (SwipeableV2State) RememberSaveableKt.rememberSaveable(new Object[]{initialValue, animationSpec2, confirmValueChange2}, SwipeableV2State.Companion.m2087SavereqLRuRQ(animationSpec2, confirmValueChange2, SwipeableV2Defaults.INSTANCE.getPositionalThreshold(), SwipeableV2Defaults.INSTANCE.m2083getVelocityThresholdD9Ej5fM()), (String) null, new SwipeableV2Kt$rememberSwipeableV2State$2(initialValue, animationSpec2, confirmValueChange2), $composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final Function2<Density, Float, Float> m2084fixedPositionalThreshold0680j_4(float threshold) {
