...
final class SearchBarKt$SearchBar$topPadding$1$1 extends Lambda implements Function0<Dp> {
    ...
    public /* bridge */ /* synthetic */ Object invoke() {
        return Dp.m5842boximpl(m1952invokeD9Ej5fM());
    }

    /* renamed from: invoke-D9Ej5fM  reason: not valid java name */
    public final float m1952invokeD9Ej5fM() {
        return Dp.m5844constructorimpl(SearchBarKt.getSearchBarVerticalPadding() + WindowInsetsKt.asPaddingValues(this.$unconsumedInsets, this.$density).m555calculateTopPaddingD9Ej5fM());
    }
}
