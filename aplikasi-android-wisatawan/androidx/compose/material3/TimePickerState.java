...
public final class TimePickerState {
    ...
    public TimePickerState(int initialHour, int initialMinute, boolean is24Hour) {
        ...
        if (initialHour >= 0 && initialHour < 24) {
            if (initialMinute >= 0 && initialMinute < 60) {
                ...
                this.center$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m5953boximpl(IntOffset.Companion.m5972getZeronOccac()), (SnapshotMutationPolicy) null, 2, (Object) null);
                this.selection$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Selection.m1953boximpl(Selection.Companion.m1960getHourJiIwxys()), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public final long m2192getSelectorPosRKDOV3M$material3_release() {
        return ((DpOffset) this.selectorPos$delegate.getValue()).m5913unboximpl();
    }

    /* renamed from: getCenter-nOcc-ac$material3_release  reason: not valid java name */
    public final long m2190getCenternOccac$material3_release() {
        return ((IntOffset) this.center$delegate.getValue()).m5971unboximpl();
    }

    /* renamed from: setCenter--gyyYBs$material3_release  reason: not valid java name */
    public final void m2193setCentergyyYBs$material3_release(long j) {
        this.center$delegate.setValue(IntOffset.m5953boximpl(j));
    }

    public final List<Integer> getValues$material3_release() {
        return Selection.m1956equalsimpl0(m2191getSelectionJiIwxys$material3_release(), Selection.Companion.m1961getMinuteJiIwxys()) ? TimePickerKt.Minutes : TimePickerKt.Hours;
    }

    /* renamed from: getSelection-JiIwxys$material3_release  reason: not valid java name */
    public final int m2191getSelectionJiIwxys$material3_release() {
        return ((Selection) this.selection$delegate.getValue()).m1959unboximpl();
    }

    /* renamed from: setSelection-iHAOin8$material3_release  reason: not valid java name */
    public final void m2194setSelectioniHAOin8$material3_release(int i) {
        this.selection$delegate.setValue(Selection.m1953boximpl(i));
    }
    ...
    public final void moveSelector$material3_release(float x, float y, float maxDist) {
        if (Selection.m1956equalsimpl0(m2191getSelectionJiIwxys$material3_release(), Selection.Companion.m1960getHourJiIwxys()) && this.is24hour) {
            setInnerCircle$material3_release(TimePickerKt.dist(x, y, IntOffset.m5962getXimpl(m2190getCenternOccac$material3_release()), IntOffset.m5963getYimpl(m2190getCenternOccac$material3_release())) < maxDist);
        }
    }

    public final boolean isSelected$material3_release(int value) {
        if (!Selection.m1956equalsimpl0(m2191getSelectionJiIwxys$material3_release(), Selection.Companion.m1961getMinuteJiIwxys())) {
    ...
    public final java.lang.Object animateToCurrent$material3_release(kotlin.coroutines.Continuation<? super kotlin.Unit> r13) {
        ...
        L_0x003e:
            kotlin.ResultKt.throwOnFailure(r8)
            r1 = r12
            int r0 = r1.m2191getSelectionJiIwxys$material3_release()
            androidx.compose.material3.Selection$Companion r2 = androidx.compose.material3.Selection.Companion
            int r2 = r2.m1960getHourJiIwxys()
            boolean r0 = androidx.compose.material3.Selection.m1956equalsimpl0(r0, r2)
    ...
    public final java.lang.Object onTap$material3_release(float r15, float r16, float r17, boolean r18, kotlin.coroutines.Continuation<? super kotlin.Unit> r19) {
        ...
        L_0x005a:
            ...
            r5 = r15
            r6 = r17
            long r7 = r1.m2190getCenternOccac$material3_release()
            int r7 = androidx.compose.ui.unit.IntOffset.m5963getYimpl(r7)
            float r7 = (float) r7
            float r7 = r4 - r7
            long r11 = r1.m2190getCenternOccac$material3_release()
            int r8 = androidx.compose.ui.unit.IntOffset.m5962getXimpl(r11)
            float r8 = (float) r8
            float r8 = r5 - r8
        ...
        L_0x0096:
            ...
            int r4 = r2.m2191getSelectionJiIwxys$material3_release()
            androidx.compose.material3.Selection$Companion r5 = androidx.compose.material3.Selection.Companion
            int r5 = r5.m1960getHourJiIwxys()
            boolean r4 = androidx.compose.material3.Selection.m1956equalsimpl0(r4, r5)
            if (r4 == 0) goto L_0x0109
            if (r1 == 0) goto L_0x00b8
            androidx.compose.material3.Selection$Companion r1 = androidx.compose.material3.Selection.Companion
            int r1 = r1.m1961getMinuteJiIwxys()
            r2.m2194setSelectioniHAOin8$material3_release(r1)
        L_0x00b5:
