...
final class SliderKt$Slider$4 extends Lambda implements Function3<SliderPositions, Composer, Integer, Unit> {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ SliderColors $colors;
    final /* synthetic */ boolean $enabled;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SliderKt$Slider$4(SliderColors sliderColors, boolean z, int i) {
        super(3);
    ...
    public final void invoke(SliderPositions sliderPositions, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C177@8154L138:Slider.kt#uh7d8r");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
        ...
        if (($dirty & 91) != 18 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(686671625, $dirty, -1, "androidx.compose.material3.Slider.<anonymous> (Slider.kt:176)");
            }
