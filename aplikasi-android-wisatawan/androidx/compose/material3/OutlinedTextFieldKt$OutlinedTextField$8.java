...
final class OutlinedTextFieldKt$OutlinedTextField$8 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        String str2 = str;
        OutlinedTextFieldKt.OutlinedTextField(str2, (Function1) this.$onValueChange, this.$modifier, this.$enabled, this.$readOnly, this.$textStyle, (Function2) this.$label, (Function2) this.$placeholder, (Function2) this.$leadingIcon, (Function2) this.$trailingIcon, (Function2) this.$supportingText, this.$isError, this.$visualTransformation, this.$keyboardOptions, this.$keyboardActions, this.$singleLine, this.$maxLines, this.$minLines, this.$interactionSource, this.$shape, this.$colors, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), RecomposeScopeImplKt.updateChangedFlags(this.$$changed1), RecomposeScopeImplKt.updateChangedFlags(this.$$changed2), this.$$default);
    }
}
