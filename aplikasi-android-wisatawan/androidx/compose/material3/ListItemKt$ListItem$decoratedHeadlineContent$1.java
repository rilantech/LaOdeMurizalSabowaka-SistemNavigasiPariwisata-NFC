...
final class ListItemKt$ListItem$decoratedHeadlineContent$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            ListItemKt.m1831ProvideTextStyleFromToken3JVO9M(this.$colors.headlineColor$material3_release(true, $composer, ((this.$$dirty >> 15) & 112) | 6).getValue().m3263unboximpl(), ListTokens.INSTANCE.getListItemLabelTextFont(), this.$headlineContent, $composer, ((this.$$dirty << 6) & 896) | 48);
            if (ComposerKt.isTraceInProgress()) {
