...
public final class SliderColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof SliderColors) || !Color.m3254equalsimpl0(this.thumbColor, ((SliderColors) other).thumbColor) || !Color.m3254equalsimpl0(this.activeTrackColor, ((SliderColors) other).activeTrackColor) || !Color.m3254equalsimpl0(this.activeTickColor, ((SliderColors) other).activeTickColor) || !Color.m3254equalsimpl0(this.inactiveTrackColor, ((SliderColors) other).inactiveTrackColor) || !Color.m3254equalsimpl0(this.inactiveTickColor, ((SliderColors) other).inactiveTickColor) || !Color.m3254equalsimpl0(this.disabledThumbColor, ((SliderColors) other).disabledThumbColor) || !Color.m3254equalsimpl0(this.disabledActiveTrackColor, ((SliderColors) other).disabledActiveTrackColor) || !Color.m3254equalsimpl0(this.disabledActiveTickColor, ((SliderColors) other).disabledActiveTickColor) || !Color.m3254equalsimpl0(this.disabledInactiveTrackColor, ((SliderColors) other).disabledInactiveTrackColor) || !Color.m3254equalsimpl0(this.disabledInactiveTickColor, ((SliderColors) other).disabledInactiveTickColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((Color.m3260hashCodeimpl(this.thumbColor) * 31) + Color.m3260hashCodeimpl(this.activeTrackColor)) * 31) + Color.m3260hashCodeimpl(this.activeTickColor)) * 31) + Color.m3260hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m3260hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m3260hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m3260hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m3260hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m3260hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m3260hashCodeimpl(this.disabledInactiveTickColor);
    }
}
