...
public final class SelectedRangeInfo {
    ...
    public SelectedRangeInfo(Pair<IntOffset, IntOffset> gridCoordinates2, boolean firstIsSelectionStart2, boolean lastIsSelectionEnd2) {
        Intrinsics.checkNotNullParameter(gridCoordinates2, "gridCoordinates");
        this.gridCoordinates = gridCoordinates2;
        this.firstIsSelectionStart = firstIsSelectionStart2;
        this.lastIsSelectionEnd = lastIsSelectionEnd2;
    }
    ...
    public static final class Companion {
        ...
        public final SelectedRangeInfo calculateRangeInfo(CalendarMonth month, CalendarDate startDate, CalendarDate endDate) {
            ...
            boolean lastIsSelectionEnd = false;
            ...
            if (lastIsSelectionEnd) {
                i = (month.getDaysFromStartOfWeekToFirstOfMonth() + endDate.getDayOfMonth()) - 1;
            } else {
                i = (month.getDaysFromStartOfWeekToFirstOfMonth() + month.getNumberOfDays()) - 1;
            }
            int endGridItemOffset = i;
            return new SelectedRangeInfo(new Pair(IntOffset.m5953boximpl(IntOffsetKt.IntOffset(startGridItemOffset % 7, startGridItemOffset / 7)), IntOffset.m5953boximpl(IntOffsetKt.IntOffset(endGridItemOffset % 7, endGridItemOffset / 7))), firstIsSelectionStart, lastIsSelectionEnd);
        }
    }
}
