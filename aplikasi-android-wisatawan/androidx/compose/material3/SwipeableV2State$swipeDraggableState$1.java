...
public final class SwipeableV2State$swipeDraggableState$1 implements DraggableState {
    ...
    SwipeableV2State$swipeDraggableState$1(SwipeableV2State<T> $receiver) {
        this.this$0 = $receiver;
        this.dragScope = new SwipeableV2State$swipeDraggableState$1$dragScope$1($receiver);
    }
    ...
    public Object drag(MutatePriority dragPriority, Function2<? super DragScope, ? super Continuation<? super Unit>, ? extends Object> block, Continuation<? super Unit> $completion) {
        Object access$swipe = this.this$0.swipe(dragPriority, new SwipeableV2State$swipeDraggableState$1$drag$2(block, this, (Continuation<? super SwipeableV2State$swipeDraggableState$1$drag$2>) null), $completion);
