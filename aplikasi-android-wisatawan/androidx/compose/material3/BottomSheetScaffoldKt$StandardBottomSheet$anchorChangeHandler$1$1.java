...
final class BottomSheetScaffoldKt$StandardBottomSheet$anchorChangeHandler$1$1 extends Lambda implements Function2<SheetValue, Float, Unit> {
    ...
    BottomSheetScaffoldKt$StandardBottomSheet$anchorChangeHandler$1$1(CoroutineScope coroutineScope, SheetState sheetState) {
        super(2);
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (sheetState.getSwipeableState$material3_release().animateTo(target, velocity, this) != coroutine_suspended) {
                        break;
                    } else {
