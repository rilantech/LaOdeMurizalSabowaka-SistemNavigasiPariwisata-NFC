...
final class NavigationRailKt$NavigationRailItemBaselineLayout$2 implements MeasurePolicy {
    ...
    public final MeasureResult m1891measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        ...
        for (Object element$iv2 : $this$first$iv) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv2), (Object) "icon")) {
                ...
                int totalIndicatorWidth2 = iconPlaceable.getWidth() + measureScope.m5819roundToPx0680j_4(Dp.m5844constructorimpl(((float) 2) * NavigationRailKt.IndicatorHorizontalPadding));
                ...
                int indicatorHeight = iconPlaceable.getHeight() + measureScope.m5819roundToPx0680j_4(Dp.m5844constructorimpl(((float) 2) * indicatorVerticalPadding));
                ...
                for (Object element$iv3 : $this$first$iv2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv3), (Object) "indicatorRipple")) {
                        ...
                        if (this.$label == null) {
                            ...
                            return NavigationRailKt.m1889placeIconX9ElhV4($this$Layout, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints);
                        }
                        Intrinsics.checkNotNull(labelPlaceable);
                        return NavigationRailKt.m1890placeLabelAndIconzUg2_y0($this$Layout, labelPlaceable, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints, this.$alwaysShowLabel, this.$animationProgress);
                    }
