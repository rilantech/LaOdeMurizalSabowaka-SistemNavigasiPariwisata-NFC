...
final class SurfaceKt$Surface$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C224@11200L139,233@11570L16,219@11013L757:Surface.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1279702876, i, -1, "androidx.compose.material3.Surface.<anonymous> (Surface.kt:218)");
            }
            Modifier modifier$iv = ClickableKt.m198clickableO2vRcR0$default(SurfaceKt.m2068surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(this.$modifier), this.$shape, SurfaceKt.m2069surfaceColorAtElevationCLU3JFs(this.$color, this.$absoluteElevation, composer, (this.$$changed >> 12) & 14), this.$border, this.$shadowElevation), this.$interactionSource, RippleKt.m1523rememberRipple9IZ8Weo(false, 0.0f, 0, $composer, 0, 7), this.$enabled, (String) null, (Role) null, this.$onClick, 24, (Object) null);
