...
final class ScaffoldKt$Scaffold$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            int i2 = this.$$dirty;
            ScaffoldKt.m1938ScaffoldLayoutFMILGgc(i, function2, function3, function22, function23, windowInsets, function24, $composer, ((i2 >> 15) & 14) | (i2 & 112) | ((i2 >> 21) & 896) | (i2 & 7168) | (57344 & i2) | ((i2 >> 9) & 458752) | ((i2 << 12) & 3670016));
            if (ComposerKt.isTraceInProgress()) {
