...
public final class TooltipKt$animateTooltip$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$animateTooltip_u24lambda_u2416 = $this$null;
        $this$animateTooltip_u24lambda_u2416.setName("animateTooltip");
        $this$animateTooltip_u24lambda_u2416.getProperties().set("transition", this.$transition$inlined);
    }
}
