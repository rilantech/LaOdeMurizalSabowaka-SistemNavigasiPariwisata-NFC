...
public final class CheckboxColors {
    ...
    public final State<Color> checkmarkColor$material3_release(ToggleableState state, Composer $composer, int $changed) {
        ...
        State<Color> r1 = SingleValueAnimationKt.m72animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(state == ToggleableState.Off ? 100 : 50, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, $composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> boxColor$material3_release(boolean enabled, ToggleableState state, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            state2 = SingleValueAnimationKt.m72animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(state == ToggleableState.Off ? 100 : 50, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, $composer, 0, 12);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(1143718613);
            ComposerKt.sourceInformation($composer, "437@17523L28");
            state2 = SnapshotStateKt.rememberUpdatedState(Color.m3243boximpl(target), $composer, 0);
            $composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof CheckboxColors) || !Color.m3254equalsimpl0(this.checkedCheckmarkColor, ((CheckboxColors) other).checkedCheckmarkColor) || !Color.m3254equalsimpl0(this.uncheckedCheckmarkColor, ((CheckboxColors) other).uncheckedCheckmarkColor) || !Color.m3254equalsimpl0(this.checkedBoxColor, ((CheckboxColors) other).checkedBoxColor) || !Color.m3254equalsimpl0(this.uncheckedBoxColor, ((CheckboxColors) other).uncheckedBoxColor) || !Color.m3254equalsimpl0(this.disabledCheckedBoxColor, ((CheckboxColors) other).disabledCheckedBoxColor) || !Color.m3254equalsimpl0(this.disabledUncheckedBoxColor, ((CheckboxColors) other).disabledUncheckedBoxColor) || !Color.m3254equalsimpl0(this.disabledIndeterminateBoxColor, ((CheckboxColors) other).disabledIndeterminateBoxColor) || !Color.m3254equalsimpl0(this.checkedBorderColor, ((CheckboxColors) other).checkedBorderColor) || !Color.m3254equalsimpl0(this.uncheckedBorderColor, ((CheckboxColors) other).uncheckedBorderColor) || !Color.m3254equalsimpl0(this.disabledBorderColor, ((CheckboxColors) other).disabledBorderColor) || !Color.m3254equalsimpl0(this.disabledIndeterminateBorderColor, ((CheckboxColors) other).disabledIndeterminateBorderColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((Color.m3260hashCodeimpl(this.checkedCheckmarkColor) * 31) + Color.m3260hashCodeimpl(this.uncheckedCheckmarkColor)) * 31) + Color.m3260hashCodeimpl(this.checkedBoxColor)) * 31) + Color.m3260hashCodeimpl(this.uncheckedBoxColor)) * 31) + Color.m3260hashCodeimpl(this.disabledCheckedBoxColor)) * 31) + Color.m3260hashCodeimpl(this.disabledUncheckedBoxColor)) * 31) + Color.m3260hashCodeimpl(this.disabledIndeterminateBoxColor)) * 31) + Color.m3260hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m3260hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m3260hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m3260hashCodeimpl(this.disabledIndeterminateBorderColor);
    }
}
