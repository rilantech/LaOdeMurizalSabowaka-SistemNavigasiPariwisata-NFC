...
public final class SurfaceKt {
    ...
    public static final void m2062SurfaceT9BRK9s(Modifier modifier, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        Shape shape2;
        long color2;
        long contentColor2;
        ...
        if ((i & 4) != 0) {
            color2 = MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1623getSurface0d7_KjU();
        } else {
            color2 = color;
        }
        if ((i & 8) != 0) {
            contentColor2 = ColorSchemeKt.m1659contentColorForek8zF_U(color2, composer, (i2 >> 6) & 14);
        } else {
            contentColor2 = contentColor;
        }
        if ((i & 16) != 0) {
            tonalElevation2 = Dp.m5844constructorimpl((float) 0);
        } else {
            tonalElevation2 = tonalElevation;
        }
        if ((i & 32) != 0) {
            shadowElevation2 = Dp.m5844constructorimpl((float) 0);
        } else {
        ...
        float absoluteElevation = Dp.m5844constructorimpl(((Dp) consume).m5858unboximpl() + tonalElevation2);
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3243boximpl(contentColor2)), this_$iv.provides(Dp.m5842boximpl(absoluteElevation))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composer, -70914509, true, surfaceKt$Surface$1), composer, 56);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m2065Surfaceo_FOJdg(Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int $changed1, int i) {
        boolean enabled2;
        Shape shape2;
        long color2;
        long contentColor2;
        ...
        if ((i3 & 32) != 0) {
            contentColor2 = ColorSchemeKt.m1659contentColorForek8zF_U(color2, composer, (i2 >> 12) & 14);
        } else {
            contentColor2 = contentColor;
        }
        if ((i3 & 64) != 0) {
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3243boximpl(contentColor2)), this_$iv.provides(Dp.m5842boximpl(absoluteElevation))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composer, 1279702876, true, surfaceKt$Surface$3), composer, 56);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final void m2063Surfaced85dljk(boolean selected, Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int $changed1, int i) {
        boolean enabled2;
        Shape shape2;
        long color2;
        long contentColor2;
        ...
        if ((i3 & 64) != 0) {
            contentColor2 = ColorSchemeKt.m1659contentColorForek8zF_U(color2, composer, (i2 >> 15) & 14);
        } else {
            contentColor2 = contentColor;
        }
        if ((i3 & 128) != 0) {
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3243boximpl(contentColor2)), this_$iv.provides(Dp.m5842boximpl(absoluteElevation))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composer, -1164547968, true, surfaceKt$Surface$5), composer, 56);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    /* renamed from: Surface-d85dljk  reason: not valid java name */
    public static final void m2064Surfaced85dljk(boolean checked, Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int $changed1, int i) {
        boolean enabled2;
        Shape shape2;
        long color2;
        long contentColor2;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3243boximpl(contentColor2)), this_$iv.provides(Dp.m5842boximpl(absoluteElevation))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composer, 712720927, true, surfaceKt$Surface$7), composer, 56);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final Modifier m2068surface8ww4TTg(Modifier $this$surface_u2d8ww4TTg, Shape shape, long backgroundColor, BorderStroke border, float shadowElevation) {
        Modifier r0 = ShadowKt.m2912shadows4CzXII$default($this$surface_u2d8ww4TTg, shadowElevation, shape, false, 0, 0, 24, (Object) null);
    ...
    public static final long m2069surfaceColorAtElevationCLU3JFs(long color, float elevation, Composer $composer, int $changed) {
        long j;
        ...
        if (Color.m3254equalsimpl0(color, MaterialTheme.INSTANCE.getColorScheme($composer, 6).m1623getSurface0d7_KjU())) {
            j = ColorSchemeKt.m1664surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme($composer, 6), elevation);
        } else {
            j = color;
        }
        if (ComposerKt.isTraceInProgress()) {
