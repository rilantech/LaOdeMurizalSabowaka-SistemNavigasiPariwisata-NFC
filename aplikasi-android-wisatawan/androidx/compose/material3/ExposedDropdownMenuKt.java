...
public final class ExposedDropdownMenuKt {
    ...
    public static final float ExposedDropdownMenuItemHorizontalPadding = Dp.m5844constructorimpl((float) 16);
    ...
    public static final void ExposedDropdownMenuBox(boolean expanded, Function1<? super Boolean, Unit> onExpandedChange, Modifier modifier, Function3<? super ExposedDropdownMenuBoxScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        ...
        if (($dirty3 & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            int verticalMarginInPx2 = density.m5819roundToPx0680j_4(MenuKt.getMenuVerticalMargin());
            $composer2.startReplaceableGroup(-492369756);
            ComposerKt.sourceInformation($composer2, "CC(remember):Composables.kt#9igjgp");
    ...
    public static final Modifier expandable(Modifier $this$expandable, boolean expanded, Function0<Unit> onExpandedChange, String menuDescription, String expandedDescription, String collapsedDescription, Composer $composer, int $changed, int i) {
        ...
        String menuDescription2 = (i & 4) != 0 ? Strings_androidKt.m2053getStringNWtq28(Strings.Companion.m2030getExposedDropdownMenuadMyvUU(), composer, 6) : menuDescription;
        if ((i & 8) != 0) {
            expandedDescription2 = Strings_androidKt.m2053getStringNWtq28(Strings.Companion.m2032getMenuExpandedadMyvUU(), composer, 6);
        } else {
            expandedDescription2 = expandedDescription;
        }
        if ((i & 16) != 0) {
            collapsedDescription2 = Strings_androidKt.m2053getStringNWtq28(Strings.Companion.m2031getMenuCollapsedadMyvUU(), composer, 6);
        } else {
