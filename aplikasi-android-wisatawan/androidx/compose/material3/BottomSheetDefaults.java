...
public final class BottomSheetDefaults {
    ...
    private static final float Elevation = SheetBottomTokens.INSTANCE.m2711getDockedModalContainerElevationD9Ej5fM();
    public static final BottomSheetDefaults INSTANCE = new BottomSheetDefaults();
    private static final float SheetPeekHeight = Dp.m5844constructorimpl((float) 56);
    ...
    public final float m1558getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final long getScrimColor(Composer $composer, int $changed) {
        ...
        long r0 = Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(ScrimTokens.INSTANCE.getContainerColor(), $composer, 6), 0.32f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets r0 = WindowInsetsKt.m641onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, $composer, 8), WindowInsetsSides.Companion.m670getVerticalJoeWqyM());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final void m1557DragHandlelgZ2HuY(Modifier modifier, float width, float height, Shape shape, long color, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        float f;
        float height2;
        Shape shape2;
        ...
        if ((46811 & $dirty) != 9362 || !$composer2.getSkipping()) {
            ...
            if ((i4 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i6 != 0) {
                    width3 = SheetBottomTokens.INSTANCE.m2710getDockedDragHandleWidthD9Ej5fM();
                } else {
                    width3 = f;
                }
                if (i7 != 0) {
                    height2 = SheetBottomTokens.INSTANCE.m2709getDockedDragHandleHeightD9Ej5fM();
                }
                if ((i & 8) != 0) {
                    $dirty &= -7169;
                ...
                if ((i & 16) != 0) {
                    color3 = Color.m3252copywmQWz5c$default(ColorSchemeKt.toColor(SheetBottomTokens.INSTANCE.getDockedDragHandleColor(), $composer2, 6), 0.4f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
                    $dirty &= -57345;
                } else {
                    color3 = j;
                }
            ...
            String dragHandleDescription = Strings_androidKt.m2053getStringNWtq28(Strings.Companion.m1991getBottomSheetDragHandleDescriptionadMyvUU(), $composer2, 6);
            Modifier r6 = PaddingKt.m540paddingVpY3zN4$default(modifier4, 0.0f, SheetDefaultsKt.DragHandleVerticalPadding, 1, (Object) null);
