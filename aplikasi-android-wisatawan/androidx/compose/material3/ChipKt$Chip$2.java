...
final class ChipKt$Chip$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            int i2 = this.$$dirty;
            long r8 = chipColors.leadingIconContentColor$material3_release(z, composer, ((i2 >> 24) & 112) | ((i2 >> 6) & 14)).getValue().m3263unboximpl();
            ChipColors chipColors2 = this.$colors;
            boolean z2 = this.$enabled;
            int i3 = this.$$dirty;
            long r10 = chipColors2.trailingIconContentColor$material3_release(z2, composer, ((i3 >> 24) & 112) | ((i3 >> 6) & 14)).getValue().m3263unboximpl();
            float f = this.$minHeight;
            PaddingValues paddingValues = this.$paddingValues;
            int i4 = this.$$dirty;
            int i5 = this.$$dirty1;
            ChipKt.m1591ChipContentfe0OD_I(function2, textStyle, j, function22, (Function2<? super Composer, ? super Integer, Unit>) null, function23, r8, r10, f, paddingValues, $composer, ((i4 >> 6) & 458752) | ((i4 >> 9) & 14) | 24576 | ((i4 >> 9) & 112) | ((i4 >> 9) & 896) | ((i4 >> 9) & 7168) | ((i5 << 18) & 234881024) | ((i5 << 18) & 1879048192));
            if (ComposerKt.isTraceInProgress()) {
