...
final class TextFieldImplKt$CommonDecorationBox$3$containerWithId$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ int $$dirty1;
    final /* synthetic */ Function2<Composer, Integer, Unit> $container;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TextFieldImplKt$CommonDecorationBox$3$containerWithId$1(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C205@8741L151:TextFieldImpl.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = LayoutIdKt.layoutId(Modifier.Companion, TextFieldImplKt.ContainerId);
            Function2<Composer, Integer, Unit> function2 = this.$container;
            int i2 = this.$$dirty1;
            composer.startReplaceableGroup(733328855);
            ComposerKt.sourceInformation(composer, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
            MeasurePolicy measurePolicy$iv = BoxKt.rememberBoxMeasurePolicy(Alignment.Companion.getTopStart(), true, composer, ((390 >> 3) & 14) | ((390 >> 3) & 112));
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1425716369, "C207@8859L11:TextFieldImpl.kt#uh7d8r");
