...
public final class MenuKt {
    private static final float DropdownMenuItemDefaultMaxWidth = Dp.m5844constructorimpl((float) 280);
    private static final float DropdownMenuItemDefaultMinWidth = Dp.m5844constructorimpl((float) 112);
    /* access modifiers changed from: private */
    public static final float DropdownMenuItemHorizontalPadding = Dp.m5844constructorimpl((float) 12);
    private static final float DropdownMenuVerticalPadding = Dp.m5844constructorimpl((float) 8);
    public static final int InTransitionDuration = 120;
    private static final float MenuVerticalMargin = Dp.m5844constructorimpl((float) 48);
    ...
    public static final void DropdownMenuContent(MutableTransitionState<Boolean> expandedStates, MutableState<TransformOrigin> transformOriginState, Modifier modifier, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        ...
        if (($dirty2 & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            SurfaceKt.m2062SurfaceT9BRK9s(GraphicsLayerModifierKt.graphicsLayer(modifier6, (Function1) value$iv$iv), ShapesKt.toShape(MenuTokens.INSTANCE.getContainerShape(), $composer2, 6), ColorSchemeKt.fromToken(MaterialTheme.INSTANCE.getColorScheme($composer2, 6), MenuTokens.INSTANCE.getContainerColor()), 0, MenuTokens.INSTANCE.m2561getContainerElevationD9Ej5fM(), MenuTokens.INSTANCE.m2561getContainerElevationD9Ej5fM(), (BorderStroke) null, ComposableLambdaKt.composableLambda($composer2, -1651673913, true, new MenuKt$DropdownMenuContent$2(modifier7, function3, $dirty2)), $composer2, 12804096, 72);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier3 = modifier7;
    ...
    public static final void DropdownMenuItemContent(Function2<? super Composer, ? super Integer, Unit> text, Function0<Unit> onClick, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> leadingIcon, Function2<? super Composer, ? super Integer, Unit> trailingIcon, boolean enabled, MenuItemColors colors, PaddingValues contentPadding, MutableInteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if ((191739611 & $dirty2) != 38347922 || !$composer3.getSkipping()) {
            ...
            int $dirty3 = $dirty2;
            $composer2 = $composer3;
            Modifier padding = PaddingKt.padding(SizeKt.m616sizeInqDBjuR0$default(SizeKt.fillMaxWidth$default(ClickableKt.m198clickableO2vRcR0$default(modifier, interactionSource, RippleKt.m1523rememberRipple9IZ8Weo(true, 0.0f, 0, $composer3, 6, 6), enabled, (String) null, (Role) null, onClick, 24, (Object) null), 0.0f, 1, (Object) null), DropdownMenuItemDefaultMinWidth, MenuTokens.INSTANCE.m2562getListItemContainerHeightD9Ej5fM(), DropdownMenuItemDefaultMaxWidth, 0.0f, 8, (Object) null), paddingValues);
