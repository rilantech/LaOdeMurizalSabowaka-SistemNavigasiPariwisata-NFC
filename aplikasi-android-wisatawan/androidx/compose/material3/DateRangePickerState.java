...
public final class DateRangePickerState {
    ...
    public final int m1721getDisplayModejFl4v0() {
        return ((DisplayMode) this.displayMode$delegate.getValue()).m1737unboximpl();
    }

    /* renamed from: setDisplayMode-vCnGnXg  reason: not valid java name */
    public final void m1722setDisplayModevCnGnXg(int i) {
        this.displayMode$delegate.setValue(DisplayMode.m1731boximpl(i));
    }
