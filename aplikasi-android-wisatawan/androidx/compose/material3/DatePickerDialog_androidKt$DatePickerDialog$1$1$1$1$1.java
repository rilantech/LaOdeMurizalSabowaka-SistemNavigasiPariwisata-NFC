            ...
            TextKt.ProvideTextStyle(textStyle, ComposableLambdaKt.composableLambda($composer, -2020639284, true, new Function2<Composer, Integer, Unit>() {
                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if (($changed & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        AlertDialogKt.m1532AlertDialogFlowRowixp7dh8(access$getDialogButtonsMainAxisSpacing$p, access$getDialogButtonsCrossAxisSpacing$p, ComposableLambdaKt.composableLambda($composer, -1863712509, true, new Function2<Composer, Integer, Unit>() {
                            public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                                invoke((Composer) p1, ((Number) p2).intValue());
                                return Unit.INSTANCE;
                            }
