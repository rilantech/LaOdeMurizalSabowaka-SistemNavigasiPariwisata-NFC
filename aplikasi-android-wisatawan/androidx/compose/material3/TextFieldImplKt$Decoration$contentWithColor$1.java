...
final class TextFieldImplKt$Decoration$contentWithColor$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3243boximpl(this.$contentColor))}, (Function2<? super Composer, ? super Integer, Unit>) this.$content, $composer, ((this.$$dirty >> 3) & 112) | 8);
            if (ComposerKt.isTraceInProgress()) {
