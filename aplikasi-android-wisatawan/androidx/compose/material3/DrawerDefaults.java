...
public final class DrawerDefaults {
    ...
    private static final float DismissibleDrawerElevation = NavigationDrawerTokens.INSTANCE.m2575getStandardContainerElevationD9Ej5fM();
    public static final DrawerDefaults INSTANCE = new DrawerDefaults();
    private static final float MaximumDrawerWidth = NavigationDrawerTokens.INSTANCE.m2572getContainerWidthD9Ej5fM();
    private static final float ModalDrawerElevation = NavigationDrawerTokens.INSTANCE.m2574getModalContainerElevationD9Ej5fM();
    private static final float PermanentDrawerElevation = NavigationDrawerTokens.INSTANCE.m2575getStandardContainerElevationD9Ej5fM();

    private DrawerDefaults() {
    }

    /* renamed from: getModalDrawerElevation-D9Ej5fM  reason: not valid java name */
    public final float m1748getModalDrawerElevationD9Ej5fM() {
        return ModalDrawerElevation;
    }

    /* renamed from: getPermanentDrawerElevation-D9Ej5fM  reason: not valid java name */
    public final float m1749getPermanentDrawerElevationD9Ej5fM() {
        return PermanentDrawerElevation;
    }

    /* renamed from: getDismissibleDrawerElevation-D9Ej5fM  reason: not valid java name */
    public final float m1746getDismissibleDrawerElevationD9Ej5fM() {
    ...
    public final float m1747getMaximumDrawerWidthD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets r0 = WindowInsetsKt.m641onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, $composer, 8), WindowInsetsSides.m655plusgK_yJZ4(WindowInsetsSides.Companion.m670getVerticalJoeWqyM(), WindowInsetsSides.Companion.m668getStartJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
