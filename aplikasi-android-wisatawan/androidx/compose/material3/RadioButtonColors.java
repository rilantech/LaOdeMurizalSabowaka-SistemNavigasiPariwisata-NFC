...
public final class RadioButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof RadioButtonColors) || !Color.m3254equalsimpl0(this.selectedColor, ((RadioButtonColors) other).selectedColor) || !Color.m3254equalsimpl0(this.unselectedColor, ((RadioButtonColors) other).unselectedColor) || !Color.m3254equalsimpl0(this.disabledSelectedColor, ((RadioButtonColors) other).disabledSelectedColor) || !Color.m3254equalsimpl0(this.disabledUnselectedColor, ((RadioButtonColors) other).disabledUnselectedColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((Color.m3260hashCodeimpl(this.selectedColor) * 31) + Color.m3260hashCodeimpl(this.unselectedColor)) * 31) + Color.m3260hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m3260hashCodeimpl(this.disabledUnselectedColor);
    }
}
