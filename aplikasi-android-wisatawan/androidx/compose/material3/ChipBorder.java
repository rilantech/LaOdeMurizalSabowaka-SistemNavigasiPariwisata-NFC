...
public final class ChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m194BorderStrokecXLIe8U(this.borderWidth, enabled ? this.borderColor : this.disabledBorderColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof ChipBorder) || !Color.m3254equalsimpl0(this.borderColor, ((ChipBorder) other).borderColor) || !Color.m3254equalsimpl0(this.disabledBorderColor, ((ChipBorder) other).disabledBorderColor) || !Dp.m5849equalsimpl0(this.borderWidth, ((ChipBorder) other).borderWidth)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((Color.m3260hashCodeimpl(this.borderColor) * 31) + Color.m3260hashCodeimpl(this.disabledBorderColor)) * 31) + Dp.m5850hashCodeimpl(this.borderWidth);
    }
}
