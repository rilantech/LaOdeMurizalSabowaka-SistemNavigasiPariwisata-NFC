...
final class NavigationDrawerKt$DismissibleNavigationDrawer$2$2 implements MeasurePolicy {
    ...
    public final MeasureResult m1881measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        Intrinsics.checkNotNullParameter($this$Layout, "$this$Layout");
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        Placeable sheetPlaceable = ((Measurable) measurables.get(0)).m4689measureBRTryo0(constraints);
        Placeable contentPlaceable = ((Measurable) measurables.get(1)).m4689measureBRTryo0(constraints);
