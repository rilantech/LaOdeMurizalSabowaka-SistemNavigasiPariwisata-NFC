...
public final class TabRowKt {
    ...
    public static final float ScrollableTabRowMinimumTabWidth = Dp.m5844constructorimpl((float) 90);
    private static final float ScrollableTabRowPadding = Dp.m5844constructorimpl((float) 52);
    /* access modifiers changed from: private */
    ...
    public static final void m2104TabRowpAZo6Ak(int r28, androidx.compose.ui.Modifier r29, long r30, long r32, kotlin.jvm.functions.Function3<? super java.util.List<androidx.compose.material3.TabPosition>, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r34, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r35, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, androidx.compose.runtime.Composer r37, int r38, int r39) {
        /*
            r12 = r28
            r13 = r36
            r14 = r38
        ...
        L_0x015e:
            ...
            kotlin.jvm.functions.Function2 r2 = r2.m1692getLambda1$material3_release()
            goto L_0x0168
        L_0x0167:
            r2 = r15
        L_0x0168:
        ...
        L_0x01ec:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabRowKt.m2104TabRowpAZo6Ak(int, androidx.compose.ui.Modifier, long, long, kotlin.jvm.functions.Function3, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }

    /* renamed from: ScrollableTabRow-sKfQg0A  reason: not valid java name */
    public static final void m2103ScrollableTabRowsKfQg0A(int selectedTabIndex, Modifier modifier, long containerColor, long contentColor, float edgePadding, Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> indicator, Function2<? super Composer, ? super Integer, Unit> divider, Function2<? super Composer, ? super Integer, Unit> tabs, Composer $composer, int $changed, int i) {
        ...
        if ((23967451 & $dirty) != 4793490 || !$composer2.getSkipping()) {
            ...
            if ((i5 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                divider3 = i10 != 0 ? ComposableSingletons$TabRowKt.INSTANCE.m1693getLambda2$material3_release() : divider;
            } else {
            ...
            SurfaceKt.m2062SurfaceT9BRK9s(modifier3, (Shape) null, containerColor2, contentColor2, 0.0f, 0.0f, (BorderStroke) null, ComposableLambdaKt.composableLambda($composer2, 286469328, true, new TabRowKt$ScrollableTabRow$2(edgePadding2, tabs, divider3, selectedTabIndex, indicator3, $dirty)), $composer2, (($dirty >> 3) & 14) | 12582912 | ($dirty & 896) | ($dirty & 7168), 114);
            if (ComposerKt.isTraceInProgress()) {
