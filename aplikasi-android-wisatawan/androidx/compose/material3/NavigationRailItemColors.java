...
public final class NavigationRailItemColors {
    ...
    private NavigationRailItemColors(long selectedIconColor2, long selectedTextColor2, long selectedIndicatorColor2, long unselectedIconColor2, long unselectedTextColor2, long disabledIconColor2, long disabledTextColor2) {
    ...
    public final State<Color> iconColor$material3_release(boolean selected, boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> r0 = SingleValueAnimationKt.m72animateColorAsStateeuL9pac(targetValue, AnimationSpecKt.tween$default(150, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, $composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof NavigationRailItemColors) || !Color.m3254equalsimpl0(this.selectedIconColor, ((NavigationRailItemColors) other).selectedIconColor) || !Color.m3254equalsimpl0(this.unselectedIconColor, ((NavigationRailItemColors) other).unselectedIconColor) || !Color.m3254equalsimpl0(this.selectedTextColor, ((NavigationRailItemColors) other).selectedTextColor) || !Color.m3254equalsimpl0(this.unselectedTextColor, ((NavigationRailItemColors) other).unselectedTextColor) || !Color.m3254equalsimpl0(this.selectedIndicatorColor, ((NavigationRailItemColors) other).selectedIndicatorColor) || !Color.m3254equalsimpl0(this.disabledIconColor, ((NavigationRailItemColors) other).disabledIconColor) || !Color.m3254equalsimpl0(this.disabledTextColor, ((NavigationRailItemColors) other).disabledTextColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((((Color.m3260hashCodeimpl(this.selectedIconColor) * 31) + Color.m3260hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m3260hashCodeimpl(this.selectedTextColor)) * 31) + Color.m3260hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m3260hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m3260hashCodeimpl(this.disabledIconColor)) * 31) + Color.m3260hashCodeimpl(this.disabledTextColor);
    }
}
