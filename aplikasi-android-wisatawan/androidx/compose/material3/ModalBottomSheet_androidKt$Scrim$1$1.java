...
final class ModalBottomSheet_androidKt$Scrim$1$1 extends Lambda implements Function1<DrawScope, Unit> {
    ...
    public final void invoke(DrawScope $this$Canvas) {
        ...
        DrawScope.m3842drawRectnJ9OG0$default($this$Canvas, this.$color, 0, 0, ModalBottomSheet_androidKt.Scrim_3J_VO9M$lambda$2(this.$alpha$delegate), (DrawStyle) null, (ColorFilter) null, 0, 118, (Object) null);
    }
}
