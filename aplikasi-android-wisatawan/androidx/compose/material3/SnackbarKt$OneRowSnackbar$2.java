...
final class SnackbarKt$OneRowSnackbar$2 implements MeasurePolicy {
    ...
    public final MeasureResult m1980measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        Placeable placeable;
        Object element$iv;
        Object element$iv2;
        int textPlaceY;
        ...
        int containerWidth = Math.min(Constraints.m5788getMaxWidthimpl(constraints), measureScope.m5819roundToPx0680j_4(SnackbarKt.ContainerMaxWidth));
        ...
        Placeable actionButtonPlaceable = measurable != null ? measurable.m4689measureBRTryo0(j) : null;
        ...
        if (measurable2 != null) {
            placeable = measurable2.m4689measureBRTryo0(j);
        }
        ...
        int textMaxWidth = RangesKt.coerceAtLeast(((containerWidth - actionButtonWidth) - dismissButtonWidth) - (dismissButtonWidth == 0 ? measureScope.m5819roundToPx0680j_4(SnackbarKt.TextEndExtraSpacing) : 0), Constraints.m5790getMinWidthimpl(constraints));
        ...
        for (Object element$iv3 : $this$firstOrNull$iv) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv3), (Object) str3)) {
                Placeable textPlaceable = ((Measurable) element$iv3).m4689measureBRTryo0(Constraints.m5779copyZbe2FdA$default(constraints, 0, textMaxWidth, 0, 0, 9, (Object) null));
                ...
                if (firstTextBaseline != Integer.MIN_VALUE) {
                    ...
                    if (lastTextBaseline != Integer.MIN_VALUE) {
                        ...
                        if (isOneLine) {
                            int minContainerHeight = measureScope.m5819roundToPx0680j_4(SnackbarTokens.INSTANCE.m2727getSingleLineContainerHeightD9Ej5fM());
                            ...
                            containerHeight = Math.max(measureScope.m5819roundToPx0680j_4(SnackbarTokens.INSTANCE.m2728getTwoLinesContainerHeightD9Ej5fM()), textPlaceY3 + textPlaceable.getHeight());
                            if (actionButtonPlaceable != null) {
