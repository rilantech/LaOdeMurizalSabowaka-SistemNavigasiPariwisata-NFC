...
final class AndroidAlertDialog_androidKt$AlertDialog$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Function2 composableLambda = ComposableLambdaKt.composableLambda(composer, -1873210524, true, new Function2<Composer, Integer, Unit>() {
                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if (($changed & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        AlertDialogKt.m1532AlertDialogFlowRowixp7dh8(access$getButtonsMainAxisSpacing$p, access$getButtonsCrossAxisSpacing$p, ComposableLambdaKt.composableLambda($composer, 628285581, true, new Function2<Composer, Integer, Unit>() {
                            public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                                invoke((Composer) p1, ((Number) p2).intValue());
                                return Unit.INSTANCE;
                            }
            ...
            int i6 = (i4 & 14) | (i4 & 112);
            AlertDialogKt.m1531AlertDialogContent4hvqGtA(composableLambda, (Modifier) null, function26, function24, function25, shape, j, f, color, j2, j3, j4, $composer, i5, i6, 2);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
                return;
            }
