...
final class AnimatedContentTransitionScopeImpl$slideIntoContainer$3 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int it) {
        return this.$initialOffset.invoke(Integer.valueOf(IntSize.m6003getHeightimpl(this.this$0.m32getCurrentSizeYbymL2g()) - IntOffset.m5963getYimpl(this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.this$0.m32getCurrentSizeYbymL2g()))));
    }
}
