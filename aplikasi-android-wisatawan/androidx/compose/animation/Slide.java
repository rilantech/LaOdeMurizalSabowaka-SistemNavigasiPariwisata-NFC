...
public final class Slide {
    ...
    public Slide(Function1<? super IntSize, IntOffset> slideOffset2, FiniteAnimationSpec<IntOffset> animationSpec2) {
        Intrinsics.checkNotNullParameter(slideOffset2, "slideOffset");
        Intrinsics.checkNotNullParameter(animationSpec2, "animationSpec");
        this.slideOffset = slideOffset2;
