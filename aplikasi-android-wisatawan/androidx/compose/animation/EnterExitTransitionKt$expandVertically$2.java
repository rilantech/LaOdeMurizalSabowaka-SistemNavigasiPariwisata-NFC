...
final class EnterExitTransitionKt$expandVertically$2 extends Lambda implements Function1<IntSize, IntSize> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return IntSize.m5996boximpl(m53invokemzRDjE0(((IntSize) p1).m6008unboximpl()));
    }

    /* renamed from: invoke-mzRDjE0  reason: not valid java name */
    public final long m53invokemzRDjE0(long it) {
        return IntSizeKt.IntSize(IntSize.m6004getWidthimpl(it), this.$initialHeight.invoke(Integer.valueOf(IntSize.m6003getHeightimpl(it))).intValue());
    }
}
