...
final class EnterExitTransitionKt$slideInVertically$2 extends Lambda implements Function1<IntSize, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return IntOffset.m5953boximpl(m58invokemHKZG7I(((IntSize) p1).m6008unboximpl()));
    }

    /* renamed from: invoke-mHKZG7I  reason: not valid java name */
    public final long m58invokemHKZG7I(long it) {
        return IntOffsetKt.IntOffset(0, this.$initialOffsetY.invoke(Integer.valueOf(IntSize.m6003getHeightimpl(it))).intValue());
    }
}
