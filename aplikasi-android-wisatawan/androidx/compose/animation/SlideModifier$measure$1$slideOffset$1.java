...
final class SlideModifier$measure$1$slideOffset$1 extends Lambda implements Function1<EnterExitState, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return IntOffset.m5953boximpl(m84invokeBjo55l4((EnterExitState) p1));
    }

    /* renamed from: invoke-Bjo55l4  reason: not valid java name */
    public final long m84invokeBjo55l4(EnterExitState it) {
        Intrinsics.checkNotNullParameter(it, "it");
        return this.this$0.m83targetValueByStateoFUgxo0(it, this.$measuredSize);
    }
}
