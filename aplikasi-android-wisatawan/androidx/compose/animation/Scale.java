...
public final class Scale {
    ...
    public static /* synthetic */ Scale m66copybnNdC4k$default(Scale scale2, float f, long j, FiniteAnimationSpec<Float> finiteAnimationSpec, int i, Object obj) {
        if ((i & 1) != 0) {
            f = scale2.scale;
        }
        if ((i & 2) != 0) {
        ...
        return scale2.m68copybnNdC4k(f, j, finiteAnimationSpec);
    }
    ...
    public final long m67component2SzJe1aQ() {
    ...
    public final Scale m68copybnNdC4k(float f, long j, FiniteAnimationSpec<Float> finiteAnimationSpec) {
    ...
    public boolean equals(Object obj) {
        ...
        return Float.compare(this.scale, scale2.scale) == 0 && TransformOrigin.m3674equalsimpl0(this.transformOrigin, scale2.transformOrigin) && Intrinsics.areEqual((Object) this.animationSpec, (Object) scale2.animationSpec);
    }

    public int hashCode() {
        return (((Float.hashCode(this.scale) * 31) + TransformOrigin.m3677hashCodeimpl(this.transformOrigin)) * 31) + this.animationSpec.hashCode();
    }

    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + TransformOrigin.m3678toStringimpl(this.transformOrigin) + ", animationSpec=" + this.animationSpec + ')';
    }
