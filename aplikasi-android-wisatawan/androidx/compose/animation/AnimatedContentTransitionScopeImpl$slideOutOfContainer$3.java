...
final class AnimatedContentTransitionScopeImpl$slideOutOfContainer$3 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int it) {
        ...
        return this.$targetOffset.invoke(Integer.valueOf((-IntOffset.m5963getYimpl(this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), state != null ? ((IntSize) state.getValue()).m6008unboximpl() : IntSize.Companion.m6009getZeroYbymL2g()))) - it));
    }
}
