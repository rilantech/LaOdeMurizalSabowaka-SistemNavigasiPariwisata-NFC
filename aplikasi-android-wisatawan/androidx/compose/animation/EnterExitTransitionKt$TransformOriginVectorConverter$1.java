...
final class EnterExitTransitionKt$TransformOriginVectorConverter$1 extends Lambda implements Function1<TransformOrigin, AnimationVector2D> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return m49invoke__ExYCQ(((TransformOrigin) p1).m3679unboximpl());
    }

    /* renamed from: invoke-__ExYCQ  reason: not valid java name */
    public final AnimationVector2D m49invoke__ExYCQ(long it) {
        return new AnimationVector2D(TransformOrigin.m3675getPivotFractionXimpl(it), TransformOrigin.m3676getPivotFractionYimpl(it));
    }
}
