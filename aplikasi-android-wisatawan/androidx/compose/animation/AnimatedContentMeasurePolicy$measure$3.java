    ...
    public final void invoke(Placeable.PlacementScope $this$layout) {
        ...
        for (Placeable placeable : placeableArr) {
            if (placeable != null) {
                ...
                long offset = animatedContentMeasurePolicy.getRootScope().getContentAlignment$animation_release().m2884alignKFBX0sM(IntSizeKt.IntSize(it.getWidth(), it.getHeight()), IntSizeKt.IntSize(i, i2), LayoutDirection.Ltr);
                Placeable.PlacementScope.place$default($this$layout, it, IntOffset.m5962getXimpl(offset), IntOffset.m5963getYimpl(offset), 0.0f, 4, (Object) null);
            }
        }
    }
}
