...
public final class StartOffsetType {
    ...
    public static final int Delay = m127constructorimpl(-1);
    /* access modifiers changed from: private */
    public static final int FastForward = m127constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ StartOffsetType m126boximpl(int i) {
        return new StartOffsetType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m127constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m128equalsimpl(int i, Object obj) {
        return (obj instanceof StartOffsetType) && i == ((StartOffsetType) obj).m132unboximpl();
    }
    ...
    public static String m131toStringimpl(int i) {
