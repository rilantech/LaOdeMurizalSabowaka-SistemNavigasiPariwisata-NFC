...
public final class DecayAnimationSpecKt {
    public static final <T, V extends AnimationVector> T calculateTargetValue(DecayAnimationSpec<T> $this$calculateTargetValue, TwoWayConverter<T, V> typeConverter, T initialValue, T initialVelocity) {
        Intrinsics.checkNotNullParameter($this$calculateTargetValue, "<this>");
    ...
    public static final float calculateTargetValue(DecayAnimationSpec<Float> $this$calculateTargetValue, float initialValue, float initialVelocity) {
        Intrinsics.checkNotNullParameter($this$calculateTargetValue, "<this>");
        return ((AnimationVector1D) $this$calculateTargetValue.vectorize(VectorConvertersKt.getVectorConverter(FloatCompanionObject.INSTANCE)).getTargetValue(AnimationVectorsKt.AnimationVector(initialValue), AnimationVectorsKt.AnimationVector(initialVelocity))).getValue();
    }
