...
final class VectorConvertersKt$IntOffsetToVector$1 extends Lambda implements Function1<IntOffset, AnimationVector2D> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return m139invokegyyYBs(((IntOffset) p1).m5971unboximpl());
    }

    /* renamed from: invoke--gyyYBs  reason: not valid java name */
    public final AnimationVector2D m139invokegyyYBs(long it) {
        return new AnimationVector2D((float) IntOffset.m5962getXimpl(it), (float) IntOffset.m5963getYimpl(it));
    }
}
