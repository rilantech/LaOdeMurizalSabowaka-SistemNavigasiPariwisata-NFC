...
public final class AnimationScope<T, V extends AnimationVector> {
    ...
    public AnimationScope(T initialValue, TwoWayConverter<T, V> typeConverter2, V initialVelocityVector, long lastFrameTimeNanos2, T targetValue2, long startTimeNanos2, boolean isRunning, Function0<Unit> onCancel2) {
        ...
        this.startTimeNanos = startTimeNanos2;
        ...
        this.lastFrameTimeNanos = lastFrameTimeNanos2;
        this.isRunning$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Boolean.valueOf(isRunning), (SnapshotMutationPolicy) null, 2, (Object) null);
    }
