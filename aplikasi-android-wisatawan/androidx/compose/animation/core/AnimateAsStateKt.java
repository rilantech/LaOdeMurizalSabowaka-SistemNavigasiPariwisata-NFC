...
public final class AnimateAsStateKt {
    ...
    private static final SpringSpec<Dp> dpDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, Dp.m5842boximpl(VisibilityThresholdsKt.getVisibilityThreshold(Dp.Companion)), 3, (Object) null);
    ...
    private static final SpringSpec<IntOffset> intOffsetDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m5953boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.Companion)), 3, (Object) null);
    private static final SpringSpec<IntSize> intSizeDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, IntSize.m5996boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntSize.Companion)), 3, (Object) null);
    private static final SpringSpec<Offset> offsetDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, Offset.m2992boximpl(VisibilityThresholdsKt.getVisibilityThreshold(Offset.Companion)), 3, (Object) null);
    ...
    private static final SpringSpec<Size> sizeDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, Size.m3060boximpl(VisibilityThresholdsKt.getVisibilityThreshold(Size.Companion)), 3, (Object) null);
    ...
    public static final State<Dp> m87animateDpAsStateAjpBEmI(float targetValue, AnimationSpec<Dp> animationSpec, String label, Function1<? super Dp, Unit> finishedListener, Composer $composer, int $changed, int i) {
        String label2;
        Function1 finishedListener2;
        Composer composer = $composer;
        int i2 = $changed;
        ...
        State<Dp> animateValueAsState = animateValueAsState(Dp.m5842boximpl(targetValue), VectorConvertersKt.getVectorConverter(Dp.Companion), animationSpec2, (Dp) null, label2, finishedListener2, $composer, (i2 & 14) | ((i2 << 3) & 896) | ((i2 << 6) & 57344) | (458752 & (i2 << 6)), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final State<Size> m96animateSizeAsStateYLp_XPw(long targetValue, AnimationSpec<Size> animationSpec, String label, Function1<? super Size, Unit> finishedListener, Composer $composer, int $changed, int i) {
        String label2;
        Function1 finishedListener2;
        Composer composer = $composer;
        int i2 = $changed;
        ...
        State<Size> animateValueAsState = animateValueAsState(Size.m3060boximpl(targetValue), VectorConvertersKt.getVectorConverter(Size.Companion), animationSpec2, (Size) null, label2, finishedListener2, $composer, (i2 & 14) | ((i2 << 3) & 896) | ((i2 << 6) & 57344) | (458752 & (i2 << 6)), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final State<Offset> m93animateOffsetAsState7362WCg(long targetValue, AnimationSpec<Offset> animationSpec, String label, Function1<? super Offset, Unit> finishedListener, Composer $composer, int $changed, int i) {
        String label2;
        Function1 finishedListener2;
        Composer composer = $composer;
        int i2 = $changed;
        ...
        State<Offset> animateValueAsState = animateValueAsState(Offset.m2992boximpl(targetValue), VectorConvertersKt.getVectorConverter(Offset.Companion), animationSpec2, (Offset) null, label2, finishedListener2, $composer, (i2 & 14) | ((i2 << 3) & 896) | ((i2 << 6) & 57344) | (458752 & (i2 << 6)), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final State<IntOffset> m90animateIntOffsetAsStateHyPO7BM(long targetValue, AnimationSpec<IntOffset> animationSpec, String label, Function1<? super IntOffset, Unit> finishedListener, Composer $composer, int $changed, int i) {
        String label2;
        Function1 finishedListener2;
        Composer composer = $composer;
        int i2 = $changed;
        ...
        State<IntOffset> animateValueAsState = animateValueAsState(IntOffset.m5953boximpl(targetValue), VectorConvertersKt.getVectorConverter(IntOffset.Companion), animationSpec2, (IntOffset) null, label2, finishedListener2, $composer, (i2 & 14) | ((i2 << 3) & 896) | ((i2 << 6) & 57344) | (458752 & (i2 << 6)), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final State<IntSize> m91animateIntSizeAsState4goxYXU(long targetValue, AnimationSpec<IntSize> animationSpec, String label, Function1<? super IntSize, Unit> finishedListener, Composer $composer, int $changed, int i) {
        String label2;
        Function1 finishedListener2;
        Composer composer = $composer;
        int i2 = $changed;
        ...
        State<IntSize> animateValueAsState = animateValueAsState(IntSize.m5996boximpl(targetValue), VectorConvertersKt.getVectorConverter(IntSize.Companion), animationSpec2, (IntSize) null, label2, finishedListener2, $composer, (i2 & 14) | ((i2 << 3) & 896) | ((i2 << 6) & 57344) | (458752 & (i2 << 6)), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m88animateDpAsStateKz89ssw(float targetValue, AnimationSpec animationSpec, Function1 finishedListener, Composer $composer, int $changed, int i) {
        ...
        State<Dp> animateValueAsState = animateValueAsState(Dp.m5842boximpl(targetValue), VectorConvertersKt.getVectorConverter(Dp.Companion), animationSpec, (Dp) null, (String) null, finishedListener, $composer, ($changed & 14) | (($changed << 3) & 896) | (($changed << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m95animateSizeAsStateLjSzlW0(long targetValue, AnimationSpec animationSpec, Function1 finishedListener, Composer $composer, int $changed, int i) {
        Function1 finishedListener2;
        Composer composer = $composer;
        int i2 = $changed;
        ...
        State<Size> animateValueAsState = animateValueAsState(Size.m3060boximpl(targetValue), VectorConvertersKt.getVectorConverter(Size.Companion), animationSpec2, (Size) null, (String) null, finishedListener2, $composer, (i2 & 14) | ((i2 << 3) & 896) | ((i2 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m94animateOffsetAsStateN6fFfp4(long targetValue, AnimationSpec animationSpec, Function1 finishedListener, Composer $composer, int $changed, int i) {
        Function1 finishedListener2;
        Composer composer = $composer;
        int i2 = $changed;
        ...
        State<Offset> animateValueAsState = animateValueAsState(Offset.m2992boximpl(targetValue), VectorConvertersKt.getVectorConverter(Offset.Companion), animationSpec2, (Offset) null, (String) null, finishedListener2, $composer, (i2 & 14) | ((i2 << 3) & 896) | ((i2 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m89animateIntOffsetAsState8f6pmRE(long targetValue, AnimationSpec animationSpec, Function1 finishedListener, Composer $composer, int $changed, int i) {
        Function1 finishedListener2;
        Composer composer = $composer;
        int i2 = $changed;
        ...
        State<IntOffset> animateValueAsState = animateValueAsState(IntOffset.m5953boximpl(targetValue), VectorConvertersKt.getVectorConverter(IntOffset.Companion), animationSpec2, (IntOffset) null, (String) null, finishedListener2, $composer, (i2 & 14) | ((i2 << 3) & 896) | ((i2 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m92animateIntSizeAsStatezTRF_AQ(long targetValue, AnimationSpec animationSpec, Function1 finishedListener, Composer $composer, int $changed, int i) {
        Function1 finishedListener2;
        Composer composer = $composer;
        int i2 = $changed;
        ...
        State<IntSize> animateValueAsState = animateValueAsState(IntSize.m5996boximpl(targetValue), VectorConvertersKt.getVectorConverter(IntSize.Companion), animationSpec2, (IntSize) null, (String) null, finishedListener2, $composer, (i2 & 14) | ((i2 << 3) & 896) | ((i2 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
