...
public final class AnimatableKt {
    ...
    public static final Animatable<Float, AnimationVector1D> Animatable(float initialValue, float visibilityThreshold) {
        return new Animatable(Float.valueOf(initialValue), VectorConvertersKt.getVectorConverter(FloatCompanionObject.INSTANCE), Float.valueOf(visibilityThreshold), (String) null, 8, (DefaultConstructorMarker) null);
    }
}
