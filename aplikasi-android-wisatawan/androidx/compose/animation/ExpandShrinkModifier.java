...
final class ExpandShrinkModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m62sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        long preEnterSize = it != null ? it.getSize().invoke(IntSize.m5996boximpl(fullSize)).m6008unboximpl() : fullSize;
        ChangeSize it2 = this.shrink.getValue();
        long postExitSize = it2 != null ? it2.getSize().invoke(IntSize.m5996boximpl(fullSize)).m6008unboximpl() : fullSize;
    ...
    public final long m63targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        if (this.currentAlignment == null) {
            return IntOffset.Companion.m5972getZeronOccac();
        }
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) {
            ...
            case 3:
                ...
                long endSize = it.getSize().invoke(IntSize.m5996boximpl(fullSize)).m6008unboximpl();
                Alignment value = this.alignment.getValue();
                Intrinsics.checkNotNull(value);
                long j = fullSize;
                long j2 = endSize;
                long targetOffset = value.m2884alignKFBX0sM(j, j2, LayoutDirection.Ltr);
                Alignment alignment2 = this.currentAlignment;
                Intrinsics.checkNotNull(alignment2);
                long currentOffset = alignment2.m2884alignKFBX0sM(j, j2, LayoutDirection.Ltr);
                return IntOffsetKt.IntOffset(IntOffset.m5962getXimpl(targetOffset) - IntOffset.m5962getXimpl(currentOffset), IntOffset.m5963getYimpl(targetOffset) - IntOffset.m5963getYimpl(currentOffset));
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
    ...
    public MeasureResult m61measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        long offset;
        ...
        long currentSize = this.sizeAnimation.animate(this.sizeTransitionSpec, new ExpandShrinkModifier$measure$currentSize$1(this, measuredSize)).getValue().m6008unboximpl();
        long offsetDelta = this.offsetAnimation.animate(ExpandShrinkModifier$measure$offsetDelta$1.INSTANCE, new ExpandShrinkModifier$measure$offsetDelta$2(this, measuredSize)).getValue().m5971unboximpl();
        Alignment alignment2 = this.currentAlignment;
        if (alignment2 != null) {
            offset = alignment2.m2884alignKFBX0sM(measuredSize, currentSize, LayoutDirection.Ltr);
        } else {
            offset = IntOffset.Companion.m5972getZeronOccac();
        }
        long j = measuredSize;
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, IntSize.m6004getWidthimpl(currentSize), IntSize.m6003getHeightimpl(currentSize), (Map) null, new ExpandShrinkModifier$measure$1(placeable, offset, offsetDelta), 4, (Object) null);
    }
}
