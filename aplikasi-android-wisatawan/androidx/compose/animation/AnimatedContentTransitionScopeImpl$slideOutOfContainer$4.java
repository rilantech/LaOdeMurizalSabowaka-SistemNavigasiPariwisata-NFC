...
final class AnimatedContentTransitionScopeImpl$slideOutOfContainer$4 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int it) {
        ...
        long targetSize = state != null ? ((IntSize) state.getValue()).m6008unboximpl() : IntSize.Companion.m6009getZeroYbymL2g();
        return this.$targetOffset.invoke(Integer.valueOf((-IntOffset.m5963getYimpl(this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) + IntSize.m6003getHeightimpl(targetSize)));
    }
}
