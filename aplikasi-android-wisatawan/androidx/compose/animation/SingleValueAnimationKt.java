...
public final class SingleValueAnimationKt {
    ...
    public static final State<Color> m72animateColorAsStateeuL9pac(long targetValue, AnimationSpec<Color> animationSpec, String label, Function1<? super Color, Unit> finishedListener, Composer $composer, int $changed, int i) {
        String label2;
        ...
        Object key1$iv = Color.m3257getColorSpaceimpl(targetValue);
        ...
        State<Color> animateValueAsState = AnimateAsStateKt.animateValueAsState(Color.m3243boximpl(targetValue), (TwoWayConverter) value$iv$iv, animationSpec2, null, label2, finishedListener2, $composer, (i2 & 14) | 576 | ((i2 << 6) & 57344) | (458752 & (i2 << 6)), 8);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ State m71animateColorAsStateKTwxG1Y(long targetValue, AnimationSpec animationSpec, Function1 finishedListener, Composer $composer, int $changed, int i) {
        ...
        State<Color> r15 = m72animateColorAsStateeuL9pac(targetValue, animationSpec, (String) null, finishedListener, $composer, ($changed & 14) | 64 | (($changed << 3) & 7168), 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final Animatable<Color, AnimationVector4D> m70Animatable8_81llA(long initialValue) {
        return new Animatable(Color.m3243boximpl(initialValue), ColorVectorConverterKt.getVectorConverter(Color.Companion).invoke(Color.m3257getColorSpaceimpl(initialValue)), (Object) null, (String) null, 12, (DefaultConstructorMarker) null);
    }
}
