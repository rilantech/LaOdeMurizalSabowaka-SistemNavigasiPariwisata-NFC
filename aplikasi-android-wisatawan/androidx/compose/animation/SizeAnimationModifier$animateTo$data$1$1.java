    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Object animateTo$default = Animatable.animateTo$default(sizeAnimationModifier$animateTo$data$1$1.$this_apply.getAnim(), IntSize.m5996boximpl(sizeAnimationModifier$animateTo$data$1$1.$targetSize), sizeAnimationModifier$animateTo$data$1$1.this$0.getAnimSpec(), (Object) null, (Function1) null, sizeAnimationModifier$animateTo$data$1$1, 12, (Object) null);
        ...
        if (result.getEndReason() == AnimationEndReason.Finished && (listener = sizeAnimationModifier$animateTo$data$1$1.this$0.getListener()) != null) {
            listener.invoke(IntSize.m5996boximpl(sizeAnimationModifier$animateTo$data$1$1.$this_apply.m78getStartSizeYbymL2g()), result.getEndState().getValue());
        }
