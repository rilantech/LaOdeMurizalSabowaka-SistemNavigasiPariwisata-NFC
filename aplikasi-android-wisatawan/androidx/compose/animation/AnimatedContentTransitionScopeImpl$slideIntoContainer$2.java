...
final class AnimatedContentTransitionScopeImpl$slideIntoContainer$2 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int it) {
        return this.$initialOffset.invoke(Integer.valueOf((-IntOffset.m5962getXimpl(this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.this$0.m32getCurrentSizeYbymL2g()))) - it));
    }
}
