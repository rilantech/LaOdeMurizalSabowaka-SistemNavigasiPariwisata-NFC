...
final class AnimatedContentMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult m11measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> measurables, long constraints) {
        Placeable placeable;
        ...
        while (true) {
            ...
            if (z) {
                placeables[index] = measurable.m4689measureBRTryo0(j);
            }
            index$iv++;
        }
        ...
        for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
            ...
            if (placeables[index2] == null) {
                placeables[index2] = measurable2.m4689measureBRTryo0(j);
            }
        }
