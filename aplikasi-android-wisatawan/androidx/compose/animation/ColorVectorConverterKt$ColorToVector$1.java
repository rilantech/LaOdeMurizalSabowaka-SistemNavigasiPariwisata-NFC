    ...
    public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
        ...
        return VectorConvertersKt.TwoWayConverter(AnonymousClass1.INSTANCE, new Function1<AnimationVector4D, Color>() {
            public /* bridge */ /* synthetic */ Object invoke(Object p1) {
                return Color.m3243boximpl(m44invokevNxB06k((AnimationVector4D) p1));
            }

            /* renamed from: invoke-vNxB06k  reason: not valid java name */
            public final long m44invokevNxB06k(AnimationVector4D vector) {
                Intrinsics.checkNotNullParameter(vector, "vector");
                return Color.m3250convertvNxB06k(ColorKt.Color(RangesKt.coerceIn(vector.getV2(), 0.0f, 1.0f), RangesKt.coerceIn(vector.getV3(), -0.5f, 0.5f), RangesKt.coerceIn(vector.getV4(), -0.5f, 0.5f), RangesKt.coerceIn(vector.getV1(), 0.0f, 1.0f), ColorSpaces.INSTANCE.getOklab()), colorSpace);
            }
        });
    }
}
