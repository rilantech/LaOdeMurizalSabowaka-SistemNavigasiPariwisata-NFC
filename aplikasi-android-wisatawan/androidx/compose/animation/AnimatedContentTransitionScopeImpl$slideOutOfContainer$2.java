...
final class AnimatedContentTransitionScopeImpl$slideOutOfContainer$2 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int it) {
        ...
        return this.$targetOffset.invoke(Integer.valueOf((-IntOffset.m5962getXimpl(this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) + IntSize.m6004getWidthimpl(targetSize)));
    }
}
