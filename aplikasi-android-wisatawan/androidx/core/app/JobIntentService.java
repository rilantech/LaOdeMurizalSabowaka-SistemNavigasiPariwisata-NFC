...
public abstract class JobIntentService extends Service {
    ...
    static abstract class WorkEnqueuer {
        ...
        WorkEnqueuer(ComponentName cn2) {
    ...
    static final class CompatWorkEnqueuer extends WorkEnqueuer {
        ...
        CompatWorkEnqueuer(Context context, ComponentName cn2) {
            ...
            PowerManager.WakeLock newWakeLock = pm.newWakeLock(1, cn2.getClassName() + ":launch");
            this.mLaunchWakeLock = newWakeLock;
            newWakeLock.setReferenceCounted(false);
            PowerManager.WakeLock newWakeLock2 = pm.newWakeLock(1, cn2.getClassName() + ":run");
    ...
    static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName cn2, boolean hasJobId, int jobId) {
        ...
        WorkEnqueuer we = hashMap.get(cn2);
        if (we != null) {
            return we;
        }
        if (hasJobId) {
            WorkEnqueuer we2 = new JobWorkEnqueuer(context, cn2, jobId);
            hashMap.put(cn2, we2);
            return we2;
        }
