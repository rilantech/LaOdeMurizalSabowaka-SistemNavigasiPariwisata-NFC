...
public final class ShareCompat {
    ...
    private static class Api16Impl {
        ...
        static void migrateExtraStreamToClipData(Intent intent, ArrayList<Uri> streams) {
            ClipData clipData = new ClipData((CharSequence) null, new String[]{intent.getType()}, new ClipData.Item(intent.getCharSequenceExtra("android.intent.extra.TEXT"), intent.getStringExtra(IntentCompat.EXTRA_HTML_TEXT), (Intent) null, streams.get(0)));
