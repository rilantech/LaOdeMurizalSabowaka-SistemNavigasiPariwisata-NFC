...
public final class TextStreamsKt {
    ...
    public static final void forEachLine(java.io.Reader r11, kotlin.jvm.functions.Function1<? super java.lang.String, kotlin.Unit> r12) {
        ...
        L_0x001b:
            ...
            r3 = r2
            java.io.BufferedReader r3 = (java.io.BufferedReader) r3     // Catch:{ all -> 0x0044 }
            r4 = 0
            kotlin.sequences.Sequence r5 = lineSequence(r3)     // Catch:{ all -> 0x0044 }
            r6 = 0
            r7 = r5
            r8 = 0
            java.util.Iterator r9 = r7.iterator()     // Catch:{ all -> 0x0044 }
        L_0x002c:
            boolean r10 = r9.hasNext()     // Catch:{ all -> 0x0044 }
            if (r10 == 0) goto L_0x003a
            java.lang.Object r10 = r9.next()     // Catch:{ all -> 0x0044 }
            r12.invoke(r10)     // Catch:{ all -> 0x0044 }
            goto L_0x002c
        L_0x003a:
            kotlin.Unit r5 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0044 }
            r3 = 0
            kotlin.io.CloseableKt.closeFinally(r2, r3)
            return
        L_0x0044:
