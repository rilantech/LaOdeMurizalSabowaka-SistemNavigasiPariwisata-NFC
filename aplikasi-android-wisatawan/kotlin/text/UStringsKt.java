...
public final class UStringsKt {
    ...
    public static final String m7533toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m7535toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m7534toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m7532toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m6297unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m6560unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m6376unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m6455unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m6376unboximpl();
        if (Integer.compareUnsigned(r0, UInt.m6324constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m6241boximpl(UByte.m6247constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m6376unboximpl();
        if (Integer.compareUnsigned(r0, UInt.m6324constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m6504boximpl(UShort.m6510constructorimpl((short) r0));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m6324constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m6324constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m6324constructorimpl(UInt.m6324constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, beforeAdding) < 0) {
                return null;
            }
        }
        return UInt.m6318boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m6403constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (Long.compareUnsigned(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = Long.divideUnsigned(-1, uradix);
                if (Long.compareUnsigned(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            long result2 = ULong.m6403constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m6403constructorimpl(ULong.m6403constructorimpl(((long) UInt.m6324constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m6397boximpl(result);
    }
}
