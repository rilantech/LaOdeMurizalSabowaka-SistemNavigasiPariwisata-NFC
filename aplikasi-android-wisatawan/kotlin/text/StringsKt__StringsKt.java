...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final boolean hasSurrogatePairAt(CharSequence $this$hasSurrogatePairAt, int index) {
        ...
        if (!new IntRange(0, $this$hasSurrogatePairAt.length() - 2).contains(index) || !Character.isHighSurrogate($this$hasSurrogatePairAt.charAt(index)) || !Character.isLowSurrogate($this$hasSurrogatePairAt.charAt(index + 1))) {
            return false;
        }
        return true;
    }
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence $this$findAnyOf, Collection<String> strings, int startIndex, boolean ignoreCase, boolean last) {
        ...
        String str = string;
        int i2 = startIndex;
        int index5 = !last ? StringsKt.indexOf$default(charSequence2, str, i2, false, 4, (Object) null) : StringsKt.lastIndexOf$default(charSequence2, str, i2, false, 4, (Object) null);
        if (index5 < 0) {
            return null;
        }
