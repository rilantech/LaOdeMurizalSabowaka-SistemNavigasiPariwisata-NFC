...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m7549getAdjustmentUwyO8pc() {
    ...
    public TimeMark m7550minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m7700minusLRDsOJo(this, duration);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m7548elapsedNowUwyO8pc() {
        return Duration.m7595minusLRDsOJo(this.mark.m7697elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m7551plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m7596plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
