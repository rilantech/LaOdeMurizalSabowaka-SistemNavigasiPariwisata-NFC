...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m7538minusLRDsOJo(long duration) {
            return ComparableTimeMark.DefaultImpls.m7555minusLRDsOJo(this, duration);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m7536elapsedNowUwyO8pc() {
            return Duration.m7595minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark m7541plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m7596plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m7539minusUwyO8pc(ComparableTimeMark other) {
            ...
            } else if (Duration.m7565equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m7592isInfiniteimpl(this.offset)) {
                return Duration.Companion.m7663getZEROUwyO8pc();
            } else {
                long offsetDiff = Duration.m7595minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
                long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
                return Duration.m7565equalsimpl0(startedAtDiff, Duration.m7613unaryMinusUwyO8pc(offsetDiff)) ? Duration.Companion.m7663getZEROUwyO8pc() : Duration.m7596plusLRDsOJo(startedAtDiff, offsetDiff);
            }
        }

        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) other).timeSource) && Duration.m7565equalsimpl0(m7539minusUwyO8pc((ComparableTimeMark) other), Duration.Companion.m7663getZEROUwyO8pc());
        }

        public int hashCode() {
            return Duration.m7588hashCodeimpl(Duration.m7596plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m7609toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m7663getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
