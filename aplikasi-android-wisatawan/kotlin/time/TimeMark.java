...
public interface TimeMark {
    ...
    TimeMark m7698minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    TimeMark m7699plusLRDsOJo(long j);

    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* compiled from: TimeSource.kt */
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public static TimeMark m7701plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m7700minusLRDsOJo(TimeMark $this, long duration) {
            return $this.m7699plusLRDsOJo(Duration.m7613unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m7593isNegativeimpl($this.m7697elapsedNowUwyO8pc());
        }
