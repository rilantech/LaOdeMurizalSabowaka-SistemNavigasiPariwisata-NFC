...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> $this$toUByteArray) {
        ...
        byte[] result = UByteArray.m6299constructorimpl($this$toUByteArray.size());
        int index = 0;
        for (UByte r3 : $this$toUByteArray) {
            UByteArray.m6310setVurrAj0(result, index, r3.m6297unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> $this$toUIntArray) {
        ...
        int[] result = UIntArray.m6378constructorimpl($this$toUIntArray.size());
        int index = 0;
        for (UInt r3 : $this$toUIntArray) {
            UIntArray.m6389setVXSXFK8(result, index, r3.m6376unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> $this$toULongArray) {
        ...
        long[] result = ULongArray.m6457constructorimpl($this$toULongArray.size());
        int index = 0;
        for (ULong r3 : $this$toULongArray) {
            ULongArray.m6468setk8EXiF4(result, index, r3.m6455unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> $this$toUShortArray) {
        ...
        short[] result = UShortArray.m6562constructorimpl($this$toUShortArray.size());
        int index = 0;
        for (UShort r3 : $this$toUShortArray) {
            UShortArray.m6573set01HTLdE(result, index, r3.m6560unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> $this$sum) {
        ...
        for (UInt r2 : $this$sum) {
            sum = UInt.m6324constructorimpl(sum + r2.m6376unboximpl());
        }
        return sum;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> $this$sum) {
        ...
        for (ULong r3 : $this$sum) {
            sum = ULong.m6403constructorimpl(sum + r3.m6455unboximpl());
        }
        return sum;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> $this$sum) {
        ...
        for (UByte r2 : $this$sum) {
            sum = UInt.m6324constructorimpl(UInt.m6324constructorimpl(r2.m6297unboximpl() & UByte.MAX_VALUE) + sum);
        }
        return sum;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> $this$sum) {
        ...
        for (UShort r2 : $this$sum) {
            sum = UInt.m6324constructorimpl(UInt.m6324constructorimpl(65535 & r2.m6560unboximpl()) + sum);
        }
        return sum;
    }
}
