...
class ArraysKt__ArraysKt extends ArraysKt__ArraysJVMKt {
                                                    ...
                                                    if (!(v1 instanceof UByteArray) || !(v2 instanceof UByteArray)) {
                                                        if (!(v1 instanceof UShortArray) || !(v2 instanceof UShortArray)) {
                                                            if (!(v1 instanceof UIntArray) || !(v2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m6795contentEqualslec5QzE(((ULongArray) v1).m6472unboximpl(), ((ULongArray) v2).m6472unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m6793contentEqualsKJPZfPQ(((UIntArray) v1).m6393unboximpl(), ((UIntArray) v2).m6393unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m6792contentEqualsFGO6Aew(((UShortArray) v1).m6577unboximpl(), ((UShortArray) v2).m6577unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m6794contentEqualskV0jMPg(((UByteArray) v1).m6314unboximpl(), ((UByteArray) v2).m6314unboximpl())) {
                                                        return false;
                                                    }
    ...
    public static final <T> String contentDeepToString(T[] $this$contentDeepToStringImpl) {
        ...
        StringBuilder $this$contentDeepToStringImpl_u24lambda_u242 = new StringBuilder((RangesKt.coerceAtMost($this$contentDeepToStringImpl.length, 429496729) * 5) + 2);
        contentDeepToStringInternal$ArraysKt__ArraysKt($this$contentDeepToStringImpl, $this$contentDeepToStringImpl_u24lambda_u242, new ArrayList());
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] r5, java.lang.StringBuilder r6, java.util.List<java.lang.Object[]> r7) {
        ...
        L_0x00d1:
            ...
            byte[] r4 = r3.m6314unboximpl()
        L_0x00df:
            java.lang.String r3 = kotlin.collections.unsigned.UArraysKt.m6800contentToString2csIQuQ(r4)
            r6.append(r3)
            goto L_0x012d
        L_0x00e7:
            ...
            short[] r4 = r3.m6577unboximpl()
        L_0x00f4:
            java.lang.String r3 = kotlin.collections.unsigned.UArraysKt.m6802contentToStringd6D3K8(r4)
            r6.append(r3)
            goto L_0x012d
        L_0x00fc:
            ...
            int[] r4 = r3.m6393unboximpl()
        L_0x0109:
            java.lang.String r3 = kotlin.collections.unsigned.UArraysKt.m6801contentToStringXUkPCBk(r4)
            r6.append(r3)
            goto L_0x012d
        L_0x0111:
            ...
            long[] r4 = r3.m6472unboximpl()
        L_0x011e:
            java.lang.String r3 = kotlin.collections.unsigned.UArraysKt.m6803contentToStringuLth9ew(r4)
            r6.append(r3)
            goto L_0x012d
        L_0x0126:
