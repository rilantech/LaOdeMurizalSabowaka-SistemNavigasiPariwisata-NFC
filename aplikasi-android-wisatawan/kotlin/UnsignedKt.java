...
public final class UnsignedKt {
    ...
    public static final int m6580uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m6324constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }

    /* renamed from: uintRemainder-J1ME1BU  reason: not valid java name */
    public static final int m6581uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m6324constructorimpl((int) ((((long) v1) & 4294967295L) % (4294967295L & ((long) v2))));
    }

    /* renamed from: ulongDivide-eb3DHEI  reason: not valid java name */
    public static final long m6582ulongDivideeb3DHEI(long v1, long v2) {
        long dividend = v1;
        long divisor = v2;
        long j = 0;
        if (divisor < 0) {
            ...
            return ULong.m6403constructorimpl(j);
        } else if (dividend >= 0) {
            return ULong.m6403constructorimpl(dividend / divisor);
        } else {
            int i = 1;
            long quotient = ((dividend >>> 1) / divisor) << 1;
            if (Long.compareUnsigned(ULong.m6403constructorimpl(dividend - (quotient * divisor)), ULong.m6403constructorimpl(divisor)) < 0) {
                i = 0;
            }
            return ULong.m6403constructorimpl(((long) i) + quotient);
        }
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m6583ulongRemaindereb3DHEI(long v1, long v2) {
        long dividend = v1;
        long divisor = v2;
        long j = 0;
        if (divisor < 0) {
            ...
            return ULong.m6403constructorimpl(v1 - v2);
        } else if (dividend >= 0) {
            return ULong.m6403constructorimpl(dividend % divisor);
        } else {
            long rem = dividend - ((((dividend >>> 1) / divisor) << 1) * divisor);
            if (Long.compareUnsigned(ULong.m6403constructorimpl(rem), ULong.m6403constructorimpl(divisor)) >= 0) {
                j = divisor;
            }
            return ULong.m6403constructorimpl(rem - j);
        }
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        if (v <= 2.147483647E9d) {
            return UInt.m6324constructorimpl((int) v);
        }
        return UInt.m6324constructorimpl(UInt.m6324constructorimpl((int) (v - ((double) Integer.MAX_VALUE))) + UInt.m6324constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        if (v < 9.223372036854776E18d) {
            return ULong.m6403constructorimpl((long) v);
        }
        return ULong.m6403constructorimpl(ULong.m6403constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
