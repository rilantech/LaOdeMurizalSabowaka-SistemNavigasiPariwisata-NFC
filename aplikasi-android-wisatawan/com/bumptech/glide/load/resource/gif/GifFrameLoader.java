...
class GifFrameLoader {
    ...
    GifFrameLoader(Glide glide, GifDecoder gifDecoder2, int width2, int height2, Transformation<Bitmap> transformation2, Bitmap firstFrame2) {
        this(glide.getBitmapPool(), Glide.with(glide.getContext()), gifDecoder2, (Handler) null, getRequestBuilder(Glide.with(glide.getContext()), width2, height2), transformation2, firstFrame2);
    }
