...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
    ...
    public void onResourceReady(Resource<R> resource2, DataSource dataSource2, boolean isLoadedFromAlternateCacheKey2) {
        synchronized (this) {
            this.resource = resource2;
            this.dataSource = dataSource2;
            this.isLoadedFromAlternateCacheKey = isLoadedFromAlternateCacheKey2;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x002f, code lost:
        r7.engineJobListener.onEngineJobComplete(r7, r1, (com.bumptech.glide.load.engine.EngineResource<?>) null);
        r0 = r2.iterator();
     */
