...
public final class GlideBuilder {
    ...
    public GlideBuilder setImageDecoderEnabledForBitmaps(boolean isEnabled) {
        this.glideExperimentsBuilder.update(new EnableImageDecoderForBitmaps(), isEnabled);
        return this;
    }
    ...
    /* access modifiers changed from: package-private */
    public Glide build(Context context, List<GlideModule> manifestModules, AppGlideModule annotationGeneratedGlideModule) {
    ...
    static final class ManualOverrideHardwareBitmapMaxFdCount implements GlideExperiments.Experiment {
        ...
        ManualOverrideHardwareBitmapMaxFdCount(int fdCount2) {
            this.fdCount = fdCount2;
        }
    }
