...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>> implements Cloneable, ModelTypes<RequestBuilder<TranscodeType>> {
    ...
    public RequestBuilder<TranscodeType> error(RequestBuilder<TranscodeType> errorBuilder2) {
        if (isAutoCloneEnabled()) {
            return clone().error(errorBuilder2);
        }
        this.errorBuilder = errorBuilder2;
        return (RequestBuilder) selfOrThrowIfLocked();
    }

    public RequestBuilder<TranscodeType> error(Object model2) {
        if (model2 != null) {
            return error(cloneWithNullErrorAndThumbnail().load(model2));
        }
    ...
    private RequestBuilder<TranscodeType> loadGeneric(Object model2) {
        if (isAutoCloneEnabled()) {
            return clone().loadGeneric(model2);
        }
        this.model = model2;
    ...
    public RequestBuilder<TranscodeType> clone() {
        ...
        if (requestBuilder != null) {
            result.thumbnailBuilder = requestBuilder.clone();
        }
        RequestBuilder<TranscodeType> requestBuilder2 = result.errorBuilder;
        if (requestBuilder2 != null) {
            result.errorBuilder = requestBuilder2.clone();
        }
        return result;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!super.equals(that) || !Objects.equals(this.transcodeClass, that.transcodeClass) || !this.transitionOptions.equals(that.transitionOptions) || !Objects.equals(this.model, that.model) || !Objects.equals(this.requestListeners, that.requestListeners) || !Objects.equals(this.thumbnailBuilder, that.thumbnailBuilder) || !Objects.equals(this.errorBuilder, that.errorBuilder) || !Objects.equals(this.thumbSizeMultiplier, that.thumbSizeMultiplier) || this.isDefaultTransitionOptionsSet != that.isDefaultTransitionOptionsSet || this.isModelSet != that.isModelSet) {
            return false;
        }
        return true;
    }
