...
public final class MonochromeRectangleDetector {
    ...
    public ResultPoint[] detect() throws NotFoundException {
        ...
        int deltaX3 = deltaX;
        int i4 = top;
        ResultPoint pointB = findCornerFromCenter(i, -deltaX3, 0, i2, i3, 0, i4, deltaX2, halfHeight / 2);
        int x = ((int) pointB.getX()) - 1;
        ResultPoint pointB2 = pointB;
        ResultPoint pointC = findCornerFromCenter(halfWidth, deltaX3, x, i2, i3, 0, i4, deltaX2, halfHeight / 2);
        int x2 = ((int) pointC.getX()) + 1;
        ResultPoint pointC2 = pointC;
        ResultPoint pointD = findCornerFromCenter(halfWidth, 0, x, x2, i3, deltaY2, i4, deltaX2, halfWidth / 2);
        int deltaY3 = deltaY2;
        int i5 = deltaY3;
        return new ResultPoint[]{findCornerFromCenter(halfWidth, 0, x, x2, i3, -deltaY3, i4, 1 + ((int) pointD.getY()), halfWidth / 4), pointB2, pointC2, pointD};
    }
