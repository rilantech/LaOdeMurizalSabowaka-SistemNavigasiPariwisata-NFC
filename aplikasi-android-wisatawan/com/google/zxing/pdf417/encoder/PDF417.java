...
public final class PDF417 {
    ...
    public void generateBarcodeLogic(String msg, int errorCorrectionLevel) throws WriterException {
        ...
        String encodeHighLevel = PDF417HighLevelEncoder.encodeHighLevel(msg, this.compaction, this.encoding);
        String highLevel = encodeHighLevel;
        int sourceCodeWords = encodeHighLevel.length();
        ...
        if (sourceCodeWords + errorCorrectionCodeWords + 1 <= 929) {
            ...
            String dataCodewords = sb3;
            String ec = PDF417ErrorCorrection.generateErrorCorrection(sb3, errorCorrectionLevel);
