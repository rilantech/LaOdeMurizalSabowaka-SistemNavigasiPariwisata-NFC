...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        if (i4 * 4 >= i5 * 7 || i5 * 4 >= i4 * 7) {
            ...
            int transitions3 = transitionsBetween(resultPoint14, resultPoint).getTransitions();
            ...
            bitMatrix = sampleGrid(this.image, resultPoint14, resultPoint12, resultPoint11, resultPoint, i, i2);
        } else {
