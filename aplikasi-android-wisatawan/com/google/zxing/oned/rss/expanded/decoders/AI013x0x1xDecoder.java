...
final class AI013x0x1xDecoder extends AI01weightDecoder {
    ...
    public void addWeightCode(StringBuilder buf, int weight) {
        ...
        buf.append(weight / AndroidComposeViewAccessibilityDelegateCompat.ParcelSafeTextLength);
        buf.append(')');
    }

    /* access modifiers changed from: protected */
    public int checkWeight(int weight) {
        return weight % AndroidComposeViewAccessibilityDelegateCompat.ParcelSafeTextLength;
    }
}
