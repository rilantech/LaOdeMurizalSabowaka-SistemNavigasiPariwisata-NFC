...
class MonthAdapter extends BaseAdapter {
    ...
    private void updateSelectedState(TextView dayTextView, long date, int dayNumber) {
        ...
        if (textView != null) {
            ...
            int i3 = year2;
            int i4 = month3;
            ColorStateList backgroundColorOverride2 = backgroundColorOverride;
            boolean z2 = selected;
            ColorStateList textColorOverride = this.dayViewDecorator.getTextColor(context2, i3, i4, month4, z, z2);
            style.styleItem(textView, backgroundColorOverride2, textColorOverride);
            ColorStateList colorStateList = backgroundColorOverride2;
            Drawable drawableLeft = this.dayViewDecorator.getCompoundDrawableLeft(context2, i3, i4, month4, z, z2);
            ColorStateList colorStateList2 = textColorOverride;
            Drawable drawableTop = this.dayViewDecorator.getCompoundDrawableTop(context2, i3, i4, month4, z, selected);
            CalendarItemStyle style2 = style;
            Drawable drawableRight = this.dayViewDecorator.getCompoundDrawableRight(context2, i3, i4, month4, z, selected);
