...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet<SideSheetCallback> {
    ...
    private void setSheetEdge(V view, int layoutDirection) {
        setSheetEdge(GravityCompat.getAbsoluteGravity(((CoordinatorLayout.LayoutParams) view.getLayoutParams()).gravity, layoutDirection) == 3 ? 1 : 0);
    }
    ...
    public /* synthetic */ void m6204lambda$setState$0$comgoogleandroidmaterialsidesheetSideSheetBehavior(int finalState) {
    ...
    public /* synthetic */ void m6203lambda$getCoplanarFinishAnimatorUpdateListener$1$comgoogleandroidmaterialsidesheetSideSheetBehavior(ViewGroup.MarginLayoutParams coplanarSiblingLayoutParams, int coplanarSiblingAdjacentMargin, View coplanarSiblingView, ValueAnimator animation) {
    ...
    class StateSettlingTracker {
        ...
        public /* synthetic */ void m6205lambda$new$0$comgoogleandroidmaterialsidesheetSideSheetBehavior$StateSettlingTracker() {
    ...
    public /* synthetic */ boolean m6202lambda$createAccessibilityViewCommandForState$2$comgoogleandroidmaterialsidesheetSideSheetBehavior(int state2, View view, AccessibilityViewCommand.CommandArguments arguments) {
        setState(state2);
        return true;
    }
}
