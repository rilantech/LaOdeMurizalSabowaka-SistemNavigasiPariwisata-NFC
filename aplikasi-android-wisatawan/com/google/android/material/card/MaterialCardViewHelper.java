...
class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(MaterialCardView card, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.iconFadeInAnimDuration = MotionUtils.resolveThemeDuration(card.getContext(), R.attr.motionDurationShort2, 300);
        this.iconFadeOutAnimDuration = MotionUtils.resolveThemeDuration(card.getContext(), R.attr.motionDurationShort1, 300);
    ...
    public /* synthetic */ void m6135lambda$animateCheckedIcon$0$comgoogleandroidmaterialcardMaterialCardViewHelper(ValueAnimator animation) {
