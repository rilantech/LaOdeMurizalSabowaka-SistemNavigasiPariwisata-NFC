...
public class NavigationView extends ScrimInsetsFrameLayout implements MaterialBackHandler {
    ...
    public NavigationView(android.content.Context r21, android.util.AttributeSet r22, int r23) {
        /*
            ...
            com.google.android.material.shape.ShapeableDelegate r2 = com.google.android.material.shape.ShapeableDelegate.create(r20)
            r0.shapeableDelegate = r2
            com.google.android.material.motion.MaterialSideContainerBackHelper r2 = new com.google.android.material.motion.MaterialSideContainerBackHelper
            r2.<init>(r0)
            r0.sideContainerBackHelper = r2
            com.google.android.material.motion.MaterialBackOrchestrator r2 = new com.google.android.material.motion.MaterialBackOrchestrator
            r2.<init>(r0)
            r0.backOrchestrator = r2
            com.google.android.material.navigation.NavigationView$1 r2 = new com.google.android.material.navigation.NavigationView$1
            r2.<init>()
            r0.backDrawerListener = r2
        ...
        L_0x006a:
            ...
            android.graphics.drawable.Drawable r2 = r20.getBackground()
        ...
        L_0x007e:
            com.google.android.material.shape.ShapeAppearanceModel$Builder r4 = com.google.android.material.shape.ShapeAppearanceModel.builder((android.content.Context) r13, (android.util.AttributeSet) r7, (int) r8, (int) r9)
            ...
            r5.<init>((com.google.android.material.shape.ShapeAppearanceModel) r4)
        ...
        L_0x0097:
            int r4 = com.google.android.material.R.styleable.NavigationView_elevation
            ...
            r0.setElevation(r4)
        L_0x00a9:
            int r4 = com.google.android.material.R.styleable.NavigationView_android_fitsSystemWindows
            boolean r4 = r1.getBoolean(r4, r12)
            r0.setFitsSystemWindows(r4)
            int r4 = com.google.android.material.R.styleable.NavigationView_android_maxWidth
            int r4 = r1.getDimensionPixelSize(r4, r12)
            r0.maxWidth = r4
            r4 = 0
            int r5 = com.google.android.material.R.styleable.NavigationView_subheaderColor
            boolean r5 = r1.hasValue(r5)
            if (r5 == 0) goto L_0x00c9
            int r5 = com.google.android.material.R.styleable.NavigationView_subheaderColor
            android.content.res.ColorStateList r4 = r1.getColorStateList(r5)
        L_0x00c9:
            r5 = 0
            int r6 = com.google.android.material.R.styleable.NavigationView_subheaderTextAppearance
        ...
        L_0x00d8:
            ...
            android.content.res.ColorStateList r4 = r0.createDefaultColorStateList(r6)
        L_0x00e3:
            int r9 = com.google.android.material.R.styleable.NavigationView_itemIconTint
        ...
        L_0x00f6:
            r9 = 0
            int r15 = com.google.android.material.R.styleable.NavigationView_itemTextAppearance
            boolean r15 = r1.hasValue(r15)
            if (r15 == 0) goto L_0x0105
            int r15 = com.google.android.material.R.styleable.NavigationView_itemTextAppearance
            int r9 = r1.getResourceId(r15, r12)
        L_0x0105:
            int r15 = com.google.android.material.R.styleable.NavigationView_itemTextAppearanceActiveBoldEnabled
            boolean r15 = r1.getBoolean(r15, r11)
            int r11 = com.google.android.material.R.styleable.NavigationView_itemIconSize
            boolean r11 = r1.hasValue(r11)
            if (r11 == 0) goto L_0x011c
            int r11 = com.google.android.material.R.styleable.NavigationView_itemIconSize
            int r11 = r1.getDimensionPixelSize(r11, r12)
            r0.setItemIconSize(r11)
        L_0x011c:
            r11 = 0
            ...
            int r12 = com.google.android.material.R.styleable.NavigationView_itemTextColor
            android.content.res.ColorStateList r11 = r1.getColorStateList(r12)
        L_0x012b:
            if (r9 != 0) goto L_0x0136
            if (r11 != 0) goto L_0x0136
            r12 = 16842806(0x1010036, float:2.369371E-38)
            android.content.res.ColorStateList r11 = r0.createDefaultColorStateList(r12)
        L_0x0136:
            int r12 = com.google.android.material.R.styleable.NavigationView_itemBackground
            android.graphics.drawable.Drawable r12 = r1.getDrawable(r12)
            if (r12 != 0) goto L_0x016f
            boolean r16 = r0.hasShapeAppearance(r1)
            if (r16 == 0) goto L_0x016f
            android.graphics.drawable.Drawable r12 = r0.createDefaultItemBackground(r1)
            r21 = r2
            int r2 = com.google.android.material.R.styleable.NavigationView_itemRippleColor
            ...
            r16 = r3
            r3 = 0
            android.graphics.drawable.Drawable r7 = r0.createDefaultItemDrawable(r1, r3)
            android.graphics.drawable.RippleDrawable r3 = new android.graphics.drawable.RippleDrawable
            android.content.res.ColorStateList r8 = com.google.android.material.ripple.RippleUtils.sanitizeRippleDrawableColor(r2)
            r18 = r2
            r2 = 0
            r3.<init>(r8, r2, r7)
            r2 = r3
            r10.setItemForeground(r2)
            goto L_0x0173
        L_0x016a:
            r18 = r2
            r16 = r3
        ...
        L_0x0199:
            ...
            int r7 = com.google.android.material.R.styleable.NavigationView_dividerInsetEnd
            int r7 = r1.getDimensionPixelSize(r7, r3)
            r0.setDividerInsetEnd(r7)
            int r8 = com.google.android.material.R.styleable.NavigationView_subheaderInsetStart
            int r8 = r1.getDimensionPixelSize(r8, r3)
            r0.setSubheaderInsetStart(r8)
            r17 = r2
            int r2 = com.google.android.material.R.styleable.NavigationView_subheaderInsetEnd
            int r2 = r1.getDimensionPixelSize(r2, r3)
            ...
            boolean r3 = r0.bottomInsetScrimEnabled
            boolean r2 = r1.getBoolean(r2, r3)
            r0.setBottomInsetScrimEnabled(r2)
            int r2 = com.google.android.material.R.styleable.NavigationView_itemIconPadding
            r3 = 0
            int r2 = r1.getDimensionPixelSize(r2, r3)
            int r3 = com.google.android.material.R.styleable.NavigationView_itemMaxLines
            r19 = r7
            r7 = 1
            int r3 = r1.getInt(r3, r7)
            r0.setItemMaxLines(r3)
            com.google.android.material.navigation.NavigationView$2 r3 = new com.google.android.material.navigation.NavigationView$2
            r3.<init>()
            r14.setCallback(r3)
            r10.setId(r7)
            r10.initForMenu(r13, r14)
            if (r5 == 0) goto L_0x01fd
            r10.setSubheaderTextAppearance(r5)
        L_0x01fd:
            r10.setSubheaderColor(r4)
            r10.setItemIconTintList(r6)
            int r3 = r20.getOverScrollMode()
            r10.setOverScrollMode(r3)
            if (r9 == 0) goto L_0x020f
            r10.setItemTextAppearance(r9)
        L_0x020f:
            r10.setItemTextAppearanceActiveBoldEnabled(r15)
            r10.setItemTextColor(r11)
            r10.setItemBackground(r12)
            r10.setItemIconPadding(r2)
            r14.addMenuPresenter(r10)
            androidx.appcompat.view.menu.MenuView r3 = r10.getMenuView(r0)
            android.view.View r3 = (android.view.View) r3
            r0.addView(r3)
            int r3 = com.google.android.material.R.styleable.NavigationView_menu
            boolean r3 = r1.hasValue(r3)
            if (r3 == 0) goto L_0x023a
            int r3 = com.google.android.material.R.styleable.NavigationView_menu
            r7 = 0
            int r3 = r1.getResourceId(r3, r7)
            r0.inflateMenu(r3)
            goto L_0x023b
        L_0x023a:
            r7 = 0
        L_0x023b:
            int r3 = com.google.android.material.R.styleable.NavigationView_headerLayout
            boolean r3 = r1.hasValue(r3)
            if (r3 == 0) goto L_0x024c
            int r3 = com.google.android.material.R.styleable.NavigationView_headerLayout
            int r3 = r1.getResourceId(r3, r7)
            r0.inflateHeaderView(r3)
        L_0x024c:
            r1.recycle()
            r20.setupInsetScrimsListener()
            return
        */
    ...
    public /* synthetic */ void m6186lambda$dispatchDraw$0$comgoogleandroidmaterialnavigationNavigationView(Canvas x$0) {
