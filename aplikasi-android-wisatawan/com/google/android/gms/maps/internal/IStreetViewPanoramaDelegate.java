...
public interface IStreetViewPanoramaDelegate extends IInterface {
    ...
    void setOnStreetViewPanoramaCameraChangeListener(@Nullable zzbl zzbl) throws RemoteException;

    void setOnStreetViewPanoramaChangeListener(@Nullable zzbn zzbn) throws RemoteException;

    void setOnStreetViewPanoramaClickListener(@Nullable zzbp zzbp) throws RemoteException;

    void setOnStreetViewPanoramaLongClickListener(@Nullable zzbr zzbr) throws RemoteException;
