...
public final class HalamanUtamaAdminBinding implements ViewBinding {
    ...
    private HalamanUtamaAdminBinding(LinearLayout rootView2, ImageView btnLogout2, LinearLayout main2, TextView result2, Button tombolBacaTag2, TextView tvNama2, TextView tvPassword2, TextView tvUsername2) {
                ...
                if (tombolBacaTag2 != null) {
                    ...
                    if (tvNama2 != null) {
                        ...
                        if (tvPassword2 != null) {
                            ...
                            if (tvUsername2 != null) {
                                return new HalamanUtamaAdminBinding((LinearLayout) view, btnLogout2, main2, result2, tombolBacaTag2, tvNama2, tvPassword2, tvUsername2);
                            }
                        }
                    }
                }
