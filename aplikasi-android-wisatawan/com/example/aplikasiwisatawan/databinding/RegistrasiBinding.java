...
public final class RegistrasiBinding implements ViewBinding {
    ...
    private RegistrasiBinding(LinearLayout rootView2, Button btnRegister2, EditText etNama2, EditText etPassword2, EditText etUsername2, LinearLayout main2, TextView tvLogin2) {
    ...
    public static RegistrasiBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, (ViewGroup) null, false);
    }

    public static RegistrasiBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.registrasi, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static RegistrasiBinding bind(View rootView2) {
        View view = rootView2;
            ...
            if (etNama2 != null) {
                ...
                if (etPassword2 != null) {
                    ...
                    if (etUsername2 != null) {
                        ...
                        if (tvLogin2 != null) {
                            return new RegistrasiBinding((LinearLayout) view, btnRegister2, etNama2, etPassword2, etUsername2, main2, tvLogin2);
                        }
                    }
                }
            }
