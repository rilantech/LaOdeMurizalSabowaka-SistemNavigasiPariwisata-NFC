...
public class Login extends AppCompatActivity {
    ...
    private String URLline = (KoneksiApi.URL_API + "api/login");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.tvRegistrasi = (TextView) findViewById(R.id.tvRegister);
        ...
        this.tvRegistrasi.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Login.this.startActivity(new Intent(Login.this, Registrasi.class));
                Login.this.finish();
            }
        });
    ...
    public void loginUser() {
        ...
        StringRequest stringRequest = new StringRequest(1, this.URLline, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                new SweetAlertDialog(Login.this, 1).setTitleText("Info").setContentText("Gagal Login!").show();
            }
        }) {
            /* access modifiers changed from: protected */
