...
<form  action='{{  url('tabeldaftarkategoriwisata') }}' method='post'>
    ...
    <div class="my-3 p-3 bg-success border border-2 border-black rounded shadow-sm row-xl-6 row-sm-12 mx-auto">
     <div class="row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm">
                <textarea class="form-control text-black @error('keterangan') is-invalid @enderror" name='keterangan'  id="keterangan" autocomplete="off">{{ old('keterangan') }}</textarea>
                @error('keterangan')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
