...
public class ShadowDrawableWrapper extends DrawableWrapperCompat {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float shadowScaleBottom3 = shadowOffset / (shadowOffset + (f - (f * 1.0f)));
        ...
        canvas2.scale(shadowScaleHorizontal, shadowScaleBottom4);
        canvas2.rotate(180.0f);
        canvas2.drawPath(this.cornerShadowPath, this.cornerShadowPaint);
        if (drawHorizontalEdges) {
            canvas2.scale(shadowOffsetHorizontal / shadowScaleHorizontal, shadowOffsetHorizontal);
        ...
        canvas2.scale(shadowScaleHorizontal, shadowScaleBottom2);
        ...
        canvas2.scale(shadowScaleHorizontal, shadowScaleTop3);
