...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public void setTextAppearanceActive(int activeTextAppearance2) {
        this.activeTextAppearance = activeTextAppearance2;
        setTextAppearanceWithoutFontScaling(this.largeLabel, activeTextAppearance2);
        calculateTextScaleFactors(this.smallLabel.getTextSize(), this.largeLabel.getTextSize());
    }
    ...
    public void setTextAppearanceActiveBoldEnabled(boolean isBold) {
        ...
        TextView textView = this.largeLabel;
        textView.setTypeface(textView.getTypeface(), isBold);
    }
