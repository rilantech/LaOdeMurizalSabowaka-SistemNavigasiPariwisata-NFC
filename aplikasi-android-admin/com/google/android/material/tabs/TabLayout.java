...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(android.content.Context r12, android.util.AttributeSet r13, int r14) {
        /*
            ...
            r11.<init>(r0, r13, r14)
            r6 = -1
            r11.indicatorPosition = r6
            java.util.ArrayList r0 = new java.util.ArrayList
            r0.<init>()
            r11.tabs = r0
            r11.selectedTabTextAppearance = r6
            r7 = 0
            r11.tabSelectedIndicatorColor = r7
            ...
            r11.setHorizontalScrollBarEnabled(r7)
        ...
        L_0x0075:
            int r2 = com.google.android.material.R.styleable.TabLayout_tabIndicator
            android.graphics.drawable.Drawable r2 = com.google.android.material.resources.MaterialResources.getDrawable(r12, r0, r2)
            r11.setSelectedTabIndicator((android.graphics.drawable.Drawable) r2)
            int r2 = com.google.android.material.R.styleable.TabLayout_tabIndicatorColor
            int r2 = r0.getColor(r2, r7)
            r11.setSelectedTabIndicatorColor(r2)
            int r2 = com.google.android.material.R.styleable.TabLayout_tabIndicatorHeight
            int r2 = r0.getDimensionPixelSize(r2, r6)
            r8.setSelectedIndicatorHeight(r2)
            int r2 = com.google.android.material.R.styleable.TabLayout_tabIndicatorGravity
            int r2 = r0.getInt(r2, r7)
            r11.setSelectedTabIndicatorGravity(r2)
            int r2 = com.google.android.material.R.styleable.TabLayout_tabIndicatorAnimationMode
            int r2 = r0.getInt(r2, r7)
            r11.setTabIndicatorAnimationMode(r2)
            int r2 = com.google.android.material.R.styleable.TabLayout_tabIndicatorFullWidth
            r3 = 1
            boolean r2 = r0.getBoolean(r2, r3)
            r11.setTabIndicatorFullWidth(r2)
            int r2 = com.google.android.material.R.styleable.TabLayout_tabPadding
            int r2 = r0.getDimensionPixelSize(r2, r7)
            r11.tabPaddingBottom = r2
            r11.tabPaddingEnd = r2
            r11.tabPaddingTop = r2
            r11.tabPaddingStart = r2
            int r2 = com.google.android.material.R.styleable.TabLayout_tabPaddingStart
            int r4 = r11.tabPaddingStart
            int r2 = r0.getDimensionPixelSize(r2, r4)
            r11.tabPaddingStart = r2
            int r2 = com.google.android.material.R.styleable.TabLayout_tabPaddingTop
            int r4 = r11.tabPaddingTop
            int r2 = r0.getDimensionPixelSize(r2, r4)
            r11.tabPaddingTop = r2
            int r2 = com.google.android.material.R.styleable.TabLayout_tabPaddingEnd
            int r4 = r11.tabPaddingEnd
            int r2 = r0.getDimensionPixelSize(r2, r4)
            r11.tabPaddingEnd = r2
            int r2 = com.google.android.material.R.styleable.TabLayout_tabPaddingBottom
            int r4 = r11.tabPaddingBottom
            int r2 = r0.getDimensionPixelSize(r2, r4)
            r11.tabPaddingBottom = r2
            boolean r2 = com.google.android.material.internal.ThemeEnforcement.isMaterial3Theme(r12)
            if (r2 == 0) goto L_0x00ed
            int r2 = com.google.android.material.R.attr.textAppearanceTitleSmall
            r11.defaultTabTextAppearance = r2
            goto L_0x00f1
        L_0x00ed:
            int r2 = com.google.android.material.R.attr.textAppearanceButton
            r11.defaultTabTextAppearance = r2
        L_0x00f1:
            int r2 = com.google.android.material.R.styleable.TabLayout_tabTextAppearance
            int r4 = com.google.android.material.R.style.TextAppearance_Design_Tab
            int r2 = r0.getResourceId(r2, r4)
            r11.tabTextAppearance = r2
            int[] r4 = androidx.appcompat.R.styleable.TextAppearance
            android.content.res.TypedArray r4 = r12.obtainStyledAttributes(r2, r4)
            int r5 = androidx.appcompat.R.styleable.TextAppearance_android_textSize     // Catch:{ all -> 0x021f }
            int r5 = r4.getDimensionPixelSize(r5, r7)     // Catch:{ all -> 0x021f }
            float r5 = (float) r5     // Catch:{ all -> 0x021f }
            r11.tabTextSize = r5     // Catch:{ all -> 0x021f }
            int r5 = androidx.appcompat.R.styleable.TextAppearance_android_textColor     // Catch:{ all -> 0x021f }
            android.content.res.ColorStateList r5 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r12, (android.content.res.TypedArray) r4, (int) r5)     // Catch:{ all -> 0x021f }
            r11.tabTextColors = r5     // Catch:{ all -> 0x021f }
            r4.recycle()
            int r5 = com.google.android.material.R.styleable.TabLayout_tabSelectedTextAppearance
            boolean r5 = r0.hasValue(r5)
            if (r5 == 0) goto L_0x0126
            int r5 = com.google.android.material.R.styleable.TabLayout_tabSelectedTextAppearance
            int r2 = r0.getResourceId(r5, r2)
            r11.selectedTabTextAppearance = r2
        L_0x0126:
            int r2 = r11.selectedTabTextAppearance
            if (r2 == r6) goto L_0x0168
            int[] r5 = androidx.appcompat.R.styleable.TextAppearance
            android.content.res.TypedArray r2 = r12.obtainStyledAttributes(r2, r5)
            int r5 = androidx.appcompat.R.styleable.TextAppearance_android_textSize     // Catch:{ all -> 0x0163 }
            float r8 = r11.tabTextSize     // Catch:{ all -> 0x0163 }
            int r8 = (int) r8     // Catch:{ all -> 0x0163 }
            int r5 = r2.getDimensionPixelSize(r5, r8)     // Catch:{ all -> 0x0163 }
            float r5 = (float) r5     // Catch:{ all -> 0x0163 }
            r11.selectedTabTextSize = r5     // Catch:{ all -> 0x0163 }
            int r5 = androidx.appcompat.R.styleable.TextAppearance_android_textColor     // Catch:{ all -> 0x0163 }
            android.content.res.ColorStateList r5 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r12, (android.content.res.TypedArray) r2, (int) r5)     // Catch:{ all -> 0x0163 }
            if (r5 == 0) goto L_0x015f
            android.content.res.ColorStateList r8 = r11.tabTextColors     // Catch:{ all -> 0x0163 }
            int r8 = r8.getDefaultColor()     // Catch:{ all -> 0x0163 }
            r9 = 16842913(0x10100a1, float:2.369401E-38)
            int[] r9 = new int[]{r9}     // Catch:{ all -> 0x0163 }
            int r10 = r5.getDefaultColor()     // Catch:{ all -> 0x0163 }
            int r9 = r5.getColorForState(r9, r10)     // Catch:{ all -> 0x0163 }
            android.content.res.ColorStateList r8 = createColorStateList(r8, r9)     // Catch:{ all -> 0x0163 }
            r11.tabTextColors = r8     // Catch:{ all -> 0x0163 }
        L_0x015f:
            r2.recycle()
            goto L_0x0168
        L_0x0163:
        ...
        L_0x0178:
            ...
            int r2 = com.google.android.material.R.styleable.TabLayout_tabSelectedTextColor
            int r2 = r0.getColor(r2, r7)
            android.content.res.ColorStateList r5 = r11.tabTextColors
            int r5 = r5.getDefaultColor()
            android.content.res.ColorStateList r5 = createColorStateList(r5, r2)
            r11.tabTextColors = r5
        L_0x0192:
            ...
            android.animation.TimeInterpolator r5 = com.google.android.material.animation.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR
            android.animation.TimeInterpolator r2 = com.google.android.material.motion.MotionUtils.resolveThemeInterpolator(r12, r2, r5)
            r11.tabIndicatorTimeInterpolator = r2
