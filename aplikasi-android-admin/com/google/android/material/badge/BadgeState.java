...
public final class BadgeState {
    ...
    BadgeState(Context context, int badgeResId, int defStyleAttr, int defStyleRes, State storedState) {
        ...
        if (storedState.number != -2) {
            int unused3 = state.number = storedState.number;
        } else if (a.hasValue(R.styleable.Badge_number)) {
            int unused4 = state.number = a.getInt(R.styleable.Badge_number, 0);
        } else {
            int unused5 = state.number = -1;
        }
        if (storedState.text != null) {
            String unused6 = state.text = storedState.text;
        } else if (a.hasValue(R.styleable.Badge_badgeText)) {
            String unused7 = state.text = a.getString(R.styleable.Badge_badgeText);
        }
        CharSequence unused8 = state.contentDescriptionForText = storedState.contentDescriptionForText;
        ...
        int unused10 = state.contentDescriptionQuantityStrings = i;
        ...
        Integer unused15 = state.badgeShapeAppearanceResId = Integer.valueOf(i5);
        ...
        Integer unused16 = state.badgeShapeAppearanceOverlayResId = Integer.valueOf(i6);
        ...
        Integer unused17 = state.badgeWithTextShapeAppearanceResId = Integer.valueOf(i7);
        ...
        Integer unused18 = state.badgeWithTextShapeAppearanceOverlayResId = Integer.valueOf(i8);
        ...
        Integer unused19 = state.backgroundColor = Integer.valueOf(i9);
        ...
        Integer unused20 = state.badgeTextAppearanceResId = Integer.valueOf(i10);
        if (storedState.badgeTextColor != null) {
            Integer unused21 = state.badgeTextColor = storedState.badgeTextColor;
        } else if (a.hasValue(R.styleable.Badge_badgeTextColor)) {
            Integer unused22 = state.badgeTextColor = Integer.valueOf(readColorFromAttributes(context, a, R.styleable.Badge_badgeTextColor));
        } else {
            Integer unused23 = state.badgeTextColor = Integer.valueOf(new TextAppearance(context, state.badgeTextAppearanceResId.intValue()).getTextColor().getDefaultColor());
        }
        ...
        Integer unused24 = state.badgeGravity = Integer.valueOf(i11);
        ...
        Integer unused25 = state.badgeHorizontalPadding = Integer.valueOf(i12);
        ...
        Integer unused26 = state.badgeVerticalPadding = Integer.valueOf(i13);
        ...
        Integer unused27 = state.horizontalOffsetWithoutText = Integer.valueOf(i14);
        ...
        Integer unused28 = state.verticalOffsetWithoutText = Integer.valueOf(i15);
        if (storedState.horizontalOffsetWithText == null) {
            i16 = a.getDimensionPixelOffset(R.styleable.Badge_horizontalOffsetWithText, state.horizontalOffsetWithoutText.intValue());
        } else {
            i16 = storedState.horizontalOffsetWithText.intValue();
        }
        Integer unused29 = state.horizontalOffsetWithText = Integer.valueOf(i16);
        if (storedState.verticalOffsetWithText == null) {
            i17 = a.getDimensionPixelOffset(R.styleable.Badge_verticalOffsetWithText, state.verticalOffsetWithoutText.intValue());
        } else {
            i17 = storedState.verticalOffsetWithText.intValue();
        }
        Integer unused30 = state.verticalOffsetWithText = Integer.valueOf(i17);
        ...
        Integer unused31 = state.largeFontVerticalOffsetAdjustment = Integer.valueOf(i18);
        Integer unused32 = state.additionalHorizontalOffset = Integer.valueOf(storedState.additionalHorizontalOffset == null ? 0 : storedState.additionalHorizontalOffset.intValue());
        Integer unused33 = state.additionalVerticalOffset = Integer.valueOf(storedState.additionalVerticalOffset == null ? 0 : storedState.additionalVerticalOffset.intValue());
        ...
        Boolean unused34 = state.autoAdjustToWithinGrandparentBounds = Boolean.valueOf(z);
        a.recycle();
        if (storedState.numberLocale == null) {
            Locale unused35 = state.numberLocale = Locale.getDefault(Locale.Category.FORMAT);
        } else {
            Locale unused36 = state.numberLocale = storedState.numberLocale;
        }
