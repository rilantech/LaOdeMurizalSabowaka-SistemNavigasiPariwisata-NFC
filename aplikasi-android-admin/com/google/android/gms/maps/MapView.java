...
public class MapView extends FrameLayout {
    ...
    public void onEnterAmbient(Bundle ambientDetails) {
        ...
        if (zzai.getDelegate() != null) {
            ((zzah) zzai.getDelegate()).zza(ambientDetails);
        }
    }
    ...
    public MapView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.zza = new zzai(this, context, GoogleMapOptions.createFromAttributes(context, attrs));
        setClickable(true);
    }
    ...
    public MapView(Context context, GoogleMapOptions options) {
        super(context);
        this.zza = new zzai(this, context, options);
        setClickable(true);
    }
}
