...
public class GoogleMap {
    ...
    public final GroundOverlay addGroundOverlay(GroundOverlayOptions options) {
        try {
            ...
            zzr addGroundOverlay = this.zza.addGroundOverlay(options);
    ...
    public final Marker addMarker(MarkerOptions options) {
        ...
        try {
            ...
            zzad addMarker = this.zza.addMarker(options);
            if (addMarker == null) {
                return null;
            }
            if (options.zzb() == 1) {
    ...
    public final TileOverlay addTileOverlay(TileOverlayOptions options) {
        try {
            ...
            zzam addTileOverlay = this.zza.addTileOverlay(options);
    ...
    public final void removeOnMapCapabilitiesChangedListener(OnMapCapabilitiesChangedListener listener) {
        try {
            if (this.zzc.containsKey(listener)) {
                this.zza.removeOnMapCapabilitiesChangedListener((zzal) this.zzc.get(listener));
    ...
    public final void addOnMapCapabilitiesChangedListener(OnMapCapabilitiesChangedListener listener) {
        try {
            zzs zzs = new zzs(this, listener);
            this.zzc.put(listener, zzs);
    ...
    public final void animateCamera(CameraUpdate update, int durationMs, CancelableCallback callback) {
        ...
        try {
            ...
            if (callback == null) {
                ...
                zzab = new zzab(callback);
            }
            iGoogleMapDelegate.animateCameraWithDurationAndCallback(zza2, durationMs, zzab);
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
