...
public final class InputKodeWisataBinding implements ViewBinding {
    ...
    private InputKodeWisataBinding(LinearLayout rootView2, EditText kodewisata2, LinearLayout main2, Button mulaiwritenfc2, Button resettagnfc2, ImageView tombolKembali2) {
            ...
            if (mulaiwritenfc2 != null) {
                ...
                if (resettagnfc2 != null) {
                    ...
                    if (tombolKembali2 != null) {
                        return new InputKodeWisataBinding((LinearLayout) rootView2, kodewisata2, main2, mulaiwritenfc2, resettagnfc2, tombolKembali2);
                    }
                }
            }
        }
