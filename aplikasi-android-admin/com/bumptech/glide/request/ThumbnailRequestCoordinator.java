...
public class ThumbnailRequestCoordinator implements RequestCoordinator, Request {
    ...
    public void onRequestSuccess(com.bumptech.glide.request.Request r3) {
        /*
            ...
            com.bumptech.glide.request.RequestCoordinator$RequestState r1 = com.bumptech.glide.request.RequestCoordinator.RequestState.SUCCESS     // Catch:{ all -> 0x002b }
            r2.thumbState = r1     // Catch:{ all -> 0x002b }
            monitor-exit(r0)     // Catch:{ all -> 0x002b }
            return
        L_0x0011:
            com.bumptech.glide.request.RequestCoordinator$RequestState r1 = com.bumptech.glide.request.RequestCoordinator.RequestState.SUCCESS     // Catch:{ all -> 0x002b }
            r2.fullState = r1     // Catch:{ all -> 0x002b }
            com.bumptech.glide.request.RequestCoordinator r1 = r2.parent     // Catch:{ all -> 0x002b }
            if (r1 == 0) goto L_0x001c
            r1.onRequestSuccess(r2)     // Catch:{ all -> 0x002b }
        L_0x001c:
            com.bumptech.glide.request.RequestCoordinator$RequestState r1 = r2.thumbState     // Catch:{ all -> 0x002b }
    ...
    public void onRequestFailed(com.bumptech.glide.request.Request r3) {
        /*
            ...
            if (r1 != 0) goto L_0x0011
            com.bumptech.glide.request.RequestCoordinator$RequestState r1 = com.bumptech.glide.request.RequestCoordinator.RequestState.FAILED     // Catch:{ all -> 0x001e }
            r2.thumbState = r1     // Catch:{ all -> 0x001e }
            monitor-exit(r0)     // Catch:{ all -> 0x001e }
            return
        L_0x0011:
            com.bumptech.glide.request.RequestCoordinator$RequestState r1 = com.bumptech.glide.request.RequestCoordinator.RequestState.FAILED     // Catch:{ all -> 0x001e }
            r2.fullState = r1     // Catch:{ all -> 0x001e }
            com.bumptech.glide.request.RequestCoordinator r1 = r2.parent     // Catch:{ all -> 0x001e }
            if (r1 == 0) goto L_0x001c
            r1.onRequestFailed(r2)     // Catch:{ all -> 0x001e }
        L_0x001c:
            monitor-exit(r0)     // Catch:{ all -> 0x001e }
            return
        L_0x001e:
