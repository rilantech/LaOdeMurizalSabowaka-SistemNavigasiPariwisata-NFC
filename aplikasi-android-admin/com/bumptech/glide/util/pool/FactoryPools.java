...
public final class FactoryPools {
    ...
    public static <T extends Poolable> Pools.Pool<T> threadSafe(int size, Factory<T> factory, Resetter<T> resetter) {
        return build(new Pools.SynchronizedPool(size), factory, resetter);
    }
