...
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {
    ...
    public Resource<Bitmap> decode(InputStream source, int width, int height, Options options) throws IOException {
        ...
        try {
            return this.downsampler.decode((InputStream) new MarkEnforcingInputStream(exceptionStream), width, height, options, (Downsampler.DecodeCallbacks) new UntrustedCallbacks(bufferedStream, exceptionStream));
        } finally {
    ...
    static class UntrustedCallbacks implements Downsampler.DecodeCallbacks {
        ...
        UntrustedCallbacks(RecyclableBufferedInputStream bufferedStream2, ExceptionPassthroughInputStream exceptionStream2) {
