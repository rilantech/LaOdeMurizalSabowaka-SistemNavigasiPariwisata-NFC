...
final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cont) {
        ...
        while (true) {
            ...
            while (true) {
                if (cur$iv$iv.getId() >= id$iv && !cur$iv$iv.getRemoved()) {
                    obj = SegmentOrClosed.m1701constructorimpl(cur$iv$iv);
                    curTail = next$iv$iv;
                    break;
                }
                ...
                if (it$iv$iv$iv == ConcurrentLinkedListKt.CLOSED) {
                    obj = SegmentOrClosed.m1701constructorimpl(ConcurrentLinkedListKt.CLOSED);
                    break;
                }
            ...
            s$iv = obj;
            if (SegmentOrClosed.m1706isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m1704getSegmentimpl(s$iv);
            while (true) {
                ...
                if (cur$iv$iv2.getId() >= to$iv$iv.getId()) {
                    ...
                    z = false;
                    break;
                } else if (tail$FU.compareAndSet(this, cur$iv$iv2, to$iv$iv)) {
        ...
        SemaphoreSegment segment = (SemaphoreSegment) SegmentOrClosed.m1704getSegmentimpl(s$iv);
        int i = (int) (enqIdx2 % ((long) SemaphoreKt.SEGMENT_SIZE));
        if (segment.acquirers.compareAndSet(i, (Object) null, cancellableContinuation)) {
            cancellableContinuation.invokeOnCancellation(new CancelSemaphoreAcquisitionHandler(segment, i));
            return true;
        }
        if (segment.acquirers.compareAndSet(i, SemaphoreKt.PERMIT, SemaphoreKt.TAKEN)) {
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        L_0x001c:
            ...
            goto L_0x0030
        L_0x002b:
            java.lang.Object r11 = kotlinx.coroutines.internal.SegmentOrClosed.m1701constructorimpl(r10)
            goto L_0x004a
        L_0x0030:
            r11 = r10
            ...
            java.lang.Object r16 = kotlinx.coroutines.internal.SegmentOrClosed.m1701constructorimpl(r16)
            r11 = r16
        L_0x004a:
            r8 = r11
            boolean r9 = kotlinx.coroutines.internal.SegmentOrClosed.m1706isClosedimpl(r8)
            if (r9 != 0) goto L_0x0096
            kotlinx.coroutines.internal.Segment r9 = kotlinx.coroutines.internal.SegmentOrClosed.m1704getSegmentimpl(r8)
            r12 = r6
            r13 = 0
            r14 = r12
            r15 = 0
        ...
        L_0x0076:
            ...
            boolean r10 = r10.compareAndSet(r12, r11, r9)
        ...
        L_0x0094:
            goto L_0x0059
        L_0x0096:
            kotlinx.coroutines.internal.Segment r6 = kotlinx.coroutines.internal.SegmentOrClosed.m1704getSegmentimpl(r8)
        ...
        L_0x00df:
            ...
            boolean r9 = r13.compareAndSet(r7, r9, r10)
            r10 = 1
            r9 = r9 ^ r10
            return r9
        L_0x00f2:
