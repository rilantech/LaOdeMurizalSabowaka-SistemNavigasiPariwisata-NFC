...
public final class DelayKt {
    ...
    public static final Object m1635delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m1636toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m1636toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m1461compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.Companion.m1565getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1480getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1);
        }
        return 0;
    }
}
