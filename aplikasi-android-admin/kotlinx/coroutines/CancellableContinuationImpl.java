...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
        ...
        while (true) {
            ...
            if (state instanceof NotCompleted) {
                ...
                if (!(state instanceof CompletedContinuation)) {
                    Throwable th2 = cause;
                    if (_state$FU.compareAndSet(this, state, new CompletedContinuation(state, (CancelHandler) null, (Function1) null, (Object) null, cause, 14, (DefaultConstructorMarker) null))) {
                        return;
                    }
                } else if (!((CompletedContinuation) state).getCancelled()) {
                    if (_state$FU.compareAndSet(this, state, CompletedContinuation.copy$default((CompletedContinuation) state, (Object) null, (CancelHandler) null, (Function1) null, (Object) null, cause, 15, (Object) null))) {
            ...
            if (state instanceof Active) {
                ...
                if (!(cancelHandler instanceof BeforeResumeCancelHandler)) {
                    if (((CompletedContinuation) state).getCancelled()) {
                        ...
                        if (_state$FU.compareAndSet(this, state, CompletedContinuation.copy$default((CompletedContinuation) state, (Object) null, cancelHandler, (Function1) null, (Object) null, (Throwable) null, 29, (Object) null))) {
                            return;
                        }
                    }
                } else {
                ...
                if (_state$FU.compareAndSet(this, state, new CompletedContinuation(state, cancelHandler, (Function1) null, (Object) null, (Throwable) null, 28, (DefaultConstructorMarker) null))) {
                    return;
                }
            } else {
                return;
    ...
    private final void resumeImpl(Object proposedUpdate, int resumeMode, Function1<? super Throwable, Unit> onCancellation) {
        ...
        } while (!_state$FU.compareAndSet(this, state, resumedState((NotCompleted) state, proposedUpdate, resumeMode, onCancellation, (Object) null)));
        detachChildIfNonResuable();
    ...
    private final Symbol tryResumeImpl(Object proposedUpdate, Object idempotent, Function1<? super Throwable, Unit> onCancellation) {
        ...
        } while (!_state$FU.compareAndSet(this, state, resumedState((NotCompleted) state, proposedUpdate, this.resumeMode, onCancellation, idempotent)));
        detachChildIfNonResuable();
        return CancellableContinuationImplKt.RESUME_TOKEN;
    }
