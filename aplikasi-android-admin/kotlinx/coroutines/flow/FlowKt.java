...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1679catch(Flow<? extends T> $this$catch, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> action) {
        return FlowKt__ErrorsKt.m1686catch($this$catch, action);
    }
    ...
    public static final <T> Flow<T> m1680debounceHG0u8IE(Flow<? extends T> $this$debounce_u2dHG0u8IE, long timeout) {
        return FlowKt__DelayKt.m1682debounceHG0u8IE($this$debounce_u2dHG0u8IE, timeout);
    }
    ...
    public static final <T> Flow<T> m1681sampleHG0u8IE(Flow<? extends T> $this$sample_u2dHG0u8IE, long period) {
        return FlowKt__DelayKt.m1683sampleHG0u8IE($this$sample_u2dHG0u8IE, period);
    }
