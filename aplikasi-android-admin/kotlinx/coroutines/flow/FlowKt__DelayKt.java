...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1682debounceHG0u8IE(Flow<? extends T> $this$debounce_u2dHG0u8IE, long timeout) {
        return FlowKt.debounce($this$debounce_u2dHG0u8IE, DelayKt.m1636toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final <T> Flow<T> m1683sampleHG0u8IE(Flow<? extends T> $this$sample_u2dHG0u8IE, long period) {
        return FlowKt.sample($this$sample_u2dHG0u8IE, DelayKt.m1636toDelayMillisLRDsOJo(period));
    }
}
