...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    public final DisposableHandle invokeOnCompletion(boolean onCancelling, boolean invokeImmediately, Function1<? super Throwable, Unit> handler) {
        ...
        while (true) {
            ...
            if (state instanceof Empty) {
                ...
                } else if (_state$FU.compareAndSet(this, state, node)) {
                    return node;
                }
            } else if (state instanceof Incomplete) {
    ...
    private final JobNode makeNode(Function1<? super Throwable, Unit> handler, boolean onCancelling) {
        ...
        if (onCancelling) {
            ...
            if (node != null) {
                JobNode it = node;
                if (DebugKt.getASSERTIONS_ENABLED() && ((it instanceof JobCancellingNode) ^ 1) == 0) {
                    throw new AssertionError();
                }
            } else {
    ...
    private final java.lang.Object makeCancelling(java.lang.Object r15) {
        ...
        L_0x0003:
            ...
            r8 = 0
            r9 = r3
            kotlinx.coroutines.JobSupport$Finishing r9 = (kotlinx.coroutines.JobSupport.Finishing) r9     // Catch:{ all -> 0x006a }
            boolean r9 = r9.isSealed()     // Catch:{ all -> 0x006a }
            if (r9 == 0) goto L_0x0022
            kotlinx.coroutines.internal.Symbol r6 = kotlinx.coroutines.JobSupportKt.TOO_LATE_TO_CANCEL     // Catch:{ all -> 0x006a }
            monitor-exit(r3)
            return r6
        L_0x0022:
            r9 = r3
            kotlinx.coroutines.JobSupport$Finishing r9 = (kotlinx.coroutines.JobSupport.Finishing) r9     // Catch:{ all -> 0x006a }
            boolean r9 = r9.isCancelling()     // Catch:{ all -> 0x006a }
            if (r15 != 0) goto L_0x002d
            if (r9 != 0) goto L_0x0042
        L_0x002d:
            if (r0 != 0) goto L_0x003a
            java.lang.Throwable r10 = r14.createCauseException(r15)     // Catch:{ all -> 0x006a }
            r11 = r10
            r12 = 0
            r0 = r11
            r13 = r10
        ...
        L_0x003b:
            r11 = r3
            kotlinx.coroutines.JobSupport$Finishing r11 = (kotlinx.coroutines.JobSupport.Finishing) r11     // Catch:{ all -> 0x0067 }
            r11.addExceptionLocked(r0)     // Catch:{ all -> 0x0067 }
            r0 = r10
        L_0x0042:
            r10 = r3
            kotlinx.coroutines.JobSupport$Finishing r10 = (kotlinx.coroutines.JobSupport.Finishing) r10     // Catch:{ all -> 0x006a }
            java.lang.Throwable r10 = r10.getRootCause()     // Catch:{ all -> 0x006a }
            r11 = r10
            r12 = 0
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x009f, code lost:
        if (tryWaitForChild(r1, r2, r14) == false) goto L_0x00a4;
     */
    ...
    private final java.lang.Object tryMakeCompletingSlowPath(kotlinx.coroutines.Incomplete r13, java.lang.Object r14) {
        ...
        L_0x001d:
            ...
            monitor-enter(r1)
            r6 = 0
            boolean r7 = r1.isCompleting()     // Catch:{ all -> 0x00a9 }
            if (r7 == 0) goto L_0x0031
            kotlinx.coroutines.internal.Symbol r2 = kotlinx.coroutines.JobSupportKt.COMPLETING_ALREADY     // Catch:{ all -> 0x00a9 }
            monitor-exit(r1)
            return r2
        L_0x0031:
            r7 = 1
            r1.setCompleting(r7)     // Catch:{ all -> 0x00a9 }
            if (r1 == r13) goto L_0x0045
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r8 = _state$FU     // Catch:{ all -> 0x00a9 }
            boolean r8 = r8.compareAndSet(r12, r13, r1)     // Catch:{ all -> 0x00a9 }
            if (r8 != 0) goto L_0x0045
            kotlinx.coroutines.internal.Symbol r2 = kotlinx.coroutines.JobSupportKt.COMPLETING_RETRY     // Catch:{ all -> 0x00a9 }
            monitor-exit(r1)
            return r2
        L_0x0045:
            boolean r8 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch:{ all -> 0x00a9 }
            if (r8 == 0) goto L_0x005b
            r8 = 0
            boolean r9 = r1.isSealed()     // Catch:{ all -> 0x00a9 }
            r8 = r9 ^ 1
            if (r8 == 0) goto L_0x0055
            goto L_0x005b
        L_0x0055:
            java.lang.AssertionError r2 = new java.lang.AssertionError     // Catch:{ all -> 0x00a9 }
            r2.<init>()     // Catch:{ all -> 0x00a9 }
            throw r2     // Catch:{ all -> 0x00a9 }
        L_0x005b:
            boolean r8 = r1.isCancelling()     // Catch:{ all -> 0x00a9 }
            boolean r9 = r14 instanceof kotlinx.coroutines.CompletedExceptionally     // Catch:{ all -> 0x00a9 }
            if (r9 == 0) goto L_0x0067
            r9 = r14
            kotlinx.coroutines.CompletedExceptionally r9 = (kotlinx.coroutines.CompletedExceptionally) r9     // Catch:{ all -> 0x00a9 }
            goto L_0x0068
        L_0x0067:
            r9 = r2
        L_0x0068:
            ...
            r10 = 0
            java.lang.Throwable r11 = r9.cause     // Catch:{ all -> 0x00a9 }
            r1.addExceptionLocked(r11)     // Catch:{ all -> 0x00a9 }
        L_0x0070:
            java.lang.Throwable r9 = r1.getRootCause()     // Catch:{ all -> 0x00a9 }
            r10 = r9
            r11 = 0
            if (r8 != 0) goto L_0x0079
            r3 = r7
        L_0x0079:
            java.lang.Boolean r3 = java.lang.Boolean.valueOf(r3)     // Catch:{ all -> 0x00a9 }
            boolean r3 = r3.booleanValue()     // Catch:{ all -> 0x00a9 }
            if (r3 == 0) goto L_0x0084
            r2 = r9
        L_0x0084:
            r4.element = r2     // Catch:{ all -> 0x00a9 }
