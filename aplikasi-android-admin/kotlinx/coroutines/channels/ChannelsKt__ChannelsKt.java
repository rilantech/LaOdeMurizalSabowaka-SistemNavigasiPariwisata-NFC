...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    public static final <E> Object trySendBlocking(SendChannel<? super E> $this$trySendBlocking, E element) {
        Object $this$onSuccess_u2dWpGqRn0$iv = $this$trySendBlocking.m1676trySendJP2dKIU(element);
        if ($this$onSuccess_u2dWpGqRn0$iv instanceof ChannelResult.Failed) {
            return ((ChannelResult) BuildersKt__BuildersKt.runBlocking$default((CoroutineContext) null, new ChannelsKt__ChannelsKt$trySendBlocking$2($this$trySendBlocking, element, (Continuation<? super ChannelsKt__ChannelsKt$trySendBlocking$2>) null), 1, (Object) null)).m1666unboximpl();
        }
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> $this$sendBlocking, E element) {
        if (!ChannelResult.m1664isSuccessimpl($this$sendBlocking.m1676trySendJP2dKIU(element))) {
