...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1 extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1675invokeWpGqRn0(((ChannelResult) obj).m1666unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1675invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1654boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Object it = ((ChannelResult) this.L$0).m1666unboximpl();
                Throwable it2 = ChannelResult.m1658exceptionOrNullimpl(it);
                if (it2 == null) {
                    Function2<E, Continuation<? super R>, Object> function2 = this.$block;
                    Object r4 = ChannelResult.m1659getOrNullimpl(it);
                    this.label = 1;
