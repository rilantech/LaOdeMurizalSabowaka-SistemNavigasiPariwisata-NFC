...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public Object m1670trySendJP2dKIU(E element) {
        Closed it = offerInternal(element);
        if (it != null) {
            return ChannelResult.Companion.m1667closedJP2dKIU(it.getSendException());
        }
        return ChannelResult.Companion.m1669successJP2dKIU(Unit.INSTANCE);
    }
