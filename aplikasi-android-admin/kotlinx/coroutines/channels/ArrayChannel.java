...
public class ArrayChannel<E> extends AbstractChannel<E> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x005e, code lost:
        if (r10 != kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()) goto L_0x006d;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0060, code lost:
        r14.size = r7;
        r14.buffer[r14.head] = r2;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x006f, code lost:
        if ((r10 instanceof kotlinx.coroutines.channels.Closed) == false) goto L_0x0075;
     */
    ...
    public java.lang.Object pollSelectInternal(kotlinx.coroutines.selects.SelectInstance<?> r15) {
        /*
            r14 = this;
            r0 = 0
            r1 = 0
            r2 = 0
            java.util.concurrent.locks.ReentrantLock r3 = r14.lock
            r4 = 0
            r5 = r3
            java.util.concurrent.locks.Lock r5 = (java.util.concurrent.locks.Lock) r5
            r5.lock()
            r6 = 0
            int r7 = r14.size     // Catch:{ all -> 0x00d9 }
            if (r7 != 0) goto L_0x001d
            kotlinx.coroutines.channels.Closed r8 = r14.getClosedForSend()     // Catch:{ all -> 0x00d9 }
            if (r8 != 0) goto L_0x0019
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00d9 }
        L_0x0019:
            r5.unlock()
            return r8
        L_0x001d:
            java.lang.Object[] r8 = r14.buffer     // Catch:{ all -> 0x00d9 }
            int r9 = r14.head     // Catch:{ all -> 0x00d9 }
            r10 = r8[r9]     // Catch:{ all -> 0x00d9 }
            r2 = r10
            r10 = 0
            r8[r9] = r10     // Catch:{ all -> 0x00d9 }
            int r8 = r7 + -1
            r14.size = r8     // Catch:{ all -> 0x00d9 }
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00d9 }
            int r9 = r14.capacity     // Catch:{ all -> 0x00d9 }
            if (r7 != r9) goto L_0x0092
        L_0x0031:
            kotlinx.coroutines.channels.AbstractChannel$TryPollDesc r9 = r14.describeTryPoll()     // Catch:{ all -> 0x00d9 }
            r10 = r9
            kotlinx.coroutines.internal.AtomicDesc r10 = (kotlinx.coroutines.internal.AtomicDesc) r10     // Catch:{ all -> 0x00d9 }
            java.lang.Object r10 = r15.performAtomicTrySelect(r10)     // Catch:{ all -> 0x00d9 }
            if (r10 != 0) goto L_0x0052
            java.lang.Object r11 = r9.getResult()     // Catch:{ all -> 0x00d9 }
            r0 = r11
            r1 = 1
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x00d9 }
            r11 = r0
            kotlinx.coroutines.channels.Send r11 = (kotlinx.coroutines.channels.Send) r11     // Catch:{ all -> 0x00d9 }
            java.lang.Object r11 = r11.getPollResult()     // Catch:{ all -> 0x00d9 }
            r8 = r11
            goto L_0x0092
        L_0x0052:
            kotlinx.coroutines.internal.Symbol r11 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00d9 }
            if (r10 == r11) goto L_0x0092
            java.lang.Object r11 = kotlinx.coroutines.internal.AtomicKt.RETRY_ATOMIC     // Catch:{ all -> 0x00d9 }
            if (r10 == r11) goto L_0x0031
            java.lang.Object r11 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00d9 }
            if (r10 != r11) goto L_0x006d
            r14.size = r7     // Catch:{ all -> 0x00d9 }
            java.lang.Object[] r11 = r14.buffer     // Catch:{ all -> 0x00d9 }
            int r12 = r14.head     // Catch:{ all -> 0x00d9 }
            r11[r12] = r2     // Catch:{ all -> 0x00d9 }
            r5.unlock()
            return r10
        L_0x006d:
            boolean r11 = r10 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00d9 }
            ...
            goto L_0x0092
        L_0x0075:
            java.lang.IllegalStateException r11 = new java.lang.IllegalStateException     // Catch:{ all -> 0x00d9 }
            java.lang.StringBuilder r12 = new java.lang.StringBuilder     // Catch:{ all -> 0x00d9 }
            r12.<init>()     // Catch:{ all -> 0x00d9 }
            java.lang.String r13 = "performAtomicTrySelect(describeTryOffer) returned "
            java.lang.StringBuilder r12 = r12.append(r13)     // Catch:{ all -> 0x00d9 }
            java.lang.StringBuilder r12 = r12.append(r10)     // Catch:{ all -> 0x00d9 }
            java.lang.String r12 = r12.toString()     // Catch:{ all -> 0x00d9 }
            java.lang.String r12 = r12.toString()     // Catch:{ all -> 0x00d9 }
            r11.<init>(r12)     // Catch:{ all -> 0x00d9 }
            throw r11     // Catch:{ all -> 0x00d9 }
        L_0x0092:
            kotlinx.coroutines.internal.Symbol r9 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00d9 }
            if (r8 == r9) goto L_0x00a6
            boolean r9 = r8 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00d9 }
            if (r9 != 0) goto L_0x00a6
            r14.size = r7     // Catch:{ all -> 0x00d9 }
            java.lang.Object[] r9 = r14.buffer     // Catch:{ all -> 0x00d9 }
            int r10 = r14.head     // Catch:{ all -> 0x00d9 }
            int r10 = r10 + r7
            int r11 = r9.length     // Catch:{ all -> 0x00d9 }
            int r10 = r10 % r11
            r9[r10] = r8     // Catch:{ all -> 0x00d9 }
            goto L_0x00bc
        L_0x00a6:
            boolean r9 = r15.trySelect()     // Catch:{ all -> 0x00d9 }
            if (r9 != 0) goto L_0x00bc
            r14.size = r7     // Catch:{ all -> 0x00d9 }
            java.lang.Object[] r9 = r14.buffer     // Catch:{ all -> 0x00d9 }
            int r10 = r14.head     // Catch:{ all -> 0x00d9 }
            r9[r10] = r2     // Catch:{ all -> 0x00d9 }
            java.lang.Object r9 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00d9 }
            r5.unlock()
            return r9
        L_0x00bc:
            int r9 = r14.head     // Catch:{ all -> 0x00d9 }
            int r9 = r9 + 1
            java.lang.Object[] r10 = r14.buffer     // Catch:{ all -> 0x00d9 }
            int r10 = r10.length     // Catch:{ all -> 0x00d9 }
            int r9 = r9 % r10
            r14.head = r9     // Catch:{ all -> 0x00d9 }
            kotlin.Unit r6 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00d9 }
            r5.unlock()
