...
public final class TimeoutKt {
    ...
    public static final <T> Object m1638withTimeoutKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return withTimeout(DelayKt.m1636toDelayMillisLRDsOJo(timeout), block, $completion);
    }
    ...
    public static final <T> Object m1639withTimeoutOrNullKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return withTimeoutOrNull(DelayKt.m1636toDelayMillisLRDsOJo(timeout), block, $completion);
    }
