...
public class MediaSessionCompat {
    ...
    private MediaSessionCompat(Context context, MediaSessionImpl impl) {
        this.mActiveListeners = new ArrayList<>();
        this.mImpl = impl;
        if (!MediaSessionCompatApi21.hasCallback(impl.getMediaSession())) {
            setCallback(new Callback() {
            });
        }
        this.mController = new MediaControllerCompat(context, this);
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCommand(java.lang.String r7, android.os.Bundle r8, android.os.ResultReceiver r9) {
                /*
                    ...
                    boolean r0 = r7.equals(r0)     // Catch:{ BadParcelableException -> 0x00c5 }
                    r1 = 0
                    if (r0 == 0) goto L_0x003d
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00c5 }
                    java.lang.ref.WeakReference<android.support.v4.media.session.MediaSessionCompat$MediaSessionImpl> r0 = r0.mSessionImpl     // Catch:{ BadParcelableException -> 0x00c5 }
                    java.lang.Object r0 = r0.get()     // Catch:{ BadParcelableException -> 0x00c5 }
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r0 = (android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r0     // Catch:{ BadParcelableException -> 0x00c5 }
                    if (r0 == 0) goto L_0x003b
                    android.os.Bundle r2 = new android.os.Bundle     // Catch:{ BadParcelableException -> 0x00c5 }
                    r2.<init>()     // Catch:{ BadParcelableException -> 0x00c5 }
                    android.support.v4.media.session.MediaSessionCompat$Token r3 = r0.getSessionToken()     // Catch:{ BadParcelableException -> 0x00c5 }
                    android.support.v4.media.session.IMediaSession r4 = r3.getExtraBinder()     // Catch:{ BadParcelableException -> 0x00c5 }
                    java.lang.String r5 = "android.support.v4.media.session.EXTRA_BINDER"
                    if (r4 != 0) goto L_0x0027
                    goto L_0x002b
                L_0x0027:
                    android.os.IBinder r1 = r4.asBinder()     // Catch:{ BadParcelableException -> 0x00c5 }
                L_0x002b:
                    androidx.core.app.BundleCompat.putBinder(r2, r5, r1)     // Catch:{ BadParcelableException -> 0x00c5 }
                    android.os.Bundle r1 = r3.getSessionToken2Bundle()     // Catch:{ BadParcelableException -> 0x00c5 }
                    java.lang.String r5 = "android.support.v4.media.session.SESSION_TOKEN2_BUNDLE"
                    r2.putBundle(r5, r1)     // Catch:{ BadParcelableException -> 0x00c5 }
                    r5 = 0
                    r9.send(r5, r2)     // Catch:{ BadParcelableException -> 0x00c5 }
                L_0x003b:
                    goto L_0x00c4
                L_0x003d:
                    ...
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00c5 }
                    android.os.Parcelable r1 = r8.getParcelable(r2)     // Catch:{ BadParcelableException -> 0x00c5 }
                    android.support.v4.media.MediaDescriptionCompat r1 = (android.support.v4.media.MediaDescriptionCompat) r1     // Catch:{ BadParcelableException -> 0x00c5 }
                    r0.onAddQueueItem(r1)     // Catch:{ BadParcelableException -> 0x00c5 }
                    goto L_0x00c4
                L_0x0054:
                    ...
                    android.os.Parcelable r1 = r8.getParcelable(r2)     // Catch:{ BadParcelableException -> 0x00c5 }
                    android.support.v4.media.MediaDescriptionCompat r1 = (android.support.v4.media.MediaDescriptionCompat) r1     // Catch:{ BadParcelableException -> 0x00c5 }
                    int r2 = r8.getInt(r3)     // Catch:{ BadParcelableException -> 0x00c5 }
                    r0.onAddQueueItem(r1, r2)     // Catch:{ BadParcelableException -> 0x00c5 }
                    goto L_0x00c4
                L_0x006e:
                    ...
                    android.os.Parcelable r1 = r8.getParcelable(r2)     // Catch:{ BadParcelableException -> 0x00c5 }
                    android.support.v4.media.MediaDescriptionCompat r1 = (android.support.v4.media.MediaDescriptionCompat) r1     // Catch:{ BadParcelableException -> 0x00c5 }
                    r0.onRemoveQueueItem(r1)     // Catch:{ BadParcelableException -> 0x00c5 }
                    goto L_0x00c4
                L_0x0082:
                    ...
                    java.util.List<android.support.v4.media.session.MediaSessionCompat$QueueItem> r2 = r0.mQueue     // Catch:{ BadParcelableException -> 0x00c5 }
                    if (r2 == 0) goto L_0x00be
                    r2 = -1
                    int r2 = r8.getInt(r3, r2)     // Catch:{ BadParcelableException -> 0x00c5 }
                    if (r2 < 0) goto L_0x00b2
                    java.util.List<android.support.v4.media.session.MediaSessionCompat$QueueItem> r3 = r0.mQueue     // Catch:{ BadParcelableException -> 0x00c5 }
                    int r3 = r3.size()     // Catch:{ BadParcelableException -> 0x00c5 }
                    if (r2 >= r3) goto L_0x00b2
                    java.util.List<android.support.v4.media.session.MediaSessionCompat$QueueItem> r1 = r0.mQueue     // Catch:{ BadParcelableException -> 0x00c5 }
                    java.lang.Object r1 = r1.get(r2)     // Catch:{ BadParcelableException -> 0x00c5 }
                ...
                L_0x00b2:
                    ...
                    android.support.v4.media.session.MediaSessionCompat$Callback r3 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00c5 }
                    android.support.v4.media.MediaDescriptionCompat r4 = r1.getDescription()     // Catch:{ BadParcelableException -> 0x00c5 }
                    r3.onRemoveQueueItem(r4)     // Catch:{ BadParcelableException -> 0x00c5 }
                L_0x00be:
                    goto L_0x00c4
                L_0x00bf:
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00c5 }
                    r0.onCommand(r7, r8, r9)     // Catch:{ BadParcelableException -> 0x00c5 }
                L_0x00c4:
                    goto L_0x00cd
                L_0x00c5:
                    r0 = move-exception
    ...
    public static final class Token implements Parcelable {
        public static final Parcelable.Creator<Token> CREATOR = new Parcelable.Creator<Token>() {
            public Token createFromParcel(Parcel in) {
                return new Token(in.readParcelable((ClassLoader) null));
            }
