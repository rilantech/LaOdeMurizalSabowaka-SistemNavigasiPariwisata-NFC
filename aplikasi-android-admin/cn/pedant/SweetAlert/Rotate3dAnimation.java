...
public class Rotate3dAnimation extends Animation {
    ...
    public Rotate3dAnimation(Context context, AttributeSet attrs) {
        ...
        Description d2 = parseValue(a.peekValue(R.styleable.Rotate3dAnimation_customPivotY));
    ...
    public void applyTransformation(float interpolatedTime, Transformation t) {
        ...
        float degrees = ((this.mToDegrees - fromDegrees) * interpolatedTime) + fromDegrees;
