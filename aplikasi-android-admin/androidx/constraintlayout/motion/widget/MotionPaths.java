...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void getCenter(double p, int[] toUse, double[] data, float[] point, double[] vdata, float[] velocity) {
        ...
        if (motionController != null) {
            ...
            float angle2 = angle;
            float angle3 = dangle;
            float v_x2 = (float) ((((double) rx) + (((double) radius2) * Math.sin((double) angle2))) - ((double) (v_width / 2.0f)));
            float v_y2 = (float) ((((double) ry) - (((double) radius2) * Math.cos((double) angle2))) - ((double) (v_height / 2.0f)));
    ...
    public void setView(float position2, View view, int[] toUse, double[] data, double[] slope, double[] cycle, boolean mForceMeasure) {
        ...
        while (true) {
            ...
            if (i2 < dArr2.length) {
                double d = 0.0d;
                if (!Double.isNaN(dArr2[i2]) || !(cycle == null || cycle[i2] == 0.0d)) {
                    if (cycle != null) {
                        d = cycle[i2];
                    }
                    double deltaCycle = d;
                ...
                if (motionController != null) {
                    ...
                    float f6 = v_y4;
                    float f7 = rx;
                    float angle = dv_width;
                    float pos_x = (float) ((((double) rx) + (((double) radius) * Math.sin((double) v_y4))) - ((double) (v_width4 / 2.0f)));
                    float dradius = dv_x;
                    v_width = v_width4;
                    v_height = v_height2;
                    float f8 = drx;
                    float dangle = dv_y;
                    float dpos_x = (float) (((double) drx) + (((double) dradius) * Math.sin((double) v_y4)) + (((double) radius) * Math.cos((double) v_y4) * ((double) dangle)));
                    float f9 = dradius;
                    float ry2 = ry;
                    float dpos_y = (float) ((((double) dry) - (((double) dradius) * Math.cos((double) v_y4))) + (((double) radius) * Math.sin((double) v_y4) * ((double) dangle)));
                    float dv_x2 = dpos_x;
                    float dv_y2 = dpos_y;
                    v_x = pos_x;
                    float v_y5 = (float) ((((double) ry) - (((double) radius) * Math.cos((double) v_y4))) - ((double) (v_height2 / 2.0f)));
                    if (dArr.length >= 2) {
                        z = false;
                    ...
                    if (!Float.isNaN(path_rotate)) {
                        ...
                        float f12 = radius;
                        view2 = view;
                        view2.setRotation((float) (((double) path_rotate) + Math.toDegrees(Math.atan2((double) dv_y2, (double) dv_x2))));
                    } else {
                        float f13 = ry2;
                        float f14 = radius;
                        view2 = view;
                    ...
                    float f15 = delta_path;
                    z2 = true;
                    z = false;
                    if (!Float.isNaN(path_rotate)) {
                        view2.setRotation((float) (((double) 0.0f) + ((double) path_rotate) + Math.toDegrees(Math.atan2((double) (dv_y3 + (dv_height2 / 2.0f)), (double) (dv_x3 + (dv_width2 / 2.0f))))));
                    }
                    float dy = dv_y3;
                    float f16 = dv_x3;
                    v_y = v_y6;
                ...
                int i_width = r - l;
                int i_height = b - t;
                if (((i_width == view.getMeasuredWidth() && i_height == view.getMeasuredHeight()) ? z : z2) || mForceMeasure) {
