...
public class MonotonicCurveFit extends CurveFit {
    ...
    public MonotonicCurveFit(double[] time, double[][] y) {
        ...
        double[][] slope = (double[][]) Array.newInstance(Double.TYPE, new int[]{N - 1, dim});
        double[][] tangent = (double[][]) Array.newInstance(Double.TYPE, new int[]{N, dim});
        for (int j = 0; j < dim; j++) {
            for (int i = 0; i < N - 1; i++) {
    ...
    private static MonotonicCurveFit buildWave(double[] values) {
        ...
        double[][] points = (double[][]) Array.newInstance(Double.TYPE, new int[]{length, 1});
