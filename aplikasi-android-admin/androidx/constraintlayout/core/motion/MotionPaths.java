        ...
        while (true) {
            ...
            if (i2 < dArr2.length) {
                ...
                if (motion != null) {
                    ...
                    float f6 = rx;
                    float angle2 = angle;
                    float angle3 = dv_width;
                    float pos_x = (float) ((((double) rx) + (((double) radius) * Math.sin((double) angle2))) - ((double) (v_width4 / 2.0f)));
                    float dradius = dv_x;
                    v_width = v_width4;
                    v_height = v_height2;
                    float f7 = drx;
                    float dangle2 = dangle;
                    float dpos_x = (float) (((double) drx) + (((double) dradius) * Math.sin((double) angle2)) + (((double) radius) * Math.cos((double) angle2) * ((double) dangle2)));
                    float f8 = ry;
                    float dpos_y = (float) ((((double) dry2) - (((double) dradius) * Math.cos((double) angle2))) + (((double) radius) * Math.sin((double) angle2) * ((double) dangle2)));
                    float dv_x2 = dpos_x;
                    float dv_y2 = dpos_y;
                    v_x = pos_x;
                    float v_y6 = (float) ((((double) ry) - (((double) radius) * Math.cos((double) angle2))) - ((double) (v_height2 / 2.0f)));
                    if (dArr.length >= 2) {
                        float f9 = angle2;
                        dry = dry2;
                    ...
                    if (!Float.isNaN(path_rotate)) {
                        ...
                        float f12 = dry;
                        motionWidget = view;
                        motionWidget.setRotationZ((float) (((double) path_rotate) + Math.toDegrees(Math.atan2((double) dv_y2, (double) dv_x2))));
                    } else {
                        float f13 = dpos_y;
                        v_y2 = v_y6;
                        float f14 = dry;
                    ...
                    if (!Float.isNaN(path_rotate)) {
                        motionWidget.setRotationZ((float) (((double) 0.0f) + ((double) path_rotate) + Math.toDegrees(Math.atan2((double) (dv_y3 + (dv_height2 / 2.0f)), (double) (dv_x3 + (dv_width2 / 2.0f))))));
                    }
                    v_y = v_y7;
                    float f16 = dv_y3;
                    float f17 = dv_x3;
