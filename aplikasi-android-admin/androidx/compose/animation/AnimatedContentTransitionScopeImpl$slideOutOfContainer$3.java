...
final class AnimatedContentTransitionScopeImpl$slideOutOfContainer$3 extends Lambda implements Function1<Integer, Integer> {
    ...
    AnimatedContentTransitionScopeImpl$slideOutOfContainer$3(AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl, Function1<? super Integer, Integer> function1) {
        super(1);
    ...
    public final Integer invoke(int it) {
        ...
        return this.$targetOffset.invoke(Integer.valueOf((-IntOffset.m7673getYimpl(this.this$0.m1741calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), state != null ? ((IntSize) state.getValue()).m7718unboximpl() : IntSize.Companion.m7719getZeroYbymL2g()))) - it));
    }
}
