...
final class EnterExitTransitionKt$slideInHorizontally$2 extends Lambda implements Function1<IntSize, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return IntOffset.m7663boximpl(m1767invokemHKZG7I(((IntSize) p1).m7718unboximpl()));
    }

    /* renamed from: invoke-mHKZG7I  reason: not valid java name */
    public final long m1767invokemHKZG7I(long it) {
        return IntOffsetKt.IntOffset(this.$initialOffsetX.invoke(Integer.valueOf(IntSize.m7714getWidthimpl(it))).intValue(), 0);
    }
}
