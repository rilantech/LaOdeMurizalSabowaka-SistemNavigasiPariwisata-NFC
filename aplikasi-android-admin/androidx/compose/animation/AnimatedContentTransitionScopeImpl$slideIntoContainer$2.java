...
final class AnimatedContentTransitionScopeImpl$slideIntoContainer$2 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int it) {
        return this.$initialOffset.invoke(Integer.valueOf((-IntOffset.m7672getXimpl(this.this$0.m1741calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.this$0.m1742getCurrentSizeYbymL2g()))) - it));
    }
}
