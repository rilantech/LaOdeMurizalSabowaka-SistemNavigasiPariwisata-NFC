...
public final class TransitionKt {
    public static final <S> State<Color> animateColor(Transition<S> $this$animateColor, Function3<? super Transition.Segment<S>, ? super Composer, ? super Integer, ? extends FiniteAnimationSpec<Color>> transitionSpec, String label, Function3<? super S, ? super Composer, ? super Integer, Color> targetValueByState, Composer $composer, int $changed, int i) {
        ...
        ColorSpace colorSpace = Color.m4967getColorSpaceimpl(function3.invoke($this$animateColor.getTargetState(), composer, Integer.valueOf(($changed >> 6) & 112)).m4973unboximpl());
    ...
    public static final State<Color> m1795animateColorDTcfvLk(InfiniteTransition $this$animateColor_u2dDTcfvLk, long initialValue, long targetValue, InfiniteRepeatableSpec<Color> animationSpec, String label, Composer $composer, int $changed, int i) {
        Object value$iv$iv;
        Composer composer = $composer;
        int i2 = $changed;
    ...
    public static final /* synthetic */ State m1796animateColorRIQooxk(InfiniteTransition $this$animateColor_u2dRIQooxk, long initialValue, long targetValue, InfiniteRepeatableSpec animationSpec, Composer $composer, int $changed) {
        Composer composer = $composer;
        int i = $changed;
        ...
        State<Color> r0 = m1795animateColorDTcfvLk($this$animateColor_u2dRIQooxk, initialValue, targetValue, animationSpec, "ColorAnimation", $composer, InfiniteTransition.$stable | 24576 | (i & 14) | (i & 112) | (i & 896) | (InfiniteRepeatableSpec.$stable << 9) | (i & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
