...
final class EnterExitTransitionKt$shrinkHorizontally$2 extends Lambda implements Function1<IntSize, IntSize> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return IntSize.m7706boximpl(m1764invokemzRDjE0(((IntSize) p1).m7718unboximpl()));
    }

    /* renamed from: invoke-mzRDjE0  reason: not valid java name */
    public final long m1764invokemzRDjE0(long it) {
        return IntSizeKt.IntSize(this.$targetWidth.invoke(Integer.valueOf(IntSize.m7714getWidthimpl(it))).intValue(), IntSize.m7713getHeightimpl(it));
    }
}
