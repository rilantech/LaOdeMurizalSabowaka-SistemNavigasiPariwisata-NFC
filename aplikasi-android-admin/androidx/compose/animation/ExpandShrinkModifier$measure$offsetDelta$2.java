...
final class ExpandShrinkModifier$measure$offsetDelta$2 extends Lambda implements Function1<EnterExitState, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return IntOffset.m7663boximpl(m1775invokeBjo55l4((EnterExitState) p1));
    }

    /* renamed from: invoke-Bjo55l4  reason: not valid java name */
    public final long m1775invokeBjo55l4(EnterExitState it) {
        Intrinsics.checkNotNullParameter(it, "it");
        return this.this$0.m1773targetOffsetByStateoFUgxo0(it, this.$measuredSize);
    }
}
