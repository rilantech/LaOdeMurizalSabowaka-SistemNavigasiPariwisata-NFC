...
final class EnterExitTransitionKt$expandVertically$2 extends Lambda implements Function1<IntSize, IntSize> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return IntSize.m7706boximpl(m1763invokemzRDjE0(((IntSize) p1).m7718unboximpl()));
    }

    /* renamed from: invoke-mzRDjE0  reason: not valid java name */
    public final long m1763invokemzRDjE0(long it) {
        return IntSizeKt.IntSize(IntSize.m7714getWidthimpl(it), this.$initialHeight.invoke(Integer.valueOf(IntSize.m7713getHeightimpl(it))).intValue());
    }
}
