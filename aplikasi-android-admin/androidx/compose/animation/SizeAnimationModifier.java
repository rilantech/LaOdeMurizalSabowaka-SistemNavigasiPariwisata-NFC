...
final class SizeAnimationModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public static final class AnimData {
        ...
        public static /* synthetic */ AnimData m1785copyO0kMr_c$default(AnimData animData, Animatable<IntSize, AnimationVector2D> animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m1787copyO0kMr_c(animatable, j);
        }
        ...
        public final long m1786component2YbymL2g() {
            return this.startSize;
        }

        /* renamed from: copy-O0kMr_c  reason: not valid java name */
        public final AnimData m1787copyO0kMr_c(Animatable<IntSize, AnimationVector2D> animatable, long j) {
        ...
        public boolean equals(Object obj) {
            ...
            return Intrinsics.areEqual((Object) this.anim, (Object) animData.anim) && IntSize.m7712equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m7715hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + IntSize.m7717toStringimpl(this.startSize) + ')';
        }
        ...
        public final long m1788getStartSizeYbymL2g() {
            return this.startSize;
        }

        /* renamed from: setStartSize-ozmzZPI  reason: not valid java name */
        public final void m1789setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }
    }
    ...
    public MeasureResult m1784measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        long r3 = m1783animateTomzRDjE0(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()));
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, IntSize.m7714getWidthimpl(r3), IntSize.m7713getHeightimpl(r3), (Map) null, new SizeAnimationModifier$measure$1(placeable), 4, (Object) null);
    }

    /* renamed from: animateTo-mzRDjE0  reason: not valid java name */
    public final long m1783animateTomzRDjE0(long targetSize) {
        long j = targetSize;
        AnimData animData = getAnimData();
        if (animData != null) {
            AnimData $this$animateTo_mzRDjE0_u24lambda_u240 = animData;
            if (!IntSize.m7712equalsimpl0(j, $this$animateTo_mzRDjE0_u24lambda_u240.getAnim().getTargetValue().m7718unboximpl())) {
                $this$animateTo_mzRDjE0_u24lambda_u240.m1789setStartSizeozmzZPI($this$animateTo_mzRDjE0_u24lambda_u240.getAnim().getValue().m7718unboximpl());
            ...
            animData = new AnimData(new Animatable(IntSize.m7706boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.Companion), IntSize.m7706boximpl(IntSizeKt.IntSize(1, 1)), (String) null, 8, (DefaultConstructorMarker) null), j, (DefaultConstructorMarker) null);
        }
        AnimData data = animData;
        setAnimData(data);
        return data.getAnim().getValue().m7718unboximpl();
    }
}
