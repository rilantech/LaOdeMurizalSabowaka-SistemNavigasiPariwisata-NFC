...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    private final MutableState measuredSize$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m7706boximpl(IntSize.Companion.m7719getZeroYbymL2g()), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public EnterTransition m1747slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, Function1<? super Integer, Integer> initialOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(initialOffset, "initialOffset");
        if (m1743isLeftgWo6LJ4(towards)) {
        ...
        if (m1744isRightgWo6LJ4(towards)) {
        ...
        if (AnimatedContentTransitionScope.SlideDirection.m1729equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.Companion.m1738getUpDKzdypw())) {
        ...
        if (AnimatedContentTransitionScope.SlideDirection.m1729equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.Companion.m1733getDownDKzdypw())) {
    ...
    private final boolean m1743isLeftgWo6LJ4(int $this$isLeft) {
        return AnimatedContentTransitionScope.SlideDirection.m1729equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.Companion.m1735getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m1729equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.Companion.m1737getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m1729equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.Companion.m1734getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-gWo6LJ4  reason: not valid java name */
    private final boolean m1744isRightgWo6LJ4(int $this$isRight) {
        return AnimatedContentTransitionScope.SlideDirection.m1729equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.Companion.m1736getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m1729equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.Companion.m1737getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m1729equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.Companion.m1734getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }

    /* access modifiers changed from: private */
    /* renamed from: calculateOffset-emnUabE  reason: not valid java name */
    public final long m1741calculateOffsetemnUabE(long fullSize, long currentSize) {
        return this.contentAlignment.m4594alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    /* renamed from: slideOutOfContainer-mOhB8PU  reason: not valid java name */
    public ExitTransition m1748slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, Function1<? super Integer, Integer> targetOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
    ...
    public final long m1745getMeasuredSizeYbymL2g$animation_release() {
        return ((IntSize) this.measuredSize$delegate.getValue()).m7718unboximpl();
    }

    /* renamed from: setMeasuredSize-ozmzZPI$animation_release  reason: not valid java name */
    public final void m1746setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize$delegate.setValue(IntSize.m7706boximpl(j));
    }
    ...
    public final long m1742getCurrentSizeYbymL2g() {
        State<IntSize> state = this.animatedSize;
        return state != null ? state.getValue().m7718unboximpl() : m1745getMeasuredSizeYbymL2g$animation_release();
    }
    ...
    private final class SizeModifier extends LayoutModifierWithPassThroughIntrinsics {
        ...
        public MeasureResult m1749measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
            ...
            return MeasureScope.layout$default($this$measure_u2d3p2s80s, IntSize.m7714getWidthimpl(size.getValue().m7718unboximpl()), IntSize.m7713getHeightimpl(size.getValue().m7718unboximpl()), (Map) null, new AnimatedContentTransitionScopeImpl$SizeModifier$measure$1(placeable, this.this$0.getContentAlignment$animation_release().m4594alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), size.getValue().m7718unboximpl(), LayoutDirection.Ltr)), 4, (Object) null);
        }
    }
}
