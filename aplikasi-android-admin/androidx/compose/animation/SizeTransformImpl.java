...
final class SizeTransformImpl implements SizeTransform {
    ...
    public SizeTransformImpl(boolean clip2, Function2<? super IntSize, ? super IntSize, ? extends FiniteAnimationSpec<IntSize>> sizeAnimationSpec2) {
        Intrinsics.checkNotNullParameter(sizeAnimationSpec2, "sizeAnimationSpec");
        this.clip = clip2;
        this.sizeAnimationSpec = sizeAnimationSpec2;
    }
    ...
    public FiniteAnimationSpec<IntSize> m1791createAnimationSpecTemP2vQ(long initialSize, long targetSize) {
        return this.sizeAnimationSpec.invoke(IntSize.m7706boximpl(initialSize), IntSize.m7706boximpl(targetSize));
    }
}
