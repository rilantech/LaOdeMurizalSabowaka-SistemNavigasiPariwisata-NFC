...
public final class SpringSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public SpringSpec(float dampingRatio2, float stiffness2, T visibilityThreshold2) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(((SpringSpec) other).stiffness == this.stiffness) || !Intrinsics.areEqual((Object) ((SpringSpec) other).visibilityThreshold, (Object) this.visibilityThreshold)) {
            return false;
        }
        return true;
    }
