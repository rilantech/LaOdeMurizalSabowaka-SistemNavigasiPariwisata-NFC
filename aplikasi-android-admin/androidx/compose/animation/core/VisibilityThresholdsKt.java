...
public final class VisibilityThresholdsKt {
    ...
    static {
        ...
        Pair<A, B> pair = TuplesKt.to(vectorConverter, valueOf2);
        Pair<A, B> pair2 = TuplesKt.to(VectorConvertersKt.getVectorConverter(IntSize.Companion), valueOf2);
        Pair<A, B> pair3 = TuplesKt.to(VectorConvertersKt.getVectorConverter(IntOffset.Companion), valueOf2);
        Pair<A, B> pair4 = TuplesKt.to(VectorConvertersKt.getVectorConverter(FloatCompanionObject.INSTANCE), Float.valueOf(0.01f));
        Pair<A, B> pair5 = TuplesKt.to(VectorConvertersKt.getVectorConverter(Rect.Companion), valueOf);
        Pair<A, B> pair6 = TuplesKt.to(VectorConvertersKt.getVectorConverter(Size.Companion), valueOf);
        Pair<A, B> pair7 = TuplesKt.to(VectorConvertersKt.getVectorConverter(Offset.Companion), valueOf);
        TwoWayConverter<Dp, AnimationVector1D> vectorConverter2 = VectorConvertersKt.getVectorConverter(Dp.Companion);
        Float valueOf3 = Float.valueOf(0.1f);
        visibilityThresholdMap = MapsKt.mapOf(pair, pair2, pair3, pair4, pair5, pair6, pair7, TuplesKt.to(vectorConverter2, valueOf3), TuplesKt.to(VectorConvertersKt.getVectorConverter(DpOffset.Companion), valueOf3));
    }
    ...
    public static final float getVisibilityThreshold(Dp.Companion $this$VisibilityThreshold) {
        Intrinsics.checkNotNullParameter($this$VisibilityThreshold, "<this>");
        return Dp.m7554constructorimpl(0.1f);
    }

    public static final long getVisibilityThreshold(DpOffset.Companion $this$VisibilityThreshold) {
        Intrinsics.checkNotNullParameter($this$VisibilityThreshold, "<this>");
        return DpKt.m7575DpOffsetYgX7TsA(getVisibilityThreshold(Dp.Companion), getVisibilityThreshold(Dp.Companion));
    }
