...
public final class TweenSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public TweenSpec(int durationMillis2, int delay2, Easing easing2) {
    ...
    public boolean equals(Object other) {
        if (!(other instanceof TweenSpec) || ((TweenSpec) other).durationMillis != this.durationMillis || ((TweenSpec) other).delay != this.delay || !Intrinsics.areEqual((Object) ((TweenSpec) other).easing, (Object) this.easing)) {
            return false;
        }
        return true;
    }
