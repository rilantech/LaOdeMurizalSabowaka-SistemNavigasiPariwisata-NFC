...
public final class InfiniteRepeatableSpec<T> implements AnimationSpec<T> {
    ...
    public final long m1811getInitialStartOffsetRmkjzm4() {
    ...
    public boolean equals(Object other) {
        if (!(other instanceof InfiniteRepeatableSpec) || !Intrinsics.areEqual((Object) ((InfiniteRepeatableSpec) other).animation, (Object) this.animation) || ((InfiniteRepeatableSpec) other).repeatMode != this.repeatMode || !StartOffset.m1830equalsimpl0(((InfiniteRepeatableSpec) other).initialStartOffset, this.initialStartOffset)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((this.animation.hashCode() * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m1833hashCodeimpl(this.initialStartOffset);
    }
}
