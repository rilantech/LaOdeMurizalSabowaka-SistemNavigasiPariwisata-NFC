...
public final class ComplexDouble {
    ...
    public ComplexDouble(double _real2, double _imaginary2) {
        this._real = _real2;
        this._imaginary = _imaginary2;
    }
    ...
    public final ComplexDouble plus(double other) {
        this._real = this._real + other;
        return this;
    }

    public final ComplexDouble plus(ComplexDouble other) {
        Intrinsics.checkNotNullParameter(other, "other");
        this._real = this._real + other.getReal();
        this._imaginary = this._imaginary + other.getImaginary();
        return this;
    }
    ...
    public final ComplexDouble minus(ComplexDouble other) {
        ...
        this._real = this._real + other$iv.getReal();
        this._imaginary = this._imaginary + other$iv.getImaginary();
        return this;
    }

    public final ComplexDouble times(double other) {
        this._real = this._real * other;
        this._imaginary = this._imaginary * other;
        return this;
    }
