...
public final class RepeatableSpec<T> implements FiniteAnimationSpec<T> {
    ...
    private RepeatableSpec(int iterations2, DurationBasedAnimationSpec<T> animation2, RepeatMode repeatMode2, long initialStartOffset2) {
    ...
    public /* synthetic */ RepeatableSpec(int r8, androidx.compose.animation.core.DurationBasedAnimationSpec r9, androidx.compose.animation.core.RepeatMode r10, long r11, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        L_0x0009:
            ...
            r11 = 0
            r12 = 0
            long r11 = androidx.compose.animation.core.StartOffset.m1828constructorimpl$default(r12, r12, r10, r11)
            r4 = r11
            goto L_0x0017
        L_0x0016:
            r4 = r11
        L_0x0017:
            ...
            r1 = r8
            r2 = r9
            r0.<init>((int) r1, (androidx.compose.animation.core.DurationBasedAnimationSpec) r2, (androidx.compose.animation.core.RepeatMode) r3, (long) r4, (kotlin.jvm.internal.DefaultConstructorMarker) r6)
            return
        */
    ...
    public final long m1823getInitialStartOffsetRmkjzm4() {
    ...
    public /* synthetic */ RepeatableSpec(int iterations2, DurationBasedAnimationSpec animation2, RepeatMode repeatMode2) {
        this(iterations2, animation2, repeatMode2, StartOffset.m1828constructorimpl$default(0, 0, 2, (DefaultConstructorMarker) null), (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(animation2, "animation");
        Intrinsics.checkNotNullParameter(repeatMode2, "repeatMode");
    }
    ...
    public <V extends AnimationVector> VectorizedFiniteAnimationSpec<V> vectorize(TwoWayConverter<T, V> converter) {
        ...
        return new VectorizedRepeatableSpec<>(this.iterations, (VectorizedDurationBasedAnimationSpec) this.animation.vectorize(converter), this.repeatMode, this.initialStartOffset, (DefaultConstructorMarker) null);
    }

    public boolean equals(Object other) {
        if (!(other instanceof RepeatableSpec) || ((RepeatableSpec) other).iterations != this.iterations || !Intrinsics.areEqual((Object) ((RepeatableSpec) other).animation, (Object) this.animation) || ((RepeatableSpec) other).repeatMode != this.repeatMode || !StartOffset.m1830equalsimpl0(((RepeatableSpec) other).initialStartOffset, this.initialStartOffset)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((this.iterations * 31) + this.animation.hashCode()) * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m1833hashCodeimpl(this.initialStartOffset);
    }
}
