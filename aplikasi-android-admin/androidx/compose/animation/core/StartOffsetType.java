...
public final class StartOffsetType {
    ...
    public static final int Delay = m1837constructorimpl(-1);
    /* access modifiers changed from: private */
    public static final int FastForward = m1837constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ StartOffsetType m1836boximpl(int i) {
        return new StartOffsetType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m1837constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1838equalsimpl(int i, Object obj) {
        return (obj instanceof StartOffsetType) && i == ((StartOffsetType) obj).m1842unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1839equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1840hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1841toStringimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m1843getDelayEo1U57Q() {
            return StartOffsetType.Delay;
        }

        /* renamed from: getFastForward-Eo1U57Q  reason: not valid java name */
        public final int m1844getFastForwardEo1U57Q() {
            return StartOffsetType.FastForward;
        }
    }

    private /* synthetic */ StartOffsetType(int value2) {
        this.value = value2;
    }
}
