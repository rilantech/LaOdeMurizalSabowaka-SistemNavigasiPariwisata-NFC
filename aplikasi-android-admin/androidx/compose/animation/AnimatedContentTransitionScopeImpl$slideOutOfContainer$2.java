...
final class AnimatedContentTransitionScopeImpl$slideOutOfContainer$2 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int it) {
        ...
        return this.$targetOffset.invoke(Integer.valueOf((-IntOffset.m7672getXimpl(this.this$0.m1741calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) + IntSize.m7714getWidthimpl(targetSize)));
    }
}
