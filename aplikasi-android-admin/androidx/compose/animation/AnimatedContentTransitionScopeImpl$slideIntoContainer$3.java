...
final class AnimatedContentTransitionScopeImpl$slideIntoContainer$3 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int it) {
        return this.$initialOffset.invoke(Integer.valueOf(IntSize.m7713getHeightimpl(this.this$0.m1742getCurrentSizeYbymL2g()) - IntOffset.m7673getYimpl(this.this$0.m1741calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.this$0.m1742getCurrentSizeYbymL2g()))));
    }
}
