...
public final class ComposablesKt {
    ...
    public static final <T> T remember(Function0<? extends T> calculation, Composer $composer, int $changed) {
        Object value$iv;
    ...
    public static final <T> T remember(Object key1, Function0<? extends T> calculation, Composer $composer, int $changed) {
        Object value$iv;
        Intrinsics.checkNotNullParameter(calculation, "calculation");
    ...
    public static final <T> T remember(Object key1, Object key2, Function0<? extends T> calculation, Composer $composer, int $changed) {
        Object value$iv;
        Intrinsics.checkNotNullParameter(calculation, "calculation");
    ...
    public static final <T> T remember(Object key1, Object key2, Object key3, Function0<? extends T> calculation, Composer $composer, int $changed) {
        Object value$iv;
        Intrinsics.checkNotNullParameter(calculation, "calculation");
    ...
    public static final <T> T remember(Object[] keys, Function0<? extends T> calculation, Composer $composer, int $changed) {
        Object value$iv;
    ...
    public static final /* synthetic */ <T, E extends Applier<?>> void ComposeNode(Function0<? extends T> factory, Function1<? super Updater<T>, Unit> update, Composer $composer, int $changed) {
        ...
        update.invoke(Updater.m4574boximpl(Updater.m4575constructorimpl($composer)));
        $composer.endNode();
        $composer.endReplaceableGroup();
    }

    public static final /* synthetic */ <T, E extends Applier<?>> void ReusableComposeNode(Function0<? extends T> factory, Function1<? super Updater<T>, Unit> update, Composer $composer, int $changed) {
        Intrinsics.checkNotNullParameter(factory, "factory");
        Intrinsics.checkNotNullParameter(update, "update");
    ...
    public static final /* synthetic */ <T, E extends Applier<?>> void ComposeNode(Function0<? extends T> factory, Function1<? super Updater<T>, Unit> update, Function3<? super SkippableUpdater<T>, ? super Composer, ? super Integer, Unit> skippableUpdate, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        update.invoke(Updater.m4574boximpl(Updater.m4575constructorimpl($composer)));
        skippableUpdate.invoke(SkippableUpdater.m4566boximpl(SkippableUpdater.m4567constructorimpl($composer)), $composer, Integer.valueOf(($changed >> 3) & 112));
