...
public abstract class TrieNodeBaseIterator<K, V, T> implements Iterator<T>, KMappedMarker {
    ...
    public final void reset(Object[] buffer2, int dataSize2, int index2) {
    ...
    public final void reset(Object[] buffer2, int dataSize2) {
        Intrinsics.checkNotNullParameter(buffer2, "buffer");
        reset(buffer2, dataSize2, 0);
    }
    ...
    public final K currentKey() {
        CommonFunctionsKt.m4591assert(hasNextKey());
    ...
    public final boolean hasNextNode() {
        CommonFunctionsKt.m4591assert(this.index >= this.dataSize);
    ...
    public final TrieNode<? extends K, ? extends V> currentNode() {
        CommonFunctionsKt.m4591assert(hasNextNode());
