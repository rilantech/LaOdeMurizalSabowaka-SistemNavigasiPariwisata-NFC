...
public final class ComposableInfo {
    ...
    public ComposableInfo(boolean isComposable2, int realParamsCount2, int changedParams2, int defaultParams2) {
        this.isComposable = isComposable2;
        this.realParamsCount = realParamsCount2;
        this.changedParams = changedParams2;
        this.defaultParams = defaultParams2;
    }
