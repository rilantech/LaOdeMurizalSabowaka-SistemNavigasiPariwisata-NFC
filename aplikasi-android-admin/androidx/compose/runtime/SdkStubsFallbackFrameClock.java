...
final class SdkStubsFallbackFrameClock implements MonotonicFrameClock {
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> onFrame, Continuation<? super R> $completion) {
        return BuildersKt.withContext(Dispatchers.getMain(), new SdkStubsFallbackFrameClock$withFrameNanos$2(onFrame, (Continuation<? super SdkStubsFallbackFrameClock$withFrameNanos$2>) null), $completion);
    }
}
