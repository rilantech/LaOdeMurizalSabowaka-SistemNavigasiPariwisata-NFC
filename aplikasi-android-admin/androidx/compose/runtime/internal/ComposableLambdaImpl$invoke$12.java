...
final class ComposableLambdaImpl$invoke$12 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer nc, int i) {
        Composer composer = nc;
        Intrinsics.checkNotNullParameter(composer, "nc");
        this.this$0.invoke(this.$p1, this.$p2, this.$p3, this.$p4, this.$p5, this.$p6, this.$param7, this.$p8, this.$p9, this.$p10, this.$p11, this.$p12, composer, RecomposeScopeImplKt.updateChangedFlags(this.$changed) | 1, RecomposeScopeImplKt.updateChangedFlags(this.$changed1));
    }
}
