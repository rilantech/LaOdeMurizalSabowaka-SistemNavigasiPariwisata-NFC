...
public final class LaunchedEffectImpl implements RememberObserver {
    ...
    public LaunchedEffectImpl(CoroutineContext parentCoroutineContext, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> task2) {
    ...
    public void onForgotten() {
        Job job2 = this.job;
        if (job2 != null) {
            job2.cancel((CancellationException) new LeftCompositionCancellationException());
        }
        this.job = null;
    }
