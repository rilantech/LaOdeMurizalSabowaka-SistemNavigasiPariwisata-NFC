...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m4566boximpl(Composer composer2) {
        return new SkippableUpdater(composer2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Composer m4567constructorimpl(Composer composer2) {
        Intrinsics.checkNotNullParameter(composer2, "composer");
        return composer2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4568equalsimpl(Composer composer2, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual((Object) composer2, (Object) ((SkippableUpdater) obj).m4573unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4569equalsimpl0(Composer composer2, Composer composer3) {
    ...
    public static int m4570hashCodeimpl(Composer composer2) {
        return composer2.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4571toStringimpl(Composer composer2) {
        return "SkippableUpdater(composer=" + composer2 + ')';
    }

    public boolean equals(Object obj) {
        return m4568equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m4570hashCodeimpl(this.composer);
    }

    public String toString() {
        return m4571toStringimpl(this.composer);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Composer m4573unboximpl() {
    ...
    public static final void m4572updateimpl(Composer arg0, Function1<? super Updater<T>, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        arg0.startReplaceableGroup(509942095);
        block.invoke(Updater.m4574boximpl(Updater.m4575constructorimpl(arg0)));
