...
final class DatePickerKt$YearPickerMenuButton$1 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    ...
    public final void invoke(RowScope $this$TextButton, Composer $composer, int $changed) {
        ...
        if (($changed & 81) != 16 || !$composer.getSkipping()) {
            ...
            SpacerKt.Spacer(SizeKt.m2322size3ABfNKs(Modifier.Companion, ButtonDefaults.INSTANCE.m3284getIconSpacingD9Ej5fM()), $composer, 6);
            ...
            if (this.$expanded) {
                ...
                String r0 = Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3722getDatePickerSwitchToDaySelectionadMyvUU(), $composer, 6);
                $composer.endReplaceableGroup();
                str = r0;
            } else {
                $composer.startReplaceableGroup(1071182591);
                ComposerKt.sourceInformation($composer, "1852@75759L50");
                String r02 = Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3726getDatePickerSwitchToYearSelectionadMyvUU(), $composer, 6);
                $composer.endReplaceableGroup();
                str = r02;
            }
            IconKt.m3518Iconww6aTOc(arrowDropDown, str, RotateKt.rotate(Modifier.Companion, this.$expanded ? 180.0f : 0.0f), 0, $composer, 0, 8);
            if (ComposerKt.isTraceInProgress()) {
