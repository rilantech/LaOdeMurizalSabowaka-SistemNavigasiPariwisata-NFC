...
public final class InputChipDefaults {
    ...
    public final SelectableChipColors m3524inputChipColorskwJvTHA(long containerColor, long labelColor, long leadingIconColor, long trailingIconColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconColor, long disabledTrailingIconColor, long selectedContainerColor, long disabledSelectedContainerColor, long selectedLabelColor, long selectedLeadingIconColor, long selectedTrailingIconColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        if ((i2 & 32) != 0) {
            disabledLabelColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledLabelColor2 = disabledLabelColor;
        }
        if ((i2 & 64) != 0) {
            disabledLeadingIconColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledLeadingIconColor2 = disabledLeadingIconColor;
        }
        if ((i2 & 128) != 0) {
            disabledTrailingIconColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledTrailingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
        ...
        if ((i2 & 512) != 0) {
            disabledSelectedContainerColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledSelectedContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
    ...
    public final SelectableChipElevation m3525inputChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float elevation2 = (i & 1) != 0 ? InputChipTokens.INSTANCE.m4249getContainerElevationD9Ej5fM() : elevation;
        if ((i & 2) != 0) {
        ...
        if ((i & 16) != 0) {
            draggedElevation2 = InputChipTokens.INSTANCE.m4251getDraggedContainerElevationD9Ej5fM();
        } else {
    ...
    public final SelectableChipBorder m3523inputChipBordergHcDVlo(long borderColor, long selectedBorderColor, long disabledBorderColor, long disabledSelectedBorderColor, float borderWidth, float selectedBorderWidth, Composer $composer, int $changed, int i) {
        ...
        if ((i & 4) != 0) {
            disabledBorderColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledUnselectedOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
        ...
        if ((i & 16) != 0) {
            borderWidth2 = InputChipTokens.INSTANCE.m4255getUnselectedOutlineWidthD9Ej5fM();
        } else {
            borderWidth2 = borderWidth;
        }
        if ((i & 32) != 0) {
            selectedBorderWidth2 = InputChipTokens.INSTANCE.m4253getSelectedOutlineWidthD9Ej5fM();
        } else {
