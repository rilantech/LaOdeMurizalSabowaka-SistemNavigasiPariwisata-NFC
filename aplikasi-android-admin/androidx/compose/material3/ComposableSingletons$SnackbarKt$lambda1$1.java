...
final class ComposableSingletons$SnackbarKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            IconKt.m3518Iconww6aTOc(CloseKt.getClose(Icons.Filled.INSTANCE), Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3747getSnackbarDismissadMyvUU(), $composer, 6), (Modifier) null, 0, $composer, 0, 12);
            if (ComposerKt.isTraceInProgress()) {
