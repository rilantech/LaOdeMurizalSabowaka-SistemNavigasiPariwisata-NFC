...
final class BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1 extends Lambda implements Function2<SubcomposeMeasureScope, Constraints, MeasureResult> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m3275invoke0kLqBqw((SubcomposeMeasureScope) p1, ((Constraints) p2).m7504unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final MeasureResult m3275invoke0kLqBqw(SubcomposeMeasureScope $this$SubcomposeLayout, long constraints) {
        Placeable placeable;
        Object obj;
        ...
        if (function2 != null) {
            ...
            placeable = subcomposeMeasureScope.subcompose(BottomSheetScaffoldLayoutSlot.TopBar, ComposableLambdaKt.composableLambdaInstance(-873203005, true, new BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$topBarPlaceable$1$1(function2, this.$$dirty))).get(0).m6399measureBRTryo0(looseConstraints);
        } else {
            placeable = null;
        }
        Placeable topBarPlaceable = placeable;
        int topBarHeight = topBarPlaceable != null ? topBarPlaceable.getHeight() : 0;
        long bodyConstraints = Constraints.m7489copyZbe2FdA$default(looseConstraints, 0, 0, 0, layoutHeight - topBarHeight, 7, (Object) null);
        ...
        final Placeable bodyPlaceable = subcomposeMeasureScope.subcompose(bottomSheetScaffoldLayoutSlot, ComposableLambdaKt.composableLambdaInstance(-1459220575, true, obj)).get(0).m6399measureBRTryo0(bodyConstraints);
        final Placeable snackbarPlaceable = subcomposeMeasureScope.subcompose(BottomSheetScaffoldLayoutSlot.Snackbar, this.$snackbarHost).get(0).m6399measureBRTryo0(looseConstraints);
