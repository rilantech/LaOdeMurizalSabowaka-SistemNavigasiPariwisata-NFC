...
public final class Selection {
    ...
    public static final int Hour = m3664constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Minute = m3664constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ Selection m3663boximpl(int i) {
        return new Selection(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m3664constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3665equalsimpl(int i, Object obj) {
        return (obj instanceof Selection) && i == ((Selection) obj).m3669unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3666equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m3667hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3668toStringimpl(int i) {
        return "Selection(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m3665equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3667hashCodeimpl(this.value);
    }

    public String toString() {
        return m3668toStringimpl(this.value);
    }
