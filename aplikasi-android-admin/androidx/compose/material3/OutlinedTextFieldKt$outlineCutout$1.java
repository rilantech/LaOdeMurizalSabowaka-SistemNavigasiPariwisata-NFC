...
final class OutlinedTextFieldKt$outlineCutout$1 extends Lambda implements Function1<ContentDrawScope, Unit> {
    ...
    public final void invoke(ContentDrawScope $this$drawWithContent) {
        ...
        float labelWidth = Size.m4782getWidthimpl(this.$labelSize);
        if (labelWidth > 0.0f) {
            float innerPadding = $this$clipRect_u2drOu3jXo$iv.m7535toPx0680j_4(OutlinedTextFieldKt.OutlinedTextFieldInnerPadding);
            float leftLtr = $this$clipRect_u2drOu3jXo$iv.m7535toPx0680j_4(this.$paddingValues.m2263calculateLeftPaddingu2uoSUM($this$drawWithContent.getLayoutDirection())) - innerPadding;
            float f = (float) 2;
            ...
            if (WhenMappings.$EnumSwitchMapping$0[$this$drawWithContent.getLayoutDirection().ordinal()] == 1) {
                left = Size.m4782getWidthimpl($this$drawWithContent.m5576getSizeNHjbRc()) - rightLtr;
            } else {
                left = RangesKt.coerceAtLeast(leftLtr, 0.0f);
            }
            if (WhenMappings.$EnumSwitchMapping$0[$this$drawWithContent.getLayoutDirection().ordinal()] == 1) {
                right = Size.m4782getWidthimpl($this$drawWithContent.m5576getSizeNHjbRc()) - RangesKt.coerceAtLeast(leftLtr, 0.0f);
            } else {
                right = rightLtr;
            }
            float labelHeight = Size.m4779getHeightimpl(this.$labelSize);
            ...
            $this$withTransform_u24lambda_u246$iv$iv.getTransform().m5631clipRectN_I0leg(left, (-labelHeight) / f, right, labelHeight / f, clipOp$iv);
