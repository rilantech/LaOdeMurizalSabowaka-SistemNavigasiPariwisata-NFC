...
final class ModalBottomSheet_androidKt$ModalBottomSheet$anchorChangeHandler$1$1 extends Lambda implements Function2<SheetValue, Float, Unit> {
    final /* synthetic */ CoroutineScope $scope;
    final /* synthetic */ SheetState $sheetState;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ModalBottomSheet_androidKt$ModalBottomSheet$anchorChangeHandler$1$1(CoroutineScope coroutineScope, SheetState sheetState) {
        super(2);
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        invoke((SheetValue) p1, ((Number) p2).floatValue());
        return Unit.INSTANCE;
    }

    public final void invoke(final SheetValue target, final float velocity) {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(sheetState, target, velocity, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (sheetState.animateTo$material3_release(target, velocity, this) != coroutine_suspended) {
                        break;
                    } else {
