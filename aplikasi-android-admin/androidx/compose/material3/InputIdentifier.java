...
public final class InputIdentifier {
    ...
    public static final int EndDateInput = m3527constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int SingleDateInput = m3527constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int StartDateInput = m3527constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ InputIdentifier m3526boximpl(int i) {
        return new InputIdentifier(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m3527constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3528equalsimpl(int i, Object obj) {
        return (obj instanceof InputIdentifier) && i == ((InputIdentifier) obj).m3532unboximpl();
    }
    ...
    public static String m3531toStringimpl(int arg0) {
        if (m3529equalsimpl0(arg0, SingleDateInput)) {
            return "SingleDateInput";
        }
        if (m3529equalsimpl0(arg0, StartDateInput)) {
            return "StartDateInput";
        }
        if (m3529equalsimpl0(arg0, EndDateInput)) {
            return "EndDateInput";
        }
        return "Unknown";
    }
