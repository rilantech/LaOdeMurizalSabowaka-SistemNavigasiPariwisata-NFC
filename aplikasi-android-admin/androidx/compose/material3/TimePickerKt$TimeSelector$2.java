...
final class TimePickerKt$TimeSelector$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ CoroutineScope $scope;
    final /* synthetic */ int $selection;
    final /* synthetic */ TimePickerState $state;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TimePickerKt$TimeSelector$2(int i, TimePickerState timePickerState, CoroutineScope coroutineScope) {
        super(0);
        this.$selection = i;
    ...
    public final void invoke() {
        if (!Selection.m3666equalsimpl0(this.$selection, this.$state.m3901getSelectionJiIwxys$material3_release())) {
            this.$state.m3904setSelectioniHAOin8$material3_release(this.$selection);
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(timePickerState, continuation);
        }
