...
public final class SelectableChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m1904BorderStrokecXLIe8U(selected ? this.selectedBorderWidth : this.borderWidth, color), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof SelectableChipBorder) || !Color.m4964equalsimpl0(this.borderColor, ((SelectableChipBorder) other).borderColor) || !Color.m4964equalsimpl0(this.selectedBorderColor, ((SelectableChipBorder) other).selectedBorderColor) || !Color.m4964equalsimpl0(this.disabledBorderColor, ((SelectableChipBorder) other).disabledBorderColor) || !Color.m4964equalsimpl0(this.disabledSelectedBorderColor, ((SelectableChipBorder) other).disabledSelectedBorderColor) || !Dp.m7559equalsimpl0(this.borderWidth, ((SelectableChipBorder) other).borderWidth) || !Dp.m7559equalsimpl0(this.selectedBorderWidth, ((SelectableChipBorder) other).selectedBorderWidth)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((Color.m4970hashCodeimpl(this.borderColor) * 31) + Color.m4970hashCodeimpl(this.selectedBorderColor)) * 31) + Color.m4970hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m4970hashCodeimpl(this.disabledSelectedBorderColor)) * 31) + Dp.m7560hashCodeimpl(this.borderWidth)) * 31) + Dp.m7560hashCodeimpl(this.selectedBorderWidth);
    }
}
