...
public final class SliderPositions {
    ...
    public SliderPositions(ClosedFloatingPointRange<Float> initialActiveRange, float[] initialTickFractions) {
        ...
        this.activeRange$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(initialActiveRange, (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SliderPositions) && Intrinsics.areEqual((Object) getActiveRange(), (Object) ((SliderPositions) other).getActiveRange()) && Arrays.equals(getTickFractions(), ((SliderPositions) other).getTickFractions())) {
            return true;
        }
        return false;
    }
