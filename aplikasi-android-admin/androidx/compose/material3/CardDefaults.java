...
public final class CardDefaults {
    ...
    public final CardElevation m3290cardElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float defaultElevation2 = (i & 1) != 0 ? FilledCardTokens.INSTANCE.m4204getContainerElevationD9Ej5fM() : defaultElevation;
        if ((i & 2) != 0) {
            pressedElevation2 = FilledCardTokens.INSTANCE.m4210getPressedContainerElevationD9Ej5fM();
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            focusedElevation2 = FilledCardTokens.INSTANCE.m4207getFocusContainerElevationD9Ej5fM();
        } else {
            focusedElevation2 = focusedElevation;
        }
        if ((i & 8) != 0) {
            hoveredElevation2 = FilledCardTokens.INSTANCE.m4208getHoverContainerElevationD9Ej5fM();
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        if ((i & 16) != 0) {
            draggedElevation2 = FilledCardTokens.INSTANCE.m4206getDraggedContainerElevationD9Ej5fM();
        } else {
            draggedElevation2 = draggedElevation;
        }
        if ((i & 32) != 0) {
            disabledElevation2 = FilledCardTokens.INSTANCE.m4205getDisabledContainerElevationD9Ej5fM();
        } else {
    ...
    public final CardElevation m3292elevatedCardElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float pressedElevation2;
        float focusedElevation2;
        float hoveredElevation2;
        float draggedElevation2;
        ...
        float defaultElevation2 = (i & 1) != 0 ? ElevatedCardTokens.INSTANCE.m4120getContainerElevationD9Ej5fM() : defaultElevation;
        if ((i & 2) != 0) {
            pressedElevation2 = ElevatedCardTokens.INSTANCE.m4126getPressedContainerElevationD9Ej5fM();
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            focusedElevation2 = ElevatedCardTokens.INSTANCE.m4123getFocusContainerElevationD9Ej5fM();
        } else {
            focusedElevation2 = focusedElevation;
        }
        if ((i & 8) != 0) {
            hoveredElevation2 = ElevatedCardTokens.INSTANCE.m4124getHoverContainerElevationD9Ej5fM();
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        if ((i & 16) != 0) {
            draggedElevation2 = ElevatedCardTokens.INSTANCE.m4122getDraggedContainerElevationD9Ej5fM();
        } else {
            draggedElevation2 = draggedElevation;
        }
        if ((i & 32) != 0) {
            disabledElevation2 = ElevatedCardTokens.INSTANCE.m4121getDisabledContainerElevationD9Ej5fM();
        } else {
            disabledElevation2 = disabledElevation;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final CardElevation m3294outlinedCardElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float pressedElevation2;
        float focusedElevation2;
        float hoveredElevation2;
        float draggedElevation2;
        ...
        float defaultElevation2 = (i & 1) != 0 ? OutlinedCardTokens.INSTANCE.m4306getContainerElevationD9Ej5fM() : defaultElevation;
        if ((i & 2) != 0) {
        ...
        if ((i & 16) != 0) {
            draggedElevation2 = OutlinedCardTokens.INSTANCE.m4308getDraggedContainerElevationD9Ej5fM();
        } else {
            draggedElevation2 = draggedElevation;
        }
        if ((i & 32) != 0) {
            disabledElevation2 = OutlinedCardTokens.INSTANCE.m4307getDisabledContainerElevationD9Ej5fM();
        } else {
            disabledElevation2 = disabledElevation;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final CardColors m3289cardColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        ...
        if ((i & 4) != 0) {
            disabledContainerColor2 = ColorKt.m5008compositeOverOWjLjI(Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(FilledCardTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null), ColorSchemeKt.m3374surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), FilledCardTokens.INSTANCE.m4205getDisabledContainerElevationD9Ej5fM()));
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i & 8) != 0) {
            disabledContentColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.m3369contentColorForek8zF_U(containerColor2, composer, i2 & 14), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
    ...
    public final CardColors m3291elevatedCardColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContainerColor2;
        long disabledContentColor2;
        Composer composer = $composer;
        ...
        if ((i & 4) != 0) {
            disabledContainerColor2 = ColorKt.m5008compositeOverOWjLjI(Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(ElevatedCardTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null), ColorSchemeKt.m3374surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), ElevatedCardTokens.INSTANCE.m4121getDisabledContainerElevationD9Ej5fM()));
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i & 8) != 0) {
    ...
    public final CardColors m3293outlinedCardColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContainerColor2;
        long disabledContentColor2;
        Composer composer = $composer;
    ...
    public final BorderStroke outlinedCardBorder(boolean enabled, Composer $composer, int $changed, int i) {
        ...
        if (enabled) {
            ...
            color = ColorKt.m5008compositeOverOWjLjI(Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(OutlinedCardTokens.INSTANCE.getDisabledOutlineColor(), $composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null), ColorSchemeKt.m3374surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme($composer, 6), OutlinedCardTokens.INSTANCE.m4307getDisabledContainerElevationD9Ej5fM()));
            $composer.endReplaceableGroup();
        }
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = BorderStrokeKt.m1904BorderStrokecXLIe8U(OutlinedCardTokens.INSTANCE.m4312getOutlineWidthD9Ej5fM(), color);
