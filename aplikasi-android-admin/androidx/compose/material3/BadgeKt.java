...
public final class BadgeKt {
    private static final float BadgeOffset = Dp.m7554constructorimpl((float) 0);
    private static final float BadgeWithContentHorizontalOffset = Dp.m7554constructorimpl(-Dp.m7554constructorimpl((float) 4));
    private static final float BadgeWithContentHorizontalPadding = Dp.m7554constructorimpl((float) 4);
    private static final float BadgeWithContentVerticalOffset = Dp.m7554constructorimpl(-Dp.m7554constructorimpl((float) 4));
    ...
    public static final void BadgedBox(Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> badge, Modifier modifier, Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        ...
        if (($dirty2 & 731) != 146 || !$composer3.getSkipping()) {
            ...
            function33.invoke(SkippableUpdater.m4566boximpl(SkippableUpdater.m4567constructorimpl($composer3)), $composer3, Integer.valueOf(($changed$iv$iv >> 3) & 112));
            ...
            function36.invoke(SkippableUpdater.m4566boximpl(SkippableUpdater.m4567constructorimpl($composer4)), $composer4, Integer.valueOf(($changed$iv$iv$iv >> 3) & 112));
    ...
    public static final void m3264BadgeeopBjH0(Modifier modifier, long containerColor, long contentColor, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        long j;
        long contentColor2;
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            if ((i4 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    $dirty &= -897;
                    contentColor2 = ColorSchemeKt.m3369contentColorForek8zF_U(containerColor3, $composer2, ($dirty >> 3) & 14);
                }
                if (i6 != 0) {
                    function3 = null;
                }
            ...
            float size = function3 != null ? badgeTokens.m4004getLargeSizeD9Ej5fM() : badgeTokens.m4005getSizeD9Ej5fM();
            if (function3 != null) {
            ...
            Modifier clip = ClipKt.clip(BackgroundKt.m1876backgroundbw27NRU(SizeKt.m2306defaultMinSizeVpY3zN4(modifier4, size, size), containerColor3, shape), shape);
            if (function3 != null) {
                float f = size;
                modifier5 = PaddingKt.m2250paddingVpY3zN4$default(Modifier.Companion, BadgeWithContentHorizontalPadding, 0.0f, 2, (Object) null);
            } else {
            ...
            if (function3 != null) {
                ...
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(contentColor2))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer3, 5609066, true, new BadgeKt$Badge$1$1(function3, $this$Badge_eopBjH0_u24lambda_u241, $changed2, $dirty)), $composer3, 56);
            } else {
                int i9 = $changed$iv;
            }
