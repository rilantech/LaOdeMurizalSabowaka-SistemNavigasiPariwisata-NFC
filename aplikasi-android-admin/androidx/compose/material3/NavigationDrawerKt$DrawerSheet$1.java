...
final class NavigationDrawerKt$DrawerSheet$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.m2326sizeInqDBjuR0$default(Modifier.Companion, NavigationDrawerKt.MinimumDrawerWidth, 0.0f, DrawerDefaults.INSTANCE.m3457getMaximumDrawerWidthD9Ej5fM(), 0.0f, 10, (Object) null), this.$windowInsets);
            Function3 content$iv = this.$content;
            int $changed$iv = (this.$$dirty >> 9) & 7168;
