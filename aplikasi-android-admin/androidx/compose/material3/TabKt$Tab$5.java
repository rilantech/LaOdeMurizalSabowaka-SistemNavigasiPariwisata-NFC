...
final class TabKt$Tab$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier fillMaxWidth$default = SizeKt.fillMaxWidth$default(SelectableKt.m2543selectableO2vRcR0(this.$modifier, this.$selected, this.$interactionSource, this.$ripple, this.$enabled, Role.m6865boximpl(Role.Companion.m6878getTabo7Vup1c()), this.$onClick), 0.0f, 1, (Object) null);
