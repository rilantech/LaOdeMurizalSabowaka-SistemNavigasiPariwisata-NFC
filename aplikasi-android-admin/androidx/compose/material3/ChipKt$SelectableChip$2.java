...
final class ChipKt$SelectableChip$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            int i2 = this.$$dirty;
            long r3 = selectableChipColors.labelColor$material3_release(z, z2, composer, ((i2 << 3) & 112) | ((i2 >> 9) & 14) | ((this.$$dirty1 << 6) & 896)).getValue().m4973unboximpl();
            SelectableChipColors selectableChipColors2 = this.$colors;
            boolean z3 = this.$enabled;
            boolean z4 = this.$selected;
            int i3 = this.$$dirty;
            long r8 = selectableChipColors2.leadingIconContentColor$material3_release(z3, z4, composer, ((i3 << 3) & 112) | ((i3 >> 9) & 14) | ((this.$$dirty1 << 6) & 896)).getValue().m4973unboximpl();
            SelectableChipColors selectableChipColors3 = this.$colors;
            boolean z5 = this.$enabled;
            boolean z6 = this.$selected;
            int i4 = this.$$dirty;
            long r10 = selectableChipColors3.trailingIconContentColor$material3_release(z5, z6, composer, ((i4 << 3) & 112) | ((i4 >> 9) & 14) | ((this.$$dirty1 << 6) & 896)).getValue().m4973unboximpl();
            ...
            ChipKt.m3301ChipContentfe0OD_I(function2, textStyle, r3, function22, function23, function24, r8, r10, f, paddingValues, $composer, i7 | ((i5 >> 9) & 458752) | ((i5 >> 12) & 14) | ((i5 >> 12) & 112) | ((i5 >> 9) & 7168) | ((i5 >> 9) & 57344) | ((i6 << 15) & 234881024));
            if (ComposerKt.isTraceInProgress()) {
