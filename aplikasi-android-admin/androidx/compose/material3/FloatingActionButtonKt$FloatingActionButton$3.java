    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1249316354, $changed, -1, "androidx.compose.material3.FloatingActionButton.<anonymous> (FloatingActionButton.kt:114)");
            }
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer, -945978686, true, new Function2<Composer, Integer, Unit>() {
                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if (($changed & 11) != 2 || !$composer.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-945978686, $changed, -1, "androidx.compose.material3.FloatingActionButton.<anonymous>.<anonymous> (FloatingActionButton.kt:115)");
                        }
                        ...
                        TextKt.ProvideTextStyle(fromToken, ComposableLambdaKt.composableLambda($composer, 167946739, true, new Function2<Composer, Integer, Unit>() {
                            ...
                            public final void invoke(Composer $composer, int $changed) {
                                ...
                                if ((i & 11) != 2 || !$composer.getSkipping()) {
                                    ...
                                    Modifier modifier$iv = SizeKt.m2306defaultMinSizeVpY3zN4(Modifier.Companion, FabPrimaryTokens.INSTANCE.m4167getContainerWidthD9Ej5fM(), FabPrimaryTokens.INSTANCE.m4166getContainerHeightD9Ej5fM());
                                    ...
                                    ComposerKt.sourceInformationMarkerStart($composer2, -1329862953, "C130@6596L9:FloatingActionButton.kt#uh7d8r");
