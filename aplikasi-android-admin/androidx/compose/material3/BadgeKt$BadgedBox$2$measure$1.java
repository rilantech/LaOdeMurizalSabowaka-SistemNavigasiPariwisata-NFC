...
final class BadgeKt$BadgedBox$2$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope $this$layout) {
        ...
        boolean hasContent = this.$badgePlaceable.getWidth() > this.$this_Layout.m7529roundToPx0680j_4(BadgeTokens.INSTANCE.m4005getSizeD9Ej5fM());
        ...
        Placeable.PlacementScope.placeRelative$default($this$layout, this.$badgePlaceable, this.$anchorPlaceable.getWidth() + this.$this_Layout.m7529roundToPx0680j_4(badgeHorizontalOffset), ((-this.$badgePlaceable.getHeight()) / 2) + this.$this_Layout.m7529roundToPx0680j_4(badgeVerticalOffset), 0.0f, 4, (Object) null);
    }
}
