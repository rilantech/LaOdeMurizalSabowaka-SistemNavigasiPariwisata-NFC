...
final class FloatingActionButtonKt$ExtendedFloatingActionButton$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = PaddingKt.m2250paddingVpY3zN4$default(SizeKt.m2326sizeInqDBjuR0$default(Modifier.Companion, FloatingActionButtonKt.ExtendedFabMinimumWidth, 0.0f, 0.0f, 0.0f, 14, (Object) null), FloatingActionButtonKt.ExtendedFabTextPadding, 0.0f, 2, (Object) null);
            Arrangement.Horizontal horizontalArrangement$iv = Arrangement.INSTANCE.getCenter();
            Alignment.Vertical verticalAlignment$iv = Alignment.Companion.getCenterVertically();
            Function3 content$iv = this.$content;
            int $changed$iv = ((this.$$dirty >> 12) & 7168) | 438;
