...
public final class SnapFlingBehavior implements FlingBehavior {
    ...
    private final float MinFlingVelocityDp = Dp.m7554constructorimpl((float) 400);
    ...
    public SnapFlingBehavior(LazyListState lazyListState2, DecayAnimationSpec<Float> decayAnimationSpec2, AnimationSpec<Float> snapAnimationSpec2, Density density2) {
        ...
        this.velocityThreshold = density2.m7535toPx0680j_4(this.MinFlingVelocityDp);
    }
    ...
    private final int getSingleAxisViewportSize(LazyListLayoutInfo $this$singleAxisViewportSize) {
        return $this$singleAxisViewportSize.getOrientation() == Orientation.Vertical ? IntSize.m7713getHeightimpl($this$singleAxisViewportSize.m2388getViewportSizeYbymL2g()) : IntSize.m7714getWidthimpl($this$singleAxisViewportSize.m2388getViewportSizeYbymL2g());
    }
}
