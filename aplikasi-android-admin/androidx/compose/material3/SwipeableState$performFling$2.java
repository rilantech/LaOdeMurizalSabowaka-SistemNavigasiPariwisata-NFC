...
final class SwipeableState$performFling$2 implements FlowCollector<Map<Float, ? extends T>> {
    ...
    public final Object emit(Map<Float, ? extends T> anchors, Continuation<? super Unit> $completion) {
        ...
        Object targetState = anchors.get(Boxing.boxFloat(SwipeableKt.computeTarget(this.this$0.getOffset().getValue().floatValue(), lastAnchor, anchors.keySet(), this.this$0.getThresholds$material3_release(), this.$velocity, this.this$0.getVelocityThreshold$material3_release())));
        if (targetState == null || !this.this$0.getConfirmStateChange$material3_release().invoke(targetState).booleanValue()) {
            SwipeableState<T> swipeableState = this.this$0;
            Object access$animateInternalToOffset = swipeableState.animateInternalToOffset(lastAnchor, swipeableState.getAnimationSpec$material3_release(), $completion);
            return access$animateInternalToOffset == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? access$animateInternalToOffset : Unit.INSTANCE;
        }
        Object animateTo$material3_release$default = SwipeableState.animateTo$material3_release$default(this.this$0, targetState, (AnimationSpec) null, $completion, 2, (Object) null);
