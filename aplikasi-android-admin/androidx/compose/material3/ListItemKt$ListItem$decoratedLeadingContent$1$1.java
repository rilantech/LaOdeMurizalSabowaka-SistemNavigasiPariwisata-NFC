    ...
    public final void invoke(RowScope $this$null, Composer $composer, int $changed) {
        ...
        if (($dirty & 91) != 18 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1673725255, $dirty, -1, "androidx.compose.material3.ListItem.<anonymous>.<anonymous> (ListItem.kt:116)");
            }
            ListItemKt.m3538LeadingContent3IgeMak($this$null, this.$colors.leadingIconColor$material3_release(true, $composer, ((this.$$dirty >> 15) & 112) | 6).getValue().m4973unboximpl(), ListItemType.m3551equalsimpl0(this.$listItemType, ListItemType.Companion.m3558getThreeLineAlXitO8()), this.$it, $composer, $dirty & 14);
            if (ComposerKt.isTraceInProgress()) {
