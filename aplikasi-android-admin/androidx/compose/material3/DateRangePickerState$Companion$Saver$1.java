...
final class DateRangePickerState$Companion$Saver$1 extends Lambda implements Function2<SaverScope, DateRangePickerState, Object> {
    ...
    public final Object invoke(SaverScope $this$Saver, DateRangePickerState it) {
        Intrinsics.checkNotNullParameter($this$Saver, "$this$Saver");
        Intrinsics.checkNotNullParameter(it, "it");
        return StateData.Companion.Saver().save($this$Saver, it.getStateData$material3_release());
    }
}
