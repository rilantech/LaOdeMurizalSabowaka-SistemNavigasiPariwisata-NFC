...
final class SliderKt$RangeSlider$9 extends Lambda implements Function3<SliderPositions, Composer, Integer, Unit> {
    ...
    public final void invoke(SliderPositions it, Composer $composer, int $changed) {
        ...
        if ((i & 81) != 16 || !$composer.getSkipping()) {
            ...
            int i2 = this.$$dirty;
            sliderDefaults.m3676Thumb9LiSoMs(mutableInteractionSource, (Modifier) null, sliderColors, z, 0, $composer, ((i2 >> 24) & 14) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE | ((i2 >> 12) & 896) | (i2 & 7168), 18);
            if (ComposerKt.isTraceInProgress()) {
