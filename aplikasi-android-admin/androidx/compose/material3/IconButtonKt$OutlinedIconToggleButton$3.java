...
final class IconButtonKt$OutlinedIconToggleButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$OutlinedIconToggleButton$3(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C524@25856L154:IconButton.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = SizeKt.m2322size3ABfNKs(Modifier.Companion, OutlinedIconButtonTokens.INSTANCE.m4314getContainerSizeD9Ej5fM());
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, -866750295, "C528@25995L9:IconButton.kt#uh7d8r");
            function2.invoke($composer2, Integer.valueOf((i2 >> 24) & 14));
