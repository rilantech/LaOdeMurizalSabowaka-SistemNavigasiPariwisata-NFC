...
final class CheckboxKt$CheckboxImpl$1$1 extends Lambda implements Function1<DrawScope, Unit> {
    ...
    public final void invoke(DrawScope $this$Canvas) {
        ...
        CheckboxKt.m3298drawBox1wkBAMs(drawScope, this.$boxColor.getValue().m4973unboximpl(), this.$borderColor.getValue().m4973unboximpl(), $this$Canvas.m7535toPx0680j_4(CheckboxKt.RadiusSize), strokeWidthPx);
        CheckboxKt.m3299drawCheck3IgeMak(drawScope, this.$checkColor.getValue().m4973unboximpl(), this.$checkDrawFraction.getValue().floatValue(), this.$checkCenterGravitationShiftFraction.getValue().floatValue(), strokeWidthPx, this.$checkCache);
    }
}
