...
final class TimePickerKt$HorizontalPeriodToggle$measurePolicy$1$1$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope $this$layout) {
        ...
        Placeable.PlacementScope.place$default($this$layout, this.$items.get(1), this.$items.get(0).getWidth(), 0, 0.0f, 4, (Object) null);
        Placeable.PlacementScope.place$default($this$layout, this.$spacerPlaceable, this.$items.get(0).getWidth() - (this.$spacerPlaceable.getWidth() / 2), 0, 0.0f, 4, (Object) null);
    }
}
