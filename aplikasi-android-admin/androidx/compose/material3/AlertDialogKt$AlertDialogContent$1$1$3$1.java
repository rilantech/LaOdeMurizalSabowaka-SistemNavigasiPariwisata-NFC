    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(613970333, $changed, -1, "androidx.compose.material3.AlertDialogContent.<anonymous>.<anonymous>.<anonymous>.<anonymous> (AlertDialog.kt:93)");
            }
            ...
            TextKt.ProvideTextStyle(textStyle, ComposableLambdaKt.composableLambda($composer, -747827634, true, new Function2<Composer, Integer, Unit>() {
                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if ((i & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        ComposerKt.sourceInformationMarkerStart($composer2, 821919644, "C103@3982L6:AlertDialog.kt#uh7d8r");
