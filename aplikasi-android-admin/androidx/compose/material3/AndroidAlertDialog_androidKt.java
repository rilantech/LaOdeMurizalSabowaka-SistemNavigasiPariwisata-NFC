...
public final class AndroidAlertDialog_androidKt {
    ...
    public static final float ButtonsCrossAxisSpacing = Dp.m7554constructorimpl((float) 12);
    /* access modifiers changed from: private */
    public static final float ButtonsMainAxisSpacing = Dp.m7554constructorimpl((float) 8);

    /* renamed from: AlertDialog-Oix01E0  reason: not valid java name */
    public static final void m3244AlertDialogOix01E0(Function0<Unit> onDismissRequest, Function2<? super Composer, ? super Integer, Unit> confirmButton, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> dismissButton, Function2<? super Composer, ? super Integer, Unit> icon, Function2<? super Composer, ? super Integer, Unit> title, Function2<? super Composer, ? super Integer, Unit> text, Shape shape, long containerColor, long iconContentColor, long titleContentColor, long textContentColor, float tonalElevation, DialogProperties properties, Composer $composer, int $changed, int $changed1, int i) {
        Function2 title2;
        Function2 text2;
        Shape shape2;
        ...
        if (($dirty2 & 1533916891) == 306783378 && ($dirty12 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if ((i7 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i16 != 0) {
                    tonalElevation3 = AlertDialogDefaults.INSTANCE.m3240getTonalElevationD9Ej5fM();
                } else {
