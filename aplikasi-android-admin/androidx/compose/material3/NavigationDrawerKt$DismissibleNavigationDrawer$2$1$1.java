...
final class NavigationDrawerKt$DismissibleNavigationDrawer$2$1$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    final /* synthetic */ DrawerState $drawerState;
    final /* synthetic */ String $navigationMenu;
    final /* synthetic */ CoroutineScope $scope;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NavigationDrawerKt$DismissibleNavigationDrawer$2$1$1(String str, DrawerState drawerState, CoroutineScope coroutineScope) {
        super(1);
