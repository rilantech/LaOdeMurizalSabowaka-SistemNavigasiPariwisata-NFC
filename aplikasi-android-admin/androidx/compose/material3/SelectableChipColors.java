...
public final class SelectableChipColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof SelectableChipColors) || !Color.m4964equalsimpl0(this.containerColor, ((SelectableChipColors) other).containerColor) || !Color.m4964equalsimpl0(this.labelColor, ((SelectableChipColors) other).labelColor) || !Color.m4964equalsimpl0(this.leadingIconColor, ((SelectableChipColors) other).leadingIconColor) || !Color.m4964equalsimpl0(this.trailingIconColor, ((SelectableChipColors) other).trailingIconColor) || !Color.m4964equalsimpl0(this.disabledContainerColor, ((SelectableChipColors) other).disabledContainerColor) || !Color.m4964equalsimpl0(this.disabledLabelColor, ((SelectableChipColors) other).disabledLabelColor) || !Color.m4964equalsimpl0(this.disabledLeadingIconColor, ((SelectableChipColors) other).disabledLeadingIconColor) || !Color.m4964equalsimpl0(this.disabledTrailingIconColor, ((SelectableChipColors) other).disabledTrailingIconColor) || !Color.m4964equalsimpl0(this.selectedContainerColor, ((SelectableChipColors) other).selectedContainerColor) || !Color.m4964equalsimpl0(this.disabledSelectedContainerColor, ((SelectableChipColors) other).disabledSelectedContainerColor) || !Color.m4964equalsimpl0(this.selectedLabelColor, ((SelectableChipColors) other).selectedLabelColor) || !Color.m4964equalsimpl0(this.selectedLeadingIconColor, ((SelectableChipColors) other).selectedLeadingIconColor) || !Color.m4964equalsimpl0(this.selectedTrailingIconColor, ((SelectableChipColors) other).selectedTrailingIconColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((((((Color.m4970hashCodeimpl(this.containerColor) * 31) + Color.m4970hashCodeimpl(this.labelColor)) * 31) + Color.m4970hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4970hashCodeimpl(this.trailingIconColor)) * 31) + Color.m4970hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4970hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m4970hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4970hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m4970hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m4970hashCodeimpl(this.disabledSelectedContainerColor)) * 31) + Color.m4970hashCodeimpl(this.selectedLabelColor)) * 31) + Color.m4970hashCodeimpl(this.selectedLeadingIconColor)) * 31) + Color.m4970hashCodeimpl(this.selectedTrailingIconColor);
    }
}
