...
public final class DrawerDefaults {
    ...
    private static final float DismissibleDrawerElevation = NavigationDrawerTokens.INSTANCE.m4285getStandardContainerElevationD9Ej5fM();
    public static final DrawerDefaults INSTANCE = new DrawerDefaults();
    private static final float MaximumDrawerWidth = NavigationDrawerTokens.INSTANCE.m4282getContainerWidthD9Ej5fM();
    private static final float ModalDrawerElevation = NavigationDrawerTokens.INSTANCE.m4284getModalContainerElevationD9Ej5fM();
    private static final float PermanentDrawerElevation = NavigationDrawerTokens.INSTANCE.m4285getStandardContainerElevationD9Ej5fM();

    private DrawerDefaults() {
    }

    /* renamed from: getModalDrawerElevation-D9Ej5fM  reason: not valid java name */
    public final float m3458getModalDrawerElevationD9Ej5fM() {
        return ModalDrawerElevation;
    }

    /* renamed from: getPermanentDrawerElevation-D9Ej5fM  reason: not valid java name */
    public final float m3459getPermanentDrawerElevationD9Ej5fM() {
        return PermanentDrawerElevation;
    }

    /* renamed from: getDismissibleDrawerElevation-D9Ej5fM  reason: not valid java name */
    public final float m3456getDismissibleDrawerElevationD9Ej5fM() {
    ...
    public final float m3457getMaximumDrawerWidthD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets r0 = WindowInsetsKt.m2351onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, $composer, 8), WindowInsetsSides.m2365plusgK_yJZ4(WindowInsetsSides.Companion.m2380getVerticalJoeWqyM(), WindowInsetsSides.Companion.m2378getStartJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
