...
public final class StateData {
    ...
    private StateData(Long initialSelectedStartDateMillis, Long initialSelectedEndDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange2, int initialDisplayMode) {
        ...
        this.displayMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DisplayMode.m3441boximpl(initialDisplayMode), (SnapshotMutationPolicy) null, 2, (Object) null);
    }
    ...
    public final void m3691switchDisplayModevCnGnXg(int displayMode2) {
        ...
        this.displayMode.setValue(DisplayMode.m3441boximpl(displayMode2));
    }
