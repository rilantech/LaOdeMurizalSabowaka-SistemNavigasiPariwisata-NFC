...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m2322size3ABfNKs(Modifier.Companion, IconButtonTokens.INSTANCE.m4246getIconSizeD9Ej5fM());

    /* renamed from: Icon-ww6aTOc  reason: not valid java name */
    public static final void m3518Iconww6aTOc(ImageVector imageVector, String contentDescription, Modifier modifier, long tint, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        long tint2;
        long tint3;
        Modifier modifier3;
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            if ((i3 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    ...
                    $dirty &= -7169;
                    tint2 = ((Color) consume).m4973unboximpl();
                }
            } else {
            ...
            m3517Iconww6aTOc((Painter) VectorPainterKt.rememberVectorPainter(imageVector2, $composer2, $dirty & 14), contentDescription, modifier4, tint2, $composer2, VectorPainter.$stable | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    /* renamed from: Icon-ww6aTOc  reason: not valid java name */
    public static final void m3516Iconww6aTOc(ImageBitmap bitmap, String contentDescription, Modifier modifier, long tint, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        long tint2;
        int $dirty;
        ...
        m3517Iconww6aTOc((Painter) (BitmapPainter) value$iv$iv, contentDescription, modifier2, tint2, $composer2, ($dirty & 112) | 8 | ($dirty & 896) | ($dirty & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    /* renamed from: Icon-ww6aTOc  reason: not valid java name */
    public static final void m3517Iconww6aTOc(Painter painter, String contentDescription, Modifier modifier, long tint, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        long tint2;
        int $dirty;
        Modifier modifier3;
    ...
    private static final Modifier defaultSizeFor(Modifier $this$defaultSizeFor, Painter painter) {
        Modifier modifier;
        if (Size.m4778equalsimpl0(painter.m5671getIntrinsicSizeNHjbRc(), Size.Companion.m4790getUnspecifiedNHjbRc()) || m3519isInfiniteuvyYCjk(painter.m5671getIntrinsicSizeNHjbRc())) {
    ...
    private static final boolean m3519isInfiniteuvyYCjk(long $this$isInfinite_u2duvyYCjk) {
