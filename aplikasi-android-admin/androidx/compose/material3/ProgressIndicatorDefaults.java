...
public final class ProgressIndicatorDefaults {
    ...
    private static final int CircularDeterminateStrokeCap = StrokeCap.Companion.m5351getButtKaPHkGw();
    private static final int CircularIndeterminateStrokeCap = StrokeCap.Companion.m5353getSquareKaPHkGw();
    private static final float CircularStrokeWidth = CircularProgressIndicatorTokens.INSTANCE.m4028getActiveIndicatorWidthD9Ej5fM();
    public static final ProgressIndicatorDefaults INSTANCE = new ProgressIndicatorDefaults();
    private static final int LinearStrokeCap = StrokeCap.Companion.m5351getButtKaPHkGw();
    ...
    public final long getCircularTrackColor(Composer $composer, int $changed) {
        ...
        long r0 = Color.Companion.m4998getTransparent0d7_KjU();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
