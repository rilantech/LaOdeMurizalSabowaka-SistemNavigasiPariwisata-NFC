...
public final class SelectableChipElevation {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (!enabled) {
            ...
            EffectsKt.LaunchedEffect((Object) Dp.m7552boximpl(target), (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new SelectableChipElevation$animateElevation$2(animatable, target, (Continuation<? super SelectableChipElevation$animateElevation$2>) null), composer, 64);
            $composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-699481799);
            ComposerKt.sourceInformation(composer, "1712@81209L570");
            EffectsKt.LaunchedEffect((Object) Dp.m7552boximpl(target), (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new SelectableChipElevation$animateElevation$3(animatable, this, target, interaction, (Continuation<? super SelectableChipElevation$animateElevation$3>) null), composer, 64);
            $composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof SelectableChipElevation) || !Dp.m7559equalsimpl0(this.elevation, ((SelectableChipElevation) other).elevation) || !Dp.m7559equalsimpl0(this.pressedElevation, ((SelectableChipElevation) other).pressedElevation) || !Dp.m7559equalsimpl0(this.focusedElevation, ((SelectableChipElevation) other).focusedElevation) || !Dp.m7559equalsimpl0(this.hoveredElevation, ((SelectableChipElevation) other).hoveredElevation) || !Dp.m7559equalsimpl0(this.disabledElevation, ((SelectableChipElevation) other).disabledElevation)) {
            return false;
        }
        return true;
    }
