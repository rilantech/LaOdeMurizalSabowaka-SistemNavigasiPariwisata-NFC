...
final class SearchBarKt$SearchBarInputField$5$2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ Function2<Composer, Integer, Unit> $trailing;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SearchBarKt$SearchBarInputField$5$2$1(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C481@22280L62:SearchBar.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = OffsetKt.m2207offsetVpY3zN4$default(Modifier.Companion, Dp.m7554constructorimpl(-SearchBarKt.SearchBarIconOffsetX), 0.0f, 2, (Object) null);
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 643341702, "C481@22330L10:SearchBar.kt#uh7d8r");
