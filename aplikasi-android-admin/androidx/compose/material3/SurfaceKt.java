...
public final class SurfaceKt {
    ...
    public static final void m3772SurfaceT9BRK9s(Modifier modifier, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        Shape shape2;
        long color2;
        long contentColor2;
        ...
        if ((i & 4) != 0) {
            color2 = MaterialTheme.INSTANCE.getColorScheme(composer, 6).m3333getSurface0d7_KjU();
        } else {
            color2 = color;
        }
        if ((i & 8) != 0) {
            contentColor2 = ColorSchemeKt.m3369contentColorForek8zF_U(color2, composer, (i2 >> 6) & 14);
        } else {
            contentColor2 = contentColor;
        }
        if ((i & 16) != 0) {
            tonalElevation2 = Dp.m7554constructorimpl((float) 0);
        } else {
            tonalElevation2 = tonalElevation;
        }
        if ((i & 32) != 0) {
            shadowElevation2 = Dp.m7554constructorimpl((float) 0);
        } else {
        ...
        float absoluteElevation = Dp.m7554constructorimpl(((Dp) consume).m7568unboximpl() + tonalElevation2);
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(contentColor2)), this_$iv.provides(Dp.m7552boximpl(absoluteElevation))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composer, -70914509, true, surfaceKt$Surface$1), composer, 56);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m3775Surfaceo_FOJdg(Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int $changed1, int i) {
        boolean enabled2;
        Shape shape2;
        long color2;
        long contentColor2;
        ...
        if ((i3 & 32) != 0) {
            contentColor2 = ColorSchemeKt.m3369contentColorForek8zF_U(color2, composer, (i2 >> 12) & 14);
        } else {
            contentColor2 = contentColor;
        }
        if ((i3 & 64) != 0) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-789752804, i2, $changed1, "androidx.compose.material3.Surface (Surface.kt:201)");
        } else {
            int i4 = $changed1;
        }
        ProvidableCompositionLocal<Dp> this_$iv = LocalAbsoluteTonalElevation;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(contentColor2)), this_$iv.provides(Dp.m7552boximpl(absoluteElevation))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composer, 1279702876, true, surfaceKt$Surface$3), composer, 56);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final void m3773Surfaced85dljk(boolean selected, Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int $changed1, int i) {
        boolean enabled2;
        Shape shape2;
        long color2;
        long contentColor2;
        ...
        if ((i3 & 64) != 0) {
            contentColor2 = ColorSchemeKt.m3369contentColorForek8zF_U(color2, composer, (i2 >> 15) & 14);
        } else {
            contentColor2 = contentColor;
        }
        if ((i3 & 128) != 0) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(540296512, i2, $changed1, "androidx.compose.material3.Surface (Surface.kt:309)");
        } else {
            int i4 = $changed1;
        }
        ProvidableCompositionLocal<Dp> this_$iv = LocalAbsoluteTonalElevation;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(contentColor2)), this_$iv.provides(Dp.m7552boximpl(absoluteElevation))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composer, -1164547968, true, surfaceKt$Surface$5), composer, 56);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    /* renamed from: Surface-d85dljk  reason: not valid java name */
    public static final void m3774Surfaced85dljk(boolean checked, Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int $changed1, int i) {
        boolean enabled2;
        Shape shape2;
        long color2;
        long contentColor2;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1877401889, i2, $changed1, "androidx.compose.material3.Surface (Surface.kt:419)");
        } else {
            int i4 = $changed1;
        }
        ProvidableCompositionLocal<Dp> this_$iv = LocalAbsoluteTonalElevation;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(contentColor2)), this_$iv.provides(Dp.m7552boximpl(absoluteElevation))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composer, 712720927, true, surfaceKt$Surface$7), composer, 56);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final Modifier m3778surface8ww4TTg(Modifier $this$surface_u2d8ww4TTg, Shape shape, long backgroundColor, BorderStroke border, float shadowElevation) {
        Modifier r0 = ShadowKt.m4622shadows4CzXII$default($this$surface_u2d8ww4TTg, shadowElevation, shape, false, 0, 0, 24, (Object) null);
    ...
    public static final long m3779surfaceColorAtElevationCLU3JFs(long color, float elevation, Composer $composer, int $changed) {
        long j;
        ...
        if (Color.m4964equalsimpl0(color, MaterialTheme.INSTANCE.getColorScheme($composer, 6).m3333getSurface0d7_KjU())) {
            j = ColorSchemeKt.m3374surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme($composer, 6), elevation);
        } else {
            j = color;
        }
        if (ComposerKt.isTraceInProgress()) {
