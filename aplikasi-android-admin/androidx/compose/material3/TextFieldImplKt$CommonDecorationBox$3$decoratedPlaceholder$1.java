...
final class TextFieldImplKt$CommonDecorationBox$3$decoratedPlaceholder$1 extends Lambda implements Function3<Modifier, Composer, Integer, Unit> {
    ...
    public final void invoke(Modifier modifier, Composer $composer, int $changed) {
        ...
        if (($dirty & 91) != 18 || !$composer.getSkipping()) {
            ...
            long r6 = textFieldColors.placeholderColor$material3_release(z, z2, interactionSource, $composer2, (i7 & 896) | (i7 & 14) | (i7 & 112) | ((i2 >> 9) & 7168)).getValue().m4973unboximpl();
            ...
            TextFieldImplKt.m3847DecorationKTwxG1Y(r6, MaterialTheme.INSTANCE.getTypography($composer2, 6).getBodyLarge(), function2, $composer2, (i3 >> 9) & 896, 0);
