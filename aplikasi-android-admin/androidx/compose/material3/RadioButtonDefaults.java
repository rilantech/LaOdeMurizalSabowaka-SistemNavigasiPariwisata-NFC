...
public final class RadioButtonDefaults {
    ...
    public final RadioButtonColors m3641colorsro_MJ88(long selectedColor, long unselectedColor, long disabledSelectedColor, long disabledUnselectedColor, Composer $composer, int $changed, int i) {
        ...
        if ((i & 4) != 0) {
            disabledSelectedColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(RadioButtonTokens.INSTANCE.getDisabledSelectedIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledSelectedColor2 = disabledSelectedColor;
        }
        if ((i & 8) != 0) {
            disabledUnselectedColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(RadioButtonTokens.INSTANCE.getDisabledUnselectedIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
