...
final class SliderDraggableState implements DraggableState {
    ...
    public SliderDraggableState(Function1<? super Float, Unit> onDelta2) {
        Intrinsics.checkNotNullParameter(onDelta2, "onDelta");
        this.onDelta = onDelta2;
    }
    ...
    public Object drag(MutatePriority dragPriority, Function2<? super DragScope, ? super Continuation<? super Unit>, ? extends Object> block, Continuation<? super Unit> $completion) {
        Object coroutineScope = CoroutineScopeKt.coroutineScope(new SliderDraggableState$drag$2(this, dragPriority, block, (Continuation<? super SliderDraggableState$drag$2>) null), $completion);
