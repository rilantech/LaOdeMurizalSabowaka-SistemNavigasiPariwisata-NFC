...
final class TimePickerKt$CircularLayout$1$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope $this$layout) {
        ...
        for (Object item$iv : this.$placeables) {
            ...
            int i = index$iv;
            int centerOffsetX = (Constraints.m7498getMaxWidthimpl(j) / 2) - (it.getWidth() / 2);
            int centerOffsetY = (Constraints.m7497getMaxHeightimpl(j) / 2) - (it.getHeight() / 2);
            double d = (double) f;
        ...
        if (placeable2 != null) {
            Placeable.PlacementScope.place$default($this$layout, placeable2, (Constraints.m7500getMinWidthimpl(this.$constraints) - this.$innerCirclePlaceable.getWidth()) / 2, (Constraints.m7499getMinHeightimpl(this.$constraints) - this.$innerCirclePlaceable.getHeight()) / 2, 0.0f, 4, (Object) null);
        }
    }
}
