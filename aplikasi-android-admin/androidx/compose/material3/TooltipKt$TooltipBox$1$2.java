...
final class TooltipKt$TooltipBox$1$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier access$animateTooltip = TooltipKt.animateTooltip(SizeKt.m2326sizeInqDBjuR0$default(this.$modifier, TooltipKt.getTooltipMinWidth(), TooltipKt.getTooltipMinHeight(), this.$maxWidth, 0.0f, 8, (Object) null), this.$transition);
            ...
            int i2 = this.$$dirty;
            SurfaceKt.m3772SurfaceT9BRK9s(semantics$default, shape, j, 0, f, f, (BorderStroke) null, function2, $composer, ((i2 >> 6) & 112) | ((i2 >> 9) & 896) | (57344 & (i2 >> 6)) | ((i2 >> 3) & 458752) | ((i2 << 21) & 29360128), 72);
            if (ComposerKt.isTraceInProgress()) {
