...
final class TabRowKt$TabRow$2$1$1 extends Lambda implements Function2<SubcomposeMeasureScope, Constraints, MeasureResult> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m3816invoke0kLqBqw((SubcomposeMeasureScope) p1, ((Constraints) p2).m7504unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final MeasureResult m3816invoke0kLqBqw(SubcomposeMeasureScope $this$SubcomposeLayout, long constraints) {
        ...
        int tabRowWidth = Constraints.m7498getMaxWidthimpl(constraints);
        ...
        for (Measurable it : $this$map$iv) {
            destination$iv$iv.add(it.m6399measureBRTryo0(Constraints.m7488copyZbe2FdA(constraints, tabWidth.element, tabWidth.element, accumulator$iv, accumulator$iv)));
            $i$f$map = $i$f$map;
        ...
        for (int index = 0; index < tabCount; index++) {
            tabPositions.add(new TabPosition(Dp.m7554constructorimpl(((float) index) * subcomposeMeasureScope.m7532toDpu2uoSUM(tabWidth.element)), subcomposeMeasureScope.m7532toDpu2uoSUM(tabWidth.element), (DefaultConstructorMarker) null));
        }
        ...
        return MeasureScope.layout$default(subcomposeMeasureScope, tabRowWidth, accumulator$iv, (Map) null, new Function1<Placeable.PlacementScope, Unit>() {
            ...
            public final void invoke(Placeable.PlacementScope $this$layout) {
                ...
                for (Measurable it : subcomposeMeasureScope2.subcompose(TabSlots.Divider, function2)) {
                    Placeable placeable = it.m6399measureBRTryo0(Constraints.m7489copyZbe2FdA$default(j, 0, 0, 0, 0, 11, (Object) null));
                ...
                for (Measurable it2 : subcomposeMeasureScope.subcompose(tabSlots, ComposableLambdaKt.composableLambdaInstance(-976887453, true, new Function2<Composer, Integer, Unit>() {
                    ...
                    Placeable.PlacementScope.placeRelative$default($this$layout, it2.m6399measureBRTryo0(Constraints.Companion.m7506fixedJhjzzOo(i3, i4)), 0, 0, 0.0f, 4, (Object) null);
                }
            }
        }, 4, (Object) null);
    }
