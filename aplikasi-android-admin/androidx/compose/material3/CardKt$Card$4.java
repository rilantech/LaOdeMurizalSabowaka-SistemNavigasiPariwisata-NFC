...
final class CardKt$Card$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    CardKt$Card$4(Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C154@7155L25:Card.kt#uh7d8r");
