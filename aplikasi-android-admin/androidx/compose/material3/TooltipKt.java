...
public final class TooltipKt {
    private static final float ActionLabelBottomPadding = Dp.m7554constructorimpl((float) 8);
    private static final float ActionLabelMinHeight = Dp.m7554constructorimpl((float) 36);
    private static final float HeightFromSubheadToTextFirstLine = Dp.m7554constructorimpl((float) 24);
    private static final float HeightToSubheadFirstLine = Dp.m7554constructorimpl((float) 28);
    private static final PaddingValues PlainTooltipContentPadding;
    private static final float PlainTooltipHorizontalPadding;
    private static final float PlainTooltipMaxWidth = Dp.m7554constructorimpl((float) 200);
    private static final float PlainTooltipVerticalPadding;
    private static final float RichTooltipHorizontalPadding = Dp.m7554constructorimpl((float) 16);
    private static final float RichTooltipMaxWidth = Dp.m7554constructorimpl((float) 320);
    private static final float TextBottomPadding = Dp.m7554constructorimpl((float) 16);
    private static final float TooltipAnchorPadding = Dp.m7554constructorimpl((float) 4);
    ...
    private static final float TooltipMinHeight = Dp.m7554constructorimpl((float) 24);
    private static final float TooltipMinWidth = Dp.m7554constructorimpl((float) 40);
    ...
    public static final void m3972PlainTooltipBoxnBX6wN0(kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r28, androidx.compose.ui.Modifier r29, androidx.compose.material3.PlainTooltipState r30, androidx.compose.ui.graphics.Shape r31, long r32, long r34, kotlin.jvm.functions.Function3<? super androidx.compose.material3.TooltipBoxScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, androidx.compose.runtime.Composer r37, int r38, int r39) {
        /*
            r12 = r28
            r13 = r36
            r14 = r38
        ...
        L_0x01de:
            ...
            int r8 = r0.m7529roundToPx0680j_4(r2)
            r0 = 0
            r1 = 0
        ...
        L_0x022b:
            ...
            r1 = 0
            float r2 = (float) r0
            float r7 = androidx.compose.ui.unit.Dp.m7554constructorimpl(r2)
            ...
            r10 = r15
            r11 = r17
            m3974TooltipBoxXDn_Kpo(r0, r1, r2, r3, r4, r5, r7, r8, r9, r10, r11)
            boolean r0 = androidx.compose.runtime.ComposerKt.isTraceInProgress()
        ...
        L_0x02c0:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TooltipKt.m3972PlainTooltipBoxnBX6wN0(kotlin.jvm.functions.Function2, androidx.compose.ui.Modifier, androidx.compose.material3.PlainTooltipState, androidx.compose.ui.graphics.Shape, long, long, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void RichTooltipBox(kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r26, androidx.compose.ui.Modifier r27, androidx.compose.material3.RichTooltipState r28, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r29, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r30, androidx.compose.ui.graphics.Shape r31, androidx.compose.material3.RichTooltipColors r32, kotlin.jvm.functions.Function3<? super androidx.compose.material3.TooltipBoxScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r33, androidx.compose.runtime.Composer r34, int r35, int r36) {
        ...
        L_0x01cc:
            ...
            r19 = r20
            r21 = r7
            androidx.compose.material3.RichTooltipColors r12 = r12.m3971richTooltipColorsro_MJ88(r13, r15, r17, r19, r21, r22, r23)
        ...
        L_0x020e:
            ...
            int r4 = r4.m7529roundToPx0680j_4(r12)
            r8 = 0
            r12 = r8
            r13 = 0
            r14 = -492369756(0xffffffffe2a708a4, float:-1.5406144E21)
        ...
        L_0x02af:
            ...
            r21 = r33
            r22 = r7
            m3974TooltipBoxXDn_Kpo(r12, r13, r14, r15, r16, r17, r19, r20, r21, r22, r23)
    ...
    public static final void m3974TooltipBoxXDn_Kpo(Function2<? super Composer, ? super Integer, Unit> tooltipContent, PopupPositionProvider tooltipPositionProvider, Modifier modifier, Shape shape, TooltipState tooltipState, long containerColor, float elevation, float maxWidth, Function3<? super TooltipBoxScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        if ((191739611 & $dirty2) != 38347922 || !$composer2.getSkipping()) {
            ...
            String longPressLabel = Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3761getTooltipLongPressLabeladMyvUU(), $composer2, 6);
            $composer2.startReplaceableGroup(-492369756);
            ComposerKt.sourceInformation($composer2, "CC(remember):Composables.kt#9igjgp");
            ...
            if (((Boolean) transition.getCurrentState()).booleanValue() || ((Boolean) transition.getTargetState()).booleanValue()) {
                ...
                TooltipPopup_androidKt.TooltipPopup(popupPositionProvider, new TooltipKt$TooltipBox$1$1(tooltipState2, coroutineScope2), ComposableLambdaKt.composableLambda($composer3, -442150991, true, new TooltipKt$TooltipBox$1$2(modifier, maxWidth, transition, Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3762getTooltipPaneDescriptionadMyvUU(), $composer3, 6), shape, containerColor, elevation, tooltipContent, $dirty2)), $composer3, (($dirty2 >> 3) & 14) | 384);
            } else {
    ...
    public static final void m3973PlainTooltipImplIv8Zu3U(long textColor, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        long j = textColor;
        ...
        if (($dirty & 91) != 18 || !$composer2.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(textColor)), TextKt.getLocalTextStyle().provides(textStyle)}, function2, $composer3, ($dirty & 112) | 8);
            ComposerKt.sourceInformationMarkerEnd($composer3);
            ComposerKt.sourceInformationMarkerEnd($composer$iv);
            $composer2.endReplaceableGroup();
            $composer2.endNode();
    ...
    public static final void RichTooltipImpl(RichTooltipColors colors, Function2<? super Composer, ? super Integer, Unit> text, Function2<? super Composer, ? super Integer, Unit> title, Function2<? super Composer, ? super Integer, Unit> action, Composer $composer, int $changed) {
        ...
        if (($dirty3 & 5851) != 1170 || !$composer3.getSkipping()) {
            ...
            Modifier modifier$iv = PaddingKt.m2250paddingVpY3zN4$default(Modifier.Companion, RichTooltipHorizontalPadding, 0.0f, 2, (Object) null);
            ...
            if (function22 == null) {
                ...
                Modifier modifier$iv2 = AlignmentLineKt.m2105paddingFromBaselineVpY3zN4$default(Modifier.Companion, HeightToSubheadFirstLine, 0.0f, 2, (Object) null);
                ...
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(colors.m3645getTitleContentColor0d7_KjU())), TextKt.getLocalTextStyle().provides(subheadTextStyle)}, (Function2<? super Composer, ? super Integer, Unit>) it, $composer5, 8);
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(colors.m3644getContentColor0d7_KjU())), TextKt.getLocalTextStyle().provides(supportingTextStyle)}, text, $composer6, ($dirty & 112) | 8);
            ...
            if (function23 != null) {
                ...
                Modifier modifier$iv4 = PaddingKt.m2252paddingqDBjuR0$default(SizeKt.m2313requiredHeightInVpY3zN4$default(Modifier.Companion, ActionLabelMinHeight, 0.0f, 2, (Object) null), 0.0f, 0.0f, 0.0f, ActionLabelBottomPadding, 7, (Object) null);
                $composer4.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation($composer4, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                ...
                $composer4.disableReusing();
                Composer $this$Layout_u24lambda_u2d0$iv$iv4 = Updater.m4575constructorimpl($composer4);
                ...
                $composer4.enableReusing();
                skippableUpdate$iv$iv$iv.invoke(SkippableUpdater.m4566boximpl(SkippableUpdater.m4567constructorimpl($composer4)), $composer4, Integer.valueOf(($changed$iv$iv$iv4 >> 3) & 112));
                $composer4.startReplaceableGroup(2058660585);
                ...
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(colors.m3642getActionContentColor0d7_KjU())), TextKt.getLocalTextStyle().provides(actionLabelTextStyle2)}, (Function2<? super Composer, ? super Integer, Unit>) it2, $composer7, 8);
    ...
    private static final Modifier textVerticalPadding(Modifier $this$textVerticalPadding, boolean subheadExists, boolean actionExists) {
        if (subheadExists || actionExists) {
            return PaddingKt.m2252paddingqDBjuR0$default(AlignmentLineKt.m2105paddingFromBaselineVpY3zN4$default($this$textVerticalPadding, HeightFromSubheadToTextFirstLine, 0.0f, 2, (Object) null), 0.0f, 0.0f, 0.0f, TextBottomPadding, 7, (Object) null);
        }
        return PaddingKt.m2250paddingVpY3zN4$default($this$textVerticalPadding, 0.0f, PlainTooltipVerticalPadding, 1, (Object) null);
    }
    ...
    static {
        float r0 = Dp.m7554constructorimpl((float) 4);
        PlainTooltipVerticalPadding = r0;
        float r1 = Dp.m7554constructorimpl((float) 8);
        PlainTooltipHorizontalPadding = r1;
        PlainTooltipContentPadding = PaddingKt.m2242PaddingValuesYgX7TsA(r1, r0);
    }
