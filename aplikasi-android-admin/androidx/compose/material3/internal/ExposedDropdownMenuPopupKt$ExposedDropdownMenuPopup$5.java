...
final class ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$5 extends Lambda implements Function1<LayoutCoordinates, Unit> {
    ...
    public final void invoke(LayoutCoordinates childCoordinates) {
        ...
        this.$popupLayout.setParentBounds(IntRectKt.m7704IntRectVbeCjmY(IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m4713getXimpl(position)), MathKt.roundToInt(Offset.m4714getYimpl(position))), layoutSize));
