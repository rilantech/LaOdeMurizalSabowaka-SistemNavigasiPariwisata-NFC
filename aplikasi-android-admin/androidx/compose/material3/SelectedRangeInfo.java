...
public final class SelectedRangeInfo {
    ...
    public static final class Companion {
        ...
        public final SelectedRangeInfo calculateRangeInfo(CalendarMonth month, CalendarDate startDate, CalendarDate endDate) {
            ...
            return new SelectedRangeInfo(new Pair(IntOffset.m7663boximpl(IntOffsetKt.IntOffset(startGridItemOffset % 7, startGridItemOffset / 7)), IntOffset.m7663boximpl(IntOffsetKt.IntOffset(endGridItemOffset % 7, endGridItemOffset / 7))), firstIsSelectionStart, lastIsSelectionEnd);
        }
    }
}
