...
final class ListItemKt$ListItem$decoratedTrailingContent$1$1 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    ...
    public final void invoke(RowScope $this$null, Composer $composer, int $changed) {
        ...
        if (($dirty & 91) != 18 || !$composer.getSkipping()) {
            ...
            ListItemKt.m3542TrailingContent3IgeMak($this$null, this.$colors.trailingIconColor$material3_release(true, $composer, ((this.$$dirty >> 15) & 112) | 6).getValue().m4973unboximpl(), ListItemType.m3551equalsimpl0(this.$listItemType, ListItemType.Companion.m3558getThreeLineAlXitO8()), this.$it, $composer, $dirty & 14);
            if (ComposerKt.isTraceInProgress()) {
