...
final class AppBarKt$BottomAppBar$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = PaddingKt.padding(SizeKt.m2308height3ABfNKs(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, (Object) null), this.$windowInsets), BottomAppBarTokens.INSTANCE.m4007getContainerHeightD9Ej5fM()), this.$contentPadding);
            Arrangement.Horizontal horizontalArrangement$iv = Arrangement.INSTANCE.getStart();
            Alignment.Vertical verticalAlignment$iv = Alignment.Companion.getCenterVertically();
            Function3 content$iv = this.$content;
            int $changed$iv = ((this.$$dirty >> 9) & 7168) | 432;
