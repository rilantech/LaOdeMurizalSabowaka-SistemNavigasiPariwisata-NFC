...
final class IconButtonKt$FilledTonalIconButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$FilledTonalIconButton$3(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C273@13331L157:IconButton.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 151425855, "C277@13473L9:IconButton.kt#uh7d8r");
