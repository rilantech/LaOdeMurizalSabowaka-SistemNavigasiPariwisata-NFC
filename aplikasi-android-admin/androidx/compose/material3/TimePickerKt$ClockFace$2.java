...
final class TimePickerKt$ClockFace$2 extends Lambda implements Function3<List<? extends Integer>, Composer, Integer, Unit> {
    ...
    public final void invoke(List<Integer> screen, Composer $composer, int $changed) {
        ...
        Modifier access$drawSelector = TimePickerKt.drawSelector(SizeKt.m2322size3ABfNKs(TimePickerKt.clockDial(Modifier.Companion, this.$state, this.$autoSwitchToMinute), TimePickerTokens.INSTANCE.m4472getClockDialContainerSizeD9Ej5fM()), this.$state, this.$colors);
        ...
        TimePickerKt.m3872CircularLayoutuFdPcIQ(access$drawSelector, access$getOuterCircleSizeRadius$p, ComposableLambdaKt.composableLambda($composer, -1385633737, true, new Function2<Composer, Integer, Unit>() {
            ...
            public final void invoke(Composer $composer, int $changed) {
                ...
                if (($changed & 11) != 2 || !$composer.getSkipping()) {
                    ...
                    ProvidedValue[] providedValueArr = {ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(timePickerColors.m3861clockDialContentColorvNxB06k$material3_release(false)))};
                        ...
                        public final void invoke(Composer $composer, int $changed) {
                            ...
                            if (($changed & 11) != 2 || !$composer.getSkipping()) {
                                ...
                                for (int i2 = 0; i2 < size; i2++) {
                                    int it = i2;
                                    if (!timePickerState.is24hour() || Selection.m3666equalsimpl0(timePickerState.m3901getSelectionJiIwxys$material3_release(), Selection.Companion.m3671getMinuteJiIwxys())) {
                                ...
                                if (Selection.m3666equalsimpl0(timePickerState.m3901getSelectionJiIwxys$material3_release(), Selection.Companion.m3670getHourJiIwxys()) && timePickerState.is24hour()) {
                                    Modifier r4 = BackgroundKt.m1876backgroundbw27NRU(SizeKt.m2322size3ABfNKs(LayoutIdKt.layoutId(Modifier.Companion, LayoutId.InnerCircle), TimePickerTokens.INSTANCE.m4472getClockDialContainerSizeD9Ej5fM()), Color.Companion.m4998getTransparent0d7_KjU(), RoundedCornerShapeKt.getCircleShape());
                                    float access$getInnerCircleRadius$p = TimePickerKt.InnerCircleRadius;
                                    final TimePickerState timePickerState2 = timePickerState;
                                    final boolean z2 = z;
                                    final int i3 = i;
                                    TimePickerKt.m3872CircularLayoutuFdPcIQ(r4, access$getInnerCircleRadius$p, ComposableLambdaKt.composableLambda($composer, -448649404, true, new Function2<Composer, Integer, Unit>() {
                                        public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                                            invoke((Composer) p1, ((Number) p2).intValue());
                                            return Unit.INSTANCE;
                                        }
