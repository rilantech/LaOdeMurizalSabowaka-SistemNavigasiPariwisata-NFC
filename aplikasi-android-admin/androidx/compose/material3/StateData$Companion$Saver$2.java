...
final class StateData$Companion$Saver$2 extends Lambda implements Function1<List, StateData> {
    ...
    public final StateData invoke(List<? extends Object> value) {
        ...
        return new StateData((Long) value.get(0), (Long) value.get(1), (Long) value.get(2), intRange, DisplayMode.m3442constructorimpl(((Integer) obj3).intValue()), (DefaultConstructorMarker) null);
    }
}
