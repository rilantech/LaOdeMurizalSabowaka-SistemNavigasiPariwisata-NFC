...
public class FloatingActionButtonElevation {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof FloatingActionButtonElevation) || !Dp.m7559equalsimpl0(this.defaultElevation, ((FloatingActionButtonElevation) other).defaultElevation) || !Dp.m7559equalsimpl0(this.pressedElevation, ((FloatingActionButtonElevation) other).pressedElevation) || !Dp.m7559equalsimpl0(this.focusedElevation, ((FloatingActionButtonElevation) other).focusedElevation) || !Dp.m7559equalsimpl0(this.hoveredElevation, ((FloatingActionButtonElevation) other).hoveredElevation)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((Dp.m7560hashCodeimpl(this.defaultElevation) * 31) + Dp.m7560hashCodeimpl(this.pressedElevation)) * 31) + Dp.m7560hashCodeimpl(this.focusedElevation)) * 31) + Dp.m7560hashCodeimpl(this.hoveredElevation);
    }
}
