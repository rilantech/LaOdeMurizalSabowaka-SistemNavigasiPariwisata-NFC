...
final class NavigationBarKt$NavigationBar$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = SelectableGroupKt.selectableGroup(SizeKt.m2308height3ABfNKs(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, (Object) null), this.$windowInsets), NavigationBarKt.NavigationBarHeight));
            Arrangement.Horizontal horizontalArrangement$iv = Arrangement.INSTANCE.m2132spacedBy0680j_4(NavigationBarKt.getNavigationBarItemHorizontalPadding());
            ...
            MeasurePolicy measurePolicy$iv = RowKt.rowMeasurePolicy(horizontalArrangement$iv, Alignment.Companion.getTop(), composer, (($changed$iv >> 3) & 14) | (($changed$iv >> 3) & 112));
