...
final class ModalBottomSheet_androidKt$modalBottomSheetSwipeable$2 extends Lambda implements Function2<SheetValue, IntSize, Float> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m3570invokeO0kMr_c((SheetValue) p1, ((IntSize) p2).m7718unboximpl());
    }

    /* renamed from: invoke-O0kMr_c  reason: not valid java name */
    public final Float m3570invokeO0kMr_c(SheetValue value, long sheetSize) {
        Intrinsics.checkNotNullParameter(value, "value");
        switch (WhenMappings.$EnumSwitchMapping$0[value.ordinal()]) {
            case 1:
                return Float.valueOf(this.$screenHeight);
            case 2:
                if (((float) IntSize.m7713getHeightimpl(sheetSize)) >= this.$screenHeight / ((float) 2) && !this.$sheetState.getSkipPartiallyExpanded$material3_release()) {
                    return Float.valueOf(this.$screenHeight / 2.0f);
                }
                return null;
            case 3:
                if (IntSize.m7713getHeightimpl(sheetSize) != 0) {
                    return Float.valueOf(Math.max(0.0f, this.$screenHeight - ((float) IntSize.m7713getHeightimpl(sheetSize))));
                }
                return null;
            default:
