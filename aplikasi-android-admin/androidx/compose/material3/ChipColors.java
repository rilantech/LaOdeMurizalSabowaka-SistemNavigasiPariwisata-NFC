...
public final class ChipColors {
    ...
    public final State<Color> containerColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4953boximpl(enabled ? this.containerColor : this.disabledContainerColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> labelColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4953boximpl(enabled ? this.labelColor : this.disabledLabelColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> trailingIconContentColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4953boximpl(enabled ? this.trailingIconContentColor : this.disabledTrailingIconContentColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof ChipColors) || !Color.m4964equalsimpl0(this.containerColor, ((ChipColors) other).containerColor) || !Color.m4964equalsimpl0(this.labelColor, ((ChipColors) other).labelColor) || !Color.m4964equalsimpl0(this.leadingIconContentColor, ((ChipColors) other).leadingIconContentColor) || !Color.m4964equalsimpl0(this.trailingIconContentColor, ((ChipColors) other).trailingIconContentColor) || !Color.m4964equalsimpl0(this.disabledContainerColor, ((ChipColors) other).disabledContainerColor) || !Color.m4964equalsimpl0(this.disabledLabelColor, ((ChipColors) other).disabledLabelColor) || !Color.m4964equalsimpl0(this.disabledLeadingIconContentColor, ((ChipColors) other).disabledLeadingIconContentColor) || !Color.m4964equalsimpl0(this.disabledTrailingIconContentColor, ((ChipColors) other).disabledTrailingIconContentColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((((((Color.m4970hashCodeimpl(this.containerColor) * 31) + Color.m4970hashCodeimpl(this.labelColor)) * 31) + Color.m4970hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m4970hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m4970hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4970hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m4970hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m4970hashCodeimpl(this.disabledTrailingIconContentColor);
    }
}
