...
final class PlainTooltipPositionProvider implements PopupPositionProvider {
    ...
    public PlainTooltipPositionProvider(int tooltipAnchorPadding2) {
    ...
    public long m3617calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        Intrinsics.checkNotNullParameter(anchorBounds, "anchorBounds");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        int x = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m7714getWidthimpl(popupContentSize)) / 2);
