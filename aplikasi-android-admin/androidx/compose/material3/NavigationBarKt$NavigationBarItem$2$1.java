...
final class NavigationBarKt$NavigationBarItem$2$1 extends Lambda implements Function1<IntSize, Unit> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        m3580invokeozmzZPI(((IntSize) p1).m7718unboximpl());
        return Unit.INSTANCE;
    }

    /* renamed from: invoke-ozmzZPI  reason: not valid java name */
    public final void m3580invokeozmzZPI(long it) {
        NavigationBarKt.NavigationBarItem$lambda$4(this.$itemWidth$delegate, IntSize.m7714getWidthimpl(it));
    }
}
