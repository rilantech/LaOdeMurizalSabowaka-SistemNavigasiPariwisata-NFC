...
final class ModalBottomSheet_androidKt$ModalBottomSheet$anchorChangeHandler$1$2 extends Lambda implements Function1<SheetValue, Unit> {
    ...
    ModalBottomSheet_androidKt$ModalBottomSheet$anchorChangeHandler$1$2(SheetState sheetState, CoroutineScope coroutineScope) {
        super(1);
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (sheetState.snapTo$material3_release(target, this) != coroutine_suspended) {
                        break;
                    } else {
