...
final class NavigationBarKt$NavigationBarItem$styledLabel$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            int i = this.$$dirty;
            ProvidedValue[] providedValueArr = {ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(invoke$lambda$0(navigationBarItemColors.textColor$material3_release(z, z2, $composer, ((i >> 18) & 896) | ((i >> 3) & 14) | ((i >> 12) & 112)))))};
    ...
    private static final long invoke$lambda$0(State<Color> $textColor$delegate) {
        return ((Color) $textColor$delegate.getValue()).m4973unboximpl();
    }
}
