...
final class NavigationRailKt$NavigationRailItem$styledIcon$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    private static final long invoke$lambda$0(State<Color> $iconColor$delegate) {
        return ((Color) $iconColor$delegate.getValue()).m4973unboximpl();
    }
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            int i2 = this.$$dirty;
            State iconColor$delegate = navigationRailItemColors.iconColor$material3_release(z, z2, composer, ((i2 >> 15) & 896) | (i2 & 14) | ((i2 >> 9) & 112));
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 540471961, "C176@8051L78:NavigationRail.kt#uh7d8r");
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(invoke$lambda$0(iconColor$delegate)))}, (Function2<? super Composer, ? super Integer, Unit>) function2, $composer2, ((i3 >> 3) & 112) | 8);
