...
final class TextFieldImplKt$CommonDecorationBox$3$borderContainerWithId$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C231@9859L302:TextFieldImpl.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = OutlinedTextFieldKt.m3614outlineCutout12SF9DM(LayoutIdKt.layoutId(Modifier.Companion, TextFieldImplKt.ContainerId), this.$labelSize.getValue().m4787unboximpl(), this.$contentPadding);
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1425717638, "C237@10128L11:TextFieldImpl.kt#uh7d8r");
