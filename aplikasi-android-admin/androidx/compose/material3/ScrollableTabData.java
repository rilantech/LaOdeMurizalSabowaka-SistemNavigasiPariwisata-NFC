...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition $this$calculateTabOffset, Density density, int edgeOffset, List<TabPosition> tabPositions) {
        ...
        int totalTabRowWidth = $this$calculateTabOffset_u24lambda_u241.m7529roundToPx0680j_4(((TabPosition) CollectionsKt.last(tabPositions)).m3810getRightD9Ej5fM()) + edgeOffset;
        int visibleWidth = totalTabRowWidth - this.scrollState.getMaxValue();
        return RangesKt.coerceIn($this$calculateTabOffset_u24lambda_u241.m7529roundToPx0680j_4($this$calculateTabOffset.m3809getLeftD9Ej5fM()) - ((visibleWidth / 2) - ($this$calculateTabOffset_u24lambda_u241.m7529roundToPx0680j_4($this$calculateTabOffset.m3811getWidthD9Ej5fM()) / 2)), 0, RangesKt.coerceAtLeast(totalTabRowWidth - visibleWidth, 0));
    }
}
