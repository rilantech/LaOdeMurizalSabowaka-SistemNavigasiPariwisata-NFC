...
final class AppBarKt$TopAppBarLayout$2$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope $this$layout) {
        ...
        if (Intrinsics.areEqual((Object) horizontal, (Object) Arrangement.INSTANCE.getCenter())) {
            i = (Constraints.m7498getMaxWidthimpl(this.$constraints) - this.$titlePlaceable.getWidth()) / 2;
        } else if (Intrinsics.areEqual((Object) horizontal, (Object) Arrangement.INSTANCE.getEnd())) {
            i = (Constraints.m7498getMaxWidthimpl(this.$constraints) - this.$titlePlaceable.getWidth()) - this.$actionIconsPlaceable.getWidth();
        } else {
            i = Math.max(this.$this_Layout.m7529roundToPx0680j_4(AppBarKt.TopAppBarTitleInset), this.$navigationIconPlaceable.getWidth());
        }
        ...
        Placeable.PlacementScope.placeRelative$default($this$layout, this.$actionIconsPlaceable, Constraints.m7498getMaxWidthimpl(this.$constraints) - this.$actionIconsPlaceable.getWidth(), (this.$layoutHeight - this.$actionIconsPlaceable.getHeight()) / 2, 0.0f, 4, (Object) null);
    }
}
