...
public final class AssistChipDefaults {
    ...
    public final ChipColors m3258assistChipColorsoq7We08(long containerColor, long labelColor, long leadingIconContentColor, long trailingIconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconContentColor, long disabledTrailingIconContentColor, Composer $composer, int $changed, int i) {
        ...
        if ((i2 & 32) != 0) {
            disabledLabelColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledLabelColor2 = disabledLabelColor;
        }
        if ((i2 & 64) != 0) {
            disabledLeadingIconContentColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getDisabledIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
    ...
    public final ChipElevation m3259assistChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float elevation2 = (i & 1) != 0 ? AssistChipTokens.INSTANCE.m4001getFlatContainerElevationD9Ej5fM() : elevation;
        if ((i & 2) != 0) {
        ...
        if ((i & 16) != 0) {
            draggedElevation2 = AssistChipTokens.INSTANCE.m3995getDraggedContainerElevationD9Ej5fM();
        } else {
    ...
    public final ChipBorder m3257assistChipBorderd_3_b6Q(long borderColor, long disabledBorderColor, float borderWidth, Composer $composer, int $changed, int i) {
        ...
        if ((i & 2) != 0) {
            disabledBorderColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getFlatDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledBorderColor2 = disabledBorderColor;
        }
        if ((i & 4) != 0) {
            borderWidth2 = AssistChipTokens.INSTANCE.m4002getFlatOutlineWidthD9Ej5fM();
        } else {
    ...
    public final ChipColors m3260elevatedAssistChipColorsoq7We08(long containerColor, long labelColor, long leadingIconContentColor, long trailingIconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconContentColor, long disabledTrailingIconContentColor, Composer $composer, int $changed, int i) {
        long labelColor2;
        long leadingIconContentColor2;
        long trailingIconContentColor2;
        long disabledContainerColor2;
        ...
        if ((i2 & 16) != 0) {
            disabledContainerColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getElevatedDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i2 & 32) != 0) {
    ...
    public final ChipElevation m3261elevatedAssistChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float pressedElevation2;
        float focusedElevation2;
        float hoveredElevation2;
        float draggedElevation2;
        ...
        float elevation2 = (i & 1) != 0 ? AssistChipTokens.INSTANCE.m3996getElevatedContainerElevationD9Ej5fM() : elevation;
        if ((i & 2) != 0) {
            pressedElevation2 = AssistChipTokens.INSTANCE.m4000getElevatedPressedContainerElevationD9Ej5fM();
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            focusedElevation2 = AssistChipTokens.INSTANCE.m3998getElevatedFocusContainerElevationD9Ej5fM();
        } else {
            focusedElevation2 = focusedElevation;
        }
        if ((i & 8) != 0) {
            hoveredElevation2 = AssistChipTokens.INSTANCE.m3999getElevatedHoverContainerElevationD9Ej5fM();
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        if ((i & 16) != 0) {
        ...
        if ((i & 32) != 0) {
            disabledElevation2 = AssistChipTokens.INSTANCE.m3997getElevatedDisabledContainerElevationD9Ej5fM();
        } else {
            disabledElevation2 = disabledElevation;
        }
        if (ComposerKt.isTraceInProgress()) {
