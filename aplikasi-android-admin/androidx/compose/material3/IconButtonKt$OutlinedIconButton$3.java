...
final class IconButtonKt$OutlinedIconButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$OutlinedIconButton$3(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C461@22666L154:IconButton.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, -369022041, "C465@22805L9:IconButton.kt#uh7d8r");
