...
final class ListItemKt$ListItem$decoratedSupportingContent$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            ListItemKt.m3541ProvideTextStyleFromToken3JVO9M(this.$colors.supportingColor$material3_release($composer, (this.$$dirty >> 18) & 14).getValue().m4973unboximpl(), ListTokens.INSTANCE.getListItemSupportingTextFont(), this.$it, $composer, 48);
            if (ComposerKt.isTraceInProgress()) {
