...
final class AnimatedPaddingValues implements PaddingValues {
    ...
    public float m3249calculateTopPaddingD9Ej5fM() {
        return Dp.m7554constructorimpl(this.topPadding.getValue().m7568unboximpl() * this.animationProgress.getValue().floatValue());
    }

    /* renamed from: calculateBottomPadding-D9Ej5fM  reason: not valid java name */
    public float m3246calculateBottomPaddingD9Ej5fM() {
        return Dp.m7554constructorimpl(SearchBarKt.getSearchBarVerticalPadding() * this.animationProgress.getValue().floatValue());
    }

    /* renamed from: calculateLeftPadding-u2uoSUM  reason: not valid java name */
    public float m3247calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return Dp.m7554constructorimpl((float) 0);
    }

    /* renamed from: calculateRightPadding-u2uoSUM  reason: not valid java name */
    public float m3248calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return Dp.m7554constructorimpl((float) 0);
    }
}
