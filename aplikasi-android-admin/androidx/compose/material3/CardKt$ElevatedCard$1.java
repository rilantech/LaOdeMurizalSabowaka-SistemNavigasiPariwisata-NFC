...
final class CardKt$ElevatedCard$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    CardKt$ElevatedCard$1(Modifier modifier, Shape shape, CardColors cardColors, CardElevation cardElevation, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i, int i2) {
        super(2);
