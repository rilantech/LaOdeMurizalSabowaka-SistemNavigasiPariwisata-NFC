...
final class IconButtonKt$FilledIconToggleButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$FilledIconToggleButton$3(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C332@16224L152:IconButton.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = SizeKt.m2322size3ABfNKs(Modifier.Companion, FilledIconButtonTokens.INSTANCE.m4211getContainerSizeD9Ej5fM());
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1822112071, "C336@16361L9:IconButton.kt#uh7d8r");
