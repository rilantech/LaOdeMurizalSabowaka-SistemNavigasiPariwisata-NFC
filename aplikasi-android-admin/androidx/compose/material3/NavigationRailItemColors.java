...
public final class NavigationRailItemColors {
    ...
    public final State<Color> iconColor$material3_release(boolean selected, boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> r0 = SingleValueAnimationKt.m1782animateColorAsStateeuL9pac(targetValue, AnimationSpecKt.tween$default(150, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, $composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof NavigationRailItemColors) || !Color.m4964equalsimpl0(this.selectedIconColor, ((NavigationRailItemColors) other).selectedIconColor) || !Color.m4964equalsimpl0(this.unselectedIconColor, ((NavigationRailItemColors) other).unselectedIconColor) || !Color.m4964equalsimpl0(this.selectedTextColor, ((NavigationRailItemColors) other).selectedTextColor) || !Color.m4964equalsimpl0(this.unselectedTextColor, ((NavigationRailItemColors) other).unselectedTextColor) || !Color.m4964equalsimpl0(this.selectedIndicatorColor, ((NavigationRailItemColors) other).selectedIndicatorColor) || !Color.m4964equalsimpl0(this.disabledIconColor, ((NavigationRailItemColors) other).disabledIconColor) || !Color.m4964equalsimpl0(this.disabledTextColor, ((NavigationRailItemColors) other).disabledTextColor)) {
            return false;
        }
        return true;
    }
