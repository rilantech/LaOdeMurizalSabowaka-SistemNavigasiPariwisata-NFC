...
public final class ChipBorder {
    ...
    private ChipBorder(long borderColor2, long disabledBorderColor2, float borderWidth2) {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m1904BorderStrokecXLIe8U(this.borderWidth, enabled ? this.borderColor : this.disabledBorderColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof ChipBorder) || !Color.m4964equalsimpl0(this.borderColor, ((ChipBorder) other).borderColor) || !Color.m4964equalsimpl0(this.disabledBorderColor, ((ChipBorder) other).disabledBorderColor) || !Dp.m7559equalsimpl0(this.borderWidth, ((ChipBorder) other).borderWidth)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((Color.m4970hashCodeimpl(this.borderColor) * 31) + Color.m4970hashCodeimpl(this.disabledBorderColor)) * 31) + Dp.m7560hashCodeimpl(this.borderWidth);
    }
}
