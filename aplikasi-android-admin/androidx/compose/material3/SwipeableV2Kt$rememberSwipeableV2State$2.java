...
final class SwipeableV2Kt$rememberSwipeableV2State$2 extends Lambda implements Function0<SwipeableV2State<T>> {
    ...
    public final SwipeableV2State<T> invoke() {
        return new SwipeableV2State(this.$initialValue, this.$animationSpec, this.$confirmValueChange, SwipeableV2Defaults.INSTANCE.getPositionalThreshold(), SwipeableV2Defaults.INSTANCE.m3793getVelocityThresholdD9Ej5fM(), (DefaultConstructorMarker) null);
    }
}
