...
final class BottomSheetScaffoldKt$StandardBottomSheet$2$1 extends Lambda implements Function2<SheetValue, IntSize, Float> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m3276invokeO0kMr_c((SheetValue) p1, ((IntSize) p2).m7718unboximpl());
    }

    /* renamed from: invoke-O0kMr_c  reason: not valid java name */
    public final Float m3276invokeO0kMr_c(SheetValue value, long sheetSize) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[value.ordinal()]) {
            ...
            case 2:
                if (IntSize.m7713getHeightimpl(sheetSize) == MathKt.roundToInt(this.$peekHeightPx)) {
                    return null;
                }
                return Float.valueOf(Float.max(0.0f, this.$layoutHeight - ((float) IntSize.m7713getHeightimpl(sheetSize))));
            case 3:
