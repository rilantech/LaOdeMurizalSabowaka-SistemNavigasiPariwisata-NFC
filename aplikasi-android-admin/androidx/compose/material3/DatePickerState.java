...
public final class DatePickerState {
    ...
    private DatePickerState(Long initialSelectedDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode) {
        this(new StateData(initialSelectedDateMillis, (Long) null, initialDisplayedMonthMillis, yearRange, initialDisplayMode, (DefaultConstructorMarker) null));
    ...
    public final void setSelection(Long dateMillis) {
        this.stateData.setSelection(dateMillis, (Long) null);
    }

    /* renamed from: getDisplayMode-jFl-4v0  reason: not valid java name */
    public final int m3425getDisplayModejFl4v0() {
    ...
    public final void m3426setDisplayModevCnGnXg(int i) {
