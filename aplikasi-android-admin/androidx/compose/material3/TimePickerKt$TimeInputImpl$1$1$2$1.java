...
final class TimePickerKt$TimeInputImpl$1$1$2$1 extends Lambda implements Function1<TextFieldValue, Unit> {
    ...
    public final void invoke(TextFieldValue newValue) {
        ...
        int r1 = Selection.Companion.m3670getHourJiIwxys();
        ...
        TimePickerKt.m3881timeInputOnChangegIWD5Rc(r1, timePickerState, newValue, access$TimeInputImpl$lambda$5, i, new Function1<TextFieldValue, Unit>() {
            public /* bridge */ /* synthetic */ Object invoke(Object p1) {
                invoke((TextFieldValue) p1);
                return Unit.INSTANCE;
            }
