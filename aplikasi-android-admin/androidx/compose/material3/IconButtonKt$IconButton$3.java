...
final class IconButtonKt$IconButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$IconButton$3(Function0<Unit> function0, Modifier modifier, boolean z, IconButtonColors iconButtonColors, MutableInteractionSource mutableInteractionSource, Function2<? super Composer, ? super Integer, Unit> function2, int i, int i2) {
        super(2);
