...
public final class ElevationKt {
    ...
    public static /* synthetic */ Object m3466animateElevationrAjV9yQ$default(Animatable animatable, float f, Interaction interaction, Interaction interaction2, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            interaction = null;
        }
        if ((i & 4) != 0) {
        ...
        return m3465animateElevationrAjV9yQ(animatable, f, interaction, interaction2, continuation);
    }

    /* renamed from: animateElevation-rAjV9yQ  reason: not valid java name */
    public static final Object m3465animateElevationrAjV9yQ(Animatable<Dp, ?> $this$animateElevation_u2drAjV9yQ, float target, Interaction from, Interaction to, Continuation<? super Unit> $completion) {
        AnimationSpec spec;
        if (to != null) {
        ...
        if (spec != null) {
            Object animateTo$default = Animatable.animateTo$default($this$animateElevation_u2drAjV9yQ, Dp.m7552boximpl(target), spec, (Object) null, (Function1) null, $completion, 12, (Object) null);
            if (animateTo$default == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return animateTo$default;
            }
        } else {
            Object snapTo = $this$animateElevation_u2drAjV9yQ.snapTo(Dp.m7552boximpl(target), $completion);
