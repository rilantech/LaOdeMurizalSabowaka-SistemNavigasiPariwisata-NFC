...
final class DefaultDrawerItemsColor implements NavigationDrawerItemColors {
    ...
    public State<Color> iconColor(boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4953boximpl(selected ? this.selectedIconColor : this.unselectedIconColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> textColor(boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4953boximpl(selected ? this.selectedTextColor : this.unselectedTextColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public State<Color> containerColor(boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4953boximpl(selected ? this.selectedContainerColor : this.unselectedContainerColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public State<Color> badgeColor(boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4953boximpl(selected ? this.selectedBadgeColor : this.unselectedBadgeColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DefaultDrawerItemsColor) && Color.m4964equalsimpl0(this.selectedIconColor, ((DefaultDrawerItemsColor) other).selectedIconColor) && Color.m4964equalsimpl0(this.unselectedIconColor, ((DefaultDrawerItemsColor) other).unselectedIconColor) && Color.m4964equalsimpl0(this.selectedTextColor, ((DefaultDrawerItemsColor) other).selectedTextColor) && Color.m4964equalsimpl0(this.unselectedTextColor, ((DefaultDrawerItemsColor) other).unselectedTextColor) && Color.m4964equalsimpl0(this.selectedContainerColor, ((DefaultDrawerItemsColor) other).selectedContainerColor) && Color.m4964equalsimpl0(this.unselectedContainerColor, ((DefaultDrawerItemsColor) other).unselectedContainerColor) && Color.m4964equalsimpl0(this.selectedBadgeColor, ((DefaultDrawerItemsColor) other).selectedBadgeColor) && Color.m4964equalsimpl0(this.unselectedBadgeColor, ((DefaultDrawerItemsColor) other).unselectedBadgeColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((Color.m4970hashCodeimpl(this.selectedIconColor) * 31) + Color.m4970hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m4970hashCodeimpl(this.selectedTextColor)) * 31) + Color.m4970hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m4970hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m4970hashCodeimpl(this.unselectedContainerColor)) * 31) + Color.m4970hashCodeimpl(this.selectedBadgeColor)) * 31) + Color.m4970hashCodeimpl(this.unselectedBadgeColor);
    }
}
