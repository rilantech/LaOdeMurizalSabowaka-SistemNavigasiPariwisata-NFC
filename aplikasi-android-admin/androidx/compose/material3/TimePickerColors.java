...
public final class TimePickerColors {
    ...
    public final long m3866periodSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m3867periodSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m3868timeSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m3869timeSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m3861clockDialContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4964equalsimpl0(this.clockDialColor, ((TimePickerColors) other).clockDialColor) && Color.m4964equalsimpl0(this.selectorColor, ((TimePickerColors) other).selectorColor) && Color.m4964equalsimpl0(this.containerColor, ((TimePickerColors) other).containerColor) && Color.m4964equalsimpl0(this.periodSelectorBorderColor, ((TimePickerColors) other).periodSelectorBorderColor) && Color.m4964equalsimpl0(this.periodSelectorSelectedContainerColor, ((TimePickerColors) other).periodSelectorSelectedContainerColor) && Color.m4964equalsimpl0(this.periodSelectorUnselectedContainerColor, ((TimePickerColors) other).periodSelectorUnselectedContainerColor) && Color.m4964equalsimpl0(this.periodSelectorSelectedContentColor, ((TimePickerColors) other).periodSelectorSelectedContentColor) && Color.m4964equalsimpl0(this.periodSelectorUnselectedContentColor, ((TimePickerColors) other).periodSelectorUnselectedContentColor) && Color.m4964equalsimpl0(this.timeSelectorSelectedContainerColor, ((TimePickerColors) other).timeSelectorSelectedContainerColor) && Color.m4964equalsimpl0(this.timeSelectorUnselectedContainerColor, ((TimePickerColors) other).timeSelectorUnselectedContainerColor) && Color.m4964equalsimpl0(this.timeSelectorSelectedContentColor, ((TimePickerColors) other).timeSelectorSelectedContentColor) && Color.m4964equalsimpl0(this.timeSelectorUnselectedContentColor, ((TimePickerColors) other).timeSelectorUnselectedContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((((Color.m4970hashCodeimpl(this.clockDialColor) * 31) + Color.m4970hashCodeimpl(this.selectorColor)) * 31) + Color.m4970hashCodeimpl(this.containerColor)) * 31) + Color.m4970hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m4970hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m4970hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m4970hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m4970hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m4970hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m4970hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m4970hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m4970hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}
