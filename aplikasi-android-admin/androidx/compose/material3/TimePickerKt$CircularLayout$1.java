...
final class TimePickerKt$CircularLayout$1 implements MeasurePolicy {
    ...
    public final MeasureResult m3882measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        Object obj;
        Object obj2;
        boolean z;
        boolean z2;
        ...
        float radiusPx = measureScope.m7535toPx0680j_4(this.$radius);
        long itemConstraints = Constraints.m7489copyZbe2FdA$default(constraints, 0, 0, 0, 0, 10, (Object) null);
        ...
        for (Measurable measurable : $this$map$iv) {
            destination$iv$iv2.add(measurable.m6399measureBRTryo0(itemConstraints));
        }
        ...
        return MeasureScope.layout$default($this$Layout, Constraints.m7500getMinWidthimpl(constraints), Constraints.m7499getMinHeightimpl(constraints), (Map) null, new TimePickerKt$CircularLayout$1$measure$1(selectorMeasurable != null ? selectorMeasurable.m6399measureBRTryo0(itemConstraints) : null, placeables, innerMeasurable != null ? innerMeasurable.m6399measureBRTryo0(itemConstraints) : null, constraints, radiusPx, 6.2831855f / ((float) placeables.size())), 4, (Object) null);
    }
}
