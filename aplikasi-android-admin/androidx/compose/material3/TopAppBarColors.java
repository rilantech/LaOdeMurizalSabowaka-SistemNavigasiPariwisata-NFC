...
public final class TopAppBarColors {
    ...
    public final long m3979getNavigationIconContentColor0d7_KjU$material3_release() {
    ...
    public final long m3980getTitleContentColor0d7_KjU$material3_release() {
        return this.titleContentColor;
    }

    /* renamed from: getActionIconContentColor-0d7_KjU$material3_release  reason: not valid java name */
    public final long m3978getActionIconContentColor0d7_KjU$material3_release() {
        return this.actionIconContentColor;
    }

    /* renamed from: containerColor-XeAY9LY$material3_release  reason: not valid java name */
    public final long m3977containerColorXeAY9LY$material3_release(float colorTransitionFraction, Composer $composer, int $changed) {
        ...
        long r0 = ColorKt.m5014lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof TopAppBarColors) || !Color.m4964equalsimpl0(this.containerColor, ((TopAppBarColors) other).containerColor) || !Color.m4964equalsimpl0(this.scrolledContainerColor, ((TopAppBarColors) other).scrolledContainerColor) || !Color.m4964equalsimpl0(this.navigationIconContentColor, ((TopAppBarColors) other).navigationIconContentColor) || !Color.m4964equalsimpl0(this.titleContentColor, ((TopAppBarColors) other).titleContentColor) || !Color.m4964equalsimpl0(this.actionIconContentColor, ((TopAppBarColors) other).actionIconContentColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((Color.m4970hashCodeimpl(this.containerColor) * 31) + Color.m4970hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m4970hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m4970hashCodeimpl(this.titleContentColor)) * 31) + Color.m4970hashCodeimpl(this.actionIconContentColor);
    }
}
