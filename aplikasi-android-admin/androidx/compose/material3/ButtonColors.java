...
public final class ButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof ButtonColors) || !Color.m4964equalsimpl0(this.containerColor, ((ButtonColors) other).containerColor) || !Color.m4964equalsimpl0(this.contentColor, ((ButtonColors) other).contentColor) || !Color.m4964equalsimpl0(this.disabledContainerColor, ((ButtonColors) other).disabledContainerColor) || !Color.m4964equalsimpl0(this.disabledContentColor, ((ButtonColors) other).disabledContentColor)) {
            return false;
        }
        return true;
    }
