...
final class ChipKt$InputChip$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    ChipKt$InputChip$2(float f, Shape shape, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C442@22624L148,441@22569L311:Chip.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-352359235, i, -1, "androidx.compose.material3.InputChip.<anonymous> (Chip.kt:440)");
            }
            Modifier modifier = Modifier.Companion;
            Object key1$iv = Float.valueOf(this.$avatarOpacity);
            Object key2$iv = this.$avatarShape;
            ...
            if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
                value$iv$iv = (Function1) new ChipKt$InputChip$2$1$1(f, shape);
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, -1294414151, "C449@22858L8:Chip.kt#uh7d8r");
