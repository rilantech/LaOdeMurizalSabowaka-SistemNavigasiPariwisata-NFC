    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1171460386, $changed, -1, "androidx.compose.material3.TextFieldDefaults.TextFieldDecorationBox.<anonymous> (TextFieldDefaults.kt:1270)");
            }
            ...
            int i3 = this.$$dirty1;
            textFieldDefaults.ContainerBox(z, z2, interactionSource, textFieldColors, shape, $composer, i2 | (i3 & 7168) | ((i3 << 6) & 57344), 0);
            if (ComposerKt.isTraceInProgress()) {
