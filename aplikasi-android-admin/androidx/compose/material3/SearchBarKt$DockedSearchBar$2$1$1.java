...
final class SearchBarKt$DockedSearchBar$2$1$1 extends Lambda implements Function3<AnimatedVisibilityScope, Composer, Integer, Unit> {
    ...
    public final void invoke(AnimatedVisibilityScope $this$AnimatedVisibility, Composer $composer, int $changed) {
        ...
        float screenHeight = Dp.m7554constructorimpl((float) ((Configuration) consume).screenHeightDp);
        Object key1$iv = Dp.m7552boximpl(screenHeight);
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = Dp.m7552boximpl(Dp.m7554constructorimpl(screenHeight * 0.6666667f));
            $this$cache$iv$iv.updateRememberedValue(value$iv$iv);
        } else {
            value$iv$iv = it$iv$iv;
        }
        $composer.endReplaceableGroup();
        float maxHeight = ((Dp) value$iv$iv).m7568unboximpl();
        Object key1$iv2 = Dp.m7552boximpl(maxHeight);
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
        ...
        if (invalid$iv$iv2 || it$iv$iv2 == Composer.Companion.getEmpty()) {
            ...
            value$iv$iv2 = Dp.m7552boximpl(((Dp) RangesKt.coerceAtMost(Dp.m7552boximpl(SearchBarKt.getDockedActiveTableMinHeight()), Dp.m7552boximpl(maxHeight))).m7568unboximpl());
        ...
        $composer.endReplaceableGroup();
        float minHeight = ((Dp) value$iv$iv2).m7568unboximpl();
        Modifier modifier$iv = SizeKt.m2309heightInVpY3zN4(Modifier.Companion, minHeight, maxHeight);
        ...
        DividerKt.m3451Divider9IZ8Weo((Modifier) null, 0.0f, searchBarColors.m3652getDividerColor0d7_KjU(), $composer2, 0, 3);
