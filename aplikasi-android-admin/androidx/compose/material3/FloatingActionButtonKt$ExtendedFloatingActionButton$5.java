...
final class FloatingActionButtonKt$ExtendedFloatingActionButton$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            float startPadding = this.$expanded ? FloatingActionButtonKt.ExtendedFabStartIconPadding : Dp.m7554constructorimpl((float) 0);
            float endPadding = this.$expanded ? FloatingActionButtonKt.ExtendedFabTextPadding : Dp.m7554constructorimpl((float) 0);
            Modifier modifier = Modifier.Companion;
            if (this.$expanded) {
                f = FloatingActionButtonKt.ExtendedFabMinimumWidth;
            } else {
                f = FabPrimaryTokens.INSTANCE.m4167getContainerWidthD9Ej5fM();
            }
            Modifier r3 = PaddingKt.m2252paddingqDBjuR0$default(SizeKt.m2326sizeInqDBjuR0$default(modifier, f, 0.0f, 0.0f, 0.0f, 14, (Object) null), startPadding, 0.0f, endPadding, 0.0f, 10, (Object) null);
