...
public final class BottomAppBarDefaults {
    ...
    private static final float ContainerElevation = BottomAppBarTokens.INSTANCE.m4006getContainerElevationD9Ej5fM();
    private static final PaddingValues ContentPadding = PaddingKt.m2245PaddingValuesa9UjIt4$default(AppBarKt.BottomAppBarHorizontalPadding, AppBarKt.getBottomAppBarVerticalPadding(), AppBarKt.BottomAppBarHorizontalPadding, 0.0f, 8, (Object) null);
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets r0 = WindowInsetsKt.m2351onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, $composer, 8), WindowInsetsSides.m2365plusgK_yJZ4(WindowInsetsSides.Companion.m2375getHorizontalJoeWqyM(), WindowInsetsSides.Companion.m2373getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
