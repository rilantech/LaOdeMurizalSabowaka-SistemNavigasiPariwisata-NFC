...
public final class SwipeableKt {
    ...
    public static /* synthetic */ Modifier m3787swipeablepPrIpRY$default(Modifier modifier, SwipeableState swipeableState, Map map, Orientation orientation, boolean z, boolean z2, MutableInteractionSource mutableInteractionSource, Function2 function2, ResistanceConfig resistanceConfig, float f, int i, Object obj) {
        boolean z3;
        ...
        return m3786swipeablepPrIpRY(modifier, swipeableState, map, orientation, z3, z4, mutableInteractionSource2, function22, (i2 & 128) != 0 ? SwipeableDefaults.resistanceConfig$material3_release$default(SwipeableDefaults.INSTANCE, map.keySet(), 0.0f, 0.0f, 6, (Object) null) : resistanceConfig, (i2 & 256) != 0 ? SwipeableDefaults.INSTANCE.m3785getVelocityThresholdD9Ej5fM$material3_release() : f);
    }

    /* renamed from: swipeable-pPrIpRY  reason: not valid java name */
    public static final <T> Modifier m3786swipeablepPrIpRY(Modifier $this$swipeable_u2dpPrIpRY, SwipeableState<T> state, Map<Float, ? extends T> anchors, Orientation orientation, boolean enabled, boolean reverseDirection, MutableInteractionSource interactionSource, Function2<? super T, ? super T, ? extends ThresholdConfig> thresholds, ResistanceConfig resistance, float velocityThreshold) {
