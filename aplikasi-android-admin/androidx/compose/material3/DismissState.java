...
public final class DismissState {
    ...
    public DismissState(DismissValue initialValue, Function1<? super DismissValue, Boolean> confirmValueChange, Function2<? super Density, ? super Float, Float> positionalThreshold) {
        ...
        this.swipeableState = new SwipeableV2State(initialValue, (AnimationSpec) null, confirmValueChange, positionalThreshold, SwipeToDismissKt.DismissThreshold, 2, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ DismissState(DismissValue dismissValue, Function1 function1, Function2<Density, Float, Float> function2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(dismissValue, (i & 2) != 0 ? AnonymousClass1.INSTANCE : function1, (i & 4) != 0 ? SwipeToDismissDefaults.INSTANCE.getFixedPositionalThreshold() : function2);
    }
    ...
    public final Object snapTo(DismissValue targetValue, Continuation<? super Unit> $completion) {
    ...
    public final Object reset(Continuation<? super Unit> $completion) {
        Object animateTo$default = SwipeableV2State.animateTo$default(this.swipeableState, DismissValue.Default, 0.0f, $completion, 2, (Object) null);
        return animateTo$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo$default : Unit.INSTANCE;
    }

    public final Object dismiss(DismissDirection direction, Continuation<? super Unit> $completion) {
        Object animateTo$default = SwipeableV2State.animateTo$default(this.swipeableState, direction == DismissDirection.StartToEnd ? DismissValue.DismissedToEnd : DismissValue.DismissedToStart, 0.0f, $completion, 2, (Object) null);
        return animateTo$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo$default : Unit.INSTANCE;
    }
    ...
    public static final class Companion {
        ...
        public final Saver<DismissState, DismissValue> Saver(Function1<? super DismissValue, Boolean> confirmValueChange, Function2<? super Density, ? super Float, Float> positionalThreshold) {
            Intrinsics.checkNotNullParameter(confirmValueChange, "confirmValueChange");
            Intrinsics.checkNotNullParameter(positionalThreshold, "positionalThreshold");
