...
final class OnGlobalLayoutListener implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public OnGlobalLayoutListener(View view2, Function0<Unit> onGlobalLayoutCallback2) {
        Intrinsics.checkNotNullParameter(view2, "view");
        Intrinsics.checkNotNullParameter(onGlobalLayoutCallback2, "onGlobalLayoutCallback");
        this.view = view2;
        this.onGlobalLayoutCallback = onGlobalLayoutCallback2;
