...
public final class FilterChipDefaults {
    ...
    public final SelectableChipColors m3491filterChipColorsXqyqHi0(long containerColor, long labelColor, long iconColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconColor, long disabledTrailingIconColor, long selectedContainerColor, long disabledSelectedContainerColor, long selectedLabelColor, long selectedLeadingIconColor, long selectedTrailingIconColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        long containerColor2 = (i2 & 1) != 0 ? Color.Companion.m4998getTransparent0d7_KjU() : containerColor;
        if ((i2 & 2) != 0) {
        ...
        if ((i2 & 16) != 0) {
            disabledLabelColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledLabelColor2 = disabledLabelColor;
        }
        if ((i2 & 32) != 0) {
            disabledLeadingIconColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
        ...
        if ((i2 & 256) != 0) {
            disabledSelectedContainerColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatDisabledSelectedContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
    ...
    public final SelectableChipElevation m3492filterChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float elevation2 = (i & 1) != 0 ? FilterChipTokens.INSTANCE.m4236getFlatContainerElevationD9Ej5fM() : elevation;
        if ((i & 2) != 0) {
            pressedElevation2 = FilterChipTokens.INSTANCE.m4240getFlatSelectedPressedContainerElevationD9Ej5fM();
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            focusedElevation2 = FilterChipTokens.INSTANCE.m4237getFlatSelectedFocusContainerElevationD9Ej5fM();
        } else {
            focusedElevation2 = focusedElevation;
        }
        if ((i & 8) != 0) {
            hoveredElevation2 = FilterChipTokens.INSTANCE.m4238getFlatSelectedHoverContainerElevationD9Ej5fM();
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        if ((i & 16) != 0) {
            draggedElevation2 = FilterChipTokens.INSTANCE.m4230getDraggedContainerElevationD9Ej5fM();
        } else {
    ...
    public final SelectableChipBorder m3490filterChipBordergHcDVlo(long borderColor, long selectedBorderColor, long disabledBorderColor, long disabledSelectedBorderColor, float borderWidth, float selectedBorderWidth, Composer $composer, int $changed, int i) {
        ...
        if ((i & 2) != 0) {
            selectedBorderColor2 = Color.Companion.m4998getTransparent0d7_KjU();
        } else {
            selectedBorderColor2 = selectedBorderColor;
        }
        if ((i & 4) != 0) {
            disabledBorderColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatDisabledUnselectedOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledBorderColor2 = disabledBorderColor;
        }
        if ((i & 8) != 0) {
            disabledSelectedBorderColor2 = Color.Companion.m4998getTransparent0d7_KjU();
        } else {
            disabledSelectedBorderColor2 = disabledSelectedBorderColor;
        }
        if ((i & 16) != 0) {
            borderWidth2 = FilterChipTokens.INSTANCE.m4243getFlatUnselectedOutlineWidthD9Ej5fM();
        } else {
            borderWidth2 = borderWidth;
        }
        if ((i & 32) != 0) {
            selectedBorderWidth2 = FilterChipTokens.INSTANCE.m4239getFlatSelectedOutlineWidthD9Ej5fM();
        } else {
    ...
    public final SelectableChipColors m3488elevatedFilterChipColorsXqyqHi0(long containerColor, long labelColor, long iconColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconColor, long disabledTrailingIconColor, long selectedContainerColor, long disabledSelectedContainerColor, long selectedLabelColor, long selectedLeadingIconColor, long selectedTrailingIconColor, Composer $composer, int $changed, int $changed1, int i) {
        long labelColor2;
        long iconColor2;
        long disabledContainerColor2;
        long disabledLabelColor2;
        ...
        if ((i2 & 8) != 0) {
            disabledContainerColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getElevatedDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i2 & 16) != 0) {
    ...
    public final SelectableChipElevation m3489elevatedFilterChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float pressedElevation2;
        float focusedElevation2;
        float hoveredElevation2;
        float draggedElevation2;
        ...
        float elevation2 = (i & 1) != 0 ? FilterChipTokens.INSTANCE.m4231getElevatedContainerElevationD9Ej5fM() : elevation;
        if ((i & 2) != 0) {
            pressedElevation2 = FilterChipTokens.INSTANCE.m4235getElevatedPressedContainerElevationD9Ej5fM();
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            focusedElevation2 = FilterChipTokens.INSTANCE.m4233getElevatedFocusContainerElevationD9Ej5fM();
        } else {
            focusedElevation2 = focusedElevation;
        }
        if ((i & 8) != 0) {
            hoveredElevation2 = FilterChipTokens.INSTANCE.m4234getElevatedHoverContainerElevationD9Ej5fM();
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        if ((i & 16) != 0) {
        ...
        if ((i & 32) != 0) {
            disabledElevation2 = FilterChipTokens.INSTANCE.m4232getElevatedDisabledContainerElevationD9Ej5fM();
        } else {
            disabledElevation2 = disabledElevation;
        }
        if (ComposerKt.isTraceInProgress()) {
