...
public final class SuggestionChipDefaults {
    ...
    private static final float Height = SuggestionChipTokens.INSTANCE.m4439getContainerHeightD9Ej5fM();
    public static final SuggestionChipDefaults INSTANCE = new SuggestionChipDefaults();
    private static final float IconSize = SuggestionChipTokens.INSTANCE.m4448getLeadingIconSizeD9Ej5fM();

    private SuggestionChipDefaults() {
    }

    /* renamed from: getHeight-D9Ej5fM  reason: not valid java name */
    public final float m3767getHeightD9Ej5fM() {
        return Height;
    }

    /* renamed from: getIconSize-D9Ej5fM  reason: not valid java name */
    public final float m3768getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* renamed from: suggestionChipColors-5tl4gsc  reason: not valid java name */
    public final ChipColors m3770suggestionChipColors5tl4gsc(long containerColor, long labelColor, long iconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledIconContentColor, Composer $composer, int $changed, int i) {
        long labelColor2;
        ...
        if ((i & 16) != 0) {
            disabledLabelColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledLabelColor2 = disabledLabelColor;
        }
        if ((i & 32) != 0) {
            disabledIconContentColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
        ...
        ChipColors chipColors = new ChipColors(containerColor2, labelColor2, iconContentColor2, Color.Companion.m4999getUnspecified0d7_KjU(), disabledContainerColor2, disabledLabelColor2, disabledIconContentColor2, Color.Companion.m4999getUnspecified0d7_KjU(), (DefaultConstructorMarker) null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ChipElevation m3771suggestionChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float elevation2 = (i & 1) != 0 ? SuggestionChipTokens.INSTANCE.m4446getFlatContainerElevationD9Ej5fM() : elevation;
        if ((i & 2) != 0) {
        ...
        if ((i & 16) != 0) {
            draggedElevation2 = SuggestionChipTokens.INSTANCE.m4440getDraggedContainerElevationD9Ej5fM();
        } else {
    ...
    public final ChipBorder m3769suggestionChipBorderd_3_b6Q(long borderColor, long disabledBorderColor, float borderWidth, Composer $composer, int $changed, int i) {
        ...
        if ((i & 2) != 0) {
            disabledBorderColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getFlatDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledBorderColor2 = disabledBorderColor;
        }
        if ((i & 4) != 0) {
            borderWidth2 = SuggestionChipTokens.INSTANCE.m4447getFlatOutlineWidthD9Ej5fM();
        } else {
    ...
    public final ChipColors m3765elevatedSuggestionChipColors5tl4gsc(long containerColor, long labelColor, long iconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledIconContentColor, Composer $composer, int $changed, int i) {
        long labelColor2;
        long iconContentColor2;
        long disabledContainerColor2;
        long disabledLabelColor2;
        ...
        if ((i & 4) != 0) {
            iconContentColor2 = MaterialTheme.INSTANCE.getColorScheme(composer, 6).m3323getOnSurfaceVariant0d7_KjU();
        } else {
            iconContentColor2 = iconContentColor;
        }
        if ((i & 8) != 0) {
            disabledContainerColor2 = Color.m4962copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getElevatedDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i & 16) != 0) {
        ...
        if ((i & 32) != 0) {
            disabledIconContentColor2 = Color.m4962copywmQWz5c$default(MaterialTheme.INSTANCE.getColorScheme(composer, 6).m3322getOnSurface0d7_KjU(), 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            disabledIconContentColor2 = disabledIconContentColor;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ChipElevation m3766elevatedSuggestionChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float pressedElevation2;
        float focusedElevation2;
        float hoveredElevation2;
        float draggedElevation2;
        ...
        float elevation2 = (i & 1) != 0 ? SuggestionChipTokens.INSTANCE.m4441getElevatedContainerElevationD9Ej5fM() : elevation;
        if ((i & 2) != 0) {
            pressedElevation2 = SuggestionChipTokens.INSTANCE.m4445getElevatedPressedContainerElevationD9Ej5fM();
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            focusedElevation2 = SuggestionChipTokens.INSTANCE.m4443getElevatedFocusContainerElevationD9Ej5fM();
        } else {
            focusedElevation2 = focusedElevation;
        }
        if ((i & 8) != 0) {
            hoveredElevation2 = SuggestionChipTokens.INSTANCE.m4444getElevatedHoverContainerElevationD9Ej5fM();
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        if ((i & 16) != 0) {
        ...
        if ((i & 32) != 0) {
            disabledElevation2 = SuggestionChipTokens.INSTANCE.m4442getElevatedDisabledContainerElevationD9Ej5fM();
        } else {
            disabledElevation2 = disabledElevation;
        }
        if (ComposerKt.isTraceInProgress()) {
