...
public final class SwipeableV2Defaults {
    ...
    private static final Function2<Density, Float, Float> PositionalThreshold = SwipeableV2Kt.m3794fixedPositionalThreshold0680j_4(Dp.m7554constructorimpl((float) 56));
    private static final float VelocityThreshold = Dp.m7554constructorimpl((float) 125);
    ...
    public static /* synthetic */ void m3792getVelocityThresholdD9Ej5fM$annotations() {
    }
    ...
    public final float m3793getVelocityThresholdD9Ej5fM() {
    ...
    public final <T> AnchorChangeHandler<T> ReconcileAnimationOnAnchorChangeHandler$material3_release(SwipeableV2State<T> state, Function2<? super T, ? super Float, Unit> animate, Function1<? super T, Unit> snap) {
        Intrinsics.checkNotNullParameter(state, "state");
        Intrinsics.checkNotNullParameter(animate, "animate");
        Intrinsics.checkNotNullParameter(snap, "snap");
        return new SwipeableV2Defaults$ReconcileAnimationOnAnchorChangeHandler$1(animate, state, snap);
    }
}
