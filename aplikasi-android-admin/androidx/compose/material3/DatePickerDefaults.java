...
public final class DatePickerDefaults {
    ...
    private static final float TonalElevation = DatePickerModalTokens.INSTANCE.m4093getContainerElevationD9Ej5fM();
    ...
    public final DatePickerColors m3416colors1m2CgY(long containerColor, long titleContentColor, long headlineContentColor, long weekdayContentColor, long subheadContentColor, long yearContentColor, long currentYearContentColor, long selectedYearContentColor, long selectedYearContainerColor, long dayContentColor, long disabledDayContentColor, long selectedDayContentColor, long disabledSelectedDayContentColor, long selectedDayContainerColor, long disabledSelectedDayContainerColor, long todayContentColor, long todayDateBorderColor, long dayInSelectionRangeContentColor, long dayInSelectionRangeContainerColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        if ((i2 & 1024) != 0) {
            disabledDayContentColor2 = Color.m4962copywmQWz5c$default(dayContentColor2, 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
        ...
        if ((i2 & 4096) != 0) {
            disabledSelectedDayContentColor2 = Color.m4962copywmQWz5c$default(selectedDayContentColor2, 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
        ...
        if ((i2 & 16384) != 0) {
            disabledSelectedDayContainerColor2 = Color.m4962copywmQWz5c$default(selectedDayContainerColor2, 0.38f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
    ...
    public final void DatePickerTitle(DatePickerState state, Modifier modifier, Composer $composer, int $changed, int i) {
        ...
        if (($dirty2 & 91) != 18 || !$composer2.getSkipping()) {
            ...
            if (DisplayMode.m3444equalsimpl0(r0, DisplayMode.Companion.m3449getPickerjFl4v0())) {
                ...
                TextKt.m3858Text4IGK_g(Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3727getDatePickerTitleadMyvUU(), $composer2, 6), modifier4, 0, 0, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0, (TextDecoration) null, (TextAlign) null, 0, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer2, $dirty2 & 112, 0, 131068);
                ...
                TextKt.m3858Text4IGK_g(Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3714getDateInputTitleadMyvUU(), $composer2, 6), modifier4, 0, 0, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0, (TextDecoration) null, (TextAlign) null, 0, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer2, $dirty2 & 112, 0, 131068);
                $composer2.endReplaceableGroup();
            } else {
    ...
    public final void DatePickerHeadline(DatePickerState state, DatePickerFormatter dateFormatter, Modifier modifier, Composer $composer, int $changed, int i) {
        ...
        if (($dirty2 & 731) != 146 || !$composer3.getSkipping()) {
            ...
            if (verboseDateDescription == null) {
                int r1 = $this$DatePickerHeadline_u24lambda_u241.getDisplayMode().getValue().m3447unboximpl();
                if (DisplayMode.m3444equalsimpl0(r1, DisplayMode.Companion.m3449getPickerjFl4v0())) {
                    $composer3.startReplaceableGroup(933108990);
                    ComposerKt.sourceInformation($composer3, "460@21322L51");
                    verboseDateDescription = Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3718getDatePickerNoSelectionDescriptionadMyvUU(), $composer3, 6);
                    $composer3.endReplaceableGroup();
                } else if (DisplayMode.m3444equalsimpl0(r1, DisplayMode.Companion.m3448getInputjFl4v0())) {
                    $composer3.startReplaceableGroup(933109079);
                    ComposerKt.sourceInformation($composer3, "461@21411L46");
                    verboseDateDescription = Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3713getDateInputNoInputDescriptionadMyvUU(), $composer3, 6);
                    $composer3.endReplaceableGroup();
                } else {
            ...
            if (formattedDate == null) {
                int r5 = $this$DatePickerHeadline_u24lambda_u241.getDisplayMode().getValue().m3447unboximpl();
                if (DisplayMode.m3444equalsimpl0(r5, DisplayMode.Companion.m3449getPickerjFl4v0())) {
                    $composer3.startReplaceableGroup(933109281);
                    ComposerKt.sourceInformation($composer3, "466@21613L37");
                    String r52 = Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3715getDatePickerHeadlineadMyvUU(), $composer3, 6);
                    $composer3.endReplaceableGroup();
                    headlineText = r52;
                } else if (DisplayMode.m3444equalsimpl0(r5, DisplayMode.Companion.m3448getInputjFl4v0())) {
                    $composer3.startReplaceableGroup(933109356);
                    ComposerKt.sourceInformation($composer3, "467@21688L36");
                    String r53 = Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3707getDateInputHeadlineadMyvUU(), $composer3, 6);
                    $composer3.endReplaceableGroup();
                    headlineText = r53;
                } else {
            ...
            $composer3.endReplaceableGroup();
            int r54 = $this$DatePickerHeadline_u24lambda_u241.getDisplayMode().getValue().m3447unboximpl();
            if (DisplayMode.m3444equalsimpl0(r54, DisplayMode.Companion.m3449getPickerjFl4v0())) {
                $composer3.startReplaceableGroup(933109538);
                ComposerKt.sourceInformation($composer3, "472@21870L48");
                str = Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3716getDatePickerHeadlineDescriptionadMyvUU(), $composer3, 6);
                $composer3.endReplaceableGroup();
            } else if (DisplayMode.m3444equalsimpl0(r54, DisplayMode.Companion.m3448getInputjFl4v0())) {
                $composer3.startReplaceableGroup(933109624);
                ComposerKt.sourceInformation($composer3, "473@21956L47");
                str = Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3708getDateInputHeadlineDescriptionadMyvUU(), $composer3, 6);
                $composer3.endReplaceableGroup();
            } else {
            ...
            $composer2 = $composer3;
            int i4 = $dirty2;
            TextKt.m3858Text4IGK_g(headlineText, semantics$default, 0, 0, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0, (TextDecoration) null, (TextAlign) null, 0, 0, false, 1, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer2, 0, 3072, 122876);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier3 = modifier5;
    ...
    public final float m3417getTonalElevationD9Ej5fM() {
