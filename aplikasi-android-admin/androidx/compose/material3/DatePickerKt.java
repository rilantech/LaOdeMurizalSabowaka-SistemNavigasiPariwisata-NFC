...
public final class DatePickerKt {
    ...
    public static final PaddingValues DatePickerHeadlinePadding = PaddingKt.m2245PaddingValuesa9UjIt4$default(Dp.m7554constructorimpl((float) 24), 0.0f, Dp.m7554constructorimpl((float) 12), Dp.m7554constructorimpl((float) 12), 2, (Object) null);
    private static final float DatePickerHorizontalPadding = Dp.m7554constructorimpl((float) 12);
    private static final PaddingValues DatePickerModeTogglePadding = PaddingKt.m2245PaddingValuesa9UjIt4$default(0.0f, 0.0f, Dp.m7554constructorimpl((float) 12), Dp.m7554constructorimpl((float) 12), 3, (Object) null);
    /* access modifiers changed from: private */
    public static final PaddingValues DatePickerTitlePadding = PaddingKt.m2245PaddingValuesa9UjIt4$default(Dp.m7554constructorimpl((float) 24), Dp.m7554constructorimpl((float) 16), Dp.m7554constructorimpl((float) 12), 0.0f, 8, (Object) null);
    private static final int MaxCalendarRows = 6;
    private static final float MonthYearHeight = Dp.m7554constructorimpl((float) 56);
    private static final float RecommendedSizeForAccessibility = Dp.m7554constructorimpl((float) 48);
    private static final int YearsInRow = 3;
    /* access modifiers changed from: private */
    public static final float YearsVerticalPadding = Dp.m7554constructorimpl((float) 16);
    ...
    public static final void DatePicker(DatePickerState state, Modifier modifier, DatePickerFormatter dateFormatter, Function1<? super Long, Boolean> dateValidator, Function2<? super Composer, ? super Integer, Unit> title, Function2<? super Composer, ? super Integer, Unit> headline, boolean showModeToggle, DatePickerColors colors, Composer $composer, int $changed, int i) {
        ...
        if (($dirty & 23967451) != 4793490 || !$composer2.getSkipping()) {
            ...
            m3419DateEntryContainerau3_HiA(modifier2, title3, headline3, function23, colors3, TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer2, 6), DatePickerModalTokens.INSTANCE.getHeaderHeadlineFont()), DatePickerModalTokens.INSTANCE.m4101getHeaderContainerHeightD9Ej5fM(), ComposableLambdaKt.composableLambda($composer2, 173769747, z, new DatePickerKt$DatePicker$6(state, dateFormatter2, dateValidator2, colors3, $dirty)), $composer2, (($dirty >> 3) & 14) | 14155776 | (($dirty >> 9) & 112) | (($dirty >> 9) & 896) | (($dirty >> 9) & 57344));
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final DatePickerState m3422rememberDatePickerStateNVmSL94(Long initialSelectedDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode, Composer $composer, int $changed, int i) {
    ...
    public static final void m3419DateEntryContainerau3_HiA(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> title, Function2<? super Composer, ? super Integer, Unit> headline, Function2<? super Composer, ? super Integer, Unit> modeToggleButton, DatePickerColors colors, TextStyle headlineTextStyle, float headerMinHeight, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        if ((23967451 & $dirty2) != 4793490 || !$composer2.getSkipping()) {
            ...
            int $dirty3 = $dirty2;
            Modifier modifier$iv = SemanticsModifierKt.semantics$default(SizeKt.m2326sizeInqDBjuR0$default(modifier, DatePickerModalTokens.INSTANCE.m4095getContainerWidthD9Ej5fM(), 0.0f, 0.0f, 0.0f, 14, (Object) null), false, DatePickerKt$DateEntryContainer$1.INSTANCE, 1, (Object) null);
            ...
            long r23 = colors.m3413getTitleContentColor0d7_KjU$material3_release();
            long r39 = colors.m3411getHeadlineContentColor0d7_KjU$material3_release();
            ...
            m3420DatePickerHeaderpc5RIQQ(Modifier.Companion, title, r23, r39, headerMinHeight, ComposableLambdaKt.composableLambda($composer4, -229007058, true, datePickerKt$DateEntryContainer$2$1), $composer4, ($dirty3 & 112) | 196614 | (($dirty3 >> 6) & 57344));
    ...
    public static final void m3421DisplayModeToggleButtontER2X8s(Modifier modifier, int displayMode, Function1<? super DisplayMode, Unit> onDisplayModeChange, Composer $composer, int $changed) {
        Object value$iv$iv;
        Object value$iv$iv2;
        ...
        if (($dirty2 & 731) != 146 || !$composer2.getSkipping()) {
            ...
            if (DisplayMode.m3444equalsimpl0(displayMode, DisplayMode.Companion.m3449getPickerjFl4v0())) {
                ...
                $composer2.endReplaceableGroup();
                IconButtonKt.IconButton((Function0) value$iv$iv2, modifier, false, (IconButtonColors) null, (MutableInteractionSource) null, ComposableSingletons$DatePickerKt.INSTANCE.m3389getLambda1$material3_release(), $composer2, (($dirty2 << 3) & 112) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 28);
                $composer2.endReplaceableGroup();
            } else {
                ...
                $composer2.endReplaceableGroup();
                IconButtonKt.IconButton((Function0) value$iv$iv, modifier, false, (IconButtonColors) null, (MutableInteractionSource) null, ComposableSingletons$DatePickerKt.INSTANCE.m3390getLambda2$material3_release(), $composer2, (($dirty2 << 3) & 112) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 28);
                $composer2.endReplaceableGroup();
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
    ...
    public static final void SwitchableDateEntryContent(DatePickerState state, DatePickerFormatter dateFormatter, Function1<? super Long, Boolean> dateValidator, DatePickerColors colors, Composer $composer, int $changed) {
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            int r0 = state.m3425getDisplayModejFl4v0();
    ...
    public static final void DatePickerContent(androidx.compose.material3.StateData r84, androidx.compose.material3.DatePickerFormatter r85, kotlin.jvm.functions.Function1<? super java.lang.Long, java.lang.Boolean> r86, androidx.compose.material3.DatePickerColors r87, androidx.compose.runtime.Composer r88, int r89) {
        ...
        L_0x021d:
            r12.disableReusing()
            androidx.compose.runtime.Composer r15 = androidx.compose.runtime.Updater.m4575constructorimpl(r12)
            r33 = 0
            ...
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r15, r3, r4)
            androidx.compose.ui.node.ComposeUiNode$Companion r4 = androidx.compose.ui.node.ComposeUiNode.Companion
            kotlin.jvm.functions.Function2 r4 = r4.getSetDensity()
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r15, r8, r4)
            androidx.compose.ui.node.ComposeUiNode$Companion r4 = androidx.compose.ui.node.ComposeUiNode.Companion
            kotlin.jvm.functions.Function2 r4 = r4.getSetLayoutDirection()
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r15, r11, r4)
            androidx.compose.ui.node.ComposeUiNode$Companion r4 = androidx.compose.ui.node.ComposeUiNode.Companion
            kotlin.jvm.functions.Function2 r4 = r4.getSetViewConfiguration()
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r15, r14, r4)
            r12.enableReusing()
            ...
            r56 = r12
            r12 = 2
            androidx.compose.ui.Modifier r40 = androidx.compose.foundation.layout.PaddingKt.m2250paddingVpY3zN4$default(r4, r10, r14, r12, r15)
        ...
        L_0x03fc:
            ...
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r15, r6, r0)
            androidx.compose.ui.node.ComposeUiNode$Companion r0 = androidx.compose.ui.node.ComposeUiNode.Companion
            kotlin.jvm.functions.Function2 r0 = r0.getSetDensity()
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r15, r4, r0)
            androidx.compose.ui.node.ComposeUiNode$Companion r0 = androidx.compose.ui.node.ComposeUiNode.Companion
            kotlin.jvm.functions.Function2 r0 = r0.getSetLayoutDirection()
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r15, r7, r0)
            androidx.compose.ui.node.ComposeUiNode$Companion r0 = androidx.compose.ui.node.ComposeUiNode.Companion
            kotlin.jvm.functions.Function2 r0 = r0.getSetViewConfiguration()
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r15, r9, r0)
            r11.enableReusing()
            androidx.compose.runtime.Composer r0 = androidx.compose.runtime.SkippableUpdater.m4567constructorimpl(r11)
            ...
            r7 = 2
            r9 = 0
            androidx.compose.ui.Modifier r10 = androidx.compose.foundation.layout.PaddingKt.m2250paddingVpY3zN4$default(r0, r10, r4, r7, r9)
            r9 = 6
            r62 = 0
        ...
        L_0x0540:
            ...
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r12, r2, r0)
            androidx.compose.ui.node.ComposeUiNode$Companion r0 = androidx.compose.ui.node.ComposeUiNode.Companion
            kotlin.jvm.functions.Function2 r0 = r0.getSetDensity()
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r12, r1, r0)
            androidx.compose.ui.node.ComposeUiNode$Companion r0 = androidx.compose.ui.node.ComposeUiNode.Companion
            kotlin.jvm.functions.Function2 r0 = r0.getSetLayoutDirection()
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r12, r4, r0)
            androidx.compose.ui.node.ComposeUiNode$Companion r0 = androidx.compose.ui.node.ComposeUiNode.Companion
            kotlin.jvm.functions.Function2 r0 = r0.getSetViewConfiguration()
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r12, r7, r0)
            r6.enableReusing()
    ...
    public static final void m3420DatePickerHeaderpc5RIQQ(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> title, long titleContentColor, long headlineContentColor, float minHeight, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        if ((374491 & $dirty2) != 74898 || !$composer2.getSkipping()) {
            ...
            if (function2 != null) {
                heightModifier = SizeKt.m2307defaultMinSizeVpY3zN4$default(Modifier.Companion, 0.0f, f, 1, (Object) null);
            } else {
            ...
            if (function2 != null) {
                MeasurePolicy measurePolicy = measurePolicy$iv;
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(titleContentColor))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer3, 1005061498, true, new DatePickerKt$DatePickerHeader$1$1(function2, $dirty2)), $composer3, 56);
            }
            $composer3.endReplaceableGroup();
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(headlineContentColor))}, function22, $composer3, (($dirty2 >> 12) & 112) | 8);
    ...
    public static final void WeekDays(DatePickerColors colors, CalendarModel calendarModel, Composer $composer, int $changed) {
        ...
        if (($dirty & 91) != 18 || !$composer2.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(colors.m3415getWeekdayContentColor0d7_KjU$material3_release()))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer2, -1445541615, true, new DatePickerKt$WeekDays$1(dayNames)), $composer2, 56);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final String dayContentDescription(boolean rangeSelectionEnabled, boolean isToday, boolean isStartDate, boolean isEndDate, boolean isInRange, Composer $composer, int $changed) {
        ...
        if (rangeSelectionEnabled) {
            if (isStartDate) {
                ...
                descriptionBuilder.append(Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3736getDateRangePickerStartHeadlineadMyvUU(), $composer, 6));
                $composer.endReplaceableGroup();
            } else if (isEndDate) {
                $composer.startReplaceableGroup(-852203980);
                ComposerKt.sourceInformation($composer, "1553@64360L54");
                descriptionBuilder.append(Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3733getDateRangePickerEndHeadlineadMyvUU(), $composer, 6));
                $composer.endReplaceableGroup();
            } else if (isInRange) {
                $composer.startReplaceableGroup(-852203842);
                ComposerKt.sourceInformation($composer, "1557@64498L53");
                descriptionBuilder.append(Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3732getDateRangePickerDayInRangeadMyvUU(), $composer, 6));
                $composer.endReplaceableGroup();
            } else {
        ...
        if (isToday) {
            ...
            descriptionBuilder.append(Strings_androidKt.m3763getStringNWtq28(Strings.Companion.m3728getDatePickerTodayDescriptionadMyvUU(), $composer, 6));
        }
        if (descriptionBuilder.length() != 0) {
            z = false;
        }
    ...
    public static final void Day(androidx.compose.ui.Modifier r27, boolean r28, kotlin.jvm.functions.Function0<kotlin.Unit> r29, boolean r30, boolean r31, boolean r32, boolean r33, java.lang.String r34, androidx.compose.material3.DatePickerColors r35, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, androidx.compose.runtime.Composer r37, int r38) {
        ...
        L_0x0104:
            ...
            float r1 = r1.m4099getDateStateLayerWidthD9Ej5fM()
            ...
            float r6 = r6.m4098getDateStateLayerHeightD9Ej5fM()
            androidx.compose.ui.Modifier r0 = androidx.compose.foundation.layout.SizeKt.m2316requiredSizeVpY3zN4(r0, r1, r6)
            int r1 = r2 >> 21
            r1 = r1 & 14
            r6 = 0
            r16 = r1
        ...
        L_0x0163:
            ...
            androidx.compose.material3.tokens.DatePickerModalTokens r0 = androidx.compose.material3.tokens.DatePickerModalTokens.INSTANCE
            float r0 = r0.m4100getDateTodayContainerOutlineWidthD9Ej5fM()
            long r1 = r35.m3414getTodayDateBorderColor0d7_KjU$material3_release()
        ...
        L_0x01fe:
            ...
            r11 = r24
            r14 = r25
            androidx.compose.material3.SurfaceKt.m3773Surfaced85dljk((boolean) r0, (kotlin.jvm.functions.Function0<kotlin.Unit>) r1, (androidx.compose.ui.Modifier) r2, (boolean) r3, (androidx.compose.ui.graphics.Shape) r4, (long) r5, (long) r7, (float) r9, (float) r10, (androidx.compose.foundation.BorderStroke) r11, (androidx.compose.foundation.interaction.MutableInteractionSource) r12, (kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit>) r13, (androidx.compose.runtime.Composer) r14, (int) r15, (int) r16, (int) r17)
            boolean r0 = androidx.compose.runtime.ComposerKt.isTraceInProgress()
    ...
    public static final void Year(androidx.compose.ui.Modifier r28, boolean r29, boolean r30, kotlin.jvm.functions.Function0<kotlin.Unit> r31, java.lang.String r32, androidx.compose.material3.DatePickerColors r33, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r34, androidx.compose.runtime.Composer r35, int r36) {
        ...
        L_0x00f6:
            ...
            r19 = r0
            float r0 = r18.m4100getDateTodayContainerOutlineWidthD9Ej5fM()
            r18 = r10
            long r10 = r33.m3414getTodayDateBorderColor0d7_KjU$material3_release()
            androidx.compose.foundation.BorderStroke r0 = androidx.compose.foundation.BorderStrokeKt.m1904BorderStrokecXLIe8U(r0, r10)
            goto L_0x0113
        L_0x010e:
            r19 = r0
            r18 = r10
        ...
        L_0x015d:
            ...
            r21 = r0
            r24 = r2
            androidx.compose.material3.SurfaceKt.m3773Surfaced85dljk((boolean) r10, (kotlin.jvm.functions.Function0<kotlin.Unit>) r11, (androidx.compose.ui.Modifier) r12, (boolean) r13, (androidx.compose.ui.graphics.Shape) r14, (long) r15, (long) r17, (float) r19, (float) r20, (androidx.compose.foundation.BorderStroke) r21, (androidx.compose.foundation.interaction.MutableInteractionSource) r22, (kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit>) r23, (androidx.compose.runtime.Composer) r24, (int) r25, (int) r26, (int) r27)
    ...
    public static final void MonthsNavigation(Modifier modifier, boolean nextAvailable, boolean previousAvailable, boolean yearPickerVisible, String yearPickerText, Function0<Unit> onNextClicked, Function0<Unit> onPreviousClicked, Function0<Unit> onYearPickerButtonClicked, Composer $composer, int $changed) {
        ...
        if ((23967451 & $dirty3) != 4793490 || !$composer2.getSkipping()) {
            ...
            Modifier r0 = SizeKt.m2311requiredHeight3ABfNKs(SizeKt.fillMaxWidth$default(modifier2, 0.0f, 1, (Object) null), MonthYearHeight);
            if (z) {
            ...
            LayoutDirection layoutDirection = layoutDirection$iv$iv;
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3 = materializerOf;
            function3.invoke(SkippableUpdater.m4566boximpl(SkippableUpdater.m4567constructorimpl($composer2)), $composer2, Integer.valueOf(($changed$iv$iv$iv >> 3) & 112));
            $composer2.startReplaceableGroup(2058660585);
            int i2 = ($changed$iv$iv$iv >> 9) & 14;
            Composer $composer3 = $composer2;
