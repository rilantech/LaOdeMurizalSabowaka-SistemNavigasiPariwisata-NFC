    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            if (function2 != null) {
                ...
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(j))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer2, 934657765, true, new AlertDialogKt$AlertDialogContent$1$1$1$1($this$invoke_u24lambda_u244, function2, i2)), $composer2, 56);
            }
            ...
            if (function22 != null) {
                ...
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(j2))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer2, 1845262876, true, new AlertDialogKt$AlertDialogContent$1$1$2$1($this$invoke_u24lambda_u244, function2, function22, i2)), $composer2, 56);
            }
            $composer2.endReplaceableGroup();
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(j5))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer3, -433542216, true, new AlertDialogKt$AlertDialogContent$1$1$4$1(function25, i2)), $composer3, 56);
