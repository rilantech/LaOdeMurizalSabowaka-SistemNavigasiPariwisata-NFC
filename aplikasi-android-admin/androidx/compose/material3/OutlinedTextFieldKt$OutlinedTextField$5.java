...
final class OutlinedTextFieldKt$OutlinedTextField$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C349@19050L20,330@18219L2342:OutlinedTextField.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            if (this.$label != null) {
                modifier = PaddingKt.m2252paddingqDBjuR0$default(SemanticsModifierKt.semantics(this.$modifier, true, AnonymousClass1.INSTANCE), 0.0f, OutlinedTextFieldKt.getOutlinedTextFieldTopPadding(), 0.0f, 0.0f, 13, (Object) null);
            } else {
                modifier = this.$modifier;
            }
            Modifier r3 = SizeKt.m2306defaultMinSizeVpY3zN4(modifier, OutlinedTextFieldDefaults.INSTANCE.m3608getMinWidthD9Ej5fM(), OutlinedTextFieldDefaults.INSTANCE.m3607getMinHeightD9Ej5fM());
            SolidColor solidColor = new SolidColor(this.$colors.cursorColor$material3_release(this.$isError, composer, ((this.$$dirty1 >> 9) & 14) | ((this.$$dirty2 >> 3) & 112)).getValue().m4973unboximpl(), (DefaultConstructorMarker) null);
            TextFieldValue textFieldValue = this.$value;
            TextFieldValue textFieldValue2 = textFieldValue;
            Function1<TextFieldValue, Unit> function1 = this.$onValueChange;
            final TextFieldValue textFieldValue3 = this.$value;
            ...
            BasicTextFieldKt.BasicTextField(textFieldValue4, (Function1<? super TextFieldValue, Unit>) function12, modifier2, this.$enabled, this.$readOnly, this.$mergedTextStyle, this.$keyboardOptions, this.$keyboardActions, this.$singleLine, this.$maxLines, this.$minLines, this.$visualTransformation, (Function1<? super TextLayoutResult, Unit>) null, this.$interactionSource, (Brush) solidColor, (Function3<? super Function2<? super Composer, ? super Integer, Unit>, ? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composer, -757328870, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() {
                ...
                public final void invoke(Function2<? super Composer, ? super Integer, Unit> innerTextField, Composer $composer, int $changed) {
                    ...
                    ComposerKt.sourceInformation(composer, "C358@19486L1051:OutlinedTextField.kt#uh7d8r");
                    int $dirty = $changed;
                    if (($changed & 14) == 0) {
                    ...
                    if (($dirty2 & 91) != 18 || !$composer.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-757328870, $dirty2, -1, "androidx.compose.material3.OutlinedTextField.<anonymous>.<anonymous> (OutlinedTextField.kt:357)");
                        }
                        ...
                        int i5 = i3;
                        int i6 = i4;
                        int i7 = (($dirty2 << 3) & 112) | ((i4 >> 3) & 896) | ((i5 >> 12) & 7168) | (i5 & 57344) | ((i6 << 15) & 458752) | ((i5 << 9) & 3670016) | ((i4 << 3) & 29360128) | ((i4 << 3) & 234881024) | ((i4 << 3) & 1879048192);
                        ...
                        String str2 = str;
                        outlinedTextFieldDefaults2.DecorationBox(str2, innerTextField, z5, z7, visualTransformation2, interactionSource, z8, function22, function23, function23, function24, function25, function26, function27, textFieldColors, (PaddingValues) null, ComposableLambdaKt.composableLambda(composer, 255570733, true, new Function2<Composer, Integer, Unit>() {
                            public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                                invoke((Composer) p1, ((Number) p2).intValue());
                                return Unit.INSTANCE;
                            }
                            ...
                            public final void invoke(Composer $composer, int $changed) {
                                ...
                                if ((i & 11) != 2 || !$composer.getSkipping()) {
                                    ...
                                    int i3 = i3;
                                    OutlinedTextFieldDefaults.INSTANCE.m3603ContainerBoxnbWgWpA(z9, z10, mutableInteractionSource2, textFieldColors, shape, 0.0f, 0.0f, $composer, i2 | ((i3 << 6) & 896) | ((i3 << 3) & 7168) | ((i3 << 9) & 57344), 96);
                                    if (ComposerKt.isTraceInProgress()) {
