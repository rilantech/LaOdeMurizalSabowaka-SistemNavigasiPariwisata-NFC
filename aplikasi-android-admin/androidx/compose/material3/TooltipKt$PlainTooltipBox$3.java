...
final class TooltipKt$PlainTooltipBox$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        TooltipKt.m3972PlainTooltipBoxnBX6wN0(this.$tooltip, this.$modifier, this.$tooltipState, this.$shape, this.$containerColor, this.$contentColor, this.$content, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), this.$$default);
    }
}
