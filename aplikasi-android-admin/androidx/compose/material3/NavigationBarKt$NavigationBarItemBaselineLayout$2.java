...
final class NavigationBarKt$NavigationBarItemBaselineLayout$2 implements MeasurePolicy {
    ...
    public final MeasureResult m3581measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        ...
        for (Object element$iv2 : $this$first$iv) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv2), (Object) "icon")) {
                ...
                int totalIndicatorWidth2 = iconPlaceable.getWidth() + measureScope.m7529roundToPx0680j_4(Dp.m7554constructorimpl(((float) 2) * NavigationBarKt.IndicatorHorizontalPadding));
                int animatedIndicatorWidth = MathKt.roundToInt(((float) totalIndicatorWidth2) * this.$animationProgress);
                int indicatorHeight = iconPlaceable.getHeight() + measureScope.m7529roundToPx0680j_4(Dp.m7554constructorimpl(((float) 2) * NavigationBarKt.IndicatorVerticalPadding));
                ...
                for (Object element$iv3 : $this$first$iv2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv3), (Object) "indicatorRipple")) {
                        ...
                        if (this.$label == null) {
                            ...
                            return NavigationBarKt.m3578placeIconX9ElhV4($this$Layout, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints);
                        }
                        Intrinsics.checkNotNull(labelPlaceable);
                        return NavigationBarKt.m3579placeLabelAndIconzUg2_y0($this$Layout, labelPlaceable, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints, this.$alwaysShowLabel, this.$animationProgress);
                    }
