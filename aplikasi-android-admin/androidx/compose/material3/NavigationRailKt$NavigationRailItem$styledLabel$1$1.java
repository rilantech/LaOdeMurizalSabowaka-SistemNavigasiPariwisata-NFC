...
final class NavigationRailKt$NavigationRailItem$styledLabel$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            int i = this.$$dirty;
            ProvidedValue[] providedValueArr = {ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(invoke$lambda$0(navigationRailItemColors.textColor$material3_release(z, z2, $composer, ((i >> 15) & 896) | (i & 14) | ((i >> 9) & 112)))))};
