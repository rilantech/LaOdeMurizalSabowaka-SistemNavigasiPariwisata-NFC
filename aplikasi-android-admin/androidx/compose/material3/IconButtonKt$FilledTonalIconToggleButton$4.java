...
final class IconButtonKt$FilledTonalIconToggleButton$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$FilledTonalIconToggleButton$4(boolean z, Function1<? super Boolean, Unit> function1, Modifier modifier, boolean z2, Shape shape, IconToggleButtonColors iconToggleButtonColors, MutableInteractionSource mutableInteractionSource, Function2<? super Composer, ? super Integer, Unit> function2, int i, int i2) {
        super(2);
        this.$checked = z;
