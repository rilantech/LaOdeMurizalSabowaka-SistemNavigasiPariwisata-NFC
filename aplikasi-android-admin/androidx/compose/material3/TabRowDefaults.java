...
public final class TabRowDefaults {
    ...
    public final void m3812Indicator9IZ8Weo(Modifier modifier, float height, long color, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        float f;
        long color2;
        long color3;
        ...
        if (($dirty & 731) != 146 || !$composer2.getSkipping()) {
            ...
            if ((i3 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    height3 = PrimaryNavigationTabTokens.INSTANCE.m4404getActiveIndicatorHeightD9Ej5fM();
                } else {
                    height3 = f;
                }
                if ((i & 4) != 0) {
