...
final class BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$bodyPlaceable$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            int i3 = this.$$dirty;
            SurfaceKt.m3772SurfaceT9BRK9s(modifier, (Shape) null, j, j2, 0.0f, 0.0f, (BorderStroke) null, ComposableLambdaKt.composableLambda(composer, 1725620860, true, new Function2<Composer, Integer, Unit>() {
                public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                    invoke((Composer) p1, ((Number) p2).intValue());
                    return Unit.INSTANCE;
                }
                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if (($changed & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        function3.invoke(PaddingKt.m2245PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, f, 7, (Object) null), $composer, Integer.valueOf((i2 >> 3) & 112));
                        if (ComposerKt.isTraceInProgress()) {
