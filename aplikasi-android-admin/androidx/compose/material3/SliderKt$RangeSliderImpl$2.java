...
final class SliderKt$RangeSliderImpl$2 implements MeasurePolicy {
    ...
    public final MeasureResult m3680measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        ...
        for (Object element$iv : $this$first$iv) {
            if ((LayoutIdKt.getLayoutId((Measurable) element$iv) == RangeSliderComponents.STARTTHUMB ? 1 : null) != null) {
                Placeable startThumbPlaceable = ((Measurable) element$iv).m6399measureBRTryo0(j);
                for (Object element$iv2 : $this$first$iv) {
                    if ((LayoutIdKt.getLayoutId((Measurable) element$iv2) == RangeSliderComponents.ENDTHUMB ? 1 : null) != null) {
                        Placeable endThumbPlaceable = ((Measurable) element$iv2).m6399measureBRTryo0(j);
                        for (Object element$iv3 : $this$first$iv) {
                            if ((LayoutIdKt.getLayoutId((Measurable) element$iv3) == RangeSliderComponents.TRACK ? 1 : null) != null) {
                                Placeable trackPlaceable = ((Measurable) element$iv3).m6399measureBRTryo0(Constraints.m7489copyZbe2FdA$default(ConstraintsKt.m7515offsetNN6EwU$default(constraints, (-(startThumbPlaceable.getWidth() + endThumbPlaceable.getWidth())) / 2, 0, 2, (Object) null), 0, 0, 0, 0, 11, (Object) null));
