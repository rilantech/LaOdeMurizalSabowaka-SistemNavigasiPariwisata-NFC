...
final class AppBarKt$SingleRowTopAppBar$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            float r4 = ((Density) consume).m7535toPx0680j_4(TopAppBarSmallTokens.INSTANCE.m4500getContainerHeightD9Ej5fM());
            ...
            long r3 = this.$colors.m3979getNavigationIconContentColor0d7_KjU$material3_release();
            long r5 = this.$colors.m3980getTitleContentColor0d7_KjU$material3_release();
            long r7 = this.$colors.m3978getActionIconContentColor0d7_KjU$material3_release();
            ...
            int i2 = this.$$dirty;
            AppBarKt.m3252TopAppBarLayoutkXwM9vE(clipToBounds, height, r3, r5, r7, function2, textStyle, 1.0f, center, center2, 0, false, function22, function23, $composer, ((i2 << 12) & 458752) | 113246208 | ((i2 << 12) & 3670016), ((i2 >> 6) & 896) | 3126);
            if (ComposerKt.isTraceInProgress()) {
