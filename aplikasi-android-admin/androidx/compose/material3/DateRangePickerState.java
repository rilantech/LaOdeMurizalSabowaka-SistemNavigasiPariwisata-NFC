...
public final class DateRangePickerState {
    ...
    public /* synthetic */ DateRangePickerState(StateData stateData2, DefaultConstructorMarker defaultConstructorMarker) {
        this(stateData2);
    }
    ...
    private DateRangePickerState(StateData stateData2) {
    ...
    private DateRangePickerState(Long initialSelectedStartDateMillis, Long initialSelectedEndDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode) {
        this(new StateData(initialSelectedStartDateMillis, initialSelectedEndDateMillis, initialDisplayedMonthMillis, yearRange, initialDisplayMode, (DefaultConstructorMarker) null));
    ...
    public final int m3431getDisplayModejFl4v0() {
        return ((DisplayMode) this.displayMode$delegate.getValue()).m3447unboximpl();
    }

    /* renamed from: setDisplayMode-vCnGnXg  reason: not valid java name */
    public final void m3432setDisplayModevCnGnXg(int i) {
        this.displayMode$delegate.setValue(DisplayMode.m3441boximpl(i));
    }
