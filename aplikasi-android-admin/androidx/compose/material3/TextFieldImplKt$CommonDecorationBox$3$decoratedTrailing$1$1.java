    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(2077796155, $changed, -1, "androidx.compose.material3.CommonDecorationBox.<anonymous>.<anonymous>.<anonymous> (TextFieldImpl.kt:189)");
            }
            TextFieldImplKt.m3847DecorationKTwxG1Y(this.$trailingIconColor, (TextStyle) null, this.$it, $composer, 0, 2);
            if (ComposerKt.isTraceInProgress()) {
