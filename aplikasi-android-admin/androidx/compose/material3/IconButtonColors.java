...
public final class IconButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof IconButtonColors) || !Color.m4964equalsimpl0(this.containerColor, ((IconButtonColors) other).containerColor) || !Color.m4964equalsimpl0(this.contentColor, ((IconButtonColors) other).contentColor) || !Color.m4964equalsimpl0(this.disabledContainerColor, ((IconButtonColors) other).disabledContainerColor) || !Color.m4964equalsimpl0(this.disabledContentColor, ((IconButtonColors) other).disabledContentColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((Color.m4970hashCodeimpl(this.containerColor) * 31) + Color.m4970hashCodeimpl(this.contentColor)) * 31) + Color.m4970hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4970hashCodeimpl(this.disabledContentColor);
    }
}
