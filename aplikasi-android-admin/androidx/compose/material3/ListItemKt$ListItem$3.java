...
final class ListItemKt$ListItem$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    ListItemKt$ListItem$3(float f, PaddingValues paddingValues, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, int i) {
        super(2);
        this.$minHeight = f;
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C221@8945L215:ListItem.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1393735016, i, -1, "androidx.compose.material3.ListItem.<anonymous> (ListItem.kt:220)");
            }
            Modifier modifier$iv = SemanticsModifierKt.semantics(PaddingKt.padding(SizeKt.m2310heightInVpY3zN4$default(Modifier.Companion, this.$minHeight, 0.0f, 2, (Object) null), this.$paddingValues), true, AnonymousClass1.INSTANCE);
            Function3 content$iv = this.$content;
            int $changed$iv = (this.$$dirty >> 15) & 7168;
            composer.startReplaceableGroup(693286680);
            ComposerKt.sourceInformation(composer, "CC(Row)P(2,1,3)78@3913L58,79@3976L130:Row.kt#2w3rfo");
            MeasurePolicy measurePolicy$iv = RowKt.rowMeasurePolicy(Arrangement.INSTANCE.getStart(), Alignment.Companion.getTop(), composer, (($changed$iv >> 3) & 14) | (($changed$iv >> 3) & 112));
