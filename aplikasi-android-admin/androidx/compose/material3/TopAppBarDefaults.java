...
public final class TopAppBarDefaults {
    ...
    public final TopAppBarColors m3985topAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
        ...
        if ((i & 2) != 0) {
            scrolledContainerColor2 = ColorSchemeKt.m3367applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme(composer, 6), containerColor2, TopAppBarSmallTokens.INSTANCE.m4502getOnScrollContainerElevationD9Ej5fM());
        } else {
    ...
    public final TopAppBarColors m3984smallTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
        long scrolledContainerColor2;
        long navigationIconContentColor2;
        long titleContentColor2;
        long actionIconContentColor2;
        ...
        TopAppBarColors topAppBarColors = m3985topAppBarColorszjMxDiM(containerColor2, scrolledContainerColor2, navigationIconContentColor2, titleContentColor2, actionIconContentColor2, $composer, (i2 & 14) | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets r0 = WindowInsetsKt.m2351onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, $composer, 8), WindowInsetsSides.m2365plusgK_yJZ4(WindowInsetsSides.Companion.m2375getHorizontalJoeWqyM(), WindowInsetsSides.Companion.m2379getTopJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final TopAppBarColors m3981centerAlignedTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
        long scrolledContainerColor2;
        long navigationIconContentColor2;
        long titleContentColor2;
        long actionIconContentColor2;
    ...
    public final TopAppBarColors m3983mediumTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
        long scrolledContainerColor2;
        long navigationIconContentColor2;
        long titleContentColor2;
        long actionIconContentColor2;
    ...
    public final TopAppBarColors m3982largeTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
        long scrolledContainerColor2;
        long navigationIconContentColor2;
        long titleContentColor2;
        long actionIconContentColor2;
