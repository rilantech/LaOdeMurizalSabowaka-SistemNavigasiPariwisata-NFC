...
final class ListItemKt$LeadingContent$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    ListItemKt$LeadingContent$1(boolean z, RowScope rowScope, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
        this.$topAlign = z;
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = PaddingKt.m2252paddingqDBjuR0$default(Modifier.Companion, 0.0f, 0.0f, ListItemKt.LeadingContentEndPadding, 0.0f, 11, (Object) null).then(!this.$topAlign ? this.$this_LeadingContent.align(Modifier.Companion, Alignment.Companion.getCenterVertically()) : Modifier.Companion);
