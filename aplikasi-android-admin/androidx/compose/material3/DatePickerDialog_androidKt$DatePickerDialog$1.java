...
final class DatePickerDialog_androidKt$DatePickerDialog$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier r1 = SizeKt.m2310heightInVpY3zN4$default(SizeKt.m2319requiredWidth3ABfNKs(Modifier.Companion, DatePickerModalTokens.INSTANCE.m4095getContainerWidthD9Ej5fM()), 0.0f, DatePickerModalTokens.INSTANCE.m4094getContainerHeightD9Ej5fM(), 1, (Object) null);
            Shape shape = this.$shape;
            long r3 = this.$colors.m3409getContainerColor0d7_KjU$material3_release();
            ...
            int i3 = this.$$dirty;
            SurfaceKt.m3772SurfaceT9BRK9s(r1, shape, r3, 0, f, 0.0f, (BorderStroke) null, ComposableLambdaKt.composableLambda(composer, 1763752415, true, new Function2<Composer, Integer, Unit>() {
                public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
                    invoke((Composer) p1, ((Number) p2).intValue());
                    return Unit.INSTANCE;
                }
                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if ((i & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        function33.invoke(SkippableUpdater.m4566boximpl(SkippableUpdater.m4567constructorimpl($composer)), composer, Integer.valueOf(($changed$iv$iv$iv >> 3) & 112));
                        ...
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(ColorSchemeKt.toColor(DialogTokens.INSTANCE.getActionLabelTextColor(), $composer3, 6)))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer3, -926980325, true, new DatePickerDialog_androidKt$DatePickerDialog$1$1$1$1$1(function2, i2, function22)), $composer3, 56);
