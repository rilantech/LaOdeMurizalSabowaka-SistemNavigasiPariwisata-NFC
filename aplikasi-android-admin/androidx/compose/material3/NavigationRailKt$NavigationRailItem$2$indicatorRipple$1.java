...
final class NavigationRailKt$NavigationRailItem$2$indicatorRipple$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            BoxKt.Box(IndicationKt.indication(ClipKt.clip(LayoutIdKt.layoutId(Modifier.Companion, "indicatorRipple"), this.$indicatorShape), this.$offsetInteractionSource, RippleKt.m3233rememberRipple9IZ8Weo(false, 0.0f, 0, $composer, 0, 7)), $composer, 0);
            if (ComposerKt.isTraceInProgress()) {
