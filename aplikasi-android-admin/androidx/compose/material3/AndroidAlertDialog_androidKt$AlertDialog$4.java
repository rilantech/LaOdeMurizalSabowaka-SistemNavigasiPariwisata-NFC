...
final class AndroidAlertDialog_androidKt$AlertDialog$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    AndroidAlertDialog_androidKt$AlertDialog$4(Function0<Unit> function0, Modifier modifier, DialogProperties dialogProperties, Function2<? super Composer, ? super Integer, Unit> function2, int i, int i2) {
        super(2);
