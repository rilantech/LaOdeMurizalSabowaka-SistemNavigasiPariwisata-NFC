...
final class ModalBottomSheet_androidKt$ModalBottomSheet$2$1$5$1$1$1$3 extends Lambda implements Function0<Boolean> {
    final /* synthetic */ CoroutineScope $scope;
    final /* synthetic */ SheetState $this_with;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ModalBottomSheet_androidKt$ModalBottomSheet$2$1$5$1$1$1$3(SheetState sheetState, CoroutineScope coroutineScope) {
        super(0);
    ...
    /* renamed from: androidx.compose.material3.ModalBottomSheet_androidKt$ModalBottomSheet$2$1$5$1$1$1$3$1  reason: invalid class name */
    /* compiled from: ModalBottomSheet.android.kt */
