...
final class SliderKt$SliderImpl$2 implements MeasurePolicy {
    ...
    public final MeasureResult m3681measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        Measurable it;
        ...
        for (Object element$iv : $this$first$iv) {
            ...
            if (it != null) {
                Placeable thumbPlaceable = ((Measurable) element$iv).m6399measureBRTryo0(constraints);
                for (Object element$iv2 : $this$first$iv) {
                    if ((LayoutIdKt.getLayoutId((Measurable) element$iv2) == SliderComponents.TRACK ? 1 : null) != null) {
                        Placeable trackPlaceable = ((Measurable) element$iv2).m6399measureBRTryo0(Constraints.m7489copyZbe2FdA$default(ConstraintsKt.m7515offsetNN6EwU$default(constraints, -thumbPlaceable.getWidth(), 0, 2, (Object) null), 0, 0, 0, 0, 11, (Object) null));
