...
public final class SearchBarColors {
    ...
    public final long m3651getContainerColor0d7_KjU() {
        return this.containerColor;
    }

    /* renamed from: getDividerColor-0d7_KjU  reason: not valid java name */
    public final long m3652getDividerColor0d7_KjU() {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4964equalsimpl0(this.containerColor, ((SearchBarColors) other).containerColor) && Color.m4964equalsimpl0(this.dividerColor, ((SearchBarColors) other).dividerColor) && Intrinsics.areEqual((Object) this.inputFieldColors, (Object) ((SearchBarColors) other).inputFieldColors)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((Color.m4970hashCodeimpl(this.containerColor) * 31) + Color.m4970hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
