...
public final class FloatingActionButtonDefaults {
    ...
    private static final float LargeIconSize = FabPrimaryLargeTokens.INSTANCE.m4148getIconSizeD9Ej5fM();

    private FloatingActionButtonDefaults() {
    }

    /* renamed from: getLargeIconSize-D9Ej5fM  reason: not valid java name */
    public final float m3501getLargeIconSizeD9Ej5fM() {
    ...
    public final FloatingActionButtonElevation m3500elevationxZ9QkE(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            defaultElevation = FabPrimaryTokens.INSTANCE.m4165getContainerElevationD9Ej5fM();
        }
        if ((i & 2) != 0) {
            pressedElevation = FabPrimaryTokens.INSTANCE.m4175getPressedContainerElevationD9Ej5fM();
        }
        if ((i & 4) != 0) {
            focusedElevation = FabPrimaryTokens.INSTANCE.m4168getFocusContainerElevationD9Ej5fM();
        }
        if ((i & 8) != 0) {
            hoveredElevation = FabPrimaryTokens.INSTANCE.m4169getHoverContainerElevationD9Ej5fM();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final FloatingActionButtonElevation m3502loweredElevationxZ9QkE(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            defaultElevation = FabPrimaryTokens.INSTANCE.m4171getLoweredContainerElevationD9Ej5fM();
        }
        if ((i & 2) != 0) {
            pressedElevation = FabPrimaryTokens.INSTANCE.m4174getLoweredPressedContainerElevationD9Ej5fM();
        }
        if ((i & 4) != 0) {
            focusedElevation = FabPrimaryTokens.INSTANCE.m4172getLoweredFocusContainerElevationD9Ej5fM();
        }
        if ((i & 8) != 0) {
            hoveredElevation = FabPrimaryTokens.INSTANCE.m4173getLoweredHoverContainerElevationD9Ej5fM();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static /* synthetic */ FloatingActionButtonElevation m3498bottomAppBarFabElevationa9UjIt4$default(FloatingActionButtonDefaults floatingActionButtonDefaults, float $this$dp$iv, float $this$dp$iv2, float $this$dp$iv3, float $this$dp$iv4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return floatingActionButtonDefaults.m3499bottomAppBarFabElevationa9UjIt4($this$dp$iv, $this$dp$iv2, $this$dp$iv3, $this$dp$iv4);
    }

    /* renamed from: bottomAppBarFabElevation-a9UjIt4  reason: not valid java name */
    public final FloatingActionButtonElevation m3499bottomAppBarFabElevationa9UjIt4(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation) {
