...
final class AppBarKt$TopAppBarLayout$1$3$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(this.$titleContentColor))}, (Function2<? super Composer, ? super Integer, Unit>) this.$title, $composer, ((this.$$dirty >> 12) & 112) | 8);
            if (ComposerKt.isTraceInProgress()) {
