...
public final class SliderColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof SliderColors) || !Color.m4964equalsimpl0(this.thumbColor, ((SliderColors) other).thumbColor) || !Color.m4964equalsimpl0(this.activeTrackColor, ((SliderColors) other).activeTrackColor) || !Color.m4964equalsimpl0(this.activeTickColor, ((SliderColors) other).activeTickColor) || !Color.m4964equalsimpl0(this.inactiveTrackColor, ((SliderColors) other).inactiveTrackColor) || !Color.m4964equalsimpl0(this.inactiveTickColor, ((SliderColors) other).inactiveTickColor) || !Color.m4964equalsimpl0(this.disabledThumbColor, ((SliderColors) other).disabledThumbColor) || !Color.m4964equalsimpl0(this.disabledActiveTrackColor, ((SliderColors) other).disabledActiveTrackColor) || !Color.m4964equalsimpl0(this.disabledActiveTickColor, ((SliderColors) other).disabledActiveTickColor) || !Color.m4964equalsimpl0(this.disabledInactiveTrackColor, ((SliderColors) other).disabledInactiveTrackColor) || !Color.m4964equalsimpl0(this.disabledInactiveTickColor, ((SliderColors) other).disabledInactiveTickColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((Color.m4970hashCodeimpl(this.thumbColor) * 31) + Color.m4970hashCodeimpl(this.activeTrackColor)) * 31) + Color.m4970hashCodeimpl(this.activeTickColor)) * 31) + Color.m4970hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m4970hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m4970hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m4970hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m4970hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m4970hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m4970hashCodeimpl(this.disabledInactiveTickColor);
    }
}
