...
final class IconButtonKt$FilledTonalIconToggleButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$FilledTonalIconToggleButton$3(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C396@19473L157:IconButton.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = SizeKt.m2322size3ABfNKs(Modifier.Companion, FilledTonalIconButtonTokens.INSTANCE.m4227getContainerSizeD9Ej5fM());
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 919448265, "C400@19615L9:IconButton.kt#uh7d8r");
