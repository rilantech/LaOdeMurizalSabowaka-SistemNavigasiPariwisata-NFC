...
final class SurfaceKt$Surface$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            Modifier modifier$iv = SelectableKt.m2544selectableO2vRcR0$default(SurfaceKt.m3778surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(this.$modifier), this.$shape, SurfaceKt.m3779surfaceColorAtElevationCLU3JFs(this.$color, this.$absoluteElevation, composer, (this.$$changed >> 15) & 14), this.$border, this.$shadowElevation), this.$selected, this.$interactionSource, RippleKt.m3233rememberRipple9IZ8Weo(false, 0.0f, 0, $composer, 0, 7), this.$enabled, (Role) null, this.$onClick, 16, (Object) null);
