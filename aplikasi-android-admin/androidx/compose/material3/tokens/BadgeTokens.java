...
public final class BadgeTokens {
    ...
    private static final float LargeSize = Dp.m7554constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = Dp.m7554constructorimpl((float) 6.0d);
    ...
    public final float m4004getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m4005getSizeD9Ej5fM() {
        return Size;
    }
}
