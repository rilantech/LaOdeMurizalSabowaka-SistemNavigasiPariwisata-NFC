...
public final class TopAppBarLargeTokens {
    ...
    private static final float ContainerHeight = Dp.m7554constructorimpl((float) 152.0d);
    ...
    public final float m4485getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* renamed from: getContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m4486getContainerHeightD9Ej5fM() {
    ...
    public final float m4487getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m4488getTrailingIconSizeD9Ej5fM() {
