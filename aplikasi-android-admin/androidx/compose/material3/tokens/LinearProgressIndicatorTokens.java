...
public final class LinearProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m7554constructorimpl((float) 4.0d);
    ...
    private static final float TrackHeight = Dp.m7554constructorimpl((float) 4.0d);
    ...
    public final float m4256getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m4257getTrackHeightD9Ej5fM() {
        return TrackHeight;
    }
