...
public final class SliderTokens {
    ...
    private static final float ActiveTrackHeight = Dp.m7554constructorimpl((float) 4.0d);
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m4127getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m4128getLevel1D9Ej5fM();
    private static final float HandleHeight = Dp.m7554constructorimpl((float) 20.0d);
    private static final ShapeKeyTokens HandleShape = ShapeKeyTokens.CornerFull;
    private static final float HandleWidth = Dp.m7554constructorimpl((float) 20.0d);
    ...
    private static final float InactiveTrackHeight = Dp.m7554constructorimpl((float) 4.0d);
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m4127getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m7554constructorimpl((float) 28.0d);
    ...
    private static final float OverlapHandleOutlineWidth = Dp.m7554constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m7554constructorimpl((float) 2.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m4127getLevel0D9Ej5fM();
    ...
    public final float m4423getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m4424getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m4425getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM  reason: not valid java name */
    public final float m4426getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m4427getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m4428getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m4429getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m4430getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m4432getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM  reason: not valid java name */
    public final float m4434getTrackElevationD9Ej5fM() {
    ...
    public final float m4431getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m4433getTickMarksContainerSizeD9Ej5fM() {
