...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m7554constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m7554constructorimpl((float) 24.0d);
    ...
    public final float m4314getContainerSizeD9Ej5fM() {
    ...
    public final float m4315getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m4316getUnselectedOutlineWidthD9Ej5fM() {
