...
public final class TopAppBarMediumTokens {
    ...
    private static final float ContainerHeight = Dp.m7554constructorimpl((float) 112.0d);
    ...
    public final float m4489getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* renamed from: getContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m4490getContainerHeightD9Ej5fM() {
    ...
    public final float m4491getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m4492getTrailingIconSizeD9Ej5fM() {
