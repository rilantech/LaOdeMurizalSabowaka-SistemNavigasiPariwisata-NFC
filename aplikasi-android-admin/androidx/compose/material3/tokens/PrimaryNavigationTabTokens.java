...
public final class PrimaryNavigationTabTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m7554constructorimpl((float) 3.0d);
    private static final RoundedCornerShape ActiveIndicatorShape = RoundedCornerShapeKt.m2582RoundedCornerShape0680j_4(Dp.m7554constructorimpl((float) 3.0d));
    ...
    private static final float ContainerHeight = Dp.m7554constructorimpl((float) 48.0d);
    ...
    private static final float DividerHeight = Dp.m7554constructorimpl((float) 1.0d);
    public static final PrimaryNavigationTabTokens INSTANCE = new PrimaryNavigationTabTokens();
    private static final float IconAndLabelTextContainerHeight = Dp.m7554constructorimpl((float) 64.0d);
    ...
    public final float m4404getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m4405getContainerElevationD9Ej5fM() {
    ...
    public final float m4407getDividerHeightD9Ej5fM() {
    ...
    public final float m4408getIconAndLabelTextContainerHeightD9Ej5fM() {
        return IconAndLabelTextContainerHeight;
    }

    /* renamed from: getIconSize-D9Ej5fM  reason: not valid java name */
    public final float m4409getIconSizeD9Ej5fM() {
        return IconSize;
    }
