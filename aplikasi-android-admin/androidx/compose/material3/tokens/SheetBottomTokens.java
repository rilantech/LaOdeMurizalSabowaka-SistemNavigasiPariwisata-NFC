...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m7554constructorimpl((float) 4.0d);
    public static final float DockedDragHandleOpacity = 0.4f;
    private static final float DockedDragHandleWidth = Dp.m7554constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m4128getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m4128getLevel1D9Ej5fM();
    ...
    public final float m4419getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* renamed from: getDockedDragHandleWidth-D9Ej5fM  reason: not valid java name */
    public final float m4420getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m4421getDockedModalContainerElevationD9Ej5fM() {
        return DockedModalContainerElevation;
    }

    /* renamed from: getDockedStandardContainerElevation-D9Ej5fM  reason: not valid java name */
    public final float m4422getDockedStandardContainerElevationD9Ej5fM() {
