...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m7554constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m7554constructorimpl((float) 48.0d);
    ...
    public final float m4028getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m4029getSizeD9Ej5fM() {
        return Size;
    }
}
