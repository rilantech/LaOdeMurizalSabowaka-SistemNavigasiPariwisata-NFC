...
final class CardKt$Card$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    CardKt$Card$1(Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i) {
        super(2);
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C92@4268L25:Card.kt#uh7d8r");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            int $changed$iv = (this.$$dirty >> 6) & 7168;
