...
public final class TextFieldColors {
    ...
    public final State<Color> containerColor$material3_release(boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        State<Color> r4 = SingleValueAnimationKt.m1782animateColorAsStateeuL9pac(targetValue, AnimationSpecKt.tween$default(150, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, $composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof TextFieldColors) || !Color.m4964equalsimpl0(this.focusedTextColor, ((TextFieldColors) other).focusedTextColor) || !Color.m4964equalsimpl0(this.unfocusedTextColor, ((TextFieldColors) other).unfocusedTextColor) || !Color.m4964equalsimpl0(this.disabledTextColor, ((TextFieldColors) other).disabledTextColor) || !Color.m4964equalsimpl0(this.errorTextColor, ((TextFieldColors) other).errorTextColor) || !Color.m4964equalsimpl0(this.focusedContainerColor, ((TextFieldColors) other).focusedContainerColor) || !Color.m4964equalsimpl0(this.unfocusedContainerColor, ((TextFieldColors) other).unfocusedContainerColor) || !Color.m4964equalsimpl0(this.disabledContainerColor, ((TextFieldColors) other).disabledContainerColor) || !Color.m4964equalsimpl0(this.errorContainerColor, ((TextFieldColors) other).errorContainerColor) || !Color.m4964equalsimpl0(this.cursorColor, ((TextFieldColors) other).cursorColor) || !Color.m4964equalsimpl0(this.errorCursorColor, ((TextFieldColors) other).errorCursorColor) || !Intrinsics.areEqual((Object) this.textSelectionColors, (Object) ((TextFieldColors) other).textSelectionColors) || !Color.m4964equalsimpl0(this.focusedIndicatorColor, ((TextFieldColors) other).focusedIndicatorColor) || !Color.m4964equalsimpl0(this.unfocusedIndicatorColor, ((TextFieldColors) other).unfocusedIndicatorColor) || !Color.m4964equalsimpl0(this.disabledIndicatorColor, ((TextFieldColors) other).disabledIndicatorColor) || !Color.m4964equalsimpl0(this.errorIndicatorColor, ((TextFieldColors) other).errorIndicatorColor) || !Color.m4964equalsimpl0(this.focusedLeadingIconColor, ((TextFieldColors) other).focusedLeadingIconColor) || !Color.m4964equalsimpl0(this.unfocusedLeadingIconColor, ((TextFieldColors) other).unfocusedLeadingIconColor) || !Color.m4964equalsimpl0(this.disabledLeadingIconColor, ((TextFieldColors) other).disabledLeadingIconColor) || !Color.m4964equalsimpl0(this.errorLeadingIconColor, ((TextFieldColors) other).errorLeadingIconColor) || !Color.m4964equalsimpl0(this.focusedTrailingIconColor, ((TextFieldColors) other).focusedTrailingIconColor) || !Color.m4964equalsimpl0(this.unfocusedTrailingIconColor, ((TextFieldColors) other).unfocusedTrailingIconColor) || !Color.m4964equalsimpl0(this.disabledTrailingIconColor, ((TextFieldColors) other).disabledTrailingIconColor) || !Color.m4964equalsimpl0(this.errorTrailingIconColor, ((TextFieldColors) other).errorTrailingIconColor) || !Color.m4964equalsimpl0(this.focusedLabelColor, ((TextFieldColors) other).focusedLabelColor) || !Color.m4964equalsimpl0(this.unfocusedLabelColor, ((TextFieldColors) other).unfocusedLabelColor) || !Color.m4964equalsimpl0(this.disabledLabelColor, ((TextFieldColors) other).disabledLabelColor) || !Color.m4964equalsimpl0(this.errorLabelColor, ((TextFieldColors) other).errorLabelColor) || !Color.m4964equalsimpl0(this.focusedPlaceholderColor, ((TextFieldColors) other).focusedPlaceholderColor) || !Color.m4964equalsimpl0(this.unfocusedPlaceholderColor, ((TextFieldColors) other).unfocusedPlaceholderColor) || !Color.m4964equalsimpl0(this.disabledPlaceholderColor, ((TextFieldColors) other).disabledPlaceholderColor) || !Color.m4964equalsimpl0(this.errorPlaceholderColor, ((TextFieldColors) other).errorPlaceholderColor) || !Color.m4964equalsimpl0(this.focusedSupportingTextColor, ((TextFieldColors) other).focusedSupportingTextColor) || !Color.m4964equalsimpl0(this.unfocusedSupportingTextColor, ((TextFieldColors) other).unfocusedSupportingTextColor) || !Color.m4964equalsimpl0(this.disabledSupportingTextColor, ((TextFieldColors) other).disabledSupportingTextColor) || !Color.m4964equalsimpl0(this.errorSupportingTextColor, ((TextFieldColors) other).errorSupportingTextColor) || !Color.m4964equalsimpl0(this.focusedPrefixColor, ((TextFieldColors) other).focusedPrefixColor) || !Color.m4964equalsimpl0(this.unfocusedPrefixColor, ((TextFieldColors) other).unfocusedPrefixColor) || !Color.m4964equalsimpl0(this.disabledPrefixColor, ((TextFieldColors) other).disabledPrefixColor) || !Color.m4964equalsimpl0(this.errorPrefixColor, ((TextFieldColors) other).errorPrefixColor) || !Color.m4964equalsimpl0(this.focusedSuffixColor, ((TextFieldColors) other).focusedSuffixColor) || !Color.m4964equalsimpl0(this.unfocusedSuffixColor, ((TextFieldColors) other).unfocusedSuffixColor) || !Color.m4964equalsimpl0(this.disabledSuffixColor, ((TextFieldColors) other).disabledSuffixColor) || !Color.m4964equalsimpl0(this.errorSuffixColor, ((TextFieldColors) other).errorSuffixColor)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((Color.m4970hashCodeimpl(this.focusedTextColor) * 31) + Color.m4970hashCodeimpl(this.unfocusedTextColor)) * 31) + Color.m4970hashCodeimpl(this.disabledTextColor)) * 31) + Color.m4970hashCodeimpl(this.errorTextColor)) * 31) + Color.m4970hashCodeimpl(this.focusedContainerColor)) * 31) + Color.m4970hashCodeimpl(this.unfocusedContainerColor)) * 31) + Color.m4970hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4970hashCodeimpl(this.errorContainerColor)) * 31) + Color.m4970hashCodeimpl(this.cursorColor)) * 31) + Color.m4970hashCodeimpl(this.errorCursorColor)) * 31) + this.textSelectionColors.hashCode()) * 31) + Color.m4970hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m4970hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m4970hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m4970hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m4970hashCodeimpl(this.focusedLeadingIconColor)) * 31) + Color.m4970hashCodeimpl(this.unfocusedLeadingIconColor)) * 31) + Color.m4970hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4970hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m4970hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m4970hashCodeimpl(this.unfocusedTrailingIconColor)) * 31) + Color.m4970hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m4970hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m4970hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m4970hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m4970hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m4970hashCodeimpl(this.errorLabelColor)) * 31) + Color.m4970hashCodeimpl(this.focusedPlaceholderColor)) * 31) + Color.m4970hashCodeimpl(this.unfocusedPlaceholderColor)) * 31) + Color.m4970hashCodeimpl(this.disabledPlaceholderColor)) * 31) + Color.m4970hashCodeimpl(this.errorPlaceholderColor)) * 31) + Color.m4970hashCodeimpl(this.focusedSupportingTextColor)) * 31) + Color.m4970hashCodeimpl(this.unfocusedSupportingTextColor)) * 31) + Color.m4970hashCodeimpl(this.disabledSupportingTextColor)) * 31) + Color.m4970hashCodeimpl(this.errorSupportingTextColor)) * 31) + Color.m4970hashCodeimpl(this.focusedPrefixColor)) * 31) + Color.m4970hashCodeimpl(this.unfocusedPrefixColor)) * 31) + Color.m4970hashCodeimpl(this.disabledPrefixColor)) * 31) + Color.m4970hashCodeimpl(this.errorPrefixColor)) * 31) + Color.m4970hashCodeimpl(this.focusedSuffixColor)) * 31) + Color.m4970hashCodeimpl(this.unfocusedSuffixColor)) * 31) + Color.m4970hashCodeimpl(this.disabledSuffixColor)) * 31) + Color.m4970hashCodeimpl(this.errorSuffixColor);
    }
}
