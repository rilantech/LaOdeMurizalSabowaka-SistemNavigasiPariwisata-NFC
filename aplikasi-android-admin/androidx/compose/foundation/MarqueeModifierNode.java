...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int iterations2, int animationMode, int delayMillis2, int initialDelayMillis2, MarqueeSpacing spacing, float velocity2) {
        ...
        this.animationMode$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m1942boximpl(animationMode), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public final int m1957getAnimationModeZbEOnfQ() {
        return ((MarqueeAnimationMode) this.animationMode$delegate.getValue()).m1948unboximpl();
    }

    /* renamed from: setAnimationMode-97h66l8  reason: not valid java name */
    public final void m1959setAnimationMode97h66l8(int i) {
        this.animationMode$delegate.setValue(MarqueeAnimationMode.m1942boximpl(i));
    }
    ...
    public final void m1960updatelWfNwf4(int iterations2, int animationMode, int delayMillis2, int initialDelayMillis2, MarqueeSpacing spacing, float velocity2) {
        Intrinsics.checkNotNullParameter(spacing, "spacing");
        setSpacing(spacing);
        m1959setAnimationMode97h66l8(animationMode);
        if (this.iterations != iterations2 || this.delayMillis != delayMillis2 || this.initialDelayMillis != initialDelayMillis2 || !Dp.m7559equalsimpl0(this.velocity, velocity2)) {
            this.iterations = iterations2;
            this.delayMillis = delayMillis2;
            this.initialDelayMillis = initialDelayMillis2;
            this.velocity = velocity2;
    ...
    public MeasureResult m1958measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$measure_u2d3p2s80s, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        Placeable placeable = measurable.m6399measureBRTryo0(Constraints.m7489copyZbe2FdA$default(constraints, 0, Integer.MAX_VALUE, 0, 0, 13, (Object) null));
        setContainerWidth(ConstraintsKt.m7512constrainWidthK40F9xA(constraints, placeable.getWidth()));
    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        $this$withTransform_u24lambda_u246$iv$iv.getTransform().m5631clipRectN_I0leg(clipOffset, 0.0f, right$iv, bottom$iv, clipOp$iv);
        ...
        $this$withTransform_u24lambda_u246$iv$iv2.m5520setSizeuvyYCjk(previousSize$iv$iv2);
    }
