...
final class MarqueeModifierElement extends ModifierNodeElement<MarqueeModifierNode> {
    ...
    private final int m1953component2ZbEOnfQ() {
    ...
    private final float m1954component6D9Ej5fM() {
        return this.velocity;
    }

    /* renamed from: copy-lWfNwf4$default  reason: not valid java name */
    public static /* synthetic */ MarqueeModifierElement m1955copylWfNwf4$default(MarqueeModifierElement marqueeModifierElement, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
        ...
        return marqueeModifierElement.m1956copylWfNwf4(i, i6, i7, i8, marqueeSpacing2, f);
    }

    /* renamed from: copy-lWfNwf4  reason: not valid java name */
    public final MarqueeModifierElement m1956copylWfNwf4(int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.iterations == marqueeModifierElement.iterations && MarqueeAnimationMode.m1945equalsimpl0(this.animationMode, marqueeModifierElement.animationMode) && this.delayMillis == marqueeModifierElement.delayMillis && this.initialDelayMillis == marqueeModifierElement.initialDelayMillis && Intrinsics.areEqual((Object) this.spacing, (Object) marqueeModifierElement.spacing) && Dp.m7559equalsimpl0(this.velocity, marqueeModifierElement.velocity);
    }

    public int hashCode() {
        return (((((((((Integer.hashCode(this.iterations) * 31) + MarqueeAnimationMode.m1946hashCodeimpl(this.animationMode)) * 31) + Integer.hashCode(this.delayMillis)) * 31) + Integer.hashCode(this.initialDelayMillis)) * 31) + this.spacing.hashCode()) * 31) + Dp.m7560hashCodeimpl(this.velocity);
    }

    public String toString() {
        return "MarqueeModifierElement(iterations=" + this.iterations + ", animationMode=" + MarqueeAnimationMode.m1947toStringimpl(this.animationMode) + ", delayMillis=" + this.delayMillis + ", initialDelayMillis=" + this.initialDelayMillis + ", spacing=" + this.spacing + ", velocity=" + Dp.m7565toStringimpl(this.velocity) + ')';
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("animationMode", MarqueeAnimationMode.m1942boximpl(this.animationMode));
        ...
        $this$inspectableProperties.getProperties().set("velocity", Dp.m7552boximpl(this.velocity));
    }
    ...
    public void update(MarqueeModifierNode node) {
        ...
        node.m1960updatelWfNwf4(this.iterations, this.animationMode, this.delayMillis, this.initialDelayMillis, this.spacing, this.velocity);
    }
}
