...
public final class BackgroundKt {
    ...
    public static /* synthetic */ Modifier m1877backgroundbw27NRU$default(Modifier modifier, long j, Shape shape, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m1876backgroundbw27NRU(modifier, j, shape);
    }

    /* renamed from: background-bw27NRU  reason: not valid java name */
    public static final Modifier m1876backgroundbw27NRU(Modifier $this$background_u2dbw27NRU, long color, Shape shape) {
