...
final class ClickableSemanticsNode extends Modifier.Node implements SemanticsModifierNode {
    ...
    public final void m1922updateUMe6uN4(boolean enabled2, String onClickLabel2, Role role2, Function0<Unit> onClick2, String onLongClickLabel2, Function0<Unit> onLongClick2) {
        Intrinsics.checkNotNullParameter(onClick2, "onClick");
        this.enabled = enabled2;
        this.onClickLabel = onClickLabel2;
        this.role = role2;
    ...
    public void applySemantics(SemanticsPropertyReceiver $this$applySemantics) {
        ...
        if (role2 != null) {
            ...
            SemanticsPropertiesKt.m6886setRolekuIjeqM($this$applySemantics, role2.m6871unboximpl());
        }
