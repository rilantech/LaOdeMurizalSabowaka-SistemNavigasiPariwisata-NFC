...
public final class BorderStroke {
    ...
    public final float m1903getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BorderStroke) && Dp.m7559equalsimpl0(this.width, ((BorderStroke) other).width) && Intrinsics.areEqual((Object) this.brush, (Object) ((BorderStroke) other).brush)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (Dp.m7560hashCodeimpl(this.width) * 31) + this.brush.hashCode();
    }

    public String toString() {
        return "BorderStroke(width=" + Dp.m7565toStringimpl(this.width) + ", brush=" + this.brush + ')';
    }

    /* renamed from: copy-D5KLDUw$default  reason: not valid java name */
    public static /* synthetic */ BorderStroke m1901copyD5KLDUw$default(BorderStroke borderStroke, float f, Brush brush2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderStroke.m1902copyD5KLDUw(f, brush2);
    }

    /* renamed from: copy-D5KLDUw  reason: not valid java name */
    public final BorderStroke m1902copyD5KLDUw(float width2, Brush brush2) {
        Intrinsics.checkNotNullParameter(brush2, "brush");
