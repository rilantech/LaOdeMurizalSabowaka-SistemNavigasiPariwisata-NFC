...
final class ExcludeFromSystemGestureNode extends Modifier.Node implements GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    private final android.graphics.Rect calcBounds(LayoutCoordinates layoutCoordinates, Rect rect2) {
        ...
        long topLeft = root.m6361localPositionOfR5De75A(layoutCoordinates2, rect2.m4748getTopLeftF1C5BW0());
        long topRight = root.m6361localPositionOfR5De75A(layoutCoordinates2, rect2.m4749getTopRightF1C5BW0());
        long bottomLeft = root.m6361localPositionOfR5De75A(layoutCoordinates2, rect2.m4741getBottomLeftF1C5BW0());
        long bottomRight = root.m6361localPositionOfR5De75A(layoutCoordinates2, rect2.m4742getBottomRightF1C5BW0());
        LayoutCoordinates layoutCoordinates3 = root;
        long j = topLeft;
        return new android.graphics.Rect(MathKt.roundToInt(ComparisonsKt.minOf(Offset.m4713getXimpl(topLeft), Offset.m4713getXimpl(topRight), Offset.m4713getXimpl(bottomLeft), Offset.m4713getXimpl(bottomRight))), MathKt.roundToInt(ComparisonsKt.minOf(Offset.m4714getYimpl(topLeft), Offset.m4714getYimpl(topRight), Offset.m4714getYimpl(bottomLeft), Offset.m4714getYimpl(bottomRight))), MathKt.roundToInt(ComparisonsKt.maxOf(Offset.m4713getXimpl(topLeft), Offset.m4713getXimpl(topRight), Offset.m4713getXimpl(bottomLeft), Offset.m4713getXimpl(bottomRight))), MathKt.roundToInt(ComparisonsKt.maxOf(Offset.m4714getYimpl(topLeft), Offset.m4714getYimpl(topRight), Offset.m4714getYimpl(bottomLeft), Offset.m4714getYimpl(bottomRight))));
    }
