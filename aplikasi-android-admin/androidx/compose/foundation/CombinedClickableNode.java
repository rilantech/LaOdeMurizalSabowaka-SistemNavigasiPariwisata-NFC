...
final class CombinedClickableNode extends AbstractClickableNode {
    ...
    public final void m1928updatecJG_KMw(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> onLongClick2, Function0<Unit> onDoubleClick) {
        ...
        boolean z3 = enabled;
        getClickableSemanticsNode().m1922updateUMe6uN4(z3, onClickLabel, role, onClick, onLongClickLabel, onLongClick2);
