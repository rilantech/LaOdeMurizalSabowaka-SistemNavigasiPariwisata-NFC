...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier $this$border, BorderStroke border, Shape shape) {
        ...
        return m1890borderziNgDLE($this$border, border.m1903getWidthD9Ej5fM(), border.getBrush(), shape);
    }

    /* renamed from: border-xT4_qwU$default  reason: not valid java name */
    public static /* synthetic */ Modifier m1889borderxT4_qwU$default(Modifier modifier, float f, long j, Shape shape, int i, Object obj) {
        if ((i & 4) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m1888borderxT4_qwU(modifier, f, j, shape);
    }

    /* renamed from: border-xT4_qwU  reason: not valid java name */
    public static final Modifier m1888borderxT4_qwU(Modifier $this$border_u2dxT4_qwU, float width, long color, Shape shape) {
        Intrinsics.checkNotNullParameter($this$border_u2dxT4_qwU, "$this$border");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m1890borderziNgDLE($this$border_u2dxT4_qwU, width, new SolidColor(color, (DefaultConstructorMarker) null), shape);
    }

    /* renamed from: border-ziNgDLE  reason: not valid java name */
    public static final Modifier m1890borderziNgDLE(Modifier $this$border_u2dziNgDLE, float width, Brush brush, Shape shape) {
    ...
    public static final androidx.compose.ui.draw.DrawResult m1891drawRectBorderNsqcLGU(androidx.compose.ui.draw.CacheDrawScope r16, androidx.compose.ui.graphics.Brush r17, long r18, long r20, boolean r22, float r23) {
        /*
        ...
        L_0x000c:
            ...
            long r0 = r16.m4614getSizeNHjbRc()
            r6 = r0
            goto L_0x0016
        L_0x0014:
            r6 = r20
        ...
        L_0x002a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.BorderKt.m1891drawRectBorderNsqcLGU(androidx.compose.ui.draw.CacheDrawScope, androidx.compose.ui.graphics.Brush, long, long, boolean, float):androidx.compose.ui.draw.DrawResult");
    }
    ...
    public static final Path createRoundRectPath(Path targetPath, RoundRect roundedRect, float strokeWidth, boolean fillArea) {
        ...
        if (!fillArea) {
            ...
            $this$createRoundRectPath_u24lambda_u241.m5246opN5in7k0($this$createRoundRectPath_u24lambda_u241, insetPath, PathOperation.Companion.m5272getDifferenceb3I0S0c());
        }
        return targetPath;
    }
    ...
    private static final RoundRect createInsetRoundedRect(float widthPx, RoundRect roundedRect) {
        float f = widthPx;
        return new RoundRect(widthPx, widthPx, roundedRect.getWidth() - f, roundedRect.getHeight() - f, m1892shrinkKibmq7A(roundedRect.m4763getTopLeftCornerRadiuskKHJgLs(), f), m1892shrinkKibmq7A(roundedRect.m4764getTopRightCornerRadiuskKHJgLs(), f), m1892shrinkKibmq7A(roundedRect.m4762getBottomRightCornerRadiuskKHJgLs(), f), m1892shrinkKibmq7A(roundedRect.m4761getBottomLeftCornerRadiuskKHJgLs(), f), (DefaultConstructorMarker) null);
    }

    /* access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A  reason: not valid java name */
    public static final long m1892shrinkKibmq7A(long $this$shrink_u2dKibmq7A, float value) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m4688getXimpl($this$shrink_u2dKibmq7A) - value), Math.max(0.0f, CornerRadius.m4689getYimpl($this$shrink_u2dKibmq7A) - value));
    }
}
