...
public final class BackgroundKt$background$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$background_u24lambda_u241 = $this$null;
        $this$background_u24lambda_u241.setName("background");
        $this$background_u24lambda_u241.getProperties().set("alpha", Float.valueOf(this.$alpha$inlined));
        $this$background_u24lambda_u241.getProperties().set("brush", this.$brush$inlined);
        $this$background_u24lambda_u241.getProperties().set("shape", this.$shape$inlined);
    }
}
