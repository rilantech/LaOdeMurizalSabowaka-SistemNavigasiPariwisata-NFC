...
abstract class AbstractClickablePointerInputNode extends DelegatingNode implements ModifierLocalModifierNode, CompositionLocalConsumerModifierNode, PointerInputModifierNode {
    ...
    public final Object m1864handlePressInteractiond4ec7I(PressGestureScope $this$handlePressInteraction_u2dd_u2d4ec7I, long offset, Continuation<? super Unit> $completion) {
        Object r0;
        MutableInteractionSource interactionSource2 = this.interactionSource;
        if (interactionSource2 == null || (r0 = ClickableKt.m1917handlePressInteractionEPk0efs($this$handlePressInteraction_u2dd_u2d4ec7I, offset, interactionSource2, this.interactionData, this.delayPressInteraction, $completion)) != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
