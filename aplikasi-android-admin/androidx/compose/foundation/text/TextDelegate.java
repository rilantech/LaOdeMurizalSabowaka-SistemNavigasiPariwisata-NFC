...
public final class TextDelegate {
    ...
    public final int m2654getOverflowgIe3tQ8() {
    ...
    private final MultiParagraph m2653layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        int maxWidth;
        int width;
        layoutIntrinsics(layoutDirection);
        int minWidth = Constraints.m7500getMinWidthimpl(constraints);
        boolean overwriteMaxLines = false;
        int i = 1;
        if (!(this.softWrap || TextOverflow.m7459equalsimpl0(this.overflow, TextOverflow.Companion.m7467getEllipsisgIe3tQ8())) || !Constraints.m7494getHasBoundedWidthimpl(constraints)) {
            maxWidth = Integer.MAX_VALUE;
        } else {
            maxWidth = Constraints.m7498getMaxWidthimpl(constraints);
        }
        if (!this.softWrap && TextOverflow.m7459equalsimpl0(this.overflow, TextOverflow.Companion.m7467getEllipsisgIe3tQ8())) {
        ...
        return new MultiParagraph(getNonNullIntrinsics(), ConstraintsKt.Constraints$default(0, width, 0, Constraints.m7497getMaxHeightimpl(constraints), 5, (Object) null), finalMaxLines, TextOverflow.m7459equalsimpl0(this.overflow, TextOverflow.Companion.m7467getEllipsisgIe3tQ8()), (DefaultConstructorMarker) null);
    }

    /* renamed from: layout-NN6Ew-U$default  reason: not valid java name */
    public static /* synthetic */ TextLayoutResult m2652layoutNN6EwU$default(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
        if ((i & 4) != 0) {
            textLayoutResult = null;
        }
        return textDelegate.m2655layoutNN6EwU(j, layoutDirection, textLayoutResult);
    }

    /* renamed from: layout-NN6Ew-U  reason: not valid java name */
    public final TextLayoutResult m2655layoutNN6EwU(long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResult) {
        long j = constraints;
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (prevResult != null) {
            if (TextLayoutHelperKt.m2688canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
