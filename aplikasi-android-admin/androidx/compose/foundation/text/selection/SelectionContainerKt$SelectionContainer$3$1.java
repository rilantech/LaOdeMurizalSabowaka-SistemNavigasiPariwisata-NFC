                    ...
                    if ((i2 & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        if (TouchMode_androidKt.isInTouchMode() && selectionManager.getHasFocus() && (selection = selectionManager.getSelection()) != null) {
                            ...
                            while (index$iv2 < size) {
                                ...
                                if (isStartHandle) {
                                    offset = selectionManager.m2808getStartHandlePosition_m7T9E();
                                } else {
                                    offset = selectionManager.m2807getEndHandlePosition_m7T9E();
                                }
