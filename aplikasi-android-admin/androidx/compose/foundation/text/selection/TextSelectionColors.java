...
public final class TextSelectionColors {
    ...
    public final long m2862getHandleColor0d7_KjU() {
        return this.handleColor;
    }

    /* renamed from: getBackgroundColor-0d7_KjU  reason: not valid java name */
    public final long m2861getBackgroundColor0d7_KjU() {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TextSelectionColors) && Color.m4964equalsimpl0(this.handleColor, ((TextSelectionColors) other).handleColor) && Color.m4964equalsimpl0(this.backgroundColor, ((TextSelectionColors) other).backgroundColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (Color.m4970hashCodeimpl(this.handleColor) * 31) + Color.m4970hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + Color.m4971toStringimpl(this.handleColor) + ", selectionBackgroundColor=" + Color.m4971toStringimpl(this.backgroundColor) + ')';
    }
}
