...
public final class SelectionManager$handleDragObserver$1 implements TextDragObserver {
    ...
    public void m2813onDownk4lQ0M(long point) {
        ...
        if (selection != null) {
            ...
            if (selectable != null && (beginLayoutCoordinates = selectable.getLayoutCoordinates()) != null) {
                long beginCoordinates = SelectionHandlesKt.m2783getAdjustedCoordinatesk4lQ0M(selectable.m2765getHandlePositiondBAh8RU(selection, this.$isStartHandle));
                SelectionManager selectionManager = this.this$0;
                selectionManager.m2797setCurrentDragPosition_kEHs6E(Offset.m4702boximpl(selectionManager.requireContainerCoordinates$foundation_release().m6361localPositionOfR5De75A(beginLayoutCoordinates, beginCoordinates)));
    ...
    public void m2815onStartk4lQ0M(long startPoint) {
        long j;
        ...
        if (this.$isStartHandle) {
            ...
            j = startSelectable.m2765getHandlePositiondBAh8RU(selection, true);
        } else {
            Intrinsics.checkNotNull(endSelectable);
            j = endSelectable.m2765getHandlePositiondBAh8RU(selection, false);
        }
        long beginCoordinates = SelectionHandlesKt.m2783getAdjustedCoordinatesk4lQ0M(j);
        SelectionManager selectionManager = this.this$0;
        selectionManager.m2798setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().m6361localPositionOfR5De75A(beginLayoutCoordinates, beginCoordinates));
        this.this$0.m2799setDragTotalDistancek4lQ0M(Offset.Companion.m4729getZeroF1C5BW0());
    }

    /* renamed from: onDrag-k-4lQ0M  reason: not valid java name */
    public void m2814onDragk4lQ0M(long delta) {
        SelectionManager selectionManager = this.this$0;
        selectionManager.m2799setDragTotalDistancek4lQ0M(Offset.m4718plusMKHz9U(selectionManager.m2806getDragTotalDistanceF1C5BW0$foundation_release(), delta));
        long endPosition = Offset.m4718plusMKHz9U(this.this$0.m2805getDragBeginPositionF1C5BW0$foundation_release(), this.this$0.m2806getDragTotalDistanceF1C5BW0$foundation_release());
        if (this.this$0.m2810updateSelectionRHHTvR4$foundation_release(Offset.m4702boximpl(endPosition), Offset.m4702boximpl(this.this$0.m2805getDragBeginPositionF1C5BW0$foundation_release()), this.$isStartHandle, SelectionAdjustment.Companion.getCharacterWithWordAccelerate())) {
            this.this$0.m2798setDragBeginPositionk4lQ0M(endPosition);
            this.this$0.m2799setDragTotalDistancek4lQ0M(Offset.Companion.m4729getZeroF1C5BW0());
        }
    }
