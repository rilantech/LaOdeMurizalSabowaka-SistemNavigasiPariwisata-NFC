...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager2) {
        ...
        this.dragBeginPosition = Offset.Companion.m4729getZeroF1C5BW0();
    ...
    public final void m2838setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition$delegate.setValue(offset);
    }

    /* renamed from: getCurrentDragPosition-_m7T9-E  reason: not valid java name */
    public final Offset m2841getCurrentDragPosition_m7T9E() {
    ...
    public static /* synthetic */ void m2837deselect_kEHs6E$foundation_release$default(TextFieldSelectionManager textFieldSelectionManager, Offset offset, int i, Object obj) {
        if ((i & 1) != 0) {
            offset = null;
        }
        textFieldSelectionManager.m2840deselect_kEHs6E$foundation_release(offset);
    }

    /* renamed from: deselect-_kEHs6E$foundation_release  reason: not valid java name */
    public final void m2840deselect_kEHs6E$foundation_release(Offset position) {
        HandleState selectionMode;
        int newCursorOffset;
        if (!TextRange.m7029getCollapsedimpl(getValue$foundation_release().m7265getSelectiond9O1mEE())) {
            TextFieldState textFieldState = this.state;
            ...
            if (position == null || layoutResult == null) {
                newCursorOffset = TextRange.m7032getMaximpl(getValue$foundation_release().m7265getSelectiond9O1mEE());
            } else {
                newCursorOffset = this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m2690getOffsetForPosition3MmeM6k$default(layoutResult, position.m4723unboximpl(), false, 2, (Object) null));
            }
            this.onValueChange.invoke(TextFieldValue.m7260copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange(newCursorOffset), (TextRange) null, 5, (Object) null));
        }
        if (position != null) {
    ...
    public final void copy$foundation_release(boolean cancelSelection) {
        if (!TextRange.m7029getCollapsedimpl(getValue$foundation_release().m7265getSelectiond9O1mEE())) {
            ...
            if (cancelSelection) {
                int newCursorOffset = TextRange.m7032getMaximpl(getValue$foundation_release().m7265getSelectiond9O1mEE());
                this.onValueChange.invoke(m2836createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(newCursorOffset, newCursorOffset)));
                setHandleState(HandleState.None);
            }
        }
    }
    ...
    public final void paste$foundation_release() {
        ...
        if (clipboardManager2 != null && (text = clipboardManager2.getText()) != null) {
            ...
            int newCursorOffset = TextRange.m7033getMinimpl(getValue$foundation_release().m7265getSelectiond9O1mEE()) + text.length();
            this.onValueChange.invoke(m2836createTextFieldValueFDrldGo(newText, TextRangeKt.TextRange(newCursorOffset, newCursorOffset)));
            setHandleState(HandleState.None);
    ...
    public final void cut$foundation_release() {
        if (!TextRange.m7029getCollapsedimpl(getValue$foundation_release().m7265getSelectiond9O1mEE())) {
            ...
            int newCursorOffset = TextRange.m7033getMinimpl(getValue$foundation_release().m7265getSelectiond9O1mEE());
            this.onValueChange.invoke(m2836createTextFieldValueFDrldGo(newText, TextRangeKt.TextRange(newCursorOffset, newCursorOffset)));
            setHandleState(HandleState.None);
            UndoManager undoManager2 = this.undoManager;
            if (undoManager2 != null) {
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue newValue = m2836createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(newValue);
        this.oldValue = TextFieldValue.m7260copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, newValue.m7265getSelectiond9O1mEE(), (TextRange) null, 5, (Object) null);
        TextFieldState textFieldState = this.state;
        if (textFieldState != null) {
    ...
    public final long m2843getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        long r0 = getValue$foundation_release().m7265getSelectiond9O1mEE();
        int offset = isStartHandle ? TextRange.m7035getStartimpl(r0) : TextRange.m7030getEndimpl(r0);
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult.getValue(), this.offsetMapping.originalToTransformed(offset), isStartHandle, TextRange.m7034getReversedimpl(getValue$foundation_release().m7265getSelectiond9O1mEE()));
    }

    /* renamed from: getCursorPosition-tuRUvjQ$foundation_release  reason: not valid java name */
    public final long m2842getCursorPositiontuRUvjQ$foundation_release(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        int offset = this.offsetMapping.originalToTransformed(TextRange.m7035getStartimpl(getValue$foundation_release().m7265getSelectiond9O1mEE()));
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        ...
        return OffsetKt.Offset(cursorRect.getLeft() + (density.m7535toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness()) / ((float) 2)), cursorRect.getBottom());
    }
    ...
    public final void showSelectionToolbar$foundation_release() {
        /*
            ...
            long r1 = r1.m7265getSelectiond9O1mEE()
            boolean r1 = androidx.compose.ui.text.TextRange.m7029getCollapsedimpl(r1)
            r2 = 0
        ...
        L_0x001f:
            androidx.compose.ui.text.input.TextFieldValue r1 = r9.getValue$foundation_release()
            long r3 = r1.m7265getSelectiond9O1mEE()
            boolean r1 = androidx.compose.ui.text.TextRange.m7029getCollapsedimpl(r3)
        ...
        L_0x0060:
            androidx.compose.ui.text.input.TextFieldValue r1 = r9.getValue$foundation_release()
            long r3 = r1.m7265getSelectiond9O1mEE()
            int r1 = androidx.compose.ui.text.TextRange.m7031getLengthimpl(r3)
    ...
    public final void m2839contextMenuOpenAdjustmentk4lQ0M(long position) {
        TextLayoutResultProxy layoutResult;
        TextFieldState textFieldState = this.state;
        if (textFieldState != null && (layoutResult = textFieldState.getLayoutResult()) != null) {
            int offset = TextLayoutResultProxy.m2690getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, (Object) null);
            if (!TextRange.m7026containsimpl(getValue$foundation_release().m7265getSelectiond9O1mEE(), offset)) {
    ...
    private final androidx.compose.ui.geometry.Rect getContentRect() {
        ...
        L_0x0013:
            ...
            long r5 = r5.m7265getSelectiond9O1mEE()
            int r5 = androidx.compose.ui.text.TextRange.m7035getStartimpl(r5)
            ...
            long r6 = r6.m7265getSelectiond9O1mEE()
            int r6 = androidx.compose.ui.text.TextRange.m7030getEndimpl(r6)
            ...
            if (r6 == 0) goto L_0x004d
            long r7 = r0.m2843getHandlePositiontuRUvjQ$foundation_release(r2)
            long r6 = r6.m6362localToRootMKHz9U(r7)
            goto L_0x0053
        L_0x004d:
            androidx.compose.ui.geometry.Offset$Companion r2 = androidx.compose.ui.geometry.Offset.Companion
            long r6 = r2.m4729getZeroF1C5BW0()
        L_0x0053:
            ...
            if (r2 == 0) goto L_0x0069
            r8 = 0
            long r8 = r0.m2843getHandlePositiontuRUvjQ$foundation_release(r8)
            long r8 = r2.m6362localToRootMKHz9U(r8)
            goto L_0x006f
        L_0x0069:
            androidx.compose.ui.geometry.Offset$Companion r2 = androidx.compose.ui.geometry.Offset.Companion
            long r8 = r2.m4729getZeroF1C5BW0()
        L_0x006f:
            androidx.compose.foundation.text.TextFieldState r2 = r0.state
            r10 = 0
        ...
        L_0x0095:
            ...
            long r11 = r2.m6362localToRootMKHz9U(r11)
            float r2 = androidx.compose.ui.geometry.Offset.m4714getYimpl(r11)
            goto L_0x00a5
        L_0x00a4:
            r2 = r10
        L_0x00a5:
        ...
        L_0x00ca:
            ...
            long r10 = r11.m6362localToRootMKHz9U(r12)
            float r10 = androidx.compose.ui.geometry.Offset.m4714getYimpl(r10)
            goto L_0x00da
        L_0x00d9:
        L_0x00da:
            float r11 = androidx.compose.ui.geometry.Offset.m4713getXimpl(r6)
            float r12 = androidx.compose.ui.geometry.Offset.m4713getXimpl(r8)
            float r11 = java.lang.Math.min(r11, r12)
            float r12 = androidx.compose.ui.geometry.Offset.m4713getXimpl(r6)
            float r13 = androidx.compose.ui.geometry.Offset.m4713getXimpl(r8)
            float r12 = java.lang.Math.max(r12, r13)
            float r13 = java.lang.Math.min(r2, r10)
            float r14 = androidx.compose.ui.geometry.Offset.m4714getYimpl(r6)
            float r15 = androidx.compose.ui.geometry.Offset.m4714getYimpl(r8)
            float r14 = java.lang.Math.max(r14, r15)
            r15 = 25
            r16 = 0
            float r0 = (float) r15
            float r0 = androidx.compose.ui.unit.Dp.m7554constructorimpl(r0)
    ...
    public final void updateSelection(androidx.compose.ui.text.input.TextFieldValue r11, int r12, int r13, boolean r14, androidx.compose.foundation.text.selection.SelectionAdjustment r15) {
        /*
            ...
            long r1 = r11.m7265getSelectiond9O1mEE()
            int r1 = androidx.compose.ui.text.TextRange.m7035getStartimpl(r1)
            int r0 = r0.originalToTransformed(r1)
            androidx.compose.ui.text.input.OffsetMapping r1 = r10.offsetMapping
            long r2 = r11.m7265getSelectiond9O1mEE()
        ...
        L_0x0031:
            r4 = r3
        L_0x0032:
            boolean r2 = androidx.compose.ui.text.TextRange.m7029getCollapsedimpl(r0)
            if (r2 == 0) goto L_0x003b
            goto L_0x003f
        L_0x003b:
            androidx.compose.ui.text.TextRange r3 = androidx.compose.ui.text.TextRange.m7023boximpl(r0)
        L_0x003f:
            r7 = r3
            r5 = r12
            r6 = r13
            r8 = r14
            r9 = r15
            long r2 = androidx.compose.foundation.text.selection.TextFieldSelectionDelegateKt.m2833getTextFieldSelectionbb3KNj8(r4, r5, r6, r7, r8, r9)
            androidx.compose.ui.text.input.OffsetMapping r4 = r10.offsetMapping
            int r5 = androidx.compose.ui.text.TextRange.m7035getStartimpl(r2)
            int r4 = r4.transformedToOriginal(r5)
            androidx.compose.ui.text.input.OffsetMapping r5 = r10.offsetMapping
            int r6 = androidx.compose.ui.text.TextRange.m7030getEndimpl(r2)
            int r5 = r5.transformedToOriginal(r6)
            long r4 = androidx.compose.ui.text.TextRangeKt.TextRange(r4, r5)
            long r6 = r11.m7265getSelectiond9O1mEE()
            boolean r6 = androidx.compose.ui.text.TextRange.m7028equalsimpl0(r4, r6)
        ...
        L_0x006d:
            ...
            int r7 = r7.m5712getTextHandleMove5zf0vsI()
            r6.m5703performHapticFeedbackCdsT49E(r7)
        L_0x007a:
            androidx.compose.ui.text.AnnotatedString r6 = r11.getAnnotatedString()
            androidx.compose.ui.text.input.TextFieldValue r6 = r10.m2836createTextFieldValueFDrldGo(r6, r4)
    ...
    public final TextFieldValue m2836createTextFieldValueFDrldGo(AnnotatedString annotatedString, long selection) {
