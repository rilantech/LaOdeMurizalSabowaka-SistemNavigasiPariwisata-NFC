...
public final class SelectionHandleInfo {
    ...
    public static /* synthetic */ SelectionHandleInfo m2779copyUv8p0NA$default(SelectionHandleInfo selectionHandleInfo, Handle handle2, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return selectionHandleInfo.m2781copyUv8p0NA(handle2, j);
    }
    ...
    public final long m2780component2F1C5BW0() {
        return this.position;
    }

    /* renamed from: copy-Uv8p0NA  reason: not valid java name */
    public final SelectionHandleInfo m2781copyUv8p0NA(Handle handle2, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.handle == selectionHandleInfo.handle && Offset.m4710equalsimpl0(this.position, selectionHandleInfo.position);
    }

    public int hashCode() {
        return (this.handle.hashCode() * 31) + Offset.m4715hashCodeimpl(this.position);
    }

    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + Offset.m4721toStringimpl(this.position) + ')';
    }
    ...
    public final long m2782getPositionF1C5BW0() {
        return this.position;
    }
}
