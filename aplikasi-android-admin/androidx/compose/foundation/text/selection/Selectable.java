...
public interface Selectable {
    ...
    long m2765getHandlePositiondBAh8RU(Selection selection, boolean z);
    ...
    long m2766getRangeOfLineContainingjx7JFs(int i);
    ...
    Pair<Selection, Boolean> m2767updateSelectionqCDeeow(long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection);

    /* renamed from: updateSelection-qCDeeow$default  reason: not valid java name */
    static /* synthetic */ Pair m2764updateSelectionqCDeeow$default(Selectable selectable, long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection, int i, Object obj) {
        boolean z2;
        if (obj == null) {
            if ((i & 8) != 0) {
                z2 = true;
            ...
            return selectable.m2767updateSelectionqCDeeow(j, j2, offset, z2, layoutCoordinates, selectionAdjustment, (i & 64) != 0 ? null : selection);
        }
