...
public final class TextFieldSelectionDelegateKt {
    ...
    public static final long m2833getTextFieldSelectionbb3KNj8(TextLayoutResult textLayoutResult, int rawStartOffset, int rawEndOffset, TextRange previousSelection, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        if (previousSelection != null || !Intrinsics.areEqual((Object) selectionAdjustment, (Object) SelectionAdjustment.Companion.getCharacter())) {
            return adjustment.m2769adjustZXO7KMw(textLayoutResult, textRange, -1, isStartHandle, previousSelection);
        }
        return textRange;
    }
}
