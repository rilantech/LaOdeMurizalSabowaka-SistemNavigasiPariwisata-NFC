...
public enum SelectionMode {
    ...
    public abstract int m2824compare3MmeM6k$foundation_release(long j, Rect rect);
    ...
    static final class Vertical extends SelectionMode {
        ...
        /* renamed from: compare-3MmeM6k$foundation_release  reason: not valid java name */
        public int m2827compare3MmeM6k$foundation_release(long position, Rect bounds) {
            Intrinsics.checkNotNullParameter(bounds, "bounds");
            if (bounds.m4739containsk4lQ0M(position)) {
                return 0;
            }
            if (Offset.m4714getYimpl(position) < bounds.getTop()) {
                return -1;
            }
            if (Offset.m4713getXimpl(position) >= bounds.getLeft() || Offset.m4714getYimpl(position) >= bounds.getBottom()) {
                return 1;
            }
            return -1;
        }
    ...
    static final class Horizontal extends SelectionMode {
        ...
        /* renamed from: compare-3MmeM6k$foundation_release  reason: not valid java name */
        public int m2826compare3MmeM6k$foundation_release(long position, Rect bounds) {
            Intrinsics.checkNotNullParameter(bounds, "bounds");
            if (bounds.m4739containsk4lQ0M(position)) {
                return 0;
            }
            if (Offset.m4713getXimpl(position) < bounds.getLeft()) {
                return -1;
            }
            if (Offset.m4714getYimpl(position) >= bounds.getTop() || Offset.m4713getXimpl(position) >= bounds.getRight()) {
                return 1;
            }
            return -1;
        }
    ...
    public final boolean m2825isSelected2x9bVx0$foundation_release(Rect bounds, long start, long end) {
        Intrinsics.checkNotNullParameter(bounds, "bounds");
        boolean z = true;
        if (bounds.m4739containsk4lQ0M(start) || bounds.m4739containsk4lQ0M(end)) {
            return true;
        }
        int compareStart = m2824compare3MmeM6k$foundation_release(start, bounds);
        int compareEnd = m2824compare3MmeM6k$foundation_release(end, bounds);
