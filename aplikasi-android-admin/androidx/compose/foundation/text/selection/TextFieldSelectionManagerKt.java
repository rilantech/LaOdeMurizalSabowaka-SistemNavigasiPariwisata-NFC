...
public final class TextFieldSelectionManagerKt {
    ...
    public static final boolean isSelectionHandleInVisibleBound(TextFieldSelectionManager $this$isSelectionHandleInVisibleBound, boolean isStartHandle) {
        ...
        return SelectionManagerKt.m2819containsInclusiveUv8p0NA(visibleBounds, $this$isSelectionHandleInVisibleBound.m2843getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
    }

    /* renamed from: calculateSelectionMagnifierCenterAndroid-O0kMr_c  reason: not valid java name */
    public static final long m2857calculateSelectionMagnifierCenterAndroidO0kMr_c(TextFieldSelectionManager manager, long magnifierSize) {
        int rawTextOffset;
        ...
        switch (draggingHandle == null ? -1 : WhenMappings.$EnumSwitchMapping$0[draggingHandle.ordinal()]) {
            ...
            case 1:
            case 2:
                rawTextOffset = TextRange.m7035getStartimpl(manager.getValue$foundation_release().m7265getSelectiond9O1mEE());
                break;
            case 3:
                rawTextOffset = TextRange.m7030getEndimpl(manager.getValue$foundation_release().m7265getSelectiond9O1mEE());
                break;
            default:
            ...
            if (layoutResult3 == null) {
                ...
                if (state$foundation_release2 == null || (textDelegate = state$foundation_release2.getTextDelegate()) == null) {
                    ...
                    if (transformedText == null) {
                        ...
                        long offsetCenter = layoutResult3.getBoundingBox(textOffset2).m4743getCenterF1C5BW0();
                            ...
                            if (containerCoordinates == null) {
                                ...
                                if (state$foundation_release4 == null || (layoutResult2 = state$foundation_release4.getLayoutResult()) == null) {
                                    ...
                                    if (fieldCoordinates == null) {
                                        ...
                                        Offset r11 = manager.m2841getCurrentDragPosition_m7T9E();
                                        if (r11 != null) {
                                            float dragX = Offset.m4713getXimpl(fieldCoordinates.m6361localPositionOfR5De75A(containerCoordinates, r11.m4723unboximpl()));
                                            ...
                                            boolean areHandlesCrossed = TextRange.m7035getStartimpl(manager.getValue$foundation_release().m7265getSelectiond9O1mEE()) > TextRange.m7030getEndimpl(manager.getValue$foundation_release().m7265getSelectiond9O1mEE());
                                            ...
                                            float f2 = lineMin;
                                            if (Math.abs(dragX - centerX) > ((float) (IntSize.m7714getWidthimpl(magnifierSize) / 2))) {
                                                return Offset.Companion.m4728getUnspecifiedF1C5BW0();
                                            }
                                            float f3 = lineMax;
                                            float f4 = lineStart;
                                            return containerCoordinates.m6361localPositionOfR5De75A(fieldCoordinates, OffsetKt.Offset(centerX, Offset.m4714getYimpl(offsetCenter)));
                                        }
                                        return Offset.Companion.m4728getUnspecifiedF1C5BW0();
                                    }
                                }
