...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final long m2748getOriginalSelectiond9O1mEE() {
    ...
    public final long m2749getSelectiond9O1mEE() {
        return this.selection;
    }

    /* renamed from: setSelection-5zc-tL8  reason: not valid java name */
    public final void m2750setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final T deselect() {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            $this$deselect_u24lambda_u241.setCursor(TextRange.m7030getEndimpl($this$deselect_u24lambda_u241.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            if (TextRange.m7029getCollapsedimpl($this$collapseLeftOr_u24lambda_u244.selection)) {
                ...
                $this$collapseLeftOr_u24lambda_u244.setCursor(TextRange.m7033getMinimpl($this$collapseLeftOr_u24lambda_u244.selection));
            } else {
                $this$collapseLeftOr_u24lambda_u244.setCursor(TextRange.m7032getMaximpl($this$collapseLeftOr_u24lambda_u244.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final T collapseRightOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            if (TextRange.m7029getCollapsedimpl($this$collapseRightOr_u24lambda_u245.selection)) {
                ...
                $this$collapseRightOr_u24lambda_u245.setCursor(TextRange.m7032getMaximpl($this$collapseRightOr_u24lambda_u245.selection));
            } else {
                $this$collapseRightOr_u24lambda_u245.setCursor(TextRange.m7033getMinimpl($this$collapseRightOr_u24lambda_u245.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m7030getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m7030getEndimpl(this.selection));
    }
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            ...
            $this$selectMovement_u24lambda_u2428.selection = TextRangeKt.TextRange(TextRange.m7035getStartimpl($this$selectMovement_u24lambda_u2428.originalSelection), TextRange.m7030getEndimpl($this$selectMovement_u24lambda_u2428.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult $this$getNextWordOffsetForLayout, int currentOffset) {
        while (currentOffset < this.originalText.length()) {
            long currentWord = $this$getNextWordOffsetForLayout.m7009getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m7030getEndimpl(currentWord) > currentOffset) {
                return this.offsetMapping.transformedToOriginal(TextRange.m7030getEndimpl(currentWord));
            }
            currentOffset++;
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult $this$getPrevWordOffset, int currentOffset) {
        while (currentOffset > 0) {
            long currentWord = $this$getPrevWordOffset.m7009getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m7035getStartimpl(currentWord) < currentOffset) {
                return this.offsetMapping.transformedToOriginal(TextRange.m7035getStartimpl(currentWord));
            }
            currentOffset--;
        }
        return 0;
    ...
    private final int jumpByLinesOffset(TextLayoutResult $this$jumpByLinesOffset, int linesAmount) {
        ...
        return this.offsetMapping.transformedToOriginal($this$jumpByLinesOffset.m7007getOffsetForPositionk4lQ0M(OffsetKt.Offset(number.floatValue(), y)));
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m7030getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m7033getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m7032getMaximpl(this.selection));
    }
    ...
    private final int getParagraphStart() {
        return StringHelpersKt.findParagraphStart(getText$foundation_release(), TextRange.m7033getMinimpl(this.selection));
    }

    private final int getParagraphEnd() {
        return StringHelpersKt.findParagraphEnd(getText$foundation_release(), TextRange.m7032getMaximpl(this.selection));
    }
