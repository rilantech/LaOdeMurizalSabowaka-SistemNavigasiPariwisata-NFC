...
public final class SelectionManager_androidKt {
    ...
    public static final boolean m2820isCopyKeyEventZmokQxo(KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        return KeyMapping_androidKt.getPlatformDefaultKeyMapping().m2612mapZmokQxo(keyEvent) == KeyCommand.COPY;
    }
    ...
    public static final Modifier selectionMagnifier(Modifier $this$selectionMagnifier, SelectionManager manager) {
        ...
        return ComposedModifierKt.composed$default($this$selectionMagnifier, (Function1) null, new SelectionManager_androidKt$selectionMagnifier$1(manager), 1, (Object) null);
    }
}
