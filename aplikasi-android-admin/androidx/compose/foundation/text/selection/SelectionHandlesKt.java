...
public final class SelectionHandlesKt {
    private static final float HandleHeight = Dp.m7554constructorimpl((float) 25);
    private static final float HandleWidth = Dp.m7554constructorimpl((float) 25);
    ...
    public static final long m2783getAdjustedCoordinatesk4lQ0M(long position) {
        return OffsetKt.Offset(Offset.m4713getXimpl(position), Offset.m4714getYimpl(position) - 1.0f);
    }
}
