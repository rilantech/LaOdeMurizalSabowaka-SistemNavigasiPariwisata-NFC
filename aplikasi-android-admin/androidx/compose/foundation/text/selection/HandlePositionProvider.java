...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    public long m2751calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        Intrinsics.checkNotNullParameter(anchorBounds, "anchorBounds");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        switch (WhenMappings.$EnumSwitchMapping$0[this.handleReferencePoint.ordinal()]) {
            case 1:
                return IntOffsetKt.IntOffset(anchorBounds.getLeft() + IntOffset.m7672getXimpl(this.offset), anchorBounds.getTop() + IntOffset.m7673getYimpl(this.offset));
            case 2:
                return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m7672getXimpl(this.offset)) - IntSize.m7714getWidthimpl(popupContentSize), anchorBounds.getTop() + IntOffset.m7673getYimpl(this.offset));
            case 3:
                return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m7672getXimpl(this.offset)) - (IntSize.m7714getWidthimpl(popupContentSize) / 2), anchorBounds.getTop() + IntOffset.m7673getYimpl(this.offset));
            default:
