...
final class TextFieldSelectionManager_androidKt$textFieldMagnifier$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
        ...
        if (it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m7706boximpl(IntSize.Companion.m7719getZeroYbymL2g()), (SnapshotMutationPolicy) null, 2, (Object) null);
        ...
        Function0 r2 = new Function0<Offset>() {
            public /* bridge */ /* synthetic */ Object invoke() {
                return Offset.m4702boximpl(m2858invokeF1C5BW0());
            }

            /* renamed from: invoke-F1C5BW0  reason: not valid java name */
            public final long m2858invokeF1C5BW0() {
                return TextFieldSelectionManagerKt.m2857calculateSelectionMagnifierCenterAndroidO0kMr_c(textFieldSelectionManager, TextFieldSelectionManager_androidKt$textFieldMagnifier$1.invoke$lambda$1(magnifierSize$delegate));
            }
        };
    ...
    public static final long invoke$lambda$1(MutableState<IntSize> $magnifierSize$delegate) {
        return ((IntSize) $magnifierSize$delegate.getValue()).m7718unboximpl();
    }

    /* access modifiers changed from: private */
    public static final void invoke$lambda$2(MutableState<IntSize> $magnifierSize$delegate, long value) {
        $magnifierSize$delegate.setValue(IntSize.m7706boximpl(value));
    }
}
