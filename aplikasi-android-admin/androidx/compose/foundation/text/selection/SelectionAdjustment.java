...
public interface SelectionAdjustment {
    ...
    long m2769adjustZXO7KMw(TextLayoutResult textLayoutResult, long j, int i, boolean z, TextRange textRange);
    ...
    public static final class Companion {
        ...
        public final long m2771adjustByBoundaryDvylE(TextLayoutResult textLayoutResult, long newRawSelection, Function1<? super Integer, TextRange> boundaryFun) {
            ...
            long startBoundary = boundaryFun.invoke(Integer.valueOf(RangesKt.coerceIn(TextRange.m7035getStartimpl(newRawSelection), 0, maxOffset))).m7039unboximpl();
            long endBoundary = boundaryFun.invoke(Integer.valueOf(RangesKt.coerceIn(TextRange.m7030getEndimpl(newRawSelection), 0, maxOffset))).m7039unboximpl();
            return TextRangeKt.TextRange(TextRange.m7034getReversedimpl(newRawSelection) ? TextRange.m7030getEndimpl(startBoundary) : TextRange.m7035getStartimpl(startBoundary), TextRange.m7034getReversedimpl(newRawSelection) ? TextRange.m7035getStartimpl(endBoundary) : TextRange.m7030getEndimpl(endBoundary));
        }
