...
public final class TextFieldSelectionManager$cursorDragObserver$1 implements TextDragObserver {
    ...
    public void m2844onDownk4lQ0M(long point) {
        this.this$0.setDraggingHandle(Handle.Cursor);
        TextFieldSelectionManager textFieldSelectionManager = this.this$0;
        textFieldSelectionManager.m2838setCurrentDragPosition_kEHs6E(Offset.m4702boximpl(SelectionHandlesKt.m2783getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m2843getHandlePositiontuRUvjQ$foundation_release(true))));
    }
    ...
    public void m2846onStartk4lQ0M(long startPoint) {
        TextFieldSelectionManager textFieldSelectionManager = this.this$0;
        textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m2783getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m2843getHandlePositiontuRUvjQ$foundation_release(true));
    ...
    public void m2845onDragk4lQ0M(long delta) {
        ...
        if (state$foundation_release != null && (layoutResult = state$foundation_release.getLayoutResult()) != null && (layoutResult2 = layoutResult.getValue()) != null) {
            ...
            Offset r4 = textFieldSelectionManager2.m2841getCurrentDragPosition_m7T9E();
            Intrinsics.checkNotNull(r4);
            int offset = offsetMapping$foundation_release.transformedToOriginal(layoutResult2.m7007getOffsetForPositionk4lQ0M(r4.m4723unboximpl()));
            long newSelection = TextRangeKt.TextRange(offset, offset);
            if (!TextRange.m7028equalsimpl0(newSelection, textFieldSelectionManager2.getValue$foundation_release().m7265getSelectiond9O1mEE())) {
                ...
                textFieldSelectionManager2.getOnValueChange$foundation_release().invoke(textFieldSelectionManager2.m2836createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getAnnotatedString(), newSelection));
            }
        }
    }
