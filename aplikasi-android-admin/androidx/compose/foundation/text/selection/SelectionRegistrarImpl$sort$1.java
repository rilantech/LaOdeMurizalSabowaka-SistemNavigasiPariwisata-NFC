...
final class SelectionRegistrarImpl$sort$1 extends Lambda implements Function2<Selectable, Selectable, Integer> {
    ...
    public final Integer invoke(Selectable a, Selectable b) {
        ...
        if (layoutCoordinatesA != null) {
            positionA = this.$containerLayoutCoordinates.m6361localPositionOfR5De75A(layoutCoordinatesA, Offset.Companion.m4729getZeroF1C5BW0());
        } else {
            positionA = Offset.Companion.m4729getZeroF1C5BW0();
        }
        if (layoutCoordinatesB != null) {
            positionB = this.$containerLayoutCoordinates.m6361localPositionOfR5De75A(layoutCoordinatesB, Offset.Companion.m4729getZeroF1C5BW0());
        } else {
            positionB = Offset.Companion.m4729getZeroF1C5BW0();
        }
        if (Offset.m4714getYimpl(positionA) == Offset.m4714getYimpl(positionB)) {
            i = ComparisonsKt.compareValues(Float.valueOf(Offset.m4713getXimpl(positionA)), Float.valueOf(Offset.m4713getXimpl(positionB)));
        } else {
            i = ComparisonsKt.compareValues(Float.valueOf(Offset.m4714getYimpl(positionA)), Float.valueOf(Offset.m4714getYimpl(positionB)));
        }
