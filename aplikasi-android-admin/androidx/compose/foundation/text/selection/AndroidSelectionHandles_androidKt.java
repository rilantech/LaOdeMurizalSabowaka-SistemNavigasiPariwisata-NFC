...
public final class AndroidSelectionHandles_androidKt {
    ...
    public static final void m2747SelectionHandle8fL75g(long position, boolean isStartHandle, ResolvedTextDirection direction, boolean handlesCrossed, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        Composer $composer2;
        ...
        if ((374491 & $dirty2) != 74898 || !$composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            m2746HandlePopupULxng0E(position, handleReferencePoint, ComposableLambdaKt.composableLambda($composer3, 732099485, true, androidSelectionHandles_androidKt$SelectionHandle$1), $composer2, ($dirty3 & 14) | 384);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void DefaultSelectionHandle(Modifier modifier, boolean isStartHandle, ResolvedTextDirection direction, boolean handlesCrossed, Composer $composer, int $changed) {
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m2324sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), isStartHandle, direction, handlesCrossed), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope $this$createHandleImage, float radius) {
        ...
        if (imageBitmap2 == null || canvas2 == null || edge > imageBitmap2.getWidth() || edge > imageBitmap2.getHeight()) {
            ImageBitmap imageBitmap3 = ImageBitmapKt.m5187ImageBitmapx__hDU$default(edge, edge, ImageBitmapConfig.Companion.m5181getAlpha8_sVssgQ(), false, (ColorSpace) null, 24, (Object) null);
        ...
        $this$draw_yzxVdVo_u24lambda_u240$iv.m5479setSizeuvyYCjk(size$iv);
        canvas.save();
        DrawScope $this$createHandleImage_u24lambda_u240 = this_$iv;
        DrawScope drawScope4 = $this$createHandleImage_u24lambda_u240;
        DrawScope.m5552drawRectnJ9OG0$default(drawScope4, Color.Companion.m4989getBlack0d7_KjU(), 0, $this$createHandleImage_u24lambda_u240.m5576getSizeNHjbRc(), 0.0f, (DrawStyle) null, (ColorFilter) null, BlendMode.Companion.m4869getClear0nO6VwU(), 58, (Object) null);
        DrawScope.m5552drawRectnJ9OG0$default(drawScope4, ColorKt.Color(4278190080L), Offset.Companion.m4729getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(f, f), 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 120, (Object) null);
        LayoutDirection layoutDirection2 = layoutDirection$iv;
        long j = size$iv;
        DrawScope.m5539drawCircleVaOC9Bg$default($this$createHandleImage_u24lambda_u240, ColorKt.Color(4278190080L), radius, OffsetKt.Offset(f, f), 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 120, (Object) null);
        canvas.restore();
    ...
    public static final void m2746HandlePopupULxng0E(long r25, androidx.compose.foundation.text.selection.HandleReferencePoint r27, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r28, androidx.compose.runtime.Composer r29, int r30) {
        /*
            r6 = r27
            r14 = r28
            r15 = r30
        ...
        L_0x0072:
            float r0 = androidx.compose.ui.geometry.Offset.m4713getXimpl(r25)
            int r0 = kotlin.math.MathKt.roundToInt((float) r0)
            float r2 = androidx.compose.ui.geometry.Offset.m4714getYimpl(r25)
            int r2 = kotlin.math.MathKt.roundToInt((float) r2)
            long r12 = androidx.compose.ui.unit.IntOffsetKt.IntOffset(r0, r2)
            androidx.compose.ui.unit.IntOffset r0 = androidx.compose.ui.unit.IntOffset.m7663boximpl(r12)
            int r2 = r1 >> 3
            r2 = r2 & 14
            r7 = 0
        ...
        L_0x012e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt.m2746HandlePopupULxng0E(long, androidx.compose.foundation.text.selection.HandleReferencePoint, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int):void");
    }
