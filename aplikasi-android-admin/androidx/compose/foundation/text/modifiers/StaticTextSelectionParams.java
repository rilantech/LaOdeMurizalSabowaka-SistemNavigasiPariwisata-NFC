...
public class StaticTextSelectionParams {
    ...
    public Path getPathForRange(int start, int end) {
        ...
        if (textLayoutResult2 != null) {
            return textLayoutResult2.getPathForRange(start, end);
        }
        return null;
    }

    /* JADX WARNING: Code restructure failed: missing block: B:2:0x0004, code lost:
        r0 = r0.getLayoutInput();
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean getShouldClip() {
        /*
            r2 = this;
            androidx.compose.ui.text.TextLayoutResult r0 = r2.textLayoutResult
            if (r0 == 0) goto L_0x0013
            androidx.compose.ui.text.TextLayoutInput r0 = r0.getLayoutInput()
            if (r0 == 0) goto L_0x0013
            int r0 = r0.m7004getOverflowgIe3tQ8()
            androidx.compose.ui.text.style.TextOverflow r0 = androidx.compose.ui.text.style.TextOverflow.m7456boximpl(r0)
            goto L_0x0014
        L_0x0013:
            r0 = 0
        L_0x0014:
            androidx.compose.ui.text.style.TextOverflow$Companion r1 = androidx.compose.ui.text.style.TextOverflow.Companion
            int r1 = r1.m7468getVisiblegIe3tQ8()
            if (r0 != 0) goto L_0x001e
            r0 = 0
            goto L_0x0026
        L_0x001e:
            int r0 = r0.m7462unboximpl()
            boolean r0 = androidx.compose.ui.text.style.TextOverflow.m7459equalsimpl0(r0, r1)
        L_0x0026:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.modifiers.StaticTextSelectionParams.getShouldClip():boolean");
    }
