...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String text2, TextStyle style2, FontFamily.Resolver fontFamilyResolver2, int overflow2, boolean softWrap2, int maxLines2, int minLines2) {
        ...
        this.lastDensity = InlineDensity.Companion.m2709getUnspecifiedL26CHvs();
        this.layoutSize = IntSizeKt.IntSize(0, 0);
        this.prevConstraints = Constraints.Companion.m7506fixedJhjzzOo(0, 0);
    ...
    public final void setDensity$foundation_release(Density value) {
        ...
        long newDensity = value != null ? InlineDensity.m2701constructorimpl(value) : InlineDensity.Companion.m2709getUnspecifiedL26CHvs();
        if (localField == null) {
            this.density = value;
            this.lastDensity = newDensity;
        } else if (value == null || !InlineDensity.m2703equalsimpl0(this.lastDensity, newDensity)) {
            this.density = value;
            this.lastDensity = newDensity;
            markDirty();
        }
    ...
    public final long m2723getLayoutSizeYbymL2g$foundation_release() {
        return this.layoutSize;
    }

    /* renamed from: setLayoutSize-ozmzZPI$foundation_release  reason: not valid java name */
    public final void m2725setLayoutSizeozmzZPI$foundation_release(long j) {
        this.layoutSize = j;
    }

    /* renamed from: layoutWithConstraints-K40F9xA  reason: not valid java name */
    public final boolean m2724layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (this.minLines > 1) {
            ...
            finalConstraints = localMin.m2713coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        } else {
            finalConstraints = constraints;
        }
        boolean z2 = false;
        if (!m2722newLayoutWillBeDifferentK40F9xA(finalConstraints, layoutDirection)) {
            if (!Constraints.m7491equalsimpl0(finalConstraints, this.prevConstraints)) {
                Paragraph localParagraph = this.paragraph;
                Intrinsics.checkNotNull(localParagraph);
                long localSize = ConstraintsKt.m7509constrain4WqzIAM(finalConstraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(localParagraph.getWidth()), TextDelegateKt.ceilToIntPx(localParagraph.getHeight())));
                this.layoutSize = localSize;
                if (TextOverflow.m7459equalsimpl0(this.overflow, TextOverflow.Companion.m7468getVisiblegIe3tQ8()) || (((float) IntSize.m7714getWidthimpl(localSize)) >= localParagraph.getWidth() && ((float) IntSize.m7713getHeightimpl(localSize)) >= localParagraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
            }
        ...
        Paragraph r0 = m2721layoutTextK40F9xA(finalConstraints, layoutDirection);
        Paragraph it = r0;
        this.prevConstraints = finalConstraints;
        long localSize2 = ConstraintsKt.m7509constrain4WqzIAM(finalConstraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(it.getWidth()), TextDelegateKt.ceilToIntPx(it.getHeight())));
        this.layoutSize = localSize2;
        if (!TextOverflow.m7459equalsimpl0(this.overflow, TextOverflow.Companion.m7468getVisiblegIe3tQ8()) && (((float) IntSize.m7714getWidthimpl(localSize2)) < it.getWidth() || ((float) IntSize.m7713getHeightimpl(localSize2)) < it.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = r0;
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int result = TextDelegateKt.ceilToIntPx(m2721layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m2726updateL6sJoHM(String text2, TextStyle style2, FontFamily.Resolver fontFamilyResolver2, int overflow2, boolean softWrap2, int maxLines2, int minLines2) {
        Intrinsics.checkNotNullParameter(text2, "text");
        Intrinsics.checkNotNullParameter(style2, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver2, "fontFamilyResolver");
        this.text = text2;
    ...
    private final Paragraph m2721layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics localParagraphIntrinsics = setLayoutDirection(layoutDirection);
        return ParagraphKt.m6935Paragraph_EkL_Y(localParagraphIntrinsics, LayoutUtilsKt.m2710finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, localParagraphIntrinsics.getMaxIntrinsicWidth()), LayoutUtilsKt.m2711finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m7459equalsimpl0(this.overflow, TextOverflow.Companion.m7467getEllipsisgIe3tQ8()));
    }

    /* renamed from: newLayoutWillBeDifferent-K40F9xA  reason: not valid java name */
    private final boolean m2722newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m7491equalsimpl0(constraints, this.prevConstraints)) {
            return false;
        }
        if (Constraints.m7498getMaxWidthimpl(constraints) == Constraints.m7498getMaxWidthimpl(this.prevConstraints) && ((float) Constraints.m7497getMaxHeightimpl(constraints)) >= localParagraph.getHeight() && !localParagraph.getDidExceedMaxLines()) {
            return false;
        }
        return true;
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull() {
        ...
        long finalConstraints = Constraints.m7489copyZbe2FdA$default(this.prevConstraints, 0, 0, 0, 0, 10, (Object) null);
        ...
        return new TextLayoutResult(textLayoutInput, new MultiParagraph(multiParagraphIntrinsics, finalConstraints, this.maxLines, TextOverflow.m7459equalsimpl0(this.overflow, TextOverflow.Companion.m7467getEllipsisgIe3tQ8()), (DefaultConstructorMarker) null), this.layoutSize, (DefaultConstructorMarker) null);
    }
