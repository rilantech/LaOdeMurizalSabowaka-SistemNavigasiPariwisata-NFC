...
final class SelectionController$modifier$2 extends Lambda implements Function0<TextLayoutResult> {
    final /* synthetic */ SelectionController this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SelectionController$modifier$2(SelectionController selectionController) {
        super(0);
