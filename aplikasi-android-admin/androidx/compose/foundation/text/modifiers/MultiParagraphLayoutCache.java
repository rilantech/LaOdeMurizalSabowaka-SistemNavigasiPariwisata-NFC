...
public final class MultiParagraphLayoutCache {
    ...
    public final boolean m2719layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (!m2717newLayoutWillBeDifferentVKLhPVY(this.layoutCache, finalConstraints, layoutDirection)) {
            TextLayoutResult textLayoutResult = this.layoutCache;
            Intrinsics.checkNotNull(textLayoutResult);
            if (Constraints.m7491equalsimpl0(finalConstraints, textLayoutResult.getLayoutInput().m7003getConstraintsmsEJaDk())) {
                return false;
            }
            TextLayoutResult textLayoutResult2 = this.layoutCache;
            Intrinsics.checkNotNull(textLayoutResult2);
            this.layoutCache = m2718textLayoutResultVKLhPVY(layoutDirection, finalConstraints, textLayoutResult2.getMultiParagraph());
            return true;
        }
        this.layoutCache = m2718textLayoutResultVKLhPVY(layoutDirection, finalConstraints, m2715layoutTextK40F9xA(finalConstraints, layoutDirection));
        return true;
    }

    /* renamed from: textLayoutResult-VKLhPVY  reason: not valid java name */
    private final TextLayoutResult m2718textLayoutResultVKLhPVY(LayoutDirection layoutDirection, long finalConstraints, MultiParagraph multiParagraph) {
        ...
        Density density2 = this.density;
        Intrinsics.checkNotNull(density2);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, textStyle, (List) list, i, z, i2, density2, layoutDirection, this.fontFamilyResolver, finalConstraints, (DefaultConstructorMarker) null), multiParagraph, ConstraintsKt.m7509constrain4WqzIAM(finalConstraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(multiParagraph.getWidth()), TextDelegateKt.ceilToIntPx(multiParagraph.getHeight()))), (DefaultConstructorMarker) null);
    }
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int result = TextDelegateKt.ceilToIntPx(m2715layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m2720updateZNqEYIc(AnnotatedString text2, TextStyle style2, FontFamily.Resolver fontFamilyResolver2, int overflow2, boolean softWrap2, int maxLines2, int minLines2, List<AnnotatedString.Range<Placeholder>> placeholders2) {
        Intrinsics.checkNotNullParameter(text2, "text");
        Intrinsics.checkNotNullParameter(style2, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver2, "fontFamilyResolver");
        this.text = text2;
    ...
    private final MultiParagraph m2715layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        MultiParagraphIntrinsics localParagraphIntrinsics = setLayoutDirection(layoutDirection);
        return new MultiParagraph(localParagraphIntrinsics, LayoutUtilsKt.m2710finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, localParagraphIntrinsics.getMaxIntrinsicWidth()), LayoutUtilsKt.m2711finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m7459equalsimpl0(this.overflow, TextOverflow.Companion.m7467getEllipsisgIe3tQ8()), (DefaultConstructorMarker) null);
    }

    /* renamed from: newLayoutWillBeDifferent-VKLhPVY  reason: not valid java name */
    private final boolean m2717newLayoutWillBeDifferentVKLhPVY(TextLayoutResult $this$newLayoutWillBeDifferent_u2dVKLhPVY, long constraints, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m7491equalsimpl0(constraints, $this$newLayoutWillBeDifferent_u2dVKLhPVY.getLayoutInput().m7003getConstraintsmsEJaDk())) {
            return false;
        }
        if (Constraints.m7498getMaxWidthimpl(constraints) == Constraints.m7498getMaxWidthimpl($this$newLayoutWillBeDifferent_u2dVKLhPVY.getLayoutInput().m7003getConstraintsmsEJaDk()) && ((float) Constraints.m7497getMaxHeightimpl(constraints)) >= $this$newLayoutWillBeDifferent_u2dVKLhPVY.getMultiParagraph().getHeight() && !$this$newLayoutWillBeDifferent_u2dVKLhPVY.getMultiParagraph().getDidExceedMaxLines()) {
            return false;
        }
        return true;
    }
    ...
    private final int m2716maxWidthBRTryo0(long constraints) {
        boolean z = this.softWrap;
        int i = this.overflow;
        MultiParagraphIntrinsics multiParagraphIntrinsics = this.paragraphIntrinsics;
        Intrinsics.checkNotNull(multiParagraphIntrinsics);
        return LayoutUtilsKt.m2712finalMaxWidthtfFHcEY(constraints, z, i, multiParagraphIntrinsics.getMaxIntrinsicWidth());
    }
