...
public final class MinLinesConstrainer {
    ...
    public final long m2713coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        int minHeight;
        int i = minLines;
        ...
        if (Float.isNaN(oneLineHeight) || Float.isNaN(lineHeight)) {
            oneLineHeight = ParagraphKt.m6934ParagraphUdtVg6A$default(MinLinesConstrainerKt.EmptyTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, (Object) null), this.density, this.fontFamilyResolver, (List) null, (List) null, 1, false, 96, (Object) null).getHeight();
            lineHeight = ParagraphKt.m6934ParagraphUdtVg6A$default(MinLinesConstrainerKt.TwoLineTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, (Object) null), this.density, this.fontFamilyResolver, (List) null, (List) null, 2, false, 96, (Object) null).getHeight() - oneLineHeight;
            this.oneLineHeightCache = oneLineHeight;
            this.lineHeightCache = lineHeight;
        }
        if (i != 1) {
            minHeight = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(MathKt.roundToInt((((float) (i - 1)) * lineHeight) + oneLineHeight), 0), Constraints.m7497getMaxHeightimpl(inConstraints));
        } else {
            minHeight = Constraints.m7499getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m7500getMinWidthimpl(inConstraints), Constraints.m7498getMaxWidthimpl(inConstraints), minHeight, Constraints.m7497getMaxHeightimpl(inConstraints));
    }
}
