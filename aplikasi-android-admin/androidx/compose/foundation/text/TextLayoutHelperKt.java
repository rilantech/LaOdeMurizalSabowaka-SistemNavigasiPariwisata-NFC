...
public final class TextLayoutHelperKt {
    ...
    public static final boolean m2688canReuse7_7YC6M(TextLayoutResult $this$canReuse_u2d7_7YC6M, AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int maxLines, boolean softWrap, int overflow, Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        ...
        if (!Intrinsics.areEqual((Object) layoutInput.getText(), (Object) annotatedString)) {
            ...
            int i4 = maxLines;
        } else if (layoutInput.getMaxLines() != maxLines || layoutInput.getSoftWrap() != z || !TextOverflow.m7459equalsimpl0(layoutInput.m7004getOverflowgIe3tQ8(), i) || !Intrinsics.areEqual((Object) layoutInput.getDensity(), (Object) density2) || layoutInput.getLayoutDirection() != layoutDirection2 || !Intrinsics.areEqual((Object) layoutInput.getFontFamilyResolver(), (Object) resolver) || Constraints.m7500getMinWidthimpl(constraints) != Constraints.m7500getMinWidthimpl(layoutInput.m7003getConstraintsmsEJaDk())) {
            return false;
        } else {
            if (!z && !TextOverflow.m7459equalsimpl0(i, TextOverflow.Companion.m7467getEllipsisgIe3tQ8())) {
                return true;
            }
            if (Constraints.m7498getMaxWidthimpl(constraints) == Constraints.m7498getMaxWidthimpl(layoutInput.m7003getConstraintsmsEJaDk()) && Constraints.m7497getMaxHeightimpl(constraints) == Constraints.m7497getMaxHeightimpl(layoutInput.m7003getConstraintsmsEJaDk())) {
                return true;
            }
            return false;
        }
