...
final class CoreTextFieldKt$CoreTextField$pointerModifier$1 extends Lambda implements Function1<Offset, Unit> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        m2606invokek4lQ0M(((Offset) p1).m4723unboximpl());
        return Unit.INSTANCE;
    }

    /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
    public final void m2606invokek4lQ0M(long offset) {
        boolean z = true;
        ...
        if (this.$state.getHandleState() != HandleState.Selection) {
            ...
            if (layoutResult != null) {
                ...
                long j = offset;
                TextFieldDelegate.Companion.m2666setCursorOffsetULxng0E$foundation_release(j, layoutResult, textFieldState.getProcessor(), this.$offsetMapping, textFieldState.getOnValueChange());
        ...
        this.$manager.m2840deselect_kEHs6E$foundation_release(Offset.m4702boximpl(offset));
    }
}
