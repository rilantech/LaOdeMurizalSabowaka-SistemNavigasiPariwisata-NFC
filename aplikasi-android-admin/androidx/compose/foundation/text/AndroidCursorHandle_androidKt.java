...
public final class AndroidCursorHandle_androidKt {
    private static final float CursorHandleHeight = Dp.m7554constructorimpl((float) 25);
    private static final float CursorHandleWidth = Dp.m7554constructorimpl(Dp.m7554constructorimpl(CursorHandleHeight * 2.0f) / 2.4142137f);
    ...
    public static final void m2585CursorHandleULxng0E(long handlePosition, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        if (($dirty2 & 731) != 146 || !$composer2.getSkipping()) {
            ...
            AndroidSelectionHandles_androidKt.m2746HandlePopupULxng0E(handlePosition, HandleReferencePoint.TopMiddle, ComposableLambdaKt.composableLambda($composer2, -1458480226, true, new AndroidCursorHandle_androidKt$CursorHandle$1(content, modifier, $dirty2)), $composer2, ($dirty2 & 14) | 432);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void DefaultCursorHandle(Modifier modifier, Composer $composer, int $changed) {
        ...
        if (($dirty & 11) != 2 || !$composer2.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m2324sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
