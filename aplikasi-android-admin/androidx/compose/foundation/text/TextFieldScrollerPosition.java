...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float initial) {
        ...
        this.previousSelection = TextRange.Companion.m7040getZerod9O1mEE();
    ...
    public final long m2679getPreviousSelectiond9O1mEE() {
        return this.previousSelection;
    }

    /* renamed from: setPreviousSelection-5zc-tL8  reason: not valid java name */
    public final void m2680setPreviousSelection5zctL8(long j) {
    ...
    public final int m2678getOffsetToFollow5zctL8(long selection) {
        if (TextRange.m7035getStartimpl(selection) != TextRange.m7035getStartimpl(this.previousSelection)) {
            return TextRange.m7035getStartimpl(selection);
        }
        if (TextRange.m7030getEndimpl(selection) != TextRange.m7030getEndimpl(this.previousSelection)) {
            return TextRange.m7030getEndimpl(selection);
        }
        return TextRange.m7033getMinimpl(selection);
    }
