...
public final class TextDelegateKt {
    ...
    public static /* synthetic */ TextDelegate m2657updateTextDelegaterm0N8CA$default(TextDelegate textDelegate, AnnotatedString annotatedString, TextStyle textStyle, Density density, FontFamily.Resolver resolver, boolean z, int i, int i2, int i3, List list, int i4, Object obj) {
        boolean z2;
        int i5;
        int i6 = i4;
        if ((i6 & 32) != 0) {
        ...
        int r9 = (i6 & 64) != 0 ? TextOverflow.Companion.m7466getClipgIe3tQ8() : i;
        ...
        return m2656updateTextDelegaterm0N8CA(textDelegate, annotatedString, textStyle, density, resolver, z2, r9, i7, i5, list);
    }

    /* renamed from: updateTextDelegate-rm0N8CA  reason: not valid java name */
    public static final TextDelegate m2656updateTextDelegaterm0N8CA(TextDelegate current, AnnotatedString text, TextStyle style, Density density, FontFamily.Resolver fontFamilyResolver, boolean softWrap, int overflow, int maxLines, int minLines, List<AnnotatedString.Range<Placeholder>> placeholders) {
        ...
        if (!Intrinsics.areEqual((Object) current.getText(), (Object) annotatedString)) {
            ...
            int i8 = maxLines;
            int i9 = minLines;
        } else if (!TextOverflow.m7459equalsimpl0(current.m2654getOverflowgIe3tQ8(), overflow)) {
            int i10 = maxLines;
            int i11 = minLines;
