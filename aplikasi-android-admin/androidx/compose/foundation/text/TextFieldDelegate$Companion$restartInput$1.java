...
final class TextFieldDelegate$Companion$restartInput$1 extends Lambda implements Function1<List<? extends EditCommand>, Unit> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        invoke((List<? extends EditCommand>) (List) p1);
        return Unit.INSTANCE;
    }

    public final void invoke(List<? extends EditCommand> it) {
        Intrinsics.checkNotNullParameter(it, "it");
        TextFieldDelegate.Companion.onEditCommand$foundation_release(it, this.$editProcessor, this.$onValueChange, (TextInputSession) this.$session.element);
    }
}
