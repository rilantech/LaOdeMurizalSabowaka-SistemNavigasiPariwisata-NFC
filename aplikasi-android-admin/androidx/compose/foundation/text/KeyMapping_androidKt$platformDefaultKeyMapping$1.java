...
public final class KeyMapping_androidKt$platformDefaultKeyMapping$1 implements KeyMapping {
    ...
    public KeyCommand m2615mapZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, NotificationCompat.CATEGORY_EVENT);
        KeyCommand keyCommand = null;
        if (KeyEvent_androidKt.m6049isShiftPressedZmokQxo(event) && KeyEvent_androidKt.m6046isAltPressedZmokQxo(event)) {
        ...
        return keyCommand == null ? KeyMappingKt.getDefaultKeyMapping().m2612mapZmokQxo(event) : keyCommand;
    }
}
