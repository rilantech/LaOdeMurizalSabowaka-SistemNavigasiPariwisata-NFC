...
public final class KeyboardOptions {
    ...
    public /* synthetic */ KeyboardOptions(int r7, boolean r8, int r9, int r10, int r11, kotlin.jvm.internal.DefaultConstructorMarker r12) {
        ...
        L_0x0022:
            ...
            int r10 = r7.m7205getDefaulteUduSuo()
            r4 = r10
            goto L_0x002f
        L_0x002e:
            r4 = r10
    ...
    public final int m2621getCapitalizationIUNYP9k() {
    ...
    public final int m2623getKeyboardTypePjHm6EE() {
        return this.keyboardType;
    }

    /* renamed from: getImeAction-eUduSuo  reason: not valid java name */
    public final int m2622getImeActioneUduSuo() {
    ...
    public static /* synthetic */ KeyboardOptions m2619copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m2620copy3m2b7yw(i, z, i2, i3);
    }

    /* renamed from: copy-3m2b7yw  reason: not valid java name */
    public final KeyboardOptions m2620copy3m2b7yw(int capitalization2, boolean autoCorrect2, int keyboardType2, int imeAction2) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof KeyboardOptions) && KeyboardCapitalization.m7223equalsimpl0(this.capitalization, ((KeyboardOptions) other).capitalization) && this.autoCorrect == ((KeyboardOptions) other).autoCorrect && KeyboardType.m7238equalsimpl0(this.keyboardType, ((KeyboardOptions) other).keyboardType) && ImeAction.m7193equalsimpl0(this.imeAction, ((KeyboardOptions) other).imeAction)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((KeyboardCapitalization.m7224hashCodeimpl(this.capitalization) * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m7239hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m7194hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "KeyboardOptions(capitalization=" + KeyboardCapitalization.m7225toStringimpl(this.capitalization) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + KeyboardType.m7240toStringimpl(this.keyboardType) + ", imeAction=" + ImeAction.m7195toStringimpl(this.imeAction) + ')';
    }
}
