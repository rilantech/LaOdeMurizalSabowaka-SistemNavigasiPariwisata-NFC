...
final class BasicTextKt$BasicText$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        BasicTextKt.m2592BasicTextVhcvRP8(this.$text, this.$modifier, this.$style, (Function1<? super TextLayoutResult, Unit>) this.$onTextLayout, this.$overflow, this.$softWrap, this.$maxLines, this.$minLines, this.$color, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), this.$$default);
    }
}
