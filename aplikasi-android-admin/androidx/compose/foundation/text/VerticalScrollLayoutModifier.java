...
final class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public VerticalScrollLayoutModifier(TextFieldScrollerPosition scrollerPosition2, int cursorOffset2, TransformedText transformedText2, Function0<TextLayoutResultProxy> textLayoutResultProvider2) {
    ...
    public MeasureResult m2697measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        MeasureScope measureScope = $this$measure_u2d3p2s80s;
        Measurable measurable2 = measurable;
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable2, "measurable");
        Placeable placeable = measurable2.m6399measureBRTryo0(Constraints.m7489copyZbe2FdA$default(constraints, 0, 0, 0, Integer.MAX_VALUE, 7, (Object) null));
        int height = Math.min(placeable.getHeight(), Constraints.m7497getMaxHeightimpl(constraints));
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), height, (Map) null, new VerticalScrollLayoutModifier$measure$1(measureScope, this, placeable, height), 4, (Object) null);
    }
}
