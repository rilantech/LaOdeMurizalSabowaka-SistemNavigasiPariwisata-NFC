...
final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult m2610measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        long childConstraints;
        MeasureScope measureScope = $this$measure_u2d3p2s80s;
        Measurable measurable2 = measurable;
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable2, "measurable");
        if (measurable2.maxIntrinsicWidth(Constraints.m7497getMaxHeightimpl(constraints)) < Constraints.m7498getMaxWidthimpl(constraints)) {
            childConstraints = constraints;
        } else {
            childConstraints = Constraints.m7489copyZbe2FdA$default(constraints, 0, Integer.MAX_VALUE, 0, 0, 13, (Object) null);
        }
        Placeable placeable = measurable2.m6399measureBRTryo0(childConstraints);
        int width = Math.min(placeable.getWidth(), Constraints.m7498getMaxWidthimpl(constraints));
