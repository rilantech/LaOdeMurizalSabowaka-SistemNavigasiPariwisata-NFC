...
final class CoreTextFieldKt$previewKeyEventToDeselectOnBack$1 extends Lambda implements Function1<KeyEvent, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return m2607invokeZmokQxo(((KeyEvent) p1).m6032unboximpl());
    }

    /* renamed from: invoke-ZmokQxo  reason: not valid java name */
    public final Boolean m2607invokeZmokQxo(android.view.KeyEvent keyEvent) {
        boolean z;
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        if (this.$state.getHandleState() != HandleState.Selection || !KeyEventHelpers_androidKt.m2611cancelsTextSelectionZmokQxo(keyEvent)) {
            z = false;
        } else {
            z = true;
            TextFieldSelectionManager.m2837deselect_kEHs6E$foundation_release$default(this.$manager, (Offset) null, 1, (Object) null);
        }
