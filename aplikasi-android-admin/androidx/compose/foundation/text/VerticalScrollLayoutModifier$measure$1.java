...
final class VerticalScrollLayoutModifier$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope $this$layout) {
        ...
        this.this$0.getScrollerPosition().update(Orientation.Vertical, TextFieldScrollKt.getCursorRectInScroller(density, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, false, this.$placeable.getWidth()), this.$height, this.$placeable.getHeight());
        Placeable.PlacementScope.placeRelative$default($this$layout, this.$placeable, 0, MathKt.roundToInt(-this.this$0.getScrollerPosition().getOffset()), 0.0f, 4, (Object) null);
    }
}
