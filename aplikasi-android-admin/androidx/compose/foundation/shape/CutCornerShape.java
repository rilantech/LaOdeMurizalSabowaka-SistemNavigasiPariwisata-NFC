...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline m2569createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (((topStart + topEnd) + bottomStart) + bottomEnd == 0.0f) {
            return new Outline.Rectangle(SizeKt.m4803toRectuvyYCjk(size));
        }
        ...
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m4782getWidthimpl(size) - cornerSize2, 0.0f);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m4782getWidthimpl(size), cornerSize2);
        float cornerSize3 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m4782getWidthimpl(size), Size.m4779getHeightimpl(size) - cornerSize3);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m4782getWidthimpl(size) - cornerSize3, Size.m4779getHeightimpl(size));
        float cornerSize4 = layoutDirection == LayoutDirection.Ltr ? bottomStart : bottomEnd;
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(cornerSize4, Size.m4779getHeightimpl(size));
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(0.0f, Size.m4779getHeightimpl(size) - cornerSize4);
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CutCornerShape) && Intrinsics.areEqual((Object) getTopStart(), (Object) ((CutCornerShape) other).getTopStart()) && Intrinsics.areEqual((Object) getTopEnd(), (Object) ((CutCornerShape) other).getTopEnd()) && Intrinsics.areEqual((Object) getBottomEnd(), (Object) ((CutCornerShape) other).getBottomEnd()) && Intrinsics.areEqual((Object) getBottomStart(), (Object) ((CutCornerShape) other).getBottomStart())) {
            return true;
        }
        return false;
    }
