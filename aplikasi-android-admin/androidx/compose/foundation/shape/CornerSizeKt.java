...
public final class CornerSizeKt {
    ...
    public static final CornerSize m2567CornerSize0680j_4(float size) {
        return new DpCornerSize(size, (DefaultConstructorMarker) null);
    }
    ...
    public static final CornerSize CornerSize(int percent) {
        return new PercentCornerSize((float) percent);
    }
