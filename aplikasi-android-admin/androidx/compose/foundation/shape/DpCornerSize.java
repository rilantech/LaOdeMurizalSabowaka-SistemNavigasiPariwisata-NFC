...
final class DpCornerSize implements CornerSize, InspectableValue {
    ...
    private final float m2573component1D9Ej5fM() {
        return this.size;
    }

    /* renamed from: copy-0680j_4$default  reason: not valid java name */
    public static /* synthetic */ DpCornerSize m2574copy0680j_4$default(DpCornerSize dpCornerSize, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpCornerSize.size;
        }
        return dpCornerSize.m2575copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4  reason: not valid java name */
    public final DpCornerSize m2575copy0680j_4(float f) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof DpCornerSize) && Dp.m7559equalsimpl0(this.size, ((DpCornerSize) obj).size);
    }
    ...
    private DpCornerSize(float size2) {
        this.size = size2;
    }

    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m7552boximpl(m2576getValueOverrideD9Ej5fM());
    }

    /* renamed from: toPx-TmRCtEA  reason: not valid java name */
    public float m2577toPxTmRCtEA(long shapeSize, Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m7535toPx0680j_4(this.size);
    }
    ...
    public float m2576getValueOverrideD9Ej5fM() {
        return this.size;
    }
}
