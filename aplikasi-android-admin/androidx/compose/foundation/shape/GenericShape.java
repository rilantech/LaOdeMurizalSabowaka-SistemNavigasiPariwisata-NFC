...
public final class GenericShape implements Shape {
    ...
    public GenericShape(Function3<? super Path, ? super Size, ? super LayoutDirection, Unit> builder2) {
        Intrinsics.checkNotNullParameter(builder2, "builder");
        this.builder = builder2;
    }

    /* renamed from: createOutline-Pq9zytI  reason: not valid java name */
    public Outline m2578createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Path path = AndroidPath_androidKt.Path();
        Path $this$createOutline_Pq9zytI_u24lambda_u240 = path;
        this.builder.invoke($this$createOutline_Pq9zytI_u24lambda_u240, Size.m4770boximpl(size), layoutDirection);
