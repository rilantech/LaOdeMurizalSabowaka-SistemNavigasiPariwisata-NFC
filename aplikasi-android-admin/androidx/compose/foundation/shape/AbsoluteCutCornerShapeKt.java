...
public final class AbsoluteCutCornerShapeKt {
    ...
    public static final AbsoluteCutCornerShape m2556AbsoluteCutCornerShape0680j_4(float size) {
        return AbsoluteCutCornerShape(CornerSizeKt.m2567CornerSize0680j_4(size));
    }
    ...
    public static /* synthetic */ AbsoluteCutCornerShape m2558AbsoluteCutCornerShapea9UjIt4$default(float $this$dp$iv, float $this$dp$iv2, float $this$dp$iv3, float $this$dp$iv4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m2557AbsoluteCutCornerShapea9UjIt4($this$dp$iv, $this$dp$iv2, $this$dp$iv3, $this$dp$iv4);
    }

    /* renamed from: AbsoluteCutCornerShape-a9UjIt4  reason: not valid java name */
    public static final AbsoluteCutCornerShape m2557AbsoluteCutCornerShapea9UjIt4(float topLeft, float topRight, float bottomRight, float bottomLeft) {
        return new AbsoluteCutCornerShape(CornerSizeKt.m2567CornerSize0680j_4(topLeft), CornerSizeKt.m2567CornerSize0680j_4(topRight), CornerSizeKt.m2567CornerSize0680j_4(bottomRight), CornerSizeKt.m2567CornerSize0680j_4(bottomLeft));
    }
