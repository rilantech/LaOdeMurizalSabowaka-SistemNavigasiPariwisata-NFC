...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    public Outline m2560createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        float f = topStart;
        float f2 = topEnd;
        float f3 = bottomEnd;
        float f4 = bottomStart;
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (((f + f2) + f3) + f4 == 0.0f) {
            return new Outline.Rectangle(SizeKt.m4803toRectuvyYCjk(size));
        }
        return new Outline.Rounded(RoundRectKt.m4765RoundRectZAM2FJo(SizeKt.m4803toRectuvyYCjk(size), CornerRadiusKt.CornerRadius$default(f, 0.0f, 2, (Object) null), CornerRadiusKt.CornerRadius$default(f2, 0.0f, 2, (Object) null), CornerRadiusKt.CornerRadius$default(f3, 0.0f, 2, (Object) null), CornerRadiusKt.CornerRadius$default(f4, 0.0f, 2, (Object) null)));
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AbsoluteRoundedCornerShape) && Intrinsics.areEqual((Object) getTopStart(), (Object) ((AbsoluteRoundedCornerShape) other).getTopStart()) && Intrinsics.areEqual((Object) getTopEnd(), (Object) ((AbsoluteRoundedCornerShape) other).getTopEnd()) && Intrinsics.areEqual((Object) getBottomEnd(), (Object) ((AbsoluteRoundedCornerShape) other).getBottomEnd()) && Intrinsics.areEqual((Object) getBottomStart(), (Object) ((AbsoluteRoundedCornerShape) other).getBottomStart())) {
            return true;
        }
        return false;
    }
    ...
    private final long m2559toRadiusBz7bX_o(float $this$toRadius_u2dBz7bX_o) {
        return CornerRadiusKt.CornerRadius$default($this$toRadius_u2dBz7bX_o, 0.0f, 2, (Object) null);
    }
}
