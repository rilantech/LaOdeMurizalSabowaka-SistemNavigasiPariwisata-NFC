...
public final class RoundedCornerShape extends CornerBasedShape {
    ...
    public Outline m2581createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        return new Outline.Rounded(RoundRectKt.m4765RoundRectZAM2FJo(SizeKt.m4803toRectuvyYCjk(size), CornerRadiusKt.CornerRadius$default(layoutDirection2 == LayoutDirection.Ltr ? topStart : topEnd, 0.0f, 2, (Object) null), CornerRadiusKt.CornerRadius$default(layoutDirection2 == LayoutDirection.Ltr ? topEnd : topStart, 0.0f, 2, (Object) null), CornerRadiusKt.CornerRadius$default(layoutDirection2 == LayoutDirection.Ltr ? bottomEnd : bottomStart, 0.0f, 2, (Object) null), CornerRadiusKt.CornerRadius$default(layoutDirection2 == LayoutDirection.Ltr ? bottomStart : bottomEnd, 0.0f, 2, (Object) null)));
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RoundedCornerShape) && Intrinsics.areEqual((Object) getTopStart(), (Object) ((RoundedCornerShape) other).getTopStart()) && Intrinsics.areEqual((Object) getTopEnd(), (Object) ((RoundedCornerShape) other).getTopEnd()) && Intrinsics.areEqual((Object) getBottomEnd(), (Object) ((RoundedCornerShape) other).getBottomEnd()) && Intrinsics.areEqual((Object) getBottomStart(), (Object) ((RoundedCornerShape) other).getBottomStart())) {
            return true;
        }
        return false;
    }
