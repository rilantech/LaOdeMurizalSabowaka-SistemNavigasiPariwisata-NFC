...
final class RequiredMinIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public long m2289calculateContentConstraintsl58MMJ0(MeasureScope $this$calculateContentConstraints_u2dl58MMJ0, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$calculateContentConstraints_u2dl58MMJ0, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m7507fixedHeightOenEA2s(measurable.minIntrinsicHeight(Constraints.m7498getMaxWidthimpl(constraints)));
    }
