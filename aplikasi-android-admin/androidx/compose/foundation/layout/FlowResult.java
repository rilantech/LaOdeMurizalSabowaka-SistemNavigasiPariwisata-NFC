...
public final class FlowResult {
    ...
    public FlowResult(int mainAxisTotalSize2, int crossAxisTotalSize2, MutableVector<RowColumnMeasureHelperResult> items2) {
        Intrinsics.checkNotNullParameter(items2, "items");
        this.mainAxisTotalSize = mainAxisTotalSize2;
        this.crossAxisTotalSize = crossAxisTotalSize2;
        this.items = items2;
    }
