...
public final class WindowInsetsPaddingKt$consumeWindowInsets$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$consumeWindowInsets_u24lambda_u241 = $this$null;
        $this$consumeWindowInsets_u24lambda_u241.setName("consumeWindowInsets");
        $this$consumeWindowInsets_u24lambda_u241.getProperties().set("insets", this.$insets$inlined);
    }
}
