...
public final class WindowInsetsSizeKt$windowInsetsBottomHeight$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$windowInsetsBottomHeight_u24lambda_u243 = $this$null;
        $this$windowInsetsBottomHeight_u24lambda_u243.setName("insetsBottomHeight");
        $this$windowInsetsBottomHeight_u24lambda_u243.getProperties().set("insets", this.$insets$inlined);
    }
}
