...
interface SideCalculator {
    ...
    long m2295consumedOffsetsMKHz9U(long j);

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    long m2296consumedVelocityQWom1Mo(long j, float f);
    ...
    public static final class Companion {
        ...
        public final SideCalculator m2297chooseCalculatorni1skBw(int side, LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            if (WindowInsetsSides.m2362equalsimpl0(side, WindowInsetsSides.Companion.m2376getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m2362equalsimpl0(side, WindowInsetsSides.Companion.m2379getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m2362equalsimpl0(side, WindowInsetsSides.Companion.m2377getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m2362equalsimpl0(side, WindowInsetsSides.Companion.m2373getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m2362equalsimpl0(side, WindowInsetsSides.Companion.m2378getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            } else if (!WindowInsetsSides.m2362equalsimpl0(side, WindowInsetsSides.Companion.m2374getEndJoeWqyM())) {
