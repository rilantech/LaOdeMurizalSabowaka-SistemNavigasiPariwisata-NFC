...
public final class WindowInsetsPaddingKt$consumeWindowInsets$$inlined$debugInspectorInfo$2 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$consumeWindowInsets_u24lambda_u242 = $this$null;
        $this$consumeWindowInsets_u24lambda_u242.setName("consumeWindowInsets");
        $this$consumeWindowInsets_u24lambda_u242.getProperties().set("paddingValues", this.$paddingValues$inlined);
    }
}
