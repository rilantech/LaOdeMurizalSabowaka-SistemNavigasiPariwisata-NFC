...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final float m2111getBeforeD9Ej5fM() {
        return this.before;
    }

    /* renamed from: setBefore-0680j_4  reason: not valid java name */
    public final void m2114setBefore0680j_4(float f) {
        this.before = f;
    }

    /* renamed from: getAfter-D9Ej5fM  reason: not valid java name */
    public final float m2110getAfterD9Ej5fM() {
        return this.after;
    }

    /* renamed from: setAfter-0680j_4  reason: not valid java name */
    public final void m2113setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public MeasureResult m2112measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$measure_u2d3p2s80s, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return AlignmentLineKt.m2099alignmentLineOffsetMeasuretjqqzMA($this$measure_u2d3p2s80s, this.alignmentLine, this.before, this.after, measurable, constraints);
    }
}
