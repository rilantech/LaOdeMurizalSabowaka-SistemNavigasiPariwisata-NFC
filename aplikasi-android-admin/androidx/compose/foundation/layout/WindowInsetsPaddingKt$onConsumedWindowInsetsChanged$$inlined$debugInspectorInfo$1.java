...
public final class WindowInsetsPaddingKt$onConsumedWindowInsetsChanged$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$onConsumedWindowInsetsChanged_u24lambda_u243 = $this$null;
        $this$onConsumedWindowInsetsChanged_u24lambda_u243.setName("onConsumedWindowInsetsChanged");
        $this$onConsumedWindowInsetsChanged_u24lambda_u243.getProperties().set("block", this.$block$inlined);
    }
}
