...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final long m2118getBeforeXSAIIZE() {
        return this.before;
    }

    /* renamed from: setBefore--R2X_6o  reason: not valid java name */
    public final void m2121setBeforeR2X_6o(long j) {
        this.before = j;
    }

    /* renamed from: getAfter-XSAIIZE  reason: not valid java name */
    public final long m2117getAfterXSAIIZE() {
        return this.after;
    }

    /* renamed from: setAfter--R2X_6o  reason: not valid java name */
    public final void m2120setAfterR2X_6o(long j) {
        this.after = j;
    }

    private AlignmentLineOffsetTextUnitNode(AlignmentLine alignmentLine2, long before2, long after2) {
    ...
    public MeasureResult m2119measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$measure_u2d3p2s80s, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return AlignmentLineKt.m2099alignmentLineOffsetMeasuretjqqzMA($this$measure_u2d3p2s80s, this.alignmentLine, !TextUnitKt.m7753isUnspecifiedR2X_6o(this.before) ? $this$measure_u2d3p2s80s.m7530toDpGaN1DYA(this.before) : Dp.Companion.m7574getUnspecifiedD9Ej5fM(), !TextUnitKt.m7753isUnspecifiedR2X_6o(this.after) ? $this$measure_u2d3p2s80s.m7530toDpGaN1DYA(this.after) : Dp.Companion.m7574getUnspecifiedD9Ej5fM(), measurable, constraints);
    }
}
