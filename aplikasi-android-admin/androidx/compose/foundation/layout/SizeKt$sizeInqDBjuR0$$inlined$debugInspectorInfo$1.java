...
public final class SizeKt$sizeInqDBjuR0$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        $this$sizeIn_qDBjuR0_u24lambda_u246.getProperties().set("minWidth", Dp.m7552boximpl(this.$minWidth$inlined));
        $this$sizeIn_qDBjuR0_u24lambda_u246.getProperties().set("minHeight", Dp.m7552boximpl(this.$minHeight$inlined));
        $this$sizeIn_qDBjuR0_u24lambda_u246.getProperties().set("maxWidth", Dp.m7552boximpl(this.$maxWidth$inlined));
        $this$sizeIn_qDBjuR0_u24lambda_u246.getProperties().set("maxHeight", Dp.m7552boximpl(this.$maxHeight$inlined));
    }
}
