...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    public final long m2116getBeforeXSAIIZE() {
        return this.before;
    }

    /* renamed from: getAfter-XSAIIZE  reason: not valid java name */
    public final long m2115getAfterXSAIIZE() {
        return this.after;
    }
    ...
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m7736hashCodeimpl(this.before)) * 31) + TextUnit.m7736hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!Intrinsics.areEqual((Object) this.alignmentLine, (Object) otherModifier.alignmentLine) || !TextUnit.m7732equalsimpl0(this.before, otherModifier.before) || !TextUnit.m7732equalsimpl0(this.after, otherModifier.after)) {
            return false;
        }
        return true;
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m2121setBeforeR2X_6o(this.before);
        node.m2120setAfterR2X_6o(this.after);
    }
}
