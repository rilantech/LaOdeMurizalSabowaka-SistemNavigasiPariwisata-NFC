...
final class BoxKt$boxMeasurePolicy$1 implements MeasurePolicy {
    ...
    public final MeasureResult m2167measure3p2s80s(MeasureScope $this$MeasurePolicy, List<? extends Measurable> measurables, long constraints) {
        long j;
        Placeable placeable;
        int boxHeight;
        int boxWidth;
        ...
        if (measurables.isEmpty()) {
            return MeasureScope.layout$default($this$MeasurePolicy, Constraints.m7500getMinWidthimpl(constraints), Constraints.m7499getMinHeightimpl(constraints), (Map) null, BoxKt$boxMeasurePolicy$1$measure$1.INSTANCE, 4, (Object) null);
        }
        if (this.$propagateMinConstraints) {
            j = constraints;
        } else {
            j = Constraints.m7489copyZbe2FdA$default(constraints, 0, 0, 0, 0, 10, (Object) null);
        }
        long contentConstraints = j;
        if (measurables.size() == 1) {
            Measurable measurable = (Measurable) list.get(0);
            if (!BoxKt.getMatchesParentSize(measurable)) {
                placeable = measurable.m6399measureBRTryo0(contentConstraints);
                boxWidth = Math.max(Constraints.m7500getMinWidthimpl(constraints), placeable.getWidth());
                boxHeight = Math.max(Constraints.m7499getMinHeightimpl(constraints), placeable.getHeight());
            } else {
                boxWidth = Constraints.m7500getMinWidthimpl(constraints);
                boxHeight = Constraints.m7499getMinHeightimpl(constraints);
                placeable = measurable.m6399measureBRTryo0(Constraints.Companion.m7506fixedJhjzzOo(Constraints.m7500getMinWidthimpl(constraints), Constraints.m7499getMinHeightimpl(constraints)));
            }
        ...
        boxWidth2.element = Constraints.m7500getMinWidthimpl(constraints);
        Ref.IntRef boxHeight2 = new Ref.IntRef();
        boxHeight2.element = Constraints.m7499getMinHeightimpl(constraints);
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            if (!BoxKt.getMatchesParentSize(measurable2)) {
                Placeable placeable2 = measurable2.m6399measureBRTryo0(contentConstraints);
        ...
        if (hasMatchParentSizeChildren) {
            ...
            for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
                ...
                if (BoxKt.getMatchesParentSize(measurable3)) {
                    placeables[index2] = measurable3.m6399measureBRTryo0(matchParentSizeConstraints);
                }
            }
        }
