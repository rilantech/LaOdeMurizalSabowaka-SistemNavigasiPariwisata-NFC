...
public final class RowColumnMeasureHelperResult {
    ...
    public RowColumnMeasureHelperResult(int crossAxisSize2, int mainAxisSize2, int startIndex2, int endIndex2, int beforeCrossAxisAlignmentLine2, int[] mainAxisPositions2) {
        Intrinsics.checkNotNullParameter(mainAxisPositions2, "mainAxisPositions");
        this.crossAxisSize = crossAxisSize2;
        this.mainAxisSize = mainAxisSize2;
        this.startIndex = startIndex2;
        this.endIndex = endIndex2;
        this.beforeCrossAxisAlignmentLine = beforeCrossAxisAlignmentLine2;
        this.mainAxisPositions = mainAxisPositions2;
    }
