...
final class WrapContentElement$Companion$size$1 extends Lambda implements Function2<IntSize, LayoutDirection, IntOffset> {
    ...
    WrapContentElement$Companion$size$1(Alignment alignment) {
        super(2);
        this.$align = alignment;
    }

    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return IntOffset.m7663boximpl(m2382invoke5SAbXVA(((IntSize) p1).m7718unboximpl(), (LayoutDirection) p2));
    }

    /* renamed from: invoke-5SAbXVA  reason: not valid java name */
    public final long m2382invoke5SAbXVA(long size, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return this.$align.m4594alignKFBX0sM(IntSize.Companion.m7719getZeroYbymL2g(), size, layoutDirection);
    }
}
