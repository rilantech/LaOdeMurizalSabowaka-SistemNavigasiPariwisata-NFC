...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public final float m2202getXD9Ej5fM() {
        return this.x;
    }

    /* renamed from: getY-D9Ej5fM  reason: not valid java name */
    public final float m2203getYD9Ej5fM() {
        return this.y;
    }
    ...
    private OffsetElement(float x2, float y2, boolean rtlAware2, Function1<? super InspectorInfo, Unit> inspectorInfo2) {
    ...
    public OffsetNode create() {
        return new OffsetNode(this.x, this.y, this.rtlAware, (DefaultConstructorMarker) null);
    }

    public void update(OffsetNode node) {
        Intrinsics.checkNotNullParameter(node, "node");
        node.m2211setX0680j_4(this.x);
        node.m2212setY0680j_4(this.y);
    ...
    public boolean equals(Object other) {
        ...
        OffsetElement otherModifierElement = other instanceof OffsetElement ? (OffsetElement) other : null;
        if (otherModifierElement == null) {
            return false;
        }
        if (!Dp.m7559equalsimpl0(this.x, otherModifierElement.x) || !Dp.m7559equalsimpl0(this.y, otherModifierElement.y) || this.rtlAware != otherModifierElement.rtlAware) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((Dp.m7560hashCodeimpl(this.x) * 31) + Dp.m7560hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + Dp.m7565toStringimpl(this.x) + ", y=" + Dp.m7565toStringimpl(this.y) + ", rtlAware=" + this.rtlAware + ')';
    }
