...
public final class SizeKt$requiredWidth3ABfNKs$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$requiredWidth_3ABfNKs_u24lambda_u247 = $this$null;
        $this$requiredWidth_3ABfNKs_u24lambda_u247.setName("requiredWidth");
        $this$requiredWidth_3ABfNKs_u24lambda_u247.setValue(Dp.m7552boximpl(this.$width$inlined));
    }
}
