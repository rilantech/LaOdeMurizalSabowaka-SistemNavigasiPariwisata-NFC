...
public final class WindowInsetsPaddingKt$windowInsetsPadding$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$windowInsetsPadding_u24lambda_u240 = $this$null;
        $this$windowInsetsPadding_u24lambda_u240.setName("windowInsetsPadding");
        $this$windowInsetsPadding_u24lambda_u240.getProperties().set("insets", this.$insets$inlined);
    }
}
