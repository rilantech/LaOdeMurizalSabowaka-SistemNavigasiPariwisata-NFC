...
public final class SizeKt$requiredSizeInqDBjuR0$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        $this$requiredSizeIn_qDBjuR0_u24lambda_u2413.getProperties().set("minWidth", Dp.m7552boximpl(this.$minWidth$inlined));
        $this$requiredSizeIn_qDBjuR0_u24lambda_u2413.getProperties().set("minHeight", Dp.m7552boximpl(this.$minHeight$inlined));
        $this$requiredSizeIn_qDBjuR0_u24lambda_u2413.getProperties().set("maxWidth", Dp.m7552boximpl(this.$maxWidth$inlined));
        $this$requiredSizeIn_qDBjuR0_u24lambda_u2413.getProperties().set("maxHeight", Dp.m7552boximpl(this.$maxHeight$inlined));
    }
}
