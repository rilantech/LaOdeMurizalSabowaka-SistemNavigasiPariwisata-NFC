...
final class FixedDpInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.m7529roundToPx0680j_4(this.leftDp);
    }

    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m7529roundToPx0680j_4(this.topDp);
    }

    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.m7529roundToPx0680j_4(this.rightDp);
    }

    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m7529roundToPx0680j_4(this.bottomDp);
    }

    public String toString() {
        return "Insets(left=" + Dp.m7565toStringimpl(this.leftDp) + ", top=" + Dp.m7565toStringimpl(this.topDp) + ", right=" + Dp.m7565toStringimpl(this.rightDp) + ", bottom=" + Dp.m7565toStringimpl(this.bottomDp) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!Dp.m7559equalsimpl0(this.leftDp, ((FixedDpInsets) other).leftDp) || !Dp.m7559equalsimpl0(this.topDp, ((FixedDpInsets) other).topDp) || !Dp.m7559equalsimpl0(this.rightDp, ((FixedDpInsets) other).rightDp) || !Dp.m7559equalsimpl0(this.bottomDp, ((FixedDpInsets) other).bottomDp)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((Dp.m7560hashCodeimpl(this.leftDp) * 31) + Dp.m7560hashCodeimpl(this.topDp)) * 31) + Dp.m7560hashCodeimpl(this.rightDp)) * 31) + Dp.m7560hashCodeimpl(this.bottomDp);
    }
}
