...
public final class SizeKt$requiredHeightInVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        $this$requiredHeightIn_VpY3zN4_u24lambda_u2412.getProperties().set("min", Dp.m7552boximpl(this.$min$inlined));
        $this$requiredHeightIn_VpY3zN4_u24lambda_u2412.getProperties().set("max", Dp.m7552boximpl(this.$max$inlined));
    }
}
