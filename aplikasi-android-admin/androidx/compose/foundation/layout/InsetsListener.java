...
final class InsetsListener extends WindowInsetsAnimationCompat.Callback implements Runnable, OnApplyWindowInsetsListener, View.OnAttachStateChangeListener {
    ...
    public InsetsListener(WindowInsetsHolder composeInsets2) {
        super(composeInsets2.getConsumes() ^ true ? 1 : 0);
        Intrinsics.checkNotNullParameter(composeInsets2, "composeInsets");
        this.composeInsets = composeInsets2;
    }
    ...
    public WindowInsetsCompat onProgress(WindowInsetsCompat insets, List<WindowInsetsAnimationCompat> runningAnimations) {
        ...
        WindowInsetsHolder.update$default(this.composeInsets, insets, 0, 2, (Object) null);
        if (!this.composeInsets.getConsumes()) {
            return insets;
        }
        WindowInsetsCompat windowInsetsCompat = WindowInsetsCompat.CONSUMED;
        Intrinsics.checkNotNullExpressionValue(windowInsetsCompat, "CONSUMED");
    ...
    public void run() {
        if (this.prepared) {
            ...
            if (it != null) {
                ...
                WindowInsetsHolder.update$default(this.composeInsets, it, 0, 2, (Object) null);
                this.savedInsets = null;
            }
        }
    }
