...
public final class RowColumnMeasurementHelper {
    ...
    public final float m2293getArrangementSpacingD9Ej5fM() {
    ...
    public final RowColumnMeasureHelperResult m2294measureWithoutPlacing_EkL_Y(MeasureScope measureScope, long constraints, int startIndex, int endIndex) {
        long fixedSpace;
        ...
        long constraints2 = OrientationIndependentConstraints.m2217constructorimpl(constraints, this.orientation);
        long arrangementSpacingPx3 = (long) measureScope.m7529roundToPx0680j_4(this.arrangementSpacing);
        long fixedSpace3 = 0;
        ...
        while (true) {
            ...
            if (weight > 0.0f) {
                ...
                int mainAxisMax4 = Constraints.m7498getMaxWidthimpl(constraints2);
                ...
                if (placeable == null) {
                    ...
                    i4 = i6;
                    subSize = subSize3;
                    placeable = child.m6399measureBRTryo0(OrientationIndependentConstraints.m2230toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m2219copyyUG9Ft0$default(constraints2, 0, subSize2, 0, 0, 8, (Object) null), this.orientation));
                } else {
                    mainAxisMax2 = crossAxisSpace3;
        ...
        if (weightChildrenCount == 0) {
            ...
            if (totalWeight <= 0.0f || Constraints.m7498getMaxWidthimpl(constraints2) == Integer.MAX_VALUE) {
                targetSpace = Constraints.m7500getMinWidthimpl(constraints2);
            } else {
                targetSpace = Constraints.m7498getMaxWidthimpl(constraints2);
            }
            ...
            while (i8 < i5) {
                ...
                if (this.placeables[i8] == null) {
                    ...
                    if (weight2 > 0.0f) {
                        ...
                        Placeable placeable2 = child3.m6399measureBRTryo0(OrientationIndependentConstraints.m2230toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m2215constructorimpl(i3, childMainAxisSize, 0, Constraints.m7497getMaxHeightimpl(constraints2)), this.orientation));
            ...
            i = 0;
            weightedSpace = (int) RangesKt.coerceIn(((long) weightedSpace3) + arrangementSpacingTotal, 0, ((long) Constraints.m7498getMaxWidthimpl(constraints2)) - fixedSpace);
        ...
        int mainAxisLayoutSize = Math.max((int) RangesKt.coerceAtLeast(fixedSpace + ((long) weightedSpace), 0), Constraints.m7500getMinWidthimpl(constraints2));
        if (Constraints.m7497getMaxHeightimpl(constraints2) == Integer.MAX_VALUE || this.crossAxisSize != SizeMode.Expand) {
            crossAxisLayoutSize = Math.max(crossAxisSpace, Math.max(Constraints.m7499getMinHeightimpl(constraints2), beforeCrossAxisAlignmentLine + afterCrossAxisAlignmentLine));
        } else {
            crossAxisLayoutSize = Constraints.m7497getMaxHeightimpl(constraints2);
        }
