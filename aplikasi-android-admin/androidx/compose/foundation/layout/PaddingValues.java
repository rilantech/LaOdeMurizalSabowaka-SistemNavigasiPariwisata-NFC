...
public interface PaddingValues {
    ...
    float m2262calculateBottomPaddingD9Ej5fM();

    /* renamed from: calculateLeftPadding-u2uoSUM  reason: not valid java name */
    float m2263calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateRightPadding-u2uoSUM  reason: not valid java name */
    float m2264calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateTopPadding-D9Ej5fM  reason: not valid java name */
    float m2265calculateTopPaddingD9Ej5fM();
    ...
    public static final class Absolute implements PaddingValues {
        ...
        private static /* synthetic */ void m2266getBottomD9Ej5fM$annotations() {
        }

        /* renamed from: getLeft-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m2267getLeftD9Ej5fM$annotations() {
        }

        /* renamed from: getRight-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m2268getRightD9Ej5fM$annotations() {
        }

        /* renamed from: getTop-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m2269getTopD9Ej5fM$annotations() {
        }
        ...
        /* renamed from: calculateLeftPadding-u2uoSUM  reason: not valid java name */
        public float m2271calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            return this.left;
        }

        /* renamed from: calculateTopPadding-D9Ej5fM  reason: not valid java name */
        public float m2273calculateTopPaddingD9Ej5fM() {
            return this.top;
        }

        /* renamed from: calculateRightPadding-u2uoSUM  reason: not valid java name */
        public float m2272calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            return this.right;
        }

        /* renamed from: calculateBottomPadding-D9Ej5fM  reason: not valid java name */
        public float m2270calculateBottomPaddingD9Ej5fM() {
            return this.bottom;
        }

        public boolean equals(Object other) {
            if ((other instanceof Absolute) && Dp.m7559equalsimpl0(this.left, ((Absolute) other).left) && Dp.m7559equalsimpl0(this.top, ((Absolute) other).top) && Dp.m7559equalsimpl0(this.right, ((Absolute) other).right) && Dp.m7559equalsimpl0(this.bottom, ((Absolute) other).bottom)) {
                return true;
            }
            return false;
        }
        ...
        public String toString() {
            return "PaddingValues.Absolute(left=" + Dp.m7565toStringimpl(this.left) + ", top=" + Dp.m7565toStringimpl(this.top) + ", right=" + Dp.m7565toStringimpl(this.right) + ", bottom=" + Dp.m7565toStringimpl(this.bottom) + ')';
        }
    }
}
