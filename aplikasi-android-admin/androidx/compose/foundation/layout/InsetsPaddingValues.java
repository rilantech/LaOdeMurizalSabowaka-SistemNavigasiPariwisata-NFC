...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float m2192calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Density $this$calculateLeftPadding_u2uoSUM_u24lambda_u240 = this.density;
        return $this$calculateLeftPadding_u2uoSUM_u24lambda_u240.m7532toDpu2uoSUM(this.insets.getLeft($this$calculateLeftPadding_u2uoSUM_u24lambda_u240, layoutDirection));
    }

    /* renamed from: calculateTopPadding-D9Ej5fM  reason: not valid java name */
    public float m2194calculateTopPaddingD9Ej5fM() {
        Density $this$calculateTopPadding_D9Ej5fM_u24lambda_u241 = this.density;
        return $this$calculateTopPadding_D9Ej5fM_u24lambda_u241.m7532toDpu2uoSUM(this.insets.getTop($this$calculateTopPadding_D9Ej5fM_u24lambda_u241));
    }

    /* renamed from: calculateRightPadding-u2uoSUM  reason: not valid java name */
    public float m2193calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Density $this$calculateRightPadding_u2uoSUM_u24lambda_u242 = this.density;
        return $this$calculateRightPadding_u2uoSUM_u24lambda_u242.m7532toDpu2uoSUM(this.insets.getRight($this$calculateRightPadding_u2uoSUM_u24lambda_u242, layoutDirection));
    }

    /* renamed from: calculateBottomPadding-D9Ej5fM  reason: not valid java name */
    public float m2191calculateBottomPaddingD9Ej5fM() {
        Density $this$calculateBottomPadding_D9Ej5fM_u24lambda_u243 = this.density;
        return $this$calculateBottomPadding_D9Ej5fM_u24lambda_u243.m7532toDpu2uoSUM(this.insets.getBottom($this$calculateBottomPadding_D9Ej5fM_u24lambda_u243));
    }
