...
public final class SizeKt$size3ABfNKs$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$size_3ABfNKs_u24lambda_u242 = $this$null;
        $this$size_3ABfNKs_u24lambda_u242.setName("size");
        $this$size_3ABfNKs_u24lambda_u242.setValue(Dp.m7552boximpl(this.$size$inlined));
    }
}
