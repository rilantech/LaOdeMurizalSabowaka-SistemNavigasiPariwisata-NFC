...
public final class AlignmentLineKt$paddingFromY_r0B1c$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$paddingFrom_Y_r0B1c_u24lambda_u241 = $this$null;
        $this$paddingFrom_Y_r0B1c_u24lambda_u241.setName("paddingFrom");
        $this$paddingFrom_Y_r0B1c_u24lambda_u241.getProperties().set("alignmentLine", this.$alignmentLine$inlined);
        $this$paddingFrom_Y_r0B1c_u24lambda_u241.getProperties().set("before", TextUnit.m7725boximpl(this.$before$inlined));
        $this$paddingFrom_Y_r0B1c_u24lambda_u241.getProperties().set("after", TextUnit.m7725boximpl(this.$after$inlined));
    }
}
