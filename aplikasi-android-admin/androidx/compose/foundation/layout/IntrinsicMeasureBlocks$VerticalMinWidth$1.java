...
final class IntrinsicMeasureBlocks$VerticalMinWidth$1 extends Lambda implements Function3<List<? extends IntrinsicMeasurable>, Integer, Integer, Integer> {
    ...
    public final Integer invoke(List<? extends IntrinsicMeasurable> measurables, int availableHeight, int mainAxisSpacing) {
        ...
        return Integer.valueOf(RowColumnImplKt.intrinsicSize(measurables, AnonymousClass1.INSTANCE, AnonymousClass2.INSTANCE, availableHeight, mainAxisSpacing, LayoutOrientation.Vertical, LayoutOrientation.Horizontal));
    }
}
