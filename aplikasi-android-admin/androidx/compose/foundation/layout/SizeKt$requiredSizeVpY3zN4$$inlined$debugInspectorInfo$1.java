...
public final class SizeKt$requiredSizeVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        $this$requiredSize_VpY3zN4_u24lambda_u2410.getProperties().set("width", Dp.m7552boximpl(this.$width$inlined));
        $this$requiredSize_VpY3zN4_u24lambda_u2410.getProperties().set("height", Dp.m7552boximpl(this.$height$inlined));
    }
}
