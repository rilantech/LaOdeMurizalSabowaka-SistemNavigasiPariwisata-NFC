...
public final class RowKt {
    ...
    static {
        ...
        float r1 = Arrangement.INSTANCE.getStart().m2140getSpacingD9Ej5fM();
        ...
        DefaultRowMeasurePolicy = RowColumnImplKt.m2291rowColumnMeasurePolicyTDGSqEk(layoutOrientation, RowKt$DefaultRowMeasurePolicy$1.INSTANCE, r1, SizeMode.Wrap, vertical$foundation_layout_release);
    }
    ...
    public static final MeasurePolicy rowMeasurePolicy(Arrangement.Horizontal horizontalArrangement, Alignment.Vertical verticalAlignment, Composer $composer, int $changed) {
        ...
        if (!Intrinsics.areEqual((Object) horizontal, (Object) Arrangement.INSTANCE.getStart()) || !Intrinsics.areEqual((Object) vertical, (Object) Alignment.Companion.getTop())) {
            ...
            if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
                LayoutOrientation layoutOrientation = LayoutOrientation.Horizontal;
                float r13 = horizontalArrangement.m2140getSpacingD9Ej5fM();
                ...
                measurePolicy2 = RowColumnImplKt.m2291rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new RowKt$rowMeasurePolicy$1$1(horizontal), r13, SizeMode.Wrap, vertical$foundation_layout_release);
