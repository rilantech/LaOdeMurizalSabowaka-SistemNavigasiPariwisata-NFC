...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult m2340measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> measurables, long constraints) {
        ...
        int height = 0;
        int width = Constraints.m7496getHasFixedWidthimpl($this$measure_3p2s80s_u24lambda_u240) ? Constraints.m7498getMaxWidthimpl($this$measure_3p2s80s_u24lambda_u240) : 0;
        if (Constraints.m7495getHasFixedHeightimpl($this$measure_3p2s80s_u24lambda_u240)) {
            height = Constraints.m7497getMaxHeightimpl($this$measure_3p2s80s_u24lambda_u240);
        }
