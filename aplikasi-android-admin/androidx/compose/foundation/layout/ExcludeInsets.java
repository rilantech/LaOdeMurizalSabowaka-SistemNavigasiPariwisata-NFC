...
final class ExcludeInsets implements WindowInsets {
    ...
    public ExcludeInsets(WindowInsets included2, WindowInsets excluded2) {
        Intrinsics.checkNotNullParameter(included2, "included");
        Intrinsics.checkNotNullParameter(excluded2, "excluded");
        this.included = included2;
    ...
    public boolean equals(Object other) {
        ...
        if (!Intrinsics.areEqual((Object) ((ExcludeInsets) other).included, (Object) this.included) || !Intrinsics.areEqual((Object) ((ExcludeInsets) other).excluded, (Object) this.excluded)) {
            return false;
        }
        return true;
    }
