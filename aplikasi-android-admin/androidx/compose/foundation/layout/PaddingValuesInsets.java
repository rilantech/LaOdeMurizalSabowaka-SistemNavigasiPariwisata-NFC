...
final class PaddingValuesInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.m7529roundToPx0680j_4(this.paddingValues.m2263calculateLeftPaddingu2uoSUM(layoutDirection));
    }

    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m7529roundToPx0680j_4(this.paddingValues.m2265calculateTopPaddingD9Ej5fM());
    }

    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.m7529roundToPx0680j_4(this.paddingValues.m2264calculateRightPaddingu2uoSUM(layoutDirection));
    }

    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m7529roundToPx0680j_4(this.paddingValues.m2262calculateBottomPaddingD9Ej5fM());
    }

    public String toString() {
        LayoutDirection layoutDirection = LayoutDirection.Ltr;
        return "PaddingValues(" + Dp.m7565toStringimpl(this.paddingValues.m2263calculateLeftPaddingu2uoSUM(layoutDirection)) + ", " + Dp.m7565toStringimpl(this.paddingValues.m2265calculateTopPaddingD9Ej5fM()) + ", " + Dp.m7565toStringimpl(this.paddingValues.m2264calculateRightPaddingu2uoSUM(layoutDirection)) + ", " + Dp.m7565toStringimpl(this.paddingValues.m2262calculateBottomPaddingD9Ej5fM()) + ')';
    }
