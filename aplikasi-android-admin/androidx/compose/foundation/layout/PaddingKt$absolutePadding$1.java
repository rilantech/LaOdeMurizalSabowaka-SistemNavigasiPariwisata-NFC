...
final class PaddingKt$absolutePadding$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$$receiver) {
        ...
        $this$$receiver.getProperties().set("left", Dp.m7552boximpl(this.$left));
        $this$$receiver.getProperties().set("top", Dp.m7552boximpl(this.$top));
        $this$$receiver.getProperties().set("right", Dp.m7552boximpl(this.$right));
        $this$$receiver.getProperties().set("bottom", Dp.m7552boximpl(this.$bottom));
    }
}
