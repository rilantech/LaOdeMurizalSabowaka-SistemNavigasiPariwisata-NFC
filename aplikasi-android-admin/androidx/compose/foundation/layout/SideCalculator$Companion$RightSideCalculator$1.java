...
public final class SideCalculator$Companion$RightSideCalculator$1 implements SideCalculator {
    ...
    public long m2302consumedOffsetsMKHz9U(long available) {
        return OffsetKt.Offset(Offset.m4713getXimpl(available), 0.0f);
    }

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    public long m2303consumedVelocityQWom1Mo(long available, float remaining) {
        return VelocityKt.Velocity(Velocity.m7779getXimpl(available) + remaining, 0.0f);
    }
}
