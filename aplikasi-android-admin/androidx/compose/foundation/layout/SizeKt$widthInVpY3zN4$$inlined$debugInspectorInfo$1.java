...
public final class SizeKt$widthInVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$widthIn_VpY3zN4_u24lambda_u244 = $this$null;
        $this$widthIn_VpY3zN4_u24lambda_u244.setName("widthIn");
        $this$widthIn_VpY3zN4_u24lambda_u244.getProperties().set("min", Dp.m7552boximpl(this.$min$inlined));
        $this$widthIn_VpY3zN4_u24lambda_u244.getProperties().set("max", Dp.m7552boximpl(this.$max$inlined));
    }
}
