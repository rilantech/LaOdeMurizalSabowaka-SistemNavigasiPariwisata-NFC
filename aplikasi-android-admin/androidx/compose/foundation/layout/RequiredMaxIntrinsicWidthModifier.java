...
final class RequiredMaxIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long m2288calculateContentConstraintsl58MMJ0(MeasureScope $this$calculateContentConstraints_u2dl58MMJ0, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$calculateContentConstraints_u2dl58MMJ0, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m7508fixedWidthOenEA2s(measurable.maxIntrinsicWidth(Constraints.m7497getMaxHeightimpl(constraints)));
    }
