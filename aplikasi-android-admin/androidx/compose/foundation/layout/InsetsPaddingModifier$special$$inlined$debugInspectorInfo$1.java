...
public final class InsetsPaddingModifier$special$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$_init__u24lambda_u240 = $this$null;
        $this$_init__u24lambda_u240.setName("InsetsPaddingModifier");
        $this$_init__u24lambda_u240.getProperties().set("insets", this.$insets$inlined);
    }
}
