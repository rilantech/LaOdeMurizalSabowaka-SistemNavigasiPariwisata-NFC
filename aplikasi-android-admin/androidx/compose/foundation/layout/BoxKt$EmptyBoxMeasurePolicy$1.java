...
final class BoxKt$EmptyBoxMeasurePolicy$1 implements MeasurePolicy {
    ...
    public final MeasureResult m2166measure3p2s80s(MeasureScope $this$MeasurePolicy, List<? extends Measurable> list, long constraints) {
        Intrinsics.checkNotNullParameter($this$MeasurePolicy, "$this$MeasurePolicy");
        Intrinsics.checkNotNullParameter(list, "<anonymous parameter 0>");
        return MeasureScope.layout$default($this$MeasurePolicy, Constraints.m7500getMinWidthimpl(constraints), Constraints.m7499getMinHeightimpl(constraints), (Map) null, BoxKt$EmptyBoxMeasurePolicy$1$measure$1.INSTANCE, 4, (Object) null);
    }
}
