...
public final class WindowInsetsSizeKt$windowInsetsTopHeight$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$windowInsetsTopHeight_u24lambda_u242 = $this$null;
        $this$windowInsetsTopHeight_u24lambda_u242.setName("insetsTopHeight");
        $this$windowInsetsTopHeight_u24lambda_u242.getProperties().set("insets", this.$insets$inlined);
    }
}
