...
public final class SizeKt$sizeVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$size_VpY3zN4_u24lambda_u243 = $this$null;
        $this$size_VpY3zN4_u24lambda_u243.setName("size");
        $this$size_VpY3zN4_u24lambda_u243.getProperties().set("width", Dp.m7552boximpl(this.$width$inlined));
        $this$size_VpY3zN4_u24lambda_u243.getProperties().set("height", Dp.m7552boximpl(this.$height$inlined));
    }
}
