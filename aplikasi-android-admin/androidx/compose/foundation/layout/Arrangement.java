...
public final class Arrangement {
    ...
    public interface Horizontal {
        ...
        public static final class DefaultImpls {
            ...
            public static float m2141getSpacingD9Ej5fM(Horizontal $this) {
                return Horizontal.super.m2140getSpacingD9Ej5fM();
            }
        }

        /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
        float m2140getSpacingD9Ej5fM() {
            return Dp.m7554constructorimpl((float) 0);
        }
    }
    ...
    public interface Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m2155getSpacingD9Ej5fM(Vertical $this) {
                return Vertical.super.m2154getSpacingD9Ej5fM();
            }
        }

        /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
        float m2154getSpacingD9Ej5fM() {
            return Dp.m7554constructorimpl((float) 0);
        }
    }
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m2144getSpacingD9Ej5fM(HorizontalOrVertical $this) {
                return HorizontalOrVertical.super.m2143getSpacingD9Ej5fM();
            }
        }

        /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
        float m2143getSpacingD9Ej5fM() {
            return Dp.m7554constructorimpl((float) 0);
        }
    }
    ...
    public final HorizontalOrVertical m2132spacedBy0680j_4(float space) {
    ...
    public final Horizontal m2133spacedByD5KLDUw(float space, Alignment.Horizontal alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(space, true, new Arrangement$spacedBy$2(alignment), (DefaultConstructorMarker) null);
    }

    /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
    public final Vertical m2134spacedByD5KLDUw(float space, Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
    ...
    public final Horizontal aligned(Alignment.Horizontal alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m7554constructorimpl((float) 0), true, new Arrangement$aligned$1(alignment), (DefaultConstructorMarker) null);
    }

    public final Vertical aligned(Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m7554constructorimpl((float) 0), false, new Arrangement$aligned$2(alignment), (DefaultConstructorMarker) null);
    }
    ...
    public static final class Absolute {
        ...
        /* renamed from: spacedBy-0680j_4  reason: not valid java name */
        public final HorizontalOrVertical m2135spacedBy0680j_4(float space) {
            return new SpacedAligned(space, false, (Function2) null, (DefaultConstructorMarker) null);
        }

        /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
        public final Horizontal m2136spacedByD5KLDUw(float space, Alignment.Horizontal alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
            return new SpacedAligned(space, false, new Arrangement$Absolute$spacedBy$1(alignment), (DefaultConstructorMarker) null);
        }

        /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
        public final Vertical m2137spacedByD5KLDUw(float space, Alignment.Vertical alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
        ...
        public final Horizontal aligned(Alignment.Horizontal alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
            return new SpacedAligned(Dp.m7554constructorimpl((float) 0), false, new Arrangement$Absolute$aligned$1(alignment), (DefaultConstructorMarker) null);
        }
    }
    ...
    public static final class SpacedAligned implements HorizontalOrVertical {
        ...
        public static /* synthetic */ SpacedAligned m2148copy8Feqmps$default(SpacedAligned spacedAligned, float f, boolean z, Function2<Integer, LayoutDirection, Integer> function2, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return spacedAligned.m2150copy8Feqmps(f, z, function2);
        }

        /* renamed from: component1-D9Ej5fM  reason: not valid java name */
        public final float m2149component1D9Ej5fM() {
            return this.space;
        }
        ...
        public final SpacedAligned m2150copy8Feqmps(float f, boolean z, Function2<? super Integer, ? super LayoutDirection, Integer> function2) {
        ...
        public boolean equals(Object obj) {
            ...
            return Dp.m7559equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual((Object) this.alignment, (Object) spacedAligned.alignment);
        }

        public int hashCode() {
            int r1 = Dp.m7560hashCodeimpl(this.space) * 31;
        ...
        public final float m2151getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
        public float m2152getSpacingD9Ej5fM() {
            return this.spacing;
        }
        ...
        public void arrange(Density $this$arrange, int totalSize, int[] sizes, LayoutDirection layoutDirection, int[] outPositions) {
            ...
            if (!(iArr.length == 0)) {
                int spacePx = density.m7529roundToPx0680j_4(this.space);
                int occupied2 = 0;
                int lastSpace2 = 0;
        ...
        public String toString() {
            return (this.rtlMirror ? "" : "Absolute") + "Arrangement#spacedAligned(" + Dp.m7565toStringimpl(this.space) + ", " + this.alignment + ')';
        }
    }
