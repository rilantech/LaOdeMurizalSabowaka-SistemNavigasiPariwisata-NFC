...
final class AndroidFlingSpline {
    ...
    public final long m2122flingPositionLfoxSSI(float time) {
        float f = (float) 100;
        ...
        return FlingResult.m2124constructorimpl((((long) Float.floatToIntBits(distanceCoef)) << 32) | (4294967295L & ((long) Float.floatToIntBits(velocityCoef))));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m2123boximpl(long j) {
            return new FlingResult(j);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        public static long m2124constructorimpl(long j) {
            return j;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m2125equalsimpl(long j, Object obj) {
            return (obj instanceof FlingResult) && j == ((FlingResult) obj).m2131unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m2126equalsimpl0(long j, long j2) {
            return j == j2;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m2129hashCodeimpl(long j) {
        ...
        public boolean equals(Object obj) {
            return m2125equalsimpl(this.packedValue, obj);
        }

        public int hashCode() {
            return m2129hashCodeimpl(this.packedValue);
        }

        public String toString() {
            return m2130toStringimpl(this.packedValue);
        }
        ...
        public static final float m2127getDistanceCoefficientimpl(long arg0) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
            return Float.intBitsToFloat((int) (arg0 >> 32));
        }

        /* renamed from: getVelocityCoefficient-impl  reason: not valid java name */
        public static final float m2128getVelocityCoefficientimpl(long arg0) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
