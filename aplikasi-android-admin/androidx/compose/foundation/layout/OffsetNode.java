...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final float m2208getXD9Ej5fM() {
        return this.x;
    }

    /* renamed from: setX-0680j_4  reason: not valid java name */
    public final void m2211setX0680j_4(float f) {
        this.x = f;
    }

    /* renamed from: getY-D9Ej5fM  reason: not valid java name */
    public final float m2209getYD9Ej5fM() {
        return this.y;
    }

    /* renamed from: setY-0680j_4  reason: not valid java name */
    public final void m2212setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public MeasureResult m2210measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
