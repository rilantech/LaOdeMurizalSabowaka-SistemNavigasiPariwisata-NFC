...
public final class VerticalAlignNode extends Modifier.Node implements ParentDataModifierNode {
    ...
    public final void setVertical(Alignment.Vertical vertical2) {
        Intrinsics.checkNotNullParameter(vertical2, "<set-?>");
        this.vertical = vertical2;
    }

    public VerticalAlignNode(Alignment.Vertical vertical2) {
