...
public final class SizeKt$heightInVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$heightIn_VpY3zN4_u24lambda_u245 = $this$null;
        $this$heightIn_VpY3zN4_u24lambda_u245.setName("heightIn");
        $this$heightIn_VpY3zN4_u24lambda_u245.getProperties().set("min", Dp.m7552boximpl(this.$min$inlined));
        $this$heightIn_VpY3zN4_u24lambda_u245.getProperties().set("max", Dp.m7552boximpl(this.$max$inlined));
    }
}
