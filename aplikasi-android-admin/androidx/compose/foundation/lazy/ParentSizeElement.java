...
final class ParentSizeElement extends ModifierNodeElement<ParentSizeNode> {
    ...
    public ParentSizeElement(float fraction2, State<Integer> widthState2, State<Integer> heightState2, String inspectorName2) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(this.fraction == ((ParentSizeNode) other).getFraction()) || !Intrinsics.areEqual((Object) this.widthState, (Object) ((ParentSizeNode) other).getWidthState()) || !Intrinsics.areEqual((Object) this.heightState, (Object) ((ParentSizeNode) other).getHeightState())) {
            return false;
        }
        return true;
    }
