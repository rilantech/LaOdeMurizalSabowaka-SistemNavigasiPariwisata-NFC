...
public final class LazyGridDslKt$items$3 extends Lambda implements Function2<LazyGridItemSpanScope, Integer, GridItemSpan> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return GridItemSpan.m2400boximpl(m2409invoke_orMbw((LazyGridItemSpanScope) p1, ((Number) p2).intValue()));
    }

    /* renamed from: invoke-_-orMbw  reason: not valid java name */
    public final long m2409invoke_orMbw(LazyGridItemSpanScope $this$null, int it) {
        Intrinsics.checkNotNullParameter($this$null, "$this$null");
        return this.$span.invoke($this$null, this.$items.get(it)).m2407unboximpl();
    }
}
