...
public interface GridCells {
    ...
    public static final class Fixed implements GridCells {
        ...
        public Fixed(int count2) {
            this.count = count2;
            if (!(count2 > 0)) {
                throw new IllegalArgumentException(("Provided count " + count2 + " should be larger than zero").toString());
            }
        }
    ...
    public static final class Adaptive implements GridCells {
        ...
        private Adaptive(float minSize2) {
            this.minSize = minSize2;
            if (!(Dp.m7553compareTo0680j_4(minSize2, Dp.m7554constructorimpl((float) 0)) > 0)) {
                throw new IllegalArgumentException(("Provided min size " + Dp.m7565toStringimpl(minSize2) + " should be larger than zero.").toString());
            }
        }

        public List<Integer> calculateCrossAxisCellSizes(Density $this$calculateCrossAxisCellSizes, int availableSize, int spacing) {
            Intrinsics.checkNotNullParameter($this$calculateCrossAxisCellSizes, "<this>");
            return LazyGridDslKt.calculateCellsCrossAxisSizeImpl(availableSize, Math.max((availableSize + spacing) / ($this$calculateCrossAxisCellSizes.m7529roundToPx0680j_4(this.minSize) + spacing), 1), spacing);
        }

        public int hashCode() {
            return Dp.m7560hashCodeimpl(this.minSize);
        }

        public boolean equals(Object other) {
            return (other instanceof Adaptive) && Dp.m7559equalsimpl0(this.minSize, ((Adaptive) other).minSize);
        }
    }
    ...
    public static final class FixedSize implements GridCells {
        ...
        private FixedSize(float size2) {
            this.size = size2;
            if (!(Dp.m7553compareTo0680j_4(size2, Dp.m7554constructorimpl((float) 0)) > 0)) {
                throw new IllegalArgumentException(("Provided size " + Dp.m7565toStringimpl(size2) + " should be larger than zero.").toString());
            }
        }

        public List<Integer> calculateCrossAxisCellSizes(Density $this$calculateCrossAxisCellSizes, int availableSize, int spacing) {
            Intrinsics.checkNotNullParameter($this$calculateCrossAxisCellSizes, "<this>");
            int cellSize = $this$calculateCrossAxisCellSizes.m7529roundToPx0680j_4(this.size);
            int i = 0;
        ...
        public int hashCode() {
            return Dp.m7560hashCodeimpl(this.size);
        }

        public boolean equals(Object other) {
            return (other instanceof FixedSize) && Dp.m7559equalsimpl0(this.size, ((FixedSize) other).size);
        }
    }
}
