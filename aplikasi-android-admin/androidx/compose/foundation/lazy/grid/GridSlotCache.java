...
final class GridSlotCache implements Function2<Density, Constraints, LazyGridSlots> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m2408invoke0kLqBqw((Density) p1, ((Constraints) p2).m7504unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public LazyGridSlots m2408invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots it = this.calculation.invoke($this$invoke_0kLqBqw_u24lambda_u241, Constraints.m7486boximpl(constraints));
        this.cachedSizes = it;
        return it;
    }
}
