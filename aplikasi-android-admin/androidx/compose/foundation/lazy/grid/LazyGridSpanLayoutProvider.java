...
public final class LazyGridSpanLayoutProvider {
    ...
    private final List<GridItemSpan> getDefaultSpans(int currentSlotsPerLine) {
        ...
        for (int i = 0; i < currentSlotsPerLine; i++) {
            int i2 = i;
            arrayList.add(GridItemSpan.m2400boximpl(LazyGridSpanKt.GridItemSpan(1)));
        }
        List it = arrayList;
    ...
    public final androidx.compose.foundation.lazy.grid.LazyGridSpanLayoutProvider.LineConfiguration getLineConfiguration(int r14) {
        ...
        L_0x0152:
            ...
            androidx.compose.foundation.lazy.grid.GridItemSpan r9 = androidx.compose.foundation.lazy.grid.GridItemSpan.m2400boximpl(r9)
            r3.add(r9)
            int r7 = r7 + r5
            r5 = r8
            goto L_0x0138
    ...
    public final int spanOf(int itemIndex, int maxSpan) {
        ...
        return GridItemSpan.m2404getCurrentLineSpanimpl(((LazyGridInterval) interval.getValue()).getSpan().invoke($this$spanOf_u24lambda_u246, Integer.valueOf(itemIndex - interval.getStartIndex())).m2407unboximpl());
    }
