...
public final class LazyGridMeasuredItem implements LazyGridItemInfo {
    ...
    public long m2426getSizeYbymL2g() {
        return this.size;
    }

    /* renamed from: getOffset-nOcc-ac  reason: not valid java name */
    public long m2425getOffsetnOccac() {
        return this.offset;
    }

    public final int getCrossAxisOffset() {
        return this.isVertical ? IntOffset.m7672getXimpl(m2425getOffsetnOccac()) : IntOffset.m7673getYimpl(m2425getOffsetnOccac());
    }
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        if (this.mainAxisLayoutSize != Integer.MIN_VALUE) {
            ...
            while (i4 < placeablesCount) {
                ...
                long offset2 = m2425getOffsetnOccac();
                ...
                if (animateNode != null) {
                    ...
                    if ((m2424getMainAxisgyyYBs(offset2) <= minOffset && m2424getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m2424getMainAxisgyyYBs(offset2) >= maxOffset && m2424getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
                ...
                if (this.reverseLayout != 0) {
                    ...
                    long j2 = offset2;
                    int mainAxisOffset = this.isVertical ? IntOffset.m7672getXimpl($this$copy_u2d4Tuh3kE$iv) : (this.mainAxisLayoutSize - IntOffset.m7672getXimpl($this$copy_u2d4Tuh3kE$iv)) - getMainAxisSize(placeable);
                    if (this.isVertical) {
                ...
                long offset3 = IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(offset2) + IntOffset.m7672getXimpl(other$iv2), IntOffset.m7673getYimpl(offset2) + IntOffset.m7673getYimpl(other$iv2));
                if (this.isVertical) {
                    int i5 = maxOffset;
                    int i6 = minOffset;
                    Placeable.PlacementScope.m6442placeWithLayeraW9wM$default($this$place_u24lambda_u244, placeable, offset3, 0.0f, (Function1) null, 6, (Object) null);
                } else {
                    int i7 = minOffset;
                    Placeable.PlacementScope.m6441placeRelativeWithLayeraW9wM$default($this$place_u24lambda_u244, placeable, offset3, 0.0f, (Function1) null, 6, (Object) null);
                }
                i4++;
                i3 = i;
            }
    ...
    private final int m2424getMainAxisgyyYBs(long $this$mainAxis) {
    ...
    private final long m2423copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> mainAxisMap) {
