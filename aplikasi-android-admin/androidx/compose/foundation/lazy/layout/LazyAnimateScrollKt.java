...
public final class LazyAnimateScrollKt {
    ...
    public static final float BoundDistance = Dp.m7554constructorimpl((float) ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED);
    private static final boolean DEBUG = false;
    /* access modifiers changed from: private */
    public static final float MinimumDistance = Dp.m7554constructorimpl((float) 50);
    /* access modifiers changed from: private */
    public static final float TargetDistance = Dp.m7554constructorimpl((float) DefaultRetryPolicy.DEFAULT_TIMEOUT_MS);
