...
public interface IntervalList<T> {
    void forEach(int i, int i2, Function1<? super Interval<? extends T>, Unit> function1);
    ...
    public static final class Interval<T> {
        ...
        public Interval(int startIndex2, int size2, T value2) {
            ...
            throw new IllegalArgumentException(("startIndex should be >= 0, but was " + startIndex2).toString());
        }
