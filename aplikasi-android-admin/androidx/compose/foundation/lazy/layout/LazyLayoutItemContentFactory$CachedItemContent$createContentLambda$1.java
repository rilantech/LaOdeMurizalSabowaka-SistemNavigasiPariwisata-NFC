    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            ...
            if (active$iv) {
                ...
                LazyLayoutItemContentFactoryKt.m2444SkippableItemJVlU9Rs(itemProvider, StableValue.m2474constructorimpl(lazyLayoutItemContentFactory.saveableStateHolder), index, StableValue.m2474constructorimpl(cachedItemContent.getKey()), $composer2, 0);
