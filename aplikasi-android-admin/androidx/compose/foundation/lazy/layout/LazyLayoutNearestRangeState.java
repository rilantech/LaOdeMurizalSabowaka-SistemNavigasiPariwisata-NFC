...
public final class LazyLayoutNearestRangeState implements State<IntRange> {
    ...
    public LazyLayoutNearestRangeState(int firstVisibleItem, int slidingWindowSize2, int extraItemCount2) {
        this.slidingWindowSize = slidingWindowSize2;
        this.extraItemCount = extraItemCount2;
        this.value$delegate = SnapshotStateKt.mutableStateOf(Companion.calculateNearestItemsRange(firstVisibleItem, slidingWindowSize2, extraItemCount2), SnapshotStateKt.structuralEqualityPolicy());
