...
public final class LazyLayoutAnimateItemModifierNode extends Modifier.Node {
    ...
    private final MutableState placementDelta$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m7663boximpl(IntOffset.Companion.m7682getZeronOccac()), (SnapshotMutationPolicy) null, 2, (Object) null);
    /* access modifiers changed from: private */
    public final Animatable<IntOffset, AnimationVector2D> placementDeltaAnimation = new Animatable(IntOffset.m7663boximpl(IntOffset.Companion.m7682getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.Companion), (Object) null, (String) null, 12, (DefaultConstructorMarker) null);
    ...
    public final long m2435getRawOffsetnOccac() {
        return this.rawOffset;
    }

    /* renamed from: setRawOffset--gyyYBs  reason: not valid java name */
    public final void m2436setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }

    /* access modifiers changed from: private */
    /* renamed from: setPlacementDelta--gyyYBs  reason: not valid java name */
    public final void m2432setPlacementDeltagyyYBs(long j) {
        this.placementDelta$delegate.setValue(IntOffset.m7663boximpl(j));
    }

    /* renamed from: getPlacementDelta-nOcc-ac  reason: not valid java name */
    public final long m2434getPlacementDeltanOccac() {
        return ((IntOffset) this.placementDelta$delegate.getValue()).m7681unboximpl();
    }
    ...
    public final void m2433animatePlacementDeltagyyYBs(long delta) {
        long arg0$iv = m2434getPlacementDeltanOccac();
        long arg0$iv2 = IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(arg0$iv) - IntOffset.m7672getXimpl(delta), IntOffset.m7673getYimpl(arg0$iv) - IntOffset.m7673getYimpl(delta));
        m2432setPlacementDeltagyyYBs(arg0$iv2);
    ...
    public void onDetach() {
        m2432setPlacementDeltagyyYBs(IntOffset.Companion.m7682getZeronOccac());
    ...
    public static final class Companion {
        ...
        public final long m2437getNotInitializednOccac() {
