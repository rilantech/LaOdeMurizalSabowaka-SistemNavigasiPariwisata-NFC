...
public interface LazyLayoutMeasureScope extends MeasureScope {
    ...
    List<Placeable> m2447measure0kLqBqw(int i, long j);

    /* renamed from: toDp-GaN1DYA  reason: not valid java name */
    float m2448toDpGaN1DYA(long $this$toDp_u2dGaN1DYA) {
    ...
    long m2451toDpSizekrfVVM(long $this$toDpSize_u2dk_u2drfVVM) {
        if ($this$toDpSize_u2dk_u2drfVVM != Size.Companion.m4790getUnspecifiedNHjbRc()) {
            return DpKt.m7576DpSizeYgX7TsA(m2449toDpu2uoSUM(Size.m4782getWidthimpl($this$toDpSize_u2dk_u2drfVVM)), m2449toDpu2uoSUM(Size.m4779getHeightimpl($this$toDpSize_u2dk_u2drfVVM)));
        }
