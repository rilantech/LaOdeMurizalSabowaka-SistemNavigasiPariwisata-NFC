...
public final class LazyStaggeredGridAnimateScrollScope implements LazyAnimateScrollScope {
    ...
    public Integer getTargetItemOffset(int index) {
        ...
        long it = findVisibleItem.m2485getOffsetnOccac();
        return Integer.valueOf(this.state.isVertical$foundation_release() ? IntOffset.m7673getYimpl(it) : IntOffset.m7672getXimpl(it));
    }
    ...
    public float expectedDistanceTo(int index, int targetScrollOffset) {
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            sum$iv += this.state.isVertical$foundation_release() ? IntSize.m7713getHeightimpl(it.m2486getSizeYbymL2g()) : IntSize.m7714getWidthimpl(it.m2486getSizeYbymL2g());
        }
