...
public interface StaggeredGridCells {
    ...
    public static final class Adaptive implements StaggeredGridCells {
        ...
        public int[] calculateCrossAxisCellSizes(Density $this$calculateCrossAxisCellSizes, int availableSize, int spacing) {
            Intrinsics.checkNotNullParameter($this$calculateCrossAxisCellSizes, "<this>");
            return LazyStaggeredGridCellsKt.calculateCellsCrossAxisSizeImpl(availableSize, Math.max((availableSize + spacing) / ($this$calculateCrossAxisCellSizes.m7529roundToPx0680j_4(this.minSize) + spacing), 1), spacing);
        }
