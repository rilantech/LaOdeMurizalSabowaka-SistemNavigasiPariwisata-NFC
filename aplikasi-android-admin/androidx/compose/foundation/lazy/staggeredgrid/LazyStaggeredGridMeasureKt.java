...
public final class LazyStaggeredGridMeasureKt {
    ...
    public static final LazyStaggeredGridMeasureResult m2496measureStaggeredGriddSVRQoE(LazyLayoutMeasureScope $this$measureStaggeredGrid_u2ddSVRQoE, LazyStaggeredGridState state, List<Integer> pinnedItems, LazyStaggeredGridItemProvider itemProvider, LazyStaggeredGridSlots resolvedSlots, long constraints, boolean isVertical, boolean reverseLayout, long contentOffset, int mainAxisAvailableSize, int mainAxisSpacing, int beforeContentPadding, int afterContentPadding) {
        Object obj;
        int i;
        Object obj2;
        int i2;
                    ...
                    while (lane < length) {
                        ...
                        try {
                            ...
                            if (lane == 0) {
                                ...
                                iArr = iArr2;
                                i3 = m2495maxInRangejy6DScQ($this$measureStaggeredGrid_dSVRQoE_u24lambda_u244_u24lambda_u242, SpanRange.m2508constructorimpl(0, lane)) + 1;
                            }
                            $this$measureStaggeredGrid_dSVRQoE_u24lambda_u244_u24lambda_u242[lane] = i3;
                            context.getLaneInfo().setLane($this$measureStaggeredGrid_dSVRQoE_u24lambda_u244_u24lambda_u242[lane], lane);
                            lane++;
    ...
    private static final LazyStaggeredGridMeasureResult measure(LazyStaggeredGridMeasureContext $this$measure, int initialScrollDelta, int[] initialItemIndices, int[] initialItemOffsets, boolean canRestartMeasure) {
        ...
        if (itemCount5 <= 0) {
            ...
            while (true) {
                ...
                long spanRange = lazyStaggeredGridMeasureContext2.m2492getSpanRangelOCCd4c($this$measure.getItemProvider(), previousItemIndex, laneIndex);
                ...
                LazyStaggeredGridMeasuredItem measuredItem = $this$measure.getMeasuredItemProvider().m2500getAndMeasurejy6DScQ(previousItemIndex, spanRange);
                int offset = m2495maxInRangejy6DScQ(gaps2, spanRange);
            ...
            while (initialLaneToMeasure6 != i11 && initialItemsMeasured3 < $this$measure.getLaneCount()) {
                ...
                if (itemIndex2 >= 0) {
                    ...
                    long spanRange2 = lazyStaggeredGridMeasureContext2.m2492getSpanRangelOCCd4c($this$measure.getItemProvider(), itemIndex2, laneIndex2);
                    LazyStaggeredGridMeasuredItem measuredItem2 = $this$measure.getMeasuredItemProvider().m2500getAndMeasurejy6DScQ(itemIndex2, spanRange2);
                    ...
                    int offset2 = m2495maxInRangejy6DScQ(currentItemOffsets4, spanRange2) + measuredItem2.getSizeWithSpacings();
            ...
            while (true) {
                ...
                long spanRange3 = $this$measure.m2492getSpanRangelOCCd4c($this$measure.getItemProvider(), itemIndex3, currentLaneIndex);
                ...
                LazyStaggeredGridMeasuredItem measuredItem3 = $this$measure.getMeasuredItemProvider().m2500getAndMeasurejy6DScQ(itemIndex3, spanRange3);
                int[] currentItemOffsets6 = currentItemOffsets5;
                int offset3 = m2495maxInRangejy6DScQ(currentItemOffsets6, spanRange3);
            ...
            if (z3) {
                ...
                while (true) {
                    ...
                    if (previousIndex < 0) {
                        ...
                        long spanRange4 = lazyStaggeredGridMeasureContext11.m2492getSpanRangelOCCd4c($this$measure.getItemProvider(), previousIndex, laneIndex4);
                        ...
                        LazyStaggeredGridMeasuredItem measuredItem4 = $this$measure.getMeasuredItemProvider().m2500getAndMeasurejy6DScQ(previousIndex, spanRange4);
                        int offset4 = m2495maxInRangejy6DScQ(gaps2, spanRange4);
            ...
            if ($this$measure.isVertical()) {
                layoutWidth = Constraints.m7498getMaxWidthimpl($this$measure.m2489getConstraintsmsEJaDk());
            } else {
                layoutWidth = ConstraintsKt.m7512constrainWidthK40F9xA($this$measure.m2489getConstraintsmsEJaDk(), ArraysKt.maxOrThrow(currentItemOffsets) + contentPadding);
            }
            if ($this$measure.isVertical()) {
                layoutHeight = ConstraintsKt.m7511constrainHeightK40F9xA($this$measure.m2489getConstraintsmsEJaDk(), ArraysKt.maxOrThrow(currentItemOffsets) + contentPadding);
            } else {
                layoutHeight = Constraints.m7497getMaxHeightimpl($this$measure.m2489getConstraintsmsEJaDk());
            }
            ...
            while (index$iv$iv < extraItemOffset3) {
                ...
                if (z7) {
                    ...
                    long spanRange$iv = $this$calculateExtraItems$iv.m2492getSpanRangelOCCd4c($this$calculateExtraItems$iv.getItemProvider(), index$iv, 0);
                    if (list == null) {
                        list = (List) new ArrayList();
                    }
                    LazyStaggeredGridMeasuredItem measuredItem$iv = $this$calculateExtraItems$iv.getMeasuredItemProvider().m2500getAndMeasurejy6DScQ(index$iv, spanRange$iv);
            ...
            while (index$iv$iv2 < size3) {
                ...
                if (z6) {
                    long spanRange$iv2 = $this$calculateExtraItems$iv2.m2492getSpanRangelOCCd4c($this$calculateExtraItems$iv2.getItemProvider(), index$iv2, 0);
                    if (extraItemsAfter == null) {
                        extraItemsAfter = (List) new ArrayList();
                    }
                    LazyStaggeredGridMeasuredItem measuredItem$iv2 = $this$calculateExtraItems$iv2.getMeasuredItemProvider().m2500getAndMeasurejy6DScQ(index$iv2, spanRange$iv2);
        ...
        while (true) {
            ...
            if (z) {
                ...
                if (item.getLane() == laneIndex) {
                    long spanRange = SpanRange.m2508constructorimpl(item.getLane(), item.getSpan());
                    int mainAxisOffset = m2495maxInRangejy6DScQ(iArr, spanRange);
    ...
    private static final List<LazyStaggeredGridMeasuredItem> calculateExtraItems(LazyStaggeredGridMeasureContext $this$calculateExtraItems, Function1<? super LazyStaggeredGridMeasuredItem, Unit> position, Function1<? super Integer, Boolean> filter) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            if (filter.invoke(Integer.valueOf(index)).booleanValue()) {
                long spanRange = $this$calculateExtraItems.m2492getSpanRangelOCCd4c($this$calculateExtraItems.getItemProvider(), index, 0);
                if (list == null) {
                    list = (List) new ArrayList();
                }
                LazyStaggeredGridMeasuredItem measuredItem = $this$calculateExtraItems.getMeasuredItemProvider().m2500getAndMeasurejy6DScQ(index, spanRange);
    ...
    private static final void m2494forEachnIS5qE8(long $this$forEach_u2dnIS5qE8, Function1<? super Integer, Unit> block) {
    ...
    private static final int m2495maxInRangejy6DScQ(int[] $this$maxInRange_u2djy6DScQ, long indexRange) {
