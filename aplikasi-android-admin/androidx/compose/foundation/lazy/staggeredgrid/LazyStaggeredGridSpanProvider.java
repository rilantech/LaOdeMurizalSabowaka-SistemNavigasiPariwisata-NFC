...
public final class LazyStaggeredGridSpanProvider {
    ...
    public LazyStaggeredGridSpanProvider(IntervalList<LazyStaggeredGridInterval> intervals2) {
    ...
    public final boolean isFullSpan(int itemIndex) {
        ...
        if (span == null || span.invoke(Integer.valueOf(localIndex)) != StaggeredGridItemSpan.Companion.getFullLine()) {
            return false;
        }
        return true;
    }
