...
public final class LazyStaggeredGridMeasuredItem implements LazyStaggeredGridItemInfo {
    ...
    public LazyStaggeredGridMeasuredItem(int index2, Object key2, List<? extends Placeable> placeables2, boolean isVertical2, int spacing, int lane2, int span2, int beforeContentPadding2, int afterContentPadding2, Object contentType2) {
        ...
        this.size = j;
        this.offset = IntOffset.Companion.m7682getZeronOccac();
    }
    ...
    public long m2505getSizeYbymL2g() {
        return this.size;
    }

    /* renamed from: getOffset-nOcc-ac  reason: not valid java name */
    public long m2504getOffsetnOccac() {
        return this.offset;
    }
    ...
    public final int getCrossAxisOffset() {
        return this.isVertical ? IntOffset.m7672getXimpl(m2504getOffsetnOccac()) : IntOffset.m7673getYimpl(m2504getOffsetnOccac());
    }
    ...
    public final void place(Placeable.PlacementScope scope, LazyStaggeredGridMeasureContext context) {
        ...
        if (lazyStaggeredGridMeasuredItem.mainAxisLayoutSize != -1) {
            ...
            for (int size2 = $this$fastForEachIndexed$iv.size(); index$iv < size2; size2 = i) {
                ...
                long offset2 = m2504getOffsetnOccac();
                ...
                if (animateNode != null) {
                    long other$iv = animateNode.m2434getPlacementDeltanOccac();
                    i = size2;
                    long j = other$iv;
                    long animatedOffset = IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(offset2) + IntOffset.m7672getXimpl(other$iv), IntOffset.m7673getYimpl(offset2) + IntOffset.m7673getYimpl(other$iv));
                    if ((lazyStaggeredGridMeasuredItem.m2503getMainAxisgyyYBs(offset2) <= minOffset2 && lazyStaggeredGridMeasuredItem.m2503getMainAxisgyyYBs(animatedOffset) <= minOffset2) || (lazyStaggeredGridMeasuredItem.m2503getMainAxisgyyYBs(offset2) >= maxOffset2 && lazyStaggeredGridMeasuredItem.m2503getMainAxisgyyYBs(animatedOffset) >= maxOffset2)) {
                ...
                if ($this$place_u24lambda_u246.getReverseLayout()) {
                    ...
                    if (this.isVertical != 0) {
                        i2 = IntOffset.m7672getXimpl($this$copy_u2d4Tuh3kE$iv);
                        long j2 = offset2;
                        minOffset = minOffset2;
                    } else {
                        int mainAxisOffset = IntOffset.m7672getXimpl($this$copy_u2d4Tuh3kE$iv);
                        long j3 = offset2;
                    ...
                    if (this.isVertical) {
                        int mainAxisOffset2 = IntOffset.m7673getYimpl($this$copy_u2d4Tuh3kE$iv);
                        ...
                        i3 = IntOffset.m7673getYimpl($this$copy_u2d4Tuh3kE$iv);
                    }
                ...
                long other$iv2 = $this$place_u24lambda_u246.m2490getContentOffsetnOccac();
                int i9 = maxOffset;
                int i10 = minOffset;
                Placeable.PlacementScope.m6441placeRelativeWithLayeraW9wM$default($this$place_u24lambda_u246_u24lambda_u245, placeable, IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(offset2) + IntOffset.m7672getXimpl(other$iv2), IntOffset.m7673getYimpl(offset2) + IntOffset.m7673getYimpl(other$iv2)), 0.0f, (Function1) null, 6, (Object) null);
    ...
    private final int m2503getMainAxisgyyYBs(long $this$mainAxis) {
        return this.isVertical ? IntOffset.m7673getYimpl($this$mainAxis) : IntOffset.m7672getXimpl($this$mainAxis);
    }
    ...
    private final long m2502copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> mainAxisMap) {
