...
final class LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1 extends Lambda implements Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m2498invoke0kLqBqw((LazyLayoutMeasureScope) p1, ((Constraints) p2).m7504unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final LazyStaggeredGridMeasureResult m2498invoke0kLqBqw(LazyLayoutMeasureScope $this$null, long constraints) {
        long contentOffset;
        LazyLayoutMeasureScope lazyLayoutMeasureScope = $this$null;
        long j = constraints;
        Intrinsics.checkNotNullParameter(lazyLayoutMeasureScope, "$this$null");
        CheckScrollableContainerConstraintsKt.m1905checkScrollableContainerConstraintsK40F9xA(j, this.$orientation);
        LazyStaggeredGridSlots resolvedSlots = this.$slots.invoke(lazyLayoutMeasureScope, Constraints.m7486boximpl(constraints));
        ...
        int beforeContentPadding = lazyLayoutMeasureScope.m7529roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.beforePadding(this.$contentPadding, this.$orientation, this.$reverseLayout, $this$null.getLayoutDirection()));
        int afterContentPadding = lazyLayoutMeasureScope.m7529roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.afterPadding(this.$contentPadding, this.$orientation, this.$reverseLayout, $this$null.getLayoutDirection()));
        int startContentPadding = lazyLayoutMeasureScope.m7529roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.startPadding(this.$contentPadding, this.$orientation, $this$null.getLayoutDirection()));
        int mainAxisAvailableSize = ((isVertical ? Constraints.m7497getMaxHeightimpl(constraints) : Constraints.m7498getMaxWidthimpl(constraints)) - beforeContentPadding) - afterContentPadding;
        if (isVertical) {
        ...
        int horizontalPadding = lazyLayoutMeasureScope.m7529roundToPx0680j_4(Dp.m7554constructorimpl(PaddingKt.calculateStartPadding($this$invoke_0kLqBqw_u24lambda_u240, $this$null.getLayoutDirection()) + PaddingKt.calculateEndPadding($this$invoke_0kLqBqw_u24lambda_u240, $this$null.getLayoutDirection())));
        PaddingValues $this$invoke_0kLqBqw_u24lambda_u241 = this.$contentPadding;
        int verticalPadding = lazyLayoutMeasureScope.m7529roundToPx0680j_4(Dp.m7554constructorimpl($this$invoke_0kLqBqw_u24lambda_u241.m2265calculateTopPaddingD9Ej5fM() + $this$invoke_0kLqBqw_u24lambda_u241.m2262calculateBottomPaddingD9Ej5fM()));
        int i = verticalPadding;
        int i2 = horizontalPadding;
        int i3 = startContentPadding;
        long r6 = Constraints.m7489copyZbe2FdA$default(constraints, ConstraintsKt.m7512constrainWidthK40F9xA(j, horizontalPadding), 0, ConstraintsKt.m7511constrainHeightK40F9xA(j, verticalPadding), 0, 10, (Object) null);
        int r23 = lazyLayoutMeasureScope.m7529roundToPx0680j_4(this.$mainAxisSpacing);
        boolean z = isVertical;
        LazyStaggeredGridSlots lazyStaggeredGridSlots = resolvedSlots;
        LazyStaggeredGridMeasureResult it = LazyStaggeredGridMeasureKt.m2496measureStaggeredGriddSVRQoE($this$null, this.$state, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(itemProvider, this.$state.getPinnedItems$foundation_release(), this.$state.getBeyondBoundsInfo$foundation_release()), itemProvider, resolvedSlots, r6, isVertical, this.$reverseLayout, contentOffset, mainAxisAvailableSize, r23, beforeContentPadding, afterContentPadding);
