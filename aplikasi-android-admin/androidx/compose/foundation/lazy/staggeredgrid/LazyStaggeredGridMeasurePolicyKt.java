...
public final class LazyStaggeredGridMeasurePolicyKt {
    ...
    public static final Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> m2497rememberStaggeredGridMeasurePolicynbWgWpA(LazyStaggeredGridState state, Function0<? extends LazyStaggeredGridItemProvider> itemProviderLambda, PaddingValues contentPadding, boolean reverseLayout, Orientation orientation, float mainAxisSpacing, float crossAxisSpacing, Function2<? super Density, ? super Constraints, LazyStaggeredGridSlots> slots, Composer $composer, int $changed) {
        ...
        Object[] keys$iv = {state, itemProviderLambda, contentPadding, Boolean.valueOf(reverseLayout), orientation, Dp.m7552boximpl(mainAxisSpacing), Dp.m7552boximpl(crossAxisSpacing), slots};
    ...
    public static final float startPadding(PaddingValues $this$startPadding, Orientation orientation, LayoutDirection layoutDirection) {
        switch (WhenMappings.$EnumSwitchMapping$0[orientation.ordinal()]) {
            ...
            case 2:
                return $this$startPadding.m2265calculateTopPaddingD9Ej5fM();
            default:
    ...
    public static final float beforePadding(PaddingValues $this$beforePadding, Orientation orientation, boolean reverseLayout, LayoutDirection layoutDirection) {
        switch (WhenMappings.$EnumSwitchMapping$0[orientation.ordinal()]) {
            case 1:
                return reverseLayout ? $this$beforePadding.m2262calculateBottomPaddingD9Ej5fM() : $this$beforePadding.m2265calculateTopPaddingD9Ej5fM();
            case 2:
                if (reverseLayout) {
    ...
    public static final float afterPadding(PaddingValues $this$afterPadding, Orientation orientation, boolean reverseLayout, LayoutDirection layoutDirection) {
        switch (WhenMappings.$EnumSwitchMapping$0[orientation.ordinal()]) {
            case 1:
                return reverseLayout ? $this$afterPadding.m2265calculateTopPaddingD9Ej5fM() : $this$afterPadding.m2262calculateBottomPaddingD9Ej5fM();
            case 2:
                if (reverseLayout) {
