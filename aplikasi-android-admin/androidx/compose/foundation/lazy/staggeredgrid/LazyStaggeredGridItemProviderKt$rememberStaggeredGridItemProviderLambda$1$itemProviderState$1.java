...
final class LazyStaggeredGridItemProviderKt$rememberStaggeredGridItemProviderLambda$1$itemProviderState$1 extends Lambda implements Function0<LazyStaggeredGridItemProviderImpl> {
    ...
    LazyStaggeredGridItemProviderKt$rememberStaggeredGridItemProviderLambda$1$itemProviderState$1(State<LazyStaggeredGridIntervalContent> state, LazyStaggeredGridState lazyStaggeredGridState) {
        super(0);
    ...
    public final LazyStaggeredGridItemProviderImpl invoke() {
        LazyStaggeredGridIntervalContent intervalContent = this.$intervalContentState.getValue();
        return new LazyStaggeredGridItemProviderImpl(this.$state, intervalContent, new NearestRangeKeyIndexMap(this.$state.getNearestRange$foundation_release(), intervalContent));
    }
}
