...
public abstract class LazyStaggeredGridMeasureProvider {
    ...
    private final long m2499childConstraintsJhjzzOo(int requestedSlot, int requestedSpan) {
        int end;
        ...
        if (this.isVertical) {
            return Constraints.Companion.m7508fixedWidthOenEA2s(end);
        }
        return Constraints.Companion.m7507fixedHeightOenEA2s(end);
    }

    /* renamed from: getAndMeasure-jy6DScQ  reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m2500getAndMeasurejy6DScQ(int index, long span) {
        int i = index;
        return createItem(index, (int) (span >> 32), ((int) (4294967295L & span)) - ((int) (span >> 32)), this.itemProvider.getKey(i), this.itemProvider.getContentType(i), this.measureScope.m2447measure0kLqBqw(i, m2499childConstraintsJhjzzOo((int) (span >> 32), ((int) (span & 4294967295L)) - ((int) (span >> 32)))));
    }
