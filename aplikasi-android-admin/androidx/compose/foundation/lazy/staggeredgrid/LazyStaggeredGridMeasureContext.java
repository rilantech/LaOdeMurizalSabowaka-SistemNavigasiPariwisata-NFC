...
public final class LazyStaggeredGridMeasureContext {
    ...
    public final long m2489getConstraintsmsEJaDk() {
    ...
    public final long m2490getContentOffsetnOccac() {
    ...
    public final long m2492getSpanRangelOCCd4c(LazyStaggeredGridItemProvider $this$getSpanRange_u2dlOCCd4c, int itemIndex, int lane) {
        ...
        return SpanRange.m2508constructorimpl(isFullSpan ? 0 : lane, isFullSpan ? this.laneCount : 1);
    }

    /* renamed from: isFullSpan-SZVOQXA  reason: not valid java name */
    public final boolean m2493isFullSpanSZVOQXA(long $this$isFullSpan) {
    ...
    public final int m2491getLaneInfoSZVOQXA(long $this$laneInfo) {
