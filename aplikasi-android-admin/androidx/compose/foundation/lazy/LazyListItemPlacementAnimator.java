...
public final class LazyListItemPlacementAnimator {
    ...
    public final void onMeasured(int r36, int r37, int r38, java.util.List<androidx.compose.foundation.lazy.LazyListMeasuredItem> r39, androidx.compose.foundation.lazy.LazyListMeasuredItemProvider r40, boolean r41) {
        ...
        L_0x00ed:
            r11 = 0
            long r22 = r12.m2394getOffsetBjo55l4(r11)
            r16 = 0
            boolean r19 = r12.isVertical()
            if (r19 == 0) goto L_0x0102
            int r19 = androidx.compose.ui.unit.IntOffset.m7673getYimpl(r22)
            goto L_0x0106
        L_0x0102:
            int r19 = androidx.compose.ui.unit.IntOffset.m7672getXimpl(r22)
        L_0x0106:
            r11 = r19
        ...
        L_0x0121:
            ...
            r29 = 0
            r30 = r1
            long r1 = r28.m2435getRawOffsetnOccac()
            ...
            long r3 = r31.m2437getNotInitializednOccac()
            boolean r1 = androidx.compose.ui.unit.IntOffset.m7671equalsimpl0(r1, r3)
            if (r1 != 0) goto L_0x0174
            long r1 = r28.m2435getRawOffsetnOccac()
            r3 = 0
            int r4 = androidx.compose.ui.unit.IntOffset.m7672getXimpl(r1)
            int r31 = androidx.compose.ui.unit.IntOffset.m7672getXimpl(r9)
            int r4 = r4 + r31
            int r31 = androidx.compose.ui.unit.IntOffset.m7673getYimpl(r1)
            int r32 = androidx.compose.ui.unit.IntOffset.m7673getYimpl(r9)
            r33 = r1
            int r1 = r31 + r32
            long r1 = androidx.compose.ui.unit.IntOffsetKt.IntOffset(r4, r1)
            r3 = r28
            r3.m2436setRawOffsetgyyYBs(r1)
            goto L_0x0176
        L_0x0174:
            r3 = r28
        L_0x0176:
    ...
    private final void initializeNode(LazyListMeasuredItem item, int mainAxisOffset) {
        ...
        int i = 0;
        long firstPlaceableOffset = lazyListMeasuredItem.m2394getOffsetBjo55l4(0);
        if (item.isVertical()) {
        ...
        while (i < placeablesCount) {
            ...
            if (it$iv != null) {
                long arg0$iv = lazyListMeasuredItem.m2394getOffsetBjo55l4(index$iv);
                ...
                it$iv.m2436setRawOffsetgyyYBs(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(targetFirstPlaceableOffset) + IntOffset.m7672getXimpl(diffToFirstPlaceableOffset), IntOffset.m7673getYimpl(targetFirstPlaceableOffset) + IntOffset.m7673getYimpl(diffToFirstPlaceableOffset)));
            } else {
                targetFirstPlaceableOffset2 = targetFirstPlaceableOffset;
                $this$forEachNode$iv = $this$forEachNode$iv2;
            }
    ...
    private final void startAnimationsIfNeeded(LazyListMeasuredItem item) {
        ...
        while (i2 < placeablesCount) {
            ...
            if (it$iv != null) {
                ...
                long newTarget = item.m2394getOffsetBjo55l4(index$iv);
                $this$forEachNode$iv = $this$forEachNode$iv2;
                this_$iv = this_$iv2;
                long currentTarget = node.m2435getRawOffsetnOccac();
                $i$f$forEachNode = $i$f$forEachNode2;
                i = placeablesCount;
                if (IntOffset.m7671equalsimpl0(currentTarget, LazyLayoutAnimateItemModifierNode.Companion.m2437getNotInitializednOccac())) {
                } else if (!IntOffset.m7671equalsimpl0(currentTarget, newTarget)) {
