...
public final class LazyListMeasuredItem implements LazyListItemInfo {
    ...
    public final long m2394getOffsetBjo55l4(int index2) {
        int[] iArr = this.placeableOffsets;
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        if (this.mainAxisLayoutSize != Integer.MIN_VALUE) {
            ...
            while (i4 < placeablesCount) {
                ...
                long offset2 = m2394getOffsetBjo55l4(index2);
                ...
                if (animateNode != null) {
                    ...
                    if ((m2393getMainAxisgyyYBs(offset2) <= minOffset && m2393getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m2393getMainAxisgyyYBs(offset2) >= maxOffset && m2393getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
    ...
    private final int m2393getMainAxisgyyYBs(long $this$mainAxis) {
    ...
    private final long m2392copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> mainAxisMap) {
