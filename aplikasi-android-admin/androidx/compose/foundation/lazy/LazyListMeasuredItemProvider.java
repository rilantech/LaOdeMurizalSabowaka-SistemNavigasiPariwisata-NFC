...
public abstract class LazyListMeasuredItemProvider {
    ...
    private LazyListMeasuredItemProvider(long constraints, boolean isVertical, LazyListItemProvider itemProvider2, LazyLayoutMeasureScope measureScope2) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, isVertical ? Constraints.m7498getMaxWidthimpl(constraints) : Integer.MAX_VALUE, 0, !isVertical ? Constraints.m7497getMaxHeightimpl(constraints) : Integer.MAX_VALUE, 5, (Object) null);
    }

    /* renamed from: getChildConstraints-msEJaDk  reason: not valid java name */
    public final long m2395getChildConstraintsmsEJaDk() {
        return this.childConstraints;
    }

    public final LazyListMeasuredItem getAndMeasure(int index) {
        return createItem(index, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.m2447measure0kLqBqw(index, this.childConstraints));
    }
