...
public final class LazyListMeasureResult implements LazyListLayoutInfo, MeasureResult {
    ...
    public LazyListMeasureResult(LazyListMeasuredItem firstVisibleItem2, int firstVisibleItemScrollOffset2, boolean canScrollForward2, float consumedScroll2, MeasureResult measureResult, List<? extends LazyListItemInfo> visibleItemsInfo2, int viewportStartOffset2, int viewportEndOffset2, int totalItemsCount2, boolean reverseLayout2, Orientation orientation2, int afterContentPadding2, int mainAxisItemSpacing2) {
        ...
        this.firstVisibleItemScrollOffset = firstVisibleItemScrollOffset2;
    ...
    public long m2391getViewportSizeYbymL2g() {
