...
public interface LazyListScope {
    ...
    public static final class DefaultImpls {
        ...
        @Deprecated
        public static void items(LazyListScope $this, int count, Function1<? super Integer, ? extends Object> key, Function1<? super Integer, ? extends Object> contentType, Function4<? super LazyItemScope, ? super Integer, ? super Composer, ? super Integer, Unit> itemContent) {
            Intrinsics.checkNotNullParameter(contentType, "contentType");
            Intrinsics.checkNotNullParameter(itemContent, "itemContent");
            LazyListScope.super.items(count, key, contentType, itemContent);
        }
    ...
    /* synthetic */ void items(int count, Function1 key, Function4 itemContent) {
        Intrinsics.checkNotNullParameter(itemContent, "itemContent");
        items(count, key, LazyListScope$items$2.INSTANCE, itemContent);
    }
