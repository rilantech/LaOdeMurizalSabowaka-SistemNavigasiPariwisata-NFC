...
final class LazyListKt$rememberLazyListMeasurePolicy$1$1 extends Lambda implements Function2<LazyLayoutMeasureScope, Constraints, LazyListMeasureResult> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m2386invoke0kLqBqw((LazyLayoutMeasureScope) p1, ((Constraints) p2).m7504unboximpl());
    }

    /* Debug info: failed to restart local var, previous not found, register: 52 */
    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final LazyListMeasureResult m2386invoke0kLqBqw(LazyLayoutMeasureScope $this$null, long containerConstraints) {
        int i;
        int i2;
        int i3;
        float f;
        ...
        CheckScrollableContainerConstraintsKt.m1905checkScrollableContainerConstraintsK40F9xA(j, this.$isVertical ? Orientation.Vertical : Orientation.Horizontal);
        if (this.$isVertical) {
            i = lazyLayoutMeasureScope.m7529roundToPx0680j_4(this.$contentPadding.m2263calculateLeftPaddingu2uoSUM($this$null.getLayoutDirection()));
        } else {
            i = lazyLayoutMeasureScope.m7529roundToPx0680j_4(PaddingKt.calculateStartPadding(this.$contentPadding, $this$null.getLayoutDirection()));
        }
        int startPadding = i;
        if (this.$isVertical) {
            i2 = lazyLayoutMeasureScope.m7529roundToPx0680j_4(this.$contentPadding.m2264calculateRightPaddingu2uoSUM($this$null.getLayoutDirection()));
        } else {
            i2 = lazyLayoutMeasureScope.m7529roundToPx0680j_4(PaddingKt.calculateEndPadding(this.$contentPadding, $this$null.getLayoutDirection()));
        }
        int endPadding = i2;
        int topPadding = lazyLayoutMeasureScope.m7529roundToPx0680j_4(this.$contentPadding.m2265calculateTopPaddingD9Ej5fM());
        int bottomPadding = lazyLayoutMeasureScope.m7529roundToPx0680j_4(this.$contentPadding.m2262calculateBottomPaddingD9Ej5fM());
        ...
        long contentConstraints = ConstraintsKt.m7514offsetNN6EwU(j, -totalHorizontalPadding, -totalVerticalPadding);
        this.$state.setDensity$foundation_release(lazyLayoutMeasureScope);
        LazyListItemProvider itemProvider = this.$itemProviderLambda.invoke();
        itemProvider.getItemScope().setMaxSize(Constraints.m7498getMaxWidthimpl(contentConstraints), Constraints.m7497getMaxHeightimpl(contentConstraints));
        if (this.$isVertical) {
            Arrangement.Vertical vertical = this.$verticalArrangement;
            if (vertical != null) {
                f = vertical.m2154getSpacingD9Ej5fM();
            } else {
            ...
            if (horizontal != null) {
                f = horizontal.m2140getSpacingD9Ej5fM();
            } else {
                throw new IllegalArgumentException("Required value was null.".toString());
            }
        }
        float spaceBetweenItemsDp = f;
        int spaceBetweenItems = lazyLayoutMeasureScope.m7529roundToPx0680j_4(spaceBetweenItemsDp);
        int itemsCount = itemProvider.getItemCount();
        if (this.$isVertical) {
            i4 = Constraints.m7497getMaxHeightimpl(containerConstraints) - totalVerticalPadding;
        } else {
            i4 = Constraints.m7498getMaxWidthimpl(containerConstraints) - totalHorizontalPadding;
        }
        ...
        this.$state.m2397setPremeasureConstraintsBRTryo0$foundation_release(measuredItemProvider.m2395getChildConstraintsmsEJaDk());
                            ...
                            try {
                                ...
                                LazyListMeasureResult it = LazyListMeasureKt.m2390measureLazyListCD5nmq0(itemsCount, measuredItemProvider, mainAxisAvailableSize, beforeContentPadding, afterContentPadding, spaceBetweenItems, firstVisibleItemIndex, firstVisibleScrollOffset, this.$state.getScrollToBeConsumed$foundation_release(), contentConstraints, this.$isVertical, itemProvider3.getHeaderIndexes(), this.$verticalArrangement, this.$horizontalArrangement, this.$reverseLayout, $this$null, this.$state.getPlacementAnimator$foundation_release(), this.$beyondBoundsItemCount, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(itemProvider3, this.$state.getPinnedItems$foundation_release(), this.$state.getBeyondBoundsInfo$foundation_release()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() {
                                    ...
                                    public final MeasureResult invoke(int width, int height, Function1<? super Placeable.PlacementScope, Unit> placement) {
                                        ...
                                        return lazyLayoutMeasureScope2.layout(ConstraintsKt.m7512constrainWidthK40F9xA(j2, i7 + width), ConstraintsKt.m7511constrainHeightK40F9xA(j2, i8 + height), MapsKt.emptyMap(), placement);
                                    }
                                });
