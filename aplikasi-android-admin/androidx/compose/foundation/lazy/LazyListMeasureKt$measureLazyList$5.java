...
final class LazyListMeasureKt$measureLazyList$5 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    LazyListMeasureKt$measureLazyList$5(List<LazyListMeasuredItem> list, LazyListMeasuredItem lazyListMeasuredItem) {
        super(1);
    ...
    public final void invoke(Placeable.PlacementScope $this$invoke) {
        ...
        LazyListMeasuredItem lazyListMeasuredItem2 = this.$headerItem;
        if (lazyListMeasuredItem2 != null) {
            lazyListMeasuredItem2.place($this$invoke);
        }
    }
}
