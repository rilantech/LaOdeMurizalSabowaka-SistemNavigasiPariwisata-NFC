...
final class ImageKt$Image$2 implements MeasurePolicy {
    ...
    public final MeasureResult m1935measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
        Intrinsics.checkNotNullParameter($this$Layout, "$this$Layout");
        Intrinsics.checkNotNullParameter(list, "<anonymous parameter 0>");
        return MeasureScope.layout$default($this$Layout, Constraints.m7500getMinWidthimpl(constraints), Constraints.m7499getMinHeightimpl(constraints), (Map) null, ImageKt$Image$2$measure$1.INSTANCE, 4, (Object) null);
    }
}
