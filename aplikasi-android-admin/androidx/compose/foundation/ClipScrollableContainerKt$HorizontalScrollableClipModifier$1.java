...
public final class ClipScrollableContainerKt$HorizontalScrollableClipModifier$1 implements Shape {
    ...
    public Outline m1926createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        return new Outline.Rectangle(new Rect(0.0f, -inflateSize, Size.m4782getWidthimpl(size), Size.m4779getHeightimpl(size) + inflateSize));
    }
}
