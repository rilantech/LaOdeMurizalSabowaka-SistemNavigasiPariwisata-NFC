...
public final class TransformGestureDetectorKt {
    ...
    public static final float calculateRotation(PointerEvent $this$calculateRotation) {
        ...
        while (index$iv < size2) {
            ...
            if (!change.getPressed() || !change.getPreviousPressed()) {
                ...
                long currentPosition = change.m6190getPositionF1C5BW0();
                long previousPosition2 = change.m6191getPreviousPositionF1C5BW0();
                long previousOffset = Offset.m4717minusMKHz9U(previousPosition2, previousCentroid);
                long j = previousPosition2;
                previousPosition = currentCentroid2;
                currentCentroid = previousCentroid;
                pointerCount = pointerCount2;
                long currentOffset = Offset.m4717minusMKHz9U(currentPosition, previousPosition);
                float angleDiff = m2089anglek4lQ0M(currentOffset) - m2089anglek4lQ0M(previousOffset);
                float weight = Offset.m4711getDistanceimpl(Offset.m4718plusMKHz9U(currentOffset, previousOffset)) / 2.0f;
                if (angleDiff > 180.0f) {
                    f = angleDiff - 360.0f;
    ...
    private static final float m2089anglek4lQ0M(long $this$angle_u2dk_u2d4lQ0M) {
        boolean z = true;
        if (Offset.m4713getXimpl($this$angle_u2dk_u2d4lQ0M) == 0.0f) {
            if (Offset.m4714getYimpl($this$angle_u2dk_u2d4lQ0M) != 0.0f) {
                z = false;
            }
            if (z) {
                return 0.0f;
        ...
        return ((-((float) Math.atan2((double) Offset.m4713getXimpl($this$angle_u2dk_u2d4lQ0M), (double) Offset.m4714getYimpl($this$angle_u2dk_u2d4lQ0M)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculatePan(PointerEvent $this$calculatePan) {
        ...
        if (Offset.m4710equalsimpl0(currentCentroid, Offset.Companion.m4728getUnspecifiedF1C5BW0())) {
            return Offset.Companion.m4729getZeroF1C5BW0();
        }
        return Offset.m4717minusMKHz9U(currentCentroid, calculateCentroid($this$calculatePan, false));
    }
    ...
    public static final float calculateCentroidSize(PointerEvent $this$calculateCentroidSize, boolean useCurrent) {
        ...
        if (Offset.m4710equalsimpl0(centroid, Offset.Companion.m4728getUnspecifiedF1C5BW0())) {
            return 0.0f;
        }
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            PointerInputChange change = $this$fastForEach$iv.get(index$iv);
            if (change.getPressed() && change.getPreviousPressed()) {
                distanceToCentroid += Offset.m4711getDistanceimpl(Offset.m4717minusMKHz9U(useCurrent ? change.m6190getPositionF1C5BW0() : change.m6191getPreviousPositionF1C5BW0(), centroid));
                distanceWeight++;
            }
        }
    ...
    public static final long calculateCentroid(PointerEvent $this$calculateCentroid, boolean useCurrent) {
        ...
        long centroid = Offset.Companion.m4729getZeroF1C5BW0();
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            PointerInputChange change = $this$fastForEach$iv.get(index$iv);
            if (change.getPressed() && change.getPreviousPressed()) {
                centroid = Offset.m4718plusMKHz9U(centroid, useCurrent ? change.m6190getPositionF1C5BW0() : change.m6191getPreviousPositionF1C5BW0());
                centroidWeight++;
            }
        }
        if (centroidWeight == 0) {
        ...
        return Offset.m4708divtuRUvjQ(centroid, (float) centroidWeight);
    }
}
