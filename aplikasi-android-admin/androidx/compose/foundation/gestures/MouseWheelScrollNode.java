...
final class MouseWheelScrollNode extends DelegatingNode implements PointerInputModifierNode {
    ...
    private final SuspendingPointerInputModifierNode pointerInputNode = ((SuspendingPointerInputModifierNode) delegate(SuspendingPointerInputFilterKt.SuspendingPointerInputModifierNode(new MouseWheelScrollNode$pointerInputNode$1(this, (Continuation<? super MouseWheelScrollNode$pointerInputNode$1>) null))));
    ...
    public MouseWheelScrollNode(State<ScrollingLogic> scrollingLogicState2, ScrollConfig mouseWheelScrollConfig2) {
    ...
    public void m2027onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
