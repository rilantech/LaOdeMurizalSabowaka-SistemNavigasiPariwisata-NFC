...
public interface TransformScope {
    ...
    void m2091transformByd4ec7I(float f, long j, float f2);

    /* renamed from: transformBy-d-4ec7I$default  reason: not valid java name */
    static /* synthetic */ void m2090transformByd4ec7I$default(TransformScope transformScope, float f, long j, float f2, int i, Object obj) {
        if (obj == null) {
            if ((i & 1) != 0) {
                f = 1.0f;
            }
            ...
            transformScope.m2091transformByd4ec7I(f, j, f2);
            return;
        }
