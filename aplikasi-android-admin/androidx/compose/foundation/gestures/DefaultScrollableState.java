...
final class DefaultScrollableState implements ScrollableState {
    ...
    public DefaultScrollableState(Function1<? super Float, Float> onDelta2) {
    ...
    public Object scroll(MutatePriority scrollPriority, Function2<? super ScrollScope, ? super Continuation<? super Unit>, ? extends Object> block, Continuation<? super Unit> $completion) {
        Object coroutineScope = CoroutineScopeKt.coroutineScope(new DefaultScrollableState$scroll$2(this, scrollPriority, block, (Continuation<? super DefaultScrollableState$scroll$2>) null), $completion);
