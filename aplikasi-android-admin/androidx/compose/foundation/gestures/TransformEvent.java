...
abstract class TransformEvent {
    ...
    public static final class TransformDelta extends TransformEvent {
        ...
        public final long m2088getPanChangeF1C5BW0() {
        ...
        private TransformDelta(float zoomChange2, long panChange2, float rotationChange2) {
            super((DefaultConstructorMarker) null);
            this.zoomChange = zoomChange2;
            this.panChange = panChange2;
            this.rotationChange = rotationChange2;
        }
    }
}
