...
final class SnapFlingBehavior$longSnap$5 extends Lambda implements Function1<Float, Unit> {
    final /* synthetic */ Function1<Float, Unit> $onAnimationStep;
    final /* synthetic */ Ref.FloatRef $remainingScrollOffset;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SnapFlingBehavior$longSnap$5(Ref.FloatRef floatRef, Function1<? super Float, Unit> function1) {
        super(1);
