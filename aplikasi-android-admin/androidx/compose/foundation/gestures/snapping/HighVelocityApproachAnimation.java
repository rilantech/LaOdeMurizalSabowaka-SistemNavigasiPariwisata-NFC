...
final class HighVelocityApproachAnimation implements ApproachAnimation<Float, AnimationVector1D> {
    ...
    public Object approachAnimation(ScrollScope scope, float offset, float velocity, Function1<? super Float, Unit> onAnimationStep, Continuation<? super AnimationResult<Float, AnimationVector1D>> $completion) {
        Object access$animateDecay = SnapFlingBehaviorKt.animateDecay(scope, offset, AnimationStateKt.AnimationState$default(0.0f, velocity, 0, 0, false, 28, (Object) null), this.decayAnimationSpec, onAnimationStep, $completion);
