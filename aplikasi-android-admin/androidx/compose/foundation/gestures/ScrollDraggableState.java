...
final class ScrollDraggableState implements DraggableState, DragScope {
    ...
    public ScrollDraggableState(State<ScrollingLogic> scrollLogic2) {
    ...
    public void dragBy(float pixels) {
        ...
        $this$dragBy_u24lambda_u241.m2073dispatchScroll3eAAhYA(this.latestScrollScope, $this$dragBy_u24lambda_u241.m2082toOffsettuRUvjQ(pixels), NestedScrollSource.Companion.m6087getDragWNlRxjI());
    }
    ...
    public Object drag(MutatePriority dragPriority, Function2<? super DragScope, ? super Continuation<? super Unit>, ? extends Object> block, Continuation<? super Unit> $completion) {
        Object scroll = this.scrollLogic.getValue().getScrollableState().scroll(dragPriority, new ScrollDraggableState$drag$2(this, block, (Continuation<? super ScrollDraggableState$drag$2>) null), $completion);
        return scroll == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? scroll : Unit.INSTANCE;
    }

    public void dispatchRawDelta(float delta) {
        ScrollingLogic $this$dispatchRawDelta_u24lambda_u242 = this.scrollLogic.getValue();
        $this$dispatchRawDelta_u24lambda_u242.m2076performRawScrollMKHz9U($this$dispatchRawDelta_u24lambda_u242.m2082toOffsettuRUvjQ(delta));
    }
}
