...
final class HoverableElement extends ModifierNodeElement<HoverableNode> {
    ...
    public HoverableElement(MutableInteractionSource interactionSource2) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HoverableElement) && Intrinsics.areEqual((Object) ((HoverableElement) other).interactionSource, (Object) this.interactionSource)) {
            return true;
        }
        return false;
    }
