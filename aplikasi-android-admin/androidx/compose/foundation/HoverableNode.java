...
final class HoverableNode extends Modifier.Node implements PointerInputModifierNode {
    ...
    public void m1933onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        Intrinsics.checkNotNullParameter(pointerEvent, "pointerEvent");
        Intrinsics.checkNotNullParameter(pass, "pass");
        if (pass == PointerEventPass.Main) {
            int r0 = pointerEvent.m6133getType7fucELk();
            if (PointerEventType.m6140equalsimpl0(r0, PointerEventType.Companion.m6144getEnter7fucELk())) {
            ...
            } else if (PointerEventType.m6140equalsimpl0(r0, PointerEventType.Companion.m6145getExit7fucELk())) {
