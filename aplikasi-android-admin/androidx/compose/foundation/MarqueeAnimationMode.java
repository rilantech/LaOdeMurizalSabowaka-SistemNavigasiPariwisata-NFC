...
public final class MarqueeAnimationMode {
    ...
    public static final int Immediately = m1943constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int WhileFocused = m1943constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m1942boximpl(int i) {
        return new MarqueeAnimationMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m1943constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1944equalsimpl(int i, Object obj) {
        return (obj instanceof MarqueeAnimationMode) && i == ((MarqueeAnimationMode) obj).m1948unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1945equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1946hashCodeimpl(int i) {
    ...
    public final /* synthetic */ int m1948unboximpl() {
        return this.value;
    }
    ...
    public static String m1947toStringimpl(int arg0) {
        if (m1945equalsimpl0(arg0, Immediately)) {
            return "Immediately";
        }
        if (m1945equalsimpl0(arg0, WhileFocused)) {
            return "WhileFocused";
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m1949getImmediatelyZbEOnfQ$annotations() {
        }

        /* renamed from: getWhileFocused-ZbEOnfQ$annotations  reason: not valid java name */
        public static /* synthetic */ void m1950getWhileFocusedZbEOnfQ$annotations() {
        }
