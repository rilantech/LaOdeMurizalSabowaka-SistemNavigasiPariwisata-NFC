...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode {
    ...
    public final void m1879setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private final void drawRect(ContentDrawScope $this$drawRect) {
        if (!Color.m4964equalsimpl0(this.color, Color.Companion.m4999getUnspecified0d7_KjU())) {
            DrawScope.m5552drawRectnJ9OG0$default($this$drawRect, this.color, 0, 0, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 126, (Object) null);
        }
        Brush it = this.brush;
        if (it != null) {
            DrawScope.m5551drawRectAsUm42w$default($this$drawRect, it, 0, 0, this.alpha, (DrawStyle) null, (ColorFilter) null, 0, 118, (Object) null);
        }
    }

    private final void drawOutline(ContentDrawScope $this$drawOutline) {
        Outline outline;
        if (!Size.m4777equalsimpl($this$drawOutline.m5576getSizeNHjbRc(), this.lastSize) || $this$drawOutline.getLayoutDirection() != this.lastLayoutDirection || !Intrinsics.areEqual((Object) this.lastShape, (Object) this.shape)) {
            outline = this.shape.m5322createOutlinePq9zytI($this$drawOutline.m5576getSizeNHjbRc(), $this$drawOutline.getLayoutDirection(), $this$drawOutline);
        } else {
            outline = this.lastOutline;
            Intrinsics.checkNotNull(outline);
        }
        if (!Color.m4964equalsimpl0(this.color, Color.Companion.m4999getUnspecified0d7_KjU())) {
            OutlineKt.m5220drawOutlinewDX37Ww$default($this$drawOutline, outline, this.color, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 60, (Object) null);
        }
        Brush it = this.brush;
        if (it != null) {
            OutlineKt.m5218drawOutlinehn5TExg$default($this$drawOutline, outline, it, this.alpha, (DrawStyle) null, (ColorFilter) null, 0, 56, (Object) null);
        }
        this.lastOutline = outline;
        this.lastSize = Size.m4770boximpl($this$drawOutline.m5576getSizeNHjbRc());
