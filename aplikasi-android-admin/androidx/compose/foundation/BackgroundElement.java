...
final class BackgroundElement extends ModifierNodeElement<BackgroundNode> {
    ...
    public void update(BackgroundNode node) {
        ...
        node.m1879setColor8_81llA(this.color);
    ...
    public int hashCode() {
        int r1 = Color.m4970hashCodeimpl(this.color) * 31;
    ...
    public boolean equals(Object other) {
        ...
        if (otherModifier == null || !Color.m4964equalsimpl0(this.color, otherModifier.color) || !Intrinsics.areEqual((Object) this.brush, (Object) otherModifier.brush)) {
            return false;
        }
