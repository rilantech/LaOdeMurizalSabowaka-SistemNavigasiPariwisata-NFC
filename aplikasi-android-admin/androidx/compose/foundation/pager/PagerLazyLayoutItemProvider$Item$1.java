    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1142237095, $changed, -1, "androidx.compose.foundation.pager.PagerLazyLayoutItemProvider.Item.<anonymous> (LazyLayoutPager.kt:188)");
            }
            LazyLayoutIntervalContent this_$iv = this.this$0.intervalContent;
            ...
            ((PagerIntervalContent) interval$iv.getValue()).getItem().invoke(pagerLazyLayoutItemProvider.pagerScopeImpl, Integer.valueOf(globalIndex$iv - interval$iv.getStartIndex()), $composer, 0);
            if (ComposerKt.isTraceInProgress()) {
