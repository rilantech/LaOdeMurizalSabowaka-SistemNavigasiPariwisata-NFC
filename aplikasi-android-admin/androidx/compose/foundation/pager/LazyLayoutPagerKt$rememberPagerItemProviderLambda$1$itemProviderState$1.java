...
final class LazyLayoutPagerKt$rememberPagerItemProviderLambda$1$itemProviderState$1 extends Lambda implements Function0<PagerLazyLayoutItemProvider> {
    ...
    public final PagerLazyLayoutItemProvider invoke() {
        PagerLayoutIntervalContent intervalContent = this.$intervalContentState.getValue();
        return new PagerLazyLayoutItemProvider(this.$state, intervalContent, new NearestRangeKeyIndexMap(this.$state.getNearestRange$foundation_release(), intervalContent));
    }
}
