...
final class ConsumeAllFlingOnDirection implements NestedScrollConnection {
    ...
    public final long m2519consumeOnOrientationQWom1Mo(long $this$consumeOnOrientation_u2dQWom1Mo, Orientation orientation2) {
        Intrinsics.checkNotNullParameter(orientation2, "orientation");
        if (orientation2 == Orientation.Vertical) {
            return Velocity.m7775copyOhffZ5M$default($this$consumeOnOrientation_u2dQWom1Mo, 0.0f, 0.0f, 2, (Object) null);
        }
        return Velocity.m7775copyOhffZ5M$default($this$consumeOnOrientation_u2dQWom1Mo, 0.0f, 0.0f, 1, (Object) null);
    }

    /* renamed from: consumeOnOrientation-8S9VItk  reason: not valid java name */
    public final long m2518consumeOnOrientation8S9VItk(long $this$consumeOnOrientation_u2d8S9VItk, Orientation orientation2) {
        Intrinsics.checkNotNullParameter(orientation2, "orientation");
        if (orientation2 == Orientation.Vertical) {
            return Offset.m4707copydBAh8RU$default($this$consumeOnOrientation_u2d8S9VItk, 0.0f, 0.0f, 2, (Object) null);
        }
        return Offset.m4707copydBAh8RU$default($this$consumeOnOrientation_u2d8S9VItk, 0.0f, 0.0f, 1, (Object) null);
    }

    /* renamed from: onPostScroll-DzOQY0M  reason: not valid java name */
    public long m2521onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (NestedScrollSource.m6082equalsimpl0(source, NestedScrollSource.Companion.m6088getFlingWNlRxjI())) {
            return m2518consumeOnOrientation8S9VItk(available, this.orientation);
        }
        return Offset.Companion.m4729getZeroF1C5BW0();
    }

    /* renamed from: onPostFling-RZ2iAVY  reason: not valid java name */
    public Object m2520onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> $completion) {
        return Velocity.m7770boximpl(m2519consumeOnOrientationQWom1Mo(available, this.orientation));
    }
}
