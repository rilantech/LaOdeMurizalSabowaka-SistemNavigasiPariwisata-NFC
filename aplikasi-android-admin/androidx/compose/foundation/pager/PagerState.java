...
public abstract class PagerState implements ScrollableState {
    ...
    public PagerState(int initialPage2, float initialPageOffsetFraction2) {
        ...
        if (-0.5d <= d && d <= 0.5d) {
            this.upDownDifference$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4702boximpl(Offset.Companion.m4729getZeroF1C5BW0()), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public final long m2539getUpDownDifferenceF1C5BW0$foundation_release() {
        return ((Offset) this.upDownDifference$delegate.getValue()).m4723unboximpl();
    }

    /* renamed from: setUpDownDifference-k-4lQ0M$foundation_release  reason: not valid java name */
    public final void m2541setUpDownDifferencek4lQ0M$foundation_release(long j) {
        this.upDownDifference$delegate.setValue(Offset.m4702boximpl(j));
    }
    ...
    public final float getPositionThresholdFraction() {
        return Math.min(this.density.m7535toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), ((float) getPageSize$foundation_release()) / 2.0f) / ((float) getPageSize$foundation_release());
    }
    ...
    public final long m2538getPremeasureConstraintsmsEJaDk$foundation_release() {
        return this.premeasureConstraints;
    }

    /* renamed from: setPremeasureConstraints-BRTryo0$foundation_release  reason: not valid java name */
    public final void m2540setPremeasureConstraintsBRTryo0$foundation_release(long j) {
            ...
            if (!info.getVisiblePagesInfo().isEmpty()) {
                ...
                if (indexToPrefetch2 != this.indexToPrefetch) {
                    ...
                    if (z) {
                        ...
                        this.currentPrefetchHandle = this.prefetchState.m2469schedulePrefetch0kLqBqw(indexToPrefetch2, this.premeasureConstraints);
                    }
                }
            }
        }
