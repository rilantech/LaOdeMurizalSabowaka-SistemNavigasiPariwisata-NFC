...
final class PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1 extends Lambda implements Function2<LazyLayoutMeasureScope, Constraints, PagerMeasureResult> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m2536invoke0kLqBqw((LazyLayoutMeasureScope) p1, ((Constraints) p2).m7504unboximpl());
    }

    /* Debug info: failed to restart local var, previous not found, register: 42 */
    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final PagerMeasureResult m2536invoke0kLqBqw(LazyLayoutMeasureScope $this$null, long containerConstraints) {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        CheckScrollableContainerConstraintsKt.m1905checkScrollableContainerConstraintsK40F9xA(j, isVertical ? Orientation.Vertical : Orientation.Horizontal);
        if (isVertical) {
        ...
        int spaceBetweenPages2 = lazyLayoutMeasureScope.m7529roundToPx0680j_4(this.$pageSpacing);
        if (isVertical) {
        ...
        if (this.$orientation == Orientation.Vertical) {
            i5 = Constraints.m7498getMaxWidthimpl(contentConstraints);
        } else {
            i5 = pageAvailableSize;
        }
        if (this.$orientation != Orientation.Vertical) {
            i6 = Constraints.m7497getMaxHeightimpl(contentConstraints);
        } else {
            i6 = pageAvailableSize;
        }
        pagerState.m2540setPremeasureConstraintsBRTryo0$foundation_release(ConstraintsKt.Constraints$default(0, i5, 0, i6, 5, (Object) null));
            ...
            try {
                ...
                PagerMeasureResult it = PagerMeasureKt.m2534measurePagerntgEbfI($this$null, this.$pageCount.invoke().intValue(), itemProvider, mainAxisAvailableSize, beforeContentPadding, afterContentPadding, spaceBetweenPages, firstVisiblePage, firstVisiblePageOffset, this.$state.getScrollToBeConsumed$foundation_release(), contentConstraints, this.$orientation, this.$verticalAlignment, this.$horizontalAlignment, this.$reverseLayout, visualItemOffset, pageAvailableSize7, this.$beyondBoundsPageCount, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(itemProvider, this.$state.getPinnedPages$foundation_release(), this.$state.getBeyondBoundsInfo$foundation_release()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() {
                    ...
                    public final MeasureResult invoke(int width, int height, Function1<? super Placeable.PlacementScope, Unit> placement) {
                        ...
                        return lazyLayoutMeasureScope2.layout(ConstraintsKt.m7512constrainWidthK40F9xA(j2, totalHorizontalPadding + width), ConstraintsKt.m7511constrainHeightK40F9xA(j2, totalVerticalPadding + height), MapsKt.emptyMap(), placement);
                    }
                });
