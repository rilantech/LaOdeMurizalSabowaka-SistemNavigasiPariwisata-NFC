...
public final class IndicationKt {
    ...
    public static final Modifier indication(Modifier $this$indication, InteractionSource interactionSource, Indication indication) {
        Intrinsics.checkNotNullParameter($this$indication, "<this>");
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        return ComposedModifierKt.composed($this$indication, InspectableValueKt.isDebugInspectorInfoEnabled() ? new IndicationKt$indication$$inlined$debugInspectorInfo$1(indication, interactionSource) : InspectableValueKt.getNoInspectorInfo(), new IndicationKt$indication$2(indication, interactionSource));
    }
