...
final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult m1971measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        Measurable measurable2 = measurable;
        Intrinsics.checkNotNullParameter($this$measure_u2d3p2s80s, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable2, "measurable");
        CheckScrollableContainerConstraintsKt.m1905checkScrollableContainerConstraintsK40F9xA(constraints, this.isVertical ? Orientation.Vertical : Orientation.Horizontal);
        Placeable placeable = measurable2.m6399measureBRTryo0(Constraints.m7489copyZbe2FdA$default(constraints, 0, this.isVertical ? Constraints.m7498getMaxWidthimpl(constraints) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m7497getMaxHeightimpl(constraints), 5, (Object) null));
        int width = RangesKt.coerceAtMost(placeable.getWidth(), Constraints.m7498getMaxWidthimpl(constraints));
        int height = RangesKt.coerceAtMost(placeable.getHeight(), Constraints.m7497getMaxHeightimpl(constraints));
