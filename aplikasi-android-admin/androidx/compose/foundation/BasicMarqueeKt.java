...
public final class BasicMarqueeKt {
    ...
    private static final float DefaultMarqueeVelocity = Dp.m7554constructorimpl((float) 30);
    ...
    public static /* synthetic */ Modifier m1883basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        int i6;
        int i7;
        int i8;
        ...
        if ((i5 & 2) != 0) {
            i6 = MarqueeAnimationMode.Companion.m1951getImmediatelyZbEOnfQ();
        } else {
            i6 = i2;
        }
        if ((i5 & 4) != 0) {
        ...
        if ((i5 & 8) != 0) {
            i8 = MarqueeAnimationMode.m1945equalsimpl0(i6, MarqueeAnimationMode.Companion.m1951getImmediatelyZbEOnfQ()) ? i7 : 0;
        } else {
            i8 = i4;
        }
        if ((i5 & 16) != 0) {
        ...
        return m1882basicMarquee1Mj1MLw(modifier, i, i6, i7, i8, marqueeSpacing2, f2);
    }

    /* renamed from: basicMarquee-1Mj1MLw  reason: not valid java name */
    public static final Modifier m1882basicMarquee1Mj1MLw(Modifier $this$basicMarquee_u2d1Mj1MLw, int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        Intrinsics.checkNotNullParameter($this$basicMarquee_u2d1Mj1MLw, "$this$basicMarquee");
        Intrinsics.checkNotNullParameter(spacing, "spacing");
        return $this$basicMarquee_u2d1Mj1MLw.then(new MarqueeModifierElement(iterations, animationMode, delayMillis, initialDelayMillis, spacing, velocity, (DefaultConstructorMarker) null));
    }

    /* access modifiers changed from: private */
    /* renamed from: createMarqueeAnimationSpec-Z4HSEVQ  reason: not valid java name */
    public static final AnimationSpec<Float> m1884createMarqueeAnimationSpecZ4HSEVQ(int iterations, float targetValue, int initialDelayMillis, int delayMillis, float velocity, Density density) {
        int i = delayMillis;
        TweenSpec<Float> velocityBasedTween = velocityBasedTween(Math.abs(density.m7535toPx0680j_4(velocity)), targetValue, i);
        long startOffset = StartOffset.m1828constructorimpl$default((-i) + initialDelayMillis, 0, 2, (DefaultConstructorMarker) null);
        if (iterations == Integer.MAX_VALUE) {
            return AnimationSpecKt.m1808infiniteRepeatable9IiC70o$default(velocityBasedTween, (RepeatMode) null, startOffset, 2, (Object) null);
        }
        return AnimationSpecKt.m1810repeatable91I0pcU$default(iterations, velocityBasedTween, (RepeatMode) null, startOffset, 4, (Object) null);
    }
    ...
    public static final MarqueeSpacing m1880MarqueeSpacing0680j_4(float spacing) {
