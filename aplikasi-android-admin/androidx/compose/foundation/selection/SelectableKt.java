...
public final class SelectableKt {
    ...
    public static /* synthetic */ Modifier m2546selectableXHw0xAI$default(Modifier modifier, boolean z, boolean z2, Role role, Function0 function0, int i, Object obj) {
        if ((i & 2) != 0) {
            z2 = true;
        }
        if ((i & 4) != 0) {
        ...
        return m2545selectableXHw0xAI(modifier, z, z2, role, function0);
    }

    /* renamed from: selectable-XHw0xAI  reason: not valid java name */
    public static final Modifier m2545selectableXHw0xAI(Modifier $this$selectable_u2dXHw0xAI, boolean selected, boolean enabled, Role role, Function0<Unit> onClick) {
    ...
    public static /* synthetic */ Modifier m2544selectableO2vRcR0$default(Modifier modifier, boolean z, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z2, Role role, Function0 function0, int i, Object obj) {
        boolean z3;
        if ((i & 8) != 0) {
            z3 = true;
        } else {
        ...
        return m2543selectableO2vRcR0(modifier, z, mutableInteractionSource, indication, z3, (i & 16) != 0 ? null : role, function0);
    }

    /* renamed from: selectable-O2vRcR0  reason: not valid java name */
    public static final Modifier m2543selectableO2vRcR0(Modifier $this$selectable_u2dO2vRcR0, boolean selected, MutableInteractionSource interactionSource, Indication indication, boolean enabled, Role role, Function0<Unit> onClick) {
        ...
        return InspectableValueKt.inspectableWrapper($this$inspectable$iv, inspectorInfo$iv, SemanticsModifierKt.semantics$default(ClickableKt.m1908clickableO2vRcR0$default(Modifier.Companion, interactionSource, indication, enabled, (String) null, role, onClick, 8, (Object) null), false, new SelectableKt$selectable$4$1(selected), 1, (Object) null));
    }
}
