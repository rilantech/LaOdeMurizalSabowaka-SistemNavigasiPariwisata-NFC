...
final class ToggleableKt$toggleable$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
        ...
        Modifier modifier2 = ToggleableKt.m2547toggleableO2vRcR0(modifier, z, (MutableInteractionSource) value$iv$iv, (Indication) consume, this.$enabled, this.$role, this.$onValueChange);
        if (ComposerKt.isTraceInProgress()) {
