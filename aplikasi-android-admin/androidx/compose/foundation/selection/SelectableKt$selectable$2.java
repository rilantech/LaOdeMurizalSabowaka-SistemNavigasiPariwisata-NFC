...
final class SelectableKt$selectable$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
        ...
        Modifier r2 = SelectableKt.m2543selectableO2vRcR0(companion, this.$selected, (MutableInteractionSource) value$iv$iv, (Indication) consume, this.$enabled, this.$role, this.$onClick);
        if (ComposerKt.isTraceInProgress()) {
