...
final class AndroidOverscrollKt$StretchOverscrollNonClippingLayer$1 extends Lambda implements Function3<MeasureScope, Measurable, Constraints, MeasureResult> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2, Object p3) {
        return m1874invoke3p2s80s((MeasureScope) p1, (Measurable) p2, ((Constraints) p3).m7504unboximpl());
    }

    /* renamed from: invoke-3p2s80s  reason: not valid java name */
    public final MeasureResult m1874invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$layout, "$this$layout");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        final Placeable placeable = measurable.m6399measureBRTryo0(constraints);
        final int extraSizePx = $this$layout.m7529roundToPx0680j_4(Dp.m7554constructorimpl(((float) 2) * ClipScrollableContainerKt.getMaxSupportedElevation()));
