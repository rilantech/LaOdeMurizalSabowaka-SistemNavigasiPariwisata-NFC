...
final class FocusableElement extends ModifierNodeElement<FocusableNode> {
    ...
    public FocusableElement(MutableInteractionSource interactionSource2) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FocusableElement) && Intrinsics.areEqual((Object) this.interactionSource, (Object) ((FocusableElement) other).interactionSource)) {
            return true;
        }
        return false;
    }
