...
final class BorderModifierNode$drawRoundRectBorder$1 extends Lambda implements Function1<ContentDrawScope, Unit> {
    ...
    public final void invoke(ContentDrawScope $this$onDrawWithContent) {
        ...
        if (this.$fillArea) {
            DrawScope.m5553drawRoundRectZuiqVtQ$default(contentDrawScope, this.$brush, 0, 0, this.$cornerRadius, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 246, (Object) null);
            return;
        }
        float r2 = CornerRadius.m4688getXimpl(this.$cornerRadius);
        float f = this.$halfStroke;
        if (r2 < f) {
            DrawScope $this$clipRect_u2drOu3jXo$iv = contentDrawScope;
            float left$iv = this.$strokeWidth;
            float right$iv = Size.m4782getWidthimpl($this$onDrawWithContent.m5576getSizeNHjbRc()) - this.$strokeWidth;
            float bottom$iv = Size.m4779getHeightimpl($this$onDrawWithContent.m5576getSizeNHjbRc()) - this.$strokeWidth;
            int clipOp$iv = ClipOp.Companion.m4951getDifferencertfAjoo();
            ...
            $this$withTransform_u24lambda_u246$iv$iv.getTransform().m5631clipRectN_I0leg(left$iv, left$iv, right$iv, bottom$iv, clipOp$iv);
            ...
            DrawScope.m5553drawRoundRectZuiqVtQ$default($this$withTransform$iv$iv, brush, 0, 0, j, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 246, (Object) null);
        ...
        DrawScope.m5553drawRoundRectZuiqVtQ$default(contentDrawScope, brush2, j2, this.$borderSize, BorderKt.m1892shrinkKibmq7A(this.$cornerRadius, f), 0.0f, this.$borderStroke, (ColorFilter) null, 0, 208, (Object) null);
    }
}
