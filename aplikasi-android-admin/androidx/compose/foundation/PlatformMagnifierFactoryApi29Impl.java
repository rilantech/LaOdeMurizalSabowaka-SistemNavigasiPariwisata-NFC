...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl create(MagnifierStyle style, View view, Density density, float initialZoom) {
        ...
        long size = $this$create_u24lambda_u241.m7536toSizeXkaWNTQ(style.m1941getSizeMYxV2XQ$foundation_release());
        float cornerRadius = $this$create_u24lambda_u241.m7535toPx0680j_4(style.m1939getCornerRadiusD9Ej5fM$foundation_release());
        float elevation = $this$create_u24lambda_u241.m7535toPx0680j_4(style.m1940getElevationD9Ej5fM$foundation_release());
        Magnifier.Builder $this$create_u24lambda_u241_u24lambda_u240 = new Magnifier.Builder(view2);
        if (size != Size.Companion.m4790getUnspecifiedNHjbRc()) {
            $this$create_u24lambda_u241_u24lambda_u240.setSize(MathKt.roundToInt(Size.m4782getWidthimpl(size)), MathKt.roundToInt(Size.m4779getHeightimpl(size)));
        }
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void m1970updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            if (!Float.isNaN(zoom)) {
                getMagnifier().setZoom(zoom);
            }
            if (OffsetKt.m4732isSpecifiedk4lQ0M(magnifierCenter)) {
                getMagnifier().show(Offset.m4713getXimpl(sourceCenter), Offset.m4714getYimpl(sourceCenter), Offset.m4713getXimpl(magnifierCenter), Offset.m4714getYimpl(magnifierCenter));
            } else {
                getMagnifier().show(Offset.m4713getXimpl(sourceCenter), Offset.m4714getYimpl(sourceCenter));
            }
        }
    }
}
