...
public final class ImageKt {
    ...
    public static final /* synthetic */ void Image(ImageBitmap bitmap, String contentDescription, Modifier modifier, Alignment alignment, ContentScale contentScale, float alpha, ColorFilter colorFilter, Composer $composer, int $changed, int i) {
        ...
        m1934Image5hnEew(bitmap, contentDescription, modifier2, alignment2, contentScale2, alpha2, colorFilter2, FilterQuality.Companion.m5060getLowfv9h1I(), $composer, (i2 & 112) | 8 | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m1934Image5hnEew(ImageBitmap bitmap, String contentDescription, Modifier modifier, Alignment alignment, ContentScale contentScale, float alpha, ColorFilter colorFilter, int filterQuality, Composer $composer, int $changed, int i) {
        Alignment alignment2;
        ContentScale contentScale2;
        float alpha2;
        ColorFilter colorFilter2;
        ...
        if ((i3 & 128) != 0) {
            filterQuality2 = DrawScope.Companion.m5578getDefaultFilterQualityfv9h1I();
        } else {
        ...
        if (invalid$iv$iv || value$iv$iv == Composer.Companion.getEmpty()) {
            ...
            value$iv$iv = BitmapPainterKt.m5665BitmapPainterQZhYCtY$default(bitmap, 0, 0, filterQuality2, 6, (Object) null);
    ...
    public static final void Image(androidx.compose.ui.graphics.painter.Painter r24, java.lang.String r25, androidx.compose.ui.Modifier r26, androidx.compose.ui.Alignment r27, androidx.compose.ui.layout.ContentScale r28, float r29, androidx.compose.ui.graphics.ColorFilter r30, androidx.compose.runtime.Composer r31, int r32, int r33) {
        ...
        L_0x0125:
            r12.useNode()
        L_0x0128:
            androidx.compose.runtime.Composer r0 = androidx.compose.runtime.Updater.m4575constructorimpl(r12)
            r20 = 0
            ...
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r0, r2, r1)
            ...
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r0, r6, r1)
            androidx.compose.ui.node.ComposeUiNode$Companion r1 = androidx.compose.ui.node.ComposeUiNode.Companion
