...
final class ClickableKt$genericClickableWithoutGesture$detectPressAndClickFromKey$1 extends Lambda implements Function1<KeyEvent, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return m1918invokeZmokQxo(((KeyEvent) p1).m6032unboximpl());
    }

    /* renamed from: invoke-ZmokQxo  reason: not valid java name */
    public final Boolean m1918invokeZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        boolean z = true;
        if (!this.$enabled || !Clickable_androidKt.m1925isPressZmokQxo(keyEvent)) {
            if (!this.$enabled || !Clickable_androidKt.m1923isClickZmokQxo(keyEvent)) {
                z = false;
            } else {
                PressInteraction.Press it = this.$currentKeyPressInteractions.remove(Key.m5732boximpl(KeyEvent_androidKt.m6043getKeyZmokQxo(keyEvent)));
                if (it != null) {
        ...
        } else if (!this.$currentKeyPressInteractions.containsKey(Key.m5732boximpl(KeyEvent_androidKt.m6043getKeyZmokQxo(keyEvent)))) {
            final PressInteraction.Press press = new PressInteraction.Press(this.$keyClickOffset.getValue().m4723unboximpl(), (DefaultConstructorMarker) null);
            this.$currentKeyPressInteractions.put(Key.m5732boximpl(KeyEvent_androidKt.m6043getKeyZmokQxo(keyEvent)), press);
