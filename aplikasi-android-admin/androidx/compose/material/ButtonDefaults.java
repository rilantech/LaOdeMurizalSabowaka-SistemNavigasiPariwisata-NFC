...
public final class ButtonDefaults {
    ...
    private static final float IconSize = Dp.m7554constructorimpl((float) 18);
    private static final float IconSpacing = Dp.m7554constructorimpl((float) 8);
    private static final float MinHeight = Dp.m7554constructorimpl((float) 36);
    private static final float MinWidth = Dp.m7554constructorimpl((float) 64);
    ...
    static {
        float r0 = Dp.m7554constructorimpl((float) 16);
        ButtonHorizontalPadding = r0;
        float r1 = Dp.m7554constructorimpl((float) 8);
        ButtonVerticalPadding = r1;
        PaddingValues r02 = PaddingKt.m2244PaddingValuesa9UjIt4(r0, r1, r0, r1);
        ContentPadding = r02;
        float r12 = Dp.m7554constructorimpl((float) 8);
        TextButtonHorizontalPadding = r12;
        TextButtonContentPadding = PaddingKt.m2244PaddingValuesa9UjIt4(r12, r02.m2265calculateTopPaddingD9Ej5fM(), r12, r02.m2262calculateBottomPaddingD9Ej5fM());
    }
    ...
    public final float m2922getMinWidthD9Ej5fM() {
        return MinWidth;
    }

    /* renamed from: getMinHeight-D9Ej5fM  reason: not valid java name */
    public final float m2921getMinHeightD9Ej5fM() {
        return MinHeight;
    }

    /* renamed from: getIconSize-D9Ej5fM  reason: not valid java name */
    public final float m2919getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* renamed from: getIconSpacing-D9Ej5fM  reason: not valid java name */
    public final float m2920getIconSpacingD9Ej5fM() {
        return IconSpacing;
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Use another overload of elevation")
    /* renamed from: elevation-yajeYGU  reason: not valid java name */
    public final /* synthetic */ ButtonElevation m2918elevationyajeYGU(float defaultElevation, float pressedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float defaultElevation2 = (i & 1) != 0 ? Dp.m7554constructorimpl((float) 2) : defaultElevation;
        if ((i & 2) != 0) {
            pressedElevation2 = Dp.m7554constructorimpl((float) 8);
        } else {
        ...
        ButtonElevation r0 = m2917elevationR_JCAzs(defaultElevation2, pressedElevation2, disabledElevation2, Dp.m7554constructorimpl((float) 4), Dp.m7554constructorimpl((float) 4), $composer, (i2 & 14) | 27648 | (i2 & 112) | (i2 & 896) | ((i2 << 6) & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonElevation m2917elevationR_JCAzs(float defaultElevation, float pressedElevation, float disabledElevation, float hoveredElevation, float focusedElevation, Composer $composer, int $changed, int i) {
        float pressedElevation2;
        float disabledElevation2;
        ...
        if ((i & 8) != 0) {
            hoveredElevation2 = Dp.m7554constructorimpl((float) 4);
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        if ((i & 16) != 0) {
            focusedElevation2 = Dp.m7554constructorimpl((float) 4);
        } else {
        ...
        Object[] keys$iv = {Dp.m7552boximpl(defaultElevation2), Dp.m7552boximpl(pressedElevation2), Dp.m7552boximpl(disabledElevation2), Dp.m7552boximpl(hoveredElevation2), Dp.m7552boximpl(focusedElevation2)};
    ...
    public final ButtonColors m2916buttonColorsro_MJ88(long backgroundColor, long contentColor, long disabledBackgroundColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        ...
        long backgroundColor2 = (i & 1) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m2951getPrimary0d7_KjU() : backgroundColor;
        if ((i & 2) != 0) {
            contentColor2 = ColorsKt.m2969contentColorForek8zF_U(backgroundColor2, composer, i2 & 14);
        } else {
            contentColor2 = contentColor;
        }
        if ((i & 4) != 0) {
            disabledBackgroundColor2 = ColorKt.m5008compositeOverOWjLjI(Color.m4962copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m2950getOnSurface0d7_KjU(), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColors(composer, 6).m2955getSurface0d7_KjU());
        } else {
            disabledBackgroundColor2 = disabledBackgroundColor;
        }
        if ((i & 8) != 0) {
            disabledContentColor2 = Color.m4962copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m2950getOnSurface0d7_KjU(), ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
    ...
    public final ButtonColors m2924outlinedButtonColorsRGew2ao(long backgroundColor, long contentColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContentColor2;
        Composer composer = $composer;
        ...
        if ((i & 2) != 0) {
            contentColor2 = MaterialTheme.INSTANCE.getColors(composer, 6).m2951getPrimary0d7_KjU();
        } else {
            contentColor2 = contentColor;
        }
        if ((i & 4) != 0) {
    ...
    public final ButtonColors m2925textButtonColorsRGew2ao(long backgroundColor, long contentColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContentColor2;
        Composer composer = $composer;
        ...
        long backgroundColor2 = (i & 1) != 0 ? Color.Companion.m4998getTransparent0d7_KjU() : backgroundColor;
        if ((i & 2) != 0) {
            contentColor2 = MaterialTheme.INSTANCE.getColors(composer, 6).m2951getPrimary0d7_KjU();
        } else {
            contentColor2 = contentColor;
    ...
    public final float m2923getOutlinedBorderSizeD9Ej5fM() {
