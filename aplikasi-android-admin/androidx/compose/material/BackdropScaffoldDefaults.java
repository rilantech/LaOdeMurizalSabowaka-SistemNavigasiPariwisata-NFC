...
public final class BackdropScaffoldDefaults {
    ...
    private static final float FrontLayerElevation = Dp.m7554constructorimpl((float) 1);
    private static final float HeaderHeight = Dp.m7554constructorimpl((float) 48);
    public static final BackdropScaffoldDefaults INSTANCE = new BackdropScaffoldDefaults();
    private static final float PeekHeight = Dp.m7554constructorimpl((float) 56);

    private BackdropScaffoldDefaults() {
    }

    /* renamed from: getPeekHeight-D9Ej5fM  reason: not valid java name */
    public final float m2880getPeekHeightD9Ej5fM() {
        return PeekHeight;
    }

    /* renamed from: getHeaderHeight-D9Ej5fM  reason: not valid java name */
    public final float m2879getHeaderHeightD9Ej5fM() {
        return HeaderHeight;
    }
    ...
    public final Shape getFrontLayerShape(Composer $composer, int $changed) {
        ...
        CornerBasedShape copy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes($composer, 6).getLarge(), CornerSizeKt.m2567CornerSize0680j_4(Dp.m7554constructorimpl((float) 16)), CornerSizeKt.m2567CornerSize0680j_4(Dp.m7554constructorimpl((float) 16)), (CornerSize) null, (CornerSize) null, 12, (Object) null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final float m2878getFrontLayerElevationD9Ej5fM() {
    ...
    public final long getFrontLayerScrimColor(Composer $composer, int $changed) {
        ...
        long r0 = Color.m4962copywmQWz5c$default(MaterialTheme.INSTANCE.getColors($composer, 6).m2955getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
