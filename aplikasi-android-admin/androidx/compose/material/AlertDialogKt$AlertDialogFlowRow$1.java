...
final class AlertDialogKt$AlertDialogFlowRow$1 implements MeasurePolicy {
    ...
    public final MeasureResult m2866measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        ...
        long childConstraints = ConstraintsKt.Constraints$default(0, Constraints.m7498getMaxWidthimpl(constraints), 0, 0, 13, (Object) null);
        for (Measurable measurable : measurables) {
            List list = currentSequence;
            Ref.IntRef intRef = currentMainAxisSize2;
            MeasureScope measureScope2 = $this$Layout;
            Measurable measurable2 = measurable;
            Placeable placeable = measurable.m6399measureBRTryo0(childConstraints);
            ...
            if (!currentSequence.isEmpty()) {
                ...
                currentMainAxisSize2.element += measureScope.m7529roundToPx0680j_4(this.$mainAxisSpacing);
            } else {
                currentMainAxisSize2 = currentMainAxisSize;
            }
        ...
        if (Constraints.m7498getMaxWidthimpl(constraints) != Integer.MAX_VALUE) {
            mainAxisLayoutSize = Constraints.m7498getMaxWidthimpl(constraints);
        } else {
            mainAxisLayoutSize = Math.max(mainAxisSpace.element, Constraints.m7500getMinWidthimpl(constraints));
        }
        List list3 = currentSequence;
        Ref.IntRef intRef3 = crossAxisSpace;
        Ref.IntRef intRef4 = mainAxisSpace;
        return MeasureScope.layout$default($this$Layout, mainAxisLayoutSize, Math.max(crossAxisSpace.element, Constraints.m7499getMinHeightimpl(constraints)), (Map) null, new AlertDialogKt$AlertDialogFlowRow$1$measure$1(sequences, $this$Layout, this.$mainAxisSpacing, mainAxisLayoutSize, crossAxisPositions), 4, (Object) null);
    }
    ...
    private static final boolean measure_3p2s80s$canAddToCurrentSequence(List<Placeable> currentSequence, Ref.IntRef currentMainAxisSize, MeasureScope $this_Layout, float $mainAxisSpacing2, long $constraints, Placeable placeable) {
        return currentSequence.isEmpty() || (currentMainAxisSize.element + $this_Layout.m7529roundToPx0680j_4($mainAxisSpacing2)) + placeable.getWidth() <= Constraints.m7498getMaxWidthimpl($constraints);
    }
    ...
    private static final void measure_3p2s80s$startNewSequence(List<List<Placeable>> sequences, Ref.IntRef crossAxisSpace, MeasureScope $this_Layout, float $crossAxisSpacing2, List<Placeable> currentSequence, List<Integer> crossAxisSizes, Ref.IntRef currentCrossAxisSize, List<Integer> crossAxisPositions, Ref.IntRef mainAxisSpace, Ref.IntRef currentMainAxisSize) {
        if (!sequences.isEmpty()) {
            crossAxisSpace.element += $this_Layout.m7529roundToPx0680j_4($crossAxisSpacing2);
        }
