...
final class DefaultSliderColors implements SliderColors {
    ...
    public State<Color> thumbColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4953boximpl(enabled ? this.thumbColor : this.disabledThumbColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4964equalsimpl0(this.thumbColor, ((DefaultSliderColors) other).thumbColor) && Color.m4964equalsimpl0(this.disabledThumbColor, ((DefaultSliderColors) other).disabledThumbColor) && Color.m4964equalsimpl0(this.activeTrackColor, ((DefaultSliderColors) other).activeTrackColor) && Color.m4964equalsimpl0(this.inactiveTrackColor, ((DefaultSliderColors) other).inactiveTrackColor) && Color.m4964equalsimpl0(this.disabledActiveTrackColor, ((DefaultSliderColors) other).disabledActiveTrackColor) && Color.m4964equalsimpl0(this.disabledInactiveTrackColor, ((DefaultSliderColors) other).disabledInactiveTrackColor) && Color.m4964equalsimpl0(this.activeTickColor, ((DefaultSliderColors) other).activeTickColor) && Color.m4964equalsimpl0(this.inactiveTickColor, ((DefaultSliderColors) other).inactiveTickColor) && Color.m4964equalsimpl0(this.disabledActiveTickColor, ((DefaultSliderColors) other).disabledActiveTickColor) && Color.m4964equalsimpl0(this.disabledInactiveTickColor, ((DefaultSliderColors) other).disabledInactiveTickColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((Color.m4970hashCodeimpl(this.thumbColor) * 31) + Color.m4970hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m4970hashCodeimpl(this.activeTrackColor)) * 31) + Color.m4970hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m4970hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m4970hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m4970hashCodeimpl(this.activeTickColor)) * 31) + Color.m4970hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m4970hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m4970hashCodeimpl(this.disabledInactiveTickColor);
    }
}
