...
final class SliderKt$rangeSliderPressDragModifier$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                final RangeSliderLogic rangeSliderLogic = new RangeSliderLogic(this.$startInteractionSource, this.$endInteractionSource, this.$rawOffsetStart, this.$rawOffsetEnd, this.$onDrag);
                final boolean z = this.$isRtl;
                final float f = this.$maxPx;
                final State<Float> state = this.$rawOffsetStart;
                final State<Function1<Boolean, Unit>> state2 = this.$gestureEndAction;
                final State<Float> state3 = this.$rawOffsetEnd;
                final State<Function2<Boolean, Float, Unit>> state4 = this.$onDrag;
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            AnonymousClass1 r0 = new AnonymousClass1(pointerInputScope, z, f, rangeSliderLogic, state, state2, state3, state4, continuation);
            r0.L$0 = obj;
            return r0;
        }
