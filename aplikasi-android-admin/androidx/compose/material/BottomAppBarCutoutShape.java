...
final class BottomAppBarCutoutShape implements Shape {
    ...
    public Outline m2891createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Path boundingRectangle = AndroidPath_androidKt.Path();
        boundingRectangle.addRect(new Rect(0.0f, 0.0f, Size.m4782getWidthimpl(size), Size.m4779getHeightimpl(size)));
        ...
        $this$createOutline_Pq9zytI_u24lambda_u241.m5246opN5in7k0(boundingRectangle, $this$createOutline_Pq9zytI_u24lambda_u241, PathOperation.Companion.m5272getDifferenceb3I0S0c());
    ...
    private final void addCutoutShape(Path $this$addCutoutShape, LayoutDirection layoutDirection, Density density) {
        ...
        float cutoutOffset = density.m7535toPx0680j_4(AppBarKt.BottomAppBarCutoutOffset);
        float f = (float) 2;
        ...
        float cutoutEndX = cutoutStartX + Size.m4782getWidthimpl(cutoutSize);
        float cutoutRadius = Size.m4779getHeightimpl(cutoutSize) / 2.0f;
        OutlineKt.addOutline(path, this.cutoutShape.m5322createOutlinePq9zytI(cutoutSize, layoutDirection, density));
        path.m5249translatek4lQ0M(OffsetKt.Offset(cutoutStartX, -cutoutRadius));
        if (Intrinsics.areEqual((Object) this.cutoutShape, (Object) RoundedCornerShapeKt.getCircleShape())) {
            addRoundedEdges($this$addCutoutShape, cutoutStartX, cutoutEndX, cutoutRadius, density.m7535toPx0680j_4(AppBarKt.BottomAppBarRoundedEdgeRadius), 0.0f);
        }
    }
