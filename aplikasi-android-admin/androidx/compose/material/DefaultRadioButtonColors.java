...
final class DefaultRadioButtonColors implements RadioButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4964equalsimpl0(this.selectedColor, ((DefaultRadioButtonColors) other).selectedColor) && Color.m4964equalsimpl0(this.unselectedColor, ((DefaultRadioButtonColors) other).unselectedColor) && Color.m4964equalsimpl0(this.disabledColor, ((DefaultRadioButtonColors) other).disabledColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((Color.m4970hashCodeimpl(this.selectedColor) * 31) + Color.m4970hashCodeimpl(this.unselectedColor)) * 31) + Color.m4970hashCodeimpl(this.disabledColor);
    }
}
