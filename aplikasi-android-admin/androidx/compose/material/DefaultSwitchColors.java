...
final class DefaultSwitchColors implements SwitchColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4964equalsimpl0(this.checkedThumbColor, ((DefaultSwitchColors) other).checkedThumbColor) && Color.m4964equalsimpl0(this.checkedTrackColor, ((DefaultSwitchColors) other).checkedTrackColor) && Color.m4964equalsimpl0(this.uncheckedThumbColor, ((DefaultSwitchColors) other).uncheckedThumbColor) && Color.m4964equalsimpl0(this.uncheckedTrackColor, ((DefaultSwitchColors) other).uncheckedTrackColor) && Color.m4964equalsimpl0(this.disabledCheckedThumbColor, ((DefaultSwitchColors) other).disabledCheckedThumbColor) && Color.m4964equalsimpl0(this.disabledCheckedTrackColor, ((DefaultSwitchColors) other).disabledCheckedTrackColor) && Color.m4964equalsimpl0(this.disabledUncheckedThumbColor, ((DefaultSwitchColors) other).disabledUncheckedThumbColor) && Color.m4964equalsimpl0(this.disabledUncheckedTrackColor, ((DefaultSwitchColors) other).disabledUncheckedTrackColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((Color.m4970hashCodeimpl(this.checkedThumbColor) * 31) + Color.m4970hashCodeimpl(this.checkedTrackColor)) * 31) + Color.m4970hashCodeimpl(this.uncheckedThumbColor)) * 31) + Color.m4970hashCodeimpl(this.uncheckedTrackColor)) * 31) + Color.m4970hashCodeimpl(this.disabledCheckedThumbColor)) * 31) + Color.m4970hashCodeimpl(this.disabledCheckedTrackColor)) * 31) + Color.m4970hashCodeimpl(this.disabledUncheckedThumbColor)) * 31) + Color.m4970hashCodeimpl(this.disabledUncheckedTrackColor);
    }
}
