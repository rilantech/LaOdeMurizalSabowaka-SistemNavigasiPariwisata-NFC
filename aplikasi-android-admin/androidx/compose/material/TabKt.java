...
public final class TabKt {
    ...
    /* access modifiers changed from: private */
    public static final float SmallTabHeight = Dp.m7554constructorimpl((float) 48);
    ...
    public static final void m3151Tab0nDMI0(boolean selected, Function0<Unit> onClick, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> text, Function2<? super Composer, ? super Integer, Unit> icon, MutableInteractionSource interactionSource, long selectedContentColor, long unselectedContentColor, Composer $composer, int $changed, int i) {
        boolean z;
        Function2 function2;
        long j;
        Function2 icon2;
        ...
        if ((191739611 & $dirty2) != 38347922 || !$composer3.getSkipping()) {
            ...
            if ((i4 & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i5 & 256) != 0) {
                    ...
                    text3 = text4;
                    icon3 = icon4;
                    unselectedContentColor2 = Color.m4962copywmQWz5c$default(selectedContentColor3, ContentAlpha.INSTANCE.getMedium($composer3, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
    ...
    public static final void m3150LeadingIconTab0nDMI0(boolean selected, Function0<Unit> onClick, Function2<? super Composer, ? super Integer, Unit> text, Function2<? super Composer, ? super Integer, Unit> icon, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, long selectedContentColor, long unselectedContentColor, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        boolean enabled2;
        MutableInteractionSource interactionSource2;
        int $dirty;
        ...
        if (($dirty & 191739611) != 38347922 || !$composer2.getSkipping()) {
            ...
            if ((i4 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i5 & 256) != 0) {
                    ...
                    unselectedContentColor2 = Color.m4962copywmQWz5c$default(selectedContentColor3, ContentAlpha.INSTANCE.getMedium($composer2, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
                    selectedContentColor2 = selectedContentColor3;
                } else {
            ...
            int $dirty5 = $dirty2;
            TabKt$LeadingIconTab$2 tabKt$LeadingIconTab$22 = new TabKt$LeadingIconTab$2(modifier3, selected, interactionSource3, RippleKt.m3233rememberRipple9IZ8Weo(true, 0.0f, selectedContentColor2, $composer2, (($dirty2 >> 15) & 896) | 6, 2), enabled3, onClick, icon, $dirty2, text);
            m3153TabTransitionKlgxPg(selectedContentColor2, unselectedContentColor2, selected, ComposableLambdaKt.composableLambda($composer2, 866677691, true, tabKt$LeadingIconTab$2), $composer2, (($dirty5 >> 21) & 14) | 3072 | (($dirty5 >> 21) & 112) | (($dirty5 << 6) & 896));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void m3152TabEVJuX4I(boolean r29, kotlin.jvm.functions.Function0<kotlin.Unit> r30, androidx.compose.ui.Modifier r31, boolean r32, androidx.compose.foundation.interaction.MutableInteractionSource r33, long r34, long r36, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r38, androidx.compose.runtime.Composer r39, int r40, int r41) {
        ...
        L_0x01d3:
            ...
            r26 = 0
            r21 = r8
            long r0 = androidx.compose.ui.graphics.Color.m4962copywmQWz5c$default(r21, r23, r24, r25, r26, r27, r28)
        ...
        L_0x0219:
            ...
            r36 = r0
            r37 = r1
            androidx.compose.foundation.Indication r16 = androidx.compose.material.ripple.RippleKt.m3233rememberRipple9IZ8Weo(r31, r32, r33, r35, r36, r37)
            ...
            r5 = r29
            r7 = r11
            m3153TabTransitionKlgxPg(r1, r3, r5, r6, r7, r8)
            boolean r0 = androidx.compose.runtime.ComposerKt.isTraceInProgress()
        ...
        L_0x02a9:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.TabKt.m3152TabEVJuX4I(boolean, kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, androidx.compose.foundation.interaction.MutableInteractionSource, long, long, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }

    /* access modifiers changed from: private */
    /* renamed from: TabTransition-Klgx-Pg  reason: not valid java name */
    public static final void m3153TabTransitionKlgxPg(long activeColor, long inactiveColor, boolean selected, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        long j;
        long j2;
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            $composer3.endReplaceableGroup();
            ColorSpace colorSpace$iv = Color.m4967getColorSpaceimpl(j3);
            ...
            Object initialValue$iv$iv = Color.m4953boximpl(j4);
            ...
            State createTransitionAnimation = TransitionKt.createTransitionAnimation($this$animateValue$iv$iv, initialValue$iv$iv, Color.m4953boximpl(j5), (FiniteAnimationSpec) transitionSpec$iv.invoke($this$animateValue$iv$iv.getSegment(), $composer2, Integer.valueOf(($changed$iv$iv >> 3) & 112)), typeConverter$iv, "ColorAnimation", $composer2, ($changed$iv$iv & 14) | (($changed$iv$iv << 9) & 57344) | (($changed$iv$iv << 6) & 458752));
            $composer2.endReplaceableGroup();
            $composer2.endReplaceableGroup();
            State color$delegate = createTransitionAnimation;
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(Color.m4962copywmQWz5c$default(TabTransition_Klgx_Pg$lambda$5(color$delegate), 1.0f, 0.0f, 0.0f, 0.0f, 14, (Object) null))), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m4965getAlphaimpl(TabTransition_Klgx_Pg$lambda$5(color$delegate))))}, function2, $composer2, (($dirty >> 6) & 112) | 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void TabBaselineLayout(kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r50, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r51, androidx.compose.runtime.Composer r52, int r53) {
        ...
        L_0x00a2:
            r4.useNode()
        L_0x00a5:
            androidx.compose.runtime.Composer r10 = androidx.compose.runtime.Updater.m4575constructorimpl(r4)
            r20 = 0
            ...
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r10, r3, r7)
            androidx.compose.ui.node.ComposeUiNode$Companion r7 = androidx.compose.ui.node.ComposeUiNode.Companion
            kotlin.jvm.functions.Function2 r7 = r7.getSetResolvedCompositionLocals()
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r10, r14, r7)
            androidx.compose.ui.node.ComposeUiNode$Companion r7 = androidx.compose.ui.node.ComposeUiNode.Companion
        ...
        L_0x00f9:
            ...
            r31 = r13
            r13 = 2
            androidx.compose.ui.Modifier r7 = androidx.compose.foundation.layout.PaddingKt.m2250paddingVpY3zN4$default(r7, r8, r9, r13, r12)
            r8 = r17
            r9 = 0
        ...
        L_0x01cf:
            r37 = r13
            androidx.compose.runtime.Composer r13 = androidx.compose.runtime.Updater.m4575constructorimpl(r10)
            r41 = 0
            ...
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r13, r9, r14)
            ...
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r13, r12, r14)
            androidx.compose.ui.node.ComposeUiNode$Companion r14 = androidx.compose.ui.node.ComposeUiNode.Companion
        ...
        L_0x032a:
            ...
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r9, r13, r12)
            ...
            androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r9, r11, r12)
            androidx.compose.ui.node.ComposeUiNode$Companion r12 = androidx.compose.ui.node.ComposeUiNode.Companion
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope $this$placeTextAndIcon, Density density, Placeable textPlaceable, Placeable iconPlaceable, int tabWidth, int tabHeight, int firstBaseline, int lastBaseline) {
        ...
        int textOffset = $this$placeTextAndIcon_u24lambda_u249.m7529roundToPx0680j_4(baselineOffset) + $this$placeTextAndIcon_u24lambda_u249.m7529roundToPx0680j_4(TabRowDefaults.INSTANCE.m3162getIndicatorHeightD9Ej5fM());
