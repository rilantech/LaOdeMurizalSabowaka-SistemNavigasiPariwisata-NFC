...
public final class AppBarKt {
    ...
    public static final float AppBarHeight = Dp.m7554constructorimpl((float) 56);
    /* access modifiers changed from: private */
    public static final float AppBarHorizontalPadding = Dp.m7554constructorimpl((float) 4);
    /* access modifiers changed from: private */
    public static final float BottomAppBarCutoutOffset = Dp.m7554constructorimpl((float) 8);
    /* access modifiers changed from: private */
    public static final float BottomAppBarRoundedEdgeRadius = Dp.m7554constructorimpl((float) 4);
    /* access modifiers changed from: private */
    public static final Modifier TitleIconModifier = SizeKt.m2327width3ABfNKs(SizeKt.fillMaxHeight$default(Modifier.Companion, 0.0f, 1, (Object) null), Dp.m7554constructorimpl(Dp.m7554constructorimpl((float) 72) - AppBarHorizontalPadding));
    /* access modifiers changed from: private */
    public static final Modifier TitleInsetWithoutIcon = SizeKt.m2327width3ABfNKs(Modifier.Companion, Dp.m7554constructorimpl(Dp.m7554constructorimpl((float) 16) - AppBarHorizontalPadding));

    /* renamed from: TopAppBar-xWeB9-s  reason: not valid java name */
    public static final void m2876TopAppBarxWeB9s(Function2<? super Composer, ? super Integer, Unit> title, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> navigationIcon, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> actions, long backgroundColor, long contentColor, float elevation, Composer $composer, int $changed, int i) {
        ...
        if (($dirty2 & 2995931) != 599186 || !$composer2.getSkipping()) {
            ...
            if ((i4 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i7 != 0) {
                    actions2 = ComposableSingletons$AppBarKt.INSTANCE.m2974getLambda1$material_release();
                }
                if ((i & 16) != 0) {
                ...
                if ((i & 32) != 0) {
                    contentColor2 = ColorsKt.m2969contentColorForek8zF_U(backgroundColor2, $composer2, ($dirty2 >> 12) & 14);
                    $dirty2 &= -458753;
                }
                if (i8 != 0) {
                    $dirty = $dirty2;
                    elevation2 = AppBarDefaults.INSTANCE.m2872getTopAppBarElevationD9Ej5fM();
    ...
    public static final void m2875TopAppBarHsRjFd4(androidx.compose.ui.Modifier r24, long r25, long r27, float r29, androidx.compose.foundation.layout.PaddingValues r30, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r31, androidx.compose.runtime.Composer r32, int r33, int r34) {
        /*
            r12 = r31
            r13 = r33
        ...
        L_0x0132:
            ...
            int r4 = r1 >> 3
            r4 = r4 & 14
            long r4 = androidx.compose.material.ColorsKt.m2969contentColorForek8zF_U(r2, r14, r4)
            r1 = r1 & -897(0xfffffffffffffc7f, float:NaN)
            r6 = r4
        L_0x0141:
            if (r8 == 0) goto L_0x014a
            androidx.compose.material.AppBarDefaults r4 = androidx.compose.material.AppBarDefaults.INSTANCE
            float r4 = r4.m2872getTopAppBarElevationD9Ej5fM()
            r9 = r4
        L_0x014a:
        ...
        L_0x0179:
            ...
            r17 = r11
            r11 = r16
            m2873AppBarcelAv9A(r0, r2, r4, r5, r6, r7, r8, r9, r10, r11)
            boolean r0 = androidx.compose.runtime.ComposerKt.isTraceInProgress()
        ...
        L_0x01e5:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.AppBarKt.m2875TopAppBarHsRjFd4(androidx.compose.ui.Modifier, long, long, float, androidx.compose.foundation.layout.PaddingValues, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final void m2874BottomAppBarY1yfwus(androidx.compose.ui.Modifier r26, long r27, long r29, androidx.compose.ui.graphics.Shape r31, float r32, androidx.compose.foundation.layout.PaddingValues r33, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r34, androidx.compose.runtime.Composer r35, int r36, int r37) {
        /*
            r12 = r34
            r13 = r36
            java.lang.String r0 = "content"
        ...
        L_0x015f:
            ...
            int r2 = r1 >> 3
            r2 = r2 & 14
            long r2 = androidx.compose.material.ColorsKt.m2969contentColorForek8zF_U(r4, r14, r2)
            r1 = r1 & -897(0xfffffffffffffc7f, float:NaN)
            r6 = r2
        L_0x016e:
        ...
        L_0x0172:
            ...
            float r2 = r2.m2871getBottomAppBarElevationD9Ej5fM()
            r11 = r2
        L_0x017b:
    ...
    public static final void m2873AppBarcelAv9A(long backgroundColor, long contentColor, float elevation, PaddingValues contentPadding, Shape shape, Modifier modifier, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        Modifier modifier3;
        ...
        if ((2995931 & $dirty) != 599186 || !$composer2.getSkipping()) {
            ...
            SurfaceKt.m3130SurfaceFjzlyU(modifier2, shape, backgroundColor, contentColor, (BorderStroke) null, elevation, ComposableLambdaKt.composableLambda($composer2, -1027830352, true, new AppBarKt$AppBar$1(paddingValues, function3, $dirty)), $composer2, (($dirty >> 15) & 14) | 1572864 | (($dirty >> 9) & 112) | (($dirty << 6) & 896) | (($dirty << 6) & 7168) | (($dirty << 9) & 458752), 16);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier3 = modifier2;
