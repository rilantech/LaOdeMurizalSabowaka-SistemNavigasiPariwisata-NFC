...
final class PullRefreshNestedScrollConnection implements NestedScrollConnection {
    ...
    public long m3219onPreScrollOzD1aCk(long available, int source) {
        if (!this.enabled) {
            return Offset.Companion.m4729getZeroF1C5BW0();
        }
        if (!NestedScrollSource.m6082equalsimpl0(source, NestedScrollSource.Companion.m6087getDragWNlRxjI()) || Offset.m4714getYimpl(available) >= 0.0f) {
            return Offset.Companion.m4729getZeroF1C5BW0();
        }
        return OffsetKt.Offset(0.0f, this.onPull.invoke(Float.valueOf(Offset.m4714getYimpl(available))).floatValue());
    }

    /* renamed from: onPostScroll-DzOQY0M  reason: not valid java name */
    public long m3217onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (!this.enabled) {
            return Offset.Companion.m4729getZeroF1C5BW0();
        }
        if (!NestedScrollSource.m6082equalsimpl0(source, NestedScrollSource.Companion.m6087getDragWNlRxjI()) || Offset.m4714getYimpl(available) <= 0.0f) {
    ...
    public java.lang.Object m3218onPreFlingQWom1Mo(long r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r10) {
        /*
            r7 = this;
        ...
        L_0x0035:
            ...
            float r4 = androidx.compose.ui.unit.Velocity.m7780getYimpl(r8)
        ...
        L_0x0050:
            ...
            androidx.compose.ui.unit.Velocity r8 = androidx.compose.ui.unit.Velocity.m7770boximpl(r8)
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.pullrefresh.PullRefreshNestedScrollConnection.m3218onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
