...
public final class PullRefreshStateKt {
    ...
    public static final PullRefreshState m3220rememberPullRefreshStateUuyPYSY(boolean refreshing, Function0<Unit> onRefresh, float refreshThreshold, float refreshingOffset, Composer $composer, int $changed, int i) {
        ...
        float refreshThreshold2 = (i & 4) != 0 ? PullRefreshDefaults.INSTANCE.m3210getRefreshThresholdD9Ej5fM() : refreshThreshold;
        if ((i & 8) != 0) {
            refreshingOffset2 = PullRefreshDefaults.INSTANCE.m3211getRefreshingOffsetD9Ej5fM();
        } else {
        ...
        if (Dp.m7553compareTo0680j_4(refreshThreshold2, Dp.m7554constructorimpl((float) 0)) > 0) {
            ...
            thresholdPx.element = $this$rememberPullRefreshState_UuyPYSY_u24lambda_u241.m7535toPx0680j_4(refreshThreshold2);
            refreshingOffsetPx.element = $this$rememberPullRefreshState_UuyPYSY_u24lambda_u241.m7535toPx0680j_4(refreshingOffset2);
