...
public final class PullRefreshDefaults {
    ...
    private static final float RefreshThreshold = Dp.m7554constructorimpl((float) 80);
    private static final float RefreshingOffset = Dp.m7554constructorimpl((float) 56);

    private PullRefreshDefaults() {
    }

    /* renamed from: getRefreshThreshold-D9Ej5fM  reason: not valid java name */
    public final float m3210getRefreshThresholdD9Ej5fM() {
        return RefreshThreshold;
    }

    /* renamed from: getRefreshingOffset-D9Ej5fM  reason: not valid java name */
    public final float m3211getRefreshingOffsetD9Ej5fM() {
