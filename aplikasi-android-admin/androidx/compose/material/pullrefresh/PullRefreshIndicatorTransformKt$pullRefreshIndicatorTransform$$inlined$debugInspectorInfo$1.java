...
public final class PullRefreshIndicatorTransformKt$pullRefreshIndicatorTransform$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        InspectorInfo $this$pullRefreshIndicatorTransform_u24lambda_u240 = $this$null;
        $this$pullRefreshIndicatorTransform_u24lambda_u240.setName("pullRefreshIndicatorTransform");
        $this$pullRefreshIndicatorTransform_u24lambda_u240.getProperties().set("state", this.$state$inlined);
        $this$pullRefreshIndicatorTransform_u24lambda_u240.getProperties().set("scale", Boolean.valueOf(this.$scale$inlined));
    }
}
