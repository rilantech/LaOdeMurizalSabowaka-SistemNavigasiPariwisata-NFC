...
public final class DrawerDefaults {
    ...
    private static final float Elevation = Dp.m7554constructorimpl((float) 16);
    ...
    public final float m2991getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final long getScrimColor(Composer $composer, int $changed) {
        ...
        long r0 = Color.m4962copywmQWz5c$default(MaterialTheme.INSTANCE.getColors($composer, 6).m2950getOnSurface0d7_KjU(), 0.32f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        if (ComposerKt.isTraceInProgress()) {
