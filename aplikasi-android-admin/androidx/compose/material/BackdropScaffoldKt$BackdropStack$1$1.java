...
final class BackdropScaffoldKt$BackdropStack$1$1 extends Lambda implements Function2<SubcomposeMeasureScope, Constraints, MeasureResult> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m2887invoke0kLqBqw((SubcomposeMeasureScope) p1, ((Constraints) p2).m7504unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final MeasureResult m2887invoke0kLqBqw(SubcomposeMeasureScope $this$SubcomposeLayout, long constraints) {
        ...
        final Placeable backLayerPlaceable = ((Measurable) CollectionsKt.first(subcomposeMeasureScope.subcompose(BackdropLayers.Back, this.$backLayer))).m6399measureBRTryo0(this.$calculateBackLayerConstraints.invoke(Constraints.m7486boximpl(constraints)).m7504unboximpl());
        ...
        while (index$iv$iv < size) {
            target$iv.add(((Measurable) $this$fastForEach$iv$iv.get(index$iv$iv)).m6399measureBRTryo0(constraints));
            index$iv$iv++;
        ...
        int maxWidth = Math.max(Constraints.m7500getMinWidthimpl(constraints), backLayerPlaceable.getWidth());
        int maxHeight = Math.max(Constraints.m7499getMinHeightimpl(constraints), backLayerPlaceable.getHeight());
