...
final class DrawerKt$BottomDrawerScrim$1$1 extends Lambda implements Function1<DrawScope, Unit> {
    ...
    public final void invoke(DrawScope $this$Canvas) {
        ...
        DrawScope.m5552drawRectnJ9OG0$default($this$Canvas, this.$color, 0, 0, DrawerKt.BottomDrawerScrim_3J_VO9M$lambda$3(this.$alpha$delegate), (DrawStyle) null, (ColorFilter) null, 0, 118, (Object) null);
    }
}
