...
public final class DeleteKt {
    ...
    public static final ImageVector getDelete(Icons.Rounded $this$Delete) {
        ...
        ImageVector build = ImageVector.Builder.m5677addPathoIyEayM$default(new ImageVector.Builder("Rounded.Delete", Dp.m7554constructorimpl(24.0f), Dp.m7554constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null), nodes, VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m4989getBlack0d7_KjU(), (DefaultConstructorMarker) null), 1.0f, (Brush) null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _delete = build;
