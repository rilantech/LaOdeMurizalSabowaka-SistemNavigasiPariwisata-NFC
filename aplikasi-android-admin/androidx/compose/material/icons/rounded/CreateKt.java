...
public final class CreateKt {
    ...
    public static final ImageVector getCreate(Icons.Rounded $this$Create) {
        ...
        ImageVector.Builder $this$_get_Create__u24lambda_u241 = new ImageVector.Builder("Rounded.Create", Dp.m7554constructorimpl(24.0f), Dp.m7554constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        $this$_get_Create__u24lambda_u241_u24lambda_u240.moveTo(3.0f, 17.46f);
        $this$_get_Create__u24lambda_u241_u24lambda_u240.verticalLineToRelative(3.04f);
        PathBuilder pathBuilder = $this$_get_Create__u24lambda_u241_u24lambda_u240;
        pathBuilder.curveToRelative(0.0f, 0.28f, 0.22f, 0.5f, 0.5f, 0.5f);
        $this$_get_Create__u24lambda_u241_u24lambda_u240.horizontalLineToRelative(3.04f);
        ...
        $this$_get_Create__u24lambda_u241_u24lambda_u240.lineTo(3.15f, 17.1f);
        ...
        ImageVector build = ImageVector.Builder.m5677addPathoIyEayM$default($this$_get_Create__u24lambda_u241, nodes, VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m4989getBlack0d7_KjU(), (DefaultConstructorMarker) null), 1.0f, (Brush) null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _create = build;
