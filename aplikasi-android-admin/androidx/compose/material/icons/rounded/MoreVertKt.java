...
public final class MoreVertKt {
    ...
    public static final ImageVector getMoreVert(Icons.Rounded $this$MoreVert) {
        ...
        ImageVector.Builder $this$_get_MoreVert__u24lambda_u241 = new ImageVector.Builder("Rounded.MoreVert", Dp.m7554constructorimpl(24.0f), Dp.m7554constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        ImageVector build = ImageVector.Builder.m5677addPathoIyEayM$default($this$_get_MoreVert__u24lambda_u241, nodes, VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m4989getBlack0d7_KjU(), (DefaultConstructorMarker) null), 1.0f, (Brush) null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _moreVert = build;
