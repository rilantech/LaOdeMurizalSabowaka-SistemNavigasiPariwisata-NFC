...
public final class PlayArrowKt {
    ...
    public static final ImageVector getPlayArrow(Icons.TwoTone $this$PlayArrow) {
        ...
        ImageVector.Builder $this$_get_PlayArrow__u24lambda_u242 = new ImageVector.Builder("TwoTone.PlayArrow", Dp.m7554constructorimpl(24.0f), Dp.m7554constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        ImageVector.Builder.m5677addPathoIyEayM$default($this$_get_PlayArrow__u24lambda_u242, nodes, VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m4989getBlack0d7_KjU(), (DefaultConstructorMarker) null), 0.3f, (Brush) null, 0.3f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
        ...
        ImageVector build = ImageVector.Builder.m5677addPathoIyEayM$default($this$_get_PlayArrow__u24lambda_u242, nodes2, VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m4989getBlack0d7_KjU(), (DefaultConstructorMarker) null), 1.0f, (Brush) null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _playArrow = build;
