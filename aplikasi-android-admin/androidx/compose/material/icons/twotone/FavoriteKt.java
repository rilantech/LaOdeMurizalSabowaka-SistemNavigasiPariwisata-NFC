...
public final class FavoriteKt {
    ...
    public static final ImageVector getFavorite(Icons.TwoTone $this$Favorite) {
        ...
        ImageVector.Builder $this$_get_Favorite__u24lambda_u242 = new ImageVector.Builder("TwoTone.Favorite", Dp.m7554constructorimpl(24.0f), Dp.m7554constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        PathBuilder $this$_get_Favorite__u24lambda_u242_u24lambda_u240 = $this$PathData_u24lambda_u240$iv$iv$iv;
        Object obj = "TwoTone.Favorite";
        $this$_get_Favorite__u24lambda_u242_u24lambda_u240.moveTo(16.5f, 5.0f);
        PathBuilder pathBuilder = $this$_get_Favorite__u24lambda_u242_u24lambda_u240;
        pathBuilder.curveToRelative(-1.54f, 0.0f, -3.04f, 0.99f, -3.56f, 2.36f);
        $this$_get_Favorite__u24lambda_u242_u24lambda_u240.horizontalLineToRelative(-1.87f);
        ...
        $this$_get_Favorite__u24lambda_u242_u24lambda_u240.lineToRelative(0.1f, 0.1f);
        $this$_get_Favorite__u24lambda_u242_u24lambda_u240.lineToRelative(0.1f, -0.1f);
        pathBuilder.curveTo(16.86f, 14.24f, 20.0f, 11.39f, 20.0f, 8.5f);
        pathBuilder.curveToRelative(0.0f, -2.0f, -1.5f, -3.5f, -3.5f, -3.5f);
        $this$_get_Favorite__u24lambda_u242_u24lambda_u240.close();
        List<PathNode> nodes = $this$PathData_u24lambda_u240$iv$iv$iv.getNodes();
        ImageVector.Builder.m5677addPathoIyEayM$default($this$_get_Favorite__u24lambda_u242, nodes, VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m4989getBlack0d7_KjU(), (DefaultConstructorMarker) null), 0.3f, (Brush) null, 0.3f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
        ImageVector.Builder $this$materialPath_u2dYwgOQQI_u24default$iv = $this$_get_Favorite__u24lambda_u242;
        ...
        PathBuilder $this$_get_Favorite__u24lambda_u242_u24lambda_u241 = $this$PathData_u24lambda_u240$iv$iv$iv2;
        ImageVector.Builder builder = $this$materialPath_u2dYwgOQQI_u24default$iv;
        $this$_get_Favorite__u24lambda_u242_u24lambda_u241.moveTo(16.5f, 3.0f);
        PathBuilder pathBuilder2 = $this$_get_Favorite__u24lambda_u242_u24lambda_u241;
        ...
        $this$_get_Favorite__u24lambda_u242_u24lambda_u241.lineTo(12.0f, 21.35f);
        $this$_get_Favorite__u24lambda_u242_u24lambda_u241.lineToRelative(1.45f, -1.32f);
        PathBuilder pathBuilder3 = $this$_get_Favorite__u24lambda_u242_u24lambda_u241;
        pathBuilder3.curveTo(18.6f, 15.36f, 22.0f, 12.28f, 22.0f, 8.5f);
        pathBuilder3.curveTo(22.0f, 5.42f, 19.58f, 3.0f, 16.5f, 3.0f);
        $this$_get_Favorite__u24lambda_u242_u24lambda_u241.close();
        $this$_get_Favorite__u24lambda_u242_u24lambda_u241.moveTo(12.1f, 18.55f);
        $this$_get_Favorite__u24lambda_u242_u24lambda_u241.lineToRelative(-0.1f, 0.1f);
        $this$_get_Favorite__u24lambda_u242_u24lambda_u241.lineToRelative(-0.1f, -0.1f);
        PathBuilder pathBuilder4 = $this$_get_Favorite__u24lambda_u242_u24lambda_u241;
        ...
        $this$_get_Favorite__u24lambda_u242_u24lambda_u241.horizontalLineToRelative(1.87f);
