...
public final class IconsKt {
    ...
    public static final ImageVector materialIcon(String name, Function1<? super ImageVector.Builder, ImageVector.Builder> block) {
        ...
        return block.invoke(new ImageVector.Builder(name, Dp.m7554constructorimpl(24.0f), Dp.m7554constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null)).build();
    }

    /* renamed from: materialPath-YwgOQQI$default  reason: not valid java name */
    public static /* synthetic */ ImageVector.Builder m3202materialPathYwgOQQI$default(ImageVector.Builder $this$materialPath_u2dYwgOQQI_u24default, float fillAlpha, float strokeAlpha, int pathFillType, Function1 pathBuilder, int i, Object obj) {
        float fillAlpha2;
        float strokeAlpha2;
        int pathFillType2;
        ...
        int strokeLineCap$iv = StrokeCap.Companion.m5351getButtKaPHkGw();
        int strokeLineJoin$iv = StrokeJoin.Companion.m5361getBevelLxFBmk8();
        ...
        return ImageVector.Builder.m5677addPathoIyEayM$default($this$path_u2dR_LF_u2d3I_u24default$iv, $this$PathData_u24lambda_u240$iv$iv.getNodes(), pathFillType2, str, new SolidColor(Color.Companion.m4989getBlack0d7_KjU(), (DefaultConstructorMarker) null), fillAlpha2, (Brush) null, strokeAlpha2, 1.0f, strokeLineCap$iv, strokeLineJoin$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
    }

    /* renamed from: materialPath-YwgOQQI  reason: not valid java name */
    public static final ImageVector.Builder m3201materialPathYwgOQQI(ImageVector.Builder $this$materialPath_u2dYwgOQQI, float fillAlpha, float strokeAlpha, int pathFillType, Function1<? super PathBuilder, Unit> pathBuilder) {
        ...
        Intrinsics.checkNotNullParameter(function1, "pathBuilder");
        Brush fill$iv = new SolidColor(Color.Companion.m4989getBlack0d7_KjU(), (DefaultConstructorMarker) null);
        int strokeLineCap$iv = StrokeCap.Companion.m5351getButtKaPHkGw();
        int strokeLineJoin$iv = StrokeJoin.Companion.m5361getBevelLxFBmk8();
        ...
        PathBuilder $this$PathData_u24lambda_u240$iv$iv = new PathBuilder();
        function1.invoke($this$PathData_u24lambda_u240$iv$iv);
        return ImageVector.Builder.m5677addPathoIyEayM$default($this$path_u2dR_LF_u2d3I_u24default$iv, $this$PathData_u24lambda_u240$iv$iv.getNodes(), i, str, fill$iv, fillAlpha, (Brush) null, strokeAlpha, 1.0f, strokeLineCap$iv, strokeLineJoin$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
    }
}
