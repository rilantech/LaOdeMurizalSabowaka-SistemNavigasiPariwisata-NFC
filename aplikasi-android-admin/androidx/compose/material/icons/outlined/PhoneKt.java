...
public final class PhoneKt {
    ...
    public static final ImageVector getPhone(Icons.Outlined $this$Phone) {
        ...
        ImageVector.Builder $this$_get_Phone__u24lambda_u241 = new ImageVector.Builder("Outlined.Phone", Dp.m7554constructorimpl(24.0f), Dp.m7554constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.moveTo(6.54f, 5.0f);
        ...
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.lineToRelative(-1.2f, 1.2f);
        pathBuilder.curveToRelative(-0.41f, -1.2f, -0.67f, -2.47f, -0.76f, -3.79f);
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.horizontalLineToRelative(1.51f);
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.moveToRelative(9.86f, 12.02f);
        pathBuilder.curveToRelative(0.85f, 0.24f, 1.72f, 0.39f, 2.6f, 0.45f);
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.verticalLineToRelative(1.49f);
        pathBuilder.curveToRelative(-1.32f, -0.09f, -2.59f, -0.35f, -3.8f, -0.75f);
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.lineToRelative(1.2f, -1.19f);
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.moveTo(7.5f, 3.0f);
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.horizontalLineTo(4.0f);
        pathBuilder.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder.curveToRelative(0.0f, 9.39f, 7.61f, 17.0f, 17.0f, 17.0f);
        pathBuilder.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        $this$_get_Phone__u24lambda_u241_u24lambda_u240.verticalLineToRelative(-3.49f);
