...
public final class ShareKt {
    ...
    public static final ImageVector getShare(Icons.Outlined $this$Share) {
        ...
        ImageVector.Builder $this$_get_Share__u24lambda_u241 = new ImageVector.Builder("Outlined.Share", Dp.m7554constructorimpl(24.0f), Dp.m7554constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        $this$_get_Share__u24lambda_u241_u24lambda_u240.moveTo(18.0f, 4.0f);
        pathBuilder.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        $this$_get_Share__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        $this$_get_Share__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(-1.0f, -0.45f, -1.0f, -1.0f);
        $this$_get_Share__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        $this$_get_Share__u24lambda_u241_u24lambda_u240.close();
        $this$_get_Share__u24lambda_u241_u24lambda_u240.moveTo(6.0f, 13.0f);
        pathBuilder.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        $this$_get_Share__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        $this$_get_Share__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        $this$_get_Share__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        $this$_get_Share__u24lambda_u241_u24lambda_u240.close();
        $this$_get_Share__u24lambda_u241_u24lambda_u240.moveTo(18.0f, 20.02f);
        pathBuilder.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        $this$_get_Share__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        $this$_get_Share__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        $this$_get_Share__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
