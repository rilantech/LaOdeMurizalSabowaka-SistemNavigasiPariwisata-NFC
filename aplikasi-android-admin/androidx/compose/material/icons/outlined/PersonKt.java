...
public final class PersonKt {
    ...
    public static final ImageVector getPerson(Icons.Outlined $this$Person) {
        ...
        ImageVector.Builder $this$_get_Person__u24lambda_u241 = new ImageVector.Builder("Outlined.Person", Dp.m7554constructorimpl(24.0f), Dp.m7554constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        $this$_get_Person__u24lambda_u241_u24lambda_u240.moveTo(12.0f, 6.0f);
        PathBuilder pathBuilder = $this$_get_Person__u24lambda_u241_u24lambda_u240;
        pathBuilder.curveToRelative(1.1f, 0.0f, 2.0f, 0.9f, 2.0f, 2.0f);
        $this$_get_Person__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(-0.9f, 2.0f, -2.0f, 2.0f);
        $this$_get_Person__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(-2.0f, -0.9f, -2.0f, -2.0f);
        $this$_get_Person__u24lambda_u241_u24lambda_u240.reflectiveCurveToRelative(0.9f, -2.0f, 2.0f, -2.0f);
        $this$_get_Person__u24lambda_u241_u24lambda_u240.moveToRelative(0.0f, 10.0f);
        pathBuilder.curveToRelative(2.7f, 0.0f, 5.8f, 1.29f, 6.0f, 2.0f);
        $this$_get_Person__u24lambda_u241_u24lambda_u240.lineTo(6.0f, 18.0f);
        pathBuilder.curveToRelative(0.23f, -0.72f, 3.31f, -2.0f, 6.0f, -2.0f);
        $this$_get_Person__u24lambda_u241_u24lambda_u240.moveToRelative(0.0f, -12.0f);
        ...
        ImageVector build = ImageVector.Builder.m5677addPathoIyEayM$default($this$_get_Person__u24lambda_u241, nodes, VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m4989getBlack0d7_KjU(), (DefaultConstructorMarker) null), 1.0f, (Brush) null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _person = build;
