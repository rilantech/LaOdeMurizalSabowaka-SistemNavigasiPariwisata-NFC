...
public final class FloatingActionButtonDefaults {
    ...
    public final /* synthetic */ FloatingActionButtonElevation m3032elevationixp7dh8(float defaultElevation, float pressedElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            defaultElevation = Dp.m7554constructorimpl((float) 6);
        }
        if ((i & 2) != 0) {
            pressedElevation = Dp.m7554constructorimpl((float) 12);
        }
        ...
        FloatingActionButtonElevation r14 = m3033elevationxZ9QkE(defaultElevation, pressedElevation, Dp.m7554constructorimpl((float) 8), Dp.m7554constructorimpl((float) 8), $composer, ($changed & 14) | 3456 | ($changed & 112) | (($changed << 6) & 57344), 0);
    ...
    public final FloatingActionButtonElevation m3033elevationxZ9QkE(float defaultElevation, float pressedElevation, float hoveredElevation, float focusedElevation, Composer $composer, int $changed, int i) {
        ...
        float defaultElevation2 = (i & 1) != 0 ? Dp.m7554constructorimpl((float) 6) : defaultElevation;
        if ((i & 2) != 0) {
            pressedElevation2 = Dp.m7554constructorimpl((float) 12);
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            hoveredElevation2 = Dp.m7554constructorimpl((float) 8);
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        if ((i & 8) != 0) {
            focusedElevation2 = Dp.m7554constructorimpl((float) 8);
        } else {
        ...
        Object[] keys$iv = {Dp.m7552boximpl(defaultElevation2), Dp.m7552boximpl(pressedElevation2), Dp.m7552boximpl(hoveredElevation2), Dp.m7552boximpl(focusedElevation2)};
