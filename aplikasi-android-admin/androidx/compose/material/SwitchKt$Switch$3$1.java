        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (SwitchKt.Switch$lambda$8(state) != newValue) {
                        Function1 access$Switch$lambda$7 = SwitchKt.Switch$lambda$7(state2);
                        if (access$Switch$lambda$7 != null) {
                            access$Switch$lambda$7.invoke(Boxing.boxBoolean(newValue));
                        }
                        MutableState<Boolean> mutableState = mutableState;
                        SwitchKt.Switch$lambda$4(mutableState, !SwitchKt.Switch$lambda$3(mutableState));
                    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                final State<Boolean> state = this.$currentChecked$delegate;
                final State<Function1<Boolean, Unit>> state2 = this.$currentOnCheckedChange$delegate;
                final MutableState<Boolean> mutableState = this.$forceAnimationCheck$delegate;
                this.label = 1;
