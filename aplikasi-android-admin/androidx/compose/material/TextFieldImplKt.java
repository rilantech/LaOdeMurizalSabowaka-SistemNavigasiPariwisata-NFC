...
public final class TextFieldImplKt {
    ...
    private static final float HorizontalIconPadding = Dp.m7554constructorimpl((float) 12);
    private static final Modifier IconDefaultSizeModifier = SizeKt.m2306defaultMinSizeVpY3zN4(Modifier.Companion, Dp.m7554constructorimpl((float) 48), Dp.m7554constructorimpl((float) 48));
    ...
    private static final float TextFieldPadding = Dp.m7554constructorimpl((float) 16);
    ...
    public static final void CommonDecorationBox(TextFieldType type, String value, Function2<? super Composer, ? super Integer, Unit> innerTextField, VisualTransformation visualTransformation, Function2<? super Composer, ? super Integer, Unit> label, Function2<? super Composer, ? super Integer, Unit> placeholder, Function2<? super Composer, ? super Integer, Unit> leadingIcon, Function2<? super Composer, ? super Integer, Unit> trailingIcon, boolean singleLine, boolean enabled, boolean isError, InteractionSource interactionSource, PaddingValues contentPadding, TextFieldColors colors, Function2<? super Composer, ? super Integer, Unit> border, Composer $composer, int $changed, int $changed1, int i) {
        ...
        if (($dirty & 1533916891) == 306783378 && (46811 & $dirty1) == 9362 && $composer3.getSkipping()) {
            ...
            boolean shouldOverrideTextStyleColor = (Color.m4964equalsimpl0(subtitle1.m7056getColor0d7_KjU(), Color.Companion.m4999getUnspecified0d7_KjU()) && !Color.m4964equalsimpl0(caption.m7056getColor0d7_KjU(), Color.Companion.m4999getUnspecified0d7_KjU())) || (!Color.m4964equalsimpl0(subtitle1.m7056getColor0d7_KjU(), Color.Companion.m4999getUnspecified0d7_KjU()) && Color.m4964equalsimpl0(caption.m7056getColor0d7_KjU(), Color.Companion.m4999getUnspecified0d7_KjU()));
            TextFieldTransitionScope textFieldTransitionScope = TextFieldTransitionScope.INSTANCE;
            $composer4.startReplaceableGroup(2129141006);
            ComposerKt.sourceInformation($composer4, "*110@4363L10,111@4455L22");
            long $this$CommonDecorationBox_u24lambda_u242 = MaterialTheme.INSTANCE.getTypography($composer4, 6).getCaption().m7056getColor0d7_KjU();
            if (shouldOverrideTextStyleColor) {
                ...
                if (!($this$takeOrElse_u2dDxMtmZc$iv != Color.Companion.m4999getUnspecified0d7_KjU())) {
                    $this$takeOrElse_u2dDxMtmZc$iv = ((Color) labelColor.invoke(inputState, $composer4, 0)).m4973unboximpl();
                }
            ...
            long $this$CommonDecorationBox_u24lambda_u244 = MaterialTheme.INSTANCE.getTypography($composer4, 6).getSubtitle1().m7056getColor0d7_KjU();
            if (shouldOverrideTextStyleColor) {
                long $this$takeOrElse_u2dDxMtmZc$iv2 = $this$CommonDecorationBox_u24lambda_u244;
                if ($this$takeOrElse_u2dDxMtmZc$iv2 != Color.Companion.m4999getUnspecified0d7_KjU()) {
                    long j3 = $this$CommonDecorationBox_u24lambda_u244;
                    z = false;
                } else {
                    long j4 = $this$CommonDecorationBox_u24lambda_u244;
                    z = false;
                    $this$takeOrElse_u2dDxMtmZc$iv2 = ((Color) labelColor.invoke(inputState, $composer4, 0)).m4973unboximpl();
                }
            ...
            $composer2 = $composer4;
            textFieldTransitionScope.m3194TransitionDTcfvLk(inputState, j, j2, labelColor, z8, ComposableLambdaKt.composableLambda($composer2, 341865432, true, textFieldImplKt$CommonDecorationBox$3), $composer2, 1769472);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m3185DecorationeuL9pac(long contentColor, TextStyle typography, Float contentAlpha, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        TextStyle textStyle;
        Float f;
        Float contentAlpha2;
