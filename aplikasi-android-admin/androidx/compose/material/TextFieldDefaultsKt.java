...
public final class TextFieldDefaultsKt {
    ...
    public static final State<BorderStroke> m3184animateBorderStrokeAsStateNuRrP5Q(boolean enabled, boolean isError, InteractionSource interactionSource, TextFieldColors colors, float focusedBorderThickness, float unfocusedBorderThickness, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            animatedThickness = AnimateAsStateKt.m1797animateDpAsStateAjpBEmI(targetThickness, AnimationSpecKt.tween$default(150, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Dp, Unit>) null, $composer, 48, 12);
            $composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(1685712164);
            ComposerKt.sourceInformation(composer, "849@38446L46");
            animatedThickness = SnapshotStateKt.rememberUpdatedState(Dp.m7552boximpl(unfocusedBorderThickness), composer, (i >> 15) & 14);
            $composer.endReplaceableGroup();
        }
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(new BorderStroke(animatedThickness.getValue().m7568unboximpl(), new SolidColor(indicatorColor.getValue().m4973unboximpl(), (DefaultConstructorMarker) null), (DefaultConstructorMarker) null), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
