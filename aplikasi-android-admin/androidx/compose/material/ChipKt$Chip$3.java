...
final class ChipKt$Chip$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 11) != 2 || !$composer.getSkipping()) {
            ...
            ProvidedValue[] providedValueArr = {ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m4965getAlphaimpl(ChipKt.Chip$lambda$1(this.$contentColor$delegate))))};
                    ...
                    if (($changed & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        TextKt.ProvideTextStyle(body2, ComposableLambdaKt.composableLambda($composer, -1131213696, true, new Function2<Composer, Integer, Unit>() {
                            ...
                            public final void invoke(androidx.compose.runtime.Composer r34, int r35) {
                                ...
                                L_0x00df:
                                    r21 = r0
                                    androidx.compose.runtime.Composer r0 = androidx.compose.runtime.Updater.m4575constructorimpl(r34)
                                    r24 = 0
                                    ...
                                    androidx.compose.runtime.Updater.m4582setimpl((androidx.compose.runtime.Composer) r0, r15, r2)
                                ...
                                L_0x0125:
                                    ...
                                    r0.apply(r3, r2)
                                L_0x0135:
                                    androidx.compose.runtime.Composer r0 = androidx.compose.runtime.SkippableUpdater.m4567constructorimpl(r34)
                                    ...
                                    androidx.compose.ui.Modifier r3 = androidx.compose.foundation.layout.SizeKt.m2327width3ABfNKs(r3, r4)
                                    r4 = 6
                                    ...
                                    androidx.compose.ui.graphics.Color r9 = androidx.compose.ui.graphics.Color.m4953boximpl(r9)
                                    ...
                                    float r10 = androidx.compose.ui.graphics.Color.m4965getAlphaimpl(r31)
                                    ...
                                    androidx.compose.ui.Modifier r4 = androidx.compose.foundation.layout.SizeKt.m2327width3ABfNKs(r4, r7)
                                    r7 = 6
                            ...
                            private static final long invoke$lambda$1$lambda$0(State<Color> $leadingIconContentColor$delegate) {
                                return ((Color) $leadingIconContentColor$delegate.getValue()).m4973unboximpl();
                            }
                        }), $composer, 48);
                        if (ComposerKt.isTraceInProgress()) {
