...
public final class SwitchDefaults {
    ...
    public final SwitchColors m3146colorsSQMK_m0(long checkedThumbColor, long checkedTrackColor, float checkedTrackAlpha, long uncheckedThumbColor, long uncheckedTrackColor, float uncheckedTrackAlpha, long disabledCheckedThumbColor, long disabledCheckedTrackColor, long disabledUncheckedThumbColor, long disabledUncheckedTrackColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        long checkedThumbColor3 = (i2 & 1) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m2954getSecondaryVariant0d7_KjU() : checkedThumbColor;
        if ((i2 & 2) != 0) {
        ...
        if ((i2 & 8) != 0) {
            uncheckedThumbColor2 = MaterialTheme.INSTANCE.getColors(composer, 6).m2955getSurface0d7_KjU();
        } else {
            uncheckedThumbColor2 = uncheckedThumbColor;
        }
        if ((i2 & 16) != 0) {
            uncheckedTrackColor2 = MaterialTheme.INSTANCE.getColors(composer, 6).m2950getOnSurface0d7_KjU();
        } else {
        ...
        if ((i2 & 64) != 0) {
            ...
            disabledCheckedThumbColor2 = ColorKt.m5008compositeOverOWjLjI(Color.m4962copywmQWz5c$default(checkedThumbColor3, ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColors(composer, 6).m2955getSurface0d7_KjU());
        } else {
            checkedThumbColor2 = checkedThumbColor3;
        ...
        if ((i2 & 128) != 0) {
            ...
            disabledCheckedTrackColor2 = ColorKt.m5008compositeOverOWjLjI(Color.m4962copywmQWz5c$default(checkedTrackColor2, ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColors(composer, 6).m2955getSurface0d7_KjU());
        } else {
            disabledCheckedThumbColor3 = disabledCheckedThumbColor2;
        ...
        if ((i2 & 256) != 0) {
            ...
            disabledUncheckedThumbColor2 = ColorKt.m5008compositeOverOWjLjI(Color.m4962copywmQWz5c$default(uncheckedThumbColor2, ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColors(composer, 6).m2955getSurface0d7_KjU());
        } else {
            uncheckedThumbColor3 = uncheckedThumbColor2;
            disabledUncheckedThumbColor2 = disabledUncheckedThumbColor;
        }
        if ((i2 & 512) != 0) {
            disabledUncheckedTrackColor2 = ColorKt.m5008compositeOverOWjLjI(Color.m4962copywmQWz5c$default(uncheckedTrackColor2, ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null), MaterialTheme.INSTANCE.getColors(composer, 6).m2955getSurface0d7_KjU());
        } else {
        ...
        DefaultSwitchColors defaultSwitchColors = new DefaultSwitchColors(checkedThumbColor2, Color.m4962copywmQWz5c$default(checkedTrackColor2, checkedTrackAlpha2, 0.0f, 0.0f, 0.0f, 14, (Object) null), uncheckedThumbColor3, Color.m4962copywmQWz5c$default(uncheckedTrackColor2, uncheckedTrackAlpha2, 0.0f, 0.0f, 0.0f, 14, (Object) null), disabledCheckedThumbColor3, Color.m4962copywmQWz5c$default(disabledCheckedTrackColor2, checkedTrackAlpha2, 0.0f, 0.0f, 0.0f, 14, (Object) null), disabledUncheckedThumbColor2, Color.m4962copywmQWz5c$default(disabledUncheckedTrackColor2, uncheckedTrackAlpha2, 0.0f, 0.0f, 0.0f, 14, (Object) null), (DefaultConstructorMarker) null);
        if (ComposerKt.isTraceInProgress()) {
