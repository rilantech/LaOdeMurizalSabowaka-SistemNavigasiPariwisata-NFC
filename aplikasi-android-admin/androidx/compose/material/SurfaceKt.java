...
public final class SurfaceKt {
    ...
    public static final void m3130SurfaceFjzlyU(androidx.compose.ui.Modifier r25, androidx.compose.ui.graphics.Shape r26, long r27, long r29, androidx.compose.foundation.BorderStroke r31, float r32, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r33, androidx.compose.runtime.Composer r34, int r35, int r36) {
        /*
            r12 = r33
            r13 = r35
        ...
        L_0x014d:
            ...
            long r2 = r0.m2955getSurface0d7_KjU()
            r1 = r1 & -897(0xfffffffffffffc7f, float:NaN)
            r7 = r2
        L_0x015f:
            r0 = r36 & 8
            ...
            int r0 = r1 >> 6
            r0 = r0 & 14
            long r2 = androidx.compose.material.ColorsKt.m2969contentColorForek8zF_U(r7, r14, r0)
        ...
        L_0x01a2:
            ...
            float r0 = r3.m7568unboximpl()
            r1 = 0
            float r2 = r0 + r21
            float r5 = androidx.compose.ui.unit.Dp.m7554constructorimpl(r2)
            androidx.compose.runtime.ProvidableCompositionLocal r0 = androidx.compose.material.ContentColorKt.getLocalContentColor()
            androidx.compose.ui.graphics.Color r1 = androidx.compose.ui.graphics.Color.m4953boximpl(r19)
            ...
            androidx.compose.ui.unit.Dp r2 = androidx.compose.ui.unit.Dp.m7552boximpl(r5)
        ...
        L_0x0250:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SurfaceKt.m3130SurfaceFjzlyU(androidx.compose.ui.Modifier, androidx.compose.ui.graphics.Shape, long, long, androidx.compose.foundation.BorderStroke, float, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final void m3131SurfaceLPr_se0(kotlin.jvm.functions.Function0<kotlin.Unit> r28, androidx.compose.ui.Modifier r29, boolean r30, androidx.compose.ui.graphics.Shape r31, long r32, long r34, androidx.compose.foundation.BorderStroke r36, float r37, androidx.compose.foundation.interaction.MutableInteractionSource r38, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r39, androidx.compose.runtime.Composer r40, int r41, int r42) {
        /*
            r15 = r28
            r14 = r39
            r13 = r41
        ...
        L_0x01d7:
            ...
            long r7 = r7.m2955getSurface0d7_KjU()
            r1 = r1 & r18
            goto L_0x01ea
        L_0x01e9:
            r7 = r9
        L_0x01ea:
            ...
            int r9 = r1 >> 12
            r9 = r9 & 14
            long r9 = androidx.compose.material.ColorsKt.m2969contentColorForek8zF_U(r7, r11, r9)
            r1 = r1 & r6
            goto L_0x01fa
        L_0x01f8:
            r9 = r34
        ...
        L_0x0200:
            ...
            r29 = r1
            float r1 = (float) r0
            float r0 = androidx.compose.ui.unit.Dp.m7554constructorimpl(r1)
            goto L_0x0211
        L_0x020d:
            r29 = r1
            r0 = r37
        ...
        L_0x028f:
            ...
            float r5 = androidx.compose.ui.unit.Dp.m7554constructorimpl(r2)
            androidx.compose.runtime.ProvidableCompositionLocal r0 = androidx.compose.material.ContentColorKt.getLocalContentColor()
            androidx.compose.ui.graphics.Color r1 = androidx.compose.ui.graphics.Color.m4953boximpl(r22)
            androidx.compose.runtime.ProvidedValue r0 = r0.provides(r1)
            androidx.compose.runtime.ProvidableCompositionLocal r1 = androidx.compose.material.ElevationOverlayKt.getLocalAbsoluteElevation()
            androidx.compose.ui.unit.Dp r2 = androidx.compose.ui.unit.Dp.m7552boximpl(r5)
            androidx.compose.runtime.ProvidedValue r1 = r1.provides(r2)
        ...
        L_0x0342:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SurfaceKt.m3131SurfaceLPr_se0(kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, androidx.compose.ui.graphics.Shape, long, long, androidx.compose.foundation.BorderStroke, float, androidx.compose.foundation.interaction.MutableInteractionSource, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }

    /* renamed from: Surface-Ny5ogXk  reason: not valid java name */
    public static final void m3132SurfaceNy5ogXk(boolean selected, Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, BorderStroke border, float elevation, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int $changed1, int i) {
        boolean z;
        int i2;
        int $dirty;
        ...
        if (($dirty & 1533916891) == 306783378 && ($dirty1 & 11) == 2 && $composer3.getSkipping()) {
            ...
            if ((i5 & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i6 & 32) != 0) {
                    $dirty &= -458753;
                    color3 = MaterialTheme.INSTANCE.getColors($composer3, 6).m2955getSurface0d7_KjU();
                } else {
                    color3 = color;
                }
                if ((i6 & 64) != 0) {
                    contentColor3 = ColorsKt.m2969contentColorForek8zF_U(color3, $composer3, ($dirty >> 15) & 14);
                    $dirty &= -3670017;
                } else {
                ...
                if (i11 != 0) {
                    border4 = border3;
                    elevation3 = Dp.m7554constructorimpl((float) 0);
                } else {
                    border4 = border3;
            ...
            float absoluteElevation = Dp.m7554constructorimpl(((Dp) consume).m7568unboximpl() + elevation2);
            ...
            $composer2 = $composer3;
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(contentColor2)), ElevationOverlayKt.getLocalAbsoluteElevation().provides(Dp.m7552boximpl(absoluteElevation))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer2, -1391199439, true, surfaceKt$Surface$7), $composer2, 56);
            if (ComposerKt.isTraceInProgress()) {
    ...
    /* renamed from: Surface-Ny5ogXk  reason: not valid java name */
    public static final void m3133SurfaceNy5ogXk(boolean checked, Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, BorderStroke border, float elevation, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int $changed1, int i) {
        boolean z;
        int i2;
        int $dirty;
        MutableInteractionSource interactionSource2;
        ...
        if (($dirty & 1533916891) == 306783378 && ($dirty1 & 11) == 2 && $composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(contentColor2)), ElevationOverlayKt.getLocalAbsoluteElevation().provides(Dp.m7552boximpl(absoluteElevation))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer2, -311657392, true, surfaceKt$Surface$10), $composer2, 56);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            int i15 = $dirty5;
        ...
        if ((1533916891 & $dirty3) == 306783378 && ($dirty12 & 731) == 146 && $composer3.getSkipping()) {
            ...
            if ((i5 & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i7 & 8) != 0) {
                    $dirty2 = $dirty3 & -7169;
                    modifier5 = modifier4;
                    color4 = MaterialTheme.INSTANCE.getColors($composer3, 6).m2955getSurface0d7_KjU();
                } else {
                    $dirty2 = $dirty3;
                    modifier5 = modifier4;
                    color4 = color;
                ...
                if ((i7 & 16) != 0) {
                    contentColor2 = ColorsKt.m2969contentColorForek8zF_U(color4, $composer3, ($dirty2 >> 9) & 14);
                    $dirty2 &= -57345;
                } else {
                    contentColor2 = contentColor;
                }
                ...
                if (i12 != 0) {
                    color5 = color4;
                    elevation4 = Dp.m7554constructorimpl((float) 0);
                } else {
                    color5 = color4;
            ...
            ComposerKt.sourceInformationMarkerEnd($composer3);
            float absoluteElevation = Dp.m7554constructorimpl(((Dp) consume2).m7568unboximpl() + elevation3);
            ...
            $composer2 = $composer3;
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4953boximpl(contentColor2)), ElevationOverlayKt.getLocalAbsoluteElevation().provides(Dp.m7552boximpl(absoluteElevation))}, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer2, 149594672, true, surfaceKt$Surface$13), $composer2, 56);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            int i19 = $dirty4;
    ...
    public static final Modifier m3136surface8ww4TTg(Modifier $this$surface_u2d8ww4TTg, Shape shape, long backgroundColor, BorderStroke border, float elevation) {
        Modifier r0 = ShadowKt.m4622shadows4CzXII$default($this$surface_u2d8ww4TTg, elevation, shape, false, 0, 0, 24, (Object) null);
        Modifier modifier = Modifier.Companion;
        if (border != null) {
            modifier = BorderKt.border(modifier, border, shape);
        }
        return ClipKt.clip(BackgroundKt.m1876backgroundbw27NRU(r0.then(modifier), backgroundColor, shape), shape);
    }

    /* access modifiers changed from: private */
    /* renamed from: surfaceColorAtElevation-cq6XJ1M  reason: not valid java name */
    public static final long m3137surfaceColorAtElevationcq6XJ1M(long color, ElevationOverlay elevationOverlay, float absoluteElevation, Composer $composer, int $changed) {
        long j;
        ...
        if (!Color.m4964equalsimpl0(color, MaterialTheme.INSTANCE.getColors($composer, 6).m2955getSurface0d7_KjU()) || elevationOverlay == null) {
            j = color;
        } else {
            j = elevationOverlay.m3014apply7g2Lkgo(color, absoluteElevation, $composer, ($changed & 14) | (($changed >> 3) & 112) | (($changed << 3) & 896));
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
