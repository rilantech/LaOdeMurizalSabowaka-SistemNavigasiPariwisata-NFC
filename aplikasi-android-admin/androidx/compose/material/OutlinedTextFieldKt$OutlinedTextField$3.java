...
final class OutlinedTextFieldKt$OutlinedTextField$3 extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
    ...
    public final void invoke(Function2<? super Composer, ? super Integer, Unit> innerTextField, Composer $composer, int $changed) {
        ...
        if (($dirty2 & 91) != 18 || !$composer.getSkipping()) {
            ...
            int i4 = this.$$dirty;
            int i5 = this.$$dirty1;
            int i6 = (i4 & 14) | (($dirty3 << 3) & 112) | ((i4 >> 3) & 896) | ((i5 >> 3) & 7168) | ((i5 << 9) & 57344) | ((i5 >> 6) & 458752) | ((i5 << 18) & 3670016) | ((i4 << 3) & 29360128) | ((i4 << 3) & 234881024) | (1879048192 & (i4 << 3));
            int i7 = ((i4 >> 27) & 14) | 27648 | ((i5 >> 24) & 112);
            textFieldDefaults2.OutlinedTextFieldDecorationBox(str2, innerTextField, z6, z7, visualTransformation2, interactionSource, z3, function22, function23, function24, function25, textFieldColors, (PaddingValues) null, ComposableLambdaKt.composableLambda(composer, -1823843281, true, new Function2<Composer, Integer, Unit>() {
                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if ((i & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        Shape shape = shape2;
                        int i2 = i3;
                        TextFieldDefaults.INSTANCE.m3172BorderBoxnbWgWpA(z8, z9, mutableInteractionSource2, textFieldColors, shape, 0.0f, 0.0f, $composer, ((i2 >> 9) & 14) | 12582912 | ((i2 << 3) & 112) | ((i2 >> 15) & 896) | ((i2 >> 18) & 7168) | ((i2 >> 12) & 57344), 96);
                        if (ComposerKt.isTraceInProgress()) {
