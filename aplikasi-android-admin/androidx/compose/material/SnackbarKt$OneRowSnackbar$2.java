...
final class SnackbarKt$OneRowSnackbar$2 implements MeasurePolicy {
    ...
    public final MeasureResult m3112measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        int textPlaceY;
        int containerHeight;
        int it;
        int i;
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv), (Object) str)) {
                Placeable buttonPlaceable = ((Measurable) element$iv).m6399measureBRTryo0(constraints);
                int textMaxWidth = RangesKt.coerceAtLeast((Constraints.m7498getMaxWidthimpl(constraints) - buttonPlaceable.getWidth()) - measureScope.m7529roundToPx0680j_4(SnackbarKt.TextEndExtraSpacing), Constraints.m7500getMinWidthimpl(constraints));
                ...
                for (Object element$iv2 : $this$first$iv) {
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) element$iv2), (Object) str2)) {
                        Placeable textPlaceable = ((Measurable) element$iv2).m6399measureBRTryo0(Constraints.m7489copyZbe2FdA$default(constraints, 0, textMaxWidth, 0, 0, 9, (Object) null));
                        ...
                        if (firstTextBaseline != Integer.MIN_VALUE) {
                            ...
                            if (lastTextBaseline != Integer.MIN_VALUE) {
                                ...
                                boolean isOneLine = z;
                                int buttonPlaceX = Constraints.m7498getMaxWidthimpl(constraints) - buttonPlaceable.getWidth();
                                if (isOneLine) {
                                    int containerHeight2 = Math.max(measureScope.m7529roundToPx0680j_4(SnackbarKt.SnackbarMinHeightOneLine), buttonPlaceable.getHeight());
                                    ...
                                    int containerHeight3 = Math.max(measureScope.m7529roundToPx0680j_4(SnackbarKt.SnackbarMinHeightTwoLines), textPlaceY3 + textPlaceable.getHeight());
                                ...
                                return MeasureScope.layout$default($this$Layout, Constraints.m7498getMaxWidthimpl(constraints), containerHeight, (Map) null, new SnackbarKt$OneRowSnackbar$2$measure$4(textPlaceable, textPlaceY, buttonPlaceable, buttonPlaceX, it), 4, (Object) null);
                            }
