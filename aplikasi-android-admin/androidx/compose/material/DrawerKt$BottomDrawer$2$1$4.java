...
final class DrawerKt$BottomDrawer$2$1$4 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    final /* synthetic */ BottomDrawerState $drawerState;
    final /* synthetic */ String $navigationMenu;
    final /* synthetic */ CoroutineScope $scope;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DrawerKt$BottomDrawer$2$1$4(String str, BottomDrawerState bottomDrawerState, CoroutineScope coroutineScope) {
        super(1);
        ...
        if (this.$drawerState.isOpen()) {
            ...
            SemanticsPropertiesKt.dismiss$default($this$semantics, (String) null, new Function0<Boolean>() {
                public final Boolean invoke() {
                    if (bottomDrawerState.confirmStateChange$material_release(BottomDrawerValue.Closed)) {
