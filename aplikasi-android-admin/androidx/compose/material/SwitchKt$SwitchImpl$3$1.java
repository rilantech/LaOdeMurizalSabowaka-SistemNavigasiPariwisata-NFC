...
final class SwitchKt$SwitchImpl$3$1 extends Lambda implements Function1<Density, IntOffset> {
    ...
    SwitchKt$SwitchImpl$3$1(Function0<Float> function0) {
        super(1);
        this.$thumbValue = function0;
    }

    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return IntOffset.m7663boximpl(m3149invokeBjo55l4((Density) p1));
    }

    /* renamed from: invoke-Bjo55l4  reason: not valid java name */
    public final long m3149invokeBjo55l4(Density $this$offset) {
        Intrinsics.checkNotNullParameter($this$offset, "$this$offset");
        return IntOffsetKt.IntOffset(MathKt.roundToInt(this.$thumbValue.invoke().floatValue()), 0);
    }
}
