...
public final class MaterialTextSelectionColorsKt {
    ...
    public static final TextSelectionColors rememberTextSelectionColors(Colors colors, Composer $composer, int $changed) {
        ...
        long primaryColor = colors.m2951getPrimary0d7_KjU();
        long backgroundColor = colors.m2944getBackground0d7_KjU();
        composer.startReplaceableGroup(35572910);
        ComposerKt.sourceInformation(composer, "*43@1845L7");
        long $this$takeOrElse_u2dDxMtmZc$iv = ColorsKt.m2968contentColorFor4WTKRHQ(colors2, backgroundColor);
        if ($this$takeOrElse_u2dDxMtmZc$iv != Color.Companion.m4999getUnspecified0d7_KjU()) {
            ...
            j = ((Color) consume).m4973unboximpl();
        }
        $composer.endReplaceableGroup();
        long textColorWithLowestAlpha = Color.m4962copywmQWz5c$default(j, ContentAlpha.INSTANCE.getMedium(composer, 6), 0.0f, 0.0f, 0.0f, 14, (Object) null);
        Object key1$iv = Color.m4953boximpl(primaryColor);
        Color r6 = Color.m4953boximpl(backgroundColor);
        Object key3$iv = Color.m4953boximpl(textColorWithLowestAlpha);
        Color color = r6;
        ...
        if (invalid$iv$iv || value$iv$iv == Composer.Companion.getEmpty()) {
            ...
            Color color2 = color;
            value$iv$iv = new TextSelectionColors(colors.m2951getPrimary0d7_KjU(), m3048calculateSelectionBackgroundColorysEtTa8(primaryColor, textColorWithLowestAlpha, backgroundColor), (DefaultConstructorMarker) null);
    ...
    public static final long m3048calculateSelectionBackgroundColorysEtTa8(long selectionColor, long textColor, long backgroundColor) {
        float alpha;
        float maximumContrastRatio = m3047calculateContrastRationb2GgbA(selectionColor, 0.4f, textColor, backgroundColor);
        float minimumContrastRatio = m3047calculateContrastRationb2GgbA(selectionColor, 0.2f, textColor, backgroundColor);
        if (maximumContrastRatio >= DesiredContrastRatio) {
            alpha = 0.4f;
        } else if (minimumContrastRatio < DesiredContrastRatio) {
            alpha = 0.2f;
        } else {
            alpha = m3045binarySearchForAccessibleSelectionColorAlphaysEtTa8(selectionColor, textColor, backgroundColor);
        }
        return Color.m4962copywmQWz5c$default(selectionColor, alpha, 0.0f, 0.0f, 0.0f, 14, (Object) null);
    }

    /* renamed from: binarySearchForAccessibleSelectionColorAlpha-ysEtTa8  reason: not valid java name */
    private static final float m3045binarySearchForAccessibleSelectionColorAlphaysEtTa8(long selectionColor, long textColor, long backgroundColor) {
        float lowAlpha = 0.2f;
        float alpha = 0.4f;
        float highAlpha = 0.4f;
        for (int attempts = 0; attempts < 7; attempts++) {
            float percentageError = (m3047calculateContrastRationb2GgbA(selectionColor, alpha, textColor, backgroundColor) / DesiredContrastRatio) - 1.0f;
            boolean z = false;
    ...
    private static final float m3047calculateContrastRationb2GgbA(long selectionColor, float selectionColorAlpha, long textColor, long backgroundColor) {
        long compositeBackground = ColorKt.m5008compositeOverOWjLjI(Color.m4962copywmQWz5c$default(selectionColor, selectionColorAlpha, 0.0f, 0.0f, 0.0f, 14, (Object) null), backgroundColor);
        return m3046calculateContrastRatioOWjLjI(ColorKt.m5008compositeOverOWjLjI(textColor, compositeBackground), compositeBackground);
    }

    /* renamed from: calculateContrastRatio--OWjLjI  reason: not valid java name */
    public static final float m3046calculateContrastRatioOWjLjI(long foreground, long background) {
        float foregroundLuminance = ColorKt.m5015luminance8_81llA(foreground) + 0.05f;
        float backgroundLuminance = ColorKt.m5015luminance8_81llA(background) + 0.05f;
