...
final class DefaultButtonElevation implements ButtonElevation {
    ...
    public State<Dp> elevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (!enabled) {
            ...
            EffectsKt.LaunchedEffect((Object) Dp.m7552boximpl(target), (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new DefaultButtonElevation$elevation$2(animatable, target, (Continuation<? super DefaultButtonElevation$elevation$2>) null), composer, 64);
            $composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-1598807146);
            ComposerKt.sourceInformation(composer, "556@22499L546");
            EffectsKt.LaunchedEffect((Object) Dp.m7552boximpl(target), (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new DefaultButtonElevation$elevation$3(animatable, this, target, interaction, (Continuation<? super DefaultButtonElevation$elevation$3>) null), composer, 64);
            $composer.endReplaceableGroup();
        }
