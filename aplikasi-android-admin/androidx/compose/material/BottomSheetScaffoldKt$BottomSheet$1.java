...
final class BottomSheetScaffoldKt$BottomSheet$1 extends Lambda implements Function1<IntSize, Unit> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        m2909invokeozmzZPI(((IntSize) p1).m7718unboximpl());
        return Unit.INSTANCE;
    }

    /* renamed from: invoke-ozmzZPI  reason: not valid java name */
    public final void m2909invokeozmzZPI(long layoutSize) {
        this.$state.getAnchoredDraggableState$material_release().updateAnchors$material_release(this.$calculateAnchors.invoke(IntSize.m7706boximpl(layoutSize)), this.$anchorChangeCallback);
    }
}
