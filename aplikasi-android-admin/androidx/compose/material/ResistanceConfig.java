...
public final class ResistanceConfig {
    ...
    public ResistanceConfig(float basis2, float factorAtMin2, float factorAtMax2) {
        this.basis = basis2;
        this.factorAtMin = factorAtMin2;
        this.factorAtMax = factorAtMax2;
    }
    ...
    public final float computeResistance(float overflow) {
        ...
        return (this.basis / factor) * ((float) Math.sin((double) ((3.1415927f * RangesKt.coerceIn(overflow / this.basis, -1.0f, 1.0f)) / ((float) 2))));
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(this.factorAtMax == ((ResistanceConfig) other).factorAtMax)) {
            return false;
        }
        return true;
    }
