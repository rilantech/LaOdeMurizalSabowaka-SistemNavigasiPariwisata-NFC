...
public final class DividerKt {
    ...
    public static final void m2986DivideroMI9zvI(Modifier modifier, long color, float thickness, float startIndent, Composer $composer, int $changed, int i) {
        Modifier modifier2;
        long j;
        float f;
        float f2;
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            if ((i3 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 2) != 0) {
                    color3 = Color.m4962copywmQWz5c$default(MaterialTheme.INSTANCE.getColors($composer2, 6).m2950getOnSurface0d7_KjU(), 0.12f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
                    $dirty &= -113;
                } else {
                    color3 = j;
                }
                if (i5 != 0) {
                    thickness3 = Dp.m7554constructorimpl((float) 1);
                } else {
                    thickness3 = f;
                }
                if (i6 != 0) {
                    startIndent3 = Dp.m7554constructorimpl((float) 0);
                } else {
                    startIndent3 = f2;
                }
            } else {
            ...
            if (!(startIndent3 == 0.0f)) {
                indentMod = PaddingKt.m2252paddingqDBjuR0$default(Modifier.Companion, startIndent3, 0.0f, 0.0f, 0.0f, 14, (Object) null);
            } else {
            ...
            BoxKt.Box(BackgroundKt.m1877backgroundbw27NRU$default(SizeKt.m2308height3ABfNKs(SizeKt.fillMaxWidth$default(modifier4.then(indentMod), 0.0f, 1, (Object) null), targetThickness), color3, (Shape) null, 2, (Object) null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
