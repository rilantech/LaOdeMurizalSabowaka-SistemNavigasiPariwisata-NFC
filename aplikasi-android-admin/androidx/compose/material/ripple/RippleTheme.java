...
public interface RippleTheme {
    ...
    long m3234defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m3236defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            float contentLuminance = ColorKt.m5015luminance8_81llA(contentColor);
            if (lightTheme || ((double) contentLuminance) >= 0.5d) {
                return contentColor;
            }
            return Color.Companion.m5000getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc  reason: not valid java name */
        public final RippleAlpha m3235defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            if (!lightTheme) {
                return RippleThemeKt.DarkThemeRippleAlpha;
            }
            if (((double) ColorKt.m5015luminance8_81llA(contentColor)) > 0.5d) {
