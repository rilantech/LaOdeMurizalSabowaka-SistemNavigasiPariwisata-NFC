...
public final class RippleKt {
    ...
    public static final Indication m3233rememberRipple9IZ8Weo(boolean bounded, float radius, long color, Composer $composer, int $changed, int i) {
        float radius2;
        long color2;
        Object value$iv$iv;
        ...
        if ((i & 2) != 0) {
            radius2 = Dp.Companion.m7574getUnspecifiedD9Ej5fM();
        } else {
            radius2 = radius;
        }
        if ((i & 4) != 0) {
            color2 = Color.Companion.m4999getUnspecified0d7_KjU();
        } else {
            color2 = color;
        }
        ...
        State colorState = SnapshotStateKt.rememberUpdatedState(Color.m4953boximpl(color2), composer, (i2 >> 6) & 14);
        Object key1$iv = Boolean.valueOf(bounded2);
        Object key2$iv = Dp.m7552boximpl(radius2);
        int i3 = (i2 & 14) | (i2 & 112);
