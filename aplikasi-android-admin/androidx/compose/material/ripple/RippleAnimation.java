...
public final class RippleAnimation {
    ...
    public final void m3226draw4WTKRHQ(DrawScope $this$draw_u2d4WTKRHQ, long color) {
        float f;
        Float f2;
        DrawScope drawScope = $this$draw_u2d4WTKRHQ;
        Intrinsics.checkNotNullParameter(drawScope, "$this$draw");
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m3228getRippleStartRadiusuvyYCjk($this$draw_u2d4WTKRHQ.m5576getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            if (Float.isNaN(this.radius)) {
                f2 = Float.valueOf(RippleAnimationKt.m3227getRippleEndRadiuscSwnlzA(drawScope, this.bounded, $this$draw_u2d4WTKRHQ.m5576getSizeNHjbRc()));
            } else {
                f2 = Float.valueOf(drawScope.m7535toPx0680j_4(this.radius));
            }
            this.targetRadius = f2;
        }
        if (this.origin == null) {
            this.origin = Offset.m4702boximpl($this$draw_u2d4WTKRHQ.m5575getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m4702boximpl(OffsetKt.Offset(Size.m4782getWidthimpl($this$draw_u2d4WTKRHQ.m5576getSizeNHjbRc()) / 2.0f, Size.m4779getHeightimpl($this$draw_u2d4WTKRHQ.m5576getSizeNHjbRc()) / 2.0f));
        }
        ...
        float r1 = Offset.m4713getXimpl(offset.m4723unboximpl());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float lerp = MathHelpersKt.lerp(r1, Offset.m4713getXimpl(offset2.m4723unboximpl()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float r2 = Offset.m4714getYimpl(offset3.m4723unboximpl());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long centerOffset = OffsetKt.Offset(lerp, MathHelpersKt.lerp(r2, Offset.m4714getYimpl(offset4.m4723unboximpl()), this.animatedCenterPercent.getValue().floatValue()));
        long modulatedColor = Color.m4962copywmQWz5c$default(color, Color.m4965getAlphaimpl(color) * alpha, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        if (this.bounded) {
            ...
            DrawScope.m5539drawCircleVaOC9Bg$default($this$withTransform$iv$iv, modulatedColor, radius2, centerOffset, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 120, (Object) null);
        ...
        DrawScope.m5539drawCircleVaOC9Bg$default($this$draw_u2d4WTKRHQ, modulatedColor, radius2, centerOffset, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 120, (Object) null);
    }
}
