...
public abstract class Ripple implements Indication {
    ...
    public abstract RippleIndicationInstance m3225rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z, float f, State<Color> state, State<RippleAlpha> state2, Composer composer, int i);
    ...
    public final IndicationInstance rememberUpdatedInstance(InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (this.color.getValue().m4973unboximpl() != Color.Companion.m4999getUnspecified0d7_KjU()) {
            j = this.color.getValue().m4973unboximpl();
        } else {
            j = theme.m3234defaultColorWaAFU9c(composer, 0);
        }
        $composer.endReplaceableGroup();
        RippleIndicationInstance instance = m3225rememberUpdatedRippleInstance942rkJo(interactionSource, this.bounded, this.radius, SnapshotStateKt.rememberUpdatedState(Color.m4953boximpl(j), composer, 0), SnapshotStateKt.rememberUpdatedState(theme.rippleAlpha(composer, 0), composer, 0), $composer, (i & 14) | ((i << 12) & 458752));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ripple) && this.bounded == ((Ripple) other).bounded && Dp.m7559equalsimpl0(this.radius, ((Ripple) other).radius) && Intrinsics.areEqual((Object) this.color, (Object) ((Ripple) other).color)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((Boolean.hashCode(this.bounded) * 31) + Dp.m7560hashCodeimpl(this.radius)) * 31) + this.color.hashCode();
    }
}
