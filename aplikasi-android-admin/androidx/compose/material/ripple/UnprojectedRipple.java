...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m3239setColorDxMtmZc(long color, float alpha) {
        long newColor = m3238calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (!(color2 == null ? false : Color.m4964equalsimpl0(color2.m4973unboximpl(), newColor))) {
            this.rippleColor = Color.m4953boximpl(newColor);
            setColor(ColorStateList.valueOf(ColorKt.m5017toArgb8_81llA(newColor)));
        }
    }
    ...
    private final long m3238calculateRippleColor5vOe2sY(long color, float alpha) {
        return Color.m4962copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, (Object) null);
    }
