...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    private AndroidRippleIndicationInstance(boolean bounded2, float radius2, State<Color> color2, State<RippleAlpha> rippleAlpha2, RippleContainer rippleContainer2) {
        ...
        this.rippleSize = Size.Companion.m4791getZeroNHjbRc();
        this.rippleRadius = -1;
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        ...
        this.rippleSize = $this$drawIndication.m5576getSizeNHjbRc();
        if (Float.isNaN(this.radius)) {
            i = MathKt.roundToInt(RippleAnimationKt.m3227getRippleEndRadiuscSwnlzA($this$drawIntoCanvas$iv, this.bounded, $this$drawIndication.m5576getSizeNHjbRc()));
        } else {
            i = $this$drawIntoCanvas$iv.m7529roundToPx0680j_4(this.radius);
        }
        this.rippleRadius = i;
        long color2 = this.color.getValue().m4973unboximpl();
        float alpha = this.rippleAlpha.getValue().getPressedAlpha();
        $this$drawIndication.drawContent();
        m3232drawStateLayerH2RKhps($this$drawIntoCanvas$iv, this.radius, color2);
        ...
        if ($this$drawIndication_u24lambda_u241_u24lambda_u240 != null) {
            $this$drawIndication_u24lambda_u241_u24lambda_u240.m3231updateRipplePropertiesbiQXAtU($this$drawIndication.m5576getSizeNHjbRc(), this.rippleRadius, color2, alpha);
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        $this$addRipple_u24lambda_u243_u24lambda_u242.m3230addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m4973unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
