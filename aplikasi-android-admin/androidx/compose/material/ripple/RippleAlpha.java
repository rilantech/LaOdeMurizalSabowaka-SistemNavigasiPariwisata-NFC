...
public final class RippleAlpha {
    ...
    public RippleAlpha(float draggedAlpha2, float focusedAlpha2, float hoveredAlpha2, float pressedAlpha2) {
        this.draggedAlpha = draggedAlpha2;
        this.focusedAlpha = focusedAlpha2;
        this.hoveredAlpha = hoveredAlpha2;
        this.pressedAlpha = pressedAlpha2;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(this.pressedAlpha == ((RippleAlpha) other).pressedAlpha)) {
            return false;
        }
        return true;
    }
