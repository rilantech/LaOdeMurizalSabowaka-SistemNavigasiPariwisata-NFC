...
public final class Strings {
    ...
    public static final int CloseDrawer = m3115constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int CloseSheet = m3115constructorimpl(2);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int DefaultErrorMessage = m3115constructorimpl(3);
    /* access modifiers changed from: private */
    public static final int ExposedDropdownMenu = m3115constructorimpl(4);
    /* access modifiers changed from: private */
    public static final int NavigationMenu = m3115constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int SliderRangeEnd = m3115constructorimpl(6);
    /* access modifiers changed from: private */
    public static final int SliderRangeStart = m3115constructorimpl(5);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ Strings m3114boximpl(int i) {
        return new Strings(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m3115constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3116equalsimpl(int i, Object obj) {
        return (obj instanceof Strings) && i == ((Strings) obj).m3120unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3117equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object obj) {
        return m3116equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3118hashCodeimpl(this.value);
    }

    public String toString() {
        return m3119toStringimpl(this.value);
    }
