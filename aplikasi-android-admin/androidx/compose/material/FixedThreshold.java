...
public final class FixedThreshold implements ThresholdConfig {
    ...
    private final float m3029component1D9Ej5fM() {
        return this.offset;
    }

    /* renamed from: copy-0680j_4$default  reason: not valid java name */
    public static /* synthetic */ FixedThreshold m3030copy0680j_4$default(FixedThreshold fixedThreshold, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = fixedThreshold.offset;
        }
        return fixedThreshold.m3031copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4  reason: not valid java name */
    public final FixedThreshold m3031copy0680j_4(float f) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof FixedThreshold) && Dp.m7559equalsimpl0(this.offset, ((FixedThreshold) obj).offset);
    }

    public int hashCode() {
        return Dp.m7560hashCodeimpl(this.offset);
    }

    public String toString() {
        return "FixedThreshold(offset=" + Dp.m7565toStringimpl(this.offset) + ')';
    }
    ...
    public float computeThreshold(Density $this$computeThreshold, float fromValue, float toValue) {
        ...
        return ($this$computeThreshold.m7535toPx0680j_4(this.offset) * Math.signum(toValue - fromValue)) + fromValue;
    }
}
