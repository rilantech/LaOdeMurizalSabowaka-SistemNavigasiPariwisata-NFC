...
final class SnackbarKt$TextOnlySnackbar$2 implements MeasurePolicy {
    ...
    public final MeasureResult m3113measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        float minHeight;
        ...
        if (measurables.size() == 1) {
            Placeable textPlaceable = ((Measurable) CollectionsKt.first(measurables)).m6399measureBRTryo0(constraints);
            ...
            if (firstBaseline != Integer.MIN_VALUE) {
                ...
                if (z) {
                    ...
                    int containerHeight = Math.max(measureScope.m7529roundToPx0680j_4(minHeight), textPlaceable.getHeight());
                    return MeasureScope.layout$default($this$Layout, Constraints.m7498getMaxWidthimpl(constraints), containerHeight, (Map) null, new SnackbarKt$TextOnlySnackbar$2$measure$4(containerHeight, textPlaceable), 4, (Object) null);
                }
