...
public final class CheckboxKt {
    ...
    private static final float CheckboxRippleRadius = Dp.m7554constructorimpl((float) 24);
    ...
    public static final void Checkbox(boolean checked, Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, CheckboxColors colors, Composer $composer, int $changed, int i) {
        ...
        if ((374491 & $dirty) != 74898 || !$composer2.getSkipping()) {
            ...
            if ((i3 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    colors3 = CheckboxDefaults.INSTANCE.m2929colorszjMxDiM(0, 0, 0, 0, 0, $composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
                    $dirty &= -458753;
                } else {
                    colors3 = colors;
                }
    ...
    public static final void TriStateCheckbox(ToggleableState state, Function0<Unit> onClick, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, CheckboxColors colors, Composer $composer, int $changed, int i) {
        ...
        if ((374491 & $dirty3) != 74898 || !$composer2.getSkipping()) {
            ...
            if ((i3 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    colors2 = CheckboxDefaults.INSTANCE.m2929colorszjMxDiM(0, 0, 0, 0, 0, $composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
                    $dirty = $dirty3 & -458753;
                    modifier3 = modifier6;
                    enabled2 = enabled3;
            ...
            if (function0 != null) {
                $dirty2 = $dirty;
                modifier4 = ToggleableKt.m2551triStateToggleableO2vRcR0(Modifier.Companion, state, interactionSource3, RippleKt.m3233rememberRipple9IZ8Weo(false, CheckboxRippleRadius, 0, $composer2, 54, 4), enabled2, Role.m6865boximpl(Role.Companion.m6873getCheckboxo7Vup1c()), onClick);
            } else {
                $dirty2 = $dirty;
                modifier4 = Modifier.Companion;
            }
            ...
            CheckboxImpl(enabled2, state, PaddingKt.m2248padding3ABfNKs(modifier3.then(modifier5).then(toggleableModifier), CheckboxDefaultPadding), colors2, $composer2, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 6) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            int i7 = $dirty2;
    ...
    public static final long CheckboxImpl$lambda$8(State<Color> $checkColor$delegate) {
        return ((Color) $checkColor$delegate.getValue()).m4973unboximpl();
    }

    /* access modifiers changed from: private */
    public static final long CheckboxImpl$lambda$9(State<Color> $boxColor$delegate) {
        return ((Color) $boxColor$delegate.getValue()).m4973unboximpl();
    }

    /* access modifiers changed from: private */
    public static final long CheckboxImpl$lambda$10(State<Color> $borderColor$delegate) {
        return ((Color) $borderColor$delegate.getValue()).m4973unboximpl();
    }

    /* access modifiers changed from: private */
    /* renamed from: drawBox-1wkBAMs  reason: not valid java name */
    public static final void m2932drawBox1wkBAMs(DrawScope $this$drawBox_u2d1wkBAMs, long boxColor, long borderColor, float radius, float strokeWidth) {
        float f = radius;
    ...
    public static final void m2933drawCheck3IgeMak(DrawScope $this$drawCheck_u2d3IgeMak, long checkColor, float checkFraction, float crossCenterGravitation, float strokeWidthPx, CheckDrawingCache drawingCache) {
