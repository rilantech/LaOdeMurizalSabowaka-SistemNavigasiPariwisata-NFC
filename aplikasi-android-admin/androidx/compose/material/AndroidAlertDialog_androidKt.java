...
public final class AndroidAlertDialog_androidKt {
    ...
    public static final void m2867AlertDialog6oU6zVQ(Function0<Unit> onDismissRequest, Function2<? super Composer, ? super Integer, Unit> confirmButton, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> dismissButton, Function2<? super Composer, ? super Integer, Unit> title, Function2<? super Composer, ? super Integer, Unit> text, Shape shape, long backgroundColor, long contentColor, DialogProperties properties, Composer $composer, int $changed, int i) {
        Function2 function2;
        long contentColor2;
        ...
        if (($dirty3 & 1533916891) != 306783378 || !$composer3.getSkipping()) {
            ...
            if ((i5 & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i6 & 128) != 0) {
                    ...
                    modifier4 = modifier3;
                    backgroundColor3 = MaterialTheme.INSTANCE.getColors($composer3, 6).m2955getSurface0d7_KjU();
                } else {
                    $dirty2 = $dirty3;
                    modifier4 = modifier3;
                ...
                if ((i6 & 256) != 0) {
                    contentColor2 = ColorsKt.m2969contentColorForek8zF_U(backgroundColor3, $composer3, ($dirty2 >> 21) & 14);
                    $dirty2 &= -234881025;
                }
                if (i11 != 0) {
                    modifier2 = modifier4;
    ...
    public static final void m2868AlertDialogwqdebIU(Function0<Unit> onDismissRequest, Function2<? super Composer, ? super Integer, Unit> buttons, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> title, Function2<? super Composer, ? super Integer, Unit> text, Shape shape, long backgroundColor, long contentColor, DialogProperties properties, Composer $composer, int $changed, int i) {
        long backgroundColor2;
        long contentColor2;
        DialogProperties properties2;
        long contentColor3;
        ...
        if (($dirty2 & 191739611) != 38347922 || !$composer2.getSkipping()) {
            ...
            if ((i5 & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i6 & 128) != 0) {
                    contentColor2 = ColorsKt.m2969contentColorForek8zF_U(backgroundColor2, $composer2, ($dirty2 >> 18) & 14);
                    $dirty2 &= -29360129;
                }
                if (i10 != 0) {
                    modifier2 = modifier4;
