...
final class DefaultSelectableChipColors implements SelectableChipColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4964equalsimpl0(this.backgroundColor, ((DefaultSelectableChipColors) other).backgroundColor) && Color.m4964equalsimpl0(this.contentColor, ((DefaultSelectableChipColors) other).contentColor) && Color.m4964equalsimpl0(this.leadingIconColor, ((DefaultSelectableChipColors) other).leadingIconColor) && Color.m4964equalsimpl0(this.disabledBackgroundColor, ((DefaultSelectableChipColors) other).disabledBackgroundColor) && Color.m4964equalsimpl0(this.disabledContentColor, ((DefaultSelectableChipColors) other).disabledContentColor) && Color.m4964equalsimpl0(this.disabledLeadingIconColor, ((DefaultSelectableChipColors) other).disabledLeadingIconColor) && Color.m4964equalsimpl0(this.selectedBackgroundColor, ((DefaultSelectableChipColors) other).selectedBackgroundColor) && Color.m4964equalsimpl0(this.selectedContentColor, ((DefaultSelectableChipColors) other).selectedContentColor) && Color.m4964equalsimpl0(this.selectedLeadingIconColor, ((DefaultSelectableChipColors) other).selectedLeadingIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((Color.m4970hashCodeimpl(this.backgroundColor) * 31) + Color.m4970hashCodeimpl(this.contentColor)) * 31) + Color.m4970hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4970hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m4970hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4970hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4970hashCodeimpl(this.selectedBackgroundColor)) * 31) + Color.m4970hashCodeimpl(this.selectedContentColor)) * 31) + Color.m4970hashCodeimpl(this.selectedLeadingIconColor);
    }
}
