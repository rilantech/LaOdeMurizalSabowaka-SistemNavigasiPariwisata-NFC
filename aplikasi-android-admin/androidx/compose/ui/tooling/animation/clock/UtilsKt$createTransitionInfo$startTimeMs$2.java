...
final class UtilsKt$createTransitionInfo$startTimeMs$2 extends Lambda implements Function0<Long> {
    ...
    public final Long invoke() {
        ...
        if (animationSpec instanceof TweenSpec) {
            ...
            if (StartOffsetType.m1839equalsimpl0(StartOffset.m1832getOffsetTypeEo1U57Q(((RepeatableSpec) animationSpec).m1823getInitialStartOffsetRmkjzm4()), StartOffsetType.Companion.m1843getDelayEo1U57Q())) {
                j = Integer.valueOf(StartOffset.m1831getOffsetMillisimpl(((RepeatableSpec) this.$animationSpec).m1823getInitialStartOffsetRmkjzm4()));
            } else {
                j = 0L;
            }
        } else if (animationSpec instanceof InfiniteRepeatableSpec) {
            if (StartOffsetType.m1839equalsimpl0(StartOffset.m1832getOffsetTypeEo1U57Q(((InfiniteRepeatableSpec) animationSpec).m1811getInitialStartOffsetRmkjzm4()), StartOffsetType.Companion.m1843getDelayEo1U57Q())) {
                j = Integer.valueOf(StartOffset.m1831getOffsetMillisimpl(((InfiniteRepeatableSpec) this.$animationSpec).m1811getInitialStartOffsetRmkjzm4()));
            } else {
                j = 0L;
            }
