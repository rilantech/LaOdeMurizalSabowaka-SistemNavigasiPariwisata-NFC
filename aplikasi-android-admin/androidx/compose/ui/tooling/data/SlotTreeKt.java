...
public final class SlotTreeKt {
    ...
    public static final IntRect boundsOfLayoutNode(LayoutInfo node) {
        ...
        long size = node.getCoordinates().m6360getSizeYbymL2g();
        int left = MathKt.roundToInt(Offset.m4713getXimpl(position));
        int top = MathKt.roundToInt(Offset.m4714getYimpl(position));
        return new IntRect(left, top, IntSize.m7714getWidthimpl(size) + left, IntSize.m7713getHeightimpl(size) + top);
    }
