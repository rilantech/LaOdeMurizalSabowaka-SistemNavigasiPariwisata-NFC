...
public final class ParameterInformation {
    ...
    private final boolean f61static;
    ...
    public static /* synthetic */ ParameterInformation copy$default(ParameterInformation parameterInformation, String str, Object obj, boolean z, boolean z2, boolean z3, String str2, boolean z4, int i, Object obj2) {
        ...
        boolean z5 = z;
        if ((i & 8) != 0) {
            z2 = parameterInformation.f61static;
        }
        boolean z6 = z2;
        if ((i & 16) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.name, (Object) parameterInformation.name) && Intrinsics.areEqual(this.value, parameterInformation.value) && this.fromDefault == parameterInformation.fromDefault && this.f61static == parameterInformation.f61static && this.compared == parameterInformation.compared && Intrinsics.areEqual((Object) this.inlineClass, (Object) parameterInformation.inlineClass) && this.stable == parameterInformation.stable;
    }
    ...
    public String toString() {
        return "ParameterInformation(name=" + this.name + ", value=" + this.value + ", fromDefault=" + this.fromDefault + ", static=" + this.f61static + ", compared=" + this.compared + ", inlineClass=" + this.inlineClass + ", stable=" + this.stable + ')';
    }
