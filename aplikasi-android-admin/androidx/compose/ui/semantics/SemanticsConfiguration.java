...
public final class SemanticsConfiguration implements SemanticsPropertyReceiver, Iterable<Map.Entry<? extends SemanticsPropertyKey<?>, ? extends Object>>, KMappedMarker {
    ...
    public final void mergeChild$ui_release(SemanticsConfiguration child) {
        ...
        for (Map.Entry next : child.props.entrySet()) {
            SemanticsPropertyKey key = (SemanticsPropertyKey) next.getKey();
    ...
    public final void collapsePeer$ui_release(SemanticsConfiguration peer) {
        ...
        for (Map.Entry next : peer.props.entrySet()) {
            SemanticsPropertyKey key = (SemanticsPropertyKey) next.getKey();
            Object nextValue = next.getValue();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SemanticsConfiguration) && Intrinsics.areEqual((Object) this.props, (Object) ((SemanticsConfiguration) other).props) && this.isMergingSemanticsOfDescendants == ((SemanticsConfiguration) other).isMergingSemanticsOfDescendants && this.isClearingSemantics == ((SemanticsConfiguration) other).isClearingSemantics) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        for (Map.Entry next : this.props.entrySet()) {
            ...
            propsString.append(nextSeparator);
            propsString.append(((SemanticsPropertyKey) next.getKey()).getName());
            propsString.append(" : ");
            propsString.append(value);
            nextSeparator = ", ";
        }
        return JvmActuals_jvmKt.simpleIdentityToString(this, (String) null) + "{ " + propsString + " }";
    }
}
