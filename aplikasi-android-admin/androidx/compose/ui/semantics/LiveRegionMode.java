...
public final class LiveRegionMode {
    ...
    public static final int Assertive = m6857constructorimpl(1);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int Polite = m6857constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ LiveRegionMode m6856boximpl(int i) {
        return new LiveRegionMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m6857constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m6858equalsimpl(int i, Object obj) {
        return (obj instanceof LiveRegionMode) && i == ((LiveRegionMode) obj).m6862unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m6858equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m6860hashCodeimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m6862unboximpl() {
        return this.value;
    }
    ...
    public static String m6861toStringimpl(int arg0) {
        if (m6859equalsimpl0(arg0, Polite)) {
            return "Polite";
        }
        if (m6859equalsimpl0(arg0, Assertive)) {
            return "Assertive";
        }
        return "Unknown";
    }
    ...
    public String toString() {
        return m6861toStringimpl(this.value);
    }
}
