...
public final class ProgressBarRangeInfo {
    ...
    public ProgressBarRangeInfo(float current2, ClosedFloatingPointRange<Float> range2, int steps2) {
        Intrinsics.checkNotNullParameter(range2, "range");
        this.current = current2;
        this.range = range2;
        this.steps = steps2;
        if (!(!Float.isNaN(current2))) {
    ...
    public boolean equals(Object other) {
        ...
        if ((this.current == ((ProgressBarRangeInfo) other).current) && Intrinsics.areEqual((Object) this.range, (Object) ((ProgressBarRangeInfo) other).range) && this.steps == ((ProgressBarRangeInfo) other).steps) {
            return true;
        }
        return false;
    }
