...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m6610updateRootConstraintsBRTryo0(long constraints) {
        ...
        if (!this.duringMeasureLayout) {
            this.rootConstraints = Constraints.m7486boximpl(constraints);
    ...
    private final boolean m6607doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean lookaheadSizeChanged;
        if (layoutNode.getLookaheadRoot$ui_release() == null) {
            return false;
        }
        if (constraints != null) {
            lookaheadSizeChanged = layoutNode.m6542lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            lookaheadSizeChanged = LayoutNode.m6538lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, (Constraints) null, 1, (Object) null);
        }
        LayoutNode parent = layoutNode.getParent$ui_release();
    ...
    private final boolean m6608doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean sizeChanged;
        if (constraints != null) {
            sizeChanged = layoutNode.m6543remeasure_Sx5XlM$ui_release(constraints);
        } else {
            sizeChanged = LayoutNode.m6539remeasure_Sx5XlM$ui_release$default(layoutNode, (Constraints) null, 1, (Object) null);
        }
        LayoutNode parent = layoutNode.getParent$ui_release();
    ...
    public final void m6609measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
            ...
            if (!this.root.isAttached()) {
                ...
                if (this.rootConstraints != null) {
                    ...
                    try {
                        ...
                        boolean lookaheadSizeChanged = m6607doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m7486boximpl(constraints));
                        m6608doRemeasuresdFAvZA(layoutNode, Constraints.m7486boximpl(constraints));
        ...
        if (layoutNode.isPlaced() || getCanAffectParent(layoutNode) || Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) || getCanAffectParentInLookahead(layoutNode) || layoutNode.getAlignmentLinesRequired$ui_release()) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release() || layoutNode.getMeasurePending$ui_release()) {
                ...
                if (layoutNode.getLookaheadMeasurePending$ui_release() && affectsLookahead) {
                    lookaheadSizeChanged = m6607doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
                }
                sizeChanged = m6608doRemeasuresdFAvZA(layoutNode, constraints);
            }
    ...
    private final void remeasureOnly(LayoutNode layoutNode) {
        ...
        if (layoutNode.getMeasurePending$ui_release() || layoutNode.getLookaheadMeasurePending$ui_release()) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release()) {
                m6607doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
            }
            m6608doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
