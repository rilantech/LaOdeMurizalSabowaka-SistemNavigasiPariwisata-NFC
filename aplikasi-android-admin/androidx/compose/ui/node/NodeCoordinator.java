...
public abstract class NodeCoordinator extends LookaheadCapablePlaceable implements Measurable, LayoutCoordinates, OwnerScope, Function1<Canvas, Unit> {
    ...
    private static final float[] tmpMatrix = Matrix.m5192constructorimpl$default((float[]) null, 1, (DefaultConstructorMarker) null);
    ...
    public interface HitTestSource {
        ...
        void m6661childHitTestYqVAtuI(LayoutNode layoutNode, long j, HitTestResult hitTestResult, boolean z, boolean z2);

        /* renamed from: entityType-OLwlOKw  reason: not valid java name */
        int m6662entityTypeOLwlOKw();
    ...
    public final /* synthetic */ <T> void m6654visitNodesaLcG6gQ(int type, Function1<? super T, Unit> block) {
        ...
        int i5 = false;
        boolean includeTail$iv5 = NodeKindKt.m6675getIncludeSelfInTraversalH91voCI(type);
    ...
    private final boolean m6626hasNodeH91voCI(int type) {
        Modifier.Node headNode = headNode(NodeKindKt.m6675getIncludeSelfInTraversalH91voCI(type));
        return headNode != null && DelegatableNodeKt.m6500has64DMado(headNode, type);
    }

    /* renamed from: head-H91voCI  reason: not valid java name */
    public final Modifier.Node m6641headH91voCI(int type) {
        boolean includeTail$iv = NodeKindKt.m6675getIncludeSelfInTraversalH91voCI(type);
        int mask$iv = type;
    ...
    public final long m6640getSizeYbymL2g() {
        return m6434getMeasuredSizeYbymL2g();
    }
    ...
    public void replace$ui_release() {
        m6649placeAtf8xVGno(m6639getPositionnOccac(), this.zIndex, this.layerBlock);
    }
    ...
    public void onMeasureResultChanged(int width, int height) {
        ...
        if (layer6 != null) {
            layer6.m6718resizeozmzZPI(IntSizeKt.IntSize(width, height));
        } else {
            NodeCoordinator nodeCoordinator = this.wrappedBy;
            if (nodeCoordinator != null) {
        ...
        m6437setMeasuredSizeozmzZPI(IntSizeKt.IntSize(width, height));
        NodeCoordinator nodeCoordinator2 = null;
        updateLayerParameters(false);
        int type$iv5 = NodeKind.m6666constructorimpl(4);
    ...
    public long m6639getPositionnOccac() {
        return this.position;
    }

    /* access modifiers changed from: protected */
    /* renamed from: setPosition--gyyYBs  reason: not valid java name */
    public void m6651setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public Object getParentData() {
        ...
        MutableVector mutableVector;
        int i = 64;
        if (!getLayoutNode().getNodes$ui_release().m6616hasH91voCI$ui_release(NodeKind.m6666constructorimpl(64))) {
            return null;
        }
        ...
        while (node$iv != null) {
            ...
            if (((node.getKindSet$ui_release() & NodeKind.m6666constructorimpl(i)) != 0 ? 1 : 0) != 0) {
                int kind$iv = NodeKind.m6666constructorimpl(i);
                MutableVector mutableVector2 = null;
    ...
    public final long m6637getLastMeasurementConstraintsmsEJaDk$ui_release() {
        return m6435getMeasurementConstraintsmsEJaDk();
    }

    /* access modifiers changed from: protected */
    /* renamed from: performingMeasure-K40F9xA  reason: not valid java name */
    public final Placeable m6648performingMeasureK40F9xA(long constraints, Function0<? extends Placeable> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public final void onMeasured() {
        ...
        int type$iv4;
        MutableVector mutableVector;
        if (m6626hasNodeH91voCI(NodeKind.m6666constructorimpl(128))) {
                                    ...
                                    try {
                                        if (node instanceof LayoutAwareModifierNode) {
                                            try {
                                                this_$iv5 = this_$iv;
                                                i3 = i;
                                                ((LayoutAwareModifierNode) node).m6527onRemeasuredozmzZPI(m6434getMeasuredSizeYbymL2g());
                                                type$iv3 = type$iv;
    ...
    public void m6649placeAtf8xVGno(long position2, float zIndex2, Function1<? super GraphicsLayerScope, Unit> layerBlock2) {
        m6630placeSelff8xVGno(position2, zIndex2, layerBlock2);
    }

    /* renamed from: placeSelf-f8xVGno  reason: not valid java name */
    private final void m6630placeSelff8xVGno(long position2, float zIndex2, Function1<? super GraphicsLayerScope, Unit> layerBlock2) {
        updateLayerBlock$default(this, layerBlock2, false, 2, (Object) null);
        if (!IntOffset.m7671equalsimpl0(m6639getPositionnOccac(), position2)) {
            m6651setPositiongyyYBs(position2);
            getLayoutNode().getLayoutDelegate$ui_release().getMeasurePassDelegate$ui_release().notifyChildrenUsingCoordinatesWhilePlacing();
            OwnedLayer layer2 = this.layer;
            if (layer2 != null) {
                layer2.m6717movegyyYBs(position2);
            } else {
                NodeCoordinator nodeCoordinator = this.wrappedBy;
                if (nodeCoordinator != null) {
                    nodeCoordinator.invalidateLayer();
    ...
    public final void m6650placeSelfApparentToRealOffsetf8xVGno(long position2, float zIndex2, Function1<? super GraphicsLayerScope, Unit> layerBlock2) {
        long other$iv = m6433getApparentToRealOffsetnOccac();
        m6630placeSelff8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position2) + IntOffset.m7672getXimpl(other$iv), IntOffset.m7673getYimpl(position2) + IntOffset.m7673getYimpl(other$iv)), zIndex2, layerBlock2);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float x = (float) IntOffset.m7672getXimpl(m6639getPositionnOccac());
        float y = (float) IntOffset.m7673getYimpl(m6639getPositionnOccac());
    ...
    public final void drawContainedDrawModifiers(Canvas canvas) {
        Modifier.Node head = m6641headH91voCI(NodeKind.m6666constructorimpl(4));
        if (head == null) {
            performDraw(canvas);
            return;
        }
        getLayoutNode().getMDrawScope$ui_release().m6548drawx_KDEd0$ui_release(canvas, IntSizeKt.m7724toSizeozmzZPI(m6640getSizeYbymL2g()), this, head);
    }
    ...
    public final void updateLayerBlock(Function1<? super GraphicsLayerScope, Unit> layerBlock2, boolean forceUpdateLayerParameters) {
        ...
        if (!isAttached() || layerBlock2 == null) {
            ...
            $this$updateLayerBlock_u24lambda_u2413.m6718resizeozmzZPI(m6434getMeasuredSizeYbymL2g());
            $this$updateLayerBlock_u24lambda_u2413.m6717movegyyYBs(m6639getPositionnOccac());
    ...
    private final void updateLayerParameters(boolean invokeOnLayoutChange) {
        ...
        if (layer2 != null) {
            ...
            if (function1 != null) {
                ...
                reusableGraphicsLayerScope.m5303setSizeuvyYCjk(IntSizeKt.m7724toSizeozmzZPI(m6640getSizeYbymL2g()));
                ...
                layer2.m6720updateLayerPropertiesdDxrwY(reusableGraphicsLayerScope.getScaleX(), reusableGraphicsLayerScope.getScaleY(), reusableGraphicsLayerScope.getAlpha(), reusableGraphicsLayerScope.getTranslationX(), reusableGraphicsLayerScope.getTranslationY(), reusableGraphicsLayerScope.getShadowElevation(), reusableGraphicsLayerScope.getRotationX(), reusableGraphicsLayerScope.getRotationY(), reusableGraphicsLayerScope.getRotationZ(), reusableGraphicsLayerScope.getCameraDistance(), reusableGraphicsLayerScope.m5300getTransformOriginSzJe1aQ(), reusableGraphicsLayerScope.getShape(), reusableGraphicsLayerScope2.getClip(), reusableGraphicsLayerScope2.getRenderEffect(), reusableGraphicsLayerScope.m5296getAmbientShadowColor0d7_KjU(), reusableGraphicsLayerScope.m5299getSpotShadowColor0d7_KjU(), reusableGraphicsLayerScope2.m5297getCompositingStrategyNrFUSI(), getLayoutNode().getLayoutDirection(), getLayoutNode().getDensity());
    ...
    public final long m6638getMinimumTouchTargetSizeNHjbRc() {
        return this.layerDensity.m7536toSizeXkaWNTQ(getLayoutNode().getViewConfiguration().m6841getMinimumTouchTargetSizeMYxV2XQ());
    }

    /* renamed from: hitTest-YqVAtuI  reason: not valid java name */
    public final void m6642hitTestYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        float f;
        ...
        Modifier.Node head = m6641headH91voCI(hitTestSource.m6662entityTypeOLwlOKw());
        boolean z = true;
        if (!m6656withinLayerBoundsk4lQ0M(j)) {
            if (isTouchEvent) {
                float distanceFromEdge = m6635distanceInMinimumTouchTargettz77jQw(j, m6638getMinimumTouchTargetSizeNHjbRc());
                ...
                if (z && hitTestResult2.isHitInMinimumTouchTargetBetter(distanceFromEdge, false)) {
                    m6628hitNearJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, false, distanceFromEdge);
                }
            }
        } else if (head == null) {
            m6643hitTestChildYqVAtuI(hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        } else if (m6644isPointerInBoundsk4lQ0M(j)) {
            m6627hit1hIXUjU(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        } else {
            if (!isTouchEvent) {
                f = Float.POSITIVE_INFINITY;
            } else {
                f = m6635distanceInMinimumTouchTargettz77jQw(j, m6638getMinimumTouchTargetSizeNHjbRc());
            }
            ...
            if (!z || !hitTestResult2.isHitInMinimumTouchTargetBetter(distanceFromEdge2, isInLayer)) {
                m6631speculativeHitJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge2);
            } else {
                m6628hitNearJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge2);
            }
        }
    }
    ...
    public final void m6627hit1hIXUjU(Modifier.Node $this$hit_u2d1hIXUjU, HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
    ...
    public final void m6628hitNearJHbHoSQ(Modifier.Node $this$hitNear_u2dJHbHoSQ, HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer, float distanceFromEdge) {
    ...
    public final void m6631speculativeHitJHbHoSQ(Modifier.Node $this$speculativeHit_u2dJHbHoSQ, HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer, float distanceFromEdge) {
        ...
        if (node == null) {
            ...
            m6631speculativeHitJHbHoSQ(NodeCoordinatorKt.m6664nextUntilhw7D004(node, hitTestSource.m6662entityTypeOLwlOKw(), NodeKind.m6666constructorimpl(2)), hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
        }
    }

    /* renamed from: hitTestChild-YqVAtuI  reason: not valid java name */
    public void m6643hitTestChildYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitTestSource, "hitTestSource");
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        NodeCoordinator wrapped2 = this.wrapped;
        if (wrapped2 != null) {
            wrapped2.m6642hitTestYqVAtuI(hitTestSource, wrapped2.m6636fromParentPositionMKHz9U(pointerPosition), hitTestResult, isTouchEvent, isInLayer);
        } else {
            long j = pointerPosition;
        }
    }
    ...
    public final Rect touchBoundsInRoot() {
        ...
        long padding = m6634calculateMinimumTouchTargetPaddingE7KxVPU(m6638getMinimumTouchTargetSizeNHjbRc());
        bounds.setLeft(-Size.m4782getWidthimpl(padding));
        bounds.setTop(-Size.m4779getHeightimpl(padding));
        bounds.setRight(((float) getMeasuredWidth()) + Size.m4782getWidthimpl(padding));
        bounds.setBottom(((float) getMeasuredHeight()) + Size.m4779getHeightimpl(padding));
    ...
    public long m6655windowToLocalMKHz9U(long relativeToWindow) {
        if (isAttached()) {
            LayoutCoordinates root = LayoutCoordinatesKt.findRootCoordinates(this);
            return m6645localPositionOfR5De75A(root, Offset.m4717minusMKHz9U(LayoutNodeKt.requireOwner(getLayoutNode()).m6721calculateLocalPositionMKHz9U(relativeToWindow), LayoutCoordinatesKt.positionInRoot(root)));
        }
        throw new IllegalStateException(ExpectAttachedLayoutCoordinates.toString());
    }

    /* renamed from: localToWindow-MK-Hz9U  reason: not valid java name */
    public long m6647localToWindowMKHz9U(long relativeToLocal) {
        return LayoutNodeKt.requireOwner(getLayoutNode()).m6722calculatePositionInWindowMKHz9U(m6646localToRootMKHz9U(relativeToLocal));
    }
    ...
    public long m6645localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
        if (sourceCoordinates instanceof LookaheadLayoutCoordinatesImpl) {
            return Offset.m4722unaryMinusF1C5BW0(sourceCoordinates.m6361localPositionOfR5De75A(this, Offset.m4722unaryMinusF1C5BW0(relativeToSource)));
        }
        ...
        while (coordinator != commonAncestor) {
            position2 = coordinator.m6652toParentPositionMKHz9U(position2);
            NodeCoordinator nodeCoordinator2 = coordinator.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator2);
            coordinator = nodeCoordinator2;
        }
        return m6625ancestorToLocalR5De75A(commonAncestor, position2);
    }

    /* renamed from: transformFrom-EL8BTi8  reason: not valid java name */
    public void m6653transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
        ...
        Matrix.m5201resetimpl(matrix);
        coordinator.m6633transformToAncestorEL8BTi8(commonAncestor, matrix);
        m6632transformFromAncestorEL8BTi8(commonAncestor, matrix);
    }

    /* renamed from: transformToAncestor-EL8BTi8  reason: not valid java name */
    private final void m6633transformToAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        NodeCoordinator wrapper = this;
        while (!Intrinsics.areEqual((Object) wrapper, (Object) ancestor)) {
            OwnedLayer ownedLayer = wrapper.layer;
            if (ownedLayer != null) {
                ownedLayer.m6719transform58bKbWc(matrix);
            }
            long position2 = wrapper.m6639getPositionnOccac();
            if (!IntOffset.m7671equalsimpl0(position2, IntOffset.Companion.m7682getZeronOccac())) {
                float[] fArr = tmpMatrix;
                Matrix.m5201resetimpl(fArr);
                Matrix.m5212translateimpl$default(fArr, (float) IntOffset.m7672getXimpl(position2), (float) IntOffset.m7673getYimpl(position2), 0.0f, 4, (Object) null);
                Matrix.m5209timesAssign58bKbWc(matrix, fArr);
            }
    ...
    private final void m6632transformFromAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        if (!Intrinsics.areEqual((Object) ancestor, (Object) this)) {
            NodeCoordinator nodeCoordinator = this.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator);
            nodeCoordinator.m6632transformFromAncestorEL8BTi8(ancestor, matrix);
            if (!IntOffset.m7671equalsimpl0(m6639getPositionnOccac(), IntOffset.Companion.m7682getZeronOccac())) {
                float[] fArr = tmpMatrix;
                Matrix.m5201resetimpl(fArr);
                Matrix.m5212translateimpl$default(fArr, -((float) IntOffset.m7672getXimpl(m6639getPositionnOccac())), -((float) IntOffset.m7673getYimpl(m6639getPositionnOccac())), 0.0f, 4, (Object) null);
                Matrix.m5209timesAssign58bKbWc(matrix, fArr);
            }
            OwnedLayer ownedLayer = this.layer;
            if (ownedLayer != null) {
                ownedLayer.m6714inverseTransform58bKbWc(matrix);
            }
        }
    }
    ...
    public Rect localBoundingBoxOf(LayoutCoordinates sourceCoordinates, boolean clipBounds) {
        ...
        if (!isAttached()) {
            ...
            bounds.setLeft(0.0f);
            bounds.setTop(0.0f);
            bounds.setRight((float) IntSize.m7714getWidthimpl(sourceCoordinates.m6360getSizeYbymL2g()));
            bounds.setBottom((float) IntSize.m7713getHeightimpl(sourceCoordinates.m6360getSizeYbymL2g()));
    ...
    private final long m6625ancestorToLocalR5De75A(NodeCoordinator ancestor, long offset) {
        if (ancestor == this) {
            return offset;
        }
        NodeCoordinator wrappedBy2 = this.wrappedBy;
        if (wrappedBy2 == null || Intrinsics.areEqual((Object) ancestor, (Object) wrappedBy2)) {
            return m6636fromParentPositionMKHz9U(offset);
        }
        return m6636fromParentPositionMKHz9U(wrappedBy2.m6625ancestorToLocalR5De75A(ancestor, offset));
    }
    ...
    public long m6646localToRootMKHz9U(long relativeToLocal) {
        if (isAttached()) {
            onCoordinatesUsed$ui_release();
    ...
    public long m6652toParentPositionMKHz9U(long position2) {
        OwnedLayer layer2 = this.layer;
        return IntOffsetKt.m7686plusNvtHpc(layer2 != null ? layer2.m6716mapOffset8S9VItk(position2, false) : position2, m6639getPositionnOccac());
    }

    /* renamed from: fromParentPosition-MK-Hz9U  reason: not valid java name */
    public long m6636fromParentPositionMKHz9U(long position2) {
        long relativeToPosition = IntOffsetKt.m7684minusNvtHpc(position2, m6639getPositionnOccac());
        OwnedLayer layer2 = this.layer;
        if (layer2 != null) {
            return layer2.m6716mapOffset8S9VItk(relativeToPosition, true);
        }
    ...
    public final void drawBorder(Canvas canvas, Paint paint) {
        ...
        canvas.drawRect(new Rect(0.5f, 0.5f, ((float) IntSize.m7714getWidthimpl(m6434getMeasuredSizeYbymL2g())) - 0.5f, ((float) IntSize.m7713getHeightimpl(m6434getMeasuredSizeYbymL2g())) - 0.5f), paint);
    }
    ...
    public final void rectInParent$ui_release(MutableRect bounds, boolean clipBounds, boolean clipToMinimumTouchTargetSize) {
        ...
        if (layer2 != null) {
            if (this.isClipping) {
                if (clipToMinimumTouchTargetSize) {
                    long minTouch = m6638getMinimumTouchTargetSizeNHjbRc();
                    float horz = Size.m4782getWidthimpl(minTouch) / 2.0f;
                    float vert = Size.m4779getHeightimpl(minTouch) / 2.0f;
                    bounds.intersect(-horz, -vert, ((float) IntSize.m7714getWidthimpl(m6640getSizeYbymL2g())) + horz, ((float) IntSize.m7713getHeightimpl(m6640getSizeYbymL2g())) + vert);
                } else if (clipBounds) {
                    bounds.intersect(0.0f, 0.0f, (float) IntSize.m7714getWidthimpl(m6640getSizeYbymL2g()), (float) IntSize.m7713getHeightimpl(m6640getSizeYbymL2g()));
                }
                if (bounds.isEmpty()) {
                    return;
                }
        ...
        int x = IntOffset.m7672getXimpl(m6639getPositionnOccac());
        bounds.setLeft(bounds.getLeft() + ((float) x));
        bounds.setRight(bounds.getRight() + ((float) x));
        int y = IntOffset.m7673getYimpl(m6639getPositionnOccac());
    ...
    public final boolean m6656withinLayerBoundsk4lQ0M(long pointerPosition) {
        if (!OffsetKt.m4730isFinitek4lQ0M(pointerPosition)) {
            return false;
        }
        OwnedLayer layer2 = this.layer;
        if (layer2 == null || !this.isClipping || layer2.m6715isInLayerk4lQ0M(pointerPosition)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean m6644isPointerInBoundsk4lQ0M(long pointerPosition) {
        float x = Offset.m4713getXimpl(pointerPosition);
        float y = Offset.m4714getYimpl(pointerPosition);
    ...
    static /* synthetic */ Object propagateRelocationRequest$suspendImpl(NodeCoordinator $this, Rect rect, Continuation<? super Unit> $completion) {
        ...
        Object propagateRelocationRequest = parent.propagateRelocationRequest(rect.m4750translatek4lQ0M(parent.localBoundingBoxOf($this, false).m4748getTopLeftF1C5BW0()), $completion);
    ...
    public final NodeCoordinator findCommonAncestor$ui_release(NodeCoordinator other) {
        ...
        if (ancestor1 == ancestor2) {
            ...
            int mask$iv = NodeKind.m6666constructorimpl(2);
    ...
    public final boolean shouldSharePointerInputWithSiblings() {
        ...
        int count$iv$iv;
        MutableVector mutableVector;
        Modifier.Node start2 = headNode(NodeKindKt.m6675getIncludeSelfInTraversalH91voCI(NodeKind.m6666constructorimpl(16)));
        if (start2 == null) {
            return false;
        }
        int type$iv4 = NodeKind.m6666constructorimpl(16);
    ...
    private final long m6629offsetFromEdgeMKHz9U(long pointerPosition) {
        float x = Offset.m4713getXimpl(pointerPosition);
    ...
    public final long m6634calculateMinimumTouchTargetPaddingE7KxVPU(long minimumTouchTargetSize) {
        return SizeKt.Size(Math.max(0.0f, (Size.m4782getWidthimpl(minimumTouchTargetSize) - ((float) getMeasuredWidth())) / 2.0f), Math.max(0.0f, (Size.m4779getHeightimpl(minimumTouchTargetSize) - ((float) getMeasuredHeight())) / 2.0f));
    }

    /* access modifiers changed from: protected */
    /* renamed from: distanceInMinimumTouchTarget-tz77jQw  reason: not valid java name */
    public final float m6635distanceInMinimumTouchTargettz77jQw(long pointerPosition, long minimumTouchTargetSize) {
        if (((float) getMeasuredWidth()) >= Size.m4782getWidthimpl(minimumTouchTargetSize) && ((float) getMeasuredHeight()) >= Size.m4779getHeightimpl(minimumTouchTargetSize)) {
            return Float.POSITIVE_INFINITY;
        }
        long r2 = m6634calculateMinimumTouchTargetPaddingE7KxVPU(minimumTouchTargetSize);
        float width = Size.m4782getWidthimpl(r2);
        float height = Size.m4779getHeightimpl(r2);
        long offsetFromEdge = m6629offsetFromEdgeMKHz9U(pointerPosition);
        if ((width > 0.0f || height > 0.0f) && Offset.m4713getXimpl(offsetFromEdge) <= width && Offset.m4714getYimpl(offsetFromEdge) <= height) {
            return Offset.m4712getDistanceSquaredimpl(offsetFromEdge);
        }
        return Float.POSITIVE_INFINITY;
    }
