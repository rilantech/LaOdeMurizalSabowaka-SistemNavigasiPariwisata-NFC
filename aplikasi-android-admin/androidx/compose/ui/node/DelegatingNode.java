...
public abstract class DelegatingNode extends Modifier.Node {
    ...
    public final <T extends DelegatableNode> T delegate(T delegatableNode) {
        ...
        if (delegateNode != delegatableNode) {
            ...
            if (isAttached()) {
                if (((delegatedKindSet & NodeKind.m6666constructorimpl(2)) != 0 ? 1 : 0) != 0) {
                    if ((beforeKindSet & NodeKind.m6666constructorimpl(2)) == 0) {
                        isDelegatedToThisNode = false;
                    }
                    if (!isDelegatedToThisNode) {
    ...
    public final void undelegate(DelegatableNode instance) {
        ...
        if (found) {
            ...
            if (isAttached()) {
                if (((beforeKindSet & NodeKind.m6666constructorimpl(2)) != 0 ? 1 : 0) != 0) {
                    if ((afterKindSet & NodeKind.m6666constructorimpl(2)) != 0) {
                        z = true;
                    }
                    if (!z) {
                        NodeChain chain = DelegatableNodeKt.requireLayoutNode(this).getNodes$ui_release();
    ...
    private final void validateDelegateKindSet(int delegateKindSet, Modifier.Node delegateNode) {
        ...
        boolean z = true;
        if (((delegateKindSet & NodeKind.m6666constructorimpl(2)) != 0 ? 1 : 0) != 0) {
            if ((current & NodeKind.m6666constructorimpl(2)) == 0) {
                z = false;
            }
