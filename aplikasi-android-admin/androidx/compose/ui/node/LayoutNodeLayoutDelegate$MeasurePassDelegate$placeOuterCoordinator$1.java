...
final class LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinator$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        ...
        float f = this.$zIndex;
        if (function1 == null) {
            $this$invoke_u24lambda_u240.m6443place70tqf50(layoutNodeLayoutDelegate.getOuterCoordinator(), j, f);
            return;
        }
        $this$invoke_u24lambda_u240.m6448placeWithLayeraW9wM(layoutNodeLayoutDelegate.getOuterCoordinator(), j, f, function1);
    }
}
