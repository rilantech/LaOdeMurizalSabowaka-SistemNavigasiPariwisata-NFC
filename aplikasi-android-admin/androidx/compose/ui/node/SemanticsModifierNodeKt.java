...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node $this$touchBoundsInRoot, boolean useMinimumTouchTarget) {
        ...
        if (!$this$touchBoundsInRoot.getNode().isAttached()) {
            return Rect.Companion.getZero();
        }
        if (!useMinimumTouchTarget) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m6502requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m6666constructorimpl(8)));
        }
        return DelegatableNodeKt.m6502requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m6666constructorimpl(8)).touchBoundsInRoot();
    }
}
