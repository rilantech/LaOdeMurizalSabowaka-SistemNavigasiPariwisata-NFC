    ...
    public static final int calculateAlignmentAndPlaceChildAsNeeded(LookaheadCapablePlaceable $this$calculateAlignmentAndPlaceChildAsNeeded, AlignmentLine alignmentLine) {
        ...
        if (!(child != null)) {
            ...
            if (alignmentLine instanceof HorizontalAlignmentLine) {
                return IntOffset.m7673getYimpl(child.m6600getPositionnOccac()) + positionInWrapped;
            }
            return IntOffset.m7672getXimpl(child.m6600getPositionnOccac()) + positionInWrapped;
        }
    }
}
