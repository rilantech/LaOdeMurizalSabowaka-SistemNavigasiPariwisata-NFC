...
public final class LayoutNodeLayoutDelegate {
    ...
    public final Constraints m6587getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m6595getLastConstraintsDWUhwKw();
    }

    /* renamed from: getLastLookaheadConstraints-DWUhwKw  reason: not valid java name */
    public final Constraints m6588getLastLookaheadConstraintsDWUhwKw() {
        LookaheadPassDelegate lookaheadPassDelegate2 = this.lookaheadPassDelegate;
        if (lookaheadPassDelegate2 != null) {
            return lookaheadPassDelegate2.m6589getLastConstraintsDWUhwKw();
        }
        return null;
    }
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        private long lastPosition = IntOffset.Companion.m7682getZeronOccac();
        ...
        /* renamed from: getLastConstraints-DWUhwKw  reason: not valid java name */
        public final Constraints m6595getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m7486boximpl(m6435getMeasurementConstraintsmsEJaDk());
            }
            return null;
        }
        ...
        public Placeable m6596measureBRTryo0(long constraints) {
            ...
            if (layoutNodeLayoutDelegate.isOutMostLookaheadRoot(layoutNodeLayoutDelegate.layoutNode)) {
                ...
                $this$measure_BRTryo0_u24lambda_u2412.m6591measureBRTryo0(constraints);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m6598remeasureBRTryo0(constraints);
            return this;
        }

        /* renamed from: remeasure-BRTryo0  reason: not valid java name */
        public final boolean m6598remeasureBRTryo0(long constraints) {
            ...
            if (LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() || !Constraints.m7491equalsimpl0(m6435getMeasurementConstraintsmsEJaDk(), constraints)) {
                getAlignmentLines().setUsedByModifierMeasurement$ui_release(false);
                forEachChildAlignmentLinesOwner(LayoutNodeLayoutDelegate$MeasurePassDelegate$remeasure$1.INSTANCE);
                this.measuredOnce = true;
                long outerPreviousMeasuredSize = LayoutNodeLayoutDelegate.this.getOuterCoordinator().m6640getSizeYbymL2g();
                m6438setMeasurementConstraintsBRTryo0(constraints);
                LayoutNodeLayoutDelegate.this.m6586performMeasureBRTryo0(constraints);
                if (IntSize.m7712equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().m6640getSizeYbymL2g(), outerPreviousMeasuredSize) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                    sizeChanged = false;
                }
                m6437setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
                return sizeChanged;
            }
        ...
        public void m6597placeAtf8xVGno(long position, float zIndex2, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            if (!IntOffset.m7671equalsimpl0(position, this.lastPosition)) {
            ...
            if (layoutNodeLayoutDelegate.isOutMostLookaheadRoot(layoutNodeLayoutDelegate.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default($this$placeAt_f8xVGno_u24lambda_u2416, it, IntOffset.m7672getXimpl(position), IntOffset.m7673getYimpl(position), 0.0f, 4, (Object) null);
            }
            m6594placeOuterCoordinatorf8xVGno(position, zIndex2, layerBlock);
        }

        /* renamed from: placeOuterCoordinator-f8xVGno  reason: not valid java name */
        private final void m6594placeOuterCoordinatorf8xVGno(long position, float zIndex2, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LayingOut;
            ...
            if (LayoutNodeLayoutDelegate.this.getLayoutPending$ui_release() || !isPlaced()) {
                ...
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().m6650placeSelfApparentToRealOffsetf8xVGno(position, zIndex2, layerBlock);
        ...
        public final void replace() {
            try {
                ...
                if (this.placedOnce) {
                    m6594placeOuterCoordinatorf8xVGno(this.lastPosition, this.lastZIndex, this.lastLayerBlock);
        ...
        private final void onBeforeLayoutChildren() {
            ...
            if (size$iv$iv > 0) {
                ...
                do {
                    ...
                    if (it.getMeasurePending$ui_release() && it.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m6539remeasure_Sx5XlM$ui_release$default(it, (Constraints) null, 1, (Object) null)) {
        ...
        public final void measureBasedOnLookahead() {
            ...
            if (lookaheadDelegate == null) {
                ...
                Constraints r2 = lookaheadDelegate.m6589getLastConstraintsDWUhwKw();
                Intrinsics.checkNotNull(r2);
                m6596measureBRTryo0(r2.m7504unboximpl());
                ...
                Constraints r22 = lookaheadDelegate.m6589getLastConstraintsDWUhwKw();
                Intrinsics.checkNotNull(r22);
                m6596measureBRTryo0(r22.m7504unboximpl());
            }
        }
        ...
        public final void placeBasedOnLookahead() {
            LookaheadPassDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getLookaheadPassDelegate$ui_release();
            if (lookaheadDelegate != null) {
                m6597placeAtf8xVGno(lookaheadDelegate.m6590getLastPositionnOccac$ui_release(), lookaheadDelegate.getLastZIndex$ui_release(), lookaheadDelegate.getLastLayerBlock$ui_release());
                return;
            }
            throw new IllegalArgumentException("Required value was null.".toString());
        }
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        /* renamed from: getLastConstraints-DWUhwKw  reason: not valid java name */
        public final Constraints m6589getLastConstraintsDWUhwKw() {
            return this.lookaheadConstraints;
        }

        /* renamed from: getLastPosition-nOcc-ac$ui_release  reason: not valid java name */
        public final long m6590getLastPositionnOccac$ui_release() {
        ...
        /* renamed from: measure-BRTryo0  reason: not valid java name */
        public Placeable m6591measureBRTryo0(long constraints) {
            trackLookaheadMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIntrinsicsUsageByParent$ui_release() == LayoutNode.UsageByParent.NotUsed) {
                LayoutNodeLayoutDelegate.this.layoutNode.clearSubtreeIntrinsicsUsage$ui_release();
            }
            m6593remeasureBRTryo0(constraints);
            return this;
        }
        ...
        /* renamed from: remeasure-BRTryo0  reason: not valid java name */
        public final boolean m6593remeasureBRTryo0(long constraints) {
            LayoutNode parent = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release();
            boolean sizeChanged = true;
            LayoutNodeLayoutDelegate.this.layoutNode.setCanMultiMeasure$ui_release(LayoutNodeLayoutDelegate.this.layoutNode.getCanMultiMeasure$ui_release() || (parent != null && parent.getCanMultiMeasure$ui_release()));
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getLookaheadMeasurePending$ui_release()) {
                ...
                if (constraints2 == null ? false : Constraints.m7491equalsimpl0(constraints2.m7504unboximpl(), constraints)) {
            ...
            this.lookaheadConstraints = Constraints.m7486boximpl(constraints);
            getAlignmentLines().setUsedByModifierMeasurement$ui_release(false);
            ...
            if (lookaheadDelegate != null) {
                ...
                LayoutNodeLayoutDelegate.this.m6585performLookaheadMeasureBRTryo0(constraints);
                m6437setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
                if (IntSize.m7714getWidthimpl(lastLookaheadSize) == lookaheadDelegate.getWidth() && IntSize.m7713getHeightimpl(lastLookaheadSize) == lookaheadDelegate.getHeight()) {
                    sizeChanged = false;
                }
                return sizeChanged;
            }
        ...
        /* access modifiers changed from: protected */
        /* renamed from: placeAt-f8xVGno  reason: not valid java name */
        public void m6592placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LookaheadLayingOut;
            this.placedOnce = true;
            if (!IntOffset.m7671equalsimpl0(position, this.lastPosition)) {
                if (LayoutNodeLayoutDelegate.this.getCoordinatesAccessedDuringModifierPlacement() || LayoutNodeLayoutDelegate.this.getCoordinatesAccessedDuringPlacement()) {
            ...
            if (size$iv$iv > 0) {
                ...
                do {
                    ...
                    if (it.getLookaheadMeasurePending$ui_release() && it.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                        ...
                        Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
                        Constraints r11 = m6589getLastConstraintsDWUhwKw();
                        Intrinsics.checkNotNull(r11);
                        if (lookaheadPassDelegate$ui_release.m6593remeasureBRTryo0(r11.m7504unboximpl())) {
        ...
        public final void replace() {
            try {
                this.relayoutWithoutParentInProgress = true;
                if (this.placedOnce) {
                    m6592placeAtf8xVGno(this.lastPosition, 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
                    this.relayoutWithoutParentInProgress = false;
                    return;
                }
                throw new IllegalStateException("Check failed.".toString());
    ...
    public final void m6586performMeasureBRTryo0(long constraints) {
    ...
    public final void m6585performLookaheadMeasureBRTryo0(long constraints) {
