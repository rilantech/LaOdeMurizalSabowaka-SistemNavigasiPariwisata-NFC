...
final class NodeCoordinator$speculativeHit$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        this.this$0.m6631speculativeHitJHbHoSQ(NodeCoordinatorKt.m6664nextUntilhw7D004(this.$this_speculativeHit, this.$hitTestSource.m6662entityTypeOLwlOKw(), NodeKind.m6666constructorimpl(2)), this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}
