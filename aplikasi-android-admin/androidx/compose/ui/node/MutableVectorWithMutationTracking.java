...
public final class MutableVectorWithMutationTracking<T> {
    ...
    public MutableVectorWithMutationTracking(MutableVector<T> vector2, Function0<Unit> onVectorMutated2) {
        Intrinsics.checkNotNullParameter(vector2, "vector");
        Intrinsics.checkNotNullParameter(onVectorMutated2, "onVectorMutated");
        this.vector = vector2;
        this.onVectorMutated = onVectorMutated2;
    }
