...
public final class NodeKindKt {
    ...
    public static final int m6676or64DMado(int $this$or_u2d64DMado, int other) {
        return $this$or_u2d64DMado | other;
    }

    /* renamed from: contains-64DMado  reason: not valid java name */
    public static final boolean m6674contains64DMado(int $this$contains_u2d64DMado, int value) {
        return ($this$contains_u2d64DMado & value) != 0;
    }

    /* renamed from: getIncludeSelfInTraversal-H91voCI  reason: not valid java name */
    public static final boolean m6675getIncludeSelfInTraversalH91voCI(int $this$includeSelfInTraversal) {
        return (NodeKind.m6666constructorimpl(128) & $this$includeSelfInTraversal) != 0;
    }

    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        Intrinsics.checkNotNullParameter(element, "element");
        int mask = NodeKind.m6666constructorimpl(1);
        if (element instanceof LayoutModifier) {
            mask = NodeKind.m6666constructorimpl(2) | mask;
        }
        if (element instanceof DrawModifier) {
            mask = NodeKind.m6666constructorimpl(4) | mask;
        }
        if (element instanceof SemanticsModifier) {
            mask = NodeKind.m6666constructorimpl(8) | mask;
        }
        if (element instanceof PointerInputModifier) {
            mask = NodeKind.m6666constructorimpl(16) | mask;
        }
        if ((element instanceof ModifierLocalConsumer) || (element instanceof ModifierLocalProvider)) {
            mask = NodeKind.m6666constructorimpl(32) | mask;
        }
        if (element instanceof FocusEventModifier) {
            mask = NodeKind.m6666constructorimpl(4096) | mask;
        }
        if (element instanceof FocusOrderModifier) {
            mask = NodeKind.m6666constructorimpl(2048) | mask;
        }
        if (element instanceof OnGloballyPositionedModifier) {
            mask = NodeKind.m6666constructorimpl(256) | mask;
        }
        if (element instanceof ParentDataModifier) {
            mask = NodeKind.m6666constructorimpl(64) | mask;
        }
        if ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) {
            return NodeKind.m6666constructorimpl(128) | mask;
        }
        return mask;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        if (node instanceof LayoutAwareModifierNode) {
            mask = NodeKind.m6666constructorimpl(128) | mask;
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            mask = NodeKind.m6666constructorimpl(256) | mask;
        }
        if (node instanceof IntermediateLayoutModifierNode) {
            mask = NodeKind.m6666constructorimpl(512) | mask;
        }
        if (node instanceof FocusTargetNode) {
            mask = NodeKind.m6666constructorimpl(1024) | mask;
        }
        ...
        if (node instanceof KeyInputModifierNode) {
            mask = NodeKind.m6666constructorimpl(8192) | mask;
        }
        if (node instanceof RotaryInputModifierNode) {
            mask = NodeKind.m6666constructorimpl(16384) | mask;
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            mask = NodeKind.m6666constructorimpl(32768) | mask;
        }
        if (node instanceof SoftKeyboardInterceptionModifierNode) {
            return NodeKind.m6666constructorimpl(131072) | mask;
        }
        return mask;
    }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int selfKindSet, int phase) {
        if (phase != 0 || node.getShouldAutoInvalidate()) {
            boolean z = true;
            if (((selfKindSet & NodeKind.m6666constructorimpl(2)) != 0 ? 1 : 0) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (phase == 2) {
                    DelegatableNodeKt.m6502requireCoordinator64DMado(node, NodeKind.m6666constructorimpl(2)).onRelease();
                }
            }
            if (((selfKindSet & NodeKind.m6666constructorimpl(256)) != 0 ? 1 : 0) != 0 && (node instanceof GlobalPositionAwareModifierNode)) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if (((selfKindSet & NodeKind.m6666constructorimpl(4)) != 0 ? 1 : 0) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if (((selfKindSet & NodeKind.m6666constructorimpl(8)) != 0 ? 1 : 0) != 0 && (node instanceof SemanticsModifierNode)) {
                SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
            }
            if (((selfKindSet & NodeKind.m6666constructorimpl(64)) != 0 ? 1 : 0) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if (((selfKindSet & NodeKind.m6666constructorimpl(1024)) != 0 ? 1 : 0) != 0 && (node instanceof FocusTargetNode)) {
                if (phase == 2) {
                    node.onReset();
                } else {
            ...
            if (((selfKindSet & NodeKind.m6666constructorimpl(2048)) != 0 ? 1 : 0) != 0 && (node instanceof FocusPropertiesModifierNode) && specifiesCanFocusProperty((FocusPropertiesModifierNode) node)) {
                if (phase == 2) {
            ...
            if ((selfKindSet & NodeKind.m6666constructorimpl(4096)) == 0) {
                z = false;
            }
