...
public final class Shadow {
    ...
    public static /* synthetic */ void m5317getColor0d7_KjU$annotations() {
    }

    /* renamed from: getOffset-F1C5BW0$annotations  reason: not valid java name */
    public static /* synthetic */ void m5318getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long r8, long r10, float r12, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        L_0x0010:
            ...
            long r10 = r8.m4729getZeroF1C5BW0()
            r3 = r10
            goto L_0x001d
        L_0x001c:
            r3 = r10
    ...
    public final long m5320getColor0d7_KjU() {
        return this.color;
    }

    /* renamed from: getOffset-F1C5BW0  reason: not valid java name */
    public final long m5321getOffsetF1C5BW0() {
        return this.offset;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Shadow) || !Color.m4964equalsimpl0(this.color, ((Shadow) other).color) || !Offset.m4710equalsimpl0(this.offset, ((Shadow) other).offset)) {
            return false;
        }
    ...
    public int hashCode() {
        return (((Color.m4970hashCodeimpl(this.color) * 31) + Offset.m4715hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + Color.m4971toStringimpl(this.color) + ", offset=" + Offset.m4721toStringimpl(this.offset) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* renamed from: copy-qcb84PM$default  reason: not valid java name */
    public static /* synthetic */ Shadow m5316copyqcb84PM$default(Shadow shadow, long j, long j2, float f, int i, Object obj) {
        long j3;
        long j4;
        float f2;
        if ((i & 1) != 0) {
        ...
        return shadow.m5319copyqcb84PM(j3, j4, f2);
    }

    /* renamed from: copy-qcb84PM  reason: not valid java name */
    public final Shadow m5319copyqcb84PM(long color2, long offset2, float blurRadius2) {
