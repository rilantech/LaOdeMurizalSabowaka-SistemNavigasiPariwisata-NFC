...
public final class AndroidPathEffect_androidKt {
    ...
    public static final PathEffect m4850actualStampedPathEffect7aD1DOk(Path shape, float advance, float phase, int style) {
        Intrinsics.checkNotNullParameter(shape, "shape");
        Path $this$asAndroidPath$iv = shape;
        if ($this$asAndroidPath$iv instanceof AndroidPath) {
            return new AndroidPathEffect(new PathDashPathEffect(((AndroidPath) $this$asAndroidPath$iv).getInternalPath(), advance, phase, m4851toAndroidPathDashPathEffectStyleoQv6xUo(style)));
        }
        throw new UnsupportedOperationException("Unable to obtain android.graphics.Path");
    }

    /* renamed from: toAndroidPathDashPathEffectStyle-oQv6xUo  reason: not valid java name */
    public static final PathDashPathEffect.Style m4851toAndroidPathDashPathEffectStyleoQv6xUo(int $this$toAndroidPathDashPathEffectStyle_u2doQv6xUo) {
        if (StampedPathEffectStyle.m5337equalsimpl0($this$toAndroidPathDashPathEffectStyle_u2doQv6xUo, StampedPathEffectStyle.Companion.m5341getMorphYpspkwk())) {
            return PathDashPathEffect.Style.MORPH;
        }
        if (StampedPathEffectStyle.m5337equalsimpl0($this$toAndroidPathDashPathEffectStyle_u2doQv6xUo, StampedPathEffectStyle.Companion.m5342getRotateYpspkwk())) {
            return PathDashPathEffect.Style.ROTATE;
        }
        if (StampedPathEffectStyle.m5337equalsimpl0($this$toAndroidPathDashPathEffectStyle_u2doQv6xUo, StampedPathEffectStyle.Companion.m5343getTranslateYpspkwk())) {
