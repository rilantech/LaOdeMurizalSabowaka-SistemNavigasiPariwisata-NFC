...
public final class PaintingStyle {
    ...
    public static final int Fill = m5234constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Stroke = m5234constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m5233boximpl(int i) {
        return new PaintingStyle(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m5234constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m5235equalsimpl(int i, Object obj) {
        return (obj instanceof PaintingStyle) && i == ((PaintingStyle) obj).m5239unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m5236equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m5237hashCodeimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m5240getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo  reason: not valid java name */
        public final int m5241getStrokeTiuSbCo() {
            return PaintingStyle.Stroke;
        }
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m5238toStringimpl(int arg0) {
        if (m5236equalsimpl0(arg0, Fill)) {
            return "Fill";
        }
        if (m5236equalsimpl0(arg0, Stroke)) {
            return "Stroke";
        }
        return "Unknown";
    }
