...
public final class BitmapPainter extends Painter {
    ...
    private BitmapPainter(ImageBitmap image2, long srcOffset2, long srcSize2) {
        ...
        this.filterQuality = FilterQuality.Companion.m5060getLowfv9h1I();
        this.size = m5660validateSizeN5eqBDc(srcOffset2, srcSize2);
        this.alpha = 1.0f;
    }

    /* renamed from: getFilterQuality-f-v9h1I$ui_graphics_release  reason: not valid java name */
    public final int m5661getFilterQualityfv9h1I$ui_graphics_release() {
        return this.filterQuality;
    }

    /* renamed from: setFilterQuality-vDHp3xo$ui_graphics_release  reason: not valid java name */
    public final void m5663setFilterQualityvDHp3xo$ui_graphics_release(int i) {
    ...
    public void onDraw(DrawScope $this$onDraw) {
        ...
        DrawScope.m5541drawImageAZ2fEMs$default($this$onDraw, this.image, this.srcOffset, this.srcSize, 0, IntSizeKt.IntSize(MathKt.roundToInt(Size.m4782getWidthimpl($this$onDraw.m5576getSizeNHjbRc())), MathKt.roundToInt(Size.m4779getHeightimpl($this$onDraw.m5576getSizeNHjbRc()))), this.alpha, (DrawStyle) null, this.colorFilter, 0, this.filterQuality, 328, (Object) null);
    }

    /* renamed from: getIntrinsicSize-NH-jbRc  reason: not valid java name */
    public long m5662getIntrinsicSizeNHjbRc() {
        return IntSizeKt.m7724toSizeozmzZPI(this.size);
    }
    ...
    private final long m5660validateSizeN5eqBDc(long srcOffset2, long srcSize2) {
        if (IntOffset.m7672getXimpl(srcOffset2) >= 0 && IntOffset.m7673getYimpl(srcOffset2) >= 0 && IntSize.m7714getWidthimpl(srcSize2) >= 0 && IntSize.m7713getHeightimpl(srcSize2) >= 0 && IntSize.m7714getWidthimpl(srcSize2) <= this.image.getWidth() && IntSize.m7713getHeightimpl(srcSize2) <= this.image.getHeight()) {
            return srcSize2;
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BitmapPainter) && Intrinsics.areEqual((Object) this.image, (Object) ((BitmapPainter) other).image) && IntOffset.m7671equalsimpl0(this.srcOffset, ((BitmapPainter) other).srcOffset) && IntSize.m7712equalsimpl0(this.srcSize, ((BitmapPainter) other).srcSize) && FilterQuality.m5055equalsimpl0(this.filterQuality, ((BitmapPainter) other).filterQuality)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((this.image.hashCode() * 31) + IntOffset.m7674hashCodeimpl(this.srcOffset)) * 31) + IntSize.m7715hashCodeimpl(this.srcSize)) * 31) + FilterQuality.m5056hashCodeimpl(this.filterQuality);
    }

    public String toString() {
        return "BitmapPainter(image=" + this.image + ", srcOffset=" + IntOffset.m7679toStringimpl(this.srcOffset) + ", srcSize=" + IntSize.m7717toStringimpl(this.srcSize) + ", filterQuality=" + FilterQuality.m5057toStringimpl(this.filterQuality) + ')';
    }
}
