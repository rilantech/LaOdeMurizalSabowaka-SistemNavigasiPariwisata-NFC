...
public final class ColorPainter extends Painter {
    ...
    public final long m5667getColor0d7_KjU() {
        return this.color;
    }
    ...
    public void onDraw(DrawScope $this$onDraw) {
        ...
        DrawScope.m5552drawRectnJ9OG0$default($this$onDraw, this.color, 0, 0, this.alpha, (DrawStyle) null, this.colorFilter, 0, 86, (Object) null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ColorPainter) && Color.m4964equalsimpl0(this.color, ((ColorPainter) other).color)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Color.m4970hashCodeimpl(this.color);
    }

    public String toString() {
        return "ColorPainter(color=" + Color.m4971toStringimpl(this.color) + ')';
    }

    /* renamed from: getIntrinsicSize-NH-jbRc  reason: not valid java name */
    public long m5668getIntrinsicSizeNHjbRc() {
