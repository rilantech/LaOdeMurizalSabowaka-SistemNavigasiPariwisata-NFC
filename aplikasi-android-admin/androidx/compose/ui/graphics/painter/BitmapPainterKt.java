...
public final class BitmapPainterKt {
    ...
    public static /* synthetic */ BitmapPainter m5665BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j, long j2, int i, int i2, Object obj) {
        long j3;
        long j4;
        int i3;
        if ((i2 & 2) != 0) {
            j3 = IntOffset.Companion.m7682getZeronOccac();
        } else {
            j3 = j;
        }
        if ((i2 & 4) != 0) {
        ...
        if ((i2 & 8) != 0) {
            i3 = FilterQuality.Companion.m5060getLowfv9h1I();
        } else {
            i3 = i;
        }
        return m5664BitmapPainterQZhYCtY(imageBitmap, j3, j4, i3);
    }

    /* renamed from: BitmapPainter-QZhYCtY  reason: not valid java name */
    public static final BitmapPainter m5664BitmapPainterQZhYCtY(ImageBitmap image, long srcOffset, long srcSize, int filterQuality) {
        ...
        $this$BitmapPainter_QZhYCtY_u24lambda_u240.m5663setFilterQualityvDHp3xo$ui_graphics_release(filterQuality);
