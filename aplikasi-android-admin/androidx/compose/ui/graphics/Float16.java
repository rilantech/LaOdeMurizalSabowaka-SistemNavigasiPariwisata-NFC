...
public final class Float16 implements Comparable<Float16> {
    ...
    public static final short Epsilon = m5069constructorimpl(5120);
    ...
    /* access modifiers changed from: private */
    public static final short LowestValue = m5069constructorimpl(-1025);
    public static final int MaxExponent = 15;
    /* access modifiers changed from: private */
    public static final short MaxValue = m5069constructorimpl(31743);
    public static final int MinExponent = -14;
    /* access modifiers changed from: private */
    public static final short MinNormal = m5069constructorimpl(1024);
    /* access modifiers changed from: private */
    public static final short MinValue = m5069constructorimpl(1);
    /* access modifiers changed from: private */
    public static final short NaN = m5069constructorimpl(32256);
    /* access modifiers changed from: private */
    public static final short NegativeInfinity = m5069constructorimpl(-1024);
    private static final short NegativeOne = m5068constructorimpl(-1.0f);
    /* access modifiers changed from: private */
    public static final short NegativeZero = m5069constructorimpl((short) ShortCompanionObject.MIN_VALUE);
    private static final short One = m5068constructorimpl(1.0f);
    /* access modifiers changed from: private */
    public static final short PositiveInfinity = m5069constructorimpl(31744);
    /* access modifiers changed from: private */
    public static final short PositiveZero = m5069constructorimpl(0);
    public static final int Size = 16;
    private final short halfValue;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ Float16 m5064boximpl(short s) {
        return new Float16(s);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static short m5069constructorimpl(short s) {
        return s;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m5070equalsimpl(short s, Object obj) {
        return (obj instanceof Float16) && s == ((Float16) obj).m5095unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m5071equalsimpl0(short s, short s2) {
        return s == s2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m5076hashCodeimpl(short s) {
        return Short.hashCode(s);
    }

    public boolean equals(Object obj) {
        return m5070equalsimpl(this.halfValue, obj);
    }

    public int hashCode() {
        return m5076hashCodeimpl(this.halfValue);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ short m5095unboximpl() {
        return this.halfValue;
    }

    public /* bridge */ /* synthetic */ int compareTo(Object other) {
        return m5094compareTo41bOqos(((Float16) other).m5095unboximpl());
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static short m5068constructorimpl(float value) {
        return m5069constructorimpl(Companion.floatToHalf(value));
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static short m5067constructorimpl(double value) {
        return m5068constructorimpl((float) value);
    }

    /* renamed from: toByte-impl  reason: not valid java name */
    public static final byte m5083toByteimpl(short arg0) {
        return (byte) ((int) m5085toFloatimpl(arg0));
    }

    /* renamed from: toShort-impl  reason: not valid java name */
    public static final short m5090toShortimpl(short arg0) {
        return (short) ((int) m5085toFloatimpl(arg0));
    }

    /* renamed from: toInt-impl  reason: not valid java name */
    public static final int m5087toIntimpl(short arg0) {
        return (int) m5085toFloatimpl(arg0);
    }

    /* renamed from: toLong-impl  reason: not valid java name */
    public static final long m5088toLongimpl(short arg0) {
        return (long) m5085toFloatimpl(arg0);
    }

    /* renamed from: toFloat-impl  reason: not valid java name */
    public static final float m5085toFloatimpl(short arg0) {
        int bits = 65535 & arg0;
        int s = 32768 & bits;
        int e = (bits >>> 10) & 31;
    ...
    public static final double m5084toDoubleimpl(short arg0) {
        return (double) m5085toFloatimpl(arg0);
    }

    /* renamed from: toBits-impl  reason: not valid java name */
    public static final int m5082toBitsimpl(short arg0) {
        if (m5079isNaNimpl(arg0)) {
            return NaN;
        }
        return 65535 & arg0;
    }
    ...
    public static final int m5089toRawBitsimpl(short arg0) {
        return 65535 & arg0;
    }

    public String toString() {
        return m5091toStringimpl(this.halfValue);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m5091toStringimpl(short arg0) {
        return String.valueOf(m5085toFloatimpl(arg0));
    }

    /* renamed from: compareTo-41bOqos  reason: not valid java name */
    public int m5094compareTo41bOqos(short other) {
        return m5066compareTo41bOqos(this.halfValue, other);
    }

    /* renamed from: compareTo-41bOqos  reason: not valid java name */
    public static int m5066compareTo41bOqos(short arg0, short other) {
        if (m5079isNaNimpl(arg0)) {
            return m5079isNaNimpl(other) ^ true ? 1 : 0;
        }
        if (m5079isNaNimpl(other)) {
            return -1;
        }
    ...
    public static final short m5074getSignslo4al4(short arg0) {
        if (m5079isNaNimpl(arg0)) {
            return NaN;
        }
        if (m5066compareTo41bOqos(arg0, NegativeZero) < 0) {
            return NegativeOne;
        }
        if (m5066compareTo41bOqos(arg0, PositiveZero) > 0) {
            return One;
        }
        return arg0;
    }
    ...
    public static final short m5093withSignqCeQghg(short arg0, short sign) {
        return m5069constructorimpl((short) ((32768 & sign) | (arg0 & ShortCompanionObject.MAX_VALUE)));
    }

    /* renamed from: absoluteValue-slo4al4  reason: not valid java name */
    public static final short m5063absoluteValueslo4al4(short arg0) {
        return m5069constructorimpl((short) (arg0 & ShortCompanionObject.MAX_VALUE));
    }

    /* renamed from: round-slo4al4  reason: not valid java name */
    public static final short m5081roundslo4al4(short arg0) {
        int i = 65535;
        int bits = arg0 & 65535;
        ...
        return m5069constructorimpl((short) result);
    }

    /* renamed from: ceil-slo4al4  reason: not valid java name */
    public static final short m5065ceilslo4al4(short arg0) {
        int bits = 65535 & arg0;
        int e = bits & FP16_COMBINED;
        int result = bits;
        int i = 1;
    ...
    public static final short m5072floorslo4al4(short arg0) {
        int i = 65535;
        int bits = arg0 & 65535;
        int e = bits & FP16_COMBINED;
        int result = bits;
    ...
    public static final short m5092truncslo4al4(short arg0) {
        int bits = 65535 & arg0;
        int e = bits & FP16_COMBINED;
        int result = bits;
        if (e < 15360) {
    ...
    public static final int m5073getExponentimpl(short arg0) {
        return ((arg0 >>> 10) & 31) - 15;
    }

    /* renamed from: getSignificand-impl  reason: not valid java name */
    public static final int m5075getSignificandimpl(short arg0) {
        return arg0 & 1023;
    }

    /* renamed from: isNaN-impl  reason: not valid java name */
    public static final boolean m5079isNaNimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) > FP16_EXPONENT_MAX;
    }

    /* renamed from: isInfinite-impl  reason: not valid java name */
    public static final boolean m5078isInfiniteimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) == FP16_EXPONENT_MAX;
    }

    /* renamed from: isFinite-impl  reason: not valid java name */
    public static final boolean m5077isFiniteimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) != FP16_EXPONENT_MAX;
    }

    /* renamed from: isNormalized-impl  reason: not valid java name */
    public static final boolean m5080isNormalizedimpl(short arg0) {
        return ((arg0 & 31744) == 0 || (arg0 & 31744) == FP16_EXPONENT_MAX) ? false : true;
    }

    /* renamed from: toHexString-impl  reason: not valid java name */
    public static final String m5086toHexStringimpl(short arg0) {
