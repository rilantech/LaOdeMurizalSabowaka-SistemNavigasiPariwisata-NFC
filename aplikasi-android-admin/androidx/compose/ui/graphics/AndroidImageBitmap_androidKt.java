...
public final class AndroidImageBitmap_androidKt {
    ...
    public static final ImageBitmap m4822ActualImageBitmapx__hDU(int width, int height, int config, boolean hasAlpha, ColorSpace colorSpace) {
        Intrinsics.checkNotNullParameter(colorSpace, "colorSpace");
        Bitmap.Config r0 = m4823toBitmapConfig1JJdX4A(config);
        return new AndroidImageBitmap(Api26Bitmap.m4861createBitmapx__hDU$ui_graphics_release(width, height, config, hasAlpha, colorSpace));
    }
    ...
    public static final Bitmap.Config m4823toBitmapConfig1JJdX4A(int $this$toBitmapConfig_u2d1JJdX4A) {
        if (ImageBitmapConfig.m5177equalsimpl0($this$toBitmapConfig_u2d1JJdX4A, ImageBitmapConfig.Companion.m5182getArgb8888_sVssgQ())) {
            return Bitmap.Config.ARGB_8888;
        }
        if (ImageBitmapConfig.m5177equalsimpl0($this$toBitmapConfig_u2d1JJdX4A, ImageBitmapConfig.Companion.m5181getAlpha8_sVssgQ())) {
            return Bitmap.Config.ALPHA_8;
        }
        if (ImageBitmapConfig.m5177equalsimpl0($this$toBitmapConfig_u2d1JJdX4A, ImageBitmapConfig.Companion.m5185getRgb565_sVssgQ())) {
            return Bitmap.Config.RGB_565;
        }
        if (ImageBitmapConfig.m5177equalsimpl0($this$toBitmapConfig_u2d1JJdX4A, ImageBitmapConfig.Companion.m5183getF16_sVssgQ())) {
            return Bitmap.Config.RGBA_F16;
        }
        if (ImageBitmapConfig.m5177equalsimpl0($this$toBitmapConfig_u2d1JJdX4A, ImageBitmapConfig.Companion.m5184getGpu_sVssgQ())) {
    ...
    public static final int toImageConfig(Bitmap.Config $this$toImageConfig) {
        ...
        if ($this$toImageConfig == Bitmap.Config.ALPHA_8) {
            return ImageBitmapConfig.Companion.m5181getAlpha8_sVssgQ();
        }
        if ($this$toImageConfig == Bitmap.Config.RGB_565) {
            return ImageBitmapConfig.Companion.m5185getRgb565_sVssgQ();
        }
        if ($this$toImageConfig == Bitmap.Config.ARGB_4444) {
            return ImageBitmapConfig.Companion.m5182getArgb8888_sVssgQ();
        }
        if ($this$toImageConfig == Bitmap.Config.RGBA_F16) {
            return ImageBitmapConfig.Companion.m5183getF16_sVssgQ();
        }
        if ($this$toImageConfig == Bitmap.Config.HARDWARE) {
            return ImageBitmapConfig.Companion.m5184getGpu_sVssgQ();
        }
        return ImageBitmapConfig.Companion.m5182getArgb8888_sVssgQ();
    }
}
