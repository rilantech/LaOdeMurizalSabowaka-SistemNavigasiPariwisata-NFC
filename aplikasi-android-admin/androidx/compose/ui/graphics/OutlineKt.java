...
public final class OutlineKt {
    public static final void addOutline(Path $this$addOutline, Outline outline) {
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            Path.m5243addPathUv8p0NA$default($this$addOutline, ((Outline.Generic) outline).getPath(), 0, 2, (Object) null);
        } else {
    ...
    public static /* synthetic */ void m5220drawOutlinewDX37Ww$default(DrawScope drawScope, Outline outline, long j, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2, Object obj) {
        float f2;
        ...
        m5219drawOutlinewDX37Ww(drawScope, outline, j, f2, drawStyle2, (i2 & 16) != 0 ? null : colorFilter, (i2 & 32) != 0 ? DrawScope.Companion.m5577getDefaultBlendMode0nO6VwU() : i);
    }

    /* renamed from: drawOutline-wDX37Ww  reason: not valid java name */
    public static final void m5219drawOutlinewDX37Ww(DrawScope $this$drawOutline_u2dwDX37Ww, Outline outline, long color, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        ...
        if (outline2 instanceof Outline.Rectangle) {
            ...
            $this$drawOutlineHelper$iv.m5572drawRectnJ9OG0(color, topLeft(rect), size(rect), alpha, style, colorFilter, blendMode);
        } else if (outline2 instanceof Outline.Rounded) {
            Path path$iv = ((Outline.Rounded) outline2).getRoundRectPath$ui_graphics_release();
            if (path$iv != null) {
                $this$drawOutlineHelper$iv.m5568drawPathLG529CI(path$iv, color, alpha, style, colorFilter, blendMode);
                return;
            }
            RoundRect rrect = ((Outline.Rounded) outline2).getRoundRect();
            float radius = CornerRadius.m4688getXimpl(rrect.m4761getBottomLeftCornerRadiuskKHJgLs());
            float f = radius;
            $this$drawOutlineHelper$iv.m5574drawRoundRectuAw5IA(color, topLeft(rrect), size(rrect), CornerRadiusKt.CornerRadius$default(radius, 0.0f, 2, (Object) null), style, alpha, colorFilter, blendMode);
        } else if (outline2 instanceof Outline.Generic) {
            $this$drawOutlineHelper$iv.m5568drawPathLG529CI(((Outline.Generic) outline2).getPath(), color, alpha, style, colorFilter, blendMode);
        } else {
            throw new NoWhenBranchMatchedException();
        }
    }
    ...
    public static /* synthetic */ void m5218drawOutlinehn5TExg$default(DrawScope drawScope, Outline outline, Brush brush, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2, Object obj) {
        float f2;
        DrawStyle drawStyle2;
        if ((i2 & 4) != 0) {
            f2 = 1.0f;
        ...
        m5217drawOutlinehn5TExg(drawScope, outline, brush, f2, drawStyle2, (i2 & 16) != 0 ? null : colorFilter, (i2 & 32) != 0 ? DrawScope.Companion.m5577getDefaultBlendMode0nO6VwU() : i);
    }

    /* renamed from: drawOutline-hn5TExg  reason: not valid java name */
    public static final void m5217drawOutlinehn5TExg(DrawScope $this$drawOutline_u2dhn5TExg, Outline outline, Brush brush, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Outline outline2 = outline;
        ...
        if (outline2 instanceof Outline.Rectangle) {
            Rect rect = ((Outline.Rectangle) outline2).getRect();
            $this$drawOutlineHelper$iv.m5571drawRectAsUm42w(brush, topLeft(rect), size(rect), alpha, style, colorFilter, blendMode);
        } else if (outline2 instanceof Outline.Rounded) {
            Path path$iv = ((Outline.Rounded) outline2).getRoundRectPath$ui_graphics_release();
            if (path$iv != null) {
                $this$drawOutlineHelper$iv.m5567drawPathGBMwjPU(path$iv, brush, alpha, style, colorFilter, blendMode);
                return;
            }
            RoundRect rrect = ((Outline.Rounded) outline2).getRoundRect();
            float radius = CornerRadius.m4688getXimpl(rrect.m4761getBottomLeftCornerRadiuskKHJgLs());
            float f = radius;
            $this$drawOutlineHelper$iv.m5573drawRoundRectZuiqVtQ(brush, topLeft(rrect), size(rrect), CornerRadiusKt.CornerRadius$default(radius, 0.0f, 2, (Object) null), alpha, style, colorFilter, blendMode);
        } else if (outline2 instanceof Outline.Generic) {
            $this$drawOutlineHelper$iv.m5567drawPathGBMwjPU(((Outline.Generic) outline2).getPath(), brush, alpha, style, colorFilter, blendMode);
        } else {
            throw new NoWhenBranchMatchedException();
        }
    }
    ...
    public static final boolean hasSameCornerRadius(androidx.compose.ui.geometry.RoundRect r6) {
        /*
            long r0 = r6.m4761getBottomLeftCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m4688getXimpl(r0)
            long r1 = r6.m4762getBottomRightCornerRadiuskKHJgLs()
            float r1 = androidx.compose.ui.geometry.CornerRadius.m4688getXimpl(r1)
        ...
        L_0x0019:
            ...
            long r3 = r6.m4762getBottomRightCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m4688getXimpl(r3)
            long r3 = r6.m4764getTopRightCornerRadiuskKHJgLs()
            float r3 = androidx.compose.ui.geometry.CornerRadius.m4688getXimpl(r3)
        ...
        L_0x0032:
            ...
            long r3 = r6.m4764getTopRightCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m4688getXimpl(r3)
            long r3 = r6.m4763getTopLeftCornerRadiuskKHJgLs()
            float r3 = androidx.compose.ui.geometry.CornerRadius.m4688getXimpl(r3)
            int r0 = (r0 > r3 ? 1 : (r0 == r3 ? 0 : -1))
        ...
        L_0x004f:
            r0 = r2
        L_0x0050:
            long r3 = r6.m4761getBottomLeftCornerRadiuskKHJgLs()
            float r3 = androidx.compose.ui.geometry.CornerRadius.m4689getYimpl(r3)
            long r4 = r6.m4762getBottomRightCornerRadiuskKHJgLs()
            float r4 = androidx.compose.ui.geometry.CornerRadius.m4689getYimpl(r4)
