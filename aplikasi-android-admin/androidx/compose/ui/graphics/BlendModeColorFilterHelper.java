...
final class BlendModeColorFilterHelper {
    ...
    public final BlendModeColorFilter m4898BlendModeColorFilterxETnrds(long color, int blendMode) {
        return new BlendModeColorFilter(ColorKt.m5017toArgb8_81llA(color), AndroidBlendMode_androidKt.m4805toAndroidBlendModes9anfk8(blendMode));
    }
}
