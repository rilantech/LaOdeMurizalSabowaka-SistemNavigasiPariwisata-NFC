...
public final class AndroidPaint_androidKt {
    ...
    public static final void m4838setNativeBlendModeGB0RdKg(Paint $this$setNativeBlendMode_u2dGB0RdKg, int mode) {
        Intrinsics.checkNotNullParameter($this$setNativeBlendMode_u2dGB0RdKg, "$this$setNativeBlendMode");
        WrapperVerificationHelperMethods.INSTANCE.m5402setBlendModeGB0RdKg($this$setNativeBlendMode_u2dGB0RdKg, mode);
    }
    ...
    public static final void m4839setNativeColor4WTKRHQ(Paint $this$setNativeColor_u2d4WTKRHQ, long value) {
        Intrinsics.checkNotNullParameter($this$setNativeColor_u2d4WTKRHQ, "$this$setNativeColor");
        $this$setNativeColor_u2d4WTKRHQ.setColor(ColorKt.m5017toArgb8_81llA(value));
    }

    /* renamed from: setNativeStyle--5YerkU  reason: not valid java name */
    public static final void m4843setNativeStyle5YerkU(Paint $this$setNativeStyle_u2d_u2d5YerkU, int value) {
        Paint.Style style;
        Intrinsics.checkNotNullParameter($this$setNativeStyle_u2d_u2d5YerkU, "$this$setNativeStyle");
        if (PaintingStyle.m5236equalsimpl0(value, PaintingStyle.Companion.m5241getStrokeTiuSbCo())) {
    ...
    public static final int getNativeStyle(Paint $this$getNativeStyle) {
        ...
        if ((style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1) {
            return PaintingStyle.Companion.m5241getStrokeTiuSbCo();
        }
        return PaintingStyle.Companion.m5240getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(Paint $this$getNativeStrokeCap) {
        ...
        switch (strokeCap == null ? -1 : WhenMappings.$EnumSwitchMapping$1[strokeCap.ordinal()]) {
            case 1:
                return StrokeCap.Companion.m5351getButtKaPHkGw();
            case 2:
                return StrokeCap.Companion.m5352getRoundKaPHkGw();
            case 3:
                return StrokeCap.Companion.m5353getSquareKaPHkGw();
            default:
                return StrokeCap.Companion.m5351getButtKaPHkGw();
        }
    }
    ...
    public static final void m4841setNativeStrokeCapCSYIeUk(Paint $this$setNativeStrokeCap_u2dCSYIeUk, int value) {
        Paint.Cap cap;
        Intrinsics.checkNotNullParameter($this$setNativeStrokeCap_u2dCSYIeUk, "$this$setNativeStrokeCap");
        if (StrokeCap.m5347equalsimpl0(value, StrokeCap.Companion.m5353getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m5347equalsimpl0(value, StrokeCap.Companion.m5352getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else if (StrokeCap.m5347equalsimpl0(value, StrokeCap.Companion.m5351getButtKaPHkGw())) {
            cap = Paint.Cap.BUTT;
        } else {
            cap = Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(Paint $this$getNativeStrokeJoin) {
        ...
        switch (strokeJoin == null ? -1 : WhenMappings.$EnumSwitchMapping$2[strokeJoin.ordinal()]) {
            case 1:
                return StrokeJoin.Companion.m5362getMiterLxFBmk8();
            case 2:
                return StrokeJoin.Companion.m5361getBevelLxFBmk8();
            case 3:
                return StrokeJoin.Companion.m5363getRoundLxFBmk8();
            default:
                return StrokeJoin.Companion.m5362getMiterLxFBmk8();
        }
    }
    ...
    public static final void m4842setNativeStrokeJoinkLtJ_vA(Paint $this$setNativeStrokeJoin_u2dkLtJ_vA, int value) {
        Paint.Join join;
        Intrinsics.checkNotNullParameter($this$setNativeStrokeJoin_u2dkLtJ_vA, "$this$setNativeStrokeJoin");
        if (StrokeJoin.m5357equalsimpl0(value, StrokeJoin.Companion.m5362getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m5357equalsimpl0(value, StrokeJoin.Companion.m5361getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else if (StrokeJoin.m5357equalsimpl0(value, StrokeJoin.Companion.m5363getRoundLxFBmk8())) {
    ...
    public static final int getNativeFilterQuality(Paint $this$getNativeFilterQuality) {
        ...
        if (!$this$getNativeFilterQuality.isFilterBitmap()) {
            return FilterQuality.Companion.m5062getNonefv9h1I();
        }
        return FilterQuality.Companion.m5060getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU  reason: not valid java name */
    public static final void m4840setNativeFilterQuality50PEsBU(Paint $this$setNativeFilterQuality_u2d50PEsBU, int value) {
        Intrinsics.checkNotNullParameter($this$setNativeFilterQuality_u2d50PEsBU, "$this$setNativeFilterQuality");
        $this$setNativeFilterQuality_u2d50PEsBU.setFilterBitmap(!FilterQuality.m5055equalsimpl0(value, FilterQuality.Companion.m5062getNonefv9h1I()));
    }
