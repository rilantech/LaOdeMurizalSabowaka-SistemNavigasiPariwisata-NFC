...
public final class StrokeJoin {
    ...
    public static final int Bevel = m5355constructorimpl(2);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int Miter = m5355constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Round = m5355constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ StrokeJoin m5354boximpl(int i) {
    ...
    public static boolean m5356equalsimpl(int i, Object obj) {
        return (obj instanceof StrokeJoin) && i == ((StrokeJoin) obj).m5360unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m5356equalsimpl(this.value, obj);
    }
    ...
    public final /* synthetic */ int m5360unboximpl() {
        return this.value;
    }
    ...
    public static final class Companion {
        ...
        public final int m5362getMiterLxFBmk8() {
            return StrokeJoin.Miter;
        }

        /* renamed from: getRound-LxFBmk8  reason: not valid java name */
        public final int m5363getRoundLxFBmk8() {
            return StrokeJoin.Round;
        }

        /* renamed from: getBevel-LxFBmk8  reason: not valid java name */
        public final int m5361getBevelLxFBmk8() {
    ...
    public static String m5359toStringimpl(int arg0) {
        if (m5357equalsimpl0(arg0, Miter)) {
            return "Miter";
        }
        if (m5357equalsimpl0(arg0, Round)) {
            return "Round";
        }
        if (m5357equalsimpl0(arg0, Bevel)) {
            return "Bevel";
        }
        return "Unknown";
    }
