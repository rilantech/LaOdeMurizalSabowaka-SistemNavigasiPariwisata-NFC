...
public class Connector {
    ...
    public static final Connector OklabToSrgbPerceptual = new Connector(ColorSpaces.INSTANCE.getOklab(), ColorSpaces.INSTANCE.getSrgb(), RenderIntent.Companion.m5436getPerceptualuksYyKA(), (DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final Connector SrgbIdentity;
    /* access modifiers changed from: private */
    public static final Connector SrgbToOklabPerceptual = new Connector(ColorSpaces.INSTANCE.getSrgb(), ColorSpaces.INSTANCE.getOklab(), RenderIntent.Companion.m5436getPerceptualuksYyKA(), (DefaultConstructorMarker) null);
    ...
    public final int m5419getRenderIntentuksYyKA() {
    ...
    private Connector(androidx.compose.ui.graphics.colorspace.ColorSpace r12, androidx.compose.ui.graphics.colorspace.ColorSpace r13, int r14) {
        /*
            ...
            long r0 = r12.m5415getModelxdoWZVw()
            ...
            long r2 = r2.m5413getRgbxdoWZVw()
            boolean r0 = androidx.compose.ui.graphics.colorspace.ColorModel.m5406equalsimpl0(r0, r2)
            r1 = 2
            r2 = 0
        ...
        L_0x002b:
            r6 = r12
        L_0x002c:
            long r3 = r13.m5415getModelxdoWZVw()
            ...
            long r7 = r0.m5413getRgbxdoWZVw()
            boolean r0 = androidx.compose.ui.graphics.colorspace.ColorModel.m5406equalsimpl0(r3, r7)
        ...
        L_0x0049:
            ...
            float[] r9 = r0.m5422computeTransformYBCOT_4(r12, r13, r14)
            r10 = 0
            r3 = r11
            r4 = r12
            r5 = r13
    ...
    public long m5420transformToColorwmQWz5c$ui_graphics_release(float r, float g, float b, float a) {
        ...
        return this.transformDestination.m5416xyzaToColorJlNiLsg$ui_graphics_release(x, y, z, a, this.destination);
    }
    ...
    public static final class RgbConnector extends Connector {
        ...
        private RgbConnector(Rgb mSource2, Rgb mDestination2, int intent) {
            ...
            this.mTransform = m5424computeTransformYBCOT_4(mSource2, mDestination2, intent);
        }
        ...
        /* renamed from: transformToColor-wmQWz5c$ui_graphics_release  reason: not valid java name */
        public long m5425transformToColorwmQWz5c$ui_graphics_release(float r, float g, float b, float a) {
        ...
        private final float[] m5424computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m5431equalsimpl0(intent, RenderIntent.Companion.m5435getAbsoluteuksYyKA())) {
    ...
    public static final class Companion {
        ...
        /* access modifiers changed from: private */
        /* renamed from: computeTransform-YBCOT_4  reason: not valid java name */
        public final float[] m5422computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m5431equalsimpl0(intent, RenderIntent.Companion.m5435getAbsoluteuksYyKA())) {
                return null;
            }
            boolean srcRGB = ColorModel.m5406equalsimpl0(source.m5415getModelxdoWZVw(), ColorModel.Companion.m5413getRgbxdoWZVw());
            boolean dstRGB = ColorModel.m5406equalsimpl0(destination.m5415getModelxdoWZVw(), ColorModel.Companion.m5413getRgbxdoWZVw());
            if (srcRGB && dstRGB) {
                return null;
            }
            if (!srcRGB && !dstRGB) {
        ...
        public final Connector identity$ui_graphics_release(ColorSpace source) {
            ...
            return new Connector$Companion$identity$1(source, RenderIntent.Companion.m5437getRelativeuksYyKA());
        }
