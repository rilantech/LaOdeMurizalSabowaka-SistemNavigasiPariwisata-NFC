...
public final class Xyz extends ColorSpace {
    ...
    public Xyz(String name, int id) {
        super(name, ColorModel.Companion.m5414getXyzxdoWZVw(), id, (DefaultConstructorMarker) null);
    ...
    public long m5445xyzaToColorJlNiLsg$ui_graphics_release(float x, float y, float z, float a, ColorSpace colorSpace) {
