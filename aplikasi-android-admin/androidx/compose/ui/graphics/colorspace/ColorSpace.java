...
public abstract class ColorSpace {
    ...
    public final long m5415getModelxdoWZVw() {
        return this.model;
    }
    ...
    public final int getComponentCount() {
        return ColorModel.m5407getComponentCountimpl(this.model);
    }
    ...
    public long m5416xyzaToColorJlNiLsg$ui_graphics_release(float x, float y, float z, float a, ColorSpace colorSpace) {
    ...
    public final float[] fromXyz(float x, float y, float z) {
        float[] xyz = new float[ColorModel.m5407getComponentCountimpl(this.model)];
        xyz[0] = x;
        xyz[1] = y;
        xyz[2] = z;
        return fromXyz(xyz);
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ColorModel.m5409toStringimpl(this.model) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.id == that.id && Intrinsics.areEqual((Object) this.name, (Object) that.name)) {
            return ColorModel.m5406equalsimpl0(this.model, that.model);
        }
        return false;
    }

    public int hashCode() {
        return (((this.name.hashCode() * 31) + ColorModel.m5408hashCodeimpl(this.model)) * 31) + this.id;
    }
