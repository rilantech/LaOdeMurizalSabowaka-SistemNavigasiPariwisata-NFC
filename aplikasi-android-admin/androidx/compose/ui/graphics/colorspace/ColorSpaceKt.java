...
public final class ColorSpaceKt {
    ...
    public static /* synthetic */ Connector m5418connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.Companion.m5436getPerceptualuksYyKA();
        }
        return m5417connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4  reason: not valid java name */
    public static final Connector m5417connectYBCOT_4(ColorSpace $this$connect_u2dYBCOT_4, ColorSpace destination, int intent) {
        ...
        if ($this$connect_u2dYBCOT_4 == ColorSpaces.INSTANCE.getSrgb()) {
            ...
            if (destination == ColorSpaces.INSTANCE.getOklab() && RenderIntent.m5431equalsimpl0(intent, RenderIntent.Companion.m5436getPerceptualuksYyKA())) {
                return Connector.Companion.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if ($this$connect_u2dYBCOT_4 == ColorSpaces.INSTANCE.getOklab() && destination == ColorSpaces.INSTANCE.getSrgb() && RenderIntent.m5431equalsimpl0(intent, RenderIntent.Companion.m5436getPerceptualuksYyKA())) {
        ...
        if (!ColorModel.m5406equalsimpl0($this$connect_u2dYBCOT_4.m5415getModelxdoWZVw(), ColorModel.Companion.m5413getRgbxdoWZVw()) || !ColorModel.m5406equalsimpl0(destination.m5415getModelxdoWZVw(), ColorModel.Companion.m5413getRgbxdoWZVw())) {
    ...
    public static final ColorSpace adapt(ColorSpace $this$adapt, WhitePoint whitePoint, Adaptation adaptation) {
        ...
        if (!ColorModel.m5406equalsimpl0($this$adapt.m5415getModelxdoWZVw(), ColorModel.Companion.m5413getRgbxdoWZVw())) {
            return $this$adapt;
        }
