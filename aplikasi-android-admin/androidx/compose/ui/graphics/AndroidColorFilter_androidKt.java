...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m4820actualTintColorFilterxETnrds(long color, int blendMode) {
        return new ColorFilter(BlendModeColorFilterHelper.INSTANCE.m4898BlendModeColorFilterxETnrds(color, blendMode));
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc  reason: not valid java name */
    public static final ColorFilter m4818actualColorMatrixColorFilterjHGOpc(float[] colorMatrix) {
        Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
        return new ColorFilter(new ColorMatrixColorFilter(colorMatrix));
    }

    /* renamed from: actualLightingColorFilter--OWjLjI  reason: not valid java name */
    public static final ColorFilter m4819actualLightingColorFilterOWjLjI(long multiply, long add) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m5017toArgb8_81llA(multiply), ColorKt.m5017toArgb8_81llA(add)));
    }
}
