...
public final class BlurEffect extends RenderEffect {
    ...
    public /* synthetic */ BlurEffect(androidx.compose.ui.graphics.RenderEffect r7, float r8, float r9, int r10, int r11, kotlin.jvm.internal.DefaultConstructorMarker r12) {
        ...
        L_0x0007:
            ...
            int r10 = r9.m5372getClamp3opZhB0()
            r4 = r10
            goto L_0x0014
        L_0x0013:
            r4 = r10
    ...
    public RenderEffect createRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m5294createBlurEffect8A3gB4(this.renderEffect, this.radiusX, this.radiusY, this.edgeTreatment);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((this.radiusY == ((BlurEffect) other).radiusY) && TileMode.m5368equalsimpl0(this.edgeTreatment, ((BlurEffect) other).edgeTreatment) && Intrinsics.areEqual((Object) this.renderEffect, (Object) ((BlurEffect) other).renderEffect)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((renderEffect2 != null ? renderEffect2.hashCode() : 0) * 31) + Float.hashCode(this.radiusX)) * 31) + Float.hashCode(this.radiusY)) * 31) + TileMode.m5369hashCodeimpl(this.edgeTreatment);
    }

    public String toString() {
        return "BlurEffect(renderEffect=" + this.renderEffect + ", radiusX=" + this.radiusX + ", radiusY=" + this.radiusY + ", edgeTreatment=" + TileMode.m5370toStringimpl(this.edgeTreatment) + ')';
    }
}
