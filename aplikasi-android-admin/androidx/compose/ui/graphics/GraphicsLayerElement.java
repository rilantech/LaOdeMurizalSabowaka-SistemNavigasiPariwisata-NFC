...
final class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public static /* synthetic */ GraphicsLayerElement m5108copyJVvOYNQ$default(GraphicsLayerElement graphicsLayerElement, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape2, boolean z, RenderEffect renderEffect2, long j2, long j3, int i, int i2, Object obj) {
        GraphicsLayerElement graphicsLayerElement2 = graphicsLayerElement;
        int i3 = i2;
        return graphicsLayerElement.m5113copyJVvOYNQ((i3 & 1) != 0 ? graphicsLayerElement2.scaleX : f, (i3 & 2) != 0 ? graphicsLayerElement2.scaleY : f2, (i3 & 4) != 0 ? graphicsLayerElement2.alpha : f3, (i3 & 8) != 0 ? graphicsLayerElement2.translationX : f4, (i3 & 16) != 0 ? graphicsLayerElement2.translationY : f5, (i3 & 32) != 0 ? graphicsLayerElement2.shadowElevation : f6, (i3 & 64) != 0 ? graphicsLayerElement2.rotationX : f7, (i3 & 128) != 0 ? graphicsLayerElement2.rotationY : f8, (i3 & 256) != 0 ? graphicsLayerElement2.rotationZ : f9, (i3 & 512) != 0 ? graphicsLayerElement2.cameraDistance : f10, (i3 & 1024) != 0 ? graphicsLayerElement2.transformOrigin : j, (i3 & 2048) != 0 ? graphicsLayerElement2.shape : shape2, (i3 & 4096) != 0 ? graphicsLayerElement2.clip : z, (i3 & 8192) != 0 ? graphicsLayerElement2.renderEffect : renderEffect2, (i3 & 16384) != 0 ? graphicsLayerElement2.ambientShadowColor : j2, (i3 & 32768) != 0 ? graphicsLayerElement2.spotShadowColor : j3, (i3 & 65536) != 0 ? graphicsLayerElement2.compositingStrategy : i);
    }
    ...
    public final long m5109component11SzJe1aQ() {
    ...
    public final long m5110component150d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: component16-0d7_KjU  reason: not valid java name */
    public final long m5111component160d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: component17--NrFUSI  reason: not valid java name */
    public final int m5112component17NrFUSI() {
    ...
    public final GraphicsLayerElement m5113copyJVvOYNQ(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape2, boolean z, RenderEffect renderEffect2, long j2, long j3, int i) {
    ...
    public boolean equals(Object obj) {
        ...
        return Float.compare(this.scaleX, graphicsLayerElement.scaleX) == 0 && Float.compare(this.scaleY, graphicsLayerElement.scaleY) == 0 && Float.compare(this.alpha, graphicsLayerElement.alpha) == 0 && Float.compare(this.translationX, graphicsLayerElement.translationX) == 0 && Float.compare(this.translationY, graphicsLayerElement.translationY) == 0 && Float.compare(this.shadowElevation, graphicsLayerElement.shadowElevation) == 0 && Float.compare(this.rotationX, graphicsLayerElement.rotationX) == 0 && Float.compare(this.rotationY, graphicsLayerElement.rotationY) == 0 && Float.compare(this.rotationZ, graphicsLayerElement.rotationZ) == 0 && Float.compare(this.cameraDistance, graphicsLayerElement.cameraDistance) == 0 && TransformOrigin.m5384equalsimpl0(this.transformOrigin, graphicsLayerElement.transformOrigin) && Intrinsics.areEqual((Object) this.shape, (Object) graphicsLayerElement.shape) && this.clip == graphicsLayerElement.clip && Intrinsics.areEqual((Object) this.renderEffect, (Object) graphicsLayerElement.renderEffect) && Color.m4964equalsimpl0(this.ambientShadowColor, graphicsLayerElement.ambientShadowColor) && Color.m4964equalsimpl0(this.spotShadowColor, graphicsLayerElement.spotShadowColor) && CompositingStrategy.m5045equalsimpl0(this.compositingStrategy, graphicsLayerElement.compositingStrategy);
    }

    public int hashCode() {
        int hashCode = ((((((((((((((((((((((Float.hashCode(this.scaleX) * 31) + Float.hashCode(this.scaleY)) * 31) + Float.hashCode(this.alpha)) * 31) + Float.hashCode(this.translationX)) * 31) + Float.hashCode(this.translationY)) * 31) + Float.hashCode(this.shadowElevation)) * 31) + Float.hashCode(this.rotationX)) * 31) + Float.hashCode(this.rotationY)) * 31) + Float.hashCode(this.rotationZ)) * 31) + Float.hashCode(this.cameraDistance)) * 31) + TransformOrigin.m5387hashCodeimpl(this.transformOrigin)) * 31) + this.shape.hashCode()) * 31;
        boolean z = this.clip;
        if (z) {
            z = true;
        }
        ...
        return ((((((i + (renderEffect2 == null ? 0 : renderEffect2.hashCode())) * 31) + Color.m4970hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m4970hashCodeimpl(this.spotShadowColor)) * 31) + CompositingStrategy.m5046hashCodeimpl(this.compositingStrategy);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("GraphicsLayerElement(scaleX=").append(this.scaleX).append(", scaleY=").append(this.scaleY).append(", alpha=").append(this.alpha).append(", translationX=").append(this.translationX).append(", translationY=").append(this.translationY).append(", shadowElevation=").append(this.shadowElevation).append(", rotationX=").append(this.rotationX).append(", rotationY=").append(this.rotationY).append(", rotationZ=").append(this.rotationZ).append(", cameraDistance=").append(this.cameraDistance).append(", transformOrigin=").append(TransformOrigin.m5388toStringimpl(this.transformOrigin)).append(", shape=");
        sb.append(this.shape).append(", clip=").append(this.clip).append(", renderEffect=").append(this.renderEffect).append(", ambientShadowColor=").append(Color.m4971toStringimpl(this.ambientShadowColor)).append(", spotShadowColor=").append(Color.m4971toStringimpl(this.spotShadowColor)).append(", compositingStrategy=").append(CompositingStrategy.m5047toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }
    ...
    public final long m5117getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    public final long m5114getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: getSpotShadowColor-0d7_KjU  reason: not valid java name */
    public final long m5116getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }
    ...
    public void update(SimpleGraphicsLayerModifier node) {
        ...
        node.m5331setTransformOrigin__ExYCQ(this.transformOrigin);
        node.setShape(this.shape);
        node.setClip(this.clip);
        node.setRenderEffect(this.renderEffect);
        node.m5328setAmbientShadowColor8_81llA(this.ambientShadowColor);
        node.m5330setSpotShadowColor8_81llA(this.spotShadowColor);
        node.m5329setCompositingStrategyaDBOjCE(this.compositingStrategy);
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("transformOrigin", TransformOrigin.m5377boximpl(this.transformOrigin));
        ...
        $this$inspectableProperties.getProperties().set("ambientShadowColor", Color.m4953boximpl(this.ambientShadowColor));
        $this$inspectableProperties.getProperties().set("spotShadowColor", Color.m4953boximpl(this.spotShadowColor));
        $this$inspectableProperties.getProperties().set("compositingStrategy", CompositingStrategy.m5042boximpl(this.compositingStrategy));
    }
}
