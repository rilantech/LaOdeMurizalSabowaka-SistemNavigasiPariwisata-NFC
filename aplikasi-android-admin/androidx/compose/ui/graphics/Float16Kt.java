...
public final class Float16Kt {
    ...
    public static final short m5107minAoSsdG0(short x, short y) {
        if (Float16.m5079isNaNimpl(x) || Float16.m5079isNaNimpl(y)) {
            return Float16.Companion.m5101getNaNslo4al4();
        }
        return Float16.m5066compareTo41bOqos(x, y) <= 0 ? x : y;
    }

    /* renamed from: max-AoSsdG0  reason: not valid java name */
    public static final short m5106maxAoSsdG0(short x, short y) {
        if (Float16.m5079isNaNimpl(x) || Float16.m5079isNaNimpl(y)) {
            return Float16.Companion.m5101getNaNslo4al4();
        }
        return Float16.m5066compareTo41bOqos(x, y) >= 0 ? x : y;
