...
public final class RadialGradient extends ShaderBrush {
    ...
    public long m5289getIntrinsicSizeNHjbRc() {
        float f = this.radius;
    ...
    public Shader m5288createShaderuvyYCjk(long size) {
        float centerY;
        float centerX;
        boolean z = true;
        if (OffsetKt.m4734isUnspecifiedk4lQ0M(this.center)) {
            long drawCenter = SizeKt.m4792getCenteruvyYCjk(size);
            centerX = Offset.m4713getXimpl(drawCenter);
            centerY = Offset.m4714getYimpl(drawCenter);
        } else {
            centerX = (Offset.m4713getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m4713getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m4782getWidthimpl(size) : Offset.m4713getXimpl(this.center);
            centerY = (Offset.m4714getYimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m4714getYimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m4779getHeightimpl(size) : Offset.m4714getYimpl(this.center);
        }
        ...
        if (z) {
            f = Size.m4781getMinDimensionimpl(size) / ((float) 2);
        }
        return ShaderKt.m5312RadialGradientShader8uybcMk(Offset, f, list, list2, this.tileMode);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof RadialGradient) || !Intrinsics.areEqual((Object) this.colors, (Object) ((RadialGradient) other).colors) || !Intrinsics.areEqual((Object) this.stops, (Object) ((RadialGradient) other).stops) || !Offset.m4710equalsimpl0(this.center, ((RadialGradient) other).center)) {
            return false;
        }
        if ((this.radius == ((RadialGradient) other).radius) && TileMode.m5368equalsimpl0(this.tileMode, ((RadialGradient) other).tileMode)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((hashCode + (list != null ? list.hashCode() : 0)) * 31) + Offset.m4715hashCodeimpl(this.center)) * 31) + Float.hashCode(this.radius)) * 31) + TileMode.m5369hashCodeimpl(this.tileMode);
    }

    public String toString() {
        String radiusValue = "";
        String centerValue = OffsetKt.m4732isSpecifiedk4lQ0M(this.center) ? "center=" + Offset.m4721toStringimpl(this.center) + ", " : radiusValue;
        float f = this.radius;
        if (!Float.isInfinite(f) && !Float.isNaN(f)) {
            radiusValue = "radius=" + this.radius + ", ";
        }
        return "RadialGradient(colors=" + this.colors + ", stops=" + this.stops + ", " + centerValue + radiusValue + "tileMode=" + TileMode.m5370toStringimpl(this.tileMode) + ')';
    }
}
