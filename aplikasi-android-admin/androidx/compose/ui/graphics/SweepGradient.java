...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader m5364createShaderuvyYCjk(long size) {
        long j;
        if (OffsetKt.m4734isUnspecifiedk4lQ0M(this.center)) {
            j = SizeKt.m4792getCenteruvyYCjk(size);
        } else {
            boolean z = true;
            float r0 = (Offset.m4713getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m4713getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m4782getWidthimpl(size) : Offset.m4713getXimpl(this.center);
            if (Offset.m4714getYimpl(this.center) != Float.POSITIVE_INFINITY) {
                z = false;
            }
            j = OffsetKt.Offset(r0, z ? Size.m4779getHeightimpl(size) : Offset.m4714getYimpl(this.center));
        }
        return ShaderKt.m5314SweepGradientShader9KIMszo(j, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SweepGradient) && Offset.m4710equalsimpl0(this.center, ((SweepGradient) other).center) && Intrinsics.areEqual((Object) this.colors, (Object) ((SweepGradient) other).colors) && Intrinsics.areEqual((Object) this.stops, (Object) ((SweepGradient) other).stops)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = ((Offset.m4715hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return result + (list != null ? list.hashCode() : 0);
    }

    public String toString() {
        return "SweepGradient(" + (OffsetKt.m4732isSpecifiedk4lQ0M(this.center) ? "center=" + Offset.m4721toStringimpl(this.center) + ", " : "") + "colors=" + this.colors + ", stops=" + this.stops + ')';
    }
}
