...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        public final PathEffect m5253stampedPathEffect7aD1DOk(Path shape, float advance, float phase, int style) {
            Intrinsics.checkNotNullParameter(shape, "shape");
            return AndroidPathEffect_androidKt.m4850actualStampedPathEffect7aD1DOk(shape, advance, phase, style);
        }
    }
}
