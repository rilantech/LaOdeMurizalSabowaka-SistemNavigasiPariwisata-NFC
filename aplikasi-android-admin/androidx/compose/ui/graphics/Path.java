...
public interface Path {
    ...
    void m5244addPathUv8p0NA(Path path, long j);
    ...
    boolean m5246opN5in7k0(Path path, Path path2, int i);
    ...
    void m5247setFillTypeoQ8Xj4U(int i);

    /* renamed from: translate-k-4lQ0M  reason: not valid java name */
    void m5249translatek4lQ0M(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static void m5252transform58bKbWc(Path $this, float[] matrix) {
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            Path.super.m5248transform58bKbWc(matrix);
        }
    }
    ...
    static /* synthetic */ void m5243addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                j = Offset.Companion.m4729getZeroF1C5BW0();
            }
            path.m5244addPathUv8p0NA(path2, j);
            return;
        }
    ...
    /* renamed from: transform-58bKbWc  reason: not valid java name */
    void m5248transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
    }
    ...
    public static final class Companion {
        ...
        public final Path m5250combinexh6zSI8(int operation, Path path1, Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path path = AndroidPath_androidKt.Path();
            if (path.m5246opN5in7k0(path1, path2, operation)) {
                return path;
            }
