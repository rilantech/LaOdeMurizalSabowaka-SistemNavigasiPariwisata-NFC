...
public final class Stroke extends DrawStyle {
    ...
    public static final int DefaultCap = StrokeCap.Companion.m5351getButtKaPHkGw();
    /* access modifiers changed from: private */
    public static final int DefaultJoin = StrokeJoin.Companion.m5362getMiterLxFBmk8();
    ...
    public final int m5656getCapKaPHkGw() {
        return this.cap;
    }

    /* renamed from: getJoin-LxFBmk8  reason: not valid java name */
    public final int m5657getJoinLxFBmk8() {
        return this.join;
    }
    ...
    public static final class Companion {
        ...
        public final int m5658getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8  reason: not valid java name */
        public final int m5659getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        if ((this.miter == ((Stroke) other).miter) && StrokeCap.m5347equalsimpl0(this.cap, ((Stroke) other).cap) && StrokeJoin.m5357equalsimpl0(this.join, ((Stroke) other).join) && Intrinsics.areEqual((Object) this.pathEffect, (Object) ((Stroke) other).pathEffect)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m5348hashCodeimpl(this.cap)) * 31) + StrokeJoin.m5358hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect2 = this.pathEffect;
        return result + (pathEffect2 != null ? pathEffect2.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + StrokeCap.m5349toStringimpl(this.cap) + ", join=" + StrokeJoin.m5359toStringimpl(this.join) + ", pathEffect=" + this.pathEffect + ')';
    }
}
