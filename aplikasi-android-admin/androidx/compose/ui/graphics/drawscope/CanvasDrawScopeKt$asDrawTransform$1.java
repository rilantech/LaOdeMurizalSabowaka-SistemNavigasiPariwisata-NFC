...
public final class CanvasDrawScopeKt$asDrawTransform$1 implements DrawTransform {
    ...
    public long m5485getSizeNHjbRc() {
        return this.$this_asDrawTransform.m5519getSizeNHjbRc();
    }

    /* renamed from: getCenter-F1C5BW0  reason: not valid java name */
    public long m5484getCenterF1C5BW0() {
        return SizeKt.m4792getCenteruvyYCjk(m5485getSizeNHjbRc());
    }

    public void inset(float left, float top, float right, float bottom) {
        Canvas it = this.$this_asDrawTransform.getCanvas();
        DrawContext drawContext = this.$this_asDrawTransform;
        long updatedSize = SizeKt.Size(Size.m4782getWidthimpl(m5485getSizeNHjbRc()) - (left + right), Size.m4779getHeightimpl(m5485getSizeNHjbRc()) - (top + bottom));
        if (Size.m4782getWidthimpl(updatedSize) >= 0.0f && Size.m4779getHeightimpl(updatedSize) >= 0.0f) {
            drawContext.m5520setSizeuvyYCjk(updatedSize);
    ...
    public void m5483clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.$this_asDrawTransform.getCanvas().m4929clipRectN_I0leg(left, top, right, bottom, clipOp);
    }

    /* renamed from: clipPath-mtrdD-E  reason: not valid java name */
    public void m5482clipPathmtrdDE(Path path, int clipOp) {
        Intrinsics.checkNotNullParameter(path, "path");
        this.$this_asDrawTransform.getCanvas().m4928clipPathmtrdDE(path, clipOp);
    }
    ...
    public void m5486rotateUv8p0NA(float degrees, long pivot) {
        Canvas $this$rotate_Uv8p0NA_u24lambda_u242 = this.$this_asDrawTransform.getCanvas();
        $this$rotate_Uv8p0NA_u24lambda_u242.translate(Offset.m4713getXimpl(pivot), Offset.m4714getYimpl(pivot));
        $this$rotate_Uv8p0NA_u24lambda_u242.rotate(degrees);
        $this$rotate_Uv8p0NA_u24lambda_u242.translate(-Offset.m4713getXimpl(pivot), -Offset.m4714getYimpl(pivot));
    }

    /* renamed from: scale-0AR0LA0  reason: not valid java name */
    public void m5487scale0AR0LA0(float scaleX, float scaleY, long pivot) {
        Canvas $this$scale_0AR0LA0_u24lambda_u243 = this.$this_asDrawTransform.getCanvas();
        $this$scale_0AR0LA0_u24lambda_u243.translate(Offset.m4713getXimpl(pivot), Offset.m4714getYimpl(pivot));
        $this$scale_0AR0LA0_u24lambda_u243.scale(scaleX, scaleY);
        $this$scale_0AR0LA0_u24lambda_u243.translate(-Offset.m4713getXimpl(pivot), -Offset.m4714getYimpl(pivot));
    }

    /* renamed from: transform-58bKbWc  reason: not valid java name */
    public void m5488transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        this.$this_asDrawTransform.getCanvas().m4931concat58bKbWc(matrix);
    }
}
