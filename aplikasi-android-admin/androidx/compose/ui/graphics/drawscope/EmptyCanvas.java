...
public final class EmptyCanvas implements Canvas {
    ...
    public void m5648concat58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        throw new UnsupportedOperationException();
    }

    /* renamed from: clipRect-N_I0leg  reason: not valid java name */
    public void m5647clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        throw new UnsupportedOperationException();
    }

    /* renamed from: clipPath-mtrdD-E  reason: not valid java name */
    public void m5646clipPathmtrdDE(Path path, int clipOp) {
        Intrinsics.checkNotNullParameter(path, "path");
        throw new UnsupportedOperationException();
    }

    /* renamed from: drawLine-Wko1d7g  reason: not valid java name */
    public void m5652drawLineWko1d7g(long p1, long p2, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        throw new UnsupportedOperationException();
    }
    ...
    public void m5649drawCircle9KIMszo(long center, float radius, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        throw new UnsupportedOperationException();
    }
    ...
    public void m5650drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
    ...
    public void m5651drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        throw new UnsupportedOperationException();
    }
    ...
    public void m5653drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint) {
    ...
    public void m5654drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
        throw new UnsupportedOperationException();
    }
    ...
    public void m5655drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
