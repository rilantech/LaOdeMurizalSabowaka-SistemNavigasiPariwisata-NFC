...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        ...
        if (target == null) {
            matrix = Matrix.m5192constructorimpl$default((float[]) null, 1, (DefaultConstructorMarker) null);
            this.groupMatrix = matrix;
        } else {
            matrix = target;
            Matrix.m5201resetimpl(matrix);
        }
        Matrix.m5212translateimpl$default(matrix, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, (Object) null);
        Matrix.m5204rotateZimpl(matrix, this.rotation);
        Matrix.m5205scaleimpl(matrix, this.scaleX, this.scaleY, 1.0f);
        Matrix.m5212translateimpl$default(matrix, -this.pivotX, -this.pivotY, 0.0f, 4, (Object) null);
    }
    ...
    public void draw(DrawScope $this$draw) {
        ...
        if (fArr != null) {
            $this$draw_u24lambda_u245.m5636transform58bKbWc((fArr != null ? Matrix.m5190boximpl(fArr) : null).m5213unboximpl());
        }
        Path targetClip = this.clipPath;
        if (getWillClipPath() && targetClip != null) {
            DrawTransform.m5626clipPathmtrdDE$default($this$draw_u24lambda_u245, targetClip, 0, 2, (Object) null);
        }
