    ...
    public static final class Companion {
        ...
        public final int nextFloat(String s, int start, int end, FloatResult result) {
            ...
            if (digitCount2 > 19) {
                ...
                if (digitCount2 > 19) {
                    ...
                    while (true) {
                        ...
                        if (retryIndex2 != significandEndIndex && Long.compareUnsigned(ULong.m305constructorimpl(significand3), 1000000000000000000L) < 0) {
                    ...
                    if (Long.compareUnsigned(ULong.m305constructorimpl(significand3), 1000000000000000000L) >= 0) {
                        ...
                        while (true) {
                            ...
                            if (Long.compareUnsigned(ULong.m305constructorimpl(significand3), j) >= 0) {
                                break;
                            }
                            significand3 = (significand3 * 10) + ((long) (c2 - '0'));
                            retryIndex4++;
            ...
            if (!(FastFloatParser.FloatMinExponent <= exponent && exponent < 11)) {
                ...
                if (Long.compareUnsigned(ULong.m305constructorimpl(significand3), ULong.m305constructorimpl(16777216)) <= 0) {
            ...
            if (!(-126 <= exponent && exponent < 128)) {
                ...
                int i14 = start;
                long significandFactor = ULongArray.m365getsVKNKU(FastFloatParser.Mantissa64, exponent + 325);
