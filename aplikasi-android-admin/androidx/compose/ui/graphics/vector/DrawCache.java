...
public final class DrawCache {
    ...
    private long size = IntSize.Companion.m7719getZeroYbymL2g();
    ...
    public final void m5672drawCachedImageCJJARo(long size2, Density density, LayoutDirection layoutDirection2, Function1<? super DrawScope, Unit> block) {
        ...
        if (targetImage == null || targetCanvas == null || IntSize.m7714getWidthimpl(size2) > targetImage.getWidth() || IntSize.m7713getHeightimpl(size2) > targetImage.getHeight()) {
            targetImage = ImageBitmapKt.m5187ImageBitmapx__hDU$default(IntSize.m7714getWidthimpl(size2), IntSize.m7713getHeightimpl(size2), 0, false, (ColorSpace) null, 28, (Object) null);
        ...
        long size$iv = IntSizeKt.m7724toSizeozmzZPI(size2);
        ...
        $this$draw_yzxVdVo_u24lambda_u240$iv.setDensity(density2);
        $this$draw_yzxVdVo_u24lambda_u240$iv.setLayoutDirection(layoutDirection3);
        ...
        targetCanvas.save();
        DrawScope $this$drawCachedImage_CJJAR_o_u24lambda_u240 = this_$iv;
        clear($this$drawCachedImage_CJJAR_o_u24lambda_u240);
        function1.invoke($this$drawCachedImage_CJJAR_o_u24lambda_u240);
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        ImageBitmap targetImage = this.mCachedImage;
        if (targetImage != null) {
            DrawScope.m5541drawImageAZ2fEMs$default(target, targetImage, 0, this.size, 0, 0, alpha, (DrawStyle) null, colorFilter, 0, 0, 858, (Object) null);
            return;
        }
    ...
    private final void clear(DrawScope $this$clear) {
        DrawScope.m5552drawRectnJ9OG0$default($this$clear, Color.Companion.m4989getBlack0d7_KjU(), 0, 0, 0.0f, (DrawStyle) null, (ColorFilter) null, BlendMode.Companion.m4869getClear0nO6VwU(), 62, (Object) null);
    }
}
