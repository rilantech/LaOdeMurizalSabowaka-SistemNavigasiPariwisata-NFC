...
final class VectorComposeKt$Path$2$10 extends Lambda implements Function2<PathComponent, StrokeCap, Unit> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        m5688invokeCSYIeUk((PathComponent) p1, ((StrokeCap) p2).m5350unboximpl());
        return Unit.INSTANCE;
    }

    /* renamed from: invoke-CSYIeUk  reason: not valid java name */
    public final void m5688invokeCSYIeUk(PathComponent $this$set, int it) {
        Intrinsics.checkNotNullParameter($this$set, "$this$set");
        $this$set.m5685setStrokeLineCapBeK7IIE(it);
    }
}
