...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m5700getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.Companion.m5351getButtKaPHkGw();
        }
        return m5699getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk  reason: not valid java name */
    private static final int m5699getStrokeLineCapCSYIeUk(int id, int defValue) {
        switch (id) {
            case 0:
    ...
    static /* synthetic */ int m5702getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.Companion.m5362getMiterLxFBmk8();
        }
        return m5701getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA  reason: not valid java name */
    private static final int m5701getStrokeLineJoinkLtJ_vA(int id, int defValue) {
        switch (id) {
            case 0:
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser $this$createVectorImageBuilder, Resources res, Resources.Theme theme, AttributeSet attrs) {
        ...
        if (viewportWidth <= 0.0f) {
            ...
            if (vectorAttrs.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
                ...
                if (value.type == 2) {
                    tintColor = Color.Companion.m4999getUnspecified0d7_KjU();
                } else {
            ...
            if (blendModeValue != -1) {
                switch (blendModeValue) {
                    case 3:
                        tintBlendMode = BlendMode.Companion.m4896getSrcOver0nO6VwU();
                        break;
                    case 5:
                        tintBlendMode = BlendMode.Companion.m4894getSrcIn0nO6VwU();
                        break;
                    case 9:
                        tintBlendMode = BlendMode.Companion.m4893getSrcAtop0nO6VwU();
                        break;
                    case 14:
                        tintBlendMode = BlendMode.Companion.m4885getModulate0nO6VwU();
                        break;
                    case 15:
                        tintBlendMode = BlendMode.Companion.m4890getScreen0nO6VwU();
                        break;
                    case 16:
                        tintBlendMode = BlendMode.Companion.m4888getPlus0nO6VwU();
                        break;
                    default:
                        tintBlendMode = BlendMode.Companion.m4894getSrcIn0nO6VwU();
                        break;
            ...
            float defaultWidthDp = Dp.m7554constructorimpl(defaultWidth / res.getDisplayMetrics().density);
            float defaultHeightDp = Dp.m7554constructorimpl(defaultHeight / res.getDisplayMetrics().density);
            vectorAttrs.recycle();
    ...
    public static final void parsePath(AndroidVectorParser $this$parsePath, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        if (TypedArrayUtils.hasAttribute($this$parsePath.getXmlParser(), "pathData")) {
            ...
            int strokeLineCap = m5699getStrokeLineCapCSYIeUk(lineCap, StrokeCap.Companion.m5351getButtKaPHkGw());
            ...
            int strokeLineJoin = m5701getStrokeLineJoinkLtJ_vA(lineJoin, StrokeJoin.Companion.m5361getBevelLxFBmk8());
            ...
            builder.m5678addPathoIyEayM(addPathNodes, fillRule == 0 ? companion.m5262getNonZeroRgk1Os() : companion.m5261getEvenOddRgk1Os(), name, fillBrush, fillAlpha, strokeBrush, strokeAlpha, strokeLineWidth, strokeLineCap, strokeLineJoin, strokeMiterLimit, trimPathStart, trimPathEnd, trimPathOffset);
            return;
        }
