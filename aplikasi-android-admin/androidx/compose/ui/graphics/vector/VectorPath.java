...
public final class VectorPath extends VectorNode {
    ...
    public final int m5696getPathFillTypeRgk1Os() {
    ...
    public final int m5697getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: getStrokeLineJoin-LxFBmk8  reason: not valid java name */
    public final int m5698getStrokeLineJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        if (!(this.strokeLineWidth == ((VectorPath) other).strokeLineWidth) || !StrokeCap.m5347equalsimpl0(this.strokeLineCap, ((VectorPath) other).strokeLineCap) || !StrokeJoin.m5357equalsimpl0(this.strokeLineJoin, ((VectorPath) other).strokeLineJoin)) {
            return false;
        }
        ...
        if ((this.trimPathOffset == ((VectorPath) other).trimPathOffset) && PathFillType.m5257equalsimpl0(this.pathFillType, ((VectorPath) other).pathFillType) && Intrinsics.areEqual((Object) this.pathData, (Object) ((VectorPath) other).pathData)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((((result2 + i) * 31) + Float.hashCode(this.strokeAlpha)) * 31) + Float.hashCode(this.strokeLineWidth)) * 31) + StrokeCap.m5348hashCodeimpl(this.strokeLineCap)) * 31) + StrokeJoin.m5358hashCodeimpl(this.strokeLineJoin)) * 31) + Float.hashCode(this.strokeLineMiter)) * 31) + Float.hashCode(this.trimPathStart)) * 31) + Float.hashCode(this.trimPathEnd)) * 31) + Float.hashCode(this.trimPathOffset)) * 31) + PathFillType.m5258hashCodeimpl(this.pathFillType);
    }
}
