...
public final class ImageVector {
    ...
    public final float m5674getDefaultWidthD9Ej5fM() {
        return this.defaultWidth;
    }

    /* renamed from: getDefaultHeight-D9Ej5fM  reason: not valid java name */
    public final float m5673getDefaultHeightD9Ej5fM() {
    ...
    public final long m5676getTintColor0d7_KjU() {
        return this.tintColor;
    }

    /* renamed from: getTintBlendMode-0nO6VwU  reason: not valid java name */
    public final int m5675getTintBlendMode0nO6VwU() {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(java.lang.String r14, float r15, float r16, float r17, float r18, long r19, int r21, boolean r22, int r23, kotlin.jvm.internal.DefaultConstructorMarker r24) {
            ...
            L_0x0019:
                ...
                int r1 = r1.m4894getSrcIn0nO6VwU()
                r10 = r1
                goto L_0x0027
            L_0x0025:
                r10 = r21
        ...
        public /* synthetic */ Builder(java.lang.String r12, float r13, float r14, float r15, float r16, long r17, int r19, int r20, kotlin.jvm.internal.DefaultConstructorMarker r21) {
            ...
            L_0x0009:
                ...
                long r0 = r0.m4999getUnspecified0d7_KjU()
                r7 = r0
                goto L_0x0017
            L_0x0015:
                r7 = r17
            L_0x0017:
                ...
                int r0 = r0.m4894getSrcIn0nO6VwU()
                r9 = r0
                goto L_0x0025
            L_0x0023:
                r9 = r19
        ...
        public static /* synthetic */ Builder m5677addPathoIyEayM$default(Builder builder, List list, int i, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7, int i4, Object obj) {
            int i5;
            String str2;
            Brush brush3;
            float f8;
            ...
            return builder.m5678addPathoIyEayM(list, i5, str2, brush3, f8, brush4, f9, f10, i6, i7, f11, f12, f13, f14);
        }

        /* renamed from: addPath-oIyEayM  reason: not valid java name */
        public final Builder m5678addPathoIyEayM(List<? extends PathNode> pathData, int pathFillType, String name2, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int strokeLineCap, int strokeLineJoin, float strokeLineMiter, float trimPathStart, float trimPathEnd, float trimPathOffset) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ImageVector) || !Intrinsics.areEqual((Object) this.name, (Object) ((ImageVector) other).name) || !Dp.m7559equalsimpl0(this.defaultWidth, ((ImageVector) other).defaultWidth) || !Dp.m7559equalsimpl0(this.defaultHeight, ((ImageVector) other).defaultHeight)) {
            return false;
        }
        if (!(this.viewportWidth == ((ImageVector) other).viewportWidth)) {
            return false;
        }
        if ((this.viewportHeight == ((ImageVector) other).viewportHeight) && Intrinsics.areEqual((Object) this.root, (Object) ((ImageVector) other).root) && Color.m4964equalsimpl0(this.tintColor, ((ImageVector) other).tintColor) && BlendMode.m4865equalsimpl0(this.tintBlendMode, ((ImageVector) other).tintBlendMode) && this.autoMirror == ((ImageVector) other).autoMirror) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((this.name.hashCode() * 31) + Dp.m7560hashCodeimpl(this.defaultWidth)) * 31) + Dp.m7560hashCodeimpl(this.defaultHeight)) * 31) + Float.hashCode(this.viewportWidth)) * 31) + Float.hashCode(this.viewportHeight)) * 31) + this.root.hashCode()) * 31) + Color.m4970hashCodeimpl(this.tintColor)) * 31) + BlendMode.m4866hashCodeimpl(this.tintBlendMode)) * 31) + Boolean.hashCode(this.autoMirror);
    }
}
