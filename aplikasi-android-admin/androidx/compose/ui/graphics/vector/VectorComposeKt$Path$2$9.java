...
final class VectorComposeKt$Path$2$9 extends Lambda implements Function2<PathComponent, StrokeJoin, Unit> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        m5690invokekLtJ_vA((PathComponent) p1, ((StrokeJoin) p2).m5360unboximpl());
        return Unit.INSTANCE;
    }

    /* renamed from: invoke-kLtJ_vA  reason: not valid java name */
    public final void m5690invokekLtJ_vA(PathComponent $this$set, int it) {
        Intrinsics.checkNotNullParameter($this$set, "$this$set");
        $this$set.m5686setStrokeLineJoinWw9F2mQ(it);
    }
}
