...
public final class VectorKt {
    private static final int DefaultFillType = PathFillType.Companion.m5262getNonZeroRgk1Os();
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.Companion.m5351getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.Companion.m5362getMiterLxFBmk8();
    public static final float DefaultStrokeLineMiter = 4.0f;
    public static final float DefaultStrokeLineWidth = 0.0f;
    private static final int DefaultTintBlendMode = BlendMode.Companion.m4894getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.Companion.m4998getTransparent0d7_KjU();
