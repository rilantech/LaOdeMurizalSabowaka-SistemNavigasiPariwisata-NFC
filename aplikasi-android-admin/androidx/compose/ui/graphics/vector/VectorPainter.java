...
public final class VectorPainter extends Painter {
    ...
    private final MutableState size$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4770boximpl(Size.Companion.m4791getZeroNHjbRc()), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public final long m5692getSizeNHjbRc$ui_release() {
        return ((Size) this.size$delegate.getValue()).m4787unboximpl();
    }

    /* renamed from: setSize-uvyYCjk$ui_release  reason: not valid java name */
    public final void m5693setSizeuvyYCjk$ui_release(long j) {
        this.size$delegate.setValue(Size.m4770boximpl(j));
    }
    ...
    public long m5691getIntrinsicSizeNHjbRc() {
        return m5692getSizeNHjbRc$ui_release();
    }
    ...
    public void onDraw(DrawScope $this$onDraw) {
        ...
        if (!getAutoMirror$ui_release() || $this$onDraw.getLayoutDirection() != LayoutDirection.Rtl) {
            ...
            long pivot$iv$iv = $this$scale_u2dFgt4K4Q_u24default$iv$iv.m5575getCenterF1C5BW0();
            ...
            long previousSize$iv$iv$iv = $this$withTransform_u24lambda_u246$iv$iv$iv.m5519getSizeNHjbRc();
            $this$withTransform_u24lambda_u246$iv$iv$iv.getCanvas().save();
            $this$withTransform_u24lambda_u246$iv$iv$iv.getTransform().m5635scale0AR0LA0(-1.0f, 1.0f, pivot$iv$iv);
            ...
            $this$withTransform_u24lambda_u246$iv$iv$iv.m5520setSizeuvyYCjk(previousSize$iv$iv$iv);
        }
        if (isDirty()) {
            setDirty(false);
        }
