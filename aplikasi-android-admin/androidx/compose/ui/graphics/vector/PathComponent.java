...
public final class PathComponent extends VNode {
    ...
    public final int m5681getPathFillTypeRgk1Os() {
        return this.pathFillType;
    }

    /* renamed from: setPathFillType-oQ8Xj4U  reason: not valid java name */
    public final void m5684setPathFillTypeoQ8Xj4U(int value) {
        this.pathFillType = value;
        this.renderPath.m5247setFillTypeoQ8Xj4U(value);
        invalidate();
    }
    ...
    public final int m5682getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: setStrokeLineCap-BeK7IIE  reason: not valid java name */
    public final void m5685setStrokeLineCapBeK7IIE(int value) {
    ...
    public final int m5683getStrokeLineJoinLxFBmk8() {
        return this.strokeLineJoin;
    }

    /* renamed from: setStrokeLineJoin-Ww9F2mQ  reason: not valid java name */
    public final void m5686setStrokeLineJoinWw9F2mQ(int value) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual((Object) this.renderPath, (Object) this.path)) {
            ...
            int fillType = this.renderPath.m5245getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.m5247setFillTypeoQ8Xj4U(fillType);
        }
    ...
    public void draw(DrawScope $this$draw) {
        ...
        Brush it = this.fill;
        if (it != null) {
            DrawScope.m5547drawPathGBMwjPU$default($this$draw, this.renderPath, it, this.fillAlpha, (DrawStyle) null, (ColorFilter) null, 0, 56, (Object) null);
        }
        ...
        if (it2 != null) {
            ...
            DrawScope.m5547drawPathGBMwjPU$default($this$draw, this.renderPath, it2, this.strokeAlpha, targetStroke, (ColorFilter) null, 0, 48, (Object) null);
        }
    }
