...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable m6333measureBRTryo0(long constraints) {
        int height;
        int width;
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(width, Constraints.m7497getMaxHeightimpl(constraints));
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m7498getMaxWidthimpl(constraints), height);
    }
