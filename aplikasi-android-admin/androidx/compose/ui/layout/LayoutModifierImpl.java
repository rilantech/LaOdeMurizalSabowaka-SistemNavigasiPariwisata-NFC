...
public final class LayoutModifierImpl extends Modifier.Node implements LayoutModifierNode {
    ...
    public LayoutModifierImpl(Function3<? super MeasureScope, ? super Measurable, ? super Constraints, ? extends MeasureResult> measureBlock2) {
        Intrinsics.checkNotNullParameter(measureBlock2, "measureBlock");
        this.measureBlock = measureBlock2;
    }

    /* renamed from: measure-3p2s80s  reason: not valid java name */
    public MeasureResult m6370measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter($this$measure_u2d3p2s80s, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return (MeasureResult) this.measureBlock.invoke($this$measure_u2d3p2s80s, measurable, Constraints.m7486boximpl(constraints));
    }
