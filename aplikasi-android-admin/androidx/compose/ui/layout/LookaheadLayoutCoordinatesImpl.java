...
public final class LookaheadLayoutCoordinatesImpl implements LookaheadLayoutCoordinates {
    ...
    public long m6391getSizeYbymL2g() {
    ...
    private final long m6390getLookaheadOffsetF1C5BW0() {
        LookaheadDelegate it = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        return Offset.m4717minusMKHz9U(m6392localPositionOfR5De75A(it.getCoordinates(), Offset.Companion.m4729getZeroF1C5BW0()), getCoordinator().m6645localPositionOfR5De75A(it.getCoordinator(), Offset.Companion.m4729getZeroF1C5BW0()));
    }

    /* renamed from: windowToLocal-MK-Hz9U  reason: not valid java name */
    public long m6396windowToLocalMKHz9U(long relativeToWindow) {
        return Offset.m4718plusMKHz9U(getCoordinator().m6655windowToLocalMKHz9U(relativeToWindow), m6390getLookaheadOffsetF1C5BW0());
    }

    /* renamed from: localToWindow-MK-Hz9U  reason: not valid java name */
    public long m6394localToWindowMKHz9U(long relativeToLocal) {
        return getCoordinator().m6647localToWindowMKHz9U(Offset.m4718plusMKHz9U(relativeToLocal, m6390getLookaheadOffsetF1C5BW0()));
    }

    /* renamed from: localToRoot-MK-Hz9U  reason: not valid java name */
    public long m6393localToRootMKHz9U(long relativeToLocal) {
        return getCoordinator().m6646localToRootMKHz9U(Offset.m4718plusMKHz9U(relativeToLocal, m6390getLookaheadOffsetF1C5BW0()));
    }

    /* renamed from: localPositionOf-R5De75A  reason: not valid java name */
    public long m6392localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource) {
        ...
        if (layoutCoordinates instanceof LookaheadLayoutCoordinatesImpl) {
            ...
            if (ancestor != null) {
                long arg0$iv = source.m6605positionInBjo55l4$ui_release(ancestor);
                long $this$round_u2dk_u2d4lQ0M$iv = relativeToSource;
                long other$iv = IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m4713getXimpl($this$round_u2dk_u2d4lQ0M$iv)), MathKt.roundToInt(Offset.m4714getYimpl($this$round_u2dk_u2d4lQ0M$iv)));
                long arg0$iv2 = IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(arg0$iv) + IntOffset.m7672getXimpl(other$iv), IntOffset.m7673getYimpl(arg0$iv) + IntOffset.m7673getYimpl(other$iv));
                long other$iv2 = this.lookaheadDelegate.m6605positionInBjo55l4$ui_release(ancestor);
                long arg0$iv3 = IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(arg0$iv2) - IntOffset.m7672getXimpl(other$iv2), IntOffset.m7673getYimpl(arg0$iv2) - IntOffset.m7673getYimpl(other$iv2));
                LookaheadDelegate lookaheadDelegate2 = source;
                NodeCoordinator nodeCoordinator = commonAncestor;
                return OffsetKt.Offset((float) IntOffset.m7672getXimpl(arg0$iv3), (float) IntOffset.m7673getYimpl(arg0$iv3));
            }
            ...
            long arg0$iv4 = source.m6605positionInBjo55l4$ui_release(sourceRoot);
            long other$iv3 = sourceRoot.m6602getPositionnOccac();
            long arg0$iv5 = IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(arg0$iv4) + IntOffset.m7672getXimpl(other$iv3), IntOffset.m7673getYimpl(arg0$iv4) + IntOffset.m7673getYimpl(other$iv3));
            long other$iv4 = relativeToSource;
            long other$iv5 = IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m4713getXimpl(other$iv4)), MathKt.roundToInt(Offset.m4714getYimpl(other$iv4)));
            long arg0$iv6 = IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(arg0$iv5) + IntOffset.m7672getXimpl(other$iv5), IntOffset.m7673getYimpl(arg0$iv5) + IntOffset.m7673getYimpl(other$iv5));
            LookaheadDelegate $this$localPositionOf_R5De75A_u24lambda_u247_u24lambda_u246 = this.lookaheadDelegate;
            long arg0$iv7 = $this$localPositionOf_R5De75A_u24lambda_u247_u24lambda_u246.m6605positionInBjo55l4$ui_release(LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate($this$localPositionOf_R5De75A_u24lambda_u247_u24lambda_u246));
            long other$iv6 = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate($this$localPositionOf_R5De75A_u24lambda_u247_u24lambda_u246).m6602getPositionnOccac();
            LookaheadDelegate lookaheadDelegate3 = source;
            NodeCoordinator nodeCoordinator3 = commonAncestor;
            long other$iv7 = IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(arg0$iv7) + IntOffset.m7672getXimpl(other$iv6), IntOffset.m7673getYimpl(arg0$iv7) + IntOffset.m7673getYimpl(other$iv6));
            long other$iv8 = IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(arg0$iv6) - IntOffset.m7672getXimpl(other$iv7), IntOffset.m7673getYimpl(arg0$iv6) - IntOffset.m7673getYimpl(other$iv7));
            ...
            return wrappedBy$ui_release.m6645localPositionOfR5De75A(wrappedBy$ui_release2, OffsetKt.Offset((float) IntOffset.m7672getXimpl($this$toOffset_u2d_u2dgyyYBs$iv), (float) IntOffset.m7673getYimpl($this$toOffset_u2d_u2dgyyYBs$iv)));
        }
        LookaheadDelegate rootDelegate = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        return Offset.m4718plusMKHz9U(m6392localPositionOfR5De75A(rootDelegate.getLookaheadLayoutCoordinates(), relativeToSource), rootDelegate.getCoordinator().getCoordinates().m6361localPositionOfR5De75A(layoutCoordinates, Offset.Companion.m4729getZeroF1C5BW0()));
    }
    ...
    public void m6395transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        getCoordinator().m6653transformFromEL8BTi8(sourceCoordinates, matrix);
    }
