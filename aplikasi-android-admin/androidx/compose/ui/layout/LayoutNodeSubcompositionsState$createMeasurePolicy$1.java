...
public final class LayoutNodeSubcompositionsState$createMeasurePolicy$1 extends LayoutNode.NoIntrinsicsMeasurePolicy {
    ...
    public MeasureResult m6387measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> measurables, long constraints) {
        ...
        if ((this.this$0.root.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring || this.this$0.root.getLayoutState$ui_release() == LayoutNode.LayoutState.LayingOut) && this.this$0.root.getLookaheadRoot$ui_release() != null) {
            return this.this$0.getIntermediateMeasurePolicy$ui_release().invoke(this.this$0.intermediateMeasureScope, Constraints.m7486boximpl(constraints));
        }
        this.this$0.currentIndex = 0;
        this.this$0.intermediateMeasureScope.m6375setLookaheadConstraintsBRTryo0(constraints);
        MeasureResult result = this.$block.invoke(this.this$0.scope, Constraints.m7486boximpl(constraints));
        int indexAfterMeasure = this.this$0.currentIndex;
        this.this$0.intermediateMeasureScope.m6376setLookaheadSizeozmzZPI(IntSizeKt.IntSize(result.getWidth(), result.getHeight()));
