...
public interface MultiContentMeasurePolicy {
    ...
    MeasureResult m6427measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j);
    ...
    int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends List<? extends IntrinsicMeasurable>> measurables, int height) {
        ...
        return m6427measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, $this$minIntrinsicWidth.getLayoutDirection()), target$iv, ConstraintsKt.Constraints$default(0, 0, 0, height, 7, (Object) null)).getWidth();
    }
    ...
    int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends List<? extends IntrinsicMeasurable>> measurables, int width) {
        ...
        List list2 = $this$fastForEach$iv$iv;
        int i4 = $i$f$fastForEach;
        return m6427measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, $this$minIntrinsicHeight.getLayoutDirection()), target$iv, ConstraintsKt.Constraints$default(0, width, 0, 0, 13, (Object) null)).getHeight();
    }
    ...
    int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends List<? extends IntrinsicMeasurable>> measurables, int height) {
        ...
        List list2 = $this$fastForEach$iv$iv;
        int i4 = $i$f$fastForEach;
        return m6427measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, $this$maxIntrinsicWidth.getLayoutDirection()), target$iv, ConstraintsKt.Constraints$default(0, 0, 0, height, 7, (Object) null)).getWidth();
    }
    ...
    int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends List<? extends IntrinsicMeasurable>> measurables, int width) {
        ...
        List list2 = $this$fastForEach$iv$iv;
        int i4 = $i$f$fastForEach;
        return m6427measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, $this$maxIntrinsicHeight.getLayoutDirection()), target$iv, ConstraintsKt.Constraints$default(0, width, 0, 0, 13, (Object) null)).getHeight();
    }
}
