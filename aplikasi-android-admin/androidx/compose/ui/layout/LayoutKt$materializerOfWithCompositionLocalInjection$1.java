...
final class LayoutKt$materializerOfWithCompositionLocalInjection$1 extends Lambda implements Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2, Object p3) {
        m6368invokeDeg8D_g(((SkippableUpdater) p1).m4573unboximpl(), (Composer) p2, ((Number) p3).intValue());
        return Unit.INSTANCE;
    }

    /* renamed from: invoke-Deg8D_g  reason: not valid java name */
    public final void m6368invokeDeg8D_g(Composer $this$null, Composer $composer, int $changed) {
        ...
        Modifier materialized = ComposedModifierKt.materializeWithCompositionLocalInjectionInternal($composer, this.$modifier);
        $this$null.startReplaceableGroup(509942095);
        Composer $this$invoke_Deg8D_g_u24lambda_u240 = Updater.m4575constructorimpl($this$null);
        Updater.m4582setimpl($this$invoke_Deg8D_g_u24lambda_u240, materialized, ComposeUiNode.Companion.getSetModifier());
