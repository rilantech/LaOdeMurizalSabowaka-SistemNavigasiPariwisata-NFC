...
public final class LayoutNodeSubcompositionsState$precompose$1 implements SubcomposeLayoutState.PrecomposedSlotHandle {
    ...
    public void m6389premeasure0kLqBqw(int index, long constraints) {
        ...
        if (node != null && node.isAttached()) {
            ...
            if (index < 0 || index >= size) {
                ...
                LayoutNodeKt.requireOwner(node).m6724measureAndLayout0kLqBqw(node.getChildren$ui_release().get(index), constraints);
