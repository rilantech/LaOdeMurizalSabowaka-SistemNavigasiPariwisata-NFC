...
public final class LayoutCoordinatesKt {
    public static final long positionInRoot(LayoutCoordinates $this$positionInRoot) {
        ...
        return $this$positionInRoot.m6362localToRootMKHz9U(Offset.Companion.m4729getZeroF1C5BW0());
    }
    ...
    public static final long positionInWindow(LayoutCoordinates $this$positionInWindow) {
        ...
        return $this$positionInWindow.m6363localToWindowMKHz9U(Offset.Companion.m4729getZeroF1C5BW0());
    }
    ...
    public static final Rect boundsInWindow(LayoutCoordinates $this$boundsInWindow) {
        ...
        float rootWidth = (float) IntSize.m7714getWidthimpl(root.m6360getSizeYbymL2g());
        float rootHeight = (float) IntSize.m7713getHeightimpl(root.m6360getSizeYbymL2g());
        ...
        if (!(boundsLeft == boundsRight)) {
            if (boundsTop == boundsBottom) {
                ...
                long topLeft = root.m6363localToWindowMKHz9U(OffsetKt.Offset(boundsLeft, boundsTop));
                long topRight = root.m6363localToWindowMKHz9U(OffsetKt.Offset(boundsRight, boundsTop));
                long bottomRight = root.m6363localToWindowMKHz9U(OffsetKt.Offset(boundsRight, boundsBottom));
                long bottomLeft = root.m6363localToWindowMKHz9U(OffsetKt.Offset(boundsLeft, boundsBottom));
                LayoutCoordinates layoutCoordinates2 = root;
                Rect rect2 = bounds;
                float f2 = rootWidth;
                return new Rect(ComparisonsKt.minOf(Offset.m4713getXimpl(topLeft), Offset.m4713getXimpl(topRight), Offset.m4713getXimpl(bottomLeft), Offset.m4713getXimpl(bottomRight)), ComparisonsKt.minOf(Offset.m4714getYimpl(topLeft), Offset.m4714getYimpl(topRight), Offset.m4714getYimpl(bottomLeft), Offset.m4714getYimpl(bottomRight)), ComparisonsKt.maxOf(Offset.m4713getXimpl(topLeft), Offset.m4713getXimpl(topRight), Offset.m4713getXimpl(bottomLeft), Offset.m4713getXimpl(bottomRight)), ComparisonsKt.maxOf(Offset.m4714getYimpl(topLeft), Offset.m4714getYimpl(topRight), Offset.m4714getYimpl(bottomLeft), Offset.m4714getYimpl(bottomRight)));
            }
        } else {
            Rect rect3 = bounds;
            float f3 = rootWidth;
    ...
    public static final long positionInParent(LayoutCoordinates $this$positionInParent) {
        ...
        return parentLayoutCoordinates != null ? parentLayoutCoordinates.m6361localPositionOfR5De75A($this$positionInParent, Offset.Companion.m4729getZeroF1C5BW0()) : Offset.Companion.m4729getZeroF1C5BW0();
    }
    ...
    public static final androidx.compose.ui.geometry.Rect boundsInParent(androidx.compose.ui.layout.LayoutCoordinates r4) {
        ...
        L_0x0014:
            ...
            long r1 = r4.m6360getSizeYbymL2g()
            int r1 = androidx.compose.ui.unit.IntSize.m7714getWidthimpl(r1)
            float r1 = (float) r1
            long r2 = r4.m6360getSizeYbymL2g()
            int r2 = androidx.compose.ui.unit.IntSize.m7713getHeightimpl(r2)
            float r2 = (float) r2
            r3 = 0
            r0.<init>(r3, r3, r1, r2)
        L_0x002c:
