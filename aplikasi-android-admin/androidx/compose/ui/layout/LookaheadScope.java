...
public interface LookaheadScope {
    ...
    long m6397localLookaheadPositionOfdBAh8RU(LayoutCoordinates $this$localLookaheadPositionOf_u2ddBAh8RU, LayoutCoordinates coordinates) {
        Intrinsics.checkNotNullParameter($this$localLookaheadPositionOf_u2ddBAh8RU, "$this$localLookaheadPositionOf");
        Intrinsics.checkNotNullParameter(coordinates, "coordinates");
        return toLookaheadCoordinates($this$localLookaheadPositionOf_u2ddBAh8RU).m6361localPositionOfR5De75A(toLookaheadCoordinates(coordinates), Offset.Companion.m4729getZeroF1C5BW0());
    }
    ...
    Modifier intermediateLayout(Modifier $this$intermediateLayout, Function4<? super MeasureScope, ? super Measurable, ? super Constraints, ? super IntSize, ? extends MeasureResult> measure) {
        Intrinsics.checkNotNullParameter($this$intermediateLayout, "<this>");
        Intrinsics.checkNotNullParameter(measure, "measure");
        return LookaheadScopeKt.intermediateLayout($this$intermediateLayout, new LookaheadScope$intermediateLayout$1(measure));
    }
}
