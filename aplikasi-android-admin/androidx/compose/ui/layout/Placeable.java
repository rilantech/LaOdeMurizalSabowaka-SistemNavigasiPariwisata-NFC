...
public abstract class Placeable implements Measured {
    ...
    public long apparentToRealOffset = IntOffset.Companion.m7682getZeronOccac();
    private int height;
    ...
    public abstract void m6436placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1);
    ...
    public int getMeasuredWidth() {
        return IntSize.m7714getWidthimpl(this.measuredSize);
    }

    public int getMeasuredHeight() {
        return IntSize.m7713getHeightimpl(this.measuredSize);
    }

    /* access modifiers changed from: protected */
    /* renamed from: getMeasuredSize-YbymL2g  reason: not valid java name */
    public final long m6434getMeasuredSizeYbymL2g() {
        return this.measuredSize;
    }

    /* access modifiers changed from: protected */
    /* renamed from: setMeasuredSize-ozmzZPI  reason: not valid java name */
    public final void m6437setMeasuredSizeozmzZPI(long value) {
        if (!IntSize.m7712equalsimpl0(this.measuredSize, value)) {
    ...
    private final void onMeasuredSizeChanged() {
        this.width = RangesKt.coerceIn(IntSize.m7714getWidthimpl(this.measuredSize), Constraints.m7500getMinWidthimpl(this.measurementConstraints), Constraints.m7498getMaxWidthimpl(this.measurementConstraints));
        this.height = RangesKt.coerceIn(IntSize.m7713getHeightimpl(this.measuredSize), Constraints.m7499getMinHeightimpl(this.measurementConstraints), Constraints.m7497getMaxHeightimpl(this.measurementConstraints));
        this.apparentToRealOffset = IntOffsetKt.IntOffset((this.width - IntSize.m7714getWidthimpl(this.measuredSize)) / 2, (this.height - IntSize.m7713getHeightimpl(this.measuredSize)) / 2);
    }

    /* access modifiers changed from: protected */
    /* renamed from: getMeasurementConstraints-msEJaDk  reason: not valid java name */
    public final long m6435getMeasurementConstraintsmsEJaDk() {
        return this.measurementConstraints;
    }

    /* access modifiers changed from: protected */
    /* renamed from: setMeasurementConstraints-BRTryo0  reason: not valid java name */
    public final void m6438setMeasurementConstraintsBRTryo0(long value) {
        if (!Constraints.m7491equalsimpl0(this.measurementConstraints, value)) {
    ...
    public final long m6433getApparentToRealOffsetnOccac() {
    ...
    public static abstract class PlacementScope {
        ...
        public static /* synthetic */ void m6440placeRelative70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj == null) {
                if ((i & 2) != 0) {
                    f = 0.0f;
                }
                placementScope.m6446placeRelative70tqf50(placeable, j, f);
                return;
            }
        ...
        public final void m6446placeRelative70tqf50(Placeable $this$placeRelative_u2d70tqf50, long position, float zIndex) {
            float f = zIndex;
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position) + IntOffset.m7672getXimpl(other$iv$iv$iv), IntOffset.m7673getYimpl(position) + IntOffset.m7673getYimpl(other$iv$iv$iv)), f, (Function1<? super GraphicsLayerScope, Unit>) null);
                return;
            }
            long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - $this$placeAutoMirrored_u2daW_u2d9_u2dwM$iv.getWidth()) - IntOffset.m7672getXimpl(position), IntOffset.m7673getYimpl(position));
            ...
            $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv2.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position$iv$iv) + IntOffset.m7672getXimpl(other$iv$iv$iv2), IntOffset.m7673getYimpl(position$iv$iv) + IntOffset.m7673getYimpl(other$iv$iv$iv2)), f, (Function1<? super GraphicsLayerScope, Unit>) null);
        }
        ...
        public final void placeRelative(Placeable $this$placeRelative, int x, int y, float zIndex) {
            ...
            if (getParentLayoutDirection() != LayoutDirection.Ltr) {
                if (getParentWidth() != 0) {
                    long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - $this$placeAutoMirrored_u2daW_u2d9_u2dwM$iv.getWidth()) - IntOffset.m7672getXimpl(position$iv), IntOffset.m7673getYimpl(position$iv));
                    Placeable $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv = $this$placeAutoMirrored_u2daW_u2d9_u2dwM$iv;
                    long other$iv$iv$iv = $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv.apparentToRealOffset;
                    $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position$iv$iv) + IntOffset.m7672getXimpl(other$iv$iv$iv), IntOffset.m7673getYimpl(position$iv$iv) + IntOffset.m7673getYimpl(other$iv$iv$iv)), f, (Function1<? super GraphicsLayerScope, Unit>) null);
                    return;
                }
            }
            Placeable $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv2 = $this$placeAutoMirrored_u2daW_u2d9_u2dwM$iv;
            long other$iv$iv$iv2 = $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv2.apparentToRealOffset;
            $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv2.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position$iv) + IntOffset.m7672getXimpl(other$iv$iv$iv2), IntOffset.m7673getYimpl(position$iv) + IntOffset.m7673getYimpl(other$iv$iv$iv2)), f, (Function1<? super GraphicsLayerScope, Unit>) null);
        }
        ...
        public final void place(Placeable $this$place, int x, int y, float zIndex) {
            ...
            $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position$iv) + IntOffset.m7672getXimpl(other$iv$iv), IntOffset.m7673getYimpl(position$iv) + IntOffset.m7673getYimpl(other$iv$iv)), zIndex, (Function1<? super GraphicsLayerScope, Unit>) null);
        }

        /* renamed from: place-70tqf50$default  reason: not valid java name */
        public static /* synthetic */ void m6439place70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj == null) {
                if ((i & 2) != 0) {
                    f = 0.0f;
                }
                placementScope.m6443place70tqf50(placeable, j, f);
                return;
            }
        ...
        public final void m6443place70tqf50(Placeable $this$place_u2d70tqf50, long position, float zIndex) {
            ...
            long other$iv$iv = $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv.apparentToRealOffset;
            $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position) + IntOffset.m7672getXimpl(other$iv$iv), IntOffset.m7673getYimpl(position) + IntOffset.m7673getYimpl(other$iv$iv)), zIndex, (Function1<? super GraphicsLayerScope, Unit>) null);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM$default  reason: not valid java name */
        public static /* synthetic */ void m6441placeRelativeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            float f2;
            ...
            if (obj == null) {
                ...
                placementScope.m6447placeRelativeWithLayeraW9wM(placeable, j, f2, function12);
                return;
            }
        ...
        public final void m6447placeRelativeWithLayeraW9wM(Placeable $this$placeRelativeWithLayer_u2daW_u2d9_u2dwM, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            float f = zIndex;
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                Placeable $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv = $this$placeAutoMirrored_u2daW_u2d9_u2dwM$iv;
                long other$iv$iv$iv = $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv.apparentToRealOffset;
                $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position) + IntOffset.m7672getXimpl(other$iv$iv$iv), IntOffset.m7673getYimpl(position) + IntOffset.m7673getYimpl(other$iv$iv$iv)), f, function1);
                return;
            }
            long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - $this$placeAutoMirrored_u2daW_u2d9_u2dwM$iv.getWidth()) - IntOffset.m7672getXimpl(position), IntOffset.m7673getYimpl(position));
            Placeable $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv2 = $this$placeAutoMirrored_u2daW_u2d9_u2dwM$iv;
            long other$iv$iv$iv2 = $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv2.apparentToRealOffset;
            $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv2.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position$iv$iv) + IntOffset.m7672getXimpl(other$iv$iv$iv2), IntOffset.m7673getYimpl(position$iv$iv) + IntOffset.m7673getYimpl(other$iv$iv$iv2)), f, function1);
        }
        ...
        public final void placeRelativeWithLayer(Placeable $this$placeRelativeWithLayer, int x, int y, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            if (getParentLayoutDirection() != LayoutDirection.Ltr) {
                if (getParentWidth() != 0) {
                    ...
                    Placeable $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv = $this$placeAutoMirrored_u2daW_u2d9_u2dwM$iv;
                    long other$iv$iv$iv = $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv.apparentToRealOffset;
                    $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position$iv$iv) + IntOffset.m7672getXimpl(other$iv$iv$iv), IntOffset.m7673getYimpl(position$iv$iv) + IntOffset.m7673getYimpl(other$iv$iv$iv)), f, function1);
                    return;
                }
            }
            Placeable $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv2 = $this$placeAutoMirrored_u2daW_u2d9_u2dwM$iv;
            long other$iv$iv$iv2 = $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv2.apparentToRealOffset;
            $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv$iv2.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position$iv) + IntOffset.m7672getXimpl(other$iv$iv$iv2), IntOffset.m7673getYimpl(position$iv) + IntOffset.m7673getYimpl(other$iv$iv$iv2)), f, function1);
        }
        ...
        public final void placeWithLayer(Placeable $this$placeWithLayer, int x, int y, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            long other$iv$iv = $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv.apparentToRealOffset;
            $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position$iv) + IntOffset.m7672getXimpl(other$iv$iv), IntOffset.m7673getYimpl(position$iv) + IntOffset.m7673getYimpl(other$iv$iv)), zIndex, function1);
        }

        /* renamed from: placeWithLayer-aW-9-wM$default  reason: not valid java name */
        public static /* synthetic */ void m6442placeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            float f2;
            Function1 function12;
            if (obj == null) {
                if ((i & 2) != 0) {
                ...
                placementScope.m6448placeWithLayeraW9wM(placeable, j, f2, function12);
                return;
            }
        ...
        public final void m6448placeWithLayeraW9wM(Placeable $this$placeWithLayer_u2daW_u2d9_u2dwM, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            long other$iv$iv = $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv.apparentToRealOffset;
            $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position) + IntOffset.m7672getXimpl(other$iv$iv), IntOffset.m7673getYimpl(position) + IntOffset.m7673getYimpl(other$iv$iv)), zIndex, layerBlock);
        }

        /* renamed from: placeAutoMirrored-aW-9-wM$ui_release  reason: not valid java name */
        public final void m6445placeAutoMirroredaW9wM$ui_release(Placeable $this$placeAutoMirrored_u2daW_u2d9_u2dwM, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            float f = zIndex;
            Function1<? super GraphicsLayerScope, Unit> function1 = layerBlock;
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                long other$iv$iv = $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv.apparentToRealOffset;
                $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position) + IntOffset.m7672getXimpl(other$iv$iv), IntOffset.m7673getYimpl(position) + IntOffset.m7673getYimpl(other$iv$iv)), f, function1);
                return;
            }
            long position$iv = IntOffsetKt.IntOffset((getParentWidth() - $this$placeAutoMirrored_u2daW_u2d9_u2dwM.getWidth()) - IntOffset.m7672getXimpl(position), IntOffset.m7673getYimpl(position));
            ...
            $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM$iv2.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position$iv) + IntOffset.m7672getXimpl(other$iv$iv2), IntOffset.m7673getYimpl(position$iv) + IntOffset.m7673getYimpl(other$iv$iv2)), f, function1);
        }

        /* renamed from: placeApparentToRealOffset-aW-9-wM$ui_release  reason: not valid java name */
        public final void m6444placeApparentToRealOffsetaW9wM$ui_release(Placeable $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            $this$placeApparentToRealOffset_u2daW_u2d9_u2dwM.m6436placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m7672getXimpl(position) + IntOffset.m7672getXimpl(other$iv), IntOffset.m7673getYimpl(position) + IntOffset.m7673getYimpl(other$iv)), zIndex, layerBlock);
        }
