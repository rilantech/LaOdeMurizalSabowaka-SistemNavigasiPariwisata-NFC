...
final class AndroidComposeView$_inputModeManager$1 extends Lambda implements Function1<InputMode, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1) {
        return m6759invokeiuPiT84(((InputMode) p1).m5722unboximpl());
    }

    /* renamed from: invoke-iuPiT84  reason: not valid java name */
    public final Boolean m6759invokeiuPiT84(int it) {
        boolean z;
        if (InputMode.m5719equalsimpl0(it, InputMode.Companion.m5724getTouchaOaMEAU())) {
            z = this.this$0.isInTouchMode();
        } else if (InputMode.m5719equalsimpl0(it, InputMode.Companion.m5723getKeyboardaOaMEAU())) {
