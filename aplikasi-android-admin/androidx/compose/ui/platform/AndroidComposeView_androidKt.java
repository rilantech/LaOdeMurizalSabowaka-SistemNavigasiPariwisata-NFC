...
public final class AndroidComposeView_androidKt {
    ...
    public static final void m6770preTransformJiSxe2E(float[] $this$preTransform_u2dJiSxe2E, float[] other) {
        float[] fArr = $this$preTransform_u2dJiSxe2E;
        float[] fArr2 = other;
        float v00 = m6769dotp89u6pk(fArr2, 0, fArr, 0);
        float v01 = m6769dotp89u6pk(fArr2, 0, fArr, 1);
        float v02 = m6769dotp89u6pk(fArr2, 0, fArr, 2);
        float v03 = m6769dotp89u6pk(fArr2, 0, fArr, 3);
        float v10 = m6769dotp89u6pk(fArr2, 1, fArr, 0);
        float v11 = m6769dotp89u6pk(fArr2, 1, fArr, 1);
        float v12 = m6769dotp89u6pk(fArr2, 1, fArr, 2);
        float v13 = m6769dotp89u6pk(fArr2, 1, fArr, 3);
        float v20 = m6769dotp89u6pk(fArr2, 2, fArr, 0);
        float v21 = m6769dotp89u6pk(fArr2, 2, fArr, 1);
        float v22 = m6769dotp89u6pk(fArr2, 2, fArr, 2);
        float v23 = m6769dotp89u6pk(fArr2, 2, fArr, 3);
        float v30 = m6769dotp89u6pk(fArr2, 3, fArr, 0);
        float v31 = m6769dotp89u6pk(fArr2, 3, fArr, 1);
        float v32 = m6769dotp89u6pk(fArr2, 3, fArr, 2);
        float v33 = m6769dotp89u6pk(fArr2, 3, fArr, 3);
        fArr[(0 * 4) + 0] = v00;
        fArr[(0 * 4) + 1] = v01;
        fArr[(0 * 4) + 2] = v02;
        fArr[(0 * 4) + 3] = v03;
    ...
    private static final float m6769dotp89u6pk(float[] m1, int row, float[] m2, int column) {
