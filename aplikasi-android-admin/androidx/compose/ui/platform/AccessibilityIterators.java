...
public final class AccessibilityIterators {
    ...
    public static final class ParagraphTextSegmentIterator extends AbstractTextSegmentIterator {
        ...
        public int[] following(int current) {
            ...
            while (start < textLength && getText().charAt(start) == 10 && !isStartBoundary(start)) {
                start++;
            }
            if (start >= textLength) {
                return null;
        ...
        public int[] preceding(int current) {
            ...
            while (end > 0 && getText().charAt(end - 1) == 10 && !isEndBoundary(end)) {
                end--;
            }
            if (end <= 0) {
                return null;
        ...
        private final boolean isStartBoundary(int index) {
            return getText().charAt(index) != 10 && (index == 0 || getText().charAt(index + -1) == 10);
        }

        private final boolean isEndBoundary(int index) {
            return index > 0 && getText().charAt(index + -1) != 10 && (index == getText().length() || getText().charAt(index) == 10);
        }
    }
    ...
    public static final class LineTextSegmentIterator extends AbstractTextSegmentIterator {
        ...
        public final void initialize(String text, TextLayoutResult layoutResult2) {
            Intrinsics.checkNotNullParameter(text, "text");
            Intrinsics.checkNotNullParameter(layoutResult2, "layoutResult");
            setText(text);
        ...
        public int[] following(int current) {
            ...
            return getRange(getLineEdgeIndex(currentLine, DirectionStart), getLineEdgeIndex(currentLine, DirectionEnd) + 1);
        }
        ...
        public int[] preceding(int current) {
            ...
            return getRange(getLineEdgeIndex(previousLine, DirectionStart), getLineEdgeIndex(previousLine, DirectionEnd) + 1);
        }
        ...
        private final int getLineEdgeIndex(int lineNumber, ResolvedTextDirection direction) {
            ...
            return TextLayoutResult.getLineEnd$default(textLayoutResult5, lineNumber, false, 2, (Object) null) - 1;
        }
    }
    ...
    public static final class PageTextSegmentIterator extends AbstractTextSegmentIterator {
        ...
        public final void initialize(String text, TextLayoutResult layoutResult2, SemanticsNode node2) {
            Intrinsics.checkNotNullParameter(text, "text");
            Intrinsics.checkNotNullParameter(layoutResult2, "layoutResult");
        ...
        public int[] following(int current) {
            ...
            try {
                ...
                float nextPageStartY = ((float) pageHeight) + textLayoutResult3.getLineTop(currentLine);
                TextLayoutResult textLayoutResult4 = this.layoutResult;
                if (textLayoutResult4 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("layoutResult");
                ...
                if (nextPageStartY < textLayoutResult4.getLineTop(textLayoutResult5.getLineCount() - 1)) {
                ...
                return getRange(start, getLineEdgeIndex(currentPageEndLine, DirectionEnd) + 1);
        ...
        public int[] preceding(int current) {
            ...
            try {
                ...
                float previousPageEndY = textLayoutResult3.getLineTop(currentLine) - ((float) pageHeight);
                ...
                return getRange(getLineEdgeIndex(currentPageStartLine, DirectionStart), end);
            } catch (IllegalStateException e) {
                return null;
            }
        }
