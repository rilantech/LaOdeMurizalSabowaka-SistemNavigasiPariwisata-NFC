...
public interface WindowInfo {
    ...
    static /* synthetic */ void m6850getKeyboardModifiersk7X9c1A$annotations() {
    }

    boolean isWindowFocused();

    /* renamed from: getKeyboardModifiers-k7X9c1A  reason: not valid java name */
    int m6851getKeyboardModifiersk7X9c1A() {
        return WindowInfoImpl.Companion.getGlobalKeyboardModifiers$ui_release().getValue().m6258unboximpl();
    }
}
