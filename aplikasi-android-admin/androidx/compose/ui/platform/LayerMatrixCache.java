...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m6800calculateMatrixGrdbGEg(T target) {
        float[] matrix = this.matrixCache;
        if (matrix == null) {
            matrix = androidx.compose.ui.graphics.Matrix.m5192constructorimpl$default((float[]) null, 1, (DefaultConstructorMarker) null);
        ...
        if (prevMatrix == null || !Intrinsics.areEqual((Object) cachedMatrix, (Object) prevMatrix)) {
            AndroidMatrixConversions_androidKt.m4825setFromtUYjHk(matrix, cachedMatrix);
    ...
    public final float[] m6799calculateInverseMatrixbWbORWo(T target) {
        ...
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m6797invertToJiSxe2E(m6800calculateMatrixGrdbGEg(target), matrix);
