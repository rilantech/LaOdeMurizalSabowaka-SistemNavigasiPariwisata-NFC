...
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    public long m4595alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long remaining = IntSizeKt.IntSize(IntSize.m7714getWidthimpl(space) - IntSize.m7714getWidthimpl(size), IntSize.m7713getHeightimpl(space) - IntSize.m7713getHeightimpl(size));
        float f = (float) 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((this.horizontalBias + f) * (((float) IntSize.m7714getWidthimpl(remaining)) / 2.0f)), MathKt.roundToInt((f + this.verticalBias) * (((float) IntSize.m7713getHeightimpl(remaining)) / 2.0f)));
    }
