...
public interface MotionDurationScale extends CoroutineContext.Element {
    ...
    public static final class DefaultImpls {
        public static <R> R fold(MotionDurationScale $this, R initial, Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
            Intrinsics.checkNotNullParameter(operation, "operation");
            return CoroutineContext.Element.DefaultImpls.fold($this, initial, operation);
        }

        public static <E extends CoroutineContext.Element> E get(MotionDurationScale $this, CoroutineContext.Key<E> key) {
