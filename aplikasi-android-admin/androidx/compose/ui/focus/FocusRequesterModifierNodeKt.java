    ...
    public static final boolean requestFocus(FocusRequesterModifierNode $this$requestFocus) {
        ...
        while (true) {
            ...
            if (this_$iv$iv$iv2 == null) {
                                ...
                                if (node$iv$iv == null) {
                                    ...
                                    while (this_$iv$iv$iv3 != null) {
                                        if (this_$iv$iv$iv3 instanceof FocusTargetNode) {
                                            ...
                                            return TwoDimensionalFocusSearchKt.m4674findChildCorrespondingToFocusEnterOMvw8(focusTarget, FocusDirection.Companion.m4638getEnterdhqQ8s(), FocusRequesterModifierNodeKt$requestFocus$1$1.INSTANCE);
                                        }
                ...
                return TwoDimensionalFocusSearchKt.m4674findChildCorrespondingToFocusEnterOMvw8(focusTarget2, FocusDirection.Companion.m4638getEnterdhqQ8s(), FocusRequesterModifierNodeKt$requestFocus$1$1.INSTANCE);
            } else {
