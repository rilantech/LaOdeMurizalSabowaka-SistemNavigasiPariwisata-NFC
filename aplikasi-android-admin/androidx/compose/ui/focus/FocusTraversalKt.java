...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m4665customFocusSearchOMvw8(FocusTargetNode $this$customFocusSearch_u2d_u2dOM_u2dvw8, int focusDirection, LayoutDirection layoutDirection) {
        FocusRequester it;
        FocusRequester it2;
        ...
        if (FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4642getNextdhqQ8s())) {
            return focusProperties.getNext();
        }
        if (FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4644getPreviousdhqQ8s())) {
            return focusProperties.getPrevious();
        }
        if (FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4646getUpdhqQ8s())) {
            return focusProperties.getUp();
        }
        if (FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4637getDowndhqQ8s())) {
            return focusProperties.getDown();
        }
        boolean z = true;
        if (FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4641getLeftdhqQ8s())) {
            ...
            return it2;
        } else if (FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4645getRightdhqQ8s())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
            ...
            return it;
        } else if (FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4638getEnterdhqQ8s())) {
            return focusProperties.getEnter().invoke(FocusDirection.m4626boximpl(focusDirection));
        } else {
            if (FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4639getExitdhqQ8s())) {
                return focusProperties.getExit().invoke(FocusDirection.m4626boximpl(focusDirection));
            }
    ...
    public static final boolean m4666focusSearchsMXa3k8(FocusTargetNode $this$focusSearch_u2dsMXa3k8, int focusDirection, LayoutDirection layoutDirection, Function1<? super FocusTargetNode, Boolean> onFound) {
        int direction;
        Boolean r2;
        ...
        if (FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4642getNextdhqQ8s()) ? true : FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4644getPreviousdhqQ8s())) {
            return OneDimensionalFocusSearchKt.m4669oneDimensionalFocusSearchOMvw8($this$focusSearch_u2dsMXa3k8, focusDirection, onFound);
        }
        if (!(FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4641getLeftdhqQ8s()) ? true : FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4645getRightdhqQ8s()) ? true : FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4646getUpdhqQ8s()))) {
            z = FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4637getDowndhqQ8s());
        }
        if (z) {
            Boolean r1 = TwoDimensionalFocusSearchKt.m4678twoDimensionalFocusSearchOMvw8($this$focusSearch_u2dsMXa3k8, focusDirection, onFound);
            if (r1 != null) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    direction = FocusDirection.Companion.m4645getRightdhqQ8s();
                    break;
                case 2:
                    direction = FocusDirection.Companion.m4641getLeftdhqQ8s();
                    break;
                default:
                    throw new NoWhenBranchMatchedException();
            }
            FocusTargetNode findActiveFocusNode = findActiveFocusNode($this$focusSearch_u2dsMXa3k8);
            if (findActiveFocusNode == null || (r2 = TwoDimensionalFocusSearchKt.m4678twoDimensionalFocusSearchOMvw8(findActiveFocusNode, direction, onFound)) == null) {
                return false;
            }
            return r2.booleanValue();
        } else if (FocusDirection.m4629equalsimpl0(focusDirection, FocusDirection.Companion.m4639getExitdhqQ8s())) {
            ...
            throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + FocusDirection.m4631toStringimpl(focusDirection)).toString());
        }
    }
