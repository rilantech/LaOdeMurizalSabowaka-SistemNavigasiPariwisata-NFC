...
public final class OneDimensionalFocusSearchKt {
    ...
    public static final boolean m4669oneDimensionalFocusSearchOMvw8(FocusTargetNode $this$oneDimensionalFocusSearch_u2d_u2dOM_u2dvw8, int direction, Function1<? super FocusTargetNode, Boolean> onFound) {
        Intrinsics.checkNotNullParameter($this$oneDimensionalFocusSearch_u2d_u2dOM_u2dvw8, "$this$oneDimensionalFocusSearch");
        Intrinsics.checkNotNullParameter(onFound, "onFound");
        if (FocusDirection.m4629equalsimpl0(direction, FocusDirection.Companion.m4642getNextdhqQ8s())) {
            return forwardFocusSearch($this$oneDimensionalFocusSearch_u2d_u2dOM_u2dvw8, onFound);
        }
        if (FocusDirection.m4629equalsimpl0(direction, FocusDirection.Companion.m4644getPreviousdhqQ8s())) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[$this$forwardFocusSearch.getFocusState().ordinal()]) {
            case 1:
                ...
                if (focusedChild != null) {
                    return forwardFocusSearch(focusedChild, onFound) || m4668generateAndSearchChildren4C6V_qg($this$forwardFocusSearch, focusedChild, FocusDirection.Companion.m4642getNextdhqQ8s(), onFound);
                }
            ...
            case 1:
                ...
                if (focusedChild != null) {
                    switch (WhenMappings.$EnumSwitchMapping$0[focusedChild.getFocusState().ordinal()]) {
                        case 1:
                            if (backwardFocusSearch(focusedChild, onFound) || m4668generateAndSearchChildren4C6V_qg($this$backwardFocusSearch, focusedChild, FocusDirection.Companion.m4644getPreviousdhqQ8s(), onFound)) {
                                return true;
                            }
                        ...
                        case 2:
                        case 3:
                            return m4668generateAndSearchChildren4C6V_qg($this$backwardFocusSearch, focusedChild, FocusDirection.Companion.m4644getPreviousdhqQ8s(), onFound);
                        case 4:
                            throw new IllegalStateException(NoActiveChild.toString());
                        default:
                            throw new NoWhenBranchMatchedException();
    ...
    private static final boolean m4668generateAndSearchChildren4C6V_qg(FocusTargetNode $this$generateAndSearchChildren_u2d4C6V_qg, FocusTargetNode focusedItem, int direction, Function1<? super FocusTargetNode, Boolean> onFound) {
        if (m4670searchChildren4C6V_qg($this$generateAndSearchChildren_u2d4C6V_qg, focusedItem, direction, onFound)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m4625searchBeyondBoundsOMvw8($this$generateAndSearchChildren_u2d4C6V_qg, direction, new OneDimensionalFocusSearchKt$generateAndSearchChildren$1($this$generateAndSearchChildren_u2d4C6V_qg, focusedItem, direction, onFound));
        if (bool != null) {
    ...
    public static final boolean m4670searchChildren4C6V_qg(FocusTargetNode $this$searchChildren_u2d4C6V_qg, FocusTargetNode focusedItem, int direction, Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        if ($this$searchChildren_u2d4C6V_qg.getFocusState() == FocusStateImpl.ActiveParent) {
            ...
            if ($this$visitChildren$iv$iv.getNode().isAttached()) {
                ...
                if (FocusDirection.m4629equalsimpl0(i, FocusDirection.Companion.m4642getNextdhqQ8s())) {
                ...
                } else if (FocusDirection.m4629equalsimpl0(i, FocusDirection.Companion.m4644getPreviousdhqQ8s())) {
                ...
                if (FocusDirection.m4629equalsimpl0(i, FocusDirection.Companion.m4642getNextdhqQ8s()) || !$this$searchChildren_u2d4C6V_qg.fetchFocusProperties$ui_release().getCanFocus() || isRoot($this$searchChildren_u2d4C6V_qg)) {
                    return false;
                }
    ...
    private static final boolean pickChildForForwardSearch(androidx.compose.ui.focus.FocusTargetNode r32, kotlin.jvm.functions.Function1<? super androidx.compose.ui.focus.FocusTargetNode, java.lang.Boolean> r33) {
        /*
            ...
            int r5 = androidx.compose.ui.node.NodeKind.m6666constructorimpl(r6)
            r6 = 0
            r7 = r5
            r8 = r3
            r9 = 0
