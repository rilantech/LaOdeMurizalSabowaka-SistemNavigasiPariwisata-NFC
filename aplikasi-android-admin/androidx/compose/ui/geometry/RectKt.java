...
public final class RectKt {
    ...
    public static final Rect m4753Recttz77jQw(long offset, long size) {
        return new Rect(Offset.m4713getXimpl(offset), Offset.m4714getYimpl(offset), Offset.m4713getXimpl(offset) + Size.m4782getWidthimpl(size), Offset.m4714getYimpl(offset) + Size.m4779getHeightimpl(size));
    }

    /* renamed from: Rect-0a9Yr6o  reason: not valid java name */
    public static final Rect m4751Rect0a9Yr6o(long topLeft, long bottomRight) {
        return new Rect(Offset.m4713getXimpl(topLeft), Offset.m4714getYimpl(topLeft), Offset.m4713getXimpl(bottomRight), Offset.m4714getYimpl(bottomRight));
    }

    /* renamed from: Rect-3MmeM6k  reason: not valid java name */
    public static final Rect m4752Rect3MmeM6k(long center, float radius) {
        return new Rect(Offset.m4713getXimpl(center) - radius, Offset.m4714getYimpl(center) - radius, Offset.m4713getXimpl(center) + radius, Offset.m4714getYimpl(center) + radius);
    }
