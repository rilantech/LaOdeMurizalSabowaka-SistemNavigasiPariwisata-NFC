...
public final class CornerRadiusKt {
    public static final long CornerRadius(float x, float y) {
        return CornerRadius.m4682constructorimpl((((long) Float.floatToIntBits(x)) << 32) | (4294967295L & ((long) Float.floatToIntBits(y))));
    }
    ...
    public static final long m4699lerp3Ry4LBc(long start, long stop, float fraction) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m4688getXimpl(start), CornerRadius.m4688getXimpl(stop), fraction), MathHelpersKt.lerp(CornerRadius.m4689getYimpl(start), CornerRadius.m4689getYimpl(stop), fraction));
    }
}
