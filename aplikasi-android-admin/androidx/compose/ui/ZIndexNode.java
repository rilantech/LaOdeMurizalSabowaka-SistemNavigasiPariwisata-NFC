...
public final class ZIndexNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public ZIndexNode(float zIndex2) {
        this.zIndex = zIndex2;
    }
    ...
    public MeasureResult m4598measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), placeable.getHeight(), (Map) null, new ZIndexNode$measure$1(placeable, this), 4, (Object) null);
    }
