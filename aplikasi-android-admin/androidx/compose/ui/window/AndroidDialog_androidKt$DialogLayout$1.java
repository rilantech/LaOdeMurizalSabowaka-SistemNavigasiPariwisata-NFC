...
final class AndroidDialog_androidKt$DialogLayout$1 implements MeasurePolicy {
    ...
    public final MeasureResult m7795measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> measurables, long constraints) {
        Object maxElem$iv;
        ...
        int width = placeable != null ? placeable.getWidth() : Constraints.m7500getMinWidthimpl(constraints);
        ...
        return MeasureScope.layout$default($this$Layout, width, placeable2 != null ? placeable2.getHeight() : Constraints.m7499getMinHeightimpl(constraints), (Map) null, new AndroidDialog_androidKt$DialogLayout$1$measure$1(placeables), 4, (Object) null);
    }
}
