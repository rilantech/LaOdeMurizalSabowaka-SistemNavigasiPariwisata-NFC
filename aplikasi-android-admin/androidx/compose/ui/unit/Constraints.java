...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m7486boximpl(long j) {
    ...
    public static boolean m7490equalsimpl(long j, Object obj) {
        return (obj instanceof Constraints) && j == ((Constraints) obj).m7504unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m7491equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public boolean equals(Object obj) {
        return m7490equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m7501hashCodeimpl(this.value);
    }
    ...
    private static final int m7492getFocusIndeximpl(long arg0) {
        return (int) (3 & arg0);
    }

    /* renamed from: getMinWidth-impl  reason: not valid java name */
    public static final int m7500getMinWidthimpl(long arg0) {
        return ((int) (arg0 >> 2)) & WidthMask[m7492getFocusIndeximpl(arg0)];
    }

    /* renamed from: getMaxWidth-impl  reason: not valid java name */
    public static final int m7498getMaxWidthimpl(long arg0) {
        int width = ((int) (arg0 >> 33)) & WidthMask[m7492getFocusIndeximpl(arg0)];
        if (width == 0) {
    ...
    public static final int m7499getMinHeightimpl(long arg0) {
        int focus = m7492getFocusIndeximpl(arg0);
        return ((int) (arg0 >> MinHeightOffsets[focus])) & HeightMask[focus];
    }

    /* renamed from: getMaxHeight-impl  reason: not valid java name */
    public static final int m7497getMaxHeightimpl(long arg0) {
        int focus = m7492getFocusIndeximpl(arg0);
    ...
    public static final boolean m7494getHasBoundedWidthimpl(long arg0) {
        return (((int) (arg0 >> 33)) & WidthMask[m7492getFocusIndeximpl(arg0)]) != 0;
    }

    /* renamed from: getHasBoundedHeight-impl  reason: not valid java name */
    public static final boolean m7493getHasBoundedHeightimpl(long arg0) {
        int focus = m7492getFocusIndeximpl(arg0);
        return (((int) (arg0 >> (MinHeightOffsets[focus] + 31))) & HeightMask[focus]) != 0;
    }

    /* renamed from: getHasFixedWidth-impl  reason: not valid java name */
    public static final boolean m7496getHasFixedWidthimpl(long arg0) {
        return m7498getMaxWidthimpl(arg0) == m7500getMinWidthimpl(arg0);
    }

    /* renamed from: getHasFixedHeight-impl  reason: not valid java name */
    public static final boolean m7495getHasFixedHeightimpl(long arg0) {
        return m7497getMaxHeightimpl(arg0) == m7499getMinHeightimpl(arg0);
    }

    /* renamed from: isZero-impl  reason: not valid java name */
    public static final boolean m7502isZeroimpl(long arg0) {
        return m7498getMaxWidthimpl(arg0) == 0 || m7497getMaxHeightimpl(arg0) == 0;
    }

    /* renamed from: copy-Zbe2FdA$default  reason: not valid java name */
    public static /* synthetic */ long m7489copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        int i6;
        int i7;
        int i8;
        int i9;
        if ((i5 & 1) != 0) {
            i6 = m7500getMinWidthimpl(j);
        } else {
            i6 = i;
        }
        if ((i5 & 2) != 0) {
            i7 = m7498getMaxWidthimpl(j);
        } else {
            i7 = i2;
        }
        if ((i5 & 4) != 0) {
            i8 = m7499getMinHeightimpl(j);
        } else {
            i8 = i3;
        }
        if ((i5 & 8) != 0) {
            i9 = m7497getMaxHeightimpl(j);
        } else {
            i9 = i4;
        }
        return m7488copyZbe2FdA(j, i6, i7, i8, i9);
    }

    /* renamed from: copy-Zbe2FdA  reason: not valid java name */
    public static final long m7488copyZbe2FdA(long arg0, int minWidth, int maxWidth, int minHeight, int maxHeight) {
        boolean z = true;
        if (minHeight >= 0 && minWidth >= 0) {
            if (maxWidth >= minWidth || maxWidth == Integer.MAX_VALUE) {
                ...
                if (z) {
                    return Companion.m7505createConstraintsZbe2FdA$ui_unit_release(minWidth, maxWidth, minHeight, maxHeight);
                }
    ...
    public String toString() {
        return m7503toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m7503toStringimpl(long arg0) {
        int maxWidth = m7498getMaxWidthimpl(arg0);
        String maxHeightStr = "Infinity";
        String maxWidthStr = maxWidth == Integer.MAX_VALUE ? maxHeightStr : String.valueOf(maxWidth);
        int maxHeight = m7497getMaxHeightimpl(arg0);
        if (maxHeight != Integer.MAX_VALUE) {
            maxHeightStr = String.valueOf(maxHeight);
        }
        return "Constraints(minWidth = " + m7500getMinWidthimpl(arg0) + ", maxWidth = " + maxWidthStr + ", minHeight = " + m7499getMinHeightimpl(arg0) + ", maxHeight = " + maxHeightStr + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m7506fixedJhjzzOo(int width, int height) {
            if (width >= 0 && height >= 0) {
                return m7505createConstraintsZbe2FdA$ui_unit_release(width, width, height, height);
            }
            throw new IllegalArgumentException(("width(" + width + ") and height(" + height + ") must be >= 0").toString());
        }

        /* renamed from: fixedWidth-OenEA2s  reason: not valid java name */
        public final long m7508fixedWidthOenEA2s(int width) {
            if (width >= 0) {
                return m7505createConstraintsZbe2FdA$ui_unit_release(width, width, 0, Integer.MAX_VALUE);
            }
            throw new IllegalArgumentException(("width(" + width + ") must be >= 0").toString());
        }

        /* renamed from: fixedHeight-OenEA2s  reason: not valid java name */
        public final long m7507fixedHeightOenEA2s(int height) {
            if (height >= 0) {
                return m7505createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, height, height);
            }
            throw new IllegalArgumentException(("height(" + height + ") must be >= 0").toString());
        }

        /* renamed from: createConstraints-Zbe2FdA$ui_unit_release  reason: not valid java name */
        public final long m7505createConstraintsZbe2FdA$ui_unit_release(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            long focus;
            int i = maxWidth;
            int i2 = maxHeight;
            ...
            if (widthBits + heightBits <= 31) {
                ...
                int i4 = widthBits;
                long j = focus;
                return Constraints.m7487constructorimpl((((long) maxWidthValue) << 33) | (((long) minWidth) << 2) | focus | (((long) minHeight) << minHeightOffset) | (((long) maxHeightValue) << (minHeightOffset + 31)));
            }
