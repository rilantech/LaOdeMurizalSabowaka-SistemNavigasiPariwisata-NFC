...
public final class IntRectKt {
    ...
    public static final IntRect m7704IntRectVbeCjmY(long offset, long size) {
        return new IntRect(IntOffset.m7672getXimpl(offset), IntOffset.m7673getYimpl(offset), IntOffset.m7672getXimpl(offset) + IntSize.m7714getWidthimpl(size), IntOffset.m7673getYimpl(offset) + IntSize.m7713getHeightimpl(size));
    }

    /* renamed from: IntRect-E1MhUcY  reason: not valid java name */
    public static final IntRect m7703IntRectE1MhUcY(long topLeft, long bottomRight) {
        return new IntRect(IntOffset.m7672getXimpl(topLeft), IntOffset.m7673getYimpl(topLeft), IntOffset.m7672getXimpl(bottomRight), IntOffset.m7673getYimpl(bottomRight));
    }

    /* renamed from: IntRect-ar5cAso  reason: not valid java name */
    public static final IntRect m7705IntRectar5cAso(long center, int radius) {
        return new IntRect(IntOffset.m7672getXimpl(center) - radius, IntOffset.m7673getYimpl(center) - radius, IntOffset.m7672getXimpl(center) + radius, IntOffset.m7673getYimpl(center) + radius);
    }
    ...
    public static final Rect toRect(IntRect $this$toRect) {
        ...
        return new Rect((float) $this$toRect.getLeft(), (float) $this$toRect.getTop(), (float) $this$toRect.getRight(), (float) $this$toRect.getBottom());
    }
