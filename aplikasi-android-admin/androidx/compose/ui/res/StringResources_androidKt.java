...
public final class StringResources_androidKt {
    public static final String stringResource(int id, Composer $composer, int $changed) {
        ...
        String string = Resources_androidKt.resources($composer, 0).getString(id);
    ...
    public static final String stringResource(int id, Object[] formatArgs, Composer $composer, int $changed) {
        ...
        String string = Resources_androidKt.resources($composer, 0).getString(id, Arrays.copyOf(formatArgs, formatArgs.length));
    ...
    public static final String[] stringArrayResource(int id, Composer $composer, int $changed) {
        ...
        String[] stringArray = Resources_androidKt.resources($composer, 0).getStringArray(id);
    ...
    public static final String pluralStringResource(int id, int count, Composer $composer, int $changed) {
        ...
        String quantityString = Resources_androidKt.resources($composer, 0).getQuantityString(id, count);
    ...
    public static final String pluralStringResource(int id, int count, Object[] formatArgs, Composer $composer, int $changed) {
        ...
        String quantityString = Resources_androidKt.resources($composer, 0).getQuantityString(id, count, Arrays.copyOf(formatArgs, formatArgs.length));
