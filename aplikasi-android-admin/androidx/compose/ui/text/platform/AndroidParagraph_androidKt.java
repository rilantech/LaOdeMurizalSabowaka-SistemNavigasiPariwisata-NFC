...
public final class AndroidParagraph_androidKt {
    ...
    public static final Paragraph ActualParagraph(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, int maxLines, boolean ellipsis, float width, Density density, Font.ResourceLoader resourceLoader) {
        ...
        return new AndroidParagraph(new AndroidParagraphIntrinsics(text, style, spanStyles, placeholders, DelegatingFontLoaderForDeprecatedUsage_androidKt.createFontFamilyResolver(resourceLoader), density), maxLines, ellipsis, ConstraintsKt.Constraints$default(0, ParagraphKt.ceilToInt(width), 0, 0, 13, (Object) null), (DefaultConstructorMarker) null);
    }

    /* renamed from: ActualParagraph-O3s9Psw  reason: not valid java name */
    public static final Paragraph m7282ActualParagraphO3s9Psw(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, int maxLines, boolean ellipsis, long constraints, Density density, FontFamily.Resolver fontFamilyResolver) {
        String str = text;
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(spanStyles, "spanStyles");
        ...
        return new AndroidParagraph(new AndroidParagraphIntrinsics(text, style, spanStyles, placeholders, fontFamilyResolver, density), maxLines, ellipsis, constraints, (DefaultConstructorMarker) null);
    }

    /* renamed from: ActualParagraph--hBUhpc  reason: not valid java name */
    public static final Paragraph m7281ActualParagraphhBUhpc(ParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {
        Intrinsics.checkNotNullParameter(paragraphIntrinsics, "paragraphIntrinsics");
        return new AndroidParagraph((AndroidParagraphIntrinsics) paragraphIntrinsics, maxLines, ellipsis, constraints, (DefaultConstructorMarker) null);
    }
}
