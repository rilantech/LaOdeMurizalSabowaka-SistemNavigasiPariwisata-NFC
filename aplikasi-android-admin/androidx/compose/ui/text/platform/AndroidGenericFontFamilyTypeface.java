...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    public AndroidGenericFontFamilyTypeface(GenericFontFamily fontFamily2) {
        Intrinsics.checkNotNullParameter(fontFamily2, "fontFamily");
        this.fontFamily = fontFamily2;
        Typeface create = Typeface.create(fontFamily2.getName(), 0);
    ...
    public Typeface m7274getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        Typeface r0 = m7273buildStyledTypefaceFO1MlWM(fontWeight, fontStyle);
        Intrinsics.checkNotNullExpressionValue(r0, "buildStyledTypeface(fontWeight, fontStyle)");
        return r0;
    }

    /* renamed from: buildStyledTypeface-FO1MlWM  reason: not valid java name */
    private final Typeface m7273buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int fontStyle) {
        return TypefaceHelperMethodsApi28.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m7134equalsimpl0(fontStyle, FontStyle.Companion.m7138getItalic_LCdwA()));
    }
}
