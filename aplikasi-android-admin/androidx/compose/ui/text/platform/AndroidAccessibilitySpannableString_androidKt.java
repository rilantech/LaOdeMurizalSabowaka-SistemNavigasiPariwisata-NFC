...
public final class AndroidAccessibilitySpannableString_androidKt {
    ...
    private static final void setSpanStyle(SpannableString $this$setSpanStyle, SpanStyle spanStyle, int start, int end, Density density, FontFamily.Resolver fontFamilyResolver) {
        SpannableExtensions_androidKt.m7300setColorRPmYEkk($this$setSpanStyle, spanStyle.m6994getColor0d7_KjU(), start, end);
        SpannableExtensions_androidKt.m7301setFontSizeKmRG4DE($this$setSpanStyle, spanStyle.m6995getFontSizeXSAIIZE(), density, start, end);
        if (!(spanStyle.getFontWeight() == null && spanStyle.m6996getFontStyle4Lr2A7w() == null)) {
            FontWeight fontWeight = spanStyle.getFontWeight();
            if (fontWeight == null) {
                fontWeight = FontWeight.Companion.getNormal();
            }
            FontStyle r2 = spanStyle.m6996getFontStyle4Lr2A7w();
            $this$setSpanStyle.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m7084getAndroidTypefaceStyleFO1MlWM(fontWeight, r2 != null ? r2.m7137unboximpl() : FontStyle.Companion.m7139getNormal_LCdwA())), start, end, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                FontSynthesis r0 = spanStyle.m6997getFontSynthesisZQGJjVo();
                Object value = FontFamily.Resolver.m7107resolveDPcqOEQ$default(fontFamilyResolver, fontFamily, (FontWeight) null, 0, r0 != null ? r0.m7148unboximpl() : FontSynthesis.Companion.m7149getAllGVVA2EU(), 6, (Object) null).getValue();
        ...
        SpannableExtensions_androidKt.m7298setBackgroundRPmYEkk($this$setSpanStyle, spanStyle.m6992getBackground0d7_KjU(), start, end);
    }
}
