...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public final long m7307getSizeNHjbRc() {
        return this.size;
    }

    /* renamed from: setSize-uvyYCjk  reason: not valid java name */
    public final void m7308setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public void updateDrawState(TextPaint textPaint) {
        ...
        if (!(this.size == Size.Companion.m4790getUnspecifiedNHjbRc())) {
            Pair finalCachedShader = this.cachedShader;
            if (finalCachedShader == null || !Size.m4778equalsimpl0(finalCachedShader.getFirst().m4787unboximpl(), this.size)) {
                shader = this.shaderBrush.m5307createShaderuvyYCjk(this.size);
            } else {
                shader = (Shader) finalCachedShader.getSecond();
            }
            textPaint.setShader(shader);
            this.cachedShader = TuplesKt.to(Size.m4770boximpl(this.size), shader);
        }
    }
}
