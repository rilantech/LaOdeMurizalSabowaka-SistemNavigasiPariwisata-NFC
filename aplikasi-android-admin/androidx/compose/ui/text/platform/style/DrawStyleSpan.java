...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (Intrinsics.areEqual((Object) drawStyle2, (Object) Fill.INSTANCE)) {
                ...
                $this$updateDrawState_u24lambda_u240.setStrokeJoin(m7306toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).m5657getJoinLxFBmk8()));
                $this$updateDrawState_u24lambda_u240.setStrokeCap(m7305toAndroidCapBeK7IIE(((Stroke) this.drawStyle).m5656getCapKaPHkGw()));
    ...
    private final Paint.Join m7306toAndroidJoinWw9F2mQ(int $this$toAndroidJoin_u2dWw9F2mQ) {
        if (StrokeJoin.m5357equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.Companion.m5362getMiterLxFBmk8())) {
            return Paint.Join.MITER;
        }
        if (StrokeJoin.m5357equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.Companion.m5363getRoundLxFBmk8())) {
            return Paint.Join.ROUND;
        }
        if (StrokeJoin.m5357equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.Companion.m5361getBevelLxFBmk8())) {
    ...
    private final Paint.Cap m7305toAndroidCapBeK7IIE(int $this$toAndroidCap_u2dBeK7IIE) {
        if (StrokeCap.m5347equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.Companion.m5351getButtKaPHkGw())) {
            return Paint.Cap.BUTT;
        }
        if (StrokeCap.m5347equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.Companion.m5352getRoundKaPHkGw())) {
            return Paint.Cap.ROUND;
        }
        if (StrokeCap.m5347equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.Companion.m5353getSquareKaPHkGw())) {
