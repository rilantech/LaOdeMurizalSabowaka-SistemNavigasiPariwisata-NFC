...
public final class AndroidMultiParagraphDrawKt {
    ...
    public static /* synthetic */ void m7276drawMultiParagraph7AXcY_I$default(MultiParagraph multiParagraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
        Shadow shadow2;
        ...
        m7275drawMultiParagraph7AXcY_I(multiParagraph, canvas, brush, f2, shadow2, textDecoration2, drawStyle2, (i2 & 64) != 0 ? BlendMode.Companion.m4896getSrcOver0nO6VwU() : i);
    }

    /* renamed from: drawMultiParagraph-7AXcY_I  reason: not valid java name */
    public static final void m7275drawMultiParagraph7AXcY_I(MultiParagraph $this$drawMultiParagraph_u2d7AXcY_I, Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        ...
        if ($this$drawMultiParagraph_u2d7AXcY_I.getParagraphInfoList$ui_text_release().size() <= 1) {
            m7277drawParagraphs7AXcY_I($this$drawMultiParagraph_u2d7AXcY_I, canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
            ...
            Shader shader = ((ShaderBrush) brush2).m5307createShaderuvyYCjk(SizeKt.Size(width, height));
            ...
            for (int size2 = $this$fastForEach$iv2.size(); index$iv2 < size2; size2 = size2) {
                ...
                it2.getParagraph().m6930painthn5TExg(canvas, BrushKt.ShaderBrush(shader), alpha, shadow, decoration, drawStyle, blendMode);
    ...
    private static final void m7277drawParagraphs7AXcY_I(MultiParagraph $this$drawParagraphs_u2d7AXcY_I, Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        List $this$fastForEach$iv = $this$drawParagraphs_u2d7AXcY_I.getParagraphInfoList$ui_text_release();
        int size = $this$fastForEach$iv.size();
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ParagraphInfo it = $this$fastForEach$iv.get(index$iv);
            it.getParagraph().m6930painthn5TExg(canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
