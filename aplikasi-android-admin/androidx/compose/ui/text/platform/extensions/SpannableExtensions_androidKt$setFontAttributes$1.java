...
final class SpannableExtensions_androidKt$setFontAttributes$1 extends Lambda implements Function3<SpanStyle, Integer, Integer, Unit> {
    ...
    public final void invoke(SpanStyle spanStyle, int start, int end) {
        ...
        FontStyle r5 = spanStyle.m6996getFontStyle4Lr2A7w();
        FontStyle r52 = FontStyle.m7131boximpl(r5 != null ? r5.m7137unboximpl() : FontStyle.Companion.m7139getNormal_LCdwA());
        FontSynthesis r6 = spanStyle.m6997getFontSynthesisZQGJjVo();
        spannable.setSpan(new TypefaceSpan(function4.invoke(fontFamily, fontWeight, r52, FontSynthesis.m7140boximpl(r6 != null ? r6.m7148unboximpl() : FontSynthesis.Companion.m7149getAllGVVA2EU()))), start, end, 33);
    }
}
