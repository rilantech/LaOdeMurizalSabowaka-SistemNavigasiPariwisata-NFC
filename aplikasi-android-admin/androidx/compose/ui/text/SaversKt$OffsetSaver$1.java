...
final class SaversKt$OffsetSaver$1 extends Lambda implements Function2<SaverScope, Offset, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m6978invokeUv8p0NA((SaverScope) p1, ((Offset) p2).m4723unboximpl());
    }

    /* renamed from: invoke-Uv8p0NA  reason: not valid java name */
    public final Object m6978invokeUv8p0NA(SaverScope $this$Saver, long it) {
        Intrinsics.checkNotNullParameter($this$Saver, "$this$Saver");
        if (Offset.m4710equalsimpl0(it, Offset.Companion.m4728getUnspecifiedF1C5BW0())) {
            return (Serializable) false;
        }
        return CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(Offset.m4713getXimpl(it))), SaversKt.save(Float.valueOf(Offset.m4714getYimpl(it))));
    }
}
