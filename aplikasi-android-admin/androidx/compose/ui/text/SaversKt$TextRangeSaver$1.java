...
final class SaversKt$TextRangeSaver$1 extends Lambda implements Function2<SaverScope, TextRange, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object p1, Object p2) {
        return m6980invokeFDrldGo((SaverScope) p1, ((TextRange) p2).m7039unboximpl());
    }

    /* renamed from: invoke-FDrldGo  reason: not valid java name */
    public final Object m6980invokeFDrldGo(SaverScope $this$Saver, long it) {
        Intrinsics.checkNotNullParameter($this$Saver, "$this$Saver");
        return CollectionsKt.arrayListOf(SaversKt.save(Integer.valueOf(TextRange.m7035getStartimpl(it))), SaversKt.save(Integer.valueOf(TextRange.m7030getEndimpl(it))));
    }
}
