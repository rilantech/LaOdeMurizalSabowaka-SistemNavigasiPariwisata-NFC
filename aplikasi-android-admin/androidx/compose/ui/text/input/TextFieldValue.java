...
public final class TextFieldValue {
    ...
    private TextFieldValue(AnnotatedString annotatedString2, long selection2, TextRange composition2) {
        ...
        this.selection = TextRangeKt.m7041coerceIn8ffj60Q(selection2, 0, getText().length());
        this.composition = composition2 != null ? TextRange.m7023boximpl(TextRangeKt.m7041coerceIn8ffj60Q(composition2.m7039unboximpl(), 0, getText().length())) : null;
    }
    ...
    public /* synthetic */ TextFieldValue(androidx.compose.ui.text.AnnotatedString r7, long r8, androidx.compose.ui.text.TextRange r10, int r11, kotlin.jvm.internal.DefaultConstructorMarker r12) {
        /*
            ...
            long r8 = r8.m7040getZerod9O1mEE()
            r2 = r8
            goto L_0x000d
        L_0x000c:
            r2 = r8
    ...
    public /* synthetic */ TextFieldValue(java.lang.String r7, long r8, androidx.compose.ui.text.TextRange r10, int r11, kotlin.jvm.internal.DefaultConstructorMarker r12) {
        ...
        L_0x0009:
            ...
            long r8 = r7.m7040getZerod9O1mEE()
            r2 = r8
            goto L_0x0016
        L_0x0015:
            r2 = r8
    ...
    public final long m7265getSelectiond9O1mEE() {
        return this.selection;
    }

    /* renamed from: getComposition-MzsxiRA  reason: not valid java name */
    public final TextRange m7264getCompositionMzsxiRA() {
        return this.composition;
    }

    /* renamed from: copy-3r_uNRQ$default  reason: not valid java name */
    public static /* synthetic */ TextFieldValue m7260copy3r_uNRQ$default(TextFieldValue textFieldValue, AnnotatedString annotatedString2, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldValue.m7262copy3r_uNRQ(annotatedString2, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ  reason: not valid java name */
    public final TextFieldValue m7262copy3r_uNRQ(AnnotatedString annotatedString2, long selection2, TextRange composition2) {
        Intrinsics.checkNotNullParameter(annotatedString2, "annotatedString");
        return new TextFieldValue(annotatedString2, selection2, composition2, (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-3r_uNRQ$default  reason: not valid java name */
    public static /* synthetic */ TextFieldValue m7261copy3r_uNRQ$default(TextFieldValue textFieldValue, String str, long j, TextRange textRange, int i, Object obj) {
        if ((i & 2) != 0) {
            j = textFieldValue.selection;
        }
        if ((i & 4) != 0) {
        ...
        return textFieldValue.m7263copy3r_uNRQ(str, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ  reason: not valid java name */
    public final TextFieldValue m7263copy3r_uNRQ(String text, long selection2, TextRange composition2) {
        Intrinsics.checkNotNullParameter(text, "text");
    ...
    public boolean equals(Object other) {
        ...
        if (!TextRange.m7028equalsimpl0(this.selection, ((TextFieldValue) other).selection) || !Intrinsics.areEqual((Object) this.composition, (Object) ((TextFieldValue) other).composition) || !Intrinsics.areEqual((Object) this.annotatedString, (Object) ((TextFieldValue) other).annotatedString)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        int result = ((this.annotatedString.hashCode() * 31) + TextRange.m7036hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        return result + (textRange != null ? TextRange.m7036hashCodeimpl(textRange.m7039unboximpl()) : 0);
    }

    public String toString() {
        return "TextFieldValue(text='" + this.annotatedString + "', selection=" + TextRange.m7038toStringimpl(this.selection) + ", composition=" + this.composition + ')';
    }
