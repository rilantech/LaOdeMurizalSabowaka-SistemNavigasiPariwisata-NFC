...
public final class EditProcessor {
    ...
    private EditingBuffer mBuffer = new EditingBuffer(this.mBufferState.getAnnotatedString(), this.mBufferState.m7265getSelectiond9O1mEE(), (DefaultConstructorMarker) null);
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.Companion.m7040getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    ...
    public final void reset(TextFieldValue value, TextInputSession textInputSession) {
        ...
        boolean compositionChanged = !Intrinsics.areEqual((Object) value.m7264getCompositionMzsxiRA(), (Object) this.mBuffer.m7187getCompositionMzsxiRA$ui_text_release());
        if (!Intrinsics.areEqual((Object) this.mBufferState.getAnnotatedString(), (Object) value.getAnnotatedString())) {
            this.mBuffer = new EditingBuffer(value.getAnnotatedString(), value.m7265getSelectiond9O1mEE(), (DefaultConstructorMarker) null);
            textChanged = true;
        } else if (!TextRange.m7028equalsimpl0(this.mBufferState.m7265getSelectiond9O1mEE(), value.m7265getSelectiond9O1mEE())) {
            this.mBuffer.setSelection$ui_text_release(TextRange.m7033getMinimpl(value.m7265getSelectiond9O1mEE()), TextRange.m7032getMaximpl(value.m7265getSelectiond9O1mEE()));
            selectionChanged = true;
        }
        if (value.m7264getCompositionMzsxiRA() == null) {
            this.mBuffer.commitComposition$ui_text_release();
        } else if (!TextRange.m7029getCollapsedimpl(value.m7264getCompositionMzsxiRA().m7039unboximpl())) {
            this.mBuffer.setComposition$ui_text_release(TextRange.m7033getMinimpl(value.m7264getCompositionMzsxiRA().m7039unboximpl()), TextRange.m7032getMaximpl(value.m7264getCompositionMzsxiRA().m7039unboximpl()));
        }
        if (textChanged || (!selectionChanged && compositionChanged)) {
            this.mBuffer.commitComposition$ui_text_release();
            newValue = TextFieldValue.m7260copy3r_uNRQ$default(value, (AnnotatedString) null, 0, (TextRange) null, 3, (Object) null);
        } else {
            newValue = value;
        }
    ...
    public final TextFieldValue apply(List<? extends EditCommand> editCommands) {
        ...
        try {
            ...
            TextFieldValue textFieldValue = new TextFieldValue(this.mBuffer.toAnnotatedString$ui_text_release(), this.mBuffer.m7188getSelectiond9O1mEE$ui_text_release(), this.mBuffer.m7187getCompositionMzsxiRA$ui_text_release(), (DefaultConstructorMarker) null);
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> editCommands, EditCommand failedCommand) {
        ...
        StringBuilder append = $this$generateBatchErrorMessage_u24lambda_u241.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m7187getCompositionMzsxiRA$ui_text_release() + ", selection=" + TextRange.m7038toStringimpl(this.mBuffer.m7188getSelectiond9O1mEE$ui_text_release()) + "):");
