...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString text, long selection) {
        ...
        this.selectionStart = TextRange.m7033getMinimpl(selection);
        this.selectionEnd = TextRange.m7032getMaximpl(selection);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int start = TextRange.m7033getMinimpl(selection);
        int end = TextRange.m7032getMaximpl(selection);
    ...
    public final TextRange m7187getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m7023boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* renamed from: getSelection-d9O1mEE$ui_text_release  reason: not valid java name */
    public final long m7188getSelectiond9O1mEE$ui_text_release() {
    ...
    private EditingBuffer(String text, long selection) {
        this(new AnnotatedString(text, (List) null, (List) null, 6, (DefaultConstructorMarker) null), selection, (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(text, "text");
    }
    ...
    public final void replace$ui_text_release(int start, int end, String text) {
        ...
        } else if (end < 0 || end > this.gapBuffer.getLength()) {
    ...
    public final void delete$ui_text_release(int start, int end) {
        ...
        long newSelection = EditingBufferKt.m7189updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), deleteRange);
        setSelectionStart(TextRange.m7033getMinimpl(newSelection));
        setSelectionEnd(TextRange.m7032getMaximpl(newSelection));
        if (hasComposition$ui_text_release()) {
            long newComposition = EditingBufferKt.m7189updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd), deleteRange);
            if (TextRange.m7029getCollapsedimpl(newComposition)) {
                commitComposition$ui_text_release();
                return;
            }
            this.compositionStart = TextRange.m7033getMinimpl(newComposition);
            this.compositionEnd = TextRange.m7032getMaximpl(newComposition);
        }
    }
