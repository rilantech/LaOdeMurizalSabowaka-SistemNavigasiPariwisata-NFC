...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            TextRange r0 = state.m7264getCompositionMzsxiRA();
            int compositionEnd = -1;
            int compositionStart = r0 != null ? TextRange.m7033getMinimpl(r0.m7039unboximpl()) : -1;
            TextRange r2 = state.m7264getCompositionMzsxiRA();
            if (r2 != null) {
                compositionEnd = TextRange.m7032getMaximpl(r2.m7039unboximpl());
            }
            inputMethodManager.updateSelection(TextRange.m7033getMinimpl(state.m7265getSelectiond9O1mEE()), TextRange.m7032getMaximpl(state.m7265getSelectiond9O1mEE()), compositionStart, compositionEnd);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m7029getCollapsedimpl(this.mTextFieldValue.m7265getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        switch (editorAction) {
            case 0:
                imeAction = ImeAction.Companion.m7205getDefaulteUduSuo();
                break;
            case 2:
                imeAction = ImeAction.Companion.m7207getGoeUduSuo();
                break;
            case 3:
                imeAction = ImeAction.Companion.m7211getSearcheUduSuo();
                break;
            case 4:
                imeAction = ImeAction.Companion.m7212getSendeUduSuo();
                break;
            case 5:
                imeAction = ImeAction.Companion.m7208getNexteUduSuo();
                break;
            case 6:
                imeAction = ImeAction.Companion.m7206getDoneeUduSuo();
                break;
            case 7:
                imeAction = ImeAction.Companion.m7210getPreviouseUduSuo();
                break;
            default:
        ...
        this.eventCallback.m7219onImeActionKlQnJC8(imeAction);
        return true;
    }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m7033getMinimpl(this.mTextFieldValue.m7265getSelectiond9O1mEE()), reqModes);
    }
