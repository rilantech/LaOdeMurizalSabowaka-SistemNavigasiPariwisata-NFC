...
public final class CommitTextCommand implements EditCommand {
    ...
    public CommitTextCommand(AnnotatedString annotatedString2, int newCursorPosition2) {
    ...
    public CommitTextCommand(String text, int newCursorPosition2) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CommitTextCommand) && Intrinsics.areEqual((Object) getText(), (Object) ((CommitTextCommand) other).getText()) && this.newCursorPosition == ((CommitTextCommand) other).newCursorPosition) {
            return true;
        }
        return false;
    }
