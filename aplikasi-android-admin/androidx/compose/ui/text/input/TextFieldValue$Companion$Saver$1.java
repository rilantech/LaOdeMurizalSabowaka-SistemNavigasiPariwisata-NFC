...
final class TextFieldValue$Companion$Saver$1 extends Lambda implements Function2<SaverScope, TextFieldValue, Object> {
    ...
    public final Object invoke(SaverScope $this$Saver, TextFieldValue it) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(it.getAnnotatedString(), SaversKt.getAnnotatedStringSaver(), $this$Saver), SaversKt.save(TextRange.m7023boximpl(it.m7265getSelectiond9O1mEE()), SaversKt.getSaver(TextRange.Companion), $this$Saver));
    }
}
