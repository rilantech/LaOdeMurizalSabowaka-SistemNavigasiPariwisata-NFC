...
public final class ImeOptions {
    ...
    public /* synthetic */ ImeOptions(boolean r8, int r9, boolean r10, int r11, int r12, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        L_0x001d:
            ...
            int r11 = r8.m7258getTextPjHm6EE()
            r4 = r11
            goto L_0x002a
        L_0x0029:
            r4 = r11
        L_0x002a:
            ...
            int r12 = r8.m7205getDefaulteUduSuo()
            r5 = r12
            goto L_0x0037
        L_0x0036:
            r5 = r12
    ...
    public final int m7215getCapitalizationIUNYP9k() {
    ...
    public final int m7217getKeyboardTypePjHm6EE() {
        return this.keyboardType;
    }

    /* renamed from: getImeAction-eUduSuo  reason: not valid java name */
    public final int m7216getImeActioneUduSuo() {
    ...
    public static /* synthetic */ ImeOptions m7213copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        int i5;
        boolean z3;
        int i6;
        int i7;
        ...
        return imeOptions.m7214copyuxg59PA(z, i5, z3, i6, i7);
    }

    /* renamed from: copy-uxg59PA  reason: not valid java name */
    public final ImeOptions m7214copyuxg59PA(boolean singleLine2, int capitalization2, boolean autoCorrect2, int keyboardType2, int imeAction2) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ImeOptions) && this.singleLine == ((ImeOptions) other).singleLine && KeyboardCapitalization.m7223equalsimpl0(this.capitalization, ((ImeOptions) other).capitalization) && this.autoCorrect == ((ImeOptions) other).autoCorrect && KeyboardType.m7238equalsimpl0(this.keyboardType, ((ImeOptions) other).keyboardType) && ImeAction.m7193equalsimpl0(this.imeAction, ((ImeOptions) other).imeAction)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((Boolean.hashCode(this.singleLine) * 31) + KeyboardCapitalization.m7224hashCodeimpl(this.capitalization)) * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m7239hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m7194hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + KeyboardCapitalization.m7225toStringimpl(this.capitalization) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + KeyboardType.m7240toStringimpl(this.keyboardType) + ", imeAction=" + ImeAction.m7195toStringimpl(this.imeAction) + ')';
    }
}
