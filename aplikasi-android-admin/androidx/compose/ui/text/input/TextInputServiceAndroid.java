...
public final class TextInputServiceAndroid implements PlatformTextInputService {
    ...
    public TextInputServiceAndroid(View view2, InputMethodManager inputMethodManager2, PlatformTextInput platformTextInput2, Executor inputCommandProcessorExecutor2) {
        ...
        this.state = new TextFieldValue("", TextRange.Companion.m7040getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    public void updateState(TextFieldValue oldValue, TextFieldValue newValue) {
        ...
        boolean needUpdateSelection = !TextRange.m7028equalsimpl0(this.state.m7265getSelectiond9O1mEE(), newValue.m7265getSelectiond9O1mEE()) || !Intrinsics.areEqual((Object) this.state.m7264getCompositionMzsxiRA(), (Object) newValue.m7264getCompositionMzsxiRA());
        this.state = newValue;
        ...
        if (Intrinsics.areEqual((Object) oldValue, (Object) newValue) == 0) {
            if (oldValue != null) {
                ...
                if (!Intrinsics.areEqual((Object) it.getText(), (Object) newValue.getText()) || (TextRange.m7028equalsimpl0(it.m7265getSelectiond9O1mEE(), newValue.m7265getSelectiond9O1mEE()) && !Intrinsics.areEqual((Object) it.m7264getCompositionMzsxiRA(), (Object) newValue.m7264getCompositionMzsxiRA()))) {
                    restartInput = true;
                }
            }
            if (restartInput) {
            ...
            int r2 = TextRange.m7033getMinimpl(newValue.m7265getSelectiond9O1mEE());
            int r3 = TextRange.m7032getMaximpl(newValue.m7265getSelectiond9O1mEE());
            TextRange r4 = this.state.m7264getCompositionMzsxiRA();
            int i3 = -1;
            int r42 = r4 != null ? TextRange.m7033getMinimpl(r4.m7039unboximpl()) : -1;
            TextRange r6 = this.state.m7264getCompositionMzsxiRA();
            if (r6 != null) {
                i3 = TextRange.m7032getMaximpl(r6.m7039unboximpl());
            }
