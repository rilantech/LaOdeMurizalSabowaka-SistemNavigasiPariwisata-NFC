...
public final class TextFieldValueKt {
    public static final AnnotatedString getTextBeforeSelection(TextFieldValue $this$getTextBeforeSelection, int maxChars) {
        ...
        return $this$getTextBeforeSelection.getAnnotatedString().subSequence(Math.max(0, TextRange.m7033getMinimpl($this$getTextBeforeSelection.m7265getSelectiond9O1mEE()) - maxChars), TextRange.m7033getMinimpl($this$getTextBeforeSelection.m7265getSelectiond9O1mEE()));
    }
    ...
    public static final AnnotatedString getTextAfterSelection(TextFieldValue $this$getTextAfterSelection, int maxChars) {
        ...
        return $this$getTextAfterSelection.getAnnotatedString().subSequence(TextRange.m7032getMaximpl($this$getTextAfterSelection.m7265getSelectiond9O1mEE()), Math.min(TextRange.m7032getMaximpl($this$getTextAfterSelection.m7265getSelectiond9O1mEE()) + maxChars, $this$getTextAfterSelection.getText().length()));
    }
    ...
    public static final AnnotatedString getSelectedText(TextFieldValue $this$getSelectedText) {
        ...
        return $this$getSelectedText.getAnnotatedString().m6905subSequence5zctL8($this$getSelectedText.m7265getSelectiond9O1mEE());
    }
}
