...
public final class MultiParagraph {
    ...
    private MultiParagraph(androidx.compose.ui.text.MultiParagraphIntrinsics r35, long r36, int r38, boolean r39) {
        /*
            ...
            r2 = r38
            r0.maxLines = r2
            int r3 = androidx.compose.ui.unit.Constraints.m7500getMinWidthimpl(r36)
            r4 = 0
            if (r3 != 0) goto L_0x0023
            int r3 = androidx.compose.ui.unit.Constraints.m7499getMinHeightimpl(r36)
            if (r3 != 0) goto L_0x0023
            r3 = 1
            goto L_0x0024
        L_0x0023:
        ...
        L_0x0039:
            ...
            int r13 = androidx.compose.ui.unit.Constraints.m7498getMaxWidthimpl(r36)
            boolean r12 = androidx.compose.ui.unit.Constraints.m7493getHasBoundedHeightimpl(r36)
            if (r12 == 0) goto L_0x0062
            int r12 = androidx.compose.ui.unit.Constraints.m7497getMaxHeightimpl(r36)
        ...
        L_0x0067:
            ...
            int r14 = r14 - r5
            r15 = r39
            androidx.compose.ui.text.Paragraph r20 = androidx.compose.ui.text.ParagraphKt.m6935Paragraph_EkL_Y(r11, r12, r14, r15)
            r17 = r3
        ...
        L_0x00d6:
            ...
            int r4 = androidx.compose.ui.unit.Constraints.m7498getMaxWidthimpl(r36)
            float r4 = (float) r4
            r0.width = r4
            r4 = r7
            r9 = 0
    ...
    public static /* synthetic */ void m6916paintRPmYEkk$default(MultiParagraph multiParagraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, int i, Object obj) {
        long j2;
        Shadow shadow2;
        TextDecoration textDecoration2;
        if ((i & 2) != 0) {
            j2 = Color.Companion.m4999getUnspecified0d7_KjU();
        } else {
            j2 = j;
        }
        if ((i & 4) != 0) {
        ...
        multiParagraph.m6921paintRPmYEkk(canvas, j2, shadow2, textDecoration2);
    }
    ...
    public final /* synthetic */ void m6921paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration decoration) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            it.getParagraph().m6929paintRPmYEkk(canvas, color, shadow, decoration);
    ...
    public static /* synthetic */ void m6915paintLG529CI$default(MultiParagraph multiParagraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
        long j2;
        Shadow shadow2;
        TextDecoration textDecoration2;
        if ((i2 & 2) != 0) {
        ...
        multiParagraph.m6920paintLG529CI(canvas, j2, shadow2, textDecoration2, drawStyle2, (i2 & 32) != 0 ? DrawScope.Companion.m5577getDefaultBlendMode0nO6VwU() : i);
    }

    /* renamed from: paint-LG529CI  reason: not valid java name */
    public final void m6920paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        Canvas canvas2 = canvas;
        Intrinsics.checkNotNullParameter(canvas2, "canvas");
        canvas.save();
        List $this$fastForEach$iv = this.paragraphInfoList;
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ParagraphInfo it = $this$fastForEach$iv.get(index$iv);
            it.getParagraph().m6928paintLG529CI(canvas, color, shadow, decoration, drawStyle, blendMode);
            canvas2.translate(0.0f, it.getParagraph().getHeight());
        }
        canvas.restore();
    }
    ...
    public static /* synthetic */ void m6917painthn5TExg$default(MultiParagraph multiParagraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
        float f2;
        Shadow shadow2;
        TextDecoration textDecoration2;
        ...
        multiParagraph.m6922painthn5TExg(canvas, brush, f2, shadow2, textDecoration2, drawStyle2, (i2 & 64) != 0 ? DrawScope.Companion.m5577getDefaultBlendMode0nO6VwU() : i);
    }

    /* renamed from: paint-hn5TExg  reason: not valid java name */
    public final void m6922painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        AndroidMultiParagraphDrawKt.m7275drawMultiParagraph7AXcY_I(this, canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
    }
        ...
        if (!z) {
            ...
            for (int i = paragraphIndex; i < size; i++) {
                ...
                if (p.getStartIndex() != p.getEndIndex()) {
                    ...
                    Path.m5243addPathUv8p0NA$default(path, $this$getPathForRange_u24lambda_u2410.toGlobal($this$getPathForRange_u24lambda_u2410.getParagraph().getPathForRange($this$getPathForRange_u24lambda_u2410.toLocalIndex(start), $this$getPathForRange_u24lambda_u2410.toLocalIndex(end))), 0, 2, (Object) null);
                }
            }
            return path;
        }
    ...
    public final int m6918getOffsetForPositionk4lQ0M(long position) {
        int paragraphIndex;
        if (Offset.m4714getYimpl(position) <= 0.0f) {
            paragraphIndex = 0;
        } else if (Offset.m4714getYimpl(position) >= this.height) {
            paragraphIndex = CollectionsKt.getLastIndex(this.paragraphInfoList);
        } else {
            paragraphIndex = MultiParagraphKt.findParagraphByY(this.paragraphInfoList, Offset.m4714getYimpl(position));
        }
        ...
        return $this$getOffsetForPosition_k_4lQ0M_u24lambda_u2412.toGlobalIndex($this$getOffsetForPosition_k_4lQ0M_u24lambda_u2412.getParagraph().m6926getOffsetForPositionk4lQ0M($this$getOffsetForPosition_k_4lQ0M_u24lambda_u2412.m6932toLocalMKHz9U(position)));
    }
    ...
    public final long m6919getWordBoundaryjx7JFs(int offset) {
        int paragraphIndex;
        requireIndexInRangeInclusiveEnd(offset);
        if (offset == getAnnotatedString().length()) {
            paragraphIndex = CollectionsKt.getLastIndex(this.paragraphInfoList);
        ...
        return $this$getWordBoundary__jx7JFs_u24lambda_u2417.m6931toGlobalGEjPoXI($this$getWordBoundary__jx7JFs_u24lambda_u2417.getParagraph().m6927getWordBoundaryjx7JFs($this$getWordBoundary__jx7JFs_u24lambda_u2417.toLocalIndex(offset)));
    }
