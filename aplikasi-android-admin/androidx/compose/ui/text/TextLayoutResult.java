...
public final class TextLayoutResult {
    ...
    private TextLayoutResult(TextLayoutInput layoutInput2, MultiParagraph multiParagraph2, long size2) {
        Intrinsics.checkNotNullParameter(layoutInput2, "layoutInput");
        Intrinsics.checkNotNullParameter(multiParagraph2, "multiParagraph");
        this.layoutInput = layoutInput2;
    ...
    public final long m7008getSizeYbymL2g() {
        return this.size;
    }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m7713getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m7714getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m7007getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m6918getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m7009getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m6919getWordBoundaryjx7JFs(offset);
    }
    ...
    public static /* synthetic */ TextLayoutResult m7005copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m7006copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c  reason: not valid java name */
    public final TextLayoutResult m7006copyO0kMr_c(TextLayoutInput layoutInput2, long size2) {
        Intrinsics.checkNotNullParameter(layoutInput2, "layoutInput");
        return new TextLayoutResult(layoutInput2, this.multiParagraph, size2, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TextLayoutResult) || !Intrinsics.areEqual((Object) this.layoutInput, (Object) ((TextLayoutResult) other).layoutInput) || !Intrinsics.areEqual((Object) this.multiParagraph, (Object) ((TextLayoutResult) other).multiParagraph) || !IntSize.m7712equalsimpl0(this.size, ((TextLayoutResult) other).size)) {
            return false;
        }
        if (!(this.firstBaseline == ((TextLayoutResult) other).firstBaseline)) {
            return false;
        }
        if ((this.lastBaseline == ((TextLayoutResult) other).lastBaseline) && Intrinsics.areEqual((Object) this.placeholderRects, (Object) ((TextLayoutResult) other).placeholderRects)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m7715hashCodeimpl(this.size)) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + IntSize.m7717toStringimpl(this.size) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
