...
public final class TextStyleKt {
    ...
    public static final int m7067resolveTextDirectionYj3eThk(LayoutDirection layoutDirection, TextDirection textDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (textDirection == null ? false : TextDirection.m7426equalsimpl0(textDirection.m7429unboximpl(), TextDirection.Companion.m7430getContents_7Xco())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.Companion.m7431getContentOrLtrs_7Xco();
                case 2:
                    return TextDirection.Companion.m7432getContentOrRtls_7Xco();
                default:
                    throw new NoWhenBranchMatchedException();
            }
        } else if (textDirection != null) {
            return textDirection.m7429unboximpl();
        } else {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.Companion.m7433getLtrs_7Xco();
                case 2:
                    return TextDirection.Companion.m7434getRtls_7Xco();
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }
