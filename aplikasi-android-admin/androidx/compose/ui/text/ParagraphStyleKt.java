...
public final class ParagraphStyleKt {
    private static final long DefaultLineHeight = TextUnit.Companion.m7746getUnspecifiedXSAIIZE();

    public static final ParagraphStyle lerp(ParagraphStyle start, ParagraphStyle stop, float fraction) {
        Intrinsics.checkNotNullParameter(start, "start");
        Intrinsics.checkNotNullParameter(stop, "stop");
        TextAlign textAlign = (TextAlign) SpanStyleKt.lerpDiscrete(start.m6950getTextAlignbuA522U(), stop.m6950getTextAlignbuA522U(), fraction);
        TextDirection textDirection = (TextDirection) SpanStyleKt.lerpDiscrete(start.m6952getTextDirectionmmuk1to(), stop.m6952getTextDirectionmmuk1to(), fraction);
        long r4 = SpanStyleKt.m7000lerpTextUnitInheritableC3pnCVY(start.m6949getLineHeightXSAIIZE(), stop.m6949getLineHeightXSAIIZE(), fraction);
        ...
        return new ParagraphStyle(textAlign, textDirection, r4, TextIndentKt.lerp(textIndent, textIndent2, fraction), lerpPlatformStyle(start.getPlatformStyle(), stop.getPlatformStyle(), fraction), (LineHeightStyle) SpanStyleKt.lerpDiscrete(start.getLineHeightStyle(), stop.getLineHeightStyle(), fraction), (LineBreak) SpanStyleKt.lerpDiscrete(start.m6947getLineBreakLgCVezo(), stop.m6947getLineBreakLgCVezo(), fraction), (Hyphens) SpanStyleKt.lerpDiscrete(start.m6945getHyphensEaSxIns(), stop.m6945getHyphensEaSxIns(), fraction), (TextMotion) SpanStyleKt.lerpDiscrete(start.getTextMotion(), stop.getTextMotion(), fraction), (DefaultConstructorMarker) null);
    }
    ...
    public static final ParagraphStyle resolveParagraphStyleDefaults(ParagraphStyle style, LayoutDirection direction) {
        ...
        TextAlign r2 = TextAlign.m7410boximpl(style.m6951getTextAlignOrDefaulte0LSkKk$ui_text_release());
        TextDirection r3 = TextDirection.m7423boximpl(TextStyleKt.m7067resolveTextDirectionYj3eThk(direction, style.m6952getTextDirectionmmuk1to()));
        long r4 = TextUnitKt.m7753isUnspecifiedR2X_6o(style.m6949getLineHeightXSAIIZE()) ? DefaultLineHeight : style.m6949getLineHeightXSAIIZE();
        ...
        LineBreak r9 = LineBreak.m7338boximpl(style.m6948getLineBreakOrDefaultrAG3T2k$ui_text_release());
        Hyphens r10 = Hyphens.m7329boximpl(style.m6946getHyphensOrDefaultvmbZdU8$ui_text_release());
    ...
    public static final androidx.compose.ui.text.ParagraphStyle m6953fastMergeHtYhynw(androidx.compose.ui.text.ParagraphStyle r26, androidx.compose.ui.text.style.TextAlign r27, androidx.compose.ui.text.style.TextDirection r28, long r29, androidx.compose.ui.text.style.TextIndent r31, androidx.compose.ui.text.PlatformParagraphStyle r32, androidx.compose.ui.text.style.LineHeightStyle r33, androidx.compose.ui.text.style.LineBreak r34, androidx.compose.ui.text.style.Hyphens r35, androidx.compose.ui.text.style.TextMotion r36) {
        /*
            ...
            androidx.compose.ui.text.style.TextAlign r10 = r26.m6950getTextAlignbuA522U()
        ...
        L_0x0029:
            r10 = r29
            r12 = 0
            boolean r13 = androidx.compose.ui.unit.TextUnitKt.m7753isUnspecifiedR2X_6o(r10)
            r10 = r13 ^ 1
            if (r10 == 0) goto L_0x0041
            long r10 = r26.m6949getLineHeightXSAIIZE()
            r12 = r29
            boolean r10 = androidx.compose.ui.unit.TextUnit.m7732equalsimpl0(r12, r10)
        ...
        L_0x004f:
            ...
            androidx.compose.ui.text.style.TextDirection r10 = r26.m6952getTextDirectionmmuk1to()
        ...
        L_0x0073:
            ...
            androidx.compose.ui.text.style.LineBreak r10 = r26.m6947getLineBreakLgCVezo()
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r6, (java.lang.Object) r10)
            if (r10 == 0) goto L_0x0097
        L_0x007f:
            if (r7 == 0) goto L_0x008b
            androidx.compose.ui.text.style.Hyphens r10 = r26.m6945getHyphensEaSxIns()
        ...
        L_0x0099:
            ...
            return r0
        L_0x009d:
            boolean r10 = androidx.compose.ui.unit.TextUnitKt.m7753isUnspecifiedR2X_6o(r29)
