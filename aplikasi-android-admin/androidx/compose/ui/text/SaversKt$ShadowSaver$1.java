...
final class SaversKt$ShadowSaver$1 extends Lambda implements Function2<SaverScope, Shadow, Object> {
    ...
    public final Object invoke(SaverScope $this$Saver, Shadow it) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(Color.m4953boximpl(it.m5320getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), $this$Saver), SaversKt.save(Offset.m4702boximpl(it.m5321getOffsetF1C5BW0()), SaversKt.getSaver(Offset.Companion), $this$Saver), SaversKt.save(Float.valueOf(it.getBlurRadius())));
    }
}
