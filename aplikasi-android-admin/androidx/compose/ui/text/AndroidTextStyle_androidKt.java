...
public final class AndroidTextStyle_androidKt {
    ...
    public static final PlatformParagraphStyle lerp(PlatformParagraphStyle start, PlatformParagraphStyle stop, float fraction) {
        ...
        return new PlatformParagraphStyle(((EmojiSupportMatch) SpanStyleKt.lerpDiscrete(EmojiSupportMatch.m6906boximpl(start.m6973getEmojiSupportMatch_3YsG6Y()), EmojiSupportMatch.m6906boximpl(stop.m6973getEmojiSupportMatch_3YsG6Y()), fraction)).m6912unboximpl(), ((Boolean) SpanStyleKt.lerpDiscrete(Boolean.valueOf(start.getIncludeFontPadding()), Boolean.valueOf(stop.getIncludeFontPadding()), fraction)).booleanValue(), (DefaultConstructorMarker) null);
    }
