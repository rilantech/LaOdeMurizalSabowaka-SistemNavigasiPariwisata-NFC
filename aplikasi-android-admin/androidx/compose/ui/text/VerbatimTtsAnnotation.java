...
public final class VerbatimTtsAnnotation extends TtsAnnotation {
    ...
    public VerbatimTtsAnnotation(String verbatim2) {
        super((DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(verbatim2, "verbatim");
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VerbatimTtsAnnotation) && Intrinsics.areEqual((Object) this.verbatim, (Object) ((VerbatimTtsAnnotation) other).verbatim)) {
            return true;
        }
        return false;
    }
