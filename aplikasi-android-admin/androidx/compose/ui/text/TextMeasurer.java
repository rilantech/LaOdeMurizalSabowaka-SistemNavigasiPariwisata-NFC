...
public final class TextMeasurer {
    ...
    public static /* synthetic */ TextLayoutResult m7011measurexDpz5zY$default(TextMeasurer textMeasurer, AnnotatedString annotatedString, TextStyle textStyle, int i, boolean z, int i2, List list, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z2, int i3, Object obj) {
        ...
        if ((i6 & 4) != 0) {
            i4 = TextOverflow.Companion.m7466getClipgIe3tQ8();
        } else {
            i4 = i;
        }
        if ((i6 & 8) != 0) {
        ...
        return textMeasurer.m7013measurexDpz5zY(annotatedString, textStyle2, i4, z3, i5, list2, Constraints$default, layoutDirection2, density2, resolver2, z4);
    }

    /* renamed from: measure-xDpz5zY  reason: not valid java name */
    public final TextLayoutResult m7013measurexDpz5zY(AnnotatedString text, TextStyle style, int overflow, boolean softWrap, int maxLines, List<AnnotatedString.Range<Placeholder>> placeholders, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        ...
        if (cacheResult != null) {
            return cacheResult.m7006copyO0kMr_c(textLayoutInput, ConstraintsKt.m7509constrain4WqzIAM(constraints, IntSizeKt.IntSize(ParagraphKt.ceilToInt(cacheResult.getMultiParagraph().getWidth()), ParagraphKt.ceilToInt(cacheResult.getMultiParagraph().getHeight()))));
        }
        long j = constraints;
    ...
    public static /* synthetic */ TextLayoutResult m7010measurewNUYSr0$default(TextMeasurer textMeasurer, String str, TextStyle textStyle, int i, boolean z, int i2, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z2, int i3, Object obj) {
        TextStyle textStyle2;
        int i4;
        boolean z3;
        int i5;
        ...
        return textMeasurer.m7012measurewNUYSr0(str, textStyle2, i4, z3, i5, Constraints$default, layoutDirection2, density2, resolver2, z4);
    }

    /* renamed from: measure-wNUYSr0  reason: not valid java name */
    public final TextLayoutResult m7012measurewNUYSr0(String text, TextStyle style, int overflow, boolean softWrap, int maxLines, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        return m7011measurexDpz5zY$default(this, new AnnotatedString(text, (List) null, (List) null, 6, (DefaultConstructorMarker) null), style, overflow, softWrap, maxLines, (List) null, constraints, layoutDirection, density, fontFamilyResolver, skipCache, 32, (Object) null);
    }
    ...
    public static final class Companion {
        ...
        public final TextLayoutResult layout(TextLayoutInput textLayoutInput) {
            ...
            int minWidth = Constraints.m7500getMinWidthimpl($this$layout_u24lambda_u240.m7003getConstraintsmsEJaDk());
            boolean overwriteMaxLines = false;
            int i = 1;
            if (!($this$layout_u24lambda_u240.getSoftWrap() || TextOverflow.m7459equalsimpl0($this$layout_u24lambda_u240.m7004getOverflowgIe3tQ8(), TextOverflow.Companion.m7467getEllipsisgIe3tQ8())) || !Constraints.m7494getHasBoundedWidthimpl($this$layout_u24lambda_u240.m7003getConstraintsmsEJaDk())) {
                maxWidth = Integer.MAX_VALUE;
            } else {
                maxWidth = Constraints.m7498getMaxWidthimpl($this$layout_u24lambda_u240.m7003getConstraintsmsEJaDk());
            }
            if (!$this$layout_u24lambda_u240.getSoftWrap() && TextOverflow.m7459equalsimpl0($this$layout_u24lambda_u240.m7004getOverflowgIe3tQ8(), TextOverflow.Companion.m7467getEllipsisgIe3tQ8())) {
            ...
            MultiParagraph multiParagraph = new MultiParagraph(multiParagraphIntrinsics, ConstraintsKt.Constraints$default(0, width, 0, Constraints.m7497getMaxHeightimpl($this$layout_u24lambda_u240.m7003getConstraintsmsEJaDk()), 5, (Object) null), finalMaxLines, TextOverflow.m7459equalsimpl0($this$layout_u24lambda_u240.m7004getOverflowgIe3tQ8(), TextOverflow.Companion.m7467getEllipsisgIe3tQ8()), (DefaultConstructorMarker) null);
            return new TextLayoutResult(textLayoutInput, multiParagraph, ConstraintsKt.m7509constrain4WqzIAM($this$layout_u24lambda_u240.m7003getConstraintsmsEJaDk(), IntSizeKt.IntSize((int) ((float) Math.ceil((double) multiParagraph.getWidth())), (int) ((float) Math.ceil((double) multiParagraph.getHeight())))), (DefaultConstructorMarker) null);
        }
    }
}
