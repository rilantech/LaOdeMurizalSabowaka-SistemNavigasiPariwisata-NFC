...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle start, TextForegroundStyle stop, float fraction) {
        ...
        if (!(start instanceof BrushStyle) && !(stop instanceof BrushStyle)) {
            return TextForegroundStyle.Companion.m7437from8_81llA(ColorKt.m5014lerpjxsXWHM(start.m7436getColor0d7_KjU(), stop.m7436getColor0d7_KjU(), fraction));
        }
        if (!(start instanceof BrushStyle) || !(stop instanceof BrushStyle)) {
    ...
    public static final long m7435modulateDxMtmZc(long $this$modulate_u2dDxMtmZc, float alpha) {
        if (Float.isNaN(alpha) || alpha >= 1.0f) {
            return $this$modulate_u2dDxMtmZc;
        }
        return Color.m4962copywmQWz5c$default($this$modulate_u2dDxMtmZc, Color.m4965getAlphaimpl($this$modulate_u2dDxMtmZc) * alpha, 0.0f, 0.0f, 0.0f, 14, (Object) null);
    }
