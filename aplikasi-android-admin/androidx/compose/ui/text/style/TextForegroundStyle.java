...
public interface TextForegroundStyle {
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        /* renamed from: getColor-0d7_KjU  reason: not valid java name */
        public long m7438getColor0d7_KjU() {
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle m7437from8_81llA(long color) {
            return (color > Color.Companion.m4999getUnspecified0d7_KjU() ? 1 : (color == Color.Companion.m4999getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? new ColorStyle(color, (DefaultConstructorMarker) null) : Unspecified.INSTANCE;
        }
        ...
        public final TextForegroundStyle from(Brush brush, float alpha) {
            ...
            if (brush instanceof SolidColor) {
                return m7437from8_81llA(TextDrawStyleKt.m7435modulateDxMtmZc(((SolidColor) brush).m5333getValue0d7_KjU(), alpha));
            }
