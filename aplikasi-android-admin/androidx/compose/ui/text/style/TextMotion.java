...
public final class TextMotion {
    ...
    public static final TextMotion Animated = new TextMotion(Linearity.Companion.m7454getLinear4e0Vf04(), true, (DefaultConstructorMarker) null);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final TextMotion Static = new TextMotion(Linearity.Companion.m7453getFontHinting4e0Vf04(), false, (DefaultConstructorMarker) null);
    ...
    public final int m7445getLinearity4e0Vf04$ui_text_release() {
    ...
    public static /* synthetic */ TextMotion m7443copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m7444copyJdDtMQo$ui_text_release(i, z);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release  reason: not valid java name */
    public final TextMotion m7444copyJdDtMQo$ui_text_release(int linearity2, boolean subpixelTextPositioning2) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TextMotion) && Linearity.m7449equalsimpl0(this.linearity, ((TextMotion) other).linearity) && this.subpixelTextPositioning == ((TextMotion) other).subpixelTextPositioning) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (Linearity.m7450hashCodeimpl(this.linearity) * 31) + Boolean.hashCode(this.subpixelTextPositioning);
    }
    ...
    public static final class Linearity {
        public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
        /* access modifiers changed from: private */
        public static final int FontHinting = m7447constructorimpl(2);
        /* access modifiers changed from: private */
        public static final int Linear = m7447constructorimpl(1);
        /* access modifiers changed from: private */
        public static final int None = m7447constructorimpl(3);
        private final int value;

        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ Linearity m7446boximpl(int i) {
            return new Linearity(i);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        private static int m7447constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m7448equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).m7452unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m7449equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m7450hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        public boolean equals(Object obj) {
            return m7448equalsimpl(this.value, obj);
        }

        public int hashCode() {
            return m7450hashCodeimpl(this.value);
        }
        ...
        public static final class Companion {
            ...
            public final int m7454getLinear4e0Vf04() {
                return Linearity.Linear;
            }

            /* renamed from: getFontHinting-4e0Vf04  reason: not valid java name */
            public final int m7453getFontHinting4e0Vf04() {
                return Linearity.FontHinting;
            }

            /* renamed from: getNone-4e0Vf04  reason: not valid java name */
            public final int m7455getNone4e0Vf04() {
        ...
        public static String m7451toStringimpl(int arg0) {
            if (m7449equalsimpl0(arg0, Linear)) {
                return "Linearity.Linear";
            }
            if (m7449equalsimpl0(arg0, FontHinting)) {
                return "Linearity.FontHinting";
            }
            if (m7449equalsimpl0(arg0, None)) {
                return "Linearity.None";
            }
            return "Invalid";
        }
