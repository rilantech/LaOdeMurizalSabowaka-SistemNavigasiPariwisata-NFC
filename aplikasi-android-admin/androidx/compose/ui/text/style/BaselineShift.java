...
public final class BaselineShift {
    ...
    public static final float None = m7310constructorimpl(0.0f);
    /* access modifiers changed from: private */
    public static final float Subscript = m7310constructorimpl(-0.5f);
    /* access modifiers changed from: private */
    public static final float Superscript = m7310constructorimpl(0.5f);
    private final float multiplier;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ BaselineShift m7309boximpl(float f) {
        return new BaselineShift(f);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static float m7310constructorimpl(float f) {
        return f;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m7311equalsimpl(float f, Object obj) {
        return (obj instanceof BaselineShift) && Float.compare(f, ((BaselineShift) obj).m7315unboximpl()) == 0;
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m7312equalsimpl0(float f, float f2) {
        return Float.compare(f, f2) == 0;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m7313hashCodeimpl(float f) {
        return Float.hashCode(f);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m7314toStringimpl(float f) {
        return "BaselineShift(multiplier=" + f + ')';
    }

    public boolean equals(Object obj) {
        return m7311equalsimpl(this.multiplier, obj);
    }

    public int hashCode() {
        return m7313hashCodeimpl(this.multiplier);
    }

    public String toString() {
        return m7314toStringimpl(this.multiplier);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ float m7315unboximpl() {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m7316getNoney9eOQZs$annotations() {
        }

        /* renamed from: getSubscript-y9eOQZs$annotations  reason: not valid java name */
        public static /* synthetic */ void m7317getSubscripty9eOQZs$annotations() {
        }

        /* renamed from: getSuperscript-y9eOQZs$annotations  reason: not valid java name */
        public static /* synthetic */ void m7318getSuperscripty9eOQZs$annotations() {
        }
