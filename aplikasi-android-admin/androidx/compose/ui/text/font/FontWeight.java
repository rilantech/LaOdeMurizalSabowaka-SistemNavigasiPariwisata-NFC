...
public final class FontWeight implements Comparable<FontWeight> {
    ...
    public FontWeight(int weight2) {
        this.weight = weight2;
        boolean z = false;
        if (1 <= weight2 && weight2 < 1001) {
            z = true;
        }
        if (!z) {
            throw new IllegalArgumentException(("Font weight can be in range [1, 1000]. Current value: " + weight2).toString());
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FontWeight) && this.weight == ((FontWeight) other).weight) {
            return true;
        }
        return false;
    }
