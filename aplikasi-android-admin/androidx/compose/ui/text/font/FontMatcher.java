...
public final class FontMatcher {
    ...
    public final List<Font> m7130matchFontRetOiIg(List<? extends Font> fontList, FontWeight fontWeight, int fontStyle) {
        List result;
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            Font it = (Font) it$iv;
            if (Intrinsics.areEqual((Object) it.getWeight(), (Object) fontWeight2) && FontStyle.m7134equalsimpl0(it.m7106getStyle_LCdwA(), i)) {
                target$iv.add(it$iv);
            }
        }
        ...
        for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
            ...
            if (FontStyle.m7134equalsimpl0(((Font) it$iv2).m7106getStyle_LCdwA(), i)) {
    ...
    /* renamed from: matchFont-RetOiIg  reason: not valid java name */
    public final List<Font> m7128matchFontRetOiIg(FontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        if (fontFamily instanceof FontListFontFamily) {
            return m7129matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, fontStyle);
        }
        throw new IllegalArgumentException("Only FontFamily instances that presents a list of Fonts can be used");
    }

    /* renamed from: matchFont-RetOiIg  reason: not valid java name */
    public final List<Font> m7129matchFontRetOiIg(FontListFontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return m7130matchFontRetOiIg((List<? extends Font>) fontFamily.getFonts(), fontWeight, fontStyle);
    }
}
