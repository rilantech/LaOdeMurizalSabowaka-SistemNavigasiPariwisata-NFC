...
public final class DeviceFontFamilyNameFontKt {
    ...
    public static /* synthetic */ Font m7104Fontvxs03AY$default(String str, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 2) != 0) {
        ...
        return m7103Fontvxs03AY(str, fontWeight, i, settings);
    }

    /* renamed from: Font-vxs03AY  reason: not valid java name */
    public static final Font m7103Fontvxs03AY(String familyName, FontWeight weight, int style, FontVariation.Settings variationSettings) {
        Intrinsics.checkNotNullParameter(familyName, "familyName");
        Intrinsics.checkNotNullParameter(weight, "weight");
        Intrinsics.checkNotNullParameter(variationSettings, "variationSettings");
        return new DeviceFontFamilyNameFont(familyName, weight, style, variationSettings, (DefaultConstructorMarker) null);
    }
}
