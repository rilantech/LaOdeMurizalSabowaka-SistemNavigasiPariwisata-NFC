...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m7084getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int fontStyle) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.Companion)) >= 0, FontStyle.m7134equalsimpl0(fontStyle, FontStyle.Companion.m7138getItalic_LCdwA()));
    }
