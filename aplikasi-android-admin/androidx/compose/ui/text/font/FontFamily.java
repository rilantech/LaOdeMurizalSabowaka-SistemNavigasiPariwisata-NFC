...
public abstract class FontFamily {
    ...
    private FontFamily(boolean canLoadSynchronously2) {
        this.canLoadSynchronously = canLoadSynchronously2;
    }
    ...
    public interface Resolver {
        ...
        State<Object> m7108resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i, int i2);

        /* renamed from: resolve-DPcqOEQ$default  reason: not valid java name */
        static /* synthetic */ State m7107resolveDPcqOEQ$default(Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
            if (obj == null) {
                if ((i3 & 1) != 0) {
                    fontFamily = null;
                }
                ...
                return resolver.m7108resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
            }
