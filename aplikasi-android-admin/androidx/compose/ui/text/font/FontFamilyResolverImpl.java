...
public final class FontFamilyResolverImpl implements FontFamily.Resolver {
    ...
    public State<Object> m7109resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return resolve(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(fontWeight), this.platformResolveInterceptor.m7157interceptFontStyleT2F_aPo(fontStyle), this.platformResolveInterceptor.m7158interceptFontSynthesisMscr08Y(fontSynthesis), this.platformFontLoader.getCacheKey(), (DefaultConstructorMarker) null));
    }
