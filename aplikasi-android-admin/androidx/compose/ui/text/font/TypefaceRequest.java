...
public final class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m7181copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily2, FontWeight fontWeight2, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        return typefaceRequest.m7184copye1PVR60(fontFamily2, fontWeight3, i4, i5, obj);
    }
    ...
    public final int m7182component3_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: component4-GVVA2EU  reason: not valid java name */
    public final int m7183component4GVVA2EU() {
    ...
    public final TypefaceRequest m7184copye1PVR60(FontFamily fontFamily2, FontWeight fontWeight2, int i, int i2, Object obj) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.fontFamily, (Object) typefaceRequest.fontFamily) && Intrinsics.areEqual((Object) this.fontWeight, (Object) typefaceRequest.fontWeight) && FontStyle.m7134equalsimpl0(this.fontStyle, typefaceRequest.fontStyle) && FontSynthesis.m7143equalsimpl0(this.fontSynthesis, typefaceRequest.fontSynthesis) && Intrinsics.areEqual(this.resourceLoaderCacheKey, typefaceRequest.resourceLoaderCacheKey);
    }

    public int hashCode() {
        FontFamily fontFamily2 = this.fontFamily;
        int i = 0;
        int hashCode = (((((((fontFamily2 == null ? 0 : fontFamily2.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m7135hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m7144hashCodeimpl(this.fontSynthesis)) * 31;
    ...
    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + FontStyle.m7136toStringimpl(this.fontStyle) + ", fontSynthesis=" + FontSynthesis.m7147toStringimpl(this.fontSynthesis) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
    ...
    public final int m7185getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: getFontSynthesis-GVVA2EU  reason: not valid java name */
    public final int m7186getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
