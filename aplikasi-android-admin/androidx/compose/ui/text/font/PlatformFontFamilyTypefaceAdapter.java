...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            result = this.platformTypefaceResolver.m7159createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m7185getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            result = this.platformTypefaceResolver.m7160createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m7185getFontStyle_LCdwA());
            ...
            result = ((AndroidTypeface) typeface).m7289getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m7185getFontStyle_LCdwA(), typefaceRequest.m7186getFontSynthesisGVVA2EU());
        }
