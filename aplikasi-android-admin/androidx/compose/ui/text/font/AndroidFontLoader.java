...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public Typeface loadBlocking(Font font) {
        ...
        if (FontLoadingStrategy.m7121equalsimpl0(r0, FontLoadingStrategy.Companion.m7126getBlockingPKNRLFQ())) {
        ...
        } else if (FontLoadingStrategy.m7121equalsimpl0(r0, FontLoadingStrategy.Companion.m7127getOptionalLocalPKNRLFQ())) {
            try {
                Result.Companion companion = Result.Companion;
                Context context4 = this.context;
                Intrinsics.checkNotNullExpressionValue(context4, "context");
                obj = Result.m131constructorimpl(AndroidFontLoader_androidKt.load((ResourceFont) font, context4));
            } catch (Throwable th) {
            ...
            throw new IllegalArgumentException("Unknown loading type " + FontLoadingStrategy.m7123toStringimpl(font.m7105getLoadingStrategyPKNRLFQ()));
        }
