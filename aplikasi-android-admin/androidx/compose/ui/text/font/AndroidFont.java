...
public abstract class AndroidFont implements Font {
    ...
    private AndroidFont(int loadingStrategy2, TypefaceLoader typefaceLoader2, FontVariation.Settings variationSettings2) {
    ...
    public final int m7077getLoadingStrategyPKNRLFQ() {
    ...
    private AndroidFont(int loadingStrategy2, TypefaceLoader typefaceLoader2) {
        this(loadingStrategy2, typefaceLoader2, new FontVariation.Settings(new FontVariation.Setting[0]), (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(typefaceLoader2, "typefaceLoader");
    }
