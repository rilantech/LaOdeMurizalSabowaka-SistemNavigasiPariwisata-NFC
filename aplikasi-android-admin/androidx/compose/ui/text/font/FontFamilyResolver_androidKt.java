...
public final class FontFamilyResolver_androidKt {
    ...
    public static /* synthetic */ State m7111resolveAsTypefaceWqqsr6A$default(FontFamily.Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            fontFamily = null;
        }
        if ((i3 & 2) != 0) {
        ...
        if ((i3 & 8) != 0) {
            i2 = FontSynthesis.Companion.m7149getAllGVVA2EU();
        }
        return m7110resolveAsTypefaceWqqsr6A(resolver, fontFamily, fontWeight, i, i2);
    }

    /* renamed from: resolveAsTypeface-Wqqsr6A  reason: not valid java name */
    public static final State<Typeface> m7110resolveAsTypefaceWqqsr6A(FontFamily.Resolver $this$resolveAsTypeface_u2dWqqsr6A, FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis) {
        Intrinsics.checkNotNullParameter($this$resolveAsTypeface_u2dWqqsr6A, "$this$resolveAsTypeface");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        State<Object> r0 = $this$resolveAsTypeface_u2dWqqsr6A.m7108resolveDPcqOEQ(fontFamily, fontWeight, fontStyle, fontSynthesis);
        Intrinsics.checkNotNull(r0, "null cannot be cast to non-null type androidx.compose.runtime.State<android.graphics.Typeface>");
        return r0;
    }
}
