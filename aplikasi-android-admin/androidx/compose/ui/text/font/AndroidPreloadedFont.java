...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    public final int m7085getStyle_LCdwA() {
        return this.style;
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    private AndroidPreloadedFont(FontWeight weight2, int style2, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.Companion.m7126getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, variationSettings, (DefaultConstructorMarker) null);
