...
public final class SaversKt {
    ...
    public static final <T extends Saver<Original, Saveable>, Original, Saveable> Object save(Original value, T saver, SaverScope scope) {
        ...
        if (value != null) {
            ...
            Object save = saver.save(scope, value);
            if (save != null) {
                return save;
            }
        }
    ...
    public static final /* synthetic */ <T extends Saver<Original, Saveable>, Original, Saveable, Result> Result restore(Saveable value, T saver) {
        Intrinsics.checkNotNullParameter(saver, "saver");
        if (Intrinsics.areEqual((Object) value, (Object) false) || value == null) {
            return null;
        }
        Saveable saveable = value;
        Result restore = ((Saver) saver).restore(value);
