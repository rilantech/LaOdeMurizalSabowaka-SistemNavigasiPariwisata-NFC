...
public final class InputMode {
    ...
    public static final int Keyboard = m5717constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int Touch = m5717constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ InputMode m5716boximpl(int i) {
    ...
    public static boolean m5718equalsimpl(int i, Object obj) {
        return (obj instanceof InputMode) && i == ((InputMode) obj).m5722unboximpl();
    }
    ...
    public final /* synthetic */ int m5722unboximpl() {
        return this.value;
    }

    private /* synthetic */ InputMode(int value2) {
        this.value = value2;
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m5721toStringimpl(int arg0) {
        if (m5719equalsimpl0(arg0, Touch)) {
            return "Touch";
        }
        if (m5719equalsimpl0(arg0, Keyboard)) {
            return "Keyboard";
        }
        return "Error";
    }
    ...
    public static final class Companion {
        ...
        public final int m5724getTouchaOaMEAU() {
            return InputMode.Touch;
        }

        /* renamed from: getKeyboard-aOaMEAU  reason: not valid java name */
        public final int m5723getKeyboardaOaMEAU() {
