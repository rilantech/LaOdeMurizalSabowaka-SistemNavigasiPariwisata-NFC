...
public final class PointerButtons {
    ...
    public static final /* synthetic */ PointerButtons m6123boximpl(int i) {
        return new PointerButtons(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m6124constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m6125equalsimpl(int i, Object obj) {
        return (obj instanceof PointerButtons) && i == ((PointerButtons) obj).m6129unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m6126equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m6127hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m6128toStringimpl(int i) {
        return "PointerButtons(packedValue=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m6125equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m6127hashCodeimpl(this.packedValue);
    }
    ...
    public final /* synthetic */ int m6129unboximpl() {
