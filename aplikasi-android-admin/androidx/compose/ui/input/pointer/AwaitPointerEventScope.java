...
public interface AwaitPointerEventScope extends Density {
    ...
    public static final class DefaultImpls {
        ...
        public static int m6106roundToPxR2X_6o(AwaitPointerEventScope $this, long $receiver) {
            return AwaitPointerEventScope.super.m7528roundToPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4  reason: not valid java name */
        public static int m6107roundToPx0680j_4(AwaitPointerEventScope $this, float $receiver) {
            return AwaitPointerEventScope.super.m7529roundToPx0680j_4($receiver);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA  reason: not valid java name */
        public static float m6108toDpGaN1DYA(AwaitPointerEventScope $this, long $receiver) {
            return AwaitPointerEventScope.super.m7530toDpGaN1DYA($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM  reason: not valid java name */
        public static float m6109toDpu2uoSUM(AwaitPointerEventScope $this, float $receiver) {
            return AwaitPointerEventScope.super.m7531toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM  reason: not valid java name */
        public static float m6110toDpu2uoSUM(AwaitPointerEventScope $this, int $receiver) {
            return AwaitPointerEventScope.super.m7532toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM  reason: not valid java name */
        public static long m6111toDpSizekrfVVM(AwaitPointerEventScope $this, long $receiver) {
            return AwaitPointerEventScope.super.m7533toDpSizekrfVVM($receiver);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o  reason: not valid java name */
        public static float m6112toPxR2X_6o(AwaitPointerEventScope $this, long $receiver) {
            return AwaitPointerEventScope.super.m7534toPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4  reason: not valid java name */
        public static float m6113toPx0680j_4(AwaitPointerEventScope $this, float $receiver) {
            return AwaitPointerEventScope.super.m7535toPx0680j_4($receiver);
        }
        ...
        public static long m6114toSizeXkaWNTQ(AwaitPointerEventScope $this, long $receiver) {
            return AwaitPointerEventScope.super.m7536toSizeXkaWNTQ($receiver);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do  reason: not valid java name */
        public static long m6115toSp0xMU5do(AwaitPointerEventScope $this, float $receiver) {
            return AwaitPointerEventScope.super.m7537toSp0xMU5do($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
        public static long m6116toSpkPz2Gy4(AwaitPointerEventScope $this, float $receiver) {
            return AwaitPointerEventScope.super.m7538toSpkPz2Gy4($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
        public static long m6117toSpkPz2Gy4(AwaitPointerEventScope $this, int $receiver) {
            return AwaitPointerEventScope.super.m7539toSpkPz2Gy4($receiver);
        }

        @Deprecated
        /* renamed from: getExtendedTouchPadding-NH-jbRc  reason: not valid java name */
        public static long m6105getExtendedTouchPaddingNHjbRc(AwaitPointerEventScope $this) {
            return AwaitPointerEventScope.super.m6103getExtendedTouchPaddingNHjbRc();
        }
    ...
    /* renamed from: getExtendedTouchPadding-NH-jbRc  reason: not valid java name */
    long m6103getExtendedTouchPaddingNHjbRc() {
