...
public final class PointerKeyboardModifiers {
    ...
    public static final /* synthetic */ PointerKeyboardModifiers m6252boximpl(int i) {
    ...
    public static boolean m6254equalsimpl(int i, Object obj) {
        return (obj instanceof PointerKeyboardModifiers) && i == ((PointerKeyboardModifiers) obj).m6258unboximpl();
    }
    ...
    public static String m6257toStringimpl(int i) {
        return "PointerKeyboardModifiers(packedValue=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m6254equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m6256hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m6257toStringimpl(this.packedValue);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m6258unboximpl() {
