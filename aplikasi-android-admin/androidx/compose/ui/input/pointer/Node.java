...
public final class Node extends NodeParent {
    ...
    public boolean dispatchMainEventPass(Map<PointerId, PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        long size = layoutCoordinates.m6360getSizeYbymL2g();
        Modifier.Node $this$dispatchForKind_u2d6rFNWt0$iv = this.modifierNode;
        int kind$iv = NodeKind.m6666constructorimpl(16);
        ...
        while (this_$iv$iv != null) {
            if (this_$iv$iv instanceof PointerInputModifierNode) {
                this_$iv = this_$iv2;
                ((PointerInputModifierNode) this_$iv$iv).m6725onPointerEventH0pRuoY(event, PointerEventPass.Initial, size);
            } else {
                this_$iv = this_$iv2;
        ...
        if (this.modifierNode.isAttached()) {
            ...
            int kind$iv2 = NodeKind.m6666constructorimpl(16);
            ...
            while (this_$iv$iv2 != null) {
                if (this_$iv$iv2 instanceof PointerInputModifierNode) {
                    ((PointerInputModifierNode) this_$iv$iv2).m6725onPointerEventH0pRuoY(event, PointerEventPass.Main, size);
                } else {
    ...
    public boolean dispatchFinalEventPass(InternalPointerEvent internalPointerEvent) {
        ...
        if (this_$iv3.relevantChanges.isEmpty()) {
            ...
            while (true) {
                ...
                if (this_$iv$iv instanceof PointerInputModifierNode) {
                    ((PointerInputModifierNode) this_$iv$iv).m6725onPointerEventH0pRuoY(event, PointerEventPass.Final, size);
                    this_$iv = this_$iv3;
    ...
    public boolean buildCache(Map<PointerId, PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        while (it.hasNext()) {
            ...
            long key = ((PointerId) next.getKey()).m6176unboximpl();
            ...
            if (0 <= size) {
                while (true) {
                    if (((PointerId) this.pointerIds.getContent()[i4]).m6176unboximpl() != keyValue) {
                        if (i4 == size) {
                            break;
                        }
                        i4++;
            ...
            if (keyInPointerIds) {
                ...
                while (index$iv < size2) {
                    ...
                    historical.add(new HistoricalChange(uptimeMillis, layoutCoordinates2.m6361localPositionOfR5De75A(layoutCoordinates, it3.m6118getPositionF1C5BW0()), (DefaultConstructorMarker) null));
                    index$iv++;
                    size2 = size2;
                    keyValue = keyValue;
                ...
                PointerId r9 = PointerId.m6170boximpl(key);
                LayoutCoordinates layoutCoordinates3 = this.coordinates;
                Intrinsics.checkNotNull(layoutCoordinates3);
                long r30 = layoutCoordinates3.m6361localPositionOfR5De75A(layoutCoordinates, change.m6191getPreviousPositionF1C5BW0());
                LayoutCoordinates layoutCoordinates4 = this.coordinates;
                Intrinsics.checkNotNull(layoutCoordinates4);
                map2.put(r9, PointerInputChange.m6180copyOHpmEuE$default(change, 0, 0, layoutCoordinates4.m6361localPositionOfR5De75A(layoutCoordinates, change.m6190getPositionF1C5BW0()), false, 0, r30, false, 0, historical, 0, 731, (Object) null));
                it = it2;
            } else {
        ...
        for (int i5 = this.pointerIds.getSize() - 1; -1 < i5; i5--) {
            if (!map.containsKey(PointerId.m6170boximpl(((PointerId) this.pointerIds.getContent()[i5]).m6176unboximpl()))) {
        ...
        while (true) {
            ...
            if (internalPointerEvent2.m6120issuesEnterExitEvent0FcD4WY(((PointerInputChange) it$iv).m6189getIdJ3iCeTQ())) {
                break;
            }
            index$iv$iv++;
            Map<PointerId, PointerInputChange> map3 = changes;
        ...
        if (enterExitChange != null) {
            if (!isInBounds) {
                ...
                if (this.isIn) {
                    ...
                    z = true;
                    this.isIn = !PointerEventKt.m6135isOutOfBoundsO0kMr_c(enterExitChange, layoutCoordinates6.m6360getSizeYbymL2g());
                } else {
                    z = true;
                }
            }
            if (this.isIn != this.wasIn && (PointerEventType.m6140equalsimpl0(event.m6133getType7fucELk(), PointerEventType.Companion.m6146getMove7fucELk()) || PointerEventType.m6140equalsimpl0(event.m6133getType7fucELk(), PointerEventType.Companion.m6144getEnter7fucELk()) || PointerEventType.m6140equalsimpl0(event.m6133getType7fucELk(), PointerEventType.Companion.m6145getExit7fucELk()))) {
                if (this.isIn) {
                    i = PointerEventType.Companion.m6144getEnter7fucELk();
                } else {
                    i = PointerEventType.Companion.m6145getExit7fucELk();
                }
                event.m6134setTypeEhbLWgg$ui_release(i);
            } else if (PointerEventType.m6140equalsimpl0(event.m6133getType7fucELk(), PointerEventType.Companion.m6144getEnter7fucELk()) && this.wasIn && !this.hasExited) {
                event.m6134setTypeEhbLWgg$ui_release(PointerEventType.Companion.m6146getMove7fucELk());
            } else if (PointerEventType.m6140equalsimpl0(event.m6133getType7fucELk(), PointerEventType.Companion.m6145getExit7fucELk()) && this.isIn && enterExitChange.getPressed()) {
                event.m6134setTypeEhbLWgg$ui_release(PointerEventType.Companion.m6146getMove7fucELk());
            }
        } else {
            z2 = false;
        ...
        boolean changed = (childChanged || !PointerEventType.m6140equalsimpl0(event.m6133getType7fucELk(), PointerEventType.Companion.m6146getMove7fucELk()) || hasPositionChanged(this.pointerEvent, event)) ? z : z2;
    ...
    private final boolean hasPositionChanged(PointerEvent oldEvent, PointerEvent newEvent) {
        ...
        for (int i = 0; i < size; i++) {
            if (!Offset.m4710equalsimpl0(oldEvent.getChanges().get(i).m6190getPositionF1C5BW0(), newEvent.getChanges().get(i).m6190getPositionF1C5BW0())) {
                return true;
            }
        }
        return false;
        ...
        if (event != null) {
            ...
            while (true) {
                ...
                if (index$iv < size) {
                    ...
                    if (!change.getPressed() && (!internalPointerEvent.m6120issuesEnterExitEvent0FcD4WY(change.m6189getIdJ3iCeTQ()) || !this.isIn)) {
                        remove = true;
                    }
                    if (remove) {
                        this.pointerIds.remove(PointerId.m6170boximpl(change.m6189getIdJ3iCeTQ()));
                    }
                    index$iv++;
                } else {
                    this.isIn = false;
                    this.hasExited = PointerEventType.m6140equalsimpl0(event.m6133getType7fucELk(), PointerEventType.Companion.m6145getExit7fucELk());
                    return;
                }
            }
        }
