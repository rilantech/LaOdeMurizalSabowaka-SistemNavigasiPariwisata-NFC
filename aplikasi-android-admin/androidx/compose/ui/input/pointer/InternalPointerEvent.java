...
public final class InternalPointerEvent {
    ...
    public InternalPointerEvent(Map<PointerId, PointerInputChange> changes2, PointerInputEvent pointerInputEvent2) {
    ...
    public final boolean m6120issuesEnterExitEvent0FcD4WY(long pointerId) {
        Object it$iv;
        List $this$fastForEach$iv$iv = this.pointerInputEvent.getPointers();
        int index$iv$iv = 0;
        ...
        while (true) {
            ...
            if (PointerId.m6173equalsimpl0(((PointerInputEventData) it$iv).m6203getIdJ3iCeTQ(), pointerId)) {
                break;
            }
            index$iv$iv++;
        }
