...
public final class VelocityTracker {
    ...
    private long currentPointerPositionAccumulator = Offset.Companion.m4729getZeroF1C5BW0();
    ...
    public final long m6301getCurrentPointerPositionAccumulatorF1C5BW0$ui_release() {
        return this.currentPointerPositionAccumulator;
    }

    /* renamed from: setCurrentPointerPositionAccumulator-k-4lQ0M$ui_release  reason: not valid java name */
    public final void m6302setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
        this.currentPointerPositionAccumulator = j;
    }

    /* renamed from: addPosition-Uv8p0NA  reason: not valid java name */
    public final void m6299addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m4713getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m4714getYimpl(position));
    }

    /* renamed from: calculateVelocity-9UxMQ8M  reason: not valid java name */
    public final long m6300calculateVelocity9UxMQ8M() {
