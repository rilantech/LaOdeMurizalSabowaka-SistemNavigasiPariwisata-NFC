...
public final class HistoricalChange {
    ...
    private HistoricalChange(long uptimeMillis2, long position2) {
    ...
    public final long m6118getPositionF1C5BW0() {
        return this.position;
    }

    public String toString() {
        return "HistoricalChange(uptimeMillis=" + this.uptimeMillis + ", position=" + Offset.m4721toStringimpl(this.position) + ')';
    }
}
