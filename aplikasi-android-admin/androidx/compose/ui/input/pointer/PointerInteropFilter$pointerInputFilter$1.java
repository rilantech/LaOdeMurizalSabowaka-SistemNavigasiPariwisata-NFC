...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    public void m6248onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent r19, androidx.compose.ui.input.pointer.PointerEventPass r20, long r21) {
        /*
            r18 = this;
            r0 = r18
            r1 = r20
        ...
        L_0x00a0:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1.m6248onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent, androidx.compose.ui.input.pointer.PointerEventPass, long):void");
    }
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
        ...
        if ($this$fastForEach$iv$iv != null) {
            if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                ...
                if (layoutCoordinates$ui_release != null) {
                    PointerInteropUtils_androidKt.m6249toCancelMotionEventScoped4ec7I(pointerEvent, layoutCoordinates$ui_release.m6362localToRootMKHz9U(Offset.Companion.m4729getZeroF1C5BW0()), new PointerInteropFilter$pointerInputFilter$1$dispatchToView$2(this.this$0));
                } else {
        ...
        if (layoutCoordinates$ui_release2 != null) {
            PointerInteropUtils_androidKt.m6250toMotionEventScoped4ec7I(pointerEvent, layoutCoordinates$ui_release2.m6362localToRootMKHz9U(Offset.Companion.m4729getZeroF1C5BW0()), new PointerInteropFilter$pointerInputFilter$1$dispatchToView$3(this, this.this$0));
            if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
