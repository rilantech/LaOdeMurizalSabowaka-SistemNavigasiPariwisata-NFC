...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> changes2, InternalPointerEvent internalPointerEvent2) {
        ...
        int i = 0;
        this.buttons = PointerButtons.m6124constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m6253constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : i);
        this.type = m6130calculatePointerEventType7fucELk();
    }
    ...
    public final int m6131getButtonsry648PA() {
        return this.buttons;
    }

    /* renamed from: getKeyboardModifiers-k7X9c1A  reason: not valid java name */
    public final int m6132getKeyboardModifiersk7X9c1A() {
        return this.keyboardModifiers;
    }

    /* renamed from: getType-7fucELk  reason: not valid java name */
    public final int m6133getType7fucELk() {
        return this.type;
    }

    /* renamed from: setType-EhbLWgg$ui_release  reason: not valid java name */
    public final void m6134setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk  reason: not valid java name */
    private final int m6130calculatePointerEventType7fucELk() {
        MotionEvent motionEvent = getMotionEvent$ui_release();
        if (motionEvent != null) {
            switch (motionEvent.getActionMasked()) {
                case 0:
                case 5:
                    return PointerEventType.Companion.m6147getPress7fucELk();
                case 1:
                case 6:
                    return PointerEventType.Companion.m6148getRelease7fucELk();
                case 2:
                case 7:
                    return PointerEventType.Companion.m6146getMove7fucELk();
                case 8:
                    return PointerEventType.Companion.m6149getScroll7fucELk();
                case 9:
                    return PointerEventType.Companion.m6144getEnter7fucELk();
                case 10:
                    return PointerEventType.Companion.m6145getExit7fucELk();
                default:
                    return PointerEventType.Companion.m6150getUnknown7fucELk();
            }
        } else {
    ...
    public final PointerEvent copy(List<PointerInputChange> changes2, MotionEvent motionEvent) {
        ...
        while (index$iv < size) {
            ...
            map.put(PointerId.m6170boximpl(change.m6189getIdJ3iCeTQ()), change);
            Collection collection = pointerEventData;
            long r15 = change.m6189getIdJ3iCeTQ();
            long uptimeMillis = change.getUptimeMillis();
            long r19 = change.m6190getPositionF1C5BW0();
            long r21 = change.m6190getPositionF1C5BW0();
            boolean pressed = change.getPressed();
            float pressure = change.getPressure();
            int r25 = change.m6193getTypeT8wyACA();
            InternalPointerEvent internalPointerEvent2 = this.internalPointerEvent;
            if (internalPointerEvent2 != null) {
                $this$fastForEach$iv = $this$fastForEach$iv2;
                $i$f$fastForEach = $i$f$fastForEach2;
                z = true;
                if (internalPointerEvent2.m6120issuesEnterExitEvent0FcD4WY(change.m6189getIdJ3iCeTQ())) {
