...
public final class PointerInputEventData {
    ...
    public static /* synthetic */ PointerInputEventData m6196copygYeeOSc$default(PointerInputEventData pointerInputEventData, long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, int i2, Object obj) {
        PointerInputEventData pointerInputEventData2 = pointerInputEventData;
        int i3 = i2;
        return pointerInputEventData.m6202copygYeeOSc((i3 & 1) != 0 ? pointerInputEventData2.id : j, (i3 & 2) != 0 ? pointerInputEventData2.uptime : j2, (i3 & 4) != 0 ? pointerInputEventData2.positionOnScreen : j3, (i3 & 8) != 0 ? pointerInputEventData2.position : j4, (i3 & 16) != 0 ? pointerInputEventData2.down : z, (i3 & 32) != 0 ? pointerInputEventData2.pressure : f, (i3 & 64) != 0 ? pointerInputEventData2.type : i, (i3 & 128) != 0 ? pointerInputEventData2.issuesEnterExit : z2, (i3 & 256) != 0 ? pointerInputEventData2.historical : list, (i3 & 512) != 0 ? pointerInputEventData2.scrollDelta : j5);
    }

    /* renamed from: component1-J3iCeTQ  reason: not valid java name */
    public final long m6197component1J3iCeTQ() {
        return this.id;
    }

    /* renamed from: component10-F1C5BW0  reason: not valid java name */
    public final long m6198component10F1C5BW0() {
    ...
    public final long m6199component3F1C5BW0() {
        return this.positionOnScreen;
    }

    /* renamed from: component4-F1C5BW0  reason: not valid java name */
    public final long m6200component4F1C5BW0() {
    ...
    public final int m6201component7T8wyACA() {
        return this.type;
    }
    ...
    public final PointerInputEventData m6202copygYeeOSc(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List<HistoricalChange> list, long j5) {
    ...
    public boolean equals(Object obj) {
        ...
        return PointerId.m6173equalsimpl0(this.id, pointerInputEventData.id) && this.uptime == pointerInputEventData.uptime && Offset.m4710equalsimpl0(this.positionOnScreen, pointerInputEventData.positionOnScreen) && Offset.m4710equalsimpl0(this.position, pointerInputEventData.position) && this.down == pointerInputEventData.down && Float.compare(this.pressure, pointerInputEventData.pressure) == 0 && PointerType.m6262equalsimpl0(this.type, pointerInputEventData.type) && this.issuesEnterExit == pointerInputEventData.issuesEnterExit && Intrinsics.areEqual((Object) this.historical, (Object) pointerInputEventData.historical) && Offset.m4710equalsimpl0(this.scrollDelta, pointerInputEventData.scrollDelta);
    }

    public int hashCode() {
        int r0 = ((((((PointerId.m6174hashCodeimpl(this.id) * 31) + Long.hashCode(this.uptime)) * 31) + Offset.m4715hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m4715hashCodeimpl(this.position)) * 31;
        boolean z = this.down;
        boolean z2 = true;
        if (z) {
            z = true;
        }
        int hashCode = (((((r0 + (z ? 1 : 0)) * 31) + Float.hashCode(this.pressure)) * 31) + PointerType.m6263hashCodeimpl(this.type)) * 31;
        boolean z3 = this.issuesEnterExit;
        if (!z3) {
            z2 = z3;
        }
        return ((((hashCode + (z2 ? 1 : 0)) * 31) + this.historical.hashCode()) * 31) + Offset.m4715hashCodeimpl(this.scrollDelta);
    }

    public String toString() {
        return "PointerInputEventData(id=" + PointerId.m6175toStringimpl(this.id) + ", uptime=" + this.uptime + ", positionOnScreen=" + Offset.m4721toStringimpl(this.positionOnScreen) + ", position=" + Offset.m4721toStringimpl(this.position) + ", down=" + this.down + ", pressure=" + this.pressure + ", type=" + PointerType.m6264toStringimpl(this.type) + ", issuesEnterExit=" + this.issuesEnterExit + ", historical=" + this.historical + ", scrollDelta=" + Offset.m4721toStringimpl(this.scrollDelta) + ')';
    }
    ...
    public final long m6203getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m6205getPositionOnScreenF1C5BW0() {
        return this.positionOnScreen;
    }

    /* renamed from: getPosition-F1C5BW0  reason: not valid java name */
    public final long m6204getPositionF1C5BW0() {
        return this.position;
    }
    ...
    public final int m6207getTypeT8wyACA() {
        return this.type;
    }
    ...
    public final long m6206getScrollDeltaF1C5BW0() {
        return this.scrollDelta;
    }
}
