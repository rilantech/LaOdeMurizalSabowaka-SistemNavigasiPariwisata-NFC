...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int initialInputMode, Function1<? super InputMode, Boolean> onRequestInputModeChange2) {
        ...
        this.inputMode$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m5716boximpl(initialInputMode), (SnapshotMutationPolicy) null, 2, (Object) null);
    }

    /* renamed from: getInputMode-aOaMEAU  reason: not valid java name */
    public int m5727getInputModeaOaMEAU() {
        return ((InputMode) this.inputMode$delegate.getValue()).m5722unboximpl();
    }

    /* renamed from: setInputMode-iuPiT84  reason: not valid java name */
    public void m5729setInputModeiuPiT84(int i) {
        this.inputMode$delegate.setValue(InputMode.m5716boximpl(i));
    }

    /* renamed from: requestInputMode-iuPiT84  reason: not valid java name */
    public boolean m5728requestInputModeiuPiT84(int inputMode) {
        return this.onRequestInputModeChange.invoke(InputMode.m5716boximpl(inputMode)).booleanValue();
    }
}
