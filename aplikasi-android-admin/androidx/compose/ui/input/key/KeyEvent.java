...
public final class KeyEvent {
    ...
    public static final /* synthetic */ KeyEvent m6026boximpl(android.view.KeyEvent keyEvent) {
        return new KeyEvent(keyEvent);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static android.view.KeyEvent m6027constructorimpl(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "nativeKeyEvent");
        return keyEvent;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m6028equalsimpl(android.view.KeyEvent keyEvent, Object obj) {
        return (obj instanceof KeyEvent) && Intrinsics.areEqual((Object) keyEvent, (Object) ((KeyEvent) obj).m6032unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m6029equalsimpl0(android.view.KeyEvent keyEvent, android.view.KeyEvent keyEvent2) {
        return Intrinsics.areEqual((Object) keyEvent, (Object) keyEvent2);
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m6030hashCodeimpl(android.view.KeyEvent keyEvent) {
        return keyEvent.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m6031toStringimpl(android.view.KeyEvent keyEvent) {
        return "KeyEvent(nativeKeyEvent=" + keyEvent + ')';
    }

    public boolean equals(Object obj) {
        return m6028equalsimpl(this.nativeKeyEvent, obj);
    }

    public int hashCode() {
        return m6030hashCodeimpl(this.nativeKeyEvent);
    }

    public String toString() {
        return m6031toStringimpl(this.nativeKeyEvent);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ android.view.KeyEvent m6032unboximpl() {
