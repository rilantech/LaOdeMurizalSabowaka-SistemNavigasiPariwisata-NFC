    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                if (this.$consumed) {
                    this.label = 2;
                    if (this.this$0.dispatcher.m6071dispatchPostFlingRZ2iAVY(this.$viewVelocity, Velocity.Companion.m7790getZero9UxMQ8M(), this) != coroutine_suspended) {
                        break;
                    } else {
                    ...
                    this.label = 1;
                    if (this.this$0.dispatcher.m6071dispatchPostFlingRZ2iAVY(Velocity.Companion.m7790getZero9UxMQ8M(), this.$viewVelocity, this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }
