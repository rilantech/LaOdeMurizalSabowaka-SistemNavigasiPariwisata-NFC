...
final class AndroidView_androidKt$AndroidView$2$1 extends Lambda implements Function2<LayoutNode, Function1<? super T, ? extends Unit>, Unit> {
    ...
    public final void invoke(LayoutNode $this$set, Function1<? super T, Unit> it) {
        ...
        AndroidView_androidKt.requireViewFactoryHolder($this$set).setResetBlock(it);
    }
}
