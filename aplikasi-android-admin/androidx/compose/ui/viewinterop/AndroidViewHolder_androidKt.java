...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View $this$layoutAccordingTo, LayoutNode layoutNode) {
        ...
        int x = MathKt.roundToInt(Offset.m4713getXimpl(position));
        int y = MathKt.roundToInt(Offset.m4714getYimpl(position));
    ...
    public static final int toNestedScrollSource(int type) {
        if (type == 0) {
            return NestedScrollSource.Companion.m6087getDragWNlRxjI();
        }
        return NestedScrollSource.Companion.m6088getFlingWNlRxjI();
    }
}
