...
public final class ShadowKt {
    ...
    public static /* synthetic */ Modifier m4624shadowziNgDLE$default(Modifier modifier, float f, Shape shape, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        if ((i & 4) != 0) {
            z = Dp.m7553compareTo0680j_4(f, Dp.m7554constructorimpl((float) 0)) > 0;
        }
        return m4623shadowziNgDLE(modifier, f, shape, z);
    }
    ...
    public static final /* synthetic */ Modifier m4623shadowziNgDLE(Modifier $this$shadow_u2dziNgDLE, float elevation, Shape shape, boolean clip) {
        Intrinsics.checkNotNullParameter($this$shadow_u2dziNgDLE, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m4621shadows4CzXII($this$shadow_u2dziNgDLE, elevation, shape, clip, GraphicsLayerScopeKt.getDefaultShadowColor(), GraphicsLayerScopeKt.getDefaultShadowColor());
    }

    /* renamed from: shadow-s4CzXII$default  reason: not valid java name */
    public static /* synthetic */ Modifier m4622shadows4CzXII$default(Modifier modifier, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        Shape shape2;
        boolean z2;
        long j3;
        long j4;
        ...
        if ((i & 4) != 0) {
            float f2 = f;
            z2 = Dp.m7553compareTo0680j_4(f, Dp.m7554constructorimpl((float) 0)) > 0;
        } else {
            float f3 = f;
            z2 = z;
        }
        ...
        return m4621shadows4CzXII(modifier, f, shape2, z2, j3, j4);
    }

    /* renamed from: shadow-s4CzXII  reason: not valid java name */
    public static final Modifier m4621shadows4CzXII(Modifier $this$shadow_u2ds4CzXII, float elevation, Shape shape, boolean clip, long ambientColor, long spotColor) {
        Modifier $this$inspectable$iv = $this$shadow_u2ds4CzXII;
        Intrinsics.checkNotNullParameter($this$inspectable$iv, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        if (Dp.m7553compareTo0680j_4(elevation, Dp.m7554constructorimpl((float) 0)) <= 0 && !clip) {
