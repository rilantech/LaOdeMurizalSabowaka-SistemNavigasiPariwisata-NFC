...
final class BlurKt$blur$1 extends Lambda implements Function1<GraphicsLayerScope, Unit> {
    ...
    public final void invoke(GraphicsLayerScope $this$graphicsLayer) {
        ...
        float horizontalBlurPixels = $this$graphicsLayer.m7535toPx0680j_4(this.$radiusX);
        float verticalBlurPixels = $this$graphicsLayer.m7535toPx0680j_4(this.$radiusY);
        if (horizontalBlurPixels <= 0.0f || verticalBlurPixels <= 0.0f) {
            renderEffect = null;
        } else {
            renderEffect = RenderEffectKt.m5292BlurEffect3YTHUZs(horizontalBlurPixels, verticalBlurPixels, this.$tileMode);
        }
