...
public final class ShadowKt$shadows4CzXII$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo $this$null) {
        ...
        $this$shadow_s4CzXII_u24lambda_u240.getProperties().set("elevation", Dp.m7552boximpl(this.$elevation$inlined));
        ...
        $this$shadow_s4CzXII_u24lambda_u240.getProperties().set("ambientColor", Color.m4953boximpl(this.$ambientColor$inlined));
        $this$shadow_s4CzXII_u24lambda_u240.getProperties().set("spotColor", Color.m4953boximpl(this.$spotColor$inlined));
    }
}
