...
final class ViewGroupKt$descendants$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super View>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0070, code lost:
        if ((r7 instanceof android.view.ViewGroup) == false) goto L_0x0095;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x008b, code lost:
        if (r9.yieldAll(r10, (kotlin.coroutines.Continuation<? super kotlin.Unit>) r1) != r0) goto L_0x008e;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0064, code lost:
        if (r3.yield(r8, r1) != r0) goto L_0x0067;
     */
