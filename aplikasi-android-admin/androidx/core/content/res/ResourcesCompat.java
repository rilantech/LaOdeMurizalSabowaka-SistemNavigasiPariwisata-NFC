...
public final class ResourcesCompat {
    ...
    public static abstract class FontCallback {
        ...
        public abstract void m7808lambda$callbackFailAsync$1$androidxcorecontentresResourcesCompat$FontCallback(int i);

        /* renamed from: onFontRetrieved */
        public abstract void m7809lambda$callbackSuccessAsync$0$androidxcorecontentresResourcesCompat$FontCallback(Typeface typeface);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:56:0x00d6 A[ExcHandler: IOException (e java.io.IOException), Splitter:B:14:0x003b] */
    ...
    private static android.graphics.Typeface loadFont(android.content.Context r21, android.content.res.Resources r22, android.util.TypedValue r23, int r24, int r25, androidx.core.content.res.ResourcesCompat.FontCallback r26, android.os.Handler r27, boolean r28, boolean r29) {
        ...
        L_0x0038:
            ...
            return r16
        L_0x003b:
            java.lang.String r0 = r9.toLowerCase()     // Catch:{ XmlPullParserException -> 0x00f9, IOException -> 0x00d6 }
            java.lang.String r1 = ".xml"
            boolean r0 = r0.endsWith(r1)     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00d6 }
            if (r0 == 0) goto L_0x0090
            android.content.res.XmlResourceParser r0 = r11.getXml(r13)     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00d6 }
            androidx.core.content.res.FontResourcesParserCompat$FamilyResourceEntry r1 = androidx.core.content.res.FontResourcesParserCompat.parse(r0, r11)     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00d6 }
            r17 = r1
        ...
        L_0x0067:
            ...
            goto L_0x00ff
        L_0x006d:
            int r5 = r12.assetCookie     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00d6 }
            r1 = r21
            r2 = r17
            r3 = r22
            r4 = r24
