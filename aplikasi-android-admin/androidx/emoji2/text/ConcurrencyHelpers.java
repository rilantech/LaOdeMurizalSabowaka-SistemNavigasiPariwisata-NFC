...
class ConcurrencyHelpers {
    ...
    static ThreadPoolExecutor createBackgroundPriorityExecutor(String name) {
        ThreadPoolExecutor executor = new ThreadPoolExecutor(0, 1, 15, TimeUnit.SECONDS, new LinkedBlockingDeque(), new ConcurrencyHelpers$$ExternalSyntheticLambda1(name));
