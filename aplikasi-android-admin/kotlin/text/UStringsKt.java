...
public final class UStringsKt {
    ...
    public static final String m1435toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1437toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1436toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1434toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m199unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m462unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m278unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m357unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m278unboximpl();
        if (Integer.compareUnsigned(r0, UInt.m226constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m143boximpl(UByte.m149constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m278unboximpl();
        if (Integer.compareUnsigned(r0, UInt.m226constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m406boximpl(UShort.m412constructorimpl((short) r0));
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m305constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            result = ULong.m305constructorimpl(ULong.m305constructorimpl(((long) UInt.m226constructorimpl(digit)) & 4294967295L) + result2);
