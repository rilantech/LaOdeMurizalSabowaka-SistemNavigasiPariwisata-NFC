...
final class ParameterizedTypeImpl implements ParameterizedType, TypeImpl {
    ...
    public String getTypeName() {
        ...
        if (type != null) {
            $this$getTypeName_u24lambda_u240.append(TypesJVMKt.typeToString(type));
        ...
        if (!(typeArr.length == 0)) {
            ArraysKt.joinTo$default((Object[]) typeArr, (Appendable) $this$getTypeName_u24lambda_u240, (CharSequence) null, (CharSequence) "<", (CharSequence) ">", 0, (CharSequence) null, (Function1) ParameterizedTypeImpl$getTypeName$1$1.INSTANCE, 50, (Object) null);
        }
