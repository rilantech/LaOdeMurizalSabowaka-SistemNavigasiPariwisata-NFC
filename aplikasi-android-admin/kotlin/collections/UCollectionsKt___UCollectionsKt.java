...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> $this$toUByteArray) {
        ...
        byte[] result = UByteArray.m201constructorimpl($this$toUByteArray.size());
        int index = 0;
        for (UByte r3 : $this$toUByteArray) {
            UByteArray.m212setVurrAj0(result, index, r3.m199unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> $this$toUIntArray) {
        ...
        int[] result = UIntArray.m280constructorimpl($this$toUIntArray.size());
        int index = 0;
        for (UInt r3 : $this$toUIntArray) {
            UIntArray.m291setVXSXFK8(result, index, r3.m278unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> $this$toULongArray) {
        ...
        long[] result = ULongArray.m359constructorimpl($this$toULongArray.size());
        int index = 0;
        for (ULong r3 : $this$toULongArray) {
            ULongArray.m370setk8EXiF4(result, index, r3.m357unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> $this$toUShortArray) {
        ...
        short[] result = UShortArray.m464constructorimpl($this$toUShortArray.size());
        int index = 0;
        for (UShort r3 : $this$toUShortArray) {
            UShortArray.m475set01HTLdE(result, index, r3.m462unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> $this$sum) {
        ...
        for (UInt r2 : $this$sum) {
            sum = UInt.m226constructorimpl(sum + r2.m278unboximpl());
        }
        return sum;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> $this$sum) {
        ...
        for (ULong r3 : $this$sum) {
            sum = ULong.m305constructorimpl(sum + r3.m357unboximpl());
        }
        return sum;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> $this$sum) {
        ...
        for (UByte r2 : $this$sum) {
            sum = UInt.m226constructorimpl(UInt.m226constructorimpl(r2.m199unboximpl() & UByte.MAX_VALUE) + sum);
        }
        return sum;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> $this$sum) {
        ...
        for (UShort r2 : $this$sum) {
            sum = UInt.m226constructorimpl(UInt.m226constructorimpl(65535 & r2.m462unboximpl()) + sum);
        }
        return sum;
    }
}
