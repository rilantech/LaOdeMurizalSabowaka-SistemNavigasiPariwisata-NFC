    ...
    public final void removeFirst(int n) {
        ...
        if (n >= 0) {
            ...
            if (!z) {
                ...
                int $this$forward$iv = (start + n) % this.capacity;
                if (start > $this$forward$iv) {
                    ArraysKt.fill((T[]) this.buffer, null, start, this.capacity);
                    ArraysKt.fill((T[]) this.buffer, null, 0, $this$forward$iv);
                } else {
                    ArraysKt.fill((T[]) this.buffer, null, start, $this$forward$iv);
                }
                this.startIndex = $this$forward$iv;
                this.size = size() - n;
            }
        } else {
