...
public final class LongSaturatedMathKt {
    ...
    public static final long m1591saturatingAddNuflL3o(long value, DurationUnit unit, long duration) {
        DurationUnit durationUnit = unit;
        Intrinsics.checkNotNullParameter(durationUnit, "unit");
        long durationInUnit = Duration.m1508toLongimpl(duration, durationUnit);
        boolean z = true;
        if (((value - 1) | 1) == Long.MAX_VALUE) {
            return m1590checkInfiniteSumDefinedPjuGub4(value, duration, durationInUnit);
        }
        if ((1 | (durationInUnit - 1)) != Long.MAX_VALUE) {
            z = false;
        }
        if (z) {
            return m1592saturatingAddInHalvesNuflL3o(value, unit, duration);
        }
    ...
    private static final long m1590checkInfiniteSumDefinedPjuGub4(long value, long duration, long durationInUnit) {
        if (!Duration.m1494isInfiniteimpl(duration) || (value ^ durationInUnit) >= 0) {
            return value;
        }
    ...
    private static final long m1592saturatingAddInHalvesNuflL3o(long value, DurationUnit unit, long duration) {
        long half = Duration.m1465divUwyO8pc(duration, 2);
        long halfInUnit = Duration.m1508toLongimpl(half, unit);
        if ((1 | (halfInUnit - 1)) == Long.MAX_VALUE) {
            return halfInUnit;
        }
        return m1591saturatingAddNuflL3o(m1591saturatingAddNuflL3o(value, unit, half), unit, Duration.m1497minusLRDsOJo(duration, half));
    }

    private static final long infinityOfSign(long value) {
        return value < 0 ? Duration.Companion.m1564getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.Companion.m1563getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long valueNs, long origin, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (origin - 1)) == Long.MAX_VALUE) {
            return Duration.m1515unaryMinusUwyO8pc(infinityOfSign(origin));
        }
    ...
    public static final long saturatingOriginsDiff(long origin1, long origin2, DurationUnit unit) {
        ...
        if ((((origin2 - 1) | 1) == Long.MAX_VALUE ? 1 : 0) == 0) {
            ...
            return Duration.m1515unaryMinusUwyO8pc(infinityOfSign(origin2));
        }
    }
    ...
    private static final long saturatingFiniteDiff(long value1, long value2, DurationUnit unit) {
        ...
        if (durationUnit.compareTo(DurationUnit.MILLISECONDS) >= 0) {
            return Duration.m1515unaryMinusUwyO8pc(infinityOfSign(result));
        }
        ...
        return Duration.m1498plusLRDsOJo(DurationKt.toDuration(resultMs, DurationUnit.MILLISECONDS), DurationKt.toDuration(resultUnit, durationUnit));
    }
