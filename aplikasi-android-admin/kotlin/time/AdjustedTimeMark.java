...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1451getAdjustmentUwyO8pc() {
    ...
    public TimeMark m1452minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1602minusLRDsOJo(this, duration);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m1450elapsedNowUwyO8pc() {
        return Duration.m1497minusLRDsOJo(this.mark.m1599elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1453plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1498plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
