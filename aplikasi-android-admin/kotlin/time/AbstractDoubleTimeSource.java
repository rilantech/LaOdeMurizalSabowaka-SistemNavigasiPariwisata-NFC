...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m1440minusLRDsOJo(long duration) {
            return ComparableTimeMark.DefaultImpls.m1457minusLRDsOJo(this, duration);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m1438elapsedNowUwyO8pc() {
            return Duration.m1497minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark m1443plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1498plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m1441minusUwyO8pc(ComparableTimeMark other) {
            ...
            } else if (Duration.m1467equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1494isInfiniteimpl(this.offset)) {
                return Duration.Companion.m1565getZEROUwyO8pc();
            } else {
                long offsetDiff = Duration.m1497minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
                long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
                return Duration.m1467equalsimpl0(startedAtDiff, Duration.m1515unaryMinusUwyO8pc(offsetDiff)) ? Duration.Companion.m1565getZEROUwyO8pc() : Duration.m1498plusLRDsOJo(startedAtDiff, offsetDiff);
            }
        }

        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) other).timeSource) && Duration.m1467equalsimpl0(m1441minusUwyO8pc((ComparableTimeMark) other), Duration.Companion.m1565getZEROUwyO8pc());
        }

        public int hashCode() {
            return Duration.m1490hashCodeimpl(Duration.m1498plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m1511toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1565getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
