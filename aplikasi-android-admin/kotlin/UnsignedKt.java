...
public final class UnsignedKt {
    ...
    public static final int m482uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m226constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }
    ...
    public static final long m484ulongDivideeb3DHEI(long v1, long v2) {
        ...
        if (divisor < 0) {
            ...
            return ULong.m305constructorimpl(j);
        } else if (dividend >= 0) {
            return ULong.m305constructorimpl(dividend / divisor);
        } else {
            int i = 1;
            long quotient = ((dividend >>> 1) / divisor) << 1;
            if (Long.compareUnsigned(ULong.m305constructorimpl(dividend - (quotient * divisor)), ULong.m305constructorimpl(divisor)) < 0) {
                i = 0;
            }
            return ULong.m305constructorimpl(((long) i) + quotient);
        }
    }
    ...
    public static final long m485ulongRemaindereb3DHEI(long v1, long v2) {
        ...
        if (divisor < 0) {
            ...
            if (Long.compareUnsigned(ULong.m305constructorimpl(rem), ULong.m305constructorimpl(divisor)) >= 0) {
                j = divisor;
            }
    ...
    public static final int doubleToUInt(double v) {
        ...
        if (v <= 2.147483647E9d) {
            return UInt.m226constructorimpl((int) v);
        }
        return UInt.m226constructorimpl(UInt.m226constructorimpl((int) (v - ((double) Integer.MAX_VALUE))) + UInt.m226constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        if (v < 9.223372036854776E18d) {
            return ULong.m305constructorimpl((long) v);
        }
        return ULong.m305constructorimpl(ULong.m305constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
