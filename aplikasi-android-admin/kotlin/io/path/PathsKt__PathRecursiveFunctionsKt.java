...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    private static final java.util.List<java.lang.Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r12) {
        ...
        L_0x0018:
            ...
            r7 = r6
            java.nio.file.DirectoryStream r7 = (java.nio.file.DirectoryStream) r7     // Catch:{ all -> 0x0040 }
            r8 = 0
            boolean r9 = r7 instanceof java.nio.file.SecureDirectoryStream     // Catch:{ all -> 0x0040 }
            if (r9 == 0) goto L_0x0039
            r1 = 0
            r0.setPath(r2)     // Catch:{ all -> 0x0040 }
            r9 = r7
            java.nio.file.SecureDirectoryStream r9 = (java.nio.file.SecureDirectoryStream) r9     // Catch:{ all -> 0x0040 }
            java.nio.file.Path r10 = r12.getFileName()     // Catch:{ all -> 0x0040 }
            java.lang.String r11 = "this.fileName"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r10, r11)     // Catch:{ all -> 0x0040 }
            handleEntry$PathsKt__PathRecursiveFunctionsKt(r9, r10, r0)     // Catch:{ all -> 0x0040 }
        L_0x0039:
