...
public class Base64 {
    ...
    private Base64(boolean isUrlSafe2, boolean isMimeScheme2) {
        this.isUrlSafe = isUrlSafe2;
        this.isMimeScheme = isMimeScheme2;
        if (!(!isUrlSafe2 || !isMimeScheme2)) {
    ...
    public static /* synthetic */ int encodeIntoByteArray$default(Base64 base64, byte[] bArr, byte[] bArr2, int i, int i2, int i3, int i4, Object obj) {
        ...
        if (obj == null) {
            ...
            return base64.encodeIntoByteArray(bArr, bArr2, i5, i6, i7);
        }
    ...
    public final byte[] decode(byte[] source, int startIndex, int endIndex) {
        ...
        byte[] destination = new byte[decodeSize(source, startIndex, endIndex)];
    ...
    public static /* synthetic */ int decodeIntoByteArray$default(Base64 base64, byte[] bArr, byte[] bArr2, int i, int i2, int i3, int i4, Object obj) {
        ...
        if (obj == null) {
            ...
            return base64.decodeIntoByteArray(bArr, bArr2, i5, i6, i7);
        }
    ...
    public final byte[] decode(CharSequence source, int startIndex, int endIndex) {
        ...
        if (source instanceof String) {
            ...
            Intrinsics.checkNotNullExpressionValue(byteSource, "this as java.lang.String).getBytes(charset)");
        } else {
    ...
    public static /* synthetic */ int decodeIntoByteArray$default(Base64 base64, CharSequence charSequence, byte[] bArr, int i, int i2, int i3, int i4, Object obj) {
        ...
        if (obj == null) {
            ...
            return base64.decodeIntoByteArray(charSequence, bArr, i5, i6, i7);
        }
        throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: decodeIntoByteArray");
    }
    ...
    public final byte[] encodeToByteArrayImpl$kotlin_stdlib(byte[] source, int startIndex, int endIndex) {
        Intrinsics.checkNotNullParameter(source, "source");
        checkSourceBounds$kotlin_stdlib(source.length, startIndex, endIndex);
        byte[] destination = new byte[encodeSize(endIndex - startIndex)];
    ...
    public final int encodeIntoByteArrayImpl$kotlin_stdlib(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        while (true) {
            ...
            if (groups == groupsPerLine && sourceIndex != i3) {
                ...
                bArr2[destinationIndex] = bArr3[0];
                destinationIndex = destinationIndex5 + 1;
                bArr2[destinationIndex5] = bArr3[1];
            }
        }
        switch (i3 - sourceIndex) {
            case 1:
                ...
                bArr2[destinationIndex8] = padSymbol;
                sourceIndex++;
                break;
            case 2:
                int sourceIndex4 = sourceIndex + 1;
                int bits3 = ((bArr[sourceIndex] & 255) << 10) | ((bArr[sourceIndex4] & 255) << 2);
                ...
                bArr2[destinationIndex9] = encodeMap[(bits3 >>> 6) & 63];
                int destinationIndex11 = destinationIndex10 + 1;
                bArr2[destinationIndex10] = encodeMap[bits3 & 63];
                destinationIndex = destinationIndex11 + 1;
                bArr2[destinationIndex11] = padSymbol;
    ...
    private final int encodeSize(int sourceSize) {
        ...
        int size = (groups * 4) + ((this.isMimeScheme ? (groups - 1) / 19 : 0) * 2);
        if (size >= 0) {
            return size;
        }
    ...
    private final int decodeImpl(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        while (true) {
            ...
            if (byteStart == -8 && symbol1 + 3 < i) {
                int sourceIndex = symbol1 + 1;
                int sourceIndex2 = sourceIndex + 1;
                int sourceIndex3 = sourceIndex2 + 1;
                int sourceIndex4 = sourceIndex3 + 1;
                int bits = (decodeMap[bArr[symbol1] & UByte.MAX_VALUE] << 18) | (decodeMap[bArr[sourceIndex] & UByte.MAX_VALUE] << 12) | (decodeMap[bArr[sourceIndex2] & UByte.MAX_VALUE] << 6) | decodeMap[bArr[sourceIndex3] & UByte.MAX_VALUE];
                if (bits >= 0) {
                    int destinationIndex2 = destinationIndex + 1;
            ...
            if (symbolBits >= 0) {
                ...
                symbol1 = handlePaddingSymbol(bArr, symbol1, i, byteStart);
                break;
        ...
        if (byteStart != -2) {
            int sourceIndex5 = skipIllegalSymbolsIfMime(bArr, symbol1, i);
            if (sourceIndex5 >= i) {
                return destinationIndex - destinationOffset;
            }
            int symbol2 = bArr[sourceIndex5] & 255;
            StringBuilder append2 = new StringBuilder().append("Symbol '").append((char) symbol2).append("'(");
            String num2 = Integer.toString(symbol2, CharsKt.checkRadix(8));
